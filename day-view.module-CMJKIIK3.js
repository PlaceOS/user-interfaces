...
import "./chunk-YNMPDG4X.js";
import {
  EventsStateService
} from "./chunk-7Z45K24I.js";
import {
  MOCK_APPROVAL_EVENTS
} from "./chunk-47QBGJE6.js";
import "./chunk-WOPYGR4Z.js";
...
function RoomBookingsTimelineComponent_For_33_For_1_Conditional_0_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("bg-success", event_r7.status === "approved")("bg-warning", event_r7.status === "tentative")("bg-error", event_r7.status === "declined" || event_r7.status === "cancelled")("bg-base-300", event_r7.status !== "approved" && event_r7.status !== "tentative" && event_r7.status !== "declined" && event_r7.status !== "cancelled");
    \u0275\u0275advance();
    \u0275\u0275classProp("opacity-60", event_r7.status === "cancelled");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", event_r7.all_day ? "All Day" : \u0275\u0275pipeBind3(3, 15, event_r7.date, ctx_r2.time_format, ctx_r2.tz), " \u2013 ", event_r7.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("opacity-60", event_r7.status === "cancelled");
    \u0275\u0275advance();
...
function RoomBookingsTimelineComponent_For_33_For_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(3, RoomBookingsTimelineComponent_For_33_For_1_Conditional_0_Conditional_3_Template, 6, 19);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const event_r7 = \u0275\u0275nextContext().$implicit;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsTimelineComponent, { className: "RoomBookingsTimelineComponent", filePath: "apps/concierge/src/app/day-view/room-timeline.component.ts", lineNumber: 270 });
})();
...
function RoomWeekBookingsTimelineComponent_For_27_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275classProp("bg-success", event_r4.status === "approved")("bg-warning", event_r4.status === "tentative" || !event_r4.status && event_r4.status !== "declined" && event_r4.status !== "cancelled")("bg-error", event_r4.status === "declined" || event_r4.status === "cancelled");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("line-through", event_r4.state === "done");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", event_r4.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind3(7, 14, event_r4.date, ctx_r1.time_format, ctx_r1.tz), " \u2013 ", \u0275\u0275pipeBind3(8, 18, event_r4.date_end, ctx_r1.time_format, ctx_r1.tz), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.tz ? 9 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", event_r4.system == null ? null : event_r4.system.display_name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ((tmp_29_0 = \u0275\u0275pipeBind1(15, 24, \u0275\u0275pipeBind1(14, 22, event_r4.host))) == null ? null : tmp_29_0.name) || event_r4.host, " ");
  }
}
function RoomWeekBookingsTimelineComponent_For_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275repeaterCreate(1, RoomWeekBookingsTimelineComponent_For_27_For_2_Template, 16, 26, "button", 19, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomWeekBookingsTimelineComponent, { className: "RoomWeekBookingsTimelineComponent", filePath: "apps/concierge/src/app/day-view/room-week-timeline.component.ts", lineNumber: 209 });
})();
...
function RoomBookingsComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_For_25_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_For_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 14)(1, "div", 25);
    \u0275\u0275conditionalCreate(2, RoomBookingsComponent_For_25_Conditional_2_Template, 5, 3, "div", 26);
...
function RoomBookingsComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_Conditional_27_Template_settings_toggle_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RoomBookingsComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-bookings-timeline", 23);
  }
}
function RoomBookingsComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-week-bookings-timeline", 23);
  }
}
function RoomBookingsComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-bookings-approvals", 24);
  }
}
...
_RoomBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsComponent, selectors: [["room-bookings"]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], decls: 47, vars: 32, consts: [[1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden", "pl-8"], [1, "flex", "w-full", "items-center", "space-x-2", "py-4", "pr-8"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "day"], ["value", "week"], ["icon", "", "matRipple", "", 1, "border-secondary", "h-12", "w-12", "rounded", "border", 3, "click", "matTooltip", "disabled"], ["diameter", "24"], [1, "text-2xl"], [1, "flex", "w-full", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "ngModel"], [1, "flex", "flex-1", "items-center", "justify-end", "space-x-4", "pr-2"], [1, "flex", "items-center", "space-x-1"], [1, "h-3", "w-3", "rounded-full", "bg-success"], [1, "text-xs", "opacity-60"], [1, "h-3", "w-3", "rounded-full", "bg-warning"], [1, "h-3", "w-3", "rounded-full", "bg-error"], [1, "border-base-200", "mt-4", "flex", "h-px", "w-full", "flex-1", "border-t"], [1, "relative", "z-0", "w-1/2", "flex-1"], [1, "relative", "z-10"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"]], template: function RoomBookingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(17, RoomBookingsComponent_Conditional_17_Template, 1, 0, "mat-spinner", 9)(18, RoomBookingsComponent_Conditional_18_Template, 2, 0, "icon", 10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 11)(20, "mat-form-field", 12)(21, "mat-select", 13);
    \u0275\u0275pipe(22, "async");
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_Template_mat_select_ngModelChange_21_listener($event) {
      return ctx.updateZones($event);
    });
    \u0275\u0275repeaterCreate(24, RoomBookingsComponent_For_25_Template, 5, 3, "mat-option", 14, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(26, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(27, RoomBookingsComponent_Conditional_27_Template, 4, 6, "settings-toggle", 15);
    ...
    \u0275\u0275conditionalCreate(42, RoomBookingsComponent_Conditional_42_Template, 1, 0, "room-bookings-timeline", 23);
    \u0275\u0275pipe(43, "async");
    \u0275\u0275pipe(44, "async");
    \u0275\u0275conditionalBranchCreate(45, RoomBookingsComponent_Conditional_45_Template, 1, 0, "room-week-bookings-timeline", 23);
    \u0275\u0275conditionalCreate(46, RoomBookingsComponent_Conditional_46_Template, 1, 0, "room-bookings-approvals", 24);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(16, 20, "APP.CONCIERGE.DOWNLOAD_USER_LIST"))("disabled", ctx.downloading());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.downloading() ? 17 : 18);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(22, 22, ctx.zones))("placeholder", \u0275\u0275pipeBind1(23, 24, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(26, 26, ctx.levels));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.allow_setup_breakdown ? 27 : -1);
    \u0275\u0275advance(15);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(43, 28, ctx.period) === "day" ? 42 : \u0275\u0275pipeBind1(44, 30, ctx.period) === "week" ? 45 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx.has_approvals ? 46 : -1);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsComponent, { className: "RoomBookingsComponent", filePath: "apps/concierge/src/app/day-view/room-bookings.component.ts", lineNumber: 160 });
})();
...
//# sourceMappingURL=day-view.module-CMJKIIK3.js.map
