...
function VisitorFlowDetailsComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.model().date)("ngModelOptions", \u0275\u0275pureFunction0(18, _c0))("disabled", ctx_r1.is_edit_in_progress())("range", ctx_r1.effective_bookable_hours())("use_24hr", ctx_r1.use_24hr())("timezone", ctx_r1.timezone);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 16, "FORM.DURATION"));
    \u0275\u0275advance(4);
    \u0275\u0275property("formField", ctx_r1.form.duration)("time", ctx_r1.model().date)("max", ctx_r1.max_duration())("end_time", ctx_r1.effective_bookable_hours()?.end)("use_24hr", ctx_r1.use_24hr())("timezone", ctx_r1.timezone);
    \u0275\u0275control();
  }
}
...
var VisitorFlowDetailsComponent = class _VisitorFlowDetailsComponent {
  constructor() {
    ...
    this.max_duration = computed(
      () => Math.min(settingSignal("visitors.max_duration", 180)(), settingSignal("bookings.max_duration", 180)()),
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorFlowDetailsComponent, selectors: [["visitor-flow-details"]], decls: 22, vars: 16, consts: [[1, "w-full", "p-4"], [1, "mt-4"], [1, "flex", "flex-col"], [1, "relative", "flex", "flex-col"], ["for", "date"], [3, "formField"], [1, "absolute", "-top-2", "right-2", 3, "formField"], [1, "flex", "flex-col", "space-y-2", "sm:flex-row", "sm:space-y-0", "sm:space-x-2"], [1, "flex", "w-full", "flex-col"], ["for", "reason"], ["appearance", "outline", 1, "w-full"], ["matInput", "", 3, "formField", "placeholder"], [1, "mb-4", "flex", "w-full", "sm:hidden"], ["appearance", "outline", 1, "no-subscript", "w-full"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], ["value", "single"], ["value", "group"], [1, "bg-base-200", "hidden", "w-full", "items-center", "space-x-1", "rounded-lg", "p-1", "sm:flex"], ["btn", "", "matRipple", "", 1, "border-base-300", "hover:bg-base-300", "flex-1", "space-x-2", "border", 3, "click"], ["for", "building"], ["name", "building", "placeholder", "Select building", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value"], [1, "flex-1"], ["for", "time"], ["name", "time", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "range", "use_24hr", "timezone"], ["for", "duration"], [3, "formField", "time", "max", "end_time", "use_24hr", "timezone"], ["for", "host"], [1, "mb-4", 3, "formField"]], template: function VisitorFlowDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(12, VisitorFlowDetailsComponent_Conditional_12_Template, 15, 19, "div", 7);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorFlowDetailsComponent, { className: "VisitorFlowDetailsComponent", filePath: "apps/workplace/src/app/book/visitor-flow-new/visitor-flow-details.component.ts", lineNumber: 242 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorFlowNewComponent, { className: "VisitorFlowNewComponent", filePath: "apps/workplace/src/app/book/visitor-flow-new/visitor-flow.component.ts", lineNumber: 131 });
})();
export {
  VisitorFlowNewComponent
};
//# sourceMappingURL=visitor-flow.component-WM6CS4XX.js.map
