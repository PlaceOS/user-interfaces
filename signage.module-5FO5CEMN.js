...
var SearchOverlayComponent = class _SearchOverlayComponent {
  constructor() {
    this.item_list = input([], ...ngDevMode ? [{ debugName: "item_list" }] : (
      /* istanbul ignore next */
      []
    ));
    this.result_template = input(void 0, ...ngDevMode ? [{ debugName: "result_template" }] : (
      /* istanbul ignore next */
      []
    ));
...
var _forTrack0 = ($index, $item) => $item == null ? null : $item.id;
...
function SignageApprovePlaylistModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(8, 7, ((tmp_1_0 = ctx_r3.current_version()) == null ? null : tmp_1_0.updated_at) * 1e3, "dd MMM, HH:mm"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(12, 10, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(23, _c02, ((tmp_2_0 = ctx_r3.current_version()) == null ? null : tmp_2_0.items.length) || 0), ((tmp_2_0 = ctx_r3.current_version()) == null ? null : tmp_2_0.items.length) || 0), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r3.current_media());
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(22, 14, ((tmp_4_0 = ctx_r3.previous_version()) == null ? null : tmp_4_0.updated_at) * 1e3, "dd MMM, HH:mm"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(26, 17, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(25, _c02, ((tmp_5_0 = ctx_r3.previous_version()) == null ? null : tmp_5_0.items.length) || 0), ((tmp_5_0 = ctx_r3.previous_version()) == null ? null : tmp_5_0.items.length) || 0), " ");
    \u0275\u0275advance(2);
...
var SignageApprovePlaylistModalComponent = class _SignageApprovePlaylistModalComponent {
  constructor() {
    ...
    this._playlist_id = signal(this._playlist?.id || "", ...ngDevMode ? [{ debugName: "_playlist_id" }] : (
      /* istanbul ignore next */
      []
    ));
    this.playlist_versions = toSignal(toObservable(this._playlist_id).pipe(filter((_) => !!_), tap(() => this.loading.set("Loading versions...")), switchMap((id) => dh(id, { limit: 2 }))), { initialValue: [] });
    this._playlist_media = toSignal(combineLatest([
      toObservable(this.playlist_versions),
      this._service.media
    ]).pipe(map(([playlists, media]) => playlists.map((playlist) => playlist.items.map((id) => media.find((m) => m?.id === id)))), tap(() => this.loading.set(""))), { initialValue: [] });
    this.playlist_media = computed(() => this._playlist_media(), ...ngDevMode ? [{ debugName: "playlist_media" }] : (
      /* istanbul ignore next */
      []
    ));
    this.current_version = computed(() => this.playlist_versions()[0], ...ngDevMode ? [{ debugName: "current_version" }] : (
      /* istanbul ignore next */
      []
    ));
    this.previous_version = computed(() => this.playlist_versions()[1], ...ngDevMode ? [{ debugName: "previous_version" }] : (
      /* istanbul ignore next */
      []
    ));
    this.current_media = computed(() => this.playlist_media()[0] || [], ...ngDevMode ? [{ debugName: "current_media" }] : (
      /* istanbul ignore next */
      []
    ));
    this.previous_media = computed(() => this.playlist_media()[1] || [], ...ngDevMode ? [{ debugName: "previous_media" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  async undoChanges() {
    ...
    await gh(this._playlist?.id, previous.items);
    this.loading.set("");
    this._dialog_ref.disableClose = false;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageApprovePlaylistModalComponent, { className: "SignageApprovePlaylistModalComponent", filePath: "apps/concierge/src/app/signage/signage-approve-playlist-modal.component.ts", lineNumber: 218 });
})();
...
var SignageDisplayModalComponent = class _SignageDisplayModalComponent {
  ...
  async save() {
    ...
    const new_display = new vs(__spreadProps(__spreadValues({}, form_value), {
    ...
    const method = this.display.id ? na(this.display.id, new_display) : sa(new_display);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageDisplayModalComponent, { className: "SignageDisplayModalComponent", filePath: "apps/concierge/src/app/signage/signage-display-modal.component.ts", lineNumber: 116 });
})();
...
var SignageMediaModalComponent = class _SignageMediaModalComponent {
  ...
  constructor() {
    ...
    this.form = new FormGroup({
      ...
      animation: new FormControl(qs.Default),
  ...
  async saveMedia() {
    ...
    if (this.item.id) {
      await nh(this.item.id, new_media).catch(onError);
    } else {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaModalComponent, selectors: [["signage-media-modal"]], features: [\u0275\u0275ProvidersFeature([
      ...
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 35, ctx.item.id ? "APP.CONCIERGE.SIGNAGE_MEDIA_EDIT" : "APP.CONCIERGE.SIGNAGE_MEDIA_NEW"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 37, "APP.CONCIERGE.SIGNAGE_MEDIA_SAVING") : "");
        \u0275\u0275advance(3);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 39, "FORM.NAME"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(15, 41, "FORM.NAME"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 43, "FORM.NAME_REQUIRED"));
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.media_type === "video" ? 19 : -1);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 45, "APP.CONCIERGE.SIGNAGE_MEDIA_PLAY_TIME"));
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.form.value.play_time ? 25 : 26);
        \u0275\u0275advance(2);
        \u0275\u0275property("min", ctx.form.value.start_time)("max", ctx.item.video_length || 3e5);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(31, 47, "APP.CONCIERGE.SIGNAGE_ANIMATION"));
        \u0275\u0275advance(4);
        \u0275\u0275property("value", 0);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(36, 49, "APP.CONCIERGE.SIGNAGE_ANIMATION_DEFAULT"));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", 1);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(39, 51, "APP.CONCIERGE.SIGNAGE_ANIMATION_CUT"));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", 2);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 53, "APP.CONCIERGE.SIGNAGE_ANIMATION_CROSS_FADE"));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", 3);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(45, 55, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_TOP"));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", 4);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(48, 57, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_LEFT"));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", 5);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 59, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_RIGHT"));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", 6);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(54, 61, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_BOTTOM"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 63, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(60, 65, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(65, 67, "APP.CONCIERGE.VALID_FROM"));
        \u0275\u0275advance(2);
        \u0275\u0275property("clear", true);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(70, 69, "APP.CONCIERGE.VALID_UNTIL"));
        \u0275\u0275advance(2);
        \u0275\u0275property("from", ctx.form.value.valid_from)("clear", true);
      }
    }, dependencies: [
      FullscreenModalShellComponent,
      ReactiveFormsModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaModalComponent, { className: "SignageMediaModalComponent", filePath: "apps/concierge/src/app/signage/signage-media-modal.component.ts", lineNumber: 250 });
})();
...
var SignageMediaPreviewModalComponent = class _SignageMediaPreviewModalComponent {
  constructor() {
    ...
    this.resource = signal(this._data.url.toString(), ...ngDevMode ? [{ debugName: "resource" }] : (
      /* istanbul ignore next */
      []
    ));
    this.name = signal(this._data.name, ...ngDevMode ? [{ debugName: "name" }] : (
      /* istanbul ignore next */
      []
    ));
    this.type = signal(this._data.type, ...ngDevMode ? [{ debugName: "type" }] : (
      /* istanbul ignore next */
      []
    ));
    this.can_save = signal(this._data.save !== false, ...ngDevMode ? [{ debugName: "can_save" }] : (
      /* istanbul ignore next */
      []
    ));
    this.file = this._data.file;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CronInputFieldComponent, { className: "CronInputFieldComponent", filePath: "libs/form-fields/src/lib/cron-input-field.component.ts", lineNumber: 166 });
})();
...
function SignagePlaylistModalComponent_Conditional_112_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("ngModel", ctx_r0.form.value.play_at)("ngModelOptions", \u0275\u0275pureFunction0(11, _c04));
    \u0275\u0275advance(2);
...
var SignagePlaylistModalComponent = class _SignagePlaylistModalComponent {
  constructor() {
    this._data = inject(MAT_DIALOG_DATA) ?? new nr({});
    ...
    this.schedule = signal("", ...ngDevMode ? [{ debugName: "schedule" }] : (
      /* istanbul ignore next */
      []
    ));
    this.form = new FormGroup({
      ...
      default_animation: new FormControl(qs.Cut),
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePlaylistModalComponent, selectors: [["signage-playlist-modal"]], decls: 114, vars: 94, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], ["for", "name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], [1, "mb-4", "flex", "items-center", "space-x-4"], ["formControlName", "enabled", 1, "flex-1", 3, "name"], ["formControlName", "random", 1, "flex-1", 3, "name"], [1, "pt-2", "pb-4"], [1, "border-base-300", "relative", "rounded-sm", "border"], ["for", "default-duration", 1, "bg-base-100", "absolute", "top-0", "left-2", "m-0", "flex", "w-auto", "min-w-0", "-translate-y-1/2", "items-center", "space-x-2", "px-2"], [1, "flex", "items-center", "px-2", "pt-2"], ["min", "5000", "max", "300000", "step", "1000", 1, "flex-1"], ["name", "default-duration", "matSliderThumb", "", "formControlName", "default_duration"], [1, "w-16", "px-2", "text-right", "font-mono", "text-xs"], [1, "flex", "space-x-2"], [1, "flex-1"], ["for", "orientation"], ["name", "orientation", "formControlName", "orientation", 3, "placeholder"], ["value", "unspecified"], ["value", "landscape"], ["value", "portrait"], ["value", "square"], ["for", "animation"], ["name", "animation", "formControlName", "default_animation", 3, "placeholder"], [3, "value"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 1, "min-h-32", 3, "placeholder"], [1, "flex", "space-x-4"], ["for", "valid-from"], ["name", "valid-from", "formControlName", "valid_from", 1, "w-full"], ["for", "valid-until"], ["name", "valid-until", "formControlName", "valid_until", 1, "w-full", 3, "from"], [1, "border-base-300", "relative", "mb-12", "space-y-2", "rounded-sm", "border", "px-4", "pt-4"], ["for", "schedule", 1, "bg-base-100", "absolute", "top-0", "left-2", "m-0", "flex", "w-auto", "min-w-0", "-translate-y-1/2", "items-center", "space-x-2", "px-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], [3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", ""], ["value", "between"], ["value", "exact", 3, "click"], ["value", "recurring", 3, "click"], [1, "pt-2"], ["for", "play-from"], ["name", "play-from", "formControlName", "play_from", 1, "w-full", 3, "no_past_times"], ["for", "play-until"], ["name", "play-until", "formControlName", "play_until", 1, "w-full", 3, "no_past_times", "from"], ["for", "play-at"], ["name", "play-at", "formControlName", "play_at", 1, "w-full"], ["for", "play-at-time"], ["name", "play-at-time", 1, "w-full", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "play-duration"], ["name", "play-duration", "formControlName", "play_duration", 1, "w-full"], ["formControlName", "play_once", 1, "mb-4"], ["formControlName", "play_cron"]], template: function SignagePlaylistModalComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(93, _c04));
        \u0275\u0275advance(10);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistModalComponent, { className: "SignagePlaylistModalComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-modal.component.ts", lineNumber: 376 });
})();
...
var SignageStateService = class _SignageStateService extends AsyncHandler {
  constructor() {
    ...
    this.media = combineLatest([
      ...
      this._change
    ]).pipe(filter(([_]) => !!_?.id), debounceTime(300), switchMap(() => eh({ limit: 2500 })), map((_) => _.data.sort((a, b) => b.created_at - a.created_at)), startWith([]), shareReplay(1));
    this.playlists = combineLatest([
      this._org.active_building,
      this._change
    ]).pipe(filter(([_]) => !!_?.id), debounceTime(300), switchMap(() => uh({ limit: 500 })), map((_) => (_.data || []).sort((a, b) => a.name.localeCompare(b.name))), startWith([]), shareReplay(1));
    this.displays = combineLatest([
      this._org.active_region,
      this._org.active_building,
      this._change
    ]).pipe(filter(([, bld]) => !!bld?.id), switchMap(([region, bld]) => from(Xc({
      zone_id: (this._settings.get("app.use_region") ? region?.id : "") || bld?.id,
      limit: 500,
      signage: true
    })).pipe(map((_) => (_.data || []).sort((a, b) => (a.display_name || a.name).localeCompare(b.display_name || b.name)).filter((_2) => _2.signage)))), startWith([]), shareReplay(1));
    this.zones = combineLatest([
      this._org.active_building,
      this._change
    ]).pipe(switchMap(() => from(ja({
      limit: 250,
      tags: "signage"
    })).pipe(catchError(() => of({ data: [] })))), map((_) => (_.data || []).sort((a, b) => (a.display_name || a.name).localeCompare(b.display_name || b.name))), startWith([]), shareReplay(1));
  }
  changed() {
    this._change.next(Date.now());
  }
  editPlaylist(playlist = new nr({})) {
  ...
  editMedia(media = new tr({}), file, playlist_id = "") {
  ...
  async editDisplay(display = new vs({})) {
  ...
  async savePlaylist(playlist) {
    ...
    const call = clean_playlist.id ? ah(clean_playlist.id, clean_playlist, "put") : hh(clean_playlist);
  ...
  previewFileMedia(media, playlist_id = "") {
    ...
    ref.componentInstance.save.subscribe(async () => {
      ...
      if (playlist_id && new_media.id) {
        const media_list = await fh(playlist_id);
        const new_media_list = [...media_list.items, new_media.id];
        await gh(playlist_id, new_media_list);
      }
      ref.close();
    });
  }
  async addMediaFromLink(url, media_item = new tr({})) {
    const url_obj = new URL(url);
    const data = __spreadValues({}, new tr(__spreadProps(__spreadValues({}, media_item), {
...
var PLAYLIST_ITEM_COUNTS = signal({}, ...ngDevMode ? [{ debugName: "PLAYLIST_ITEM_COUNTS" }] : (
  /* istanbul ignore next */
  []
));
var SignageItemPlaylistsComponent = class _SignageItemPlaylistsComponent {
  constructor() {
    ...
    this.name = input("zone", ...ngDevMode ? [{ debugName: "name" }] : (
      /* istanbul ignore next */
      []
    ));
    this.extra = input("", ...ngDevMode ? [{ debugName: "extra" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.playlist_thumbnail_media = computed(() => {
      ...
      for (const [playlist_id, data] of Object.entries(counts)) {
        result[playlist_id] = (data.media_ids || []).map((id) => rh(id));
      }
      return result;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageItemPlaylistsComponent, { className: "SignageItemPlaylistsComponent", filePath: "apps/concierge/src/app/signage/signage-item-playlists.component.ts", lineNumber: 251 });
})();
...
var ZoneSelectModalComponent = class _ZoneSelectModalComponent {
  constructor() {
    ...
    this._zones = toSignal(toObservable(this.search_term).pipe(debounceTime(300), switchMap((term) => from(ja(__spreadProps(__spreadValues({}, this.query), { q: term, limit: 100 }))).pipe(map((_) => _.data), catchError(() => of([])))), startWith([])), { initialValue: [] });
    this.zones = computed(() => this._zones().filter((zone) => !this.ignore.includes(zone.id)), ...ngDevMode ? [{ debugName: "zones" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneSelectModalComponent, { className: "ZoneSelectModalComponent", filePath: "apps/concierge/src/app/signage/zone-select-modal.component.ts", lineNumber: 94 });
})();
...
var SignageDisplaysComponent = class _SignageDisplaysComponent {
  get signage_path() {
  ...
  constructor() {
    ...
    this.selected = signal("", ...ngDevMode ? [{ debugName: "selected" }] : (
      /* istanbul ignore next */
      []
    ));
    this.selected_trigger = signal("", ...ngDevMode ? [{ debugName: "selected_trigger" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.triggers = toSignal(toObservable(this.selected).pipe(switchMap((id) => {
      if (!id)
        return of([]);
      return from(_a(id)).pipe(map((_) => _.data), tap(() => setTimeout(() => this.switching.set(false), 200)));
    })), { initialValue: [] });
  ...
  async setOrientation(orientation) {
    ...
    if (!display)
      return;
    await na(display.id, { orientation, version: display.version }, "patch").catch((e) => {
...
var SignageMediaListComponent = class _SignageMediaListComponent {
  constructor() {
    ...
    this.playlist_search = signal("", ...ngDevMode ? [{ debugName: "playlist_search" }] : (
      /* istanbul ignore next */
      []
    ));
    this._playlists = toSignal(this._state.playlists, {
    ...
    this.playlist_ids = computed(() => new Array(this.playlist_count()).fill(0).map((_, idx) => `playlist-${idx}`), ...ngDevMode ? [{ debugName: "playlist_ids" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  async addToPlaylist(media_id, playlist) {
    const media_list = await fh(playlist.id);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaListComponent, { className: "SignageMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-media-list.component.ts", lineNumber: 360 });
})();
...
var SignagePlaylistMediaListComponent = class _SignagePlaylistMediaListComponent {
  constructor() {
    ...
    this._settings = inject(SettingsService);
    this.playlist = input("", ...ngDevMode ? [{ debugName: "playlist" }] : (
      /* istanbul ignore next */
      []
    ));
    this.playlist_count = input(0, ...ngDevMode ? [{ debugName: "playlist_count" }] : (
    ...
    this.approved = signal(0, ...ngDevMode ? [{ debugName: "approved" }] : (
      /* istanbul ignore next */
      []
    ));
    this.loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : (
    ...
    ]).pipe(map(([playlist]) => playlist), filter((playlist) => !!playlist), debounceTime(300), tap(() => this.loading.set(true)), switchMap((playlist) => from(fh(playlist.id)).pipe(catchError(() => of({ id: "", items: [], approved: 0 })))), tap((_) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistMediaListComponent, { className: "SignagePlaylistMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-media-list.component.ts", lineNumber: 369 });
})();
...
var SignageMediaComponent = class _SignageMediaComponent extends AsyncHandler {
  constructor() {
    ...
    this.selected_playlist = computed(() => this._route_query()?.get("playlist") || "", ...ngDevMode ? [{ debugName: "selected_playlist" }] : (
      /* istanbul ignore next */
      []
    ));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaComponent, { className: "SignageMediaComponent", filePath: "apps/concierge/src/app/signage/signage-media.component.ts", lineNumber: 190 });
})();
...
var SignageZonesComponent = class _SignageZonesComponent {
  constructor() {
    this._state = inject(SignageStateService);
    this._route = inject(ActivatedRoute);
    this.adding = signal(false, ...ngDevMode ? [{ debugName: "adding" }] : (
    ...
    this.triggers = toSignal(toObservable(this.selected).pipe(switchMap((id) => {
      if (!id)
        return of([]);
      return from(Za(id)).pipe(map((_) => _.data), tap(() => setTimeout(() => this.switching.set(false), 100)));
    })), { initialValue: [] });
    this.active_trigger = computed(() => {
      const list = this.triggers();
      const id = this.selected_trigger();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageZonesComponent, { className: "SignageZonesComponent", filePath: "apps/concierge/src/app/signage/signage-zones.component.ts", lineNumber: 164 });
})();
...
var SignageComponent = class _SignageComponent {
  constructor() {
    this._state = inject(SignageStateService);
    this._router = inject(Router);
    this.loading = this._state.loading;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageComponent, { className: "SignageComponent", filePath: "apps/concierge/src/app/signage/signage.component.ts", lineNumber: 94 });
})();
...
//# sourceMappingURL=signage.module-5FO5CEMN.js.map
