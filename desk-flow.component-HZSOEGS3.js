...
function DeskFlowSelectComponent_Conditional_91_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 4, "COMMON.FAVOURITES_ONLY"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 6, "CALENDAR_EVENT.FACILITIES"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.features());
  }
}
var DeskFlowSelectComponent = class _DeskFlowSelectComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFlowSelectComponent, selectors: [["desk-flow-select"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 92, vars: 82, consts: [[1, "relative", "w-full", "bg-base-100"], [1, "gradient", "relative", "flex", "h-14", "items-center", "justify-between", "space-x-2", "border-l-8", "border-base-content", "px-4", "text-xl", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["icon", "", "matRipple", "", 1, "sm:hidden", 3, "click"], [1, "fixed", "inset-0", "z-20", "bg-black/50", "sm:hidden"], [1, "relative", "flex", "w-full", "overflow-hidden", "p-2", "sm:space-x-2"], [1, "hidden", "sm:sticky", "sm:top-0", "sm:block", "sm:w-[20rem]", "sm:max-w-[20rem]"], [1, "flex", "w-full", "items-center", "justify-between", "p-2"], [1, "px-2", "text-xl", "font-medium"], [1, "flex", "flex-col", "overflow-y-auto", "px-4", "pb-4"], ["for", "location"], ["appearance", "outline", 1, "w-full"], ["for", "date"], [3, "formField", "to"], [1, "mb-2", 3, "formField"], [1, "flex", "min-w-0", "flex-1", "flex-col"], [1, "mb-2", "flex", "space-x-2"], ["filters", "", 1, "flex", "flex-1", "flex-wrap", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-2"], ["btn", "", "matRipple", "", "name", "clear-space-filters", 1, "mb-2", "mr-2", "min-h-[2rem]"], ["filter-item", "", "zone", ""], ["filter-item", "", "date", ""], ["filter-item", "", "time", ""], ["filter-item", ""], [1, "space-y-2"], ["btn", "", "matRipple", "", 1, "w-full", "space-x-2", 3, "click"], [1, "text-2xl"], [1, "pr-2"], [1, "relative", "flex", "flex-col", "overflow-hidden", "rounded-lg", "border", "border-base-300", "bg-base-200", "p-2"], [3, "selected_items"], [3, "selected_items", "promote_selected"], [1, "filters-panel-mobile", "fixed", "bottom-0", "left-0", "right-0", "z-30", "w-full", "border-t", "border-base-300", "bg-base-100", "shadow-lg", "transition-transform", "duration-300", "sm:hidden"], [1, "flex", "w-full", "items-center", "justify-between", "border-b", "border-base-300", "p-2"], ["icon", "", "matRipple", "", 3, "click"], [1, "flex", "max-h-[60vh]", "flex-col", "overflow-y-auto", "p-4"], [1, "fixed", "inset-0", "z-20", "bg-black/50", "sm:hidden", 3, "click"], ["name", "region", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "value"], ["name", "building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["name", "location-multi", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder", "multiple"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [1, "flex", "space-x-2"], [1, "flex-1", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr", "timezone"], [1, "w-1/3", "flex-1", 3, "formField", "time", "max", "min", "custom_options", "step", "use_24hr", "timezone"], [1, "mb-4", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "text-lg", "font-medium"], [1, "mb-4", "flex", "flex-col", "space-y-2"], [1, "w-full", 3, "label", "ngModel", "ngModelOptions"], [1, "w-full", 3, "ngModelChange", "label", "ngModel", "ngModelOptions"], ["btn", "", "matRipple", "", "name", "clear-space-filters", 1, "mb-2", "mr-2", "min-h-[2rem]", 3, "click"], [1, "truncate"], ["icon", "", "matRipple", "", "name", "remove-space-filter", 1, "-mr-4", 3, "click"], [3, "item_selected", "selected_items"], [3, "item_selected", "selected_items", "promote_selected"], ["name", "location-multi-mobile", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder", "multiple"], [1, "w-1/3", "flex-1", 3, "formField", "time", "min", "max", "step", "custom_options", "use_24hr", "timezone"]], template: function DeskFlowSelectComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskFlowSelectComponent, { className: "DeskFlowSelectComponent", filePath: "apps/workplace/src/app/book/desk-flow-new/desk-flow-select.component.ts", lineNumber: 568 });
})();
...
var DeskFlowNewComponent = class _DeskFlowNewComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    if (!this._booking_form.model().id)
      this._booking_form.model.update((m) => __spreadProps(__spreadValues({}, m), { title: "Booking" }));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFlowNewComponent, selectors: [["desk-flow-new"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [[1, "bg-base-200", "relative", "z-0", "flex", "h-full", "w-full", "flex-col", "overflow-auto"], [1, "mx-auto", "min-h-full", "w-[80rem]", "max-w-full", "flex-1", "space-y-4", "px-4", "pt-4"], [1, "block"], [1, "border-base-300", "bg-base-100", "flex", "w-full", "flex-col", "overflow-hidden", "rounded-xl", "border"], [1, "gradient", "border-base-content", "relative", "flex", "items-center", "space-x-2", "border-l-8", "px-4", "py-3", "text-xl", "font-medium"], [1, "border-base-300", "bg-base-100", "sticky", "bottom-0", "z-20", "flex", "justify-between", "rounded-t-xl", "border-x", "border-t", "p-3"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [1, "flex", "items-center", "space-x-2"], [1, "animate-spin", "text-2xl"], [1, "text-2xl"], [1, "flex-1", "pr-4"]], template: function DeskFlowNewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=desk-flow.component-HZSOEGS3.js.map
