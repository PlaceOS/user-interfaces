...
} from "./chunk-4J6VQTHB.js";
import {
  BookingFormService
} from "./chunk-WWS5253B.js";
import {
  ItemListFieldComponent
} from "./chunk-ZM6SAS3O.js";
import {
  DEFAULT_COLOURS
} from "./chunk-MCZVUIQB.js";
import {
...
import {
  MapPinComponent
} from "./chunk-3DDPADQI.js";
import {
  DateFieldComponent
} from "./chunk-BR4QHLZX.js";
import {
  InteractiveMapComponent
} from "./chunk-K3TIH5Y7.js";
import {
  openConfirmModal
...
var ParkingSpacePipe = class _ParkingSpacePipe {
  ...
  async transform(asset_id) {
    ...
    if (cached)
      return cached;
    const space = await Bh(asset_id).catch(() => null);
    if (space) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFiltersComponent, selectors: [["parking-space-filters"]], inputs: { hide_levels: [1, "hide_levels"] }, decls: 28, vars: 29, consts: [[1, "border-base-300", "bg-base-100", "sticky", "top-0", "z-10", "flex", "items-center", "border-b", "px-4", "py-4"], [1, "text-xl", "font-medium"], [1, "divide-base-200", "relative", "z-0", "w-full", "divide-y", "p-2"], ["details", ""], [1, "mb-1", "text-lg", "font-medium"], [1, "flex", "min-w-32", "flex-1", "flex-col"], ["for", "location"], ["appearance", "outline", 1, "w-full"], [1, "min-w-[256px]", "flex-1"], ["name", "date", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "to", "timezone"], [1, "-mt-2", "mb-2", "flex", "justify-end"], [1, "flex", "items-center", "space-x-2"], ["favs", "", 1, "space-y-2", "pb-4"], ["features", "", 1, "space-y-2"], [1, "border-base-200", "w-full", "border-t", "px-2", "py-2"], ["name", "region", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "value"], ["name", "building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["name", "location", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "w-1/3", "flex-1"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr", "timezone", "range"], [3, "ngModelChange", "ngModel", "ngModelOptions", "time", "max", "min", "step", "use_24hr", "timezone", "end_time"], [1, "text-lg", "font-medium"], [1, "flex", "w-full", "items-center"], [1, "w-full", 3, "ngModelChange", "label", "ngModel", "ngModelOptions"], [1, "flex", "flex-wrap", "items-center", "space-x-2"], ["for", "feat", 1, "w-1/2", "flex-1"], ["btn", "", "matRipple", "", "name", "apply-parking-filters", 1, "w-full", 3, "click"]], template: function ParkingFiltersComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 22, "BOOKINGS.LOCATION"), " ");
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFiltersComponent, { className: "ParkingFiltersComponent", filePath: "libs/bookings/src/lib/parking-select-modal/parking-filters.component.ts", lineNumber: 262 });
})();
...
var ParkingSpaceListFieldComponent = class _ParkingSpaceListFieldComponent {
  constructor() {
    ...
    this.favorites = this._settings.signal("favourite_spaces", EMPTY_FAVS, true);
...
function ParkingAssignSpaceModalComponent_Conditional_21_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(space_r3.name || space_r3.id);
  }
}
...
var ParkingAssignSpaceModalComponent = class _ParkingAssignSpaceModalComponent extends AsyncHandler {
  constructor() {
    ...
    this._bookings_resource = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_bookings_resource" } : (
      /* istanbul ignore next */
      {}
    )), {
      params: () => this.selected_level(),
      loader: ({ params: level }) => level ? queryBookings({
    ...
    this._bookings = computed(
      () => this._bookings_resource.value() ?? [],
      ...ngDevMode ? [{ debugName: "_bookings" }] : (
        /* istanbul ignore next */
        []
      )
    );
    ...
    this.available_spaces = computed(
      () => {
        const booked_ids = new Set(this._bookings().filter((booking) => !booking.asset_id?.startsWith("unallocated") && !booking.rejected).map((booking) => booking.asset_id));
        const clash_ids = this._recurring_clash_ids();
        return this._all_spaces().filter((space) => !booked_ids.has(space.id) && !clash_ids.has(space.id) && !space.assigned_to && space.bookable !== false);
      },
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingAssignSpaceModalComponent, { className: "ParkingAssignSpaceModalComponent", filePath: "apps/concierge/src/app/parking/parking-assign-space-modal.component.ts", lineNumber: 225 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingBookingModalComponent, selectors: [["parking-booking-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 48, vars: 49, consts: [[3, "confirm", "heading", "loading"], [1, "mb-4", "flex", "items-center", "space-x-2"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1"], ["for", "user-name"], ["appearance", "outline", 1, "w-full"], ["matInput", "", 3, "formField", "placeholder"], ["for", "email"], [1, "relative"], ["for", "date"], [3, "formField"], [1, "absolute", "-top-2", "right-0", 3, "formField"], ["for", "parking-space"], [1, "mb-2", 3, "formField"], ["for", "plate-number"], [1, "flex-1", 3, "formField"], [1, "w-1/3", "flex-1"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "use_24hr", "range", "min_duration"], [1, "relative", "w-1/3", "flex-1"], ["for", "end-time"], [3, "formField", "time", "max", "custom_options", "use_24hr", "end_time"], ["for", "notes"], ["matInput", "", "rows", "3", 3, "formField", "placeholder"]], template: function ParkingBookingModalComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275control();
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(39, 43, "EXPLORE.PARKING_PLATE_NUMBER"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.user ? 40 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("formField", ctx.form.plate_number)("placeholder", \u0275\u0275pipeBind1(43, 45, "EXPLORE.PARKING_PLATE_NUMBER"));
        \u0275\u0275control();
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingBookingModalComponent, { className: "ParkingBookingModalComponent", filePath: "apps/concierge/src/app/parking/parking-booking-modal.component.ts", lineNumber: 208 });
})();
...
function ParkingFleetModalComponent_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 23, "EXPLORE.PARKING_PLATE_NUMBER"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r0.form.plate_number)("placeholder", \u0275\u0275pipeBind1(17, 25, "EXPLORE.PARKING_PLATE_NUMBER"));
    \u0275\u0275control();
    \u0275\u0275advance(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 19);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 19);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_For_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 28);
    \u0275\u0275listener("click", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_For_6_Template_button_click_0_listener($event) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_Conditional_7_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 30);
    \u0275\u0275listener("click", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_Conditional_7_For_5_Template_button_click_0_listener($event) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_Conditional_7_For_5_Template, 3, 14, "button", 29, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(4);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_For_13_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_For_6_Template, 3, 12, "button", 25, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_Conditional_7_Template, 6, 3);
    \u0275\u0275elementStart(8, "div", 23);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 26);
    \u0275\u0275repeaterCreate(12, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_For_13_Template, 4, 4, "div", 27, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5)(1, "div", 17);
    \u0275\u0275listener("click", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Template_div_click_1_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.setBookingFrequency("single"));
    });
    \u0275\u0275elementStart(2, "div", 18);
    \u0275\u0275conditionalCreate(3, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_3_Template, 1, 0, "div", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "div", 20);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Template_div_click_11_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.setBookingFrequency("daily"));
    });
    \u0275\u0275elementStart(12, "div", 18);
    \u0275\u0275conditionalCreate(13, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_13_Template, 1, 0, "div", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 11)(15, "div", 20);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(21, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Conditional_21_Template, 14, 7, "div", 22);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function ParkingRequestFormDetailsComponent_Conditional_0_For_17_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 19);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_For_17_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_For_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275listener("click", function ParkingRequestFormDetailsComponent_Conditional_0_For_17_Template_div_click_0_listener() {
      const type_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.setRequestType(type_r10.id));
    });
    \u0275\u0275elementStart(1, "div", 18);
    \u0275\u0275conditionalCreate(2, ParkingRequestFormDetailsComponent_Conditional_0_For_17_Conditional_2_Template, 1, 0, "div", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "div", 32)(5, "span", 20);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_For_17_Conditional_8_Template, 3, 3, "span", 33);
    \u0275\u0275elementEnd();
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "h4", 23);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "a-user-search-field", 34);
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "label", 23);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 13);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const forced_time_r11 = ctx;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate3(" ", \u0275\u0275pipeBind1(2, 3, ctx_r2.selected_request_type()?.name), ": ", \u0275\u0275pipeBind2(3, 5, ctx_r2.shiftTime(forced_time_r11.start_time), ctx_r2.time_format), " - ", \u0275\u0275pipeBind2(4, 8, ctx_r2.shiftTime(forced_time_r11.end_time), ctx_r2.time_format), " ");
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_27_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
    \u0275\u0275pipe(2, "date");
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275conditionalCreate(3, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_27_Conditional_3_Template, 3, 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "date");
  ...
  if (rf & 2) {
    const option_r13 = ctx;
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275textInterpolate3(" ", \u0275\u0275pipeBind1(1, 3, option_r13.name), " (", \u0275\u0275pipeBind2(2, 5, ctx_r2.shiftTime(option_r13.start_time), ctx_r2.time_format), " - ", \u0275\u0275pipeBind2(3, 8, ctx_r2.shiftTime(option_r13.end_time), ctx_r2.time_format), ") ");
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "date");
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_For_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate3(" ", \u0275\u0275pipeBind1(2, 4, option_r14.name), " (", \u0275\u0275pipeBind2(3, 6, ctx_r2.shiftTime(option_r14.start_time), ctx_r2.time_format), " - ", \u0275\u0275pipeBind2(4, 9, ctx_r2.shiftTime(option_r14.end_time), ctx_r2.time_format), ") ");
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 15);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 13)(4, "mat-select", 37);
    \u0275\u0275listener("selectionChange", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Template_mat_select_selectionChange_4_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.setShiftType($event.value));
    });
    \u0275\u0275elementStart(5, "mat-select-trigger");
    \u0275\u0275conditionalCreate(6, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Conditional_6_Template, 4, 11)(7, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Conditional_7_Template, 4, 11);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_For_9_Template, 5, 12, "mat-option", 15, _forTrack02, true);
    \u0275\u0275conditionalCreate(10, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Conditional_10_Template, 5, 12, "mat-option", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_5_0;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional((tmp_5_0 = ctx_r2.selected_shift_option()) ? 6 : 7, tmp_5_0);
    \u0275\u0275advance(2);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "label", 12);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    const option_r15 = ctx;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 4, "BOOKINGS.PARKING_SHIFT_TYPE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate3(" ", \u0275\u0275pipeBind1(5, 6, option_r15.name), " (", \u0275\u0275pipeBind2(6, 8, ctx_r2.shiftTime(option_r15.start_time), ctx_r2.time_format), " - ", \u0275\u0275pipeBind2(7, 11, ctx_r2.shiftTime(option_r15.end_time), ctx_r2.time_format), ") ");
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 15);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(2, 2, ctx_r2.shiftTime(opt_r17.value), ctx_r2.time_format));
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 15);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(2, 2, ctx_r2.shiftTime(opt_r18.value), ctx_r2.time_format));
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 11)(2, "label", 12);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-form-field", 13)(6, "mat-select", 37);
    \u0275\u0275listener("selectionChange", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_Template_mat_select_selectionChange_6_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.setStartTime($event.value));
    });
    \u0275\u0275repeaterCreate(7, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_For_8_Template, 3, 5, "mat-option", 15, _forTrack2);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "div", 11)(10, "label", 12);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "mat-form-field", 13)(14, "mat-select", 37);
    \u0275\u0275listener("selectionChange", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_Template_mat_select_selectionChange_14_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.setEndTime($event.value));
    });
    \u0275\u0275repeaterCreate(15, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_For_16_Template, 3, 5, "mat-option", 15, _forTrack2);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 4, "BOOKINGS.PARKING_START_TIME"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("value", ctx_r2.start_time_mins());
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.time_options());
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 6, "BOOKINGS.PARKING_END_TIME"), " ");
    \u0275\u0275advance(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "div");
    \u0275\u0275conditionalCreate(2, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Template, 11, 6)(3, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_3_Template, 8, 14);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_4_Template, 17, 8, "div", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.show_shift_select() ? 2 : (tmp_2_0 = ctx_r2.selected_shift_option()) ? 3 : -1, tmp_2_0);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.show_custom_time_inputs() ? 4 : -1);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 19);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41)(1, "icon", 44);
    \u0275\u0275text(2, "desk");
    \u0275\u0275elementEnd()();
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const bld_r20 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getBayInfo(bld_r20), " ");
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_9_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_9_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "icon", 47);
    \u0275\u0275text(3, "car_lock");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(5);
    const percent_r21 = ctx_r2.usage_ratio();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", ctx_r2.spaces_in_use_count(), " of ", ctx_r2.total_space_count(), " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("bg-error", percent_r21 === 1)("text-error-content", percent_r21 === 1)("bg-warning", percent_r21 > 0.5 && percent_r21 < 1)("text-warning-content", percent_r21 > 0.5 && percent_r21 < 1)("bg-success", percent_r21 < 0.5)("text-success-content", percent_r21 < 0.5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 15, percent_r21 * 100, "1.0-0"), "% ");
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 43);
    \u0275\u0275conditionalCreate(1, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_9_Conditional_1_Template, 2, 0, "div", 45)(2, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_9_Conditional_2_Template, 7, 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(4);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 40);
    \u0275\u0275listener("click", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Template_div_click_0_listener() {
      const bld_r20 = \u0275\u0275restoreView(_r19).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.setBuilding(bld_r20));
    });
    \u0275\u0275elementStart(1, "div", 18);
    \u0275\u0275conditionalCreate(2, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_2_Template, 1, 0, "div", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_3_Template, 3, 0, "div", 41);
    \u0275\u0275elementStart(4, "div", 42)(5, "div")(6, "div", 20);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_8_Template, 2, 1, "div", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Conditional_9_Template, 3, 1, "div", 43);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const bld_r20 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("border-info", ctx_r2.building()?.id === bld_r20.id)("border-base-300", ctx_r2.building()?.id !== bld_r20.id);
    \u0275\u0275advance();
    \u0275\u0275classProp("border-info", ctx_r2.building()?.id === bld_r20.id)("border-base-300", ctx_r2.building()?.id !== bld_r20.id);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.building()?.id === bld_r20.id ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.desk_booking_building_id() === bld_r20.id ? 3 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", bld_r20.display_name || bld_r20.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.getBayInfo(bld_r20) ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.building()?.id === bld_r20.id && !ctx_r2.hide_availability_counter() ? 9 : -1);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "h3", 38)(2, "icon", 3);
    \u0275\u0275text(3, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_Conditional_6_Template, 2, 1, "div", 23);
    \u0275\u0275elementStart(7, "div", 5);
    \u0275\u0275repeaterCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Template, 10, 13, "div", 39, _forTrack02, true);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_Conditional_10_Template, 3, 4, "settings-toggle", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.region_name ? 6 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r2.building_list());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r2.hide_prefer_toggle() ? 10 : -1);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_11_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45);
    \u0275\u0275text(1, " Checking... ");
    \u0275\u0275elementEnd();
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_11_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "icon", 47);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(4);
    const percent_r22 = ctx_r2.usage_ratio();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", ctx_r2.spaces_in_use_count() || 0, " of ", ctx_r2.total_space_count() || 0, " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("bg-error", percent_r22 === 1)("text-error-content", percent_r22 === 1)("bg-warning", percent_r22 > 0.5 && percent_r22 < 1)("text-warning-content", percent_r22 > 0.5 && percent_r22 < 1)("bg-success", percent_r22 < 0.5)("text-success-content", percent_r22 < 0.5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 15, percent_r22 * 100, "2.0-0"), "% ");
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 50);
    \u0275\u0275conditionalCreate(1, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_11_Conditional_1_Template, 2, 0, "div", 45)(2, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_11_Conditional_2_Template, 7, 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 49)(7, "div")(8, "div", 20);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_10_Template, 2, 1, "div", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Conditional_11_Template, 3, 1, "div", 50);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function ParkingRequestFormDetailsComponent_Conditional_0_For_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 15);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    const vtype_r23 = ctx.$implicit;
    \u0275\u0275property("value", vtype_r23.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 2, vtype_r23.name));
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_55_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 15);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", option_r24.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 2, option_r24.name));
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "h3", 2)(2, "icon", 3);
    \u0275\u0275text(3, "group");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "mat-form-field", 13)(7, "mat-select", 51);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275repeaterCreate(9, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_55_For_10_Template, 3, 4, "mat-option", 15, _forTrack02, true);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_9_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 15);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", option_r26.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 2, option_r26.name));
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r25 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 13)(1, "mat-select", 37);
    \u0275\u0275listener("selectionChange", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_9_Template_mat_select_selectionChange_1_listener($event) {
      \u0275\u0275restoreView(_r25);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.setSpaceRestriction($event.value));
    });
    \u0275\u0275repeaterCreate(2, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_9_For_3_Template, 3, 4, "mat-option", 15, _forTrack02, true);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r2.selected_space_restriction());
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.space_restriction_options());
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r27 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "settings-toggle", 54);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("ngModelChange", function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_For_2_Template_settings_toggle_ngModelChange_0_listener($event) {
      const option_r28 = \u0275\u0275restoreView(_r27).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.setExtraRestriction(option_r28.id, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(1, 3, option_r28.name))("ngModel", ctx_r2.isExtraRestrictionSelected(option_r28.id))("ngModelOptions", \u0275\u0275pureFunction0(5, _c07));
    \u0275\u0275control();
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275repeaterCreate(1, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_For_2_Template, 2, 6, "settings-toggle", 53, _forTrack02, true);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "h3", 2)(2, "icon", 3);
    \u0275\u0275text(3, "tune");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_9_Template, 4, 1, "mat-form-field", 13);
    \u0275\u0275conditionalCreate(10, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_Template, 3, 0, "div", 52);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 4, "BOOKINGS.PARKING_SPACE_RESTRICTIONS_TITLE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 6, "BOOKINGS.PARKING_SPACE_RESTRICTIONS_DESC"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.space_restriction_options().length ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.extra_space_restriction_options().length ? 10 : -1);
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2)(3, "icon", 3);
    \u0275\u0275text(4, "date_range");
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(7, "a-date-field", 4);
    \u0275\u0275controlCreate();
    \u0275\u0275conditionalCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_8_Template, 22, 31, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 1)(10, "h3", 2)(11, "icon", 3);
    \u0275\u0275text(12, "ballot");
    \u0275\u0275elementEnd();
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "translate");
    ...
    \u0275\u0275repeaterCreate(16, ParkingRequestFormDetailsComponent_Conditional_0_For_17_Template, 12, 16, "div", 6, _forTrack02, true);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_18_Template, 5, 8, "div", 7);
    \u0275\u0275conditionalCreate(19, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_19_Template, 6, 4, "div", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 1)(21, "h3", 2)(22, "icon", 3);
    \u0275\u0275text(23, "schedule");
    \u0275\u0275elementEnd();
    \u0275\u0275text(24);
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(26, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_26_Template, 5, 11, "div", 8)(27, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_27_Template, 4, 4, "div", 8)(28, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Template, 5, 2, "div", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(29, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_Template, 11, 5, "div", 1)(30, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_30_Template, 12, 6, "div", 1);
    \u0275\u0275elementStart(31, "div", 1)(32, "h3", 2)(33, "icon", 3);
    \u0275\u0275text(34, "directions_car");
    \u0275\u0275elementEnd();
    \u0275\u0275text(35);
    \u0275\u0275pipe(36, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 10)(38, "div", 11)(39, "label", 12);
    \u0275\u0275text(40);
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "mat-form-field", 13)(43, "mat-select", 14);
    \u0275\u0275repeaterCreate(44, ParkingRequestFormDetailsComponent_Conditional_0_For_45_Template, 3, 4, "mat-option", 15, _forTrack02, true);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(48);
    \u0275\u0275pipe(49, "translate");
    \u0275\u0275conditionalCreate(50, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_50_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "mat-form-field", 13)(52, "input", 16);
    \u0275\u0275pipe(53, "translate");
    \u0275\u0275listener("ngModelChange", function ParkingRequestFormDetailsComponent_Conditional_0_Template_input_ngModelChange_52_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275conditionalCreate(54, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_54_Template, 3, 3, "mat-error");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(55, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_55_Template, 11, 7, "div", 1);
    \u0275\u0275conditionalCreate(56, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Template, 11, 8, "div", 1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 22, "BOOKINGS.PARKING_BOOKING_FREQUENCY"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r2.form().date)("to", ctx_r2.end_date())("timezone", ctx_r2.timezone);
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.allow_recurrence() ? 8 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 24, "BOOKINGS.PARKING_REQUEST_TYPE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.request_types());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.show_host_select() ? 18 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.show_notes() ? 19 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(25, 26, "BOOKINGS.PARKING_SHIFT_SELECTION"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.forced_request_time()) ? 26 : ctx_r2.is_all_day_forced() ? 27 : 28, tmp_12_0);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r2.hasMultipleBuildings(ctx_r2.building_list()) ? 29 : 30);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(36, 28, "BOOKINGS.PARKING_VEHICLE_DETAILS"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(41, 30, "BOOKINGS.PARKING_VEHICLE_TYPE"), " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(49, 32, "BOOKINGS.PARKING_REGISTRATION"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.require_plate_number() ? 50 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.model().plate_number)("ngModelOptions", \u0275\u0275pureFunction0(36, _c07))("placeholder", \u0275\u0275pipeBind1(53, 34, "BOOKINGS.PARKING_REGISTRATION_PLACEHOLDER"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.showPlateNumberError() ? 54 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.filtered_approver_group_options().length && !ctx_r2.is_auto_approved() ? 55 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.space_restriction_options().length || ctx_r2.extra_space_restriction_options().length ? 56 : -1);
  }
}
...
var ParkingRequestFormDetailsComponent = class _ParkingRequestFormDetailsComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    ...
    runInInjectionContext(this._injector, () => effect(async () => {
      ...
      if (!this.default_location_from_desk_booking() || kn() || id || !date || buildings?.length <= 1) {
    ...
    if (this.space_restriction_options().length) {
      ...
      if (!current || current === true || typeof current === "string" && !this.space_restriction_options().find((_) => _.id === current)) {
  ...
  _applyPreferredShift() {
    ...
    if (this.has_preset_shifts()) {
      const matching_preset = this.shift_options().find((_) => _.start_time === this.start_time_mins() && _.end_time === this.end_time_mins() % 1440);
  ...
  _restoreShiftState(shift) {
    ...
    const preset = shift.type !== CUSTOM_SHIFT_ID && this.shift_options().find((_) => _.id === shift.type) || this.shift_options().find((_) => _.start_time === shift.start_time && _.end_time === shift.end_time % 1440);
    if (preset) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingRequestFormDetailsComponent, selectors: [["parking-request-form-details"]], inputs: { form: [1, "form"], model_input: [1, "model_input"], show_special_needs: [1, "show_special_needs"], force_show_host_select: [1, "force_show_host_select"], force_allow_any_host: [1, "force_allow_any_host"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 1, vars: 1, consts: [[1, "flex", "flex-col", "gap-2", "sm:gap-4"], [1, "border-base-300", "space-y-3", "rounded-lg", "border", "p-4"], [1, "text-info", "flex", "items-center", "gap-2", "text-sm", "font-bold", "tracking-wider", "uppercase"], [1, "text-lg"], [3, "formField", "to", "timezone"], [1, "space-y-2"], [1, "flex", "cursor-pointer", "items-start", "gap-3", "rounded-lg", "border", "p-4", "transition-colors", 3, "border-info", "border-base-300"], [1, "border-base-300", "space-y-3", "border-t", "pt-3"], [1, "border-base-300", "bg-base-200", "rounded-lg", "border", "px-4", "py-3"], [1, "space-y-3"], [1, "flex", "flex-col", "gap-3", "sm:flex-row", "sm:gap-4"], [1, "flex-1"], [1, "mb-1", "block", "text-sm", "font-medium"], ["appearance", "outline", 1, "w-full"], [3, "formField"], [3, "value"], ["matInput", "", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [1, "flex", "cursor-pointer", "items-start", "gap-3", "rounded-lg", "border", "p-4", "transition-colors", 3, "click"], [1, "mt-0.5", "flex", "h-5", "w-5", "shrink-0", "items-center", "justify-center", "rounded-full", "border-2"], [1, "bg-info", "h-2.5", "w-2.5", "rounded-full"], [1, "font-medium"], [1, "text-sm", "opacity-60"], [1, "border-base-300", "mt-3", "space-y-3", "rounded-lg", "border", "p-3"], [1, "text-sm", "font-medium"], [1, "flex", "gap-2"], ["type", "button", 1, "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", "border-2", "text-sm", "font-medium", "transition-colors", 3, "border-info", "bg-info", "text-info-content", "border-base-300"], [1, "space-y-1"], [1, "flex", "items-center", "gap-2", "text-sm"], ["type", "button", 1, "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", "border-2", "text-sm", "font-medium", "transition-colors", 3, "click"], ["type", "button", 1, "flex", "h-10", "min-w-10", "items-center", "justify-center", "rounded-full", "border-2", "px-3", "text-sm", "font-medium", "transition-colors", 3, "border-info", "bg-info", "text-info-content", "border-base-300"], ["type", "button", 1, "flex", "h-10", "min-w-10", "items-center", "justify-center", "rounded-full", "border-2", "px-3", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "bg-success", "h-2", "w-2", "rounded-full"], [1, "flex", "items-center", "gap-2"], [1, "bg-base-200", "rounded", "px-2", "py-0.5", "text-xs"], [3, "formField", "guests", "guests_only", "disable_search", "allow_externals"], ["matInput", "", "rows", "3", 3, "formField"], [1, "flex", "gap-4"], [3, "selectionChange", "value"], [1, "text-success", "flex", "items-center", "gap-2", "text-sm", "font-bold", "tracking-wider", "uppercase"], [1, "flex", "min-h-15", "cursor-pointer", "items-center", "gap-3", "rounded-lg", "border", "px-4", "py-2", "transition-colors", 3, "border-info", "border-base-300"], [1, "flex", "min-h-15", "cursor-pointer", "items-center", "gap-3", "rounded-lg", "border", "px-4", "py-2", "transition-colors", 3, "click"], ["matTooltip", "Matched to desk booking", 1, "bg-info", "text-info-content", "flex", "h-6", "w-6", "shrink-0", "items-center", "justify-center", "rounded-full"], [1, "flex", "flex-1", "items-center", "justify-between", "gap-3"], [1, "border-base-300", "flex", "shrink-0", "items-center", "space-x-2", "rounded-md", "border", "py-1", "pr-1", "pl-3", "text-sm"], [1, "text-base!"], [1, "text-sm", "font-medium", "opacity-60"], [1, "flex", "items-center"], [1, "ml-1!", "text-lg"], [1, "rounded-sm", "px-2", "py-1", "font-mono", "text-xs"], [1, "flex", "items-center", "justify-between", "gap-3"], [1, "border-base-300", "mr-2", "flex", "shrink-0", "items-center", "space-x-2", "rounded-md", "border", "py-1", "pr-1", "pl-3", "text-sm"], [3, "formField", "placeholder"], [1, "flex", "flex-col", "gap-2"], [3, "label", "ngModel", "ngModelOptions"], [3, "ngModelChange", "label", "ngModel", "ngModelOptions"]], template: function ParkingRequestFormDetailsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, ParkingRequestFormDetailsComponent_Conditional_0_Template, 57, 37, "div", 0);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingRequestFormDetailsComponent, { className: "ParkingRequestFormDetailsComponent", filePath: "apps/workplace/src/app/book/parking-request-flow/parking-request-form-details.component.ts", lineNumber: 1147 });
})();

// apps/concierge/src/app/parking/parking-request-modal.component.ts
function ParkingRequestModalComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
...
var ParkingRequestModalComponent = class _ParkingRequestModalComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingRequestModalComponent, selectors: [["parking-request-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 31, vars: 28, consts: [[3, "confirm", "heading", "loading"], [1, "mx-auto", "-mb-4", "w-[80rem]", "max-w-full", "space-y-4"], [1, "border-base-300", "bg-base-100", "flex", "w-full", "flex-col", "overflow-hidden", "rounded-xl", "border"], [1, "gradient", "border-base-content", "relative", "flex", "items-center", "space-x-2", "border-l-8", "px-4", "py-3", "text-xl", "font-medium"], [1, "px-6", "py-4"], [1, "opacity-60"], [3, "form", "model_input", "show_special_needs", "force_show_host_select", "force_allow_any_host"], [1, "gradient", "border-base-content", "flex", "items-center", "space-x-2", "border-l-8", "px-4", "py-3", "font-medium"], [1, "space-y-4", "p-4"], [1, "bg-base-200", "border-base-300", "flex", "items-start", "gap-3", "rounded-lg", "border", "p-4"], [1, "text-warning", "mt-0.5", "shrink-0", "text-xl"], [1, "text-sm", 3, "innerHTML"], [1, "border-base-300", "bg-base-100", "rounded-xl", "border", "p-4"], [1, "prose", "prose-sm", "max-w-none", 3, "innerHTML"]], template: function ParkingRequestModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
        \u0275\u0275pipe(1, "translate");
        \u0275\u0275pipe(2, "translate");
        ...
        \u0275\u0275elementStart(18, "div", 7)(19, "icon");
        \u0275\u0275text(20, "info");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(23, "translate");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(24, "div", 8)(25, "div", 9)(26, "icon", 10);
        \u0275\u0275text(27, "campaign");
        \u0275\u0275elementEnd();
        \u0275\u0275element(28, "p", 11);
        \u0275\u0275pipe(29, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275conditionalCreate(30, ParkingRequestModalComponent_Conditional_30_Template, 3, 3, "div", 12);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275property("heading", ctx.model().id ? \u0275\u0275pipeBind1(1, 12, "APP.CONCIERGE.PARKING_REQUEST_EDIT") : \u0275\u0275pipeBind1(2, 14, "APP.CONCIERGE.PARKING_REQUEST_NEW"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(3, 16, "COMMON.SAVING") : "");
        \u0275\u0275advance(10);
        \u0275\u0275textInterpolate1(" ", ctx.model().id ? \u0275\u0275pipeBind1(11, 18, "APP.CONCIERGE.PARKING_REQUEST_EDIT") : \u0275\u0275pipeBind1(12, 20, "BOOKINGS.PARKING_REQUEST_TITLE"), " ");
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 22, "BOOKINGS.PARKING_REQUEST_SUBTITLE"), " ");
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 24, "BOOKINGS.PARKING_SUMMARY_TITLE"), " ");
        \u0275\u0275advance(6);
        \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(29, 26, "BOOKINGS.PARKING_ALLOCATION_INFO"), \u0275\u0275sanitizeHtml);
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.submission_notes_html() ? 30 : -1);
      }
    }, dependencies: [
      FullscreenModalShellComponent,
      IconComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingRequestModalComponent, { className: "ParkingRequestModalComponent", filePath: "apps/concierge/src/app/parking/parking-request-modal.component.ts", lineNumber: 136 });
})();
...
function ParkingUserModalComponent_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(27, 29, "EXPLORE.PARKING_PLATE_NUMBER"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.plate_number)("placeholder", \u0275\u0275pipeBind1(30, 31, "EXPLORE.PARKING_PLATE_NUMBER"));
    \u0275\u0275control();
    \u0275\u0275advance(4);
...
var ParkingStateService = class _ParkingStateService extends AsyncHandler {
  ...
  constructor() {
    ...
    this._spaces_params = computed(() => {
      ...
      const zone_ids = options.zones.length ? options.zones : levels[0]?.id ? [levels[0].id] : [];
    ...
    this.bookings = linkedSignal(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "bookings" } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.loading = computed(
      () => {
        ...
        if (this._fleet_resource.isLoading())
          list.push("fleet");
        if (this._bookings_resource.isLoading())
          list.push("[BOOKINGS]");
        return list;
      },
      ...ngDevMode ? [{ debugName: "loading" }] : (
  ...
  isManualRequest(booking) {
    return !!booking.extension_data?.requires_manual_approval || this.isRequest(booking) && !!booking.extension_data?.approver_group;
  }
  isWaitlisted(booking) {
    if (!this.isRequest(booking) || booking.status !== "tentative" || booking.process_state === "waiting_approval") {
      return false;
    }
    const now = Date.now();
    ...
    return booking.date >= current_week_start && booking.date <= current_week_end;
  }
  ...
  startPolling(delay = 3 * MINUTES) {
    ...
    this._bookings_resource.reload();
    this.interval("poll", () => this._bookings_resource.reload(), poll_delay);
  ...
  async uploadSpacesCSV(event) {
    ...
    try {
      ...
      const zone_id = this._options().zones[0] || this._org.levelsForBuilding()[0]?.id;
      if (!zone_id) {
      ...
      for (const row of rows) {
        try {
          const space_data = __spreadValues(__spreadProps(__spreadValues({}, row.id ? { id: row.id } : {}), {
            identifier: row.identifier || "",
            map_id: row.map_id || "",
            assigned_to: row.assigned_to || "",
            assigned_name: row.assigned_name || "",
            bookable: row.bookable === true || row.bookable === "true" || row.bookable === "TRUE",
  ...
  async editSpace(space = {}) {
    ...
    if (state?.reason !== "done")
      return;
    const zone_id = this._options().zones[0] || space.zone_id || this._org.levelsForBuilding()[0]?.id;
    ...
    const original_space_data = __spreadProps(__spreadValues({}, space), {
    ...
    const saved = await saveParkingSpace(__spreadProps(__spreadValues({}, asset_data), {
      zones
    })).catch((e) => {
      notifyError(i18n("APP.CONCIERGE.PARKING_ASSIGN_SPACE_ERROR", {
        error: e
  ...
  async setBookingCheckinState(booking, state = true) {
    const promise = (booking.instance ? checkinBookingInstance(booking.id, booking.instance, state) : checkinBooking(booking.id, state)).catch((_) => ({ state: "failed", error: _ }));
  ...
  async _checkAssignedParkingLimit(user_email, current_space_id) {
    ...
    if (assigned_count >= max_assigned_count) {
      const key = max_assigned_count === 1 ? "APP.CONCIERGE.PARKING_ASSIGN_LIMIT_ERROR_1" : "APP.CONCIERGE.PARKING_ASSIGN_LIMIT_ERROR_N";
...
//# sourceMappingURL=chunk-ZUOILJB2.js.map
