...
} from "./chunk-AEOLOWZA.js";
import {
  MediaThumbnailComponent
} from "./chunk-FIT4JK4N.js";
import {
...
function TemplateEditModalComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, TemplateEditModalComponent_Conditional_28_Conditional_6_Template, 2, 1, "div", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
var TemplateEditModalComponent = class _TemplateEditModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TemplateEditModalComponent, selectors: [["template-edit-modal"]], decls: 39, vars: 43, consts: [["confirm_hotkey", "S", 3, "confirm", "heading", "loading"], ["for", "name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", 3, "placeholder", "formField"], ["for", "description"], ["matInput", "", 1, "min-h-32", 3, "placeholder", "formField"], [1, "mb-4"], [1, "mb-1"], [1, "border-base-300", "flex", "flex-wrap", "items-center", "gap-3", "rounded-lg", "border", "p-3"], [1, "ml-auto", "flex", "shrink-0", "items-center", "gap-1"], ["type", "button", "matRipple", "", 1, "hover:bg-base-200", "rounded", "px-3", "py-2", "text-sm", "font-medium", 3, "click"], ["icon", "", "type", "button", "matRipple", "", 1, "text-error"], ["info", "When selected, takeover content will hide the template and takeover the entire screen", 3, "label", "formField"], ["type", "templates", 3, "item_id", "group_id"], ["auth", "", 1, "bg-base-200", "h-16", "w-24", "shrink-0", "rounded", "object-cover", 3, "source", "alt"], [1, "min-w-32", "flex-1"], [1, "truncate", "font-medium"], [1, "text-base-content/70", "text-xs", "capitalize"], [1, "bg-base-200", "flex", "h-16", "w-24", "shrink-0", "items-center", "justify-center", "rounded"], [1, "text-base-content/40", "text-3xl"], [1, "text-base-content/70", "min-w-32", "flex-1"], ["icon", "", "type", "button", "matRipple", "", 1, "text-error", 3, "click"]], template: function TemplateEditModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        \u0275\u0275element(38, "signage-shared-with", 14);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 19, ctx.template.id ? "SIGNAGE_MANAGER.TEMPLATE_EDIT" : "SIGNAGE_MANAGER.NEW_TEMPLATE"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 21, "SIGNAGE_MANAGER.TEMPLATE_SAVING") : "");
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 23, "FORM.NAME"));
        \u0275\u0275advance(5);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(11, 25, "FORM.NAME"))("formField", ctx.form.name);
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(12, 27, "SIGNAGE_MANAGER.TEMPLATE_NAME_ARIA"));
        \u0275\u0275control();
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(15, 29, "FORM.NAME_REQUIRED"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 31, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(21, 33, "COMMON.DESCRIPTION"))("formField", ctx.form.description);
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(22, 35, "SIGNAGE_MANAGER.TEMPLATE_DESCRIPTION_ARIA"));
        \u0275\u0275control();
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(26, 37, "SIGNAGE_MANAGER.TEMPLATE_BACKGROUND"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.model().background_item_id ? 28 : 29);
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(33, 39, ctx.model().background_item_id ? "COMMON.CHANGE" : "SIGNAGE_MANAGER.TEMPLATE_BACKGROUND_SELECT"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.model().background_item_id ? 34 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("label", \u0275\u0275pipeBind1(37, 41, "SIGNAGE_MANAGER.TEMPLATE_FULLSCREEN_TAKEOVER"))("formField", ctx.form.full_screen_takeover);
        \u0275\u0275control();
        \u0275\u0275advance(2);
...
//# debugId=80c45b8d-b538-5429-800f-b8e96042f0bd
//# sourceMappingURL=template-edit-modal.component-HUKCZP4D.js.map
