...
var ZoneHeaderComponent = class _ZoneHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneHeaderComponent, selectors: [["zone-header"]], decls: 12, vars: 11, consts: [[1, "bg-base-100", "border-base-300", "sticky", "top-0", "flex", "flex-wrap", "items-center", "gap-2", "border-b", "px-4", "py-2", "shadow", "sm:flex-nowrap"], [1, "py-2"], [1, "text-2xl", "font-medium"], [1, "flex", "flex-wrap", "items-center", "gap-2"], [1, "text-sm", "opacity-60"], [1, "w-px", "flex-1"], ["icon", "", "default", "", "type", "button", "matRipple", "", 1, "text-xl", 3, "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"]], template: function ZoneHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275element(10, "div", 5);
        \u0275\u0275conditionalCreate(11, ZoneHeaderComponent_Conditional_11_Template, 5, 6, "button", 6);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneHeaderComponent, { className: "ZoneHeaderComponent", filePath: "apps/signage-manager/src/app/zones/zone-header.component.ts", lineNumber: 57 });
})();
...
var ZonesSectionComponent = class _ZonesSectionComponent {
  constructor() {
    ...
    this._template_mappings = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_template_mappings" } : (
      ...
      loader: ({ params }) => this._service.listTemplateMappings({ zone_id: params.id })
    }));
    this.template_count_loading = this._template_mappings.isLoading;
    this.playlist_count_loading = this._service.playlists_loading;
    this.display_count_loading = this._service.displays_loading;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZonesSectionComponent, { className: "ZonesSectionComponent", filePath: "apps/signage-manager/src/app/zones/zones.component.ts", lineNumber: 288 });
})();
export {
  ZonesSectionComponent
};
//# debugId=6e417ec4-5929-5975-b5c5-672508a0309a
//# sourceMappingURL=zones.component-2F2YV2ER.js.map
