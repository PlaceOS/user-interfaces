...
var BookingFormService = class _BookingFormService extends AsyncHandler {
  ...
  newForm(type, booking = new Booking({})) {
    ...
    this.form().reset();
    this._patch(Vs(__spreadValues(__spreadProps(__spreadValues({}, booking.extension_data), {
      attachments: bookingAttachments(booking)
    }), booking), [null, void 0, ""]), { emitEvent: false });
...
//# sourceMappingURL=chunk-UEHTNZVE.js.map
