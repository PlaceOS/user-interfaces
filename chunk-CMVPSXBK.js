...
var _ParkingStateService = class _ParkingStateService extends AsyncHandler {
  constructor() {
    ...
    this.spaces = combineLatest([
      ...
      return Pu(options.zones[0] || levels[0]?.id, "parking-spaces").pipe(map(({ details }) => (details instanceof Array ? details : []).map((space) => __spreadProps(__spreadValues({}, space), {
...
//# sourceMappingURL=chunk-CMVPSXBK.js.map
