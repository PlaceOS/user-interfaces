...
function DeskModalComponent_Conditional_6_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "icon", 33);
    \u0275\u0275text(2, "warning");
    \u0275\u0275elementEnd();
...
function DeskModalComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(67, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "mat-form-field", 30);
    \u0275\u0275element(69, "textarea", 31);
    \u0275\u0275pipe(70, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(73, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(74, "mat-form-field", 10);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 29, "APP.CONCIERGE.DESKS_ID"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("formField", ctx_r1.form.id);
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 31, "FORM.ID_REQUIRED"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 33, "APP.CONCIERGE.DESKS_NAME"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("formField", ctx_r1.form.name);
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 35, "FORM.NAME_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(27, 37, "EXPLORE.MAP_ID"));
    \u0275\u0275advance(6);
    \u0275\u0275property("formField", ctx_r1.form.map_id)("placeholder", \u0275\u0275pipeBind1(33, 39, "APP.CONCIERGE.DESKS_MAP_ID_PLACEHOLDER"));
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(36, 41, "EXPLORE.MAP_ID_REQUIRED"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(38, 43, "APP.CONCIERGE.POI_MAP_SELECT"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 45, "APP.CONCIERGE.USER_ASSIGNED"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.assigned_user);
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(47, 47, "APP.CONCIERGE.USER_CLEAR"));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.future_bookings().length ? 50 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r1.form.bookable)("label", \u0275\u0275pipeBind1(53, 49, "COMMON.BOOKABLE"));
    \u0275\u0275control();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 51, "COMMON.GROUPS"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(59, 53, "BOOKINGS.GROUPS"))("formField", ctx_r1.form.groups);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(62, 55, "COMMON.FEATURES"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(64, 57, "COMMON.FEATURES"))("formField", ctx_r1.form.features);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(67, 59, "FORM.NOTES"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(70, 61, "FORM.NOTES"))("formField", ctx_r1.form.notes);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(73, 63, "APP.CONCIERGE.DESKS_SECURITY"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(76, 65, "APP.CONCIERGE.DESKS_SECURITY"))("formField", ctx_r1.form.security);
    \u0275\u0275control();
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskModalComponent, selectors: [["desk-modal"]], outputs: { event: "event" }, decls: 12, vars: 8, consts: [[1, "w-lg"], [1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "flex-col", "overflow-auto", "p-4"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "border-base-300", "flex", "items-center", "justify-end", "space-x-2", "border-t", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "w-full"], ["for", "id"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "placeholder", "desk-10.123", 3, "formField"], [1, "flex", "space-x-2"], [1, "w-1/3", "flex-1"], ["for", "name"], ["matInput", "", "placeholder", "e.g. Office Desk", 3, "formField"], ["for", "map-id"], ["matInput", "", 3, "formField", "placeholder"], ["icon", "", "matRipple", "", 1, "border-secondary", "text-secondary", "h-12", "w-12", "min-w-12", "rounded-sm", "border", 3, "click", "matTooltip"], ["for", "user"], [1, "mb-4", "flex", "space-x-2"], [1, "flex-1", 3, "formField"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "min-w-12", "rounded-sm", 3, "click", "matTooltip"], ["className", "material-symbols-outlined"], [1, "bg-warning/10", "border-warning", "text-warning-content", "mb-4", "flex", "items-start", "space-x-2", "rounded-sm", "border", "p-2", "text-sm"], [1, "flex", "space-x-4", "pb-4"], [1, "flex-1", 3, "formField", "label"], [1, "flex-1"], ["for", "notes"], [1, "w-full", 3, "placeholder", "formField"], ["appearance", "outline"], ["matInput", "", 3, "placeholder", "formField"], ["for", "security"], [1, "text-warning"], ["diameter", "32"]], template: function DeskModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(6, DeskModalComponent_Conditional_6_Template, 77, 67, "main", 4)(7, DeskModalComponent_Conditional_7_Template, 5, 3, "main", 5);
...
var DesksStateService = class _DesksStateService extends AsyncHandler {
      ...
      loader: async ({ params }) => {
        ...
        try {
          ...
          if (zones && !zones.includes("All")) {
            const metadata = await ju(zones[0], "desks").catch(() => ({ details: [] }));
            list = metadata.details instanceof Array ? metadata.details : [];
          } else {
            const metadata = await Qu(this._org.building?.id, { name: "desks" }).catch(() => []);
            list = metadata.map((i) => i.metadata?.desks?.details || []).reduce((c, i) => [...c, ...i], []);
          }
  ...
  async editDesk(desk = new Desk()) {
    ...
    if ((desk.assigned_to !== new_desk.assigned_to || recreate) && new_desk.assigned_to) {
      const created = await saveBooking(this._createAssignedBooking(new_desk, zone)).catch(async (e) => {
        await this._rollbackMetadata(zone, original_desk_list);
        if (recreate) {
  ...
  async checkinDesk(desk, state = true) {
    const status = await checkinBooking(desk.id, state ?? true).catch((_) => ({ failed: true, error: _ }));
    if (status.failed) {
  ...
  async giveAccess(desk) {
    const status = await saveBooking(new Booking(__spreadProps(__spreadValues({}, desk), { access: true }))).catch((_) => ({ failed: true, error: _ }));
    if (status.failed) {
  ...
  async _checkAssignedDeskLimit(user_email, current_desk_id) {
    ...
    const assigned_count = (await Promise.all(this._currentLevelList().map((level) => ju(level.id, "desks").then((metadata) => metadata.details instanceof Array ? metadata.details : []).catch(() => [])))).flat().filter((item) => item.id !== current_desk_id && item.assigned_to?.toLowerCase() === email).length;
...
//# sourceMappingURL=chunk-YWSA2UWG.js.map
