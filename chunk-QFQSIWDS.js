...
var _DesksStateService = class _DesksStateService extends AsyncHandler {
  ...
  constructor() {
    ...
    this._desks$ = combineLatest([
      ...
      const fetch$ = zones && !zones.includes("All") ? Xu(zones[0], "desks").pipe(map((m) => m.details instanceof Array ? m.details : []), catchError((_) => of([]))) : rc(this._org.building?.id, {
        name: "desks"
...
//# sourceMappingURL=chunk-QFQSIWDS.js.map
