...
var AssetBulkFormComponent = class _AssetBulkFormComponent extends AsyncHandler {
  ...
  async save() {
    ...
    const data = this.model();
    const list = await Wl(new Array(this.count()).fill(__spreadProps(__spreadValues({}, data), {
      zone_id: this._org.building.id
    }))).catch((e) => {
      this.loading.set("");
...
//# sourceMappingURL=asset-manager.routes-N2WAXSJK.js.map
