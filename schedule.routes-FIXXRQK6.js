...
import {
  ...
  isSameMonth,
  startOfMonth
} from "./chunk-4GSI6CJH.js";
import {
  MatProgressBar,
  MatProgressBarModule
} from "./chunk-RE3MIBBE.js";
import {
  FooterMenuComponent,
...
import {
  ParkingService
} from "./chunk-IXWAVADF.js";
import "./chunk-H55RKZH4.js";
import {
  SettingsToggleComponent
} from "./chunk-EN6Z4G45.js";
import {
  MatCheckboxModule,
  MatTooltip,
  MatTooltipModule,
...
function ScheduleListViewComponent_Conditional_0_For_1_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ScheduleListViewComponent_Conditional_0_For_1_For_5_Conditional_0_Template, 1, 3, "event-card", 2)(1, ScheduleListViewComponent_Conditional_0_For_1_For_5_Conditional_1_Template, 1, 5, "booking-card", 3);
  }
  if (rf & 2) {
...
var ScheduleListViewComponent = class _ScheduleListViewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleListViewComponent, selectors: [["schedule-list-view"]], inputs: { date: [1, "date"], end_date: [1, "end_date"], bookings: [1, "bookings"], loading: [1, "loading"] }, decls: 2, vars: 1, consts: [[1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "p-8"], [1, "mb-2", "font-medium"], [3, "event", "edit_fn", "remove_fn"], [3, "booking", "edit_fn", "remove_fn", "end_fn", "refresh_fn"], ["src", "assets/img/no-events.svg", 1, "mr-4"], [1, "opacity-30"]], template: function ScheduleListViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleListViewComponent, { className: "ScheduleListViewComponent", filePath: "apps/workplace/src/app/schedule/schedule-list-view.component.ts", lineNumber: 72 });
})();
...
//# sourceMappingURL=schedule.routes-FIXXRQK6.js.map
