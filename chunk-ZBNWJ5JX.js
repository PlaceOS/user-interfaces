...
_BookingRulesModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingRulesModalComponent, selectors: [["app-booking-rules-modal"]], decls: 22, vars: 18, consts: [["index_template", ""], ["conditions_template", ""], ["zone_template", ""], ["bool_template", ""], ["actions_template", ""], [3, "heading", "loading", "hide_confirm", "full_width"], [1, "-mx-2", "mb-2", "w-[calc(100%+1rem)]", "rounded-sm", "bg-info", "p-4", "text-center", "text-xs", "text-info-content"], [3, "ngSwitch"], [3, "ruleset", "save", "rulesetChange", 4, "ngSwitchCase"], [1, "-mx-2", "w-[calc(100%+1rem)]", "overflow-auto"], ["class", "block w-full min-w-3xl text-sm", 3, "data", "columns", 4, "ngSwitchCase"], ["class", "fixed bottom-0 left-1/2 z-10 mx-auto my-2 flex w-[calc(100%-1rem)] -translate-x-1/2 items-center justify-end space-x-4 rounded-sm border-none bg-base-200 px-4 py-2", 3, "max-w-156", 4, "ngIf"], [3, "rulesetChange", "ruleset", "save"], [1, "block", "w-full", "min-w-3xl", "text-sm", 3, "data", "columns"], [1, "m-auto", "p-4", "font-medium"], [1, "p-4"], ["class", "px-4 py-2", 4, "ngIf"], ["class", "px-4 py-2 font-mono italic", 4, "ngIf"], [1, "px-4", "py-2"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "px-4", "py-2", "font-mono", "italic"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", "text-white"], [1, "mx-auto", "flex", "w-full", "flex-col", "items-center", "justify-center", "gap-1", "p-1"], [1, "flex", "items-center", "gap-1"], ["icon", "", "matRipple", "", 1, "rounded-sm", 3, "click", "matTooltip"], [1, "text-error"], [1, "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "-translate-x-1/2", "items-center", "justify-end", "space-x-4", "rounded-sm", "border-none", "bg-base-200", "px-4", "py-2"], ["btn", "", "matRipple", "", "class", "inverse w-36", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "class", "w-36", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "inverse", "w-36", 3, "click"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click"]], template: function BookingRulesModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-ZBNWJ5JX.js.map
