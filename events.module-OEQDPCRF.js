import {
  ...
  generateFinancePdf
} from "./chunk-T32PCEWU.js";
import "./chunk-DPLZHTJT.js";
import {
  subMonths
} from "./chunk-YNMPDG4X.js";
import {
  ...
  ROLE_DISPLAY_NAMES,
  ROLE_PERMISSIONS
} from "./chunk-47QBGJE6.js";
import "./chunk-2A4T7TVG.js";
...
function EventRequestWizardComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(32, EventRequestWizardComponent_Conditional_11_For_33_Template, 2, 2, "mat-option", 28, _forTrack1);
    \u0275\u0275elementEnd()()()();
...
function EventRequestWizardComponent_Conditional_13_Conditional_21_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51)(1, "icon", 52);
    \u0275\u0275text(2, "schedule");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r2.getCategoryName(svc_r13));
  }
}
function EventRequestWizardComponent_Conditional_13_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, EventRequestWizardComponent_Conditional_13_Conditional_21_For_5_Template, 7, 1, "div", 51, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function EventRequestWizardComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "mat-form-field", 20);
    \u0275\u0275element(11, "input", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 29)(13, "mat-checkbox", 27);
    \u0275\u0275text(14, " Outdoor Event ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-checkbox", 27);
    \u0275\u0275text(16, " Major Event ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "label", 18);
    \u0275\u0275text(18, "Special Requirements");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 20);
    \u0275\u0275element(20, "textarea", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(21, EventRequestWizardComponent_Conditional_13_Conditional_21_Template, 6, 0, "div", 46);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function EventRequestWizardComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Documents");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 54)(4, "icon", 55);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 61)(18, "div", 62)(19, "span", 63);
    \u0275\u0275text(20, "Title");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "span", 64);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 62)(24, "span", 63);
    \u0275\u0275text(25, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "span");
    \u0275\u0275text(27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 62)(29, "span", 63);
    \u0275\u0275text(30, "Duration");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 62)(39, "span", 63);
    \u0275\u0275text(40, "Organizer");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "span");
    \u0275\u0275text(42);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(43, EventRequestWizardComponent_Conditional_14_Conditional_43_Template, 5, 1, "div", 62);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
_EventRequestWizardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventRequestWizardComponent, selectors: [["app-event-request-wizard"]], decls: 21, vars: 8, consts: [["locationAuto", "matAutocomplete"], [1, "bg-base-100", "absolute", "inset-0", "overflow-auto"], [1, "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[720px]", "items-center", "justify-between", "rounded-sm", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "mx-auto", "my-4", "flex", "w-full", "max-w-[720px]", "items-center", "justify-center", "px-4"], [1, "mx-auto", "flex", "w-full", "max-w-[720px]", "flex-col", "px-4", "pb-24"], [1, "flex", "flex-col", "space-y-4"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[720px]", "-translate-x-1/2", "items-center", "justify-between", "rounded-sm", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "inverse"], ["btn", "", "matRipple", "", 3, "disabled"], [1, "mx-1", "h-0.5", "w-12", 3, "bg-primary", "bg-base-300"], ["matRipple", "", 1, "flex", "flex-col", "items-center", 3, "click", "disabled"], [1, "flex", "h-9", "w-9", "items-center", "justify-center", "rounded-full", "text-sm", "font-medium", "transition-colors"], [1, "text-lg"], [1, "mt-1", "text-xs"], [1, "mx-1", "h-0.5", "w-12"], [1, "text-lg", "font-medium"], [1, "text-sm", "font-medium"], [1, "text-error"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "placeholder", "e.g. Annual Awards Night", 3, "formControl"], [1, "flex", "flex-wrap", "gap-4"], [1, "min-w-[200px]", "flex-1"], ["matInput", "", "type", "date", 3, "formControl"], [1, "min-w-[140px]", "flex-1"], ["matInput", "", "type", "time", 3, "formControl"], [3, "formControl"], [3, "value"], [1, "flex", "gap-4"], ["matRipple", "", 1, "flex", "flex-1", "flex-col", "items-center", "rounded-lg", "border-2", "p-4", "transition-colors", 3, "border-primary", "bg-base-200", "border-base-300"], ["matInput", "", "placeholder", "Start typing a venue name...", 3, "input", "formControl", "matAutocomplete"], [3, "optionSelected"], ["matInput", "", "rows", "3", "placeholder", "Describe your event...", 3, "formControl"], ["matRipple", "", 1, "flex", "flex-1", "flex-col", "items-center", "rounded-lg", "border-2", "p-4", "transition-colors", 3, "click"], [1, "mb-2", "text-3xl"], [1, "mt-1", "text-center", "text-xs", "opacity-60"], [1, "flex", "flex-col", "py-1"], [1, "text-xs", "opacity-60"], ["matInput", "", "placeholder", "e.g. Sarah Chen", 3, "formControl"], ["matInput", "", "type", "email", "placeholder", "e.g. sarah.chen@ucla.edu", 3, "formControl"], ["matInput", "", "type", "tel", "placeholder", "e.g. +61 400 000 000", 3, "formControl"], [1, "flex", "flex-col", "space-y-2", "rounded-lg", "border", "border-base-300", "p-4"], [3, "checked"], ["matInput", "", "type", "number", "placeholder", "e.g. 150", 3, "formControl"], ["matInput", "", "rows", "3", "placeholder", "Any special requirements or notes...", 3, "formControl"], [1, "rounded-lg", "border", "border-base-300", "bg-base-200", "p-4"], [3, "change", "checked"], [1, "flex", "items-center", "space-x-2"], [1, "mb-2", "text-sm", "font-medium", "opacity-70"], [1, "space-y-1"], [1, "flex", "items-center", "space-x-2", "text-sm"], [1, "text-warning", "text-base"], [1, "text-xs", "opacity-50"], [1, "flex", "flex-col", "items-center", "justify-center", "rounded-lg", "border-2", "border-dashed", "border-base-300", "p-8", "transition-colors", "hover:border-primary"], [1, "mb-2", "text-4xl", "opacity-40"], [1, "mt-1", "text-xs", "opacity-50"], ["btn", "", "matRipple", "", 1, "inverse", "mt-4", "text-sm"], [1, "text-xs", "italic", "opacity-40"], [1, "mt-4", "rounded-lg", "border", "border-base-300", "bg-base-200", "p-4"], [1, "mb-3", "text-sm", "font-medium"], [1, "space-y-2", "text-sm"], [1, "flex", "justify-between"], [1, "opacity-60"], [1, "font-medium"], ["btn", "", "matRipple", "", 1, "inverse", 3, "click"], [1, "text-xl"], [1, "ml-1"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [1, "mr-1"], [1, "mr-1", "text-xl"]], template: function EventRequestWizardComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(13, EventRequestWizardComponent_Conditional_13_Template, 22, 5, "section", 7);
    \u0275\u0275conditionalCreate(14, EventRequestWizardComponent_Conditional_14_Template, 44, 6, "section", 7);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventRequestWizardComponent, { className: "EventRequestWizardComponent", filePath: "apps/concierge/src/app/events/event-request-wizard.component.ts", lineNumber: 819 });
})();
...
var _c9 = (a0) => ({ key: "actions", name: " ", content: a0, size: "4rem", sortable: false });
var _c10 = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => [a0, a1, a2, a3, a4, a5, a6, a7, a8, a9];
var _c11 = (a0) => ["/entertainment", "events", "manage", a0];
...
function EventListingComponent_ng_template_8_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 24)(1, "icon", 28);
    \u0275\u0275text(2, "done");
    \u0275\u0275elementEnd()();
  }
}
function EventListingComponent_ng_template_8_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 25)(1, "icon", 28);
    \u0275\u0275text(2, "close");
    \u0275\u0275elementEnd()();
  }
}
function EventListingComponent_ng_template_8_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 26)(1, "icon", 28);
    \u0275\u0275text(2, "schedule");
    \u0275\u0275elementEnd()();
  }
}
...
function EventListingComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, EventListingComponent_ng_template_8_Case_1_Template, 3, 0, "span", 24)(2, EventListingComponent_ng_template_8_Case_2_Template, 3, 0, "span", 25)(3, EventListingComponent_ng_template_8_Case_3_Template, 3, 0, "span", 26)(4, EventListingComponent_ng_template_8_Case_4_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.reqStatus(item_r5, "venue")) === "approved" ? 1 : tmp_12_0 === "declined" ? 2 : tmp_12_0 === "pending" ? 3 : 4);
  }
}
...
function EventListingComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275conditionalCreate(1, EventListingComponent_ng_template_10_Case_1_Template, 3, 0, "span", 24)(2, EventListingComponent_ng_template_10_Case_2_Template, 3, 0, "span", 25)(3, EventListingComponent_ng_template_10_Case_3_Template, 3, 0, "span", 26)(4, EventListingComponent_ng_template_10_Case_4_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.reqStatus(item_r6, "dining")) === "approved" ? 1 : tmp_12_0 === "declined" ? 2 : tmp_12_0 === "pending" ? 3 : 4);
  }
}
...
function EventListingComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275conditionalCreate(1, EventListingComponent_ng_template_12_Case_1_Template, 3, 0, "span", 24)(2, EventListingComponent_ng_template_12_Case_2_Template, 3, 0, "span", 25)(3, EventListingComponent_ng_template_12_Case_3_Template, 3, 0, "span", 26)(4, EventListingComponent_ng_template_12_Case_4_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.reqStatus(item_r7, "av_tech")) === "approved" ? 1 : tmp_12_0 === "declined" ? 2 : tmp_12_0 === "pending" ? 3 : 4);
  }
}
...
function EventListingComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275conditionalCreate(1, EventListingComponent_ng_template_14_Case_1_Template, 3, 0, "span", 24)(2, EventListingComponent_ng_template_14_Case_2_Template, 3, 0, "span", 25)(3, EventListingComponent_ng_template_14_Case_3_Template, 3, 0, "span", 26)(4, EventListingComponent_ng_template_14_Case_4_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.reqStatus(item_r8, "safety")) === "approved" ? 1 : tmp_12_0 === "declined" ? 2 : tmp_12_0 === "pending" ? 3 : 4);
  }
}
...
function EventListingComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275conditionalCreate(1, EventListingComponent_ng_template_16_Case_1_Template, 3, 0, "span", 24)(2, EventListingComponent_ng_template_16_Case_2_Template, 3, 0, "span", 25)(3, EventListingComponent_ng_template_16_Case_3_Template, 3, 0, "span", 26)(4, EventListingComponent_ng_template_16_Case_4_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.reqStatus(item_r9, "events")) === "approved" ? 1 : tmp_12_0 === "declined" ? 2 : tmp_12_0 === "pending" ? 3 : 4);
  }
}
...
function EventListingComponent_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275conditionalCreate(1, EventListingComponent_ng_template_18_Case_1_Template, 3, 0, "span", 24)(2, EventListingComponent_ng_template_18_Case_2_Template, 3, 0, "span", 25)(3, EventListingComponent_ng_template_18_Case_3_Template, 3, 0, "span", 26)(4, EventListingComponent_ng_template_18_Case_4_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.reqStatus(item_r10, "parking")) === "approved" ? 1 : tmp_12_0 === "declined" ? 2 : tmp_12_0 === "pending" ? 3 : 4);
  }
}
...
function EventListingComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275conditionalCreate(1, EventListingComponent_ng_template_20_Case_1_Template, 3, 0, "span", 24)(2, EventListingComponent_ng_template_20_Case_2_Template, 3, 0, "span", 25)(3, EventListingComponent_ng_template_20_Case_3_Template, 3, 0, "span", 26)(4, EventListingComponent_ng_template_20_Case_4_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r2.reqStatus(item_r11, "setup")) === "approved" ? 1 : tmp_12_0 === "declined" ? 2 : tmp_12_0 === "pending" ? 3 : 4);
  }
}
function EventListingComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "mat-menu", null, 10)(5, "a", 30)(6, "div", 31)(7, "icon", 32);
    \u0275\u0275text(8, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function EventListingComponent_ng_template_22_Template_button_click_11_listener() {
      const row_r13 = \u0275\u0275restoreView(_r12).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removeEvent(row_r13));
    });
    \u0275\u0275elementStart(12, "div", 31)(13, "icon", 35);
    \u0275\u0275text(14, "delete");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const menu_r14 = \u0275\u0275reference(4);
    \u0275\u0275property("matMenuTriggerFor", menu_r14);
    \u0275\u0275advance(5);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(2, _c11, row_r13 == null ? null : row_r13.id));
  }
}
...
_EventListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventListingComponent, selectors: [["event-listing"]], decls: 24, vars: 38, consts: [["event_template", ""], ["location_template", ""], ["venue_req_template", ""], ["dining_req_template", ""], ["av_req_template", ""], ["safety_req_template", ""], ["events_req_template", ""], ["parking_req_template", ""], ["setup_req_template", ""], ["actions_template", ""], ["menu", "matMenu"], ["mode", "indeterminate", 1, "w-full"], ["empty_message", "No events for selected period", 1, "block", "w-full", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable"], [1, "h-20", "w-full"], [1, "flex", "cursor-pointer", "items-center", "space-x-2", "px-3", "py-2", "hover:bg-base-200/50", 3, "click"], ["date", "", 1, "flex", "w-8", "flex-col", "items-center", "leading-tight"], ["month", "", 1, "relative", "top-0.5", "text-sm", "font-medium", "opacity-60"], ["day", "", 1, "relative", "-top-0.5", "text-2xl", "font-light"], ["details", "", 1, "flex", "flex-col"], [1, "text-sm", "font-medium", "hover:underline"], [1, "text-xs", "opacity-40"], [1, "text-xs", "opacity-60"], [1, "p-4", "text-sm"], [1, "flex", "items-center", "justify-center", "p-2"], [1, "flex", "h-7", "w-7", "items-center", "justify-center", "rounded", "bg-success"], [1, "flex", "h-7", "w-7", "items-center", "justify-center", "rounded", "bg-error"], [1, "flex", "h-7", "w-7", "items-center", "justify-center", "rounded", "bg-warning"], [1, "opacity-30"], [1, "text-base", "text-white"], ["icon", "", "matRipple", "", 1, "mx-2", "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "routerLink"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "mr-2"], ["mat-menu-item", "", 3, "click"], [1, "text-error", "text-2xl"]], template: function EventListingComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 11);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275element(2, "simple-table", 12)(3, "div", 13);
    \u0275\u0275template(4, EventListingComponent_ng_template_4_Template, 17, 18, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, EventListingComponent_ng_template_6_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(8, EventListingComponent_ng_template_8_Template, 5, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(10, EventListingComponent_ng_template_10_Template, 5, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(12, EventListingComponent_ng_template_12_Template, 5, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(14, EventListingComponent_ng_template_14_Template, 5, 1, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(16, EventListingComponent_ng_template_16_Template, 5, 1, "ng-template", null, 6, \u0275\u0275templateRefExtractor)(18, EventListingComponent_ng_template_18_Template, 5, 1, "ng-template", null, 7, \u0275\u0275templateRefExtractor)(20, EventListingComponent_ng_template_20_Template, 5, 1, "ng-template", null, 8, \u0275\u0275templateRefExtractor)(22, EventListingComponent_ng_template_22_Template, 17, 4, "ng-template", null, 9, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const event_template_r15 = \u0275\u0275reference(5);
    const location_template_r16 = \u0275\u0275reference(7);
    const venue_req_template_r17 = \u0275\u0275reference(9);
    const dining_req_template_r18 = \u0275\u0275reference(11);
    const av_req_template_r19 = \u0275\u0275reference(13);
    const safety_req_template_r20 = \u0275\u0275reference(15);
    const events_req_template_r21 = \u0275\u0275reference(17);
    const parking_req_template_r22 = \u0275\u0275reference(19);
    const setup_req_template_r23 = \u0275\u0275reference(21);
    const actions_template_r24 = \u0275\u0275reference(23);
    \u0275\u0275classProp("opacity-0", !\u0275\u0275pipeBind1(1, 5, ctx.loading));
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx.event_list)("columns", \u0275\u0275pureFunctionV(27, _c10, [\u0275\u0275pureFunction1(7, _c04, event_template_r15), \u0275\u0275pureFunction1(9, _c12, location_template_r16), \u0275\u0275pureFunction1(11, _c2, venue_req_template_r17), \u0275\u0275pureFunction1(13, _c3, dining_req_template_r18), \u0275\u0275pureFunction1(15, _c4, av_req_template_r19), \u0275\u0275pureFunction1(17, _c5, safety_req_template_r20), \u0275\u0275pureFunction1(19, _c6, events_req_template_r21), \u0275\u0275pureFunction1(21, _c7, parking_req_template_r22), \u0275\u0275pureFunction1(23, _c8, setup_req_template_r23), \u0275\u0275pureFunction1(25, _c9, actions_template_r24)]))("sortable", true);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventListingComponent, { className: "EventListingComponent", filePath: "apps/concierge/src/app/events/event-listing.component.ts", lineNumber: 374 });
})();
...
//# sourceMappingURL=events.module-OEQDPCRF.js.map
