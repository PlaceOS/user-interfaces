...
import {
  ...
  CdkTreeNodeDef,
  CdkTreeNodePadding
} from "./chunk-JCWNDZ4V.js";
import {
  PagedSearch,
  byDisplayName
} from "./chunk-XKTYPKKO.js";
import "./chunk-RH2ZNZ4A.js";
import "./chunk-3AKDHGBZ.js";
import {
  SettingsToggleComponent
} from "./chunk-4INDJHS3.js";
import "./chunk-SMPBGOJX.js";
import {
...
var SignageGroupDetailHeaderComponent = class _SignageGroupDetailHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupDetailHeaderComponent, selectors: [["signage-group-detail-header"]], decls: 1, vars: 1, consts: [[1, "bg-base-100", "border-base-300", "mx-2", "flex", "items-center", "gap-2", "rounded-b-lg", "border", "px-4", "py-3"], ["icon", "", "matRipple", "", "type", "button", 1, "desktop-hidden", 3, "click"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-lg", "font-medium"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"]], template: function SignageGroupDetailHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# debugId=22673b2c-1116-576a-848a-bc31918012a5
//# sourceMappingURL=groups.component-MZR35B3P.js.map
