...
} from "./chunk-IA3CQ2BX.js";
import {
  ExploreDesksService,
  ExploreZoomControlComponent
} from "./chunk-7HIH3D5L.js";
import "./chunk-SETZMNE2.js";
import {
  SearchbarComponent
} from "./chunk-S62Q5SKJ.js";
import {
  DeskListFieldComponent
} from "./chunk-YVOEHGJW.js";
import {
...
import {
  BookingFormService
} from "./chunk-QL7WGT5P.js";
import {
  AssetListFieldComponent
} from "./chunk-JXLXDFNC.js";
import {
...
function DeskBookingsComponent_ng_template_24_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 28);
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_24_Conditional_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r16);
...
function DeskBookingsComponent_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(13, DeskBookingsComponent_ng_template_24_Conditional_13_Template, 7, 3, "button", 34);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 3, "COMMON.CANCEL_BOOKING"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(row_r15.instance ? 13 : -1);
  }
}
...
_DeskBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskBookingsComponent, selectors: [["desk-bookings"]], decls: 27, vars: 65, consts: [["date_template", ""], ["group_template", ""], ["period_template", ""], ["user_template", ""], ["status_template", ""], ["option_template", ""], ["action_template", ""], ["menu", "matMenu"], ["checkinMenu", "matMenu"], ["actionMenu", "matMenu"], [1, "h-full", "w-full", "overflow-auto", "pb-16"], [1, "block", "min-w-368", "text-sm", 3, "data", "filter", "filter_on", "columns", "empty_message", "sortable"], ["btn", "", "matRipple", "", 1, "absolute", "bottom-2", "left-4", "z-20", "w-32"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-4", "font-mono", "text-[0.625rem]"], [1, "opacity-30"], [1, "p-2"], [1, "bg-error", "rounded-3xl", "px-4", "py-2", "text-xs", "text-white"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], [1, "max-w-48", "truncate", "text-xs", "opacity-30", "select-all"], [1, "px-2"], ["matRipple", "", 1, "bg-warning", "text-warning-content", "h-10", "w-30", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pr-2", "pl-4"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "bg-warning", "text-warning-content", "h-10", "w-18", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled", "matTooltip"], [1, "mx-auto", "flex", "items-center", "justify-end", "space-x-2"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", ""], [1, "text-error", "text-2xl"], ["btn", "", "matRipple", "", 1, "absolute", "bottom-2", "left-4", "z-20", "w-32", 3, "click"]], template: function DeskBookingsComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.bookings())("filter", ctx.filters().search)("filter_on", \u0275\u0275pureFunction0(27, _c0))("columns", \u0275\u0275pureFunctionV(54, _c11, [\u0275\u0275pureFunction2(28, _c1, \u0275\u0275pipeBind1(2, 7, "FORM.DATE"), date_template_r19), \u0275\u0275pureFunction2(31, _c2, \u0275\u0275pipeBind1(3, 9, "FORM.PERIOD"), period_template_r20), \u0275\u0275pureFunction1(34, _c3, \u0275\u0275pipeBind1(4, 11, "RESOURCE.DESK")), \u0275\u0275pureFunction2(36, _c4, \u0275\u0275pipeBind1(5, 13, "COMMON.PERSON"), user_template_r21), \u0275\u0275pureFunction2(39, _c5, \u0275\u0275pipeBind1(6, 15, "COMMON.BOOKED_BY"), user_template_r21), \u0275\u0275pureFunction1(42, _c6, \u0275\u0275pipeBind1(7, 17, "FORM.TITLE")), \u0275\u0275pureFunction1(44, _c7, \u0275\u0275pipeBind1(8, 19, "APP.CONCIERGE.APPROVER")), \u0275\u0275pureFunction2(46, _c8, \u0275\u0275pipeBind1(9, 21, "COMMON.STATUS"), status_template_r22), \u0275\u0275pureFunction2(49, _c9, \u0275\u0275pipeBind1(10, 23, "COMMON.CHECKED_IN"), option_template_r23), \u0275\u0275pureFunction1(52, _c10, action_template_r24)]))("empty_message", \u0275\u0275pipeBind1(11, 25, ctx.filters().search ? "APP.CONCIERGE.DESKS_BOOKINGS_SEARCH_EMPTY" : "APP.CONCIERGE.DESKS_BOOKINGS_EMPTY"))("sortable", true);
    \u0275\u0275advance(25);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskBookingsComponent, { className: "DeskBookingsComponent", filePath: "apps/concierge/src/app/desks/desk-bookings.component.ts", lineNumber: 338 });
})();
...
function DesksManageComponent_ng_template_16_ng_template_13_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("src", ctx_r3.qr_code().get(row_r13.id), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
...
var _DesksManageComponent = class _DesksManageComponent extends AsyncHandler {
  constructor() {
    ...
    this.qr_code = signal(/* @__PURE__ */ new Map());
    this.filters = this._state.filters;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DesksManageComponent, { className: "DesksManageComponent", filePath: "apps/concierge/src/app/desks/desks-manage.component.ts", lineNumber: 264 });
})();
...
function DesksComponent_Conditional_16_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 23);
  }
}
function DesksComponent_Conditional_16_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function DesksComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(9, "button", 22);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("click", function DesksComponent_Conditional_16_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.downloadCsv());
    });
    \u0275\u0275conditionalCreate(11, DesksComponent_Conditional_16_Conditional_11_Template, 1, 0, "mat-spinner", 23)(12, DesksComponent_Conditional_16_Conditional_12_Template, 2, 0, "icon");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(2, 7, "COMMON.REFRESH"))("disabled", ctx_r1.loading());
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(6, 9, "APP.CONCIERGE.REJECT_ALL"))("disabled", ctx_r1.loading());
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(10, 11, "APP.CONCIERGE.DOWNLOAD_USER_LIST"))("disabled", ctx_r1.downloading());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.downloading() ? 11 : 12);
  }
}
...
_DesksComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DesksComponent, selectors: [["", "app-desks", ""]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], attrs: _c04, decls: 21, vars: 11, consts: [[1, "print:hidden"], [1, "flex", "h-px", "flex-1", "print:hidden"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "w-full", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], ["btn", "", "matRipple", "", 1, "w-44", "space-x-2"], [1, "mb-4", "flex", "w-full", "items-center", "gap-2", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-60"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], ["mode", "indeterminate", 1, "w-full"], ["btn", "", "matRipple", "", 1, "w-44", "space-x-2", 3, "click"], [1, "pl-2"], [1, "text-2xl"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "ngModelChange", "ngModel", "placeholder"], [3, "dateChange"], ["btn", "", "icon", "", "matRipple", "", 1, "border-base-200", "rounded-sm", "border", 3, "click", "matTooltip", "disabled"], ["diameter", "24"], ["btn", "", "icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "click", "matTooltip"], ["btn", "", "icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "matTooltip"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "click", "matTooltip"]], template: function DesksComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(15, "div", 5);
    \u0275\u0275conditionalCreate(16, DesksComponent_Conditional_16_Template, 13, 13);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DesksComponent, { className: "DesksComponent", filePath: "apps/concierge/src/app/desks/desks.component.ts", lineNumber: 327 });
})();
...
//# sourceMappingURL=desks.module-J4FE36CL.js.map
