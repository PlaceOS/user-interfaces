...
/*# sourceMappingURL=app-sidebar.component.css.map */`]})}}return n})();var Oc=()=>[`/`];var Wb=(()=>{class n{constructor(){this._settings=g(ks$1),this._theme=this._settings.theme_signal,this._logo_dark=this._settings.signal(`app.logo_dark`,{},!0),this._logo_light=this._settings.signal(`app.logo_light`,{},!0),this.logo_src=Ae$1(()=>{let e=this.logo();return typeof e==`string`?e:e?.src||``}),this.logo=Ae$1(()=>(this._theme()===`dark`?this._logo_dark():this._logo_light())||{}),this.user=IJ()}static{this.ɵfac=function(t){return new(t||n)}}static{this.ɵcmp=Ue({type:n,selectors:[[`app-topbar`]],decls:10,vars:4,consts:[[1,`border-base-200`,`flex`,`items-center`,`border-b`,`p-2`],[1,`w-64`],[3,`routerLink`],[`auth`,``,1,`h-12`,3,`source`],[1,`flex`,`flex-1`,`items-center`,`justify-end`,`space-x-2`],[`btn`,``,`icon`,``,`matRipple`,``],[1,`text-2xl`],[1,`mr-2`],[3,`user`]],template:function(t,i){t&1&&(Ar(0,`div`,0)(1,`div`,1)(2,`a`,2),So(3,`img`,3),Rr()(),Ar(4,`div`,4)(5,`button`,5)(6,`icon`,6),Ca$1(7,`notifications`),Rr()(),Ar(8,`user-controls-sidebar`,7),So(9,`a-user-avatar`,8),Rr()()()),t&2&&(Ut(2),Ku(`routerLink`,W4(3,Oc)),Ut(),Ku(`source`,i.logo_src()),Ut(6),Ku(`user`,i.user()))},dependencies:[mte,JS,Mn,gm,Dw,_t,VXe,Ma],styles:[`[_nghost-%COMP%]{width:100%}
...
//# debugId=3041015e-8aee-52d1-bbce-e41ffe57274d
//# sourceMappingURL=chunk-8npFME0Y.js.map