...
function ServicesPackagesComponent_For_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(6, _c12, pkg_r2.id));
    \u0275\u0275advance(7);
...
function ServicesPackagesComponent_For_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c12, option_r5.id));
  }
}
function ServicesPackagesComponent_For_56_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(5, _c12, addon_r7.id));
  }
}
...
_ServicesPackagesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServicesPackagesComponent, selectors: [["services-packages"]], decls: 65, vars: 6, consts: [[1, "p-6"], [1, "mb-6", "flex", "items-start", "justify-between"], [1, "text-2xl", "font-semibold"], [1, "text-base-content/60", "mt-1"], ["matRipple", "", 1, "bg-primary", "text-primary-content", "flex", "items-center", "gap-2", "rounded", "px-4", "py-2", "text-sm", "font-medium", 3, "routerLink"], [1, "mb-4", "flex", "items-center", "gap-2"], [1, "text-sm", "font-medium"], [1, "rounded-full", "px-4", "py-1", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "mb-3", "text-lg", "font-semibold"], [1, "mb-8", "grid", "grid-cols-1", "gap-4", "md:grid-cols-2", "lg:grid-cols-3"], [1, "border-base-200", "bg-base-100", "group", "rounded-lg", "border", "p-4", "shadow-sm"], [1, "text-base-content/60", "text-sm", "font-normal"], [1, "border-base-200", "mb-8", "overflow-hidden", "rounded-lg", "border"], [1, "w-full"], [1, "bg-base-200"], [1, "px-4", "py-3", "text-left", "text-sm"], [1, "px-4", "py-3", "text-right", "text-sm"], [1, "w-20", "px-4", "py-3", "text-right", "text-sm"], [1, "border-base-200", "group", "border-t"], [1, "border-base-200", "overflow-hidden", "rounded-lg", "border"], [1, "bg-info/10", "text-info", "mt-6", "rounded-lg", "p-4", "text-sm"], [1, "mb-3", "flex", "items-start", "justify-between"], [1, "flex-1"], [1, "text-lg", "font-semibold"], [1, "text-base-content/60", "text-sm"], [1, "flex", "items-center", "gap-1"], ["matRipple", "", 1, "hover:bg-base-200", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "opacity-0", "transition-opacity", "group-hover:opacity-100", 3, "routerLink"], [1, "text-base"], ["matRipple", "", 1, "hover:bg-error/10", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "opacity-0", "transition-opacity", "group-hover:opacity-100", 3, "click"], [1, "text-error", "text-base"], [1, "text-base-content/70", "mb-3", "text-sm"], [1, "border-base-200", "flex", "items-center", "justify-between", "border-t", "pt-3"], [1, "bg-base-200", "rounded", "px-2", "py-0.5", "text-xs"], [1, "text-primary", "text-lg", "font-bold"], [1, "px-4", "py-3", "text-sm"], [1, "text-primary", "px-4", "py-3", "text-right", "text-sm", "font-semibold"], [1, "px-4", "py-3", "text-right"], [1, "flex", "items-center", "justify-end", "gap-1", "opacity-0", "transition-opacity", "group-hover:opacity-100"], [1, "hover:bg-base-200", "flex", "h-7", "w-7", "items-center", "justify-center", "rounded-full", 3, "routerLink"], [1, "text-sm"], [1, "hover:bg-error/10", "flex", "h-7", "w-7", "items-center", "justify-center", "rounded-full", 3, "click"], [1, "text-error", "text-sm"], [1, "flex", "items-center", "gap-2"], [1, "text-base-content/40", "text-base"], [1, "text-base-content/60", "px-4", "py-3", "text-sm"]], template: function ServicesPackagesComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(21, ServicesPackagesComponent_For_22_Template, 21, 8, "div", 10, _forTrack0);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(38, ServicesPackagesComponent_For_39_Template, 13, 5, "tr", 18, _forTrack0);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275repeaterCreate(55, ServicesPackagesComponent_For_56_Template, 18, 7, "tr", 18, _forTrack0);
    \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServicesPackagesComponent, { className: "ServicesPackagesComponent", filePath: "apps/concierge/src/app/services/services-packages.component.ts", lineNumber: 273 });
})();
...
_ServicesSpacesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServicesSpacesComponent, selectors: [["services-spaces"]], decls: 21, vars: 4, consts: [[1, "p-6"], [1, "mb-6"], [1, "text-2xl", "font-semibold"], [1, "text-base-content/60", "mt-1"], [1, "mb-4", "flex", "items-center", "gap-2"], [1, "text-sm", "font-medium"], [1, "rounded-full", "px-4", "py-1", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "space-y-6"], [1, "border-base-200", "overflow-hidden", "rounded-lg", "border"], [1, "text-base-content/50", "mt-6", "border-t", "border-base-200", "pt-4", "text-xs"], [1, "mt-1"], [1, "bg-base-200", "flex", "items-center", "gap-3", "px-4", "py-3"], [1, "text-primary", "text-2xl"], [1, "flex-1"], [1, "text-lg", "font-semibold"], [1, "text-base-content/60", "text-xs"], [1, "bg-primary/10", "text-primary", "rounded-full", "px-3", "py-1", "text-sm", "font-medium"], [1, "p-4"], [1, "mb-2", "text-sm", "font-semibold"], [1, "mb-4", "space-y-1"], [1, "text-base-content/70", "flex", "items-start", "gap-2", "text-sm"], [1, "text-success", "mt-0.5", "text-base"], [1, "border-base-200", "mb-4", "overflow-hidden", "rounded", "border"], [1, "border-base-200", "flex", "items-center", "justify-between", "border-b", "px-3", "py-2", "last:border-b-0"], [1, "text-sm"], [1, "text-primary", "text-sm", "font-medium"], [1, "text-base-content/60", "font-normal"], [1, "border-base-200", "overflow-hidden", "rounded", "border"]], template: function ServicesSpacesComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServicesSpacesComponent, { className: "ServicesSpacesComponent", filePath: "apps/concierge/src/app/services/services-spaces.component.ts", lineNumber: 404 });
})();
...
_ServicesAdditionalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServicesAdditionalComponent, selectors: [["services-additional"]], decls: 94, vars: 0, consts: [[1, "p-6"], [1, "mb-6"], [1, "text-2xl", "font-semibold"], [1, "text-base-content/60", "mt-1"], [1, "grid", "grid-cols-1", "gap-6", "lg:grid-cols-2"], [1, "border-base-200", "overflow-hidden", "rounded-lg", "border"], [1, "bg-base-200", "flex", "items-center", "gap-3", "px-4", "py-3"], [1, "text-primary", "text-2xl"], [1, "text-lg", "font-semibold"], [1, "space-y-3", "p-4"], [1, "text-base-content/70", "text-sm"], [1, "space-y-2"], [1, "flex", "items-start", "gap-2"], [1, "text-base-content/50", "mt-0.5", "text-base"], [1, "text-sm"], [1, "bg-warning/10", "text-warning", "rounded", "p-3", "text-sm"], [1, "bg-info/10", "text-info", "rounded", "p-3", "text-sm"], [1, "flex", "items-center", "gap-2"], [1, "text-primary", "text-base"], [1, "text-sm", "font-medium"], [1, "mt-8"], [1, "mb-4", "text-xl", "font-semibold"], [1, "grid", "grid-cols-1", "gap-4", "lg:grid-cols-2"], [1, "border-base-200", "rounded-lg", "border", "p-4"], [1, "mb-2", "font-semibold"], [1, "text-base-content/60", "mt-2", "text-xs"], [1, "bg-info/10", "text-info", "mt-6", "rounded-lg", "p-4", "text-sm"]], template: function ServicesAdditionalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2", 2);
...
_ServiceFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceFormComponent, selectors: [["service-form"]], decls: 66, vars: 7, consts: [[1, "bg-base-100", "absolute", "inset-0", "overflow-auto"], [1, "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "items-center", "justify-between", "rounded", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 1, "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", 3, "routerLink"], [1, "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "flex-col", "gap-1", "px-4", "pb-20", 3, "formGroup"], [1, "text-sm", "font-medium"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "formControlName", "name", "placeholder", "Service name"], ["formControlName", "category", "placeholder", "Select category"], ["value", "package"], ["value", "alacarte"], ["value", "addon"], ["value", "space"], ["matInput", "", "formControlName", "space", "placeholder", "e.g. Auditorium and Lobby"], ["matInput", "", "formControlName", "duration", "placeholder", "e.g. Up to 4 hours"], ["matInput", "", "formControlName", "description", "placeholder", "Service description", "rows", "3"], [1, "grid", "grid-cols-2", "gap-4"], ["matInput", "", "formControlName", "internal_price", "placeholder", "e.g. $719"], ["matInput", "", "formControlName", "external_price", "placeholder", "e.g. $990.94"], ["matInput", "", "formControlName", "icon", "placeholder", "e.g. groups, school, meeting_room"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "-translate-x-1/2", "items-center", "justify-end", "gap-2", "rounded", "px-4", "py-2"], ["matRipple", "", 1, "bg-base-300", "hover:bg-base-content/20", "rounded", "px-6", "py-2", "text-sm", "font-medium", 3, "routerLink"], ["matRipple", "", 1, "bg-primary", "text-primary-content", "rounded", "px-6", "py-2", "text-sm", "font-medium", 3, "click"]], template: function ServiceFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15, "Category *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "mat-form-field", 6)(17, "mat-select", 8)(18, "mat-option", 9);
    \u0275\u0275text(19, " Event Package ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-option", 10);
    \u0275\u0275text(21, "A La Carte");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "mat-option", 11);
    \u0275\u0275text(23, "AV Add-on");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "mat-option", 12);
    \u0275\u0275text(25, "Space / Venue");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "mat-error");
    \u0275\u0275text(27, "Category is required");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "label", 5);
    \u0275\u0275text(29, "Space / Venue");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "mat-form-field", 6);
    \u0275\u0275element(31, "input", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "label", 5);
    \u0275\u0275text(33, "Duration");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "mat-form-field", 6);
    \u0275\u0275element(35, "input", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "label", 5);
    \u0275\u0275text(37, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "mat-form-field", 6);
    \u0275\u0275element(39, "textarea", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "div", 16)(41, "div")(42, "label", 5);
    \u0275\u0275text(43, " Internal Price (UCLA) * ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "mat-form-field", 6);
    \u0275\u0275element(45, "input", 17);
    \u0275\u0275elementStart(46, "mat-error");
    \u0275\u0275text(47, "Price is required");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(48, "div")(49, "label", 5);
    \u0275\u0275text(50, " External Price * ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "mat-form-field", 6);
    \u0275\u0275element(52, "input", 18);
    \u0275\u0275elementStart(53, "mat-error");
    \u0275\u0275text(54, "Price is required");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(55, "label", 5);
    \u0275\u0275text(56, "Icon");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "mat-form-field", 6);
    \u0275\u0275element(58, "input", 19);
    \u0275\u0275elementStart(59, "mat-hint");
    \u0275\u0275text(60, " Use underscores, e.g. meeting_room not meeting room ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(61, "footer", 20)(62, "a", 21);
    \u0275\u0275text(63, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "button", 22);
    \u0275\u0275listener("click", function ServiceFormComponent_Template_button_click_64_listener() {
      return ctx.save();
    });
    \u0275\u0275text(65);
    \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServiceFormComponent, { className: "ServiceFormComponent", filePath: "apps/concierge/src/app/services/service-form.component.ts", lineNumber: 170 });
})();
...
//# sourceMappingURL=services.module-XUFGMEEZ.js.map
