...
function GuestListingComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, GuestListingComponent_ng_template_13_Conditional_0_Template, 5, 10, "div", 20);
    \u0275\u0275conditionalCreate(1, GuestListingComponent_ng_template_13_Conditional_1_Template, 4, 3, "div", 21);
    \u0275\u0275conditionalCreate(2, GuestListingComponent_ng_template_13_Conditional_2_Template, 5, 10, "div", 22);
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, GuestListingComponent_ng_template_15_Conditional_3_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, GuestListingComponent_ng_template_17_Conditional_3_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, GuestListingComponent_ng_template_19_Conditional_1_Template, 2, 1, "button", 26);
    \u0275\u0275elementEnd();
...
function GuestListingComponent_ng_template_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, GuestListingComponent_ng_template_21_Conditional_0_Template, 3, 0, "div", 31);
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, GuestListingComponent_ng_template_25_Conditional_6_Template, 2, 0, "icon", 37);
    \u0275\u0275elementEnd()()();
...
function GuestListingComponent_ng_template_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
    \u0275\u0275conditionalCreate(3, GuestListingComponent_ng_template_27_Conditional_3_Template, 3, 5, "span", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 33);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, GuestListingComponent_ng_template_29_Conditional_2_Template, 2, 0, "span", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "async");
    \u0275\u0275pipe(3, "date");
    \u0275\u0275conditionalCreate(4, GuestListingComponent_ng_template_31_Conditional_4_Template, 3, 5, "span", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_14_0;
...
function GuestListingComponent_ng_template_33_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Conditional_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r18);
...
function GuestListingComponent_ng_template_33_For_18_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_33_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Conditional_26_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r21);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_33_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Conditional_34_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r22);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Conditional_34_Template_div_click_9_listener($event) {
      \u0275\u0275restoreView(_r22);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(10, "mat-form-field", 50)(11, "input", 51);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function GuestListingComponent_ng_template_33_Conditional_34_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r22);
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Conditional_34_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r22);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_33_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Conditional_35_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r24);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_33_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Conditional_36_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r25);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "more_horiz");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "mat-menu", null, 14)(6, "button", 45);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Template_button_click_6_listener() {
      const row_r17 = \u0275\u0275restoreView(_r16).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.viewAttachments(row_r17));
    });
    \u0275\u0275elementStart(7, "div", 39)(8, "icon", 37);
    \u0275\u0275text(9, "attachment");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(13, GuestListingComponent_ng_template_33_Conditional_13_Template, 7, 3, "button", 46);
    ...
    \u0275\u0275repeaterCreate(17, GuestListingComponent_ng_template_33_For_18_Template, 2, 2, "a", 47, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "button", 38);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_33_Template_button_click_19_listener() {
      const row_r17 = \u0275\u0275restoreView(_r16).row;
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(26, GuestListingComponent_ng_template_33_Conditional_26_Template, 7, 3, "button", 46);
    \u0275\u0275elementStart(27, "a", 47)(28, "div", 39)(29, "icon", 37);
    \u0275\u0275text(30, "email");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(34, GuestListingComponent_ng_template_33_Conditional_34_Template, 16, 12);
    \u0275\u0275conditionalCreate(35, GuestListingComponent_ng_template_33_Conditional_35_Template, 7, 4, "button", 46);
    \u0275\u0275conditionalCreate(36, GuestListingComponent_ng_template_33_Conditional_36_Template, 14, 6);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, GuestListingComponent_ng_template_35_Conditional_5_Template, 4, 3, "div", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
_GuestListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GuestListingComponent, selectors: [["guest-listings"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 40, vars: 89, consts: [["state_template", ""], ["person_template", ""], ["host_template", ""], ["id_template", ""], ["parking_template", ""], ["induction_template", ""], ["status_template", ""], ["time_template", ""], ["pass_template", ""], ["date_template", ""], ["action_template", ""], ["notes_template", ""], ["id_confirmation", ""], ["menu", "matMenu"], ["guest_menu", "matMenu"], ["pass_menu", ""], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "z-0", "block", "text-sm", 3, "data", "columns", "filter", "sortable"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 1, "bg-secondary", "absolute", "right-4", "bottom-4", "z-20", "h-12", "w-12", "text-white", "shadow-sm", "hover:shadow-lg", 3, "matTooltip"], [1, "h-8", "w-full"], ["matTooltipPosition", "right", 1, "bg-base-400", "text-neutral-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "bg-warning", "text-warning-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "bg-success", "text-success-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", 3, "matTooltip"], [1, "px-4", "py-2"], [1, "text-xs", "opacity-30"], ["customTooltip", "", 3, "content"], ["matRipple", "", 1, "bg-success", "rounded-3xl", "px-4", "py-2", "text-white"], [1, "bg-base-100", "my-2", "flex", "w-[20rem]", "flex-col", "space-y-2", "rounded-sm", "p-2"], [1, "max-h-80", "max-w-[20rem]", "object-contain", 3, "src"], ["matRipple", "", 3, "click"], ["matRipple", "", 1, "inverse", "mt-2", 3, "click"], [1, "bg-success", "text-success-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl"], [1, "px-4"], ["matRipple", "", 1, "h-10", "w-30", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pr-2", "pl-4"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], [1, "text-error", "text-2xl"], [1, "opacity-30"], [1, "flex", "items-center", "justify-end", "px-2"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click", "disabled"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "href"], ["mat-menu-item", "", 3, "click", "matMenuTriggerFor"], [1, "w-full", "space-y-2", "px-2", 3, "click"], ["appearance", "outline", 1, "no-subscript"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click", "disabled"], [1, "relative", "mx-auto", "p-4"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "bg-info", "text-info-content", "absolute", "top-1", "right-1", "flex", "h-4", "w-4", "items-center", "justify-center", "rounded-full", 3, "matTooltip"], ["className", "material-symbols-rounded", 1, "text-sm"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 1, "bg-secondary", "absolute", "right-4", "bottom-4", "z-20", "h-12", "w-12", "text-white", "shadow-sm", "hover:shadow-lg", 3, "click", "matTooltip"]], template: function GuestListingComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, GuestListingComponent_ng_template_13_Template, 3, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(15, GuestListingComponent_ng_template_15_Template, 4, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(17, GuestListingComponent_ng_template_17_Template, 4, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(19, GuestListingComponent_ng_template_19_Template, 4, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(21, GuestListingComponent_ng_template_21_Template, 1, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(23, GuestListingComponent_ng_template_23_Template, 3, 13, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(25, GuestListingComponent_ng_template_25_Template, 23, 30, "ng-template", null, 6, \u0275\u0275templateRefExtractor)(27, GuestListingComponent_ng_template_27_Template, 4, 6, "ng-template", null, 7, \u0275\u0275templateRefExtractor)(29, GuestListingComponent_ng_template_29_Template, 3, 2, "ng-template", null, 8, \u0275\u0275templateRefExtractor)(31, GuestListingComponent_ng_template_31_Template, 5, 8, "ng-template", null, 9, \u0275\u0275templateRefExtractor)(33, GuestListingComponent_ng_template_33_Template, 37, 19, "ng-template", null, 10, \u0275\u0275templateRefExtractor)(35, GuestListingComponent_ng_template_35_Template, 6, 4, "ng-template", null, 11, \u0275\u0275templateRefExtractor);
    \u0275\u0275conditionalCreate(37, GuestListingComponent_Conditional_37_Template, 4, 3, "button", 18);
    \u0275\u0275pipe(38, "async");
    \u0275\u0275element(39, "div", 19);
  }
  if (rf & 2) {
    let tmp_17_0;
    const state_template_r30 = \u0275\u0275reference(14);
    const person_template_r31 = \u0275\u0275reference(16);
    const host_template_r32 = \u0275\u0275reference(18);
    const parking_template_r33 = \u0275\u0275reference(22);
    const induction_template_r34 = \u0275\u0275reference(24);
    const status_template_r35 = \u0275\u0275reference(26);
    const time_template_r36 = \u0275\u0275reference(28);
    const pass_template_r37 = \u0275\u0275reference(30);
    const date_template_r38 = \u0275\u0275reference(32);
    const action_template_r39 = \u0275\u0275reference(34);
    const notes_template_r40 = \u0275\u0275reference(36);
    \u0275\u0275advance();
    \u0275\u0275styleProp("min-width", 68 + ctx.extra_width + "rem");
    \u0275\u0275property("data", ctx.guests)("columns", \u0275\u0275pureFunctionV(76, _c12, [\u0275\u0275pureFunction3(31, _c0, \u0275\u0275pipeBind1(2, 7, "COMMON.STATUS"), state_template_r30, !ctx.hide_field("state")), \u0275\u0275pureFunction3(35, _c1, \u0275\u0275pipeBind1(3, 9, "FORM.TIME"), date_template_r38, !ctx.hide_field("date")), \u0275\u0275pureFunction2(39, _c2, \u0275\u0275pipeBind1(4, 11, "RESOURCE.VISITOR"), person_template_r31), \u0275\u0275pureFunction3(42, _c3, \u0275\u0275pipeBind1(5, 13, "FORM.HOST"), host_template_r32, !ctx.hide_field("user_name")), \u0275\u0275pureFunction3(46, _c4, \u0275\u0275pipeBind1(6, 15, "COMMON.CHECKED_IN"), time_template_r36, !ctx.hide_field("checked_in_at")), \u0275\u0275pureFunction3(50, _c5, \u0275\u0275pipeBind1(7, 17, "COMMON.CHECKED_OUT"), time_template_r36, !ctx.hide_field("checked_out_at")), \u0275\u0275pureFunction3(54, _c6, \u0275\u0275pipeBind1(8, 19, "BOOKINGS.INDUCTED"), induction_template_r34, !!ctx.inductions_enabled()), \u0275\u0275pureFunction3(58, _c7, \u0275\u0275pipeBind1(9, 21, "BOOKINGS.PASS_NUMBER"), pass_template_r37, ctx.pass_number_enabled), \u0275\u0275pureFunction3(62, _c8, \u0275\u0275pipeBind1(10, 23, "RESOURCE.PARKING"), parking_template_r33, !!ctx.has_parking), \u0275\u0275pureFunction3(66, _c9, \u0275\u0275pipeBind1(11, 25, "COMMON.STATE"), status_template_r35, !ctx.hide_field("status")), \u0275\u0275pureFunction3(70, _c10, \u0275\u0275pipeBind1(12, 27, "FORM.NOTES"), notes_template_r40, !ctx.hide_field("notes")), \u0275\u0275pureFunction1(74, _c11, action_template_r39)]))("filter", ctx.search)("sortable", true);
    \u0275\u0275advance(36);
    \u0275\u0275conditional(((tmp_17_0 = \u0275\u0275pipeBind1(38, 29, ctx.guests)) == null ? null : tmp_17_0.length) ? 37 : -1);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GuestListingComponent, { className: "GuestListingComponent", filePath: "apps/concierge/src/app/visitors/guest-listing.component.ts", lineNumber: 663 });
})();
...
//# sourceMappingURL=chunk-Q5T672GJ.js.map
