...
var ParkingRequestFormDetailsComponent = class _ParkingRequestFormDetailsComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    ...
    runInInjectionContext(this._injector, () => effect(async () => {
      ...
      if (!this.default_location_from_desk_booking() || Sn() || id || !date || buildings?.length <= 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingRequestFormDetailsComponent, { className: "ParkingRequestFormDetailsComponent", filePath: "apps/workplace/src/app/book/parking-request-flow/parking-request-form-details.component.ts", lineNumber: 1211 });
})();
...
function ParkingRequestFormComponent_Conditional_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 2, "BOOKINGS.PARKING_CANCEL"), " ");
    \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingRequestFormComponent, { className: "ParkingRequestFormComponent", filePath: "apps/workplace/src/app/book/parking-request-flow/parking-request-form.component.ts", lineNumber: 132 });
})();
...
//# sourceMappingURL=parking-request-flow.component-IXG5HQR4.js.map
