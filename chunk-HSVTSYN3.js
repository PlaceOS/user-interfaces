...
function NavSidebarComponent_For_12_Template(rf, ctx) {
  if (rf & 1) {
...
function NavSidebarComponent_Conditional_14_For_10_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", lang_r3.local, " ");
  }
}
function NavSidebarComponent_Conditional_14_For_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 17);
    \u0275\u0275listener("click", function NavSidebarComponent_Conditional_14_For_10_Template_button_click_0_listener() {
      const lang_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.setLocale(lang_r3.id));
    });
    \u0275\u0275elementStart(1, "div", 18)(2, "icon", 19);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 20)(5, "div");
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, NavSidebarComponent_Conditional_14_For_10_Conditional_8_Template, 2, 1, "div", 21);
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("font-semibold", ctx_r3.active_locale() === lang_r3.id);
    \u0275\u0275property("matTooltip", ctx_r3.localeDetails(lang_r3));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r3.active_locale() === lang_r3.id ? "check" : "language", " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 6, lang_r3.name));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(lang_r3.local && \u0275\u0275pipeBind1(9, 8, lang_r3.name) !== lang_r3.local ? 8 : -1);
  }
}
function NavSidebarComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "mat-menu", 15, 0);
    \u0275\u0275repeaterCreate(9, NavSidebarComponent_Conditional_14_For_10_Template, 10, 10, "button", 16, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const language_menu_r5 = \u0275\u0275reference(8);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275property("matMenuTriggerFor", language_menu_r5)("matTooltip", ctx_r3.active_locale_details());
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(1, 4, "COMMON.LANGUAGE_SELECT"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 6, ctx_r3.active_locale_label()), " ");
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r3.locales());
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavSidebarComponent, selectors: [["nav-sidebar"]], decls: 16, vars: 14, consts: [["language_menu", "matMenu"], [1, "bg-secondary", "text-secondary-content", "border-base-100", "relative", "z-30", "hidden", "h-full", "flex-col", "border-r", "p-2", "shadow-lg", "sm:flex"], ["logo", "", 1, "bg-base-100/80", "mx-auto", "flex", "h-20", "w-20", "shrink-0", "items-center", "justify-center", "rounded-2xl", "shadow-xl", 3, "routerLink"], ["auth", "", 1, "max-h-18", "max-w-18", "object-contain", 3, "alt", "source"], [1, "opacity-20"], ["type", "button", "matRipple", "", "matTooltipPosition", "right", 1, "hover:bg-base-100/30", "focus-visible:bg-base-100/30", "mx-auto", "mt-2", "flex", "h-10", "w-18", "shrink-0", "items-center", "justify-center", "gap-1", "rounded-xl", 3, "click", "matTooltip"], [1, "text-2xl"], [1, "flex", "min-h-0", "w-[calc(100%+0.5rem)]", "flex-1", "flex-col", "gap-4", "overflow-x-hidden", "overflow-y-auto", "p-2"], ["routerLinkActive", "active bg-primary/30", "ariaCurrentWhenActive", "page", 1, "hover:bg-base-100/30", "focus-visible:bg-base-100/30", "relative", "flex", "h-18", "w-18", "shrink-0", "flex-col", "items-center", "justify-center", "rounded-xl", 3, "routerLink"], [1, "shrink-0", "p-2"], [1, "text-3xl"], [1, "text-center", "text-xs", "font-medium"], ["active", "", 1, "bg-base-100", "absolute", "inset-y-0", "top-0", "-right-4", "w-2", "rounded-l-lg"], ["type", "button", "matRipple", "", "matTooltipPosition", "right", 1, "hover:bg-base-100/30", "focus-visible:bg-base-100/30", "mb-2", "flex", "h-18", "w-18", "flex-col", "items-center", "justify-center", "rounded-xl", "text-center", 3, "matMenuTriggerFor", "matTooltip"], [1, "mt-1", "line-clamp-2", "w-full", "px-1", "text-xs", "leading-tight", "font-medium"], ["xPosition", "after"], ["type", "button", "mat-menu-item", "", "matTooltipPosition", "right", 3, "matTooltip", "font-semibold"], ["type", "button", "mat-menu-item", "", "matTooltipPosition", "right", 3, "click", "matTooltip"], [1, "flex", "max-w-64", "min-w-44", "items-center", "gap-3"], [1, "text-xl"], [1, "min-w-0", "leading-tight"], [1, "text-base-content/60", "truncate", "text-xs"]], template: function NavSidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(11, NavSidebarComponent_For_12_Template, 8, 8, "a", 8, _forTrack03);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(13, "div", 9);
        \u0275\u0275conditionalCreate(14, NavSidebarComponent_Conditional_14_Template, 11, 8);
        \u0275\u0275element(15, "signage-group-selector");
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        let tmp_2_0;
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(1, 7, "SIGNAGE_MANAGER.PRIMARY_NAV"));
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(13, _c02));
        \u0275\u0275advance();
        \u0275\u0275conditional((tmp_2_0 = ctx.logo_src) ? 3 : 4, tmp_2_0);
        \u0275\u0275advance(2);
        \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(6, 9, "SIGNAGE_MANAGER.PALETTE_OPEN") + " (" + ctx.palette_shortcut + ")");
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(7, 11, "SIGNAGE_MANAGER.PALETTE_OPEN"))("aria-keyshortcuts", ctx.palette_aria_shortcut);
        \u0275\u0275advance(6);
        \u0275\u0275repeater(ctx.nav_items());
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.show_locale_selector() && ctx.locales().length > 1 ? 14 : -1);
      }
    }, dependencies: [
      RouterModule,
      RouterLink,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavSidebarComponent, { className: "NavSidebarComponent", filePath: "apps/signage-manager/src/app/shared/nav-sidebar.component.ts", lineNumber: 168 });
})();
...
//# debugId=9024e57a-0af0-5f61-b145-6e7c445190eb
//# sourceMappingURL=chunk-HSVTSYN3.js.map
