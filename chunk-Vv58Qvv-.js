import {m,ar as ie,eH as Fs,eI as I,eJ as Yh,aw as l,av as m$1,eK as Tr,eL as us,eM as L$1,eN as q,eO as ut,eP as lt$1,eQ as qN,eR as ih,eS as Wh,eT as Ee,eU as ny,eV as Yie,a as mt,eW as Er,e as et,b1 as RD,a2 as kt,t as Wn,aU as xt}from'./main-RCOGCXYP.js';function j(o,m){}var F="_mat-bottom-sheet-enter",L="_mat-bottom-sheet-exit",z=(()=>{class o extends Wh{_breakpointSubscription;_animationsDisabled=Fs();_animationState="void";_animationStateChanged=new Ee;_destroyed=false;constructor(){super();let e=m(ny);this._breakpointSubscription=e.observe([Yie.Medium,Yie.Large,Yie.XLarge]).subscribe(()=>{let n=this._elementRef.nativeElement.classList;n.toggle("mat-bottom-sheet-container-medium",e.isMatched(Yie.Medium)),n.toggle("mat-bottom-sheet-container-large",e.isMatched(Yie.Large)),n.toggle("mat-bottom-sheet-container-xlarge",e.isMatched(Yie.XLarge));});}enter(){this._destroyed||(this._animationState="visible",this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation(F));}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute("mat-exit",""),this._animationState="hidden",this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(L));}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=true;}_simulateAnimation(e){this._ngZone.run(()=>{this._handleAnimationEvent(true,e),setTimeout(()=>this._handleAnimationEvent(false,e));});}_trapFocus(){super._trapFocus({preventScroll:true});}_handleAnimationEvent(e,n){let t=n===F;(t||n===L)&&this._animationStateChanged.emit({toState:t?"visible":"hidden",phase:e?"start":"done"});}static \u0275fac=function(n){return new(n||o)};static \u0275cmp=mt({type:o,selectors:[["mat-bottom-sheet-container"]],hostAttrs:["tabindex","-1",1,"mat-bottom-sheet-container"],hostVars:9,hostBindings:function(n,t){n&1&&kt("animationstart",function(a){return t._handleAnimationEvent(true,a.animationName)})("animationend",function(a){return t._handleAnimationEvent(false,a.animationName)})("animationcancel",function(a){return t._handleAnimationEvent(false,a.animationName)}),n&2&&(Wn("role",t._config.role)("aria-modal",t._config.ariaModal)("aria-label",t._config.ariaLabel),xt("mat-bottom-sheet-container-animations-enabled",!t._animationsDisabled)("mat-bottom-sheet-container-enter",t._animationState==="visible")("mat-bottom-sheet-container-exit",t._animationState==="hidden"));},features:[et],decls:1,vars:0,consts:[["cdkPortalOutlet",""]],template:function(n,t){n&1&&RD(0,j,0,0,"ng-template",0);},dependencies:[Er],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
