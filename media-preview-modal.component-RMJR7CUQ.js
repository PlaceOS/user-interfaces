...
var MediaPreviewModalComponent = class _MediaPreviewModalComponent {
  ...
  async ngOnInit() {
    try {
      const media = await zh(this.item.id, this.group_id ? { group_id: this.group_id } : {});
...
//# sourceMappingURL=media-preview-modal.component-RMJR7CUQ.js.map
