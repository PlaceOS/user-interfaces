...
var DealsService = class _DealsService extends AsyncHandler {
  constructor() {
    ...
    this._deals = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_deals" } : (
      ...
      loader: async ({ params }) => {
        ...
        const metadata = await ic(params.building, "deals-n-offers").catch(() => ({ details: [] }));
  ...
  async getDeals() {
    const metadata = await ic(this._org.building.id, "deals-n-offers").catch(() => null);
    return metadata?.details instanceof Array ? metadata.details : [];
  }
  async saveDeal(deal) {
    const metadata = await ic(this._org.building.id, "deals-n-offers").catch(() => null);
...
//# debugId=42ef3c63-8804-5583-9656-252ee1a1397f
//# sourceMappingURL=deals.routes-Y3VSRQ2D.js.map
