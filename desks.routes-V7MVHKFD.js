import {
  PrintableComponent
} from "./chunk-CUZCEI34.js";
import {
  DesksStateService
} from "./chunk-IMIEVDTB.js";
import "./chunk-QLTMFDNH.js";
import {
  ExploreZoomControlComponent
} from "./chunk-R2X27V7H.js";
import {
...
function SetDatetimeModalComponent_Conditional_7_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r0.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(10, _c08))("range", ctx_r0.bookable_hours())("use_24hr", ctx_r0.use_24hr_time());
    \u0275\u0275control();
    \u0275\u0275advance(4);
...
var ExploreDeviceInfoComponent = class _ExploreDeviceInfoComponent {
  ...
  async loadUser() {
    if (this.username())
      return;
    const mod = gd(this._details.system, "LocationServices");
    if (!mod)
      return;
  ...
  constructor() {
    ...
    this._desk_list = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_desk_list" } : (
      ...
      loader: ({ params: lvl }) => {
        ...
        return Vu(lvl.id, "desks").catch(() => ({ details: [] })).then((i) => (i?.details instanceof Array ? i.details : []).map((j) => new Desk(__spreadProps(__spreadValues({}, j), { zone: lvl }))));
      }
    }));
...
//# debugId=2818805a-1300-5920-a4fb-2a31cadb1c4d
//# sourceMappingURL=desks.routes-V7MVHKFD.js.map
