...
var _DealDetailsModalComponent = class _DealDetailsModalComponent {
  constructor() {
...
var DealDetailsModalComponent = _DealDetailsModalComponent;
(() => {
...
var _DealsService = class _DealsService {
  constructor() {
...
_DealsService.\u0275fac = function DealsService_Factory(__ngFactoryType__) {
...
function DealsComponent_For_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275classProp("bg-base-100", ctx_r3.type.value === t_r3);
    \u0275\u0275advance();
...
function DealsComponent_For_37_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("source", deal_r6.image);
  }
}
...
var ROUTES = [{ path: "", component: DealsComponent }];
...
_DealsModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [DealsComponent, RouterModule.forChild(ROUTES)] });
...
//# sourceMappingURL=deals.module-F6PWQFUF.js.map
