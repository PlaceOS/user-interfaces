...
} from "./chunk-LHAWUPE7.js";
import {
  DateOptionsComponent
} from "./chunk-4X4ODVUT.js";
import "./chunk-KMUXGWWI.js";
import {
  BookingFormService
...
function VisitorNotesModalComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "main", 2)(1, "mat-form-field", 5)(2, "mat-label");
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "textarea", 6);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function VisitorNotesModalComponent_Conditional_7_Template_textarea_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 3, "FORM.NOTES"));
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.notes);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(6, 5, "APP.CONCIERGE.VISITORS_NOTES_HEADERS"));
  }
}
...
_VisitorNotesModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorNotesModalComponent, selectors: [["visitor-notes-modal"]], decls: 10, vars: 7, consts: [[1, "bg-base-200", "ml-2", "rounded-sm", "px-2", "py-1", "text-sm", "font-medium"], ["icon", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "w-xl", "overflow-auto", "p-4"], ["loading", "", 1, "bg-base-100", "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "border-base-200", "flex", "justify-end", "space-x-2", "border-t", "p-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 1, "h-[60vh]", "max-h-256", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function VisitorNotesModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, VisitorNotesModalComponent_Conditional_7_Template, 7, 7, "main", 2)(8, VisitorNotesModalComponent_Conditional_8_Template, 5, 4, "div", 3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorNotesModalComponent, { className: "VisitorNotesModalComponent", filePath: "apps/concierge/src/app/visitors/visitor-notes-modal.component.ts", lineNumber: 82 });
})();
...
function GuestListingComponent_ng_template_32_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(10, "mat-form-field", 49)(11, "mat-label");
    \u0275\u0275text(12, "Pass Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "input", 50);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function GuestListingComponent_ng_template_32_Conditional_34_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r22);
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_32_Conditional_34_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r22);
      const row_r17 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(14, 8, "BOOKINGS.PASS_NUMBER"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r1.pass_number());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 10, "COMMON.SAVE"), " ");
  }
}
...
function GuestListingComponent_ng_template_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(34, GuestListingComponent_ng_template_32_Conditional_34_Template, 18, 12);
...
_GuestListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GuestListingComponent, selectors: [["guest-listings"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 39, vars: 89, consts: [["state_template", ""], ["person_template", ""], ["host_template", ""], ["id_template", ""], ["parking_template", ""], ["induction_template", ""], ["status_template", ""], ["time_template", ""], ["pass_template", ""], ["date_template", ""], ["action_template", ""], ["notes_template", ""], ["id_confirmation", ""], ["menu", "matMenu"], ["guest_menu", "matMenu"], ["pass_menu", ""], [1, "z-0", "block", "text-sm", "text-base-content", 3, "data", "columns", "filter", "sortable"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", "aria-label", "Download visitor list", 1, "bg-secondary", "absolute", "right-4", "bottom-4", "z-20", "h-12", "w-12", "text-white", "shadow-sm", "hover:shadow-lg", 3, "matTooltip"], [1, "h-8", "w-full"], ["matTooltipPosition", "right", 1, "bg-base-400", "text-neutral-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "bg-warning", "text-warning-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "bg-success", "text-success-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", 3, "matTooltip"], [1, "px-4", "py-2"], [1, "text-xs", "opacity-60"], ["customTooltip", "", 3, "content"], ["matRipple", "", 1, "bg-success", "rounded-3xl", "px-4", "py-2", "text-white"], [1, "bg-base-100", "my-2", "flex", "w-[20rem]", "flex-col", "space-y-2", "rounded-sm", "p-2"], [1, "max-h-80", "max-w-[20rem]", "object-contain", 3, "src"], ["matRipple", "", "aria-label", "Approve ID", 3, "click"], ["matRipple", "", "aria-label", "Reject ID", 1, "inverse", "mt-2", 3, "click"], [1, "bg-success", "text-success-content", "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl"], [1, "px-4"], ["matRipple", "", 1, "h-10", "w-30", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pr-2", "pl-4"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], [1, "text-error", "text-2xl"], [1, "opacity-60"], [1, "flex", "items-center", "justify-end", "px-2"], ["icon", "", "matRipple", "", "aria-label", "More options", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click", "disabled"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "href"], ["mat-menu-item", "", 3, "click", "matMenuTriggerFor"], [1, "w-full", "space-y-2", "px-2", 3, "click"], ["appearance", "outline", 1, "no-subscript"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click", "disabled"], [1, "relative", "mx-auto", "p-4"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", "aria-label", "Edit visitor notes", 3, "click", "matTooltip"], [1, "bg-info", "text-info-content", "absolute", "top-1", "right-1", "flex", "h-4", "w-4", "items-center", "justify-center", "rounded-full", 3, "matTooltip"], ["className", "material-symbols-rounded", 1, "text-sm"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", "aria-label", "Download visitor list", 1, "bg-secondary", "absolute", "right-4", "bottom-4", "z-20", "h-12", "w-12", "text-white", "shadow-sm", "hover:shadow-lg", 3, "click", "matTooltip"]], template: function GuestListingComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GuestListingComponent, { className: "GuestListingComponent", filePath: "apps/concierge/src/app/visitors/guest-listing.component.ts", lineNumber: 666 });
})();
...
function VisitorsComponent_For_23_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function VisitorsComponent_For_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 11)(1, "div", 15);
    \u0275\u0275conditionalCreate(2, VisitorsComponent_For_23_Conditional_2_Template, 5, 3, "div", 16);
...
function VisitorsComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
...
_VisitorsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsComponent, selectors: [["", "app-new-visitors", ""]], attrs: _c02, decls: 31, vars: 20, consts: [[1, "print:hidden"], [1, "flex", "h-px", "flex-1", "print:hidden"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-2", "flex-1"], [1, "mr-2", 3, "modelChange"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "flex", "items-center", "px-8", "pb-4"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "dateChange"], [1, "mx-8", "h-1/2", "flex-1", "overflow-auto"], ["mode", "indeterminate", 1, "w-full"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-60"], [1, "opacity-0"]], template: function VisitorsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(20, "async");
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275listener("ngModelChange", function VisitorsComponent_Template_mat_select_ngModelChange_19_listener($event) {
      return ctx.updateZones($event);
    });
    \u0275\u0275repeaterCreate(22, VisitorsComponent_For_23_Template, 5, 3, "mat-option", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(24, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(25, "div", 5);
    \u0275\u0275elementStart(26, "date-options", 12);
    \u0275\u0275listener("dateChange", function VisitorsComponent_Template_date_options_dateChange_26_listener($event) {
      return ctx.setDate($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 13);
    \u0275\u0275element(28, "guest-listings");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(29, VisitorsComponent_Conditional_29_Template, 1, 0, "mat-progress-bar", 14);
    \u0275\u0275pipe(30, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 10, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", (tmp_3_0 = \u0275\u0275pipeBind1(20, 12, ctx.filters)) == null ? null : tmp_3_0.zones)("placeholder", \u0275\u0275pipeBind1(21, 14, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(24, 16, ctx.levels));
    \u0275\u0275advance(7);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(30, 18, ctx.loading) ? 29 : -1);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorsComponent, { className: "VisitorsComponent", filePath: "apps/concierge/src/app/visitors/visitors.component.ts", lineNumber: 129 });
})();
...
//# sourceMappingURL=visitors.module-JK7CBMJC.js.map
