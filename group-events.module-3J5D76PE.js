...
var GroupEventsStateService = class _GroupEventsStateService {
  constructor() {
    ...
    this.calendar_system = this._org.active_building.pipe(debounceTime(100), switchMap((bld) => !bld ? of(null) : from(ea({ in: this.calendar })).pipe(map((r) => r.data?.[0]), catchError(() => of(null)))), shareReplay(1));
...
var GroupEventsFiltersListComponent = class _GroupEventsFiltersListComponent {
  ...
  static {
    ...
    }, dependencies: [CommonModule, MatRippleModule, MatRipple, IconComponent, AsyncPipe, DatePipe, TranslatePipe], encapsulation: 2 });
  }
};
(() => {
...
var GroupEventsModule = class _GroupEventsModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [GroupEventsComponent, RouterModule.forChild(ROUTES)] });
  }
};
(() => {
...
//# sourceMappingURL=group-events.module-3J5D76PE.js.map
