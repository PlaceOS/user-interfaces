...
import {
  EventsStateService
} from "./chunk-GPHQ5GAN.js";
import "./chunk-KCO4IGZD.js";
import "./chunk-L7PWBL4V.js";
import "./chunk-P6RGEXZT.js";
import "./chunk-YCI7SKOW.js";
import {
  LevelPipe
...
import "./chunk-RD3FANKR.js";
import "./chunk-WBQUNQLL.js";
import {
...
import "./chunk-SBCKD46P.js";
import "./chunk-OKVB4YRR.js";
import "./chunk-ZD6ONGPP.js";
...
function EventDetailsModalComponent_Conditional_88_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 11, "CALENDAR_EVENT.CATERING_ORDER_AT", \u0275\u0275pureFunction1(20, _c02, \u0275\u0275pipeBind2(10, 8, order_r8.deliver_at, "MMM d, " + ctx_r1.time_format()))), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 17, "CALENDAR_EVENT.CATERING_ORDER_DETAILS", \u0275\u0275pureFunction2(22, _c1, order_r8.item_count, \u0275\u0275pipeBind2(15, 14, order_r8.total_cost / 100, ctx_r1.currency_code))), " ");
    \u0275\u0275advance(3);
...
function EventDetailsModalComponent_Conditional_92_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 21, "CALENDAR_EVENT.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(24, _c02, \u0275\u0275pipeBind2(5, 18, request_r11.deliver_at, "MMM d, " + ctx_r1.time_format()))), " ");
    \u0275\u0275advance(3);
...
var EventDetailsModalComponent = class _EventDetailsModalComponent {
  constructor() {
    ...
    this.accept_count = computed(
      () => this.event().attendees.reduce((count, user) => count += user.response_status === "accepted" ? 1 : 0, 0),
    ...
    this.declined_count = computed(
      () => this.event().attendees.reduce((count, user) => count += user.response_status === "declined" ? 1 : 0, 0),
    ...
    this.pending_count = computed(
      () => this.event().attendees.reduce((count, user) => count += user.response_status === "tentative" || user.response_status === "needsAction" ? 1 : 0, 0),
  ...
  async checkin() {
    const mod = zd(this.space()?.id, "Bookings");
    if (!mod)
      return;
...
function SetupBreakdownModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 8, "CALENDAR_EVENT.SETUP_DURATION"));
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r0.form.setup)("min", 0)("custom_options", \u0275\u0275pureFunction0(12, _c03));
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 10, "CALENDAR_EVENT.BREAKDOWN_DURATION"), "Breakdown Duration");
    \u0275\u0275advance(2);
    \u0275\u0275property("min", 0)("formField", ctx_r0.form.breakdown)("custom_options", \u0275\u0275pureFunction0(13, _c03));
    \u0275\u0275control();
  }
}
...
var SetupBreakdownModalComponent = class _SetupBreakdownModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SetupBreakdownModalComponent, selectors: [["setup-breakdown-modal"]], decls: 8, vars: 6, consts: [[1, "min-h-16", "space-x-4"], ["btn", "", "icon", "", "mat-dialog-close", "", "matRipple", ""], [1, "w-full", "min-w-[20rem]", "p-4"], [1, "flex", "h-64", "w-64", "flex-col", "items-center", "justify-center"], [1, "border-base-200", "flex", "justify-end", "border-t", "px-4", "py-2"], [1, "flex", "flex-col", "space-y-2"], ["for", "setup"], [3, "formField", "min", "custom_options"], ["for", "breakdown"], [3, "min", "formField", "custom_options"], [3, "diameter"], [1, "p-4", "text-center"], ["btn", "", "matRipple", "", 3, "click"]], template: function SetupBreakdownModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(5, SetupBreakdownModalComponent_Conditional_5_Template, 11, 14, "main", 2)(6, SetupBreakdownModalComponent_Conditional_6_Template, 4, 1, "div", 3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SetupBreakdownModalComponent, { className: "SetupBreakdownModalComponent", filePath: "libs/events/src/lib/setup-breakdown-modal.component.ts", lineNumber: 80 });
})();

// apps/concierge/src/app/day-view/room-approvals.component.ts
var _c04 = (a0, a1) => ({ count: a0, total: a1 });
var _forTrack0 = ($index, $item) => $item.id;
function RoomBookingsApprovalsComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_For_19_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_For_19_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_For_19_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("source", space_r4?.images[0]);
  }
}
function RoomBookingsApprovalsComponent_For_19_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "hr", 19);
  }
}
function RoomBookingsApprovalsComponent_For_19_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 30);
  }
}
function RoomBookingsApprovalsComponent_For_19_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_For_19_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 30);
  }
}
function RoomBookingsApprovalsComponent_For_19_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsApprovalsComponent_For_19_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 35)(1, "icon");
    \u0275\u0275text(2, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "mat-menu", null, 0)(5, "button", 36);
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_For_19_Conditional_50_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r5);
      const event_r2 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.approveSeries(event_r2));
    });
    \u0275\u0275elementStart(6, "div", 37)(7, "icon", 31);
    \u0275\u0275text(8, "done");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div");
    \u0275\u0275text(10);
    ...
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_For_19_Conditional_50_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r5);
      const event_r2 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.rejectSeries(event_r2));
    });
    \u0275\u0275elementStart(13, "div", 37)(14, "icon", 33);
    \u0275\u0275text(15, "close");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275nextContext();
    const busy_r7 = \u0275\u0275readContextLet(7);
    \u0275\u0275property("disabled", !!busy_r7)("matMenuTriggerFor", menu_r6);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 4, "APP.CONCIERGE.ROOMS_APPROVE_SERIES"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(18, 6, "APP.CONCIERGE.ROOMS_REJECT_SERIES"), " ");
  }
}
function RoomBookingsApprovalsComponent_For_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275conditionalCreate(1, RoomBookingsApprovalsComponent_For_19_Conditional_1_Template, 3, 0, "div", 15);
    \u0275\u0275declareLet(2);
    \u0275\u0275pipe(3, "space");
    \u0275\u0275pipe(4, "async");
    \u0275\u0275pipe(5, "space");
    ...
    \u0275\u0275pipe(13, "date");
    \u0275\u0275pipe(14, "date");
    \u0275\u0275conditionalCreate(15, RoomBookingsApprovalsComponent_For_19_Conditional_15_Template, 3, 5, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(16, RoomBookingsApprovalsComponent_For_19_Conditional_16_Template, 2, 1, "div", 18)(17, RoomBookingsApprovalsComponent_For_19_Conditional_17_Template, 1, 0, "hr", 19);
    \u0275\u0275elementStart(18, "div", 20)(19, "div", 21)(20, "icon", 22);
    \u0275\u0275text(21, "place");
    \u0275\u0275elementEnd()();
    \u0275\u0275declareLet(22);
    \u0275\u0275pipe(23, "building");
    ...
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "div", 20)(32, "div", 21)(33, "icon", 22);
    \u0275\u0275text(34, "person");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_For_19_Template_button_click_38_listener() {
    ...
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(42, RoomBookingsApprovalsComponent_For_19_Conditional_42_Template, 1, 0, "mat-spinner", 30)(43, RoomBookingsApprovalsComponent_For_19_Conditional_43_Template, 2, 0, "icon", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "button", 32);
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_For_19_Template_button_click_44_listener() {
      const event_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(47, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(48, RoomBookingsApprovalsComponent_For_19_Conditional_48_Template, 1, 0, "mat-spinner", 30)(49, RoomBookingsApprovalsComponent_For_19_Conditional_49_Template, 2, 0, "icon", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(50, RoomBookingsApprovalsComponent_For_19_Conditional_50_Template, 19, 8);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    const space_r8 = \u0275\u0275storeLet((event_r2.resources.length ? \u0275\u0275pipeBind1(4, 20, \u0275\u0275pipeBind1(3, 18, event_r2.resources[0]?.email)) : \u0275\u0275pipeBind1(6, 24, \u0275\u0275pipeBind1(5, 22, event_r2.mailbox))) || event_r2.system);
    \u0275\u0275advance(5);
    const busy_r9 = \u0275\u0275storeLet(ctx_r2.in_progress()[event_r2.id]);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(event_r2.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate3(" ", \u0275\u0275pipeBind3(12, 28, event_r2.date, "mediumDate", ctx_r2.tz), " ", \u0275\u0275pipeBind3(13, 32, event_r2.date, ctx_r2.time_format, ctx_r2.tz), " \u2013 ", \u0275\u0275pipeBind3(14, 36, event_r2.date_end, ctx_r2.time_format, ctx_r2.tz), " ");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r2.tz ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(space_r8?.images?.length ? 16 : 17);
    const bld_r10 = \u0275\u0275pipeBind1(23, 40, space_r8?.zones);
    const lvl_r11 = \u0275\u0275pipeBind1(25, 42, space_r8?.zones);
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate1(" ", space_r8?.display_name || space_r8?.name || "No Location", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", bld_r10?.display_name || bld_r10?.name, ", ", lvl_r11?.display_name || lvl_r11?.name, " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", event_r2.organiser?.name || event_r2.host, " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !!busy_r9 || ctx_r2.status()[event_r2.id] === "accept");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(41, 44, ctx_r2.status()[event_r2.id] === "accept" ? "COMMON.APPROVED" : "COMMON.APPROVE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(busy_r9 === "accept" ? 42 : 43);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !!busy_r9 || ctx_r2.status()[event_r2.id] === "decline");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(47, 46, ctx_r2.status()[event_r2.id] === "decline" ? "COMMON.DECLINED" : "COMMON.DECLINE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(busy_r9 === "decline" ? 48 : 49);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(event_r2.recurring_event_id ? 50 : -1);
  }
}
function RoomBookingsApprovalsComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function RoomBookingsApprovalsComponent_Conditional_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
...
var RoomBookingsApprovalsComponent = class _RoomBookingsApprovalsComponent {
  constructor() {
    ...
    this.in_progress = signal(
      {},
      ...ngDevMode ? [{ debugName: "in_progress" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this._in_progress_events = signal(
      {},
      ...ngDevMode ? [{ debugName: "_in_progress_events" }] : (
        /* istanbul ignore next */
        []
      )
    );
    ...
    this.filtered_pending = computed(
      () => {
        ...
        const retained = Object.values(in_progress_events).filter(({ event }) => !events.some((_) => _.id === event.id)).sort((a, b) => a.index - b.index);
        for (const { event, index } of retained) {
          const at = index < 0 ? events.length : Math.min(index, events.length);
          events.splice(at, 0, event);
        }
        return events.filter((event) => !status[event.id] && (!event.recurring_event_id || !status[event.recurring_event_id]) && (event.title.toLowerCase().includes(search) || event.host.toLowerCase().includes(search) || event.organiser?.name?.toLowerCase().includes(search)));
      },
  ...
  async approveSeries(event) {
    ...
    try {
      await mod.execute("accept_recurring_event", [event.mailbox, event.recurring_event_id || event.id], 30 * 1e3);
    } catch (e) {
  ...
  async rejectSeries(event) {
    ...
    try {
      await mod.execute("decline_recurring_event", [event.mailbox, event.recurring_event_id || event.id], 30 * 1e3);
    } catch (e) {
      this._clearInProgress(events);
  ...
  _seriesEvents(event) {
    ...
    const events = this.pending().filter((_) => (_.recurring_event_id || _.id) === recurring_event_id);
    return events.length ? events : [event];
  }
  _setInProgress(events, action) {
    const pending = this.pending();
    this.in_progress.update((s) => __spreadValues(__spreadValues({}, s), Object.fromEntries(events.map((event) => [event.id, action]))));
    this._in_progress_events.update((s) => __spreadValues(__spreadValues({}, s), Object.fromEntries(events.map((event) => [
      event.id,
      {
        event,
  ...
  _clearInProgress(events) {
    this.in_progress.update((s) => {
      const next = __spreadValues({}, s);
  ...
  _eventWithStatus(event, status) {
    ...
    return new CalendarEvent(__spreadProps(__spreadValues({}, event), {
      status,
      resources: event.resources.map((resource2) => __spreadProps(__spreadValues({}, resource2), {
        response_status
      })),
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsApprovalsComponent, selectors: [["room-bookings-approvals"]], decls: 21, vars: 20, consts: [["menu", "matMenu"], [1, "border-base-300", "flex", "h-full", "w-[20rem]", "flex-col", "overflow-hidden", "border-l"], [1, "border-base-200", "relative", "flex", "items-center", "justify-center", "space-x-2", "border-b", "p-2"], ["icon", "", "default", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "top-3", "left-2", 3, "click", "matTooltip"], [1, "flex-1", "py-3", "text-center"], [1, "bg-info-light", "rounded-full", "px-2", "py-1", "text-xs"], [1, "border-base-300", "relative", "-mt-px", "border-b"], ["type", "text", 1, "w-full", "py-4", "pr-4", "pl-10", 3, "ngModelChange", "placeholder", "ngModel"], [1, "pointer-events-none", "absolute", "top-1/2", "left-2", "-translate-y-1/2", "text-2xl"], [1, "bg-base-200", "flex-1", "space-y-1", "overflow-auto", "p-1"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "border-base-300", "bg-base-100", "hover:border-info", "relative", "w-full", "rounded-lg", "border", "p-2", "hover:shadow-lg"], ["icon", "", "default", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "top-3", "-left-7", 3, "matTooltip"], ["src", "assets/icons/no-pending.svg"], [1, "opacity-30"], ["matTooltip", "Recurring Series", "matTooltipPosition", "left", 1, "absolute", "top-3", "right-2", "text-2xl"], [1, "font-medium"], [1, "mb-2", "text-xs", "opacity-30"], [1, "bg-base-200", "mb-2", "h-32", "w-full", "overflow-hidden", "rounded-sm"], [1, "border-base-300", "bg-base-200", "mb-2"], [1, "mb-2", "flex", "items-center", "space-x-2"], [1, "bg-base-200", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full"], [1, "text-xl"], [1, "flex-1"], [1, "text-sm"], [1, "text-xs", "opacity-50"], [1, "flex-1", "text-sm"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "border-success", "bg-success-light", "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "text-black", 3, "click", "disabled"], [1, "ml-2"], ["diameter", "20", 1, "mx-2", "min-w-5"], [1, "text-success", "text-2xl"], ["btn", "", "matRipple", "", 1, "border-error", "bg-error-light", "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "text-black", 3, "click", "disabled"], [1, "text-error", "text-2xl"], ["auth", "", 1, "min-h-full", "min-w-full", "object-cover", "object-center", 3, "source"], ["icon", "", "matRipple", "", 1, "border-base-300", "bg-base-200", "h-12", "w-12", "rounded-md", "border", 3, "disabled", "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2", "pr-4"], ["icon", "", "default", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "top-3", "-left-7", 3, "click", "matTooltip"]], template: function RoomBookingsApprovalsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(13, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function RoomBookingsApprovalsComponent_Template_input_ngModelChange_12_listener($event) {
        ...
        \u0275\u0275conditionalCreate(17, RoomBookingsApprovalsComponent_Conditional_17_Template, 5, 3, "div", 10);
        \u0275\u0275repeaterCreate(18, RoomBookingsApprovalsComponent_For_19_Template, 51, 48, "div", 11, _forTrack0);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(20, RoomBookingsApprovalsComponent_Conditional_20_Template, 4, 3, "button", 12);
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(8, 12, "APP.CONCIERGE.ROOMS_PENDING_HEADER", \u0275\u0275pureFunction2(17, _c04, ctx.filtered_pending().length || "0", ctx.pending().length || "0")), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate2(" ", ctx.filtered_pending().length || "0", " of ", ctx.pending().length || "0", " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(13, 15, "COMMON.SEARCH"));
        \u0275\u0275twoWayProperty("ngModel", ctx.search);
        \u0275\u0275control();
        \u0275\u0275advance(5);
        \u0275\u0275conditional(!ctx.filtered_pending().length ? 17 : -1);
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.filtered_pending());
        \u0275\u0275advance(2);
        \u0275\u0275conditional(!ctx.show() ? 20 : -1);
      }
    }, dependencies: [
      CommonModule,
      IconComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsApprovalsComponent, { className: "RoomBookingsApprovalsComponent", filePath: "apps/concierge/src/app/day-view/room-approvals.component.ts", lineNumber: 314 });
})();

// apps/concierge/src/app/day-view/room-bookings-list.component.ts
var _c05 = (a0, a1) => ({ key: "date", name: a0, content: a1, size: "4rem", sortable: false });
var _c12 = (a0, a1) => ({ key: "date", name: a0, content: a1, size: "9rem" });
var _c22 = (a0) => ({ key: "room_name", name: a0 });
var _c32 = (a0, a1) => ({ key: "host", name: a0, content: a1 });
...
function RoomBookingsListComponent_ng_template_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const user_r6 = \u0275\u0275pipeBind1(2, 5, \u0275\u0275pipeBind2(1, 2, email_r4, "email-prefix"));
    const attendee_name_r7 = \u0275\u0275nextContext().hostAttendeeName(row_r5.source_event);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", user_r6?.name || attendee_name_r7 || user_r6?.email || email_r4, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(user_r6?.name || attendee_name_r7 ? 6 : -1);
  }
}
function RoomBookingsListComponent_ng_template_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, row_r8.type === "external" ? "COMMON.TYPE_EXTERNAL" : row_r8.type === "cancelled" ? "COMMON.TYPE_CANCELLED" : "COMMON.TYPE_INTERNAL"), " ");
  }
}
function RoomBookingsListComponent_ng_template_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classProp("bg-error!", !row_r9.deleted && (row_r9.type === "cancelled" || row_r9.status === "declined"))("text-error-content!", !row_r9.deleted && (row_r9.type === "cancelled" || row_r9.status === "declined"))("bg-neutral!", row_r9.deleted)("text-neutral-content!", row_r9.deleted)("bg-warning!", row_r9.status === "tentative" && !row_r9.deleted)("text-warning-content!", row_r9.status === "tentative" && !row_r9.deleted);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 13, row_r9.deleted ? "APP.CONCIERGE.BOOKING_STATUS_DELETED" : row_r9.type === "cancelled" || row_r9.status === "declined" ? "APP.CONCIERGE.BOOKING_STATUS_DECLINED" : row_r9.status === "tentative" ? "APP.CONCIERGE.BOOKING_STATUS_PENDING" : "APP.CONCIERGE.BOOKING_STATUS_APPROVED"), " ");
  }
}
function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const row_r11 = \u0275\u0275nextContext(2).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.edit(row_r11));
    });
...
function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_7_Template_button_click_0_listener() {
      ...
      const row_r11 = \u0275\u0275nextContext(2).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.cancel(row_r11));
    });
    \u0275\u0275elementStart(1, "div", 29)(2, "icon", 31);
    \u0275\u0275text(3, "delete");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div");
    \u0275\u0275text(5);
...
function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_8_Template_button_click_0_listener() {
      ...
      const row_r11 = \u0275\u0275nextContext(2).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.print(row_r11));
    });
    \u0275\u0275elementStart(1, "div", 29)(2, "icon", 30);
    \u0275\u0275text(3, "print");
    \u0275\u0275elementEnd();
...
function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_9_Template_button_click_0_listener() {
      ...
      const row_r11 = \u0275\u0275nextContext(2).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.cancel(row_r11, true));
    });
    \u0275\u0275elementStart(1, "div", 29)(2, "icon", 31);
    \u0275\u0275text(3, "delete");
    \u0275\u0275elementEnd();
...
function RoomBookingsListComponent_ng_template_24_Conditional_0_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoomBookingsListComponent_ng_template_24_Conditional_0_For_11_Template_button_click_0_listener() {
      const act_r16 = \u0275\u0275restoreView(_r15).$implicit;
      const row_r11 = \u0275\u0275nextContext(2).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.performAction(row_r11, act_r16.id));
    });
    \u0275\u0275elementStart(1, "div", 29)(2, "icon", 30);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(act_r16.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(act_r16.name);
  }
}
function RoomBookingsListComponent_ng_template_24_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "button", 26)(2, "icon");
    \u0275\u0275text(3, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "mat-menu", null, 6);
    \u0275\u0275conditionalCreate(6, RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_6_Template, 7, 3, "button", 27);
    \u0275\u0275conditionalCreate(7, RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_7_Template, 7, 3, "button", 27);
    \u0275\u0275conditionalCreate(8, RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_8_Template, 7, 3, "button", 27);
    \u0275\u0275conditionalCreate(9, RoomBookingsListComponent_ng_template_24_Conditional_0_Conditional_9_Template, 7, 3, "button", 27);
    \u0275\u0275repeaterCreate(10, RoomBookingsListComponent_ng_template_24_Conditional_0_For_11_Template, 6, 2, "button", 27, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const action_menu_r17 = \u0275\u0275reference(5);
    const row_r11 = \u0275\u0275nextContext().row;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", action_menu_r17);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(row_r11.recurring_event_id ? 9 : -1);
    \u0275\u0275advance();
...
function RoomBookingsListComponent_ng_template_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.show_actions(row_r11) ? 0 : -1);
  }
}
var RoomBookingsListComponent = class _RoomBookingsListComponent {
  constructor() {
    ...
    this.bookings = computed(
      () => [...this.events()].filter((event) => !event.extension_data?.shared_event).sort((a, b) => a.date - b.date).map((event) => __spreadProps(__spreadValues({}, event), {
        source_event: event,
    ...
    this.custom_actions = computed(
      ...
      ...ngDevMode ? [{ debugName: "custom_actions" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  hostAttendeeName(event) {
    const host_email = event.host.toLowerCase();
    return event.attendees?.find(({ email }) => email.toLowerCase() === host_email)?.name || "";
  }
  room_name(event) {
    const space = this.spaces().find((item) => event.resources?.some((resource2) => resource2.id === item.id || resource2.email === item.email) || event.system?.id === item.id || event.system?.email === item.email);
    return space?.display_name || space?.name || event.location || i18n("RESOURCE.ROOM") || "";
  }
  static {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsListComponent, selectors: [["room-bookings-list"]], features: [\u0275\u0275ProvidersFeature([UserPipe])], decls: 26, vars: 57, consts: [["date_template", ""], ["period_template", ""], ["user_template", ""], ["type_template", ""], ["status_template", ""], ["action_template", ""], ["action_menu", "matMenu"], [1, "flex", "h-full", "w-full", "flex-col"], [1, "border-base-200", "bg-base-100", "flex", "items-center", "justify-center", "border-b", "p-2"], [3, "dateChange", "date", "step", "display_mode", "week_start", "is_new", "hide_today"], [1, "min-h-0", "flex-1", "overflow-auto", "px-8", "pb-16"], [1, "block", "min-w-368", "text-sm", 3, "data", "columns", "empty_message", "sortable"], [1, "absolute", "top-14", "right-0", "bottom-0", "left-0", "z-30", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-2"], [1, "bg-base-100", "absolute", "inset-0", "z-0", "opacity-80"], ["diameter", "32"], [1, "relative", "z-10"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-2"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], [1, "max-w-48", "truncate", "text-xs", "opacity-30", "select-all"], [1, "px-4", "py-2"], [1, "bg-success", "text-success-content", "inline-flex", "rounded-full", "px-3", "py-1", "text-xs"], [1, "mx-auto"], ["icon", "", "default", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "text-error", "text-2xl"]], template: function RoomBookingsListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(14, RoomBookingsListComponent_ng_template_14_Template, 7, 8, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(16, RoomBookingsListComponent_ng_template_16_Template, 3, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(18, RoomBookingsListComponent_ng_template_18_Template, 7, 7, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(20, RoomBookingsListComponent_ng_template_20_Template, 3, 3, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(22, RoomBookingsListComponent_ng_template_22_Template, 4, 15, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(24, RoomBookingsListComponent_ng_template_24_Template, 1, 1, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        ...
        const type_template_r21 = \u0275\u0275reference(21);
        const status_template_r22 = \u0275\u0275reference(23);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("data", ctx.bookings())("columns", \u0275\u0275pureFunction8(48, _c8, \u0275\u0275pureFunction2(27, _c05, \u0275\u0275pipeBind1(5, 11, "FORM.DATE"), date_template_r18), \u0275\u0275pureFunction2(30, _c12, \u0275\u0275pipeBind1(6, 13, "FORM.PERIOD"), period_template_r19), \u0275\u0275pureFunction1(33, _c22, \u0275\u0275pipeBind1(7, 15, "RESOURCE.ROOM")), \u0275\u0275pureFunction2(35, _c32, \u0275\u0275pipeBind1(8, 17, "FORM.HOST"), user_template_r20), \u0275\u0275pureFunction1(38, _c4, \u0275\u0275pipeBind1(9, 19, "FORM.TITLE")), \u0275\u0275pureFunction2(40, _c5, \u0275\u0275pipeBind1(10, 21, "COMMON.TYPE"), type_template_r21), \u0275\u0275pureFunction2(43, _c6, \u0275\u0275pipeBind1(11, 23, "COMMON.STATUS"), status_template_r22), \u0275\u0275pureFunction1(46, _c7, action_template_r23)))("empty_message", \u0275\u0275pipeBind1(12, 25, "APP.CONCIERGE.SCHEDULE_EMPTY"))("sortable", true);
        \u0275\u0275advance(9);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsListComponent, { className: "RoomBookingsListComponent", filePath: "apps/concierge/src/app/day-view/room-bookings-list.component.ts", lineNumber: 316 });
})();

// apps/concierge/src/app/day-view/room-booking-search.component.ts
var _c06 = ["input_el"];
var _c13 = (a0, a1) => ({ count: a0, total: a1 });
...
function RoomBookingSearchComponent_Conditional_8_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", event_r4.system?.display_name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 25, \u0275\u0275pipeBind1(21, 23, event_r4.host))?.name || event_r4.host, " ");
  }
}
function RoomBookingSearchComponent_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 2, "APP.CONCIERGE.ROOMS_SEARCH_COUNT", \u0275\u0275pureFunction2(5, _c13, ctx_r1.filtered().length, ctx_r1.events().length)), " ");
    \u0275\u0275advance(2);
...
var RoomBookingSearchComponent = class _RoomBookingSearchComponent extends AsyncHandler {
  constructor() {
    ...
    this._input_element = viewChild(
      "input_el",
      ...ngDevMode ? [{ debugName: "_input_element" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingSearchComponent, selectors: [["room-booking-search"]], viewQuery: function RoomBookingSearchComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuerySignal(ctx._input_element, _c06, 5);
      }
      if (rf & 2) {
        \u0275\u0275queryAdvance();
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingSearchComponent, { className: "RoomBookingSearchComponent", filePath: "apps/concierge/src/app/day-view/room-booking-search.component.ts", lineNumber: 144 });
})();
...
function RoomBookingsInvertedTimelineComponent_For_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", (ctx_r2.events()[space_r6.id] || \u0275\u0275pureFunction0(6, _c14)).length, " ");
  }
}
...
function RoomBookingsInvertedTimelineComponent_For_24_For_3_Conditional_0_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("opacity-60", event_r11.status === "cancelled");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", event_r11.organiser?.name || event_r11.host, " ");
  }
}
...
function RoomBookingsInvertedTimelineComponent_For_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(1, "div", 27);
    \u0275\u0275repeaterCreate(2, RoomBookingsInvertedTimelineComponent_For_24_For_3_Template, 1, 1, null, null, _forTrack02);
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.events()[space_r12.id] || \u0275\u0275pureFunction0(8, _c14));
  }
}
...
var RoomBookingsInvertedTimelineComponent = class _RoomBookingsInvertedTimelineComponent extends AsyncHandler {
  constructor() {
    ...
    this._settings = inject(SettingsService);
    this._org = inject(OrganisationService);
    this._timeline_el = viewChild(
      "timeline_el",
      ...ngDevMode ? [{ debugName: "_timeline_el" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this._building = this._org.active_building;
    this._filtered = this._state.filtered;
    ...
    this.hours = computed(
      () => this._hour_list.filter((hour) => hour >= this.block_start && hour < this.block_end),
    ...
    effect(() => {
      const spaces = this.spaces();
      const date = this.date();
      if (this._did_auto_scroll || !spaces.length)
        return;
      this.timeout("auto_scroll", () => this._autoScrollToCurrentTime(date), 100);
    });
  }
  get now() {
...
Host:  ${event.organiser?.name || event.host}`;
  ...
  viewEvent(event, space_id, scroll_to = false) {
    ...
    this.subscription("actions", ref.componentInstance.action.subscribe(async (action) => {
      ...
      const data = await nextValueFrom(ref2.afterClosed());
      if (data)
        this._state.replace(data);
    }));
  }
  ...
  static {
    this.\u0275fac = function RoomBookingsInvertedTimelineComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _RoomBookingsInvertedTimelineComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsInvertedTimelineComponent, selectors: [["room-bookings-inverted-timeline"]], viewQuery: function RoomBookingsInvertedTimelineComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("selected", function RoomBookingsInvertedTimelineComponent_Template_room_booking_search_selected_5_listener($event) {
          return ctx.viewEvent($event, $event.system?.id, true);
        });
        \u0275\u0275elementEnd()()();
...
(() => {
  ...
  }], () => [], { _timeline_el: [{ type: ViewChild, args: ["timeline_el", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsInvertedTimelineComponent, { className: "RoomBookingsInvertedTimelineComponent", filePath: "apps/concierge/src/app/day-view/room-timeline-inverted.component.ts", lineNumber: 280 });
})();
...
function RoomBookingsTimelineComponent_For_26_For_1_Conditional_0_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("opacity-60", event_r7.status === "cancelled");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", event_r7.organiser?.name || event_r7.host, " ");
  }
}
...
function RoomBookingsTimelineComponent_For_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, RoomBookingsTimelineComponent_For_26_For_1_Template, 1, 1, null, null, _forTrack03);
  }
  if (rf & 2) {
    const space_r8 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275repeater(ctx_r2.events()[space_r8.id] || \u0275\u0275pureFunction0(0, _c08));
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsTimelineComponent, selectors: [["room-bookings-timeline"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 28, vars: 16, consts: [[1, "bg-info", "text-info-content", "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "p-2", "text-center", "text-xs"], [1, "border-base-200", "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "p-2"], [3, "dateChange", "date", "is_new", "hide_today"], [1, "text-info", "absolute", "top-1/2", "left-10", "-translate-y-1/2", "text-sm"], [1, "absolute", "top-1/2", "right-8", "-translate-y-1/2"], [3, "selected"], ["timeline", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["timezone", "", 1, "bg-base-100", "sticky", "top-0", "left-0", "z-30", "flex", "items-center", "justify-center"], [1, "text-xs", "opacity-30"], [1, "bg-base-300", "absolute", "right-0", "bottom-0", "h-2", "w-px"], [1, "bg-base-300", "absolute", "right-0", "bottom-0", "h-px", "w-2"], ["space-headers", "", 1, "border-base-300", "bg-base-100", "sticky", "top-0", "z-20", "flex", "items-center", "border-b"], [1, "relative", "flex", "h-full", "w-56", "items-center", "justify-center", "px-4"], ["hour-blocks", "", 1, "border-base-300", "bg-base-100", "sticky", "left-0", "z-10", "overflow-visible", "border-r"], [1, "relative", "w-full", 3, "height"], [1, "bg-secondary", "absolute", "right-0", "h-2", "w-2", "translate-x-1/2", "-translate-y-1/2", "rounded-full", 3, "top"], ["space-blocks", "", 1, "relative", "overflow-hidden"], [1, "border-base-200", "relative", "w-full", "border-b", 3, "height"], [1, "bg-base-200", "absolute", "top-0", "h-full", "w-px", 3, "left"], [1, "bg-secondary", "absolute", "inset-x-0", "h-[2px]", 3, "top"], [1, "truncate", "px-4"], [1, "bg-base-300", "absolute", "bottom-0", "-left-px", "h-2", "w-px"], [1, "relative", "w-full"], [1, "bg-base-300", "absolute", "-top-px", "right-0", "h-px", "w-2"], [1, "absolute", "-top-px", "right-3", "-translate-y-1/2", "text-xs", "opacity-60"], [1, "bg-secondary", "absolute", "right-0", "h-2", "w-2", "translate-x-1/2", "-translate-y-1/2", "rounded-full"], [1, "border-base-200", "relative", "w-full", "border-b"], [1, "bg-base-200", "absolute", "top-0", "h-full", "w-px"], ["event", "", "matRipple", "", 1, "absolute", "w-52", "text-left", "hover:opacity-90", 3, "left", "top", "height", "matTooltip"], ["event", "", "matRipple", "", 1, "absolute", "w-52", "text-left", "hover:opacity-90", 3, "click", "matTooltip"], [1, "border-base-200", "bg-base-100", "hover:bg-base-200", "relative", "h-full", "w-full", "overflow-hidden", "rounded-lg", "border", "px-3", "py-1", "text-xs", "shadow-sm"], [1, "bg-secondary", "absolute", "-inset-px", "opacity-30"], [1, "absolute", "inset-y-0", "left-0", "w-1"], [1, "truncate"], [1, "bg-secondary", "absolute", "inset-x-0", "h-[2px]"]], template: function RoomBookingsTimelineComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(25, RoomBookingsTimelineComponent_For_26_Template, 2, 1, null, null, _forTrack03);
...
function RoomWeekBookingsTimelineComponent_For_19_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RoomWeekBookingsTimelineComponent_For_19_For_2_Template_button_click_0_listener() {
      const event_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.viewEvent(event_r4, event_r4.system?.id));
    });
    \u0275\u0275element(1, "div", 21);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", event_r4.system?.display_name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 21, \u0275\u0275pipeBind2(14, 18, event_r4.host, "email-prefix"))?.name || ctx_r1.hostAttendeeName(event_r4) || event_r4.host, " ");
  }
}
function RoomWeekBookingsTimelineComponent_For_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275repeaterCreate(1, RoomWeekBookingsTimelineComponent_For_19_For_2_Template, 16, 23, "button", 19, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.events()[date_r5] || \u0275\u0275pureFunction0(0, _c09));
  }
}
var RoomWeekBookingsTimelineComponent = class _RoomWeekBookingsTimelineComponent extends AsyncHandler {
  ...
  viewEvent(event, space_id, scroll_to = false) {
    ...
    this.subscription("actions", ref.componentInstance.action.subscribe((action) => {
      ...
      nextValueFrom(ref2.afterClosed()).then((data) => {
        if (data)
          this._state.replace(data);
      });
    }));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RoomWeekBookingsTimelineComponent, [{
    ...
    `, imports: [
      ...
      TranslatePipe,
      UserPipe
    ], styles: ["/* angular:styles/component:css;1b7892d84bac57db6254c251f0e57a189213a188a333a12063f142382ead8941;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/day-view/room-week-timeline.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  max-width: 100%;\n}\n[timeline] {\n  grid-template-columns: 5rem auto;\n  grid-template-rows: 3.5rem auto;\n}\n/*# sourceMappingURL=room-week-timeline.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomWeekBookingsTimelineComponent, { className: "RoomWeekBookingsTimelineComponent", filePath: "apps/concierge/src/app/day-view/room-week-timeline.component.ts", lineNumber: 213 });
})();
...
var RoomBookingsComponent = class _RoomBookingsComponent extends AsyncHandler {
  constructor() {
    ...
    this.downloading = signal(
      false,
      ...ngDevMode ? [{ debugName: "downloading" }] : (
        /* istanbul ignore next */
        []
      )
    );
    ...
    this._levels = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_levels" } : (
      ...
      loader: async ({ params }) => {
        ...
        if (!zone_id)
          return [];
        const spaces = await nextValueFrom(requestSpacesForZone(zone_id)).catch(() => []);
    ...
    effect(() => {
      ...
      if (this._levels.status() !== "resolved")
        return;
      untracked(() => {
        if (this.use_region)
          return;
  ...
  static {
    this.\u0275fac = function RoomBookingsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _RoomBookingsComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsComponent, selectors: [["room-bookings"]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], decls: 60, vars: 47, consts: [["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden"], [1, "flex", "w-full", "items-center", "gap-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "day"], ["value", "week"], ["icon", "", "matRipple", "", 1, "border-secondary", "h-12", "w-12", "rounded", "border", 3, "click", "matTooltip", "disabled"], ["diameter", "24"], [1, "text-2xl"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click"], [1, "pl-2"], [1, "border-base-300", "bg-base-100", "flex", "overflow-hidden", "rounded-lg", "border"], ["icon", "", "matRipple", "", 1, "hover:bg-base-200", "h-12", "w-12", "rounded-none", 3, "click", "matTooltip"], [1, "flex", "w-full", "items-center", "gap-2", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "ngModel"], [1, "flex", "flex-1", "justify-end"], [1, "border-base-300", "bg-base-200", "flex", "max-w-lg", "flex-1", "items-center", "rounded-full", "border"], [1, "flex", "w-px", "flex-1", "items-center", "space-x-1", "overflow-x-auto", "rounded-l-full", "px-1"], ["btn", "", "matRipple", "", 1, "inverse", "bg-base-100", 3, "matMenuTriggerFor"], [1, "mx-2"], [1, ""], [1, "flex", "w-48", "flex-col", "space-y-2", "overflow-hidden"], [1, "border-base-200", "mt-4", "flex", "h-px", "w-full", "flex-1", "border-t"], [1, "relative", "z-0", "w-1/2", "flex-1"], [1, "relative", "z-10"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [1, "border-base-300", "bg-base-100", "flex", "items-center", "rounded-full", "border"], [1, "m-2", "h-4", "w-4", "rounded-full"], [1, "truncate", "text-sm"], ["icon", "", "matRipple", "", 1, "text-base-300", "hover:text-base-content", 3, "click"], [1, "text-xl"]], template: function RoomBookingsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(43, RoomBookingsComponent_For_44_Template, 1, 1, null, null, _forTrack04);
        \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsComponent, { className: "RoomBookingsComponent", filePath: "apps/concierge/src/app/day-view/room-bookings.component.ts", lineNumber: 270 });
})();
...
var DayViewComponent = class _DayViewComponent {
  constructor() {
    ...
    const sub = this._router.events.subscribe(() => this._url.set(this._router.url));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DayViewComponent, selectors: [["", "app-new-dayview", ""]], decls: 5, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"]], template: function DayViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DayViewComponent, { className: "DayViewComponent", filePath: "apps/concierge/src/app/day-view/day-view.component.ts", lineNumber: 47 });
})();

// apps/concierge/src/app/day-view/day-view.routes.ts
var ROUTES = [
...
//# debugId=1150aa44-3ff6-5cd9-a0be-0e3888968fbf
//# sourceMappingURL=day-view.routes-2AVS47H6.js.map
