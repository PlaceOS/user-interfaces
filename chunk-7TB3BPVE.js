...
function DeskModalComponent_Conditional_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "mat-form-field", 31)(6, "mat-select", 36);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275repeaterCreate(8, DeskModalComponent_Conditional_6_Conditional_1_For_9_Template, 2, 2, "mat-option", 37, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
...
function DeskModalComponent_Conditional_6_Conditional_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "icon", 38);
    \u0275\u0275text(2, "warning");
    \u0275\u0275elementEnd();
...
function DeskModalComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(65, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementStart(66, "label", 30);
    \u0275\u0275text(67);
    \u0275\u0275pipe(68, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(69, "item-list-field", 29);
    \u0275\u0275pipe(70, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementStart(71, "label", 28);
    \u0275\u0275text(72);
    \u0275\u0275pipe(73, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(74, "mat-form-field", 31);
    \u0275\u0275element(75, "textarea", 32);
    \u0275\u0275pipe(76, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "label", 33);
    \u0275\u0275text(78);
    \u0275\u0275pipe(79, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "mat-form-field", 10);
    \u0275\u0275element(81, "input", 32);
    \u0275\u0275pipe(82, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "label", 34);
    \u0275\u0275text(84);
    \u0275\u0275pipe(85, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "mat-form-field", 10);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 36, "APP.CONCIERGE.DESKS_ID"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("formField", ctx_r2.form.id);
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 38, "FORM.ID_REQUIRED"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 40, "APP.CONCIERGE.DESKS_NAME"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("formField", ctx_r2.form.name);
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(24, 42, "FORM.NAME_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(28, 44, "EXPLORE.MAP_ID"));
    \u0275\u0275advance(6);
    \u0275\u0275property("formField", ctx_r2.form.map_id)("placeholder", \u0275\u0275pipeBind1(34, 46, "APP.CONCIERGE.DESKS_MAP_ID_PLACEHOLDER"));
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(37, 48, "EXPLORE.MAP_ID_REQUIRED"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(39, 50, "APP.CONCIERGE.POI_MAP_SELECT"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(44, 52, "APP.CONCIERGE.USER_ASSIGNED"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r2.form.assigned_user);
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(48, 54, "APP.CONCIERGE.USER_CLEAR"));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r2.future_bookings().length ? 51 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r2.form.bookable)("label", \u0275\u0275pipeBind1(54, 56, "COMMON.BOOKABLE"));
    \u0275\u0275control();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(58, 58, "COMMON.GROUPS"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(60, 60, "BOOKINGS.GROUPS"))("formField", ctx_r2.form.groups);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(63, 62, "COMMON.FEATURES"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(65, 64, "COMMON.FEATURES"))("formField", ctx_r2.form.features);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(68, 66, "COMMON.TAGS"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(70, 68, "COMMON.TAGS"))("formField", ctx_r2.form.tags);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(73, 70, "FORM.NOTES"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(76, 72, "FORM.NOTES"))("formField", ctx_r2.form.notes);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(79, 74, "APP.CONCIERGE.DESKS_HOMEBASE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(82, 76, "APP.CONCIERGE.DESKS_HOMEBASE"))("formField", ctx_r2.form.homebase);
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(85, 78, "APP.CONCIERGE.DESKS_SECURITY"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(88, 80, "APP.CONCIERGE.DESKS_SECURITY"))("formField", ctx_r2.form.security);
    \u0275\u0275control();
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskModalComponent, selectors: [["desk-modal"]], outputs: { event: "event" }, decls: 12, vars: 8, consts: [[1, "w-lg"], [1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "flex-col", "overflow-auto", "p-4"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "border-base-300", "flex", "items-center", "justify-end", "space-x-2", "border-t", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "w-full"], ["for", "id"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "placeholder", "desk-10.123", 3, "formField"], [1, "flex", "space-x-2"], [1, "w-1/3", "flex-1"], ["for", "name"], ["matInput", "", "placeholder", "e.g. Office Desk", 3, "formField"], ["for", "map-id"], ["matInput", "", 3, "formField", "placeholder"], ["icon", "", "matRipple", "", 1, "border-secondary", "text-secondary", "h-12", "w-12", "min-w-12", "rounded-sm", "border", 3, "click", "matTooltip"], ["for", "user"], [1, "mb-4", "flex", "space-x-2"], [1, "flex-1", 3, "formField"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "min-w-12", "rounded-sm", 3, "click", "matTooltip"], ["className", "material-symbols-outlined"], [1, "bg-warning/10", "border-warning", "text-warning-content", "mb-4", "flex", "items-start", "space-x-2", "rounded-sm", "border", "p-2", "text-sm"], [1, "flex", "space-x-4", "pb-4"], [1, "flex-1", 3, "formField", "label"], [1, "flex-1"], ["for", "notes"], [1, "w-full", 3, "placeholder", "formField"], ["for", "tags"], ["appearance", "outline"], ["matInput", "", 3, "placeholder", "formField"], ["for", "homebase"], ["for", "security"], ["for", "level"], [3, "formField", "placeholder"], [3, "value"], [1, "text-warning"], ["diameter", "32"]], template: function DeskModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(6, DeskModalComponent_Conditional_6_Template, 89, 82, "main", 4)(7, DeskModalComponent_Conditional_7_Template, 5, 3, "main", 5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskModalComponent, { className: "DeskModalComponent", filePath: "apps/concierge/src/app/desks/desk-modal.component.ts", lineNumber: 315 });
})();
...
var DesksStateService = class _DesksStateService extends AsyncHandler {
        ...
        try {
          ...
          if (zones.length && !params.zones.includes("All")) {
            const metadata = await Promise.all(zones.map(async (zone) => ({
              zone,
              details: await ic(zone, "desks").then((item) => item.details instanceof Array ? item.details : []).catch(() => [])
            })));
            list = metadata.flatMap(({ zone, details }) => details.map((item) => __spreadProps(__spreadValues({}, item), {
              zone: { id: zone }
            })));
          } else {
            const metadata = await ac(this._org.building?.id, { name: "desks" }).catch(() => []);
  ...
  async _checkAssignedDeskLimit(user_email, current_desk_id) {
    ...
    const levels = this._currentLevelList();
    const desks = this._settings.get("app.desks.use_assets") ? await queryDeskAssetsForZones(levels.map((level) => level.id)) : (await Promise.all(levels.map((level) => ic(level.id, "desks").then((metadata) => metadata.details instanceof Array ? metadata.details : []).catch(() => [])))).flat();
...
//# debugId=9d39751e-5ae9-581f-ba90-03375caf498b
//# sourceMappingURL=chunk-7TB3BPVE.js.map
