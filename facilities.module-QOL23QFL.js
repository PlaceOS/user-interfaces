...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FacilitiesMapComponent, { className: "FacilitiesMapComponent", filePath: "apps/concierge/src/app/facilities/facilities-map.component.ts", lineNumber: 36 });
})();
...
var FacilitiesStatusComponent = class _FacilitiesStatusComponent {
  constructor() {
    this.feedback = signal("", ...ngDevMode ? [{ debugName: "feedback" }] : (
...
var FacilitiesTopbarComponent = class _FacilitiesTopbarComponent extends AsyncHandler {
  constructor() {
    ...
    this.type_list = signal(this.types.map((i) => `${i.id}`), ...ngDevMode ? [{ debugName: "type_list" }] : (
      /* istanbul ignore next */
      []
    ));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FacilitiesTopbarComponent, { className: "FacilitiesTopbarComponent", filePath: "apps/concierge/src/app/facilities/facilities-topbar.component.ts", lineNumber: 75 });
})();
...
var FacilitiesComponent = class _FacilitiesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FacilitiesComponent, selectors: [["", "app-new-facilities", ""]], attrs: _c02, decls: 8, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "flex-1"], [1, "h-full", "flex-1"], [1, "h-full", "space-y-4"]], template: function FacilitiesComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FacilitiesComponent, { className: "FacilitiesComponent", filePath: "apps/concierge/src/app/facilities/facilities.component.ts", lineNumber: 51 });
})();
...
var FacilitiesModule = class _FacilitiesModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [FacilitiesComponent, RouterModule.forChild(ROUTES)] });
  }
};
(() => {
...
//# sourceMappingURL=facilities.module-QOL23QFL.js.map
