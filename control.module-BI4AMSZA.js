...
var ControlSpaceListItemComponent = class _ControlSpaceListItemComponent {
  constructor() {
    ...
    this.space = input(void 0, ...ngDevMode ? [{ debugName: "space" }] : (
...
function ControlSpaceListComponent_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275nextContext();
    const spaces_r2 = \u0275\u0275readContextLet(6);
    \u0275\u0275advance();
    \u0275\u0275repeater(spaces_r2);
  }
}
function ControlSpaceListComponent_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r2.search.getValue() ? ' No matches for "' + ctx_r2.search.getValue() + '"' : "No controllable spaces", " ");
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ControlSpaceListComponent, selectors: [["a-control-space-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 10, vars: 6, consts: [[1, "border-base-300", "bg-base-100", "flex", "w-full", "items-center", "justify-center", "border-b", "p-2"], ["overlay", "", "appearance", "outline", 1, "h-12", "rounded-sm"], ["matPrefix", "", 1, "text-xl"], ["matInput", "", "placeholder", "Search...", 3, "ngModelChange", "ngModel"], ["matSuffix", "", 1, "top-2", 3, "diameter"], [1, "flex", "w-full", "flex-1", "flex-col", "overflow-auto", "p-4"], [1, "flex", "flex-col", "items-center", "space-y-4", "p-8", "opacity-30"], [3, "space"], [1, "text-6xl"]], template: function ControlSpaceListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        const spaces_r4 = \u0275\u0275storeLet(\u0275\u0275pipeBind1(7, 3, ctx.filtered_spaces));
        \u0275\u0275advance(2);
        \u0275\u0275conditional(spaces_r4.length ? 8 : 9);
      }
    }, dependencies: [
      CommonModule,
      FormsModule,
...
var ControlComponent = class _ControlComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ControlComponent, selectors: [["", "app-control", ""]], attrs: _c02, decls: 5, vars: 0, consts: [[1, "flex", "h-1/2", "flex-1", "flex-col-reverse", "sm:flex-row"], [1, "relative", "z-0", "flex", "h-1/2", "flex-1", "flex-col", "overflow-hidden", "sm:h-auto"]], template: function ControlComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "topbar");
...
var ControlModule = class _ControlModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [ControlComponent, RouterModule.forChild(ROUTES)] });
  }
};
(() => {
...
//# sourceMappingURL=control.module-BI4AMSZA.js.map
