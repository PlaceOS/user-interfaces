...
import {
  ...
  EventCardComponent
} from "./chunk-X5BWPC4U.js";
import "./chunk-4VPAALS4.js";
import {
  FAV_DESK_KEY
...
import {
  FAV_PARKING_KEY
} from "./chunk-B3RDUBFD.js";
import "./chunk-U3OGZDV4.js";
import "./chunk-G3FS6QYD.js";
import {
  BookingFormService
...
import "./chunk-H72AD466.js";
import "./chunk-LPNTYU7F.js";
...
var LandingFavouritesComponent = class _LandingFavouritesComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    const metadata = await ju(this._org.organisation.id, "room_alerts");
...
function LandingUpcomingComponent_Conditional_13_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, LandingUpcomingComponent_Conditional_13_For_1_Case_0_Template, 1, 4, "event-card", 8)(1, LandingUpcomingComponent_Conditional_13_For_1_Case_1_Template, 1, 5, "booking-card", 9);
  }
  if (rf & 2) {
    let tmp_12_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingUpcomingComponent, { className: "LandingUpcomingComponent", filePath: "apps/workplace/src/app/landing/landing-upcoming.component.ts", lineNumber: 113 });
})();
...
//# sourceMappingURL=landing.routes-BBDYCVME.js.map
