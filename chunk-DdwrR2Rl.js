import{$a as mt,$r as _ce,Cn as Ph,Co as pt,Da as jt,Go as se,Ht as Le,Ka as mM,Or as XS,Qs as zn,To as q,Wa as m,ba as it,hr as Ve,hs as ve,it as Gt,li as aa,lo as oa,mr as VT,nc as m$1,tc as l,ut as I,vn as P$1,yt as It}from"./chunk-Cr962_JF.js";import{A as Ni,D as Lf,W as Uf,_ as Gn,en as po,o as Ai,wt as dS}from"./chunk-DZRDtaD6.js";function Y(o,m){}var z=`_mat-bottom-sheet-enter`;var P=`_mat-bottom-sheet-exit`;var G=(()=>{class o extends Lf{_breakpointSubscription;_animationsDisabled=oa();_animationState=`void`;_animationStateChanged=new ve;_destroyed=!1;constructor(){super();let e=m(XS);this._breakpointSubscription=e.observe([_ce.Medium,_ce.Large,_ce.XLarge]).subscribe(()=>{let n=this._elementRef.nativeElement.classList;n.toggle(`mat-bottom-sheet-container-medium`,e.isMatched(_ce.Medium)),n.toggle(`mat-bottom-sheet-container-large`,e.isMatched(_ce.Large)),n.toggle(`mat-bottom-sheet-container-xlarge`,e.isMatched(_ce.XLarge))})}enter(){this._destroyed||(this._animationState=`visible`,this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation(z))}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute(`mat-exit`,``),this._animationState=`hidden`,this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(P))}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=!0}_simulateAnimation(e){this._ngZone.run(()=>{this._handleAnimationEvent(!0,e,this._elementRef.nativeElement),setTimeout(()=>this._handleAnimationEvent(!1,e,this._elementRef.nativeElement))})}_trapFocus(){super._trapFocus({preventScroll:!0})}_handleAnimationEvent(e,n,t){if(t===this._elementRef.nativeElement){let i=n===z;(i||n===P)&&this._animationStateChanged.emit({toState:i?`visible`:`hidden`,phase:e?`start`:`done`})}}static ɵfac=function(n){return new(n||o)};static ɵcmp=It({type:o,selectors:[[`mat-bottom-sheet-container`]],hostAttrs:[`tabindex`,`-1`,1,`mat-bottom-sheet-container`],hostVars:9,hostBindings:function(n,t){n&1&&Gt(`animationstart`,function(a){return t._handleAnimationEvent(!0,a.animationName,a.target)})(`animationend`,function(a){return t._handleAnimationEvent(!1,a.animationName,a.target)})(`animationcancel`,function(a){return t._handleAnimationEvent(!1,a.animationName,a.target)}),n&2&&(zn(`role`,t._config.role)(`aria-modal`,t._config.ariaModal)(`aria-label`,t._config.ariaLabel),jt(`mat-bottom-sheet-container-animations-enabled`,!t._animationsDisabled)(`mat-bottom-sheet-container-enter`,t._animationState===`visible`)(`mat-bottom-sheet-container-exit`,t._animationState===`hidden`))},features:[it],decls:1,vars:0,consts:[[`cdkPortalOutlet`,``]],template:function(n,t){n&1&&VT(0,Y,0,0,`ng-template`,0)},dependencies:[Ai],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
