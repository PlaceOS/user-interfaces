...
} from "./chunk-2RDAWQKZ.js";
import {
  UserListFieldComponent
} from "./chunk-KEJVS4TD.js";
import {
  LevelPipe
} from "./chunk-QOBBE64Y.js";
import "./chunk-EQBULE35.js";
import {
  ImageCarouselComponent
} from "./chunk-J4A3BZSR.js";
import {
  BuildingPipe
} from "./chunk-UWJWCCHI.js";
import {
  DEFAULT_COLOURS
} from "./chunk-ZRVHORLH.js";
import {
  DurationFieldComponent
} from "./chunk-74TCSZDQ.js";
import {
...
import "./chunk-BDR6TSF6.js";
import "./chunk-GFUT5DYI.js";
import {
  subMinutes
} from "./chunk-5KN75HHU.js";
import {
  RichTextInputComponent
} from "./chunk-ZAMM4SZX.js";
import {
  SpacesService
} from "./chunk-KEYTM7JH.js";
...
function MeetingFlowSuccessComponent_Conditional_4_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275nextContext(2);
    const details_r1 = \u0275\u0275readContextLet(0);
    \u0275\u0275textInterpolate3(" Your room booking for ", details_r1.level, ", ", details_r1.space, " on ", details_r1.date, " is pending approval. ");
  }
}
function MeetingFlowSuccessComponent_Conditional_4_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275nextContext(2);
    const details_r1 = \u0275\u0275readContextLet(0);
    \u0275\u0275textInterpolate4(" Your room booking for ", details_r1.level, ", ", details_r1.space, " on ", details_r1.date, " at ", details_r1.time, " is pending approval. ");
  }
}
function MeetingFlowSuccessComponent_Conditional_4_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r1.formatted_recurrence, " ");
  }
}
function MeetingFlowSuccessComponent_Conditional_4_Conditional_15_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowSuccessComponent_Conditional_4_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275listener("click", function MeetingFlowSuccessComponent_Conditional_4_Conditional_15_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.startDeskBooking());
    });
    \u0275\u0275conditionalCreate(1, MeetingFlowSuccessComponent_Conditional_4_Conditional_15_Conditional_1_Template, 2, 0, "icon", 15);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("disabled", ctx_r1.desk_loading());
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.desk_loading() ? 1 : -1);
    \u0275\u0275advance();
...
function MeetingFlowSuccessComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, " Room booking pending approval ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 3)(5, "icon", 4);
    \u0275\u0275text(6, "pending");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "p", 5);
    \u0275\u0275conditionalCreate(8, MeetingFlowSuccessComponent_Conditional_4_Conditional_8_Template, 1, 3);
    \u0275\u0275conditionalCreate(9, MeetingFlowSuccessComponent_Conditional_4_Conditional_9_Template, 1, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, MeetingFlowSuccessComponent_Conditional_4_Conditional_10_Template, 5, 1, "div", 6);
    \u0275\u0275elementStart(11, "p", 7);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(14, "div", 8);
    \u0275\u0275conditionalCreate(15, MeetingFlowSuccessComponent_Conditional_4_Conditional_15_Template, 4, 5, "button", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "footer", 10)(17, "a", 11);
    \u0275\u0275text(18);
    \u0275\u0275pipe(19, "translate");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275conditional(ctx_r1.last_event()?.all_day ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.last_event()?.all_day ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.last_event()?.recurrence?.pattern ? 10 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 7, "CALENDAR_EVENT.SUCCESS_WAIT_APPROVED"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.space().email && ctx_r1.allow_desk_booking ? 15 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(11, _c1));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 9, "APP.WORKPLACE.MEETING_FINISHED"), " ");
  }
}
var MeetingFlowSuccessComponent = class _MeetingFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSuccessComponent, selectors: [["meeting-flow-success"]], features: [\u0275\u0275ProvidersFeature([SpacePipe])], decls: 5, vars: 16, consts: [[1, "bg-base-100", "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], ["name", "meeting-pending-icon", "aria-hidden", "true", 1, "bg-warning", "text-warning-content", "my-2", "flex", "h-28", "w-28", "items-center", "justify-center", "rounded-full"], [1, "text-7xl"], [1, "max-w-lg", "text-center"], [1, "bg-base-200", "flex", "items-center", "space-x-2", "rounded-lg", "px-4", "py-2"], ["name", "meeting-pending-guidance", 1, "font-bold"], [1, "h-4"], ["btn", "", "matRipple", "", 1, "w-56", 3, "disabled"], [1, "border-base-200", "bg-base-100", "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "p-2"], ["btn", "", "name", "meeting-created-continue", "matRipple", "", 1, "w-full", "max-w-lg", 3, "routerLink"], [1, "text-xl"], [1, "text-sm"], ["btn", "", "matRipple", "", 1, "w-56", 3, "click", "disabled"], [1, "mr-2", "animate-spin", "text-2xl"]], template: function MeetingFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275declareLet(0);
        \u0275\u0275pipe(1, "date");
        \u0275\u0275pipe(2, "date");
        \u0275\u0275pipe(3, "date");
        \u0275\u0275conditionalCreate(4, MeetingFlowSuccessComponent_Conditional_4_Template, 20, 12, "div", 0);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowSuccessComponent, { className: "MeetingFlowSuccessComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-success.component.ts", lineNumber: 108 });
})();
...
function MeetingFlowOptionsComponent_Conditional_50_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r0.form.catering)("options", \u0275\u0275pureFunction4(7, _c2, ctx_r0.form_value().date, ctx_r0.form_value().duration, ctx_r0.form_value().all_day, ctx_r0.form_value().resources?.length ? ctx_r0.form_value().resources[0]?.level?.parent_id : ""));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function MeetingFlowOptionsComponent_Conditional_51_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("options", \u0275\u0275pureFunction4(6, _c2, ctx_r0.form_value().date, ctx_r0.form_value().duration, ctx_r0.form_value().all_day, ctx_r0.form_value()?.resources?.length ? ctx_r0.form_value()?.resources[0]?.level?.parent_id : ""))("rejected_ids", ctx_r0.invalid_assets)("formField", ctx_r0.form.assets);
    \u0275\u0275control();
  }
}
...
var MeetingFlowSpaceSelectComponent = class _MeetingFlowSpaceSelectComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSpaceSelectComponent, selectors: [["meeting-flow-space-select"]], outputs: { prev: "prev", next: "next" }, decls: 116, vars: 100, consts: [[1, "border-base-300", "bg-base-100", "relative", "w-full", "overflow-hidden", "rounded-lg", "border"], [1, "gradient", "border-base-content", "relative", "flex", "items-center", "justify-between", "space-x-2", "border-l-8", "px-4", "py-3", "text-xl", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["icon", "", "matRipple", "", 1, "sm:hidden", 3, "click"], [1, "fixed", "inset-0", "z-20", "bg-black/50", "sm:hidden"], [1, "relative", "flex", "w-full", "overflow-hidden", "p-2", "sm:space-x-2"], [1, "hidden", "sm:sticky", "sm:top-0", "sm:block", "sm:w-[20rem]", "sm:max-w-[20rem]"], [1, "flex", "w-full", "items-center", "justify-between", "p-2"], [1, "px-2", "text-xl", "font-medium"], [1, "flex", "flex-col", "overflow-y-auto", "p-4"], ["for", "location"], ["appearance", "outline", 1, "w-full"], ["for", "capacity"], ["name", "capacity", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value"], ["for", "date"], [3, "formField"], [1, "mb-2", 3, "formField"], [1, "mb-4", 3, "ngModel", "ngModelOptions"], [1, "flex", "min-w-0", "flex-1", "flex-col"], [1, "mb-2", "flex", "space-x-2"], ["filters", "", 1, "border-base-300", "bg-base-100", "flex", "flex-1", "flex-wrap", "rounded-lg", "border", "p-2"], ["btn", "", "matRipple", "", "name", "clear-space-filters", 1, "mr-2", "mb-2", "min-h-8"], ["filter-item", "", "zone", ""], ["filter-item", "", "date", ""], ["filter-item", "", "time", ""], ["filter-item", "", "count", ""], ["filter-item", ""], [1, "space-y-2"], ["btn", "", "matRipple", "", 1, "w-full", "space-x-2", 3, "click"], [1, "text-2xl"], [1, "pr-2"], [1, "border-base-300", "bg-base-200", "relative", "flex", "flex-col", "overflow-hidden", "rounded-lg", "border", "p-2"], [3, "selected_spaces"], [1, "filters-panel-mobile", "border-base-300", "bg-base-100", "fixed", "right-0", "bottom-0", "left-0", "z-30", "w-full", "border-t", "shadow-lg", "transition-transform", "duration-300", "sm:hidden"], [1, "border-base-300", "flex", "w-full", "items-center", "justify-between", "border-b", "p-2"], ["icon", "", "matRipple", "", 3, "click"], [1, "flex", "max-h-[60vh]", "flex-col", "overflow-y-auto", "p-4"], ["name", "capacity-mobile", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "h-4"], [1, "border-base-300", "bg-base-100", "sticky", "bottom-0", "z-10", "flex", "justify-between", "rounded-t-xl", "border-x", "border-t", "p-3", "sm:z-40"], ["btn", "", "matRipple", "", 1, "inverse", "w-40", "cursor-pointer", 3, "routerLink", "queryParams"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "fixed", "inset-0", "z-20", "bg-black/50", "sm:hidden", 3, "click"], ["name", "region", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["name", "building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["name", "location-multi", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder", "multiple"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [1, "flex", "space-x-2"], [1, "flex-1", 3, "ngModelChange", "ngModel", "ngModelOptions", "disabled", "use_24hr", "timezone"], [1, "w-1/3", "flex-1", 3, "formField", "time", "max", "min", "step", "custom_options", "use_24hr", "timezone"], [1, "mb-4", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "text-lg", "font-medium"], [1, "mb-4", "flex", "flex-col", "space-y-2"], [1, "w-full", 3, "label", "ngModel", "ngModelOptions"], [1, "w-full", 3, "ngModelChange", "label", "ngModel", "ngModelOptions"], ["btn", "", "matRipple", "", "name", "clear-space-filters", 1, "mr-2", "mb-2", "min-h-8", 3, "click"], [1, "truncate"], ["icon", "", "matRipple", "", "name", "remove-space-filter", 1, "-mr-4", 3, "click"], [3, "space_selected", "selected_spaces"], ["name", "location-multi-mobile", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder", "multiple"]], template: function MeetingFlowSpaceSelectComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "icon");
        \u0275\u0275text(4, "info");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(98, _c15))("queryParams", \u0275\u0275pureFunction0(99, _c22));
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowSpaceSelectComponent, { className: "MeetingFlowSpaceSelectComponent", filePath: "apps/workplace/src/app/book/meeting-flow-new/meeting-flow-space-select.component.ts", lineNumber: 649 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowNewComponent, { className: "MeetingFlowNewComponent", filePath: "apps/workplace/src/app/book/meeting-flow-new/meeting-flow.component.ts", lineNumber: 143 });
})();
export {
  MeetingFlowNewComponent
};
//# sourceMappingURL=meeting-flow.component-SXS3XWB3.js.map
