...
import "./chunk-BSLJKJYP.js";
import {
  newCalendarEventFromBooking
} from "./chunk-4NOKP5UK.js";
import {
  queryEvents,
  showEventMetadata,
  updateEventMetadata
...
} from "./chunk-JOPVUYGV.js";
import {
  MatProgressBar,
  MatProgressBarModule
} from "./chunk-RZML3XZY.js";
import "./chunk-6J6JACM5.js";
...
var CateringStateService = class _CateringStateService extends AsyncHandler {
  ...
  async getCateringConfig(zone_id = this._org.building.id) {
    const rules = (await ic(zone_id, "catering_config")).details;
...
function CateringOrderListComponent_ng_template_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const row_r6 = ctx.row;
    const space_r7 = \u0275\u0275storeLet(row_r6?.space || data_r5?.system);
    \u0275\u0275advance();
    \u0275\u0275conditional(space_r7 || !data_r5?.location ? 1 : 2);
  }
}
...
function CateringOrderListComponent_ng_template_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r8?.organiser?.name || data_r8?.host || "", " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(!(data_r8?.organiser?.name || data_r8?.host) ? 3 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", data_r8?.organiser?.email || data_r8?.host, " ");
  }
}
function CateringOrderListComponent_ng_template_19_For_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CateringOrderListComponent_ng_template_19_For_9_Template_button_click_0_listener() {
      const status_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const row_r11 = \u0275\u0275nextContext().row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.updateStatus(row_r11, status_r10.id));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("background-color", status_r10.colour);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(status_r10.name);
  }
}
function CateringOrderListComponent_ng_template_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275styleProp("background", ctx_r2.status(data_r12)?.colour);
    \u0275\u0275property("matMenuTriggerFor", menu_r13);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r2.status(data_r12)?.name, " ");
    \u0275\u0275advance(5);
...
function CateringOrderListComponent_ng_template_21_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", row_r15.notes, " ");
  }
}
function CateringOrderListComponent_ng_template_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CateringOrderListComponent_ng_template_21_Template_button_click_6_listener() {
      ...
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleExpanded(row_r15.id));
    });
  ...
  if (rf & 2) {
    ...
    const notes_template_r16 = \u0275\u0275reference(5);
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("hover", true)("content", notes_template_r16)("disabled", !row_r15.notes);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", ctx_r2.isExpanded(row_r15.id) ? "keyboard_arrow_down" : "chevron_right", " ");
  }
}
function CateringOrderListComponent_ng_template_23_Conditional_0_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("order_id", row_r18?.id)("item", item_r17);
  }
}
...
function CateringOrderListComponent_ng_template_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(row_r18?.items.length ? 0 : -1);
  }
}
var CateringOrderListComponent = class _CateringOrderListComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringOrderListComponent, selectors: [["catering-order-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 25, vars: 57, consts: [["state_template", ""], ["time_template", ""], ["location_template", ""], ["host_template", ""], ["status_template", ""], ["actions_template", ""], ["child_template", ""], ["menu", "matMenu"], ["notes_template", ""], [1, "flex", "h-full", "w-full", "flex-col", "overflow-auto"], ["mode", "indeterminate", 1, "sticky", "top-0", "left-0", "w-full"], [1, "block", "w-full", "min-w-6xl", "text-sm", 3, "data", "columns", "sortable", "show_children", "child_template", "empty_message"], [1, "p-2"], [1, "bg-base-200", "flex", "items-center", "justify-center", "rounded-full", "p-2", "text-2xl"], [1, "p-4"], [1, "text-xs", "opacity-30"], [1, "px-4", "py-2"], [1, "opacity-30"], ["status", "", "matRipple", "", 1, "flex", "h-10", "w-36", "items-center", "rounded-3xl", "border-none", "px-4", "text-base", "text-white", 3, "matMenuTriggerFor"], [1, "mx-2", "flex", "text-center", "capitalize"], [1, "pl-2"], ["mat-menu-item", "", 1, "flex", "items-center"], ["mat-menu-item", "", 1, "flex", "items-center", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "mr-2", "h-4", "w-4", "rounded-full"], [1, "mr-2", "w-20"], [1, "mx-auto", "flex", "items-center", "space-x-2", "p-2"], ["icon", "", "matRipple", "", "customTooltip", "", "xPosition", "end", "yPosition", "top", 3, "hover", "content", "disabled"], ["icon", "", "matRipple", "", 3, "click"], [1, "border-base-200", "bg-base-100", "text-base-content", "max-w-lg", "min-w-32", "rounded-lg", "border", "p-2", "shadow-sm"], [1, "mb-2"], [1, "bg-base-200", "rounded-sm", "px-4", "py-2", "text-sm"], [1, "relative", "z-0", "m-0", "w-full", "list-none", "p-0"], ["catering-order-item", "", 1, "flex", "items-center", 3, "order_id", "item"]], template: function CateringOrderListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        const state_template_r19 = \u0275\u0275reference(12);
        const time_template_r20 = \u0275\u0275reference(14);
        const location_template_r21 = \u0275\u0275reference(16);
        const host_template_r22 = \u0275\u0275reference(18);
        const status_template_r23 = \u0275\u0275reference(20);
        const actions_template_r24 = \u0275\u0275reference(22);
        const child_template_r25 = \u0275\u0275reference(24);
        \u0275\u0275advance();
        \u0275\u0275classProp("opacity-0", !ctx.loading());
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.order_list())("columns", \u0275\u0275pureFunctionV(47, _c8, [\u0275\u0275pureFunction1(24, _c03, state_template_r19), \u0275\u0275pureFunction2(26, _c13, \u0275\u0275pipeBind1(3, 8, "CATERING.CATERER"), !ctx.filters()?.caterer && ctx.caterers().length > 1), \u0275\u0275pureFunction2(29, _c22, \u0275\u0275pipeBind1(4, 10, "COMMON.TIME"), time_template_r20), \u0275\u0275pureFunction2(32, _c32, \u0275\u0275pipeBind1(5, 12, "COMMON.LOCATION"), location_template_r21), \u0275\u0275pureFunction2(35, _c32, \u0275\u0275pipeBind1(6, 14, "FORM.HOST"), host_template_r22), \u0275\u0275pureFunction1(38, _c42, \u0275\u0275pipeBind1(7, 16, "CATERING.CHARGE_CODE")), \u0275\u0275pureFunction1(40, _c52, \u0275\u0275pipeBind1(8, 18, "CATERING.INVOICE_NUMBER")), \u0275\u0275pureFunction2(42, _c62, \u0275\u0275pipeBind1(9, 20, "COMMON.STATUS"), status_template_r23), \u0275\u0275pureFunction1(45, _c7, actions_template_r24)]))("sortable", true)("show_children", ctx.show_children())("child_template", child_template_r25)("empty_message", \u0275\u0275pipeBind1(10, 22, "CATERING.ORDERS_EMPTY"));
      }
    }, dependencies: [
      CommonModule,
...
//# debugId=f450d3a6-1b1f-5c5f-bad5-6c44896af407
//# sourceMappingURL=catering.routes-CZLPOO6Z.js.map
