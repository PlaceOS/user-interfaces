      ...
      loader: async ({ params }) => {
        ...
        try {
          ...
          if (zones.length && !params.zones.includes("All")) {
            ...
            const metadata = await sc(this._org.building?.id, { name: "desks" }).catch(() => []);
...
//# debugId=8b20d6ff-d6af-5c3d-887d-9e466762e86c
//# sourceMappingURL=chunk-IMIEVDTB.js.map
