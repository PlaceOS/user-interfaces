...
_AssetFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetFormComponent, selectors: [["asset-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 60, vars: 62, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", 3, "ngModel", "ngModelOptions", "disabled"], [1, "flex", "items-center", "space-x-2"], ["for", "serial-number"], ["matInput", "", "name", "serial-number", "formControlName", "serial_number", 3, "placeholder"], ["for", "identifier"], ["matInput", "", "name", "identifier", "formControlName", "identifier", 3, "placeholder"], ["for", "purchase-order-id"], ["formControlName", "purchase_order_id", 3, "placeholder"], [3, "value"], [1, "opacity-60", 3, "disabled"], ["matInput", "", "name", "barcode", "formControlName", "barcode", 3, "placeholder"], ["for", "refund-deadline"], ["matInput", "", "type", "date", "name", "refund-deadline", "placeholder", "Refund deadline date", 3, "ngModelChange", "ngModel", "ngModelOptions"]], template: function AssetFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(54, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(55, "div", 2)(56, "label", 16);
    \u0275\u0275text(57, "Refund Deadline");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "mat-form-field", 4)(59, "input", 17);
    \u0275\u0275listener("ngModelChange", function AssetFormComponent_Template_input_ngModelChange_59_listener($event) {
  ...
  if (rf & 2) {
    let tmp_17_0;
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 23, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_EDIT" : "APP.CONCIERGE.ASSETS_NEW"))("close", ctx.product ? \u0275\u0275pureFunction2(55, _c02, ctx.base_route, ctx.product.id) : \u0275\u0275pureFunction1(58, _c12, ctx.base_route))("loading", ctx.loading);
    \u0275\u0275advance(2);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 25, "APP.CONCIERGE.ASSETS_PRODUCT"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", (ctx.product == null ? null : ctx.product.name) || "No Product")("ngModelOptions", \u0275\u0275pureFunction0(60, _c22))("disabled", true);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 27, "APP.CONCIERGE.ASSETS_ITEM_ASSET_SERIAL"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(16, 29, "APP.CONCIERGE.ASSETS_ITEM_ASSET_SERIAL"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 31, "APP.CONCIERGE.ASSETS_SERIAL_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 33, "APP.CONCIERGE.ASSETS_ITEM_ASSET_NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(26, 35, "APP.CONCIERGE.ASSETS_ITEM_ASSET_NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 37, "APP.CONCIERGE.ASSETS_NAME_REQUIRED"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 39, "APP.CONCIERGE.ASSETS_ORDER_ID"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(36, 41, "APP.CONCIERGE.ASSETS_ORDER_SELECT"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(39, 43, ctx.purchase_orders));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!((tmp_17_0 = \u0275\u0275pipeBind1(41, 45, ctx.purchase_orders)) == null ? null : tmp_17_0.length) ? 40 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(44, 47, "APP.CONCIERGE.ASSETS_ORDER_ID_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(48, 49, "APP.CONCIERGE.ASSETS_BARCODE"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(51, 51, "APP.CONCIERGE.ASSETS_BARCODE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(54, 53, "APP.CONCIERGE.ASSETS_BARCODE_REQUIRED"));
    \u0275\u0275advance(6);
    \u0275\u0275property("ngModel", ctx.refund_deadline)("ngModelOptions", \u0275\u0275pureFunction0(61, _c22));
  }
}, dependencies: [
  FullscreenModalShellComponent,
  MatFormFieldModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetFormComponent, { className: "AssetFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-form.component.ts", lineNumber: 186 });
})();
...
_AssetGroupFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetGroupFormComponent, selectors: [["asset-group-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 68, vars: 56, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["formControlName", "category_id", 3, "click", "placeholder"], [3, "value"], [1, "relative", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["for", "brand"], ["matInput", "", "name", "brand", "formControlName", "brand", 3, "placeholder"], ["for", "description"], ["matInput", "", "name", "description", "placeholder", "Description of the product", "formControlName", "description"], ["for", "images"], ["name", "images", "formControlName", "images"], ["for", "refund-lead-days"], ["matInput", "", "type", "number", "name", "refund-lead-days", "placeholder", "Days before event for refund cutoff", 3, "ngModelChange", "ngModel", "ngModelOptions", "min"]], template: function AssetGroupFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "div", 2)(64, "label", 16);
    \u0275\u0275text(65, "Refund Lead Time (days)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "mat-form-field", 4)(67, "input", 17);
    \u0275\u0275listener("ngModelChange", function AssetGroupFormComponent_Template_input_ngModelChange_67_listener($event) {
      return ctx.refund_lead_days = $event;
    });
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 20, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_ITEM_EDIT" : "APP.CONCIERGE.ASSETS_ITEM_NEW"))("close", ctx.form.value.id ? \u0275\u0275pureFunction2(50, _c03, ctx.base_route, ctx.form.value.id) : \u0275\u0275pureFunction1(53, _c13, ctx.base_route))("loading", ctx.loading);
    \u0275\u0275advance(2);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 22, "FORM.NAME"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(11, 24, "FORM.NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 26, "FORM.NAME_REQUIED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 28, "COMMON.CATEGORY"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(23, 30, "COMMON.CATEGORY"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(26, 32, ctx.categories));
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(33, 34, "COMMON.CATEGORY_NEW"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(36, 36, "COMMON.CATEGORY_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(40, 38, "APP.CONCIERGE.ASSETS_ITEM_BRAND"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(45, 40, "APP.CONCIERGE.ASSETS_ITEM_BRAND"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(48, 42, "APP.CONCIERGE.ASSETS_ITEM_BRAND_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(52, 44, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 46, "COMMON.DESCRIPTION_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(61, 48, "COMMON.IMAGES"));
    \u0275\u0275advance(7);
    \u0275\u0275property("ngModel", ctx.refund_lead_days)("ngModelOptions", \u0275\u0275pureFunction0(55, _c23))("min", 0);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetGroupFormComponent, { className: "AssetGroupFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-group-form.component.ts", lineNumber: 178 });
})();
...
//# sourceMappingURL=asset-manager.module-C6NWLM2R.js.map
