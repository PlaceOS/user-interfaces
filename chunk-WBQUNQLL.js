...
var UserListFieldComponent = class _UserListFieldComponent extends AsyncHandler {
  async searchStaff(q) {
    return this._use_basic_user_search() ? Ja({ q, authority_id: Mt()?.id }).then((_) => _.data.map((u) => new User(u))) : searchStaff(q);
  }
  constructor() {
    super();
...
//# debugId=16f0209c-b22a-5ce8-821d-98189778118d
//# sourceMappingURL=chunk-WBQUNQLL.js.map
