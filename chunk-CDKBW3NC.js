...
var UserSearchFieldComponent = class _UserSearchFieldComponent extends AsyncHandler {
  constructor() {
    ...
    this.query_fn = input(
      async (q) => {
        ...
        if (this.guests_only())
          return guest_query();
        const staff = this.use_basic_search() ? await La({
          q,
          authority_id: It()?.id,
  ...
  setValue(new_value, email) {
    ...
    if (typeof new_value !== "string" && !this.use_basic_search() && (value?.id || value?.email)) {
      ja(value.email || value.id).then((details) => {
        if (!details)
          return;
...
//# debugId=1f252529-8bb7-50c8-8e07-a569a357eddc
//# sourceMappingURL=chunk-CDKBW3NC.js.map
