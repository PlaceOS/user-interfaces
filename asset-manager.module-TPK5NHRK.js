...
function AssetCategoryManagementModalComponent_ng_container_12_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetCategoryManagementModalComponent_ng_container_12_div_1_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function AssetCategoryManagementModalComponent_ng_container_12_div_1_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r1);
      const category_r2 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
...
function AssetCategoryManagementModalComponent_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AssetCategoryManagementModalComponent_ng_container_12_div_1_Template, 9, 1, "div", 5);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const category_r2 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", category_r2.id);
  }
}
var _AssetCategoryManagementModalComponent = class _AssetCategoryManagementModalComponent {
  constructor(_data, _dialog_ref) {
    ...
    this.remove = (category) => __async(this, null, function* () {
      yield deleteAssetCategory(category.id).toPromise();
      this.changed.emit();
    });
  }
};
_AssetCategoryManagementModalComponent.\u0275fac = function AssetCategoryManagementModalComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetCategoryManagementModalComponent)(\u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(MatDialogRef));
};
_AssetCategoryManagementModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetCategoryManagementModalComponent, selectors: [["asset-category-management-modal"]], decls: 14, vars: 3, consts: [["btn", "", "icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "overflow-y-auto", "min-w-[20rem]", "divide-y", "divide-base-200", "max-h-[65vh]"], ["btn", "", "matRipple", "", 1, "flex", "items-center", "justify-center", "space-x-2", "w-[calc(100%-1rem)]", "m-2", 3, "click"], [1, "truncate"], [4, "ngFor", "ngForOf"], ["class", "flex items-center space-x-2 hover:bg-base-200:bg-base-300 p-2", 4, "ngIf"], [1, "flex", "items-center", "space-x-2", "hover:bg-base-200:bg-base-300", "p-2"], [1, "flex-1", "truncate"], ["btn", "", "icon", "", "matRipple", "", 3, "click"]], template: function AssetCategoryManagementModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "header")(1, "h2");
    \u0275\u0275text(2, "Manage Categories");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 0)(4, "app-icon");
    \u0275\u0275text(5, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(6, "main", 1)(7, "button", 2);
    \u0275\u0275listener("click", function AssetCategoryManagementModalComponent_Template_button_click_7_listener() {
      return ctx.edit();
    });
    ...
    \u0275\u0275text(11, "add");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, AssetCategoryManagementModalComponent_ng_container_12_Template, 2, 1, "ng-container", 4);
    \u0275\u0275pipe(13, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(12);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(13, 1, ctx.list));
  }
}, dependencies: [NgForOf, NgIf, MatDialogClose, MatRipple, IconComponent, AsyncPipe] });
var AssetCategoryManagementModalComponent = _AssetCategoryManagementModalComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetCategoryManagementModalComponent, { className: "AssetCategoryManagementModalComponent", filePath: "apps/concierge/src/app/asset-manager/asset-category-management-modal.component.ts", lineNumber: 45 });
})();
...
function AssetCategoryFormComponent_main_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12, "Parent Category");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "mat-form-field", 10)(14, "mat-select", 12);
    \u0275\u0275pipe(15, "async");
    \u0275\u0275template(16, AssetCategoryFormComponent_main_4_mat_option_16_Template, 2, 2, "mat-option", 13);
    \u0275\u0275pipe(17, "async");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(14);
    \u0275\u0275property("disabled", !((tmp_3_0 = \u0275\u0275pipeBind1(15, 3, ctx_r1.categories)) == null ? null : tmp_3_0.length));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(17, 5, ctx_r1.categories));
  }
}
function AssetCategoryFormComponent_footer_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 15)(1, "a", 16);
    \u0275\u0275text(2, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 17);
    \u0275\u0275listener("click", function AssetCategoryFormComponent_footer_5_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
var _AssetCategoryFormComponent = class _AssetCategoryFormComponent {
  ...
  save() {
    return __async(this, null, function* () {
      ...
      const item = yield saveAssetCategory(data).toPromise().catch((e) => {
        this.loading = false;
...
_AssetCategoryFormComponent.\u0275fac = function AssetCategoryFormComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetCategoryFormComponent)(\u0275\u0275directiveInject(MAT_DIALOG_DATA), \u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(MatDialogRef));
};
_AssetCategoryFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetCategoryFormComponent, selectors: [["asset-category-form"]], decls: 8, vars: 5, consts: [["load_state", ""], [1, "flex", "items-center", "p-2"], [1, "text-center", "text-xl", "font-medium"], ["btn", "", "icon", "", "matRipple", "", "mat-dialog-close", "", 4, "ngIf"], ["class", "flex-1 h-1/2 overflow-auto p-2 w-[20rem] max-w-[80vw]", 3, "formGroup", 4, "ngIf", "ngIfElse"], ["class", "flex justify-end space-x-2 p-2 border-t border-base-200", 4, "ngIf"], ["btn", "", "icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex-1", "h-1/2", "overflow-auto", "p-2", "w-[20rem]", "max-w-[80vw]", 3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "placeholder", "Category Name", "formControlName", "name"], ["formControlName", "parent_category_id", "placeholder", "No Parent", 3, "disabled"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "flex", "justify-end", "space-x-2", "p-2", "border-t", "border-base-200"], ["btn", "", "matRipple", "", "mat-dialog-close", "", 1, "w-32", "inverse"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8"], [3, "diameter"], [1, "mt-4"]], template: function AssetCategoryFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "header", 1)(1, "h2", 2);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, AssetCategoryFormComponent_button_3_Template, 3, 0, "button", 3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AssetCategoryFormComponent_main_4_Template, 18, 7, "main", 4)(5, AssetCategoryFormComponent_footer_5_Template, 5, 0, "footer", 5)(6, AssetCategoryFormComponent_ng_template_6_Template, 4, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const load_state_r4 = \u0275\u0275reference(7);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx.form.value.id ? "Edit" : "Add", " Category ");
    \u0275\u0275advance();
...
}, dependencies: [NgForOf, NgIf, MatFormField, MatError, MatInput, MatSelect, MatOption, MatProgressSpinner, MatDialogClose, MatRipple, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, IconComponent, AsyncPipe] });
var AssetCategoryFormComponent = _AssetCategoryFormComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetCategoryFormComponent, { className: "AssetCategoryFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-category-form.component.ts", lineNumber: 74 });
})();
...
var _AssetManagerStateService = class _AssetManagerStateService extends AsyncHandler {
  ...
  constructor(_spaces, _org, _dialog, _settings) {
    ...
    this.product_mapping = combineLatest([
      ...
      for (const group2 of categories) {
        map2[group2] = products.filter((i) => i.category_id === group2);
      }
      return map2;
    }));
    this.settings = combineLatest([
      this._org.active_building,
      this._change
    ]).pipe(filter(([_]) => !!_), switchMap(([_]) => showMetadata(_.id, "assets-settings").pipe(catchError((_2) => of({})))), map((_) => _.details || {}), shareReplay(1));
  ...
  editCategory() {
    return __async(this, arguments, function* (category = {}) {
  ...
  setStatus(item, status) {
    return __async(this, null, function* () {
      let result = item;
      if (status === "declined") {
        result = yield rejectBooking(item.id).toPromise();
      } else if (status === "approved") {
        result = yield approveBooking(item.id).toPromise();
      }
      this._change.next(Date.now());
      return result;
    });
  ...
  setTracking(item, tracking) {
    return __async(this, null, function* () {
      const result = yield updateBooking(item.id, __spreadProps(__spreadValues({}, item.toJSON()), {
  ...
  deleteActiveProduct() {
    return __async(this, null, function* () {
      const item = yield this.active_product.pipe(take(1)).toPromise();
      if (!item?.id)
        return;
      yield deleteAssetGroup(item.id).toPromise();
      this._change.next(Date.now());
  ...
  postForm() {
    return __async(this, null, function* () {
      ...
      data.other_data = cleanObject(other_data, [void 0, null, ""]);
      const asset = yield saveAsset(data).toPromise();
      this._change.next(Date.now());
  ...
  editConfig() {
    return __async(this, null, function* () {
      const config = yield this.getConfig(this._org.building.id);
      const items = yield this.products.pipe(take(1)).toPromise();
  ...
  getConfig() {
    return __async(this, arguments, function* (zone_id = this._org.building.id) {
      const rules = (yield showMetadata(zone_id, "assets_config").toPromise()).details;
...
_AssetManagerStateService.\u0275fac = function AssetManagerStateService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetManagerStateService)(\u0275\u0275inject(SpacesService), \u0275\u0275inject(OrganisationService), \u0275\u0275inject(MatDialog), \u0275\u0275inject(SettingsService));
};
...
var _c03 = (a0) => [a0, "manage", "group"];
var _c12 = (a0) => [a0, "manage", "purchase-order"];
function AssetManagerTopbarComponent_a_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(1, _c03, ctx_r0.base_route));
  }
}
function AssetManagerTopbarComponent_a_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 11);
    \u0275\u0275text(1, " Add Purchase Order ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(1, _c12, ctx_r0.base_route));
  }
}
function AssetManagerTopbarComponent_mat_button_toggle_group_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-button-toggle-group", 12);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("ngModelChange", function AssetManagerTopbarComponent_mat_button_toggle_group_3_Template_mat_button_toggle_group_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.setOptions({ view: $event }));
    });
    \u0275\u0275elementStart(2, "mat-button-toggle", 13)(3, "div", 14)(4, "app-icon", 15);
    \u0275\u0275text(5, "view_module");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(6, "mat-button-toggle", 16)(7, "div", 14)(8, "app-icon", 15);
    \u0275\u0275text(9, "view_list");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("ngModel", (tmp_1_0 = \u0275\u0275pipeBind1(1, 1, ctx_r0.options)) == null ? null : tmp_1_0.view);
  }
}
function AssetManagerTopbarComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetManagerTopbarComponent_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
...
function AssetManagerTopbarComponent_button_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetManagerTopbarComponent_button_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
...
function AssetManagerTopbarComponent_button_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetManagerTopbarComponent_button_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
...
function AssetManagerTopbarComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "async");
    \u0275\u0275listener("ngModelChange", function AssetManagerTopbarComponent_div_13_Template_mat_select_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.setBuilding($event));
    });
    \u0275\u0275template(4, AssetManagerTopbarComponent_div_13_mat_option_4_Template, 2, 2, "mat-option", 23);
    \u0275\u0275pipe(5, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", (tmp_1_0 = \u0275\u0275pipeBind1(3, 2, ctx_r0.building)) == null ? null : tmp_1_0.id);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(5, 4, ctx_r0.buildings));
  }
}
  ...
  setRoomAvailability() {
    return __async(this, null, function* () {
      const ref = this._dialog.open(AvailableRoomsStateModalComponent, {
        data: {
          type: "Assets",
          disabled_rooms: yield this._state.availability.pipe(take(1)).toPromise()
        }
      });
      this.subscription("room-availability", ref.componentInstance.change.subscribe((list) => __async(this, null, function* () {
        yield this._state.saveSettings({ disabled_rooms: list }).catch();
        ref.componentInstance.loading = false;
      })));
    });
  }
};
_AssetManagerTopbarComponent.\u0275fac = function AssetManagerTopbarComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetManagerTopbarComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(SettingsService), \u0275\u0275directiveInject(MatDialog));
};
_AssetManagerTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetManagerTopbarComponent, selectors: [["asset-manager-topbar"]], inputs: { active: "active" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 15, vars: 12, consts: [[1, "w-full", "px-8", "pt-4", "pb-2", "bg-base-100", "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", "class", "secondary", 3, "routerLink", 4, "ngIf"], [3, "ngModel", "ngModelChange", 4, "ngIf"], [1, "flex-1"], ["btn", "", "icon", "", "matRipple", "", "class", "bg-secondary text-secondary-content rounded h-12 w-12", "matTooltip", "Edit Config", 3, "click", 4, "ngIf"], ["btn", "", "icon", "", "matRipple", "", "class", "bg-secondary text-secondary-content rounded h-12 w-12", "matTooltip", "Room Availability", 3, "click", 4, "ngIf"], ["btn", "", "icon", "", "matRipple", "", "class", "bg-secondary text-secondary-content rounded h-12 w-12", "matTooltip", "Manage Categories", 3, "click", 4, "ngIf"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "text-2xl", "relative", "top-1", "-left-1"], ["matInput", "", "placeholder", "Search products and requests", 3, "ngModelChange", "ngModel"], ["class", "flex items-center space-x-2 px-4 pb-2", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "secondary", 3, "routerLink"], [3, "ngModelChange", "ngModel"], ["value", "grid", "matTooltip", "View as Grid"], [1, "flex", "items-center", "justify-center", "h-12", "w-8"], [1, "text-2xl"], ["value", "list", "matTooltip", "View as List"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Edit Config", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12", 3, "click"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Room Availability", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12", 3, "click"], ["btn", "", "icon", "", "matRipple", "", "matTooltip", "Manage Categories", 1, "bg-secondary", "text-secondary-content", "rounded", "h-12", "w-12", 3, "click"], [1, "flex", "items-center", "space-x-2", "px-4", "pb-2"], ["appearance", "outline", 1, "no-subscript", "w-48"], ["placeholder", "All Buildings", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]], template: function AssetManagerTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275template(1, AssetManagerTopbarComponent_a_1_Template, 2, 3, "a", 1)(2, AssetManagerTopbarComponent_a_2_Template, 2, 3, "a", 1)(3, AssetManagerTopbarComponent_mat_button_toggle_group_3_Template, 10, 3, "mat-button-toggle-group", 2);
    \u0275\u0275element(4, "div", 3);
    \u0275\u0275template(5, AssetManagerTopbarComponent_button_5_Template, 3, 0, "button", 4)(6, AssetManagerTopbarComponent_button_6_Template, 3, 0, "button", 5)(7, AssetManagerTopbarComponent_button_7_Template, 3, 0, "button", 6);
    \u0275\u0275elementStart(8, "mat-form-field", 7)(9, "app-icon", 8);
    \u0275\u0275text(10, " search ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(13, AssetManagerTopbarComponent_div_13_Template, 6, 6, "div", 10);
    \u0275\u0275pipe(14, "async");
  }
  if (rf & 2) {
    let tmp_6_0;
    let tmp_7_0;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.active === "items");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.active === "purchase-orders");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.active === "items");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.active === "items");
    ...
    \u0275\u0275property("ngIf", ctx.active === "items");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", (tmp_6_0 = \u0275\u0275pipeBind1(12, 8, ctx.options)) == null ? null : tmp_6_0.search);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.use_region && ((tmp_7_0 = \u0275\u0275pipeBind1(14, 10, ctx.building)) == null ? null : tmp_7_0.length));
  }
}, dependencies: [NgForOf, NgIf, MatFormField, MatPrefix, MatInput, MatSelect, MatOption, MatTooltip, MatRipple, DefaultValueAccessor, NgControlStatus, NgModel, IconComponent, MatButtonToggleGroup, MatButtonToggle, RouterLink, AsyncPipe] });
var AssetManagerTopbarComponent = _AssetManagerTopbarComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetManagerTopbarComponent, { className: "AssetManagerTopbarComponent", filePath: "apps/concierge/src/app/asset-manager/asset-manager-topbar.component.ts", lineNumber: 117 });
})();

// apps/concierge/src/app/asset-manager/asset-listing.component.ts
var _c04 = (a0) => [a0, "list", "items"];
var _c13 = (a0) => [a0, "list", "purchase-orders"];
var _c22 = (a0) => [a0, "list", "requests"];
function AssetListingComponent_nav_2_a_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 8);
    \u0275\u0275listener("click", function AssetListingComponent_nav_2_a_1_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r2);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c22, ctx_r2.base_route))("routerLinkActive", "active")("active", ctx_r2.active === "requests");
  }
}
function AssetListingComponent_nav_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AssetListingComponent_nav_2_a_1_Template, 2, 5, "a", 6);
    \u0275\u0275elementStart(2, "a", 7);
    \u0275\u0275listener("click", function AssetListingComponent_nav_2_Template_a_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AssetListingComponent_nav_2_Template_a_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.active = "purchase-orders");
    });
    \u0275\u0275text(5, " Purchase Orders ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.is_new);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(6, _c04, ctx_r2.base_route))("active", ctx_r2.active === "items");
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(8, _c13, ctx_r2.base_route))("active", ctx_r2.active === "purchase-orders");
  }
}
...
_AssetListingComponent.\u0275fac = function AssetListingComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetListingComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(AssetManagerStateService));
};
_AssetListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetListingComponent, selectors: [["asset-listing"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 2, consts: [["tabPanel", ""], [3, "active"], [1, "flex", "flex-col", "flex-1", "h-1/2", "w-full", "px-8"], ["mat-tab-nav-bar", "", 3, "tabPanel", 4, "ngIf"], [1, "flex-1", "h-1/2", "w-full", "overflow-visible"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "routerLinkActive", "active", "click", 4, "ngIf"], ["mat-tab-link", "", 3, "click", "routerLink", "active"], ["mat-tab-link", "", 3, "click", "routerLink", "routerLinkActive", "active"]], template: function AssetListingComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "asset-manager-topbar", 1);
    \u0275\u0275elementStart(1, "div", 2);
    \u0275\u0275template(2, AssetListingComponent_nav_2_Template, 6, 10, "nav", 3);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !ctx.is_new || ctx.active !== "requests");
  }
}, dependencies: [NgIf, MatTabNav, MatTabNavPanel, MatTabLink, RouterOutlet, RouterLink, RouterLinkActive, AssetManagerTopbarComponent], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  height: 100%;\n}\n/*# sourceMappingURL=asset-listing.component.css.map */"] });
...
_AssetManagerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetManagerComponent, selectors: [["", "asset-manager", ""]], attrs: _c05, decls: 3, vars: 0, consts: [[1, "relative", "w-1/2", "flex-1", "bg-base-100", "overflow-hidden"]], template: function AssetManagerComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "sidebar");
...
}, dependencies: [SidebarComponent, RouterOutlet], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  height: 100%;\n  width: 100%;\n  background: var(--b1);\n}\n/*# sourceMappingURL=asset-manager.component.css.map */"] });
var AssetManagerComponent = _AssetManagerComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetManagerComponent, { className: "AssetManagerComponent", filePath: "apps/concierge/src/app/asset-manager/asset-manager.component.ts", lineNumber: 22 });
})();
...
var _c06 = (a0) => ({ key: "zone", name: "Level", content: a0 });
var _c14 = () => ({ key: "description", name: "Space" });
var _c23 = (a0) => ({ key: "tracking", name: "Tracking", content: a0 });
...
function AssetLocationModalComponent_div_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ((tmp_4_0 = ctx_r1.level(ctx_r1.selected.zone)) == null ? null : tmp_4_0.display_name) || "N/A", " ");
  }
}
function AssetLocationModalComponent_interactive_map_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "interactive-map", 17);
  }
  if (rf & 2) {
    let tmp_4_0;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("src", ((tmp_4_0 = ctx_r1.level(ctx_r1.selected.zone)) == null ? null : tmp_4_0.map_id) || "")("styles", \u0275\u0275pureFunction2(5, _c6, \u0275\u0275pureFunction0(3, _c5), \u0275\u0275pureFunction0(4, _c5)))("features", ctx_r1.selected_feature);
  }
}
...
function AssetLocationModalComponent_ng_template_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ((tmp_5_0 = ctx_r1.level(data_r3)) == null ? null : tmp_5_0.display_name) || "N/A", " ");
  }
}
function AssetLocationModalComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetLocationModalComponent_ng_template_22_Template_button_click_1_listener($event) {
      \u0275\u0275restoreView(_r4);
    ...
    \u0275\u0275pipe(4, "splitjoin");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "app-icon", 23);
    \u0275\u0275text(6, "expand_more");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "mat-menu", null, 3)(9, "button", 24);
    \u0275\u0275listener("click", function AssetLocationModalComponent_ng_template_22_Template_button_click_9_listener() {
      const row_r5 = \u0275\u0275restoreView(_r4).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setTracking(row_r5, "in_storage"));
    });
    \u0275\u0275elementStart(10, "div", 25)(11, "app-icon", 23);
    \u0275\u0275text(12, "inventory");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AssetLocationModalComponent_ng_template_22_Template_button_click_15_listener() {
      const row_r5 = \u0275\u0275restoreView(_r4).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setTracking(row_r5, "in_transit"));
    });
    \u0275\u0275elementStart(16, "div", 25)(17, "app-icon", 23);
    \u0275\u0275text(18, "trolley");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AssetLocationModalComponent_ng_template_22_Template_button_click_21_listener() {
      const row_r5 = \u0275\u0275restoreView(_r4).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setTracking(row_r5, "at_location"));
    });
    \u0275\u0275elementStart(22, "div", 25)(23, "app-icon", 23);
    \u0275\u0275text(24, "place");
    \u0275\u0275elementEnd();
...
var _AssetLocationModalComponent = class _AssetLocationModalComponent {
  updateFeatures() {
    return __async(this, null, function* () {
      const space = yield this._space.transform(this.selected.extension_data?.location_id);
  ...
  setTracking(item, state2) {
    return __async(this, null, function* () {
      this.loading[item.id] = true;
      yield this._state.setTracking(item, state2);
...
_AssetLocationModalComponent.\u0275fac = function AssetLocationModalComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetLocationModalComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(OrganisationService));
};
_AssetLocationModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetLocationModalComponent, selectors: [["asset-location-modal"]], decls: 24, vars: 23, consts: [["empty_state", ""], ["level_template", ""], ["tracking_template", ""], ["tracking_menu", "matMenu"], [1, "p-6", "relative"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "top-4", "right-4"], [1, "font-medium", "mb-2"], ["appearance", "outline", 1, "h-[3.5rem]", "mb-2"], ["matPrefix", ""], ["matInput", "", "placeholder", "Search..."], [1, "flex", "items-center", "space-x-4", "w-[90vw]", "text-sm"], [1, "flex-1", "h-[60vh]", "w-1/2", "border", "border-base-200", "bg-base-200", "overflow-auto"], ["empty_message", "No requested assets for this product", 1, "block", "w-full", 3, "row_clicked", "data", "columns", "sortable"], [1, "flex-1", "h-[60vh]", "w-1/2", "border", "border-base-200", "bg-base-200", "relative", "flex", "items-center", "justify-center"], ["class", "absolute top-4 left-4 bg-base-100 px-4 py-2 rounded-3xl border border-base-200", 4, "ngIf"], [3, "src", "styles", "features", 4, "ngIf", "ngIfElse"], [1, "absolute", "top-4", "left-4", "bg-base-100", "px-4", "py-2", "rounded-3xl", "border", "border-base-200"], [3, "src", "styles", "features"], [1, "opacity-30"], [1, "p-4"], [1, "px-4", "py-2"], ["matRipple", "", 1, "bg-none", "w-full", "flex", "items-center", "px-2", "py-1", "text-left", "rounded", 3, "click", "matMenuTriggerFor", "disabled"], [1, "capitalize", "flex-1", "min-w-32"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"]], template: function AssetLocationModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 4)(1, "button", 5)(2, "app-icon");
    \u0275\u0275text(3, "close");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 10)(13, "div", 11)(14, "simple-table", 12);
    ...
    \u0275\u0275template(16, AssetLocationModalComponent_div_16_Template, 2, 1, "div", 14)(17, AssetLocationModalComponent_interactive_map_17_Template, 1, 8, "interactive-map", 15);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(18, AssetLocationModalComponent_ng_template_18_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(20, AssetLocationModalComponent_ng_template_20_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(22, AssetLocationModalComponent_ng_template_22_Template, 27, 5, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    let tmp_3_0;
    const empty_state_r7 = \u0275\u0275reference(19);
    const level_template_r8 = \u0275\u0275reference(21);
    const tracking_template_r9 = \u0275\u0275reference(23);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", (tmp_3_0 = \u0275\u0275pipeBind1(6, 8, ctx.asset)) == null ? null : tmp_3_0.name, " in use location: ", (tmp_3_0 = \u0275\u0275pipeBind1(7, 10, ctx.requests)) == null ? null : tmp_3_0.length, " ");
    \u0275\u0275advance(9);
    \u0275\u0275property("data", ctx.requests)("columns", \u0275\u0275pureFunction4(18, _c4, \u0275\u0275pureFunction1(12, _c06, level_template_r8), \u0275\u0275pureFunction0(14, _c14), \u0275\u0275pureFunction1(15, _c23, tracking_template_r9), \u0275\u0275pureFunction0(17, _c32)))("sortable", true);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.selected);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.selected)("ngIfElse", empty_state_r7);
  }
}, dependencies: [NgIf, MatFormField, MatPrefix, MatInput, MatMenu, MatMenuItem, MatMenuTrigger, MatDialogClose, MatRipple, IconComponent, InteractiveMapComponent, SimpleTableComponent, AsyncPipe, SplitJoinPipe] });
var AssetLocationModalComponent = _AssetLocationModalComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetLocationModalComponent, { className: "AssetLocationModalComponent", filePath: "apps/concierge/src/app/asset-manager/asset-location-modal.component.ts", lineNumber: 127 });
})();

// apps/concierge/src/app/asset-manager/asset-view.component.ts
var _c07 = (a0) => [a0, "list", "items"];
var _c15 = () => [];
var _c24 = (a0) => [a0, "manage", "group"];
var _c33 = (a0) => ({ id: a0 });
var _c42 = (a0) => [a0, "manage", "asset"];
var _c52 = (a0) => ({ group_id: a0 });
var _c62 = (a0) => [a0, "manage", "asset-bulk"];
var _c7 = () => ({ key: "id", name: "ID" });
var _c8 = () => ({ key: "identifier", name: "Label/Friendly Name" });
var _c9 = () => ({ key: "serial_number", name: "Serial Number" });
var _c10 = (a0) => ({ key: "actions", name: " ", content: a0, size: "5.5rem", sortable: false });
var _c11 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
var _c122 = (a0) => [a0, "manage", "purchase-order"];
var _c132 = () => ({ key: "purchase_order_number", name: "PO Number" });
var _c142 = () => ({ key: "invoice_number", name: "Invoice Number" });
var _c152 = (a0) => ({ key: "expected_service_start_date", name: "Service Start", content: a0 });
var _c16 = (a0) => ({ key: "expected_service_end_date", name: "Service End", content: a0 });
var _c17 = (a0, a1, a2, a3, a4) => [a0, a1, a2, a3, a4];
var _c18 = (a0, a1) => ({ id: a0, group_id: a1 });
function AssetViewComponent_div_0_ng_container_48_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ((tmp_10_0 = \u0275\u0275pipeBind1(2, 1, ctx_r1.item)) == null ? null : tmp_10_0.description) || "~No Description~", " ");
  }
}
...
function AssetViewComponent_div_0_ng_template_77_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetViewComponent_div_0_ng_template_77_Template_button_click_5_listener() {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(4, _c42, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction2(6, _c18, row_r4.id, (tmp_12_0 = \u0275\u0275pipeBind1(2, 2, ctx_r1.item)) == null ? null : tmp_12_0.id));
  }
}
function AssetViewComponent_div_0_ng_template_97_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 51)(1, "a", 54)(2, "app-icon", 26);
    \u0275\u0275text(3, "edit");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "button", 55);
    \u0275\u0275listener("click", function AssetViewComponent_div_0_ng_template_97_Template_button_click_4_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.removePurchaseOrder(row_r6));
    });
    \u0275\u0275elementStart(5, "app-icon", 26);
    \u0275\u0275text(6, "delete");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(2, _c122, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction2(4, _c18, row_r6.id, row_r6 == null ? null : row_r6.id));
  }
}
function AssetViewComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "div", 11)(2, "a", 12)(3, "div", 13)(4, "app-icon", 14);
    \u0275\u0275text(5, "arrow_back");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(10, "Assets");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "span")(12, "app-icon", 17);
    ...
    \u0275\u0275pipe(16, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span")(18, "app-icon", 17);
    ...
    \u0275\u0275pipe(22, "async");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div", 13)(24, "div", 18);
    \u0275\u0275element(25, "image-carousel", 19);
    \u0275\u0275pipe(26, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 20)(28, "div", 21)(29, "div", 22);
    \u0275\u0275text(30);
    \u0275\u0275pipe(31, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "div", 23)(33, "a", 24);
    \u0275\u0275pipe(34, "async");
    \u0275\u0275elementStart(35, "div", 25)(36, "app-icon", 26);
    \u0275\u0275text(37, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(40, "div", 28);
    \u0275\u0275elementStart(41, "button", 29)(42, "div", 30)(43, "app-icon", 26);
    \u0275\u0275text(44, "delete");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(48, AssetViewComponent_div_0_ng_container_48_Template, 3, 3, "ng-container", 32);
    \u0275\u0275pipe(49, "async");
    \u0275\u0275template(50, AssetViewComponent_div_0_ng_template_50_Template, 2, 0, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "div", 33)(53, "div", 34)(54, "div", 35);
    \u0275\u0275text(55);
    \u0275\u0275pipe(56, "async");
    \u0275\u0275pipe(57, "async");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(63, "async");
    \u0275\u0275pipe(64, "async");
    \u0275\u0275listener("click", function AssetViewComponent_div_0_Template_button_click_62_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.viewLocations());
    });
    \u0275\u0275text(65, " View Locations ");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(66, "mat-tab-group", 37)(67, "mat-tab", 38)(68, "div", 39)(69, "div", 40)(70, "a", 41);
    \u0275\u0275pipe(71, "async");
    \u0275\u0275text(72, " Add Asset ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "a", 41);
    \u0275\u0275pipe(74, "async");
    \u0275\u0275text(75, " Bulk Add Asset ");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(76, "simple-table", 42);
    \u0275\u0275template(77, AssetViewComponent_div_0_ng_template_77_Template, 8, 9, "ng-template", null, 6, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(79, "mat-tab", 43)(80, "div", 39)(81, "h3", 44);
    \u0275\u0275text(82, "General");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "div", 45)(84, "div", 46)(85, "label");
    \u0275\u0275text(86, "Brand");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "div");
    \u0275\u0275text(88);
    \u0275\u0275pipe(89, "async");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(90, "mat-tab", 47)(91, "div", 39)(92, "a", 48);
    \u0275\u0275pipe(93, "async");
    \u0275\u0275text(94, " Add Purchase Order ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(95, "simple-table", 49);
    \u0275\u0275pipe(96, "async");
    \u0275\u0275template(97, AssetViewComponent_div_0_ng_template_97_Template, 7, 7, "ng-template", null, 7, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_10_0;
    ...
    let tmp_31_0;
    let tmp_32_0;
    const no_desc_state_r7 = \u0275\u0275reference(51);
    const action_template_r8 = \u0275\u0275reference(78);
    const po_action_template_r9 = \u0275\u0275reference(98);
    const ctx_r1 = \u0275\u0275nextContext();
    const date_template_r10 = \u0275\u0275reference(5);
    const delete_tooltip_r11 = \u0275\u0275reference(7);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(58, _c07, ctx_r1.base_route));
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate((tmp_10_0 = \u0275\u0275pipeBind1(16, 26, ctx_r1.item)) == null ? null : tmp_10_0.category == null ? null : tmp_10_0.category.name);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate((tmp_11_0 = \u0275\u0275pipeBind1(22, 28, ctx_r1.item)) == null ? null : tmp_11_0.name);
    \u0275\u0275advance(4);
    \u0275\u0275property("images", ((tmp_12_0 = \u0275\u0275pipeBind1(26, 30, ctx_r1.item)) == null ? null : tmp_12_0.images) || \u0275\u0275pureFunction0(60, _c15));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", (tmp_13_0 = \u0275\u0275pipeBind1(31, 32, ctx_r1.item)) == null ? null : tmp_13_0.name, " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(61, _c24, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(63, _c33, (tmp_15_0 = \u0275\u0275pipeBind1(34, 34, ctx_r1.item)) == null ? null : tmp_15_0.id));
    \u0275\u0275advance(9);
    \u0275\u0275property("content", delete_tooltip_r11);
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", (tmp_17_0 = \u0275\u0275pipeBind1(49, 36, ctx_r1.item)) == null ? null : tmp_17_0.description)("ngIfElse", no_desc_state_r7);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" Available: ", \u0275\u0275pipeBind1(56, 38, ctx_r1.asset_list).length - ((tmp_19_0 = \u0275\u0275pipeBind1(57, 40, ctx_r1.requests)) == null ? null : tmp_19_0.length) || 0, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" In Use: ", ((tmp_20_0 = \u0275\u0275pipeBind1(61, 42, ctx_r1.requests)) == null ? null : tmp_20_0.length) || 0, " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", \u0275\u0275pipeBind1(63, 44, ctx_r1.asset_list).length - ((tmp_21_0 = \u0275\u0275pipeBind1(64, 46, ctx_r1.requests)) == null ? null : tmp_21_0.length) !== 0);
    \u0275\u0275advance(8);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(65, _c42, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(67, _c52, (tmp_23_0 = \u0275\u0275pipeBind1(71, 48, ctx_r1.item)) == null ? null : tmp_23_0.id));
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(69, _c62, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(71, _c52, (tmp_25_0 = \u0275\u0275pipeBind1(74, 50, ctx_r1.item)) == null ? null : tmp_25_0.id));
    \u0275\u0275advance(3);
    \u0275\u0275property("data", ctx_r1.asset_list)("columns", \u0275\u0275pureFunction4(78, _c11, \u0275\u0275pureFunction0(73, _c7), \u0275\u0275pureFunction0(74, _c8), \u0275\u0275pureFunction0(75, _c9), \u0275\u0275pureFunction1(76, _c10, action_template_r8)))("sortable", true);
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate1(" ", ((tmp_29_0 = \u0275\u0275pipeBind1(89, 52, ctx_r1.item)) == null ? null : tmp_29_0.brand) || "~None~", " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(83, _c122, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(85, _c52, (tmp_31_0 = \u0275\u0275pipeBind1(93, 54, ctx_r1.item)) == null ? null : tmp_31_0.id));
    \u0275\u0275advance(3);
    \u0275\u0275property("data", (tmp_32_0 = \u0275\u0275pipeBind1(96, 56, ctx_r1.item)) == null ? null : tmp_32_0.purchase_orders)("columns", \u0275\u0275pureFunction5(95, _c17, \u0275\u0275pureFunction0(87, _c132), \u0275\u0275pureFunction0(88, _c142), \u0275\u0275pureFunction1(89, _c152, date_template_r10), \u0275\u0275pureFunction1(91, _c16, date_template_r10), \u0275\u0275pureFunction1(93, _c10, po_action_template_r9)))("sortable", true);
  }
}
function AssetViewComponent_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "Loading product details...");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function AssetViewComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
    \u0275\u0275template(3, AssetViewComponent_ng_template_4_span_3_Template, 2, 0, "span", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const data_r12 = ctx.data;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, data_r12 * 1e3, "mediumDate"), " ");
    \u0275\u0275advance(2);
...
function AssetViewComponent_ng_template_6_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Are you sure you want to permanently delete this product?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 62)(4, "button", 63);
    \u0275\u0275listener("click", function AssetViewComponent_ng_template_6_div_0_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function AssetViewComponent_ng_template_6_div_0_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function AssetViewComponent_ng_template_6_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "mat-spinner", 57);
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "Deleting product details...");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function AssetViewComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AssetViewComponent_ng_template_6_div_0_Template, 8, 0, "div", 60)(1, AssetViewComponent_ng_template_6_ng_template_1_Template, 4, 1, "ng-template", null, 8, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const delete_loading_r14 = \u0275\u0275reference(2);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngIf", !ctx_r1.deleting)("ngIfElse", delete_loading_r14);
  }
}
function AssetViewComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 66);
    \u0275\u0275text(1, "No purchase orders");
    \u0275\u0275elementEnd();
  }
}
...
var _AssetViewComponent = class _AssetViewComponent extends AsyncHandler {
  deleteAsset() {
    return __async(this, null, function* () {
      this.deleting = true;
      yield this._state.deleteActiveProduct();
      this.deleting = false;
  ...
  removeAsset(asset) {
    return __async(this, null, function* () {
      ...
      yield deleteAsset(asset.id).toPromise();
      yield removeAssetRequests(asset.id);
      const item = yield this._state.active_product.pipe(first()).toPromise();
  ...
  removePurchaseOrder(asset) {
    return __async(this, null, function* () {
      ...
      yield deleteAssetPurchaseOrder(asset.id).toPromise();
      const item = yield this._state.active_product.pipe(first()).toPromise();
      this._state.setOptions({ active_item: "" });
      setTimeout(() => this._state.setOptions({ active_item: item.id }), 1e3);
      resp.close();
...
_AssetViewComponent.\u0275fac = function AssetViewComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetViewComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(OrganisationService));
};
...
_DurationFormatPipe.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "duration", type: _DurationFormatPipe, pure: true });
...
function AssetRequestDetailsComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      ctx_r1.request = null;
    ...
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_div_click_2_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(3, "button", 6);
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      ctx_r1.request = null;
      return \u0275\u0275resetView(ctx_r1.requestChange.emit(ctx_r1.request));
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 11)(17, "app-icon");
    \u0275\u0275text(18, "call");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "a", 12);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 11)(22, "app-icon");
    \u0275\u0275text(23, "work_outline");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div");
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(26, "div", 13)(27, "div", 14)(28, "div", 15)(29, "app-icon", 16);
    \u0275\u0275text(30, "send");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 10);
    \u0275\u0275text(32, "Asset Requested");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 17);
    \u0275\u0275template(34, AssetRequestDetailsComponent_div_0_div_34_Template, 4, 2, "div", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 19)(36, "div", 15)(37, "app-icon", 16);
    \u0275\u0275text(38, "event");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(43, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "div", 19)(45, "div", 15)(46, "app-icon", 16);
    \u0275\u0275text(47, "schedule");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(54, "duration");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "div", 19)(56, "div", 15)(57, "app-icon", 16);
    \u0275\u0275text(58, "place");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(62);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "div", 19)(64, "div", 15)(65, "app-icon", 16);
    \u0275\u0275text(66, "meeting_room");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "div", 21)(72, "button", 22)(73, "app-icon", 23);
    \u0275\u0275text(74);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "div", 24);
    \u0275\u0275text(76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "app-icon", 25);
    \u0275\u0275text(78, "expand_more");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(79, "mat-menu", 26, 0)(81, "button", 27);
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_button_click_81_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(82, " Approve ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "button", 27);
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_button_click_83_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(84, " Decline ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(85, "button", 28)(86, "div", 24);
    \u0275\u0275text(87);
    \u0275\u0275pipe(88, "splitjoin");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "app-icon", 25);
    \u0275\u0275text(90, "expand_more");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(91, "mat-menu", 26, 1)(93, "button", 27);
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_button_click_93_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setTracking("in_storage"));
    });
    \u0275\u0275text(94, " In Storage ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "button", 27);
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_button_click_95_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setTracking("in_transit"));
    });
    \u0275\u0275text(96, " In Transit ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "button", 27);
    \u0275\u0275listener("click", function AssetRequestDetailsComponent_div_0_Template_button_click_97_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setTracking("at_location"));
    });
    \u0275\u0275text(98, " At Location ");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    let tmp_13_0;
    const menu_r4 = \u0275\u0275reference(80);
    const tracking_menu_r5 = \u0275\u0275reference(92);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275property("user", \u0275\u0275pureFunction1(46, _c08, ctx_r1.request.user_name));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.request.user_name);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.request.user_company || "PlaceOS");
    \u0275\u0275advance(9);
    \u0275\u0275property("ngForOf", ctx_r1.items);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(43, 33, ctx_r1.request.date, "EEEE, MMMM d, y"), " ");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate3(" ", \u0275\u0275pipeBind2(52, 36, ctx_r1.request.date, ctx_r1.time_format), " \u2013 ", \u0275\u0275pipeBind2(53, 39, ctx_r1.request.date + ctx_r1.request.duration * 60 * 1e3, ctx_r1.time_format), " (", \u0275\u0275pipeBind1(54, 42, ctx_r1.request.duration), ") ");
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" ", ((tmp_13_0 = ctx_r1.level(ctx_r1.request.zones)) == null ? null : tmp_13_0.display_name) || "N/A", " ");
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(88, 44, ctx_r1.request.extension_data == null ? null : ctx_r1.request.extension_data.tracking) || "In Storage", " ");
  }
}
var _AssetRequestDetailsComponent = class _AssetRequestDetailsComponent {
  ...
  setStatus(status) {
    return __async(this, null, function* () {
      this.loading = true;
      yield this._state.setStatus(this.request, status);
  ...
  setTracking(state2) {
    return __async(this, null, function* () {
      this.loading = true;
      yield this._state.setTracking(this.request, state2);
      this.request.extension_data.tracking = state2;
      this.loading = false;
    });
  }
};
_AssetRequestDetailsComponent.\u0275fac = function AssetRequestDetailsComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetRequestDetailsComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(SettingsService));
};
_AssetRequestDetailsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetRequestDetailsComponent, selectors: [["asset-request-details"]], inputs: { request: "request" }, outputs: { requestChange: "requestChange" }, decls: 1, vars: 1, consts: [["menu", "matMenu"], ["tracking_menu", "matMenu"], ["class", "fixed inset-0 z-50", 3, "click", 4, "ngIf"], [1, "fixed", "inset-0", "z-50", 3, "click"], [1, "absolute", "inset-0", "bg-black", "opacity-50"], [1, "absolute", "inset-y-0", "right-0", "bg-base-100", "w-[480px]", 3, "click"], ["icon", "", "matRipple", "", 1, "absolute", "top-1", "right-1", 3, "click"], [1, "border-b", "border-base-200", "px-2", "py-4", "flex", "space-x-4"], [1, "text-xl", 3, "user"], ["details", "", 1, "space-y-1"], [1, "font-medium"], [1, "flex", "items-center", "text-sm", "space-x-2"], [1, "underline", 3, "href"], [1, "px-3", "py-4", "relative"], [1, "flex", "items-center", "space-x-4"], [1, "h-6", "w-6", "rounded-full", "text-secondary", "bg-base-200", "flex", "items-center", "justify-center"], [1, "text-sm"], [1, "pl-10", "flex", "flex-col", "mt-1"], [4, "ngFor", "ngForOf"], [1, "flex", "items-center", "space-x-4", "mt-4"], [1, "pl-10", "mt-1"], [1, "absolute", "top-4", "right-4", "text-sm"], ["matRipple", "", 1, "rounded-3xl", "!bg-opacity-20", "flex", "items-center", "px-2", "py-1", "w-full", "text-left", "space-x-2", "mb-4", 3, "matMenuTriggerFor", "disabled"], [1, "text-xl"], [1, "capitalize", "flex-1"], [1, "text-2xl"], [1, "w-36"], ["mat-menu-item", "", 3, "click"], ["matRipple", "", 1, "bg-none", "w-full", "flex", "items-center", "px-2", "py-1", "text-left", "border", "border-base-200", "rounded-none", 3, "matMenuTriggerFor", "disabled"], [1, "text-xs", "bg-success", "text-success-content", "px-2", "py-1", "rounded"]], template: function AssetRequestDetailsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, AssetRequestDetailsComponent_div_0_Template, 99, 48, "div", 2);
  }
  if (rf & 2) {
    \u0275\u0275property("ngIf", ctx.request);
  }
}, dependencies: [NgForOf, NgIf, MatMenu, MatMenuItem, MatMenuTrigger, MatRipple, IconComponent, UserAvatarComponent, DatePipe, SplitJoinPipe, DurationFormatPipe] });
var AssetRequestDetailsComponent = _AssetRequestDetailsComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetRequestDetailsComponent, { className: "AssetRequestDetailsComponent", filePath: "apps/concierge/src/app/asset-manager/asset-request-details.component.ts", lineNumber: 216 });
})();

// apps/concierge/src/app/asset-manager/asset-request-list.component.ts
var _c09 = (a0) => ({ key: "user_name", name: "Requester", content: a0 });
var _c19 = (a0) => ({ key: "date", name: "Deliver At", content: a0, size: "8rem" });
var _c25 = (a0) => ({ key: "assets", name: "Asset", content: a0, sortable: false });
var _c34 = (a0) => ({ key: "zones", name: "Floor", content: a0, size: "9rem", sortable: false });
var _c43 = () => ({ key: "description", name: "Location" });
var _c53 = (a0) => ({ key: "status", name: "Approval", content: a0, size: "11rem" });
var _c63 = (a0) => ({ key: "tracking", name: "Tracking", content: a0, size: "12rem", sortable: false });
...
function AssetRequestListComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275template(1, AssetRequestListComponent_ng_template_15_div_1_Template, 4, 2, "div", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r5 = ctx.row;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", (row_r5.extension_data == null ? null : row_r5.extension_data.request == null ? null : row_r5.extension_data.request.items) || \u0275\u0275pureFunction0(1, _c82));
  }
}
...
function AssetRequestListComponent_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21);
    \u0275\u0275text(1);
    \u0275\u0275template(2, AssetRequestListComponent_ng_template_19_span_2_Template, 2, 0, "span", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_8_0;
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (tmp_8_0 = ctx_r2.level(data_r7)) == null ? null : tmp_8_0.display_name, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r2.level(data_r7));
  }
}
function AssetRequestListComponent_ng_template_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15, "Approve Asset Request");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "button", 29);
    \u0275\u0275listener("click", function AssetRequestListComponent_ng_template_21_Template_button_click_16_listener() {
      const row_r9 = \u0275\u0275restoreView(_r8).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setStatus(row_r9, "declined"));
    });
    \u0275\u0275elementStart(17, "div", 30)(18, "app-icon", 28);
    \u0275\u0275text(19, "event_busy");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 31);
    \u0275\u0275text(21, "Decline Asset Request");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function AssetRequestListComponent_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 24)(1, "button", 32);
    ...
    \u0275\u0275listener("click", function AssetRequestListComponent_ng_template_23_Template_button_click_15_listener() {
      const row_r12 = \u0275\u0275restoreView(_r11).row;
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AssetRequestListComponent_ng_template_23_Template_button_click_21_listener() {
      const row_r12 = \u0275\u0275restoreView(_r11).row;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setTracking(row_r12, "at_location"));
    });
    \u0275\u0275elementStart(22, "div", 30)(23, "app-icon", 28);
    \u0275\u0275text(24, "place");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 3, row_r12.extension_data == null ? null : row_r12.extension_data.tracking) || "In Storage", " ");
  }
}
var _AssetRequestListComponent = class _AssetRequestListComponent extends AsyncHandler {
  ...
  setStatus(item, status) {
    return __async(this, null, function* () {
      this.loading[item.id] = true;
      yield this._state.setStatus(item, status);
      this.loading[item.id] = false;
    });
  }
  setTracking(item, state2) {
...
_AssetRequestListComponent.\u0275fac = function AssetRequestListComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetRequestListComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(OrganisationService), \u0275\u0275directiveInject(SettingsService));
};
_AssetRequestListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetRequestListComponent, selectors: [["app-asset-request-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 26, vars: 40, consts: [["user_template", ""], ["assets_template", ""], ["date_template", ""], ["level_template", ""], ["approval_template", ""], ["tracking_template", ""], ["menu", "matMenu"], ["tracking_menu", "matMenu"], [1, "relative", "w-full", "h-[calc(100%-1rem)]", "flex", "flex-col"], [1, "flex", "items-center", "justify-between"], [1, "opacity-60", "text-sm", "p-4"], [3, "dateChange", "date"], [1, "w-full", "overflow-auto", "h-1/2", "flex-1", "pt-2"], ["asset-requests", "", 1, "block", "min-w-[82rem]", "text-sm", 3, "row_clicked", "data", "filter", "columns", "empty_message", "sortable"], [1, "w-full", "h-20"], [3, "requestChange", "request"], [1, "flex", "flex-col", "px-4", "py-2", "text-left"], [1, "text-xs", "opacity-30"], [1, "flex", "flex-col", "p-4"], [4, "ngFor", "ngForOf"], [1, "font-mono", "text-sm"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"], [1, "px-4", "py-2"], ["matRipple", "", 1, "rounded-3xl", "!bg-opacity-20", "flex", "items-center", "px-2", "py-1", "w-full", "text-left", "space-x-2", 3, "click", "matMenuTriggerFor", "disabled"], [1, "text-xl"], [1, "capitalize", "flex-1"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "bg-none", "w-full", "flex", "items-center", "px-2", "py-1", "text-left", "rounded", 3, "click", "matMenuTriggerFor", "disabled"], [1, "capitalize", "flex-1", "min-w-32"]], template: function AssetRequestListComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275element(12, "div", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, AssetRequestListComponent_ng_template_13_Template, 7, 9, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(15, AssetRequestListComponent_ng_template_15_Template, 2, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(17, AssetRequestListComponent_ng_template_17_Template, 3, 4, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(19, AssetRequestListComponent_ng_template_19_Template, 3, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(21, AssetRequestListComponent_ng_template_21_Template, 22, 16, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(23, AssetRequestListComponent_ng_template_23_Template, 27, 5, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(25, "asset-request-details", 15);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", (tmp_6_0 = \u0275\u0275pipeBind1(4, 9, ctx.requests)) == null ? null : tmp_6_0.length, " asset request", ((tmp_6_0 = \u0275\u0275pipeBind1(5, 11, ctx.requests)) == null ? null : tmp_6_0.length) === "1" ? "" : "s", " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("date", (tmp_7_0 = \u0275\u0275pipeBind1(7, 13, ctx.filters)) == null ? null : tmp_7_0.date);
    \u0275\u0275advance(3);
    \u0275\u0275property("data", ctx.requests)("filter", (tmp_9_0 = \u0275\u0275pipeBind1(10, 15, ctx.filters)) == null ? null : tmp_9_0.search)("columns", \u0275\u0275pureFunction7(32, _c72, \u0275\u0275pureFunction1(19, _c09, user_template_r14), \u0275\u0275pureFunction1(21, _c19, date_template_r16), \u0275\u0275pureFunction1(23, _c25, assets_template_r15), \u0275\u0275pureFunction1(25, _c34, level_template_r17), \u0275\u0275pureFunction0(27, _c43), \u0275\u0275pureFunction1(28, _c53, approval_template_r18), \u0275\u0275pureFunction1(30, _c63, tracking_template_r19)))("empty_message", ((tmp_11_0 = \u0275\u0275pipeBind1(11, 17, ctx.filters)) == null ? null : tmp_11_0.search) ? "No matching asset requests" : "There are no asset requests for the currently selected date.")("sortable", true);
    \u0275\u0275advance(16);
    \u0275\u0275twoWayProperty("request", ctx.request);
  }
}, dependencies: [NgForOf, NgIf, DateOptionsComponent, MatMenu, MatMenuItem, MatMenuTrigger, MatRipple, IconComponent, SimpleTableComponent, AssetRequestDetailsComponent, AsyncPipe, DatePipe, SplitJoinPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=asset-request-list.component.css.map */"] });
var AssetRequestListComponent = _AssetRequestListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetRequestListComponent, { className: "AssetRequestListComponent", filePath: "apps/concierge/src/app/asset-manager/asset-request-list.component.ts", lineNumber: 220 });
})();

// apps/concierge/src/app/asset-manager/asset-item-list.component.ts
var _c010 = (a0, a1) => [a0, "view", a1];
...
function AssetItemListComponent_div_0_ng_container_1_div_1_ng_container_10_a_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(5, _c010, ctx_r2.base_route, asset_r1.id));
    \u0275\u0275advance(2);
...
function AssetItemListComponent_div_0_ng_container_1_div_1_ng_container_11_a_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(5);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(5, _c010, ctx_r2.base_route, asset_r5.id));
    \u0275\u0275advance(2);
...
function AssetItemListComponent_div_0_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" (", (tmp_6_0 = \u0275\u0275pipeBind1(6, 5, ctx_r2.products)[group_r4.id]) == null ? null : tmp_6_0.length, " item", ((tmp_6_0 = \u0275\u0275pipeBind1(7, 7, ctx_r2.products)[group_r4.id]) == null ? null : tmp_6_0.length) === 1 ? "" : "s", ") ");
    \u0275\u0275advance(3);
...
function AssetItemListComponent_div_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, AssetItemListComponent_div_0_ng_container_1_div_1_Template, 12, 11, "div", 6);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AssetItemListComponent_ng_template_5_a_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(1, _c110, ctx_r2.base_route));
  }
}
...
}, dependencies: [NgForOf, NgIf, NgSwitch, NgSwitchCase, NgSwitchDefault, MatProgressBar, MatRipple, AuthenticatedImageDirective, RouterLink, AsyncPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  width: 100%;\n  height: 100%;\n}\n/*# sourceMappingURL=asset-item-list.component.css.map */"] });
var AssetItemListComponent = _AssetItemListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetItemListComponent, { className: "AssetItemListComponent", filePath: "apps/concierge/src/app/asset-manager/asset-item-list.component.ts", lineNumber: 190 });
})();

// apps/concierge/src/app/asset-manager/asset-purchase-order-form.component.ts
var _c011 = (a0, a1) => [a0, "view", a1];
var _c111 = (a0) => [a0, "list", "purchase-orders"];
var _c26 = () => [];
var _c35 = () => ({ key: "name", name: "Name" });
var _c44 = () => ({ key: "identifier", name: "Label/Friendly Name" });
var _c54 = () => ({ key: "serial_number", name: "Serial Number" });
var _c64 = (a0) => ({ key: "actions", name: " ", content: a0 });
var _c73 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
function AssetPurchaseOrderFormComponent_div_1_h3_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h3", 31);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Associated Assets (", ((tmp_3_0 = \u0275\u0275pipeBind1(2, 1, ctx_r1.asset_list)) == null ? null : tmp_3_0.length) || "0", ") ");
  }
}
function AssetPurchaseOrderFormComponent_div_1_simple_table_43_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("data", \u0275\u0275pipeBind1(1, 2, ctx_r1.asset_list) || \u0275\u0275pureFunction0(4, _c26))("columns", \u0275\u0275pureFunction4(10, _c73, \u0275\u0275pureFunction0(5, _c35), \u0275\u0275pureFunction0(6, _c44), \u0275\u0275pureFunction0(7, _c54), \u0275\u0275pureFunction1(8, _c64, ctx_r1.action_template)));
  }
}
function AssetPurchaseOrderFormComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "main", 6)(5, "div", 7)(6, "label", 8);
    \u0275\u0275text(7, " Order Number");
    ...
    \u0275\u0275text(13, "Order number is required");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "div", 7)(15, "label", 11);
    \u0275\u0275text(16, " Invoice Number ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "mat-form-field", 9);
    \u0275\u0275element(18, "input", 12);
    \u0275\u0275elementStart(19, "mat-error");
    \u0275\u0275text(20, "Invoice number is required");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "div", 13)(22, "div", 14)(23, "label", 15);
    \u0275\u0275text(24, " Purchase Date ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(25, "a-date-field", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "div", 14)(27, "label", 17);
    \u0275\u0275text(28, " Purchase Price ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-form-field", 18)(30, "div", 19);
    \u0275\u0275text(31, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275element(32, "input", 20);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(33, "div", 13)(34, "div", 21)(35, "label", 22);
    \u0275\u0275text(36, " Expected Service Start Date ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(37, "a-date-field", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 21)(39, "label", 24);
    \u0275\u0275text(40, " Expected Service End Date ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(41, "a-date-field", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(42, AssetPurchaseOrderFormComponent_div_1_h3_42_Template, 3, 3, "h3", 26)(43, AssetPurchaseOrderFormComponent_div_1_simple_table_43_Template, 2, 15, "simple-table", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "footer", 28)(45, "a", 29);
    \u0275\u0275text(46, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "button", 30);
    \u0275\u0275listener("click", function AssetPurchaseOrderFormComponent_div_1_Template_button_click_47_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.save());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.form.value.id ? "Edit" : "Add", " Purchase Order ");
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(21);
    \u0275\u0275property("from", ctx_r1.from);
    \u0275\u0275advance(7);
    \u0275\u0275property("from", ctx_r1.from);
    \u0275\u0275advance(5);
    \u0275\u0275property("from", ctx_r1.from);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.item == null ? null : ctx_r1.item.id);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.item == null ? null : ctx_r1.item.id);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", ctx_r1.product_id ? \u0275\u0275pureFunction2(8, _c011, ctx_r1.base_route, ctx_r1.product_id) : \u0275\u0275pureFunction1(11, _c111, ctx_r1.base_route));
  }
}
...
var _AssetPurchaseOrderFormComponent = class _AssetPurchaseOrderFormComponent extends AsyncHandler {
  ...
  constructor(_state, _route, _router, _org) {
    ...
    this.asset_list = combineLatest([
      this._id,
      this._org.active_building
    ]).pipe(filter(([_, bld]) => !!_ && !!bld), switchMap(([id]) => queryAssets({ order_id: id })), switchMap((asset_list) => __async(this, null, function* () {
      const groups = yield queryAssetGroups({
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe((params) => __async(this, null, function* () {
      if (params.get("id")) {
        ...
        const asset = yield showAssetPurchaseOrder(params.get("id")).toPromise().catch(() => null);
        if (!asset) {
  ...
  save() {
    return __async(this, null, function* () {
      ...
      const item = yield saveAssetPurchaseOrder(data).toPromise().catch((e) => {
        this.loading = "";
...
_AssetPurchaseOrderFormComponent.\u0275fac = function AssetPurchaseOrderFormComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetPurchaseOrderFormComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(OrganisationService));
};
_AssetPurchaseOrderFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetPurchaseOrderFormComponent, selectors: [["asset-purchase-order-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 2, consts: [["load_state", ""], [1, "absolute", "inset-0", "bg-base-100"], ["class", "h-full max-w-[32rem] mx-auto flex flex-col", 4, "ngIf", "ngIfElse"], [1, "h-full", "max-w-[32rem]", "mx-auto", "flex", "flex-col"], [1, "p-4"], [1, "text-center", "text-xl", "font-medium"], [1, "flex-1", "h-1/2", "overflow-auto", 3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "order-number"], ["appearance", "outline"], ["matInput", "", "name", "order-number", "placeholder", "Order Number", "formControlName", "order_number"], ["for", "invoice-number"], ["matInput", "", "name", "invoice-number", "placeholder", "Invoice Number", "formControlName", "invoice_number"], [1, "flex", "space-x-2"], [1, "flex-1", "flex", "flex-col", "space-y-2"], ["for", "purchase-date"], ["name", "purchase-date", "formControlName", "purchase_date", 3, "from"], ["for", "unit-price"], ["appearance", "outline", 1, "w-full"], ["matPrefix", ""], ["matInput", "", "name", "unit-price", "formControlName", "unit_price", 3, "from"], [1, "flex", "flex-col", "space-y-2", "flex-1"], ["for", "depreciation-start-date"], ["name", "depreciation-start-date", "formControlName", "expected_service_start_date", 3, "from"], ["for", "depreciation-end-date"], ["name", "depreciation-end-date", "formControlName", "expected_service_end_date"], ["class", "font-medium mb-2", 4, "ngIf"], ["class", "w-full block text-sm", "empty_message", "No assets for this purchase order", 3, "data", "columns", 4, "ngIf"], [1, "flex", "justify-end", "space-x-2", "p-2", "border-t", "border-base-200"], ["btn", "", "matRipple", "", 1, "w-32", "inverse", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "font-medium", "mb-2"], ["empty_message", "No assets for this purchase order", 1, "w-full", "block", "text-sm", 3, "data", "columns"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function AssetPurchaseOrderFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275template(1, AssetPurchaseOrderFormComponent_div_1_Template, 49, 13, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, AssetPurchaseOrderFormComponent_ng_template_2_Template, 4, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
}, dependencies: [NgIf, MatFormField, MatError, MatPrefix, MatInput, MatProgressSpinner, MatRipple, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, DateFieldComponent, SimpleTableComponent, RouterLink, AsyncPipe] });
var AssetPurchaseOrderFormComponent = _AssetPurchaseOrderFormComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetPurchaseOrderFormComponent, { className: "AssetPurchaseOrderFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-purchase-order-form.component.ts", lineNumber: 155 });
})();

// apps/concierge/src/app/asset-manager/asset-form.component.ts
var _c012 = () => ({ standalone: true });
var _c112 = (a0, a1) => [a0, "view", a1];
var _c27 = (a0) => [a0];
function AssetFormComponent_div_1_mat_option_30_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", order_r2.purchase_order_number || order_r2.invoice_number, " ");
  }
}
...
function AssetFormComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7, "Product");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-form-field", 9);
    \u0275\u0275element(9, "input", 10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 11)(11, "div", 7)(12, "label", 12);
    \u0275\u0275text(13, " Serial Number ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "mat-form-field", 9);
    \u0275\u0275element(15, "input", 13);
    \u0275\u0275elementStart(16, "mat-error");
    \u0275\u0275text(17, "Serial Number is required");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "div", 7)(19, "label", 14);
    \u0275\u0275text(20, "Label/Friendly Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "mat-form-field", 9);
    \u0275\u0275element(22, "input", 15);
    \u0275\u0275elementStart(23, "mat-error");
    \u0275\u0275text(24, " Label/Friendly Name is required ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(25, "div", 7)(26, "label", 16);
    \u0275\u0275text(27, " Purchase Order ID ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "mat-form-field", 9)(29, "mat-select", 17);
    \u0275\u0275template(30, AssetFormComponent_div_1_mat_option_30_Template, 2, 2, "mat-option", 18);
    \u0275\u0275pipe(31, "async");
    \u0275\u0275template(32, AssetFormComponent_div_1_mat_option_32_Template, 2, 1, "mat-option", 19);
    \u0275\u0275pipe(33, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "mat-error");
    \u0275\u0275text(35, " Purchase Order ID is required ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(36, "div", 7)(37, "label", 12);
    \u0275\u0275text(38, "Barcode");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-form-field", 9);
    \u0275\u0275element(40, "input", 20);
    \u0275\u0275elementStart(41, "mat-error");
    \u0275\u0275text(42, "Barcode is required");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(43, "footer", 21)(44, "a", 22);
    \u0275\u0275text(45, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "button", 23);
    \u0275\u0275listener("click", function AssetFormComponent_div_1_Template_button_click_46_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r2.form.value.id ? "Edit" : "Add", " Asset ");
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r2.form);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", (ctx_r2.product == null ? null : ctx_r2.product.name) || "No Product")("ngModelOptions", \u0275\u0275pureFunction0(12, _c012))("disabled", true);
    \u0275\u0275advance(21);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(31, 8, ctx_r2.purchase_orders));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !((tmp_8_0 = \u0275\u0275pipeBind1(33, 10, ctx_r2.purchase_orders)) == null ? null : tmp_8_0.length));
    \u0275\u0275advance(12);
    \u0275\u0275property("routerLink", ctx_r2.product ? \u0275\u0275pureFunction2(13, _c112, ctx_r2.base_route, ctx_r2.product.id) : \u0275\u0275pureFunction1(16, _c27, ctx_r2.base_route));
  }
}
...
var _AssetFormComponent = class _AssetFormComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe((params) => __async(this, null, function* () {
      if (params.get("id")) {
        ...
        const asset = yield showAsset(params.get("id")).toPromise().catch(() => null);
        if (!asset) {
      ...
      if (params.get("group_id")) {
        ...
        const product = yield showAssetGroup(params.get("group_id")).toPromise().catch(() => null);
        if (!product) {
  ...
  save() {
    return __async(this, null, function* () {
      ...
      this.loading = "Saving Product...";
      const data = this.form.value;
      const item = yield saveAsset(__spreadProps(__spreadValues({}, data), {
        zone_id: this._org.building.id
      })).toPromise().catch((e) => {
        this.loading = "";
...
_AssetFormComponent.\u0275fac = function AssetFormComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetFormComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(OrganisationService));
};
_AssetFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetFormComponent, selectors: [["asset-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 2, consts: [["load_state", ""], [1, "absolute", "inset-0", "bg-base-100"], ["class", "h-full max-w-[32rem] mx-auto flex flex-col", 4, "ngIf", "ngIfElse"], [1, "h-full", "max-w-[32rem]", "mx-auto", "flex", "flex-col"], [1, "p-4"], [1, "text-center", "text-xl", "font-medium"], [1, "flex-1", "h-1/2", "overflow-auto", 3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", 3, "ngModel", "ngModelOptions", "disabled"], [1, "flex", "items-center", "space-x-2"], ["for", "serial-number"], ["matInput", "", "name", "serial-number", "placeholder", "Serial Number", "formControlName", "serial_number"], ["for", "identifier"], ["matInput", "", "name", "identifier", "placeholder", "Identifier, Asset ID or Barcode", "formControlName", "identifier"], ["for", "purchase-order-id"], ["formControlName", "purchase_order_id", "placeholder", "Select Purchase Order"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "opacity-60", 3, "disabled", 4, "ngIf"], ["matInput", "", "name", "barcode", "placeholder", "Barcode", "formControlName", "barcode"], [1, "flex", "justify-end", "space-x-2", "p-2", "border-t", "border-base-200"], ["btn", "", "matRipple", "", 1, "w-32", "inverse", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [3, "value"], [1, "opacity-60", 3, "disabled"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function AssetFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275template(1, AssetFormComponent_div_1_Template, 48, 18, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, AssetFormComponent_ng_template_2_Template, 4, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
}, dependencies: [NgForOf, NgIf, MatFormField, MatError, MatInput, MatSelect, MatOption, MatProgressSpinner, MatRipple, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, RouterLink, AsyncPipe] });
var AssetFormComponent = _AssetFormComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetFormComponent, { className: "AssetFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-form.component.ts", lineNumber: 150 });
})();

// apps/concierge/src/app/asset-manager/asset-group-form.component.ts
var _c013 = (a0, a1) => [a0, "view", a1];
var _c113 = (a0) => [a0, "list", "items"];
function AssetGroupFormComponent_div_1_mat_option_21_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", category_r3.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", category_r3.name, " ");
  }
}
function AssetGroupFormComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(18, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "mat-form-field", 9)(20, "mat-select", 11);
    \u0275\u0275listener("click", function AssetGroupFormComponent_div_1_Template_mat_select_click_20_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.current_category = ctx_r1.form.value.category_id);
    });
    \u0275\u0275template(21, AssetGroupFormComponent_div_1_mat_option_21_Template, 2, 2, "mat-option", 12);
    \u0275\u0275pipe(22, "async");
    \u0275\u0275elementStart(23, "mat-option", 13);
    \u0275\u0275listener("click", function AssetGroupFormComponent_div_1_Template_mat_option_click_23_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.newCategory());
    });
    \u0275\u0275elementStart(24, "div", 14)(25, "app-icon");
    \u0275\u0275text(26, "add");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "p");
    \u0275\u0275text(28, "New Category");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(29, "mat-error");
    \u0275\u0275text(30, "Category is required");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "div", 7)(32, "label", 15);
    \u0275\u0275text(33, "Brand");
    \u0275\u0275elementStart(34, "span");
    \u0275\u0275text(35, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "mat-form-field", 9);
    \u0275\u0275element(37, "input", 16);
    \u0275\u0275elementStart(38, "mat-error");
    \u0275\u0275text(39, "Brand is required");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "div", 7)(41, "label", 17);
    \u0275\u0275text(42, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "mat-form-field", 9);
    \u0275\u0275element(44, "textarea", 18);
    \u0275\u0275elementStart(45, "mat-error");
    \u0275\u0275text(46, "Description is required");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(47, "div", 7)(48, "label", 19);
    \u0275\u0275text(49, "Images");
    \u0275\u0275elementEnd();
    \u0275\u0275element(50, "image-list-field", 20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "footer", 21)(52, "a", 22);
    \u0275\u0275text(53, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "button", 23);
    \u0275\u0275listener("click", function AssetGroupFormComponent_div_1_Template_button_click_54_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.save());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.form.value.id ? "Edit" : "Add", " Product ");
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(17);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(22, 4, ctx_r1.categories));
    \u0275\u0275advance(31);
    \u0275\u0275property("routerLink", ctx_r1.form.value.id ? \u0275\u0275pureFunction2(6, _c013, ctx_r1.base_route, ctx_r1.form.value.id) : \u0275\u0275pureFunction1(9, _c113, ctx_r1.base_route));
  }
}
...
var _AssetGroupFormComponent = class _AssetGroupFormComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe((params) => __async(this, null, function* () {
      if (params.get("id")) {
        this.loading = "Loading Product Details...";
        const product = yield showAssetGroup(params.get("id")).toPromise().catch(() => null);
        if (!product) {
  ...
  newCategory() {
    return __async(this, null, function* () {
      ...
      const category = yield this._state.editCategory();
      if (!category)
        return;
  ...
  save() {
    return __async(this, null, function* () {
      ...
      this.loading = "Saving Product...";
      const data = this.form.value;
      const item = yield saveAssetGroup(data).toPromise().catch((e) => {
        this.loading = "";
...
_AssetGroupFormComponent.\u0275fac = function AssetGroupFormComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetGroupFormComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(MatDialog));
};
_AssetGroupFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetGroupFormComponent, selectors: [["asset-group-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 2, consts: [["load_state", ""], [1, "absolute", "inset-0", "bg-base-100"], ["class", "h-full max-w-[32rem] mx-auto flex flex-col", 4, "ngIf", "ngIfElse"], [1, "h-full", "max-w-[32rem]", "mx-auto", "flex", "flex-col"], [1, "p-4"], [1, "text-center", "text-xl", "font-medium"], [1, "flex-1", "h-1/2", "overflow-auto", "p-2", 3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "placeholder", "Name of the product", "formControlName", "name"], ["formControlName", "category_id", "placeholder", "Category of Product", 3, "click"], [3, "value", 4, "ngFor", "ngForOf"], [1, "relative", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["for", "brand"], ["matInput", "", "name", "brand", "placeholder", "Brand of the product", "formControlName", "brand"], ["for", "description"], ["matInput", "", "name", "description", "placeholder", "Description of the product", "formControlName", "description"], ["for", "images"], ["name", "images", "formControlName", "images"], [1, "flex", "justify-end", "space-x-2", "p-2", "border-t", "border-base-200"], ["btn", "", "matRipple", "", 1, "w-32", "inverse", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [3, "value"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function AssetGroupFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275template(1, AssetGroupFormComponent_div_1_Template, 56, 11, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, AssetGroupFormComponent_ng_template_2_Template, 4, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const load_state_r4 = \u0275\u0275reference(3);
    \u0275\u0275advance();
...
}, dependencies: [NgForOf, NgIf, MatFormField, MatError, MatInput, MatSelect, MatOption, MatProgressSpinner, MatRipple, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, ImageListFieldComponent, IconComponent, RouterLink, AsyncPipe] });
var AssetGroupFormComponent = _AssetGroupFormComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetGroupFormComponent, { className: "AssetGroupFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-group-form.component.ts", lineNumber: 134 });
})();

// apps/concierge/src/app/asset-manager/asset-purchase-order-list.component.ts
var _c014 = () => ({ key: "purchase_order_number", name: "PO Number" });
var _c114 = () => ({ key: "invoice_number", name: "Invoice Number" });
var _c28 = (a0) => ({ key: "purchase_date", name: "Purchase Date", content: a0 });
var _c36 = (a0) => ({ key: "expected_service_start_date", name: "Service Start", content: a0 });
var _c45 = (a0) => ({ key: "expected_service_end_date", name: "Service End", content: a0 });
...
function AssetPurchaseOrderListComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275template(1, AssetPurchaseOrderListComponent_ng_template_5_span_1_Template, 2, 0, "span", 5);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd();
  }
...
_AssetPurchaseOrderListComponent.\u0275fac = function AssetPurchaseOrderListComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetPurchaseOrderListComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(Router));
};
_AssetPurchaseOrderListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetPurchaseOrderListComponent, selectors: [["app-asset-purchase-order-list"]], decls: 7, vars: 23, consts: [["date_template", ""], [1, "relative", "-left-4", "w-[calc(100%+2rem)]", "mt-4", "h-[calc(100%-1rem)]", "flex", "flex-col"], [1, "w-full", "overflow-auto", "h-1/2", "flex-1", "p-4"], ["purchase-orders", "", 1, "min-w-[52rem]", "block", "text-sm", 3, "row_clicked", "data", "columns", "empty_message", "filter", "sortable"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]], template: function AssetPurchaseOrderListComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(5, AssetPurchaseOrderListComponent_ng_template_5_Template, 4, 5, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    let tmp_3_0;
    let tmp_4_0;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx.purchase_orders)("columns", \u0275\u0275pureFunction5(17, _c55, \u0275\u0275pureFunction0(9, _c014), \u0275\u0275pureFunction0(10, _c114), \u0275\u0275pureFunction1(11, _c28, date_template_r3), \u0275\u0275pureFunction1(13, _c36, date_template_r3), \u0275\u0275pureFunction1(15, _c45, date_template_r3)))("empty_message", ((tmp_3_0 = \u0275\u0275pipeBind1(3, 5, ctx.filters)) == null ? null : tmp_3_0.search) ? "No matching purchase orders found." : "There are purchase orders for this building.")("filter", (tmp_4_0 = \u0275\u0275pipeBind1(4, 7, ctx.filters)) == null ? null : tmp_4_0.search)("sortable", true);
  }
}, dependencies: [NgIf, SimpleTableComponent, AsyncPipe, DatePipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=asset-purchase-order-list.component.css.map */"] });
var AssetPurchaseOrderListComponent = _AssetPurchaseOrderListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetPurchaseOrderListComponent, { className: "AssetPurchaseOrderListComponent", filePath: "apps/concierge/src/app/asset-manager/asset-purchase-order-list.component.ts", lineNumber: 71 });
})();

// apps/concierge/src/app/asset-manager/asset-bulk-form.component.ts
var _c015 = () => ({ standalone: true });
var _c115 = (a0, a1) => [a0, "view", a1];
var _c29 = (a0) => [a0];
function AssetBulkFormComponent_div_1_mat_option_28_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", order_r3.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", order_r3.purchase_order_number || order_r3.invoice_number, " ");
  }
}
...
function AssetBulkFormComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 11)(11, "div", 7)(12, "label", 12);
    \u0275\u0275text(13, " Number of Assets to create ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "mat-form-field", 9)(15, "input", 13);
    \u0275\u0275twoWayListener("ngModelChange", function AssetBulkFormComponent_div_1_Template_input_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.count, $event) || (ctx_r1.count = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(16, "div", 7)(17, "label", 14);
    \u0275\u0275text(18, "Label/Friendly Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 9);
    \u0275\u0275element(20, "input", 15);
    \u0275\u0275elementStart(21, "mat-error");
    \u0275\u0275text(22, " Label/Friendly Name is required ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div", 7)(24, "label", 16);
    \u0275\u0275text(25, " Purchase Order ID ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "mat-form-field", 9)(27, "mat-select", 17);
    \u0275\u0275template(28, AssetBulkFormComponent_div_1_mat_option_28_Template, 2, 2, "mat-option", 18);
    \u0275\u0275pipe(29, "async");
    \u0275\u0275template(30, AssetBulkFormComponent_div_1_mat_option_30_Template, 2, 1, "mat-option", 19);
    \u0275\u0275pipe(31, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "mat-error");
    \u0275\u0275text(33, " Purchase Order ID is required ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(34, "footer", 20)(35, "a", 21);
    \u0275\u0275text(36, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "button", 22);
    \u0275\u0275listener("click", function AssetBulkFormComponent_div_1_Template_button_click_37_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.save());
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Bulk ", ctx_r1.form.value.id ? "Edit" : "Add", " Asset ");
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", (ctx_r1.product == null ? null : ctx_r1.product.name) || "No Product")("ngModelOptions", \u0275\u0275pureFunction0(14, _c015))("disabled", true);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.count);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(15, _c015));
    \u0275\u0275advance(13);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(29, 10, ctx_r1.purchase_orders));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !((tmp_10_0 = \u0275\u0275pipeBind1(31, 12, ctx_r1.purchase_orders)) == null ? null : tmp_10_0.length));
    \u0275\u0275advance(5);
    \u0275\u0275property("routerLink", ctx_r1.product ? \u0275\u0275pureFunction2(16, _c115, ctx_r1.base_route, ctx_r1.product.id) : \u0275\u0275pureFunction1(19, _c29, ctx_r1.base_route));
  }
}
...
var _AssetBulkFormComponent = class _AssetBulkFormComponent extends AsyncHandler {
  ...
  save() {
    return __async(this, null, function* () {
      ...
      this.loading = "Saving Product...";
      const data = this.form.value;
      const list = yield addAssetsInBulk(new Array(this.count).fill(__spreadProps(__spreadValues({}, data), {
        zone_id: this._org.building.id
      }))).toPromise().catch((e) => {
        this.loading = "";
        notifyError(`Error saving asset: ${e.message}`);
...
_AssetBulkFormComponent.\u0275fac = function AssetBulkFormComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AssetBulkFormComponent)(\u0275\u0275directiveInject(AssetManagerStateService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(OrganisationService));
};
_AssetBulkFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetBulkFormComponent, selectors: [["asset-bulk-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 4, vars: 2, consts: [["load_state", ""], [1, "absolute", "inset-0", "bg-base-100"], ["class", "h-full max-w-[32rem] mx-auto flex flex-col", 4, "ngIf", "ngIfElse"], [1, "h-full", "max-w-[32rem]", "mx-auto", "flex", "flex-col"], [1, "p-4"], [1, "text-center", "text-xl", "font-medium"], [1, "flex-1", "h-1/2", "overflow-auto", 3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", 3, "ngModel", "ngModelOptions", "disabled"], [1, "flex", "items-center", "space-x-2"], ["for", "count"], ["matInput", "", "name", "count", "type", "number", "placeholder", "Number of assets to add", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "identifier"], ["matInput", "", "name", "identifier", "placeholder", "Identifier, Asset ID or Barcode", "formControlName", "identifier"], ["for", "purchase-order-id"], ["formControlName", "purchase_order_id", "placeholder", "Select Purchase Order"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "opacity-60", 3, "disabled", 4, "ngIf"], [1, "flex", "justify-end", "space-x-2", "p-2", "border-t", "border-base-200"], ["btn", "", "matRipple", "", 1, "w-32", "inverse", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [3, "value"], [1, "opacity-60", 3, "disabled"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function AssetBulkFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275template(1, AssetBulkFormComponent_div_1_Template, 39, 21, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, AssetBulkFormComponent_ng_template_2_Template, 4, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const load_state_r4 = \u0275\u0275reference(3);
    \u0275\u0275advance();
...
}, dependencies: [NgForOf, NgIf, MatFormField, MatError, MatInput, MatSelect, MatOption, MatProgressSpinner, MatRipple, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, FormGroupDirective, FormControlName, RouterLink, AsyncPipe] });
var AssetBulkFormComponent = _AssetBulkFormComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetBulkFormComponent, { className: "AssetBulkFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-bulk-form.component.ts", lineNumber: 141 });
})();

// apps/concierge/src/app/asset-manager/new-asset-manager.component.ts
var _c016 = ["asset-manager", ""];
var _NewAssetManagerComponent = class _NewAssetManagerComponent {
};
_NewAssetManagerComponent.\u0275fac = function NewAssetManagerComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NewAssetManagerComponent)();
};
_NewAssetManagerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewAssetManagerComponent, selectors: [["", "asset-manager", ""]], attrs: _c016, decls: 5, vars: 0, consts: [[1, "flex", "flex-1", "h-px"], [1, "flex", "flex-col", "flex-1", "w-1/2", "h-full"]], template: function NewAssetManagerComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [ApplicationTopbarComponent, ApplicationSidebarComponent, RouterOutlet], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: 100%;\n  background-color: var(--b1);\n}\n/*# sourceMappingURL=new-asset-manager.component.css.map */"] });
var NewAssetManagerComponent = _NewAssetManagerComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewAssetManagerComponent, { className: "NewAssetManagerComponent", filePath: "apps/concierge/src/app/asset-manager/new-asset-manager.component.ts", lineNumber: 26 });
})();
...
//# sourceMappingURL=asset-manager.module-TPK5NHRK.js.map
