...
function FooterMenuComponent_Conditional_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 8)(1, "icon", 10);
...
function FooterMenuComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(7, FooterMenuComponent_Conditional_0_Conditional_7_Template, 6, 5, "a", 8);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.features().includes("visitor-invite") ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.features().includes("schedule") ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.features().includes("events") ? 7 : -1);
  }
}
function FooterMenuComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 1)(1, "a", 11)(2, "icon", 12);
    \u0275\u0275text(3, "home");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(10, "icon", 16);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "a", 17)(13, "icon", 12);
    \u0275\u0275text(14, "place");
    \u0275\u0275elementEnd();
...
var _FooterMenuComponent = class _FooterMenuComponent extends AsyncHandler {
  constructor() {
    ...
    this.blur_backdrop = model(false);
...
_FooterMenuComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterMenuComponent, selectors: [["footer-menu"]], inputs: { blur_backdrop: [1, "blur_backdrop"] }, outputs: { blur_backdrop: "blur_backdropChange" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 2, consts: [[1, "fixed", "inset-0", "bottom-16", "z-20"], [1, "border-base-200", "bg-base-100", "relative", "z-40", "flex", "h-16", "w-full", "items-center", "justify-center", "border-t", "shadow-sm", "sm:hidden"], [1, "fixed", "inset-0", "bottom-16", "z-20", 3, "click"], [1, "absolute", "inset-x-0", "bottom-0", "grid", "grid-cols-2", "gap-4", "rounded-t-xl", "border-t", "border-base-200", "bg-base-100", "p-4"], ["name", "footer-nav-meeting", "matRipple", "", "routerLinkActive", "active", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "bg-base-200", "px-4", "py-8", 3, "routerLink"], ["matRipple", "", "name", "footer-nav-desks", "routerLinkActive", "active", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "bg-base-200", "px-4", "py-8", 3, "routerLink"], ["matRipple", "", "name", "footer-nav-parking", "routerLinkActive", "active", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "bg-base-200", "px-4", "py-8", 3, "routerLink"], ["matRipple", "", "name", "footer-nav-visitor-invite", "routerLinkActive", "active", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "bg-base-200", "px-4", "py-8", 3, "routerLink"], ["matRipple", "", "name", "footer-nav-my-day", "routerLinkActive", "active", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-xl", "bg-base-200", "px-4", "py-8", 3, "routerLink"], [1, "text-3xl", "text-secondary"], [1, "text-3xl", "text-primary"], ["matRipple", "", "name", "footer-nav-home", "routerLinkActive", "text-secondary active", 1, "relative", "flex", "flex-1", "flex-col", "items-center", "justify-center", 3, "routerLink"], ["filled", "", 1, "text-2xl"], ["outline", "", "className", "material-symbols-outlined", 1, "m-0!", "text-2xl"], [1, "text-sm"], ["matRipple", "", 1, "z-10", "mb-4", "flex", "h-12", "w-12", "items-center", "justify-center", "rounded-full", 3, "click"], [1, "text-2xl"], ["matRipple", "", "routerLinkActive", "text-secondary active", 1, "relative", "flex", "flex-1", "flex-col", "items-center", "justify-center", 3, "routerLink"], [1, "absolute", "top-0", "left-1/2", "h-2", "w-24", "-translate-x-1/2", "-translate-y-full", "overflow-hidden"], [1, "border-base-200", "bg-base-100", "mx-auto", "h-16", "w-16", "rounded-full", "border-t", "shadow-sm"]], template: function FooterMenuComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, FooterMenuComponent_Conditional_0_Template, 8, 7, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FooterMenuComponent, [{
    ...
    `, imports: [TranslatePipe, IconComponent, RouterModule, MatRippleModule], styles: ["/* angular:styles/component:css;284ac002de2eeaa1175fa738ed3719d1108673a10454a9459c4dd2267eb55510;/home/runner/work/user-interfaces/user-interfaces/apps/workplace/src/app/components/footer-menu.component.ts */\na.active icon {\n  color: var(--secondary) !important;\n}\na.active {\n  font-weight: 500;\n}\na:not(.active) [filled],\na.active [outline] {\n  display: none;\n}\n/*# sourceMappingURL=footer-menu.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterMenuComponent, { className: "FooterMenuComponent", filePath: "apps/workplace/src/app/components/footer-menu.component.ts", lineNumber: 203 });
})();
...
var _c05 = (a0, a1) => ({ used: a0, count: a1 });
function ExploreLockerBankInfoComponent_ng_template_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 5, "EXPLORE.LOCKERS_USE", \u0275\u0275pureFunction2(8, _c05, ctx_r1.in_use_count, ctx_r1.bank.lockers.length || 1)), " ");
  }
}
...
_ExplorePointOfInterestModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExplorePointOfInterestModalComponent, selectors: [["explore-poi-modal"]], viewQuery: function ExplorePointOfInterestModalComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._media_el, _c06, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance();
  }
...
}, features: [\u0275\u0275InheritDefinitionFeature], attrs: _c13, decls: 2, vars: 4, consts: [["canvas", ""], [1, "absolute", "top-1/2", "left-1/2", "-translate-x-1/2", "-translate-y-1/2"]], template: function MapCanvasComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_ExploreMapViewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreMapViewComponent, selectors: [["explore-map-view"]], features: [\u0275\u0275ProvidersFeature([
  ...
  if (rf & 2) {
    \u0275\u0275property("src", \u0275\u0275pipeBind1(1, 10, ctx.url))("styles", \u0275\u0275pipeBind1(2, 12, ctx.styles))("features", \u0275\u0275pipeBind1(3, 14, ctx.features))("actions", \u0275\u0275pipeBind1(4, 16, ctx.actions))("labels", \u0275\u0275pipeBind1(5, 18, ctx.labels))("focus", ctx.locate)("options", \u0275\u0275pureFunction0(22, _c08));
    \u0275\u0275advance(6);
...
var _ScheduleStateService = class _ScheduleStateService extends AsyncHandler {
  ...
  constructor() {
    ...
    this._spaces = inject(SpacesService);
    this._poll = signal(0);
    this._poll_type = signal("api");
    this._loading = signal(false);
    this._options = signal({ period: "day" });
    ...
    this._date = signal(Date.now());
    this._end_date = signal(null);
    this._deleted = [];
    ...
    this._space_bookings = this._org.active_building.pipe(
      ...
      switchMap((list) => {
        ...
        return combineLatest((list || []).map((space) => {
          const binding = $h(space.id, "Bookings").variable("bookings");
    ...
    this.events = computed(() => this.raw_events().filter((_) => !_.extension_data?.shared_event));
    this.visitors = toSignal(combineLatest([this._update$, toObservable(this.options)]).pipe(switchMap(([[date, end_date], options]) => this._bookingQuery("visitor", options.period, date, end_date)), map((_) => _.filter((_2) => !_2.parent_id && !_2.linked_event)), tap(() => this.timeout("end_loading", () => this._loading.set(false))), shareReplay(1)), { initialValue: [] });
    this.desks = toSignal(combineLatest([this._update$, toObservable(this.options)]).pipe(switchMap(([[date, end_date], options]) => this._bookingQuery("desk", options.period, date, end_date)), tap(() => this.timeout("end_loading", () => this._loading.set(false))), shareReplay(1)), { initialValue: [] });
    ...
    this.group_events = computed(() => this.raw_events().filter((_) => _.extension_data?.shared_event));
  ...
  async edit(event) {
    ...
    if (event.resources?.length) {
      const full_resources = await Promise.all(event.resources.map(async (resource) => {
...
var _c010 = ["input"];
var _c15 = (a0, a1, a2, a3, a4) => ({ "w-lg": a0, "w-px": a1, "opacity-100": a2, "opacity-0": a3, "pointer-events-none": a4 });
var _c22 = () => ["/explore"];
...
function GlobalSearchComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_3_0;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction5(7, _c15, ctx_r1.show(), !ctx_r1.show(), ctx_r1.show(), !ctx_r1.show(), !ctx_r1.show()));
    \u0275\u0275advance();
...
_GlobalSearchComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GlobalSearchComponent, selectors: [["global-search"]], viewQuery: function GlobalSearchComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._input_el, _c010, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance();
  }
}, features: [\u0275\u0275InheritDefinitionFeature], decls: 13, vars: 15, consts: [["input", ""], [1, "relative", "h-full", "w-12"], ["icon", "", "name", "global-search", "matRipple", "", 1, "bg-base-200", "h-10", "w-10", "rounded-full", 3, "click"], [1, "text-2xl"], ["search", "", 1, "border-neutral", "bg-base-100", "absolute", "top-1/2", "right-2", "z-50", "flex", "h-12", "max-w-[calc(100vw-4rem)]", "-translate-y-1/2", "items-center", "space-x-2", "rounded-[24px]", "border-2", "px-2", "shadow-sm", 3, "click", "ngClass"], [1, "w-1/2", "flex-1", "py-2", "outline-hidden", 3, "ngModelChange", "blur", "placeholder", "ngModel"], [3, "diameter"], ["search", "", 1, "border-base-200", "bg-base-100", "absolute", "right-2", "bottom-0", "flex", "max-h-[40vh]", "max-w-[calc(100vw-4rem)]", "translate-y-[calc(100%-1rem)]", "flex-col", "items-center", "overflow-auto", "rounded-b", "border", "pt-4", "shadow-sm", 3, "ngClass"], ["empty", "", 1, "w-full", "p-4", "text-center", "opacity-60"], ["matRipple", "", 1, "hover:bg-base-200", "flex", "h-14", "min-h-14", "w-full", "items-center", "px-4", "py-2", "leading-tight", 3, "routerLink", "queryParams"], [1, "flex-1", "overflow-hidden"], [1, "w-full", "truncate"], [1, "text-xs", "opacity-60"], [1, "bg-secondary", "text-secondary-content", "rounded-sm", "p-2", "text-xs", "font-medium", "text-white", "capitalize"]], template: function GlobalSearchComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction5(9, _c15, ctx.show(), !ctx.show(), ctx.show(), !ctx.show(), !ctx.show()));
    \u0275\u0275advance(3);
...
function TopMenuComponent_Conditional_0_For_3_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("name", "nav-" + route_r3.id)("routerLink", \u0275\u0275pureFunction1(10, _c16, route_r3.route))("matTooltip", route_r3.name);
    \u0275\u0275advance();
...
_TopMenuComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TopMenuComponent, selectors: [["top-menu"]], viewQuery: function TopMenuComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx.menu, _c011, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance();
  }
}, features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 2, consts: [["menu", "matMenu"], ["menuContainer", ""], ["menu", "", 1, "text-base-content", "flex", "h-full", "w-full", "min-w-full", "items-center", "justify-center", "overflow-hidden", 3, "opacity-0", "h-0!"], [1, "absolute", "inset-y-0", "-right-16", "left-0", "flex", "items-center", "justify-end"], ["menu", "", 1, "text-base-content", "flex", "h-full", "w-full", "min-w-full", "items-center", "justify-center", "overflow-hidden", 3, "resize"], ["matRipple", "", "routerLinkActive", "text-secondary active", "matTooltipPosition", "below", 1, "relative", "flex", "items-center", "justify-center", "space-x-2", "px-8", 3, "name", "routerLink", "matTooltip"], ["filled", "", 1, "text-xl"], ["outline", "", "className", "material-symbols-outlined", 1, "m-0!", "text-xl"], [1, "truncate"], ["bar", "", 1, "bg-secondary", "absolute", "inset-x-0", "bottom-0", "h-0.5"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", "routerLinkActive", "text-secondary active", 3, "routerLink"], [1, "flex", "items-center", "space-x-2"], [1, "truncate", "pr-4"]], template: function TopMenuComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TopMenuComponent, { className: "TopMenuComponent", filePath: "apps/workplace/src/app/components/top-menu.component.ts", lineNumber: 141 });
})();
...
_TopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TopbarComponent, selectors: [["topbar"]], decls: 10, vars: 9, consts: [["topbar", "", 1, "border-base-200", "bg-base-100", "relative", "z-50", "flex", "h-14", "items-center", "justify-between", "border-b", "shadow-sm"], ["name", "nav-logo", 1, "flex", "h-full", "w-48", "items-center", "p-2", 3, "routerLink"], ["auth", "", "alt", "Logo", 1, "h-10", "sm:block", 3, "source"], [1, "relative", "hidden", "h-full", "w-1/2", "flex-1", "items-center", "justify-center", "sm:flex"], [1, "flex", "w-48", "items-center", "justify-end"], ["icon", "", "matRipple", "", "avatar", "", "name", "user-controls", "customTooltip", "", 1, "bg-base-200", "mr-2", "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", 3, "content"], [3, "user"]], template: function TopbarComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_2_0;
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(8, _c012));
    \u0275\u0275advance();
...
//# sourceMappingURL=chunk-575FDSG4.js.map
