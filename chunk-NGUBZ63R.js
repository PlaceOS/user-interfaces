...
function AssetListFieldComponent_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AssetListFieldComponent_Conditional_0_For_2_Template_button_click_22_listener() {
      const request_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.show_request[request_r3.id] = !ctx_r3.show_request[request_r3.id]);
    });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetListFieldComponent, { className: "AssetListFieldComponent", filePath: "libs/assets/src/lib/asset-list-field.component.ts", lineNumber: 250 });
})();

export {
  AssetListFieldComponent
};
//# sourceMappingURL=chunk-NGUBZ63R.js.map
