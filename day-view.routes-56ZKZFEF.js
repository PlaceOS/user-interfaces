import {
  EventsStateService
} from "./chunk-AXBCLUPA.js";
import "./chunk-EUBHJUDP.js";
import "./chunk-SFASMMEW.js";
import "./chunk-KNVKKHPU.js";
import "./chunk-CUXMHG46.js";
import "./chunk-N6OKWP4S.js";
import {
  ImageCarouselComponent
} from "./chunk-4MLVIUOC.js";
import "./chunk-MINNJC2L.js";
...
} from "./chunk-BVXGK56S.js";
import {
  MapPinComponent
} from "./chunk-HP5NGB4U.js";
import {
  loadPersistedZones,
  persistZones
...
var BindingDirective = class _BindingDirective extends AsyncHandler {
  ...
  ngOnInit() {
    oi(Lr(), (_) => _).then(() => this.bindVariable());
  }
  ngOnChanges(changes) {
  ...
  bindVariable() {
    if (Rt() && this.bind() && this.sys() && this.mod() && !this._binding) {
      this.timeout("bind", () => {
        const module = Wl(this.sys(), this.mod(), this.index());
...
var StatusPillComponent = class _StatusPillComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StatusPillComponent, selectors: [["status-pill"]], inputs: { status: [1, "status"] }, ngContentSelectors: _c0, decls: 10, vars: 25, consts: [[1, "border-base-200", "bg-opacity-30", "flex", "items-center", "space-x-2", "rounded-full", "border", "px-2", "py-1", "text-base", "font-medium", "text-black"], [1, "flex", "h-5", "w-5", "items-center", "justify-center", "rounded-full"], [1, "text-2xl"]], template: function StatusPillComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
...
var EventDetailsModalComponent = class _EventDetailsModalComponent {
  ...
  async checkin() {
    const mod = Wl(this.space()?.id, "Bookings");
    if (!mod)
      return;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsListComponent, selectors: [["room-bookings-list"]], features: [\u0275\u0275ProvidersFeature([UserPipe])], decls: 26, vars: 57, consts: [["date_template", ""], ["period_template", ""], ["user_template", ""], ["type_template", ""], ["status_template", ""], ["action_template", ""], ["action_menu", "matMenu"], [1, "flex", "h-full", "w-full", "flex-col"], [1, "border-base-200", "bg-base-100", "flex", "items-center", "justify-center", "border-b", "p-2"], [3, "dateChange", "date", "step", "display_mode", "week_start", "is_new", "hide_today"], [1, "min-h-0", "flex-1", "overflow-auto", "px-8", "pb-16"], [1, "block", "min-w-368", "text-sm", 3, "data", "columns", "empty_message", "sortable"], [1, "absolute", "top-14", "right-0", "bottom-0", "left-0", "z-30", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-2"], [1, "bg-base-100", "absolute", "inset-0", "z-0", "opacity-80"], ["diameter", "32"], [1, "relative", "z-10"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-2"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], [1, "max-w-48", "truncate", "text-xs", "opacity-30", "select-all"], [1, "px-4", "py-2"], [1, "bg-success", "text-success-content", "inline-flex", "rounded-full", "px-3", "py-1", "text-xs"], [1, "mx-auto"], ["icon", "", "default", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "text-error", "text-2xl"]], template: function RoomBookingsListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("data", ctx.bookings())("columns", \u0275\u0275pureFunction8(48, _c8, \u0275\u0275pureFunction2(27, _c05, \u0275\u0275pipeBind1(5, 11, "FORM.DATE"), date_template_r16), \u0275\u0275pureFunction2(30, _c12, \u0275\u0275pipeBind1(6, 13, "FORM.PERIOD"), period_template_r17), \u0275\u0275pureFunction1(33, _c22, \u0275\u0275pipeBind1(7, 15, "RESOURCE.ROOM")), \u0275\u0275pureFunction2(35, _c32, \u0275\u0275pipeBind1(8, 17, "FORM.HOST"), user_template_r18), \u0275\u0275pureFunction1(38, _c4, \u0275\u0275pipeBind1(9, 19, "FORM.TITLE")), \u0275\u0275pureFunction2(40, _c5, \u0275\u0275pipeBind1(10, 21, "COMMON.TYPE"), type_template_r19), \u0275\u0275pureFunction2(43, _c6, \u0275\u0275pipeBind1(11, 23, "COMMON.STATUS"), status_template_r20), \u0275\u0275pureFunction1(46, _c7, action_template_r21)))("empty_message", \u0275\u0275pipeBind1(12, 25, "APP.CONCIERGE.SCHEDULE_EMPTY"))("sortable", true);
        \u0275\u0275advance(9);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsListComponent, { className: "RoomBookingsListComponent", filePath: "apps/concierge/src/app/day-view/room-bookings-list.component.ts", lineNumber: 312 });
})();
...
function RoomWeekBookingsTimelineComponent_For_19_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", event_r4.system?.display_name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 20, \u0275\u0275pipeBind1(14, 18, event_r4.host))?.name || event_r4.host, " ");
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomWeekBookingsTimelineComponent, { className: "RoomWeekBookingsTimelineComponent", filePath: "apps/concierge/src/app/day-view/room-week-timeline.component.ts", lineNumber: 208 });
})();
...
//# sourceMappingURL=day-view.routes-56ZKZFEF.js.map
