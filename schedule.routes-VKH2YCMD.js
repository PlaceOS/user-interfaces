...
import {
  ...
  isSameMonth,
  startOfMonth
} from "./chunk-MAJDNXEP.js";
import {
  MatProgressBar,
  MatProgressBarModule
} from "./chunk-HHSBQ4XQ.js";
import {
  FooterMenuComponent,
...
var _c0 = [[["", "booking-status", ""]]];
var _c1 = ["[booking-status]"];
var _c2 = () => ["./"];
var _c3 = (a0) => ({ booking: a0 });
var _c4 = (a0) => ({ name: a0 });
...
function BookingCardComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_13_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(23, _c2))("queryParams", \u0275\u0275pureFunction1(24, _c3, ctx_r0.booking()?.id));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.booking().status === "cancelled" ? 10 : -1);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275conditional((tmp_13_0 = ctx_r0.type()) === "desk" ? 18 : tmp_13_0 === "locker" ? 19 : tmp_13_0 === "parking" ? 20 : tmp_13_0 === "visitor" ? 21 : 22);
    \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingCardComponent, { className: "BookingCardComponent", filePath: "libs/bookings/src/lib/booking-card.component.ts", lineNumber: 209 });
})();
...
var ScheduleDayViewComponent = class _ScheduleDayViewComponent extends AsyncHandler {
  ...
  bookingStatus(booking) {
    ...
    if (status === "tentative" && booking instanceof Booking && booking.booking_type === "parking" && isInWaitlistWeek(booking.date, this._org.building?.timezone)) {
      return "waitlisted";
    }
...
var ScheduleFilterCardComponent = class _ScheduleFilterCardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleFilterCardComponent, selectors: [["schedule-filter-card"]], inputs: { bookings: [1, "bookings"] }, outputs: { bookings: "bookingsChange" }, decls: 24, vars: 8, consts: [[1, "border-base-200", "mb-4", "flex", "items-center", "space-x-2", "border-b", "text-xl"], ["icon", "", "matRipple", "", 3, "click"], [1, "w-1/2", "flex-1", "text-center"], [1, "border-base-200", "mb-4", "space-y-2", "border-b", "px-4", "pb-4"], [3, "click", "ngModel"], [1, "-my-2", "-ml-2", "flex", "items-center", "space-x-2"], [1, "bg-base-300", "rounded-full", "p-1", "text-2xl"], [1, "flex-1", "font-medium"], [1, "font-mono", "text-xs"], [1, "px-4", "pb-4"], ["btn", "", "matRipple", "", "name", "schedule-apply-filter", 1, "w-full", 3, "click"], [3, "ngModel"]], template: function ScheduleFilterCardComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 4, "COMMON.FILTERS"), " ");
        \u0275\u0275advance(4);
...
function ScheduleListViewComponent_Conditional_0_For_1_For_5_Conditional_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "COMMON.TYPE_CANCELLED"), " ");
  }
}
function ScheduleListViewComponent_Conditional_0_For_1_For_5_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "booking-card", 3);
    \u0275\u0275conditionalCreate(1, ScheduleListViewComponent_Conditional_0_For_1_For_5_Conditional_1_Conditional_1_Template, 3, 3, "span", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r1 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("booking", item_r1)("edit_fn", ctx_r1.edit_booking_fn)("remove_fn", ctx_r1.remove_fn)("end_fn", ctx_r1.end_fn)("refresh_fn", ctx_r1.refresh_fn);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r1.status === "cancelled" ? 1 : -1);
  }
}
function ScheduleListViewComponent_Conditional_0_For_1_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ScheduleListViewComponent_Conditional_0_For_1_For_5_Conditional_0_Template, 1, 3, "event-card", 2)(1, ScheduleListViewComponent_Conditional_0_For_1_For_5_Conditional_1_Template, 2, 6, "booking-card", 3);
  }
  if (rf & 2) {
...
var ScheduleListViewComponent = class _ScheduleListViewComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleListViewComponent, selectors: [["schedule-list-view"]], inputs: { date: [1, "date"], end_date: [1, "end_date"], bookings: [1, "bookings"], loading: [1, "loading"] }, decls: 2, vars: 1, consts: [[1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "p-8"], [1, "mb-2", "font-medium"], [3, "event", "edit_fn", "remove_fn"], [3, "booking", "edit_fn", "remove_fn", "end_fn", "refresh_fn"], ["booking-status", "", 1, "text-error", "text-sm", "font-medium"], ["src", "assets/img/no-events.svg", 1, "mr-4"], [1, "opacity-30"]], template: function ScheduleListViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleListViewComponent, { className: "ScheduleListViewComponent", filePath: "apps/workplace/src/app/schedule/schedule-list-view.component.ts", lineNumber: 81 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleTopbarComponent, selectors: [["schedule-topbar"]], inputs: { view: [1, "view"], date: [1, "date"], end_date: [1, "end_date"] }, outputs: { view: "viewChange", date: "dateChange", end_date: "end_dateChange" }, decls: 22, vars: 36, consts: [["date_range_menu", "matMenu"], [1, "border-base-300", "bg-base-100", "flex", "w-full", "flex-col", "items-center", "justify-between", "space-y-2", "border-b", "p-2", "sm:flex-row", "sm:space-y-0", "sm:space-x-2"], ["date", "", 1, "flex", "w-full", "items-center", "space-x-2", "sm:w-auto"], ["btn", "", "matRipple", "", 1, "inverse", "min-h-11", 3, "click"], [1, "border-base-300", "rounded-lg", "border", "px-2", "py-1", "text-xs"], ["view", "", 1, "border-base-300", "bg-base-200", "flex", "w-full", "space-x-1", "rounded-xl", "border", "p-1", "sm:w-auto"], ["btn", "", "matRipple", "", 1, "hover:bg-base-300", "min-h-10", "flex-1", 3, "click", "routerLink", "queryParams"], ["btn", "", "matRipple", "", 1, "inverse", "min-h-11", "min-w-11", "p-0", 3, "click"], [1, "text-2xl"], ["btn", "", "matRipple", "", 1, "inverse", "min-h-11", "min-w-11", "p-0", "sm:hidden", 3, "matMenuTriggerFor"], [1, "schedule-date-menu"], [1, "w-72", "space-y-2", "p-2", 3, "click"], [3, "startChange", "endChange", "from", "start", "end", "offset_weekday"], [1, "bg-info", "text-info-content", "rounded", "p-2", "text-center", "text-xs"]], template: function ScheduleTopbarComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(34, _c04))("queryParams", \u0275\u0275pureFunction0(35, _c32));
        \u0275\u0275advance();
...
function ScheduleComponent_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("date", ctx_r0.date())("bookings", ctx_r0.calendar_bookings())("loading", ctx_r0.loading());
  }
}
...
var ScheduleComponent = class _ScheduleComponent extends AsyncHandler {
  constructor() {
    ...
    this.calendar_bookings = computed(
      () => this.bookings().filter((booking) => !(booking instanceof Booking) || booking.status !== "cancelled"),
      ...ngDevMode ? [{ debugName: "calendar_bookings" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleComponent, selectors: [["app-schedule"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 12, vars: 10, consts: [[3, "viewChange", "dateChange", "end_dateChange", "view", "date", "end_date"], [1, "bg-base-200", "relative", "flex", "h-1/2", "flex-1", "flex-col", "sm:flex-row"], [1, "bg-base-100", "relative", "z-50", "hidden", "sm:block", 3, "bookings", "view"], [1, "flex", "h-full", "flex-1", "flex-col", "overflow-auto"], [1, "sticky", "top-0", "z-20", 3, "bookings"], [1, "relative", "z-10", 3, "date", "bookings", "loading"], [1, "h-1/2", "flex-1", 3, "date", "bookings", "loading"], [1, "p-4"], ["mode", "indeterminate", 1, "absolute", "inset-x-0", "bottom-0"], [1, "space-y-3", 3, "date", "end_date", "bookings", "loading"]], template: function ScheduleComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# debugId=b7b17ff8-1986-5ef6-97c0-d994fb92090d
//# sourceMappingURL=schedule.routes-VKH2YCMD.js.map
