import {
  ...
  TeamScheduleService
} from "./chunk-HQ4P6KES.js";
import {
  LandingStateService
} from "./chunk-7GPSBLFD.js";
import {
  BindingDirective,
  BookingDetailsModalComponent,
  EventDetailsModalComponent,
  canEditBooking
} from "./chunk-CIDQPKLT.js";
import {
  GroupEventDetailsModalComponent,
  MapLocateModalComponent
} from "./chunk-MVBSEOAI.js";
import {
  VirtualConciergeButtonComponent
} from "./chunk-JBEV3LZZ.js";
import {
  AutoAssignedDeskModalComponent
} from "./chunk-TVR2SJOJ.js";
import {
  LevelPipe
} from "./chunk-MKVQIQIV.js";
import {
  toObservable,
  toSignal
} from "./chunk-FEP6KYWH.js";
import "./chunk-6XTXEEZD.js";
import "./chunk-R2CDIGGE.js";
import {
  BuildingPipe
} from "./chunk-36QO473H.js";
import {
  ExploreSpacesService
} from "./chunk-KUVZELBB.js";
import "./chunk-JYS7V37C.js";
import "./chunk-RWHP3H4D.js";
import "./chunk-LU3DCUJK.js";
import "./chunk-NT4LKQRM.js";
import {
  FooterMenuComponent,
  ScheduleStateService,
  TopbarComponent
} from "./chunk-5IZVDD2R.js";
import "./chunk-NJ23FPNM.js";
import "./chunk-7X6A3JFR.js";
import "./chunk-GXDHPWFM.js";
import "./chunk-DLJ2M7KA.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
  MatMenuTrigger
} from "./chunk-F6GEIZUY.js";
import {
  EventFormService,
  SpacePipe,
  checkinEventGuest
} from "./chunk-QO4CONNN.js";
import "./chunk-AHY7HDOU.js";
import "./chunk-B5FYPWPG.js";
import {
  BookingFormService
} from "./chunk-LDZDAULU.js";
import "./chunk-3X5WTZMJ.js";
import {
  ...
  MatTooltipModule,
  UserAvatarComponent
} from "./chunk-OMYLRE7M.js";
import "./chunk-GUTIOTOK.js";
import {
  AsyncHandler,
  Booking,
  CalendarEvent,
...
function LandingUpcomingBookingComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LandingUpcomingBookingComponent_Conditional_0_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.checkIn());
    });
    \u0275\u0275elementStart(24, "icon", 16);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(30, "icon", 16);
    \u0275\u0275text(31, "edit");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div", 14)(33, "button", 19);
    ...
    \u0275\u0275elementStart(39, "icon", 16);
    \u0275\u0275text(40, "delete");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "a", 21)(42, "icon", 16);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 20, "CALENDAR_EVENT.GROUP_FEATURED"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(28, 22, ctx_r2.isCheckedIn() ? "COMMON.CHECKED_IN" : "COMMON.CHECK_IN"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r2.canEdit());
    \u0275\u0275advance(9);
    \u0275\u0275property("disabled", ctx_r2.deleteDisabled());
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(26, _c05));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(46, 24, "APP.WORKPLACE.UPCOMING_VIEW_BOOKINGS"), " ");
  }
}
function LandingUpcomingBookingComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 24);
    \u0275\u0275element(2, "div", 4);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 28)(10, "div", 29)(11, "a", 30)(12, "div");
    \u0275\u0275text(13, "Book a Space");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "a", 31)(15, "div");
    \u0275\u0275text(16, "Find Desk");
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(17, "div", 32);
    \u0275\u0275elementStart(18, "a", 33)(19, "icon", 16);
...
var LandingUpcomingBookingComponent = class _LandingUpcomingBookingComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingUpcomingBookingComponent, selectors: [["landing-upcoming-booking"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [[1, "bg-grad", "border-base-300", "text-brand-content", "col-span-2", "space-y-2", "rounded-lg", "border", "p-4"], [1, "bg-grad", "border-base-300", "text-brand-content", "col-span-2", "flex", "min-h-48", "flex-col", "items-start", "justify-center", "space-y-2", "rounded-lg", "border", "p-4"], [1, "flex", "w-full", "items-center", "justify-between"], [1, "relative", "overflow-hidden", "rounded", "px-2", "py-1", "text-sm", "capitalize"], [1, "bg-brand-content", "absolute", "inset-0", "opacity-20"], [1, "flex", "w-48", "items-center", "space-x-2", "px-2", "text-center"], [1, "flex", "min-w-48", "items-center", "space-x-2", "px-2", "text-center"], [1, "flex", "w-full", "flex-col", "items-center", "justify-between", "space-y-2", "sm:flex-row", "sm:space-y-0"], [1, "w-full", "sm:flex-1"], [1, "text-2xl", "font-medium"], [1, "mb-1", "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "w-full", "flex-col", "items-end", "space-y-2", "sm:flex-1"], [1, "flex", "w-full", "items-center", "space-x-2", "sm:w-56"], ["btn", "", "matRipple", "", 1, "flex-1", "space-x-2", 3, "click", "disabled"], [1, "text-2xl"], [1, "pr-2"], ["btn", "", "matRiple", "", "matTooltip", "Edit Booking", "matTooltipPosition", "left", 1, "white", "inverse", "h-12", "w-12", "px-0", 3, "click", "disabled"], ["btn", "", "matRipple", "", 1, "inverse", "white", "flex", "flex-1", "space-x-2", 3, "click"], ["btn", "", "matRiple", "", "matTooltip", "Delete Booking", "matTooltipPosition", "left", 1, "white", "inverse", "h-12", "w-12", "px-0", 3, "click", "disabled"], ["btn", "", "matRipple", "", 1, "inverse", "white", "w-full", "space-x-2", "sm:w-56", 3, "routerLink"], ["binding", "", "mod", "Bookings", "bind", "status", 1, "hidden", 3, "modelChange", "model", "sys"], ["binding", "", "mod", "Bookings", "bind", "last_booking_started", 1, "hidden", 3, "modelChange", "model", "sys"], [1, "relative", "overflow-hidden", "rounded", "px-2", "py-1", "text-sm"], [1, "capitalize"], [1, "text-3xl", "font-medium"], [1, "text-base", "opacity-90"], [1, "flex", "w-full", "flex-wrap", "gap-3", "pt-2"], [1, "flex", "w-full", "flex-wrap", "gap-3", "sm:w-auto"], ["btn", "", "matRipple", "", 1, "white", "min-w-48", "flex-1", "space-x-2", "sm:w-48", "sm:flex-0", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "inverse", "white", "min-w-48", "flex-1", "space-x-2", "sm:w-48", "sm:flex-0", 3, "routerLink"], [1, "hidden", "w-px", "flex-1", "sm:block"], ["btn", "", "matRipple", "", 1, "inverse", "white", "w-full", "space-x-2", "sm:w-52", 3, "routerLink"]], template: function LandingUpcomingBookingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, LandingUpcomingBookingComponent_Conditional_0_Template, 47, 27, "div", 0)(1, LandingUpcomingBookingComponent_Conditional_1_Template, 24, 9, "div", 1);
      }
      if (rf & 2) {
        let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingUpcomingBookingComponent, { className: "LandingUpcomingBookingComponent", filePath: "apps/workplace/src/app/landing-new/landing-upcoming-booking.component.ts", lineNumber: 277 });
})();
...
//# sourceMappingURL=landing-new.component-YY6E6NB4.js.map
