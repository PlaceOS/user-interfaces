...
var _EventPinComponent = class _EventPinComponent {
  constructor() {
...
var EventPinComponent = _EventPinComponent;
(() => {
...
var _ExploreComponent = class _ExploreComponent extends AsyncHandler {
  constructor() {
    ...
    this._time = signal(Date.now());
    this.next_event = computed(() => this._upcoming()[0]);
...
_ExploreComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreComponent, selectors: [["app-explore"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 3, consts: [[1, "bg-base-200", "flex", "h-1/2", "flex-1", "flex-col-reverse", "sm:flex-row"], [1, "relative", "z-0", "flex", "h-1/2", "flex-1", "flex-col", "overflow-hidden", "sm:h-auto"], [1, "absolute", "right-2", "top-2", "flex", "items-center", "space-x-2", "rounded-full", "border", "border-base-300", "bg-base-100", "p-1"], [1, "max-w-[40vw]", "flex-1", "px-4", "leading-tight"], [1, "truncate"], [1, "truncate", "text-xs", "opacity-60"], [1, "rounded", "bg-base-200", "px-2", "py-1", "text-xs"], ["icon", "", "matRipple", "", "matTooltip", "Pin my booking", 1, "border", "border-base-200", "bg-secondary", "text-secondary-content", 3, "click"]], template: function ExploreComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=explore.module-SUZMPSP7.js.map
