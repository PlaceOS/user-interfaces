...
} from "./chunk-FCPWCH3I.js";
import "./chunk-XASXR3ZT.js";
import {
  SearchbarComponent
} from "./chunk-W5AX6WJJ.js";
import "./chunk-VVCSIYWZ.js";
import {
  DateOptionsComponent
} from "./chunk-2VWEHOMS.js";
...
function CateringTopbarComponent_For_14_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringTopbarComponent_For_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 7)(1, "div", 10);
    \u0275\u0275conditionalCreate(2, CateringTopbarComponent_For_14_Conditional_2_Template, 5, 3, "div", 11);
...
function CateringTopbarComponent_Conditional_16_For_10_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringTopbarComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "mat-form-field", 5)(1, "mat-label");
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-select", 13);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275listener("ngModelChange", function CateringTopbarComponent_Conditional_16_Template_mat_select_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setCaterer($event));
    });
    \u0275\u0275elementStart(6, "mat-option", 14);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(9, CateringTopbarComponent_Conditional_16_For_10_Template, 3, 4, "mat-option", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 4, "COMMON.STATUS"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r1.filters == null ? null : ctx_r1.filters.caterer)("placeholder", \u0275\u0275pipeBind1(5, 6, "CATERING.CATERERS_ALL"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 8, "CATERING.CATERERS_ALL"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(11, 10, ctx_r1.caterers));
  }
}
...
function CateringTopbarComponent_Conditional_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "CATERING.MENU_ADD"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 4, "CATERING.MENU_ADD"));
  }
}
function CateringTopbarComponent_Conditional_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "CATERING.BOOKING_RULES"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 4, "CATERING.BOOKING_RULES"));
  }
}
function CateringTopbarComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function CateringTopbarComponent_Conditional_21_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "CATERING.MENU_IMPORT"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 4, "CATERING.MENU_IMPORT"));
  }
}
function CateringTopbarComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function CateringTopbarComponent_Conditional_22_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "CATERING.ROOM_AVAILABILITY"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 4, "CATERING.ROOM_AVAILABILITY"));
  }
}
function CateringTopbarComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 15);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function CateringTopbarComponent_Conditional_23_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "CATERING.CHARGE_CODES"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 4, "CATERING.CHARGE_CODES"));
  }
}
function CateringTopbarComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 8);
  }
}
function CateringTopbarComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "date-options", 17);
    \u0275\u0275listener("dateChange", function CateringTopbarComponent_Conditional_25_Template_date_options_dateChange_0_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
...
_CateringTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringTopbarComponent, selectors: [["catering-topbar"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 26, vars: 24, consts: [[1, "flex", "w-full", "items-center", "space-x-2", "px-8", "pt-4", "pb-2"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], [1, "bg-base-100", "flex", "h-20", "items-center", "space-x-2", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "w-2", "flex-1"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "matTooltip"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-60"], [1, "opacity-0"], [3, "ngModelChange", "ngModel", "placeholder"], ["value", ""], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "click", "matTooltip"], [1, "text-2xl"], [3, "dateChange"]], template: function CateringTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275listener("ngModelChange", function CateringTopbarComponent_Template_mat_select_ngModelChange_11_listener($event) {
      return ctx.updateZones($event);
    });
    \u0275\u0275repeaterCreate(13, CateringTopbarComponent_For_14_Template, 5, 3, "mat-option", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(15, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(16, CateringTopbarComponent_Conditional_16_Template, 12, 12, "mat-form-field", 5);
    \u0275\u0275pipe(17, "async");
    \u0275\u0275conditionalCreate(18, CateringTopbarComponent_Conditional_18_Template, 1, 0, "div", 8);
    \u0275\u0275conditionalCreate(19, CateringTopbarComponent_Conditional_19_Template, 5, 6, "button", 9);
    \u0275\u0275conditionalCreate(20, CateringTopbarComponent_Conditional_20_Template, 5, 6, "button", 9);
    \u0275\u0275conditionalCreate(21, CateringTopbarComponent_Conditional_21_Template, 5, 6, "button", 9);
    \u0275\u0275conditionalCreate(22, CateringTopbarComponent_Conditional_22_Template, 5, 6, "button", 9);
    \u0275\u0275conditionalCreate(23, CateringTopbarComponent_Conditional_23_Template, 5, 6, "button", 9);
    \u0275\u0275conditionalCreate(24, CateringTopbarComponent_Conditional_24_Template, 1, 0, "div", 8);
    \u0275\u0275conditionalCreate(25, CateringTopbarComponent_Conditional_25_Template, 1, 0, "date-options");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_6_0;
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 16, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx.filters == null ? null : ctx.filters.zones)("placeholder", \u0275\u0275pipeBind1(12, 18, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(15, 20, ctx.levels));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_6_0 = \u0275\u0275pipeBind1(17, 22, ctx.caterers)) == null ? null : tmp_6_0.length) > 1 ? 16 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.page === "menu" ? 18 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.page === "menu" && (!ctx.zones[0] || ctx.zones[0] === (ctx.building == null ? null : ctx.building.id)) ? 19 : -1);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.page === "menu" ? 23 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.page !== "menu" ? 24 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.page !== "menu" ? 25 : -1);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringTopbarComponent, { className: "CateringTopbarComponent", filePath: "apps/concierge/src/app/catering/catering-topbar.component.ts", lineNumber: 199 });
})();
...
_CateringComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringComponent, selectors: [["", "app-new-catering", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c0, decls: 11, vars: 2, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "relative", "z-10"], [1, "flex", "h-1/2", "flex-1", "flex-col", "px-8"], [1, "bg-info", "mb-4", "flex", "items-center", "justify-center", "rounded-sm", "p-2", "text-sm", "text-white"], [1, "flex", "h-1/2", "w-full", "flex-1", "overflow-auto"], [1, "flex-1"], [1, "flex", "flex-1", "flex-wrap", "items-center", "justify-center"], ["matRipple", "", "aria-label", "Catering Menu", 1, "bg-base-100", "flex", "flex-col", "items-center", "rounded-sm", "text-black", "shadow-sm", 3, "routerLink"], ["name", "img", 1, "relative", "flex", "w-full", "flex-1", "items-center", "justify-center", "bg-cover", "bg-center", "text-2xl", "text-white"], [1, "bg-neutral", "absolute", "inset-0", "z-0", "opacity-60"], [1, "z-10"], [1, "flex", "h-14", "w-full", "items-center", "justify-center", "p-2", "text-center", "text-sm"], ["matRipple", "", "aria-label", "Catering Orders", 1, "bg-base-100", "flex", "flex-col", "items-center", "rounded-sm", "text-black", "shadow-sm", 3, "routerLink"]], template: function CateringComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringComponent, { className: "CateringComponent", filePath: "apps/concierge/src/app/catering/catering.component.ts", lineNumber: 144 });
})();
...
//# sourceMappingURL=catering.module-HCSA7A46.js.map
