...
`],encapsulation:2})}return r})(),ba=(()=>{class r{id=u(xt).getId("mat-tab-nav-panel-");_activeTabId;static \u0275fac=function(e){return new(e||r)};static \u0275cmp=G({type:r,selectors:[["mat-tab-nav-panel"]],hostAttrs:["role","tabpanel",1,"mat-mdc-tab-nav-panel"],hostVars:2,hostBindings:function(e,i){e&2&&U("aria-labelledby",i._activeTabId)("id",i.id);},inputs:{id:"id"},exportAs:["matTabNavPanel"],ngContentSelectors:nt,decls:1,vars:0,template:function(e,i){e&1&&(Ze$1(),he(0));},encapsulation:2})}return r})(),ua=(()=>{class r{static \u0275fac=function(e){return new(e||r)};static \u0275mod=ve({type:r});static \u0275inj=_e({imports:[Et$1]})}return r})();export{Bn as B,Fn as F,Hn as H,Nn as N,On as O,ba as a,bn as b,un as c,ci as d,cn as e,hn as h,pa as p,ua as u};//# sourceMappingURL=chunk-Dx8AaFW-.js.map
