...
var ApplicationSidebarComponent = class _ApplicationSidebarComponent extends AsyncHandler {
  constructor() {
    ...
    this.show_block = signal({}, ...ngDevMode ? [{ debugName: "show_block" }] : (
      /* istanbul ignore next */
      []
    ));
    this.links = [];
    this.filtered_links = signal([], ...ngDevMode ? [{ debugName: "filtered_links" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApplicationSidebarComponent, { className: "ApplicationSidebarComponent", filePath: "apps/concierge/src/app/ui/app-sidebar.component.ts", lineNumber: 95 });
})();
...
var ApplicationTopbarComponent = class _ApplicationTopbarComponent {
  constructor() {
    ...
    this.logo = computed(() => (this._theme() === "dark" ? this._logo_dark() : this._logo_light()) || {}, ...ngDevMode ? [{ debugName: "logo" }] : (
      /* istanbul ignore next */
      []
    ));
    this.user = computed(() => currentUser(), ...ngDevMode ? [{ debugName: "user" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
//# sourceMappingURL=chunk-5O7QTLTR.js.map
