import {m,ar as re,ey as ks,ez as I,eA as Mp,aw as l,av as m$1,eB as Yi,eC as Lo,eD as L$1,eE as z$1,eF as at,eG as ct,eH as BN,eI as rh,eJ as Rp,eK as _e,eL as JE,eM as Nie,a as ft,eN as Wi,c as Dt,b0 as DD,a2 as Kn,t as Yn,aV as wt}from'./main-34YPHDMS.js';function j(o,m){}var F="_mat-bottom-sheet-enter",L="_mat-bottom-sheet-exit",z=(()=>{class o extends Rp{_breakpointSubscription;_animationsDisabled=ks();_animationState="void";_animationStateChanged=new _e;_destroyed=false;constructor(){super();let e=m(JE);this._breakpointSubscription=e.observe([Nie.Medium,Nie.Large,Nie.XLarge]).subscribe(()=>{let n=this._elementRef.nativeElement.classList;n.toggle("mat-bottom-sheet-container-medium",e.isMatched(Nie.Medium)),n.toggle("mat-bottom-sheet-container-large",e.isMatched(Nie.Large)),n.toggle("mat-bottom-sheet-container-xlarge",e.isMatched(Nie.XLarge));});}enter(){this._destroyed||(this._animationState="visible",this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation(F));}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute("mat-exit",""),this._animationState="hidden",this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(L));}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=true;}_simulateAnimation(e){this._ngZone.run(()=>{this._handleAnimationEvent(true,e),setTimeout(()=>this._handleAnimationEvent(false,e));});}_trapFocus(){super._trapFocus({preventScroll:true});}_handleAnimationEvent(e,n){let t=n===F;(t||n===L)&&this._animationStateChanged.emit({toState:t?"visible":"hidden",phase:e?"start":"done"});}static \u0275fac=function(n){return new(n||o)};static \u0275cmp=ft({type:o,selectors:[["mat-bottom-sheet-container"]],hostAttrs:["tabindex","-1",1,"mat-bottom-sheet-container"],hostVars:9,hostBindings:function(n,t){n&1&&Kn("animationstart",function(a){return t._handleAnimationEvent(true,a.animationName)})("animationend",function(a){return t._handleAnimationEvent(false,a.animationName)})("animationcancel",function(a){return t._handleAnimationEvent(false,a.animationName)}),n&2&&(Yn("role",t._config.role)("aria-modal",t._config.ariaModal)("aria-label",t._config.ariaLabel),wt("mat-bottom-sheet-container-animations-enabled",!t._animationsDisabled)("mat-bottom-sheet-container-enter",t._animationState==="visible")("mat-bottom-sheet-container-exit",t._animationState==="hidden"));},features:[Dt],decls:1,vars:0,consts:[["cdkPortalOutlet",""]],template:function(n,t){n&1&&DD(0,j,0,0,"ng-template",0);},dependencies:[Wi],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
