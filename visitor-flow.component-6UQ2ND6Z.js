...
function InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_14_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_14_Conditional_7_For_5_Template, 2, 4, "mat-checkbox", 40, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(5);
...
function InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_14_Conditional_7_Template, 6, 0, "div", 38);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
...
function InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "label", 42);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
...
function InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(17);
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275conditionalCreate(19, InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_19_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-form-field", 17);
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(26, InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_26_Template, 7, 7, "div", 10);
    \u0275\u0275conditionalCreate(27, InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_27_Template, 3, 1, "div", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 14, "FORM.DATE"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(18, 16, "BOOKINGS.VISITOR_REASON"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.reason_required() ? 19 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r2.reason_form.title)("placeholder", \u0275\u0275pipeBind1(22, 18, "BOOKINGS.VISITOR_REASON_PLACEHOLDER"));
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 20, "COMMON.REQUIRED"));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.allow_pass_number() ? 26 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.allow_international() && !ctx_r2.multiple() ? 27 : -1);
  }
}
function InviteVisitorFormComponent_Conditional_0_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Template, 28, 22, "form", 7);
...
function InviteVisitorFormComponent_Conditional_1_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "a", 51);
    \u0275\u0275pipe(2, "sanitize");
    \u0275\u0275element(3, "img", 52);
    \u0275\u0275elementStart(4, "span");
    \u0275\u0275text(5);
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "a", 55);
    \u0275\u0275pipe(14, "safe");
    \u0275\u0275elementStart(15, "icon", 56);
    \u0275\u0275text(16, "download");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span");
    \u0275\u0275text(18);
...
function InviteVisitorFormComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 44)(2, "h2", 45);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "img", 46);
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, InviteVisitorFormComponent_Conditional_1_Conditional_11_Template, 20, 21, "div", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 48)(13, "div", 49)(14, "button", 50);
...
var InviteVisitorFormComponent = class _InviteVisitorFormComponent {
  constructor() {
    ...
    this.reason_required = this._settings.signal("visitors.reason_required", false);
    this.reason_form = form(this._service.model, (p) => {
      required(p.title, { when: () => this.reason_required() });
      validate(p.title, ({ value }) => this.reason_required() && !value()?.trim() ? { kind: "required" } : void 0);
    });
    this.date = input(
      void 0,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InviteVisitorFormComponent, { className: "InviteVisitorFormComponent", filePath: "libs/bookings/src/lib/invite-visitor-form.component.ts", lineNumber: 599 });
})();
...
//# debugId=0c661641-c347-5434-b04e-a9668180158c
//# sourceMappingURL=visitor-flow.component-6UQ2ND6Z.js.map
