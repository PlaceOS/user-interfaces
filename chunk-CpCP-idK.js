...
`],encapsulation:2})}return n})();var Hn=(()=>{class n{static ɵfac=function(t){return new(t||n)};static ɵmod=ae({type:n});static ɵinj=oe({imports:[Kl$1,ti,Rt]})}return n})();var Ea=(()=>{class n{constructor(){this.url=m(wde)}static{this.ɵfac=function(t){return new(t||n)}}static{this.ɵcmp=_e({type:n,selectors:[[`image-viewer`]],decls:5,vars:1,consts:[[1,`bg-base-200`,`h-screen`,`w-screen`],[`auth`,``,1,`h-full`,`w-full`,`object-contain`,`object-center`,3,`source`],[`icon`,``,`matRipple`,``,`mat-dialog-close`,``,1,`bg-base-100`,`absolute`,`top-1`,`right-1`]],template:function(t,i){t&1&&(ke(0,`div`,0),Bt(1,`img`,1),ke(2,`button`,2)(3,`icon`),yi(4,`close`),Ue()()()),t&2&&(fe(),Dn$1(`source`,i.url))},dependencies:[Lnt,Mt,xJe,MJe],encapsulation:2})}}return n})();var ll=(n,o,e)=>({file:n,is_public:o,permissions:e});function cl(n,o){if(n&1){let e=jC();ke(0,`div`,7)(1,`label`),yi(2,`Permissions`),Ue(),ke(3,`mat-form-field`,11)(4,`mat-select`,12),He(`ngModelChange`,function(i){Ay(e);return Dy(bt().permissions.set(i))}),ke(5,`mat-option`,13),yi(6,`None`),Ue(),ke(7,`mat-option`,14),yi(8,`Support`),Ue(),ke(9,`mat-option`,15),yi(10,`Admin`),Ue()(),J4(),Ue()()}if(n&2){let e=bt();fe(4),Dn$1(`ngModel`,e.permissions()),t6()}}var Na=(()=>{class n{constructor(){this._dialog_ref=m(ZT),this._data=m(wde),this.file=this._data.file,this.is_public=N(!!this._data.is_public),this.permissions=N(`none`),this.file=this._data.file}close(){this._dialog_ref.close()}static{this.ɵfac=function(t){return new(t||n)}}static{this.ɵcmp=_e({type:n,selectors:[[`upload-permissions-modal`]],decls:18,vars:7,consts:[[1,`bg-base-200`,`sticky`,`top-0`,`z-10`,`m-2`,`w-[calc(100%-1rem)]`,`rounded-sm`,`border-none`,`p-2`],[1,`px-2`,`text-xl`,`font-medium`],[`icon`,``,`matRipple`,``,`mat-dialog-close`,``],[1,`min-w-[20rem]`,`space-y-2`,`px-4`,`py-2`],[1,`flex`,`flex-col`],[`appearance`,`outline`,1,`no-subscript`],[`matInput`,``,`disabled`,`true`,`placeholder`,`File Name`,3,`ngModel`],[1,`flex`,`flex-col`,`space-y-2`],[1,`border-base-200`,`flex`,`items-center`,`justify-end`,`space-x-2`,`border-t`,`px-4`,`py-2`],[`btn`,``,`matRipple`,``,`mat-dialog-close`,``,1,`inverse`,`w-32`],[`btn`,``,`matRipple`,``,1,`w-32`,3,`mat-dialog-close`],[`appearance`,`outline`],[3,`ngModelChange`,`ngModel`],[`value`,`none`],[`value`,`support`],[`value`,`admin`]],template:function(t,i){t&1&&(ke(0,`header`,0)(1,`h2`,1),yi(2,`Upload File`),Ue(),ke(3,`button`,2)(4,`icon`),yi(5,`close`),Ue()()(),ke(6,`main`,3)(7,`div`,4)(8,`label`),yi(9,`File Name`),Ue(),ke(10,`mat-form-field`,5),Bt(11,`input`,6),J4(),Ue()(),Le(12,cl,11,1,`div`,7),Ue(),ke(13,`footer`,8)(14,`button`,9),yi(15,` Cancel `),Ue(),ke(16,`button`,10),yi(17,` Upload `),Ue()()),t&2&&(fe(11),Dn$1(`ngModel`,i.file.name),t6(),fe(),Fe(i.is_public()?-1:12),fe(4),Dn$1(`mat-dialog-close`,i7(3,ll,i.file,i.is_public(),i.permissions())))},dependencies:[xJe,MJe,wx,rq,Ike,EH,yke,jee,Zt,Qt,UW,Lnt,Iit,Tit,Kl$1,b0],encapsulation:2})}}return n})();var dl=[`image_list`];var ml=[`file_input`];function pl(n,o){if(n&1){let e=jC();ke(0,`div`,15),Bt(1,`img`,16),ke(2,`div`,17),Bt(3,`div`,18),ke(4,`div`,19)(5,`button`,20),He(`click`,function(){let i=Ay(e).$implicit;return Dy(bt().copyLink(i))}),ke(6,`icon`),yi(7,`link`),Ue()(),ke(8,`button`,20),He(`click`,function(){let i=Ay(e).$implicit;return Dy(bt().viewImage(i))}),ke(9,`icon`),yi(10,`visibility`),Ue()(),ke(11,`button`,20),He(`click`,function(){let i=Ay(e).$implicit;return Dy(bt().removeImage(i))}),ke(12,`icon`),yi(13,`close`),Ue()()()()()}if(n&2){let e=o.$implicit;GC(`transform`,`translate(-`+bt().offset()+`00%)`),fe(),Dn$1(`source`,e)}}function ul(n,o){if(n&1&&Bt(0,`mat-progress-spinner`,22),n&2){let e=bt().$implicit;Dn$1(`value`,e.progress)(`diameter`,64)}}function _l(n,o){n&1&&(ke(0,`icon`,23),yi(1,`warning`),Ue())}function hl(n,o){n&1&&(ke(0,`div`,24)(1,`icon`,25),yi(2,`refresh`),Ue()())}function fl(n,o){if(n&1){let e=jC();ke(0,`div`,21),He(`click`,function(){let i=Ay(e).$implicit;return Dy(bt().retryUpload(i))}),Le(1,ul,1,2,`mat-progress-spinner`,22),Le(2,_l,2,0,`icon`,23),Le(3,hl,3,0,`div`,24),Ue()}if(n&2){let e=o.$implicit;GC(`transform`,`translate(-`+bt().offset()+`00%)`),Dn$1(`matTooltip`,e.error),fe(),Fe(e.error?-1:1),fe(),Fe(e.error?2:-1),fe(),Fe(e.error?3:-1)}}function gl(n,o){if(n&1){let e=jC();ke(0,`button`,26),He(`click`,function(){Ay(e);return Dy(bt().previousOffset())}),ke(1,`icon`),yi(2,`chevron_left`),Ue()()}if(n&2)Dn$1(`disabled`,bt().offset()===0)}function bl(n,o){if(n&1){let e=jC();ke(0,`button`,27),He(`click`,function(){Ay(e);return Dy(bt().nextOffset())}),ke(1,`icon`),yi(2,`chevron_right`),Ue()()}if(n&2){let e=bt();Dn$1(`disabled`,e.offset()>=e.length()-e.view_space())}}function vl(n,o){if(n&1){let e=jC();ke(0,`mat-chip-row`,28),He(`removed`,function(){let i=Ay(e).$implicit;return Dy(bt().removeImage(i))}),ke(1,`div`,29),yi(2),Ue(),ke(3,`button`,30)(4,`icon`),yi(5,`cancel`),Ue()()()}if(n&2){let e=o.$implicit;fe(2),gu(e),fe(),Ge$1(`aria-label`,`Remove `+e)}}var Oa=(()=>{class n extends so{constructor(){super(...arguments),this._clipboard=m(Vj),this._uploads=m(KJe),this._dialog=m(QT),this._injector=m(H),this._upload_completion_effect=Xe(()=>{let e=this.upload_list(),t=this.upload_ids();for(let i of t){let r=e.find(d=>d?.id===i);r&&r.progress>=100&&(this.addImageUrl(r.link),this.upload_ids.set(this.upload_ids().filter(d=>d!==i)))}},{injector:this._injector}),this.list=N([]),this.upload_map={},this.upload_ids=N([]),this.upload_list=N([]),this.offset=N(0),this.view_space=N(0),this.separators=[188,13],this.uploads=w(()=>{let e=this.upload_ids();return this.upload_list().filter(t=>e.includes(t?.id))}),this.length=w(()=>this.list().length+this.upload_list().length+1),this._list_el=sl$1(`image_list`),this._file_input=sl$1(`file_input`),this.registerOnChange=e=>this._onChange=e,this.registerOnTouched=e=>this._onTouch=e}ngAfterViewInit(){this.updateViewSpace()}updateViewSpace(){this.timeout(`init_view_space`,()=>{let e=this._list_el()?.nativeElement?.getBoundingClientRect();e&&this.view_space.set(Math.floor(e.width/152))},100)}copyLink(e){this._clipboard.copy(e),cj(`Copied image URL to clipboard`)}viewImage(e){this._dialog.open(Ea,{data:e})}removeImage(e){this.setValue(this.list().filter(t=>t!==e))}addImage(e){e.value&&(this.setValue(ei$1([...this.list(),e.value])),e.chipInput.inputElement.value=``)}addImageUrl(e){this.setValue(ei$1([...this.list(),e]))}retryUpload(e){e.error&&(e.error=null,e.upload.resume())}previousOffset(){this.offset.update(e=>e-1)}nextOffset(){this.offset.update(e=>e+1)}async uploadImages(e){let t=e.target;if(t?.files){let i=t.files;if(i.length){this.interval(`update_status`,()=>this._updateUploadHistory());for(let r=0;r<i.length;r++)try{let d=await this._uploads.uploadFileWithPermissions(i[r]);this.upload_ids.set([...this.upload_ids(),d])}catch(d){if(d instanceof lI)continue;sj(`Failed to upload ${i[r].name}: ${d?.message||`Unknown error`}`)}this._file_input().nativeElement.value=``}}}setValue(e){let t=e||[];this.list.set(t),this._onChange&&this._onChange(t)}writeValue(e){this.list.set(e||[])}async _updateUploadHistory(){let e=this.upload_ids();if(e.length===0)return;let i=this._uploads.upload_list().filter(d=>e.find(x=>x===d?.id)),r=i.filter(d=>d.progress>=100);this.upload_list.set(i),r.forEach(d=>{console.log(`ID:`,l({},d)),this.upload_map[d?.id]=d.upload?.id||d?.id,delete d.upload}),r.length>=e.length&&this.clearInterval(`update_status`)}static{this.ɵfac=(()=>{let e;return function(i){return(e||(e=pt(n)))(i||n)}})()}static{this.ɵcmp=_e({type:n,selectors:[[`image-list-field`]],viewQuery:function(t,i){t&1&&pu(i._list_el,dl,5)(i._file_input,ml,5),t&2&&mu(2)},features:[qe([{provide:zo,useExisting:sn$1(()=>n),multi:!0},{provide:Tue,useValue:Na}]),Ne],decls:23,vars:13,consts:[[`image_list`,``],[`file_input`,``],[`chipList`,``],[`images`,``,1,`relative`,`mb-2`,`flex`,`w-full`,`items-center`,`space-x-2`,`overflow-hidden`,`py-2`,3,`resize`],[`image`,``,1,`border-base-200`,`hover:border-base-300`,`hover:bg-base-200`,`relative`,`flex`,`h-32`,`w-36`,`shrink-0`,`cursor-pointer`,`flex-col`,`items-center`,`justify-center`,`rounded-xl`,`border-2`,`border-dashed`],[1,`text-4xl`,`opacity-60`],[1,`px-4`,`text-center`,`opacity-60`],[`type`,`file`,1,`absolute`,`inset-0`,`h-32`,`w-32`,`cursor-pointer`,`opacity-0`,3,`change`],[`image`,``,1,`bg-base-200`,`relative`,`h-32`,`w-36`,`shrink-0`,`overflow-hidden`,`rounded-sm`,`bg-cover`,`bg-center`,3,`transform`],[`upload`,``,1,`border-base-content/10`,`/5`,`bg-base-200`,`flex`,`h-32`,`w-36`,`shrink-0`,`items-center`,`justify-center`,`rounded-sm`,`border`,`bg-cover`,`bg-center`,3,`transform`,`matTooltip`],[`icon`,``,`matRipple`,``,1,`bg-base-100`,`absolute`,`top-1/2`,`left-0`,`-translate-y-1/2`,`transform`,3,`disabled`],[`icon`,``,`matRipple`,``,1,`bg-base-100`,`absolute`,`top-1/2`,`right-0`,`-translate-y-1/2`,`transform`,3,`disabled`],[`appearance`,`outline`,1,`w-full`],[`aria-label`,`Image List`],[3,`matChipInputTokenEnd`,`placeholder`,`matChipInputFor`,`matChipInputSeparatorKeyCodes`,`matChipInputAddOnBlur`],[`image`,``,1,`bg-base-200`,`relative`,`h-32`,`w-36`,`shrink-0`,`overflow-hidden`,`rounded-sm`,`bg-cover`,`bg-center`],[`auth`,``,1,`pointer-events-none`,`absolute`,`top-1/2`,`left-1/2`,`z-10`,`-translate-x-1/2`,`-translate-y-1/2`,`object-contain`,3,`source`],[`overlay`,``,1,`text-base-100`,`absolute`,`inset-0`,`z-20`],[`bg`,``,1,`absolute`,`inset-0`,`bg-black`,`opacity-0`],[`actions`,``,1,`absolute`,`top-0`,`right-0`,`left-0`,`flex`,`items-center`,`justify-center`,`space-x-2`,`opacity-0`],[`icon`,``,3,`click`],[`upload`,``,1,`border-base-content/10`,`/5`,`bg-base-200`,`flex`,`h-32`,`w-36`,`shrink-0`,`items-center`,`justify-center`,`rounded-sm`,`border`,`bg-cover`,`bg-center`,3,`click`,`matTooltip`],[`mode`,`determinate`,3,`value`,`diameter`],[1,`text-error`,`text-6xl`],[`overlay`,``,1,`text-base-100`,`hover:bg-base-content`,`hover:bg-opacity-50`,`absolute`,`inset-0`,`flex`,`items-center`,`justify-center`],[1,`text-3xl`,`opacity-0`],[`icon`,``,`matRipple`,``,1,`bg-base-100`,`absolute`,`top-1/2`,`left-0`,`-translate-y-1/2`,`transform`,3,`click`,`disabled`],[`icon`,``,`matRipple`,``,1,`bg-base-100`,`absolute`,`top-1/2`,`right-0`,`-translate-y-1/2`,`transform`,3,`click`,`disabled`],[3,`removed`],[1,`max-w-md`,`truncate`],[`matChipRemove`,``]],template:function(t,i){if(t&1&&(ke(0,`div`,3,0),He(`resize`,function(){return i.updateViewSpace()},C8),ke(2,`div`,4)(3,`icon`,5),yi(4,`add`),Ue(),ke(5,`p`,6),yi(6),gp(7,`translate`),Ue(),ke(8,`input`,7,1),He(`change`,function(d){return i.uploadImages(d)}),Ue()(),s9(10,pl,14,3,`div`,8,o9),s9(12,fl,4,6,`div`,9,o9),Le(14,gl,3,1,`button`,10),Le(15,bl,3,1,`button`,11),Ue(),ke(16,`mat-form-field`,12)(17,`mat-chip-grid`,13,2),s9(19,vl,6,2,`mat-chip-row`,null,o9),Ue(),ke(21,`input`,14),gp(22,`translate`),He(`matChipInputTokenEnd`,function(d){return i.addImage(d)}),Ue()()),t&2){let r=DE(18);fe(2),GC(`transform`,`translate(-`+i.offset()+`00%)`),fe(4),Lo(` `,zC(7,9,`COMMON.IMAGE_UPLOADS`),` `),fe(4),a9(i.list()),fe(2),a9(i.uploads()),fe(2),Fe(i.length()>i.view_space()?14:-1),fe(),Fe(i.length()>i.view_space()?15:-1),fe(4),a9(i.list()),fe(2),Dn$1(`placeholder`,zC(22,11,`COMMON.IMAGE_ADD_URL`))(`matChipInputFor`,r)(`matChipInputSeparatorKeyCodes`,i.separators)(`matChipInputAddOnBlur`,!0)}},dependencies:[wx,rq,Yot,Got,zot,$ot,jhe,Ct,Xt,Zit,mhe,Lnt,Mt,tot],styles:[`[_nghost-%COMP%]{width:100%}[overlay][_ngcontent-%COMP%]{transition:background .2s}[image][_ngcontent-%COMP%]:hover   [actions][_ngcontent-%COMP%], [image][_ngcontent-%COMP%]:hover > icon[_ngcontent-%COMP%]{opacity:1!important}[image][_ngcontent-%COMP%]:hover   [bg][_ngcontent-%COMP%]{opacity:.4!important}[actions][_ngcontent-%COMP%], [image][_ngcontent-%COMP%] > icon[_ngcontent-%COMP%]{transition:opacity .2s}[image][_ngcontent-%COMP%]{transition:transform .2s}
/*# sourceMappingURL=image-list-field.component.css.map */`]})}}return n})();function xl(n,o){if(n&1&&(Bt(0,`div`,1),gp(1,`safe`)),n&2)Dn$1(`innerHTML`,YC(1,1,bt().changelog(),`html`),sC)}function kl(n,o){n&1&&(ke(0,`div`,2)(1,`icon`,3),yi(2,`close`),Ue(),ke(3,`div`,4),yi(4,`No changelog`),Ue()())}var Ra=(()=>{class n{constructor(){this._data=m(wde),this.loading=N(!1),this.changelog=w(()=>dt(this._data.changelog||``,{async:!1}))}static{this.ɵfac=function(t){return new(t||n)}}static{this.ɵcmp=_e({type:n,selectors:[[`changelog-modal`]],decls:3,vars:3,consts:[[3,`heading`,`hide_confirm`],[1,`markdown`,3,`innerHTML`],[1,`flex`,`flex-col`,`items-center`,`justify-center`,`space-y-2`],[1,`text-3xl`],[1,`text`]],template:function(t,i){t&1&&(ke(0,`fullscreen-modal-shell`,0),Le(1,xl,2,4,`div`,1)(2,kl,5,0,`div`,2),Ue()),t&2&&(Dn$1(`heading`,`Changelog`)(`hide_confirm`,!0),fe(),Fe(i.changelog()?1:2))},dependencies:[zn,Lnt,BW],encapsulation:2})}}return n})();function yl(n,o){if(n&1&&(ke(0,`div`,1),yi(1),Ue()),n&2){let e=bt(2);fe(),Lo(` `,e.initials,` `)}}function Cl(n,o){if(n&1&&Bt(0,`img`,2),n&2){let e=bt(2);Dn$1(`alt`,e.initials)(`source`,e.user().photo)}}function Ml(n,o){if(n&1&&(ke(0,`div`,0),Le(1,yl,2,1,`div`,1)(2,Cl,1,2,`img`,2),Ue()),n&2){let e=bt();Ge$1(`user-id`,e.user().id),fe(),Fe(e.user().photo?2:1)}}var Wn=(()=>{class n{constructor(){this.user=Jt$1(void 0),this.is_valid=w(()=>{let e=this.user();if(!e)return!1;let t=(e.name||``).trim(),i=(e.email||``).trim();return t.startsWith(`<empty>`)||i.startsWith(`<empty>`)?!1:!!(t||i||e.first_name||e.last_name)})}get initials(){let e=this.user();if(!e)return`NA`;if(e.first_name&&e.last_name)return`${e.first_name[0]}${e.last_name[0]}`;let t=(e.name||``).replace(/<[^>]*>/g,` `).trim();t||(t=(e.email||e.name||``).split(`@`)[0]);let i=t.replace(/[()[\]\-+=\\/@<>]+/gi,` `).split(/\s+/).filter(Boolean);return i.length===0?`NA`:i.length>1?`${i[0][0]}${i[i.length-1][0]}`:i[0].slice(0,2)}static{this.ɵfac=function(t){return new(t||n)}}static{this.ɵcmp=_e({type:n,selectors:[[`a-user-avatar`]],inputs:{user:[1,`user`]},decls:1,vars:1,consts:[[1,`border-base-100`,`bg-base-200`,`flex`,`h-[2.5em]`,`w-[2.5em]`,`items-center`,`justify-center`,`overflow-hidden`,`rounded-full`,`border-2`],[`initials`,``,1,`text-base-content`,`uppercase`,`opacity-60`],[`auth`,``,1,`flex`,`h-full`,`w-full`,`items-center`,`justify-center`,`object-cover`,`object-center`,3,`alt`,`source`]],template:function(t,i){t&1&&Le(0,Ml,3,2,`div`,0),t&2&&Fe(i.is_valid()?0:-1)},dependencies:[Mt],encapsulation:2})}}return n})();function Sl(n,o){if(n&1&&(ke(0,`mat-option`,8),yi(1),Ue()),n&2){let e=o.$implicit;Dn$1(`value`,e.display_name||e.name),fe(),Lo(` `,e.display_name||e.name,` `)}}function wl(n,o){if(n&1&&(ke(0,`mat-option`,8),yi(1),Ue()),n&2){let e=o.$implicit;Dn$1(`value`,e?.name||e),fe(),Lo(` `,e.name||e,` `)}}function Tl(n,o){if(n&1&&(ke(0,`div`,5)(1,`label`),yi(2),gp(3,`translate`),Ue(),ke(4,`mat-form-field`,6)(5,`mat-select`,7),gp(6,`translate`),s9(7,wl,2,2,`mat-option`,8,o9),Ue(),J4(),Ue()()),n&2){let e=bt();fe(2),gu(zC(3,3,`COMMON.SUPPORT_TYPE`)),fe(3),Dn$1(`placeholder`,zC(6,5,`COMMON.SUPPORT_TYPE`))(`formField`,e.form.issue_type),t6(),fe(2),a9(e.support_request_types())}}function El(n,o){n&1&&(ke(0,`mat-error`,11),yi(1),gp(2,`translate`),Ue()),n&2&&(fe(),Lo(` `,zC(2,1,`COMMON.DESCRIPTION_REQUIRED`),` `))}function Il(n,o){if(n&1&&(ke(0,`div`,12)(1,`label`,10),yi(2),gp(3,`translate`),Ue(),Bt(4,`image-list-field`,14),J4(),Ue()),n&2){let e=bt();fe(2),gu(zC(3,2,`COMMON.IMAGES`)),fe(2),Dn$1(`formField`,e.form.images),t6()}}var Aa=(()=>{class n{constructor(){this._dialog_ref=m(ZT),this._org=m(HT),this._settings=m(sa$1),this._support_email=this._settings.signal(`support_email`,`support@place.tech`),this._support_issue_types=this._settings.signal(`support_issue_types`,[]),this._allow_images=this._settings.signal(`allow_support_ticket_images`,!1),this.loading=N(!1),this.model=N({name:``,email:``,location:``,description:``,issue_type:``,images:[]}),this.form=Lfe(this.model,e=>{Brt(e.name),Brt(e.email),Brt(e.description)}),this.desc_error=N(!1),this.support_email=this._support_email,this.support_request_types=this._support_issue_types,this.allow_images=this._allow_images,this.buildings=this._org.building_list}ngOnInit(){let e=Mi();e&&this.model.update(t=>m$1(l({},t),{name:e.name,email:e.email})),this._org.building&&this.model.update(t=>m$1(l({},t),{location:this._org.building.display_name||this._org.building.name}))}async submit(){if(this.loading.set(!0),this.form().markAsTouched(),this._updateDescError(),this.form().valid()){let e=this._org.module(`smtp`,`Mailer`);if(!e)return sj(Sr(`COMMON.SUPPORT_NO_MAILER`));let{name:t,email:i,location:r,description:d,images:x,issue_type:O}=this.model(),$=this.support_request_types().find(_e=>_e.name===O)?.email||this.support_email(),ie=Sr(`COMMON.SUPPORT_MAIL_HEADER`,{issue_type:O?` - `+O:``});await e.execute(`send_mail`,[$,ie,`${t}
${i}
...
//# debugId=785b523d-99e0-5da4-a784-bf86e645c78c
//# sourceMappingURL=chunk-CpCP-idK.js.map