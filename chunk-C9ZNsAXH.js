...
`],encapsulation:2})}return i})(),mn=(()=>{class i{id=m($t).getId("mat-tab-nav-panel-");_activeTabId;static \u0275fac=function(e){return new(e||i)};static \u0275cmp=Ee$1({type:i,selectors:[["mat-tab-nav-panel"]],hostAttrs:["role","tabpanel",1,"mat-mdc-tab-nav-panel"],hostVars:2,hostBindings:function(e,n){e&2&&ze("aria-labelledby",n._activeTabId)("id",n.id);},inputs:{id:"id"},exportAs:["matTabNavPanel"],ngContentSelectors:F,decls:1,vars:0,template:function(e,n){e&1&&(Kt(),Pe$1(0));},encapsulation:2})}return i})(),hn=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=ae({type:i});static \u0275inj=oe$1({imports:[Dt]})}return i})();export{Ae as A,Be as B,Se as S,bn as b,hn as h,mn as m};//# sourceMappingURL=chunk-C9ZNsAXH.js.map
