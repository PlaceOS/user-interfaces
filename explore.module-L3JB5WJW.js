...
var AccessibilityControlsComponent = class _AccessibilityControlsComponent extends AsyncHandler {
  constructor() {
    ...
    this.can_change_dark_mode = computed(() => !!this._allow_dark_mode(), ...ngDevMode ? [{ debugName: "can_change_dark_mode" }] : (
      /* istanbul ignore next */
      []
    ));
    this.dark_mode = computed(() => this.can_change_dark_mode() && this._settings.theme_signal() === "dark", ...ngDevMode ? [{ debugName: "dark_mode" }] : (
      /* istanbul ignore next */
      []
    ));
    this.accessible = computed(() => !!this._accessible(), ...ngDevMode ? [{ debugName: "accessible" }] : (
      /* istanbul ignore next */
      []
    ));
    this.font_size = computed(() => this._font_size() || 16, ...ngDevMode ? [{ debugName: "font_size" }] : (
      /* istanbul ignore next */
      []
    ));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AccessibilityControlsComponent, { className: "AccessibilityControlsComponent", filePath: "apps/map-kiosk/src/app/accessibility-controls.component.ts", lineNumber: 66 });
})();
...
var ExploreLockerBankModalComponent = class _ExploreLockerBankModalComponent {
  constructor() {
    ...
    this.lockers = computed(() => this._data.lockers.reduce((map, locker) => {
      map[locker.id] = "busy";
      return map;
...
var MapCanvasComponent = class _MapCanvasComponent {
  ...
  static {
    ...
    }, attrs: _c12, decls: 2, vars: 4, consts: [["canvas", ""], [1, "absolute", "top-1/2", "left-1/2", "-translate-x-1/2", "-translate-y-1/2"]], template: function MapCanvasComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var ExploreSearchComponent = class _ExploreSearchComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreSearchComponent, selectors: [["explore-search"]], viewQuery: function ExploreSearchComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuerySignal(ctx._input_el, _c08, 5)(ctx._button_el, _c13, 5);
      }
      if (rf & 2) {
        \u0275\u0275queryAdvance(2);
      }
...
function ExploreLevelSelectComponent_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("active", lvl_r2.id === ((tmp_10_0 = ctx_r2.level()) == null ? null : tmp_10_0.id));
    \u0275\u0275advance(2);
...
var ExploreLevelSelectComponent = class _ExploreLevelSelectComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreLevelSelectComponent, selectors: [["explore-level-select"]], decls: 3, vars: 0, consts: [[1, "border-base-300", "bg-base-100", "m-2", "overflow-hidden", "rounded-sm", "border", "border-solid", "shadow-sm"], ["matRipple", "", 1, "flex", "h-16", "w-16", "flex-col", "items-center", "justify-center", "border-none", "p-2", 3, "active"], ["matRipple", "", 1, "flex", "h-16", "w-16", "flex-col", "items-center", "justify-center", "border-none", "p-2", 3, "click"], [1, "text-2xl"], [1, "m-0", "text-sm", "whitespace-nowrap"]], template: function ExploreLevelSelectComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275repeaterCreate(1, ExploreLevelSelectComponent_For_2_Template, 5, 4, "button", 1, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ExploreLevelSelectComponent, [{
    ...
    `, imports: [MatRippleModule], styles: ["/* angular:styles/component:css;e63d04c22f2df73bef976dac40737116b35c5759d42b86f0004e301d9e8ecd5b;/home/runner/work/user-interfaces/user-interfaces/apps/map-kiosk/src/app/explore-level-select.component.ts */\n.active {\n  background: var(--secondary) !important;\n  color: #fff !important;\n}\nbutton:not(:first-child) {\n  border-top: 1px solid var(--base-300) !important;\n}\n/*# sourceMappingURL=explore-level-select.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
function ExploreComponent_Conditional_13_For_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("opacity-30", lvl_r9.id !== ((tmp_12_0 = ctx_r2.level()) == null ? null : tmp_12_0.id));
    \u0275\u0275advance(2);
...
var ExploreComponent = class _ExploreComponent extends AsyncHandler {
  constructor() {
    ...
    this.show_levels = signal(true, ...ngDevMode ? [{ debugName: "show_levels" }] : (
      /* istanbul ignore next */
      []
    ));
    this.show_legend = signal(false, ...ngDevMode ? [{ debugName: "show_legend" }] : (
      /* istanbul ignore next */
      []
    ));
    this.show_accessibility = signal(false, ...ngDevMode ? [{ debugName: "show_accessibility" }] : (
      /* istanbul ignore next */
      []
    ));
    this.legend = [
    ...
    this.level = this._state.level;
    this.logo = computed(() => this._settings.theme_signal() === "dark" ? this._settings.signal("logo_dark")() : this._settings.signal("logo_light")(), ...ngDevMode ? [{ debugName: "logo" }] : (
      /* istanbul ignore next */
      []
    ));
    this.legend_visible = computed(() => this._settings.signal("explore.show_legend")() !== false, ...ngDevMode ? [{ debugName: "legend_visible" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.setOptions = (o) => this._state.setOptions(o);
    this.setLevel = (lvl) => this._state.setLevel(lvl.id);
    this.can_search = computed(() => !!this._settings.signal("explore.search_enabled")(), ...ngDevMode ? [{ debugName: "can_search" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  async locateUser(user) {
    ...
    const mod = Dl(locate_details.system_id, locate_details.module);
    const locations = (await mod.execute("locate_user", [
      user.email,
      user.username || user.id
    ])).map((i) => new MapLocation(i));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreComponent, selectors: [["", "app-explore", ""]], hostBindings: function ExploreComponent_HostBindings(rf, ctx) {
      ...
      ExploreParkingService,
      SpacePipe
    ]), \u0275\u0275InheritDefinitionFeature], attrs: _c09, decls: 29, vars: 18, consts: [["accessibility_controls", ""], ["levelMenu", "matMenu"], ["legendMenu", "matMenu"], ["topbar", "", 1, "border-base-300", "bg-base-100", "text-base-content", "relative", "flex", "items-center", "justify-between", "border-b", "px-4", "py-2"], ["matRipple", "", "routerLink", "/", 1, "rounded-sm", "p-2", "text-2xl"], ["auth", "", "alt", "Logo", 1, "h-12", 3, "source"], [1, "absolute", "top-1/2", "right-2", "flex", "-translate-y-1/2", "items-center"], ["icon", "", "matRipple", "", "customTooltip", "", 1, "bg-base-200", "flex", "sm:hidden", 3, "content"], ["options", "", 1, "bg-base-content", "text-base-100", "flex", "items-center", "space-x-2", "p-2", "sm:hidden"], [1, "flex", "h-1/2", "flex-1"], ["sidebar", "", 1, "border-base-300", "bg-base-100", "text-base-content", "hidden", "w-[20rem]", "overflow-auto", "border-r", "px-2", "py-4", "sm:block"], ["btn", "", "matRipple", "", 1, "items", "clear", "hover:bg-base-200", "flex", "w-full", "space-x-4", 3, "click"], [1, "text-2xl"], [1, "flex-1", "text-left", "font-medium"], [1, "px-8"], [1, "space-y-2", "py-4"], [1, "mx-auto", "w-[calc(100%-4rem)]"], [1, "relative", "h-full", "flex-1"], [1, "absolute", "inset-0"], [3, "zoomChange", "centerChange", "src", "zoom", "center", "styles", "features", "actions", "labels", "options", "focus"], [1, "bg-base-100", "w-[18rem]", "rounded-sm", "p-2"], ["btn", "", "matRipple", "", 1, "clear", "text-base-100", 3, "matMenuTriggerFor"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "hover:bg-base-200", "flex", "w-full", "items-center", "space-x-4", "rounded-sm", "px-4", "py-2"], [1, "h-3", "w-3", "rounded-full"], [1, "text-left", "opacity-60"], ["btn", "", "matRipple", "", 1, "clear", "hover:bg-base-200", "w-full", "hover:opacity-100", 3, "opacity-30"], ["btn", "", "matRipple", "", 1, "clear", "hover:bg-base-200", "w-full", "hover:opacity-100", 3, "click"], [1, "w-full", "text-left"]], template: function ExploreComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("source", ((tmp_1_0 = ctx.logo()) == null ? null : tmp_1_0.src) || ctx.logo());
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(6);
        \u0275\u0275property("src", ctx.url())("zoom", (tmp_10_0 = ctx.positions()) == null ? null : tmp_10_0.zoom)("center", (tmp_11_0 = ctx.positions()) == null ? null : tmp_11_0.center)("styles", ctx.styles())("features", ctx.features())("actions", ctx.actions())("labels", ctx.labels())("options", \u0275\u0275pureFunction0(17, _c14))("focus", ctx.locate());
      }
    }, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExploreComponent, { className: "ExploreComponent", filePath: "apps/map-kiosk/src/app/explore.component.ts", lineNumber: 295 });
})();
...
var AppExploreModule = class _AppExploreModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forChild(ROUTES), STANDALONE_COMPONENTS2] });
  }
};
(() => {
...
//# sourceMappingURL=explore.module-L3JB5WJW.js.map
