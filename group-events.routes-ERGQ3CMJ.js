...
var GroupEventsStateService = class _GroupEventsStateService {
  ...
  constructor() {
    ...
    effect(async () => {
      ...
      const sys = await na({ in: this.calendar }).then((r) => r.data?.[0]).catch(() => null);
      if (!sys) {
        this._events.set([]);
        return;
      }
...
//# sourceMappingURL=group-events.routes-ERGQ3CMJ.js.map
