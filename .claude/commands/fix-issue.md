...
argument-hint: [ISSUE-KEY] [--status STATUS] [--review-status STATUS] [--commit-behavior ask|source|worktree] [additional instructions]
---
...
Fetch full issue context before editing code:
...
Use the appropriate file editing tool for manual edits. Keep changes scoped to the Jira issue.
