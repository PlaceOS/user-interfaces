...
class AssetReportDailyUsageComponent {
  constructor(_state) {
    ...
    this._state = _state;
    this.print = false;
    this.daily_products = this._state.daily_stats$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(days => {
      let list = [];
      for (const date in days) {
        ...
        const products_list = (products || []).map(p => {
          const product_bookings = bookings.filter(b => p.assets.find(({
            id
          }) => b.asset_ids.includes(id)));
          return {
            name: p.name,
            date,
            booking_count: product_bookings.length,
            booked_count: product_bookings.reduce((acc, b) => acc + b.asset_ids.filter(asset_id => p.assets.find(({
              id
            }) => asset_id === id)).length, 0),
  ...
  static #_ = this.ɵfac = function AssetReportDailyUsageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || AssetReportDailyUsageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_assets_report_service__WEBPACK_IMPORTED_MODULE_2__.AssetsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    ...
    template: function AssetReportDailyUsageComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("data", ctx.daily_products)("columns", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction5"](11, _c5, _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](5, _c0), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction1"](6, _c1, date_template_r4), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](8, _c2), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](9, _c3), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](10, _c4)))("sortable", true)("page_size", ctx.print ? 0 : 10);
      }
    },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AssetReportExpiredItemsComponent: () => (/* binding */ AssetReportExpiredItemsComponent)
/* harmony export */ });
/* harmony import */ var _home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var _placeos_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @placeos/common */ 22797);
...
function AssetReportExpiredItemsComponent_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "button", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AssetReportExpiredItemsComponent_button_4_Template_button_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"](ctx_r1.download());
    });
...
function AssetReportExpiredItemsComponent_ng_template_6_span_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](1, "No Date");
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
  }
}
function AssetReportExpiredItemsComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](1, AssetReportExpiredItemsComponent_ng_template_6_span_1_Template, 2, 0, "span", 8);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", !data_r3);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"](" ", data_r3 ? _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind2"](3, 2, data_r3 * 1000, "mediumDate") : "", " ");
  }
}
class AssetReportExpiredItemsComponent {
  constructor(_state) {
    var _this = this;
    this._state = _state;
    this.print = false;
    ...
    this.download = /*#__PURE__*/(0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const data = yield _this.expired_items.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.take)(1)).toPromise();
      (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.downloadFile)('report-assets-expired-items.csv', (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.jsonToCsv)(data));
    });
  }
  static #_ = this.ɵfac = function AssetReportExpiredItemsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || AssetReportExpiredItemsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_assets_report_service__WEBPACK_IMPORTED_MODULE_2__.AssetsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    type: AssetReportExpiredItemsComponent,
    selectors: [["asset-report-expired-items"]],
    inputs: {
      print: "print"
    },
    decls: 8,
    vars: 19,
    consts: [["date_template", ""], [1, "m-4", "rounded", "bg-base-100", "border", "border-base-200", "overflow-hidden"], [1, "border-b", "border-base-200", "px-4", "py-2", "flex", "items-center"], [1, "font-bold", "text-xl", "flex-1"], ["icon", "", "matRipple", "", 3, "click", 4, "ngIf"], ["empty_message", "No purchase orders expired for selected period", 1, "w-full", "block", "text-sm", 3, "data", "columns", "sortable", "page_size"], ["icon", "", "matRipple", "", 3, "click"], [1, "p-4"], ["class", "opacity-30", 4, "ngIf"], [1, "opacity-30"]],
    template: function AssetReportExpiredItemsComponent_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 1)(1, "div", 2)(2, "h3", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](3, " Expired Assets Purchase Orders ");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](4, AssetReportExpiredItemsComponent_button_4_Template, 3, 0, "button", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](5, "simple-table", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](6, AssetReportExpiredItemsComponent_ng_template_6_Template, 4, 5, "ng-template", null, 0, _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplateRefExtractor"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
      }
      if (rf & 2) {
        const date_template_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵreference"](7);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", !ctx.print);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("data", ctx.expired_items)("columns", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction5"](13, _c5, _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](5, _c0), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](6, _c1), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction1"](7, _c2, date_template_r4), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction1"](9, _c3, date_template_r4), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction1"](11, _c4, date_template_r4)))("sortable", true)("page_size", ctx.print ? 0 : 10);
      }
    },
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ 56441);
...
class AssetReportOverallComponent {
  constructor(_state) {
    ...
    }) => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.differenceInBusinessDays)((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.endOfDay)(end || Date.now()).valueOf() + 1, (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.startOfDay)(start || Date.now())) || 1));
  ...
  static #_ = this.ɵfac = function AssetReportOverallComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || AssetReportOverallComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_assets_report_service__WEBPACK_IMPORTED_MODULE_0__.AssetsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
...
class AssetReportProductUsageComponent {
  ...
  static #_ = this.ɵfac = function AssetReportProductUsageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || AssetReportProductUsageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_assets_report_service__WEBPACK_IMPORTED_MODULE_2__.AssetsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
...
class AssetReportUsersComponent {
  constructor(_state) {
    ...
    this.users = this._state.stats$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(({
      ...
      const data = (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.unique)(events, 'host').map(user_event => {
        const host_bookings = bookings.filter(b => b.booked_by_email === user_event.host);
        const booked_assets = (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.unique)(host_bookings.map(_ => _.asset_ids).flat());
        const booked_products = (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.unique)(booked_assets.map(i => products.find(p => p.assets.find(_ => _.id === i))?.name));
        return {
  ...
  static #_ = this.ɵfac = function AssetReportUsersComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || AssetReportUsersComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_assets_report_service__WEBPACK_IMPORTED_MODULE_2__.AssetsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    ...
    template: function AssetReportUsersComponent_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 0)(1, "div", 1)(2, "h3", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](3, "Asset Requestees");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
...
/* harmony import */ var _asset_report_expired_items_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./asset-report-expired-items.component */ 86890);
...
function AssetsReportComponent_ng_container_10_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelement"](1, "asset-report-overall")(2, "asset-report-daily-usage", 10)(3, "asset-report-product-usage", 10)(4, "asset-report-users", 10)(5, "asset-report-expired-items", 10);
...
function AssetsReportComponent_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtemplate"](1, AssetsReportComponent_ng_container_10_ng_container_1_Template, 6, 4, "ng-container", 9);
...
class AssetsReportComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_0__.AsyncHandler {
  ...
  constructor(_state, _settings, _route) {
    super();
    this._state = _state;
    this._settings = _settings;
    this._route = _route;
    this.printing = false;
    this.total_count = this._state.stats$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(i => i.total_booked_items || 0));
  ...
  ngOnInit() {
    this.subscription('route.query', this._route.queryParamMap.subscribe(params => {
      ...
      if (params.has('zones') || params.has('zone_ids')) {
        ...
        if (zones.length) this._state.setOptions({
          zones
        });
      }
    }));
  }
  static #_ = this.ɵfac = function AssetsReportComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || AssetsReportComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdirectiveInject"](_assets_report_service__WEBPACK_IMPORTED_MODULE_1__.AssetsReportService), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_0__.SettingsService), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_10__.ActivatedRoute));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
    ...
    template: function AssetsReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵpipe"](2, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("printing", function AssetsReportComponent_Template_reports_options_printing_0_listener($event) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtext"](9, "Assets Report");
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementEnd"]()()();
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtemplate"](10, AssetsReportComponent_ng_container_10_Template, 3, 4, "ng-container", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵpipe"](11, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtemplate"](12, AssetsReportComponent_ng_template_12_Template, 4, 1, "ng-template", null, 0, _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtemplateRefExtractor"])(14, AssetsReportComponent_ng_template_14_Template, 3, 0, "ng-template", null, 1, _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtemplateRefExtractor"]);
      }
      if (rf & 2) {
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_11__.NgIf, _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_12__.MatProgressSpinner, _reports_options_component__WEBPACK_IMPORTED_MODULE_2__.ReportsOptionsComponent, _asset_report_overall_component__WEBPACK_IMPORTED_MODULE_3__.AssetReportOverallComponent, _asset_report_daily_usage_component__WEBPACK_IMPORTED_MODULE_4__.AssetReportDailyUsageComponent, _asset_report_product_usage_component__WEBPACK_IMPORTED_MODULE_5__.AssetReportProductUsageComponent, _asset_report_users_component__WEBPACK_IMPORTED_MODULE_6__.AssetReportUsersComponent, _asset_report_expired_items_component__WEBPACK_IMPORTED_MODULE_7__.AssetReportExpiredItemsComponent, _angular_common__WEBPACK_IMPORTED_MODULE_11__.AsyncPipe],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AssetsReportService: () => (/* binding */ AssetsReportService)
/* harmony export */ });
/* harmony import */ var _home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! date-fns */ 31257);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! date-fns */ 28797);
...
class AssetsReportService {
  _processBookingStats(booking_list, products) {
    ...
    const unique_events = (0,_placeos_common__WEBPACK_IMPORTED_MODULE_3__.unique)(booking_list.map(_ => _.linked_event || _.linked_bookings[0]).filter(_ => _), 'id').map(i => new _placeos_events__WEBPACK_IMPORTED_MODULE_4__.CalendarEvent(i));
    return {
  ...
  constructor(_org, _settings) {
    ...
    this.products$ = this._generate.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.filter)(gen => gen > 0), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(() => this._options.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.take)(1))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.debounceTime)(300), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(options => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this._loading.next(false)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.shareReplay)(1));
    this.bookings$ = this._generate.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.filter)(gen => gen > 0), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(() => this._options.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.take)(1))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.debounceTime)(300), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(options => {
      this._loading.next(true);
      const {
        start,
        end,
      ...
      return (0,_placeos_bookings__WEBPACK_IMPORTED_MODULE_2__.queryBookings)({
        period_start: (0,date_fns__WEBPACK_IMPORTED_MODULE_13__.getUnixTime)((0,date_fns__WEBPACK_IMPORTED_MODULE_14__.startOfDay)(start || Date.now())),
        period_end: (0,date_fns__WEBPACK_IMPORTED_MODULE_13__.getUnixTime)((0,date_fns__WEBPACK_IMPORTED_MODULE_15__.endOfDay)(end || start || Date.now())),
        type: 'asset-request',
    ...
    this.stats$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_16__.combineLatest)([this.products$, this.bookings$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(([products, bookings]) => {
      const data = this._processBookingStats(bookings, products);
      return data;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.shareReplay)(1));
    this.daily_stats$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_16__.combineLatest)([this._options, this.products$, this.bookings$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(([options, products, bookings]) => {
      const stats = {};
      let count = 0;
      let start = (0,date_fns__WEBPACK_IMPORTED_MODULE_14__.startOfDay)(options.start);
      const end = (0,date_fns__WEBPACK_IMPORTED_MODULE_15__.endOfDay)(options.end);
      while ((0,date_fns__WEBPACK_IMPORTED_MODULE_18__.isBefore)(start, end) && count < 365) {
        const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_19__.format)(start, 'yyyy-MM-dd');
        stats[date] = this._processBookingStats(bookings.filter(_ => (0,date_fns__WEBPACK_IMPORTED_MODULE_20__.isSameDay)(_.date, start)), products);
        start = (0,date_fns__WEBPACK_IMPORTED_MODULE_21__.addDays)(start, 1);
        count++;
      }
      return stats;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.shareReplay)(1));
    this.expired_items$ = this._generate.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.switchMap)(() => {
      this._loading.next(true);
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_16__.combineLatest)([(0,_placeos_assets__WEBPACK_IMPORTED_MODULE_1__.queryAssetPurchaseOrders)({}), this._options]);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.map)(([purchase_orders, options]) => {
      return purchase_orders.filter(order => {
        order.expected_service_end_date < (0,date_fns__WEBPACK_IMPORTED_MODULE_13__.getUnixTime)(options.start || Date.now());
      });
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.tap)(() => this._loading.next(false)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.shareReplay)(1));
  }
  generateReport() {
  ...
  downloadReport() {
    ...
    return (0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const bookings = yield _this.bookings$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.take)(1)).toPromise();
      if (!bookings?.length) return;
      const is_same = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__.isSameDay)(options.start, options.end);
      const date = is_same ? (0,date_fns__WEBPACK_IMPORTED_MODULE_19__.format)(options.start, 'yyyy-MM-dd') : `${(0,date_fns__WEBPACK_IMPORTED_MODULE_19__.format)(options.start, 'yyyy-MM-dd')}-${(0,date_fns__WEBPACK_IMPORTED_MODULE_19__.format)(options.end, 'yyyy-MM-dd')}`;
  ...
  static #_ = this.ɵfac = function AssetsReportService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || AssetsReportService)(_angular_core__WEBPACK_IMPORTED_MODULE_22__["ɵɵinject"](_placeos_organisation__WEBPACK_IMPORTED_MODULE_5__.OrganisationService), _angular_core__WEBPACK_IMPORTED_MODULE_22__["ɵɵinject"](_placeos_common__WEBPACK_IMPORTED_MODULE_3__.SettingsService));
  };
...
class CateringReportOverallComponent {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    styles: ["[_nghost-%COMP%] {\n                display: flex;\n                flex-wrap: wrap;\n                align-items: center;\n                justify-content: center;\n                padding: 0.5rem;\n                max-width: 64rem;\n                margin: 0 auto;\n            }\n\n            [item][_ngcontent-%COMP%] {\n                border: 1px solid var(--b2);\n                border-radius: 0.5rem;\n                padding: 1rem;\n                margin: 0.5rem;\n                height: 6rem;\n                width: 12rem;\n                min-width: 7rem;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class CateringReportStateService {
  constructor(_reports) {
    ...
    this.catering_orders = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.combineLatest)([this._reports.options, this._reports.bookings]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(([{
      ...
      const start_date = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.startOfDay)(start).valueOf();
      const end_date = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.endOfDay)(end).valueOf();
  ...
  static #_ = this.ɵfac = function CateringReportStateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || CateringReportStateService)(_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵinject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_3__.ReportsStateService));
  };
...
function CateringReportComponent_ng_container_10_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringReportComponent_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](1, CateringReportComponent_ng_container_10_ng_container_1_Template, 4, 2, "ng-container", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](2, "async");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    const empty_state_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵreference"](15);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"]();
...
class CateringReportComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_1__.AsyncHandler {
  get logo() {
    return this._settings.get('app.logo_light') || {};
  }
  constructor(_state, _settings, _route) {
  ...
  static #_ = this.ɵfac = function CateringReportComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || CateringReportComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_0__.ReportsStateService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_1__.SettingsService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__.ActivatedRoute));
  };
    ...
    template: function CateringReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("printing", function CateringReportComponent_Template_reports_options_printing_0_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx.downloadReport());
        })("generate", function CateringReportComponent_Template_reports_options_generate_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx.generateReport());
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](3, "div", 3)(4, "div", 4)(5, "div", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](6, "img", 6)(7, "div", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](8, "h2", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](9, "Catering Report");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()()();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](10, CateringReportComponent_ng_container_10_Template, 3, 4, "ng-container", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](11, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](12, CateringReportComponent_ng_template_12_Template, 4, 1, "ng-template", null, 0, _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplateRefExtractor"])(14, CateringReportComponent_ng_template_14_Template, 3, 0, "ng-template", null, 1, _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplateRefExtractor"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
      }
      if (rf & 2) {
        const load_state_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵreference"](13);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("loading", _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipeBind1"](1, 5, ctx.loading))("has_data", _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipeBind1"](2, 7, ctx.total_count));
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("ngIf", !_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipeBind1"](11, 9, ctx.loading))("ngIfElse", load_state_r4);
      }
    },
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.NgIf, _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_10__.MatProgressSpinner, _reports_options_component__WEBPACK_IMPORTED_MODULE_2__.ReportsOptionsComponent, _catering_report_overall_component__WEBPACK_IMPORTED_MODULE_3__.CateringReportOverallComponent, _catering_report_orders_component__WEBPACK_IMPORTED_MODULE_4__.CateringReportOrdersComponent, _catering_report_items_component__WEBPACK_IMPORTED_MODULE_5__.CateringReportItemsComponent, _angular_common__WEBPACK_IMPORTED_MODULE_9__.AsyncPipe],
    styles: ["[_nghost-%COMP%] {\n                display: flex;\n                flex-direction: column;\n                height: 100%;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
/* harmony import */ var _angular_material_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/core */ 74646);
/* harmony import */ var _libs_form_fields_src_lib_date_range_field_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../libs/form-fields/src/lib/date-range-field.component */ 5472);
...
class ContactTracingOptionsComponent {
  ...
  constructor(_state, _settings) {
    this._state = _state;
    this._settings = _settings;
    this.printing = new _angular_core__WEBPACK_IMPORTED_MODULE_5__.EventEmitter();
    this.download = new _angular_core__WEBPACK_IMPORTED_MODULE_5__.EventEmitter();
  ...
  static #_ = this.ɵfac = function ContactTracingOptionsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ContactTracingOptionsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_contact_tracing_state_service__WEBPACK_IMPORTED_MODULE_0__.ContactTracingStateService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_1__.SettingsService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    ...
    decls: 19,
    vars: 16,
    consts: [["startDate", ""], ["endDate", ""], [1, "flex", "items-center", "space-x-2", "w-full", "p-4", "bg-base-100", "shadow"], [3, "week_start"], [3, "ngModelChange", "ngModel"], ["placeholder", "Search for user to trace...", 1, "w-64", 3, "ngModelChange", "ngModel"], [1, "flex-1"], ["icon", "", "matRipple", "", "matTooltip", "Download Report", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "disabled"], ["icon", "", "matRipple", "", "matTooltip", "Print Report", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "disabled"]],
    template: function ContactTracingOptionsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵgetCurrentView"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 2)(1, "date-range-field", 3)(2, "input", 4, 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipe"](4, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngModelChange", function ContactTracingOptionsComponent_Template_input_ngModelChange_2_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"]($event ? ctx.setOptions({
            start: $event,
            user: null
          }) : "");
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](5, "input", 4, 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipe"](7, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngModelChange", function ContactTracingOptionsComponent_Template_input_ngModelChange_5_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"]($event ? ctx.setOptions({
            end: $event,
            user: null
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](8, "a-user-search-field", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipe"](9, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngModelChange", function ContactTracingOptionsComponent_Template_a_user_search_field_ngModelChange_8_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"](ctx.setOptions({
            user: $event
          }));
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipe"](12, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ContactTracingOptionsComponent_Template_button_click_11_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"](ctx.download.emit());
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](13, "app-icon");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function ContactTracingOptionsComponent_Template_button_click_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"](ctx.print());
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](17, "app-icon");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](18, "print");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]()()();
      }
      if (rf & 2) {
        let tmp_3_0;
        ...
        let tmp_7_0;
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("week_start", ctx.week_start);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngModel", (tmp_3_0 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind1"](4, 6, ctx.options)) == null ? null : tmp_3_0.start);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngModel", (tmp_4_0 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind1"](7, 8, ctx.options)) == null ? null : tmp_4_0.end);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngModel", (tmp_5_0 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind1"](9, 10, ctx.options)) == null ? null : tmp_5_0.user);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("disabled", !((tmp_6_0 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind1"](12, 12, ctx.options)) == null ? null : tmp_6_0.user));
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("disabled", !((tmp_7_0 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipeBind1"](16, 14, ctx.options)) == null ? null : tmp_7_0.user));
      }
    },
    dependencies: [_angular_forms__WEBPACK_IMPORTED_MODULE_6__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.NgModel, _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_7__.MatTooltip, _angular_material_core__WEBPACK_IMPORTED_MODULE_8__.MatRipple, _libs_form_fields_src_lib_date_range_field_component__WEBPACK_IMPORTED_MODULE_2__.DateRangeFieldComponent, _libs_form_fields_src_lib_user_search_field_component__WEBPACK_IMPORTED_MODULE_3__.UserSearchFieldComponent, _libs_components_src_lib_icon_component__WEBPACK_IMPORTED_MODULE_4__.IconComponent, _angular_common__WEBPACK_IMPORTED_MODULE_9__.AsyncPipe],
    styles: ["mat-form-field[_ngcontent-%COMP%] {\n                height: 3.25rem;\n            }\n\n            button[icon][disabled][_ngcontent-%COMP%] {\n                background-color: var(--n) !important;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class ContactTracingReportComponent {
  ...
  constructor(_state, _settings) {
    ...
    this.setOptions = _ => this._state.setOptions(_);
    this.downloadReport = () => this._state.downloadReport();
    this.formatDuration = d => (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.formatDuration)({
      hours: Math.floor(d / 60),
      minutes: d % 60
    });
  }
  static #_ = this.ɵfac = function ContactTracingReportComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ContactTracingReportComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_contact_tracing_state_service__WEBPACK_IMPORTED_MODULE_0__.ContactTracingStateService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_1__.SettingsService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    ...
    styles: ["[_nghost-%COMP%] {\n                width: 100%;\n                height: 100%;\n                display: flex;\n                flex-direction: column;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class ContactTracingStateService {
  ...
  constructor(_org, _reports, _settings) {
    ...
    this._generate = new rxjs__WEBPACK_IMPORTED_MODULE_6__.BehaviorSubject(0);
    this._options = new rxjs__WEBPACK_IMPORTED_MODULE_6__.BehaviorSubject({
      start: (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.startOfDay)(Date.now()),
      end: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__.endOfDay)(Date.now())
    });
    this.events = (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.combineLatest)([this._options, this._generate]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.distinctUntilChanged)((a, b) => a[1] === b[1]), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.filter)(([_, gen]) => !!gen), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.switchMap)(([{
      ...
      return this.system_id && mod ? mod.execute('close_contacts', [user.email, user.username, (0,date_fns__WEBPACK_IMPORTED_MODULE_14__.getUnixTime)(start), (0,date_fns__WEBPACK_IMPORTED_MODULE_14__.getUnixTime)(end)]).catch(err => {
  ...
  downloadReport() {
    ...
    return (0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const processed_events = yield Promise.all(events.map( /*#__PURE__*/function () {
        var _ref = (0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (_) {
          return {
            ...
            Date: (0,date_fns__WEBPACK_IMPORTED_MODULE_20__.format)(_.date, 'dd MMM yyyy, ' + _this.time_format),
            'User Name': _.user,
      ...
      (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.downloadFile)(`report+contact-tracing+${(0,date_fns__WEBPACK_IMPORTED_MODULE_20__.format)(start, 'yyyy-MM-dd')}+${(0,date_fns__WEBPACK_IMPORTED_MODULE_20__.format)(end, 'yyyy-MM-dd')}.csv`, (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.jsonToCsv)(processed_events));
    })();
  }
  static #_ = this.ɵfac = function ContactTracingStateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ContactTracingStateService)(_angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵinject"](_placeos_organisation__WEBPACK_IMPORTED_MODULE_2__.OrganisationService), _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵinject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_4__.ReportsStateService), _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵinject"](_placeos_common__WEBPACK_IMPORTED_MODULE_1__.SettingsService));
  };
...
class GetUserPipe {
  ...
  static #_ = this.ɵfac = function GetUserPipe_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || GetUserPipe)();
  };
...
class CustomReportComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_0__.AsyncHandler {
  ...
  static #_ = this.ɵfac = function CustomReportComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || CustomReportComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_0__.SettingsService), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    styles: ["[_nghost-%COMP%] {\n                height: 100%;\n                width: 100%;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class ReportDesksChartsComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_2__.AsyncHandler {
  ...
  updateDailyChart(list) {
    const data = {
      labels: list.map(_ => (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.format)(_.date, 'dd MMM')),
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
    ...
    styles: ["[_nghost-%COMP%] {\n                display: block;\n            }\n\n            .is-print[_ngcontent-%COMP%]   .ct-chart[_ngcontent-%COMP%] {\n                width: 8cm !important;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class ReportDesksLevelListComponent {
  constructor(_state, _org, _settings) {
    ...
    this.level_list = (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.combineLatest)([this._state.options, this._state.stats, this._state.counts]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.map)(([options, stats, counts]) => {
      ...
      const duration = (0,date_fns__WEBPACK_IMPORTED_MODULE_9__.differenceInDays)(end, start) || 1;
      if (!zones.length) {
        zones = this._settings.get('app.use_region') ? this._org.levelsForRegion().map(_ => _.id) : this._org.levelsForBuilding().map(_ => _.id);
      }
      const levels = [];
  ...
  static #_ = this.ɵfac = function ReportDesksLevelListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportDesksLevelListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_3__.ReportsStateService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_organisation__WEBPACK_IMPORTED_MODULE_2__.OrganisationService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_1__.SettingsService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
...
class ReportDesksOverallListComponent {
  constructor(_state) {
    ...
    this.download = /*#__PURE__*/(0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      data = data.map(d => ({
        ...d,
        date: (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.format)(d.date, 'MMMM d, y(EEE)')
      }));
  ...
  static #_ = this.ɵfac = function ReportDesksOverallListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportDesksOverallListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_2__.ReportsStateService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
...
function ReportDesksComponent_ng_container_10_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerStart"](0);
...
function ReportDesksComponent_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](1, ReportDesksComponent_ng_container_10_ng_container_1_Template, 17, 9, "ng-container", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](2, "async");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
class ReportDesksComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_1__.AsyncHandler {
  get logo() {
    return this._settings.get('app.logo_light') || {};
  }
  constructor(_state, _settings, _route) {
  ...
  static #_ = this.ɵfac = function ReportDesksComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportDesksComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_0__.ReportsStateService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_1__.SettingsService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__.ActivatedRoute));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
    ...
    template: function ReportDesksComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](6, "img", 6)(7, "div", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](8, "h2", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](9, "Desks Report");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()()();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](10, ReportDesksComponent_ng_container_10_Template, 3, 4, "ng-container", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](11, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](12, ReportDesksComponent_ng_template_12_Template, 4, 1, "ng-template", null, 0, _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplateRefExtractor"])(14, ReportDesksComponent_ng_template_14_Template, 3, 0, "ng-template", null, 1, _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplateRefExtractor"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
      }
      if (rf & 2) {
        const load_state_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵreference"](13);
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.NgIf, _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_10__.MatProgressSpinner, _reports_options_component__WEBPACK_IMPORTED_MODULE_2__.ReportsOptionsComponent, _report_desks_overall_list_component__WEBPACK_IMPORTED_MODULE_3__.ReportDesksOverallListComponent, _report_desks_level_list_component__WEBPACK_IMPORTED_MODULE_4__.ReportDesksLevelListComponent, _report_desks_charts_component__WEBPACK_IMPORTED_MODULE_5__.ReportDesksChartsComponent, _angular_common__WEBPACK_IMPORTED_MODULE_9__.AsyncPipe],
    styles: ["[_nghost-%COMP%] {\n                display: flex;\n                flex-direction: column;\n                height: 100%;\n            }\n\n            h3[_ngcontent-%COMP%] {\n                font-weight: 500;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class NewReportsComponent {
  ...
  static #_ = this.ɵfac = function NewReportsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || NewReportsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__.Router));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
    ...
    styles: ["[_nghost-%COMP%] {\n                display: flex;\n                flex-direction: column;\n                height: 100%;\n                width: 100%;\n                background-color: var(--b1);\n            }\n\n            main[_ngcontent-%COMP%]    > *[_ngcontent-%COMP%]:not(router-outlet) {\n                display: flex;\n                flex-direction: column;\n                width: 100%;\n                height: 100%;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class ReportsMenuComponent {
  ...
  static #_ = this.ɵfac = function ReportsMenuComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportsMenuComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_0__.SettingsService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    styles: ["[_nghost-%COMP%] {\n                display: flex;\n                flex-direction: row !important;\n                align-items: center;\n                justify-content: center;\n                background: inherit;\n            }\n\n            .grid[_ngcontent-%COMP%] {\n                display: grid;\n                grid-template-columns: repeat(auto-fill, minmax(16rem, 1fr));\n                \n\n                \n\n                gap: 1rem;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
/* harmony import */ var _libs_form_fields_src_lib_date_range_field_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../libs/form-fields/src/lib/date-range-field.component */ 5472);
/* harmony import */ var _libs_components_src_lib_icon_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../libs/components/src/lib/icon.component */ 69434);
/* harmony import */ var _libs_components_src_lib_building_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../libs/components/src/lib/building.pipe */ 56062);
...
function ReportsOptionsComponent_mat_option_3_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](2, "building");
  ...
  if (rf & 2) {
    let tmp_5_0;
    const level_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtextInterpolate1"](" ", (tmp_5_0 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipeBind1"](2, 1, level_r2.parent_id)) == null ? null : tmp_5_0.display_name, " ");
  }
}
function ReportsOptionsComponent_mat_option_3_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "mat-option", 14)(1, "div", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](2, ReportsOptionsComponent_mat_option_3_div_2_Template, 5, 3, "div", 16);
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("ngIf", ctx_r2.use_region);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtextInterpolate"](level_r2.display_name || level_r2.name);
  }
}
function ReportsOptionsComponent_mat_spinner_11_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](0, "mat-spinner", 19);
  }
  if (rf & 2) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("diameter", 32);
  }
...
function ReportsOptionsComponent_p_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](1, "Generate Report");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
  }
}
class ReportsOptionsComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_1__.AsyncHandler {
  ...
  constructor(_org, _settings, _route, _router) {
    ...
    this.loading = false;
    this.has_data = false;
    this.printing = new _angular_core__WEBPACK_IMPORTED_MODULE_6__.EventEmitter();
    this.generate = new _angular_core__WEBPACK_IMPORTED_MODULE_6__.EventEmitter();
    this.download = new _angular_core__WEBPACK_IMPORTED_MODULE_6__.EventEmitter();
    /** List of selected levels */
    this.zones = [];
    this.start = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.startOfDay)(Date.now()).getTime();
    this.end = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__.endOfDay)(Date.now()).getTime();
    this.types = [{
      id: 'internal',
      name: 'Internal'
    }, {
    ...
    this.setEndDate = date => {
      ...
      this._router.navigate([], {
        relativeTo: this._route,
        queryParams: {
          end: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__.endOfDay)(date).valueOf()
        },
        queryParamsHandling: 'merge'
      });
    };
  ...
  ngOnInit() {
    ...
    return (0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.subscription('route.query', _this._route.queryParamMap.subscribe(params => {
        ...
        if (params.has('start')) _this.start = +params.get('start');
        if (params.has('end')) _this.end = +params.get('end');
      }));
    })();
  }
  print() {
  ...
  static #_ = this.ɵfac = function ReportsOptionsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportsOptionsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_organisation__WEBPACK_IMPORTED_MODULE_2__.OrganisationService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_1__.SettingsService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_12__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_12__.Router));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
    ...
    decls: 20,
    vars: 12,
    consts: [["startDate", ""], ["endDate", ""], [1, "bg-base-100", "h-20", "w-full", "flex", "items-center", "space-x-2", "p-4", "z-20", "border-b", "border-base-200", "print:hidden"], ["appearance", "outline", 1, "w-60", "no-subscript"], ["placeholder", "All Levels", "multiple", "", 3, "ngModelChange", "ngModel"], [3, "value", 4, "ngFor", "ngForOf"], [3, "week_start"], [3, "ngModelChange", "ngModel"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [3, "diameter", 4, "ngIf"], [4, "ngIf"], [1, "flex-1"], ["icon", "", "matRipple", "", "matTooltip", "Download Report Data", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "disabled"], ["icon", "", "matRipple", "", "matTooltip", "Print Report", 1, "h-12", "w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "disabled"], [3, "value"], [1, "flex", "flex-col-reverse"], ["class", "text-xs opacity-30", 4, "ngIf"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "diameter"]],
    template: function ReportsOptionsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵgetCurrentView"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "div", 2)(1, "mat-form-field", 3)(2, "mat-select", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtwoWayListener"]("ngModelChange", function ReportsOptionsComponent_Template_mat_select_ngModelChange_2_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtwoWayBindingSet"](ctx.zones, $event) || (ctx.zones = $event);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"]($event);
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function ReportsOptionsComponent_Template_mat_select_ngModelChange_2_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx.setZones($event));
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](3, ReportsOptionsComponent_mat_option_3_Template, 5, 3, "mat-option", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](4, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](5, "date-range-field", 6)(6, "input", 7, 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function ReportsOptionsComponent_Template_input_ngModelChange_6_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"]($event ? ctx.setStartDate($event) : "");
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](8, "input", 7, 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("ngModelChange", function ReportsOptionsComponent_Template_input_ngModelChange_8_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"]($event ? ctx.setEndDate($event) : "");
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](10, "button", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function ReportsOptionsComponent_Template_button_click_10_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx.generate.emit());
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](11, ReportsOptionsComponent_mat_spinner_11_Template, 1, 1, "mat-spinner", 9)(12, ReportsOptionsComponent_p_12_Template, 2, 0, "p", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function ReportsOptionsComponent_Template_button_click_14_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx.download.emit());
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function ReportsOptionsComponent_Template_button_click_17_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx.print());
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](18, "app-icon");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](19, "print");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()()();
      }
      if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("ngForOf", _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipeBind1"](4, 10, ctx.levels));
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("week_start", ctx.week_start);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("ngModel", ctx.start);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("ngModel", ctx.end);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("ngIf", !ctx.loading);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("disabled", !ctx.has_data);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("disabled", !ctx.has_data);
      }
    },
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_13__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_13__.NgIf, _angular_forms__WEBPACK_IMPORTED_MODULE_14__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_14__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_14__.NgModel, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_15__.MatFormField, _angular_material_select__WEBPACK_IMPORTED_MODULE_16__.MatSelect, _angular_material_core__WEBPACK_IMPORTED_MODULE_17__.MatOption, _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_18__.MatTooltip, _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_19__.MatProgressSpinner, _angular_material_core__WEBPACK_IMPORTED_MODULE_17__.MatRipple, _libs_form_fields_src_lib_date_range_field_component__WEBPACK_IMPORTED_MODULE_3__.DateRangeFieldComponent, _libs_components_src_lib_icon_component__WEBPACK_IMPORTED_MODULE_4__.IconComponent, _angular_common__WEBPACK_IMPORTED_MODULE_13__.AsyncPipe, _libs_components_src_lib_building_pipe__WEBPACK_IMPORTED_MODULE_5__.BuildingPipe],
    styles: ["button[_ngcontent-%COMP%] {\n                min-width: 0;\n                padding: 0 0.85rem;\n            }\n\n            button[icon][disabled][_ngcontent-%COMP%] {\n                background-color: var(--n) !important;\n            }\n\n            mat-slide-toggle[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n                width: 5.5em;\n                white-space: initial;\n                line-height: 1.2em;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! date-fns */ 7729);
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! date-fns */ 55882);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs */ 33119);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs */ 90521);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! rxjs */ 68824);
...
class ReportsStateService {
  get _ignore_days() {
    ...
    return day_list?.map(_ => typeof _ === 'string' ? _?.toLowerCase() : (0,date_fns__WEBPACK_IMPORTED_MODULE_9__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_10__.setDay)(new Date(), _), 'eeee')?.toLowerCase()).filter(_ => !!_);
  }
  get duration() {
    const opts = this._options.getValue();
    let start = (0,date_fns__WEBPACK_IMPORTED_MODULE_11__.startOfDay)(opts.start);
    const end = (0,date_fns__WEBPACK_IMPORTED_MODULE_12__.endOfDay)(opts.end).valueOf();
    let count = 1;
    while (start.valueOf() < end) {
      if (!this._ignore_days.includes(DAYS_OF_WEEK_INDEX[start.getDay()])) {
        count++;
      }
      start = (0,date_fns__WEBPACK_IMPORTED_MODULE_13__.addDays)(start, 1);
    }
  ...
  constructor(_org, _settings) {
    ...
    this._generate = new rxjs__WEBPACK_IMPORTED_MODULE_14__.Subject();
    this._loading = new rxjs__WEBPACK_IMPORTED_MODULE_15__.BehaviorSubject('');
    this._active_bookings = new rxjs__WEBPACK_IMPORTED_MODULE_15__.BehaviorSubject([]);
    this._options = new rxjs__WEBPACK_IMPORTED_MODULE_15__.BehaviorSubject({
      start: new Date(),
      end: new Date(),
      zones: []
    });
    this._bookings_list = this._generate.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.debounceTime)(500), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.switchMap)(_ => {
      const options = this._options.getValue();
      this._loading.next('Loading report details...');
      if (!options?.type && !options?.zones?.length) return (0,rxjs__WEBPACK_IMPORTED_MODULE_18__.of)([]);
      const start = (0,date_fns__WEBPACK_IMPORTED_MODULE_11__.startOfDay)(options.start || Date.now());
      const end = (0,date_fns__WEBPACK_IMPORTED_MODULE_12__.endOfDay)(options.end || start);
    ...
    this.spaces = this._options.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.switchMap)(({
      zones
    }) => {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_23__.forkJoin)(zones.map(id => (0,_placeos_spaces__WEBPACK_IMPORTED_MODULE_8__.requestSpacesForZone)(id).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_20__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_18__.of)([])))));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_21__.map)(l => (0,_placeos_common__WEBPACK_IMPORTED_MODULE_3__.flatten)(l)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.shareReplay)(1));
    this.counts = this._options.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.debounceTime)(500), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_17__.switchMap)(filters => {
      let zones = (filters.zones || []).filter(z => z !== -1 && z !== 'All');
      if (!zones.length) {
        zones = this._settings.get('app.use_region') ? this._org.levelsForRegion().map(_ => _.id) : this._org.levelsForBuilding().map(_ => _.id);
      }
      if (filters.type === 'events') {
        return this.spaces.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_21__.map)(_ => zones.map(z => [z, _.filter(s => s.zones.includes(z)).length])));
      }
      return Promise.all(zones.map(z => (0,_placeos_ts_client__WEBPACK_IMPORTED_MODULE_1__.showMetadata)(z, 'desks').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_20__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_18__.of)({
        details: []
    ...
    this.day_list = (0,rxjs__WEBPACK_IMPORTED_MODULE_24__.combineLatest)([this.options, this.stats]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_21__.map)(([options, stats]) => {
      ...
      let date = (0,date_fns__WEBPACK_IMPORTED_MODULE_11__.startOfDay)(start);
      const end = (0,date_fns__WEBPACK_IMPORTED_MODULE_12__.endOfDay)(options.end || date);
      const dates = [];
      while ((0,date_fns__WEBPACK_IMPORTED_MODULE_25__.isBefore)(date, end)) {
        if (this._ignore_days.includes(DAYS_OF_WEEK_INDEX[date.getDay()])) {
          date = (0,date_fns__WEBPACK_IMPORTED_MODULE_13__.addDays)(date, 1);
          continue;
        }
        const s = (0,date_fns__WEBPACK_IMPORTED_MODULE_11__.startOfDay)(date).valueOf();
        const e = (0,date_fns__WEBPACK_IMPORTED_MODULE_12__.endOfDay)(s).valueOf();
  ...
  downloadReport() {
    ...
    (0,_placeos_common__WEBPACK_IMPORTED_MODULE_3__.downloadFile)(`report+${options.type}+${(0,date_fns__WEBPACK_IMPORTED_MODULE_9__.format)(options.start, 'yyyy-MM-dd')}+${(0,date_fns__WEBPACK_IMPORTED_MODULE_9__.format)(options.end, 'yyyy-MM-dd')}.tsv`, (0,_placeos_common__WEBPACK_IMPORTED_MODULE_3__.jsonToCsv)(bookings.map(bkn => {
      const details = bkn.toJSON();
      delete details.zones;
      delete details.server_names;
      delete details.extension_data;
  ...
  static #_ = this.ɵfac = function ReportsStateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportsStateService)(_angular_core__WEBPACK_IMPORTED_MODULE_26__["ɵɵinject"](_placeos_organisation__WEBPACK_IMPORTED_MODULE_5__.OrganisationService), _angular_core__WEBPACK_IMPORTED_MODULE_26__["ɵɵinject"](_placeos_common__WEBPACK_IMPORTED_MODULE_3__.SettingsService));
  };
...
class ReportsComponent {
  ...
  static #_ = this.ɵfac = function ReportsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    styles: ["[_nghost-%COMP%] {\n                display: flex;\n                height: 100%;\n                width: 100%;\n            }\n\n            main[_ngcontent-%COMP%]    > *[_ngcontent-%COMP%]:not(router-outlet) {\n                display: flex;\n                flex-direction: column;\n                width: 100%;\n                height: 100%;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! @angular/router */ 95072);
/* harmony import */ var _ui_ui_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ui/ui.module */ 15412);
/* harmony import */ var _angular_material_paginator__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! @angular/material/paginator */ 24624);
...
/* harmony import */ var _visitors_visitors_report_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./visitors/visitors-report.component */ 9820);
/* harmony import */ var _visitors_visitor_report_overall_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./visitors/visitor-report-overall.component */ 22471);
/* harmony import */ var _visitors_visitor_report_list_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./visitors/visitor-report-list.component */ 83010);
/* harmony import */ var _visitors_visitor_report_daily_usage_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./visitors/visitor-report-daily-usage.component */ 56789);
...
const children = [{
  ...
  path: 'assets',
  component: _assets_assets_report_component__WEBPACK_IMPORTED_MODULE_24__.AssetsReportComponent
}, {
  path: 'visitors',
  component: _visitors_visitors_report_component__WEBPACK_IMPORTED_MODULE_31__.VisitorsReportComponent
}, {
  path: ':id',
...
class ReportSpacesOverallListComponent {
  ...
  static #_ = this.ɵfac = function ReportSpacesOverallListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportSpacesOverallListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_2__.ReportsStateService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
...
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ 88948);
...
class ReportSpacesOverallComponent {
  constructor(_state) {
    ...
    }) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.differenceInBusinessDays)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.endOfDay)(end || Date.now()).valueOf() + 2, (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.startOfDay)(start || Date.now())) || 1));
    this.total_count = this._state.stats.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(i => i.count || 0));
    this.avg_length = this._state.stats.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(i => (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.formatDuration)({
  ...
  static #_ = this.ɵfac = function ReportSpacesOverallComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportSpacesOverallComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_0__.ReportsStateService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
    ...
    styles: ["h3[_ngcontent-%COMP%] {\n                font-weight: 500;\n            }\n\n            p[_ngcontent-%COMP%]:not([simple]) {\n                font-size: 1.75rem;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
class ReportSpacesUserListingComponent {
  ...
  static #_ = this.ɵfac = function ReportSpacesUserListingComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || ReportSpacesUserListingComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_reports_state_service__WEBPACK_IMPORTED_MODULE_2__.ReportsStateService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VisitorReportDailyUsageComponent: () => (/* binding */ VisitorReportDailyUsageComponent)
/* harmony export */ });
/* harmony import */ var _home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var _placeos_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @placeos/common */ 22797);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ 35443);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs/operators */ 33602);
/* harmony import */ var _visitors_report_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./visitors-report.service */ 61300);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/common */ 60316);
/* harmony import */ var _angular_material_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/material/core */ 74646);
/* harmony import */ var _libs_components_src_lib_icon_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../../libs/components/src/lib/icon.component */ 69434);
...
function VisitorReportDailyUsageComponent_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "button", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function VisitorReportDailyUsageComponent_button_4_Template_button_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"](ctx_r1.download());
    });
...
class VisitorReportDailyUsageComponent {
  constructor(_state) {
    var _this = this;
    this._state = _state;
    this.print = false;
    this.daily_stats = this._state.daily_stats$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(days => {
      let list = [];
      for (const date in days) {
        list.push({
          date,
          booking_count: (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.unique)(days[date].bookings, 'asset_id').length,
          host_count: (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.unique)(days[date].bookings, 'user_email').length,
    ...
    this.download = /*#__PURE__*/(0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const data = yield _this.daily_stats.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.take)(1)).toPromise();
      (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.downloadFile)('report-visitors-daily-usage.csv', (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.jsonToCsv)(data));
    });
  }
  static #_ = this.ɵfac = function VisitorReportDailyUsageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || VisitorReportDailyUsageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_visitors_report_service__WEBPACK_IMPORTED_MODULE_2__.VisitorsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    type: VisitorReportDailyUsageComponent,
    selectors: [["visitor-report-daily-usage"]],
    inputs: {
      print: "print"
    },
    decls: 8,
    ...
    template: function VisitorReportDailyUsageComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](5, "simple-table", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](6, VisitorReportDailyUsageComponent_ng_template_6_Template, 3, 4, "ng-template", null, 0, _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplateRefExtractor"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
      }
      if (rf & 2) {
        const date_template_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵreference"](7);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", !ctx.print);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("data", ctx.daily_stats)("columns", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction4"](10, _c4, _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction1"](5, _c0, date_template_r4), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](7, _c1), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](8, _c2), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](9, _c3)))("sortable", true)("page_size", ctx.print ? 0 : 10);
      }
    },
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_8__.NgIf, _angular_material_core__WEBPACK_IMPORTED_MODULE_9__.MatRipple, _libs_components_src_lib_icon_component__WEBPACK_IMPORTED_MODULE_3__.IconComponent, _libs_components_src_lib_simple_table_component__WEBPACK_IMPORTED_MODULE_4__.SimpleTableComponent, _angular_common__WEBPACK_IMPORTED_MODULE_8__.DatePipe]
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VisitorReportListComponent: () => (/* binding */ VisitorReportListComponent)
/* harmony export */ });
/* harmony import */ var _home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var _placeos_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @placeos/common */ 22797);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ 35443);
...
function VisitorReportListComponent_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "button", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function VisitorReportListComponent_button_4_Template_button_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵresetView"](ctx_r1.download());
    });
...
class VisitorReportListComponent {
  constructor(_state) {
    var _this = this;
    this._state = _state;
    this.print = false;
    this.visitor_bookings = this._state.bookings$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(bookings => {
      let list = [];
    ...
    this.download = /*#__PURE__*/(0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const data = yield _this.visitor_bookings.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.take)(1)).toPromise();
      (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.downloadFile)('report-assets-daily-usage.csv', (0,_placeos_common__WEBPACK_IMPORTED_MODULE_1__.jsonToCsv)(data));
    });
  }
  static #_ = this.ɵfac = function VisitorReportListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || VisitorReportListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_visitors_report_service__WEBPACK_IMPORTED_MODULE_2__.VisitorsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    type: VisitorReportListComponent,
    selectors: [["visitor-report-list"]],
    inputs: {
      print: "print"
    },
    decls: 8,
    ...
    template: function VisitorReportListComponent_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 1)(1, "div", 2)(2, "h3", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](3, "Visitor List");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](4, VisitorReportListComponent_button_4_Template, 3, 0, "button", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](5, "simple-table", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](6, VisitorReportListComponent_ng_template_6_Template, 3, 4, "ng-template", null, 0, _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplateRefExtractor"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
      }
      if (rf & 2) {
        const date_template_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵreference"](7);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VisitorReportOverallComponent: () => (/* binding */ VisitorReportOverallComponent)
/* harmony export */ });
/* harmony import */ var _visitors_report_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./visitors-report.service */ 61300);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ 35443);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ 88948);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ 56441);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns */ 33240);
...
class VisitorReportOverallComponent {
  constructor(_state) {
    this._state = _state;
    this.total_count = this._state.bookings$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(i => i.length || 0));
    this.business_days = this._state.options$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(({
      start,
      end
    }) => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.differenceInBusinessDays)((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.endOfDay)(end || Date.now()).valueOf() + 1, (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.startOfDay)(start || Date.now())) || 1));
    this.avg_length = this._state.bookings$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(events => Math.floor(events.reduce((c, i) => c + i.duration, 0) / events.length)));
  }
  static #_ = this.ɵfac = function VisitorReportOverallComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || VisitorReportOverallComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_visitors_report_service__WEBPACK_IMPORTED_MODULE_0__.VisitorsReportService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
    type: VisitorReportOverallComponent,
    selectors: [["visitor-report-overall"]],
    decls: 19,
    vars: 9,
    consts: [[1, "m-4", "p-4", "rounded", "bg-base-100", "border", "border-base-200", "flex", "justify-center", "items-center", "space-x-2"], [1, "flex", "flex-col", "items-center", "flex-1"], [1, "text-sm"], [1, "text-2xl"]],
    template: function VisitorReportOverallComponent_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](0, "div", 0)(1, "div", 1)(2, "h3", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](3, "Business Days");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](13, "div", 1)(14, "h3", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](15, "Avg. Booking Length");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](16, "p", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](17);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpipe"](18, "async");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VisitorsReportComponent: () => (/* binding */ VisitorsReportComponent)
/* harmony export */ });
/* harmony import */ var _placeos_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @placeos/common */ 22797);
/* harmony import */ var _visitors_report_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./visitors-report.service */ 61300);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs/operators */ 35443);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/router */ 95072);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common */ 60316);
/* harmony import */ var _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/material/progress-spinner */ 41134);
/* harmony import */ var _reports_options_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../reports-options.component */ 5956);
/* harmony import */ var _visitor_report_overall_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./visitor-report-overall.component */ 22471);
/* harmony import */ var _visitor_report_daily_usage_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./visitor-report-daily-usage.component */ 56789);
/* harmony import */ var _visitor_report_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./visitor-report-list.component */ 83010);
...
const _c0 = ["visitors-report", ""];
function VisitorsReportComponent_ng_container_10_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](1, "visitor-report-overall")(2, "visitor-report-daily-usage", 10)(3, "visitor-report-list");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"](2);
...
function VisitorsReportComponent_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](1, VisitorsReportComponent_ng_container_10_ng_container_1_Template, 4, 1, "ng-container", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](2, "async");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementContainerEnd"]();
  }
  if (rf & 2) {
...
function VisitorsReportComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](1, "mat-spinner", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](2, "p", 13);
...
class VisitorsReportComponent extends _placeos_common__WEBPACK_IMPORTED_MODULE_0__.AsyncHandler {
  get logo() {
    return this._settings.get('app.logo_light') || {};
  }
  constructor(_state, _settings, _route) {
    ...
    this._route = _route;
    this.printing = false;
    this.total_count = this._state.bookings$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(i => i.length || 0));
    this.loading = this._state.loading$;
    this.downloadReport = () => this._state.downloadReport();
    this.generateReport = () => this._state.generateReport();
  }
  ...
  static #_ = this.ɵfac = function VisitorsReportComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || VisitorsReportComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_visitors_report_service__WEBPACK_IMPORTED_MODULE_1__.VisitorsReportService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_0__.SettingsService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__.ActivatedRoute));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
    type: VisitorsReportComponent,
    selectors: [["", "visitors-report", ""]],
    features: [_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵInheritDefinitionFeature"]],
    attrs: _c0,
    decls: 16,
    vars: 11,
    consts: [["load_state", ""], ["empty_state", ""], [3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "flex-1", "h-1/2", "w-full", "overflow-auto", "print:overflow-visible", "print:h-auto"], [1, "w-full"], [1, "flex", "items-center", "m-4", "p-4", "rounded", "bg-base-200"], [1, "h-12", 3, "src"], [1, "flex-1"], [1, "text-2xl", "font-medium", "px-2"], [4, "ngIf", "ngIfElse"], [3, "print"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8"], [1, "mb-4", 3, "diameter"], [1, "opacity-30"], [1, "h-full", "w-full", "flex", "flex-col", "items-center", "p-8", "screen-only"]],
    template: function VisitorsReportComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵgetCurrentView"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](0, "reports-options", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](1, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](2, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("printing", function VisitorsReportComponent_Template_reports_options_printing_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵrestoreView"](_r1);
          return _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵresetView"](ctx.printing = $event);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelement"](6, "img", 6)(7, "div", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](8, "h2", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](9, "Visitors Report");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()()();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](10, VisitorsReportComponent_ng_container_10_Template, 3, 4, "ng-container", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipe"](11, "async");
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](12, VisitorsReportComponent_ng_template_12_Template, 4, 1, "ng-template", null, 0, _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplateRefExtractor"])(14, VisitorsReportComponent_ng_template_14_Template, 3, 0, "ng-template", null, 1, _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplateRefExtractor"]);
      }
      if (rf & 2) {
        const load_state_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵreference"](13);
        _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("loading", _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipeBind1"](1, 5, ctx.loading))("has_data", _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵpipeBind1"](2, 7, ctx.total_count));
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.NgIf, _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_10__.MatProgressSpinner, _reports_options_component__WEBPACK_IMPORTED_MODULE_2__.ReportsOptionsComponent, _visitor_report_overall_component__WEBPACK_IMPORTED_MODULE_3__.VisitorReportOverallComponent, _visitor_report_daily_usage_component__WEBPACK_IMPORTED_MODULE_4__.VisitorReportDailyUsageComponent, _visitor_report_list_component__WEBPACK_IMPORTED_MODULE_5__.VisitorReportListComponent, _angular_common__WEBPACK_IMPORTED_MODULE_9__.AsyncPipe],
    styles: ["[_nghost-%COMP%] {\n                display: flex;\n                flex-direction: column;\n                height: 100%;\n            }\n        \n/*# sourceMappingURL=data:application/json;base64, */\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VisitorsReportService: () => (/* binding */ VisitorsReportService)
/* harmony export */ });
/* harmony import */ var _home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
...
class VisitorsReportService {
  constructor(_settings, _org) {
    ...
    this._generate = new rxjs__WEBPACK_IMPORTED_MODULE_4__.BehaviorSubject(0);
    this.loading$ = this._loading.asObservable();
    this.options$ = this._options.asObservable();
    this.bookings$ = this._generate.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)(gen => gen > 0), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(() => this._options.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.take)(1))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.debounceTime)(300), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.switchMap)(options => {
      this._loading.next(true);
      const {
        start,
        end,
      ...
      return (0,_placeos_bookings__WEBPACK_IMPORTED_MODULE_1__.queryBookings)({
        period_start: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__.getUnixTime)((0,date_fns__WEBPACK_IMPORTED_MODULE_10__.startOfDay)(start || Date.now())),
        period_end: (0,date_fns__WEBPACK_IMPORTED_MODULE_9__.getUnixTime)((0,date_fns__WEBPACK_IMPORTED_MODULE_11__.endOfDay)(end || start || Date.now())),
        type: 'visitor',
        zones: (zones || [])?.join(',') || (this._settings.get('app.use_region') ? this._org.region?.id : '') || this._org.building?.id
      });
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.tap)(_ => {
      if (!_.length) {
        (0,_placeos_common__WEBPACK_IMPORTED_MODULE_2__.notifyError)('No bookings for the selected levels and period');
      }
      this._loading.next(false);
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.startWith)([]), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.shareReplay)(1));
    this.daily_stats$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_15__.combineLatest)([this.bookings$, this._options]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.map)(([bookings, options]) => {
      const days = {};
      for (const booking of bookings) {
        const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_17__.format)(booking.date, 'yyyy-MM-dd');
        if (!days[date]) {
          days[date] = {
            date: booking.date,
            bookings: []
  ...
  downloadReport() {
    ...
    return (0,_home_runner_work_user_interfaces_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const options = _this._options.getValue();
      const bookings = yield _this.bookings$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.take)(1)).toPromise();
      if (!bookings?.length) return;
      ...
      (0,_placeos_common__WEBPACK_IMPORTED_MODULE_2__.downloadFile)(`report+assets+${date}.tsv`, (0,_placeos_common__WEBPACK_IMPORTED_MODULE_2__.jsonToCsv)(bookings.map(bkn => {
        const details = bkn.toJSON();
        delete details.zones;
        delete details.server_names;
        delete details.extension_data;
  ...
  static #_ = this.ɵfac = function VisitorsReportService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || VisitorsReportService)(_angular_core__WEBPACK_IMPORTED_MODULE_19__["ɵɵinject"](_placeos_common__WEBPACK_IMPORTED_MODULE_2__.SettingsService), _angular_core__WEBPACK_IMPORTED_MODULE_19__["ɵɵinject"](_placeos_organisation__WEBPACK_IMPORTED_MODULE_3__.OrganisationService));
  };
  static #_2 = this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_19__["ɵɵdefineInjectable"]({
    token: VisitorsReportService,
    factory: VisitorsReportService.ɵfac,
    providedIn: 'root'
  });
}
...
/* harmony export */   differenceInBusinessDays: () => (/* binding */ differenceInBusinessDays)
/* harmony export */ });
/* harmony import */ var _addDays_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./addDays.mjs */ 28797);
/* harmony import */ var _differenceInCalendarDays_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./differenceInCalendarDays.mjs */ 56248);
/* harmony import */ var _isSameDay_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./isSameDay.mjs */ 31257);
/* harmony import */ var _isValid_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./isValid.mjs */ 86211);
/* harmony import */ var _isWeekend_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./isWeekend.mjs */ 51174);
...
function differenceInBusinessDays(dateLeft, dateRight) {
  ...
  let _dateRight = (0,_toDate_mjs__WEBPACK_IMPORTED_MODULE_0__.toDate)(dateRight);
  if (!(0,_isValid_mjs__WEBPACK_IMPORTED_MODULE_1__.isValid)(_dateLeft) || !(0,_isValid_mjs__WEBPACK_IMPORTED_MODULE_1__.isValid)(_dateRight)) return NaN;
  const calendarDifference = (0,_differenceInCalendarDays_mjs__WEBPACK_IMPORTED_MODULE_2__.differenceInCalendarDays)(_dateLeft, _dateRight);
  const sign = calendarDifference < 0 ? -1 : 1;
  const weeks = Math.trunc(calendarDifference / 7);
  let result = weeks * 5;
  _dateRight = (0,_addDays_mjs__WEBPACK_IMPORTED_MODULE_3__.addDays)(_dateRight, weeks * 7);

  // the loop below will run at most 6 times to account for the remaining days that don't makeup a full week
  while (!(0,_isSameDay_mjs__WEBPACK_IMPORTED_MODULE_4__.isSameDay)(_dateLeft, _dateRight)) {
    // sign is used to account for both negative and positive differences
    result += (0,_isWeekend_mjs__WEBPACK_IMPORTED_MODULE_5__.isWeekend)(_dateRight) ? 0 : sign;
    _dateRight = (0,_addDays_mjs__WEBPACK_IMPORTED_MODULE_3__.addDays)(_dateRight, sign);
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (differenceInBusinessDays);
...
function isWeekend(date) {
  const day = (0,_toDate_mjs__WEBPACK_IMPORTED_MODULE_0__.toDate)(date).getDay();
  return day === 0 || day === 6;
}

// Fallback for modularized imports:
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (isWeekend);
