...
} from "./chunk-XQDKLLRC.js";
import {
  FindAvailabilityModalComponent,
  RecurrenceFieldComponent
} from "./chunk-RRXB34X2.js";
import {
  UserListFieldComponent
} from "./chunk-LH2OMQTB.js";
import {
  LevelPipe
} from "./chunk-Q33YBQIK.js";
import "./chunk-AFI7MTZP.js";
import "./chunk-ECMLEA2W.js";
import {
  BuildingPipe
} from "./chunk-ZHYHV6BW.js";
import {
  DEFAULT_COLOURS
} from "./chunk-AO34L25L.js";
import {
  DurationFieldComponent
} from "./chunk-NWA5JF7B.js";
import {
  InteractiveMapComponent
} from "./chunk-IQF6635J.js";
import {
  DateFieldComponent
} from "./chunk-4H7XQFNE.js";
import {
  UserSearchFieldComponent
} from "./chunk-DVGXNG7J.js";
import "./chunk-ME5WOFOF.js";
import {
  SpacesService
} from "./chunk-TEGKKKSJ.js";
import "./chunk-NBGPRYVE.js";
import "./chunk-YDAD57HI.js";
import {
  TimeFieldComponent
} from "./chunk-CPEG4NFB.js";
import {
  SpacePipe
} from "./chunk-D3CEJ6RS.js";
import "./chunk-P4JICI4W.js";
import {
  BookingFormService
} from "./chunk-KZ72BXJG.js";
import {
  SettingsToggleComponent
} from "./chunk-WBSUTH2M.js";
import {
  AuthenticatedImageDirective,
  MatCheckbox,
  MatCheckboxModule,
  UserAvatarComponent
} from "./chunk-3KIDSXHU.js";
import "./chunk-AVLY3BEF.js";
import {
  AsyncHandler,
  Building,
  BuildingLevel,
    ...
    this.styles = computed(
      () => {
        ...
        return spaces.reduce((styles, space) => {
          ...
          const status = free_spaces.find((_) => _.id === space.id) ? this.selected_items().includes(space.id) ? "pending" : "free" : "busy";
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskFlowSelectMapComponent, { className: "DeskFlowSelectMapComponent", filePath: "apps/workplace/src/app/book/desk-flow-new/desk-flow-select-map.component.ts", lineNumber: 141 });
})();
...
var DeskFlowSelectComponent = class _DeskFlowSelectComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    this.subscription("clear_selected_desk_on_building_change", this._effect(() => {
      const bld = this._org.active_building();
      if (previous_building_id && bld?.id && previous_building_id !== bld.id) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskFlowSelectComponent, { className: "DeskFlowSelectComponent", filePath: "apps/workplace/src/app/book/desk-flow-new/desk-flow-select.component.ts", lineNumber: 577 });
})();
...
var NewDeskFlowSuccessComponent = class _NewDeskFlowSuccessComponent {
    ...
    this.group_booking_items = computed(
      () => {
        ...
        const failed = this.group_failures().filter((_) => !booked_emails.has(_.email)).map((failure) => ({
          ...
          email: failure.email,
          asset_name: failure.asset_name || failure.asset_id || "No desk assigned",
          failed: true,
          error: failure.error
        }));
        return [...items, ...failed];
  ...
  async _loadGroupBookings() {
    ...
    if (booking_ids.length <= 1)
      return;
    try {
      const bookings = await Promise.all(booking_ids.map((id) => showBooking(id)));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowSuccessComponent, { className: "NewDeskFlowSuccessComponent", filePath: "apps/workplace/src/app/book/desk-flow-new/desk-flow-success.component.ts", lineNumber: 280 });
})();
...
var DeskFlowNewComponent = class _DeskFlowNewComponent extends AsyncHandler {
  ...
  async _findDeskResourceFromBuildings(asset_id) {
    for (const building of this._org.buildings || []) {
      const data = await Qu(building.id, {
        name: "desks"
      }).catch(() => []);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskFlowNewComponent, selectors: [["desk-flow-new"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [[1, "bg-base-200", "relative", "flex", "h-full", "w-full", "flex-col", "overflow-auto"], [1, "mx-auto", "min-h-full", "w-7xl", "max-w-full", "flex-1", "space-y-4", "px-4", "pt-4"], [1, "block"], [1, "border-base-300", "bg-base-100", "flex", "w-full", "flex-col", "overflow-hidden", "rounded-xl", "border"], [1, "gradient", "border-base-content", "relative", "flex", "items-center", "space-x-2", "border-l-8", "px-4", "py-3", "text-xl", "font-medium"], [1, "border-base-300", "bg-base-100", "sticky", "bottom-0", "z-20", "flex", "justify-between", "rounded-t-xl", "border-x", "border-t", "p-3"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [1, "flex", "items-center", "space-x-2"], [1, "animate-spin", "text-2xl"], [1, "text-2xl"], [1, "flex-1", "pr-4"]], template: function DeskFlowNewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskFlowNewComponent, { className: "DeskFlowNewComponent", filePath: "apps/workplace/src/app/book/desk-flow-new/desk-flow.component.ts", lineNumber: 121 });
})();
export {
  DeskFlowNewComponent
};
//# sourceMappingURL=desk-flow.component-3SX6K5G4.js.map
