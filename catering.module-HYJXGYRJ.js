...
function CateringTopbarComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", (tmp_1_0 = ctx_r1.filters()) == null ? null : tmp_1_0.caterer)("placeholder", \u0275\u0275pipeBind1(2, 3, "CATERING.CATERERS_ALL"));
    \u0275\u0275advance(3);
...
var CateringTopbarComponent = class _CateringTopbarComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    this.page = signal("", ...ngDevMode ? [{ debugName: "page" }] : (
      /* istanbul ignore next */
      []
    ));
    this.filters = signal(this._orders.filters || {}, ...ngDevMode ? [{ debugName: "filters" }] : (
      /* istanbul ignore next */
      []
    ));
    this.caterers = signal([], ...ngDevMode ? [{ debugName: "caterers" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  async ngOnInit() {
    ...
    if (this._orders.order_filters?.subscribe) {
      this.subscription("filters", this._orders.order_filters.subscribe((filters) => {
        this.filters.set(filters || {});
      }));
    }
    if (this._catering.caterers?.subscribe) {
      this.subscription("caterers", this._catering.caterers.subscribe((caterers) => {
        this.caterers.set(caterers || []);
      }));
    }
    if (this._org.active_building?.subscribe && this._org.active_region?.subscribe) {
      this.subscription("levels", combineLatest([
        this._org.active_building,
        this._org.active_region
      ]).pipe(map(([bld, region]) => this._settings.get("app.use_region") ? this._org.levelsForRegion?.(region) : this._org.levelsForBuilding?.(bld))).subscribe((levels) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringTopbarComponent, selectors: [["catering-topbar"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 17, consts: [[1, "flex", "w-full", "items-center", "space-x-2", "px-8", "pt-4", "pb-2"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], [1, "bg-base-100", "flex", "h-20", "items-center", "space-x-2", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "w-2", "flex-1"], ["icon", "", "default", "", "matRipple", "", 3, "matTooltip"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "ngModelChange", "ngModel", "placeholder"], ["value", ""], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-2xl"], [3, "dateChange"]], template: function CateringTopbarComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("model", (tmp_1_0 = ctx.filters()) == null ? null : tmp_1_0.search);
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", (tmp_2_0 = ctx.filters()) == null ? null : tmp_2_0.zones)("placeholder", \u0275\u0275pipeBind1(9, 15, "COMMON.LEVEL_ALL"));
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.page() === "menu" && (!ctx.zones()[0] || ctx.zones()[0] === (ctx.building == null ? null : ctx.building.id)) ? 14 : -1);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringTopbarComponent, { className: "CateringTopbarComponent", filePath: "apps/concierge/src/app/catering/catering-topbar.component.ts", lineNumber: 195 });
})();
...
var CateringComponent = class _CateringComponent {
  constructor() {
    this._route = inject(ActivatedRoute);
    this.page = toSignal(this._route.paramMap.pipe(map((params) => params.get("view") || "")), { initialValue: this._route.snapshot.paramMap.get("view") || "" });
  }
  static {
...
var CateringModule = class _CateringModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [CateringComponent, RouterModule.forChild(ROUTES)] });
  }
};
(() => {
...
//# sourceMappingURL=catering.module-HYJXGYRJ.js.map
