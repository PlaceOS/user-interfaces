...
var DateOptionsComponent = class _DateOptionsComponent extends AsyncHandler {
  constructor() {
    ...
    this.is_new = input(false, ...ngDevMode ? [{ debugName: "is_new" }] : (
    ...
    this.display_mode = input("day", ...ngDevMode ? [{ debugName: "display_mode" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.hide_today = input(false, ...ngDevMode ? [{ debugName: "hide_today" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.is_today = computed(() => this.display_mode() === "day" && isSameDay(this.date(), Date.now()) && !this.hide_today(), ...ngDevMode ? [{ debugName: "is_today" }] : (
      /* istanbul ignore next */
      []
    ));
...
(() => {
  ...
  }], null, { is_new: [{ type: Input, args: [{ isSignal: true, alias: "is_new", required: false }] }], disabled: [{ type: Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], week_start: [{ type: Input, args: [{ isSignal: true, alias: "week_start", required: false }] }], date: [{ type: Input, args: [{ isSignal: true, alias: "date", required: false }] }, { type: Output, args: ["dateChange"] }], display_mode: [{ type: Input, args: [{ isSignal: true, alias: "display_mode", required: false }] }], step: [{ type: Input, args: [{ isSignal: true, alias: "step", required: false }] }], hide_today: [{ type: Input, args: [{ isSignal: true, alias: "hide_today", required: false }] }], dateChange: [{ type: Output, args: ["dateChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DateOptionsComponent, { className: "DateOptionsComponent", filePath: "apps/concierge/src/app/ui/date-options.component.ts", lineNumber: 152 });
})();

export {
  DateOptionsComponent
};
//# sourceMappingURL=chunk-J55DB2VV.js.map
