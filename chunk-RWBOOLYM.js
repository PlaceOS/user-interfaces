...
} from "./chunk-322E3KKE.js";
import {
  deskFromAsset,
  queryDeskAssetsForZones
} from "./chunk-UHLUEGIR.js";
import {
  AssetStateService,
  CalendarService,
  bookingAttachments,
...
import {
  removeEventGuest
} from "./chunk-ZHHRCTEU.js";
import {
  openConfirmModal
} from "./chunk-HLO6GV4H.js";
import {
  validateAssetRequestsForResource
} from "./chunk-VZD7BPPZ.js";
import {
  bookedResourceList,
  findBookingClashes,
  queryBookings,
...
var BookingFormService = class _BookingFormService extends AsyncHandler {
  ...
  async loadGroupSiblings(booking) {
    ...
    return list.filter((b) => b.status !== "cancelled" && (b.id === parent_id || b.parent_id === parent_id || !!group_ref && `${b.group || ""}`.trim() === group_ref || !!legacy_group && b.description === legacy_group));
  }
...
//# debugId=39e211e7-edb6-5e71-b2ea-487baa3e8cd4
//# sourceMappingURL=chunk-RWBOOLYM.js.map
