...
var DisplayScheduleComponent = class _DisplayScheduleComponent {
  constructor() {
    ...
    this._playlists = toSignal(this._service.playlists, {
      initialValue: []
    });
    this.week_offset = signal(0, ...ngDevMode ? [{ debugName: "week_offset" }] : (
    ...
    this.days = computed(() => Array.from({ length: DAY_COUNT }, (_, i) => addDays(this.week_start(), i)), ...ngDevMode ? [{ debugName: "days" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.display_assignments = computed(() => this.display_playlists().map((playlist) => ({ playlist })), ...ngDevMode ? [{ debugName: "display_assignments" }] : (
      /* istanbul ignore next */
      []
    ));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplayScheduleComponent, { className: "DisplayScheduleComponent", filePath: "apps/signage-manager/src/app/displays/display-schedule.component.ts", lineNumber: 261 });
})();
...
function DisplayContentComponent_Conditional_0_Conditional_3_Conditional_9_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_15_0 = ctx_r1.playlist_thumbnail_media()[playlist_r6.id]) == null ? null : tmp_15_0.length) ? 4 : 5);
    \u0275\u0275advance(4);
...
function DisplayContentComponent_Conditional_0_Conditional_3_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "icon", 31);
...
function DisplayContentComponent_Conditional_0_Conditional_4_Conditional_8_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, DisplayContentComponent_Conditional_0_Conditional_4_Conditional_8_For_1_Conditional_7_Template, 2, 1, "div", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DisplayContentComponent_Conditional_0_Conditional_4_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, DisplayContentComponent_Conditional_0_Conditional_4_Conditional_8_For_1_Template, 8, 11, "a", 33, _forTrack02);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function DisplayContentComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 1, "SIGNAGE_MANAGER.DISPLAY_SELECT_DETAILS"));
  }
}
var DisplayContentComponent = class _DisplayContentComponent {
  constructor() {
    this._service = inject(SignageService);
    this.activeTab = input("schedule", ...ngDevMode ? [{ debugName: "activeTab" }] : (
      /* istanbul ignore next */
      []
    ));
    this.selected_display = this._service.selected_display;
    ...
    this._zones = toSignal(this._service.zones, {
      initialValue: []
    });
    this.display_playlists = computed(() => {
      const display = this.selected_display();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DisplayContentComponent, selectors: [["display-content"]], inputs: { activeTab: [1, "activeTab"] }, decls: 2, vars: 1, consts: [[1, "flex", "h-full", "flex-col", "overflow-hidden"], [1, "text-base-content/70", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "flex", "min-h-0", "flex-1", "flex-col", "gap-3", "p-3"], ["id", "display-schedule-panel", "role", "tabpanel", "aria-labelledby", "display-schedule-tab", 1, "bg-base-100", "border-base-300", "min-h-0", "flex-1", "overflow-hidden", "rounded-lg", "border"], ["id", "display-playlists-panel", "role", "tabpanel", "aria-labelledby", "display-playlists-tab", 1, "bg-base-100", "border-base-300", "min-h-0", "flex-1", "overflow-auto", "rounded-lg", "border"], ["id", "display-zones-panel", "role", "tabpanel", "aria-labelledby", "display-zones-tab", 1, "bg-base-100", "border-base-300", "min-h-0", "flex-1", "overflow-auto", "rounded-lg", "border"], [1, "border-base-300", "flex", "items-center", "gap-2", "border-b", "px-4", "py-3"], [1, "text-base-content/80", "flex", "flex-1", "items-center", "gap-2", "font-medium", "tracking-wider", "uppercase"], [1, "text-lg"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "rounded-lg", "border", "hover:shadow-md", 3, "matTooltip"], [1, "gap-2", "p-2"], [1, "text-base-content/70", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-6"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "rounded-lg", "border", "hover:shadow-md", 3, "click", "matTooltip"], [1, "border-base-300", "bg-base-100", "mb-2", "flex", "items-center", "gap-3", "rounded-lg", "border", "p-0.5", "pl-1"], ["matRipple", "", 1, "hover:bg-base-200", "flex", "min-w-0", "flex-1", "items-center", "gap-3", "rounded-lg", "p-1", "no-underline", "transition-colors", 3, "routerLink"], [1, "border-base-200", "relative", "h-12", "w-12", "shrink-0", "overflow-hidden", "rounded-md", "border"], [1, "text-base-content/35", "flex", "h-full", "w-full", "items-center", "justify-center"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-sm", "font-medium"], [1, "mt-1", "flex", "flex-wrap", "gap-1"], [1, "bg-warning", "text-warning-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "bg-error", "text-error-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "bg-info", "text-info-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "bg-secondary", "text-secondary-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "text-base-content/70", "mt-0.5", "truncate", "text-xs"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "mr-1", "rounded-lg", "border", "hover:shadow-md", 3, "matTooltip"], ["auth", "", "alt", "", 1, "border-base-300", "bg-base-200", "absolute", "h-9", "w-9", "rounded-sm", "border", "object-cover", "shadow", 3, "source", "top", "left", "z-index"], ["auth", "", "alt", "", 1, "border-base-300", "bg-base-200", "absolute", "h-9", "w-9", "rounded-sm", "border", "object-cover", "shadow", 3, "source"], [1, "text-2xl"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "mr-1", "rounded-lg", "border", "hover:shadow-md", 3, "click", "matTooltip"], [1, "text-error"], [1, "text-4xl"], [1, "text-sm"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "hover:bg-base-200", "mb-2", "flex", "items-center", "gap-3", "rounded-lg", "border", "px-4", "py-3", "no-underline", "transition-colors", 3, "routerLink"], [1, "shrink-0", "text-xl", "opacity-60"], [1, "text-base-content/70", "truncate", "text-xs"], [1, "text-6xl"]], template: function DisplayContentComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplayContentComponent, { className: "DisplayContentComponent", filePath: "apps/signage-manager/src/app/displays/display-content.component.ts", lineNumber: 393 });
})();
...
var DisplayHeaderComponent = class _DisplayHeaderComponent {
  constructor() {
    this._service = inject(SignageService);
    this.total_count = computed(() => this._service.filtered_displays().length, ...ngDevMode ? [{ debugName: "total_count" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DisplayHeaderComponent, selectors: [["display-header"]], decls: 9, vars: 10, consts: [[1, "bg-base-100", "border-base-300", "sticky", "top-0", "flex", "flex-wrap", "items-center", "gap-2", "border-b", "px-4", "py-2", "shadow", "sm:flex-nowrap"], [1, "py-2"], [1, "text-2xl", "font-medium"], [1, "text-sm", "opacity-60"], [1, "w-px", "flex-1"]], template: function DisplayHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(7, 4, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(8, _c03, ctx.total_count()), ctx.total_count()), " ");
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplayHeaderComponent, { className: "DisplayHeaderComponent", filePath: "apps/signage-manager/src/app/displays/display-header.component.ts", lineNumber: 29 });
})();

// apps/signage-manager/src/app/displays/display-list.component.ts
var _c04 = (a0) => ["/displays", a0];
var _c12 = (a0) => ({ name: a0 });
...
function DisplayListComponent_Conditional_6_For_1_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("opacity-70", ((tmp_12_0 = ctx_r1.selected()) == null ? null : tmp_12_0.id) !== display_r1.id)("opacity-90", ((tmp_13_0 = ctx_r1.selected()) == null ? null : tmp_13_0.id) === display_r1.id);
    \u0275\u0275advance();
...
function DisplayListComponent_Conditional_6_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-primary", ((tmp_11_0 = ctx_r1.selected()) == null ? null : tmp_11_0.id) === display_r1.id)("text-primary-content", ((tmp_12_0 = ctx_r1.selected()) == null ? null : tmp_12_0.id) === display_r1.id)("hover:bg-base-200", ((tmp_13_0 = ctx_r1.selected()) == null ? null : tmp_13_0.id) !== display_r1.id);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(13, _c04, display_r1.id));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(1, 10, "SIGNAGE_MANAGER.OPEN_DISPLAY", \u0275\u0275pureFunction1(15, _c12, display_r1.display_name || display_r1.name)));
    \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplayListComponent, { className: "DisplayListComponent", filePath: "apps/signage-manager/src/app/displays/display-list.component.ts", lineNumber: 106 });
})();
...
var DisplaysSectionComponent = class _DisplaysSectionComponent {
  constructor() {
    ...
    this.view_tab = signal("schedule", ...ngDevMode ? [{ debugName: "view_tab" }] : (
      /* istanbul ignore next */
      []
    ));
    this.selected_display = this._service.selected_display;
    this._displays = toSignal(this._service.displays, {
      initialValue: []
    });
    this._playlists = toSignal(this._service.playlists, {
      initialValue: []
    ...
    this._route_id = toSignal(this._route.paramMap.pipe(map((p) => p.get("id") || "")), { initialValue: "" });
    this._route_tab = toSignal(this._route.queryParamMap.pipe(map((p) => p.get(TAB_QUERY_PARAM))), { initialValue: null });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DisplaysSectionComponent, selectors: [["displays-section"]], decls: 10, vars: 6, consts: [[1, "bg-base-200", "absolute", "inset-0", "flex", "flex-col", "sm:flex-row"], [1, "sm:h-full"], [1, "flex", "min-h-0", "flex-1", "flex-col", "overflow-hidden"], [1, "relative", "z-10"], [1, "flex", "min-h-0", "flex-1", "flex-row"], [1, "mobile-full"], [1, "flex", "min-h-0", "w-px", "flex-1", "flex-col"], [1, "h-1/2", "flex-1", 3, "activeTab"], [1, "bg-base-100", "border-base-300", "mx-2", "flex", "items-center", "gap-2", "rounded-b-lg", "border", "px-2", "py-1"], ["icon", "", "type", "button", "matRipple", "", 1, "sm:hidden", 3, "click"], [1, "shrink-0", "text-2xl", "opacity-60"], [1, "min-w-0", "flex-1", "py-2"], [1, "truncate", "text-lg", "font-medium"], [1, "text-base-content/80", "truncate", "text-sm"], ["icon", "", "matRipple", "", "target", "_blank", "rel", "noopener noreferrer", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "rounded-lg", "border", "hover:shadow-md", 3, "matTooltip", "href"], ["role", "tablist", 1, "bg-base-100", "border-base-300", "mx-2", "mt-2", "flex", "overflow-hidden", "rounded-lg", "border"], ["type", "button", "role", "tab", "aria-controls", "display-schedule-panel", "id", "display-schedule-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], ["type", "button", "role", "tab", "aria-controls", "display-playlists-panel", "id", "display-playlists-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], ["type", "button", "role", "tab", "aria-controls", "display-zones-panel", "id", "display-zones-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"]], template: function DisplaysSectionComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplaysSectionComponent, { className: "DisplaysSectionComponent", filePath: "apps/signage-manager/src/app/displays/displays.component.ts", lineNumber: 224 });
})();
export {
  DisplaysSectionComponent
};
//# sourceMappingURL=displays.component-BSMAPGPT.js.map
