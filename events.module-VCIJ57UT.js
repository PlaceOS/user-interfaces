      ...
      this._event_source.onmessage = (msg) => {
        try {
          ...
          if (data.type === "event_added" && data.event) {
            this._zone.run(() => {
              console.log(`[EventSync] Event received: ${data.event.title}`);
            });
          }
        } catch {
        }
...
_EventSyncService.\u0275fac = function EventSyncService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _EventSyncService)(\u0275\u0275inject(NgZone));
};
...
var _EventsListComponent = class _EventsListComponent extends AsyncHandler {
  constructor() {
    ...
    this._router = inject(Router);
    this._route = inject(ActivatedRoute);
    this._event_sync = inject(EventSyncService);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventsListComponent, { className: "EventsListComponent", filePath: "apps/concierge/src/app/events/events-list.component.ts", lineNumber: 141 });
})();
...
//# sourceMappingURL=events.module-VCIJ57UT.js.map
