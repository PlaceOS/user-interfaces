import {
  LandingStateService
} from "./chunk-FB7CIA2O.js";
import {
  ExploreDeskInfoComponent,
  LockerGridComponent
} from "./chunk-ZNI6DG2C.js";
import {
  VirtualConciergeButtonComponent
} from "./chunk-5LERF3OC.js";
import {
  LevelPipe
} from "./chunk-4537DZHK.js";
import {
  toSignal
} from "./chunk-AFI7MTZP.js";
import {
  ExploreParkingInfoComponent
} from "./chunk-ZOAWIJSH.js";
import {
  MapPinComponent
} from "./chunk-UD6WSAOR.js";
import {
  DEFAULT_COLOURS,
...
import "./chunk-ROMSGI4Y.js";
import {
  DateFieldComponent
} from "./chunk-CPYNIVH5.js";
import {
  UserSearchFieldComponent
} from "./chunk-OBKGJT3L.js";
import {
  compareAsc,
  differenceInMonths
} from "./chunk-ELH7OUNO.js";
import {
  FooterMenuComponent,
  TopbarComponent
} from "./chunk-WNJGYRMP.js";
import "./chunk-QYMPTGSB.js";
import {
  SpacesService
...
import {
  ParkingService
} from "./chunk-PPTQYXZO.js";
import {
  BookingFormService,
  DeskQuestionsModalComponent,
  queryParkingSpacesForZones
} from "./chunk-QLH737ZA.js";
import {
...
function SetDatetimeModalComponent_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275control();
    \u0275\u0275advance(6);
    \u0275\u0275property("ngModel", ctx_r1.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(10, _c0))("range", ctx_r1.bookable_hours())("use_24hr", ctx_r1.use_24hr_time());
    \u0275\u0275control();
    \u0275\u0275advance();
...
var ExplorePointOfInterestService = class _ExplorePointOfInterestService extends AsyncHandler {
  constructor() {
    ...
    this._features = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_features" } : (
      ...
      params: () => this._building() || void 0,
      loader: async () => {
        const metadata = await ju(this._org.organisation.id, "points-of-interest").catch((_) => ({ details: {} }));
...
var ExploreMapViewComponent = class _ExploreMapViewComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreMapViewComponent, selectors: [["explore-map-view"]], features: [\u0275\u0275ProvidersFeature([
      ...
      SpacePipe
    ]), \u0275\u0275InheritDefinitionFeature], decls: 4, vars: 11, consts: [[3, "mapInfo", "src", "styles", "features", "actions", "labels", "focus", "options"], ["controls", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "left-2", "max-w-[calc(100vw-1rem)]", "space-y-2", "overflow-hidden", "rounded-lg", "border", "p-2", "shadow-xl"], ["legend", "", 1, "border-base-300", "bg-base-100", "absolute", "bottom-2", "left-2", "gap-2", "rounded-lg", "border"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "right-2", "h-12", "min-w-32", "rounded-lg", "border", "px-4", "shadow-sm"], [1, "mt-2", 3, "label", "ngModel"], [1, "mt-2", 3, "ngModelChange", "label", "ngModel"], [1, "min-w-64", "p-3", "font-medium"], ["id", "explore-map-legend-items", 1, "space-y-1", "px-4", "pb-3", "sm:block"], [1, "flex", "items-center", "space-x-2"], ["type", "button", "aria-controls", "explore-map-legend-items", 1, "flex", "w-full", "min-w-64", "items-center", "justify-between", "space-x-4", "p-3", "text-left", "font-medium", "sm:hidden", 3, "click"], [1, "text-sm", "underline", "sm:hidden"], [1, "hidden", "min-w-64", "p-3", "font-medium", "sm:block"], [1, "border-base-200", "h-3", "w-3", "rounded-full", "border"], [1, "text-sm"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "right-2", "h-12", "min-w-32", "rounded-lg", "border", "px-4", "shadow-sm", 3, "click"]], template: function ExploreMapViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExploreMapViewComponent, { className: "ExploreMapViewComponent", filePath: "libs/explore/src/lib/explore-map-view.component.ts", lineNumber: 154 });
})();
...
//# sourceMappingURL=explore.routes-WH4ZI6DU.js.map
