...
(() => {
  ...
  }], null, { from_date: [{ type: Input, args: [{ isSignal: true, alias: "from", required: false }] }], to_date: [{ type: Input, args: [{ isSignal: true, alias: "to", required: false }] }], offset_weekday: [{ type: Input, args: [{ isSignal: true, alias: "offset_weekday", required: false }] }], startInput: [{ type: Input, args: [{ isSignal: true, alias: "start", required: false }] }], endInput: [{ type: Input, args: [{ isSignal: true, alias: "end", required: false }] }], month: [{ type: Input, args: [{ isSignal: true, alias: "month", required: false }] }, { type: Output, args: ["monthChange"] }], startChange: [{ type: Output, args: ["startChange"] }], endChange: [{ type: Output, args: ["endChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DateRangeCalendarComponent, { className: "DateRangeCalendarComponent", filePath: "libs/form-fields/src/lib/date-range-calendar.component.ts", lineNumber: 104 });
})();
...
//# debugId=909554db-79cf-5ef1-b528-e43021689203
//# sourceMappingURL=chunk-XBJ7H7AU.js.map
