import{$n as Ss,$o as uc,$t as Me,Ai as dc,An as Pt,Bt as Kn,Cr as X,D as Bs,Di as cu,Ea as jt,F as Ck,Ga as md,Gn as Rv,Go as ti,Ha as m,Ii as ds,Is as yn,Jn as Sce,Jt as Le,Ka as me,M as Ce,Ns as ye$1,Ot as It,Qi as fk,Ra as lc,Rs as ys,Rt as Kg,Uo as ta,Ws as zn,_t as Hs,a as $S,ao as oc,bi as cb,ca as hd,ct as Gt,fa as ic,ha as it,hs as vt,io as oa,is as v,ks as xr,l as $t,ls as vd,lt as Gx,mr as Ve,ms as vs,no,oi as ac,s as $f,ti as _t,ut as H,xi as cc,xt as Id,y as Av}from"./chunk-DiRZz73h.js";import{M as Ln}from"./chunk-DIf9RsKC.js";import{St as zu,a as Bu,m as Fd}from"./chunk-DuNsWotq.js";var _e=[`input`];var xe=[`*`];var C={color:`accent`,clickAction:`check-indeterminate`,disabledInteractive:!1};var pe=new v(`mat-checkbox-default-options`,{providedIn:`root`,factory:()=>C});var a=(function(t){return t[t.Init=0]=`Init`,t[t.Checked=1]=`Checked`,t[t.Unchecked=2]=`Unchecked`,t[t.Indeterminate=3]=`Indeterminate`,t})(a||{});var I=class{source;checked};var ve=(()=>{class t{_elementRef=m(Me);_changeDetectorRef=m($t);_ngZone=m(me);_animationsDisabled=ta();_options=m(pe,{optional:!0});focus(){this._inputElement.nativeElement.focus()}_createChangeEvent(e){let n=new I;return n.source=this,n.checked=e,n}_getAnimationTargetElement(){return this._inputElement?.nativeElement}_animationClasses={uncheckedToChecked:`mdc-checkbox--anim-unchecked-checked`,uncheckedToIndeterminate:`mdc-checkbox--anim-unchecked-indeterminate`,checkedToUnchecked:`mdc-checkbox--anim-checked-unchecked`,checkedToIndeterminate:`mdc-checkbox--anim-checked-indeterminate`,indeterminateToChecked:`mdc-checkbox--anim-indeterminate-checked`,indeterminateToUnchecked:`mdc-checkbox--anim-indeterminate-unchecked`};ariaLabel=``;ariaLabelledby=null;ariaDescribedby;ariaExpanded;ariaControls;ariaOwns;_uniqueId;id;get inputId(){return`${this.id||this._uniqueId}-input`}required=!1;labelPosition=`after`;name=null;change=new ye$1;indeterminateChange=new ye$1;value;disableRipple=!1;_inputElement;tabIndex;color;disabledInteractive;_onTouched=()=>{};_currentAnimationClass=``;_currentCheckState=a.Init;_controlValueAccessorChangeFn=()=>{};_validatorChangeFn=()=>{};constructor(){m(xr).load(cb);let e=m(new vd(`tabindex`),{optional:!0});this._options=this._options||C,this.color=this._options.color||C.color,this.tabIndex=e==null?0:parseInt(e)||0,this.id=this._uniqueId=m(cu).getId(`mat-mdc-checkbox-`),this.disabledInteractive=this._options?.disabledInteractive??!1}ngOnChanges(e){e.required&&this._validatorChangeFn()}ngAfterViewInit(){this._syncIndeterminate(this.indeterminate)}get checked(){return this._checked}set checked(e){e!=this.checked&&(this._checked=e,this._changeDetectorRef.markForCheck())}_checked=!1;get disabled(){return this._disabled}set disabled(e){e!==this.disabled&&(this._disabled=e,this._changeDetectorRef.markForCheck())}_disabled=!1;get indeterminate(){return this._indeterminate()}set indeterminate(e){let n=e!=this._indeterminate();this._indeterminate.set(e),n&&(e?this._transitionCheckState(a.Indeterminate):this._transitionCheckState(this.checked?a.Checked:a.Unchecked),this.indeterminateChange.emit(e)),this._syncIndeterminate(e)}_indeterminate=H(!1);_isRippleDisabled(){return this.disableRipple||this.disabled}_onLabelTextChange(){this._changeDetectorRef.detectChanges()}writeValue(e){this.checked=!!e}registerOnChange(e){this._controlValueAccessorChangeFn=e}registerOnTouched(e){this._onTouched=e}setDisabledState(e){this.disabled=e}validate(e){return this.required&&e.value!==!0?{required:!0}:null}registerOnValidatorChange(e){this._validatorChangeFn=e}_transitionCheckState(e){let n=this._currentCheckState,c=this._getAnimationTargetElement();if(!(n===e||!c)&&(this._currentAnimationClass&&c.classList.remove(this._currentAnimationClass),this._currentAnimationClass=this._getAnimationClassForCheckStateTransition(n,e),this._currentCheckState=e,this._currentAnimationClass.length>0)){c.classList.add(this._currentAnimationClass);let i=this._currentAnimationClass;this._ngZone.runOutsideAngular(()=>{setTimeout(()=>{c.classList.remove(i)},1e3)})}}_emitChangeEvent(){this._controlValueAccessorChangeFn(this.checked),this.change.emit(this._createChangeEvent(this.checked)),this._inputElement&&(this._inputElement.nativeElement.checked=this.checked)}toggle(){this.checked=!this.checked,this._controlValueAccessorChangeFn(this.checked)}_handleInputClick(){let e=this._options?.clickAction;!this.disabled&&e!==`noop`?(this.indeterminate&&e!==`check`&&Promise.resolve().then(()=>{this._indeterminate.set(!1),this.indeterminateChange.emit(!1)}),this._checked=!this._checked,this._transitionCheckState(this._checked?a.Checked:a.Unchecked),this._emitChangeEvent()):(this.disabled&&this.disabledInteractive||!this.disabled&&e===`noop`)&&(this._inputElement.nativeElement.checked=this.checked,this._inputElement.nativeElement.indeterminate=this.indeterminate)}_onInteractionEvent(e){e.stopPropagation()}_onBlur(){Promise.resolve().then(()=>{this._onTouched(),this._changeDetectorRef.markForCheck()})}_getAnimationClassForCheckStateTransition(e,n){if(this._animationsDisabled)return``;switch(e){case a.Init:if(n===a.Checked)return this._animationClasses.uncheckedToChecked;if(n==a.Indeterminate)return this._checked?this._animationClasses.checkedToIndeterminate:this._animationClasses.uncheckedToIndeterminate;break;case a.Unchecked:return n===a.Checked?this._animationClasses.uncheckedToChecked:this._animationClasses.uncheckedToIndeterminate;case a.Checked:return n===a.Unchecked?this._animationClasses.checkedToUnchecked:this._animationClasses.checkedToIndeterminate;case a.Indeterminate:return n===a.Checked?this._animationClasses.indeterminateToChecked:this._animationClasses.indeterminateToUnchecked}return``}_syncIndeterminate(e){let n=this._inputElement;n&&(n.nativeElement.indeterminate=e)}_onInputClick(){this._handleInputClick()}_preventBubblingFromLabel(e){e.target&&this._inputElement&&e.target!==this._inputElement.nativeElement&&e.stopPropagation()}static ɵfac=function(n){return new(n||t)};static ɵcmp=It({type:t,selectors:[[`mat-checkbox`]],viewQuery:function(n,c){if(n&1&&md(_e,5),n&2){let i;uc(i=lc())&&(c._inputElement=i.first)}},hostAttrs:[1,`mat-mdc-checkbox`],hostVars:16,hostBindings:function(n,c){n&2&&(hd(`id`,c.id),zn(`tabindex`,null)(`aria-label`,null)(`aria-labelledby`,null),Ck(c.color?`mat-`+c.color:`mat-accent`),jt(`_mat-animation-noopable`,c._animationsDisabled)(`mdc-checkbox--disabled`,c.disabled)(`mat-mdc-checkbox-disabled`,c.disabled)(`mat-mdc-checkbox-checked`,c.checked)(`mat-mdc-checkbox-disabled-interactive`,c.disabledInteractive))},inputs:{ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],ariaExpanded:[2,`aria-expanded`,`ariaExpanded`,yn],ariaControls:[0,`aria-controls`,`ariaControls`],ariaOwns:[0,`aria-owns`,`ariaOwns`],id:`id`,required:[2,`required`,`required`,yn],labelPosition:`labelPosition`,name:`name`,value:`value`,disableRipple:[2,`disableRipple`,`disableRipple`,yn],tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?void 0:Gx(e)],color:`color`,disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,yn],checked:[2,`checked`,`checked`,yn],disabled:[2,`disabled`,`disabled`,yn],indeterminate:[2,`indeterminate`,`indeterminate`,yn]},outputs:{change:`change`,indeterminateChange:`indeterminateChange`},exportAs:[`matCheckbox`],features:[Pt([{provide:Bs,useExisting:_t(()=>t),multi:!0},{provide:Hs,useExisting:t,multi:!0}]),vt],ngContentSelectors:xe,decls:15,vars:23,consts:[[`checkbox`,``],[`input`,``],[`label`,``],[`mat-internal-form-field`,``,3,`click`,`labelPosition`,`for`],[1,`mdc-checkbox`],[`aria-hidden`,`true`,1,`mat-mdc-checkbox-touch-target`],[`type`,`checkbox`,1,`mdc-checkbox__native-control`,3,`blur`,`click`,`change`,`checked`,`indeterminate`,`disabled`,`id`,`required`,`tabIndex`],[`aria-hidden`,`true`,1,`mdc-checkbox__ripple`],[`aria-hidden`,`true`,1,`mdc-checkbox__background`],[`focusable`,`false`,`viewBox`,`0 0 24 24`,1,`mdc-checkbox__checkmark`],[`fill`,`none`,`d`,`M1.73,12.91 8.1,19.28 22.79,4.59`,1,`mdc-checkbox__checkmark-path`],[1,`mdc-checkbox__mixedmark`],[`mat-ripple`,``,`aria-hidden`,`true`,1,`mat-mdc-checkbox-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mat-internal-form-field-label`,`mdc-label`]],template:function(n,c){if(n&1&&(cc(),ti(0,`label`,3),Gt(`click`,function(l){return c._preventBubblingFromLabel(l)}),ti(1,`span`,4,0),no(3,`span`,5),ti(4,`input`,6,1),Gt(`blur`,function(){return c._onBlur()})(`click`,function(){return c._onInputClick()})(`change`,function(l){return c._onInteractionEvent(l)}),ys(),no(6,`span`,7),ti(7,`span`,8),Av(),ti(8,`svg`,9),no(9,`path`,10),ys(),Rv(),no(10,`span`,11),ys(),no(11,`span`,12),ys(),ti(12,`span`,13,2),vs(14),ys()()),n&2){let i=fk(2);Ss(`labelPosition`,c.labelPosition)(`for`,c.inputId),ds(4),jt(`mdc-checkbox--selected`,c.checked),Ss(`checked`,c.checked)(`indeterminate`,c.indeterminate)(`disabled`,c.disabled&&!c.disabledInteractive)(`id`,c.inputId)(`required`,c.required)(`tabIndex`,c.disabled&&!c.disabledInteractive?-1:c.tabIndex),zn(`aria-label`,c.ariaLabel||null)(`aria-labelledby`,c.ariaLabelledby)(`aria-describedby`,c.ariaDescribedby)(`aria-checked`,c.indeterminate?`mixed`:null)(`aria-controls`,c.ariaControls)(`aria-disabled`,c.disabled&&c.disabledInteractive?!0:null)(`aria-expanded`,c.ariaExpanded)(`aria-owns`,c.ariaOwns)(`name`,c.name)(`value`,c.value),ds(7),Ss(`matRippleTrigger`,i)(`matRippleDisabled`,c.disableRipple||c.disabled)(`matRippleCentered`,!0)}},dependencies:[$S,Sce],styles:[`.mdc-checkbox {
...
`],encapsulation:2})}return t})();var Ue=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵmod=Ve({type:t});static ɵinj=Le({imports:[ve,oa]})}return t})();var ue=(()=>{class t extends Ln{constructor(){super(...arguments),this._element=m(Me),this._observer=null,this._source_version=0,this.source=Id(void 0)}ngOnChanges(e){if(!e.source)return;this._source_version+=1,this.clearTimeout(`load`),this._observer?.disconnect(),this._observer=null;let n=this.source();if(n){if(!this._isLocalUrl(n)){this._element.nativeElement.src=n;return}this._loadWhenVisible(n,this._source_version)}}ngOnDestroy(){this._observer?.disconnect(),this._observer=null,super.ngOnDestroy()}_loadWhenVisible(e,n){if(typeof IntersectionObserver>`u`){this._loadImage(e,n);return}this._observer=new IntersectionObserver(c=>{c.some(({isIntersecting:i})=>i)&&(this._observer?.disconnect(),this._observer=null,this._loadImage(e,n))},{rootMargin:`300px`}),this._observer.observe(this._element.nativeElement)}async _loadImage(e,n){if(n!==this._source_version||e!==this.source())return;if(!$f()){this.timeout(`load`,()=>{this._loadImage(e,n)},300);return}let c=Fd(e);if(c){this._element.nativeElement.src=c;return}let i=e.includes(`/api/engine/v2/uploads`)||e.includes(`/api/engine/v2/signage`);try{let l=i?await zu(e,this._cookiePath(e)):await Bu(e);n===this._source_version&&e===this.source()&&(this._element.nativeElement.src=l)}catch(l){n===this._source_version&&this._element.nativeElement.dispatchEvent(new ErrorEvent(`error`,{error:l}))}}_isLocalUrl(e){try{return new URL(e,location.href).origin===location.origin}catch{return!1}}_cookiePath(e){return e.includes(`/api/engine/v2/uploads`)?`/api/engine/v2/uploads`:`/api/engine/v2/signage`}static{this.ɵfac=(()=>{let e;return function(c){return(e||(e=Kn(t)))(c||t)}})()}static{this.ɵdir=X({type:t,selectors:[[`img`,`auth`,``],[`video`,`auth`,``],[`audio`,`auth`,``]],inputs:{source:[1,`source`]},features:[it,vt]})}}return t})();function fe(t,E){if(t&1&&(ti(0,`div`,1),Kg(1),ys()),t&2){let e=ac(2);ds(),dc(` `,e.initials,` `)}}function ge(t,E){if(t&1&&no(0,`img`,2),t&2){let e=ac(2);Ss(`alt`,e.initials)(`source`,e.user().photo)}}function ye(t,E){if(t&1&&(ti(0,`div`,0),oc(1,fe,2,1,`div`,1)(2,ge,1,2,`img`,2),ys()),t&2){let e=ac();zn(`user-id`,e.user().id),ds(),ic(e.user().photo?2:1)}}var Qe=(()=>{class t{constructor(){this.user=Id(void 0),this.is_valid=Ce(()=>{let e=this.user();if(!e)return!1;let n=(e.name||``).trim(),c=(e.email||``).trim();return n.startsWith(`<empty>`)||c.startsWith(`<empty>`)?!1:!!(n||c||e.first_name||e.last_name)})}get initials(){let e=this.user();if(!e)return`NA`;if(e.first_name&&e.last_name)return`${e.first_name[0]}${e.last_name[0]}`;let n=(e.name||``).replace(/<[^>]*>/g,` `).trim();n||(n=(e.email||e.name||``).split(`@`)[0]);let c=n.replace(/[()[\]\-+=\\/@<>]+/gi,` `).split(/\s+/).filter(Boolean);return c.length===0?`NA`:c.length>1?`${c[0][0]}${c[c.length-1][0]}`:c[0].slice(0,2)}static{this.ɵfac=function(n){return new(n||t)}}static{this.ɵcmp=It({type:t,selectors:[[`a-user-avatar`]],inputs:{user:[1,`user`]},decls:1,vars:1,consts:[[1,`border-base-100`,`bg-base-200`,`flex`,`h-[2.5em]`,`w-[2.5em]`,`items-center`,`justify-center`,`overflow-hidden`,`rounded-full`,`border-2`],[`initials`,``,1,`text-base-content`,`uppercase`,`opacity-60`],[`auth`,``,1,`flex`,`h-full`,`w-full`,`items-center`,`justify-center`,`object-cover`,`object-center`,3,`alt`,`source`]],template:function(n,c){n&1&&oc(0,ye,3,2,`div`,0),n&2&&ic(c.is_valid()?0:-1)},dependencies:[ue],encapsulation:2})}}return t})();export{ve as i,Ue as n,ue as r,Qe as t};
//# debugId=43bf6f18-36f4-5933-82d1-8be54f3e5671
//# sourceMappingURL=chunk-D0q_Oh1y.js.map