import {
  SpacesService
} from "./chunk-S7URZ5S6.js";
import {
  AssetListFieldComponent,
  CounterComponent,
  RecurrenceFieldComponent
} from "./chunk-6DYJVWR6.js";
import {
  UserListFieldComponent
} from "./chunk-BR243DUI.js";
import {
  HostSelectFieldComponent
} from "./chunk-UAQFPES3.js";
import {
  MatBottomSheet,
  MatBottomSheetModule,
  MatBottomSheetRef
} from "./chunk-YMXJUT2B.js";
import {
  ImageCarouselComponent
} from "./chunk-NQNKVSR6.js";
import {
  MapPinComponent
} from "./chunk-XMIVU47F.js";
import "./chunk-5V4URE3M.js";
import {
  BuildingPipe
} from "./chunk-IT5T3PXQ.js";
import {
  DEFAULT_COLOURS
} from "./chunk-USUV5JJA.js";
import {
  InteractiveMapComponent
} from "./chunk-VVVVIMZU.js";
import {
  DurationFieldComponent
} from "./chunk-IATN63QK.js";
import {
  DateFieldComponent,
  UserSearchFieldComponent
} from "./chunk-TTYDOBDW.js";
import "./chunk-K6L3GS53.js";
import {
  EventFormService
} from "./chunk-7S5TPFNO.js";
import "./chunk-NX53SQQB.js";
import "./chunk-GLHCWUFS.js";
import {
  AssetStateService
} from "./chunk-CGPIUSMZ.js";
import {
  subMinutes
} from "./chunk-CTGKKBLO.js";
import {
  RichTextInputComponent
} from "./chunk-AS6OROB3.js";
import {
  MatChip,
  MatChipSet,
  MatChipsModule
} from "./chunk-4DWXA23G.js";
import "./chunk-4O32ACI6.js";
import {
  SettingsToggleComponent
} from "./chunk-LL7UFDC6.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
  MatMenuTrigger,
  TimeFieldComponent
} from "./chunk-IRAJFMNZ.js";
import {
  AuthenticatedImageDirective,
  MatCheckbox,
  MatCheckboxModule,
  UserAvatarComponent
} from "./chunk-CJVBJOXN.js";
import {
  MatTooltip,
  MatTooltipModule
} from "./chunk-CNRULILI.js";
...
function FindAvailabilityModalComponent_For_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("user", user_r7)("date", ctx_r2.date())("availability", ctx_r2.availability()[user_r7.email.toLowerCase()] ?? \u0275\u0275pureFunction0(3, _c12));
  }
}
var FindAvailabilityModalComponent = class _FindAvailabilityModalComponent extends AsyncHandler {
  constructor() {
    ...
    this._container_el = viewChild.required(
      "container",
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FindAvailabilityModalComponent, selectors: [["find-availability-modal"]], viewQuery: function FindAvailabilityModalComponent_Query(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("user", ctx.host)("date", ctx.date())("availability", ctx.availability()[ctx.host.email.toLowerCase()] ?? \u0275\u0275pureFunction0(24, _c12));
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.users());
        \u0275\u0275advance(3);
...
function query_catering_types() {
  if (!_catering_types_promise) {
    _catering_types_promise = resolveCateringCategoryId().then((category_id) => Zl({ category_id, limit: 500 })).then((_) => _.data.filter((type) => isCateringTypeName(type.name))).catch(() => []);
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceFiltersDisplayComponent, selectors: [["space-filters-display"]], inputs: { view: [1, "view"] }, outputs: { viewChange: "viewChange" }, decls: 14, vars: 14, consts: [["filters", "", 1, "border-base-300", "bg-base-100", "sticky", "-top-1", "z-20", "-mx-1", "mb-4!", "flex", "w-[calc(100%+0.5rem)]", "flex-wrap", "items-center", "rounded-sm", "border", "p-1", "pr-10!", "sm:pr-1!"], ["btn", "", "matRipple", "", "name", "clear-space-filters", 1, "mr-2", "mb-2", "min-h-8"], ["filter-item", "", "zone", ""], ["filter-item", "", "date", ""], ["filter-item", "", "time", ""], ["filter-item", "", "count", ""], ["filter-item", ""], ["btn", "", "matRipple", "", "name", "clear-space-filters", 1, "mr-2", "mb-2", "min-h-8", 3, "click"], [1, "truncate"], ["icon", "", "matRipple", "", "name", "remove-space-filter", 1, "-mr-4", 3, "click"]], template: function SpaceFiltersDisplayComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 9, "CALENDAR_EVENT.SPACE_SELECT_SIZE_X", \u0275\u0275pureFunction1(12, _c03, ctx.filters()?.capacity || 2)), " ");
        \u0275\u0275advance(2);
...
function SpaceFiltersComponent_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.region())("ngModelOptions", \u0275\u0275pureFunction0(5, _c04))("placeholder", \u0275\u0275pipeBind1(2, 3, "COMMON.REGION_ANY"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
...
function SpaceFiltersComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.building())("ngModelOptions", \u0275\u0275pureFunction0(3, _c04))("placeholder", ctx_r1.building()?.display_name || ctx_r1.building()?.name);
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SpaceFiltersComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.options()?.zones)("ngModelOptions", \u0275\u0275pureFunction0(6, _c04))("placeholder", \u0275\u0275pipeBind1(2, 4, "COMMON.LEVEL_ANY"))("multiple", true);
    \u0275\u0275control();
    \u0275\u0275advance(2);
...
function SpaceFiltersComponent_Conditional_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.model().date_end)("ngModelOptions", \u0275\u0275pureFunction0(13, _c04))("from", ctx_r1.start_date)("to", ctx_r1.end_date())("short", true)("timezone", ctx_r1.timezone())("range", 2);
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SpaceFiltersComponent_Conditional_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.model().all_day)("ngModelOptions", \u0275\u0275pureFunction0(5, _c04));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SpaceFiltersComponent_Conditional_26_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.model().date_end)("ngModelOptions", \u0275\u0275pureFunction0(9, _c04))("from", ctx_r1.model().date)("use_24hr", ctx_r1.use_24hr())("timezone", ctx_r1.timezone())("range", ctx_r1.bookable_hours());
    \u0275\u0275control();
  }
}
...
function SpaceFiltersComponent_Conditional_26_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.model().date)("ngModelOptions", \u0275\u0275pureFunction0(11, _c04))("use_24hr", ctx_r1.use_24hr())("timezone", ctx_r1.timezone())("range", ctx_r1.bookable_hours())("min_duration", ctx_r1.effective_min_duration());
    \u0275\u0275control();
    \u0275\u0275advance();
...
function SpaceFiltersComponent_Conditional_27_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(6, 6, "COMMON.FAVOURITES_ONLY"))("ngModel", ctx_r1.filters()?.show_fav)("ngModelOptions", \u0275\u0275pureFunction0(8, _c04));
    \u0275\u0275control();
  }
}
function SpaceFiltersComponent_Conditional_28_For_4_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("label", ctx_r1.feature_display()[feat_r14] || feat_r14)("ngModel", ctx_r1.filters()?.features?.includes(feat_r14))("ngModelOptions", \u0275\u0275pureFunction0(3, _c04));
    \u0275\u0275control();
  }
}
...
var SpaceFiltersComponent = class _SpaceFiltersComponent {
  constructor() {
    ...
    this._allow_multiple = multipleSpacesSignal(this._settings);
    this.timezone = computed(
      () => this._allow_multiple() ? this.model().timezone || Intl.DateTimeFormat().resolvedOptions().timeZone : this._use_building_tz() ? this._org.active_building()?.timezone || "" : "",
    ...
    this._bookable_hours = settingSignal("events.bookable_hours", void 0);
    this.bookable_hours = computed(
      () => this._allow_multiple() ? void 0 : this._bookable_hours(),
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceFiltersComponent, selectors: [["space-filters"]], inputs: { multiday: [1, "multiday"], hide_levels: [1, "hide_levels"], viewing_map: [1, "viewing_map"] }, decls: 30, vars: 29, consts: [[1, "border-base-300", "bg-base-100", "sticky", "top-0", "z-10", "flex", "items-center", "border-b", "px-4", "py-4"], [1, "text-xl", "font-medium"], [1, "divide-base-200", "max-h-[65vh]", "w-full", "max-w-[100vw]", "divide-y", "overflow-x-hidden", "overflow-y-auto", "p-2"], ["details", ""], [1, "mb-1", "text-lg", "font-medium"], [1, "flex", "min-w-32", "flex-1", "flex-col"], ["for", "location"], ["appearance", "outline", 1, "w-full"], [1, "flex", "flex-wrap", "items-center", "sm:space-x-2"], [1, "min-w-32", "flex-1"], ["for", "date"], ["name", "date", 3, "ngModelChange", "ngModel", "ngModelOptions", "to", "short", "timezone", "range"], [1, "relative", "min-w-32", "flex-1"], [1, "-mt-2", "mb-2", "flex", "justify-end"], [1, "flex", "items-center", "space-x-2"], ["favs", "", 1, "space-y-2", "pb-4"], ["features", "", 1, "space-y-2"], [1, "border-base-200", "w-full", "border-t", "px-2", "pt-2"], ["name", "region", "aria-label", "Region", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "value"], ["name", "building", "aria-label", "Building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["name", "location", "aria-label", "Level", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder", "multiple"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], ["name", "date", 3, "ngModelChange", "ngModel", "ngModelOptions", "from", "to", "short", "timezone", "range"], [3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "w-1/3", "flex-1"], ["for", "start-time"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "use_24hr", "timezone", "range", "min_duration"], ["for", "end-time"], ["name", "end-time", 3, "ngModelChange", "ngModel", "ngModelOptions", "from", "use_24hr", "timezone", "range"], [3, "formField", "time", "max", "min", "step", "custom_options", "use_24hr", "timezone", "end_time"], [1, "mt-2", "text-lg", "font-medium"], [1, "flex", "w-full", "items-center"], [1, "w-full", 3, "ngModelChange", "label", "ngModel", "ngModelOptions"], [1, "flex", "items-center"], ["btn", "", "matRipple", "", "name", "apply-space-filters", 1, "w-full", 3, "click"]], template: function SpaceFiltersComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275property("ngModel", ctx.model().date)("ngModelOptions", \u0275\u0275pureFunction0(28, _c04))("to", ctx.end_date())("short", true)("timezone", ctx.timezone())("range", ctx.multiday() ? 1 : 0);
        \u0275\u0275control();
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SpaceFiltersComponent, { className: "SpaceFiltersComponent", filePath: "libs/events/src/lib/space-select-modal/space-filters.component.ts", lineNumber: 351 });
})();

// libs/events/src/lib/space-select-modal/space-list.component.ts
var _c05 = (a0) => ({ count: a0 });
var _c13 = (a0, a1) => ({ $implicit: a0, location: a1 });
var _c2 = (a0) => ({ $implicit: a0, location: "" });
var _forTrack0 = ($index, $item) => $item.space.id;
var _forTrack1 = ($index, $item) => $item.id;
function SpaceListComponent_Conditional_0_For_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275nextContext(2);
    const space_item_r2 = \u0275\u0275reference(10);
    \u0275\u0275property("ngTemplateOutlet", space_item_r2)("ngTemplateOutletContext", \u0275\u0275pureFunction2(2, _c13, item_r1.space, item_r1.location));
  }
}
function SpaceListComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, SpaceListComponent_Conditional_0_For_8_Template, 1, 5, "ng-container", 7, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 2, "RESOURCE.ROOMS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 4, "COMMON.SELECTED_COUNT", \u0275\u0275pureFunction1(7, _c05, ctx_r2.selected_spaces().length)), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.selected_spaces());
  }
}
function SpaceListComponent_Conditional_7_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0, 7);
  }
  if (rf & 2) {
    ...
    \u0275\u0275nextContext(3);
    const space_item_r2 = \u0275\u0275reference(10);
    \u0275\u0275property("ngTemplateOutlet", space_item_r2)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c2, space_r4));
  }
}
function SpaceListComponent_Conditional_7_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 8);
    \u0275\u0275repeaterCreate(1, SpaceListComponent_Conditional_7_Conditional_0_For_2_Template, 1, 4, "ng-container", 7, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.result_spaces());
  }
}
function SpaceListComponent_Conditional_7_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function SpaceListComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SpaceListComponent_Conditional_7_Conditional_0_Template, 3, 0, "ul", 8)(1, SpaceListComponent_Conditional_7_Conditional_1_Template, 4, 3, "div", 9);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.result_spaces().length ? 0 : 1);
  }
}
...
function SpaceListComponent_ng_template_9_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SpaceListComponent_ng_template_9_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 17);
  }
  if (rf & 2) {
    const space_r6 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("source", space_r6.images[0]);
  }
}
function SpaceListComponent_ng_template_9_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 18);
  }
}
function SpaceListComponent_ng_template_9_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28);
    \u0275\u0275listener("click", function SpaceListComponent_ng_template_9_Conditional_6_Template_div_click_0_listener($event) {
  ...
  if (rf & 2) {
    const space_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("bg-error", ctx_r2.room_alerts()[space_r6.id][0] === "closed")("bg-info", ctx_r2.room_alerts()[space_r6.id][0] === "info")("bg-warning", ctx_r2.room_alerts()[space_r6.id][0] === "warn")("text-error-content", ctx_r2.room_alerts()[space_r6.id][0] === "closed")("text-info-content", ctx_r2.room_alerts()[space_r6.id][0] === "info")("text-warning-content", ctx_r2.room_alerts()[space_r6.id][0] === "warn");
    \u0275\u0275property("matTooltip", ctx_r2.room_alerts()[space_r6.id][1]);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.room_alerts()[space_r6.id][0] === "warn" ? "warning" : ctx_r2.room_alerts()[space_r6.id][0] === "info" ? "info" : "close");
  }
}
function SpaceListComponent_ng_template_9_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
...
function SpaceListComponent_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SpaceListComponent_ng_template_9_Template_button_click_1_listener() {
      const space_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.selectSpace(space_r6));
    });
    \u0275\u0275elementStart(2, "div", 15);
    \u0275\u0275conditionalCreate(3, SpaceListComponent_ng_template_9_Conditional_3_Template, 3, 0, "div", 16);
    \u0275\u0275conditionalCreate(4, SpaceListComponent_ng_template_9_Conditional_4_Template, 1, 1, "img", 17)(5, SpaceListComponent_ng_template_9_Conditional_5_Template, 1, 0, "img", 18);
    \u0275\u0275conditionalCreate(6, SpaceListComponent_ng_template_9_Conditional_6_Template, 3, 14, "div", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 20)(8, "div", 21);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 22)(11, "icon", 23);
    \u0275\u0275text(12, "place");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "p", 24);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 22)(16, "icon", 23);
    \u0275\u0275text(17, "people");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "p");
    \u0275\u0275text(19);
    ...
    \u0275\u0275listener("click", function SpaceListComponent_ng_template_9_Template_button_click_21_listener() {
      const space_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleFav.emit(space_r6));
    });
    \u0275\u0275elementStart(22, "icon", 26);
    \u0275\u0275text(23, "favorite");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(24, SpaceListComponent_ng_template_9_Conditional_24_Template, 3, 3, "div", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("border-info!", ctx_r2.active() === space_r6.id)("bg-error-light!", ctx_r2.room_alerts()[space_r6.id] ? ctx_r2.room_alerts()[space_r6.id][0] === "closed" : false);
    \u0275\u0275advance();
    \u0275\u0275classProp("pointer-events-none", ctx_r2.room_alerts()[space_r6.id] ? ctx_r2.room_alerts()[space_r6.id][0] === "closed" : false);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.selected().includes(space_r6.id) ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(space_r6.images?.length ? 4 : 5);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.room_alerts()[space_r6.id] ? 6 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", space_r6.display_name || space_r6.name || "Meeting Space", " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", location_r7 || ctx_r2.spaceLocation(space_r6), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(20, 16, "CALENDAR_EVENT.CAPACITY_COUNT", \u0275\u0275pureFunction1(19, _c05, space_r6.capacity < 1 ? 2 : space_r6.capacity)), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("text-info", ctx_r2.isFavourite(space_r6.id));
    \u0275\u0275advance();
    \u0275\u0275property("className", ctx_r2.isFavourite(space_r6.id) ? "material-symbols-rounded" : "material-symbols-outlined");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(space_r6.approval ? 24 : -1);
  }
}
var SpaceListComponent = class _SpaceListComponent {
  constructor() {
    ...
    this.result_spaces = computed(
      () => {
        const selected_ids = new Set(this.selected_spaces().map((item) => item.space.id));
        return (this.available_spaces() || []).filter((space) => !selected_ids.has(space.id));
      },
      ...ngDevMode ? [{ debugName: "result_spaces" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  spaceLocation(space) {
    return this._org.locationWithID(space.zones).label || space.level?.display_name || space.level?.name;
  }
  ngOnInit() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceListComponent, selectors: [["space-list"]], inputs: { active: [1, "active"], selected: [1, "selected"], selected_spaces: [1, "selected_spaces"], favorites: [1, "favorites"] }, outputs: { onSelect: "onSelect", toggleFav: "toggleFav" }, decls: 11, vars: 12, consts: [["space_item", ""], [1, "px-2", "font-bold"], ["count", "", 1, "mb-4", "px-2", "text-sm", "opacity-60"], ["loading", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], ["selected-spaces-heading", "", 1, "px-2", "font-bold"], ["selected-spaces-count", "", 1, "mb-2", "px-2", "text-sm", "opacity-60"], ["selected-spaces", "", 1, "list-style-none", "mb-4", "space-y-2"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], ["results", "", 1, "list-style-none", "space-y-2"], ["empty", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], [1, "text-center", "opacity-30"], [3, "diameter"], [1, "opacity-30"], ["space", "", 1, "border-base-200", "bg-base-100", "relative", "w-full", "rounded-lg", "border", "p-2", "shadow-sm"], ["matRipple", "", "name", "select-space", 1, "flex", "h-full", "w-full", "items-center", "rounded-sm", 3, "click"], [1, "bg-base-200", "relative", "mr-4", "flex", "h-20", "w-20", "min-w-20", "items-center", "justify-center", "overflow-hidden", "rounded-xl"], [1, "border-neutral", "bg-base-200", "absolute", "top-1", "left-1", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "border"], ["auth", "", 1, "h-full", "object-cover", 3, "source"], ["src", "assets/icons/room-placeholder.svg", 1, "m-auto"], [1, "pointer-events-auto", "absolute", "bottom-1", "left-1", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", 3, "matTooltip", "bg-error", "bg-info", "bg-warning", "text-error-content", "text-info-content", "text-warning-content"], [1, "w-full", "space-y-2"], [1, "mr-10", "truncate", "text-left", "font-medium"], [1, "flex", "items-center", "space-x-2", "text-sm"], [1, "text-info"], [1, "truncate"], ["icon", "", "matRipple", "", "name", "toggle-space-favourite", 1, "absolute", "top-1", "right-1", 3, "click"], [3, "className"], [1, "bg-warning", "text-warning-content", "absolute", "right-1", "bottom-1", "w-14", "rounded-sm", "px-2", "py-1", "text-center", "text-[0.625rem]", "leading-tight", "font-medium"], [1, "pointer-events-auto", "absolute", "bottom-1", "left-1", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", 3, "click", "matTooltip"]], template: function SpaceListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, SpaceListComponent_Conditional_0_Template, 9, 9);
        ...
        \u0275\u0275pipe(6, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(7, SpaceListComponent_Conditional_7_Template, 2, 1)(8, SpaceListComponent_Conditional_8_Template, 5, 4, "div", 3);
        \u0275\u0275template(9, SpaceListComponent_ng_template_9_Template, 25, 21, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        \u0275\u0275conditional(ctx.selected_spaces().length ? 0 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 4, "COMMON.RESULTS"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(6, 6, "COMMON.RESULTS_COUNT", \u0275\u0275pureFunction1(10, _c05, ctx.result_spaces().length), ctx.result_spaces().length), " ");
        \u0275\u0275advance(2);
...
(() => {
  ...
  }], null, { active: [{ type: Input, args: [{ isSignal: true, alias: "active", required: false }] }], selected: [{ type: Input, args: [{ isSignal: true, alias: "selected", required: false }] }], selected_spaces: [{ type: Input, args: [{ isSignal: true, alias: "selected_spaces", required: false }] }], favorites: [{ type: Input, args: [{ isSignal: true, alias: "favorites", required: false }] }], onSelect: [{ type: Output, args: ["onSelect"] }], toggleFav: [{ type: Output, args: ["toggleFav"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SpaceListComponent, { className: "SpaceListComponent", filePath: "libs/events/src/lib/space-select-modal/space-list.component.ts", lineNumber: 227 });
})();
...
function SpaceMapComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(5, _c14))("placeholder", \u0275\u0275pipeBind1(3, 3, "COMMON.LEVEL_ANY"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.levels());
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceMapComponent, selectors: [["space-map"]], inputs: { selected: [1, "selected"], active: [1, "active"], is_displayed: [1, "is_displayed"] }, outputs: { onSelect: "onSelect" }, decls: 3, vars: 9, consts: [[1, "border-base-200", "bg-base-100", "w-full", "border-b", "p-2"], [1, "relative", "w-full", "flex-1"], [3, "zoomChange", "centerChange", "src", "zoom", "center", "styles", "features", "actions", "options"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["name", "location", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "value"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"]], template: function SpaceMapComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("styles", ctx.styles())("features", ctx.features())("actions", ctx.actions())("options", \u0275\u0275pureFunction0(8, _c06));
      }
    }, dependencies: [
      InteractiveMapComponent,
      MatFormFieldModule,
...
function SpaceSelectModalComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("toggleFav", function SpaceSelectModalComponent_Conditional_22_Template_space_list_toggleFav_0_listener($event) {
      ...
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.selectSpace($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("active", ctx_r1.displayed()?.id)("selected", ctx_r1.selected_ids())("selected_spaces", ctx_r1.allow_multiple() ? ctx_r1.selected_locations() : \u0275\u0275pureFunction0(4, _c07))("favorites", ctx_r1.favorites());
  }
}
...
var SpaceSelectModalComponent = class _SpaceSelectModalComponent {
  constructor() {
    ...
    this.selected_locations = computed(
      () => {
        return this.selected().map((space) => {
          const { level, building, region, label: location2 } = this._org.locationWithID(space.zones);
          return { space, level, building, region, location: location2 };
        });
      },
      ...ngDevMode ? [{ debugName: "selected_locations" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this.favorites = settingSignal("favourite_spaces", [], true);
    ...
    this._remove_stale_selections = effect(
      () => {
        const loaded_lists = __spreadProps(__spreadValues({}, this._event_form.loaded_space_lists()), {
          [this._event_form.loaded_space_zone()]: this._event_form.spaces()
        });
        const stale = this.selected().filter((space) => {
          const matching_lists = Object.entries(loaded_lists).filter(([zone_id]) => zone_id && space.zones.includes(zone_id));
          return matching_lists.some(([, spaces]) => !spaces.some((candidate) => candidate.id === space.id));
        });
        if (!stale.length)
          return;
        const stale_ids = new Set(stale.map((space) => space.id));
        this.selected.update((spaces) => spaces.filter((space) => !stale_ids.has(space.id)));
      },
      ...ngDevMode ? [{ debugName: "_remove_stale_selections" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  async returnToSpace(space) {
    const item = this.selected_locations().find((_) => _.space.id === space.id);
    if (!item)
      return;
    if (item.region)
      await this._org.setRegion(item.region);
    if (item.building)
      this._org.setBuilding(item.building);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceSelectModalComponent, selectors: [["space-select-modal"]], decls: 37, vars: 64, consts: [[1, "bg-base-100", "mb-18", "flex", "h-[calc(100vh-4.5rem)]", "max-h-[calc(100vh-4.5rem)]", "w-screen", "flex-col", "space-y-2", "overflow-hidden", "p-2", "sm:m-0", "sm:h-auto", "sm:w-auto"], [1, "bg-base-200", "flex", "h-14", "w-full", "items-center", "space-x-2", "rounded-sm", "border-none", "p-2"], [1, "flex-1", "px-2", "text-xl", "font-medium", "capitalize"], [1, "divide-secondary", "border-secondary", "flex", "divide-x", "rounded-sm", "border"], ["icon", "", "matRipple", "", 1, "rounded-l", "rounded-r-none", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "rounded-l-none", "rounded-r", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "relative", "flex", "h-1/2", "max-h-[calc(100vh-7rem)]", "flex-1", "sm:h-[65vh]", "sm:flex-none", "sm:space-x-2"], ["filters", "", 1, "border-base-300", "h-full", "w-full", "overflow-x-hidden", "overflow-y-auto", "rounded-sm", "border", "shadow-sm", "sm:block", "sm:w-80"], [3, "hide_levels"], ["list", "", 1, "border-base-300", "bg-base-200", "h-full", "w-full", "overflow-auto", "rounded-sm", "border", "sm:w-80", "md:w-112", "lg:block"], [3, "view"], ["list", "", 3, "active", "selected", "selected_spaces", "favorites"], ["map", "", 1, "h-full", "min-h-[60vh]", "w-full", 3, "is_displayed", "active"], [1, "border-base-300", "relative", "h-full", "w-full", "overflow-auto", "rounded-sm", "border", "shadow-sm", "sm:w-[20rem]"], ["icon", "", "matRipple", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "left-2", "z-20", "hidden", "border", "md:flex"], ["details", "", 3, "activeChange", "toggleFav", "close", "space", "active", "hide_map", "fav"], ["icon", "", "matRipple", "", 1, "border-base-200", "bg-base-100", "absolute", "top-3", "right-2", "z-20", "border", "sm:hidden"], [1, "bg-base-200", "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "border-none", "p-2"], ["btn", "", "matRipple", "", "name", "space-return", 1, "inverse", "bg-base-100", "text-secondary", 3, "mat-dialog-close"], ["btn", "", "matRipple", "", "name", "toggle-space", 3, "click", "disabled"], [1, "flex", "items-center"], [1, "text-xl"], [1, "mr-1"], [3, "viewChange", "view"], ["list", "", 3, "toggleFav", "onSelect", "active", "selected", "selected_spaces", "favorites"], ["map", "", 1, "h-full", "min-h-[60vh]", "w-full", 3, "onSelect", "is_displayed", "active"], ["icon", "", "matRipple", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "left-2", "z-20", "hidden", "border", "md:flex", 3, "click"], ["icon", "", "matRipple", "", 1, "border-base-200", "bg-base-100", "absolute", "top-3", "right-2", "z-20", "border", "sm:hidden", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"]], template: function SpaceSelectModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(22, SpaceSelectModalComponent_Conditional_22_Template, 1, 5, "space-list", 12)(23, SpaceSelectModalComponent_Conditional_23_Template, 1, 2, "space-map", 13);
        \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SpaceSelectModalComponent, { className: "SpaceSelectModalComponent", filePath: "libs/events/src/lib/space-select-modal/space-select-modal.component.ts", lineNumber: 249 });
})();
...
function MeetingFlowConfirmComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 18);
    \u0275\u0275listener("click", function MeetingFlowConfirmComponent_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function MeetingFlowConfirmComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowConfirmComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowConfirmComponent_Conditional_26_For_10_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowConfirmComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(9, MeetingFlowConfirmComponent_Conditional_26_For_10_Template, 6, 1, "mat-chip", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 1, "CALENDAR_EVENT.ATTENDEE_COUNT", \u0275\u0275pureFunction1(4, _c08, ctx_r1.event.attendees.length)), " ");
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r1.event.attendees);
  }
}
function MeetingFlowConfirmComponent_Conditional_27_For_8_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowConfirmComponent_Conditional_27_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "icon", 8);
    \u0275\u0275text(2, "meeting_room");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 25)(4, "div");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, MeetingFlowConfirmComponent_Conditional_27_For_8_Conditional_6_Template, 2, 1, "div", 26);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", ctx_r1.spaceLocation(s_r4), " / ", s_r4.display_name || s_r4.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r1.roomTime(s_r4)) ? 6 : -1, tmp_12_0);
  }
}
function MeetingFlowConfirmComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(7, MeetingFlowConfirmComponent_Conditional_27_For_8_Template, 7, 3, "div", 24, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 1, "APP.WORKPLACE.MEETING_BOOKED_ROOM"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.event.resources);
  }
}
function MeetingFlowConfirmComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 15)(1, "div", 27);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
  }
...
var MeetingFlowConfirmComponent = class _MeetingFlowConfirmComponent extends AsyncHandler {
  ...
  roomTime(space) {
    ...
    const room_timezone = this._org.locationWithID(space.zones).building?.timezone;
    const user_timezone = this.event.timezone || Intl.DateTimeFormat().resolvedOptions().timeZone;
    if (!room_timezone || !user_timezone)
      return "";
    try {
      ...
      return room_offset === user_offset ? "" : this.formattedTime(room_offset);
    } catch {
      return "";
    }
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowConfirmComponent, selectors: [["meeting-flow-confirm"]], inputs: { show_close: [1, "show_close"] }, outputs: { show_close: "show_closeChange" }, features: [\u0275\u0275ProvidersFeature([SpacePipe]), \u0275\u0275InheritDefinitionFeature], decls: 33, vars: 20, consts: [[1, "bg-base-200", "sticky", "top-2", "z-10", "mx-auto", "mb-4", "flex", "h-14", "w-full", "max-w-[calc(100%-1rem)]", "items-center", "justify-between", "rounded-sm", "border-none", "px-4", "py-2"], [1, "m-0", "flex-1", "text-xl", "font-medium", "capitalize"], ["diameter", "32"], ["icon", "", "matRipple", ""], ["period", "", 1, "flex", "space-x-1", "px-2"], [1, "text-success", "mt-1"], ["details", "", 1, "leading-6"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], ["date", ""], [1, "flex", "flex-col", "leading-tight"], ["time", ""], [1, "text-xs", "opacity-30"], ["attendees", "", 1, "mt-2", "flex", "space-x-1", "px-2"], ["spaces", "", 1, "mt-2", "flex", "space-x-1", "px-2"], [1, "px-2", "pt-4"], [1, "border-base-200", "mt-4", "w-full", "border-t", "p-2"], ["btn", "", "name", "confirm-meeting", "matRipple", "", 1, "w-full", 3, "click", "disabled"], ["icon", "", "matRipple", "", 3, "click"], ["attendee-list", ""], ["aria-label", "User selection"], [1, "flex", "items-center"], [1, "mr-2"], [1, "max-w-[50vw]", "truncate"], [1, "flex", "items-start", "space-x-2"], [1, "flex", "flex-col"], ["room-time", "", 1, "text-xs", "opacity-60"], [1, "bg-warning", "text-warning-content", "rounded-sm", "border-none!", "px-2", "py-1", "text-center", "text-sm"]], template: function MeetingFlowConfirmComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(5, MeetingFlowConfirmComponent_Conditional_5_Template, 3, 0, "button", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "section", 4)(7, "icon", 5);
        \u0275\u0275text(8, "done");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(9, "div", 6)(10, "h3");
        \u0275\u0275text(11);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "div", 7)(13, "icon", 8);
        \u0275\u0275text(14, "today");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(17, "date");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(18, MeetingFlowConfirmComponent_Conditional_18_Template, 5, 1, "div", 7);
        \u0275\u0275elementStart(19, "div", 7)(20, "icon", 8);
        \u0275\u0275text(21, "schedule");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(22, "div", 10)(23, "div", 11);
        \u0275\u0275text(24);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(25, MeetingFlowConfirmComponent_Conditional_25_Template, 2, 1, "div", 12);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275conditionalCreate(26, MeetingFlowConfirmComponent_Conditional_26_Template, 11, 6, "section", 13);
        \u0275\u0275conditionalCreate(27, MeetingFlowConfirmComponent_Conditional_27_Template, 9, 3, "section", 14);
        \u0275\u0275conditionalCreate(28, MeetingFlowConfirmComponent_Conditional_28_Template, 4, 3, "section", 15);
        \u0275\u0275elementStart(29, "footer", 16)(30, "button", 17);
        \u0275\u0275listener("click", function MeetingFlowConfirmComponent_Template_button_click_30_listener() {
          return ctx.postForm();
        });
        \u0275\u0275text(31);
        \u0275\u0275pipe(32, "translate");
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.show_close() && !ctx.loading() ? 5 : -1);
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(ctx.event.title || "Meeting Details");
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(17, 15, ctx.event.date, "fullDate"));
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.event.recurrence?.pattern ? 18 : -1);
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(ctx.formattedTime());
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.timezone ? 25 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.event.attendees?.length ? 26 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.event.resources?.length ? 27 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.requires_approval ? 28 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", ctx.loading());
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(32, 18, "COMMON.CONFIRM"), " ");
      }
    }, dependencies: [
      CommonModule,
      MatProgressSpinnerModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MeetingFlowConfirmComponent, [{
    type: Component,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmComponent, { className: "MeetingFlowConfirmComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm.component.ts", lineNumber: 183 });
})();
...
function getCateringRulesForZone(zone_id, fresh = false) {
  ...
  if (!RULE_REQUESTS[zone_id] || fresh)
    RULE_REQUESTS[zone_id] = ic(zone_id, "catering_config").then((_) => _.details instanceof Array ? _.details : []).catch(() => []);
...
var CateringOrderStateService = class _CateringOrderStateService {
  ...
  async orderAvailable(order, resource2, details) {
    if (this.availability().includes(resource2.id))
      return false;
    const rules = await getCateringRulesForZone(details.zone_id);
    const available_items = this._available_menu().filter((item) => !item.hide_for_zones.some((zone) => resource2.zones.includes(zone)) && cateringItemAvailable(item, rules, {
      date: details.date,
      duration: details.duration,
      resources: [resource2]
    }));
    return order.items.every((order_item) => available_items.some((item) => item.id === order_item.id && item.caterer === order_item.caterer));
  }
  async _loadSettings(building_id) {
    const metadata = await ic(building_id, "catering-settings").catch(() => ({}));
...
function CateringItemListComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 4, "CATERING.ORDER_SELECTED_COUNT", \u0275\u0275pureFunction1(7, _c09, ctx_r2.list().length || 0)), " ");
    \u0275\u0275advance(3);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringItemListComponent, selectors: [["catering-item-list"]], inputs: { active: [1, "active"], selected: [1, "selected"], selected_items: [1, "selected_items"], favorites: [1, "favorites"] }, outputs: { toggleFav: "toggleFav", onSelect: "onSelect" }, decls: 10, vars: 11, consts: [[1, "h-full", "w-full", "py-2"], [1, "px-2", "font-bold"], ["count", "", 1, "mb-2", "px-2", "text-sm", "opacity-60"], ["loading", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], [1, "list-style-none", "space-y-2", "p-2"], [1, "block", 3, "item", "active", "show_count", "favourite"], [1, "block", 3, "toggleFav", "select", "item", "active", "show_count", "favourite"], ["empty", "", 1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-16"], [1, "block", 3, "item", "active", "show_count", "favourite", "code"], [1, "block", 3, "toggleFav", "select", "item", "active", "show_count", "favourite", "code"], [1, "text-center", "opacity-30"], [3, "diameter"], [1, "opacity-30"]], template: function CateringItemListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 6, "COMMON.RESULTS_COUNT", \u0275\u0275pureFunction1(9, _c09, ctx.item_list().length || 0)), " ");
        \u0275\u0275advance(2);
...
var _c010 = (a0, a1) => ({ date: a0, time: a1 });
var _c15 = (a0, a1) => ({ count: a0, cost: a1 });
var _c22 = (a0) => ({ count: a0 });
var _forTrack02 = ($index, $item) => $item.id;
var _forTrack12 = ($index, $item) => $item.custom_id;
function CateringListFieldComponent_For_2_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function CateringListFieldComponent_For_2_For_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function CateringListFieldComponent_For_2_For_12_Template_button_click_0_listener() {
      const room_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const order_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.editOrder(order_r4, room_r3));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r4.spaceLabel(room_r3), " ");
  }
}
function CateringListFieldComponent_For_2_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275property("matTooltip", ctx_r4.err_tooltip());
  }
}
function CateringListFieldComponent_For_2_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 17);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function CateringListFieldComponent_For_2_Conditional_24_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const order_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.duplicateOrder(order_r4));
    });
...
function CateringListFieldComponent_For_2_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 17);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function CateringListFieldComponent_For_2_Conditional_25_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const order_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.editOrder(order_r4));
    });
    \u0275\u0275elementStart(2, "icon");
    \u0275\u0275text(3, "edit");
    \u0275\u0275elementEnd()();
...
function CateringListFieldComponent_For_2_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 21);
    \u0275\u0275listener("click", function CateringListFieldComponent_For_2_Conditional_26_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const order_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.removeOrder(order_r4));
    });
    \u0275\u0275elementStart(1, "icon");
    \u0275\u0275text(2, "delete");
    \u0275\u0275elementEnd()();
...
function CateringListFieldComponent_For_2_For_33_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275property("matTooltip", ctx_r4.optionList(item_r10));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, "CALENDAR_EVENT.CATERING_ORDER_OPTION_COUNT", \u0275\u0275pureFunction1(5, _c22, item_r10.option_list?.length || "0")), " ");
  }
}
function CateringListFieldComponent_For_2_For_33_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 29);
    \u0275\u0275listener("click", function CateringListFieldComponent_For_2_For_33_Conditional_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const item_r10 = \u0275\u0275nextContext().$implicit;
      const order_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.removeOrderItem(order_r4, item_r10));
    });
    \u0275\u0275elementStart(1, "icon");
    \u0275\u0275text(2, "delete");
    \u0275\u0275elementEnd()();
...
function CateringListFieldComponent_For_2_For_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 19)(1, "div", 22);
    \u0275\u0275text(2);
    \u0275\u0275conditionalCreate(3, CateringListFieldComponent_For_2_For_33_Conditional_3_Template, 3, 7, "span", 23);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(8, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, CateringListFieldComponent_For_2_For_33_Conditional_9_Template, 3, 0, "button", 26);
    \u0275\u0275elementStart(10, "button", 27);
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275listener("click", function CateringListFieldComponent_For_2_For_33_Template_button_click_10_listener() {
      const item_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.toggleFavourite(item_r10));
    });
    \u0275\u0275elementStart(12, "icon", 28);
    \u0275\u0275text(13, "favorite");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", item_r10.name || "Item", " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r10.option_list?.length ? 3 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" x", item_r10.quantity, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(8, 9, item_r10.unit_price_with_options / 100, ctx_r4.currency_code()), " ea ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r4.disabled() ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("text-info", ctx_r4.favorites().includes(item_r10.id));
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(11, 12, ctx_r4.favorites().includes(item_r10.id) ? "COMMON.FAVOURITES_REMOVE" : "COMMON.FAVOURITES_ADD"));
    \u0275\u0275advance(2);
    \u0275\u0275property("className", ctx_r4.favorites().includes(item_r10.id) ? "material-symbols-rounded" : "material-symbols-outlined");
  }
}
function CateringListFieldComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 8)(2, "div", 9)(3, "button", 10)(4, "icon", 11);
    \u0275\u0275text(5, "meeting_room");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "span");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, CateringListFieldComponent_For_2_Conditional_8_Template, 2, 0, "icon", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "mat-menu", null, 1);
    \u0275\u0275repeaterCreate(11, CateringListFieldComponent_For_2_For_12_Template, 2, 1, "button", 6, _forTrack02);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 12)(14, "div");
    \u0275\u0275text(15);
    \u0275\u0275pipe(16, "date");
    \u0275\u0275pipe(17, "date");
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(19, CateringListFieldComponent_For_2_Conditional_19_Template, 3, 1, "div", 13);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(24, CateringListFieldComponent_For_2_Conditional_24_Template, 4, 3, "button", 15);
    \u0275\u0275conditionalCreate(25, CateringListFieldComponent_For_2_Conditional_25_Template, 4, 3, "button", 15);
    \u0275\u0275conditionalCreate(26, CateringListFieldComponent_For_2_Conditional_26_Template, 3, 0, "button", 16);
    \u0275\u0275elementStart(27, "button", 17);
    \u0275\u0275pipe(28, "translate");
    \u0275\u0275listener("click", function CateringListFieldComponent_For_2_Template_button_click_27_listener() {
      const order_r4 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleOrder(order_r4.id));
    });
    \u0275\u0275elementStart(29, "icon");
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "div", 18);
    \u0275\u0275repeaterCreate(32, CateringListFieldComponent_For_2_For_33_Template, 14, 14, "div", 19, _forTrack12);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const order_r4 = ctx.$implicit;
    const room_menu_r12 = \u0275\u0275reference(10);
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275classProp("border-error", ctx_r4.end_time() < order_r4.deliver_at)("border-base-300", ctx_r4.end_time() >= order_r4.deliver_at);
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx_r4.disabled())("matMenuTriggerFor", room_menu_r12);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r4.roomLabel(order_r4));
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r4.disabled() ? 8 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r4.rooms());
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(18, 24, "CALENDAR_EVENT.CATERING_ORDER_AT_DATE", \u0275\u0275pureFunction2(35, _c010, \u0275\u0275pipeBind2(16, 18, order_r4.deliver_at, "mediumDate"), \u0275\u0275pipeBind2(17, 21, order_r4.deliver_at, ctx_r4.time_format()))), " ");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r4.end_time() < order_r4.deliver_at ? 19 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(23, 30, "CALENDAR_EVENT.CATERING_ORDER_DETAILS", \u0275\u0275pureFunction2(38, _c15, order_r4.item_count, \u0275\u0275pipeBind2(22, 27, order_r4.total_cost / 100, ctx_r4.currency_code()))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx_r4.disabled() ? 24 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r4.disabled() ? 25 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r4.disabled() ? 26 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(28, 33, ctx_r4.show_order()[order_r4.id] ? "CALENDAR_EVENT.CATERING_ORDER_HIDE" : "CALENDAR_EVENT.CATERING_ORDER_SHOW"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r4.show_order()[order_r4.id] ? "expand_less" : "expand_more", " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("contract-collapsed", !ctx_r4.show_order()[order_r4.id]);
    \u0275\u0275advance();
    \u0275\u0275repeater(order_r4.items);
  }
}
function CateringListFieldComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function CateringListFieldComponent_For_13_Template_button_click_0_listener() {
      const room_r14 = \u0275\u0275restoreView(_r13).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.addOrder(room_r14));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r4.spaceLabel(room_r14), " ");
  }
}
var EMPTY_FAVS2 = [];
var CateringListFieldComponent = class _CateringListFieldComponent {
  constructor() {
    ...
    this.multiple_spaces = this._settings.signal("events.multiple_spaces", false);
    this.requires_room_selection = computed(
      () => this.rooms().length > 1 && !!this.multiple_spaces(),
      ...ngDevMode ? [{ debugName: "requires_room_selection" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  ngOnChanges(changes) {
    if (changes.options) {
      ...
      const room_ids = new Set((options.resources || []).flatMap((_) => [_.id, _.email]));
      const orders = this.orders().filter((_) => !("resources" in options) || !_.system_id || room_ids.has(_.system_id)).map((_) => new CateringOrder(__spreadProps(__spreadValues({}, _), { event: options })));
  ...
  addOrder(room) {
    ...
    if (!assigned_room)
      return;
    this.editOrder(new CateringOrder({ system_id: assigned_room.id }), assigned_room);
  }
  ...
  editOrder(order = new CateringOrder(), room) {
    const assigned_room = room || this.roomFor(order) || this._defaultRoom();
    if (!assigned_room)
      return;
    const options = this.options();
    const optionsValue = this.options();
    const location2 = this._org.locationWithID(assigned_room.zones);
    const zone_id = assigned_room.level?.parent_id || this._org.levelWithID(assigned_room.zones)?.parent_id || location2.building?.id || options.zone_id;
    this._state.setOptions({
      building: location2.building?.id,
      zone: zone_id
    });
  ...
  roomFor(order) {
    if (!order.system_id)
      return void 0;
    return this.rooms().find((_) => _.id === order.system_id || _.email === order.system_id);
  }
  roomLabel(order) {
    const room = this.roomFor(order);
    return room ? this.spaceLabel(room) : i18n("CALENDAR_EVENT.ROOM_REQUIRED");
  }
  spaceLabel(room) {
    const location2 = this._org.locationWithID(room.zones)?.label;
    const room_name = room.display_name || room.name;
    return [location2, room_name].filter((_) => !!_).join(" / ");
  }
  _defaultRoom() {
    const rooms = this.rooms();
    return rooms.length === 1 || !this.multiple_spaces() ? rooms[0] : void 0;
  }
  ...
  static {
    ...
    ]), \u0275\u0275NgOnChangesFeature], decls: 14, vars: 5, consts: [["add_room_menu", "matMenu"], ["room_menu", "matMenu"], ["list", "", 1, "space-y-2"], ["order", "", 1, "bg-base-100", "overflow-hidden", "rounded-xl", "border", "shadow-sm", 3, "border-error", "border-base-300"], ["btn", "", "matRipple", "", "name", "add-catering-item", 1, "inverse", "mt-2", "w-full", 3, "click", "disabled", "matMenuTriggerFor"], [1, "flex", "items-center", "justify-center", "space-x-2"], ["mat-menu-item", ""], ["order", "", 1, "bg-base-100", "overflow-hidden", "rounded-xl", "border", "shadow-sm"], [1, "flex", "items-center", "space-x-2", "p-4"], [1, "flex-1"], ["room", "", 1, "mb-1", "flex", "items-center", "space-x-1", "text-left", "text-sm", 3, "disabled", "matMenuTriggerFor"], [1, "text-lg"], [1, "flex", "items-center", "space-x-4"], [1, "bg-error", "text-error-content", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", 3, "matTooltip"], [1, "text-xs", "opacity-60"], ["icon", "", "matRipple", "", 3, "matTooltip"], ["icon", "", "matRipple", "", "matTooltip", "Remove Order", 1, "text-error"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "contract-expand", "divide-base-100", "bg-base-200", "flex", "flex-col", "divide-y"], [1, "flex", "items-center", "space-x-2", "px-4", "py-1", "hover:opacity-90"], ["mat-menu-item", "", 3, "click"], ["icon", "", "matRipple", "", "matTooltip", "Remove Order", 1, "text-error", 3, "click"], [1, "flex", "flex-1", "items-center"], [1, "ml-4", "text-xs", "font-normal", "opacity-60", 3, "matTooltip"], [1, "bg-success", "text-success-content", "rounded-sm", "px-2", "py-1", "text-xs"], [1, "bg-info", "text-info-content", "rounded-sm", "px-2", "py-1", "text-xs"], ["icon", "", "matRipple", "", "matTooltip", "Remove Order Item", 1, "text-error"], ["icon", "", "matRipple", "", "name", "toggle-catering-item-favourite", 3, "click", "matTooltip"], [3, "className"], ["icon", "", "matRipple", "", "matTooltip", "Remove Order Item", 1, "text-error", 3, "click"]], template: function CateringListFieldComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 2);
        \u0275\u0275repeaterCreate(1, CateringListFieldComponent_For_2_Template, 34, 41, "div", 3, _forTrack02);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(3, "button", 4);
        \u0275\u0275listener("click", function CateringListFieldComponent_Template_button_click_3_listener() {
          return ctx.addOrder();
        });
        \u0275\u0275elementStart(4, "div", 5)(5, "icon");
        \u0275\u0275text(6, "search");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275repeaterCreate(12, CateringListFieldComponent_For_13_Template, 2, 1, "button", 6, _forTrack02);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        const add_room_menu_r15 = \u0275\u0275reference(11);
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.orders());
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", ctx.disabled() || !ctx.rooms().length)("matMenuTriggerFor", ctx.requires_room_selection() ? add_room_menu_r15 : null);
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 3, "CALENDAR_EVENT.CATERING_ORDER_ADD"), " ");
        \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringListFieldComponent, { className: "CateringListFieldComponent", filePath: "libs/catering/src/lib/catering-list-field.component.ts", lineNumber: 295 });
})();
...
function SpaceListFieldComponent_For_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", ctx_r2.location(space_r2), " ");
    \u0275\u0275advance(5);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SpaceListFieldComponent, selectors: [["space-list-field"]], inputs: { multiday: [1, "multiday"] }, features: [\u0275\u0275ProvidersFeature([
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(5);
        \u0275\u0275property("ngModel", ctx.room_size())("ngModelOptions", \u0275\u0275pureFunction0(25, _c011));
        ...
        \u0275\u0275property("value", 4);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 17, "CALENDAR_EVENT.SPACE_SELECT_SIZE_X", \u0275\u0275pureFunction0(26, _c16)), " ");
        \u0275\u0275advance(2);
        \u0275\u0275property("value", 10);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(19, 20, "CALENDAR_EVENT.SPACE_SELECT_SIZE_X", \u0275\u0275pureFunction0(27, _c23)), " ");
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SpaceListFieldComponent, { className: "SpaceListFieldComponent", filePath: "libs/form-fields/src/lib/space-list-field.component.ts", lineNumber: 208 });
})();
...
function MeetingFormDetailsComponent_Conditional_0_Conditional_14_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r0.model().date_end)("ngModelOptions", \u0275\u0275pureFunction0(10, _c012))("from", ctx_r0.model()?.date + 30 * 60 * 1e3)("range", ctx_r0.bookable_hours())("use_24hr", ctx_r0.use_24hr())("extra_info_fn", ctx_r0.duration_info)("timezone", ctx_r0.timezone());
    \u0275\u0275control();
  }
}
...
function MeetingFormDetailsComponent_Conditional_0_Conditional_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r0.model().date)("ngModelOptions", \u0275\u0275pureFunction0(12, _c012))("disabled", ctx_r0.form().date().disabled())("range", ctx_r0.bookable_hours())("min_duration", ctx_r0.effective_min_duration())("use_24hr", ctx_r0.use_24hr())("timezone", ctx_r0.timezone());
    \u0275\u0275control();
    \u0275\u0275advance();
...
function MeetingFormDetailsComponent_Conditional_0_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(8, MeetingFormDetailsComponent_Conditional_0_Conditional_19_For_9_Template, 3, 4, "mat-option", 31, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
...
function MeetingFormDetailsComponent_Conditional_0_Conditional_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngModel", ctx_r0.model().meeting_provider === "teamsForBusiness")("ngModelOptions", \u0275\u0275pureFunction0(5, _c012));
    \u0275\u0275control();
    \u0275\u0275advance();
...
var MeetingFormDetailsComponent = class _MeetingFormDetailsComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    this._multiple_spaces = multipleSpacesSignal(this._settings);
    ...
    this.timezone = computed(
      () => {
        return this._multiple_spaces() ? this.model().timezone || "" : this._use_building_timezone() ? this._org.building?.timezone || "" : "";
      },
      ...ngDevMode ? [{ debugName: "timezone" }] : (
        /* istanbul ignore next */
        []
    ...
    onFieldChange(this.model, (m) => m.organiser, (user) => {
      this._setOrganiserTimezone(user);
      return this._checkCalendarPermission(user);
    }, this._injector);
  }
  _setOrganiserTimezone(user) {
    if (!this._multiple_spaces())
      return;
    const timezone = organiserTimezone(user);
    if (!timezone || timezone === this.model().timezone)
      return;
    try {
    ...
    this.model.update((model2) => __spreadProps(__spreadValues({}, model2), { timezone }));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFormDetailsComponent, { className: "MeetingFormDetailsComponent", filePath: "libs/events/src/lib/meeting-form-details.component.ts", lineNumber: 350 });
})();

// apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm-modal.component.ts
var _c013 = (a0) => ({ count: a0 });
var _c17 = (a0) => ({ time: a0 });
var _forTrack04 = ($index, $item) => $item.email;
...
function MeetingFlowConfirmModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 3);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowConfirmModalComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function MeetingFlowConfirmModalComponent_Conditional_29_For_10_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowConfirmModalComponent_Conditional_29_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19)(1, "icon", 7);
    \u0275\u0275text(2, "layers");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 20)(4, "div");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, MeetingFlowConfirmModalComponent_Conditional_29_For_10_Conditional_6_Template, 2, 1, "div", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", ctx_r0.spaceLocation(s_r2), " / ", s_r2.display_name || s_r2.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_12_0 = ctx_r0.roomTime(s_r2)) ? 6 : -1, tmp_12_0);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(9, MeetingFlowConfirmModalComponent_Conditional_29_For_10_Template, 7, 3, "div", 19, _forTrack04);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 1, "APP.WORKPLACE.MEETING_BOOKED_ROOM"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r0.event.resources);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_30_For_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-chip")(1, "div", 24)(2, "icon", 25);
    \u0275\u0275text(3, "business");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
...
function MeetingFlowConfirmModalComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 22)(9, "mat-chip-set", 23);
    \u0275\u0275repeaterCreate(10, MeetingFlowConfirmModalComponent_Conditional_30_For_11_Template, 5, 1, "mat-chip", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 1, "CALENDAR_EVENT.ATTENDEE_COUNT", \u0275\u0275pureFunction1(4, _c013, ctx_r0.event.attendees?.length)), " ");
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r0.event.attendees);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_For_22_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, "CALENDAR_EVENT.CATERING_ORDER_OPTION_COUNT", \u0275\u0275pureFunction1(5, _c013, item_r4.option_list?.length || "0")), " ");
  }
}
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_For_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41)(1, "div", 42)(2, "span", 35);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_For_22_Conditional_4_Template, 3, 7, "span", 43);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r4.option_list?.length ? 4 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" x", item_r4.quantity, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 5, item_r4.unit_price_with_options / 100, ctx_r0.code), " ea ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(12, 8, item_r4.total_cost / 100, ctx_r0.code), " ");
  }
}
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30)(1, "div", 31)(2, "div", 32)(3, "div", 33)(4, "icon", 34);
    \u0275\u0275text(5, "meeting_room");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "span");
    \u0275\u0275text(7);
    ...
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_Conditional_12_Template, 4, 3, "div", 36);
    \u0275\u0275element(13, "div", 37);
    ...
    \u0275\u0275repeaterCreate(21, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_For_22_Template, 13, 11, "div", 41, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r0.cateringRoomLabel(order_r5));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 12, "CALENDAR_EVENT.CATERING_ORDER_AT", \u0275\u0275pureFunction1(21, _c17, \u0275\u0275pipeBind2(10, 9, order_r5.deliver_at, "MMM d, " + ctx_r0.time_format))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.end_time < order_r5.deliver_at ? 12 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 15, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(23, _c013, order_r5.item_count)), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Total: ", \u0275\u0275pipeBind2(19, 18, order_r5.total_cost / 100, ctx_r0.code), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(order_r5.items);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 5)(2, "div", 6)(3, "icon", 7);
    \u0275\u0275text(4, "done");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "h3", 8);
    \u0275\u0275text(6);
    ...
    \u0275\u0275repeaterCreate(9, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_For_10_Template, 23, 25, "div", 29, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 1, "RESOURCE.CATERING"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r0.catering_orders);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_For_10_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "icon");
    \u0275\u0275text(2, "priority_high");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_For_10_For_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41)(1, "div", 42)(2, "span", 35);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
...
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45)(1, "div", 31)(2, "div", 46)(3, "div", 35);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "date");
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_For_10_Conditional_7_Template, 3, 1, "div", 36);
    \u0275\u0275element(8, "div", 37);
    ...
    \u0275\u0275repeaterCreate(13, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_For_10_For_14_Template, 6, 2, "div", 41, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 10, "CALENDAR_EVENT.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(16, _c17, \u0275\u0275pipeBind2(5, 7, request_r6.deliver_at_time, "MMM d, " + ctx_r0.time_format))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.end_time < request_r6.deliver_at || request_r6.conflict ? 7 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 13, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(18, _c013, request_r6.item_count)), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(request_r6.items);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27)(1, "div", 5)(2, "div", 6)(3, "icon", 7);
    \u0275\u0275text(4, "done");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "h3", 8);
    \u0275\u0275text(6);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 28);
    \u0275\u0275repeaterCreate(9, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_For_10_Template, 15, 20, "div", 44, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 1, "RESOURCE.ASSETS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r0.assets);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275conditionalCreate(1, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_1_Template, 11, 3, "div", 26);
    \u0275\u0275conditionalCreate(2, MeetingFlowConfirmModalComponent_Conditional_31_Conditional_2_Template, 11, 3, "div", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.event.catering?.length ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.assets?.length ? 2 : -1);
  }
}
function MeetingFlowConfirmModalComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16)(1, "div", 47)(2, "icon");
    \u0275\u0275text(3, "done");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 2, "FORM.NOTES"), " ");
    \u0275\u0275advance(2);
...
function MeetingFlowConfirmModalComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 18)(1, "button", 50);
    \u0275\u0275listener("click", function MeetingFlowConfirmModalComponent_Conditional_34_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext();
...
var MeetingFlowConfirmModalComponent = class _MeetingFlowConfirmModalComponent extends AsyncHandler {
  ...
  cateringRoomLabel(order) {
    ...
    if (!room)
      return i18n("CALENDAR_EVENT.ROOM_REQUIRED");
    return [this.spaceLocation(room), room.display_name || room.name].filter((_) => !!_).join(" / ");
  }
  /** Format a room's local time when it differs from the organiser's. */
  roomTime(space) {
    if (!multipleSpacesEnabled(this._settings) || this.event.all_day) {
  ...
  async ngOnInit() {
    ...
    this._space = await this._space_pipe.transform(this.event.resources[0]?.email) || this._space;
    const original_space_ids = new Set(this._event_form.event?.resources?.map((space) => space.id) || []);
    const changed_spaces = !this._event_form.event || original_space_ids.size !== this.event.resources.length || this.event.resources.some((space) => !original_space_ids.has(space.id));
    ...
    if (this.has_assets && event.assets?.length) {
      ...
      }, event.assets, changed_spaces || changed_times).catch((e) => notifyError(e));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowConfirmModalComponent, selectors: [["meeting-flow-confirm-modal"]], inputs: { show_close: [1, "show_close"] }, outputs: { show_close: "show_closeChange" }, features: [\u0275\u0275ProvidersFeature([SpacePipe]), \u0275\u0275InheritDefinitionFeature], decls: 35, vars: 19, consts: [[1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "flex", "h-14", "w-160", "max-w-full", "items-center", "justify-between", "rounded-sm", "border-none", "px-4", "py-2"], [1, "text-xl", "font-medium", "capitalize"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], ["diameter", "32", 1, "absolute", "top-1/2", "right-2", "-translate-y-1/2"], [1, "grid", "max-h-[65vh]", "w-full", "max-w-[calc(100vw-2rem)]", "flex-1", "grid-cols-2", "gap-4", "overflow-auto", "px-4", "pt-2", "pb-4"], [1, "mb-2", "flex", "items-center", "space-x-4"], [1, "border-success", "text-success", "flex", "items-center", "justify-center", "rounded-full", "border"], [1, "text-2xl"], [1, "text-xl"], [1, "space-y-1", "pl-10"], [1, "flex", "items-center", "space-x-2"], ["date", ""], [1, "flex", "flex-col", "leading-tight"], ["time", ""], [1, "text-xs", "opacity-30"], [1, "col-span-2"], [1, "relative", "space-y-2", "py-4", "pr-4", "pl-16"], [1, "bg-warning", "text-warning-content", "col-span-2", "mt-2", "rounded-sm", "border-none!", "px-2", "py-1", "text-center", "text-sm"], [1, "border-base-200", "flex", "items-center", "justify-end", "border-t", "p-2"], [1, "flex", "items-start", "space-x-2"], [1, "flex", "flex-col"], ["room-time", "", 1, "text-xs", "opacity-60"], ["attendee-list", "", 1, "pl-10"], ["aria-label", "User selection"], [1, "flex", "items-center"], [1, "mr-2"], [1, "w-full"], [1, "col-span-2", "mt-4", "w-full"], [1, "flex", "w-full", "flex-col", "space-y-2", "pl-12"], ["order", "", 1, "bg-base-100", "overflow-hidden", "rounded-xl", "border", 3, "border-error", "border-base-300"], ["order", "", 1, "bg-base-100", "overflow-hidden", "rounded-xl", "border"], [1, "flex", "items-center", "space-x-2", "p-3"], [1, "flex", "flex-1", "flex-wrap", "items-center", "gap-x-2"], [1, "mb-1", "flex", "w-full", "items-center", "space-x-1", "text-xs", "opacity-60"], [1, "text-lg"], [1, "text-sm"], [1, "bg-error", "text-error-content", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", 3, "matTooltip"], [1, "flex-1"], [1, "bg-success", "text-success-content", "rounded-sm", "px-2", "py-1", "text-xs"], [1, "bg-info", "text-info-content", "rounded-sm", "px-2", "py-1", "text-xs"], [1, "divide-base-100", "bg-base-200", "flex", "flex-col", "divide-y"], [1, "flex", "items-center", "space-x-2", "px-3", "py-1", "hover:opacity-90"], [1, "flex", "flex-1", "items-center"], [1, "ml-4", "text-xs", "font-normal", "opacity-60", 3, "matTooltip"], ["request", "", 1, "bg-base-100", "w-full", "overflow-hidden", "rounded-xl", "border", 3, "border-error", "border-base-300"], ["request", "", 1, "bg-base-100", "w-full", "overflow-hidden", "rounded-xl", "border"], [1, "flex", "flex-1", "items-center", "space-x-2"], [1, "border-success", "text-success", "absolute", "top-4", "left-4", "flex", "items-center", "justify-center", "rounded-full", "border", "text-2xl"], [1, "mt-0!", "text-xl"], [3, "innerHTML"], ["btn", "", "name", "confirm-meeting", "matRipple", "", 1, "w-32", 3, "click"]], template: function MeetingFlowConfirmModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "header", 0)(1, "h2", 1);
        \u0275\u0275text(2);
        \u0275\u0275pipe(3, "translate");
        ...
        \u0275\u0275conditionalCreate(5, MeetingFlowConfirmModalComponent_Conditional_5_Template, 1, 0, "mat-spinner", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "main", 4)(7, "div")(8, "div", 5)(9, "div", 6)(10, "icon", 7);
        \u0275\u0275text(11, "done");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(12, "h3", 8);
        \u0275\u0275text(13);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(14, "div", 9)(15, "div", 10)(16, "icon", 7);
        \u0275\u0275text(17, "today");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(20, "date");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(21, MeetingFlowConfirmModalComponent_Conditional_21_Template, 5, 1, "div", 10);
        \u0275\u0275elementStart(22, "div", 10)(23, "icon", 7);
        \u0275\u0275text(24, "schedule");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(25, "div", 12)(26, "div", 13);
        \u0275\u0275text(27);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(28, MeetingFlowConfirmModalComponent_Conditional_28_Template, 2, 1, "div", 14);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275conditionalCreate(29, MeetingFlowConfirmModalComponent_Conditional_29_Template, 11, 3, "div");
        \u0275\u0275conditionalCreate(30, MeetingFlowConfirmModalComponent_Conditional_30_Template, 12, 6, "div");
        \u0275\u0275conditionalCreate(31, MeetingFlowConfirmModalComponent_Conditional_31_Template, 3, 2, "div", 15);
        \u0275\u0275conditionalCreate(32, MeetingFlowConfirmModalComponent_Conditional_32_Template, 9, 6, "div", 16);
        \u0275\u0275conditionalCreate(33, MeetingFlowConfirmModalComponent_Conditional_33_Template, 3, 3, "div", 17);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(34, MeetingFlowConfirmModalComponent_Conditional_34_Template, 4, 3, "footer", 18);
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(20, 16, ctx.event.date, "fullDate"));
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.event.recurrence?.pattern ? 21 : -1);
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(ctx.formattedTime());
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.timezone ? 28 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.event.resources?.length ? 29 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.event.attendees?.length ? 30 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.event.catering?.length || ctx.event.assets?.length ? 31 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.event.body ? 32 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.requires_approval ? 33 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(!ctx.loading() ? 34 : -1);
      }
    }, dependencies: [
      CommonModule,
      IconComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MeetingFlowConfirmModalComponent, [{
    type: Component,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowConfirmModalComponent, { className: "MeetingFlowConfirmModalComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-confirm-modal.component.ts", lineNumber: 497 });
})();

// apps/workplace/src/app/book/meeting-flow/meeting-flow-form.component.ts
var _c014 = ["confirm_ref"];
var _c18 = ["input"];
var _c24 = () => ({ standalone: true });
var _c32 = (a0, a1, a2, a3, a4) => ({ date: a0, duration: a1, all_day: a2, zone_id: a3, resources: a4 });
var _c4 = () => [];
var _c5 = (a0, a1, a2, a3, a4) => ({ date: a0, duration: a1, all_day: a2, zone: a3, resources: a4 });
function MeetingFlowFormComponent_Conditional_5_Conditional_14_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-checkbox", 24);
    \u0275\u0275twoWayListener("ngModelChange", function MeetingFlowFormComponent_Conditional_5_Conditional_14_Conditional_16_Template_mat_checkbox_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r4);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(5, _c24));
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 3, "CALENDAR_EVENT.NOTIFY_NEW_ATTENDEES_ONLY"), " ");
  }
}
function MeetingFlowFormComponent_Conditional_5_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 5)(1, "h3", 6)(2, "div", 7);
    \u0275\u0275text(3, " 2 ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Conditional_14_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Conditional_14_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(15, "a-user-list-field", 22);
    \u0275\u0275controlCreate();
    \u0275\u0275conditionalCreate(16, MeetingFlowFormComponent_Conditional_5_Conditional_14_Conditional_16_Template, 3, 6, "mat-checkbox", 23);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 9, "CALENDAR_EVENT.ATTENDEES"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 11, "COMMON.AVAILABILITY"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.hide_block.attendees ? "expand_more" : "expand_less");
    \u0275\u0275advance();
    \u0275\u0275classProp("contract-collapsed", ctx_r1.hide_block.attendees);
    \u0275\u0275advance();
    \u0275\u0275property("formField", ctx_r1.form.attendees)("time", ctx_r1.model().date)("guests", ctx_r1.allow_externals());
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.can_notify_new_attendees_only() ? 16 : -1);
  }
}
function MeetingFlowFormComponent_Conditional_5_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
function MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_13_For_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", code_r7, " ");
  }
}
function MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 29);
    \u0275\u0275listener("openedChange", function MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_13_Template_mat_form_field_openedChange_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.focusInput());
    });
    \u0275\u0275elementStart(1, "mat-select", 30);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementStart(3, "input", 31, 0);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275listener("ngModelChange", function MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_13_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.code_filter.set($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275element(6, "mat-option", 32);
    \u0275\u0275repeaterCreate(7, MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_13_For_8_Template, 2, 2, "mat-option", 33, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementStart(9, "mat-error");
    \u0275\u0275text(10);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r1.code_filter())("ngModelOptions", \u0275\u0275pureFunction0(12, _c24))("placeholder", \u0275\u0275pipeBind1(5, 8, "CALENDAR_EVENT.CATERING_CHARGE_CODE_SEARCH"));
    \u0275\u0275control();
    \u0275\u0275advance(4);
...
function MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowFormComponent_Conditional_5_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 5)(1, "h3", 6)(2, "div", 7);
    \u0275\u0275text(3, " 4 ");
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Conditional_29_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(12, "catering-list-field", 26);
    \u0275\u0275controlCreate();
    \u0275\u0275conditionalCreate(13, MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_13_Template, 12, 13, "mat-form-field", 27);
    \u0275\u0275conditionalCreate(14, MeetingFlowFormComponent_Conditional_5_Conditional_29_Conditional_14_Template, 6, 9, "mat-form-field", 28);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 8, "RESOURCE.CATERING"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.hide_block.catering ? "expand_more" : "expand_less");
    \u0275\u0275advance();
    \u0275\u0275classProp("contract-collapsed", ctx_r1.hide_block.catering);
    \u0275\u0275advance();
    \u0275\u0275property("formField", ctx_r1.form.catering)("options", \u0275\u0275pureFunction5(10, _c32, ctx_r1.model().date, ctx_r1.model().duration, ctx_r1.model().all_day, ctx_r1.model()?.resources?.length ? ctx_r1.model()?.resources[0]?.level?.parent_id : "", ctx_r1.model().resources));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function MeetingFlowFormComponent_Conditional_5_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 5)(1, "h3", 6)(2, "div", 7);
    \u0275\u0275text(3);
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Conditional_30_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 11);
    \u0275\u0275element(12, "asset-list-field", 37);
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 8, "RESOURCE.ASSETS"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.hide_block.assets ? "expand_more" : "expand_less");
    \u0275\u0275advance();
    \u0275\u0275classProp("contract-collapsed", ctx_r1.hide_block.assets);
    \u0275\u0275advance();
    \u0275\u0275property("options", \u0275\u0275pureFunction5(11, _c5, ctx_r1.model().date, ctx_r1.model().duration, ctx_r1.model().all_day, ctx_r1.model()?.resources?.length ? ctx_r1.model()?.resources[0]?.level?.parent_id : "", ctx_r1.model()?.resources || \u0275\u0275pureFunction0(10, _c4)))("rejected_ids", ctx_r1.invalid_assets())("formField", ctx_r1.form.assets);
    \u0275\u0275control();
  }
}
function MeetingFlowFormComponent_Conditional_5_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 5)(1, "h3", 38)(2, "div", 7);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 8);
    \u0275\u0275text(5);
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Conditional_31_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.resetNotes());
    });
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 40)(12, "label", 41);
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "rich-text-input", 30);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 6, "FORM.NOTES"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 8, "FORM.RESET_NOTES"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 10, "CALENDAR_EVENT.NOTES_INFO"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("formField", ctx_r1.form.body)("placeholder", \u0275\u0275pipeBind1(16, 12, "CALENDAR_EVENT.NOTES_INFO"));
    \u0275\u0275control();
  }
}
function MeetingFlowFormComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 4)(1, "section", 5)(2, "h3", 6)(3, "div", 7);
    \u0275\u0275text(4, " 1 ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(13, "meeting-form-details", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(14, MeetingFlowFormComponent_Conditional_5_Conditional_14_Template, 17, 13, "section", 5);
    \u0275\u0275elementStart(15, "section", 5)(16, "h3", 6)(17, "div", 7);
    \u0275\u0275text(18, " 3 ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(27, MeetingFlowFormComponent_Conditional_5_Conditional_27_Template, 3, 3, "div", 15);
    \u0275\u0275element(28, "space-list-field", 16);
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(29, MeetingFlowFormComponent_Conditional_5_Conditional_29_Template, 15, 16, "section", 5);
    \u0275\u0275conditionalCreate(30, MeetingFlowFormComponent_Conditional_5_Conditional_30_Template, 13, 17, "section", 5);
    \u0275\u0275conditionalCreate(31, MeetingFlowFormComponent_Conditional_5_Conditional_31_Template, 17, 14, "section", 5);
    \u0275\u0275elementStart(32, "section", 17)(33, "button", 18);
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Template_button_click_33_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function MeetingFlowFormComponent_Conditional_5_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 18, "COMMON.DETAILS"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.hide_block.details ? "expand_more" : "expand_less");
    \u0275\u0275advance();
    \u0275\u0275classProp("contract-collapsed", ctx_r1.hide_block.details);
    \u0275\u0275advance();
    \u0275\u0275property("form", ctx_r1.form);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.hide_attendees ? 14 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(21, 20, "RESOURCE.ROOM"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.hide_block.resources ? "expand_more" : "expand_less");
    \u0275\u0275advance();
    \u0275\u0275classProp("contract-collapsed", ctx_r1.hide_block.resources);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.strict_capacity_check && ctx_r1.total_capacity && ctx_r1.total_capacity <= ctx_r1.model().attendees?.length ? 27 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("formField", ctx_r1.form.resources)("multiday", ctx_r1.allow_multiday);
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.has_catering() ? 29 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.has_assets ? 30 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.hide_notes ? 31 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(35, 22, "CALENDAR_EVENT.CONFIRM"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(38, 24, !!ctx_r1.model().id ? "FORM.RESET" : "FORM.CLEAR"), " ");
  }
}
var MeetingFlowFormComponent = class _MeetingFlowFormComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    this.invalid_assets = signal(
      [],
      ...ngDevMode ? [{ debugName: "invalid_assets" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this.can_notify_new_attendees_only = this._state.can_notify_new_attendees_only;
    this.notify_new_attendees_only = this._state.notify_new_attendees_only;
    ...
    this.filtered_codes = computed(
      () => this._catering.charge_codes().filter((_) => _.toLowerCase().includes(this.code_filter().toLowerCase())),
      ...ngDevMode ? [{ debugName: "filtered_codes" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this.allow_externals = settingSignal("events.allow_externals");
    ...
    this._assets_available = signal(
      false,
      ...ngDevMode ? [{ debugName: "_assets_available" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this._catering_available = signal(
      false,
      ...ngDevMode ? [{ debugName: "_catering_available" }] : (
        /* istanbul ignore next */
        []
      )
    );
    ...
    this.viewConfirm = async () => {
      ...
      if (!this.allow_daily_allday_recurrence && this.model().all_day && this.model().recurrence?.pattern === "daily") {
      ...
      if (this._settings.get("app.events.no_standalone") && !this.model().resources.length)
    ...
    this._confirm_ref = viewChild(
      "confirm_ref",
      ...ngDevMode ? [{ debugName: "_confirm_ref" }] : (
        /* istanbul ignore next */
        []
      )
    );
    ...
    effect((onCleanup) => {
      ...
      this.model();
      const timeout = setTimeout(() => this._checkAssets(space_list), 300);
    ...
    effect((onCleanup) => {
      ...
      this.has_catering();
      this.model();
      const timeout = setTimeout(() => this._checkCatering(space_list), 300);
      onCleanup(() => clearTimeout(timeout));
    });
  }
  resetNotes() {
  ...
  _updateValidAssets() {
    ...
    this.invalid_assets.set(requested_assets.filter((_) => !_._changed && !linked_bookings.find((bkn) => bkn.extension_data?.request_id === _.id)).map((_) => _.id));
  }
  _checkAssets(space_list) {
    ...
    const assets_available = space_list.every((space) => items.filter((_) => !_.hide_for_zones?.find((z) => space.zones.includes(z))).length > 0);
    const available = assets_available && !disabled_rooms.find((_) => space_list.find((i) => i.id === _));
    ...
    const time_changed = has_assets && (!id || date !== event.date || date_end !== event.date_end);
    if (time_changed) {
      this.model.update((m) => __spreadProps(__spreadValues({}, m), { assets: [] }));
      if (this.has_assets) {
        notifyWarn(i18n("CALENDAR_EVENT.ASSETS_UNAVAILABLE"));
      }
    }
  }
  _checkCatering(space_list) {
    if (!space_list?.length || !this.has_catering()) {
      this._catering_available.set(false);
      return;
    }
    const value = this.model();
    const room_ids = new Set(space_list.flatMap((space) => [space.id, space.email]));
    const valid_orders = (value.catering || []).filter((order) => !order.system_id || room_ids.has(order.system_id));
    ...
    const can_cater = space_list.some((space) => !disabled_rooms.includes(space.id) && menu.some((_) => !_.hide_for_zones.some((z) => space.zones.includes(z))));
    ...
    const time_changed = has_catering && (!id || date !== event.date || date_end !== event.date_end);
    if (time_changed) {
      this.model.update((m) => __spreadProps(__spreadValues({}, m), { catering: [] }));
      if (this.has_catering()) {
        notifyWarn(i18n("CALENDAR_EVENT.CATERING_UNAVAILABLE"));
      }
    }
  }
  async _cateringOrdersAvailable() {
    const { catering = [], date, duration, resources } = this.model();
    for (const order of catering) {
      if (!order.system_id)
        return false;
      const room = resources.find((_) => _.id === order.system_id || _.email === order.system_id);
      if (!room)
        return false;
      const zone_id = room.level?.parent_id || this._org.levelWithID(room.zones)?.parent_id || this._org.locationWithID(room.zones).building?.id;
      if (!await this._catering.orderAvailable(order, room, {
        date,
        duration,
        zone_id
      })) {
  ...
  async ngOnInit() {
    ...
    this.subscription("asset_changes", {
      unsubscribe: onFieldChange(this._state.model, (m) => m.assets, () => this._updateValidAssets(), this._injector).destroy
    });
    for (const key of [
      "resources",
      "date",
      ...
      this.subscription(`${key}_changes`, {
        unsubscribe: onFieldChange(this._state.model, (m) => m[key], () => this.timeout("check_resources", () => this._space_list.set(this.model().resources || [])), this._injector).destroy
      });
    }
    ...
    this._idle.idleFor((this._settings.get("app.idle_timeout") || 5) * 60 * 1e3, idle_abort.signal).then(async (did_idle) => {
      if (!did_idle)
        return;
  ...
  static {
    this.\u0275fac = function MeetingFlowFormComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _MeetingFlowFormComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowFormComponent, selectors: [["meeting-flow-form"]], viewQuery: function MeetingFlowFormComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuerySignal(ctx._confirm_ref, _c014, 5)(ctx._input_el, _c18, 5);
      }
      if (rf & 2) {
        \u0275\u0275queryAdvance(2);
      }
    }, features: [\u0275\u0275InheritDefinitionFeature], decls: 6, vars: 4, consts: [["input", ""], [1, "bg-base-200", "h-full", "w-full", "overflow-auto"], [1, "border-base-300", "bg-base-100", "mx-auto", "w-3xl", "max-w-full", "border", "sm:my-4"], [1, "border-base-300", "w-full", "border-b", "p-4", "text-2xl", "font-medium", "sm:px-16", "sm:py-4"], [1, "divide-base-200", "space-y-2", "divide-y", "p-0", "sm:px-16", "sm:py-4"], [1, "p-2"], [1, "flex", "items-center", "space-x-2"], [1, "bg-base-200", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full"], [1, "text-xl"], [1, "w-px", "flex-1"], ["icon", "", "name", "toggle-details-meeting", "matRipple", "", 3, "click"], [1, "contract-expand"], [1, "mt-4", 3, "form"], ["icon", "", "name", "toggle-spaces-meeting", "matRipple", "", 3, "click"], [1, "contract-expand", "flex", "flex-col", "items-center"], [1, "bg-warning", "text-warning-content", "mx-auto", "my-2", "inline-flex", "rounded-sm", "p-2", "text-xs", "shadow-sm"], [1, "w-full", 3, "formField", "multiday"], [1, "flex", "flex-col", "items-center", "p-2", "sm:flex-row", "sm:space-x-2"], ["btn", "", "name", "open-meeting-confirm", "matRipple", "", "confirm", "", 1, "mb-2", "w-full", "sm:mb-0", "sm:w-auto", 3, "click"], ["btn", "", "name", "clear-form-meeting", "matRipple", "", "clear-form", "", 1, "inverse", "w-full", "sm:w-auto", 3, "click"], ["matRipple", "", "name", "find-attendee-availability", 1, "text-info", "bg-none", "text-xs", "underline", 3, "click"], ["icon", "", "name", "toggle-attendees-meeting", "matRipple", "", 3, "click"], [1, "mt-4", 3, "formField", "time", "guests"], ["name", "notify-new-attendees-only", 3, "ngModel", "ngModelOptions"], ["name", "notify-new-attendees-only", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["icon", "", "name", "toggle-catering-meeting", "matRipple", "", 3, "click"], [3, "formField", "options"], ["appearance", "outline", 1, "mt-2", "w-full"], ["appearance", "outline", 1, "w-full", 3, "mt-2"], ["appearance", "outline", 1, "mt-2", "w-full", 3, "openedChange"], [3, "formField", "placeholder"], [1, "border-base-200", "bg-base-100", "sticky", "top-0", "z-50", "w-full", "rounded-none", "border-x-0", "border-t-0", "border-b", "px-4", "py-3", "text-base", "focus:border-b", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [1, "hidden"], [3, "value"], ["appearance", "outline", 1, "w-full"], ["matInput", "", 3, "formField", "placeholder"], ["icon", "", "name", "toggle-assets-meeting", "matRipple", "", 3, "click"], [3, "options", "rejected_ids", "formField"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["type", "button", "matRipple", "", "name", "reset-notes-meeting", 1, "text-info", "bg-none", "text-xs", "underline", 3, "click"], [1, "flex", "w-full", "flex-col"], ["for", "notes"]], template: function MeetingFlowFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h2", 3);
        \u0275\u0275text(3);
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(5, MeetingFlowFormComponent_Conditional_5_Template, 39, 26, "form", 4);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 2, !!ctx.model().id ? "APP.WORKPLACE.MEETING_BOOK_EDIT_HEADER" : "APP.WORKPLACE.MEETING_BOOK_NEW_HEADER"), " ");
        \u0275\u0275advance(2);
...
(() => {
  ...
  }], () => [], { _confirm_ref: [{ type: ViewChild, args: ["confirm_ref", { isSignal: true }] }], _input_el: [{ type: ViewChild, args: ["input", { isSignal: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowFormComponent, { className: "MeetingFlowFormComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-form.component.ts", lineNumber: 524 });
})();

// apps/workplace/src/app/book/meeting-flow/meeting-flow-success.component.ts
var _c015 = (a0, a1, a2, a3) => ({ level: a0, space: a1, date: a2, time: a3 });
var _c19 = () => ["/"];
function MeetingFlowSuccessComponent_Conditional_4_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, ctx_r0.space ? "CALENDAR_EVENT.SUCCESS_WITH_SPACE_ALLDAY" : "CALENDAR_EVENT.SUCCESS_WITHOUT_SPACE_ALLDAY", details_r2), " ");
  }
}
function MeetingFlowSuccessComponent_Conditional_4_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    const details_r2 = \u0275\u0275readContextLet(0);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, ctx_r0.space ? "CALENDAR_EVENT.SUCCESS_WITH_SPACE" : "CALENDAR_EVENT.SUCCESS_WITHOUT_SPACE", details_r2), " ");
  }
}
function MeetingFlowSuccessComponent_Conditional_4_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function MeetingFlowSuccessComponent_Conditional_4_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 14);
    \u0275\u0275listener("click", function MeetingFlowSuccessComponent_Conditional_4_Conditional_16_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function MeetingFlowSuccessComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 3)(6, "icon", 4);
    \u0275\u0275text(7, "schedule");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275conditionalCreate(12, MeetingFlowSuccessComponent_Conditional_4_Conditional_12_Template, 2, 4);
    \u0275\u0275conditionalCreate(13, MeetingFlowSuccessComponent_Conditional_4_Conditional_13_Template, 2, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, MeetingFlowSuccessComponent_Conditional_4_Conditional_14_Template, 5, 1, "div", 7);
    \u0275\u0275element(15, "div", 8);
    \u0275\u0275conditionalCreate(16, MeetingFlowSuccessComponent_Conditional_4_Conditional_16_Template, 3, 3, "button", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "footer", 10)(18, "a", 11);
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 8, "CALENDAR_EVENT.ROOM_BOOKING_REQUESTED"), " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 10, "CALENDAR_EVENT.SUCCESS_WAIT_APPROVED"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.last_event()?.all_day ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.last_event()?.all_day ? 13 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.formatted_recurrence() ? 14 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.space?.email && ctx_r0.allow_desk_booking ? 16 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(14, _c19));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(20, 12, "APP.WORKPLACE.MEETING_FINISHED"), " ");
  }
}
var MeetingFlowSuccessComponent = class _MeetingFlowSuccessComponent {
  constructor() {
    ...
    this.resolved_space = signal(
      null,
      ...ngDevMode ? [{ debugName: "resolved_space" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  async ngOnInit() {
    ...
    if (space?.email || space?.id) {
      const resolved_space = await this._space_pipe.transform(space.email || space.id);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSuccessComponent, selectors: [["meeting-flow-success"]], features: [\u0275\u0275ProvidersFeature([SpacePipe])], decls: 5, vars: 16, consts: [[1, "bg-base-100", "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-center", "text-2xl", "font-medium"], ["aria-hidden", "true", 1, "bg-warning", "text-warning-content", "flex", "h-32", "w-32", "shrink-0", "items-center", "justify-center", "rounded-full"], [1, "text-6xl"], [1, "max-w-lg", "text-center", "font-bold"], [1, "max-w-lg", "text-center"], ["recurrence", "", 1, "bg-base-200", "flex", "items-center", "space-x-2", "rounded-lg", "px-4", "py-2"], [1, "h-4"], ["btn", "", "matRipple", "", 1, "w-48"], [1, "border-base-200", "bg-base-100", "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "p-2"], ["btn", "", "name", "meeting-created-continue", "matRipple", "", 1, "w-full", "max-w-lg", 3, "routerLink"], [1, "text-xl"], [1, "text-sm"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function MeetingFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275declareLet(0);
        \u0275\u0275pipe(1, "date");
        \u0275\u0275pipe(2, "date");
        \u0275\u0275pipe(3, "date");
        \u0275\u0275conditionalCreate(4, MeetingFlowSuccessComponent_Conditional_4_Template, 21, 15, "div", 0);
      }
      if (rf & 2) {
        \u0275\u0275storeLet(\u0275\u0275pureFunction4(11, _c015, ctx.level?.display_name || ctx.level?.name, ctx.space?.display_name || ctx.space?.name, \u0275\u0275pipeBind2(1, 1, ctx.last_event()?.date, "mediumDate"), \u0275\u0275pipeBind2(2, 4, ctx.last_event()?.date, ctx.time_format) + " \u2014 " + \u0275\u0275pipeBind2(3, 7, ctx.last_event()?.date_end, ctx.time_format)));
        \u0275\u0275advance(4);
        \u0275\u0275conditional(!ctx.loading() ? 4 : -1);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowSuccessComponent, { className: "MeetingFlowSuccessComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-success.component.ts", lineNumber: 109 });
})();

// apps/workplace/src/app/book/meeting-flow.component.ts
function BookMeetingFlowComponent_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "meeting-flow-success");
  }
}
function BookMeetingFlowComponent_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "meeting-flow-confirm");
  }
}
function BookMeetingFlowComponent_Case_3_Template(rf, ctx) {
  if (rf & 1) {
...
var BookMeetingFlowComponent = class _BookMeetingFlowComponent extends AsyncHandler {
  constructor() {
    ...
    this.last_success = this._state.last_success;
  }
  ngOnInit() {
    ...
    this.subscription("route.query", this._route.queryParams.subscribe(async (param) => {
      if ("success" in param)
        this._state.setView("success");
      if (param.space_id) {
        const space = await this._space_pipe.transform(param.space_id);
        if (!space?.id) {
          return notifyInfo("Unable to find room with given space ID.");
        }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookMeetingFlowComponent, selectors: [["placeos-book-meeting-flow"]], features: [\u0275\u0275ProvidersFeature([SpacePipe]), \u0275\u0275InheritDefinitionFeature], decls: 4, vars: 1, consts: [[1, "bg-base-100", "z-50", "h-full", "w-full"]], template: function BookMeetingFlowComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
      ...
      if (rf & 2) {
        let tmp_0_0;
        \u0275\u0275advance();
        \u0275\u0275conditional((tmp_0_0 = ctx.view()) === "success" ? 1 : tmp_0_0 === "confirm" ? 2 : 3);
      }
    }, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BookMeetingFlowComponent, [{
    ...
    `, imports: [
      ...
      MeetingFlowConfirmComponent,
      MeetingFlowFormComponent
    ], providers: [SpacePipe], styles: ["/* angular:styles/component:css;8f663144e307d97d7c6361d75534b712825c70421a65c587eccbcb19333fd199;/home/runner/work/user-interfaces/user-interfaces/apps/workplace/src/app/book/meeting-flow.component.ts */\n:host {\n  height: 100%;\n  width: 100%;\n}\n/*# sourceMappingURL=meeting-flow.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookMeetingFlowComponent, { className: "BookMeetingFlowComponent", filePath: "apps/workplace/src/app/book/meeting-flow.component.ts", lineNumber: 41 });
})();
export {
  BookMeetingFlowComponent
};
//# debugId=9628b8e9-5b41-5c07-9ff4-6d99f65f72bf
//# sourceMappingURL=meeting-flow.component-XYA4QZRP.js.map
