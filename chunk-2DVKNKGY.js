...
} from "./chunk-FH5HNXXQ.js";
import {
  AssetListFieldComponent
} from "./chunk-RSB53MCB.js";
import {
...
function EventBookModalComponent_Conditional_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 7, "COMMON.AVAILABILITY"), " ");
    \u0275\u0275advance(4);
...
function EventBookModalComponent_Conditional_33_Conditional_13_For_8_Template(rf, ctx) {
  if (rf & 1) {
...
function EventBookModalComponent_Conditional_33_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("openedChange", function EventBookModalComponent_Conditional_33_Conditional_13_Template_mat_form_field_openedChange_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.focusInput());
    });
    \u0275\u0275elementStart(1, "mat-select", 23);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementStart(3, "input", 24, 0);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275listener("ngModelChange", function EventBookModalComponent_Conditional_33_Conditional_13_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.code_filter.next($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "mat-option", 25);
    \u0275\u0275repeaterCreate(7, EventBookModalComponent_Conditional_33_Conditional_13_For_8_Template, 2, 2, "mat-option", 26, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(9, "async");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r1.code_filter.getValue())("ngModelOptions", \u0275\u0275pureFunction0(13, _c1))("placeholder", \u0275\u0275pipeBind1(5, 7, "CALENDAR_EVENT.CATERING_CHARGE_CODE_SEACH"));
    \u0275\u0275advance(4);
...
function EventBookModalComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(13, EventBookModalComponent_Conditional_33_Conditional_13_Template, 13, 14, "mat-form-field", 20);
    \u0275\u0275pipe(14, "async");
    \u0275\u0275conditionalCreate(15, EventBookModalComponent_Conditional_33_Conditional_15_Template, 7, 10, "mat-form-field", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function EventBookModalComponent_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(13, "asset-list-field", 30);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", !\u0275\u0275pipeBind1(4, 5, ctx_r1.has_catering) ? "4" : "5", " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("options", \u0275\u0275pureFunction4(9, _c02, ctx_r1.form.getRawValue().date, ctx_r1.form.value.duration, ctx_r1.form.value.all_day, (ctx_r1.form.value == null ? null : ctx_r1.form.value.resources == null ? null : ctx_r1.form.value.resources.length) ? ctx_r1.form.value == null ? null : ctx_r1.form.value.resources[0] == null ? null : ctx_r1.form.value.resources[0].level == null ? null : ctx_r1.form.value.resources[0].level.parent_id : ""));
  }
}
function EventBookModalComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 3)(1, "h3", 31)(2, "div", 5);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275pipe(5, "async");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(13, "rich-text-input", 34);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
_EventBookModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventBookModalComponent, selectors: [["event-book-modal"]], outputs: { event: "event" }, decls: 37, vars: 28, consts: [["input", ""], [3, "confirm", "heading", "loading"], [3, "formGroup"], [1, "p-2"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "bg-base-200"], [1, "text-xl"], [1, "w-px", "flex-1"], ["icon", "", "name", "toggle-details-meeting", "matRipple", "", 3, "click"], [1, "overflow-hidden"], [1, "mt-4", 3, "form"], ["icon", "", "name", "toggle-spaces-meeting", "matRipple", "", 3, "click"], [1, "flex", "flex-col", "items-center", "overflow-hidden"], [1, "mx-auto", "my-2", "inline-flex", "rounded-sm", "bg-warning", "p-2", "text-xs", "text-warning-content", "shadow-sm"], ["formControlName", "resources", 1, "w-full", 3, "multiday"], ["matRipple", "", "name", "find-attendee-availability", 1, "bg-none", "text-xs", "text-info", "underline", 3, "click"], ["icon", "", "name", "toggle-attendees-meeting", "matRipple", "", 3, "click"], ["formControlName", "attendees", 1, "mt-4", 3, "guests"], ["icon", "", "name", "toggle-catering-meeting", "matRipple", "", 3, "click"], ["formControlName", "catering", 3, "options"], ["appearance", "outline", 1, "mt-2", "w-full"], ["appearance", "outline", 1, "w-full", 3, "mt-2"], ["appearance", "outline", 1, "mt-2", "w-full", 3, "openedChange"], ["formControlName", "catering_charge_code", 3, "placeholder"], [1, "sticky", "top-0", "z-50", "w-full", "rounded-none", "border-x-0", "border-b", "border-t-0", "border-base-200", "bg-base-100", "px-4", "py-3", "text-base", "focus:border-b", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [1, "hidden"], [3, "value"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "formControlName", "catering_notes", 3, "placeholder"], ["icon", "", "name", "toggle-assets-meeting", "matRipple", "", 3, "click"], ["formControlName", "assets", 3, "options"], [1, "mb-4", "flex", "items-center", "space-x-2"], [1, "flex", "w-full", "flex-col"], ["for", "notes"], ["name", "notes", "formControlName", "body", 3, "placeholder"]], template: function EventBookModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(18, EventBookModalComponent_Conditional_18_Template, 16, 9, "section", 3);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(33, EventBookModalComponent_Conditional_33_Template, 16, 15, "section", 3);
    \u0275\u0275pipe(34, "async");
    \u0275\u0275conditionalCreate(35, EventBookModalComponent_Conditional_35_Template, 14, 14, "section", 3);
    \u0275\u0275conditionalCreate(36, EventBookModalComponent_Conditional_36_Template, 15, 14, "section", 3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 16, ctx.form.value.id ? "APP.CONCIERGE.ROOMS_BOOK_EDIT" : "APP.CONCIERGE.ROOMS_BOOK_NEW"))("loading", \u0275\u0275pipeBind1(2, 18, ctx.loading) ? \u0275\u0275pipeBind1(3, 20, "CALENDAR_EVENT.LOADING") : "");
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(25, 24, "RESOURCE.ROOM"), " ");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(\u0275\u0275pipeBind1(34, 26, ctx.has_catering) ? 33 : -1);
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventBookModalComponent, { className: "EventBookModalComponent", filePath: "apps/concierge/src/app/day-view/event-book-modal.component.ts", lineNumber: 410 });
})();
...
var _EventsStateService = class _EventsStateService extends AsyncHandler {
  constructor() {
    ...
    this.filtered = combineLatest([
      ...
      this._period,
      this._zones
    ]).pipe(map(([events, removed, added, filters, date, period, zones]) => {
...
//# sourceMappingURL=chunk-2DVKNKGY.js.map
