...
var ScheduleTimelineComponent = class _ScheduleTimelineComponent {
  constructor() {
    ...
    this.view_tab = input("displays", ...ngDevMode ? [{ debugName: "view_tab" }] : (
      /* istanbul ignore next */
      []
    ));
    this.selected_date = input.required(...ngDevMode ? [{ debugName: "selected_date" }] : (
      /* istanbul ignore next */
      []
    ));
    this.current_minutes = input(0, ...ngDevMode ? [{ debugName: "current_minutes" }] : (
      /* istanbul ignore next */
      []
    ));
    this.show_current_time = input(false, ...ngDevMode ? [{ debugName: "show_current_time" }] : (
      /* istanbul ignore next */
      []
    ));
    this.playlist_approval_status = input({}, ...ngDevMode ? [{ debugName: "playlist_approval_status" }] : (
      /* istanbul ignore next */
      []
    ));
    this.block_width = 6;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleTimelineComponent, { className: "ScheduleTimelineComponent", filePath: "apps/signage-manager/src/app/schedules/schedule-timeline.component.ts", lineNumber: 301 });
})();
...
var SchedulesSectionComponent = class _SchedulesSectionComponent {
  constructor() {
    ...
    this.view_tab = signal("displays", ...ngDevMode ? [{ debugName: "view_tab" }] : (
      /* istanbul ignore next */
      []
    ));
    this.search_term = signal("", ...ngDevMode ? [{ debugName: "search_term" }] : (
      /* istanbul ignore next */
      []
    ));
    this.selected_date = signal(startOfDay(/* @__PURE__ */ new Date()), ...ngDevMode ? [{ debugName: "selected_date" }] : (
      /* istanbul ignore next */
      []
    ));
    this.current_time = signal(/* @__PURE__ */ new Date(), ...ngDevMode ? [{ debugName: "current_time" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this._route_tab = toSignal(this._route.queryParamMap.pipe(map((params) => params.get(TAB_QUERY_PARAM))), { initialValue: null });
    this.playlist_approval_status = this._service.playlist_approval_status;
    this.display_total = computed(() => this._displays().length, ...ngDevMode ? [{ debugName: "display_total" }] : (
      /* istanbul ignore next */
      []
    ));
    this.zone_total = computed(() => this._zones().length, ...ngDevMode ? [{ debugName: "zone_total" }] : (
      /* istanbul ignore next */
      []
    ));
    this.search_placeholder = computed(() => this.view_tab() === "displays" ? "SIGNAGE_MANAGER.SEARCH_DISPLAYS_ZONES_PLAYLISTS" : "SIGNAGE_MANAGER.SEARCH_ZONES_PLAYLISTS", ...ngDevMode ? [{ debugName: "search_placeholder" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.show_current_time = computed(() => isSameDay(this.selected_date(), this.current_time()), ...ngDevMode ? [{ debugName: "show_current_time" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.rows = computed(() => this.view_tab() === "displays" ? this.display_rows() : this.zone_rows(), ...ngDevMode ? [{ debugName: "rows" }] : (
      /* istanbul ignore next */
      []
    ));
    effect(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SchedulesSectionComponent, { className: "SchedulesSectionComponent", filePath: "apps/signage-manager/src/app/schedules/schedules.component.ts", lineNumber: 250 });
})();
export {
  SchedulesSectionComponent
};
//# sourceMappingURL=schedules.component-STJHAHWE.js.map
