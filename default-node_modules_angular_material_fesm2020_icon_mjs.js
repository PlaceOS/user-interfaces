"use strict";(self.webpackChunkconcierge=self.webpackChunkconcierge||[]).push([["default-node_modules_angular_material_fesm2020_icon_mjs"],{7822:(q,y,l)=>{l.d(y,{Hw:()=>J,Ps:()=>X});var i=l(2560),E=l(207),P=l(8971),S=l(4666),u=l(4139),w=l(6587),D=l(4350),N=l(6957),C=l(8759),g=l(6942),U=l(7418),x=l(4661),B=l(4514),W=l(3910),F=l(8987),M=l(4497);
/**
     * @license
     ...
     */const b=["*"];let m;function d(s){return function K(){if(void 0===m&&(m=null,typeof window<"u")){const s=window;void 0!==s.trustedTypes&&(m=s.trustedTypes.createPolicy("angular#components",{createHTML:c=>c}))}return m}()?.createHTML(s)||s}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
