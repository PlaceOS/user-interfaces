...
} from "./chunk-3AKDHGBZ.js";
import {
  AuthenticatedImageDirective
} from "./chunk-PUH3M47P.js";
import {
  AiImageService
...
function filterManageNavItems(can_manage_groups, templates_enabled = false, ai_enabled = false) {
...
var NavFooterComponent = class _NavFooterComponent {
  constructor() {
    ...
    this.primary_nav_items = computed(
      () => filterManageNavItems(this.can_manage_groups(), this._service.templates_enabled(), this._ai.enabled()).filter((item) => !this.MORE_MENU_ROUTES.includes(item.route)),
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavFooterComponent, { className: "NavFooterComponent", filePath: "apps/signage-manager/src/app/shared/nav-footer.component.ts", lineNumber: 131 });
})();
...
var NavSidebarComponent = class _NavSidebarComponent {
  constructor() {
    ...
    this.nav_items = computed(
      () => filterManageNavItems(this._service.can_manage_all_groups() || !!this._service.manageable_signage_groups().length, this._service.templates_enabled(), this._ai.enabled()),
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavSidebarComponent, selectors: [["nav-sidebar"]], decls: 11, vars: 7, consts: [["route_active", "routerLinkActive"], ["language_menu", "matMenu"], [1, "bg-secondary", "text-secondary-content", "border-base-100", "relative", "z-30", "hidden", "h-full", "flex-col", "border-r", "p-2", "shadow-lg", "sm:flex"], ["logo", "", 1, "bg-base-100/80", "mx-auto", "flex", "h-20", "w-20", "shrink-0", "items-center", "justify-center", "rounded-2xl", "shadow-xl", 3, "routerLink"], ["auth", "", 1, "max-h-18", "max-w-18", "object-contain", 3, "alt", "source"], [1, "opacity-20"], [1, "flex", "min-h-0", "w-[calc(100%+0.5rem)]", "flex-1", "flex-col", "gap-4", "overflow-x-hidden", "overflow-y-auto", "p-2"], ["routerLinkActive", "active bg-primary/30", 1, "hover:bg-base-100/30", "focus-visible:bg-base-100/30", "relative", "flex", "h-18", "w-18", "shrink-0", "flex-col", "items-center", "justify-center", "rounded-xl", 3, "routerLink"], [1, "shrink-0", "p-2"], [1, "text-3xl"], [1, "text-center", "text-xs", "font-medium"], ["active", "", 1, "bg-base-100", "absolute", "inset-y-0", "top-0", "-right-4", "w-2", "rounded-l-lg"], ["type", "button", "matRipple", "", "matTooltipPosition", "right", 1, "hover:bg-base-100/30", "focus-visible:bg-base-100/30", "mb-2", "flex", "h-18", "w-18", "flex-col", "items-center", "justify-center", "rounded-xl", "text-center", 3, "matMenuTriggerFor", "matTooltip"], [1, "mt-1", "line-clamp-2", "w-full", "px-1", "text-xs", "leading-tight", "font-medium"], ["xPosition", "after"], ["type", "button", "mat-menu-item", "", "matTooltipPosition", "right", 3, "matTooltip", "font-semibold"], ["type", "button", "mat-menu-item", "", "matTooltipPosition", "right", 3, "click", "matTooltip"], [1, "flex", "max-w-64", "min-w-44", "items-center", "gap-3"], [1, "text-xl"], [1, "min-w-0", "leading-tight"], [1, "text-base-content/60", "truncate", "text-xs"]], template: function NavSidebarComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        let tmp_2_0;
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(1, 4, "SIGNAGE_MANAGER.PRIMARY_NAV"));
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(6, _c02));
        \u0275\u0275advance();
        \u0275\u0275conditional((tmp_2_0 = ctx.logo_src) ? 3 : 4, tmp_2_0);
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavSidebarComponent, { className: "NavSidebarComponent", filePath: "apps/signage-manager/src/app/shared/nav-sidebar.component.ts", lineNumber: 155 });
})();
...
//# debugId=f39c7fc2-642a-5c96-b236-bb4fc4cca91d
//# sourceMappingURL=chunk-SPCJEKB5.js.map
