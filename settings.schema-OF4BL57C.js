...
var properties = {
  ...
  schedule_timezone_once_only: {
    type: "boolean",
    default: true,
    description: "Show the timezone selector above the timing fields for schedules that play once and inside the validity block for recurring schedules. Set to false to show it above the timing fields for both schedule types."
  },
  locales: {
    type: "array",
  ...
  features: {
    type: "array",
    description: "Signage features available to every group: `templates`, `template-editing`, `ai-generation`, `ai-editing`, `branding-editing`. Signage group feature flags can narrow this list. Defaults to all features.",
    items: {
      type: "string",
      enum: [
        "templates",
...
//# debugId=c6ec183c-ccb1-50a4-83ec-0c38df112f6e
//# sourceMappingURL=settings.schema-OF4BL57C.js.map
