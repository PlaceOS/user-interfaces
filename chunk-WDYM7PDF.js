...
} from "./chunk-2SQ7BBBV.js";
import {
  markSignageSharedGroupsChanged,
  openConfirmModal
} from "./chunk-2KM254EA.js";
import {
  loadAuthenticatedImage
} from "./chunk-B6XI7VOD.js";
import {
...
var SignageService = class _SignageService {
  ...
  async addPlaylist() {
    if (!this._requirePermission(this.can_create(), i18n("SIGNAGE_MANAGER.SVC_NO_CREATE_PLAYLISTS")))
      return;
    const { PlaylistEditModalComponent } = await import("./playlist-edit-modal.component-5LNSCDE5.js");
  ...
  async approvePlaylist(playlist) {
    ...
    if (!this._requirePermission(this.can_approve(), i18n("SIGNAGE_MANAGER.SVC_NO_APPROVE_PLAYLISTS")))
      return;
    const { PlaylistApproveModalComponent } = await import("./playlist-approve-modal.component-3IRFW5F7.js");
  ...
  async requestPlaylistApproval(playlist) {
    ...
    if (!group)
      return;
    const { PlaylistRequestApprovalModalComponent } = await import("./playlist-request-approval-modal.component-MYCNVLH3.js");
  ...
  async editPlaylistItemSchedules(items) {
    ...
    if (!this._requirePermission(this.can_update(), i18n("SIGNAGE_MANAGER.SVC_NO_UPDATE_PLAYLISTS")))
      return false;
    const { PlaylistItemScheduleModalComponent } = await import("./playlist-item-schedule-modal.component-KJU7BLYL.js");
  ...
  async addTemplate() {
    if (!this._requirePermission(this.can_create(), i18n("SIGNAGE_MANAGER.SVC_NO_CREATE_TEMPLATES")))
      return;
    const { TemplateEditModalComponent } = await import("./template-edit-modal.component-U5U43A7P.js");
  ...
  async editTemplateMapping(target, mapping = null) {
    ...
    const { TemplateMappingModalComponent } = await import("./template-mapping-modal.component-6MVBRIG6.js");
  ...
  async approveTemplate(template) {
    ...
    if (!this._requirePermission(this.can_approve(), i18n("SIGNAGE_MANAGER.SVC_NO_APPROVE_TEMPLATES")))
      return;
    const { TemplateApproveModalComponent } = await import("./template-approve-modal.component-YNP5HRM2.js");
  ...
  async requestTemplateApproval(template) {
    ...
    if (!group)
      return;
    const { TemplateRequestApprovalModalComponent } = await import("./template-request-approval-modal.component-4PMWKH6O.js");
  ...
  async _shareSignageItems(item_type, item_ids) {
    ...
    const { GroupSelectModalComponent } = await import("./group-select-modal.component-TJVOJ2JB.js");
  ...
  async previewMedia(item) {
    ...
    const { MediaPreviewModalComponent } = await import("./media-preview-modal.component-SAK4SNJJ.js");
  ...
  async bulkUploadMedia(files, playlist_id = "") {
    ...
    const { BulkMediaUploadModalComponent } = await import("./bulk-media-upload-modal.component-CZ57G3E5.js");
  ...
  async generateMediaWithAI(options = {}) {
    ...
    if (this._ai_modal_ref)
      return;
    const { AiImageModalComponent } = await import("./ai-image-modal.component-YETH7MYX.js");
  ...
  async editMedia(media = new ws({}), file, playlist_id = "", prepared_file_metadata, plugin) {
    ...
    const { MediaEditModalComponent } = await import("./media-edit-modal.component-N5ZUP42A.js");
  ...
  async addMediaTags(items) {
    ...
    if (!this._requirePermission(this.can_update(), i18n("SIGNAGE_MANAGER.SVC_NO_UPDATE_MEDIA")))
      return false;
    const { MediaTagsModalComponent } = await import("./media-tags-modal.component-DRD42Q6H.js");
  ...
  async renameMediaTag(tag, count) {
    ...
    if (!this._requirePermission(this.can_update_media_tags(), i18n("SIGNAGE_MANAGER.SVC_NO_UPDATE_MEDIA")))
      return false;
    const { MediaTagModalComponent } = await import("./media-tag-modal.component-KRZCYFXI.js");
  ...
  async openPlaylistSelectModal(media_id) {
    const { PlaylistSelectModalComponent } = await import("./playlist-select-modal.component-5SL7UN2R.js");
  ...
  async addZone() {
    if (!this._requirePermission(this.can_manage_zones(), i18n("SIGNAGE_MANAGER.SVC_NO_MANAGE_ZONES")))
      return null;
    const { ZoneEditModalComponent } = await import("./zone-edit-modal.component-5U6QHRWM.js");
  ...
  async addDisplay() {
    ...
    const { DisplayEditModalComponent } = await import("./display-edit-modal.component-NAHTZO62.js");
  ...
  async addDisplayToZone(zone) {
    if (!this._requirePermission(this.can_update(), i18n("SIGNAGE_MANAGER.SVC_NO_UPDATE_ASSIGNMENTS")))
      return;
    const { DisplaySelectModalComponent } = await import("./display-select-modal.component-TPTKNPTK.js");
  ...
  async addPlaylistToDisplay(display) {
    ...
    const updated = await $a(display.id, { playlists, version: display.version }, "patch").catch(() => {
  ...
  async addDisplayToPlaylist(playlist) {
    ...
    if (!display_id)
      return;
    const display = this.displays().find((d) => d.id === display_id) || await ba(display_id).catch(() => {
      notifyError(i18n("SIGNAGE_MANAGER.SVC_PLAYLIST_ADD_DISPLAY_ERROR"));
      return null;
    });
    if (!display)
  ...
  async addZoneToPlaylist(playlist) {
    if (!this._requirePermission(this.can_update(), i18n("SIGNAGE_MANAGER.SVC_NO_UPDATE_ASSIGNMENTS")))
      return;
    const { ZoneSelectModalComponent } = await import("./zone-select-modal.component-JR5H3CMH.js");
...
//# debugId=098986cb-b295-50da-9b17-fee339a4fc83
//# sourceMappingURL=chunk-WDYM7PDF.js.map
