...
function UserListFieldComponent_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classProp("text-base-content!", !item_r2.is_external)("text-warning-content!", item_r2.is_external);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(5, 15, "COMMON.REMOVE_ITEM", \u0275\u0275pureFunction1(18, _c1, item_r2.name || item_r2.email)));
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserListFieldComponent, { className: "UserListFieldComponent", filePath: "libs/form-fields/src/lib/user-list-field.component.ts", lineNumber: 248 });
})();

export {
  UserListFieldComponent
};
//# sourceMappingURL=chunk-OFHL6E7E.js.map
