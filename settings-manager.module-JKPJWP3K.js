...
} from "./chunk-6Y5ZM3H6.js";
import {
  PointsAssetsComponent,
  PointsOverviewComponent,
  PointsStateService
} from "./chunk-LJ2KWQGV.js";
import {
...
var _POIModalComponent = class _POIModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    this.loading = true;
    const old_metadata = await Pu(this._org.organisation.id, "points-of-interest", {}).toPromise();
    ...
    const resp = await Tu(this._org.organisation.id, {
...
var _POIManagementService = class _POIManagementService {
  constructor() {
    ...
    this._features = combineLatest([
      ...
      this._change
    ]).pipe(switchMap(() => Pu(this._org.organisation.id, "points-of-interest").pipe(catchError((_) => of({ details: {} })))), map((_) => {
...
_POIListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _POIListComponent, selectors: [["poi-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 13, vars: 29, consts: [["level_template", ""], ["bool_template", ""], ["action_template", ""], ["qr_menu", ""], ["menu", "matMenu"], ["print_content", ""], [1, "absolute", "inset-0", "overflow-auto", "px-8"], ["empty_message", "No Points of Interest found.", 1, "block", "min-w-[48rem]", "text-sm", 3, "data", "columns", "sortable"], [1, "h-12", "w-full"], [1, "p-4"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-success", "text-2xl", "text-success-content"], [1, "mx-auto", "flex", "w-full", "justify-end", "space-x-2", "px-4", "py-2"], [3, "matTooltip"], ["icon", "", "matRipple", "", "customTooltip", "", 3, "click", "content", "data"], ["icon", "", "matRipple", "", "customTooltip", "", 3, "click", "disabled", "data", "content"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-red-500", "flex", "items-center", "space-x-2"], [1, "text-error"], [1, "rounded", "bg-base-100", "py-2", "shadow"], ["printable", "", 1, "", 3, "content"], ["btn", "", "matRipple", "", 1, "mx-4", "my-2", "w-[calc(100%-2rem)]", 3, "click"], ["target", "_blank", "ref", "noopener noreferrer", 1, "mx-4", "my-2", "block", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", 3, "href"], [1, "mx-auto", "w-48", 3, "src"], [1, "mx-4", "mt-2", "w-[calc(100%-2rem)]", "rounded", "bg-base-200", "p-2", "text-center", "font-mono", "text-sm"]], template: function POIListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_UrlListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UrlListComponent, selectors: [["short-url-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 13, vars: 29, consts: [["url_template", ""], ["desc_template", ""], ["action_template", ""], ["qr_menu", ""], ["menu", "matMenu"], ["print_content", ""], [1, "absolute", "inset-0", "overflow-auto", "px-8"], ["empty_message", "No Points of Interest found.", 1, "block", "min-w-[64rem]", "text-sm", 3, "data", "columns", "sortable"], [1, "h-12", "w-full"], ["link", "", 1, "w-full", "overflow-hidden", "break-words", "p-4", "text-xs", 3, "href"], [1, "p-4", "text-xs"], [1, "opacity-30"], [1, "mx-auto", "flex", "w-full", "justify-end", "space-x-2", "px-4", "py-2"], ["icon", "", "matRipple", "", "customTooltip", "", 3, "click", "content"], ["btn", "", "icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-red-500", "flex", "items-center", "space-x-2"], [1, "text-error"], [1, "rounded", "bg-base-100", "py-2", "shadow"], ["printable", "", 1, "", 3, "content"], ["btn", "", "matRipple", "", 1, "mx-4", "my-2", "w-[calc(100%-2rem)]", 3, "click"], ["target", "_blank", "ref", "noopener noreferrer", 1, "mx-4", "my-2", "block", "rounded-lg", "border", "border-base-200", "bg-base-100", "p-2", 3, "href"], [1, "mx-auto", "w-48", 3, "src"], [1, "mx-4", "mt-2", "w-[calc(100%-2rem)]", "rounded", "bg-base-200", "p-2", "text-center", "font-mono", "text-sm"]], template: function UrlListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6);
    \u0275\u0275element(1, "simple-table", 7);
    \u0275\u0275pipe(2, "translate");
...
//# sourceMappingURL=settings-manager.module-JKPJWP3K.js.map
