...
_UserSearchFieldComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserSearchFieldComponent, selectors: [["a-user-search-field"]], viewQuery: function UserSearchFieldComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._input_el, _c03, 5, ElementRef)(ctx._autocomplete_trigger, MatAutocompleteTrigger, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance(2);
  }
...
function newBookingFromCalendarEvent(event) {
  ...
  return new Booking(__spreadProps(__spreadValues({
    ...
    date,
    duration: event.duration,
    asset_id: ((_b = event.system) == null ? void 0 : _b.id) || event.system_id,
    asset_name: ((_c = event.system) == null ? void 0 : _c.display_name) || ((_d = event.system) == null ? void 0 : _d.name),
    booking_type: "room",
...
//# sourceMappingURL=chunk-H47ZJMW5.js.map
