...
} from "./chunk-BN7HH7NS.js";
import {
  PlaylistThumbnailComponent
} from "./chunk-7YCR63BW.js";
import {
  DateFromPipe,
  isDisplayOnline
} from "./chunk-OOBHS2UF.js";
import {
...
// apps/signage-manager/src/app/displays/display-schedule.util.ts
function buildDisplayScheduleDays(playlists, mappings, days) {
  const templates = mappings.flatMap((mapping) => buildScheduleBlocks([
    {
      playlist: new _r({
        id: mapping.id,
        name: mapping.template_details.name || mapping.template_id,
        schedules: mapping.schedule ? [mapping.schedule] : []
      })
    }
  ], days).map((block) => __spreadProps(__spreadValues({}, block), {
    mapping,
    children: []
  })));
  return days.map((day, day_index) => {
    const parents = templates.filter((block) => block.day_index === day_index);
    const standalone = [];
    for (const playlist of playlists.filter((block) => block.day_index === day_index)) {
      let remaining = [playlist];
      for (const parent of parents) {
        const start = Math.max(playlist.start_minutes, parent.start_minutes);
        ...
        remaining = remaining.flatMap((block) => {
          ...
          if (block.start_minutes < overlap_start) {
            parts.push(sliceBlock(block, block.start_minutes, overlap_start, day));
          }
          if (overlap_end < blockEnd(block)) {
            parts.push(sliceBlock(block, overlap_end, blockEnd(block), day));
          }
          return parts;
        });
      }
      standalone.push(...remaining.map((block) => __spreadProps(__spreadValues({}, block), { children: [] })));
    }
    const items = [...parents, ...standalone].sort(sortBlocks);
    for (const parent of parents)
      parent.children.sort(sortBlocks);
    return {
      items,
...
function blockEnd(block) {
  return Math.min(MINUTES_PER_DAY, block.start_minutes + block.duration_minutes);
}
function sliceBlock(block, start, end, day) {
  if (start === block.start_minutes && end === blockEnd(block))
    return block;
...
function sortBlocks(left, right) {
  return Number(right.all_day) - Number(left.all_day) || left.start_minutes - right.start_minutes || left.playlist.name.localeCompare(right.playlist.name);
}

// apps/signage-manager/src/app/displays/display-schedule.component.ts
var _c0 = (a0) => ["/templates", a0];
...
function DisplayScheduleComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 1, "SIGNAGE_MANAGER.NO_SCHEDULE_CONTENT"), " ");
  }
}
function DisplayScheduleComponent_Conditional_22_For_3_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 17);
  }
}
function DisplayScheduleComponent_Conditional_22_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, DisplayScheduleComponent_Conditional_22_For_3_Conditional_7_Template, 1, 0, "div", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DisplayScheduleComponent_Conditional_22_For_6_For_3_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "SIGNAGE_MANAGER.DEFAULT_TEMPLATE"), " ");
  }
}
function DisplayScheduleComponent_Conditional_22_For_6_For_3_Conditional_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "a", 29)(2, "icon", 23);
    \u0275\u0275text(3, "playlist_play");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(8, _c1, child_r4.playlist.id))("matTooltip", ctx_r2.block_tooltip(child_r4));
    \u0275\u0275advance();
    \u0275\u0275styleProp("color", child_r4.text_color);
    \u0275\u0275advance(3);
    \u0275\u0275classProp("line-through", !child_r4.playlist.enabled);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", child_r4.playlist.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", child_r4.label, " ");
  }
}
function DisplayScheduleComponent_Conditional_22_For_6_For_3_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 28);
    \u0275\u0275repeaterCreate(1, DisplayScheduleComponent_Conditional_22_For_6_For_3_Conditional_10_For_2_Template, 9, 10, "li", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const block_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275repeater(block_r5.children);
  }
}
function DisplayScheduleComponent_Conditional_22_For_6_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 20)(1, "a", 22)(2, "icon", 23);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, DisplayScheduleComponent_Conditional_22_For_6_For_3_Conditional_9_Template, 3, 3, "div", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(10, DisplayScheduleComponent_Conditional_22_For_6_For_3_Conditional_10_Template, 3, 0, "ul", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", block_r5.mapping ? \u0275\u0275pureFunction1(11, _c0, block_r5.mapping.template_id) : \u0275\u0275pureFunction1(13, _c1, block_r5.playlist.id))("matTooltip", ctx_r2.block_tooltip(block_r5));
    \u0275\u0275advance();
    \u0275\u0275styleProp("color", block_r5.text_color);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", block_r5.mapping ? "dashboard" : "playlist_play", " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("line-through", !block_r5.playlist.enabled);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", block_r5.playlist.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", block_r5.label, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(block_r5.mapping && !block_r5.mapping.schedule ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(block_r5.children.length ? 10 : -1);
  }
}
function DisplayScheduleComponent_Conditional_22_For_6_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21)(1, "icon", 32);
    \u0275\u0275text(2, "event_busy");
    \u0275\u0275elementEnd();
...
function DisplayScheduleComponent_Conditional_22_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18)(1, "ul", 19);
    \u0275\u0275repeaterCreate(2, DisplayScheduleComponent_Conditional_22_For_6_For_3_Template, 11, 15, "li", 20, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, DisplayScheduleComponent_Conditional_22_For_6_Conditional_4_Template, 6, 3, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("today-column", ctx_r2.isToday(day_r6));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r2.day_blocks()[\u0275$index_70_r7].items);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r2.day_blocks()[\u0275$index_70_r7].all_day.length && !ctx_r2.day_blocks()[\u0275$index_70_r7].timed.length ? 4 : -1);
  }
}
function DisplayScheduleComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 10);
    \u0275\u0275repeaterCreate(2, DisplayScheduleComponent_Conditional_22_For_3_Template, 8, 17, "div", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 12);
    \u0275\u0275repeaterCreate(5, DisplayScheduleComponent_Conditional_22_For_6_Template, 5, 3, "div", 13, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var DisplayScheduleComponent = class _DisplayScheduleComponent {
  constructor() {
    ...
    this._template_mappings = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_template_mappings" } : (
      ...
      params: () => this._service.templates_enabled() ? this.selected_display()?.id : void 0,
      loader: ({ params }) => this._service.listTemplateMappings({ control_system_id: params })
    }));
    this.templates_loading = this._template_mappings.isLoading;
    this.templates_error = this._template_mappings.error;
    this.template_mappings = computed(
      () => this._template_mappings.hasValue() ? this._template_mappings.value() : [],
      ...ngDevMode ? [{ debugName: "template_mappings" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this.day_blocks = computed(
      () => buildDisplayScheduleDays(this.schedule_entries(), this.template_mappings(), this.days()),
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DisplayScheduleComponent, selectors: [["display-schedule"]], decls: 23, vars: 20, consts: [[1, "flex", "h-full", "flex-col", "overflow-hidden"], [1, "border-base-200", "flex", "items-center", "justify-center", "gap-0.5", "border-b", "px-3", "py-2"], ["icon", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], [1, "ml-1.5", "text-sm", "font-medium"], [1, "flex", "flex-1", "items-center", "justify-center", "p-8"], [1, "text-error", "p-8", "text-center"], [1, "text-base-content/40", "flex", "flex-1", "flex-col", "items-center", "justify-center", "gap-3"], ["timeline", "", 1, "z-0", "grid", "min-h-0", "flex-1", "overflow-auto"], [1, "text-4xl"], [1, "text-sm"], ["day-headers", "", 1, "border-base-300", "bg-base-100", "sticky", "top-0", "z-20", "flex", "min-w-[calc(100%-5rem)]", "items-center", "border-b"], [1, "relative", "flex", "h-full", "min-w-48", "flex-1", "flex-col", "items-center", "justify-center", "py-2", "leading-tight", 3, "today-column"], ["date-blocks", "", 1, "relative", "flex", "min-w-[calc(100%-5rem)]"], [1, "border-base-content/[0.06]", "min-w-48", "flex-1", "border-r", "p-2", "last:border-none", 3, "today-column"], [1, "relative", "flex", "h-full", "min-w-48", "flex-1", "flex-col", "items-center", "justify-center", "py-2", "leading-tight"], [1, "text-base-content/45", "text-[10px]", "font-medium", "tracking-wide", "uppercase"], [1, "truncate", "text-sm"], [1, "bg-base-content/10", "absolute", "top-0", "-left-px", "h-2", "w-px"], [1, "border-base-content/[0.06]", "min-w-48", "flex-1", "border-r", "p-2", "last:border-none"], [1, "space-y-2"], [1, "border-base-content/10", "rounded-md", "border"], [1, "border-base-content/10", "text-base-content/25", "flex", "min-h-20", "flex-col", "items-center", "justify-center", "gap-1", "rounded-md", "border", "border-dashed"], [1, "hover:bg-base-content/[0.04]", "flex", "items-start", "gap-2", "rounded-md", "px-2", "py-1.5", "no-underline", 3, "routerLink", "matTooltip"], [1, "mt-0.5", "shrink-0", "text-sm"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-[13px]", "font-medium"], [1, "text-base-content/60", "text-[11px]", "tabular-nums"], [1, "text-primary", "text-[11px]"], [1, "border-base-content/10", "mb-2", "ml-4", "space-y-1", "border-l", "pr-1", "pl-2"], [1, "hover:bg-base-content/[0.04]", "flex", "gap-2", "rounded-md", "px-2", "py-1", "no-underline", 3, "routerLink", "matTooltip"], [1, "min-w-0"], [1, "truncate", "text-[13px]"], [1, "text-base"], [1, "text-[11px]"]], template: function DisplayScheduleComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275conditionalCreate(19, DisplayScheduleComponent_Conditional_19_Template, 3, 3, "div", 4)(20, DisplayScheduleComponent_Conditional_20_Template, 3, 3, "div", 5)(21, DisplayScheduleComponent_Conditional_21_Template, 6, 3, "div", 6)(22, DisplayScheduleComponent_Conditional_22_Template, 7, 4, "div", 7);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(5);
        \u0275\u0275conditional(ctx.templates_loading() ? 19 : ctx.templates_error() ? 20 : !ctx.schedule_entries().length && !ctx.template_mappings().length ? 21 : 22);
      }
    }, dependencies: [
      MatRippleModule,
      MatRipple,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplayScheduleComponent, { className: "DisplayScheduleComponent", filePath: "apps/signage-manager/src/app/displays/display-schedule.component.ts", lineNumber: 322 });
})();
...
function DisplayContentComponent_Conditional_0_Conditional_4_Conditional_9_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(11, _c12, playlist_r3.id));
...
function DisplayContentComponent_Conditional_0_Conditional_4_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, DisplayContentComponent_Conditional_0_Conditional_4_Conditional_9_For_1_Template, 14, 15, "div", 15, _forTrack0);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function DisplayContentComponent_Conditional_0_Conditional_5_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, DisplayContentComponent_Conditional_0_Conditional_5_Conditional_8_For_1_Template, 8, 11, "a", 30, _forTrack0);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function DisplayHeaderComponent_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "SIGNAGE_MANAGER.NEW_DISPLAY"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 4, "SIGNAGE_MANAGER.CREATE_NEW_DISPLAY"));
  }
}
var DisplayHeaderComponent = class _DisplayHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DisplayHeaderComponent, selectors: [["display-header"]], decls: 12, vars: 11, consts: [[1, "bg-base-100", "border-base-300", "sticky", "top-0", "flex", "flex-wrap", "items-center", "gap-2", "border-b", "px-4", "py-2", "shadow", "sm:flex-nowrap"], [1, "py-2"], [1, "text-2xl", "font-medium"], [1, "flex", "flex-wrap", "items-center", "gap-2"], [1, "text-sm", "opacity-60"], [1, "w-px", "flex-1"], ["icon", "", "default", "", "type", "button", "matRipple", "", 1, "text-xl", 3, "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", 1, "text-xl", 3, "click", "matTooltip"]], template: function DisplayHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275element(10, "div", 5);
        \u0275\u0275conditionalCreate(11, DisplayHeaderComponent_Conditional_11_Template, 5, 6, "button", 6);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplayHeaderComponent, { className: "DisplayHeaderComponent", filePath: "apps/signage-manager/src/app/displays/display-header.component.ts", lineNumber: 57 });
})();

// apps/signage-manager/src/app/displays/display-list.component.ts
var _c04 = ["display_item"];
var _c13 = (a0) => ["/displays", a0];
var _c22 = (a0) => ({ name: a0 });
var _c32 = (a0) => ({ time: a0 });
var _forTrack02 = ($index, $item) => $item.id;
function DisplayListComponent_Conditional_6_For_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function DisplayListComponent_Conditional_6_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, DisplayListComponent_Conditional_6_For_1_Conditional_12_Template, 2, 5, "div", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(25, _c13, display_r1.id));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(2, 16, "SIGNAGE_MANAGER.OPEN_DISPLAY", \u0275\u0275pureFunction1(27, _c22, display_r1.display_name || display_r1.name)));
    \u0275\u0275advance(3);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind2(4, 19, ctx_r1.statusLabel(display_r1), \u0275\u0275pureFunction1(29, _c32, ctx_r1.lastSeen(display_r1))));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(5, 22, ctx_r1.statusLabel(display_r1), \u0275\u0275pureFunction1(31, _c32, ctx_r1.lastSeen(display_r1))));
    \u0275\u0275advance(5);
    \u0275\u0275classProp("bg-success", ctx_r1.isOnline(display_r1))("bg-error", !ctx_r1.isOnline(display_r1));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", display_r1.display_name || display_r1.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(display_r1.description ? 12 : -1);
  }
}
...
function DisplayListComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, DisplayListComponent_Conditional_6_For_1_Template, 13, 33, "a", 6, _forTrack02);
...
function DisplayListComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "icon", 18);
    \u0275\u0275text(2, "tv");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4);
...
var DisplayListComponent = class _DisplayListComponent {
  constructor() {
    ...
    const timer = setInterval(() => this._now.set(Date.now()), 60 * 1e3);
  ...
  statusLabel(display) {
    ...
    return this.isOnline(display) ? "SIGNAGE_MANAGER.DISPLAY_STATUS_ONLINE" : "SIGNAGE_MANAGER.DISPLAY_STATUS_OFFLINE";
  }
  ...
  lastSeen(display) {
    ...
    if (!display.signage_last_seen)
      return "";
    return this._date_from.transform(display.signage_last_seen * 1e3);
  }
  static {
  ...
  static {
    ...
    }, decls: 8, vars: 8, consts: [["display_item", ""], [1, "bg-base-100", "border-base-300", "h-full", "min-w-64", "overflow-auto", "border-r", "sm:max-w-80"], [1, "border-base-300", "border-b", "p-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], [1, "text-base-content/70", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["matRipple", "", "queryParamsHandling", "merge", 1, "border-base-300", "flex", "w-full", "cursor-pointer", "items-center", "gap-3", "border-b", "px-4", "py-3", "text-left", "no-underline", "transition-colors", 3, "bg-primary", "text-primary-content", "hover:bg-base-200", "routerLink"], ["intersect", "", 1, "h-px", "w-full"], [1, "text-base-content/50", "p-3", "text-center", "text-xs"], ["matRipple", "", "queryParamsHandling", "merge", 1, "border-base-300", "flex", "w-full", "cursor-pointer", "items-center", "gap-3", "border-b", "px-4", "py-3", "text-left", "no-underline", "transition-colors", 3, "routerLink"], ["role", "img", 1, "relative", "shrink-0", 3, "matTooltip"], [1, "text-2xl"], [1, "border-base-100", "absolute", "-right-0.5", "-bottom-0.5", "h-2.5", "w-2.5", "rounded-full", "border-2"], [1, "min-w-0", "flex-1"], [1, "truncate", "font-medium"], [1, "mt-0.5", "truncate", "text-xs", 3, "opacity-70", "opacity-90"], [1, "mt-0.5", "truncate", "text-xs"], ["intersect", "", 1, "h-px", "w-full", 3, "intersect"], [1, "text-6xl"]], template: function DisplayListComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplayListComponent, { className: "DisplayListComponent", filePath: "apps/signage-manager/src/app/displays/display-list.component.ts", lineNumber: 155 });
})();
...
function DisplaysSectionComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(24, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(25, DisplaysSectionComponent_Conditional_7_Conditional_25_Template, 5, 14, "button", 20);
    ...
    \u0275\u0275listener("click", function DisplaysSectionComponent_Conditional_7_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 45, "SIGNAGE_MANAGER.BACK_TO_DISPLAYS"));
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(16, 47, "SIGNAGE_MANAGER.OPEN_PANEL"))("href", ctx_r1.panel_link(), \u0275\u0275sanitizeUrl);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(17, 49, "SIGNAGE_MANAGER.OPEN_PANEL_NEW_TAB"));
    \u0275\u0275advance(5);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(21, 51, "SIGNAGE_MANAGER.DISPLAY_DETAILS_TABS"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(24, 53, "SIGNAGE_MANAGER.SCHEDULE"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(28, 55, "SIGNAGE_MANAGER.NAV_PLAYLISTS"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(33, 57, "SIGNAGE_MANAGER.NAV_ZONES"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275attribute("aria-busy", ctx_r1.zone_count_loading());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.zone_count_loading() ? "?" : ctx_r1.zone_count(), " ");
  }
}
...
var DisplaysSectionComponent = class _DisplaysSectionComponent {
  constructor() {
    ...
    this._template_mappings = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_template_mappings" } : (
      ...
      params: () => {
        ...
        return this.templates_enabled() && id ? { id, revision: this._service.template_mappings_revision() } : void 0;
      },
      loader: ({ params }) => this._service.listTemplateMappings({
        control_system_id: params.id
      })
    }));
    this.template_count_loading = this._template_mappings.isLoading;
    this.playlist_count_loading = this._service.playlists_loading;
    this.zone_count_loading = this._service.all_zones_loading;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DisplaysSectionComponent, selectors: [["displays-section"]], inputs: { id: [1, "id"], tab: [1, "tab"] }, decls: 10, vars: 6, consts: [[1, "bg-base-200", "absolute", "inset-0", "flex", "flex-col", "sm:flex-row"], [1, "sm:h-full"], [1, "flex", "min-h-0", "flex-1", "flex-col", "overflow-hidden"], [1, "relative", "z-10"], [1, "flex", "min-h-0", "flex-1", "flex-row"], [1, "mobile-full"], [1, "flex", "min-h-0", "w-px", "flex-1", "flex-col"], [1, "h-1/2", "flex-1", 3, "activeTab"], [1, "bg-base-100", "border-base-300", "mx-2", "flex", "items-center", "gap-2", "rounded-b-lg", "border", "px-2", "py-1"], ["icon", "", "type", "button", "matRipple", "", 1, "desktop-hidden", 3, "click"], [1, "shrink-0", "text-2xl", "opacity-60"], [1, "min-w-0", "flex-1", "py-2"], [1, "truncate", "text-lg", "font-medium"], [1, "text-base-content/80", "truncate", "text-sm"], [1, "text-base-content/60", "truncate", "text-xs", "capitalize"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "matTooltip"], ["icon", "", "default", "", "error", "", "type", "button", "matRipple", "", 3, "matTooltip"], ["icon", "", "default", "", "matRipple", "", "target", "_blank", "rel", "noopener noreferrer", 3, "matTooltip", "href"], ["role", "tablist", 1, "bg-base-100", "border-base-300", "mx-2", "mt-2", "flex", "overflow-hidden", "rounded-lg", "border"], ["type", "button", "role", "tab", "aria-controls", "display-schedule-panel", "id", "display-schedule-tab", 1, "flex", "flex-1", "items-center", "justify-center", "gap-2", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], ["type", "button", "role", "tab", "aria-controls", "display-templates-panel", "id", "display-templates-tab", 1, "flex", "flex-1", "items-center", "justify-center", "gap-2", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "border-primary", "border-b-2", "text-primary", "opacity-60"], ["type", "button", "role", "tab", "aria-controls", "display-playlists-panel", "id", "display-playlists-tab", 1, "flex", "flex-1", "items-center", "justify-center", "gap-2", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "bg-base-content/5", "inline-flex", "h-6", "min-w-6", "items-center", "justify-center", "rounded-full", "px-1.5", "text-xs", "tabular-nums"], ["type", "button", "role", "tab", "aria-controls", "display-zones-panel", "id", "display-zones-tab", 1, "flex", "flex-1", "items-center", "justify-center", "gap-2", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], ["type", "button", "role", "tab", "aria-controls", "display-templates-panel", "id", "display-templates-tab", 1, "flex", "flex-1", "items-center", "justify-center", "gap-2", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"]], template: function DisplaysSectionComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(7, DisplaysSectionComponent_Conditional_7_Template, 36, 59);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DisplaysSectionComponent, { className: "DisplaysSectionComponent", filePath: "apps/signage-manager/src/app/displays/displays.component.ts", lineNumber: 333 });
})();
export {
  DisplaysSectionComponent
};
//# debugId=b5702281-5e22-5463-9651-d5cb45cd9f60
//# sourceMappingURL=displays.component-2757CYAI.js.map
