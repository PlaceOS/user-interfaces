...
function UserListFieldComponent_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(5, 5, "COMMON.REMOVE_ITEM", \u0275\u0275pureFunction1(8, _c2, item_r2.name || item_r2.email)));
  }
}
...
function UserListFieldComponent_Conditional_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, "FORM.USER_LIST_ADD_EXTERNAL", \u0275\u0275pureFunction1(4, _c3, ctx_r2.search())), " ");
  }
}
...
var UserListFieldComponent = class _UserListFieldComponent extends AsyncHandler {
  async searchStaff(q) {
    return this._use_basic_user_search() ? Ea({ q, authority_id: Rt()?.id }).then((_) => _.data.map((u) => new User(u))) : searchStaff(q);
  }
  constructor() {
    super();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListFieldComponent, selectors: [["a-user-list-field"]], viewQuery: function UserListFieldComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(17, UserListFieldComponent_Conditional_17_Template, 27, 18, "div", 12);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-LH2OMQTB.js.map
