...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ImageFieldComponent, { className: "ImageFieldComponent", filePath: "libs/form-fields/src/lib/image-field.component.ts", lineNumber: 121 });
})();
...
var POIModalComponent = class _POIModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    const old_metadata = await ju(this._org.organisation.id, "points-of-interest");
    ...
    const resp = await Gu(this._org.organisation.id, {
...
//# sourceMappingURL=poi-manager.routes-MUJEF3FQ.js.map
