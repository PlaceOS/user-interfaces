...
_AutoReleaseSettingsModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AutoReleaseSettingsModalComponent, selectors: [["auto-release-modal"]], decls: 8, vars: 6, consts: [[1, "m-2", "flex", "h-14", "w-[calc(100%-1rem)]", "items-center", "justify-between", "rounded-sm", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "w-lg", "overflow-auto", "px-4"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-32"], [1, "flex", "justify-end", "border-t", "border-base-200", "px-4", "py-2"], [1, "text-2xl"], [1, "flex", "space-x-2"], [1, "flex-1"], [3, "ngModelChange", "min", "max", "step", "ngModel"], [1, "flex", "items-end", "space-x-2"], [3, "ngModelChange", "no_past_times", "ngModel"], [1, "mb-4", "flex-1", 3, "ngModelChange", "name", "ngModel"], [1, "my-2", "grid", "grid-cols-2", "gap-2"], [1, "col-span-2", "mb-2", "flex", "w-full", "items-center", "justify-center", "rounded-sm", "bg-base-200", "py-4", "opacity-30"], ["btn", "", "matRipple", "", 1, "mb-4", "w-full", 3, "click"], ["appearance", "outline", 1, "w-full"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], ["value", "desk"], ["value", "visitor"], ["value", "parking"], ["value", "locker"], [1, "relative", "rounded-sm", "border", "border-base-300", "px-2", "pb-2", "pt-4"], [1, "absolute", "-top-2", "left-2", "rounded-sm", "bg-base-100", "px-2", "text-sm"], [1, "relative", "-top-0.5"], [1, "mb-1", "text-xs", "opacity-60"], [1, "mb-4", "space-y-4", "rounded-lg", "border", "border-base-200"], [3, "ngModelChange", "name", "ngModel"], [1, "flex", "h-14", "space-x-2", "px-2"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function AutoReleaseSettingsModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_InductionSettingsModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InductionSettingsModalComponent, selectors: [["induction-settings-modal"]], decls: 8, vars: 6, consts: [[1, "m-2", "flex", "h-14", "w-[calc(100%-1rem)]", "items-center", "justify-between", "rounded-sm", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "flex-col", "space-y-2", "px-4"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-32"], [1, "mt-2", "flex", "justify-end", "border-t", "border-base-200", "px-4", "py-2"], [1, "text-2xl"], [3, "ngModelChange", "ngModel", "name"], ["appearance", "outline", 1, "h-[50vh]", "w-xl", "max-w-[80vw]"], ["matInput", "", 1, "h-[calc(50vh-2rem)]", "w-136", "max-w-[calc(80vw-2rem)]", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function InductionSettingsModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "header", 0)(1, "h3", 1);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
_ItemListModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemListModalComponent, selectors: [["item-list-modal"]], decls: 16, vars: 6, consts: [["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-[50vh]", "w-xl", "space-y-2", "overflow-auto", "p-2"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "flex", "items-center", "justify-end", "border-t", "border-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["type", "text", 1, "flex-1", "rounded-sm", "border", "border-base-200", "px-4", "py-3", 3, "ngModelChange", "placeholder", "ngModel"], ["type", "email", 1, "flex-2", "rounded-sm", "border", "border-base-200", "px-4", "py-3", 3, "ngModelChange", "placeholder", "ngModel"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", "border", "border-error", "text-error", 3, "click", "matTooltip"], [1, "text-2xl"]], template: function ItemListModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_BuildingListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BuildingListComponent, selectors: [["building-list"]], decls: 18, vars: 34, consts: [["name_template", ""], ["timezone_template", ""], ["level_template", ""], ["image_template", ""], ["action_template", ""], ["menu", "matMenu"], ["app_settings_menu", "matMenu"], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "block", "w-full", "min-w-248", "text-sm", 3, "data", "empty_message", "columns", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "p-4", "font-mono", "text-xs"], ["auth", "", 1, "max-h-12", "max-w-32", 3, "source"], [1, "opacity-30"], [1, "flex", "w-full", "justify-center", "space-x-2", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], ["mat-menu-item", "", 3, "click"], ["className", "material-symbols-rounded", 1, "text-xl"], [1, "text-red-500", "flex", "items-center", "space-x-2"], [1, "text-xl", "text-error"]], template: function BuildingListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_LevelListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LevelListComponent, selectors: [["level-list"]], decls: 14, vars: 32, consts: [["name_template", ""], ["parking_template", ""], ["action_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "block", "min-w-3xl", "text-sm", 3, "data", "empty_message", "columns", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "bg-success", "text-2xl", "text-success-content"], [1, "flex", "w-full", "justify-center", "space-x-2", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], ["className", "material-symbols-rounded", 1, "text-2xl"], [1, "text-2xl", "text-error"]], template: function LevelListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_RegionListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegionListComponent, selectors: [["region-list"]], decls: 10, vars: 21, consts: [["name_template", ""], ["action_template", ""], ["menu", "matMenu"], ["app_settings_menu", "matMenu"], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "block", "min-w-lg", "text-sm", 3, "data", "empty_message", "columns", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "w-full", "justify-end", "space-x-2", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], ["mat-menu-item", "", 3, "click"], [1, "text-red-500", "flex", "items-center", "space-x-2"], [1, "text-xl", "text-error"]], template: function RegionListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275element(1, "simple-table", 5);
    \u0275\u0275pipe(2, "translate");
...
//# sourceMappingURL=zone-manager.module-YGFVYWEZ.js.map
