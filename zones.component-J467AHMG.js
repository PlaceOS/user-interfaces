...
function ZoneHeaderComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 7);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function ZoneHeaderComponent_Conditional_11_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(1, 2, "SIGNAGE_MANAGER.CREATE_NEW_ZONE"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 4, "SIGNAGE_MANAGER.NEW_ZONE"));
  }
}
var ZoneHeaderComponent = class _ZoneHeaderComponent {
  constructor() {
    ...
    this.can_manage_zones = this._service.can_manage_zones;
  }
  async addZone() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneHeaderComponent, selectors: [["zone-header"]], decls: 12, vars: 11, consts: [[1, "bg-base-100", "border-base-300", "sticky", "top-0", "flex", "flex-wrap", "items-center", "gap-2", "border-b", "px-4", "py-2", "shadow", "sm:flex-nowrap"], [1, "py-2"], [1, "text-2xl", "font-medium"], [1, "flex", "flex-wrap", "items-center", "gap-2"], [1, "text-sm", "opacity-60"], [1, "w-px", "flex-1"], ["btn", "", "type", "button", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "shrink-0", "rounded-lg", "px-4"], ["btn", "", "type", "button", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "shrink-0", "rounded-lg", "px-4", 3, "click"], [1, "mr-2", "text-2xl"]], template: function ZoneHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275element(10, "div", 5);
        \u0275\u0275conditionalCreate(11, ZoneHeaderComponent_Conditional_11_Template, 7, 6, "button", 6);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(8, 5, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(9, _c02, ctx.total_count()), ctx.total_count()), " ");
        \u0275\u0275advance(4);
        \u0275\u0275conditional(ctx.can_manage_zones() ? 11 : -1);
      }
    }, dependencies: [
      MatRippleModule,
      MatRipple,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneHeaderComponent, { className: "ZoneHeaderComponent", filePath: "apps/signage-manager/src/app/zones/zone-header.component.ts", lineNumber: 55 });
})();
...
function ZonesSectionComponent_Conditional_7_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function ZonesSectionComponent_Conditional_7_Conditional_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function ZonesSectionComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ZonesSectionComponent_Conditional_7_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(19, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(20, ZonesSectionComponent_Conditional_7_Conditional_20_Template, 3, 12, "button", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 26, "SIGNAGE_MANAGER.BACK_TO_ZONES"));
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 28, "SIGNAGE_MANAGER.ZONE_DETAILS_TABS"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(16, 30, "SIGNAGE_MANAGER.PLAYLISTS_COUNT", \u0275\u0275pureFunction1(38, _c04, ctx_r1.playlist_count()), ctx_r1.playlist_count()), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(19, 34, "SIGNAGE_MANAGER.DISPLAYS_COUNT", \u0275\u0275pureFunction1(40, _c04, ctx_r1.display_count()), ctx_r1.display_count()), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.templates_enabled() ? 20 : -1);
  }
}
...
var ZonesSectionComponent = class _ZonesSectionComponent {
  constructor() {
    ...
    this.can_manage_selected_zone = computed(
      () => {
        const zone = this.selected_zone();
        return this._service.can_manage_zones() && !!zone?.tags?.includes("signage");
      },
  ...
  editZone() {
    const zone = this.selected_zone();
    if (zone)
      this._service.editZone(zone);
  }
  async removeZone() {
    const zone = this.selected_zone();
    if (!zone || !await this._service.removeZone(zone))
      return;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZonesSectionComponent, selectors: [["zones-section"]], inputs: { id: [1, "id"], tab: [1, "tab"] }, decls: 10, vars: 6, consts: [[1, "bg-base-200", "absolute", "inset-0", "flex", "flex-col", "sm:flex-row"], [1, "sm:h-full"], [1, "flex", "min-h-0", "flex-1", "flex-col"], [1, "relative", "z-10"], [1, "flex", "min-h-0", "flex-1", "flex-row"], [1, "mobile-full"], [1, "flex", "min-h-0", "w-px", "flex-1", "flex-col"], [1, "h-1/2", "flex-1", 3, "activeTab"], [1, "bg-base-100", "border-base-300", "mx-2", "flex", "items-center", "gap-2", "rounded-b-lg", "border", "px-4", "py-3"], ["icon", "", "type", "button", "matRipple", "", 1, "sm:hidden", 3, "click"], [1, "shrink-0", "text-2xl", "opacity-60"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-lg", "font-medium"], [1, "text-base-content/80", "truncate", "text-sm"], ["role", "tablist", 1, "bg-base-100", "border-base-300", "mx-2", "mt-2", "flex", "overflow-hidden", "rounded-lg", "border"], ["type", "button", "role", "tab", "aria-controls", "zone-playlists-panel", "id", "zone-playlists-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], ["type", "button", "role", "tab", "aria-controls", "zone-displays-panel", "id", "zone-displays-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], ["type", "button", "role", "tab", "aria-controls", "zone-templates-panel", "id", "zone-templates-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "border-primary", "border-b-2", "text-primary", "opacity-60"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], ["type", "button", "role", "tab", "aria-controls", "zone-templates-panel", "id", "zone-templates-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"]], template: function ZonesSectionComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(7, ZonesSectionComponent_Conditional_7_Template, 21, 42);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZonesSectionComponent, { className: "ZonesSectionComponent", filePath: "apps/signage-manager/src/app/zones/zones.component.ts", lineNumber: 255 });
})();
export {
  ZonesSectionComponent
};
//# debugId=9a18ea55-9137-5ad5-9f7d-ca51f617461e
//# sourceMappingURL=zones.component-J467AHMG.js.map
