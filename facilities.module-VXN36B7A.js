...
_FacilitiesStatusComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FacilitiesStatusComponent, selectors: [["facilities-status"]], decls: 24, vars: 6, consts: [[1, "w-full", "flex-1", "rounded-lg", "bg-base-100", "p-6", "shadow-xs"], [1, "mb-4", "mt-0"], [1, "mb-2", "flex", "w-full", "items-center", "rounded-lg", "border", "border-base-200"], ["name", "status", 1, "rounded-full"], [1, "text-bold", "flex-1", "text-xs"], [1, "text-bold", "p-4"], [1, "text-bold", "mr-4", "text-right"], [1, "w-full", "rounded-sm", "bg-base-100", "p-6", "shadow-xs"], [1, "mb-2", "mt-0"], ["name", "mood", 1, "flex", "w-full", "items-center", "overflow-hidden", "rounded-lg", "border", "border-base-200"], [1, "bg-light", "px-1", "text-2xl", 3, "icon"], [1, "text-bold", "px-4", "text-sm"]], template: function FacilitiesStatusComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=facilities.module-VXN36B7A.js.map
