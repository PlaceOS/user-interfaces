...
} from "./chunk-KCO4IGZD.js";
import {
  queryCateringItems
} from "./chunk-L7PWBL4V.js";
import {
  SpacesService
} from "./chunk-P6RGEXZT.js";
import {
  CounterComponent
...
function getCateringRulesForZone(zone_id, fresh = false) {
  ...
  if (!RULE_REQUESTS[zone_id] || fresh)
    RULE_REQUESTS[zone_id] = rc(zone_id, "catering_config").then((_) => _.details instanceof Array ? _.details : []).catch(() => []);
  ...
  constructor() {
    ...
    effect((on_cleanup) => {
      ...
      for (const space of driver_spaces) {
        const mod = zd(space.id, "Bookings");
...
//# sourceMappingURL=chunk-GPHQ5GAN.js.map
