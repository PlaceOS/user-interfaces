...
import {
  ...
  MatChipRow,
  MatChipsModule
} from "./chunk-S7GN3WI7.js";
import {
  ExploreStateService
} from "./chunk-HDEVLWQ7.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
  ...
  _loadSpaceBookings() {
    effect(async (onCleanup) => {
      ...
      for (const [idx, space] of (spaces || []).entries()) {
        const binding = dp(space.id, "Bookings").variable("bookings");
...
//# sourceMappingURL=chunk-WY2GTBXG.js.map
