...
var UserListFieldComponent = class _UserListFieldComponent extends AsyncHandler {
  async searchStaff(q) {
    return this._use_basic_user_search() ? La({ q, authority_id: It()?.id }).then((_) => _.data.map((u) => new User(u))) : searchStaff(q);
  }
  constructor() {
    super();
...
//# debugId=fc228183-2a6a-5954-b779-97670bffbdbe
//# sourceMappingURL=chunk-JHS25J6A.js.map
