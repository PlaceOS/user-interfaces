...
import {
  SpacesService
} from "./chunk-KJM2FUA6.js";
import "./chunk-TGMMXDFA.js";
import {
  ExploreStateService
} from "./chunk-UYWA6U56.js";
import {
...
function SetDatetimeModalComponent_Conditional_7_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r0.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(16, _c0))("range", ctx_r0.bookable_hours())("use_24hr", ctx_r0.use_24hr_time());
    \u0275\u0275control();
    \u0275\u0275advance(3);
...
function ExploreMapControlComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.building())("compareWith", ctx_r1.compareZones);
    \u0275\u0275control();
    \u0275\u0275advance();
...
function ExploreMapControlComponent_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.level())("compareWith", ctx_r1.compareZones);
    \u0275\u0275control();
    \u0275\u0275advance();
...
var ExploreMapControlComponent = class _ExploreMapControlComponent extends AsyncHandler {
  constructor() {
    ...
    this.compareZones = (first, second) => first?.id === second?.id;
    this.setBuilding = (bld) => {
      if (bld?.id === this.building()?.id)
        return;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreMapControlComponent, selectors: [["explore-map-controls"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 3, vars: 2, consts: [[1, "flex", "w-full", "space-x-2"], ["overlay", "", "buildings", "", "has-bld", "true", "appearance", "outline", 1, "no-subscript", "min-w-42", "flex-1"], ["overlay", "", "levels", "", "appearance", "outline", 1, "no-subscript", "min-w-41", "flex-1"], ["placeholder", "Select Building...", 3, "ngModelChange", "ngModel", "compareWith"], [3, "value"], ["placeholder", "Select Level...", 3, "ngModelChange", "ngModel", "compareWith"]], template: function ExploreMapControlComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275conditionalCreate(1, ExploreMapControlComponent_Conditional_1_Template, 4, 2, "mat-form-field", 1);
        \u0275\u0275conditionalCreate(2, ExploreMapControlComponent_Conditional_2_Template, 4, 3, "mat-form-field", 2);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
var ExplorePointOfInterestService = class _ExplorePointOfInterestService extends AsyncHandler {
  constructor() {
    ...
    this._features = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_features" } : (
      ...
      params: () => this._building() || void 0,
      loader: async () => {
        const metadata = await ic(this._org.organisation.id, "points-of-interest").catch((_) => ({ details: {} }));
...
//# debugId=b4b199e4-d73c-569b-bd39-2eb2f5e19914
//# sourceMappingURL=explore.routes-FYELF2JG.js.map
