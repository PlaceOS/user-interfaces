...
`;var vi=[[[``,`matChipEdit`,``]],[[`mat-chip-avatar`],[``,`matChipAvatar`,``]],[[``,`matChipEditInput`,``]],`*`,[[`mat-chip-trailing-icon`],[``,`matChipRemove`,``],[``,`matChipTrailingIcon`,``]]];var gi=[`[matChipEdit]`,`mat-chip-avatar, [matChipAvatar]`,`[matChipEditInput]`,`*`,`mat-chip-trailing-icon,[matChipRemove],[matChipTrailingIcon]`];function fi(n,r){n&1&&Jo(0,`span`,0)}function yi(n,r){n&1&&(ar(0,`span`,1),wn(1),$r())}function bi(n,r){n&1&&(ar(0,`span`,3),wn(1,1),$r())}function Si(n,r){n&1&&wn(0,2)}function wi(n,r){n&1&&Jo(0,`span`,7)}function Ci(n,r){if(n&1&&Gr(0,Si,1,0)(1,wi,1,0,`span`,7),n&2)jr(Wr().contentEditInput?0:1)}function Ii(n,r){n&1&&wn(0,3)}function Ni(n,r){n&1&&(ar(0,`span`,6),wn(1,4),$r())}var $e=[`*`];var ki=`.mat-mdc-chip-set {
  display: flex;
}
