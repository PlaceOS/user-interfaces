...
var POIModalComponent = class _POIModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    const old_metadata = await Wu(this._org.organisation.id, "points-of-interest");
    ...
    const resp = await Qu(this._org.organisation.id, {
...
//# sourceMappingURL=poi-manager.routes-KG7EEFK4.js.map
