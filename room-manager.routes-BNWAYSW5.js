...
var RoomAlertModalComponent = class _RoomAlertModalComponent {
  ...
  async save() {
    ...
    const metadata = await rc(this._org.organisation.id, "room_alerts").catch((e) => {
...
var RoomModalComponent = class _RoomModalComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    this.encryption_levels = [
      { id: Le.None, name: "None" },
      { id: Le.Support, name: "Support" },
      { id: Le.Admin, name: "Admin" },
      { id: Le.NeverDisplay, name: "Never Display" }
    ];
  ...
  async ngOnInit() {
    const { details } = await rc(this._org.organisation.id, "settings");
  ...
  async save() {
    ...
    await (data.id ? ka(data.id, data) : Sa(data));
...
var RoomManagementService = class _RoomManagementService {
  constructor() {
    ...
    this._room_alerts = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_room_alerts" } : (
      ...
      loader: async () => {
        const metadata = await rc(this._org.organisation.id, "room_alerts").catch(() => ({ details: {} }));
    ...
    this._room_list = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_room_list" } : (
      ...
      loader: async ({ params }) => {
        ...
        const list = await queryAllPages($a({ zone_id, limit: 200 })).catch(() => []);
...
//# debugId=539eadb6-0dd9-56bc-85a9-b39c83874673
//# sourceMappingURL=room-manager.routes-BNWAYSW5.js.map
