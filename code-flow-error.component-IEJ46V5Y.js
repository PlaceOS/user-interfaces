...
var CodeFlowErrorComponent = class _CodeFlowErrorComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CodeFlowErrorComponent, selectors: [["code-flow-error"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 17, vars: 14, consts: [[1, "bg-base-100", "z-50", "flex", "h-full", "w-full", "flex-col"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], [1, "py-4"], ["src", "assets/icons/not-found.svg", 1, "h-64"], [1, "max-w-lg", "text-center"], [1, "border-base-200", "mt-4", "flex", "w-full", "items-center", "justify-center", "space-x-2", "border-t", "p-2"], ["btn", "", "matRipple", "", 1, "w-full", "max-w-lg", 3, "routerLink", "queryParams"], ["btn", "", "matRipple", "", 1, "inverse", "w-full", "max-w-lg", 3, "routerLink"]], template: function CodeFlowErrorComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=code-flow-error.component-IEJ46V5Y.js.map
