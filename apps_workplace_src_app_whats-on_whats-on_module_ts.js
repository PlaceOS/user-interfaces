...
function WhatsOnEventListComponent_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, WhatsOnEventListComponent_ng_container_6_div_1_Template, 17, 18, "div", 7)(2, WhatsOnEventListComponent_ng_container_6_button_2_Template, 3, 0, "button", 8)(3, WhatsOnEventListComponent_ng_container_6_button_3_Template, 3, 0, "button", 9);
...
function WhatsOnEventListComponent_ng_template_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" No ", ctx_r2.title, " events ");
  }
}
...
class WhatsOnEventListComponent {
  ...
  static #_ = this.ɵfac = function WhatsOnEventListComponent_Factory(t) {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    decls: 9,
    vars: 3,
    consts: [[1, "flex", "items-center", "space-x-4", "mb-2"], [1, "text-xl", "font-medium"], [1, "flex-1", "h-0.5", "w-px", "bg-primary"], [1, "relative", "flex", "items-center", "w-full", "space-x-2", "py-2"], ["container", ""], [4, "ngIf", "ngIfElse"], ["empty_state", ""], ["class", "flex flex-col items-center justify-center bg-base-100 shadow h-[24rem]", "card", "", 3, "min-width", "max-width", "opacity", "transform", 4, "ngFor", "ngForOf"], ["icon", "", "matRipple", "", "class", "absolute left-0 top-1/2 transform -translate-x-1/2 -translate-y-16 bg-base-100 shadow", 3, "click", 4, "ngIf"], ["icon", "", "matRipple", "", "class", "absolute right-0 top-1/2 transform translate-x-1/2 -translate-y-16 bg-base-100 shadow", 3, "click", 4, "ngIf"], ["card", "", 1, "flex", "flex-col", "items-center", "justify-center", "bg-base-100", "shadow", "h-[24rem]"], [1, "w-full", "h-40", "bg-base-300"], [1, "flex", "flex-col", "items-center", "p-2", "flex-1", "h-1/2", "w-full", "space-y-2"], ["date", "", 1, "w-full", "uppercase", "text-primary"], ["title", "", 1, "w-full", "font-medium"], ["desc", "", 1, "flex-1", "h-1/2", "w-full", "text-sm"], ["btn", "", "matRipple", "", 1, "w-full"], [1, "flex", "items-center"], ["icon", "", "matRipple", "", 1, "absolute", "left-0", "top-1/2", "transform", "-translate-x-1/2", "-translate-y-16", "bg-base-100", "shadow", 3, "click"], ["icon", "", "matRipple", "", 1, "absolute", "right-0", "top-1/2", "transform", "translate-x-1/2", "-translate-y-16", "bg-base-100", "shadow", 3, "click"], [1, "p-12", "flex", "items-center", "justify-center", "w-full", "opacity-40"]],
    template: function WhatsOnEventListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.events == null ? null : ctx.events.length)("ngIfElse", _r3);
      }
    },
    ...
    styles: ["[card][_ngcontent-%COMP%] {\n                transition: transform 200ms, opacity 200ms;\n            }\n        \n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ 12687);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 61699);
...
class WhatsOnHeaderComponent {
  ...
  static #_ = this.ɵfac = function WhatsOnHeaderComponent_Factory(t) {
...
/* harmony import */ var _whats_on_header_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./whats-on-header.component */ 82933);
/* harmony import */ var _whats_on_event_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./whats-on-event-list.component */ 87704);
...
class WhatsOnComponent {
  static #_ = this.ɵfac = function WhatsOnComponent_Factory(t) {
  ...
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
    ...
    decls: 8,
    vars: 0,
    consts: [[1, "flex-1", "flex", "sm:flex-row", "flex-col-reverse", "h-1/2", "bg-base-200"], [1, "relative", "z-0", "flex", "flex-col", "flex-1", "h-1/2", "sm:h-auto", "overflow-hidden"], [1, "flex", "flex-col", "flex-1", "px-0", "sm:px-8", "overflow-y-auto", "overflow-x-hidden", "h-px", "sm:h-auto"], [1, "mb-4"], ["title", "Ongoing"]],
    ...
    styles: ["[_nghost-%COMP%] {\n                position: absolute;\n                top: 0;\n                left: 0;\n                right: 0;\n                bottom: 0;\n                overflow: hidden;\n                display: flex;\n                flex-direction: column;\n            }\n\n            main[_ngcontent-%COMP%] {\n                min-height: 50%;\n            }\n\n            .top[_ngcontent-%COMP%] {\n                background-color: #007ac8;\n            }\n        \n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
  });
}
...
/* harmony import */ var _whats_on_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./whats-on.component */ 72742);
...
class WhatsOnModule {
  static #_ = this.ɵfac = function WhatsOnModule_Factory(t) {
