...
var NavFooterComponent = class _NavFooterComponent {
  constructor() {
    ...
    this.can_manage_groups = computed(() => this._service.can_manage_all_groups() || !!this._service.manageable_signage_groups().length, ...ngDevMode ? [{ debugName: "can_manage_groups" }] : (
      /* istanbul ignore next */
      []
    ));
    this.primary_nav_items = computed(() => filterManageNavItems(this.can_manage_groups()).filter((item) => !["/schedules", "/groups"].includes(item.route)), ...ngDevMode ? [{ debugName: "primary_nav_items" }] : (
      /* istanbul ignore next */
      []
    ));
    this.more_nav_items = computed(() => filterManageNavItems(this.can_manage_groups()).filter((item) => ["/schedules", "/groups"].includes(item.route)), ...ngDevMode ? [{ debugName: "more_nav_items" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.selected_label = computed(() => this.selected_group()?.group.name || "SIGNAGE_MANAGER.ALL_GROUPS", ...ngDevMode ? [{ debugName: "selected_label" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavFooterComponent, { className: "NavFooterComponent", filePath: "apps/signage-manager/src/app/shared/nav-footer.component.ts", lineNumber: 125 });
})();
...
var NavSidebarComponent = class _NavSidebarComponent {
  constructor() {
    ...
    this.nav_items = computed(() => filterManageNavItems(this._service.can_manage_all_groups() || !!this._service.manageable_signage_groups().length), ...ngDevMode ? [{ debugName: "nav_items" }] : (
      /* istanbul ignore next */
      []
    ));
    this.active_locale = computed(() => this._locale.locale, ...ngDevMode ? [{ debugName: "active_locale" }] : (
      /* istanbul ignore next */
      []
    ));
...
//# sourceMappingURL=chunk-GHCVWSL4.js.map
