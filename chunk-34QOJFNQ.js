...
function DeskModalComponent_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 22, "APP.CONCIERGE.DESKS_ID"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 24, "FORM.ID_REQUIRED"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 26, "APP.CONCIERGE.DESKS_NAME"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 28, "FORM.NAME_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(27, 30, "EXPLORE.MAP_ID"));
    \u0275\u0275advance(6);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(33, 32, "APP.CONCIERGE.DESKS_MAP_ID_PLACEHOLDER"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(36, 34, "EXPLORE.MAP_ID_REQUIRED"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(38, 36, "APP.CONCIERGE.POI_MAP_SELECT"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 38, "APP.CONCIERGE.USER_ASSIGNED"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(47, 40, "APP.CONCIERGE.USER_CLEAR"));
    \u0275\u0275advance(5);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(52, 42, "COMMON.BOOKABLE"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(56, 44, "COMMON.GROUPS"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(58, 46, "BOOKINGS.GROUPS"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(61, 48, "COMMON.FEATURES"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(63, 50, "COMMON.FEATURES"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(66, 52, "FORM.NOTES"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(69, 54, "FORM.NOTES"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(72, 56, "APP.CONCIERGE.DESKS_HOMEBASE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(75, 58, "APP.CONCIERGE.DESKS_HOMEBASE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(78, 60, "APP.CONCIERGE.DESKS_SECURITY"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(81, 62, "APP.CONCIERGE.DESKS_SECURITY"));
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskModalComponent, selectors: [["desk-modal"]], outputs: { event: "event" }, decls: 12, vars: 8, consts: [[1, "w-lg"], [1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "flex-col", "overflow-auto", "p-4", 3, "formGroup"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "border-base-300", "flex", "items-center", "justify-end", "space-x-2", "border-t", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "w-full"], ["for", "id"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "id", "formControlName", "id", "placeholder", "desk-10.123"], [1, "flex", "space-x-2"], [1, "w-1/3", "flex-1"], ["for", "name"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "e.g. Office Desk"], ["for", "map-id"], ["matInput", "", "name", "map-id", "formControlName", "map_id", 3, "placeholder"], ["icon", "", "matRipple", "", 1, "border-secondary", "text-secondary", "h-12", "w-12", "min-w-12", "rounded-sm", "border", 3, "click", "matTooltip"], ["for", "user"], [1, "mb-4", "flex", "space-x-2"], ["name", "user", "formControlName", "assigned_user", 1, "flex-1"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "min-w-12", "rounded-sm", 3, "click", "matTooltip"], ["className", "material-symbols-outlined"], [1, "flex", "space-x-4", "pb-4"], ["formControlName", "bookable", 1, "flex-1", 3, "name"], [1, "flex-1"], ["for", "notes"], ["formControlName", "groups", 1, "w-full", 3, "placeholder"], ["formControlName", "features", 1, "w-full", 3, "placeholder"], ["appearance", "outline"], ["matInput", "", "name", "notes", "formControlName", "notes", 3, "placeholder"], ["for", "homebase"], ["matInput", "", "name", "homebase", "formControlName", "homebase", 3, "placeholder"], ["for", "security"], ["matInput", "", "name", "security", "formControlName", "security", 3, "placeholder"], ["diameter", "32"]], template: function DeskModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(6, DeskModalComponent_Conditional_6_Template, 82, 64, "main", 4)(7, DeskModalComponent_Conditional_7_Template, 5, 3, "main", 5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskModalComponent, { className: "DeskModalComponent", filePath: "apps/concierge/src/app/desks/desk-modal.component.ts", lineNumber: 265 });
})();
...
var DesksStateService = class _DesksStateService extends AsyncHandler {
  ...
  constructor() {
    ...
    this._filters = signal({}, ...ngDevMode ? [{ debugName: "_filters" }] : (
      /* istanbul ignore next */
      []
    ));
    this._desk_bookings = [];
    ...
    this.print_desk = signal(null, ...ngDevMode ? [{ debugName: "print_desk" }] : (
      /* istanbul ignore next */
      []
    ));
    this._desks$ = combineLatest([
      ...
      const fetch$ = zones && !zones.includes("All") ? from(Fu(zones[0], "desks")).pipe(map((m) => m.details instanceof Array ? m.details : []), catchError((_) => of([]))) : from(Bu(this._org.building?.id, {
        name: "desks"
    ...
    this.levels = this._org.active_levels.pipe(switchMap((levels) => {
      if (!levels.length) {
        return of([]);
      }
      return combineLatest(levels.map((level) => from(Fu(level.id, "desks")).pipe(map((metadata) => ({
        level,
    ...
    this.setup_paging = combineLatest([
      ...
      this._first_page = () => queryPagedBookings({
    ...
    this._paged_bookings$ = combineLatest([
      ...
      if (action.includes("RESET")) {
        return from(next_page()).pipe(map((data) => __spreadProps(__spreadValues({}, data), { reset: true })), catchError((_) => of({ data: [], total: 0, next: null })));
      }
      return from(next_page()).pipe(map((data) => __spreadProps(__spreadValues({}, data), { reset: false })), catchError((_) => of({ data: [], total: 0, next: null })));
    ...
    this.has_more_pages = computed(() => this.paged_bookings().has_next, ...ngDevMode ? [{ debugName: "has_more_pages" }] : (
      /* istanbul ignore next */
      []
    ));
    this.bookings = computed(() => this.paged_bookings().list, ...ngDevMode ? [{ debugName: "bookings" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  async editDesk(desk = new Desk()) {
    ...
    if ((desk.assigned_to !== new_desk.assigned_to || recreate) && new_desk.assigned_to) {
      await saveBooking(this._createAssignedBooking(new_desk, zone)).toPromise().catch(async (e) => {
        await this._rollbackMetadata(zone, original_desk_list);
        if (recreate) {
  ...
  async rejectDesk(desk) {
    const status = await this._rejectDeskBooking(desk).toPromise().catch((_) => ({ failed: true, error: _ }));
    if (status.failed) {
  ...
  async rejectAllDesks() {
    ...
    try {
      await Promise.all(list.map((desk) => this._rejectDeskBooking(desk).toPromise()));
      list.forEach((desk) => {
        desk.approved = false;
        desk.rejected = true;
        desk.status = "declined";
  ...
  async _checkAssignedDeskLimit(user_email, current_desk_id) {
    ...
    const assigned_count = (await Promise.all(this._currentLevelList().map((level) => Fu(level.id, "desks").then((metadata) => metadata.details instanceof Array ? metadata.details : []).catch(() => [])))).flat().filter((item) => item.id !== current_desk_id && item.assigned_to?.toLowerCase() === email).length;
    if (assigned_count >= max_assigned_count) {
      const key = max_assigned_count === 1 ? "APP.CONCIERGE.DESKS_ASSIGN_LIMIT_ERROR_1" : "APP.CONCIERGE.DESKS_ASSIGN_LIMIT_ERROR_N";
...
//# sourceMappingURL=chunk-34QOJFNQ.js.map
