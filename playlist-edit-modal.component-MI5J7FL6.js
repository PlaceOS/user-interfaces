import {
  ...
  MatSliderModule,
  MatSliderThumb
} from "./chunk-HSMKLNF2.js";
import {
  MediaDurationPipe
} from "./chunk-5PMO4CI2.js";
import {
    ...
    this.model = signal(
      {
        ...
        default_animation: this.playlist.default_animation ?? Os.Default,
  ...
  async savePlaylist() {
    await submit(this.form, async () => {
      ...
      try {
        let result;
        if (this.playlist.id) {
          result = this._data.onEdit ? await this._data.onEdit(this.playlist.id, data) : await Kh(this.playlist.id, data);
        } else {
          result = this._data.onAdd ? await this._data.onAdd(data) : await Zh(data);
        }
        this._dialog_ref.disableClose = false;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaylistEditModalComponent, { className: "PlaylistEditModalComponent", filePath: "apps/signage-manager/src/app/shared/playlist-edit-modal.component.ts", lineNumber: 337 });
})();
export {
  PlaylistEditModalComponent
};
//# debugId=d9e948a0-14ef-594a-9ad0-55ae3ad3caf8
//# sourceMappingURL=playlist-edit-modal.component-MI5J7FL6.js.map
