...
function BookingRulesFormComponent_For_18_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingRulesFormComponent_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingRulesFormComponent_Conditional_84_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingRulesFormComponent_Conditional_85_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingRulesFormComponent_Conditional_86_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingRulesFormComponent_Conditional_87_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingRulesFormComponent_Conditional_87_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingRulesFormComponent_Conditional_87_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26);
    \u0275\u0275conditionalCreate(1, BookingRulesFormComponent_Conditional_87_Conditional_1_Template, 5, 6, "div", 2);
    \u0275\u0275conditionalCreate(2, BookingRulesFormComponent_Conditional_87_Conditional_2_Template, 5, 6, "div", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BookingRulesFormComponent_Conditional_88_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 7);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BookingRulesFormComponent_Conditional_88_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "label", 37);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 38)(5, "mat-label");
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-select", 39);
    \u0275\u0275repeaterCreate(9, BookingRulesFormComponent_Conditional_88_For_10_Template, 2, 2, "mat-option", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 3, ctx_r1.form.value.rules.hidden ? "BOOKINGS.BEFORE_DENY" : "BOOKINGS.BEFORE_ALLOW"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 5, ctx_r1.form.value.rules.hidden ? "BOOKINGS.BEFORE_DENY" : "BOOKINGS.BEFORE_ALLOW"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.duration_blocks);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 7, "BOOKINGS.BEFORE_REQUIRED"));
  }
}
function BookingRulesFormComponent_Conditional_89_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 7);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BookingRulesFormComponent_Conditional_89_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-select", 41);
    \u0275\u0275repeaterCreate(9, BookingRulesFormComponent_Conditional_89_For_10_Template, 2, 2, "mat-option", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-error");
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "translate");
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 3, ctx_r1.form.value.rules.hidden ? "BOOKINGS.AFTER_DENY" : "BOOKINGS.AFTER_ALLOW"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 5, ctx_r1.form.value.rules.hidden ? "BOOKINGS.AFTER_DENY" : "BOOKINGS.AFTER_ALLOW"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.duration_blocks);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 7, "BOOKINGS.AFTER_REQUIRED"), " ");
  }
}
function BookingRulesFormComponent_Conditional_90_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function BookingRulesFormComponent_Conditional_90_Template_a_date_field_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("ngModelChange", function BookingRulesFormComponent_Conditional_90_Template_a_date_field_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
function BookingRulesFormComponent_Conditional_91_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 7);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function BookingRulesFormComponent_Conditional_91_For_16_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 7);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function BookingRulesFormComponent_Conditional_91_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, BookingRulesFormComponent_Conditional_91_For_16_Conditional_0_Template, 3, 5, "mat-option", 7);
  }
  if (rf & 2) {
...
function BookingRulesFormComponent_Conditional_91_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 46)(5, "mat-form-field", 38)(6, "mat-label");
    \u0275\u0275text(7, "Start Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-select", 47);
    \u0275\u0275listener("ngModelChange", function BookingRulesFormComponent_Conditional_91_Template_mat_select_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setIsBetween($event, ctx_r1.form.value.conditions.is_between[1]));
    });
    \u0275\u0275repeaterCreate(9, BookingRulesFormComponent_Conditional_91_For_10_Template, 3, 5, "mat-option", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "mat-form-field", 38)(12, "mat-label");
    \u0275\u0275text(13, "End Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "mat-select", 48);
    \u0275\u0275listener("ngModelChange", function BookingRulesFormComponent_Conditional_91_Template_mat_select_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setIsBetween(ctx_r1.form.value.conditions.is_between[0], $event));
    });
    \u0275\u0275repeaterCreate(15, BookingRulesFormComponent_Conditional_91_For_16_Template, 1, 1, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275repeater(ctx_r1.time_blocks);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 8, "BOOKINGS.BETWEEN_HOURS_REQUIRED"));
  }
}
function BookingRulesFormComponent_Conditional_92_Template(rf, ctx) {
  if (rf & 1) {
...
_BookingRulesFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingRulesFormComponent, selectors: [["booking-rules-form"]], inputs: { ruleset: [1, "ruleset"], save: [1, "save"] }, outputs: { rulesetChange: "rulesetChange" }, features: [\u0275\u0275NgOnChangesFeature], decls: 93, vars: 82, consts: [[1, "flex", "flex-col", "space-y-2", 3, "formGroup"], [1, "flex", "items-center", "space-x-4"], [1, "flex", "flex-1", "flex-col"], ["for", "zone"], ["appearance", "outline"], ["name", "zone", "formControlName", "zone"], ["value", "*"], [3, "value"], ["for", "name"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "Ruleset Name"], ["formGroupName", "rules", 1, "flex", "items-center", "space-x-4", "pb-4"], ["formControlName", "hidden", 3, "name", "info"], ["formControlName", "auto_approve", 3, "name", "info"], [1, "flex", "flex-col"], ["name", "zone", "multiple", "", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], ["value", "groups"], ["value", "locations"], ["value", "tags"], ["value", "min_length"], ["value", "max_length"], ["value", "is_before"], ["value", "is_after"], ["value", "is_between"], ["value", "is_period"], ["value", "resource_ids"], ["formGroupName", "conditions", 1, "flex", "flex-col"], ["formGroupName", "conditions", 1, "flex", "items-center", "space-x-2"], ["for", "groups"], ["name", "groups", "formControlName", "groups", 3, "placeholder"], ["for", "locations"], ["name", "locations", "formControlName", "locations", 3, "placeholder"], ["for", "tags"], ["name", "tags", "formControlName", "tags", 3, "placeholder"], ["for", "min_length"], ["name", "min_length", "formControlName", "min_length", 3, "min", "max", "step"], ["for", "max_length"], ["name", "max_length", "formControlName", "max_length", 3, "min", "max", "step"], ["for", "is-before"], ["appearance", "outline", 1, "flex-1"], ["name", "is-before", "formControlName", "is_before"], ["for", "is-after"], ["name", "is-after", "formControlName", "is_after"], [1, "flex", "items-center", "space-x-2"], [1, "flex-1", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "flex-1", 3, "ngModelChange", "from", "ngModel", "ngModelOptions"], ["for", "is_between"], [1, "flex", "w-full", "items-center", "space-x-2"], ["name", "start-time", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["name", "end-time", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "resource_ids"], ["name", "resource_ids", "formControlName", "resource_ids", 3, "placeholder"]], template: function BookingRulesFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(17, BookingRulesFormComponent_For_18_Template, 2, 2, "mat-option", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(19, "async");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div", 2)(24, "label", 8);
    \u0275\u0275text(25);
    \u0275\u0275pipe(26, "translate");
    ...
    \u0275\u0275pipe(36, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(37, "div", 10)(38, "div", 2);
    \u0275\u0275element(39, "settings-toggle", 11);
    \u0275\u0275pipe(40, "translate");
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "div", 2);
    \u0275\u0275conditionalCreate(43, BookingRulesFormComponent_Conditional_43_Template, 3, 6, "settings-toggle", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "div", 13)(45, "label", 3);
    \u0275\u0275text(46);
    \u0275\u0275pipe(47, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(51, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "mat-select", 14);
    \u0275\u0275pipe(53, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function BookingRulesFormComponent_Template_mat_select_ngModelChange_52_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.available_conditions, $event) || (ctx.available_conditions = $event);
      return $event;
    });
    \u0275\u0275elementStart(54, "mat-option", 15);
    \u0275\u0275text(55);
    \u0275\u0275pipe(56, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "mat-option", 16);
    \u0275\u0275text(58);
    \u0275\u0275pipe(59, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "mat-option", 17);
    \u0275\u0275text(61);
    \u0275\u0275pipe(62, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "mat-option", 18);
    \u0275\u0275text(64);
    \u0275\u0275pipe(65, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(68, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "mat-option", 20);
    \u0275\u0275text(70);
    \u0275\u0275pipe(71, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(72, "mat-option", 21);
    \u0275\u0275text(73);
    \u0275\u0275pipe(74, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "mat-option", 22);
    \u0275\u0275text(76);
    \u0275\u0275pipe(77, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(83, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(84, BookingRulesFormComponent_Conditional_84_Template, 6, 6, "div", 25);
    \u0275\u0275conditionalCreate(85, BookingRulesFormComponent_Conditional_85_Template, 6, 6, "div", 25);
    \u0275\u0275conditionalCreate(86, BookingRulesFormComponent_Conditional_86_Template, 6, 6, "div", 25);
    \u0275\u0275conditionalCreate(87, BookingRulesFormComponent_Conditional_87_Template, 3, 2, "div", 26);
    \u0275\u0275conditionalCreate(88, BookingRulesFormComponent_Conditional_88_Template, 14, 9, "div", 25);
    \u0275\u0275conditionalCreate(89, BookingRulesFormComponent_Conditional_89_Template, 14, 9, "div", 25);
    \u0275\u0275conditionalCreate(90, BookingRulesFormComponent_Conditional_90_Template, 7, 10, "div", 25);
    \u0275\u0275conditionalCreate(91, BookingRulesFormComponent_Conditional_91_Template, 20, 12, "div", 25);
    \u0275\u0275conditionalCreate(92, BookingRulesFormComponent_Conditional_92_Template, 6, 6, "div", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 35, "COMMON.ZONE"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 37, "COMMON.ZONE"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 39, "COMMON.ZONE_ANY"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(19, 41, ctx.building_zones));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 43, "COMMON.ZONE_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 45, "FORM.NAME"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 47, "FORM.NAME"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(36, 49, "FORM.NAME_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(40, 51, "BOOKINGS.PREVENT"))("info", \u0275\u0275pipeBind1(41, 53, "BOOKINGS.PREVENT_INFO"));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(!ctx.form.value.rules.hidden ? 43 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 55, "BOOKINGS.CONDITIONS"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 57, "BOOKINGS.CONDITIONS"));
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx.available_conditions);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(81, _c0))("placeholder", \u0275\u0275pipeBind1(53, 59, "BOOKINGS.CONDITIONS_PLACEHOLDER"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(56, 61, "BOOKINGS.CONDITION_GROUPS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(59, 63, "BOOKINGS.CONDITION_LOCATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(62, 65, "BOOKINGS.CONDITION_TAGS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(65, 67, "BOOKINGS.CONDITION_MIN_LENGTH"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(68, 69, "BOOKINGS.CONDITION_MAX_LENGTH"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(71, 71, "BOOKINGS.CONDITION_WITHIN"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(74, 73, "BOOKINGS.CONDITION_AFTER"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(77, 75, "BOOKINGS.CONDITION_BETWEEN_HOURS"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(80, 77, "BOOKINGS.CONDITION_BETWEEN_DATES"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(83, 79, "BOOKINGS.CONDITION_RESOURCES"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.available_conditions.includes("groups") ? 84 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("locations") ? 85 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("tags") ? 86 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("min_length") || ctx.available_conditions.includes("max_length") ? 87 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("is_before") ? 88 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("is_after") ? 89 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("is_period") ? 90 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("is_between") ? 91 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.available_conditions.includes("resource_ids") ? 92 : -1);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingRulesFormComponent, { className: "BookingRulesFormComponent", filePath: "libs/form-fields/src/lib/booking-rules-form.component.ts", lineNumber: 459 });
})();
...
_BookingRulesModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingRulesModalComponent, selectors: [["app-booking-rules-modal"]], decls: 22, vars: 18, consts: [["index_template", ""], ["conditions_template", ""], ["zone_template", ""], ["bool_template", ""], ["actions_template", ""], [3, "heading", "loading", "hide_confirm", "full_width"], [1, "bg-info", "text-info-content", "-mx-2", "mb-2", "w-[calc(100%+1rem)]", "rounded-sm", "p-4", "text-center", "text-xs"], [3, "ngSwitch"], [3, "ruleset", "save", "rulesetChange", 4, "ngSwitchCase"], [1, "-mx-2", "w-[calc(100%+1rem)]", "overflow-auto"], ["class", "block w-full min-w-3xl text-sm", 3, "data", "columns", 4, "ngSwitchCase"], ["class", "bg-base-200 fixed bottom-0 left-1/2 z-10 mx-auto my-2 flex w-[calc(100%-1rem)] -translate-x-1/2 items-center justify-end space-x-4 rounded-sm border-none px-4 py-2", 3, "max-w-156", 4, "ngIf"], [3, "rulesetChange", "ruleset", "save"], [1, "block", "w-full", "min-w-3xl", "text-sm", 3, "data", "columns"], [1, "m-auto", "p-4", "font-medium"], [1, "p-4"], ["class", "px-4 py-2", 4, "ngIf"], ["class", "px-4 py-2 font-mono italic", 4, "ngIf"], [1, "px-4", "py-2"], [1, "font-mono", "text-[0.625rem]", "opacity-60"], [1, "px-4", "py-2", "font-mono", "italic"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", "text-white"], [1, "mx-auto", "flex", "w-full", "flex-col", "items-center", "justify-center", "gap-1", "p-1"], [1, "flex", "items-center", "gap-1"], ["icon", "", "matRipple", "", 1, "rounded-sm", 3, "click", "matTooltip"], [1, "text-error"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "-translate-x-1/2", "items-center", "justify-end", "space-x-4", "rounded-sm", "border-none", "px-4", "py-2"], ["btn", "", "matRipple", "", "class", "inverse w-36", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "class", "w-36", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "inverse", "w-36", 3, "click"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click"]], template: function BookingRulesModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-2S3J2CPU.js.map
