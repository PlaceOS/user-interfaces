...
function toSignal(source, options) {
  ...
  if (ngDevMode && requiresCleanup && !(options == null ? void 0 : options.injector)) {
    assertInInjectionContext(toSignal);
  }
  const cleanupRef = requiresCleanup ? ((_a2 = options == null ? void 0 : options.injector) == null ? void 0 : _a2.get(DestroyRef)) ?? inject(DestroyRef) : null;
  ...
  if (options == null ? void 0 : options.requireSync) {
    state = signal({
      ...
      equal
    }, ngDevMode ? createDebugNameObject(options == null ? void 0 : options.debugName, "state") : void 0));
  } else {
    state = signal({
      kind: 1,
  ...
  }, ngDevMode ? createDebugNameObject(options == null ? void 0 : options.debugName, "source") : void 0));
}
...
var MatFormField = class _MatFormField {
  ...
  ngOnDestroy() {
    var _a2, _b2, _c9, _d2;
    (_a2 = this._outlineLabelOffsetResizeObserver) == null ? void 0 : _a2.disconnect();
  ...
  _writeOutlinedLabelStyles(styles) {
    ...
    if (styles !== null) {
      ...
      if (notchedOutlineWidth !== null) {
        (_a2 = this._notchedOutline) == null ? void 0 : _a2._setMaxWidth(notchedOutlineWidth);
      }
    }
  }
  _isAttachedToDom() {
...
var CdkTextareaAutosize = class _CdkTextareaAutosize {
  ...
  ngOnDestroy() {
    var _a2;
    (_a2 = this._listenerCleanups) == null ? void 0 : _a2.forEach((cleanup) => cleanup());
...
function readFieldStateBindingValue(fieldState, key) {
  ...
  return (_a2 = fieldState[property]) == null ? void 0 : _a2.call(fieldState);
}
...
var AnimationInputValidityMonitor = class _AnimationInputValidityMonitor extends InputValidityMonitor {
  ...
  isBadInput(element) {
    var _a2;
    return ((_a2 = element.validity) == null ? void 0 : _a2.badInput) ?? false;
  }
  createTransitionStyle(rootNode) {
    ...
    if (rootNode.nodeType === 9) {
      (_a2 = rootNode.head) == null ? void 0 : _a2.appendChild(element);
    } else {
  ...
  ngOnDestroy() {
    var _a2;
    (_a2 = this.injectedStyles.get(this.document)) == null ? void 0 : _a2.remove();
  }
...
var FormField = class _FormField {
  ...
  parseErrors = computed(() => {
    var _a2;
    return ((_a2 = this.parseErrorsSource()) == null ? void 0 : _a2().map((err) => __spreadProps(__spreadValues({}, err), {
  ...
  get controlValueAccessor() {
    ...
    if (!this.controlValueAccessors || this.controlValueAccessors.length === 0) {
      return ((_a2 = this.interopNgControl) == null ? void 0 : _a2.valueAccessor) ?? void 0;
    }
    return selectValueAccessor(this.interopNgControl, this.controlValueAccessors) ?? void 0;
  }
  installClassBindingEffect() {
    var _a2;
    const classes = Object.entries(((_a2 = this.config) == null ? void 0 : _a2.classes) ?? {}).map(([className, computation]) => [className, computed(() => computation(this))]);
    if (classes.length === 0) {
      return;
    }
    const bindings = createBindings();
  ...
  reset() {
    var _a2;
    this.resetter();
    (_a2 = this.parseErrorsResetCallback) == null ? void 0 : _a2.call(this, this.state().value());
  }
...
var MatInput = class _MatInput {
  ...
  get required() {
    var _a2, _b2;
    return this._required ?? ((_b2 = (_a2 = this.ngControl) == null ? void 0 : _a2.control) == null ? void 0 : _b2.hasValidator(Validators.required)) ?? false;
  }
  set required(value) {
  ...
  constructor() {
    ...
    this.disabledInteractive = ((_a2 = this._config) == null ? void 0 : _a2.disabledInteractive) || false;
  ...
  ngOnDestroy() {
    ...
    (_a2 = this._cleanupIosKeyup) == null ? void 0 : _a2.call(this);
...
var MatMenuItem = class _MatMenuItem {
  ...
  constructor() {
    ...
    (_b2 = (_a2 = this._parentMenu) == null ? void 0 : _a2.addItem) == null ? void 0 : _b2.call(_a2, this);
  }
  ...
  getLabel() {
    ...
    return ((_a2 = clone.textContent) == null ? void 0 : _a2.trim()) || "";
  }
...
var MatMenuContent = class _MatMenuContent {
  ...
  detach() {
    var _a2;
    if ((_a2 = this._portal) == null ? void 0 : _a2.isAttached) {
      this._portal.detach();
    }
  }
  ngOnDestroy() {
    var _a2;
    this.detach();
    (_a2 = this._outlet) == null ? void 0 : _a2.dispose();
  }
...
var MatMenu = class _MatMenu {
  ...
  ngAfterContentInit() {
    ...
    this._directDescendantItems.changes.subscribe((itemsList) => {
      ...
      if (this._panelAnimationState === "enter" && ((_a2 = manager.activeItem) == null ? void 0 : _a2._hasFocus())) {
  ...
  focusFirstItem(origin = "program") {
    var _a2;
    (_a2 = this._firstItemFocusRef) == null ? void 0 : _a2.destroy();
...
var MatMenuTriggerBase = class _MatMenuTriggerBase {
  ...
  set _menu(menu) {
    ...
    (_a2 = this._menuItemInstance) == null ? void 0 : _a2._setTriggersSubmenu(this._triggersSubmenu());
  }
  _menuInternal = null;
  ...
  ngOnDestroy() {
    ...
    (_a2 = this._pendingRemoval) == null ? void 0 : _a2.unsubscribe();
    this._menuCloseSubscription.unsubscribe();
  ...
  _closeMenu() {
    var _a2;
    (_a2 = this._menu) == null ? void 0 : _a2.close.emit();
  }
  _openMenu(autoFocus) {
    var _a2, _b2;
    ...
    if (menu instanceof MatMenu && this._ownsMenu(menu)) {
      this._pendingRemoval = menu._animationDone.pipe(take(1)).subscribe(() => {
        ...
        if (!PANELS_TO_TRIGGERS.has(menu)) {
          (_a3 = menu.lazyContent) == null ? void 0 : _a3.detach();
        }
      });
...
var MatMenuTrigger = class _MatMenuTrigger extends MatMenuTriggerBase {
  ...
  updatePosition() {
    var _a2;
    (_a2 = this._overlayRef) == null ? void 0 : _a2.updatePosition();
  }
  ngAfterContentInit() {
    this._handleHover();
  }
  ...
  _handleHover() {
    if (this.triggersSubmenu() && this._parentMaterialMenu) {
      this._hoverSubscription = this._parentMaterialMenu._hovered().subscribe((active) => {
        var _a2;
        if (active === this._menuItemInstance && !active.disabled && ((_a2 = this._parentMaterialMenu) == null ? void 0 : _a2._panelAnimationState) !== "void") {
  ...
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    ...
    hostBindings: function MatMenuTrigger_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275attribute("aria-haspopup", ctx.menu ? "menu" : null)("aria-expanded", ctx.menuOpen)("aria-controls", ctx.menuOpen ? (_a2 = ctx.menu) == null ? void 0 : _a2.panelId : null);
      }
    },
    inputs: {
...
var MatContextMenuTrigger = class _MatContextMenuTrigger extends MatMenuTriggerBase {
  ...
  ngOnDestroy() {
    var _a2;
    super.ngOnDestroy();
    (_a2 = this._scrollSubscription) == null ? void 0 : _a2.unsubscribe();
  }
  ...
  _isWithinMenuOrTrigger(target) {
    ...
    const overlay = (_a2 = this._overlayRef) == null ? void 0 : _a2.hostElement;
  ...
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    ...
    hostBindings: function MatContextMenuTrigger_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275attribute("aria-controls", ctx.menuOpen ? (_a2 = ctx.menu) == null ? void 0 : _a2.panelId : null);
...
function MatSelect_ng_template_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("mat-select-panel-animations-enabled", !ctx_r0._animationsDisabled)("mat-primary", ((_a2 = ctx_r0._parentFormField) == null ? void 0 : _a2.color) === "primary")("mat-accent", ((_b2 = ctx_r0._parentFormField) == null ? void 0 : _b2.color) === "accent")("mat-warn", ((_c9 = ctx_r0._parentFormField) == null ? void 0 : _c9.color) === "warn")("mat-undefined", !((_d2 = ctx_r0._parentFormField) == null ? void 0 : _d2.color));
...
var _SpacePipe = class _SpacePipe {
  ...
  _cacheSystem(system) {
    ...
    const space = new Space(__spreadProps(__spreadValues({}, system), {
      ...
      level: (_a2 = this.org) == null ? void 0 : _a2.levelWithID([...system.zones || []])
    }));
    cacheSpace(space);
    return space;
  }
...
//# sourceMappingURL=chunk-XNIFZHBS.js.map
