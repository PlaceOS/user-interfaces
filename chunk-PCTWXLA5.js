...
var BookingRulesFormComponent = class _BookingRulesFormComponent {
  constructor() {
    ...
    this.ruleset = input(void 0, ...ngDevMode ? [{ debugName: "ruleset" }] : (
      /* istanbul ignore next */
      []
    ));
    this.save = input(false, ...ngDevMode ? [{ debugName: "save" }] : (
      /* istanbul ignore next */
      []
    ));
    this.rulesetChange = output();
    this.available_conditions = [];
    this.building_zones = this._org.active_building.pipe(filter((_) => !!_), switchMap((bld) => ja({ parent_id: bld.id }).catch(() => ({ data: [] }))), map((res) => res.data), shareReplay(1));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingRulesFormComponent, { className: "BookingRulesFormComponent", filePath: "libs/form-fields/src/lib/booking-rules-form.component.ts", lineNumber: 440 });
})();
...
function BookingRulesModalComponent_Case_8_For_21_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ((tmp_13_0 = \u0275\u0275pipeBind1(3, 2, row_r5.zone)) == null ? null : tmp_13_0.display_name) || row_r5.zone, " ");
    \u0275\u0275advance(3);
...
function BookingRulesModalComponent_Case_8_For_21_Conditional_36_Conditional_1_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 2, ctx_r1.CONDITION_LABELS[key_r6]), ": ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.formatConditionValue(key_r6, row_r5.conditions[key_r6]));
  }
}
function BookingRulesModalComponent_Case_8_For_21_Conditional_36_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275repeaterCreate(1, BookingRulesModalComponent_Case_8_For_21_Conditional_36_Conditional_1_For_2_Template, 6, 4, "div", 31, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function BookingRulesModalComponent_Case_8_For_21_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26);
    \u0275\u0275conditionalCreate(1, BookingRulesModalComponent_Case_8_For_21_Conditional_36_Conditional_1_Template, 3, 0, "div", 29)(2, BookingRulesModalComponent_Case_8_For_21_Conditional_36_Conditional_2_Template, 2, 0, "div", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r5 = \u0275\u0275nextContext().$implicit;
...
function BookingRulesModalComponent_Case_8_For_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function BookingRulesModalComponent_Case_8_For_21_Template_div_click_22_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(5, 20, "APP.CONCIERGE.BOOKING_RULESET_REORDER"));
    \u0275\u0275advance(5);
    \u0275\u0275conditional(((tmp_14_0 = \u0275\u0275pipeBind1(10, 22, row_r5.zone)) == null ? null : tmp_14_0.id) ? 9 : 11);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", row_r5.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("bg-error", !(row_r5.rules == null ? null : row_r5.rules.auto_approve))("bg-success", row_r5.rules == null ? null : row_r5.rules.auto_approve);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((row_r5.rules == null ? null : row_r5.rules.auto_approve) ? "done" : "close");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("bg-error", !(row_r5.rules == null ? null : row_r5.rules.hidden))("bg-success", row_r5.rules == null ? null : row_r5.rules.hidden);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((row_r5.rules == null ? null : row_r5.rules.hidden) ? "done" : "close");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.isExpanded(row_r5.id) ? "keyboard_arrow_down" : "chevron_right");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(26, 24, "APP.CONCIERGE.BOOKING_RULES_CONDITIONS_COUNT", \u0275\u0275pureFunction1(31, _c1, ctx_r1.keyCount(row_r5.conditions))), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(29, 27, "APP.CONCIERGE.BOOKING_RULESET_EDIT"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(33, 29, "APP.CONCIERGE.BOOKING_RULESET_REMOVE"));
    \u0275\u0275advance(4);
...
function BookingRulesModalComponent_Case_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(20, BookingRulesModalComponent_Case_8_For_21_Template, 37, 33, "div", 10, _forTrack0, false, BookingRulesModalComponent_Case_8_ForEmpty_22_Template, 2, 0, "div", 11);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var BookingRulesModalComponent = class _BookingRulesModalComponent {
  constructor() {
    ...
    this.activate_save = signal(false, ...ngDevMode ? [{ debugName: "activate_save" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.change = signal(0, ...ngDevMode ? [{ debugName: "change" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this._booking_rules = combineLatest([
      this._org.active_building,
      toObservable(this.change)
    ]).pipe(filter(([_]) => !!_), switchMap(([bld]) => {
      return from(Fu(bld.id, `${this._data.type}_booking_rules`)).pipe(catchError(() => of({ details: [] })));
    }), map(({ details }) => details instanceof Array ? details : []), shareReplay(1));
    this.booking_rules = toSignal(this._booking_rules, {
      initialValue: []
    });
  ...
  async removeRuleset(ruleset) {
    ...
    if (index >= 0) {
      ...
      await Lu(this._org.building.id, {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingRulesModalComponent, selectors: [["app-booking-rules-modal"]], decls: 10, vars: 17, consts: [[3, "heading", "loading", "hide_close", "hide_confirm", "full_width"], [1, "bg-info", "text-info-content", "-mx-2", "mb-2", "w-[calc(100%+1rem)]", "rounded-sm", "p-4", "text-center", "text-xs"], [3, "ruleset", "save"], [1, "-mx-2", "w-[calc(100%+1rem)]", "overflow-auto"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "-translate-x-1/2", "items-center", "justify-end", "space-x-4", "rounded-sm", "border-none", "px-4", "py-2", 3, "max-w-156"], [3, "rulesetChange", "ruleset", "save"], [1, "border-base-300", "grid", "min-w-3xl", "border", "text-sm"], [1, "bg-base-300", "border-base-200", "border-b", "px-4", "py-2", "font-medium"], [1, "bg-base-300", "border-base-200", "flex", "h-full", "items-center", "border-b", "border-l", "px-4", "py-2", "font-medium"], ["cdkDropList", "", 1, "min-w-3xl", 3, "cdkDropListDropped"], ["cdkDrag", "", "cdkDragLockAxis", "y", 1, "border-base-300", "border-x", "border-b"], [1, "border-base-300", "flex", "items-center", "justify-center", "border-x", "border-b", "p-8", "opacity-30"], ["class", "border-base-content bg-base-300 h-14 rounded-sm border-2 border-dashed opacity-50", 4, "cdkDragPlaceholder"], [1, "bg-base-100", "grid", "text-sm"], [1, "border-base-200", "flex", "items-center", "justify-center", "border-r"], ["icon", "", "matRipple", "", "cdkDragHandle", "", 1, "cursor-grab", "rounded-sm", 3, "matTooltip"], [1, "border-base-200", "flex", "items-center", "border-r"], [1, "px-4", "py-2"], [1, "px-4", "py-2", "font-mono", "italic"], [1, "border-base-200", "border-r", "p-4"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", "text-white"], [1, "border-base-200", "flex", "cursor-pointer", "items-center", "border-r", "p-4", "select-none", 3, "click"], [1, "mr-1", "text-2xl"], [1, "flex", "items-center", "justify-center", "gap-1", "p-1"], ["icon", "", "matRipple", "", 1, "rounded-sm", 3, "click", "matTooltip"], [1, "text-error"], [1, "bg-base-200", "border-base-300", "border-t", "px-6", "py-3"], [1, "border-base-content", "bg-base-300", "h-14", "rounded-sm", "border-2", "border-dashed", "opacity-50"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "flex-wrap", "gap-x-8", "gap-y-2", "text-xs"], [1, "text-xs", "opacity-30"], [1, "flex", "items-baseline", "gap-2"], [1, "font-medium", "opacity-60"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-[calc(100%-1rem)]", "-translate-x-1/2", "items-center", "justify-end", "space-x-4", "rounded-sm", "border-none", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "inverse", "w-36"], ["btn", "", "matRipple", "", 1, "w-36"], ["btn", "", "matRipple", "", 1, "inverse", "w-36", 3, "click"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click"]], template: function BookingRulesModalComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        let tmp_0_0;
        let tmp_6_0;
        \u0275\u0275property("heading", \u0275\u0275pipeBind2(1, 8, ctx.view() !== "form" ? "APP.CONCIERGE.BOOKING_RULES_HEADER" : ((tmp_0_0 = ctx.selected()) == null ? null : tmp_0_0.id) ? "APP.CONCIERGE.BOOKING_RULES_EDIT" : "APP.CONCIERGE.BOOKING_RULES_NEW", \u0275\u0275pureFunction1(15, _c02, ctx.type)))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 11, "APP.CONCIERGE.BOOKING_RULESET_SAVING") : "")("hide_close", ctx.view() === "form")("hide_confirm", true)("full_width", ctx.view() !== "form");
        \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingRulesModalComponent, { className: "BookingRulesModalComponent", filePath: "apps/concierge/src/app/ui/booking-rules-modal.component.ts", lineNumber: 419 });
})();

export {
  BookingRulesModalComponent
};
//# sourceMappingURL=chunk-PCTWXLA5.js.map
