...
} from "./chunk-RF5TIORG.js";
import {
  ExplorePointOfInterestModalComponent
} from "./chunk-CLILFEPP.js";
import "./chunk-UBOF3DDD.js";
...
function POIModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 3, "FORM.NAME"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 5, "FORM.NAME"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(11, 7, "FORM.NAME"));
  }
}
function POIModalComponent_Conditional_6_For_12_Template(rf, ctx) {
  if (rf & 1) {
...
function POIModalComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "mat-select", 24);
    \u0275\u0275twoWayListener("ngModelChange", function POIModalComponent_Conditional_6_Template_mat_select_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.building, $event) || (ctx_r1.building = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275repeaterCreate(11, POIModalComponent_Conditional_6_For_12_Template, 2, 2, "mat-option", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(13, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(13, 8, ctx_r1.building_list));
  }
}
function POIModalComponent_Conditional_8_For_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 25);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function POIModalComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "mat-select", 27);
    \u0275\u0275repeaterCreate(11, POIModalComponent_Conditional_8_For_12_Template, 2, 2, "mat-option", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(13, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 4, "RESOURCE.LEVEL"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(13, 6, ctx_r1.level_list));
  }
}
function POIModalComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9)(1, "mat-form-field", 15)(2, "mat-label");
    \u0275\u0275text(3, "Location");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function POIModalComponent_Conditional_26_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    \u0275\u0275advance(5);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(6, 1, "APP.CONCIERGE.POI_MAP_SELECT"));
  }
}
function POIModalComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "mat-form-field", 30)(2, "mat-label");
    \u0275\u0275text(3, "Latitude");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 31);
    \u0275\u0275listener("ngModelChange", function POIModalComponent_Conditional_27_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ location: [+$event, +ctx_r1.form.value.location[1]] }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "mat-form-field", 30)(6, "mat-label");
    \u0275\u0275text(7, "Longitude");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "input", 32);
    \u0275\u0275listener("ngModelChange", function POIModalComponent_Conditional_27_Template_input_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function POIModalComponent_For_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "mat-form-field", 15)(2, "mat-label");
    \u0275\u0275text(3, "Label");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 33);
    \u0275\u0275twoWayListener("ngModelChange", function POIModalComponent_For_47_Template_input_ngModelChange_4_listener($event) {
      const value_r8 = \u0275\u0275restoreView(_r7).$implicit;
      \u0275\u0275twoWayBindingSet(value_r8[0], $event) || (value_r8[0] = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "mat-form-field", 15)(6, "mat-label");
    \u0275\u0275text(7, "Content");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "input", 34);
    \u0275\u0275twoWayListener("ngModelChange", function POIModalComponent_For_47_Template_input_ngModelChange_8_listener($event) {
      const value_r8 = \u0275\u0275restoreView(_r7).$implicit;
...
_POIModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _POIModalComponent, selectors: [["poi-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 50, vars: 49, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], ["formControlName", "image", 1, "mb-4!", "block"], [1, "flex", "flex-col"], ["for", "location"], ["appearance", "outline"], ["placeholder", "Location Type", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", "map_id"], ["value", "coordinates"], [1, "flex", "items-center", "space-x-2", "pb-2"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "items-center", "space-x-4", "pt-2"], ["formControlName", "can_search", 1, "flex-1", 3, "name"], ["for", "media", 1, "mt-4"], [1, "flex", "items-center", "space-x-2", "pt-2"], ["appearance", "outline", 1, "no-subscript"], ["matInput", "", "formControlName", "media_url", 3, "placeholder"], [3, "ngModelChange", "ngModel", "ngModelOptions", "types"], ["for", "extra-details", 1, "mt-4"], [1, "space-y-2"], ["btn", "", "matRipple", "", 1, "mt-2", "mb-4", "w-full", 3, "click"], ["for", "name"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["for", "building"], ["placeholder", "Select Building", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value"], ["for", "level"], ["formControlName", "level_id", "placeholder", "Select Level"], ["matInput", "", "name", "location", "placeholder", "Location", "formControlName", "location"], ["icon", "", "matRipple", "", 1, "border-secondary", "text-secondary", "h-12", "w-12", "rounded-sm", "border", 3, "click", "matTooltip"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", "name", "latitude", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matInput", "", "name", "longitude", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matInput", "", "placeholder", "Label", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matInput", "", "placeholder", "Content", 3, "ngModelChange", "ngModel", "ngModelOptions"]], template: function POIModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, POIModalComponent_Conditional_5_Template, 12, 9, "div", 3);
    \u0275\u0275conditionalCreate(6, POIModalComponent_Conditional_6_Template, 14, 11, "div", 3);
    \u0275\u0275pipe(7, "async");
    \u0275\u0275conditionalCreate(8, POIModalComponent_Conditional_8_Template, 14, 8, "div", 3);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function POIModalComponent_Template_mat_select_ngModelChange_19_listener($event) {
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(26, POIModalComponent_Conditional_26_Template, 9, 3, "div", 9);
    \u0275\u0275conditionalCreate(27, POIModalComponent_Conditional_27_Template, 9, 6, "div", 10);
    \u0275\u0275elementStart(28, "div", 11);
    \u0275\u0275element(29, "settings-toggle", 12);
    \u0275\u0275pipe(30, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "label", 13);
    \u0275\u0275text(32);
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 14)(35, "mat-form-field", 15)(36, "mat-label");
    \u0275\u0275text(37);
    \u0275\u0275pipe(38, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(40, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "upload-button", 17);
    \u0275\u0275listener("ngModelChange", function POIModalComponent_Template_upload_button_ngModelChange_41_listener($event) {
    ...
    \u0275\u0275repeaterCreate(46, POIModalComponent_For_47_Template, 9, 6, "div", 10, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "button", 20);
    \u0275\u0275listener("click", function POIModalComponent_Template_button_click_48_listener() {
      return ctx.extra_details.push(["", ""]);
    });
    \u0275\u0275text(49, " Add Details Item ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_4_0;
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 22, ctx.form.value.id ? "APP.CONCIERGE.POI_EDIT" : "APP.CONCIERGE.POI_NEW"))("loading", ctx.loading ? \u0275\u0275pipeBind1(2, 24, "APP.CONCIERGE.POI_SAVING") : "");
    \u0275\u0275advance(3);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.form.controls.name ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(((tmp_4_0 = \u0275\u0275pipeBind1(7, 26, ctx.building_list)) == null ? null : tmp_4_0.length) > 1 ? 6 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.form.controls.level_id ? 8 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 28, "COMMON.LOCATION"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 30, "COMMON.LOCATION"));
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx.location_type);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(46, _c02));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 32, "EXPLORE.MAP_ID"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(25, 34, "EXPLORE.COORDINATES"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.location_type === "map_id" ? 26 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.location_type === "coordinates" ? 27 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(30, 36, "APP.CONCIERGE.POI_SEARCHABLE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(33, 38, "APP.CONCIERGE.POI_MEDIA"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(38, 40, "APP.CONCIERGE.POI_MEDIA_URL"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(40, 42, "APP.CONCIERGE.POI_MEDIA_URL"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx.form.value.media_url)("ngModelOptions", \u0275\u0275pureFunction0(47, _c02))("types", \u0275\u0275pureFunction0(48, _c1));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(44, 44, "APP.CONCIERGE.POI_DETAILS"), " ");
    \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(POIModalComponent, { className: "POIModalComponent", filePath: "apps/concierge/src/app/poi-manager/poi-modal.component.ts", lineNumber: 303 });
})();
...
function POIManagerComponent_Conditional_12_For_7_Template(rf, ctx) {
  if (rf & 1) {
...
function POIManagerComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "mat-form-field", 8)(2, "mat-label");
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-select", 9);
    \u0275\u0275listener("ngModelChange", function POIManagerComponent_Conditional_12_Template_mat_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.building = $event);
    });
    \u0275\u0275repeaterCreate(6, POIManagerComponent_Conditional_12_For_7_Template, 2, 2, "mat-option", 10, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(8, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 4, "RESOURCE.BUILDING"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r1.building)("ngModelOptions", \u0275\u0275pureFunction0(8, _c13))("placeholder", (ctx_r1.building == null ? null : ctx_r1.building.display_name) || (ctx_r1.building == null ? null : ctx_r1.building.name));
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(8, 6, ctx_r1.buildings));
  }
}
...
_POIManagerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _POIManagerComponent, selectors: [["", "app-poi-manager", ""]], attrs: _c04, decls: 15, vars: 13, consts: [[1, "print:hidden"], [1, "flex", "h-px", "flex-1", "print:hidden"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "items-center", "justify-between", "px-8", "py-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "click"], [1, "mb-2", "flex", "items-center", "justify-between", "px-8"], [1, "relative", "block", "h-1/2", "w-full", "flex-1"], ["appearance", "outline", 1, "w-64"], ["name", "building", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [3, "value"]], template: function POIManagerComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(12, POIManagerComponent_Conditional_12_Template, 9, 9, "div", 6);
    \u0275\u0275pipe(13, "async");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(POIManagerComponent, { className: "POIManagerComponent", filePath: "apps/concierge/src/app/poi-manager/poi-manager.component.ts", lineNumber: 99 });
})();
...
//# sourceMappingURL=poi-manager.module-UBCZRSPT.js.map
