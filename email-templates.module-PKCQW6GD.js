...
var _EmailTemplatesStateService = class _EmailTemplatesStateService extends AsyncHandler {
  constructor() {
    ...
    this.template_definitions = combineLatest([
      ...
      this._change
    ]).pipe(filter(([bld]) => !!bld), switchMap(() => nc(this._org.organisation.id, "email_template_fields").pipe(map((_) => {
    ...
    this.templates = combineLatest([
      ...
      nc(this._org.organisation.id, "email_templates").pipe(map((_) => this._processTemplates(_, this._org.organisation.id)), catchError(() => of([]))),
      nc(bld.id, "email_templates").pipe(map((_) => this._processTemplates(_, bld.id)), catchError(() => of([]))),
      region ? nc(region.id, "email_templates").pipe(map((_) => this._processTemplates(_, region.id)), catchError(() => of([]))) : of([])
  ...
  async saveTemplate(template, old_zone = "") {
    ...
    if (template.id && old_zone) {
      const old_metadata = await lastValueFrom(nc(old_zone, "email_templates"));
      if (old_metadata.details instanceof Array) {
        await lastValueFrom(rc(old_zone, {
    ...
    const metadata = await lastValueFrom(nc(template.zone_id, "email_templates"));
    ...
    await lastValueFrom(rc(template.zone_id, {
      name: `email_templates`,
...
function EmailTemplateManageComponent_For_23_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_For_45_For_3_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_For_45_For_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 24);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_For_45_For_3_Template_button_click_0_listener() {
    ...
    \u0275\u0275text(8, ":");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(9, EmailTemplateManageComponent_For_45_For_3_Conditional_9_Template, 2, 0, "icon", 22);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function EmailTemplateManageComponent_For_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(2, EmailTemplateManageComponent_For_45_For_3_Template, 10, 3, "button", 26, \u0275\u0275repeaterTrackByIdentity);
  }
  if (rf & 2) {
...
function EmailTemplateManageComponent_For_53_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 24);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_For_53_Template_button_click_0_listener() {
...
function EmailTemplateManageComponent_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
...
function EmailTemplateManageComponent_Conditional_83_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 35)(1, "button", 44);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_Conditional_83_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r4 = \u0275\u0275nextContext();
...
function EmailTemplateManageComponent_ng_template_84_Template(rf, ctx) {
  if (rf & 1) {
...
_EmailTemplateManageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplateManageComponent, selectors: [["email-template-manage"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 86, vars: 61, consts: [["trigger_menu", "matMenu"], ["tracking_menu", "matMenu"], ["load_state", ""], [1, "bg-base-200", "absolute", "inset-0", "overflow-auto"], [1, "border-base-300", "bg-base-100", "absolute", "top-0", "left-1/2", "h-full", "w-164", "max-w-full", "-translate-x-1/2", "border-x"], [1, "bg-base-200", "sticky", "top-0", "z-20", "mx-auto", "my-2", "flex", "w-full", "max-w-160", "items-center", "justify-between", "rounded-sm", "border-none", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "relative", "z-10", "mx-auto", "w-full", "max-w-160", "overflow-visible", "p-2", 3, "formGroup"], [1, "flex", "items-center", "space-x-4"], [1, "w-1/4", "flex-1", "space-y-2"], ["for", "zone"], ["appearance", "outline", 1, "w-full"], ["name", "zone", "formControlName", "zone_id", 3, "placeholder"], ["value", ""], [3, "value"], [1, "w-1/4", "flex-1", "space-y-2", "pb-6"], ["for", "trigger"], ["btn", "", "matRipple", "", 1, "inverse", "border-base-300", "flex", "h-12", "w-full", "items-center", "justify-between", "rounded-sm", "border", "px-2", 3, "click", "matMenuTriggerFor"], [1, "flex", "w-1/2", "flex-1", "flex-col", "px-2", "text-left", "leading-tight"], [1, "truncate"], [1, "truncate", "opacity-60"], [1, "text-2xl"], [1, "max-h-96"], ["mat-menu-item", "", 3, "click"], ["btn", "", "matRipple", "", "matTooltip", "Values that get replaced in the email template when sent", 1, "mt-2", "flex-1", 3, "disabled", "matMenuTriggerFor"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "disabled"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", "formControlName", "reply_to", 3, "placeholder"], ["matInput", "", "formControlName", "from", 3, "placeholder"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Template Subject", "formControlName", "subject"], ["formControlName", "html", 1, "block", "min-h-[calc(100vh-32rem)]", 3, "placeholder", "images_allowed"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-20", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "-translate-x-1/2", "items-center", "justify-end", "rounded-sm", "border-none", "px-4", "py-2"], [1, "p-4"], [1, "flex", "items-center", "space-x-2", "pl-2"], [1, "my-2", "flex", "flex-1", "flex-col-reverse", "leading-tight"], [1, "text-xs", "opacity-60"], [1, "text-sm"], [1, "opacity-0"], [1, "flex", "flex-col", "leading-tight"], [1, "font-mono", "text-sm"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "bg-base-100", "absolute", "inset-0"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function EmailTemplateManageComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "mat-select", 13);
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275elementStart(19, "mat-option", 14);
    \u0275\u0275text(20);
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(22, EmailTemplateManageComponent_For_23_Template, 2, 2, "mat-option", 15, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(24, "async");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(27, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div", 16)(29, "label", 17);
    \u0275\u0275text(30);
    \u0275\u0275pipe(31, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "button", 18);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_Template_button_click_32_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(35);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(36, EmailTemplateManageComponent_Conditional_36_Template, 3, 3, "div", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "icon", 22);
    \u0275\u0275text(38, " arrow_drop_down ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "mat-menu", 23, 0)(41, "button", 24);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_Template_button_click_41_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275pipe(43, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(44, EmailTemplateManageComponent_For_45_Template, 4, 1, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(46, "async");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(49, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "mat-menu", 23, 1);
    \u0275\u0275repeaterCreate(52, EmailTemplateManageComponent_For_53_Template, 6, 2, "button", 26, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(54, EmailTemplateManageComponent_Conditional_54_Template, 3, 4, "button", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 28)(56, "mat-form-field", 29)(57, "mat-label");
    \u0275\u0275text(58, "Reply To");
    \u0275\u0275elementEnd();
    \u0275\u0275element(59, "input", 30);
    \u0275\u0275pipe(60, "translate");
    \u0275\u0275elementStart(61, "mat-error");
    \u0275\u0275text(62);
    \u0275\u0275pipe(63, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(64, "mat-form-field", 29)(65, "mat-label");
    \u0275\u0275text(66, "From");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(71, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(72, "mat-form-field", 12)(73, "mat-label");
    \u0275\u0275text(74, "Subject");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "icon", 32);
    \u0275\u0275text(76, " description ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(77, "input", 33);
    \u0275\u0275elementStart(78, "mat-error");
    \u0275\u0275text(79);
    \u0275\u0275pipe(80, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(81, "rich-text-input", 34);
    \u0275\u0275pipe(82, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(83, EmailTemplateManageComponent_Conditional_83_Template, 4, 3, "footer", 35);
    \u0275\u0275elementEnd();
    \u0275\u0275template(84, EmailTemplateManageComponent_ng_template_84_Template, 5, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const trigger_menu_r10 = \u0275\u0275reference(40);
    const tracking_menu_r11 = \u0275\u0275reference(51);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 25, (ctx.template == null ? null : ctx.template.id) ? "APP.CONCIERGE.EMAIL_TEMPLATES_EDIT" : "APP.CONCIERGE.EMAIL_TEMPLATES_NEW"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx.loading ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 27, "RESOURCE.BUILDING"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 29, "RESOURCE.BUILDING"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(18, 31, "COMMON.BUILDING_SELECT"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 33, "COMMON.BUILDING_EMPTY"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(24, 35, ctx.buildings));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(27, 37, "COMMON.BUILDING_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 39, "COMMON.TRIGGER"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx.active_trigger ? 36 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(43, 41, "COMMON.NONE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(46, 43, ctx.definitions));
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx.form.value.trigger)("matMenuTriggerFor", tracking_menu_r11);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(49, 45, "APP.CONCIERGE.EMAIL_TEMPLATES_PLACEHOLDERS"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275repeater((ctx.active_trigger == null ? null : ctx.active_trigger.fields) || \u0275\u0275pureFunction0(59, _c0));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!((ctx.active_trigger == null ? null : ctx.active_trigger.fields) || \u0275\u0275pureFunction0(60, _c0)).length ? 54 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(60, 47, "APP.CONCIERGE.EMAIL_TEMPLATES_REPLY_TO"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(63, 49, "APP.CONCIERGE.EMAIL_TEMPLATES_REPLY_TO_REQUIRED"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(68, 51, "APP.CONCIERGE.EMAIL_TEMPLATES_FROM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(71, 53, "APP.CONCIERGE.EMAIL_TEMPLATES_FROM_REQUIRED"));
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(80, 55, "APP.CONCIERGE.EMAIL_TEMPLATES_SUBJECT_REQUIRED"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(82, 57, "APP.CONCIERGE.EMAIL_TEMPLATES_BODY"))("images_allowed", true);
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplateManageComponent, { className: "EmailTemplateManageComponent", filePath: "apps/concierge/src/app/email-templates/email-template-manage.component.ts", lineNumber: 302 });
})();
...
_EmailTemplatesListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplatesListComponent, selectors: [["email-templates-list"]], decls: 29, vars: 46, consts: [["date_template", ""], ["bld_template", ""], ["trigger_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "space-x-2", "p-8"], [1, "text-2xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-y-auto", "px-8"], [1, "min-h-full", "w-full", "overflow-x-auto"], ["empty_message", "No group events for selected period", 1, "block", "w-full", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable"], [1, "p-4", "opacity-60"], [1, "p-4"], [1, "opacity-60"], [1, "p-4", "font-mono", "text-xs"], ["icon", "", "matRipple", "", "aria-label", "More options", 1, "mx-auto", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", 3, "routerLink"], [1, "text-error", "text-2xl"]], template: function EmailTemplatesListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplatesListComponent, { className: "EmailTemplatesListComponent", filePath: "apps/concierge/src/app/email-templates/email-templates-list.component.ts", lineNumber: 184 });
})();
...
//# sourceMappingURL=email-templates.module-PKCQW6GD.js.map
