import {
  ParkingService
} from "./chunk-RQKENEG6.js";
import {
  BookingFormService
} from "./chunk-7OC4HH7T.js";
import {
  DateFieldComponent,
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_28_Conditional_2_For_9_Template, 5, 12, "mat-option", 15, _forTrack0, true);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_29_For_9_Template, 10, 13, "div", 39, _forTrack0, true);
    \u0275\u0275elementEnd();
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275repeaterCreate(9, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_55_For_10_Template, 3, 4, "mat-option", 15, _forTrack0, true);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_9_For_3_Template, 3, 4, "mat-option", 15, _forTrack0, true);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(1, 3, option_r28.name))("ngModel", ctx_r2.isExtraRestrictionSelected(option_r28.id))("ngModelOptions", \u0275\u0275pureFunction0(5, _c0));
    \u0275\u0275control();
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_56_Conditional_10_For_2_Template, 2, 6, "settings-toggle", 53, _forTrack0, true);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(16, ParkingRequestFormDetailsComponent_Conditional_0_For_17_Template, 12, 16, "div", 6, _forTrack0, true);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(44, ParkingRequestFormDetailsComponent_Conditional_0_For_45_Template, 3, 4, "mat-option", 15, _forTrack0, true);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.model().plate_number)("ngModelOptions", \u0275\u0275pureFunction0(36, _c0))("placeholder", \u0275\u0275pipeBind1(53, 34, "BOOKINGS.PARKING_REGISTRATION_PLACEHOLDER"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
...
var ParkingRequestFormComponent = class _ParkingRequestFormComponent extends AsyncHandler {
  constructor() {
    ...
    this.submitRequest = async () => {
      ...
      const location = building?.display_name || building?.name || this.model().location;
...
//# sourceMappingURL=parking-request-flow.component-B3O5Q25G.js.map
