...
function AiImageModalComponent_Conditional_19_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 28)(1, "label", 44);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 30)(5, "textarea", 45);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function AiImageModalComponent_Conditional_19_Conditional_1_Template_textarea_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function AiImageModalComponent_Conditional_19_Conditional_1_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 5, "SIGNAGE_MANAGER.AI_REFINE"));
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(6, 7, "SIGNAGE_MANAGER.AI_REFINE_HINT"));
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 9, "SIGNAGE_MANAGER.AI_REFINE_ACTION"), " ");
  }
}
function AiImageModalComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, AiImageModalComponent_Conditional_19_Conditional_1_Template, 10, 11, "div", 28);
    \u0275\u0275elementStart(2, "ai-references", 37);
    \u0275\u0275listener("picked", function AiImageModalComponent_Conditional_19_Template_ai_references_picked_2_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addReferences($event, "include"));
    })("removed", function AiImageModalComponent_Conditional_19_Template_ai_references_removed_2_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeReference($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ai-references", 38);
    \u0275\u0275listener("picked", function AiImageModalComponent_Conditional_19_Template_ai_references_picked_3_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addReferences($event, "style"));
    })("removed", function AiImageModalComponent_Conditional_19_Template_ai_references_removed_3_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeReference($event));
    });
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "ai-layer-controls", 43);
    \u0275\u0275listener("changed", function AiImageModalComponent_Conditional_19_Template_ai_layer_controls_changed_8_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.layer_state.set($event));
    })("logoPicked", function AiImageModalComponent_Conditional_19_Template_ai_layer_controls_logoPicked_8_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("items", ctx_r1.style_items())("uploading", ctx_r1.uploading_references())("max", ctx_r1.style_max())("offset", ctx_r1.include_references().length);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 16, "SIGNAGE_MANAGER.AI_WORDS_AND_LOGO"), " ");
    \u0275\u0275advance(2);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AiImageModalComponent, selectors: [["ai-image-modal"]], viewQuery: function AiImageModalComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(18, AiImageModalComponent_Conditional_18_Template, 20, 21)(19, AiImageModalComponent_Conditional_19_Template, 9, 18);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AiImageModalComponent, { className: "AiImageModalComponent", filePath: "apps/signage-manager/src/app/ai/ai-image-modal.component.ts", lineNumber: 505 });
})();
export {
  AiImageModalComponent
};
//# debugId=3c59a5c0-1e0f-5080-98aa-413667a77027
//# sourceMappingURL=ai-image-modal.component-GPVOQDAG.js.map
