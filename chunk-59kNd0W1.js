...
`],encapsulation:2})}return n})(),Rr=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=ce({type:n});static \u0275inj=oe({imports:[xl$1,vi,It$1]})}return n})();var bl=(()=>{class n{constructor(){this.url=m(hae);}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["image-viewer"]],decls:5,vars:1,consts:[[1,"bg-base-200","h-screen","w-screen"],["auth","",1,"h-full","w-full","object-contain","object-center",3,"source"],["icon","","matRipple","","mat-dialog-close","",1,"bg-base-100","absolute","top-1","right-1"]],template:function(t,r){t&1&&(ke(0,"div",0),Ft(1,"img",1),ke(2,"button",2)(3,"icon"),mr(4,"close"),Be()()()),t&2&&(he(),Dn$1("source",r.url));},dependencies:[mXe,It,h7e,p7e],encapsulation:2});}}return n})();var Ad=(n,i,e)=>({file:n,is_public:i,permissions:e});function Pd(n,i){if(n&1){let e=xD();ke(0,"div",7)(1,"label"),mr(2,"Permissions"),Be(),ke(3,"mat-form-field",11)(4,"mat-select",12),$e("ngModelChange",function(r){F_(e);let o=vt();return U_(o.permissions.set(r))}),ke(5,"mat-option",13),mr(6,"None"),Be(),ke(7,"mat-option",14),mr(8,"Support"),Be(),ke(9,"mat-option",15),mr(10,"Admin"),Be()(),r5(),Be()();}if(n&2){let e=vt();he(4),Dn$1("ngModel",e.permissions()),s5();}}var yl=(()=>{class n{constructor(){this._dialog_ref=m(iT),this._data=m(hae),this.file=this._data.file,this.is_public=w(!!this._data.is_public),this.permissions=w("none"),this.file=this._data.file;}close(){this._dialog_ref.close();}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["upload-permissions-modal"]],decls:18,vars:7,consts:[[1,"bg-base-200","sticky","top-0","z-10","m-2","w-[calc(100%-1rem)]","rounded-sm","border-none","p-2"],[1,"px-2","text-xl","font-medium"],["icon","","matRipple","","mat-dialog-close",""],[1,"min-w-[20rem]","space-y-2","px-4","py-2"],[1,"flex","flex-col"],["appearance","outline",1,"no-subscript"],["matInput","","disabled","true","placeholder","File Name",3,"ngModel"],[1,"flex","flex-col","space-y-2"],[1,"border-base-200","flex","items-center","justify-end","space-x-2","border-t","px-4","py-2"],["btn","","matRipple","","mat-dialog-close","",1,"inverse","w-32"],["btn","","matRipple","",1,"w-32",3,"mat-dialog-close"],["appearance","outline"],[3,"ngModelChange","ngModel"],["value","none"],["value","support"],["value","admin"]],template:function(t,r){t&1&&(ke(0,"header",0)(1,"h2",1),mr(2,"Upload File"),Be(),ke(3,"button",2)(4,"icon"),mr(5,"close"),Be()()(),ke(6,"main",3)(7,"div",4)(8,"label"),mr(9,"File Name"),Be(),ke(10,"mat-form-field",5),Ft(11,"input",6),r5(),Be()(),Le(12,Pd,11,1,"div",7),Be(),ke(13,"footer",8)(14,"button",9),mr(15," Cancel "),Be(),ke(16,"button",10),mr(17," Upload "),Be()()),t&2&&(he(11),Dn$1("ngModel",r.file.name),s5(),he(),Fe$1(r.is_public()?-1:12),he(4),Dn$1("mat-dialog-close",c4(3,Ad,r.file,r.is_public(),r.permissions())));},dependencies:[h7e,p7e,sM,P3,oOe,mB,J0e,qQ,ci,li,g3,mXe,TJe,SJe,xl$1,s0],encapsulation:2});}}return n})();var Fd=["image_list"],Vd=["file_input"];function Ld(n,i){if(n&1){let e=xD();ke(0,"div",15),Ft(1,"img",16),ke(2,"div",17),Ft(3,"div",18),ke(4,"div",19)(5,"button",20),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.copyLink(r))}),ke(6,"icon"),mr(7,"link"),Be()(),ke(8,"button",20),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.viewImage(r))}),ke(9,"icon"),mr(10,"visibility"),Be()(),ke(11,"button",20),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.removeImage(r))}),ke(12,"icon"),mr(13,"close"),Be()()()()();}if(n&2){let e=i.$implicit,t=vt();PD("transform","translate(-"+t.offset()+"00%)"),he(),Dn$1("source",e);}}function Bd(n,i){if(n&1&&Ft(0,"mat-progress-spinner",22),n&2){let e=vt().$implicit;Dn$1("value",e.progress)("diameter",64);}}function Ud(n,i){n&1&&(ke(0,"icon",23),mr(1,"warning"),Be());}function zd(n,i){n&1&&(ke(0,"div",24)(1,"icon",25),mr(2,"refresh"),Be()());}function Gd(n,i){if(n&1){let e=xD();ke(0,"div",21),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.retryUpload(r))}),Le(1,Bd,1,2,"mat-progress-spinner",22),Le(2,Ud,2,0,"icon",23),Le(3,zd,3,0,"div",24),Be();}if(n&2){let e=i.$implicit,t=vt();PD("transform","translate(-"+t.offset()+"00%)"),Dn$1("matTooltip",e.error),he(),Fe$1(e.error?-1:1),he(),Fe$1(e.error?2:-1),he(),Fe$1(e.error?3:-1);}}function Hd(n,i){if(n&1){let e=xD();ke(0,"button",26),$e("click",function(){F_(e);let r=vt();return U_(r.previousOffset())}),ke(1,"icon"),mr(2,"chevron_left"),Be()();}if(n&2){let e=vt();Dn$1("disabled",e.offset()===0);}}function Wd(n,i){if(n&1){let e=xD();ke(0,"button",27),$e("click",function(){F_(e);let r=vt();return U_(r.nextOffset())}),ke(1,"icon"),mr(2,"chevron_right"),Be()();}if(n&2){let e=vt();Dn$1("disabled",e.offset()>=e.length()-e.view_space());}}function jd(n,i){if(n&1){let e=xD();ke(0,"mat-chip-row",28),$e("removed",function(){let r=F_(e).$implicit,o=vt();return U_(o.removeImage(r))}),ke(1,"div",29),mr(2),Be(),ke(3,"button",30)(4,"icon"),mr(5,"cancel"),Be()()();}if(n&2){let e=i.$implicit;he(2),Kd$1(e),he(),Ge("aria-label","Remove "+e);}}var xl=(()=>{class n extends no$1{constructor(){super(...arguments),this._clipboard=m(OH),this._uploads=m(O7e),this._dialog=m(rT),this._injector=m(H$1),this._upload_completion_effect=_t(()=>{let e=this.upload_list(),t=this.upload_ids();for(let r of t){let o=e.find(c=>c?.id===r);o&&o.progress>=100&&(this.addImageUrl(o.link),this.upload_ids.set(this.upload_ids().filter(c=>c!==r)));}},{injector:this._injector}),this.list=w([]),this.upload_map={},this.upload_ids=w([]),this.upload_list=w([]),this.offset=w(0),this.view_space=w(0),this.separators=[188,13],this.uploads=me(()=>{let e=this.upload_ids();return this.upload_list().filter(t=>e.includes(t?.id))}),this.length=me(()=>this.list().length+this.upload_list().length+1),this._list_el=qc$1("image_list"),this._file_input=qc$1("file_input"),this.registerOnChange=e=>this._onChange=e,this.registerOnTouched=e=>this._onTouch=e;}ngAfterViewInit(){this.updateViewSpace();}updateViewSpace(){this.timeout("init_view_space",()=>{let e=this._list_el()?.nativeElement?.getBoundingClientRect();e&&this.view_space.set(Math.floor(e.width/152));},100);}copyLink(e){this._clipboard.copy(e),nH("Copied image URL to clipboard");}viewImage(e){this._dialog.open(bl,{data:e});}removeImage(e){this.setValue(this.list().filter(t=>t!==e));}addImage(e){e.value&&(this.setValue(Cr$1([...this.list(),e.value])),e.chipInput.inputElement.value="");}addImageUrl(e){this.setValue(Cr$1([...this.list(),e]));}retryUpload(e){e.error&&(e.error=null,e.upload.resume());}previousOffset(){this.offset.update(e=>e-1);}nextOffset(){this.offset.update(e=>e+1);}async uploadImages(e){let t=e.target;if(t?.files){let r=t.files;if(r.length){this.interval("update_status",()=>this._updateUploadHistory());for(let o=0;o<r.length;o++){let c=await this._uploads.uploadFileWithPermissions(r[o]);this.upload_ids.set([...this.upload_ids(),c]),this._file_input().nativeElement.value="";}}}}setValue(e){let t=e||[];this.list.set(t),this._onChange&&this._onChange(t);}writeValue(e){this.list.set(e||[]);}async _updateUploadHistory(){let e=this.upload_ids();if(e.length===0)return;let r=this._uploads.upload_list().filter(c=>e.find(h=>h===c?.id)),o=r.filter(c=>c.progress>=100);this.upload_list.set(r),o.forEach(c=>{console.log("ID:",l({},c)),this.upload_map[c?.id]=c.upload?.id||c?.id,delete c.upload;}),o.length>=e.length&&this.clearInterval("update_status");}static{this.\u0275fac=(()=>{let e;return function(r){return (e||(e=yt(n)))(r||n)}})();}static{this.\u0275cmp=ve({type:n,selectors:[["image-list-field"]],viewQuery:function(t,r){t&1&&Wd$1(r._list_el,Fd,5)(r._file_input,Vd,5),t&2&&qd$1(2);},features:[ot$1([{provide:ka,useExisting:nn(()=>n),multi:true},{provide:ece,useValue:yl}]),Re],decls:23,vars:13,consts:[["image_list",""],["file_input",""],["chipList",""],["images","",1,"relative","mb-2","flex","w-full","items-center","space-x-2","overflow-hidden","py-2",3,"resize"],["image","",1,"border-base-200","hover:border-base-300","hover:bg-base-200","relative","flex","h-32","w-36","shrink-0","cursor-pointer","flex-col","items-center","justify-center","rounded-xl","border-2","border-dashed"],[1,"text-4xl","opacity-60"],[1,"px-4","text-center","opacity-60"],["type","file",1,"absolute","inset-0","h-32","w-32","cursor-pointer","opacity-0",3,"change"],["image","",1,"bg-base-200","relative","h-32","w-36","shrink-0","overflow-hidden","rounded-sm","bg-cover","bg-center",3,"transform"],["upload","",1,"border-base-content/10","/5","bg-base-200","flex","h-32","w-36","shrink-0","items-center","justify-center","rounded-sm","border","bg-cover","bg-center",3,"transform","matTooltip"],["icon","","matRipple","",1,"bg-base-100","absolute","top-1/2","left-0","-translate-y-1/2","transform",3,"disabled"],["icon","","matRipple","",1,"bg-base-100","absolute","top-1/2","right-0","-translate-y-1/2","transform",3,"disabled"],["appearance","outline",1,"w-full"],["aria-label","Image List"],[3,"matChipInputTokenEnd","placeholder","matChipInputFor","matChipInputSeparatorKeyCodes","matChipInputAddOnBlur"],["image","",1,"bg-base-200","relative","h-32","w-36","shrink-0","overflow-hidden","rounded-sm","bg-cover","bg-center"],["auth","",1,"pointer-events-none","absolute","top-1/2","left-1/2","z-10","-translate-x-1/2","-translate-y-1/2","object-contain",3,"source"],["overlay","",1,"text-base-100","absolute","inset-0","z-20"],["bg","",1,"absolute","inset-0","bg-black","opacity-0"],["actions","",1,"absolute","top-0","right-0","left-0","flex","items-center","justify-center","space-x-2","opacity-0"],["icon","",3,"click"],["upload","",1,"border-base-content/10","/5","bg-base-200","flex","h-32","w-36","shrink-0","items-center","justify-center","rounded-sm","border","bg-cover","bg-center",3,"click","matTooltip"],["mode","determinate",3,"value","diameter"],[1,"text-error","text-6xl"],["overlay","",1,"text-base-100","hover:bg-base-content","hover:bg-opacity-50","absolute","inset-0","flex","items-center","justify-center"],[1,"text-3xl","opacity-0"],["icon","","matRipple","",1,"bg-base-100","absolute","top-1/2","left-0","-translate-y-1/2","transform",3,"click","disabled"],["icon","","matRipple","",1,"bg-base-100","absolute","top-1/2","right-0","-translate-y-1/2","transform",3,"click","disabled"],[3,"removed"],[1,"max-w-md","truncate"],["matChipRemove",""]],template:function(t,r){if(t&1&&(ke(0,"div",3,0),$e("resize",function(){return r.updateViewSpace()},xq),ke(2,"div",4)(3,"icon",5),mr(4,"add"),Be(),ke(5,"p",6),mr(6),Up(7,"translate"),Be(),ke(8,"input",7,1),$e("change",function(c){return r.uploadImages(c)}),Be()(),d8(10,Ld,14,3,"div",8,l8),d8(12,Gd,4,6,"div",9,l8),Le(14,Hd,3,1,"button",10),Le(15,Wd,3,1,"button",11),Be(),ke(16,"mat-form-field",12)(17,"mat-chip-grid",13,2),d8(19,jd,6,2,"mat-chip-row",null,l8),Be(),ke(21,"input",14),Up(22,"translate"),$e("matChipInputTokenEnd",function(c){return r.addImage(c)}),Be()()),t&2){let o=HE(18);he(2),PD("transform","translate(-"+r.offset()+"00%)"),he(4),Lo$1(" ",LD(7,9,"COMMON.IMAGE_UPLOADS")," "),he(4),u8(r.list()),he(2),u8(r.uploads()),he(2),Fe$1(r.length()>r.view_space()?14:-1),he(),Fe$1(r.length()>r.view_space()?15:-1),he(4),u8(r.list()),he(2),Dn$1("placeholder",LD(22,11,"COMMON.IMAGE_ADD_URL"))("matChipInputFor",o)("matChipInputSeparatorKeyCodes",r.separators)("matChipInputAddOnBlur",true);}},dependencies:[sM,P3,Yet,jet,zet,$et,kle,St,oi,KJe,ale,mXe,It,eet],styles:["[_nghost-%COMP%]{width:100%}[overlay][_ngcontent-%COMP%]{transition:background .2s}[image][_ngcontent-%COMP%]:hover   [actions][_ngcontent-%COMP%], [image][_ngcontent-%COMP%]:hover > icon[_ngcontent-%COMP%]{opacity:1!important}[image][_ngcontent-%COMP%]:hover   [bg][_ngcontent-%COMP%]{opacity:.4!important}[actions][_ngcontent-%COMP%], [image][_ngcontent-%COMP%] > icon[_ngcontent-%COMP%]{transition:opacity .2s}[image][_ngcontent-%COMP%]{transition:transform .2s}"]});}}return n})();function Kd(n,i){if(n&1&&(Ft(0,"div",1),Up(1,"safe")),n&2){let e=vt();Dn$1("innerHTML",FD(1,1,e.changelog(),"html"),QA);}}function qd(n,i){n&1&&(ke(0,"div",2)(1,"icon",3),mr(2,"close"),Be(),ke(3,"div",4),mr(4,"No changelog"),Be()());}var kl=(()=>{class n{constructor(){this._data=m(hae),this.loading=w(false),this.changelog=me(()=>lt(this._data.changelog||"",{async:false}));}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["changelog-modal"]],decls:3,vars:3,consts:[[3,"heading","hide_confirm"],[1,"markdown",3,"innerHTML"],[1,"flex","flex-col","items-center","justify-center","space-y-2"],[1,"text-3xl"],[1,"text"]],template:function(t,r){t&1&&(ke(0,"fullscreen-modal-shell",0),Le(1,Kd,2,4,"div",1)(2,qd,5,0,"div",2),Be()),t&2&&(Dn$1("heading","Changelog")("hide_confirm",true),he(),Fe$1(r.changelog()?1:2));},dependencies:[Sr,mXe,E3],encapsulation:2});}}return n})();function $d(n,i){if(n&1&&(ke(0,"div",1),mr(1),Be()),n&2){let e=vt(2);he(),Lo$1(" ",e.initials," ");}}function Xd(n,i){if(n&1&&Ft(0,"img",2),n&2){let e=vt(2);Dn$1("alt",e.initials)("source",e.user().photo);}}function Yd(n,i){if(n&1&&(ke(0,"div",0),Le(1,$d,2,1,"div",1)(2,Xd,1,2,"img",2),Be()),n&2){let e=vt();Ge("user-id",e.user().id),he(),Fe$1(e.user().photo?2:1);}}var Or=(()=>{class n{constructor(){this.user=gn(void 0),this.is_valid=me(()=>{let e=this.user();if(!e)return  false;let t=(e.name||"").trim(),r=(e.email||"").trim();return t.startsWith("<empty>")||r.startsWith("<empty>")?false:!!(t||r||e.first_name||e.last_name)});}get initials(){let e=this.user();if(!e)return "NA";if(e.first_name&&e.last_name)return `${e.first_name[0]}${e.last_name[0]}`;let t=(e.name||"").replace(/<[^>]*>/g," ").trim();t||(t=(e.email||e.name||"").split("@")[0]);let r=t.replace(/[()[\]\-+=\\/@<>]+/gi," ").split(/\s+/).filter(Boolean);return r.length===0?"NA":r.length>1?`${r[0][0]}${r[r.length-1][0]}`:r[0].slice(0,2)}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["a-user-avatar"]],inputs:{user:[1,"user"]},decls:1,vars:1,consts:[[1,"border-base-100","bg-base-200","flex","h-[2.5em]","w-[2.5em]","items-center","justify-center","overflow-hidden","rounded-full","border-2"],["initials","",1,"text-base-content","uppercase","opacity-60"],["auth","",1,"flex","h-full","w-full","items-center","justify-center","object-cover","object-center",3,"alt","source"]],template:function(t,r){t&1&&Le(0,Yd,3,2,"div",0),t&2&&Fe$1(r.is_valid()?0:-1);},dependencies:[It],encapsulation:2});}}return n})();function Qd(n,i){if(n&1&&(ke(0,"mat-option",8),mr(1),Be()),n&2){let e=i.$implicit;Dn$1("value",e.display_name||e.name),he(),Lo$1(" ",e.display_name||e.name," ");}}function Zd(n,i){if(n&1&&(ke(0,"mat-option",8),mr(1),Be()),n&2){let e=i.$implicit;Dn$1("value",e?.name||e),he(),Lo$1(" ",e.name||e," ");}}function Jd(n,i){if(n&1&&(ke(0,"div",5)(1,"label"),mr(2),Up(3,"translate"),Be(),ke(4,"mat-form-field",6)(5,"mat-select",7),Up(6,"translate"),d8(7,Zd,2,2,"mat-option",8,l8),Be(),r5(),Be()()),n&2){let e=vt();he(2),Kd$1(LD(3,3,"COMMON.SUPPORT_TYPE")),he(3),Dn$1("placeholder",LD(6,5,"COMMON.SUPPORT_TYPE"))("formField",e.form.issue_type),s5(),he(2),u8(e.support_request_types());}}function em(n,i){n&1&&(ke(0,"mat-error",11),mr(1),Up(2,"translate"),Be()),n&2&&(he(),Lo$1(" ",LD(2,1,"COMMON.SUPPORT_DESCRIPTION_REQUIRED")," "));}function tm(n,i){if(n&1&&(ke(0,"div",12)(1,"label",10),mr(2),Up(3,"translate"),Be(),Ft(4,"image-list-field",14),r5(),Be()),n&2){let e=vt();he(2),Kd$1(LD(3,2,"COMMON.SUPPORT_IMAGES")),he(2),Dn$1("formField",e.form.images),s5();}}var Ml=(()=>{class n{constructor(){this._dialog_ref=m(iT),this._org=m(eT),this._settings=m(Ws$1),this._support_email=this._settings.signal("support_email","support@place.tech"),this._support_issue_types=this._settings.signal("support_issue_types",[]),this._allow_images=this._settings.signal("allow_support_ticket_images",false),this.loading=w(false),this.model=w({name:"",email:"",location:"",description:"",issue_type:"",images:[]}),this.form=Ro(this.model,e=>{Tr(e.name),Tr(e.email),Tr(e.description);}),this.desc_error=w(false),this.support_email=this._support_email,this.support_request_types=this._support_issue_types,this.allow_images=this._allow_images,this.buildings=this._org.building_list;}ngOnInit(){let e=so$1();e&&this.model.update(t=>m$1(l({},t),{name:e.name,email:e.email})),this._org.building&&this.model.update(t=>m$1(l({},t),{location:this._org.building.display_name||this._org.building.name}));}async submit(){if(this.loading.set(true),this.form().markAsTouched(),this._updateDescError(),this.form().valid()){let e=this._org.module("smtp","Mailer");if(!e)return eH(vi$1("COMMON.SUPPORT_NO_MAILER"));let{name:t,email:r,location:o,description:c,images:h,issue_type:x}=this.model(),R=this.support_request_types().find(ae=>ae.name===x)?.email||this.support_email(),F=vi$1("COMMON.SUPPORT_MAIL_HEADER",{issue_type:x?" - "+x:""});await e.execute("send_mail",[R,F,`${t}
${r}
...
${h.join(`
`)}`,`<p>${t}</p><p>${r}</p><p>${o}</p><p>${c}</p>${h.join("<br>")}`,[],[],[],[],null,`${r}`]),this._dialog_ref.close(),this.loading.set(false),tb(vi$1("COMMON.SUPPORT_SUCCESS"));}}_updateDescError(){this.desc_error.set(this.form.description().invalid()&&this.form.description().touched());}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["support-ticket-modal"]],decls:51,vars:45,consts:[[3,"confirm","heading","loading","confirm_text"],[1,"flex","flex-wrap","items-center","sm:space-x-2"],[1,"flex","flex-1","flex-col"],["appearance","outline"],["matInput","",3,"placeholder","formField"],[1,"flex","flex-col"],["appearance","outline",1,"w-full"],[3,"placeholder","formField"],[3,"value"],[1,""],[1,"mb-4"],[1,"my-2","text-xs"],[1,"pt-4"],[1,"mb-2","text-center","text-xs","italic"],[3,"formField"]],template:function(t,r){t&1&&(ke(0,"fullscreen-modal-shell",0),Up(1,"translate"),$e("confirm",function(){return r.submit()}),ke(2,"form")(3,"div",1)(4,"div",2)(5,"label"),mr(6),Up(7,"translate"),ke(8,"span"),mr(9,"*"),Be()(),ke(10,"mat-form-field",3),Ft(11,"input",4),Up(12,"translate"),r5(),ke(13,"mat-error"),mr(14),Up(15,"translate"),Be()()(),ke(16,"div",2)(17,"label"),mr(18),Up(19,"translate"),ke(20,"span"),mr(21,"*"),Be()(),ke(22,"mat-form-field",3),Ft(23,"input",4),Up(24,"translate"),r5(),ke(25,"mat-error"),mr(26),Up(27,"translate"),Be()()()(),ke(28,"div",5)(29,"label"),mr(30),Up(31,"translate"),Be(),ke(32,"mat-form-field",6)(33,"mat-select",7),Up(34,"translate"),d8(35,Qd,2,2,"mat-option",8,l8),Be(),r5(),Be()(),Le(37,Jd,9,7,"div",5),ke(38,"div",9)(39,"label",10),mr(40),Up(41,"translate"),ke(42,"span"),mr(43,"*"),Be()(),Ft(44,"rich-text-input",7),Up(45,"translate"),r5(),Le(46,em,3,3,"mat-error",11),Be(),Le(47,tm,5,4,"div",12),Be(),ke(48,"div",13),mr(49),Up(50,"translate"),Be()()),t&2&&(Dn$1("heading","Raise a support ticket")("loading",r.loading()?"true":"")("confirm_text",LD(1,21,"COMMON.SUBMIT")),he(6),Kd$1(LD(7,23,"FORM.NAME")),he(5),Dn$1("placeholder",LD(12,25,"FORM.NAME"))("formField",r.form.name),s5(),he(3),Kd$1(LD(15,27,"FORM.NAME_REQUIRED")),he(4),Kd$1(LD(19,29,"FORM.EMAIL")),he(5),Dn$1("placeholder",LD(24,31,"FORM.EMAIL"))("formField",r.form.email),s5(),he(3),Kd$1(LD(27,33,"FORM.EMAIL_REQUIRED")),he(4),Kd$1(LD(31,35,"COMMON.SUPPORT_LOCATION")),he(3),Dn$1("placeholder",LD(34,37,"COMMON.SUPPORT_LOCATION"))("formField",r.form.location),s5(),he(2),u8(r.buildings()),he(2),Fe$1(r.support_request_types().length?37:-1),he(3),Lo$1(" ",LD(41,39,"COMMON.SUPPORT_DESCRIPTION")," "),he(4),Dn$1("placeholder",LD(45,41,"COMMON.SUPPORT_DESCRIPTION"))("formField",r.form.description),s5(),he(2),Fe$1(r.desc_error()?46:-1),he(),Fe$1(r.allow_images()?47:-1),he(2),Lo$1(" ",LD(50,43,"COMMON.SUPPORT_MSG")," "));},dependencies:[py,sM,P3,Hce,TJe,SJe,hl,St,xl$1,Cl,xl,ci,li,g3,h7e,Sr,eet],styles:["mat-form-field[_ngcontent-%COMP%]{width:100%}"]});}}return n})();var im=["*"],nm=(n,i)=>i.id;function rm(n,i){if(n&1&&(ke(0,"div",4),mr(1),Up(2,"date"),Be()),n&2){let e=vt();he(),Lo$1(" ",E4(2,1,e.active_time(),e.time_format()+" (z)",e.tz())," ");}}function om(n,i){if(n&1&&(ke(0,"div",13),mr(1),Up(2,"date"),Be()),n&2){let e=vt(2);he(),Lo$1(" ",E4(2,1,e.force_time(),e.time_format()+" (z)",e.tz())," ");}}function am(n,i){n&1&&(ke(0,"icon",14),mr(1," done "),Be());}function sm(n,i){if(n&1){let e=xD();ke(0,"button",9),$e("click",function(){F_(e);let r=vt();return U_(r.setValue(r.force_time().toString()))}),ke(1,"div",10)(2,"div",11)(3,"div",12),mr(4),Up(5,"date"),Be(),Le(6,om,3,5,"div",13),Be(),Le(7,am,2,0,"icon",14),Be()();}if(n&2){let e=vt();Dn$1("value",e.force_time()),he(4),Lo$1(" ",FD(5,4,e.force_time(),e.time_format())," "),he(2),Fe$1(e.timezone()&&e.tz()?6:-1),he(),Fe$1(e.active_time()===e.force_time()?7:-1);}}function lm(n,i){if(n&1&&(ke(0,"div",13),mr(1),Up(2,"date"),Be()),n&2){let e=vt().$implicit,t=vt();he(),Lo$1(" ",E4(2,1,e.date,t.time_format()+" (z)",t.tz())," ");}}function cm(n,i){n&1&&(ke(0,"icon",14),mr(1," done "),Be());}function dm(n,i){if(n&1){let e=xD();ke(0,"button",9),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.setValue(r.id))}),ke(1,"div",10)(2,"div",11)(3,"div",12),mr(4),Up(5,"date"),Be(),Le(6,lm,3,5,"div",13),Be(),Le(7,cm,2,0,"icon",14),Be()();}if(n&2){let e=i.$implicit,t=vt();Dn$1("value",e.id),Ge("data-time",e.id),he(4),zL(" ",FD(5,6,e.date,t.time_format())," ",t.extra_info_fn()(e.date)," "),he(2),Fe$1(t.timezone()&&t.tz()?6:-1),he(),Fe$1(t.active_time()===e.date?7:-1);}}function mm(n,i){n&1&&(ke(0,"div",8),mr(1,"No time options to select"),Be());}function um(n,i){n&1&&(ke(0,"mat-error"),Pe(1),Be());}var wl=(()=>{class n extends no$1{constructor(){super(...arguments),this.step=gn(15),this.disabled=UIe(void 0),this.no_past_times=gn(true),this.use_24hr=gn(false),this.force_time=gn(void 0),this.no_error=gn(void 0),this.extra_info_fn=gn(e=>""),this.from=gn(Cn(Date.now()).valueOf()),this.range=gn(void 0),this.min_duration=gn(0),this.timezone=gn(""),this.date=w(new Date().valueOf()),this.time=w(to$1(new Date,"HH:mm")),this._time_options=w([]),this.show_select=w(false),this.active_time=w(Date.now()),this.no_options=w(false),this._menu_trigger=qc$1(ut),this.time_format=me(()=>this.use_24hr()?"HH : mm":"h : mm a"),this._local_tz=dxe(Intl.DateTimeFormat().resolvedOptions().timeZone),this.tz=me(()=>{let e=this.timezone();if(!e)return "";let t=dxe(e);return t===this._local_tz?"":t});}ngOnInit(){this.show_select.set(true),this._time_options.set(this.generateAvailableTimes(this.date(),!this.no_past_times(),this.step())),this._updateNoOptions(),this.timeout("hide",()=>this.show_select.set(false));let e=this.timezone()||void 0;this.active_time.set(this._time_options().find(t=>t.id===fxe(this.date(),e))?.date||this.active_time());}ngOnChanges(e){(e.no_past_times||e.step||e.from||e.range||e.min_duration)&&(this._time_options.set(this.generateAvailableTimes(this.date(),!this.no_past_times(),this.step())),this._updateNoOptions());}ngAfterViewInit(){let e=this._menu_trigger();e&&this.subscription("menu_opened",e.menuOpened.subscribe(()=>{this._scrollToSelectedTime();}));}_scrollToSelectedTime(){requestAnimationFrame(()=>{if(!this._menu_trigger()?.menu)return;let t=document.querySelector(".mat-mdc-menu-panel");if(!t)return;let r=this.timezone()||void 0,o=this.time()||fxe(new Date,r),c=t.querySelector(`[data-time="${o}"]`);if(!c&&this._time_options().length){let h=this._timeToMinutes(o),x=this._time_options()[0],R=1/0;for(let F of this._time_options()){let ae=this._timeToMinutes(F.id),ue=Math.abs(ae-h);ue<R&&(R=ue,x=F);}c=t.querySelector(`[data-time="${x.id}"]`);}if(c){if(typeof c.scrollIntoView!="function")return;c.scrollIntoView({block:"center",behavior:"instant"});}});}_timeToMinutes(e){let[t,r]=e.split(":").map(Number);return t*60+r}time_options(){let e=this.timezone()||void 0,t=(this.time()||"00:00").split(":"),r=pxe(this.date(),+t[0],+t[1],e),{minutes:o}=qJ(r,e),c=fxe(r,e),h=[...this._time_options()];return o%this.step()!==0&&this._isWithinRange(r)&&!h.find(x=>x.id===c)&&(h.push({date:r,id:c}),h.sort((x,R)=>`${x.id}`.localeCompare(`${R.id}`))),h}setValue(e){this.time.set(e);let t=this.timezone()||void 0;if(this._onChange){let h=(this.time()||"00:00").split(":"),x=pxe(this.date(),+h[0],+h[1],t);Txe(),this._onChange(x);}let r=this.force_time()||this.time(),o=(typeof r=="string"?r:fxe(r,t)).split(":"),c=pxe(this.date(),+o[0],+o[1],t);this.active_time.set(this._time_options().find(h=>h.id===(typeof r=="string"?r:fxe(r,t)))?.date||c);}writeValue(e){this.date.set(e||this.date());let t=this.timezone()||void 0,r=bl$1(this.date());r=Sl(r,{nearestTo:5}),this.time.set(fxe(r,t)),this._time_options.set(this.generateAvailableTimes(this.date(),!this.no_past_times(),this.step())),this._updateNoOptions();let o=this.force_time(),c=o?fxe(o,t):this.time();this.active_time.set(this._time_options().find(h=>h.id===c)?.date||r.valueOf());}setDisabledState(e){this.disabled.set(e),this._time_options.set(this.generateAvailableTimes(this.date(),!this.no_past_times()||e,this.step())),this._updateNoOptions();}registerOnChange(e){this._onChange=e;}registerOnTouched(e){this._onTouch=e;}_updateNoOptions(){this.no_options.set(!this.disabled()&&(!this._time_options()||this._time_options().length===0)&&!this.force_time());}generateAvailableTimes(e,t,r=15){let o=t?this.from():Math.max(this.from(),Date.now()),c=[],h=this.range(),x=this.timezone()||void 0,R=x?jo(e,x):Cn(e).valueOf(),F=x?zo$1(e,x):br$1(e).valueOf(),ae=this.min_duration()||0,ue=h?h.start*60:void 0,pt=h?h.end*60:void 0,st=pt!=null&&ae>0?pt-ae:pt,xi=Math.max(R,o,ue!=null?R+ue*60*1e3:R),G=Math.min(F,st!=null?R+st*60*1e3:F);if(xi>G)return c;let te=this._roundUpToStep(xi,r),Le=this._roundDownToStep(G,r);for(;!Ha(te,Le);)c.push({date:te.valueOf(),id:fxe(te,x)}),te=gt(te,r);return c}_isWithinRange(e){if(Qi(e,this.from()))return  false;let t=this.range();if(!t)return  true;let r=t.start*60,o=t.end*60,c=this.min_duration()||0,h=c>0?o-c:o,x=this.timezone()||void 0,{hours:R,minutes:F}=qJ(e,x),ae=R*60+F;return !(ae<r||ae>h)}_roundUpToStep(e,t){let r=Sl(e,{nearestTo:t});return Qi(r,e)&&(r=gt(r,t)),bl$1(r)}_roundDownToStep(e,t){let r=Sl(e,{nearestTo:t});return Ha(r,e)&&(r=gt(r,-t)),bl$1(r)}static{this.\u0275fac=(()=>{let e;return function(r){return (e||(e=yt(n)))(r||n)}})();}static{this.\u0275cmp=ve({type:n,selectors:[["a-time-field"],["time-field"]],viewQuery:function(t,r){t&1&&Wd$1(r._menu_trigger,ut,5),t&2&&qd$1();},inputs:{step:[1,"step"],disabled:[1,"disabled"],no_past_times:[1,"no_past_times"],use_24hr:[1,"use_24hr"],force_time:[1,"force_time"],no_error:[1,"no_error"],extra_info_fn:[1,"extra_info_fn"],from:[1,"from"],range:[1,"range"],min_duration:[1,"min_duration"],timezone:[1,"timezone"]},outputs:{disabled:"disabledChange"},features:[ot$1([{provide:ka,useExisting:nn(()=>n),multi:true}]),Re,Et],ngContentSelectors:im,decls:15,vars:12,consts:[["menu","matMenu"],["time-field","","matRipple","",1,"border-neutral","flex","h-12","w-full","items-center","justify-between","rounded-sm","border","px-2",3,"disabled","matMenuTriggerFor"],[1,"flex","w-1/2","flex-1","flex-col","px-2","text-left","leading-tight"],[1,"truncate"],[1,"truncate","text-xs","opacity-30"],[1,"text-2xl"],[1,"max-h-60","min-w-[18rem]"],["mat-menu-item","",1,"text-left",3,"value"],["mat-menu-item","","disabled",""],["mat-menu-item","",1,"text-left",3,"click","value"],[1,"flex","items-center","justify-between"],[1,"flex","flex-col","leading-tight"],[1,""],[1,"text-xs","opacity-30"],[1,"ml-2","text-2xl"]],template:function(t,r){if(t&1&&(Kt(),ke(0,"button",1)(1,"div",2)(2,"div",3),mr(3),Up(4,"date"),Be(),Le(5,rm,3,5,"div",4),Be(),ke(6,"icon",5),mr(7,"arrow_drop_down"),Be()(),ke(8,"mat-menu",6,0),Le(10,sm,8,7,"button",7),d8(11,dm,8,9,"button",7,nm,false,mm,2,0,"div",8),Be(),Le(14,um,2,0,"mat-error")),t&2){let o=HE(9);Ne("opacity-30",r.disabled()||r.no_options()),Dn$1("disabled",r.disabled()||r.no_options())("matMenuTriggerFor",o),he(3),Lo$1(" ",FD(4,9,r.active_time(),r.time_format())," "),he(2),Fe$1(r.timezone()&&r.tz()?5:-1),he(5),Fe$1(r.force_time()?10:-1),he(),u8(r.time_options()),he(3),Fe$1(r.no_error()?-1:14);}},dependencies:[py,si,rt,mt,ut,sM,Hce,mXe,H6],styles:["mat-form-field[_ngcontent-%COMP%]{width:100%}"]});}}return n})();function pm(n,i){n&1&&(ke(0,"button",2)(1,"icon"),mr(2,"close"),Be()());}function hm(n,i){if(n&1){let e=xD();ke(0,"div",7)(1,"div",11),mr(2),Up(3,"date"),Be(),ke(4,"mat-checkbox",12),$e("ngModelChange",function(r){let o=F_(e).$implicit,c=vt(2);return c.setWeekdayEnabled(o.getDay(),r),U_(r&&c.initialiseDay(o.getDay()))}),Be(),r5(),Be();}if(n&2){let e=i.$implicit,t=vt(2);he(2),Lo$1(" ",FD(3,2,e,"EEE")," "),he(2),Dn$1("ngModel",t.weekdays_enabled()[e.getDay()]),s5();}}function _m(n,i){if(n&1&&(ke(0,"mat-option",20),mr(1),Be()),n&2){let e=i.$implicit;Dn$1("value",e.id),he(),Lo$1(" ",e.name," ");}}function fm(n,i){if(n&1){let e=xD();ke(0,"button",23),$e("click",function(){F_(e);let r=vt().$index,o=vt(2).$implicit,c=vt(3);return U_(c.addBlock(c.settings()[o.getDay()],r))}),ke(1,"icon"),mr(2,"add"),Be()();}}function gm(n,i){if(n&1){let e=xD();ke(0,"button",24),$e("click",function(){F_(e);let r=vt().$index,o=vt(2).$implicit,c=vt(3);return U_(c.removeBlock(c.settings()[o.getDay()],r))}),ke(1,"icon"),mr(2,"delete"),Be()();}}function bm(n,i){if(n&1){let e=xD();ke(0,"div",16)(1,"a-time-field",18),$e("ngModelChange",function(r){let o=F_(e).$implicit,c=vt(2).$implicit,h=vt(3);return U_(h.setStartTime(o,c.getDay(),r))}),Be(),r5(),ke(2,"a-time-field",18),$e("ngModelChange",function(r){let o=F_(e).$implicit,c=vt(2).$implicit,h=vt(3);return U_(h.setEndTime(o,c.getDay(),r))}),Be(),r5(),ke(3,"mat-form-field",19)(4,"mat-select",12),KL("ngModelChange",function(r){let o=F_(e).$implicit;return Q8(o.location,r)||(o.location=r),U_(r)}),d8(5,_m,2,2,"mat-option",20,l8),Be(),r5(),Be(),Le(7,fm,3,0,"button",21),Le(8,gm,3,0,"button",22),Be();}if(n&2){let e=i.$implicit,t=i.$index,r=vt(2).$implicit,o=vt(3);he(),Dn$1("ngModel",o.timeFrom(e.start_time))("from",o.timeFrom((t>0?o.settings()[r.getDay()].blocks[t-1]?.end_time:0)||0))("no_error",true),s5(),he(),Dn$1("ngModel",o.timeFrom(e.end_time))("from",o.timeFrom(e.start_time+.25))("no_error",true),s5(),he(2),qL("ngModel",e.location),s5(),he(),u8(o.options()),he(2),Fe$1(t===0?7:-1),he(),Fe$1(t!==0?8:-1);}}function vm(n,i){if(n&1&&(ke(0,"div",14)(1,"div",15),d8(2,bm,9,9,"div",16,l8),Be(),ke(4,"h3",17),mr(5),Up(6,"date"),Be()()),n&2){let e=vt().$implicit,t=vt(3);he(2),u8(t.settings()[e.getDay()].blocks),he(3),Lo$1(" ",FD(6,1,e,"EEEE")," ");}}function ym(n,i){if(n&1&&Le(0,vm,7,4,"div",14),n&2){let e=i.$implicit,t=vt(3);Fe$1(t.weekdays_enabled()[e.getDay()]?0:-1);}}function xm(n,i){if(n&1&&(ke(0,"div",9),d8(1,ym,1,1,null,null,l8),ke(3,"h3",13),mr(4),Up(5,"translate"),Be()()),n&2){let e=vt(2);he(),u8(e.days),he(3),Lo$1(" ",LD(5,1,"COMMON.WORK_HOURS")," ");}}function km(n,i){n&1&&(ke(0,"div",10),Ft(1,"img",25),ke(2,"p",26),mr(3),Up(4,"translate"),Be()()),n&2&&(he(3),Lo$1(" ",LD(4,1,"COMMON.WORK_SETTINGS_EMPTY")," "));}function Cm(n,i){if(n&1&&(ke(0,"main",3)(1,"div",6),d8(2,hm,5,5,"div",7,l8),ke(4,"h3",8),mr(5),Up(6,"translate"),Be()(),Le(7,xm,6,3,"div",9)(8,km,5,3,"div",10),Be()),n&2){let e=vt();he(2),u8(e.days),he(3),Lo$1(" ",LD(6,2,"COMMON.WORK_DAYS")," "),he(2),Fe$1(e.has_working_days()?7:8);}}function Mm(n,i){n&1&&(ke(0,"div",4),Ft(1,"mat-spinner",27),ke(2,"p",26),mr(3),Up(4,"translate"),Be()()),n&2&&(he(),Dn$1("diameter",32),he(2),Lo$1(" ",LD(4,2,"COMMON.WORK_SETTINGS_SAVE")," "));}function wm(n,i){if(n&1){let e=xD();ke(0,"footer",5)(1,"button",28),$e("click",function(){F_(e);let r=vt();return U_(r.saveChanges())}),mr(2),Up(3,"translate"),Be()();}n&2&&(he(2),Lo$1(" ",LD(3,1,"COMMON.SAVE")," "));}var Dr=(()=>{class n{constructor(){this._data=m(hae),this._dialog_ref=m(iT),this.options=w([]),this.option=w(""),this.settings=w([]),this.weekdays_enabled=w({}),this.changed=w(false),this.loading=w(false),this.available_weekdays=w([]),this.days=new Array(7).fill(0).map((e,t)=>Fn$1(Fs$1(Fn$1(Date.now(),30)),t)),this.has_working_days=me(()=>{let e=this.weekdays_enabled();return Object.keys(e).some(t=>e[t])}),this.option_name=me(()=>this.options().find(e=>e.id===this.option())?.name||""),this.now=me(()=>bl$1(Date.now()).getTime());}ngOnInit(){let e=so$1(),r=[...((this._data?.local?this._data.preferences:e.work_preferences)||[]).map(h=>m$1(l({},h),{blocks:[...h?.blocks||[]]}))],o={};for(let h of r)h.blocks.length&&(o[h.day_of_week]=true);this.settings.set(r),this.weekdays_enabled.set(o);let c=[{id:"wfo",name:vi$1("COMMON.WORK_OFFICE"),icon:"business"},{id:"wfh",name:vi$1("COMMON.WORK_HOME"),icon:"home"},{id:"aol",name:vi$1("COMMON.WORK_LEAVE"),icon:"event_busy"}];this.options.set(c),this.option.set(c[0].id);}timeFrom(e){return bl$1(Dr$1(Fn$1(new Date,1),{hours:Math.floor(e),minutes:e*60%60})).getTime()}fromTime(e){let t=new Date(e);return t.getHours()+t.getMinutes()/60}initialiseDay(e){let t=this.settings();t[e]||(t[e]={day_of_week:e,blocks:[]}),t[e].blocks||(t[e].blocks=[]),t[e].blocks.length===0&&this.addBlock(t[e],0),this.settings.set([...t]);}addBlock(e,t){e.blocks.splice(t+1,0,{start_time:9,end_time:17,location:"wfo"}),this.cleanupBlocks(e),this.settings.update(r=>[...r]);}removeBlock(e,t){e.blocks.length<=1||(e.blocks.splice(t,1),this.settings.update(r=>[...r]));}setEndTime(e,t,r){setTimeout(()=>{e.end_time=this.fromTime(r),this.cleanupBlocks(this.settings()[t]),this.settings.update(o=>[...o]);},50);}setStartTime(e,t,r){setTimeout(()=>{e.start_time=this.fromTime(r),this.cleanupBlocks(this.settings()[t]),this.settings.update(o=>[...o]);},50);}cleanupBlocks(e){if(e?.blocks?.length)for(let t=0;t<e.blocks.length;t++){let r=e.blocks[t];t>0&&r.start_time<e.blocks[t-1].end_time&&(r.start_time=e.blocks[t-1].end_time),r.end_time<=r.start_time&&(r.end_time=r.start_time+1);}}async saveChanges(e=true){this.loading.set(true),this._dialog_ref.disableClose=true;let t=new Array(7).fill(0).map((r,o)=>({day_of_week:o,blocks:[]}));for(let r of this.days){let o=r.getDay();this.weekdays_enabled()[o]&&(t[o]={day_of_week:o,blocks:this.settings()[o].blocks});}if(!this._data?.local){let r=await iw("current");await CV(r.id,m$1(l({},r),{groups:r.groups.filter(o=>!o.startsWith("placeos_")),work_preferences:t})).catch(o=>{throw this.loading.set(false),this._dialog_ref.disableClose=false,eH("Unable to save user work preferences."),o});}this.loading.set(false),this._dialog_ref.disableClose=false,e&&(this._data?.local||SH(),this._dialog_ref.close(t));}setWeekdayEnabled(e,t){this.weekdays_enabled.update(r=>m$1(l({},r),{[e]:t}));}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["wfh-settings-modal"]],decls:8,vars:6,consts:[[1,"bg-base-200","sticky","top-0","z-10","m-2","w-[calc(100%-1rem)]","rounded-sm","border-none","p-2"],[1,"px-2","text-xl","font-medium"],["icon","","matRipple","","mat-dialog-close","",1,"bg-base-200"],[1,"relative","flex","max-h-[calc(100vh-9rem)]","w-160","max-w-full","flex-col","space-y-2","overflow-x-hidden","overflow-y-auto","rounded-sm","px-2","py-4","sm:max-h-[65vh]","sm:p-4"],["loading","",1,"bg-base-100","relative","flex","h-72","w-[24rem]","flex-col","items-center","justify-center","space-y-2","overflow-hidden","rounded-sm","text-center"],[1,"border-base-200","flex","justify-end","border-t","px-4","py-2"],[1,"border-base-300","relative","mb-4","flex","w-full","items-center","justify-between","space-x-2","rounded-sm","border","p-2"],[1,"flex","flex-1","flex-col","items-center","pt-2"],[1,"bg-base-100","absolute","top-0","left-2","-translate-y-1/2","px-2"],[1,"border-base-300","relative","flex","w-full","flex-col","items-center","justify-between","space-y-4","rounded-sm","border","px-2","pt-6","pb-4","sm:px-4"],[1,"flex","flex-col","items-center","justify-center","space-y-4","px-8","py-16"],[1,"text-xs","font-bold","uppercase"],[3,"ngModelChange","ngModel"],[1,"bg-base-100","absolute","top-0","left-2","m-0!","-translate-y-1/2","px-2"],[1,"border-base-200","relative","flex","w-full","items-center","justify-between","space-x-2","rounded-sm","border","p-2"],[1,"w-1/2","flex-1","space-y-2","pt-2"],[1,"flex","items-center","space-x-2"],[1,"border-base-200","bg-base-100","bg-opacity-50","absolute","top-0","left-2","-translate-y-1/2","rounded-sm","border","px-2","text-sm","font-medium"],[1,"w-1/4","flex-1",3,"ngModelChange","ngModel","from","no_error"],["appearance","outline",1,"no-subscript","w-1/4","flex-1"],[3,"value"],["icon","","matRipple","",1,"border-base-400","h-12","w-12","rounded-sm","border"],["icon","","matRipple","",1,"border-error","text-error","h-12","w-12","rounded-sm","border"],["icon","","matRipple","",1,"border-base-400","h-12","w-12","rounded-sm","border",3,"click"],["icon","","matRipple","",1,"border-error","text-error","h-12","w-12","rounded-sm","border",3,"click"],["src","assets/icons/no-results.svg",1,"m-auto"],[1,"opacity-30"],[3,"diameter"],["btn","","matRipple","",1,"w-48",3,"click"]],template:function(t,r){t&1&&(ke(0,"header",0)(1,"h2",1),mr(2),Up(3,"translate"),Be(),Le(4,pm,3,0,"button",2),Be(),Le(5,Cm,9,4,"main",3)(6,Mm,5,4,"div",4),Le(7,wm,4,3,"footer",5)),t&2&&(he(2),Lo$1(" ",LD(3,4,"COMMON.WORK_LOCATION_SETTINGS")," "),he(2),Fe$1(r.loading()?-1:4),he(),Fe$1(r.loading()?6:5),he(2),Fe$1(r.loading()?-1:7));},dependencies:[py,h7e,p7e,xl$1,s0,sM,P3,ci,li,g3,wl,pr,Ai,oOe,J0e,qQ,mXe,St,oi,H6,eet],encapsulation:2});}}return n})();var Tm=["knob"],Em=["valueIndicatorContainer"];function Sm(n,i){if(n&1&&(ke(0,"div",2,1)(2,"div",5)(3,"span",6),mr(4),Be()()()),n&2){let e=vt();he(4),Kd$1(e.valueIndicatorText);}}var Im=["trackActive"],Rm=["*"];function Om(n,i){if(n&1&&Ft(0,"div"),n&2){let e=i.$implicit,t=i.$index,r=vt(3);ws(e===0?"mdc-slider__tick-mark--active":"mdc-slider__tick-mark--inactive"),PD("transform",r._calcTickMarkTransform(t));}}function Dm(n,i){if(n&1&&d8(0,Om,1,4,"div",8,c8),n&2){let e=vt(2);u8(e._tickMarks);}}function Nm(n,i){if(n&1&&(ke(0,"div",6,1),Le(2,Dm,2,0),Be()),n&2){let e=vt();he(2),Fe$1(e._cachedWidth?2:-1);}}function Am(n,i){if(n&1&&Ft(0,"mat-slider-visual-thumb",7),n&2){let e=vt();Dn$1("discrete",e.discrete)("thumbPosition",1)("valueIndicatorText",e.startValueIndicatorText);}}var A=(function(n){return n[n.START=1]="START",n[n.END=2]="END",n})(A||{}),yi=(function(n){return n[n.ACTIVE=0]="ACTIVE",n[n.INACTIVE=1]="INACTIVE",n})(yi||{}),zo=new v("_MatSlider"),Tl=new v("_MatSliderThumb"),Pm=new v("_MatSliderRangeThumb"),El=new v("_MatSliderVisualThumb");var Fm=(()=>{class n{_cdr=m(Tt);_ngZone=m(B);_slider=m(zo);_renderer=m(We);_listenerCleanups;discrete=false;thumbPosition;valueIndicatorText;_ripple;_knob;_valueIndicatorContainer;_sliderInput;_sliderInputEl;_hoverRippleRef;_focusRippleRef;_activeRippleRef;_isHovered=false;_isActive=false;_isValueIndicatorVisible=false;_hostElement=m(G).nativeElement;_platform=m(je);ngAfterViewInit(){let e=this._slider._getInput(this.thumbPosition);e&&(this._ripple.radius=24,this._sliderInput=e,this._sliderInputEl=this._sliderInput._hostElement,this._ngZone.runOutsideAngular(()=>{let t=this._sliderInputEl,r=this._renderer;this._listenerCleanups=[r.listen(t,"pointermove",this._onPointerMove),r.listen(t,"pointerdown",this._onDragStart),r.listen(t,"pointerup",this._onDragEnd),r.listen(t,"pointerleave",this._onMouseLeave),r.listen(t,"focus",this._onFocus),r.listen(t,"blur",this._onBlur)];}));}ngOnDestroy(){this._listenerCleanups?.forEach(e=>e());}_onPointerMove=e=>{if(this._sliderInput._isFocused)return;let t=this._hostElement.getBoundingClientRect(),r=this._slider._isCursorOnSliderThumb(e,t);this._isHovered=r,r?this._showHoverRipple():this._hideRipple(this._hoverRippleRef);};_onMouseLeave=()=>{this._isHovered=false,this._hideRipple(this._hoverRippleRef);};_onFocus=()=>{this._hideRipple(this._hoverRippleRef),this._showFocusRipple(),this._hostElement.classList.add("mdc-slider__thumb--focused");};_onBlur=()=>{this._isActive||this._hideRipple(this._focusRippleRef),this._isHovered&&this._showHoverRipple(),this._hostElement.classList.remove("mdc-slider__thumb--focused");};_onDragStart=e=>{e.button===0&&(this._isActive=true,this._showActiveRipple());};_onDragEnd=()=>{this._isActive=false,this._hideRipple(this._activeRippleRef),this._sliderInput._isFocused||this._hideRipple(this._focusRippleRef),this._platform.SAFARI&&this._showHoverRipple();};_showHoverRipple(){this._isShowingRipple(this._hoverRippleRef)||(this._hoverRippleRef=this._showRipple({enterDuration:0,exitDuration:0}),this._hoverRippleRef?.element.classList.add("mat-mdc-slider-hover-ripple"));}_showFocusRipple(){this._isShowingRipple(this._focusRippleRef)||(this._focusRippleRef=this._showRipple({enterDuration:0,exitDuration:0},true),this._focusRippleRef?.element.classList.add("mat-mdc-slider-focus-ripple"));}_showActiveRipple(){this._isShowingRipple(this._activeRippleRef)||(this._activeRippleRef=this._showRipple({enterDuration:225,exitDuration:400}),this._activeRippleRef?.element.classList.add("mat-mdc-slider-active-ripple"));}_isShowingRipple(e){return e?.state===Xi.FADING_IN||e?.state===Xi.VISIBLE}_showRipple(e,t){if(!this._slider.disabled&&(this._showValueIndicator(),this._slider._isRange&&this._slider._getThumb(this.thumbPosition===A.START?A.END:A.START)._showValueIndicator(),!(this._slider._globalRippleOptions?.disabled&&!t)))return this._ripple.launch({animation:this._slider._noopAnimations?{enterDuration:0,exitDuration:0}:e,centered:true,persistent:true})}_hideRipple(e){if(e?.fadeOut(),this._isShowingAnyRipple())return;this._slider._isRange||this._hideValueIndicator();let t=this._getSibling();t._isShowingAnyRipple()||(this._hideValueIndicator(),t._hideValueIndicator());}_showValueIndicator(){this._hostElement.classList.add("mdc-slider__thumb--with-indicator");}_hideValueIndicator(){this._hostElement.classList.remove("mdc-slider__thumb--with-indicator");}_getSibling(){return this._slider._getThumb(this.thumbPosition===A.START?A.END:A.START)}_getValueIndicatorContainer(){return this._valueIndicatorContainer?.nativeElement}_getKnob(){return this._knob.nativeElement}_isShowingAnyRipple(){return this._isShowingRipple(this._hoverRippleRef)||this._isShowingRipple(this._focusRippleRef)||this._isShowingRipple(this._activeRippleRef)}static \u0275fac=function(t){return new(t||n)};static \u0275cmp=ve({type:n,selectors:[["mat-slider-visual-thumb"]],viewQuery:function(t,r){if(t&1&&Pn$1(s0,5)(Tm,5)(Em,5),t&2){let o;Ae(o=De())&&(r._ripple=o.first),Ae(o=De())&&(r._knob=o.first),Ae(o=De())&&(r._valueIndicatorContainer=o.first);}},hostAttrs:[1,"mdc-slider__thumb","mat-mdc-slider-visual-thumb"],inputs:{discrete:"discrete",thumbPosition:"thumbPosition",valueIndicatorText:"valueIndicatorText"},features:[ot$1([{provide:El,useExisting:n}])],decls:4,vars:2,consts:[["knob",""],["valueIndicatorContainer",""],[1,"mdc-slider__value-indicator-container"],[1,"mdc-slider__thumb-knob"],["matRipple","",1,"mat-focus-indicator",3,"matRippleDisabled"],[1,"mdc-slider__value-indicator"],[1,"mdc-slider__value-indicator-text"]],template:function(t,r){t&1&&(Le(0,Sm,5,1,"div",2),Ft(1,"div",3,0)(3,"div",4)),t&2&&(Fe$1(r.discrete?0:-1),he(3),Dn$1("matRippleDisabled",true));},dependencies:[s0],styles:[`.mat-mdc-slider-visual-thumb .mat-ripple {
  height: 100%;
  width: 100%;
}
...
`],encapsulation:2})}return n})();var Vm={provide:ka,useExisting:nn(()=>zi),multi:true};var zi=(()=>{class n{_ngZone=m(B);_elementRef=m(G);_cdr=m(Tt);_slider=m(zo);_platform=m(je);_listenerCleanups;get value(){return Qd$1(this._hostElement.value,0)}set value(e){e===null&&(e=this._getDefaultValue()),e=isNaN(e)?0:e;let t=e+"";if(!this._hasSetInitialValue){this._initialValue=t;return}this._isActive||this._setValue(t);}_setValue(e){this._hostElement.value=e,this._updateThumbUIByValue(),this._slider._onValueChange(this),this._cdr.detectChanges(),this._slider._cdr.markForCheck();}valueChange=new ne;dragStart=new ne;dragEnd=new ne;get translateX(){return this._slider.min>=this._slider.max?(this._translateX=this._tickMarkOffset,this._translateX):(this._translateX===void 0&&(this._translateX=this._calcTranslateXByValue()),this._translateX)}set translateX(e){this._translateX=e;}_translateX;thumbPosition=A.END;get min(){return Qd$1(this._hostElement.min,0)}set min(e){this._hostElement.min=e+"",this._cdr.detectChanges();}get max(){return Qd$1(this._hostElement.max,0)}set max(e){this._hostElement.max=e+"",this._cdr.detectChanges();}get step(){return Qd$1(this._hostElement.step,0)}set step(e){this._hostElement.step=e+"",this._cdr.detectChanges();}get disabled(){return be(this._hostElement.disabled)}set disabled(e){this._hostElement.disabled=e,this._cdr.detectChanges(),this._slider.disabled!==this.disabled&&(this._slider.disabled=this.disabled);}get percentage(){return this._slider.min>=this._slider.max?this._slider._isRtl()?1:0:(this.value-this._slider.min)/(this._slider.max-this._slider.min)}get fillPercentage(){return this._slider._cachedWidth?this._translateX===0?0:this.translateX/this._slider._cachedWidth:this._slider._isRtl()?1:0}_hostElement=this._elementRef.nativeElement;_valuetext=w("");_knobRadius=8;_tickMarkOffset=3;_isActive=false;_isFocused=false;_setIsFocused(e){this._isFocused=e;}_hasSetInitialValue=false;_initialValue;_formControl;_destroyed=new R;_skipUIUpdate=false;_onChangeFn;_onTouchedFn=()=>{};_isControlInitialized=false;constructor(){let e=m(We);this._ngZone.runOutsideAngular(()=>{this._listenerCleanups=[e.listen(this._hostElement,"pointerdown",this._onPointerDown.bind(this)),e.listen(this._hostElement,"pointermove",this._onPointerMove.bind(this)),e.listen(this._hostElement,"pointerup",this._onPointerUp.bind(this))];});}ngOnDestroy(){this._listenerCleanups.forEach(e=>e()),this._destroyed.next(),this._destroyed.complete(),this.dragStart.complete(),this.dragEnd.complete();}initProps(){this._updateWidthInactive(),this.disabled!==this._slider.disabled&&(this._slider.disabled=true),this.step=this._slider.step,this.min=this._slider.min,this.max=this._slider.max,this._initValue();}initUI(){this._updateThumbUIByValue();}_initValue(){this._hasSetInitialValue=true,this._initialValue===void 0?this.value=this._getDefaultValue():(this._hostElement.value=this._initialValue,this._updateThumbUIByValue(),this._slider._onValueChange(this),this._cdr.detectChanges());}_getDefaultValue(){return this.min}_onBlur(){this._setIsFocused(false),this._onTouchedFn();}_onFocus(){this._slider._setTransition(false),this._slider._updateTrackUI(this),this._setIsFocused(true);}_onChange(){this.valueChange.emit(this.value),this._isActive&&this._updateThumbUIByValue({withAnimation:true});}_onInput(){this._onChangeFn?.(this.value),(this._slider.step||!this._isActive)&&this._updateThumbUIByValue({withAnimation:true}),this._slider._onValueChange(this);}_onNgControlValueChange(){(!this._isActive||!this._isFocused)&&(this._slider._onValueChange(this),this._updateThumbUIByValue()),this._slider.disabled=this._formControl.disabled;}_onPointerDown(e){if(!(this.disabled||e.button!==0)){if(this._platform.IOS){let t=this._slider._isCursorOnSliderThumb(e,this._slider._getThumb(this.thumbPosition)._hostElement.getBoundingClientRect());this._isActive=t,this._updateWidthActive(),this._slider._updateDimensions();return}this._isActive=true,this._setIsFocused(true),this._updateWidthActive(),this._slider._updateDimensions(),this._slider.step||this._updateThumbUIByPointerEvent(e,{withAnimation:true}),this.disabled||(this._handleValueCorrection(e),this.dragStart.emit({source:this,parent:this._slider,value:this.value}));}}_handleValueCorrection(e){this._skipUIUpdate=true,setTimeout(()=>{this._skipUIUpdate=false,this._fixValue(e);},0);}_fixValue(e){let t=e.clientX-this._slider._cachedLeft,r=this._slider._cachedWidth,o=this._slider.step===0?1:this._slider.step,c=Math.floor((this._slider.max-this._slider.min)/o),h=this._slider._isRtl()?1-t/r:t/r,R=Math.round(h*c)/c*(this._slider.max-this._slider.min)+this._slider.min,F=Math.round(R/o)*o,ae=this.value;if(F===ae){this._slider._onValueChange(this),this._slider.step>0?this._updateThumbUIByValue():this._updateThumbUIByPointerEvent(e,{withAnimation:this._slider._hasAnimation});return}this.value=F,this.valueChange.emit(this.value),this._onChangeFn?.(this.value),this._slider._onValueChange(this),this._slider.step>0?this._updateThumbUIByValue():this._updateThumbUIByPointerEvent(e,{withAnimation:this._slider._hasAnimation});}_onPointerMove(e){!this._slider.step&&this._isActive&&this._updateThumbUIByPointerEvent(e);}_onPointerUp(){this._isActive&&(this._isActive=false,this._platform.SAFARI&&this._setIsFocused(false),this.dragEnd.emit({source:this,parent:this._slider,value:this.value}),setTimeout(()=>this._updateWidthInactive(),this._platform.IOS?10:0));}_clamp(e){let t=this._tickMarkOffset,r=this._slider._cachedWidth-this._tickMarkOffset;return Math.max(Math.min(e,r),t)}_calcTranslateXByValue(){return this._slider._isRtl()?(1-this.percentage)*(this._slider._cachedWidth-this._tickMarkOffset*2)+this._tickMarkOffset:this.percentage*(this._slider._cachedWidth-this._tickMarkOffset*2)+this._tickMarkOffset}_calcTranslateXByPointerEvent(e){return e.clientX-this._slider._cachedLeft}_updateWidthActive(){}_updateWidthInactive(){this._hostElement.style.padding=`0 ${this._slider._inputPadding}px`,this._hostElement.style.width=`calc(100% + ${this._slider._inputPadding-this._tickMarkOffset*2}px)`,this._hostElement.style.left=`-${this._slider._rippleRadius-this._tickMarkOffset}px`;}_updateThumbUIByValue(e){this.translateX=this._clamp(this._calcTranslateXByValue()),this._updateThumbUI(e);}_updateThumbUIByPointerEvent(e,t){this.translateX=this._clamp(this._calcTranslateXByPointerEvent(e)),this._updateThumbUI(t);}_updateThumbUI(e){this._slider._setTransition(!!e?.withAnimation),this._slider._onTranslateXChange(this);}writeValue(e){(this._isControlInitialized||e!==null)&&(this.value=e);}registerOnChange(e){this._onChangeFn=e,this._isControlInitialized=true;}registerOnTouched(e){this._onTouchedFn=e;}setDisabledState(e){this.disabled=e;}focus(){this._hostElement.focus();}blur(){this._hostElement.blur();}static \u0275fac=function(t){return new(t||n)};static \u0275dir=O({type:n,selectors:[["input","matSliderThumb",""]],hostAttrs:["type","range",1,"mdc-slider__input"],hostVars:1,hostBindings:function(t,r){t&1&&$e("change",function(){return r._onChange()})("input",function(){return r._onInput()})("blur",function(){return r._onBlur()})("focus",function(){return r._onFocus()}),t&2&&Ge("aria-valuetext",r._valuetext());},inputs:{value:[2,"value","value",Qd$1]},outputs:{valueChange:"valueChange",dragStart:"dragStart",dragEnd:"dragEnd"},exportAs:["matSliderThumb"],features:[ot$1([Vm,{provide:Tl,useExisting:n}])]})}return n})();var Ar=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=ce({type:n});static \u0275inj=oe({imports:[xl$1,It$1]})}return n})();function Lm(n,i){if(n&1){let e=xD();ke(0,"settings-toggle",6),$e("ngModelChange",function(r){F_(e);let o=vt();return U_(o.setDarkMode(r))}),ke(1,"div",7)(2,"icon",8),mr(3,"mode_night"),Be(),ke(4,"div"),mr(5),Up(6,"translate"),Be()()(),r5();}if(n&2){let e=vt();Dn$1("ngModel",e.dark_mode())("toggle",true),s5(),he(5),Kd$1(LD(6,3,"COMMON.DARK_MODE"));}}function Bm(n,i){if(n&1){let e=xD();ke(0,"settings-toggle",6),$e("ngModelChange",function(r){F_(e);let o=vt();return U_(o.setLocatable(r))}),ke(1,"div",7)(2,"icon",8),mr(3,"emergency_share"),Be(),ke(4,"div"),mr(5),Up(6,"translate"),Be()()(),r5();}if(n&2){let e=vt();Dn$1("ngModel",e.locatable())("toggle",true),s5(),he(5),Kd$1(LD(6,3,"COMMON.LOCATABLE"));}}function Um(n,i){if(n&1){let e=xD();ke(0,"div",9),mr(1),Up(2,"translate"),Be(),ke(3,"div",10)(4,"span",11),mr(5,"A"),Be(),ke(6,"mat-slider",12)(7,"input",13),$e("ngModelChange",function(r){F_(e);let o=vt();return U_(o.applySetting("font_size",r))}),Be(),r5(),Be(),ke(8,"span",2),mr(9,"A"),Be(),ke(10,"span",14),mr(11),Be()();}if(n&2){let e=vt();he(),Lo$1(" ",LD(2,6,"COMMON.TEXT_SIZE_MSG")," "),he(5),Dn$1("min",10)("max",24)("step",2),he(),Dn$1("ngModel",e.font_size()),s5(),he(4),Lo$1(" ",e.font_size(),"px ");}}var Il=(()=>{class n extends no$1{constructor(){super(...arguments),this._data=m(gle),this._settings=m(Ws$1),this.accessible=w(false),this.locatable=w(false),this.can_locate=fee("allow_locatability_option",true),this._allow_dark_mode=this._settings.signal("allow_dark_mode",false),this._font_size=this._settings.signal("font_size",16,true),this._accessible=this._settings.signal("accessible",false,true),this._theme=this._settings.theme_signal,this.dark_mode=me(()=>this._theme()==="dark"),this.can_change_dark_mode=me(()=>!!this._allow_dark_mode()),this.font_size=this._font_size,this.applySetting=(e,t)=>this.timeout("apply_setting",()=>{this._settings.saveUserSetting(e,t),e==="accessible"&&this.accessible.set(t);},500),this.close=()=>this._data?.close(),this.setLocatable=e=>{this._settings.updateLocatable(e),this.locatable.set(e);};}async ngOnInit(){this.accessible.set(!!this._accessible()),this.subscription("user",xke.subscribe(e=>{this.locatable.set(e.locatable);}));}setDarkMode(e){let t=this._theme();e&&t!=="dark"?this._settings.setTheme("dark"):!e&&t==="dark"&&this._settings.setTheme("light");}static{this.\u0275fac=(()=>{let e;return function(r){return (e||(e=yt(n)))(r||n)}})();}static{this.\u0275cmp=ve({type:n,selectors:[["accessibility-tooltip"]],features:[Re],decls:18,vars:11,consts:[[1,"bg-base-100","relative","-top-12","-right-1","flex","max-h-[65vh]","w-[20rem]","flex-col","overflow-auto","rounded-sm","pb-3","shadow-sm"],["matRipple","",1,"border-base-300","flex","items-center","space-x-2","border-b","px-2","py-3",3,"click"],[1,"text-2xl"],[1,""],[1,"space-y-2","p-2"],[3,"ngModel","toggle"],[3,"ngModelChange","ngModel","toggle"],[1,"flex","items-center","space-x-2"],[1,"-ml-2","text-xl"],[1,"bg-base-200","px-8","py-4","text-center"],[1,"flex","items-center","space-x-4","px-4"],[1,"text-sm"],[1,"w-1/2","flex-1","text-[16px]",3,"min","max","step"],["matSliderThumb","",1,"text-[16px]",3,"ngModelChange","ngModel"],[1,"bg-base-300","my-2","rounded-sm","px-2","py-1","text-base","text-white"]],template:function(t,r){t&1&&(ke(0,"div",0)(1,"div",1),$e("click",function(){return r.close()}),ke(2,"icon",2),mr(3,"arrow_back"),Be(),ke(4,"div",3),mr(5),Up(6,"translate"),Be()(),ke(7,"div",4),Le(8,Lm,7,5,"settings-toggle",5),Le(9,Bm,7,5,"settings-toggle",5),ke(10,"settings-toggle",6),$e("ngModelChange",function(c){return r.applySetting("accessible",c)}),ke(11,"div",7)(12,"icon",8),mr(13,"playlist_add"),Be(),ke(14,"div"),mr(15),Up(16,"translate"),Be()()(),r5(),Be(),Le(17,Um,12,8),Be()),t&2&&(he(5),Lo$1(" ",LD(6,7,"COMMON.CONTROLS_ACCESSIBILITY")," "),he(3),Fe$1(r.can_change_dark_mode()?8:-1),he(),Fe$1(r.can_locate()?9:-1),he(),Dn$1("ngModel",r.accessible())("toggle",true),s5(),he(5),Kd$1(LD(16,9,"COMMON.TEXT_SIZE")),he(2),Fe$1(r.accessible()?17:-1));},dependencies:[xl$1,s0,Ar,Nr,zi,Fs,mXe,oOe,mB,J0e,qQ,eet],encapsulation:2});}}return n})();function zm(n,i){if(n&1){let e=xD();ke(0,"mat-radio-button",8),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.setBuilding(r))}),mr(1),Be();}if(n&2){let e=i.$implicit;Dn$1("value",e.id),he(),Lo$1(" ",e.display_name||e.name," ");}}var Rl=(()=>{class n{constructor(){this._data=m(gle),this._org=m(eT),this.buildings=this._org.active_buildings,this.building=this._org.active_building,this.setBuilding=e=>{this._org.setBuilding(e,true),this._data?.close();},this.close=()=>this._data?.close();}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["building-select"]],decls:16,vars:8,consts:[[1,"bg-base-100","relative","-top-12","-right-1","flex","max-h-[65vh]","w-74","flex-col","overflow-auto","rounded-sm","pb-3","shadow-sm",3,"click"],["matRipple","",1,"border-base-300","flex","items-center","space-x-2","border-b","px-2","py-3"],[1,"text-2xl"],[1,"leading-tight"],[1,"text-xs","opacity-30"],[1,"px-4","py-2","text-xs","opacity-60"],[1,"flex","flex-col","space-y-2","px-2",3,"ngModel"],[3,"value"],[3,"click","value"]],template:function(t,r){t&1&&(ke(0,"div",0),$e("click",function(){return r.close()}),ke(1,"div",1)(2,"icon",2),mr(3,"arrow_back"),Be(),ke(4,"div",3)(5,"div"),mr(6),Be(),ke(7,"div",4),mr(8),Up(9,"translate"),Be()()(),ke(10,"div",5),mr(11),Up(12,"translate"),Be(),ke(13,"mat-radio-group",6),d8(14,zm,2,2,"mat-radio-button",7,l8),Be(),r5(),Be()),t&2&&(he(6),Lo$1(" ",r.building()?.display_name||r.building()?.name," "),he(2),Lo$1(" ",LD(9,4,"RESOURCE.BUILDING")," "),he(3),Lo$1(" ",LD(12,6,"COMMON.BUILDING_SELECT")," "),he(2),Dn$1("ngModel",r.building()?.id),s5(),he(),u8(r.buildings()));},dependencies:[Rr,Bi,vi,mXe,xl$1,s0,oOe,J0e,qQ,eet],encapsulation:2});}}return n})();function Gm(n,i){n&1&&(ke(0,"div",3),mr(1),Up(2,"translate"),Be()),n&2&&(he(),Lo$1(" ",LD(2,1,"COMMON.DESK_HEIGHT_NOT_SET")," "));}function Hm(n,i){if(n&1){let e=xD();ke(0,"button",13),$e("click",function(){F_(e);let r=vt();return U_(r.onClose())}),mr(1),Up(2,"translate"),Be();}n&2&&(he(),Lo$1(" ",LD(2,1,"COMMON.SAVE")," "));}var Ol=(()=>{class n{constructor(){this._settings=m(Ws$1),this.show_close=UIe(false),this.close=FIe(),this.not_set=w(false),this.desk_sitting_height=w(71),this.desk_standing_height=w(101);}ngOnInit(){this.not_set.set(!this._settings.get("desk_sitting_height")&&!this._settings.get("desk_standing_height")),this.desk_sitting_height.set(this._settings.get("desk_sitting_height")||71),this.desk_standing_height.set(this._settings.get("desk_standing_height")||101);}onClose(){this.saveSetting("desk_sitting_height",this.desk_sitting_height()),this.saveSetting("desk_standing_height",this.desk_standing_height()),this.close.emit();}formatLabel(e){return `${e.toFixed(1)}cm`}saveSetting(e,t){this._settings.saveUserSetting(e,t);}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["desk-height-presets"]],inputs:{show_close:[1,"show_close"]},outputs:{show_close:"show_closeChange",close:"close"},decls:29,vars:23,consts:[[1,"bg-base-100","relative","w-[20rem]","rounded-sm","p-4","shadow-sm"],[1,"mb-2","text-lg"],[1,"mb-4","text-xs","opacity-60"],[1,"bg-warning","text-warning-content","-mx-2","mb-4","rounded-sm","p-2","text-xs"],[1,"mt-2","flex","flex-col"],[1,"flex","items-center","space-x-2"],["min","60","max","80","step","0.5","discrete","",1,"flex-1",3,"displayWith"],["matSliderThumb","",3,"ngModelChange","ngModel"],[1,"w-12","text-right","text-sm"],[1,"mr-2","flex","items-center","space-x-2"],["min","90","max","120","step","0.5","discrete","",1,"flex-1",3,"displayWith"],[1,"mr-2","w-12","text-right","text-sm"],["btn","","matRipple","",1,"mt-2","w-full"],["btn","","matRipple","",1,"mt-2","w-full",3,"click"]],template:function(t,r){t&1&&(ke(0,"div",0)(1,"div",1),mr(2),Up(3,"translate"),Be(),ke(4,"div",2),mr(5),Up(6,"translate"),Be(),Le(7,Gm,3,3,"div",3),ke(8,"div",2),mr(9),Up(10,"translate"),Be(),ke(11,"div",4)(12,"label"),mr(13),Up(14,"translate"),Be(),ke(15,"div",5)(16,"mat-slider",6)(17,"input",7),$e("ngModelChange",function(c){return r.desk_sitting_height.set(c),r.saveSetting("desk_sitting_height",c)}),Be(),r5(),Be(),ke(18,"div",8),mr(19),Be()(),ke(20,"label"),mr(21),Up(22,"translate"),Be(),ke(23,"div",9)(24,"mat-slider",10)(25,"input",7),$e("ngModelChange",function(c){return r.desk_standing_height.set(c),r.saveSetting("desk_standing_height",c)}),Be(),r5(),Be(),ke(26,"div",11),mr(27),Be()()(),Le(28,Hm,3,3,"button",12),Be()),t&2&&(he(2),Lo$1(" ",LD(3,13,"COMMON.DESK_HEIGHT_TITLE")," "),he(3),Lo$1(" ",LD(6,15,"COMMON.DESK_HEIGHT_MSG")," "),he(2),Fe$1(r.not_set()&&r.show_close()?7:-1),he(2),Lo$1(" ",LD(10,17,"COMMON.DESK_HEIGHT_INFO")," "),he(4),Kd$1(LD(14,19,"COMMON.DESK_HEIGHT_SITTING")),he(3),Dn$1("displayWith",r.formatLabel),he(),Dn$1("ngModel",r.desk_sitting_height()),s5(),he(2),Lo$1(" ",r.desk_sitting_height().toFixed(1),"cm "),he(2),Lo$1("",LD(22,21,"COMMON.DESK_HEIGHT_STANDING"),"t"),he(3),Dn$1("displayWith",r.formatLabel),he(),Dn$1("ngModel",r.desk_standing_height()),s5(),he(2),Lo$1(" ",r.desk_standing_height().toFixed(1),"cm "),he(),Fe$1(r.show_close()?28:-1));},dependencies:[xl$1,s0,Ar,Nr,zi,oOe,mB,J0e,qQ,eet],encapsulation:2});}}return n})();function Wm(n,i){if(n&1&&(ke(0,"a",4)(1,"div",5),Ft(2,"icon",6),ke(3,"div"),mr(4),Be()()()),n&2){let e=i.$implicit;Dn$1("href",e.link,IE),he(2),Dn$1("icon",e.icon),he(2),Kd$1(e.name);}}var Dl=(()=>{class n{constructor(){this._data=m(gle),this._settings=m(Ws$1),this._tiles=this._settings.signal("help",[]),this.close=()=>{this._data?.close();};}get tiles(){return this._tiles()}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["help-tooltip"]],decls:9,vars:3,consts:[[1,"bg-base-100","relative","-top-12","-right-1","flex","w-74","flex-col","rounded-sm","shadow-sm",3,"click"],["matRipple","",1,"border-base-300","flex","items-center","space-x-2","border-b","px-2","py-4"],[1,"text-2xl"],[1,""],["matRipple","","target","_blank","ref","noreferer noopener",1,"w-full","p-2","text-left",3,"href"],[1,"hover:bg-base-200","flex","w-full","items-center","space-x-2","rounded-sm","p-2"],[1,"text-xl",3,"icon"]],template:function(t,r){t&1&&(ke(0,"div",0),$e("click",function(){return r.close()}),ke(1,"div",1)(2,"icon",2),mr(3,"arrow_back"),Be(),ke(4,"div",3),mr(5),Up(6,"translate"),Be()(),d8(7,Wm,5,3,"a",4,l8),Be()),t&2&&(he(5),Kd$1(LD(6,1,"COMMON.CONTROLS_HELP")),he(2),u8(r.tiles));},dependencies:[xl$1,s0,mXe,eet],encapsulation:2});}}return n})();var jm=(n,i)=>i.id;function Km(n,i){if(n&1&&(ke(0,"div",8),mr(1),Be()),n&2){let e=vt().$implicit;he(),Lo$1(" ",e.local," ");}}function qm(n,i){if(n&1){let e=xD();ke(0,"button",6),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.setLocale(r.id))}),ke(1,"div",7),Up(2,"translate"),ke(3,"div"),mr(4),Up(5,"translate"),Be(),Le(6,Km,2,1,"div",8),Up(7,"translate"),Be()();}if(n&2){let e=i.$implicit,t=vt();he(),Ne("mt-2",LD(2,8,e.name)!==e.local)("border",t.active_locale===e.id)("border-info",t.active_locale===e.id),he(3),Kd$1(LD(5,10,e.name)),he(2),Fe$1(LD(7,12,e.name)!==e.local?6:-1);}}var Nl=(()=>{class n{constructor(){this._data=m(gle),this._settings=m(Ws$1),this._locale=m(lb),this._locales=this._settings.signal("locales",[]),this.setLocale=e=>{this._locale.setLocale(e),localStorage.setItem("PLACEOS.locale",e),setTimeout(()=>location.reload(),300);},this.close=()=>this._data?.close();}get active_locale(){return this._locale.locale}get locales(){return this._locales()}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["language-select"]],decls:12,vars:6,consts:[[1,"bg-base-100","relative","-top-12","-right-1","flex","max-h-[65vh]","w-74","flex-col","overflow-auto","rounded-sm","pb-3","shadow-sm",3,"click"],["matRipple","",1,"border-base-300","flex","items-center","space-x-2","border-b","px-2","py-3"],[1,"text-2xl"],[1,""],[1,"px-4","py-2","text-xs","opacity-60"],["matRipple","",1,"flex","h-14","items-center","justify-between","space-x-8","px-2","text-left"],["matRipple","",1,"flex","h-14","items-center","justify-between","space-x-8","px-2","text-left",3,"click"],[1,"hover:bg-base-200","flex","flex-1","items-center","justify-between","rounded-sm","p-2","leading-tight"],[1,"bg-base-300","rounded-sm","px-2","py-1","text-xs","opacity-60"]],template:function(t,r){t&1&&(ke(0,"div",0),$e("click",function(){return r.close()}),ke(1,"div",1)(2,"icon",2),mr(3,"arrow_back"),Be(),ke(4,"div",3),mr(5),Up(6,"translate"),Be()(),ke(7,"div",4),mr(8),Up(9,"translate"),Be(),d8(10,qm,8,14,"button",5,jm),Be()),t&2&&(he(5),Kd$1(LD(6,2,"COMMON.LANGUAGE")),he(3),Lo$1(" ",LD(9,4,"COMMON.LANGUAGE_SELECT")," "),he(2),u8(r.locales));},dependencies:[xl$1,s0,mXe,eet],encapsulation:2});}}return n})();function $m(n,i){if(n&1){let e=xD();ke(0,"mat-radio-button",8),$e("click",function(){let r=F_(e).$implicit,o=vt();return U_(o.setRegion(r))}),mr(1),Be();}if(n&2){let e=i.$implicit;Dn$1("value",e.id),he(),Lo$1(" ",e.display_name||e.name," ");}}var Al=(()=>{class n{constructor(){this._data=m(gle),this._org=m(eT),this.regions=this._org.region_list,this.region=this._org.active_region,this.setRegion=async e=>{await this._org.setRegion(e),this._org.setBuilding(this._org.building,true),this._data?.close();},this.close=()=>this._data?.close();}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["region-select"]],decls:16,vars:8,consts:[[1,"bg-base-100","relative","-top-12","-right-1","flex","max-h-[65vh]","w-74","flex-col","overflow-auto","rounded-sm","pb-3","shadow-sm",3,"click"],["matRipple","",1,"border-base-300","flex","items-center","space-x-2","border-b","px-2","py-3"],[1,"text-2xl"],[1,"leading-tight"],[1,"text-xs","opacity-30"],[1,"px-4","py-2","text-xs","opacity-60"],[1,"flex","flex-col","space-y-2","px-2",3,"ngModel"],[3,"value"],[3,"click","value"]],template:function(t,r){t&1&&(ke(0,"div",0),$e("click",function(){return r.close()}),ke(1,"div",1)(2,"icon",2),mr(3,"arrow_back"),Be(),ke(4,"div",3)(5,"div"),mr(6),Be(),ke(7,"div",4),mr(8),Up(9,"translate"),Be()()(),ke(10,"div",5),mr(11),Up(12,"translate"),Be(),ke(13,"mat-radio-group",6),d8(14,$m,2,2,"mat-radio-button",7,l8),Be(),r5(),Be()),t&2&&(he(6),Lo$1(" ",r.region()?.display_name||r.region()?.name," "),he(2),Lo$1(" ",LD(9,4,"RESOURCE.REGION")," "),he(3),Lo$1(" ",LD(12,6,"COMMON.REGION_SELECT")," "),he(2),Dn$1("ngModel",r.region()?.id),s5(),he(),u8(r.regions()));},dependencies:[Rr,Bi,vi,mXe,xl$1,s0,oOe,J0e,qQ,eet],encapsulation:2});}}return n})();var Pl=(()=>{class n{constructor(){this._settings=m(Ws$1),this._tooltip=m(gle,{optional:true}),this.plate_number=w("");}async ngOnInit(){await lH(this._settings.initialised),this.plate_number.set(this._settings.get("plate_number")||"");}save(){this.plate_number()&&this._settings.saveUserSetting("plate_number",this.plate_number()),tb(vi$1("COMMON.PARKING_SETTINGS_SAVE")),this._tooltip?.close();}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["user-parking-tooltip"]],decls:14,vars:13,consts:[[1,"border-base-300","bg-base-100","min-w-[20rem]","space-y-2","rounded-md","border","p-2"],[1,"border-base-300","border-b","text-lg","font-medium"],[1,"flex","flex-col"],["for","plate-number"],["appearance","outline",1,"no-subscript"],["matInput","",3,"ngModelChange","ngModel","placeholder"],["btn","","matRipple","",1,"w-full",3,"click"]],template:function(t,r){t&1&&(ke(0,"div",0)(1,"h3",1),mr(2),Up(3,"translate"),Be(),ke(4,"div",2)(5,"label",3),mr(6),Up(7,"translate"),Be(),ke(8,"mat-form-field",4)(9,"input",5),Up(10,"translate"),KL("ngModelChange",function(c){return Q8(r.plate_number,c)||(r.plate_number=c),c}),Be(),r5(),Be()(),ke(11,"button",6),$e("click",function(){return r.save()}),mr(12),Up(13,"translate"),Be()()),t&2&&(he(2),Lo$1(" ",LD(3,5,"COMMON.CONTROLS_PARKING")," "),he(4),Kd$1(LD(7,7,"EXPLORE.PARKING_PLATE_NUMBER")),he(3),qL("ngModel",r.plate_number),Dn$1("placeholder",LD(10,9,"EXPLORE.PARKING_PLATE_NUMBER")),s5(),he(3),Lo$1(" ",LD(13,11,"COMMON.SAVE")," "));},dependencies:[sM,P3,TJe,SJe,oOe,mB,J0e,qQ,eet],encapsulation:2});}}return n})();function Xm(n,i){if(n&1){let e=xD();ke(0,"button",17),$e("click",function(){let r=F_(e).$implicit,o=vt().$index,c=vt(2);return U_(c.setLocation(o,r.id))}),ke(1,"div",18)(2,"icon",11),mr(3),Be(),ke(4,"div",19),mr(5),Up(6,"translate"),Be()()();}if(n&2){let e=i.$implicit;he(3),Kd$1(e.icon),he(2),Lo$1(" ",LD(6,2,e.name)," ");}}function Ym(n,i){n&1&&Ft(0,"div",16);}function Qm(n,i){if(n&1&&(ke(0,"div",9)(1,"div",10)(2,"icon",11),mr(3),Be()(),ke(4,"div",12)(5,"button",13)(6,"div"),mr(7),Be(),ke(8,"icon"),mr(9,"expand_more"),Be()(),ke(10,"mat-menu",null,0),d8(12,Xm,7,4,"button",14,l8),Be(),ke(14,"div",15),mr(15),Up(16,"date"),Up(17,"date"),Be()(),Le(18,Ym,1,0,"div",16),Be()),n&2){let e=i.$implicit,t=i.$index,r=HE(11),o=vt(2);Ne("opacity-30",o.now>o.timeFrom(e.end_time)),he(),Ne("bg-base-200",o.now<o.timeFrom(e.start_time)||o.now>o.timeFrom(e.end_time))("bg-info",o.now>=o.timeFrom(e.start_time)&&o.now<=o.timeFrom(e.end_time))("text-info-content",o.now>=o.timeFrom(e.start_time)&&o.now<=o.timeFrom(e.end_time)),he(2),Kd$1(o.location_icon(o.timeFrom(e.start_time))),he(2),Dn$1("matMenuTriggerFor",r),he(2),Lo$1(" ",o.location(o.timeFrom(e.start_time))," "),he(5),u8(o.locations()),he(3),zL(" ",FD(16,14,o.timeFrom(e.start_time),"shortTime")," \u2013 ",FD(17,17,o.timeFrom(e.end_time),"shortTime")," "),he(3),Fe$1(t>0?18:-1);}}function Zm(n,i){if(n&1&&(ke(0,"div",6),d8(1,Qm,19,20,"div",8,l8),Be()),n&2){let e=vt();he(),u8(e.active_preference?.blocks);}}function Jm(n,i){n&1&&(ke(0,"div",7)(1,"icon",20),mr(2,"event_busy"),Be(),ke(3,"p",21),mr(4),Up(5,"translate"),Be(),ke(6,"p",21),mr(7),Up(8,"translate"),Be()()),n&2&&(he(4),Lo$1(" ",LD(5,2,"COMMON.WORK_LOCATION_EMPTY")," "),he(3),Lo$1(" ",LD(8,4,"COMMON.WORK_LOCATION_EDIT_INFO")," "));}var Fl=(()=>{class n{constructor(){this._dialog=m(rT),this.locations=w([]),this.settings=w(void 0),this.overrides=w({});}get active_preference(){let e=to$1(new Date,"yyyy-MM-dd");return this.overrides()[e]?this.overrides()[e]:this.settings()?.find(t=>t.day_of_week===new Date().getDay())}get now(){return bl$1(Date.now()).getTime()}ngOnInit(){let e=so$1();this.settings.set(e.work_preferences),this.overrides.set(e.work_overrides),this.locations.set([{id:"wfo",name:vi$1("COMMON.WORK_OFFICE"),icon:"business"},{id:"wfh",name:vi$1("COMMON.WORK_HOME"),icon:"home"},{id:"aol",name:vi$1("COMMON.WORK_LEAVE"),icon:"event_busy"},{id:"sick",name:vi$1("COMMON.WORK_SICK"),icon:"sick"}]);}location_icon(e){return so$1().location_icon(e+60*1e3)}location(e){return so$1().location_name_time(e+60*1e3)}timeFrom(e){return bl$1(Dr$1(new Date,{hours:Math.floor(e),minutes:e*60%60,seconds:0,milliseconds:0})).getTime()}editSettings(){this._dialog.open(Dr);}async setLocation(e,t){let r=so$1(),o=this.active_preference,c=to$1(Date.now(),"yyyy-MM-dd"),h=m$1(l({},r.work_overrides),{[c]:m$1(l({},o),{blocks:[...o.blocks.slice(0,e),m$1(l({},o.blocks[e]),{location:t}),...o.blocks.slice(e+1)]})});for(let x in h){let R=Ds(x,"yyyy-MM-dd",new Date);(!h[x].blocks.length||Qi(R,Fn$1(Cn(Date.now()),-1)))&&delete h[x];}this.overrides.set(h),await CV(r.id,m$1(l({},r),{work_overrides:h})),SH();}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["work-location-tooltip"]],decls:14,vars:11,consts:[["work_menu","matMenu"],[1,"bg-base-100","relative","-top-12","-right-1","flex","w-74","flex-col","overflow-hidden","rounded-sm","shadow-sm"],[1,"flex","items-center","justify-between","px-2"],[1,"px-2","py-4","font-medium"],["icon","","matRipple","","matTooltipPosition","left",1,"hover:bg-base-200",3,"click","matTooltip"],[1,"px-4","text-sm","font-medium"],[1,"pb-2"],[1,"flex","w-full","flex-col","items-center","justify-center","space-y-2","p-8","opacity-30"],[1,"relative","flex","items-center","px-4","py-2",3,"opacity-30"],[1,"relative","flex","items-center","px-4","py-2"],[1,"bg-base-200","z-20","flex","h-10","w-10","items-center","justify-center","rounded-full"],[1,"text-2xl"],[1,"ml-2","flex-1"],["matRipple","",1,"hover:bg-base-200","flex","items-center","space-x-2","rounded-sm","px-2","py-1","font-medium",3,"matMenuTriggerFor"],["mat-menu-item",""],[1,"px-2","text-xs","opacity-60"],[1,"border-base-200","absolute","-top-2","left-7","h-4","w-0","-translate-x-px","border-l-2","border-dashed"],["mat-menu-item","",3,"click"],[1,"flex","items-center","space-x-2"],[1,"pr-8"],[1,"text-6xl"],[1,"text-center","text-sm"]],template:function(t,r){t&1&&(ke(0,"div",1)(1,"div",2)(2,"h3",3),mr(3),Up(4,"translate"),Be(),ke(5,"button",4),Up(6,"translate"),$e("click",function(){return r.editSettings()}),ke(7,"icon"),mr(8,"edit_note"),Be()()(),ke(9,"h3",5),mr(10),Up(11,"date"),Be(),Le(12,Zm,3,0,"div",6)(13,Jm,9,6,"div",7),Be()),t&2&&(he(3),Lo$1(" ",LD(4,4,"COMMON.WORK_LOCATION")," "),he(2),Dn$1("matTooltip",LD(6,6,"COMMON.WORK_LOCATION_EDIT")),he(5),Lo$1(" ",FD(11,8,r.now,"fullDate")," "),he(2),Fe$1(r.active_preference?.blocks?.length?12:13));},dependencies:[py,h7e,si,rt,mt,ut,xl$1,s0,KJe,ale,mXe,H6,eet],encapsulation:2});}}return n})();function eu(n,i){if(n&1){let e=xD();ke(0,"button",28),$e("click",function(){let r=F_(e).$implicit,o=vt(2);return U_(o.saveSetting("work_location",r.id))}),ke(1,"div",29)(2,"icon",23),mr(3),Be(),ke(4,"div",30),mr(5),Up(6,"translate"),Be()()();}if(n&2){let e=i.$implicit;he(3),Kd$1(e.icon),he(2),Lo$1(" ",LD(6,2,e.name)," ");}}function tu(n,i){if(n&1&&(ke(0,"div",7)(1,"h3",19),mr(2," Today's Work Location "),Be(),ke(3,"div",20)(4,"div",21)(5,"div",22)(6,"icon",23),mr(7),Be()(),ke(8,"div",24)(9,"button",25)(10,"div"),mr(11),Be(),ke(12,"icon"),mr(13,"expand_more"),Be()(),ke(14,"mat-menu",null,1),d8(16,eu,7,4,"button",26,l8),Be(),ke(18,"div",27),mr(19),Up(20,"date"),Up(21,"date"),Be()()()()()),n&2){let e=HE(15),t=vt();he(7),Kd$1(t.location_icon(t.timeFrom(t.active_block().start_time))),he(2),Dn$1("matMenuTriggerFor",e),he(2),Lo$1(" ",t.location(t.timeFrom(t.active_block().start_time))," "),he(5),u8(t.pref_locations()),he(3),zL(" ",FD(20,5,t.timeFrom(t.active_block().start_time),"shortTime")," \u2013 ",FD(21,8,t.timeFrom(t.active_block().end_time),"shortTime")," ");}}function iu(n,i){if(n&1&&(ke(0,"div",8)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"layers"),Be()(),ke(6,"div",33),mr(7),Be(),ke(8,"icon",34),mr(9," chevron_right "),Be()()()()),n&2){let e=vt();Dn$1("content",e.region_select),he(7),Lo$1(" ",e.region()?.display_name||e.region()?.name," ");}}function nu(n,i){if(n&1&&(ke(0,"div",8)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"business"),Be()(),ke(6,"div",33),mr(7),Be(),ke(8,"icon",34),mr(9," chevron_right "),Be()()()()),n&2){let e=vt();Dn$1("content",e.building_select),he(7),Lo$1(" ",e.building()?.display_name||e.building()?.name," ");}}function ru(n,i){if(n&1&&(ke(0,"div",9)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"help"),Be()(),ke(6,"div",35),mr(7),Up(8,"translate"),Be(),ke(9,"icon",34),mr(10," chevron_right "),Be()()()()),n&2){let e=vt();Dn$1("content",e.help_tooltip),he(7),Lo$1(" ",LD(8,2,"COMMON.CONTROLS_HELP")," ");}}function ou(n,i){if(n&1&&(ke(0,"div",9)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"share_location"),Be()(),ke(6,"div",35),mr(7),Up(8,"translate"),Be(),ke(9,"icon",34),mr(10,"chevron_right"),Be()()()()),n&2){let e=vt();Dn$1("content",e.work_location_tooltip),he(7),Lo$1(" ",LD(8,2,"COMMON.CONTROLS_WORK_LOCATION")," ");}}function au(n,i){if(n&1&&(ke(0,"div",9)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"mode_night"),Be()(),ke(6,"div",35),mr(7),Up(8,"translate"),Be(),ke(9,"icon",34),mr(10,"chevron_right"),Be()()()()),n&2){let e=vt();Ne("border-b!",!e.locales().length||!e.desk_height()),Dn$1("content",e.accessibility_tooltip),he(7),Lo$1(" ",LD(8,4,"COMMON.CONTROLS_ACCESSIBILITY")," ");}}function su(n,i){if(n&1&&(ke(0,"div",9)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"desk"),Be()(),ke(6,"div",35),mr(7),Up(8,"translate"),Be(),ke(9,"icon",34),mr(10," chevron_right "),Be()()()()),n&2){let e=vt(),t=HE(15);Ne("border-b!",!e.locales().length),Dn$1("content",t),he(7),Lo$1(" ",LD(8,4,"COMMON.CONTROLS_DESKS")," ");}}function lu(n,i){n&1&&Ft(0,"desk-height-presets");}function cu(n,i){if(n&1&&(ke(0,"div",9)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"parking_sign"),Be()(),ke(6,"div",35),mr(7),Up(8,"translate"),Be(),ke(9,"icon",34),mr(10," chevron_right "),Be()()()()),n&2){let e=vt();Ne("border-b!",!e.locales().length),Dn$1("content",e.parking_tooltip),he(7),Lo$1(" ",LD(8,4,"COMMON.CONTROLS_PARKING")," ");}}function du(n,i){n&1&&(ke(0,"div",37),mr(1," Language "),Be());}function mu(n,i){if(n&1&&(ke(0,"div",11)(1,"button",12)(2,"div",31)(3,"div",32)(4,"icon"),mr(5,"language"),Be()(),ke(6,"div",36)(7,"div")(8,"div"),mr(9),Up(10,"translate"),Be(),Le(11,du,2,0,"div",37),Up(12,"translate"),Be(),ke(13,"div",38),Up(14,"translate"),mr(15),Up(16,"translate"),Be()(),ke(17,"icon",34),mr(18," chevron_right "),Be()()()()),n&2){let e=vt();Dn$1("content",e.language_tooltip),he(9),Lo$1(" ",LD(10,5,"COMMON.LANGUAGE")," "),he(2),Fe$1(LD(12,7,"COMMON.LANGUAGE")!=="Language"?11:-1),he(2),Dn$1("matTooltip",LD(14,9,e.active_locale)),he(2),Lo$1(" ",LD(16,11,e.active_locale)," ");}}function uu(n,i){if(n&1){let e=xD();ke(0,"button",39),$e("click",function(){F_(e);let r=vt();return U_(r.newSupportTicket())}),ke(1,"div",31)(2,"div",32)(3,"icon"),mr(4,"support_agent"),Be()(),ke(5,"div",35),mr(6),Up(7,"translate"),Be()()();}n&2&&(he(6),Lo$1(" ",LD(7,1,"COMMON.CONTROLS_SUPPORT")," "));}function pu(n,i){if(n&1){let e=xD();ke(0,"button",40),$e("click",function(){F_(e);let r=vt();return U_(r.reloadPage())}),mr(1),Up(2,"translate"),Be();}n&2&&(he(),Lo$1(" ",LD(2,1,"COMMON.CONTROLS_NEW_VERSION")," "));}function hu(n,i){if(n&1){let e=xD();ke(0,"button",41),$e("click",function(){F_(e);let r=vt();return U_(r.viewChangelog())}),mr(1),Be();}if(n&2){let e=vt();he(),Lo$1(" ",e.version.hash," ");}}function _u(n,i){if(n&1&&(ke(0,"span"),mr(1),Be()),n&2){let e=vt();he(),Kd$1(e.version.hash);}}var Vl=(()=>{class n{constructor(){this._settings=m(Ws$1),this._org=m(eT),this._dialog=m(rT),this._locale=m(lb),this.building=this._org.active_building,this.region=this._org.active_region,this.regions=this._org.region_list,this.sidebar=gn(false),this.accessibility=fee("allow_accessibility_changes",true),this.show_changelog=fee("show_changelog",true),this.region_select=Al,this.building_select=Rl,this.help_tooltip=Dl,this.accessibility_tooltip=Il,this.language_tooltip=Nl,this.work_location_tooltip=Fl,this.parking_tooltip=Pl,this.features=fee("features",[]),this._locales=this._settings.signal("locales",[]),this._desk_height=this._settings.signal("desks.height_enabled",false),this._use_region=this._settings.signal("use_region",false),this._disable_building_select=this._settings.signal("disable_building_select",false),this.pref_locations=w([]),this.work_prefs=w([]),this.overrides=w({}),this.active_block=me(()=>{let e=to$1(new Date,"yyyy-MM-dd"),t=new Date().getDay();return (this.overrides()[e]?this.overrides()[e]:this.work_prefs().find(o=>o.day_of_week===t))?.blocks?.find(o=>this.now>=this.timeFrom(o.start_time)&&this.now<this.timeFrom(o.end_time))}),this.active_index=me(()=>{let e=to$1(new Date,"yyyy-MM-dd"),t=new Date().getDay();return (this.overrides()[e]?this.overrides()[e]:this.work_prefs().find(o=>o.day_of_week===t))?.blocks?.findIndex(o=>this.now>=this.timeFrom(o.start_time)&&this.now<this.timeFrom(o.end_time))}),this.locales=this._locales,this.desk_height=this._desk_height,this.use_region=this._use_region,this.disable_building_select=this._disable_building_select;}location_icon(e){return so$1().location_icon(e+60*1e3)}location(e){return so$1().location_name_time(e+60*1e3)}timeFrom(e){return bl$1(Dr$1(new Date,{hours:Math.floor(e),minutes:e*60%60,seconds:0,milliseconds:0})).getTime()}get user(){return so$1()}get groups(){return this.user?.groups?.join(`
`)||""}get version(){return im$1}get active_locale(){let e=this.locales(),t=this._locale.locale;for(let r of e)if(r.id===t)return r.name;return "LANGUAGE.ENGLISH"}get now(){return bl$1(Date.now()).getTime()}get has_new_version(){return Zj()}ngOnInit(){let e=so$1();this.work_prefs.set(e?.work_preferences||[]),this.overrides.set(e?.work_overrides||{}),this.pref_locations.set([{id:"wfo",name:vi$1("COMMON.WORK_OFFICE"),icon:"business"},{id:"wfh",name:vi$1("COMMON.WORK_HOME"),icon:"home"},{id:"aol",name:vi$1("COMMON.WORK_LEAVE"),icon:"event_busy"},{id:"sick",name:vi$1("COMMON.WORK_SICK"),icon:"sick"}]);}logout(){dOe();}reloadPage(){location.reload();}newSupportTicket(){this._settings.get("app.external_support_url")?window.open(this._settings.get("app.external_support_url"),"_blank"):this._dialog.open(Ml);}openWfhModal(){this._dialog.open(Dr);}async viewChangelog(){let e=await(await fetch("https://raw.githubusercontent.com/PlaceOS/user-interfaces/develop/CHANGELOG.md")).text();this._dialog.open(kl,{data:{changelog:e}});}saveSetting(e,t){this._settings.saveUserSetting(e,t);}formatLabel(e){return `${e.toFixed(1)}cm`}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["user-controls"]],inputs:{sidebar:[1,"sidebar"]},decls:35,vars:32,consts:[["desk_height_tooltip",""],["work_menu","matMenu"],[1,"divide-base-200","border-base-300","bg-base-100","relative","mt-1","flex","flex-col","divide-y","overflow-auto","rounded-sm","border","shadow-sm"],["avatar","",1,"flex","w-full","min-w-72","flex-col","items-center","p-2"],[1,"text-2xl",3,"user","matTooltip"],[1,""],[1,"truncate","text-xs","opacity-60"],[1,"border-base-200","w-full","rounded-sm","border-y","py-2"],["customTooltip","",1,"relative",3,"content"],["customTooltip","",3,"content"],["customTooltip","",3,"content","border-b!"],["customTooltip","",1,"border-b!",3,"content"],["btn","","matRipple","",1,"clear","h-14","w-full","text-left"],[1,"flex","flex-col","items-center","p-4"],[1,"mb-4","flex","items-center","justify-center","space-x-2"],["btn","","matRipple","",1,"inverse",3,"click"],["btn","","matRipple",""],[1,"w-full","text-xs","opacity-60"],[1,"m-0","border-none","bg-none","p-0","text-xs","underline"],[1,"w-full","px-4","pb-2","text-sm","font-medium"],[1,"w-full"],[1,"relative","flex","items-center","px-4","py-2"],[1,"bg-info","text-info-content","z-20","flex","h-10","w-10","items-center","justify-center","rounded-full"],[1,"text-2xl"],[1,"ml-2","flex-1"],["matRipple","",1,"hover:bg-base-200","flex","items-center","space-x-2","rounded-sm","px-2","py-1","font-medium",3,"matMenuTriggerFor"],["mat-menu-item",""],[1,"px-2","text-xs","opacity-60"],["mat-menu-item","",3,"click"],[1,"flex","items-center","space-x-2"],[1,"pr-8"],[1,"flex","w-full","items-center","space-x-2"],[1,"bg-base-200","flex","h-8","w-8","items-center","justify-center","rounded-full"],[1,"w-px","flex-1","truncate"],[1,"text-2xl","opacity-60"],[1,"flex-1"],[1,"flex","flex-1","items-center","justify-between","space-x-4"],[1,"text-xs","opacity-30"],[1,"bg-base-200","max-w-24","truncate","rounded-sm","px-2","py-1","text-sm",3,"matTooltip"],["btn","","matRipple","",1,"clear","h-14","w-full","text-left",3,"click"],["btn","","matRipple","",3,"click"],[1,"m-0","border-none","bg-none","p-0","text-xs","underline",3,"click"]],template:function(t,r){t&1&&(ke(0,"div",2)(1,"div",3),Ft(2,"a-user-avatar",4),ke(3,"div",5),mr(4),Be(),ke(5,"div",6),mr(6),Be()(),Le(7,tu,22,11,"div",7),Le(8,iu,10,2,"div",8),Le(9,nu,10,2,"div",8),Le(10,ru,11,4,"div",9),Le(11,ou,11,4,"div",9),Le(12,au,11,6,"div",10),Le(13,su,11,6,"div",10),Kn$1(14,lu,1,0,"ng-template",null,0,Bp),Le(16,cu,11,6,"div",10),Le(17,mu,19,13,"div",11),Le(18,uu,8,3,"button",12),ke(19,"div",13)(20,"div",14)(21,"button",15),$e("click",function(){return r.logout()}),mr(22),Up(23,"translate"),Be(),Le(24,pu,3,3,"button",16),Be(),ke(25,"div",17),ND(26),mr(27),Up(28,"translate"),MD(),Le(29,hu,2,1,"button",18)(30,_u,2,1,"span"),Be(),ke(31,"div",17),mr(32),Up(33,"date"),Up(34,"date"),Be()()()),t&2&&(Ne("border",!r.sidebar()),he(2),Dn$1("user",r.user)("matTooltip",r.groups),he(2),Kd$1(r.user?.name),he(2),Lo$1(" ",r.user?.email," "),he(),Fe$1(r.features().includes("wfh")&&r.active_block()?7:-1),he(),Fe$1(r.regions()?.length?8:-1),he(),Fe$1(!r.disable_building_select()&&!r.use_region()?9:-1),he(),Fe$1(r.features().includes("help")?10:-1),he(),Fe$1(r.features().includes("wfh")?11:-1),he(),Fe$1(r.accessibility()?12:-1),he(),Fe$1(r.desk_height()?13:-1),he(3),Fe$1(r.features().includes("parking-controls")?16:-1),he(),Fe$1(r.locales().length>1?17:-1),he(),Fe$1(r.features().includes("support-ticket")?18:-1),he(4),Lo$1(" ",LD(23,22,"COMMON.CONTROLS_SIGN_OUT")," "),he(2),Fe$1(r.has_new_version?24:-1),he(3),Lo$1(" ",LD(28,24,"COMMON.CONTROLS_VERSION"),": "),he(2),Fe$1(r.show_changelog()?29:30),he(3),zL(" ",FD(33,26,r.version.time,"longDate")," (",FD(34,29,r.version.time,"shortTime"),") "));},dependencies:[py,h7e,xl$1,s0,mXe,met,KJe,ale,Or,si,rt,mt,ut,Ol,H6,eet],encapsulation:2});}}return n})();var fu=["*"];function gu(n,i){n&1&&(ke(0,"icon",2),mr(1,"person"),Be());}function bu(n,i){if(n&1){let e=xD();ke(0,"div",1)(1,"button",3),$e("click",function(){F_(e);let r=vt();return U_(r.close())}),Be(),ke(2,"div",4)(3,"div",5),Ft(4,"user-controls",6),ke(5,"button",7),$e("click",function(){F_(e);let r=vt();return U_(r.close())}),ke(6,"icon",2),mr(7,"close"),Be()()()()();}if(n&2){let e=vt();he(),Ne("opacity-50",e.is_open())("opacity-0",!e.is_open()),he(2),Ne("translate-x-0",e.is_open())("translate-x-full",!e.is_open()),he(),Dn$1("sidebar",true);}}var Ll=(()=>{class n{constructor(){this._close_timeout=null,this.is_open=w(false),this.is_rendered=w(false);}open(){this._close_timeout&&(clearTimeout(this._close_timeout),this._close_timeout=null),this.is_rendered.set(true),requestAnimationFrame(()=>this.is_open.set(true));}close(){this.is_open.set(false),this._close_timeout=setTimeout(()=>{this.is_rendered.set(false),this._close_timeout=null;},200);}onEscape(){this.is_open()&&this.close();}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["user-controls-sidebar"]],hostBindings:function(t,r){t&1&&$e("keydown.escape",function(){return r.onEscape()},kq);},ngContentSelectors:fu,decls:4,vars:1,consts:[["icon","","matRipple","","avatar","","type","button","name","user-controls",1,"bg-base-200","flex","h-10","w-10","items-center","justify-center","rounded-full",3,"click"],[1,"fixed","inset-0","z-9999","overflow-hidden"],[1,"text-2xl"],["type","button","aria-label","Close user controls",1,"absolute","inset-0","bg-black","transition-opacity","duration-200",3,"click"],[1,"absolute","inset-y-0","right-0","flex","max-w-full"],[1,"bg-base-100","relative","h-full","w-80","max-w-[100vw]","overflow-auto","pt-[calc(env(safe-area-inset-top)+1rem)]","pb-[env(safe-area-inset-bottom)]","pr-[env(safe-area-inset-right)]","shadow-xl","transition-transform","duration-200","ease-out"],[3,"sidebar"],["icon","","default","","matRipple","","type","button",1,"absolute","top-[calc(env(safe-area-inset-top)+0.5rem)]","right-[calc(env(safe-area-inset-right)+0.5rem)]",3,"click"]],template:function(t,r){t&1&&(Kt(),ke(0,"button",0),$e("click",function(){return r.open()}),Pe(1,0,null,gu,2,0),Be(),Le(3,bu,8,9,"div",1)),t&2&&(he(3),Fe$1(r.is_rendered()?3:-1));},dependencies:[xl$1,s0,mXe,Vl],encapsulation:2});}}return n})();var vu=["editor"];function yu(n,i){if(n&1){let e=xD();ke(0,"button",20),$e("click",function(){F_(e);let r=vt(2);return U_(r.insertImage())}),ke(1,"icon"),mr(2,"image"),Be()(),ke(3,"button",20),$e("click",function(){F_(e);let r=vt(2);return U_(r.insertAttachment())}),ke(4,"icon"),mr(5,"attachment"),Be()();}}function xu(n,i){if(n&1){let e=xD();ke(0,"div",3)(1,"select",5),$e("change",function(r){F_(e);let o=vt();return U_(o.setFontFace(r))}),ke(2,"option",6),mr(3,"Font"),Be(),ke(4,"option",7),mr(5,"Arial"),Be(),ke(6,"option",8),mr(7,"Helvetica"),Be(),ke(8,"option",9),mr(9,"Georgia"),Be(),ke(10,"option",10),mr(11,"Times New Roman"),Be()(),ke(12,"select",11),$e("change",function(r){F_(e);let o=vt();return U_(o.setFontSize(r))}),ke(13,"option",12),mr(14,"Size"),Be(),ke(15,"option",13),mr(16,"12"),Be(),ke(17,"option",14),mr(18,"14"),Be(),ke(19,"option",15),mr(20,"16"),Be(),ke(21,"option",16),mr(22,"18"),Be(),ke(23,"option",17),mr(24,"24"),Be(),ke(25,"option",18),mr(26,"32"),Be(),ke(27,"option",19),mr(28,"48"),Be()(),ke(29,"button",20),$e("click",function(){F_(e);let r=vt();return U_(r.toggleBold())}),ke(30,"icon"),mr(31,"format_bold"),Be()(),ke(32,"button",20),$e("click",function(){F_(e);let r=vt();return U_(r.toggleItalic())}),ke(33,"icon"),mr(34,"format_italic"),Be()(),ke(35,"button",20),$e("click",function(){F_(e);let r=vt();return U_(r.toggleUnderline())}),ke(36,"icon"),mr(37,"format_underlined"),Be()(),ke(38,"button",20),$e("click",function(){F_(e);let r=vt();return U_(r.makeUnorderedList())}),ke(39,"icon"),mr(40,"format_list_bulleted"),Be()(),ke(41,"button",20),$e("click",function(){F_(e);let r=vt();return U_(r.makeOrderedList())}),ke(42,"icon"),mr(43,"format_list_numbered"),Be()(),ke(44,"button",20),$e("click",function(){F_(e);let r=vt();return U_(r.insertLink())}),ke(45,"icon"),mr(46,"link"),Be()(),Le(47,yu,6,0),Be();}if(n&2){let e=vt();he(29),Ne("border-info",e.toolbar_state().bold)("text-info",e.toolbar_state().bold),he(3),Ne("border-info",e.toolbar_state().italic)("text-info",e.toolbar_state().italic),he(3),Ne("border-info",e.toolbar_state().underline)("text-info",e.toolbar_state().underline),he(3),Ne("border-info",e.toolbar_state().unordered_list)("text-info",e.toolbar_state().unordered_list),he(3),Ne("border-info",e.toolbar_state().ordered_list)("text-info",e.toolbar_state().ordered_list),he(3),Ne("border-info",e.toolbar_state().link)("text-info",e.toolbar_state().link),he(3),Fe$1(e.images_allowed()?47:-1);}}var Cl=(()=>{class n extends no$1{constructor(){super(...arguments),this._uploads=m(O7e),this._dom_sanitizer=m(Zc$1),this._ng_zone=m(B),this.placeholder=gn(""),this.readonly=gn(false),this.images_allowed=gn(false),this._editor_el=qc$1("editor"),this._onChange=()=>{},this._onTouch=()=>{},this.toolbar_state=w({bold:false,italic:false,underline:false,unordered_list:false,ordered_list:false,link:false}),this.registerOnChange=e=>this._onChange=e,this.registerOnTouched=e=>this._onTouch=e,this._syncValue=()=>{this._editor&&this.setValue(this._editor.getHTML());},this._handleTouched=()=>{this._editor&&this._onTouch();},this._refreshToolbarState=()=>{this._editor&&this._ng_zone.run(()=>{this.toolbar_state.set({bold:this._editor.hasFormat("B"),italic:this._editor.hasFormat("I"),underline:this._editor.hasFormat("U"),unordered_list:this._editor.hasFormat("UL"),ordered_list:this._editor.hasFormat("OL"),link:this._editor.hasFormat("A")});});};}ngOnChanges(e){e.placeholder&&this.timeout("init",()=>this._initialiseEditor()),e.readonly&&this._editor&&this._setReadonlyState();}ngAfterViewInit(){this.timeout("init",()=>this._initialiseEditor());}setValue(e){this._onChange(e);}writeValue(e){this.timeout("write",()=>{this._editor?(this._editor.setHTML(e||""),this._setPlaceholder()):this.timeout("write",()=>this.writeValue(e));});}toggleBold(){this._toggleFormat("B",()=>this._editor.removeBold(),()=>this._editor.bold());}toggleItalic(){this._toggleFormat("I",()=>this._editor.removeItalic(),()=>this._editor.italic());}toggleUnderline(){this._toggleFormat("U",()=>this._editor.removeUnderline(),()=>this._editor.underline());}makeUnorderedList(){this._toggleFormat("UL",()=>this._editor.removeList(),()=>this._editor.makeUnorderedList());}makeOrderedList(){this._toggleFormat("OL",()=>this._editor.removeList(),()=>this._editor.makeOrderedList());}insertLink(){if(!this._editor)return;if(this._editor.hasFormat("A")){this._editor.removeLink(),this._syncValue(),this._refreshToolbarState();return}let e=prompt("Enter URL");e&&(this._editor.makeLink(e),this._syncValue(),this._refreshToolbarState());}setFontFace(e){if(!this._editor)return;let t=e.target.value;t&&(this._editor.setFontFace(t==="default"?"inherit":t),this._syncValue());}setFontSize(e){if(!this._editor)return;let t=e.target.value;t&&(this._editor.setFontSize(t),this._syncValue());}insertImage(){this._embedFile(true);}insertAttachment(){this._embedFile(false);}async _initialiseEditor(){let e=this._editor_el()?.nativeElement;if(!e)return this.timeout("init",()=>this._initialiseEditor());let{default:t}=await import('./chunk-CRXfBZqR.js');this._editor&&this._editor.destroy(),e.innerHTML="",this._editor=new t(e,{blockTag:"div",sanitizeToDOMFragment:r=>{let o=this._dom_sanitizer.sanitize(Mi.HTML,r||"")||"",c=document.createElement("template");return c.innerHTML=o,c.content.cloneNode(true)}}),this._editor.addEventListener("input",this._syncValue),this._editor.addEventListener("blur",this._handleTouched),this._editor.addEventListener("cursor",this._refreshToolbarState),this._editor.addEventListener("select",this._refreshToolbarState),this._editor.addEventListener("pathChange",this._refreshToolbarState),this._setReadonlyState(),this._setPlaceholder(),this._refreshToolbarState();}_embedFile(e){if(!this._editor)return;let t=document.createElement("input");t.setAttribute("type","file"),e&&t.setAttribute("accept","image/*"),t.click(),t.onchange=()=>{let r=t.files?.[0];r&&this._uploads.uploadFile(r,true).then(o=>{if(!o)return;let c=`${location.origin}/api/engine/v2/uploads/${encodeURIComponent(o)}/url`;this._setAuth(),setTimeout(()=>{this._insertUploadedFile(c,r,e),this._syncValue();},100);});};}_setReadonlyState(){let e=this._editor_el()?.nativeElement;e&&e.setAttribute("contenteditable",`${!this.readonly()}`);}_setPlaceholder(){let e=this._editor_el()?.nativeElement;e&&e.setAttribute("data-placeholder",this.placeholder()||"");}_toggleFormat(e,t,r){this._editor&&(this._editor.hasFormat(e)?t():r(),this._syncValue(),this._refreshToolbarState());}_insertUploadedFile(e,t,r){let o=t.type.startsWith("image/");if(r||o){this._editor.insertHTML(`<img src="${e}" alt="${t.name}" />`);return}this._editor.insertHTML(`<a href="${e}" target="_blank">${t.name}</a>`);}_setAuth(){let e=Qt();document.cookie=`${e==="x-api-key"?"api-key="+encodeURIComponent(ml$1()):"bearer_token="+encodeURIComponent(e)};max-age=30;path=/api/engine/v2/uploads;samesite=strict;${location.protocol==="https:"?"secure;":""}`;}static{this.\u0275fac=(()=>{let e;return function(r){return (e||(e=yt(n)))(r||n)}})();}static{this.\u0275cmp=ve({type:n,selectors:[["rich-text-input"]],viewQuery:function(t,r){t&1&&Wd$1(r._editor_el,vu,5),t&2&&qd$1();},inputs:{placeholder:[1,"placeholder"],readonly:[1,"readonly"],images_allowed:[1,"images_allowed"]},features:[ot$1([{provide:ka,useExisting:nn(()=>n),multi:true}]),Re,Et],decls:5,vars:1,consts:[["container",""],["editor",""],[1,"w-full"],[1,"border-base-300","bg-base-100","flex","flex-wrap","items-center","gap-1","rounded-t","border","p-2"],[1,"squire-editor"],[1,"border-base-300","bg-base-100","rounded","border","p-2","text-sm",3,"change"],["value","default"],["value","Arial"],["value","Helvetica"],["value","Georgia"],["value","Times New Roman"],[1,"border-base-300","bg-base-100","min-w-24","rounded","border","p-2","text-sm",3,"change"],["value",""],["value","12px"],["value","14px"],["value","16px"],["value","18px"],["value","24px"],["value","32px"],["value","48px"],["icon","","type","button",1,"border-base-300","rounded","border","px-2","py-1","text-sm",3,"click"]],template:function(t,r){t&1&&(ke(0,"div",2,0),Le(2,xu,48,25,"div",3),Ft(3,"div",4,1),Be()),t&2&&(he(2),Fe$1(r.readonly()?-1:2));},dependencies:[mXe],styles:["[_nghost-%COMP%]{display:block;width:100%}[_nghost-%COMP%]     .squire-editor{border-radius:.25rem;border:1px solid var(--base-300);padding:.5rem;min-height:8rem;width:100%;outline:none}[_nghost-%COMP%]     .squire-editor:empty:before{content:attr(data-placeholder);color:var(--base-content);opacity:.5}[_nghost-%COMP%]     .squire-editor ul{list-style-type:disc;margin:.5rem 0;padding-left:1.5rem}[_nghost-%COMP%]     .squire-editor ol{list-style-type:decimal;margin:.5rem 0;padding-left:1.5rem}[_nghost-%COMP%]     .squire-editor li{margin:.125rem 0}"]});}}return n})();var ku=(n,i)=>i.id+""+n;function Cu(n,i){if(n&1&&(ke(0,"a",1)(1,"icon",2),mr(2),Be(),ke(3,"span",3),mr(4),Be()()),n&2){let e=vt().$implicit;Dn$1("routerLink",e.route),he(2),Kd$1(e.icon),he(2),Kd$1(e.name);}}function Mu(n,i){if(n&1){let e=xD();ke(0,"button",6),$e("click",function(){F_(e);let r=vt(2).$implicit,o=vt();return U_(o.toggleBlock(r.id||r._id))}),ke(1,"icon",2),mr(2),Be(),ke(3,"div",7),mr(4),Be(),ke(5,"icon",8),mr(6,"arrow_drop_down"),Be()();}if(n&2){let e=vt(2).$implicit;he(2),Lo$1(" ",e.icon," "),he(2),Lo$1(" ",e.name," ");}}function wu(n,i){if(n&1&&(ke(0,"a",9),Ft(1,"icon",8),ke(2,"span"),mr(3),Be()()),n&2){let e=i.$implicit;Dn$1("routerLink",e.route),he(3),Kd$1(e.name);}}function Tu(n,i){if(n&1&&(ke(0,"section",5),d8(1,wu,4,2,"a",9,l8),Be()),n&2){let e=vt(2).$implicit,t=vt();Dn$1("@show",t.isBlockCollapsed(e.id||e._id)?"hide":"show"),he(),u8(e.children);}}function Eu(n,i){if(n&1&&(Le(0,Mu,7,2,"button",4),Le(1,Tu,3,1,"section",5)),n&2){let e=vt().$implicit;Fe$1(e.children?.length?0:-1),he(),Fe$1(e.children?.length?1:-1);}}function Su(n,i){if(n&1&&Le(0,Cu,5,3,"a",1)(1,Eu,2,2),n&2){let e=i.$implicit;Fe$1(e.children?1:0);}}var F1=(()=>{class n extends no$1{constructor(){super(),this._settings=m(Ws$1),this._org=m(eT),this._element_ref=m(G),this.show_block=w({}),this.links=[],this.filtered_links=w([]),_t(()=>{this._org.active_building()&&this.timeout("update_links",()=>this.updateFilteredLinks(),500);});}get feature_list(){return this._settings.get("app.features")||[]}get feature_groups(){return this._settings.get("app.feature_groups")||{}}get is_admin(){let e=so$1().groups||[],t=this._settings.get("app.admin_group")||"admin";return e.includes(t)||e.includes("placeos_admin")||e.includes("placeos_support")}async ngOnInit(){await this._org.waitUntilInitialised(),this.links=[{name:vi$1("APP.CONCIERGE.MENU_BOOKINGS"),icon:"add_circle",children:[{id:"spaces",name:vi$1("APP.CONCIERGE.MENU_ROOM_BOOKINGS"),route:["/book/rooms"]},{id:"desks",name:vi$1("APP.CONCIERGE.MENU_DESK_BOOKINGS"),route:["/book/desks/events"]},{id:"parking",name:vi$1("APP.CONCIERGE.MENU_PARKING_BOOKINGS"),route:["/book/parking/events"]},{id:"parking-bookings",name:vi$1("APP.CONCIERGE.MENU_PARKING_BOOKINGS"),route:["/book/parking/events"]},{id:"lockers",name:vi$1("APP.CONCIERGE.MENU_LOCKER_BOOKINGS"),route:["/book/lockers/events"]},{id:"assets",name:vi$1("APP.CONCIERGE.MENU_ASSET_BOOKINGS"),route:["/book/assets/list/requests"]},{id:"catering",name:vi$1("APP.CONCIERGE.MENU_CATERING_BOOKINGS"),route:["/book/catering/orders"]},{id:"visitors",name:vi$1("APP.CONCIERGE.MENU_VISITOR_BOOKINGS"),route:["/book/visitors"]},{id:"visitor-rules",name:vi$1("APP.CONCIERGE.MENU_VISITOR_RULES"),route:["/book/visitors/rules"]}]},{id:"facilities",name:vi$1("APP.CONCIERGE.MENU_MANAGEMENT"),icon:"place",children:[{id:"zones",name:vi$1("APP.CONCIERGE.MENU_MANAGE_ZONES"),route:["/zone-management"]},{id:"spaces",name:vi$1("APP.CONCIERGE.MENU_MANAGE_ROOMS"),route:["/room-management"]},{id:"desks",name:vi$1("APP.CONCIERGE.MENU_MANAGE_DESKS"),route:["/book/desks/manage"]},{id:"parking",name:vi$1("APP.CONCIERGE.MENU_MANAGE_PARKING"),route:["/book/parking/manage"]},{id:"parking-manage",name:vi$1("APP.CONCIERGE.MENU_MANAGE_PARKING"),route:["/book/parking/manage"]},{id:"lockers",name:vi$1("APP.CONCIERGE.MENU_MANAGE_LOCKERS"),route:["/book/lockers/manage"]},{id:"catering",name:vi$1("APP.CONCIERGE.MENU_MANAGE_CATERING"),route:["/book/catering/menu"]},{id:"points",name:vi$1("APP.CONCIERGE.MENU_MANAGE_POINTS"),route:["/points-management"]},{id:"emergency-contacts",name:vi$1("APP.CONCIERGE.MENU_MANAGE_CONTACTS"),icon:"assignment_ind",route:["/users/staff/emergency-contacts"]},{id:"signage",name:vi$1("APP.CONCIERGE.MENU_MANAGE_SIGNAGE"),route:["/signage"]},{id:"points-of-interest",name:vi$1("APP.CONCIERGE.MENU_MANAGE_MAP_FEATURES"),route:["/points-of-interest"]},{id:"url-management",name:vi$1("APP.CONCIERGE.MENU_MANAGE_URLS"),route:["/url-management"]},{id:"email-templates",name:vi$1("APP.CONCIERGE.MENU_MANAGE_EMAILS"),route:["/email-templates"]},{id:"deals-n-offers",name:vi$1("APP.CONCIERGE.MENU_MANAGE_DEALS"),route:["/deals-n-offers"]}]},{id:"assets",name:vi$1("APP.CONCIERGE.MENU_ASSETS"),route:["/book/assets/list/items"],icon:"vibration"},{id:"internal-users",name:vi$1("APP.CONCIERGE.MENU_USER_LIST"),icon:"assignment_ind",route:["/users/staff"]},{id:"events",name:vi$1("APP.CONCIERGE.MENU_EVENTS"),route:["/entertainment/events"],icon:"confirmation_number"},{id:"surveys",name:vi$1("APP.CONCIERGE.MENU_SURVEYS"),route:["/surveys"],icon:"add_reaction"},{_id:"reports",name:vi$1("APP.CONCIERGE.MENU_REPORTS"),icon:"analytics",children:[{id:"attendance-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_SITE_ATTENDANCE"),route:["/reports/attendance"]},{id:"booking-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_ROOMS"),route:["/reports/bookings"]},{id:"desk-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_DESKS"),route:["/reports/desks"]},{id:"parking-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_PARKING"),route:["/reports/parking"]},{id:"lockers-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_LOCKERS"),route:["/reports/lockers"]},{id:"catering-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_CATERING"),route:["/reports/catering"]},{id:"contact-tracing-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_CONTACT_TRACING"),route:["/reports/contact-tracing"]},{id:"assets-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_ASSETS"),route:["/reports/assets"]},{id:"visitors-report",name:vi$1("APP.CONCIERGE.MENU_REPORT_VISITORS"),route:["/reports/visitors"]}]}],this.updateFilteredLinks(),this.timeout("update_inview",()=>this._moveActiveLinkIntoView(),50),this.timeout("update_links",()=>this.updateFilteredLinks(),500);}_isFeatureAvailable(e){if(e.startsWith("*"))return  true;let t=this.feature_list.includes(e),r=this.feature_groups[e]||[],o=so$1().groups;return !!(t&&(this.is_admin||!r.length||o.find(c=>r.includes(c))))}updateFilteredLinks(){let e=this._settings.get("app.custom_reports")||[];if(e.length&&this.links.find(t=>t._id==="reports")){let t=this.links.find(r=>r._id==="reports");t.children=Cr$1(t.children.concat(e.map(r=>m$1(l({},r),{id:`*${r.id}`,route:["/reports",r.id]}))),"id");}if(this.filtered_links.set(this.links.map(t=>m$1(l({},t),{children:t.children?t.children.filter(r=>this._isFeatureAvailable(r.id)):null})).filter(t=>(!t.id||t.id==="home"||this._isFeatureAvailable(t.id))&&t.route||t.children?.length)),this.filtered_links().find(t=>t.id==="home")){let t=this.filtered_links().find(r=>r.id==="home");t.route=this._settings.get("app.default_route")||["/"];}this.is_admin||this.filtered_links.update(t=>t.filter(r=>r.id!=="facilities"));}toggleBlock(e){this.show_block.update(t=>m$1(l({},t),{[e]:!t[e]}));}isBlockCollapsed(e){return !!this.show_block()[e]}_moveActiveLinkIntoView(){let e=this._element_ref.nativeElement.querySelector("a.active");e&&e.scrollIntoView({block:"center",behavior:"instant"});}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["app-sidebar"]],features:[Re],decls:3,vars:0,consts:[[1,"border-base-200","h-full","w-64","overflow-auto","border-r","py-2","pr-3"],["matRipple","","routerLinkActive","active",1,"hover:bg-base-200","my-1","flex","w-full","items-center","space-x-2","rounded-r-full","p-1",3,"routerLink"],[1,"text-2xl","opacity-60"],[1,"font-medium"],["matRipple","",1,"hover:bg-base-200","my-1","flex","w-full","items-center","space-x-2","rounded-r-full","p-1"],[1,"w-full","overflow-hidden"],["matRipple","",1,"hover:bg-base-200","my-1","flex","w-full","items-center","space-x-2","rounded-r-full","p-1",3,"click"],[1,"flex-1","text-left","font-medium"],[1,"text-2xl"],["routerLinkActive","active",1,"hover:bg-base-200","my-1","flex","w-full","items-center","space-x-2","rounded-r-full","p-1",3,"routerLink"]],template:function(t,r){t&1&&(ke(0,"div",0),d8(1,Su,2,1,null,null,ku),Be()),t&2&&(he(),u8(r.filtered_links()));},dependencies:[_Z,nv,uZ,xl$1,s0,mXe],styles:["[_nghost-%COMP%]{height:100%}a.active[_ngcontent-%COMP%]{background-color:var(--secondary);color:var(--secondary-content)}a.active[_ngcontent-%COMP%]:hover{color:var(--base-content);opacity:.75}"],data:{animation:[JZe]}});}}return n})();var Iu=()=>["/"],j1=(()=>{class n{constructor(){this._settings=m(Ws$1),this._theme=this._settings.theme_signal,this._logo_dark=this._settings.signal("app.logo_dark",{},true),this._logo_light=this._settings.signal("app.logo_light",{},true),this.logo_src=me(()=>{let e=this.logo();return typeof e=="string"?e:e?.src||""}),this.logo=me(()=>(this._theme()==="dark"?this._logo_dark():this._logo_light())||{}),this.user=aee();}static{this.\u0275fac=function(t){return new(t||n)};}static{this.\u0275cmp=ve({type:n,selectors:[["app-topbar"]],decls:10,vars:4,consts:[[1,"border-base-200","flex","items-center","border-b","p-2"],[1,"w-64"],[3,"routerLink"],["auth","",1,"h-12",3,"source"],[1,"flex","flex-1","items-center","justify-end","space-x-2"],["btn","","icon","","matRipple",""],[1,"text-2xl"],[1,"mr-2"],[3,"user"]],template:function(t,r){t&1&&(ke(0,"div",0)(1,"div",1)(2,"a",2),Ft(3,"img",3),Be()(),ke(4,"div",4)(5,"button",5)(6,"icon",6),mr(7,"notifications"),Be()(),ke(8,"user-controls-sidebar",7),Ft(9,"a-user-avatar",8),Be()()()),t&2&&(he(2),Dn$1("routerLink",o4(3,Iu)),he(),Dn$1("source",r.logo_src()),he(6),Dn$1("user",r.user()));},dependencies:[_Z,nv,Or,xl$1,s0,It,mXe,Ll],styles:["[_nghost-%COMP%]{width:100%}"]});}}return n})();
