...
} from "./chunk-TG3CR53U.js";
import {
  LandingStateService
} from "./chunk-556WBWYD.js";
import {
  FooterMenuComponent,
...
}, dependencies: [IconComponent, MatRippleModule, MatRipple, SafePipe, MatDialogModule, MatDialogClose], encapsulation: 2 });
var FullscreenEmbedComponent = _FullscreenEmbedComponent;
(() => {
...
var _LandingAvailableNowComponent = class _LandingAvailableNowComponent {
  constructor() {
    ...
    this.active_tab = signal("desks");
    this.active_filter = signal("nearest");
    this.levels_free = this._state.level_occupancy;
    this.features = settingSignal("features", []);
    this.feature_count = computed(() => (this.features().includes("desks") ? 1 : 0) + (this.features().includes("lockers") ? 1 : 0) + (this.features().includes("spaces") ? 1 : 0));
...
var LandingAvailableNowComponent = _LandingAvailableNowComponent;
(() => {
...
function AddColleaguesModalComponent_Conditional_18_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, AddColleaguesModalComponent_Conditional_18_Conditional_2_For_6_Template, 10, 5, "button", 21, _forTrack02);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
...
function AddColleaguesModalComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, AddColleaguesModalComponent_Conditional_20_For_5_Template, 10, 4, "div", 31, _forTrack02);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(3, 1, "APP.WORKPLACE.COLLEAGUES_SELECTED", \u0275\u0275pureFunction1(5, _c02, ctx_r2.selected_users().length), ctx_r2.selected_users().length), " ");
    \u0275\u0275advance(2);
...
var _AddColleaguesModalComponent = class _AddColleaguesModalComponent extends AsyncHandler {
  constructor() {
    super(...arguments);
    this._state = inject(LandingStateService);
    ...
    this._search_results = toSignal(this._state.search_results, {
      initialValue: []
    });
    this._loading_state = toSignal(this._state.loading, {
      initialValue: ""
    });
    this._existing_contacts = toSignal(this._state.contacts, {
      initialValue: []
    });
    this.loading_users = computed(() => !!this._loading_state());
    this.available_users = computed(() => this._search_results());
    this.existing_contacts = computed(() => this._existing_contacts());
  }
  get search_term() {
...
_AddColleaguesModalComponent.\u0275fac = /* @__PURE__ */ (() => {
...
_AddColleaguesModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddColleaguesModalComponent, selectors: [["add-colleagues-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 29, vars: 26, consts: [[1, "relative", "flex", "h-screen", "w-screen", "flex-col", "sm:h-auto", "sm:w-[32rem]"], [1, "sticky", "top-0", "z-10", "m-2", "h-14", "w-[calc(100%-1rem)]", "min-w-[20rem]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", 1, "h-10", "w-10", 3, "click"], [1, "flex-1", "overflow-auto", "p-4"], [1, "mb-4", "text-sm", "opacity-60"], ["appearance", "outline", 1, "no-subscript", "mb-4", "w-full"], ["matPrefix", "", 1, "block", "flex", "w-6", "items-center", "justify-center", "text-2xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder", "disabled"], ["matSuffix", "", "diameter", "24"], [1, "flex", "flex-col", "items-center", "justify-center", "rounded-xl", "bg-base-200", "py-16", "text-sm", "opacity-60"], [1, "mt-4", "space-y-2", "border-t", "border-base-200", "pt-4"], [1, "mt-4", "flex", "items-center", "justify-center", "space-x-2"], [1, "flex", "items-center", "justify-between", "gap-2", "border-t", "border-base-200", "p-4"], ["btn", "", "matRipple", "", 1, "inverse", "flex-1", 3, "click"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click", "disabled"], [1, "flex", "items-center", "justify-center", "py-8"], [1, "mb-4", "space-y-2"], [3, "diameter"], [1, "text-sm", "font-medium"], [1, "max-h-64", "space-y-2", "overflow-auto"], ["matRipple", "", 1, "flex", "w-full", "items-center", "space-x-2", "rounded", "border", "border-base-300", "bg-base-100", "p-2", "text-left", "hover:bg-base-200", 3, "disabled"], ["matRipple", "", 1, "flex", "w-full", "items-center", "space-x-2", "rounded", "border", "border-base-300", "bg-base-100", "p-2", "text-left", "hover:bg-base-200", 3, "click", "disabled"], [3, "user"], [1, "flex", "w-16", "flex-1", "flex-col", "leading-tight"], [1, "truncate"], [1, "truncate", "text-xs", "opacity-60"], [1, "text-xs", "opacity-60"], [1, "text-success"], [1, "opacity-30"], [1, "mb-2", "text-4xl"], [1, "bg-success/10", "flex", "items-center", "space-x-2", "rounded", "border", "border-base-300", "p-2"], ["icon", "", "matRipple", "", 3, "click", "disabled"], [1, "text-sm", "opacity-60"]], template: function AddColleaguesModalComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(28, 20, "APP.WORKPLACE.COLLEAGUES_ADD_CONFIRM", \u0275\u0275pureFunction1(24, _c02, ctx.selected_users().length), ctx.selected_users().length), " ");
  }
}, dependencies: [
  CommonModule,
  FormsModule,
...
var AddColleaguesModalComponent = _AddColleaguesModalComponent;
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddColleaguesModalComponent, { className: "AddColleaguesModalComponent", filePath: "apps/workplace/src/app/landing-new/add-colleagues-modal.component.ts", lineNumber: 250 });
})();
...
function LandingColleaguesNewComponent_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(2, 1, "COMMON.SELECTED_COUNT", \u0275\u0275pureFunction1(4, _c03, ctx_r1.selected_users().length)));
  }
}
function LandingColleaguesNewComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LandingColleaguesNewComponent_Conditional_12_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.bookDeskWithSelected());
    });
    ...
    \u0275\u0275listener("click", function LandingColleaguesNewComponent_Conditional_12_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.bookMeetingWithSelected());
    });
...
function LandingColleaguesNewComponent_Conditional_13_For_2_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 24);
  }
}
function LandingColleaguesNewComponent_Conditional_13_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("change", function LandingColleaguesNewComponent_Conditional_13_For_2_Template_mat_checkbox_change_1_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleSelection(user_r5));
    ...
    \u0275\u0275listener("click", function LandingColleaguesNewComponent_Conditional_13_For_2_Template_button_click_13_listener() {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.bookMeeting(user_r5));
    });
    ...
    \u0275\u0275listener("click", function LandingColleaguesNewComponent_Conditional_13_For_2_Template_button_click_20_listener() {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.removeColleague(user_r5));
    });
    \u0275\u0275elementStart(21, "div", 21)(22, "icon", 23);
    \u0275\u0275text(23, "person_remove");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div");
    \u0275\u0275text(25);
    \u0275\u0275pipe(26, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(27, LandingColleaguesNewComponent_Conditional_13_For_2_Conditional_27_Template, 1, 0, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("border-secondary", ctx_r1.isSelected(user_r5));
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r1.isSelected(user_r5));
    \u0275\u0275advance();
    \u0275\u0275property("user", user_r5);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(user_r5.name);
    \u0275\u0275advance();
    \u0275\u0275property("href", "mailto:" + user_r5.email, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(user_r5.email);
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", menu_r6);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 11, "APP.WORKPLACE.COLLEAGUES_BOOK_MEETING"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(26, 13, "APP.WORKPLACE.COLLEAGUES_REMOVE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.isSelected(user_r5) ? 27 : -1);
  }
}
function LandingColleaguesNewComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6);
    \u0275\u0275repeaterCreate(1, LandingColleaguesNewComponent_Conditional_13_For_2_Template, 28, 15, "div", 12, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
...
var _LandingColleaguesNewComponent = class _LandingColleaguesNewComponent {
  constructor() {
    this._state = inject(LandingStateService);
...
_LandingColleaguesNewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingColleaguesNewComponent, selectors: [["landing-colleagues-new"]], decls: 21, vars: 19, consts: [["menu", "matMenu"], [1, "rounded-lg", "border", "border-base-300", "bg-base-100", "p-4"], [1, "mb-2", "flex", "items-center", "justify-between"], [1, "text-lg", "font-medium"], [1, "rounded", "px-2", "py-1", "text-xs", "opacity-60"], [1, "mt-2", "flex", "space-x-2"], [1, "mt-2", "flex", "w-full", "flex-col", "space-y-2"], [1, "flex", "h-48", "w-full", "flex-col", "items-center", "justify-center", "space-y-2", "rounded-xl", "bg-base-200", "p-8"], ["btn", "", "matRipple", "", 1, "mt-4", "w-full", 3, "click"], [1, "text-xl"], ["btn", "", "matRipple", "", 1, "flex-1", "space-x-2", "text-sm", 3, "click"], [1, "text-lg"], [1, "relative", "flex", "items-center", "space-x-2", "overflow-hidden", "rounded", "border", "border-base-300", "p-2", 3, "border-secondary"], [1, "relative", "flex", "items-center", "space-x-2", "overflow-hidden", "rounded", "border", "border-base-300", "p-2"], [1, "-mx-1", 3, "change", "click", "checked"], [3, "user"], [1, "flex", "w-16", "flex-1", "flex-col", "leading-tight"], [1, "truncate"], ["target", "_blank", "rel", "noopener noreferrer", 1, "truncate", "text-xs", "underline", "opacity-60", 3, "href"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "text-2xl", "text-error"], [1, "absolute", "inset-0", "!m-0", "bg-secondary", "opacity-10"], ["src", "assets/icons/no-contacts.svg"], [1, "text-center", "text-sm", "opacity-60"]], template: function LandingColleaguesNewComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LandingColleaguesNewComponent_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.openAddColleaguesModal());
    });
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    const contact_list_r8 = \u0275\u0275storeLet(\u0275\u0275pipeBind1(2, 6, ctx.contacts));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 9, "APP.WORKPLACE.COLLEAGUES"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.selected_users().length > 0 ? 8 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind3(11, 11, "APP.WORKPLACE.COLLEAGUES_COUNT", \u0275\u0275pureFunction1(17, _c03, contact_list_r8 == null ? null : contact_list_r8.length), contact_list_r8 == null ? null : contact_list_r8.length));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.selected_users().length > 0 ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((contact_list_r8 == null ? null : contact_list_r8.length) ? 13 : 14);
    \u0275\u0275advance(6);
...
var LandingColleaguesNewComponent = _LandingColleaguesNewComponent;
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingColleaguesNewComponent, { className: "LandingColleaguesNewComponent", filePath: "apps/workplace/src/app/landing-new/landing-colleagues-new.component.ts", lineNumber: 179 });
})();
...
function LandingDeskWeekComponent_For_26_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, LandingDeskWeekComponent_For_26_Conditional_10_For_1_Template, 11, 3, "button", 23, _forTrack03);
  }
  if (rf & 2) {
...
function LandingDeskWeekComponent_For_29_Conditional_0_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, LandingDeskWeekComponent_For_29_Conditional_0_Conditional_10_For_1_Template, 11, 3, "button", 23, _forTrack03);
  }
  if (rf & 2) {
...
function LandingDeskWeekComponent_For_32_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, LandingDeskWeekComponent_For_32_Conditional_10_For_1_Template, 11, 3, "button", 23, _forTrack03);
  }
  if (rf & 2) {
...
var _LandingDeskWeekComponent = class _LandingDeskWeekComponent extends AsyncHandler {
  constructor() {
    super(...arguments);
    this._dialog = inject(MatDialog);
    this._org = inject(OrganisationService);
    ...
    this.loading = signal(false);
    this.selected_date = signal(Date.now());
    ...
    this.weekend_days = computed(() => this.weekdays().filter((day) => day.is_weekend));
...
_LandingDeskWeekComponent.\u0275fac = /* @__PURE__ */ (() => {
...
_LandingDeskWeekComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingDeskWeekComponent, selectors: [["landing-desk-week"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 33, vars: 24, consts: [[1, "border-base-300", "bg-base-100", "space-y-2", "rounded-lg", "border", "p-4"], [1, "flex", "flex-col", "gap-2", "md:flex-row", "md:items-center", "md:justify-between"], [1, "px-2", "text-lg", "font-medium"], [1, "px-2", "text-sm", "opacity-60"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "h-8", "text-sm", 3, "click", "disabled"], ["btn", "", "matRipple", "", 1, "inverse", "h-8", "text-sm", 3, "click", "disabled"], [1, "flex", "items-center"], ["icon", "", "matRipple", "", 1, "hover:bg-base-200", "h-12", "w-12", "rounded-lg", 3, "click", "matTooltip"], [1, "text-2xl"], [1, "flex", "flex-col", "gap-2", "pt-2", "md:hidden"], [1, "flex", "flex-col"], [1, "hidden", "gap-2", "pt-2", "md:grid", "md:grid-cols-6"], [1, "flex", "flex-col", "space-y-1"], [1, "flex", "flex-1", "flex-col"], [1, "mb-1", "flex", "items-center", "justify-center", "space-x-2", "text-sm"], [1, "flex", "items-center", "space-x-1"], [1, "text-base"], [1, "font-medium", "uppercase"], [1, "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full", "text-xs"], [1, "border-base-300", "min-h-16", "flex-1", "rounded-lg", "border", "p-2"], ["btn", "", "matRipple", "", 1, "inverse", "border-base-300", "h-full", "w-full", "space-x-2", "border-2", "border-dashed"], [1, "flex", "h-full", "min-h-10", "w-full", "items-center", "justify-center"], ["matRipple", "", 1, "bg-secondary", "text-secondary-content", "mb-2", "w-full", "rounded-lg", "p-2", "text-left", "last:mb-0", 3, "matTooltip"], ["matRipple", "", 1, "bg-secondary", "text-secondary-content", "mb-2", "w-full", "rounded-lg", "p-2", "text-left", "last:mb-0", 3, "click", "matTooltip"], [1, "text-sm"], [1, "truncate", "text-xs"], ["btn", "", "matRipple", "", 1, "inverse", "border-base-300", "h-full", "w-full", "space-x-2", "border-2", "border-dashed", 3, "click"], [1, "text-xl", "opacity-60"], [1, "text-xs", "opacity-60"], [1, "text-xl", "opacity-30"], [1, "border-base-300", "flex", "min-h-24", "flex-1", "flex-col", "space-y-2", "rounded-lg", "border", "p-2"], ["btn", "", "matRipple", "", 1, "inverse", "border-base-300", "h-full", "w-full", "flex-col", "space-y-1", "border-2", "border-dashed"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center"], ["btn", "", "matRipple", "", 1, "inverse", "border-base-300", "h-full", "w-full", "flex-col", "space-y-1", "border-2", "border-dashed", 3, "click"], [1, "text-base", "opacity-40"], [1, "border-base-300", "bg-base-200", "flex", "min-h-12", "flex-1", "flex-col", "space-y-2", "rounded-lg", "border", "p-2"]], template: function LandingDeskWeekComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(25, LandingDeskWeekComponent_For_26_Template, 13, 16, "div", 11, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 12);
    \u0275\u0275repeaterCreate(28, LandingDeskWeekComponent_For_29_Template, 1, 1, null, null, _forTrack03);
    \u0275\u0275elementStart(30, "div", 13);
    \u0275\u0275repeaterCreate(31, LandingDeskWeekComponent_For_32_Template, 12, 11, "div", 14, _forTrack03);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(4);
...
var LandingDeskWeekComponent = _LandingDeskWeekComponent;
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingDeskWeekComponent, { className: "LandingDeskWeekComponent", filePath: "apps/workplace/src/app/landing-new/landing-desk-week.component.ts", lineNumber: 404 });
})();
...
function LandingFavouritesNewComponent_Conditional_8_For_2_Conditional_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_r2 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 1, "APP.WORKPLACE.CAPACITY", \u0275\u0275pureFunction1(4, _c04, item_r2.capacity)), " ");
  }
}
...
function LandingFavouritesNewComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, LandingFavouritesNewComponent_Conditional_8_For_2_Template, 23, 12, "div", 6, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var _LandingFavouritesNewComponent = class _LandingFavouritesNewComponent {
  constructor() {
    ...
    this.all_desks = toSignal(this._booking_form.loadResourceList("desks"), { initialValue: [] });
    this.all_parking = toSignal(this._booking_form.loadResourceList("parking-spaces"), { initialValue: [] });
    this.all_lockers = toSignal(this._booking_form.loadResourceList("lockers"), { initialValue: [] });
...
_LandingFavouritesNewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingFavouritesNewComponent, selectors: [["landing-favourites-new"]], features: [\u0275\u0275ProvidersFeature([ExploreSpacesService])], decls: 10, vars: 11, consts: [[1, "flex", "flex-col", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-4"], [1, "mb-2"], [1, "text-lg", "font-medium"], [1, "text-sm"], [1, "grid", "min-h-64", "w-full", "grid-cols-1", "gap-2", "sm:grid-cols-2", "lg:grid-cols-3"], [1, "flex", "min-h-64", "w-full", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "rounded-xl", "bg-base-200", "p-8"], [1, "relative", "flex", "h-[8.5rem]", "flex-col", "space-y-2", "rounded", "border", "border-base-300", "bg-base-100", "p-2"], [1, "flex", "space-x-2"], [1, "relative", "flex", "h-16", "w-16", "items-center", "justify-center", "overflow-hidden", "rounded", "bg-base-300"], ["auth", "", 1, "absolute", "left-1/2", "top-1/2", "min-h-full", "min-w-full", "-translate-x-1/2", "-translate-y-1/2", "object-cover", 3, "source"], [1, "m-auto", 3, "src"], [1, "flex", "flex-1", "flex-col", "justify-center", "space-y-1", "leading-tight"], [1, "w-full", "truncate", "pr-8"], [1, "flex", "items-center", "space-x-1", "text-xs", "opacity-60"], [1, "text-blue-500"], [1, "flex-1", "truncate"], [1, "flex", "items-center", "space-x-1", "truncate", "text-xs", "opacity-60"], ["icon", "", "matRipple", "", "name", "remove-favourite", 1, "absolute", "right-1", "top-1", 3, "click", "matTooltip"], [1, "text-error"], ["btn", "", "matRipple", "", "name", "book-favourite", 1, "inverse", "w-full", 3, "click"], ["src", "assets/icons/no-favourites.svg"], [1, "text-center", "text-sm", "opacity-60"]], template: function LandingFavouritesNewComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(7, 5, "APP.WORKPLACE.FAVOURITES_COUNT", \u0275\u0275pureFunction1(9, _c04, ctx.favourites().length), ctx.favourites().length), " ");
    \u0275\u0275advance(2);
...
var LandingFavouritesNewComponent = _LandingFavouritesNewComponent;
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingFavouritesNewComponent, { className: "LandingFavouritesNewComponent", filePath: "apps/workplace/src/app/landing-new/landing-favourites-new.component.ts", lineNumber: 163 });
})();
...
function LandingQuickActionsComponent_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c05));
  }
}
...
var _LandingQuickActionsComponent = class _LandingQuickActionsComponent {
  constructor() {
    this._dialog = inject(MatDialog);
    this._router = inject(Router);
    this.features = settingSignal("features", []);
...
var LandingQuickActionsComponent = _LandingQuickActionsComponent;
(() => {
...
function LandingUpcomingBookingComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LandingUpcomingBookingComponent_Conditional_0_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(31, "edit");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div", 15)(33, "button", 20);
    \u0275\u0275listener("click", function LandingUpcomingBookingComponent_Conditional_0_Template_button_click_33_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.viewDetails());
    });
    \u0275\u0275elementStart(34, "icon", 17);
    \u0275\u0275text(35, "info");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 18);
    \u0275\u0275text(37, "View Details");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "button", 21);
    \u0275\u0275listener("click", function LandingUpcomingBookingComponent_Conditional_0_Template_button_click_38_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.remove());
    });
    \u0275\u0275elementStart(39, "icon", 17);
    \u0275\u0275text(40, "delete");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "a", 22)(42, "icon", 17);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 10, "CALENDAR_EVENT.GROUP_FEATURED"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx_r1.canCheckin());
    \u0275\u0275advance(17);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(14, _c06));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(46, 12, "APP.WORKPLACE.UPCOMING_VIEW_BOOKINGS"), " ");
  }
}
...
var _LandingUpcomingBookingComponent = class _LandingUpcomingBookingComponent extends AsyncHandler {
  constructor() {
    super(...arguments);
    this._state = inject(LandingStateService);
    this._schedule = inject(ScheduleStateService);
...
_LandingUpcomingBookingComponent.\u0275fac = /* @__PURE__ */ (() => {
...
_LandingUpcomingBookingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingUpcomingBookingComponent, selectors: [["landing-upcoming-booking"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [[1, "bg-grad", "col-span-2", "space-y-2", "rounded-lg", "border", "border-base-300", "p-4", "text-brand-content"], [1, "bg-grad", "col-span-2", "flex", "min-h-48", "flex-col", "items-start", "justify-center", "space-y-2", "rounded-lg", "border", "border-base-300", "p-4", "text-brand-content"], [1, "flex", "w-full", "items-center", "justify-between"], [1, "relative", "overflow-hidden", "rounded", "px-2", "py-1", "text-sm", "capitalize"], [1, "absolute", "inset-0", "bg-brand-content", "opacity-20"], [1, "flex", "w-48", "items-center", "space-x-2", "px-2", "text-center"], [1, "flex", "min-w-48", "items-center", "space-x-2", "px-2", "text-center"], [1, "flex", "w-full", "flex-col", "items-center", "justify-between", "space-y-2", "sm:flex-row", "sm:space-y-0"], [1, "w-full", "sm:flex-1"], [1, "text-2xl", "font-medium"], [1, "mb-2", "text-lg", "font-medium"], [1, "mb-1", "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "w-full", "flex-col", "items-end", "space-y-2", "sm:flex-1"], [1, "flex", "w-full", "items-center", "space-x-2", "sm:w-56"], ["btn", "", "matRipple", "", 1, "white", "flex-1", "space-x-2", 3, "click", "disabled"], [1, "text-2xl"], [1, "pr-2"], ["btn", "", "matRiple", "", "matTooltip", "Edit Booking", "matTooltipPosition", "left", 1, "white", "inverse", "h-12", "w-12", "px-0", 3, "click"], ["btn", "", "matRipple", "", 1, "inverse", "white", "flex", "flex-1", "space-x-2", 3, "click"], ["btn", "", "matRiple", "", "matTooltip", "Delete Booking", "matTooltipPosition", "left", 1, "white", "inverse", "h-12", "w-12", "px-0", 3, "click"], ["btn", "", "matRipple", "", 1, "inverse", "white", "w-full", "space-x-2", "sm:w-56", 3, "routerLink"], [1, "relative", "overflow-hidden", "rounded", "px-2", "py-1", "text-sm"], [1, "capitalize"], [1, "text-3xl", "font-medium"], [1, "text-base", "opacity-90"], [1, "flex", "w-full", "flex-wrap", "gap-3", "pt-2"], [1, "flex", "w-full", "flex-wrap", "gap-3", "sm:w-auto"], ["btn", "", "matRipple", "", 1, "white", "sm:flex-0", "min-w-48", "flex-1", "space-x-2", "sm:w-48", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "inverse", "white", "sm:flex-0", "min-w-48", "flex-1", "space-x-2", "sm:w-48", 3, "routerLink"], [1, "hidden", "w-px", "flex-1", "sm:block"], ["btn", "", "matRipple", "", 1, "inverse", "white", "w-full", "space-x-2", "sm:w-52", 3, "routerLink"]], template: function LandingUpcomingBookingComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, LandingUpcomingBookingComponent_Conditional_0_Template, 47, 15, "div", 0)(1, LandingUpcomingBookingComponent_Conditional_1_Template, 24, 9, "div", 1);
  }
  if (rf & 2) {
    let tmp_0_0;
...
var LandingUpcomingBookingComponent = _LandingUpcomingBookingComponent;
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingUpcomingBookingComponent, { className: "LandingUpcomingBookingComponent", filePath: "apps/workplace/src/app/landing-new/landing-upcoming-booking.component.ts", lineNumber: 232 });
})();
...
var _LandingNewComponent = class _LandingNewComponent extends AsyncHandler {
  constructor() {
    super(...arguments);
    this._state = inject(LandingStateService);
    this._dialog = inject(MatDialog);
...
_LandingNewComponent.\u0275fac = /* @__PURE__ */ (() => {
...
var LandingNewComponent = _LandingNewComponent;
(() => {
...
//# sourceMappingURL=landing-new.component-RXEZM63A.js.map
