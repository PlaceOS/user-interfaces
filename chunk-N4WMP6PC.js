...
var WFHSettingsModalComponent = class _WFHSettingsModalComponent {
  ...
  async saveChanges(close = true) {
    ...
    if (!this._data?.local) {
      try {
        const user = await Va("current");
        await Xa(user.id, __spreadProps(__spreadValues({}, user), {
...
//# debugId=a2dd28a7-bd39-57c6-9fd7-187b10e3c873
//# sourceMappingURL=chunk-N4WMP6PC.js.map
