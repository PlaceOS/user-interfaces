...
var UploadButtonComponent = class _UploadButtonComponent {
  constructor() {
    ...
    this.types = input(["image"], ...ngDevMode ? [{ debugName: "types" }] : (
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UploadButtonComponent, { className: "UploadButtonComponent", filePath: "apps/concierge/src/app/ui/app-settings/upload-button.component.ts", lineNumber: 44 });
})();

export {
  UploadButtonComponent
};
//# sourceMappingURL=chunk-CSCDIJVD.js.map
