...
_ApplicationTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApplicationTopbarComponent, selectors: [["app-topbar"]], decls: 10, vars: 4, consts: [[1, "border-base-200", "flex", "items-center", "border-b", "p-2"], [1, "w-64"], [3, "routerLink"], ["auth", "", "alt", "Home", 1, "h-12", 3, "source"], [1, "flex", "flex-1", "items-center", "justify-end", "space-x-2"], ["btn", "", "icon", "", "matRipple", "", "aria-label", "Notifications"], [1, "text-2xl"], [1, "mr-2"], [3, "user"]], template: function ApplicationTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-TYEIOTTY.js.map
