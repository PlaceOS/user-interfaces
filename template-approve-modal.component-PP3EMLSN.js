...
var TemplateApproveModalComponent = class _TemplateApproveModalComponent {
  ...
  async undoChanges() {
    ...
    try {
      await ml(this._data.template.id);
  ...
  async approve() {
    ...
    this._dialog_ref.disableClose = true;
    try {
      const template = await yl(this._data.template.id);
...
//# debugId=34ac8d42-28b3-5cdf-b95d-5c7920646b58
//# sourceMappingURL=template-approve-modal.component-PP3EMLSN.js.map
