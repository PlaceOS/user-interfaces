...
var _ScheduleDayViewComponent = class _ScheduleDayViewComponent extends AsyncHandler {
  constructor() {
    super();
    ...
    this._changed = signal(0);
    this.scrollContainer = viewChild("scrollContainer");
    this.currentTimeMarker = viewChild("currentTimeMarker");
    this.START_HOUR = 0;
    this.END_HOUR = 23;
    this.HOUR_HEIGHT = 64;
...
_ScheduleDayViewComponent.\u0275fac = function ScheduleDayViewComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ScheduleDayViewComponent)();
};
_ScheduleDayViewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleDayViewComponent, selectors: [["schedule-day-view"]], viewQuery: function ScheduleDayViewComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx.scrollContainer, _c0, 5);
    \u0275\u0275viewQuerySignal(ctx.currentTimeMarker, _c1, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance(2);
  }
...
}, dependencies: [CommonModule, AsyncPipe, DatePipe, MatRippleModule, MatRipple, MatTooltipModule, MatTooltip, UserPipe], encapsulation: 2 });
var ScheduleDayViewComponent = _ScheduleDayViewComponent;
(() => {
...
}, dependencies: [CommonModule, TranslatePipe, IconComponent, MatRippleModule, MatRipple], encapsulation: 2 });
...
var _ScheduleListViewComponent = class _ScheduleListViewComponent {
  constructor() {
    this._state = inject(ScheduleStateService);
    this.date = input(Date.now());
    this.end_date = input(null);
    this.bookings = input([]);
    this.loading = input(false);
...
var ScheduleListViewComponent = _ScheduleListViewComponent;
(() => {
...
var _ScheduleSidebarComponent = class _ScheduleSidebarComponent extends AsyncHandler {
  constructor() {
    ...
    this._settings = inject(SettingsService);
    this.filters = this._state.filters;
    this.date = computed(() => startOfDay(this._state.date()));
...
var _ScheduleTopbarComponent = class _ScheduleTopbarComponent {
  constructor() {
    this.view = model("list");
    this.date = model(Date.now());
    this.end_date = model(null);
...
_ScheduleTopbarComponent.\u0275fac = function ScheduleTopbarComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ScheduleTopbarComponent)();
};
_ScheduleTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleTopbarComponent, selectors: [["schedule-topbar"]], inputs: { view: [1, "view"], date: [1, "date"], end_date: [1, "end_date"] }, outputs: { view: "viewChange", date: "dateChange", end_date: "end_dateChange" }, decls: 21, vars: 36, consts: [[1, "flex", "w-full", "flex-col", "items-center", "justify-between", "space-y-2", "border-b", "border-base-300", "bg-base-100", "p-2", "sm:flex-row", "sm:space-x-2", "sm:space-y-0"], ["date", "", 1, "flex", "w-full", "items-center", "space-x-2", "sm:w-auto"], ["btn", "", "matRipple", "", 1, "inverse", "min-h-11", 3, "click"], [1, "rounded-lg", "border", "border-base-300", "px-2", "py-1", "text-xs"], ["view", "", 1, "flex", "w-full", "space-x-1", "rounded-xl", "border", "border-base-300", "bg-base-200", "p-1", "sm:w-auto"], ["btn", "", "matRipple", "", 1, "min-h-10", "flex-1", "hover:bg-base-300", 3, "click", "routerLink", "queryParams"], ["btn", "", "matRipple", "", 1, "inverse", "min-h-11", "min-w-11", "p-0", 3, "click"], [1, "text-2xl"]], template: function ScheduleTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [CommonModule, DatePipe, TranslatePipe, IconComponent, RouterModule, RouterLink], encapsulation: 2 });
var ScheduleTopbarComponent = _ScheduleTopbarComponent;
(() => {
...
var _ScheduleWeekViewComponent = class _ScheduleWeekViewComponent {
  constructor() {
    this._dialog = inject(MatDialog);
    this._state = inject(ScheduleStateService);
    this._org = inject(OrganisationService);
    ...
    this.loading = input(false);
    this.colors = BOOKING_TYPE_COLORS;
    this._scroll_container = viewChild("scrollContainer");
...
_ScheduleWeekViewComponent.\u0275fac = function ScheduleWeekViewComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ScheduleWeekViewComponent)();
};
_ScheduleWeekViewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleWeekViewComponent, selectors: [["schedule-week-view"]], viewQuery: function ScheduleWeekViewComponent_Query(rf, ctx) {
  if (rf & 1) {
...
var ScheduleWeekViewComponent = _ScheduleWeekViewComponent;
(() => {
...
//# sourceMappingURL=schedule.module-OL4KSGDN.js.map
