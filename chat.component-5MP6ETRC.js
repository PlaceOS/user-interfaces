...
var _DateFromPipe = class _DateFromPipe {
  transform(date) {
    const now = Date.now();
...
_DateFromPipe.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "dateFrom", type: _DateFromPipe, pure: true });
var DateFromPipe = _DateFromPipe;
(() => {
...
var _ChatComponent = class _ChatComponent extends AsyncHandler {
  toggleChat() {
  ...
  constructor() {
    ...
    this.waiting = computed(
      () => {
        ...
        return (msgs == null ? void 0 : msgs.length) !== 0 && ((_a = msgs == null ? void 0 : msgs[(msgs == null ? void 0 : msgs.length) - 1]) == null ? void 0 : _a.user_id) === this.user().id;
      },
  ...
  scrollToBottom(delay = 300) {
    this.timeout("scroll", () => {
      ...
      if (_container_el == null ? void 0 : _container_el.nativeElement) {
...
_ChatComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatComponent, selectors: [["global-chat"]], viewQuery: function ChatComponent_Query(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chat.component-5MP6ETRC.js.map
