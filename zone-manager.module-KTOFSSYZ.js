...
var _AppSettingsModalComponent = class _AppSettingsModalComponent {
  ...
  async ngOnInit() {
    ...
    const zone_settings = (await Pu(this.zone.id, `${this.workplace_key}`).toPromise().catch(() => ({ details: {} }))).details;
    const parent_settings = (await Pu(this.zone.parent_id, `${this.workplace_key}`).toPromise().catch(() => ({ details: {} }))).details;
    const org_settings = (await Pu(this._org.organisation.id, `${this.workplace_key}`).toPromise().catch(() => ({ details: {} }))).details;
...
_AppSettingsModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppSettingsModalComponent, selectors: [["app-settings-modal"]], decls: 8, vars: 4, consts: [[1, "flex", "h-screen", "w-screen", "flex-col", "bg-base-100"], [1, "sticky", "top-0", "z-10", "mx-auto", "w-full", "max-w-[640px]", "border-none", "px-0", "py-2"], [1, "text-2xl", "font-medium"], [1, "z-0", "h-1/2", "flex-1", "space-y-2", "overflow-auto", "p-2", 3, "formGroup"], [1, "z-0", "flex", "h-1/2", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "overflow-auto", "p-2"], [1, "sticky", "bottom-0", "z-10", "mx-auto", "flex", "w-full", "max-w-[640px]", "items-center", "justify-end", "space-x-2", "bg-base-100", "p-2"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "right-2", "top-2"], [1, "mx-auto", "w-full", "max-w-[640px]"], [1, "text-lg", "font-medium"], [1, "-mx-2", "flex", "flex-wrap", "items-center", "py-2"], ["matRipple", "", 1, "m-2", "flex", "w-[calc(50%-1rem)]", "items-center", "space-x-2", "border", "border-base-200", "p-2", 3, "click"], [1, "ml-2", "flex-1", "text-left"], [1, "pointer-events-none", 3, "ngModel", "ngModelOptions"], ["matRipple", "", 1, "m-2", "flex", "w-[calc(50%-1rem)]", "items-center", "space-x-2", "border", "border-base-200", "p-2"], ["formGroupName", "events"], ["formGroupName", "desks"], [1, "pointer-events-none", 3, "formControlName"], [3, "diameter"], ["btn", "", "matRipple", "", "mat-dialog-close", "", 1, "inverse", "w-32"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function AppSettingsModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [ReactiveFormsModule, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, FormGroupName, MatRippleModule, MatRipple, MatDialogModule, MatDialogClose, MatProgressSpinnerModule, MatProgressSpinner, MatCheckboxModule, MatCheckbox], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppSettingsModalComponent, { className: "AppSettingsModalComponent", filePath: "apps/concierge/src/app/ui/app-settings-modal.component.ts", lineNumber: 234 });
})();
...
function getAliasCount(doc, node, anchors) {
  if (isAlias(node)) {
    ...
    const vc2 = getAliasCount(doc, node.value, anchors);
    return Math.max(kc, vc2);
  }
  return 1;
}
...
var _AutoReleaseSettingsModalComponent = class _AutoReleaseSettingsModalComponent {
  ...
  async loadSettings(id) {
    ...
    this.settings = { custom: [] };
    const settings = await nextValueFrom(gc({ parent_id: id }).pipe(map((_) => _.data)));
  ...
  async save() {
    ...
    const settings = await lastValueFrom(gc({ parent_id: this.id }).pipe(map((_) => _.data)));
    ...
    unencrypted.id ? await lastValueFrom(vc(unencrypted.id, unencrypted)).catch(on_error) : await lastValueFrom(Sc(unencrypted)).catch(on_error);
    const metadata_key = this._settings.get("app.workplace_metadata_key") || "workplace_app";
    const metadata = await lastValueFrom(Pu(this.id, metadata_key));
    const details = metadata.details || {};
    details.auto_release = new_settings;
    await nextValueFrom(Tu(this.id, {
      name: metadata_key,
      details,
      description: ""
    })).catch(on_error);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AutoReleaseSettingsModalComponent, { className: "AutoReleaseSettingsModalComponent", filePath: "apps/concierge/src/app/building-manager/auto-release-settings-modal.component.ts", lineNumber: 266 });
})();
...
var _BuildingFormComponent = class _BuildingFormComponent extends AsyncHandler {
  ...
  async saveChanges() {
    ...
    const body = __spreadProps(__spreadValues({}, data), {
      tags: ["building"],
      name: `BLD ${kt().description} ${data.display_name}`
    });
    const building = await (data.id ? ia(data.id, body) : oa(body)).toPromise().catch((e) => {
...
_BuildingModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BuildingModalComponent, selectors: [["building-modal"]], decls: 5, vars: 11, consts: [[3, "confirm", "heading", "loading"], [3, "loadingChange", "done", "building", "save", "loading"]], template: function BuildingModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildingModalComponent, { className: "BuildingModalComponent", filePath: "apps/concierge/src/app/building-manager/building-modal.component.ts", lineNumber: 44 });
})();
...
var _InductionSettingsModalComponent = class _InductionSettingsModalComponent {
  ...
  async loadSettings() {
    ...
    const [bld_metadata, org_metadata, org_settings] = await Promise.all([
      await lastValueFrom(Pu(this._zone_id, visitor_kiosk_app)),
      await lastValueFrom(Pu(this._org.organisation.id, visitor_kiosk_app)),
      await lastValueFrom(Pu(this._org.organisation.id, "settings"))
    ]);
  ...
  async save() {
    ...
    this._dialog_ref.disableClose = true;
    const metadata = await lastValueFrom(Pu(this._zone_id, visitor_kiosk_app));
    const con_metadata = await lastValueFrom(Pu(this._zone_id, concierge_app));
    ...
    const result_visitor = await lastValueFrom(Tu(this._zone_id, {
    ...
    const result_concierge = await lastValueFrom(Tu(this._zone_id, {
...
_InductionSettingsModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InductionSettingsModalComponent, selectors: [["induction-settings-modal"]], decls: 8, vars: 6, consts: [[1, "m-2", "flex", "h-14", "w-[calc(100%-1rem)]", "items-center", "justify-between", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "flex-col", "space-y-2", "px-4"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-32"], [1, "mt-2", "flex", "justify-end", "border-t", "border-base-200", "px-4", "py-2"], [1, "text-2xl"], [3, "ngModelChange", "ngModel", "name"], ["appearance", "outline", 1, "h-[50vh]", "w-[36rem]", "max-w-[80vw]"], ["matInput", "", 1, "h-[calc(50vh-2rem)]", "w-[34rem]", "max-w-[calc(80vw-2rem)]", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function InductionSettingsModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "header", 0)(1, "h3", 1);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
...
var _ItemListModalComponent = class _ItemListModalComponent {
  ...
  async ngOnInit() {
    const metadata_key = this._settings.get("app.workplace_metadata_key") || "workplace_app";
    const metadata = await Pu(this._bld_id, metadata_key).toPromise();
  ...
  async save() {
    ...
    let resp = await Tu(this._bld_id, {
      name: metadata_key,
    ...
    const concierge_metadata = await Pu(this._bld_id, metadata_key).toPromise();
    concierge_metadata.details.support_issue_types = items;
    resp = await Tu(this._bld_id, {
      name: concierge_key,
...
_ItemListModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ItemListModalComponent, selectors: [["item-list-modal"]], decls: 16, vars: 6, consts: [["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-[50vh]", "w-[36rem]", "space-y-2", "overflow-auto", "p-2"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "flex", "items-center", "justify-end", "border-t", "border-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["type", "text", 1, "flex-1", "rounded", "border", "border-base-200", "px-4", "py-3", 3, "ngModelChange", "placeholder", "ngModel"], ["type", "email", 1, "flex-[2]", "rounded", "border", "border-base-200", "px-4", "py-3", 3, "ngModelChange", "placeholder", "ngModel"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-error", "text-error", 3, "click", "matTooltip"], [1, "text-2xl"]], template: function ItemListModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ItemListModalComponent, { className: "ItemListModalComponent", filePath: "apps/concierge/src/app/building-manager/item-list-modal.component.ts", lineNumber: 79 });
})();
...
var _BuildingManagementService = class _BuildingManagementService {
  ...
  editBuildingMetadata(zone = new vn()) {
  ...
  async removeBuilding(building) {
    ...
    await sa(building.id).toPromise().catch((e) => {
...
var _BookingPanelSettingsModalComponent = class _BookingPanelSettingsModalComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    ...
    const settings = await lastValueFrom(gc({ parent_id: this.zone.id }).pipe(catchError(() => of({ data: [] })), map((_) => _.data)));
    const unencrypted_settings = settings.find((block) => block.encryption_level === Te.None);
  ...
  async save() {
    ...
    const settings = await lastValueFrom(gc({ parent_id: this.zone.id }).pipe(catchError(() => of({ data: [] })), map((_) => _.data)));
    let unencrypted_settings = settings.find((block) => block.encryption_level === Te.None);
    if (!unencrypted_settings)
      unencrypted_settings = new Se({
        encryption_level: Te.None
      });
    const setting_value = parse(unencrypted_settings.settings_string) || {};
    ...
    const update = unencrypted_settings.id ? vc(unencrypted_settings.id, new_setting) : Sc(new_setting);
...
var _ConciergeSettingsFormModalComponent = class _ConciergeSettingsFormModalComponent {
  ...
  async save() {
    ...
    await lastValueFrom(Tu(zone.id, {
  ...
  _getMetadata(id) {
    return lastValueFrom(Pu(id, this.settings_key).pipe(map((m) => m.details)));
  }
};
...
function VisitorKioskSettingsFormModalComponent_Conditional_135_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 50)(1, "div", 52)(2, "mat-form-field", 5)(3, "input", 53);
    \u0275\u0275twoWayListener("ngModelChange", function VisitorKioskSettingsFormModalComponent_Conditional_135_For_4_Template_input_ngModelChange_3_listener($event) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function VisitorKioskSettingsFormModalComponent_Conditional_135_For_4_Template_input_ngModelChange_5_listener($event) {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
    ...
    \u0275\u0275listener("click", function VisitorKioskSettingsFormModalComponent_Conditional_135_For_4_Template_button_click_6_listener() {
      const \u0275$index_233_r4 = \u0275\u0275restoreView(_r2).$index;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.removeLegend(\u0275$index_233_r4));
    });
...
function VisitorKioskSettingsFormModalComponent_Conditional_135_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 42)(1, "h3", 22);
    \u0275\u0275text(2, " Legend ");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, VisitorKioskSettingsFormModalComponent_Conditional_135_For_4_Template, 9, 6, "div", 50, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(5, "button", 51);
    \u0275\u0275listener("click", function VisitorKioskSettingsFormModalComponent_Conditional_135_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r1);
...
_VisitorKioskSettingsFormModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorKioskSettingsFormModalComponent, selectors: [["visitor-kiosk-settings-form-modal"]], decls: 144, vars: 11, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-8", 3, "formGroup"], ["general", "", 1, "space-y-2", "rounded", "bg-base-100"], ["for", "logo_light"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "logo_light", "formControlName", "logo_light"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions"], ["for", "logo_dark"], ["matInput", "", "name", "logo_dark", "formControlName", "logo_dark"], ["for", "welcome-background"], ["matInput", "", "name", "welcome-background", "formControlName", "welcome_background"], ["for", "default-route"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "welcome-message", "formControlName", "welcome_message", "placeholder", "Welcome to PlaceOS Self Service Kiosk"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Enable Induction", "formControlName", "induction_enabled"], ["name", "Induction after Confirm Details", "formControlName", "induction_after_details"], ["name", "Allow Self Registration", "formControlName", "allow_self_registration"], ["name", "Allow setting visitor pass number", "formControlName", "allow_pass_number"], ["name", "Allow Printing Label", "formControlName", "allow_printing_label"], ["explore", "", "formGroupName", "explore", 1, "relative", "rounded", "border", "border-base-300", "px-4", "pb-2", "pt-4"], [1, "absolute", "left-4", "top-0", "-translate-y-1/2", "rounded", "bg-base-100", "px-2", "py-1", "font-medium"], ["for", "disable"], ["name", "disable", "formControlName", "disable", "placeholder", "No disabled features", "multiple", ""], ["value", "devices"], ["value", "desks"], ["value", "lockers"], ["value", "parking"], ["value", "spaces"], ["value", "spaces-presence"], ["value", "zones"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], ["for", "disable-actions"], ["name", "disable-actions", "formControlName", "disable_actions", "placeholder", "No disabled actions", "multiple", ""], ["for", "available-period"], ["name", "disable-labels", "formControlName", "disable_labels", "placeholder", "No disabled labels", "multiple", ""], ["for", "disable-features"], ["name", "disable-features", "formControlName", "disable_features", "placeholder", "No disabled displays", "multiple", ""], ["for", "disable-styles"], ["name", "disable-styles", "formControlName", "disable_styles", "placeholder", "No disabled styles", "multiple", ""], [1, "relative", "rounded", "border", "border-base-300", "p-4"], ["name", "Hide device fields", "formControlName", "hide_device_fields", "info", "Hides the MAC address, manufacturer, OS and SSID fields from device info tooltips"], ["name", "Show Legend", "formControlName", "show_legend"], ["name", "Hide Zones", "formControlName", "hide_zones"], ["name", "Show Booking QR Code", "formControlName", "show_booking_qr"], ["name", "Use defined polygons for zones", "formControlName", "use_zone_polygons"], ["name", "Show labels for zones", "formControlName", "show_zone_labels"], ["name", "Show zone sensor info", "formControlName", "show_zone_sensor_info"], [1, "mb-4", "flex", "items-center", "space-x-4"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "w-3/4", "flex-1"], ["matInput", "", "placeholder", "Legend Key", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matTooltip", "Legend Color", 1, "flex", "w-12", "items-center", "justify-center"], ["type", "color", 1, "h-11", "rounded-lg", "border", "border-base-content", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-error", "text-error", 3, "click"]], template: function VisitorKioskSettingsFormModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
    ...
    \u0275\u0275element(32, "settings-toggle", 18)(33, "settings-toggle", 19)(34, "settings-toggle", 20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "section", 21)(36, "h3", 22);
    \u0275\u0275text(37, " PlaceOS Maps ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div")(39, "label", 23);
    \u0275\u0275text(40, " Disabled Features ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "mat-form-field", 13)(42, "mat-select", 24)(43, "mat-option", 25);
    \u0275\u0275text(44, "Devices");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(50, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "mat-option", 29);
    \u0275\u0275text(52, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "mat-option", 30);
    \u0275\u0275text(54, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "mat-option", 31);
    \u0275\u0275text(56, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(57, "div", 32)(58, "div", 33)(59, "label", 34);
    \u0275\u0275text(60, " Disabled Feature Actions ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "mat-form-field", 13)(62, "mat-select", 35)(63, "mat-option", 25);
    \u0275\u0275text(64, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "mat-option", 26);
    \u0275\u0275text(66, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "mat-option", 27);
    \u0275\u0275text(68, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "mat-option", 28);
    \u0275\u0275text(70, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "mat-option", 29);
    \u0275\u0275text(72, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "mat-option", 30);
    \u0275\u0275text(74, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "mat-option", 31);
    \u0275\u0275text(76, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(77, "div", 33)(78, "label", 36);
    \u0275\u0275text(79, " Disabled Feature Labels ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "mat-form-field", 13)(81, "mat-select", 37)(82, "mat-option", 25);
    \u0275\u0275text(83, "Devices");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(87, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(88, "mat-option", 28);
    \u0275\u0275text(89, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(90, "mat-option", 29);
    \u0275\u0275text(91, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "mat-option", 30);
    \u0275\u0275text(93, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(94, "mat-option", 31);
    \u0275\u0275text(95, "Zones");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(96, "div", 32)(97, "div", 33)(98, "label", 38);
    \u0275\u0275text(99, " Disabled Feature Displays ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(100, "mat-form-field", 13)(101, "mat-select", 39)(102, "mat-option", 25);
    \u0275\u0275text(103, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(104, "mat-option", 26);
    \u0275\u0275text(105, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(106, "mat-option", 27);
    \u0275\u0275text(107, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(108, "mat-option", 28);
    \u0275\u0275text(109, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(110, "mat-option", 29);
    \u0275\u0275text(111, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(112, "mat-option", 30);
    \u0275\u0275text(113, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(114, "mat-option", 31);
    \u0275\u0275text(115, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(116, "div", 33)(117, "label", 40);
    \u0275\u0275text(118, " Disabled Feature Styles ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(119, "mat-form-field", 13)(120, "mat-select", 41)(121, "mat-option", 25);
    \u0275\u0275text(122, "Devices");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(126, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(127, "mat-option", 28);
    \u0275\u0275text(128, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(129, "mat-option", 29);
    \u0275\u0275text(130, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(131, "mat-option", 30);
    \u0275\u0275text(132, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(133, "mat-option", 31);
    \u0275\u0275text(134, "Zones");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275conditionalCreate(135, VisitorKioskSettingsFormModalComponent_Conditional_135_Template, 7, 1, "div", 42);
    \u0275\u0275elementStart(136, "div", 15);
    \u0275\u0275element(137, "settings-toggle", 43)(138, "settings-toggle", 44)(139, "settings-toggle", 45)(140, "settings-toggle", 46)(141, "settings-toggle", 47)(142, "settings-toggle", 48)(143, "settings-toggle", 49);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(104);
    \u0275\u0275conditional((ctx.form.value.explore == null ? null : ctx.form.value.explore.show_legend) ? 135 : -1);
  }
}, dependencies: [
  FullscreenModalShellComponent,
  MatDialogModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorKioskSettingsFormModalComponent, { className: "VisitorKioskSettingsFormModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/visitor-kiosk-settings-form-modal.component.ts", lineNumber: 444 });
})();
...
_BuildingListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BuildingListComponent, selectors: [["building-list"]], decls: 18, vars: 34, consts: [["name_template", ""], ["timezone_template", ""], ["level_template", ""], ["image_template", ""], ["action_template", ""], ["menu", "matMenu"], ["app_settings_menu", "matMenu"], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "block", "w-full", "min-w-[62rem]", "text-sm", 3, "data", "empty_message", "columns", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "p-4", "font-mono", "text-xs"], ["auth", "", 1, "max-h-[3rem]", "max-w-[8rem]", 3, "source"], [1, "opacity-30"], [1, "flex", "w-full", "justify-center", "space-x-2", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], ["mat-menu-item", "", 3, "click"], ["className", "material-symbols-rounded", 1, "text-xl"], [1, "text-red-500", "flex", "items-center", "space-x-2"], [1, "text-xl", "text-error"]], template: function BuildingListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildingListComponent, { className: "BuildingListComponent", filePath: "apps/concierge/src/app/building-manager/building-list.component.ts", lineNumber: 257 });
})();
...
var _LevelModalComponent = class _LevelModalComponent {
  ...
  async save() {
    ...
    const resp = await (data.id ? ia(data.id, __spreadProps(__spreadValues({}, data), {
      name: `LEVEL ${kt().description} ${data.display_name}`
    })) : oa(__spreadProps(__spreadValues({}, data), {
      name: `LEVEL ${kt().description} ${data.display_name}`
    }))).toPromise().catch();
    if (resp.id)
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LevelModalComponent, { className: "LevelModalComponent", filePath: "apps/concierge/src/app/level-manager/level-modal.component.ts", lineNumber: 143 });
})();
...
var _LevelManagementService = class _LevelManagementService {
  ...
  async removeLevel(level) {
    ...
    await sa(level.id).toPromise().catch((e) => {
...
var _RegionModalComponent = class _RegionModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    this.loading = true;
    const resp = await (data.id ? ia(data.id, __spreadProps(__spreadValues({}, data), {
      name: `REGION ${kt().description} ${data.display_name}`
    })) : oa(__spreadProps(__spreadValues({}, data), {
      name: `REGION ${kt().description} ${data.display_name}`
    }))).toPromise().catch();
    if (resp.id)
...
var _RegionManagementService = class _RegionManagementService {
  ...
  editRegionMetadata(region = new vn()) {
    const ref = this._dialog.open(AppSettingsModalComponent, {
      data: { zone: region }
    });
    ref.afterClosed().subscribe((data) => {
  ...
  async removeRegion(region) {
    ...
    await sa(region.id).toPromise().catch((e) => {
...
_ZoneManagerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneManagerComponent, selectors: [["", "app-zone-manager", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c08, decls: 58, vars: 30, consts: [["app_settings_menu", "matMenu"], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "mb-2", "flex", "items-center", "justify-between", "px-8", "pb-2", "pt-4"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "gap-2"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor", "matTooltip"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], [1, "mx-8", "mb-4", "overflow-hidden", "rounded-md", "bg-base-200", 3, "selectedIndexChange", "selectedIndex"], [3, "label"], [1, "content-area", "flex-1"], [1, "relative", "block", "h-full", "w-full"], ["mat-menu-item", "", 3, "click"], [1, "text-xl"]], template: function ZoneManagerComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
...
//# sourceMappingURL=zone-manager.module-KTOFSSYZ.js.map
