...
var GroupEventsStateService = class _GroupEventsStateService {
  ...
  constructor() {
    ...
    effect(async () => {
      ...
      const sys = await ya({ in: this.calendar }).then((r) => r.data?.[0]).catch(() => null);
      if (!sys) {
        this._events.set([]);
        return;
      }
...
//# sourceMappingURL=group-events.routes-GCOE5GV4.js.map
