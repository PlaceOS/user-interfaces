...
} from "./chunk-NZMEQBU2.js";
import {
  UserListFieldComponent
} from "./chunk-BPK5PQUW.js";
import "./chunk-RFNRR45U.js";
import {
  HostSelectFieldComponent
} from "./chunk-5HQWTOFL.js";
import {
  MatBottomSheet,
  MatBottomSheetModule,
  MatBottomSheetRef
} from "./chunk-W3O7LSPF.js";
import {
  BuildingPipe
...
} from "./chunk-4G7JDBNK.js";
import {
  MapPinComponent
} from "./chunk-P7GTABY4.js";
import {
  InteractiveMapComponent
} from "./chunk-GAUYNR6I.js";
import "./chunk-LRENEV44.js";
import {
  EventFormService
} from "./chunk-I7RLYWHF.js";
import "./chunk-KAF56GZC.js";
import "./chunk-M6MEMKNC.js";
import {
  AssetStateService
} from "./chunk-HZKXHNPJ.js";
import {
  subMinutes
} from "./chunk-WHR6ZRMK.js";
import {
  RichTextInputComponent
} from "./chunk-SBGYZRZC.js";
import {
  MatChip,
  MatChipSet,
  MatChipsModule
} from "./chunk-LROOLUT4.js";
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FindAvailabilityModalComponent, { className: "FindAvailabilityModalComponent", filePath: "libs/users/src/lib/find-availability-modal/find-availability-modal.component.ts", lineNumber: 282 });
})();
...
function query_catering_types() {
  if (!_catering_types_promise) {
    _catering_types_promise = resolveCateringCategoryId().then((category_id) => Tl({ category_id, limit: 500 })).then((_) => _.data.filter((type) => isCateringTypeName(type.name))).catch(() => []);
  }
...
async function queryCateringItems(zone_id) {
  ...
  if (!types.length)
    return [];
  const results = await Promise.all(types.map((type) => bl({
    zone_id,
    type_id: type.id,
    limit: 500
...
function CateringListFieldComponent_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(18, 23, "CALENDAR_EVENT.CATERING_ORDER_AT_DATE", \u0275\u0275pureFunction2(34, _c010, \u0275\u0275pipeBind2(16, 17, order_r4.deliver_at, "mediumDate"), \u0275\u0275pipeBind2(17, 20, order_r4.deliver_at, ctx_r4.time_format()))), " ");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r4.end_time() < order_r4.deliver_at ? 19 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(23, 29, "CALENDAR_EVENT.CATERING_ORDER_DETAILS", \u0275\u0275pureFunction2(37, _c15, order_r4.item_count, \u0275\u0275pipeBind2(22, 26, order_r4.total_cost / 100, ctx_r4.currency_code()))), " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(28, 32, ctx_r4.show_order()[order_r4.id] ? "CALENDAR_EVENT.CATERING_ORDER_HIDE" : "CALENDAR_EVENT.CATERING_ORDER_SHOW"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r4.show_order()[order_r4.id] ? "expand_less" : "expand_more", " ");
    \u0275\u0275advance();
    \u0275\u0275property("@show", ctx_r4.show_order()[order_r4.id] ? "show" : "hide");
    \u0275\u0275advance();
...
function MeetingFlowFormComponent_Conditional_5_Conditional_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 8, "CALENDAR_EVENT.ATTENDEES"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 10, "COMMON.AVAILABILITY"), " ");
    \u0275\u0275advance(4);
...
function MeetingFlowFormComponent_Conditional_5_Conditional_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("formField", ctx_r1.form.catering)("options", \u0275\u0275pureFunction5(9, _c32, ctx_r1.model().date, ctx_r1.model().duration, ctx_r1.model().all_day, ctx_r1.model()?.resources?.length ? ctx_r1.model()?.resources[0]?.level?.parent_id : "", ctx_r1.model().resources));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function MeetingFlowFormComponent_Conditional_5_Conditional_30_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 7, "RESOURCE.ASSETS"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.hide_block.assets ? "expand_more" : "expand_less");
    \u0275\u0275advance();
    \u0275\u0275property("@show", ctx_r1.hide_block.assets ? "hide" : "show");
    \u0275\u0275advance();
    \u0275\u0275property("options", \u0275\u0275pureFunction5(10, _c5, ctx_r1.model().date, ctx_r1.model().duration, ctx_r1.model().all_day, ctx_r1.model()?.resources?.length ? ctx_r1.model()?.resources[0]?.level?.parent_id : "", ctx_r1.model()?.resources || \u0275\u0275pureFunction0(9, _c4)))("rejected_ids", ctx_r1.invalid_assets())("formField", ctx_r1.form.assets);
    \u0275\u0275control();
  }
}
...
function MeetingFlowFormComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(14, MeetingFlowFormComponent_Conditional_5_Conditional_14_Template, 17, 12, "section", 5);
    ...
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(29, MeetingFlowFormComponent_Conditional_5_Conditional_29_Template, 15, 15, "section", 5);
    \u0275\u0275conditionalCreate(30, MeetingFlowFormComponent_Conditional_5_Conditional_30_Template, 13, 16, "section", 5);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 16, "COMMON.DETAILS"), " ");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(35, 20, "CALENDAR_EVENT.CONFIRM"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(38, 22, !!ctx_r1.model().id ? "FORM.RESET" : "FORM.CLEAR"), " ");
  }
}
var MeetingFlowFormComponent = class _MeetingFlowFormComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    ...
    this._idle.idleFor((this._settings.get("app.idle_timeout") || 5) * 60 * 1e3).then(async () => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowFormComponent, selectors: [["meeting-flow-form"]], viewQuery: function MeetingFlowFormComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275pipe(4, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(5, MeetingFlowFormComponent_Conditional_5_Template, 39, 24, "form", 4);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
function MeetingFlowSuccessComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(12, "div", 6);
    \u0275\u0275conditionalCreate(13, MeetingFlowSuccessComponent_Conditional_4_Conditional_13_Template, 3, 3, "button", 7);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 10, "BOOKINGS.ITEM_BOOKED", \u0275\u0275pureFunction1(15, _c19, \u0275\u0275pipeBind1(4, 8, "RESOURCE.ROOM"))), " ");
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r0.last_event()?.all_day ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.last_event()?.all_day ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.formatted_recurrence() ? 10 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(true ? 11 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.space?.email && ctx_r0.allow_desk_booking ? 13 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(17, _c25));
    \u0275\u0275advance();
...
var MeetingFlowSuccessComponent = class _MeetingFlowSuccessComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MeetingFlowSuccessComponent, selectors: [["meeting-flow-success"]], features: [\u0275\u0275ProvidersFeature([SpacePipe])], decls: 5, vars: 16, consts: [[1, "bg-base-100", "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "max-w-lg", "text-center"], ["recurrence", "", 1, "bg-base-200", "flex", "items-center", "space-x-2", "rounded-lg", "px-4", "py-2"], [1, "h-4"], ["btn", "", "matRipple", "", 1, "w-48"], [1, "border-base-200", "bg-base-100", "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "p-2"], ["btn", "", "name", "meeting-created-continue", "matRipple", "", 1, "w-full", "max-w-lg", 3, "routerLink"], [1, "text-xl"], [1, "text-sm"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function MeetingFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275declareLet(0);
        \u0275\u0275pipe(1, "date");
        \u0275\u0275pipe(2, "date");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MeetingFlowSuccessComponent, { className: "MeetingFlowSuccessComponent", filePath: "apps/workplace/src/app/book/meeting-flow/meeting-flow-success.component.ts", lineNumber: 111 });
})();
...
//# debugId=c2ea0a02-fe81-5820-ae78-51799af85301
//# sourceMappingURL=meeting-flow.component-FCTYTJZK.js.map
