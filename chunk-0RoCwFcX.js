import{Ba as m,Ca as jt,Cs as xS,Dt as It,Fo as se,Gt as L,Ho as ta,K as ET,Ka as mt,Ks as zn,P as Ch,Ps as ye,Qt as Le,S as Bb,Xs as m$1,Ys as l,ha as it,ho as q,no as oa,ns as v,po as pt,ut as Gt,vr as Ve,xi as cae}from"./chunk-CEffMQ-E.js";import{D as Ii,an as to,ot as Uv,rt as Ti,s as Af,w as Hn,zt as kf}from"./chunk-CkUhk5JP.js";function Y(o,m){}var z=`_mat-bottom-sheet-enter`;var P=`_mat-bottom-sheet-exit`;var G=(()=>{class o extends kf{_breakpointSubscription;_animationsDisabled=ta();_animationState=`void`;_animationStateChanged=new ye;_destroyed=!1;constructor(){super();let e=m(xS);this._breakpointSubscription=e.observe([cae.Medium,cae.Large,cae.XLarge]).subscribe(()=>{let n=this._elementRef.nativeElement.classList;n.toggle(`mat-bottom-sheet-container-medium`,e.isMatched(cae.Medium)),n.toggle(`mat-bottom-sheet-container-large`,e.isMatched(cae.Large)),n.toggle(`mat-bottom-sheet-container-xlarge`,e.isMatched(cae.XLarge))})}enter(){this._destroyed||(this._animationState=`visible`,this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation(z))}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute(`mat-exit`,``),this._animationState=`hidden`,this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(P))}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=!0}_simulateAnimation(e){this._ngZone.run(()=>{this._handleAnimationEvent(!0,e,this._elementRef.nativeElement),setTimeout(()=>this._handleAnimationEvent(!1,e,this._elementRef.nativeElement))})}_trapFocus(){super._trapFocus({preventScroll:!0})}_handleAnimationEvent(e,n,t){if(t===this._elementRef.nativeElement){let i=n===z;(i||n===P)&&this._animationStateChanged.emit({toState:i?`visible`:`hidden`,phase:e?`start`:`done`})}}static ɵfac=function(n){return new(n||o)};static ɵcmp=It({type:o,selectors:[[`mat-bottom-sheet-container`]],hostAttrs:[`tabindex`,`-1`,1,`mat-bottom-sheet-container`],hostVars:9,hostBindings:function(n,t){n&1&&Gt(`animationstart`,function(a){return t._handleAnimationEvent(!0,a.animationName,a.target)})(`animationend`,function(a){return t._handleAnimationEvent(!1,a.animationName,a.target)})(`animationcancel`,function(a){return t._handleAnimationEvent(!1,a.animationName,a.target)}),n&2&&(zn(`role`,t._config.role)(`aria-modal`,t._config.ariaModal)(`aria-label`,t._config.ariaLabel),jt(`mat-bottom-sheet-container-animations-enabled`,!t._animationsDisabled)(`mat-bottom-sheet-container-enter`,t._animationState===`visible`)(`mat-bottom-sheet-container-exit`,t._animationState===`hidden`))},features:[it],decls:1,vars:0,consts:[[`cdkPortalOutlet`,``]],template:function(n,t){n&1&&ET(0,Y,0,0,`ng-template`,0)},dependencies:[Ti],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
