...
}, dependencies: [FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, IconComponent, MatRippleModule, MatRipple, TranslatePipe], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SearchOverlayComponent, { className: "SearchOverlayComponent", filePath: "apps/concierge/src/app/signage/search-overlay.component.ts", lineNumber: 91 });
})();
...
function SignageApprovePlaylistModalComponent_Conditional_5_For_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SignageApprovePlaylistModalComponent_Conditional_5_For_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SignageApprovePlaylistModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275declareLet(3);
    \u0275\u0275pipe(4, "async");
    \u0275\u0275elementStart(5, "div", 5)(6, "div", 6)(7, "h3");
    \u0275\u0275text(8, "Version to approve");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(15, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(16, SignageApprovePlaylistModalComponent_Conditional_5_For_17_Template, 2, 1, "div", 10, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 11)(19, "div", 6)(20, "h3");
    \u0275\u0275text(21, "Previous version");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div", 7);
    \u0275\u0275text(23);
    \u0275\u0275pipe(24, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 8)(26, "div", 12);
    \u0275\u0275text(27);
    \u0275\u0275pipe(28, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(29, SignageApprovePlaylistModalComponent_Conditional_5_For_30_Template, 2, 1, "div", 10, _forTrack0);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "footer", 13)(32, "button", 14);
    \u0275\u0275listener("click", function SignageApprovePlaylistModalComponent_Conditional_5_Template_button_click_32_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.undoChanges());
    });
    \u0275\u0275text(33, " Undo Changes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "button", 15);
    \u0275\u0275listener("click", function SignageApprovePlaylistModalComponent_Conditional_5_Template_button_click_34_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    const versions_r5 = \u0275\u0275pipeBind1(2, 5, ctx_r3.playlist_versions);
    const media_r6 = \u0275\u0275pipeBind1(4, 7, ctx_r3.playlist_media);
    const current_version_r7 = versions_r5 == null ? null : versions_r5[0];
    const current_media_r8 = (media_r6 == null ? null : media_r6[0]) || \u0275\u0275pureFunction0(25, _c02);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 9, (current_version_r7 == null ? null : current_version_r7.updated_at) * 1e3, "dd MMM, HH:mm"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(15, 12, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(26, _c1, current_version_r7 == null ? null : current_version_r7.items.length), current_version_r7 == null ? null : current_version_r7.items.length), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(current_media_r8);
    const previous_version_r9 = versions_r5 == null ? null : versions_r5[1];
    const previous_media_r10 = (media_r6 == null ? null : media_r6[1]) || \u0275\u0275pureFunction0(28, _c02);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(24, 16, (previous_version_r9 == null ? null : previous_version_r9.updated_at) * 1e3, "dd MMM, HH:mm"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(28, 19, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(29, _c1, previous_version_r9 == null ? null : previous_version_r9.items.length), previous_version_r9 == null ? null : previous_version_r9.items.length), " ");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(previous_media_r10);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(36, 23, "COMMON.APPROVE"), " ");
  }
}
function SignageApprovePlaylistModalComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "main")(1, "div", 16);
...
var _SignageApprovePlaylistModalComponent = class _SignageApprovePlaylistModalComponent {
  constructor() {
    ...
    this.loading = signal("");
    this.playlist_versions = this._playlist_id.pipe(filter((_) => !!_), tap(() => this.loading.set("Loading versions...")), switchMap((id) => Sa(id, { limit: 2 })), shareReplay(1));
  ...
  async undoChanges() {
    ...
    await lastValueFrom(xa(this._playlist.id, previous.items));
    this.loading.set("");
  ...
  async approve() {
    ...
    this._dialog_ref.disableClose = true;
    await lastValueFrom(ka(this._playlist.id));
    this.loading.set("");
    this._dialog_ref.disableClose = false;
...
_SignageApprovePlaylistModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageApprovePlaylistModalComponent, selectors: [["signage-approve-playlist-modal"]], decls: 7, vars: 2, consts: [[1, "p-2"], [1, "rounded", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "space-x-2", "py-2"], [1, "w-[24rem]", "rounded", "border", "border-base-300", "bg-success-light"], [1, "flex", "items-center", "space-x-8", "rounded", "border-b", "border-base-300", "bg-base-200", "px-4", "py-2"], [1, "font-mono", "text-xs", "opacity-50"], [1, "space-y-2", "p-2"], [1, "px-2", "text-sm"], [1, "truncate", "rounded", "border", "border-base-300", "bg-base-100", "p-2"], [1, "w-[24rem]", "rounded", "border", "border-base-300", "bg-error-light"], [1, "space-y-2", "px-2", "text-sm"], [1, "flex", "items-center", "justify-end", "space-x-2", "rounded", "bg-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "inverse", "w-40", "bg-base-100", 3, "click"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-4"], ["diameter", "32"]], template: function SignageApprovePlaylistModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, SignageApprovePlaylistModalComponent_Conditional_5_Template, 37, 31)(6, SignageApprovePlaylistModalComponent_Conditional_6_Template, 6, 3, "main");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageApprovePlaylistModalComponent, { className: "SignageApprovePlaylistModalComponent", filePath: "apps/concierge/src/app/signage/signage-approve-playlist-modal.component.ts", lineNumber: 157 });
})();
...
var _SignageDisplayModalComponent = class _SignageDisplayModalComponent {
  ...
  async save() {
    ...
    const new_display = new Pr(__spreadProps(__spreadValues({}, form_value), {
    ...
    const method = this.display.id ? wc(this.display.id, new_display) : Oc(new_display);
...
var _SignageMediaModalComponent = class _SignageMediaModalComponent {
  ...
  constructor() {
    ...
    this.form = new FormGroup({
      ...
      animation: new FormControl(Rr.Default),
  ...
  async saveMedia() {
    ...
    if (this.item.id) {
      await lastValueFrom(ha(this.item.id, new_media)).catch(onError);
    } else {
...
_SignageMediaPreviewModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaPreviewModalComponent, selectors: [["signage-media-preview-modal"]], outputs: { save: "save" }, decls: 10, vars: 8, consts: [[1, "flex", "items-center", "justify-between", "border-b", "border-base-300", "p-2"], [1, "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "bg-base-200"], [1, "flex", "h-[20rem]", "max-h-[65vh]", "w-[28rem]", "max-w-[80vw]", "flex-col", "items-center", "justify-center", "p-8"], [1, "flex", "items-center", "justify-end", "space-x-2", "border-t", "border-base-300", "p-2"], [1, "flex", "h-[65vh]", "max-h-[65vh]", "w-[80vw]", "max-w-[80vw]", "items-center", "justify-center"], ["auth", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [1, "h-full", "w-full", "object-contain", "object-center", 3, "src"], ["auth", "", "autoplay", "", "controls", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function SignageMediaPreviewModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaPreviewModalComponent, { className: "SignageMediaPreviewModalComponent", filePath: "apps/concierge/src/app/signage/signage-media-preview-modal.component.ts", lineNumber: 84 });
})();
...
])], decls: 8, vars: 3, consts: [[1, "mb-1", "flex", "w-full", "items-center", "space-x-2", "rounded", "border", "border-base-300", "focus-within:border-base-content", "focus-within:outline-4", "focus-within:outline-base-content", 3, "formGroup"], ["placeholder", "*", "name", "minute", "formControlName", "minute", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-none", 3, "keydown"], ["placeholder", "*", "name", "hour", "formControlName", "hour", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-none"], ["placeholder", "*", "name", "day", "formControlName", "day", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-none"], ["placeholder", "*", "name", "month", "formControlName", "month", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-none"], ["placeholder", "*", "name", "day_of_week", "formControlName", "day_of_week", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-none"], [1, "text-xs", "text-error"]], template: function CronInputFieldComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _SignagePlaylistModalComponent = class _SignagePlaylistModalComponent {
  constructor() {
    this._data = inject(MAT_DIALOG_DATA) ?? new Zo({});
    ...
    this.form = new FormGroup({
      ...
      default_animation: new FormControl(Rr.Cut),
...
var _SignageStateService = class _SignageStateService extends AsyncHandler {
  constructor() {
    ...
    this.media = combineLatest([
      ...
      this._change
    ]).pipe(filter(([_]) => !!_?.id), debounceTime(300), switchMap(() => la({ limit: 2500 })), map((_) => _.data.sort((a, b) => b.created_at - a.created_at)), shareReplay(1));
    this.playlists = combineLatest([
      this._org.active_building,
      this._change
    ]).pipe(filter(([_]) => !!_?.id), debounceTime(300), switchMap(() => _a({ limit: 500 })), map((_) => (_.data || []).sort((a, b) => a.name.localeCompare(b.name))), shareReplay(1));
    this.displays = combineLatest([
      this._org.active_region,
      this._org.active_building,
      this._change
    ]).pipe(filter(([, bld]) => !!bld?.id), switchMap(([region, bld]) => xc({
  ...
  editMedia(media = new Ko({}), file, playlist_id = "") {
  ...
  async editDisplay(display = new Pr({})) {
  ...
  async removeDisplay(display) {
    ...
    if (display.map_id || display.email || display.module_list.length > 0) {
      await lastValueFrom(wc(display.id, {
        signage: false
      }));
    } else {
      await lastValueFrom(Ec(display.id));
    }
    this._change.next(Date.now());
  ...
  async savePlaylist(playlist) {
    const call = lastValueFrom(playlist.id ? ya(playlist.id, playlist, "put") : ga(playlist));
  ...
  previewFileMedia(media, playlist_id = "") {
    ...
    ref.componentInstance.save.subscribe(async () => {
      ...
      if (playlist_id && new_media.id) {
        const media_list = await lastValueFrom(va(playlist_id));
        const new_media_list = [...media_list.items, new_media.id];
        await lastValueFrom(xa(playlist_id, new_media_list));
      }
      ref.close();
    });
  }
  async addMediaFromLink(url, media_item = new Ko({})) {
    const url_obj = new URL(url);
    const data = __spreadValues({}, new Ko(__spreadProps(__spreadValues({}, media_item), {
  ...
  async addMedia(file, media_item = new Ko({})) {
    ...
    if (thumbnail_image) {
      ...
      const thumb_id = await this._uploads.uploadFile(dataURLtoFile(thumbnail_image, name), true);
  ...
  async updateMedia(item) {
    if (!item?.id)
      return;
    await lastValueFrom(ha(item.id, item));
  }
...
function SignageItemPlaylistsComponent_Conditional_6_For_2_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageItemPlaylistsComponent_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(12, SignageItemPlaylistsComponent_Conditional_6_For_2_Conditional_12_Template, 4, 3, "div", 17);
    \u0275\u0275elementStart(13, "button", 18)(14, "icon");
    \u0275\u0275text(15, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-menu", null, 0)(18, "a", 19)(19, "div", 9)(20, "icon", 10);
    ...
    \u0275\u0275listener("click", function SignageItemPlaylistsComponent_Conditional_6_For_2_Template_button_click_25_listener() {
      const item_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.remove.emit(item_r4));
    });
    \u0275\u0275elementStart(26, "div", 9)(27, "icon", 21);
    \u0275\u0275text(28, " delete ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const menu_r5 = \u0275\u0275reference(17);
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(3, 9, "APP.CONCIERGE.SIGNAGE_MEDIA_REORDER"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", item_r4.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 11, "APP.CONCIERGE.SIGNAGE_MEDIA_COUNT", \u0275\u0275pureFunction1(18, _c13, ((tmp_14_0 = ctx_r0.playlist_count()[item_r4.id]) == null ? null : tmp_14_0.count) || 0)), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.isScheduled(item_r4) ? 12 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", menu_r5);
    \u0275\u0275advance(5);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(20, _c2))("queryParams", \u0275\u0275pureFunction1(21, _c3, item_r4.id));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(24, 14, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_VIEW"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 16, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_REMOVE"), " ");
  }
}
function SignageItemPlaylistsComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SignageItemPlaylistsComponent_Conditional_6_For_2_Template, 32, 23, "div", 7, _forTrack02);
    \u0275\u0275elementEnd();
...
function SignageItemPlaylistsComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 5)(1, "div", 23)(2, "icon", 24);
    \u0275\u0275text(3, "hide_image");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p");
    \u0275\u0275text(5);
...
_SignageItemPlaylistsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageItemPlaylistsComponent, selectors: [["signage-item-playlists"]], inputs: { item: [1, "item"], name: [1, "name"], extra: [1, "extra"], link: [1, "link"] }, outputs: { add: "add", remove: "remove", ondrop: "ondrop" }, features: [\u0275\u0275NgOnChangesFeature], ngContentSelectors: _c05, decls: 8, vars: 4, consts: [["menu", "matMenu"], [1, "flex", "items-center", "justify-center", "space-x-2"], [1, "text-xl", "font-medium"], [1, "rounded-lg", "bg-base-200", "px-2", "py-1", "font-mono", "text-xs", "uppercase"], ["icon", "", "matRipple", "", "target", "_blank", "rel", "noopener noreferrer", 1, "text-xs", 3, "href", "matTooltip"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["cdkDropList", "", 1, "mt-4", "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", 3, "cdkDropListDropped"], ["cdkDrag", "", 1, "flex", "h-20", "w-full", "items-center", "space-x-2", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-2"], ["btn", "", "matRipple", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["class", "h-20 w-full rounded-xl border-4 border-dashed border-base-400 bg-base-300", 4, "cdkDragPlaceholder"], ["matRipple", "", "cdkDragHandle", "", 1, "!m-0", "flex", "h-full", "w-6", "items-center", "justify-center", "rounded", "hover:bg-base-200", 3, "matTooltip"], [1, "w-1/2", "flex-1", "text-base-content"], [1, "truncate"], [1, "truncate", "text-sm", "opacity-30"], [1, "rounded", "border", "border-info", "bg-base-100", "bg-info-light", "p-1", "text-lg", 3, "matTooltip"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "routerLink", "queryParams"], ["mat-menu-item", "", 3, "click"], [1, "text-2xl", "text-error"], [1, "h-20", "w-full", "rounded-xl", "border-4", "border-dashed", "border-base-400", "bg-base-300"], [1, "flex", "flex-col", "items-center", "justify-center", "opacity-30"], [1, "text-6xl"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function SignageItemPlaylistsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275projectionDef();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageItemPlaylistsComponent, { className: "SignageItemPlaylistsComponent", filePath: "apps/concierge/src/app/signage/signage-item-playlists.component.ts", lineNumber: 208 });
})();
...
var _ZoneSelectModalComponent = class _ZoneSelectModalComponent {
  constructor() {
    ...
    this.zones = this.search_term.pipe(debounceTime(300), switchMap((term) => ea(__spreadProps(__spreadValues({}, this.query), { q: term, limit: 100 })).pipe(map((_) => _.data), catchError(() => of([])))), map((zones) => zones.filter((zone) => !this.ignore.includes(zone.id))), startWith([]), shareReplay(1));
  }
};
...
var _SignageDisplaysComponent = class _SignageDisplaysComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      Cc(id).pipe(map((_) => _.data), tap((_) => setTimeout(() => this.switching.set(false), 200))).subscribe((data) => this._triggers.set(data));
    });
  }
  ...
  async setOrientation(orientation) {
    ...
    if (!display)
      return;
    await lastValueFrom(wc(display.id, { orientation, version: display.version }, "patch")).catch((e) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageDisplaysComponent, { className: "SignageDisplaysComponent", filePath: "apps/concierge/src/app/signage/signage-displays.component.ts", lineNumber: 341 });
})();
...
function SignageMediaListComponent_Conditional_18_For_2_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_18_For_2_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_18_For_2_For_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_2_For_24_Template_button_click_0_listener() {
...
function SignageMediaListComponent_Conditional_18_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, SignageMediaListComponent_Conditional_18_For_2_Conditional_5_Template, 1, 1, "img", 22);
    \u0275\u0275elementStart(6, "div", 23);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, SignageMediaListComponent_Conditional_18_For_2_Conditional_9_Template, 3, 3, "div", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 25)(11, "div", 26);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "button", 27)(14, "icon");
    \u0275\u0275text(15, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-menu", null, 1)(18, "div", 28)(19, "mat-form-field", 29);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_2_Template_mat_form_field_click_19_listener($event) {
      \u0275\u0275restoreView(_r5);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(20, "input", 6);
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275listener("ngModelChange", function SignageMediaListComponent_Conditional_18_For_2_Template_input_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.playlist_search.set($event));
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(22, SignageMediaListComponent_Conditional_18_For_2_Conditional_22_Template, 3, 4, "button", 30);
    \u0275\u0275repeaterCreate(23, SignageMediaListComponent_Conditional_18_For_2_For_24_Template, 4, 1, "button", 31, _forTrack04);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-menu", null, 2)(27, "button", 32);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_2_Template_button_click_27_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.editItem(media_r6));
    });
    \u0275\u0275elementStart(28, "div", 33)(29, "icon", 34);
    \u0275\u0275text(30, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(34, "button", 36)(35, "div", 33)(36, "icon", 34);
    \u0275\u0275text(37, "add");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_2_Template_button_click_41_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.previewItem(media_r6));
    });
    \u0275\u0275elementStart(42, "div", 33)(43, "icon", 34);
    \u0275\u0275text(44, "visibility");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_18_For_2_Template_button_click_48_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeItem(media_r6));
    });
    \u0275\u0275elementStart(49, "div", 33)(50, "icon", 37);
    \u0275\u0275text(51, " delete ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const playlist_menu_r9 = \u0275\u0275reference(17);
    const menu_r10 = \u0275\u0275reference(26);
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275conditional(media_r6.thumbnail_url ? 5 : -1);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 27, media_r6.media_type === "image" ? "COMMON.IMAGE" : media_r6.media_type === "webpage" ? "COMMON.WEBPAGE" : "COMMON.VIDEO"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(media_r6.play_time ? 9 : -1);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(7);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(21, 29, "COMMON.SEARCH"))("ngModel", ctx_r2.playlist_search());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!(((tmp_29_0 = ctx_r2.playlists()) == null ? null : tmp_29_0.length) > 0) ? 22 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.playlists());
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(33, 31, "APP.CONCIERGE.SIGNAGE_MEDIA_EDIT"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matMenuTriggerFor", playlist_menu_r9);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(40, 33, "APP.CONCIERGE.SIGNAGE_MEDIA_ADD_PLAYLIST"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(47, 35, "APP.CONCIERGE.SIGNAGE_MEDIA_PREVIEW"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(54, 37, "APP.CONCIERGE.SIGNAGE_MEDIA_REMOVE"), " ");
  }
}
function SignageMediaListComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SignageMediaListComponent_Conditional_18_For_2_Template, 55, 39, "div", 17, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function SignageMediaListComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "icon", 40);
    \u0275\u0275text(2, "hide_image");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4);
...
var _SignageMediaListComponent = class _SignageMediaListComponent {
  ...
  async addToPlaylist(media_id, playlist) {
    const media_list = await lastValueFrom(va(playlist.id));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SignageMediaListComponent, [{
    ...
    `, imports: [
      ...
      MediaDurationPipe,
      AuthenticatedImageDirective
    ], styles: ["/* angular:styles/component:css;62f1948e80f1d37fbfc7dd0fe5a3ff76993e7e5f074002a0c62e64986fc743cb;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/signage/signage-media-list.component.ts */\n:host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n/*# sourceMappingURL=signage-media-list.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaListComponent, { className: "SignageMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-media-list.component.ts", lineNumber: 334 });
})();

// apps/concierge/src/app/signage/signage-playlist-media-list.component.ts
function SignagePlaylistMediaListComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      const playlist_r4 = \u0275\u0275readContextLet(1);
      return \u0275\u0275resetView(ctx_r2.approvePlaylist(playlist_r4));
    });
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("disabled", !ctx_r2.is_admin)("matTooltip", \u0275\u0275pipeBind1(1, 2, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_NOT_APPROVED"));
  }
}
function SignagePlaylistMediaListComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePlaylistMediaListComponent_Conditional_59_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePlaylistMediaListComponent_Conditional_60_For_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 26);
  }
}
function SignagePlaylistMediaListComponent_Conditional_60_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 27);
  }
}
function SignagePlaylistMediaListComponent_Conditional_60_For_2_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34)(1, "icon", 35);
    \u0275\u0275text(2, " add ");
    \u0275\u0275elementEnd()();
  }
}
function SignagePlaylistMediaListComponent_Conditional_60_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 25);
    \u0275\u0275conditionalCreate(1, SignagePlaylistMediaListComponent_Conditional_60_For_2_Conditional_1_Template, 1, 0, "div", 26)(2, SignagePlaylistMediaListComponent_Conditional_60_For_2_Conditional_2_Template, 1, 0, "div", 27);
    \u0275\u0275template(3, SignagePlaylistMediaListComponent_Conditional_60_For_2_div_3_Template, 3, 0, "div", 28);
    \u0275\u0275elementStart(4, "button", 29)(5, "icon");
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "button", 33)(12, "icon");
    \u0275\u0275text(13, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "mat-menu", null, 0)(16, "button", 5);
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_60_For_2_Template_button_click_16_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.editItem(item_r7));
    });
    \u0275\u0275elementStart(17, "div", 6)(18, "icon", 7);
    \u0275\u0275text(19, " edit ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_60_For_2_Template_button_click_23_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.previewItem(item_r7));
    });
    \u0275\u0275elementStart(24, "div", 6)(25, "icon", 7);
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Conditional_60_For_2_Template_button_click_30_listener() {
      const item_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeItem(item_r7));
    });
    \u0275\u0275elementStart(31, "div", 6)(32, "icon", 10);
    \u0275\u0275text(33, " delete ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r7.valid_from && ctx_r2.now < item_r7.valid_from ? 1 : item_r7.valid_until && ctx_r2.now > item_r7.valid_until ? 2 : -1);
    \u0275\u0275advance(7);
...
function SignagePlaylistMediaListComponent_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275listener("cdkDropListDropped", function SignagePlaylistMediaListComponent_Conditional_60_Template_div_cdkDropListDropped_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.drop($event));
    });
    \u0275\u0275repeaterCreate(1, SignagePlaylistMediaListComponent_Conditional_60_For_2_Template, 37, 13, "div", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function SignagePlaylistMediaListComponent_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21)(1, "icon", 36);
    \u0275\u0275text(2, "hide_image");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4);
...
var _SignagePlaylistMediaListComponent = class _SignagePlaylistMediaListComponent {
  constructor() {
    ...
    this._playlist_media = toSignal(toObservable(this._playlist_media_observable).pipe(filter((playlist) => !!playlist), debounceTime(300), switchMap((playlist) => va(playlist.id).pipe(catchError(() => of({ id: "", items: [], approved: 0 })))), tap((_) => this.approved.set(_.approved))), { initialValue: { id: "", items: [], approved: 0 } });
    this.media = computed(() => {
      const playlist = this._playlist_media();
...
_SignagePlaylistMediaListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePlaylistMediaListComponent, selectors: [["signage-playlist-media-list"]], inputs: { playlist: [1, "playlist"], playlist_count: [1, "playlist_count"] }, features: [\u0275\u0275NgOnChangesFeature], decls: 62, vars: 45, consts: [["menu", "matMenu"], [1, "relative", "flex", "h-full", "w-full", "flex-col", "space-y-4", "p-4"], [1, "text-center", "text-xl", "font-medium"], ["icon", "", "matRipple", "", 1, "absolute", "left-2", "top-2", "!m-0", 3, "disabled", "matTooltip"], ["icon", "", "matRipple", "", 1, "absolute", "right-2", "top-2", "!m-0", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "click", "disabled"], [1, "text-2xl", "text-error"], ["details", "", 1, "flex", "flex-wrap", "items-center"], [1, "m-1", "ml-2", "rounded", "px-2", "py-1", "text-xs"], [1, "m-1", "ml-2", "rounded", "bg-secondary", "px-2", "py-1", "text-xs", "text-secondary-content"], ["matTooltip", "Default Transition Animation", 1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "ml-1", "rounded", "bg-base-300", "px-2", "py-1", "uppercase"], ["matTooltip", "Default Playback Duration", 1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "ml-1", "rounded", "bg-base-300", "px-2", "py-1", "font-mono"], ["matTooltip", "Prefered Orientation", 1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "m-1", "rounded", "bg-base-200", "px-2", "py-2", "text-xs", "uppercase"], ["cdkDropList", "", "id", "playlist-list", 1, "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", 3, "cdkDropListData", "cdkDropListConnectedTo"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], ["icon", "", "matRipple", "", 1, "absolute", "left-2", "top-2", "!m-0", 3, "click", "disabled", "matTooltip"], [1, "text-2xl", "text-warning"], ["cdkDropList", "", "id", "playlist-list", 1, "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], ["cdkDrag", "", 1, "relative", "flex", "h-20", "w-full", "items-center", "space-x-2", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-2"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-warning", "opacity-10"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-error", "opacity-10"], ["class", "flex min-h-10 min-w-10 items-center justify-center rounded-2xl border-4 border-dashed border-base-400 bg-base-300", 4, "cdkDragPlaceholder"], ["matRipple", "", "cdkDragHandle", "", "matTooltip", "Drag to reorder", 1, "!m-0", "flex", "h-full", "w-6", "items-center", "justify-center", "rounded", "hover:bg-base-200"], ["preview", "", 1, "h-16", "w-[4.5rem]", "overflow-hidden", "rounded-lg", "bg-base-200"], ["auth", "", 1, "h-full", "w-full", "object-contain", 3, "source"], [1, "w-1/2", "flex-1", "truncate", "text-base-content"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], [1, "flex", "min-h-10", "min-w-10", "items-center", "justify-center", "rounded-2xl", "border-4", "border-dashed", "border-base-400", "bg-base-300"], [1, "text-2xl", "text-base-100"], [1, "text-6xl"]], template: function SignagePlaylistMediaListComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, SignagePlaylistMediaListComponent_Conditional_4_Template, 4, 4, "button", 3);
    \u0275\u0275elementStart(5, "button", 4)(6, "icon");
    \u0275\u0275text(7, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "mat-menu", null, 0)(10, "button", 5);
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      const playlist_r4 = \u0275\u0275readContextLet(1);
      return \u0275\u0275resetView(ctx.approvePlaylist(playlist_r4));
    });
    \u0275\u0275elementStart(18, "div", 6)(19, "icon", 7);
    \u0275\u0275text(20, "order_approve");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r1);
      const playlist_r4 = \u0275\u0275readContextLet(1);
      return \u0275\u0275resetView(ctx.copyID(playlist_r4 == null ? null : playlist_r4.id));
    });
    \u0275\u0275elementStart(25, "div", 6)(26, "icon", 7);
    ...
    \u0275\u0275pipe(30, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "button", 5);
    \u0275\u0275listener("click", function SignagePlaylistMediaListComponent_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.removePlaylist());
    });
    \u0275\u0275elementStart(32, "div", 6)(33, "icon", 10);
    \u0275\u0275text(34, "delete");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(38, "div", 11)(39, "div", 12);
    \u0275\u0275text(40);
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(42, SignagePlaylistMediaListComponent_Conditional_42_Template, 3, 3, "div", 13);
    ...
    \u0275\u0275text(58);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(59, SignagePlaylistMediaListComponent_Conditional_59_Template, 3, 3, "div", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(60, SignagePlaylistMediaListComponent_Conditional_60_Template, 3, 2, "div", 20)(61, SignagePlaylistMediaListComponent_Conditional_61_Template, 6, 3, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_10_0;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Playlist - ", playlist_r10 == null ? null : playlist_r10.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx.approved() ? 4 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", menu_r9);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 27, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_EDIT"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx.approved() || !ctx.is_admin);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 29, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_APPROVE"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(30, 31, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_COPY_ID"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(37, 33, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_REMOVE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("bg-success", (tmp_10_0 = ctx.selected_playlist()) == null ? null : tmp_10_0.enabled)("text-success-content", (tmp_11_0 = ctx.selected_playlist()) == null ? null : tmp_11_0.enabled)("bg-error", !((tmp_12_0 = ctx.selected_playlist()) == null ? null : tmp_12_0.enabled))("text-error-content", !((tmp_13_0 = ctx.selected_playlist()) == null ? null : tmp_13_0.enabled));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(41, 35, ((tmp_14_0 = ctx.selected_playlist()) == null ? null : tmp_14_0.enabled) ? "COMMON.ENABLED" : "COMMON.DISABLED"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_15_0 = ctx.selected_playlist()) == null ? null : tmp_15_0.random) ? 42 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(45, 37, "APP.CONCIERGE.SIGNAGE_ANIMATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx.animation_name((tmp_17_0 = ctx.selected_playlist()) == null ? null : tmp_17_0.default_animation));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(50, 39, "APP.CONCIERGE.SIGNAGE_DURATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(53, 41, ((tmp_19_0 = ctx.selected_playlist()) == null ? null : tmp_19_0.default_duration) / 1e3));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(56, 43, "APP.CONCIERGE.SIGNAGE_ORIENTATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((tmp_21_0 = ctx.selected_playlist()) == null ? null : tmp_21_0.orientation);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.isScheduled(ctx.selected_playlist()) ? 59 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.media().length > 0 ? 60 : 61);
  }
}, dependencies: [
  CommonModule,
  TranslatePipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistMediaListComponent, { className: "SignagePlaylistMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-media-list.component.ts", lineNumber: 340 });
})();
...
var _SignageMediaComponent = class _SignageMediaComponent extends AsyncHandler {
  ...
  async drop(playlist, event) {
    ...
    const media_list = await va(playlist.id).toPromise();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaComponent, { className: "SignageMediaComponent", filePath: "apps/concierge/src/app/signage/signage-media.component.ts", lineNumber: 185 });
})();
...
var _SignageZonesComponent = class _SignageZonesComponent {
  constructor() {
    ...
    effect(() => {
      ...
      sa(id).pipe(map((_) => _.data), tap((_) => setTimeout(() => this.switching.set(false), 100))).subscribe((data) => this._triggers.set(data));
    });
  }
  async addPlaylist(playlist) {
    const zone = this.active_zone();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageZonesComponent, { className: "SignageZonesComponent", filePath: "apps/concierge/src/app/signage/signage-zones.component.ts", lineNumber: 161 });
})();
...
_SignageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageComponent, selectors: [["", "app-new-staff", ""]], attrs: _c09, decls: 17, vars: 6, consts: [["tabPanel", ""], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "h-20", "items-center", "justify-between", "p-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 1, "w-40"], [1, "px-8"], [1, "overflow-hidden", "rounded", "bg-base-200"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "h-1/2", "flex-1", "overflow-auto", "px-8", "py-4"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], ["mat-tab-link", "", 3, "click", "routerLink", "active"]], template: function SignageComponent_Template(rf, ctx) {
  if (rf & 1) {
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=signage.module-PDURNRNH.js.map
