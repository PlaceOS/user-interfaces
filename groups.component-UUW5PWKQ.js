import {
  ...
  CdkTreeNodeDef,
  CdkTreeNodePadding
} from "./chunk-D3KTHFMG.js";
import {
  NavFooterComponent,
  NavSidebarComponent
} from "./chunk-GHCVWSL4.js";
import {
  Component,
...
function SignageGroupPermissionsModalComponent_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("name", \u0275\u0275pipeBind1(1, 2, permission_r2.label))("ngModel", ctx_r2.hasPermission(permission_r2.value));
  }
}
function SignageGroupPermissionsModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("name", \u0275\u0275pipeBind1(2, 2, "SIGNAGE_MANAGER.PERM_DENY_SELECTED"));
...
var SignageGroupPermissionsModalComponent = class _SignageGroupPermissionsModalComponent {
  constructor() {
    ...
    this.value = signal(+this.data.permissions || 0, ...ngDevMode ? [{ debugName: "value" }] : (
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupPermissionsModalComponent, selectors: [["signage-group-permissions-modal"]], decls: 6, vars: 4, consts: [[3, "confirm", "heading"], [1, "flex", "flex-col", "gap-3"], [3, "name", "ngModel"], [1, "border-base-300", "mt-2", "border-t", "pt-3"], [3, "ngModelChange", "name", "ngModel"]], template: function SignageGroupPermissionsModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var SignageGroupUserSelectModalComponent = class _SignageGroupUserSelectModalComponent {
  ...
  async searchUsers() {
    ...
    const users = await lastValueFrom(this._service.searchGroupUsers(this.search()));
    this.users.set(users.filter((user) => !exclude_ids.has(user.id) && !exclude_ids.has(user.email)));
  }
  static {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupUserSelectModalComponent, selectors: [["signage-group-user-select-modal"]], decls: 15, vars: 14, consts: [[1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "type", "button", "matRipple", "", "mat-dialog-close", ""], [1, "h-[65vh]", "max-w-lg", "min-w-lg", "space-y-2", "overflow-auto", "px-4", "pt-2", "pb-4", "text-center", "max-md:h-auto", "max-md:max-w-none", "max-md:min-w-0", "max-md:flex-1"], ["appearance", "outline", 1, "no-subscript", "bg-base-100", "sticky", "top-0", "z-10", "w-full"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], [1, "bg-base-200", "flex", "h-[calc(100%-3.5rem)]", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-lg", "p-16"], ["type", "button", "matRipple", "", 1, "border-base-300", "hover:bg-base-200", "z-0", "flex", "h-16", "w-full", "items-center", "space-x-2", "rounded-sm", "border", "p-2", "text-left", 3, "mat-dialog-close"], [1, "text-base-content/60", "shrink-0", "text-2xl"], [1, "min-w-0", "flex-1"], [1, "truncate"], [1, "text-base-content/70", "truncate", "text-xs"], [1, "text-base-content/70", "text-8xl"], [1, "text-base-content/70"]], template: function SignageGroupUserSelectModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(11, "translate");
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275listener("ngModelChange", function SignageGroupUserSelectModalComponent_Template_input_ngModelChange_10_listener($event) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(6);
        \u0275\u0275property("ngModel", ctx.search())("placeholder", \u0275\u0275pipeBind1(11, 10, "SIGNAGE_MANAGER.SEARCH_USERS"));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupUserSelectModalComponent, { className: "SignageGroupUserSelectModalComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-user-select-modal.component.ts", lineNumber: 93 });
})();
...
function SignageGroupUsersComponent_Conditional_13_For_1_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r2.user == null ? null : row_r2.user.email, " ");
  }
}
...
function SignageGroupUsersComponent_Conditional_13_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((row_r2.user == null ? null : row_r2.user.email) ? 6 : -1);
    \u0275\u0275advance(2);
...
var SignageGroupUsersComponent = class _SignageGroupUsersComponent {
  constructor() {
    ...
    this.users = toSignal(this._service.managed_group_users, {
      initialValue: []
    });
    this.permissionLabels = groupPermissionLabels;
  }
  async addUser() {
    const user = await lastValueFrom(this._dialog.open(SignageGroupUserSelectModalComponent, {
      data: {
  ...
  async editUserPermissions(row) {
    const result = await lastValueFrom(this._dialog.open(SignageGroupPermissionsModalComponent, {
      data: {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupUsersComponent, selectors: [["signage-group-users"]], decls: 15, vars: 14, consts: [[1, "bg-base-100", "border-base-300", "flex", "h-full", "min-h-0", "flex-col", "overflow-auto", "rounded-lg", "border"], [1, "border-base-300", "flex", "items-center", "gap-2", "border-b", "px-4", "py-3"], [1, "text-base-content/80", "flex", "flex-1", "items-center", "gap-2", "font-medium", "tracking-wider", "uppercase"], [1, "text-lg"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "rounded-lg", "border", "hover:shadow-md", 3, "click", "matTooltip"], [1, "gap-2", "p-2"], [1, "text-base-content/70", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-6"], [1, "border-base-300", "bg-base-100", "mb-2", "flex", "items-center", "gap-3", "rounded-lg", "border", "px-4", "py-3"], [1, "shrink-0", "text-xl", "opacity-60"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-sm", "font-medium"], [1, "text-base-content/70", "truncate", "text-xs"], [1, "text-base-content/70", "mt-1", "truncate", "text-xs"], [1, "italic"], [1, "text-error"], [1, "text-4xl"], [1, "text-sm"]], template: function SignageGroupUsersComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupUsersComponent, { className: "SignageGroupUsersComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-users.component.ts", lineNumber: 144 });
})();
...
function SignageGroupZoneSelectModalComponent_Conditional_13_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, SignageGroupZoneSelectModalComponent_Conditional_13_For_1_Conditional_6_Template, 2, 1, "div", 11);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function SignageGroupZoneSelectModalComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SignageGroupZoneSelectModalComponent_Conditional_13_For_1_Template, 7, 3, "button", 7, _forTrack04);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var SignageGroupZoneSelectModalComponent = class _SignageGroupZoneSelectModalComponent {
  ...
  async searchZones() {
    const exclude_ids = new Set(this._data.exclude_ids || []);
    const zones = await lastValueFrom(this._service.searchGroupZones(this.search()));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupZoneSelectModalComponent, selectors: [["signage-group-zone-select-modal"]], decls: 15, vars: 14, consts: [[1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "type", "button", "matRipple", "", "mat-dialog-close", ""], [1, "h-[65vh]", "max-w-lg", "min-w-lg", "space-y-2", "overflow-auto", "px-4", "pt-2", "pb-4", "text-center", "max-md:h-auto", "max-md:max-w-none", "max-md:min-w-0", "max-md:flex-1"], ["appearance", "outline", 1, "no-subscript", "bg-base-100", "sticky", "top-0", "z-10", "w-full"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], [1, "bg-base-200", "flex", "h-[calc(100%-3.5rem)]", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-lg", "p-16"], ["type", "button", "matRipple", "", 1, "border-base-300", "hover:bg-base-200", "z-0", "flex", "h-16", "w-full", "items-center", "space-x-2", "rounded-sm", "border", "p-2", "text-left", 3, "mat-dialog-close"], [1, "text-base-content/60", "shrink-0", "text-2xl"], [1, "min-w-0", "flex-1"], [1, "truncate"], [1, "text-base-content/70", "truncate", "text-xs"], [1, "text-base-content/70", "text-8xl"], [1, "text-base-content/70"]], template: function SignageGroupZoneSelectModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "header", 0)(1, "h2", 1);
        \u0275\u0275text(2);
        \u0275\u0275pipe(3, "translate");
        ...
        \u0275\u0275pipe(11, "translate");
        \u0275\u0275pipe(12, "translate");
        \u0275\u0275listener("ngModelChange", function SignageGroupZoneSelectModalComponent_Template_input_ngModelChange_10_listener($event) {
          return ctx.setSearch($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(13, SignageGroupZoneSelectModalComponent_Conditional_13_Template, 2, 0)(14, SignageGroupZoneSelectModalComponent_Conditional_14_Template, 6, 3, "div", 6);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.zones().length > 0 ? 13 : 14);
      }
    }, dependencies: [
      FormsModule,
      DefaultValueAccessor,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupZoneSelectModalComponent, { className: "SignageGroupZoneSelectModalComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-zone-select-modal.component.ts", lineNumber: 95 });
})();
...
function SignageGroupZonesComponent_Conditional_13_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", (row_r6.zone == null ? null : row_r6.zone.display_name) || (row_r6.zone == null ? null : row_r6.zone.name) || row_r6.zone_id, " ");
    \u0275\u0275advance(2);
...
function SignageGroupZonesComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6)(1, "icon", 14);
    \u0275\u0275text(2, "layers_clear");
    \u0275\u0275elementEnd();
...
var SignageGroupZonesComponent = class _SignageGroupZonesComponent {
  constructor() {
    this._service = inject(SignageService);
    this._dialog = inject(MatDialog);
    this.zones = toSignal(this._service.managed_group_zones, {
      initialValue: []
    });
    this.permissionLabels = groupPermissionLabels;
  }
  async addZone() {
    const zone = await lastValueFrom(this._dialog.open(SignageGroupZoneSelectModalComponent, {
      data: {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupZonesComponent, selectors: [["signage-group-zones"]], decls: 15, vars: 14, consts: [[1, "bg-base-100", "border-base-300", "flex", "h-full", "min-h-0", "flex-col", "overflow-auto", "rounded-lg", "border"], [1, "border-base-300", "flex", "items-center", "gap-2", "border-b", "px-4", "py-3"], [1, "text-base-content/80", "flex", "flex-1", "items-center", "gap-2", "font-medium", "tracking-wider", "uppercase"], [1, "text-lg"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "rounded-lg", "border", "hover:shadow-md", 3, "click", "matTooltip"], [1, "gap-2", "p-2"], [1, "text-base-content/70", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-6"], [1, "border-base-300", "bg-base-100", "mb-2", "flex", "items-center", "gap-3", "rounded-lg", "border", "px-4", "py-3"], [1, "shrink-0", "text-xl", "opacity-60"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-sm", "font-medium"], [1, "text-base-content/70", "mt-1", "truncate", "text-xs"], [1, "italic"], [1, "text-error"], [1, "text-4xl"], [1, "text-sm"]], template: function SignageGroupZonesComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h5", 2)(3, "icon", 3);
        \u0275\u0275text(4, "layers");
        \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupZonesComponent, { className: "SignageGroupZonesComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-zones.component.ts", lineNumber: 149 });
})();
...
var SignageGroupEditModalComponent = class _SignageGroupEditModalComponent {
  constructor() {
    ...
    this.form = new FormGroup({
      ...
      parent_id: new FormControl(this.group.parent_id || "", this.group.id ? [] : [Validators.required])
    });
  }
  async save() {
    ...
    try {
      const result = await this._service.saveSignageGroup(this.group, this.form.getRawValue());
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupEditModalComponent, selectors: [["signage-group-edit-modal"]], decls: 33, vars: 31, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", 3, "formGroup"], ["for", "signage-group-name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", "id", "signage-group-name", "name", "signage-group-name", "formControlName", "name", "required", "", 3, "placeholder"], ["for", "signage-group-description"], ["matInput", "", "id", "signage-group-description", "name", "signage-group-description", "formControlName", "description", 1, "min-h-32", 3, "placeholder"], ["for", "signage-group-parent"], ["id", "signage-group-parent", "name", "signage-group-parent", "formControlName", "parent_id", 3, "placeholder", "required"], ["value", ""], [3, "value"]], template: function SignageGroupEditModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
        \u0275\u0275pipe(1, "translate");
        \u0275\u0275pipe(2, "translate");
      ...
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 13, ctx.group.id ? "SIGNAGE_MANAGER.GROUP_EDIT_HEADING" : "SIGNAGE_MANAGER.GROUP_NEW_HEADING"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 15, "SIGNAGE_MANAGER.GROUP_SAVING") : "");
        \u0275\u0275advance(3);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 17, "FORM.NAME"));
        \u0275\u0275advance(5);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(11, 19, "FORM.NAME"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 21, "SIGNAGE_MANAGER.NAME_REQUIRED"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(17, 23, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(20, 25, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(4);
        \u0275\u0275conditional(!ctx.group.id ? 23 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(26, 27, "SIGNAGE_MANAGER.SELECT_PARENT"))("required", !ctx.group.id);
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.group.id ? 27 : -1);
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.parent_groups());
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 29, "SIGNAGE_MANAGER.PARENT_REQUIRED"));
      }
    }, dependencies: [
      FullscreenModalShellComponent,
      ReactiveFormsModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupEditModalComponent, { className: "SignageGroupEditModalComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-edit-modal.component.ts", lineNumber: 95 });
})();
...
var SignageGroupDetailHeaderComponent = class _SignageGroupDetailHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupDetailHeaderComponent, selectors: [["signage-group-detail-header"]], decls: 1, vars: 1, consts: [[1, "bg-base-100", "border-base-300", "mx-2", "flex", "items-center", "gap-2", "rounded-b-lg", "border", "px-4", "py-3"], ["icon", "", "matRipple", "", "type", "button", 1, "sm:hidden", 3, "click"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-lg", "font-medium"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "mr-1", "rounded-lg", "border", "hover:shadow-md", 3, "click", "matTooltip"], ["icon", "", "type", "button", "matRipple", "", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "text-error", "mr-1", "rounded-lg", "border", "hover:shadow-md", 3, "click", "matTooltip"]], template: function SignageGroupDetailHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupDetailHeaderComponent, { className: "SignageGroupDetailHeaderComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-detail-header.component.ts", lineNumber: 64 });
})();

// apps/signage-manager/src/app/groups/signage-group-header.component.ts
var _c03 = (a0) => ({ count: a0 });
function SignageGroupHeaderComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 6);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function SignageGroupHeaderComponent_Conditional_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
var SignageGroupHeaderComponent = class _SignageGroupHeaderComponent {
  constructor() {
    ...
    this.group_count = computed(() => this._service.manageable_signage_groups().length, ...ngDevMode ? [{ debugName: "group_count" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupHeaderComponent, selectors: [["signage-group-header"]], decls: 10, vars: 11, consts: [[1, "bg-base-100", "border-base-300", "sticky", "top-0", "z-10", "flex", "flex-wrap", "items-center", "gap-2", "border-b", "px-4", "py-2", "shadow", "sm:flex-nowrap"], [1, "py-2"], [1, "text-2xl", "font-medium"], [1, "text-sm", "opacity-60"], [1, "w-px", "flex-1"], ["icon", "", "type", "button", "matRipple", "", "matTooltipPosition", "left", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "mr-1", "rounded-lg", "border", "hover:shadow-md", 3, "matTooltip"], ["icon", "", "type", "button", "matRipple", "", "matTooltipPosition", "left", 1, "border-base-200", "hover:bg-base-200", "hover:border-base-300", "mr-1", "rounded-lg", "border", "hover:shadow-md", 3, "click", "matTooltip"]], template: function SignageGroupHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275element(8, "div", 4);
        \u0275\u0275conditionalCreate(9, SignageGroupHeaderComponent_Conditional_9_Template, 4, 3, "button", 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(7, 5, "SIGNAGE_MANAGER.GROUP_COUNT", \u0275\u0275pureFunction1(9, _c03, ctx.group_count()), ctx.group_count()), " ");
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.can_manage_all_groups() ? 9 : -1);
      }
    }, dependencies: [IconComponent, MatRippleModule, MatRipple, MatTooltipModule, MatTooltip, TranslatePipe], encapsulation: 2 });
  }
};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupHeaderComponent, { className: "SignageGroupHeaderComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-header.component.ts", lineNumber: 44 });
})();
...
function SignageGroupListComponent_Conditional_7_Conditional_0_For_1_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const group_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("opacity-70", group_r2.id !== ((tmp_13_0 = ctx_r2.selected_group()) == null ? null : tmp_13_0.id))("opacity-90", group_r2.id === ((tmp_14_0 = ctx_r2.selected_group()) == null ? null : tmp_14_0.id));
    \u0275\u0275advance();
...
function SignageGroupListComponent_Conditional_7_Conditional_0_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("bg-primary", group_r2.id === ((tmp_12_0 = ctx_r2.selected_group()) == null ? null : tmp_12_0.id))("text-primary-content", group_r2.id === ((tmp_13_0 = ctx_r2.selected_group()) == null ? null : tmp_13_0.id))("hover:bg-base-200", group_r2.id !== ((tmp_14_0 = ctx_r2.selected_group()) == null ? null : tmp_14_0.id));
...
function SignageGroupListComponent_Conditional_8_cdk_tree_node_1_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const row_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("opacity-70", row_r6.group.id !== ((tmp_4_0 = ctx_r2.selected_group()) == null ? null : tmp_4_0.id))("opacity-90", row_r6.group.id === ((tmp_5_0 = ctx_r2.selected_group()) == null ? null : tmp_5_0.id));
    \u0275\u0275advance();
...
function SignageGroupListComponent_Conditional_8_cdk_tree_node_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const row_r6 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-primary", row_r6.group.id === ((tmp_3_0 = ctx_r2.selected_group()) == null ? null : tmp_3_0.id))("text-primary-content", row_r6.group.id === ((tmp_4_0 = ctx_r2.selected_group()) == null ? null : tmp_4_0.id))("hover:bg-base-200", row_r6.group.id !== ((tmp_5_0 = ctx_r2.selected_group()) == null ? null : tmp_5_0.id));
...
var SignageGroupListComponent = class _SignageGroupListComponent {
  constructor() {
    ...
    this.tree_nodes = signal([], ...ngDevMode ? [{ debugName: "tree_nodes" }] : (
      /* istanbul ignore next */
      []
    ));
    this.show_search_results = computed(() => !!this.search().trim(), ...ngDevMode ? [{ debugName: "show_search_results" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  async loadChildren(group_id) {
    const children = await lastValueFrom(this._service.groupChildren(group_id)).catch(() => this.child_lookup()[group_id] || []);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupListComponent, { className: "SignageGroupListComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-list.component.ts", lineNumber: 263 });
})();
...
//# sourceMappingURL=groups.component-UUW5PWKQ.js.map
