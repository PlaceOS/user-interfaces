...
var RoomAlertModalComponent = class _RoomAlertModalComponent {
  ...
  async save() {
    ...
    const metadata = await Fu(this._org.organisation.id, "room_alerts").catch((e) => {
...
function RoomBookingHistoryModalComponent_ng_template_45_Conditional_2_Conditional_2_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional((change_r8.changed_fields == null ? null : change_r8.changed_fields.length) ? 12 : -1);
  }
}
...
var RoomBookingHistoryModalComponent = class _RoomBookingHistoryModalComponent {
  constructor() {
    ...
    this.room = this._data.room;
    this.period = signal("week", ...ngDevMode ? [{ debugName: "period" }] : (
      /* istanbul ignore next */
      []
    ));
    this.loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : (
    ...
    this.expanded = signal({}, ...ngDevMode ? [{ debugName: "expanded" }] : (
      /* istanbul ignore next */
      []
    ));
    this.histories = signal({}, ...ngDevMode ? [{ debugName: "histories" }] : (
      /* istanbul ignore next */
      []
    ));
    this.history_loading = signal({}, ...ngDevMode ? [{ debugName: "history_loading" }] : (
      /* istanbul ignore next */
      []
    ));
    this._events = signal([], ...ngDevMode ? [{ debugName: "_events" }] : (
      /* istanbul ignore next */
      []
    ));
    this.bookings = computed(() => [...this._events()].sort((a, b) => b.date - a.date).map((event) => __spreadProps(__spreadValues({}, event), {
  ...
  async loadRowHistory(row) {
    ...
    const changes = await queryEventHistory(params).toPromise().catch(() => []);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingHistoryModalComponent, selectors: [["room-booking-history-modal"]], features: [\u0275\u0275ProvidersFeature([UserPipe])], decls: 49, vars: 72, consts: [["date_template", ""], ["period_template", ""], ["user_template", ""], ["expand_template", ""], ["history_template", ""], ["status_template", ""], [1, "bg-base-200", "flex", "h-14", "w-full", "flex-none", "items-center", "justify-between", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium", "capitalize"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "min-h-0", "w-full", "flex-1", "flex-col", "overflow-hidden"], [1, "flex", "items-center", "justify-between", "px-4", "pt-2", "pb-3"], [1, "text-sm", "opacity-60"], ["appearance", "outline", 1, "no-subscript", "w-48"], [3, "ngModelChange", "ngModel"], ["value", "week"], ["value", "month"], ["value", "3_months"], ["value", "12_months"], [1, "relative", "min-h-0", "flex-1"], [1, "bg-base-100/60", "absolute", "inset-0", "z-10", "flex", "items-center", "justify-center"], [1, "relative", "z-0", "h-full", "w-full", "overflow-auto", "px-4", "pb-4"], [1, "block", "min-w-3xl", "text-sm", 3, "data", "columns", "empty_message", "sortable", "child_template", "show_children"], ["diameter", "32"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "text-xs", "opacity-60"], [1, "p-2"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], [1, "max-w-48", "truncate", "text-xs", "opacity-30", "select-all"], [1, "flex", "h-full", "w-full", "items-center", "justify-center"], ["icon", "", "matRipple", "", 1, "h-10", "w-10", "rounded-sm", 3, "click"], [1, "bg-base-200/40", "px-6", "py-4"], [1, "flex", "items-center", "justify-center", "py-6"], ["diameter", "24"], [1, "py-4", "text-center", "text-sm", "opacity-60"], [1, "mb-2", "text-xs", "font-medium", "uppercase", "opacity-60"], [1, "flex", "flex-col", "space-y-2"], [1, "border-base-300", "bg-base-100", "flex", "items-start", "space-x-3", "rounded-sm", "border", "p-3"], [1, "text-xl", "opacity-60"], [1, "flex", "flex-1", "flex-col"], [1, "flex", "items-center", "space-x-2", "text-sm"], [1, "font-medium", "capitalize"], [1, "bg-base-200", "rounded-2xl", "px-2", "py-0.5", "font-mono", "text-[0.625rem]", "opacity-70"], [1, "mt-1", "flex", "flex-wrap", "gap-1"], [1, "bg-base-300", "rounded-2xl", "px-2", "py-0.5", "font-mono", "text-[0.625rem]"], [1, "px-4", "py-2"], [1, "bg-success", "text-success-content", "inline-flex", "rounded-full", "px-3", "py-1", "text-xs"]], template: function RoomBookingHistoryModalComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var RoomModalComponent = class _RoomModalComponent extends AsyncHandler {
  constructor() {
    ...
    this.timezones = signal(TIMEZONES_IANA, ...ngDevMode ? [{ debugName: "timezones" }] : (
      /* istanbul ignore next */
      []
    ));
    this._timezone_query = toSignal(this.form.controls.timezone.valueChanges, { initialValue: this.form.controls.timezone.value || "" });
    ...
    this.encryption_levels = [
      { id: De.None, name: "None" },
      { id: De.Support, name: "Support" },
      { id: De.Admin, name: "Admin" },
      { id: De.NeverDisplay, name: "Never Display" }
    ];
    this.query_fn = (_) => from(ja({ q: _ })).pipe(map((resp) => resp.data));
  ...
  async ngOnInit() {
    const { details } = await Fu(this._org.organisation.id, "settings");
  ...
  async save() {
    ...
    await (data.id ? na(data.id, data) : sa(data));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomModalComponent, { className: "RoomModalComponent", filePath: "apps/concierge/src/app/room-manager/room-modal.component.ts", lineNumber: 484 });
})();
...
function RoomListComponent_ng_template_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ((tmp_8_0 = \u0275\u0275pipeBind1(2, 1, data_r5)) == null ? null : tmp_8_0.display_name) || ((tmp_8_0 = \u0275\u0275pipeBind1(3, 3, data_r5)) == null ? null : tmp_8_0.name), " ");
  }
}
...
var RoomManagerTopbarComponent = class _RoomManagerTopbarComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    this.levels = toSignal(combineLatest([
      this._org.active_building,
      this._org.active_region
    ]).pipe(map(([bld, region]) => this.use_region ? this._org.levelsForRegion(region) : this._org.levelsForBuilding(bld))), { initialValue: [] });
    this.filters = toSignal(this._manager.options, {
      initialValue: {}
    });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomManagerTopbarComponent, selectors: [["room-manager-topbar"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 20, vars: 13, consts: [[1, "flex", "items-center", "space-x-2", "px-8", "pt-4"], [1, "text-2xl", "font-medium"], [1, "w-2", "flex-1"], [3, "modelChange"], ["btn", "", 1, "w-40", 3, "click"], [1, "bg-base-100", "flex", "h-20", "items-center", "space-x-2", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"]], template: function RoomManagerTopbarComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275property("ngModel", (tmp_2_0 = ctx.filters()) == null ? null : tmp_2_0.zones)("placeholder", \u0275\u0275pipeBind1(12, 9, "COMMON.LEVEL_ALL"));
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomManagerTopbarComponent, { className: "RoomManagerTopbarComponent", filePath: "apps/concierge/src/app/room-manager/room-manager-topbar.component.ts", lineNumber: 101 });
})();
...
var RoomManagerComponent = class _RoomManagerComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomManagerComponent, selectors: [["", "app-new-room-manager", ""]], attrs: _c04, decls: 6, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "block", "w-full"], [1, "relative", "block", "h-1/2", "w-full", "flex-1"]], template: function RoomManagerComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomManagerComponent, { className: "RoomManagerComponent", filePath: "apps/concierge/src/app/room-manager/room-manager.component.ts", lineNumber: 54 });
})();
...
var RoomManagerModule = class _RoomManagerModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RoomManagerComponent, RouterModule.forChild(ROUTES)] });
  }
};
(() => {
...
//# sourceMappingURL=room-manager.module-HY2V2CGO.js.map
