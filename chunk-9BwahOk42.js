...
`;var vi=[[[``,`matChipEdit`,``]],[[`mat-chip-avatar`],[``,`matChipAvatar`,``]],[[``,`matChipEditInput`,``]],`*`,[[`mat-chip-trailing-icon`],[``,`matChipRemove`,``],[``,`matChipTrailingIcon`,``]]];var gi=[`[matChipEdit]`,`mat-chip-avatar, [matChipAvatar]`,`[matChipEditInput]`,`*`,`mat-chip-trailing-icon,[matChipRemove],[matChipTrailingIcon]`];function fi(n,r){n&1&&Wo(0,`span`,0)}function yi(n,r){n&1&&(nr(0,`span`,1),or(1),xr())}function bi(n,r){n&1&&(nr(0,`span`,3),or(1,1),xr())}function Si(n,r){n&1&&or(0,2)}function wi(n,r){n&1&&Wo(0,`span`,7)}function Ci(n,r){if(n&1&&Pr(0,Si,1,0)(1,wi,1,0,`span`,7),n&2)kr(Br().contentEditInput?0:1)}function Ii(n,r){n&1&&or(0,3)}function Ni(n,r){n&1&&(nr(0,`span`,6),or(1,4),xr())}var $e=[`*`];var ki=`.mat-mdc-chip-set {
  display: flex;
}
