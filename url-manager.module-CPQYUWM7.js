...
var UrlListComponent = class _UrlListComponent extends AsyncHandler {
  constructor() {
    super(...arguments);
    this._manager = inject(UrlManagementService);
    this._settings = inject(SettingsService);
    this.features = toSignal(this._manager.url_list, {
      initialValue: []
    });
  ...
  ngOnInit() {
    this.subscription("url_list", this._manager.url_list.subscribe(async (l) => {
      for (const item of l) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UrlListComponent, { className: "UrlListComponent", filePath: "apps/concierge/src/app/url-management/url-list.component.ts", lineNumber: 164 });
})();
...
var UrlManagerModule = class _UrlManagerModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [UrlManagerComponent, RouterModule.forChild(ROUTES)] });
  }
};
(() => {
...
//# sourceMappingURL=url-manager.module-CPQYUWM7.js.map
