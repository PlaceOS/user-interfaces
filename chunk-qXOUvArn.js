import {m as m$1,ba as oe,ek as Us,el as I,em as Ap,v as l,u as m$2,en as Ki,eo as Io,ep as L,eq as z$1,er as ut,es as lt,et as ZN,eu as rh,ev as xe,ew as Me,ex as F0,ey as ui,ez as Gs,eA as kp,eB as _e,eC as rS,eD as Gie,p as pt,eE as Yi,J as Je,by as ND,Y as kt,bL as zn,a1 as xt}from'./main.js';function Y(o,m){}var z="_mat-bottom-sheet-enter",P="_mat-bottom-sheet-exit",G=(()=>{class o extends kp{_breakpointSubscription;_animationsDisabled=Us();_animationState="void";_animationStateChanged=new _e;_destroyed=false;constructor(){super();let e=m$1(rS);this._breakpointSubscription=e.observe([Gie.Medium,Gie.Large,Gie.XLarge]).subscribe(()=>{let n=this._elementRef.nativeElement.classList;n.toggle("mat-bottom-sheet-container-medium",e.isMatched(Gie.Medium)),n.toggle("mat-bottom-sheet-container-large",e.isMatched(Gie.Large)),n.toggle("mat-bottom-sheet-container-xlarge",e.isMatched(Gie.XLarge));});}enter(){this._destroyed||(this._animationState="visible",this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation(z));}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute("mat-exit",""),this._animationState="hidden",this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(P));}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=true;}_simulateAnimation(e){this._ngZone.run(()=>{this._handleAnimationEvent(true,e),setTimeout(()=>this._handleAnimationEvent(false,e));});}_trapFocus(){super._trapFocus({preventScroll:true});}_handleAnimationEvent(e,n){let t=n===z;(t||n===P)&&this._animationStateChanged.emit({toState:t?"visible":"hidden",phase:e?"start":"done"});}static \u0275fac=function(n){return new(n||o)};static \u0275cmp=pt({type:o,selectors:[["mat-bottom-sheet-container"]],hostAttrs:["tabindex","-1",1,"mat-bottom-sheet-container"],hostVars:9,hostBindings:function(n,t){n&1&&kt("animationstart",function(a){return t._handleAnimationEvent(true,a.animationName)})("animationend",function(a){return t._handleAnimationEvent(false,a.animationName)})("animationcancel",function(a){return t._handleAnimationEvent(false,a.animationName)}),n&2&&(zn("role",t._config.role)("aria-modal",t._config.ariaModal)("aria-label",t._config.ariaLabel),xt("mat-bottom-sheet-container-animations-enabled",!t._animationsDisabled)("mat-bottom-sheet-container-enter",t._animationState==="visible")("mat-bottom-sheet-container-exit",t._animationState==="hidden"));},features:[Je],decls:1,vars:0,consts:[["cdkPortalOutlet",""]],template:function(n,t){n&1&&ND(0,Y,0,0,"ng-template",0);},dependencies:[Yi],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
