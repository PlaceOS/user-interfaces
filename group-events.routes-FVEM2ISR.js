...
import "./chunk-P7GTABY4.js";
import "./chunk-GAUYNR6I.js";
import {
  DateCalendarComponent,
  startOfMonth
} from "./chunk-LRENEV44.js";
...
var GroupEventsStateService = class _GroupEventsStateService {
  ...
  constructor() {
    ...
    effect(async () => {
      ...
      const sys = await da({ in: this.calendar }).then((r) => r.data?.[0]).catch(() => null);
      if (!sys) {
        this._events.set([]);
        return;
      }
...
//# debugId=771d2cbf-c5e4-5d68-b3b6-f692630bbdfd
//# sourceMappingURL=group-events.routes-FVEM2ISR.js.map
