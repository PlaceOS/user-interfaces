import {
  LandingStateService
} from "./chunk-UM6YVZKN.js";
import {
  ExploreDeskInfoComponent,
  LockerGridComponent
} from "./chunk-A2TBQVI2.js";
import {
  VirtualConciergeButtonComponent
} from "./chunk-I5BHDHL5.js";
import {
  LevelPipe
...
} from "./chunk-YVNVC4JP.js";
import {
  MapPinComponent
} from "./chunk-JPGTBKRC.js";
import {
  DEFAULT_COLOURS,
...
import {
  compareAsc,
  differenceInMonths
} from "./chunk-VD7MJZEB.js";
import {
  FooterMenuComponent,
  TopbarComponent
} from "./chunk-ML7YZ6OA.js";
import "./chunk-BWNHVPCP.js";
import {
  SpacesService
...
var ExplorePointOfInterestService = class _ExplorePointOfInterestService extends AsyncHandler {
  constructor() {
    ...
    this._features = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_features" } : (
      ...
      params: () => this._building() || void 0,
      loader: async () => {
        const metadata = await Wu(this._org.organisation.id, "points-of-interest").catch((_) => ({ details: {} }));
...
function ExploreMapViewComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2);
    \u0275\u0275conditionalCreate(1, ExploreMapViewComponent_Conditional_2_Conditional_1_Template, 6, 5, "button", 6)(2, ExploreMapViewComponent_Conditional_2_Conditional_2_Template, 3, 3, "h3", 7);
    \u0275\u0275elementStart(3, "div", 8);
    \u0275\u0275repeaterCreate(4, ExploreMapViewComponent_Conditional_2_For_5_Template, 4, 3, "div", 9, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var ExploreMapViewComponent = class _ExploreMapViewComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreMapViewComponent, selectors: [["explore-map-view"]], features: [\u0275\u0275ProvidersFeature([
      ...
      SpacePipe
    ]), \u0275\u0275InheritDefinitionFeature], decls: 4, vars: 11, consts: [[3, "mapInfo", "src", "styles", "features", "actions", "labels", "focus", "options"], ["controls", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "left-2", "max-w-[calc(100vw-1rem)]", "space-y-2", "overflow-hidden", "rounded-lg", "border", "p-2", "shadow-xl"], ["legend", "", 1, "border-base-300", "bg-base-100", "absolute", "bottom-2", "left-2", "gap-2", "rounded-lg", "border"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "right-2", "h-12", "min-w-32", "rounded-lg", "border", "px-4", "shadow-sm"], [1, "mt-2", 3, "label", "ngModel"], [1, "mt-2", 3, "ngModelChange", "label", "ngModel"], ["type", "button", "aria-controls", "explore-map-legend-items", 1, "flex", "w-full", "min-w-64", "items-center", "justify-between", "space-x-4", "p-3", "text-left", "font-medium"], [1, "min-w-64", "p-3", "font-medium"], ["id", "explore-map-legend-items", 1, "space-y-1", "px-4", "pb-3"], [1, "flex", "items-center", "space-x-2"], ["type", "button", "aria-controls", "explore-map-legend-items", 1, "flex", "w-full", "min-w-64", "items-center", "justify-between", "space-x-4", "p-3", "text-left", "font-medium", 3, "click"], [1, "text-sm", "underline"], [1, "border-base-200", "h-3", "w-3", "rounded-full", "border"], [1, "text-sm"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "right-2", "h-12", "min-w-32", "rounded-lg", "border", "px-4", "shadow-sm", 3, "click"]], template: function ExploreMapViewComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExploreMapViewComponent, { className: "ExploreMapViewComponent", filePath: "libs/explore/src/lib/explore-map-view.component.ts", lineNumber: 151 });
})();
...
//# sourceMappingURL=explore.routes-5WOVKXLI.js.map
