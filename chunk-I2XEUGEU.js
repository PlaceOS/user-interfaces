...
import {
  ...
  MatChipRow,
  MatChipsModule
} from "./chunk-3IBGPMK3.js";
import {
  ExploreStateService
} from "./chunk-JNP3PD7G.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
  ...
  constructor() {
    ...
    this.menu_items = computed(
      () => {
        ...
        return FEATURE_MENU_ITEMS.filter((item) => features.includes(item.id) && (item.id !== "vip-visitor-invite" || !vip_group || groups.includes(vip_group)));
      },
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterMenuComponent, { className: "FooterMenuComponent", filePath: "apps/workplace/src/app/components/footer-menu.component.ts", lineNumber: 262 });
})();
    ...
    this.features = computed(
      () => {
        ...
        return feature_list.filter((name) => {
          if (name === "vip-visitor-invite" && vip_group && !groups.includes(vip_group)) {
            return false;
          }
    ...
    this.type = computed(
      () => {
        ...
        if (url.includes("book/locker"))
          return "lockers";
        if (url.includes("book/vip-visitor"))
          return "vip-visitor-invite";
...
//# sourceMappingURL=chunk-I2XEUGEU.js.map
