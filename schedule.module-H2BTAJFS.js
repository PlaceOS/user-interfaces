...
_ScheduleFilterCardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleFilterCardComponent, selectors: [["schedule-filter-card"]], decls: 19, vars: 12, consts: [[1, "border-base-200", "mb-4", "flex", "items-center", "space-x-2", "border-b", "text-xl"], ["icon", "", "matRipple", "", 3, "click"], [1, "w-1/2", "flex-1", "text-center"], [1, "border-base-200", "mb-4", "space-y-4", "border-b", "px-2", "pb-4"], ["matRipple", "", "name", "schedule-toggle-event-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-desk-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-parking-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-visitor-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-locker-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], [1, "px-2", "pb-2"], ["btn", "", "matRipple", "", "name", "schedule-apply-filter", 1, "w-full", 3, "click"], ["matRipple", "", "name", "schedule-toggle-event-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], [1, "bg-base-200", "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", "text-2xl"], [1, "flex-1"], [1, ""], [1, "text-sm", "opacity-60"], [3, "ngModel"], ["matRipple", "", "name", "schedule-toggle-desk-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], ["src", "assets/icons/desk-outline.svg", 1, "w-6"], ["matRipple", "", "name", "schedule-toggle-parking-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], ["matRipple", "", "name", "schedule-toggle-visitor-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], ["matRipple", "", "name", "schedule-toggle-locker-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"]], template: function ScheduleFilterCardComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(9, ScheduleFilterCardComponent_Conditional_9_Template, 13, 9, "button", 4);
    \u0275\u0275conditionalCreate(10, ScheduleFilterCardComponent_Conditional_10_Template, 12, 9, "button", 5);
    \u0275\u0275conditionalCreate(11, ScheduleFilterCardComponent_Conditional_11_Template, 13, 9, "button", 6);
    \u0275\u0275conditionalCreate(12, ScheduleFilterCardComponent_Conditional_12_Template, 13, 9, "button", 7);
    \u0275\u0275conditionalCreate(13, ScheduleFilterCardComponent_Conditional_13_Template, 13, 9, "button", 8);
    \u0275\u0275conditionalCreate(14, ScheduleFilterCardComponent_Conditional_14_Template, 13, 9, "button", 8);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.hasFeature("parking") ? 11 : -1);
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleFilterCardComponent, { className: "ScheduleFilterCardComponent", filePath: "apps/workplace/src/app/schedule/schedule-filter-card.component.ts", lineNumber: 231 });
})();
...
function ScheduleFiltersComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 9);
    \u0275\u0275text(2);
    ...
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_11_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ScheduleFiltersComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 9);
    \u0275\u0275text(2);
    ...
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_13_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ScheduleFiltersComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 9);
    \u0275\u0275text(2);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 14);
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_15_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
function ScheduleFiltersComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_22_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleType("event", true));
    });
...
function ScheduleFiltersComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_24_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleType("desk", true));
    });
...
function ScheduleFiltersComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_26_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleType("parking", true));
    });
...
function ScheduleFiltersComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_28_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleType("visitor", true));
    });
...
function ScheduleFiltersComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_30_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleType("locker", true));
    });
...
function ScheduleFiltersComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 19);
    \u0275\u0275listener("click", function ScheduleFiltersComponent_Conditional_32_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleType("group-event", true));
    });
...
_ScheduleFiltersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleFiltersComponent, selectors: [["schedule-filters"]], decls: 34, vars: 39, consts: [[1, "border-base-200", "bg-base-100", "hidden", "rounded-sm", "border", "p-2", "sm:block"], [1, "mb-2", "font-medium"], [1, "flex", "flex-wrap"], [1, "border-base-200", "m-1", "flex", "items-center", "rounded-3xl", "border"], [1, "flex", "items-center", "space-x-2", "overflow-auto", "sm:hidden"], ["btn", "", "matRipple", "", "name", "schedule-open-filter-edit", 1, "min-w-12", "sm:w-24", 3, "click"], [1, "flex", "items-center", "justify-center", "space-x-2"], [1, "text-xl"], [1, "border-base-200", "bg-base-100", "flex", "items-center", "rounded-3xl", "border", "pl-2", "text-sm"], [1, "px-2"], ["icon", "", "matRipple", "", "name", "schedule-remove-event-filter", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-desk-filter", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-parking-filter", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-visitor-filter", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-locker-filter", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-event-filter-mobile", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-desk-filter-mobile", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-parking-filter-mobile", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-visitor-filter-mobile", 3, "click"], ["icon", "", "matRipple", "", "name", "schedule-remove-locker-filter-mobile", 3, "click"]], template: function ScheduleFiltersComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(10, "async");
    \u0275\u0275conditionalCreate(11, ScheduleFiltersComponent_Conditional_11_Template, 7, 3, "div", 3);
    \u0275\u0275pipe(12, "async");
    \u0275\u0275conditionalCreate(13, ScheduleFiltersComponent_Conditional_13_Template, 7, 3, "div", 3);
    \u0275\u0275pipe(14, "async");
    \u0275\u0275conditionalCreate(15, ScheduleFiltersComponent_Conditional_15_Template, 7, 3, "div", 3);
    \u0275\u0275pipe(16, "async");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementStart(19, "div", 6)(20, "icon", 7);
    \u0275\u0275text(21, "filter_list");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(22, ScheduleFiltersComponent_Conditional_22_Template, 7, 3, "div", 8);
    \u0275\u0275pipe(23, "async");
    \u0275\u0275conditionalCreate(24, ScheduleFiltersComponent_Conditional_24_Template, 7, 3, "div", 8);
    \u0275\u0275pipe(25, "async");
    \u0275\u0275conditionalCreate(26, ScheduleFiltersComponent_Conditional_26_Template, 7, 3, "div", 8);
    \u0275\u0275pipe(27, "async");
    \u0275\u0275conditionalCreate(28, ScheduleFiltersComponent_Conditional_28_Template, 7, 3, "div", 8);
    \u0275\u0275pipe(29, "async");
    \u0275\u0275conditionalCreate(30, ScheduleFiltersComponent_Conditional_30_Template, 7, 3, "div", 8);
    \u0275\u0275pipe(31, "async");
    \u0275\u0275conditionalCreate(32, ScheduleFiltersComponent_Conditional_32_Template, 7, 3, "div", 8);
    \u0275\u0275pipe(33, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_1_0 = \u0275\u0275pipeBind1(6, 15, ctx.filters)) == null ? null : tmp_1_0.shown_types == null ? null : tmp_1_0.shown_types.includes("event")) && ctx.hasFeature("spaces") ? 5 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_2_0 = \u0275\u0275pipeBind1(8, 17, ctx.filters)) == null ? null : tmp_2_0.shown_types == null ? null : tmp_2_0.shown_types.includes("desk")) && ctx.hasFeature("desks") ? 7 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_3_0 = \u0275\u0275pipeBind1(10, 19, ctx.filters)) == null ? null : tmp_3_0.shown_types == null ? null : tmp_3_0.shown_types.includes("parking")) && ctx.hasFeature("parking") ? 9 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_4_0 = \u0275\u0275pipeBind1(12, 21, ctx.filters)) == null ? null : tmp_4_0.shown_types == null ? null : tmp_4_0.shown_types.includes("visitor")) && ctx.hasFeature("visitor-invite") ? 11 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_5_0 = \u0275\u0275pipeBind1(14, 23, ctx.filters)) == null ? null : tmp_5_0.shown_types == null ? null : tmp_5_0.shown_types.includes("locker")) && ctx.hasFeature("lockers") ? 13 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_6_0 = \u0275\u0275pipeBind1(16, 25, ctx.filters)) == null ? null : tmp_6_0.shown_types == null ? null : tmp_6_0.shown_types.includes("group-event")) && ctx.hasFeature("group-events") ? 15 : -1);
    \u0275\u0275advance(7);
    \u0275\u0275conditional(((tmp_7_0 = \u0275\u0275pipeBind1(23, 27, ctx.filters)) == null ? null : tmp_7_0.shown_types == null ? null : tmp_7_0.shown_types.includes("event")) && ctx.hasFeature("spaces") ? 22 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_8_0 = \u0275\u0275pipeBind1(25, 29, ctx.filters)) == null ? null : tmp_8_0.shown_types == null ? null : tmp_8_0.shown_types.includes("desk")) && ctx.hasFeature("desks") ? 24 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_9_0 = \u0275\u0275pipeBind1(27, 31, ctx.filters)) == null ? null : tmp_9_0.shown_types == null ? null : tmp_9_0.shown_types.includes("parking")) && ctx.hasFeature("parking") ? 26 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_10_0 = \u0275\u0275pipeBind1(29, 33, ctx.filters)) == null ? null : tmp_10_0.shown_types == null ? null : tmp_10_0.shown_types.includes("visitor")) && ctx.hasFeature("visitor-invite") ? 28 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_11_0 = \u0275\u0275pipeBind1(31, 35, ctx.filters)) == null ? null : tmp_11_0.shown_types == null ? null : tmp_11_0.shown_types.includes("locker")) && ctx.hasFeature("lockers") ? 30 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_12_0 = \u0275\u0275pipeBind1(33, 37, ctx.filters)) == null ? null : tmp_12_0.shown_types == null ? null : tmp_12_0.shown_types.includes("group-event")) && ctx.hasFeature("group-events") ? 32 : -1);
  }
}, dependencies: [CommonModule, AsyncPipe, TranslatePipe, IconComponent, MatRippleModule, MatRipple], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleFiltersComponent, { className: "ScheduleFiltersComponent", filePath: "apps/workplace/src/app/schedule/schedule-filters.component.ts", lineNumber: 270 });
})();
...
_ScheduleMobileCalendarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleMobileCalendarComponent, selectors: [["schedule-mobile-calendar"]], features: [\u0275\u0275ProvidersFeature([
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 1, (ctx.date_list[6] == null ? null : ctx.date_list[6].id) || ctx.active_date, "LLLL yyyy"), " ");
    \u0275\u0275advance(13);
    \u0275\u0275repeater(\u0275\u0275pipeBind3(18, 4, ctx.date_list, 0, 7));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx.list);
  }
}, dependencies: [CommonModule, SlicePipe, DatePipe, MatRipple, IconComponent], encapsulation: 2 });
...
function ScheduleSidebarComponent_Conditional_10_For_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ScheduleSidebarComponent_Conditional_10_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 16);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, ScheduleSidebarComponent_Conditional_10_For_5_Conditional_2_Template, 3, 3, "span", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ScheduleSidebarComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, ScheduleSidebarComponent_Conditional_10_For_5_Template, 3, 3, "mat-option", 16, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(6, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(3, 1, ctx_r1.week_date));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(6, 3, ctx_r1.week_options));
  }
}
...
_ScheduleSidebarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleSidebarComponent, selectors: [["schedule-sidebar"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 22, consts: [[1, "bg-base-100[#1F2021]", "border-base-200", "flex", "h-full", "w-[18rem]", "flex-col", "overflow-hidden", "border-r"], [1, "flex", "items-center", "space-x-2", "p-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], [1, "w-full", "px-2"], [1, "border-base-200", "border-b", 3, "ngModel", "offset_weekday"], [1, "mx-4", "mt-4", "font-medium"], [1, "h-1/2", "flex-1", "space-y-4", "overflow-auto", "p-4"], ["matRipple", "", "name", "schedule-toggle-event-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-desk-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-parking-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-visitor-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["matRipple", "", "name", "schedule-toggle-locker-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left"], ["btn", "", "matRipple", "", 1, "inverse", "w-full", 3, "click"], [1, "border-base-200", "border-b", 3, "ngModelChange", "ngModel", "offset_weekday"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["placeholder", "Select Week...", 3, "ngModelChange", "ngModel"], [1, "leading-tight", 3, "value"], [1, "text-info", "px-1", "text-xs", 3, "matTooltip"], ["matRipple", "", "name", "schedule-toggle-event-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], [1, "bg-base-200", "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", "text-2xl"], [1, "flex-1"], [1, ""], [1, "text-sm", "opacity-60"], [3, "ngModel"], ["matRipple", "", "name", "schedule-toggle-desk-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], ["src", "assets/icons/desk-outline.svg", 1, "w-6"], ["matRipple", "", "name", "schedule-toggle-parking-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], ["matRipple", "", "name", "schedule-toggle-visitor-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"], ["matRipple", "", "name", "schedule-toggle-locker-filter", 1, "flex", "w-full", "items-center", "space-x-2", "text-left", 3, "click"]], template: function ScheduleSidebarComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(9, ScheduleSidebarComponent_Conditional_9_Template, 2, 4, "date-calendar", 4);
    \u0275\u0275conditionalCreate(10, ScheduleSidebarComponent_Conditional_10_Template, 7, 5, "div", 3);
    \u0275\u0275elementStart(11, "h3", 5);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 6);
    \u0275\u0275conditionalCreate(15, ScheduleSidebarComponent_Conditional_15_Template, 13, 9, "button", 7);
    \u0275\u0275conditionalCreate(16, ScheduleSidebarComponent_Conditional_16_Template, 12, 9, "button", 8);
    \u0275\u0275conditionalCreate(17, ScheduleSidebarComponent_Conditional_17_Template, 13, 9, "button", 9);
    \u0275\u0275conditionalCreate(18, ScheduleSidebarComponent_Conditional_18_Template, 13, 9, "button", 10);
    \u0275\u0275conditionalCreate(19, ScheduleSidebarComponent_Conditional_19_Template, 13, 9, "button", 11);
    \u0275\u0275conditionalCreate(20, ScheduleSidebarComponent_Conditional_20_Template, 13, 9, "button", 11);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.hasFeature("parking") ? 17 : -1);
    \u0275\u0275advance();
...
function ScheduleComponent_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(1, 1, ctx_r1.date));
  }
}
function ScheduleComponent_Conditional_12_For_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ScheduleComponent_Conditional_12_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 13);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, ScheduleComponent_Conditional_12_For_6_Conditional_2_Template, 3, 3, "span", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ScheduleComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, ScheduleComponent_Conditional_12_For_6_Template, 3, 3, "mat-option", 13, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(7, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(3, 2, ctx_r1.week_date))("placeholder", \u0275\u0275pipeBind1(4, 4, "COMMON.WEEK_SELECT"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(7, 6, ctx_r1.week_options));
  }
}
...
function ScheduleComponent_Conditional_15_For_1_For_5_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_r5 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("booking", item_r5)("edit_fn", ctx_r1.edit_booking_fn)("remove_fn", ctx_r1.remove_fn)("end_fn", ctx_r1.end_fn);
  }
}
function ScheduleComponent_Conditional_15_For_1_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ScheduleComponent_Conditional_15_For_1_For_5_Conditional_0_Template, 1, 3, "event-card", 16)(1, ScheduleComponent_Conditional_15_For_1_For_5_Conditional_1_Template, 1, 4, "booking-card", 17);
  }
  if (rf & 2) {
...
function ScheduleComponent_Conditional_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(2, 0, ctx_r1.booking_dates));
  }
}
function ScheduleComponent_Conditional_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind1(4, 2, "APP.WORKPLACE.SCHEDULE_EMPTY"), " ", \u0275\u0275pipeBind2(6, 6, \u0275\u0275pipeBind1(5, 4, ctx_r1.date), "EEEE, dd LLL yyyy"), " ");
  }
}
...
function ScheduleComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
...
_ScheduleComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleComponent, selectors: [["app-schedule"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 20, consts: [[1, "bg-base-200", "relative", "flex", "h-1/2", "flex-1", "flex-col", "sm:flex-row"], [1, "bg-base-100", "hidden", "sm:block"], [1, "border-neutral", "bg-base-100", "w-full", "border-b", "sm:hidden"], [1, "flex", "items-center", "space-x-2", "px-2", "pt-2"], ["btn", "", "matRipple", "", 1, "flex-1", 3, "click"], [3, "ngModel"], [1, "my-2", "w-full", "px-2"], [1, "h-full", "flex-1", "space-y-2", "overflow-auto", "p-4"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "p-8"], ["mode", "indeterminate", 1, "absolute", "inset-x-0", "bottom-0"], [3, "ngModelChange", "ngModel"], ["appearance", "outline", 1, "no-subscript", "w-full"], [3, "ngModelChange", "ngModel", "placeholder"], [1, "leading-tight", 3, "value"], [1, "text-info", "px-1", "text-xs", 3, "matTooltip"], [1, "my-2", "font-medium"], [3, "event", "edit_fn", "remove_fn"], [3, "booking", "edit_fn", "remove_fn", "end_fn"], ["src", "assets/img/no-events.svg", 1, "mr-4"], [1, "opacity-30"]], template: function ScheduleComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(11, ScheduleComponent_Conditional_11_Template, 2, 3, "schedule-mobile-calendar", 5);
    \u0275\u0275conditionalCreate(12, ScheduleComponent_Conditional_12_Template, 8, 8, "div", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 7);
    \u0275\u0275element(14, "schedule-filters");
    \u0275\u0275conditionalCreate(15, ScheduleComponent_Conditional_15_Template, 3, 2);
    \u0275\u0275pipe(16, "async");
    \u0275\u0275conditionalBranchCreate(17, ScheduleComponent_Conditional_17_Template, 7, 9, "div", 8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, ScheduleComponent_Conditional_18_Template, 1, 0, "mat-progress-bar", 9);
    \u0275\u0275pipe(19, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(20, ScheduleComponent_Conditional_20_Template, 1, 0, "footer-menu");
  }
  if (rf & 2) {
    let tmp_7_0;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_7_0 = \u0275\u0275pipeBind1(16, 16, ctx.booking_dates)) == null ? null : tmp_7_0.length) ? 15 : 17);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(19, 18, ctx.loading) ? 18 : -1);
    \u0275\u0275advance(2);
...
_AppScheduleModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [ScheduleComponent, RouterModule.forChild(ROUTES)] });
...
//# sourceMappingURL=schedule.module-H2BTAJFS.js.map
