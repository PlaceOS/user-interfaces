...
function InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_14_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, InviteVisitorFormComponent_Conditional_0_Conditional_0_Conditional_5_Conditional_14_Conditional_7_For_5_Template, 2, 4, "mat-checkbox", 39, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(5);
...
var InviteVisitorFormComponent = class _InviteVisitorFormComponent {
  ...
  async _loadSiblingVisitors(booking_ref) {
    ...
    this.model.update((m) => __spreadProps(__spreadValues({}, m), { assets: visitors }));
  ...
  async _bookForMany() {
    ...
    if (this.is_edit()) {
      ...
      if (!existing_siblings.length) {
        existing_siblings = await this._service.loadGroupSiblings(new Booking(this.model()));
      }
      if (!existing_siblings.length) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InviteVisitorFormComponent, { className: "InviteVisitorFormComponent", filePath: "libs/bookings/src/lib/invite-visitor-form.component.ts", lineNumber: 594 });
})();
...
//# sourceMappingURL=visitor-flow.component-32ELFIV6.js.map
