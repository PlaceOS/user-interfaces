...
_SearchOverlayComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchOverlayComponent, selectors: [["search-overlay"]], inputs: { item_list: [1, "item_list"], result_template: [1, "result_template"] }, outputs: { selected: "selected", close: "close" }, features: [\u0275\u0275NgOnChangesFeature], decls: 14, vars: 5, consts: [[1, "absolute", "inset-0", "flex", "flex-col", "items-center", "p-8", 3, "click", "keydown.esc"], [1, "absolute", "inset-0", "z-0", "bg-base-content", "opacity-70"], [1, "relative", "z-10", "mx-auto", "mb-4", "w-lg", "max-w-[calc(100%-2rem)]", 3, "click"], [1, "w-full", "rounded-[4rem]", "border", "border-base-300", "bg-base-100", "py-4", "pl-14", "pr-6", "text-xl", "text-base-content", "shadow-sm", 3, "ngModelChange", "ngModel", "placeholder"], [1, "pointer-events-none", "absolute", "left-3", "top-1/2", "-translate-y-1/2", "text-3xl"], [1, "z-10", "mx-auto", "max-h-[65%]", "w-lg", "max-w-[calc(100%-2rem)]", "overflow-auto", "rounded-sm", 3, "click"], ["matRipple", "", 1, "w-full", "text-left"], ["matRipple", "", 1, "w-full", "p-4", "text-base-100"], ["icon", "", "matRipple", "", 1, "absolute", "right-8", "top-10", "h-12", "w-12", "text-xl", "text-base-100"], ["matRipple", "", 1, "w-full", "text-left", 3, "click"], [1, "w-full", "border", "border-base-300", "bg-base-100", "p-4", "hover:bg-base-200"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], ["matRipple", "", 1, "w-full", "p-4", "text-base-100", 3, "click"], [1, "opacity-30"]], template: function SearchOverlayComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _SignageApprovePlaylistModalComponent = class _SignageApprovePlaylistModalComponent {
  constructor() {
    ...
    this.loading = signal("");
    this.playlist_versions = this._playlist_id.pipe(filter((_) => !!_), tap(() => this.loading.set("Loading versions...")), switchMap((id) => sl(id, { limit: 2 })), shareReplay(1));
  ...
  async undoChanges() {
    ...
    await lastValueFrom(ul(this._playlist.id, previous.items));
    this.loading.set("");
  ...
  async approve() {
    ...
    this._dialog_ref.disableClose = true;
    await lastValueFrom(ol(this._playlist.id));
    this.loading.set("");
    this._dialog_ref.disableClose = false;
...
_SignageApprovePlaylistModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageApprovePlaylistModalComponent, selectors: [["signage-approve-playlist-modal"]], decls: 7, vars: 2, consts: [[1, "p-2"], [1, "rounded-sm", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "space-x-2", "py-2"], [1, "w-[24rem]", "rounded-sm", "border", "border-base-300", "bg-success-light"], [1, "flex", "items-center", "space-x-8", "rounded-sm", "border-b", "border-base-300", "bg-base-200", "px-4", "py-2"], [1, "font-mono", "text-xs", "opacity-50"], [1, "space-y-2", "p-2"], [1, "px-2", "text-sm"], [1, "flex", "items-center", "space-x-2", "rounded-sm", "border", "border-base-300", "bg-base-100", "p-2"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-30"], [1, "w-[24rem]", "rounded-sm", "border", "border-base-300", "bg-error-light"], [1, "space-y-2", "px-2", "text-sm"], [1, "flex", "items-center", "justify-end", "space-x-2", "rounded-sm", "bg-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "inverse", "w-40", "bg-base-100", 3, "click"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], ["matRipple", "", 1, "h-10", "w-10", "shrink-0", "overflow-hidden", "rounded-sm", "bg-base-200", 3, "click"], [1, "truncate"], ["auth", "", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "absolute", "inset-0", "flex", "items-end", "justify-end", "p-1", "opacity-0", "transition-opacity", "duration-200", "hover:opacity-100"], [1, "text-lg"], [1, "text-4xl"], [1, "text-sm"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-4"], ["diameter", "32"]], template: function SignageApprovePlaylistModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaModalComponent, { className: "SignageMediaModalComponent", filePath: "apps/concierge/src/app/signage/signage-media-modal.component.ts", lineNumber: 247 });
})();
...
_SignageMediaPreviewModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaPreviewModalComponent, selectors: [["signage-media-preview-modal"]], outputs: { save: "save" }, decls: 10, vars: 8, consts: [[1, "flex", "items-center", "justify-between", "border-b", "border-base-300", "p-2"], [1, "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "bg-base-200"], [1, "flex", "h-80", "max-h-[65vh]", "w-md", "max-w-[80vw]", "flex-col", "items-center", "justify-center", "p-8"], [1, "flex", "items-center", "justify-end", "space-x-2", "border-t", "border-base-300", "p-2"], [1, "flex", "h-[65vh]", "max-h-[65vh]", "w-[80vw]", "max-w-[80vw]", "items-center", "justify-center"], ["auth", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [1, "h-full", "w-full", "object-contain", "object-center", 3, "src"], ["auth", "", "autoplay", "", "controls", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function SignageMediaPreviewModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
])], decls: 8, vars: 3, consts: [[1, "mb-1", "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "border", "border-base-300", "focus-within:border-base-content", "focus-within:outline-4", "focus-within:outline-base-content", 3, "formGroup"], ["placeholder", "*", "name", "minute", "formControlName", "minute", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-hidden", 3, "keydown"], ["placeholder", "*", "name", "hour", "formControlName", "hour", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-hidden"], ["placeholder", "*", "name", "day", "formControlName", "day", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-hidden"], ["placeholder", "*", "name", "month", "formControlName", "month", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-hidden"], ["placeholder", "*", "name", "day_of_week", "formControlName", "day_of_week", 1, "w-px", "flex-1", "border-none", "bg-none", "px-2", "py-3", "text-base", "outline-hidden"], [1, "text-xs", "text-error"]], template: function CronInputFieldComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, decls: 114, vars: 94, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], ["for", "name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], [1, "mb-4", "flex", "items-center", "space-x-4"], ["formControlName", "enabled", 1, "flex-1", 3, "name"], ["formControlName", "random", 1, "flex-1", 3, "name"], [1, "pb-4", "pt-2"], [1, "relative", "rounded-sm", "border", "border-base-300"], ["for", "default-duration", 1, "absolute", "left-2", "top-0", "m-0", "flex", "w-auto", "min-w-0", "-translate-y-1/2", "items-center", "space-x-2", "bg-base-100", "px-2"], [1, "flex", "items-center", "px-2", "pt-2"], ["min", "5000", "max", "300000", "step", "1000", 1, "flex-1"], ["name", "default-duration", "matSliderThumb", "", "formControlName", "default_duration"], [1, "w-16", "px-2", "text-right", "font-mono", "text-xs"], [1, "flex", "space-x-2"], [1, "flex-1"], ["for", "orientation"], ["name", "orientation", "formControlName", "orientation", 3, "placeholder"], ["value", "unspecified"], ["value", "landscape"], ["value", "portrait"], ["value", "square"], ["for", "animation"], ["name", "animation", "formControlName", "default_animation", 3, "placeholder"], [3, "value"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 1, "min-h-32", 3, "placeholder"], [1, "flex", "space-x-4"], ["for", "valid-from"], ["name", "valid-from", "formControlName", "valid_from", 1, "w-full"], ["for", "valid-until"], ["name", "valid-until", "formControlName", "valid_until", 1, "w-full", 3, "from"], [1, "relative", "mb-12", "space-y-2", "rounded-sm", "border", "border-base-300", "px-4", "pt-4"], ["for", "schedule", 1, "absolute", "left-2", "top-0", "m-0", "flex", "w-auto", "min-w-0", "-translate-y-1/2", "items-center", "space-x-2", "bg-base-100", "px-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], [3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", ""], ["value", "between"], ["value", "exact", 3, "click"], ["value", "recurring", 3, "click"], [1, "pt-2"], ["for", "play-from"], ["name", "play-from", "formControlName", "play_from", 1, "w-full", 3, "no_past_times"], ["for", "play-until"], ["name", "play-until", "formControlName", "play_until", 1, "w-full", 3, "no_past_times", "from"], ["for", "play-at"], ["name", "play-at", "formControlName", "play_at", 1, "w-full"], ["for", "play-at-time"], ["name", "play-at-time", 1, "w-full", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "play-duration"], ["name", "play-duration", "formControlName", "play_duration", 1, "w-full"], ["formControlName", "play_once", 1, "mb-4"], ["formControlName", "play_cron"]], template: function SignagePlaylistModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
...
var _SignageStateService = class _SignageStateService extends AsyncHandler {
  constructor() {
    ...
    this.playlists = combineLatest([
      this._org.active_building,
      this._change
    ]).pipe(filter(([_]) => !!_?.id), debounceTime(300), switchMap(() => Xa({ limit: 500 })), map((_) => (_.data || []).sort((a, b) => a.name.localeCompare(b.name))), shareReplay(1));
  ...
  async savePlaylist(playlist) {
    const call = lastValueFrom(playlist.id ? tl(playlist.id, playlist, "put") : nl(playlist));
  ...
  previewFileMedia(media, playlist_id = "") {
    ...
    ref.componentInstance.save.subscribe(async () => {
      ...
      if (playlist_id && new_media.id) {
        const media_list = await lastValueFrom(il(playlist_id));
        const new_media_list = [...media_list.items, new_media.id];
        await lastValueFrom(ul(playlist_id, new_media_list));
      }
      ref.close();
    });
  }
...
function SignageItemPlaylistsComponent_Conditional_6_For_2_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("top", 0.5 + \u0275$index_36_r5 * 1 + "rem")("left", 0.5 + \u0275$index_36_r5 * 1 + "rem");
...
function SignageItemPlaylistsComponent_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(7, SignageItemPlaylistsComponent_Conditional_6_For_2_For_8_Template, 1, 5, "img", 15, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageItemPlaylistsComponent_Conditional_6_For_2_Template_button_click_28_listener() {
      const item_r6 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.remove.emit(item_r6));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(21, _c13))("queryParams", \u0275\u0275pureFunction1(22, _c2, item_r6.id));
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.playlist_thumbnail_media()[item_r6.id] || \u0275\u0275pureFunction0(24, _c3));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", item_r6.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(14, 13, "APP.CONCIERGE.SIGNAGE_MEDIA_COUNT", \u0275\u0275pureFunction1(25, _c4, ((tmp_17_0 = ctx_r0.playlist_count()[item_r6.id]) == null ? null : tmp_17_0.count) || 0), ((tmp_17_0 = ctx_r0.playlist_count()[item_r6.id]) == null ? null : tmp_17_0.count) || 0), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.isScheduled(item_r6) ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", menu_r7);
    \u0275\u0275advance(5);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(27, _c13))("queryParams", \u0275\u0275pureFunction1(28, _c2, item_r6.id));
    \u0275\u0275advance(5);
...
var PLAYLIST_ITEM_MEDIA = signal({});
var _SignageItemPlaylistsComponent = class _SignageItemPlaylistsComponent {
  constructor() {
        ...
        this._state.getPlaylistMedia(item.id).then(async (media) => {
          ...
          for (const id of media) {
            if (!thumbnails.find((_) => _.id === id)) {
              media_requests.push(lastValueFrom(Ga(id)).catch(() => null));
            }
          }
          if (media_requests.length) {
            const media_items = await Promise.all(media_requests);
            for (const item2 of media_items) {
              if (!item2)
                continue;
              thumbnails.push(item2);
            }
          }
          this.playlist_media.update((m) => __spreadProps(__spreadValues({}, m), {
            [item.id]: thumbnails
          }));
        });
      }
    ...
    this.playlist_media = PLAYLIST_ITEM_MEDIA;
    this.playlist_thumbnail_media = computed(() => {
      ...
      for (const [playlist_id, media_items] of Object.entries(thumbnails)) {
        result[playlist_id] = media_items.slice(0, 2).map((item) => `/api/engine/v2/uploads/${encodeURIComponent(item.thumbnail_id)}/url`).filter((m) => m);
      }
      return result;
    });
  }
...
_SignageItemPlaylistsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageItemPlaylistsComponent, selectors: [["signage-item-playlists"]], inputs: { item: [1, "item"], name: [1, "name"], extra: [1, "extra"], link: [1, "link"] }, outputs: { add: "add", remove: "remove", ondrop: "ondrop" }, features: [\u0275\u0275NgOnChangesFeature], ngContentSelectors: _c05, decls: 8, vars: 4, consts: [["menu", "matMenu"], [1, "flex", "items-center", "justify-center", "space-x-2", "rounded-xl", "bg-base-100", "p-2"], [1, "text-xl", "font-medium"], [1, "rounded-lg", "bg-base-200", "px-2", "py-1", "font-mono", "text-xs", "uppercase"], ["icon", "", "matRipple", "", "target", "_blank", "rel", "noopener noreferrer", 1, "text-xs", 3, "href", "matTooltip"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["cdkDropList", "", 1, "mt-4", "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", 3, "cdkDropListDropped"], ["cdkDrag", "", 1, "flex", "h-20", "w-full", "items-center", "space-x-2", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-2"], ["btn", "", "matRipple", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["class", "h-20 w-full rounded-xl border-4 border-dashed border-base-400 bg-base-300", 4, "cdkDragPlaceholder"], ["matRipple", "", "cdkDragHandle", "", 1, "m-0!", "flex", "h-full", "w-6", "items-center", "justify-center", "rounded-sm", "hover:bg-base-200", 3, "matTooltip"], ["preview", "", "matRipple", "", 1, "h-14", "w-14", "overflow-hidden", "rounded-sm", "border", "border-base-200", "bg-base-200", 3, "routerLink", "queryParams"], ["auth", "", 1, "absolute", "h-full", "w-full", "rounded-sm", "object-cover", "shadow-lg", 3, "source", "top", "left"], [1, "w-1/2", "flex-1", "text-base-content"], [1, "truncate"], [1, "truncate", "text-sm", "opacity-30"], [1, "rounded-sm", "border", "border-info", "bg-info-light", "p-1", "text-lg", 3, "matTooltip"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "routerLink", "queryParams"], ["mat-menu-item", "", 3, "click"], [1, "text-2xl", "text-error"], [1, "h-20", "w-full", "rounded-xl", "border-4", "border-dashed", "border-base-400", "bg-base-300"], ["auth", "", 1, "absolute", "h-full", "w-full", "rounded-sm", "object-cover", "shadow-lg", 3, "source"], [1, "flex", "flex-col", "items-center", "justify-center", "opacity-30"], [1, "text-6xl"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"]], template: function SignageItemPlaylistsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275projectionDef();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageItemPlaylistsComponent, { className: "SignageItemPlaylistsComponent", filePath: "apps/concierge/src/app/signage/signage-item-playlists.component.ts", lineNumber: 247 });
})();
...
_ZoneSelectModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneSelectModalComponent, selectors: [["app-zone-select-modal"]], decls: 14, vars: 8, consts: [[1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "h-[65vh]", "min-w-lg", "max-w-lg", "space-y-2", "overflow-auto", "px-4", "pb-4", "pt-2", "text-center"], ["appearance", "outline", 1, "no-subscript", "sticky", "top-0", "z-10", "w-full", "bg-base-100"], ["matInput", "", "placeholder", "Search zones", 3, "ngModelChange", "ngModel"], ["matRipple", "", 1, "z-0", "flex", "h-16", "w-full", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "border-base-300", "p-2", "text-left", "hover:bg-base-200", 3, "mat-dialog-close"], [1, "flex", "h-[calc(100%-3.5rem)]", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-lg", "bg-base-200", "p-16"], ["matRipple", "", "class", "z-0 flex h-16 w-full items-center justify-center space-x-2 rounded-sm border border-base-300 p-2 text-left hover:bg-base-200", 3, "mat-dialog-close", 4, "ngFor", "ngForOf"], [1, "flex-1"], [1, ""], [1, "text-xs", "opacity-30"], [1, "rounded-lg", "bg-info", "px-2", "py-1", "font-mono", "text-[0.625rem]", "text-info-content"], [1, "text-8xl", "opacity-30"], [1, "opacity-30"]], template: function ZoneSelectModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
...
_SignageDisplaysComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageDisplaysComponent, selectors: [["signage-displays"]], decls: 14, vars: 10, consts: [["menu", "matMenu"], ["orientationMenu", "matMenu"], [1, "relative", "flex", "h-full", "w-full", "space-x-2", "overflow-visible"], ["sidebar", "", 1, "flex", "h-full", "w-64", "flex-col", "space-y-2", "overflow-auto", "rounded-xl", "border", "border-base-300", "p-2"], [1, "rounded-lg", "bg-base-200", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], [1, "h-1/2", "w-full", "flex-1", "space-y-2", "overflow-auto"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", "rounded-lg", "border", "border-base-300", "bg-base-200", "p-2", "shadow-sm"], [1, "flex", "flex-1", "flex-col", 3, "item", "name", "extra", "link"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "opacity-30"], [3, "item_list"], ["matRipple", "", 1, "relative", "z-10", "flex", "h-12", "min-h-12", "w-full", "items-center", "truncate", "rounded-3xl", "border", "border-base-100", "px-6", "even:border-base-200", "even:bg-base-200", "hover:border-info", 3, "routerLink", "queryParams"], [1, "relative", "z-0", "flex", "items-center", "space-x-2"], [1, "w-6"], [1, "absolute", "left-6", "top-1/2", "z-0", "h-16", "w-4", "-translate-y-full", "border-b-2", "border-l-2", "border-base-300"], ["matRipple", "", 1, "relative", "z-10", "flex", "min-h-12", "w-1/2", "flex-1", "items-center", "truncate", "rounded-3xl", "px-6", "hover:bg-base-200", 3, "routerLink", "queryParams"], [1, "max-w-full", "truncate"], [1, "text-6xl"], [1, "text-center"], [1, "flex", "flex-1", "flex-col", 3, "add", "remove", "ondrop", "item", "name", "extra", "link"], [1, "mt-2", "flex", "flex-wrap", "items-center", "overflow-auto", "rounded-xl", "bg-base-100", "p-1"], ["icon", "", "matRipple", "", 1, "absolute", "right-2", "top-2", "m-0!", 3, "matMenuTriggerFor"], ["mat-menu-item", "", "target", "_blank", "ref", "noopener noreferrer", 3, "href"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "text-2xl", "text-error"], ["matRipple", "", 1, "m-1", "whitespace-nowrap", "rounded-sm", "bg-base-200", "px-2", "py-1", "font-mono", "text-xs", 3, "routerLink", "queryParams"], ["matRipple", "", 1, "m-1", "rounded-sm", "px-2", "py-1", "font-mono", "text-xs", "underline", 3, "click"], [3, "selected", "close", "item_list"]], template: function SignageDisplaysComponent_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_18_For_2_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37)(1, "icon", 38);
    \u0275\u0275text(2, " add ");
    \u0275\u0275elementEnd()();
  }
}
function SignageMediaListComponent_Conditional_18_For_2_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 39);
    \u0275\u0275elementStart(1, "div", 40)(2, "icon", 33);
    \u0275\u0275text(3, "expand_content");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function SignageMediaListComponent_Conditional_18_For_2_For_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 32)(2, "div", 34);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function SignageMediaListComponent_Conditional_18_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, SignageMediaListComponent_Conditional_18_For_2_Conditional_5_Template, 4, 1);
    \u0275\u0275elementStart(6, "div", 22);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, SignageMediaListComponent_Conditional_18_For_2_Conditional_9_Template, 3, 3, "div", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 24)(11, "div", 25);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "button", 26)(14, "icon");
    \u0275\u0275text(15, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-menu", null, 1)(18, "div", 27)(19, "mat-form-field", 28);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(22, SignageMediaListComponent_Conditional_18_For_2_Conditional_22_Template, 3, 4, "button", 29);
    \u0275\u0275repeaterCreate(23, SignageMediaListComponent_Conditional_18_For_2_For_24_Template, 4, 1, "button", 30, _forTrack04);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-menu", null, 2)(27, "button", 31);
    ...
    \u0275\u0275elementStart(28, "div", 32)(29, "icon", 33);
    \u0275\u0275text(30, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(34, "button", 35)(35, "div", 32)(36, "icon", 33);
    \u0275\u0275text(37, "add");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(42, "div", 32)(43, "icon", 33);
    ...
    \u0275\u0275elementStart(49, "div", 32)(50, "icon", 36);
    \u0275\u0275text(51, " delete ");
    \u0275\u0275elementEnd();
...
function SignageMediaListComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "icon", 41);
    \u0275\u0275text(2, "hide_image");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4);
...
var _SignageMediaListComponent = class _SignageMediaListComponent {
  ...
  async addToPlaylist(media_id, playlist) {
    const media_list = await lastValueFrom(il(playlist.id));
...
_SignageMediaListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaListComponent, selectors: [["signage-media-list"]], inputs: { playlist_count: [1, "playlist_count"] }, features: [\u0275\u0275NgOnChangesFeature], decls: 20, vars: 15, consts: [["add_link_template", ""], ["playlist_menu", "matMenu"], ["menu", "matMenu"], [1, "relative", "p-2"], [1, "mb-2", "rounded-xl", "bg-base-100", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "white", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["icon", "", "matRipple", "", "customTooltip", "", "matTooltipPosition", "left", 1, "absolute", "right-14", "top-3", "h-9!", "max-h-9", "w-9!", "min-w-0", "max-w-9", "border", "border-base-300", 3, "content", "matTooltip"], ["icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "right-3", "top-3", "h-9!", "max-h-9", "w-9!", "min-w-0", "max-w-9", "border", "border-base-300", 3, "matTooltip"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["cdkDropList", "", "id", "media-list", 1, "grid", "w-full", "gap-4", "p-4", "md:grid-cols-2", "lg:grid-cols-3", 3, "cdkDropListData", "cdkDropListConnectedTo"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], [1, "my-2", "flex", "w-[20rem]", "flex-col", "space-y-4", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-4", "shadow-sm"], ["appearance", "outline", 1, "no-subscript"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "mr-2", "text-2xl"], ["cdkDropList", "", "id", "media-list", 1, "grid", "w-full", "gap-4", "p-4", "md:grid-cols-2", "lg:grid-cols-3", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], ["cdkDrag", "", 1, "relative", "flex", "flex-col", "items-center", "justify-center", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-3", "hover:opacity-80"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-warning", "opacity-10"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-error", "opacity-10"], ["class", "flex min-h-10 min-w-10 items-center justify-center rounded-2xl border-4 border-dashed border-base-400 bg-base-300 opacity-30", 4, "cdkDragPlaceholder"], ["preview", "", "matRipple", "", 1, "relative", "h-36", "w-full", "overflow-hidden", "rounded-lg", "bg-base-200", 3, "click"], [1, "absolute", "left-1", "top-1", "rounded-lg", "px-2", "py-1", "font-mono", "text-xs", "capitalize"], [1, "absolute", "bottom-1", "right-1", "rounded-lg", "bg-info", "px-2", "py-1", "font-mono", "text-xs", "capitalize", "text-info-content"], [1, "relative", "top-1", "flex", "w-full", "items-center", "justify-between"], [1, "w-1/2", "flex-1", "truncate", "text-base-content", 3, "matTooltip"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], [1, "px-2"], ["appearance", "outline", 1, "no-subscript", "w-full", 3, "click"], ["mat-menu-item", "", 3, "disabled"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "text-2xl", "text-error"], [1, "flex", "min-h-10", "min-w-10", "items-center", "justify-center", "rounded-2xl", "border-4", "border-dashed", "border-base-400", "bg-base-300", "opacity-30"], [1, "text-2xl", "text-base-100"], ["auth", "", 1, "h-full", "w-full", "rounded-lg", "object-contain", 3, "source"], [1, "absolute", "inset-0", "flex", "items-end", "justify-end", "p-1", "opacity-0", "transition-opacity", "duration-200", "hover:opacity-100"], [1, "text-6xl"]], template: function SignageMediaListComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaListComponent, { className: "SignageMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-media-list.component.ts", lineNumber: 350 });
})();
...
var _SignagePlaylistMediaListComponent = class _SignagePlaylistMediaListComponent {
  constructor() {
    ...
    this._playlist_media = toSignal(toObservable(this._playlist_media_observable).pipe(filter((playlist) => !!playlist), debounceTime(300), tap(() => this.loading.set(true)), switchMap((playlist) => il(playlist.id).pipe(catchError(() => of({ id: "", items: [], approved: 0 })))), tap((_) => {
...
_SignagePlaylistMediaListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePlaylistMediaListComponent, selectors: [["signage-playlist-media-list"]], inputs: { playlist: [1, "playlist"], playlist_count: [1, "playlist_count"] }, features: [\u0275\u0275NgOnChangesFeature], decls: 67, vars: 45, consts: [["menu", "matMenu"], [1, "relative", "flex", "h-full", "w-full", "flex-col"], [1, "space-y-2", "p-2"], [1, "flex", "items-center", "justify-center", "space-x-2", "rounded-xl", "bg-base-100", "p-2"], [1, "text-xl", "font-medium"], [1, "rounded-sm", "bg-base-200", "px-2", "py-1", "font-mono", "text-xs"], ["icon", "", "matRipple", "", 1, "absolute", "right-2.5", "top-2.5", "m-0!", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "click", "disabled"], [1, "text-2xl", "text-error"], ["details", "", 1, "flex", "flex-wrap", "items-center", "rounded-xl", "bg-base-100", "p-1"], [1, "m-1", "ml-2", "rounded-sm", "px-2", "py-1", "text-xs"], [1, "m-1", "ml-2", "rounded-sm", "bg-secondary", "px-2", "py-1", "text-xs", "text-secondary-content"], ["matTooltip", "Default Transition Animation", 1, "m-1", "rounded-sm", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "ml-1", "rounded-sm", "bg-base-300", "px-2", "py-1", "uppercase"], ["matTooltip", "Default Playback Duration", 1, "m-1", "rounded-sm", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "ml-1", "rounded-sm", "bg-base-300", "px-2", "py-1", "font-mono"], ["matTooltip", "Prefered Orientation", 1, "m-1", "rounded-sm", "bg-base-200", "px-2", "py-2", "text-xs"], [1, "m-1", "rounded-sm", "bg-base-200", "px-2", "py-2", "text-xs", "uppercase"], ["matRipple", "", 1, "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "border-warning", "bg-warning", "p-1", "text-xs", "text-warning-content", "shadow-sm", 3, "disabled", "matTooltip"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], ["cdkDropList", "", "id", "playlist-list", 1, "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", "p-2", 3, "cdkDropListData", "cdkDropListConnectedTo"], ["matRipple", "", 1, "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "border-warning", "bg-warning", "p-1", "text-xs", "text-warning-content", "shadow-sm", 3, "click", "disabled", "matTooltip"], [1, "ml-1", "text-xl", "text-warning-content"], [1, "underline"], ["diameter", "32"], ["cdkDropList", "", "id", "playlist-list", 1, "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", "p-2", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], ["cdkDrag", "", 1, "relative", "flex", "h-20", "w-full", "items-center", "space-x-2", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-2"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-warning", "opacity-10"], [1, "absolute", "inset-0", "z-0", "rounded-lg", "bg-error", "opacity-10"], ["class", "flex min-h-10 min-w-10 items-center justify-center rounded-2xl border-4 border-dashed border-base-400 bg-base-300", 4, "cdkDragPlaceholder"], ["matRipple", "", "cdkDragHandle", "", "matTooltip", "Drag to reorder", 1, "m-0!", "flex", "h-full", "w-6", "items-center", "justify-center", "rounded-sm", "hover:bg-base-200"], ["preview", "", "matRipple", "", 1, "relative", "h-16", "w-18", "overflow-hidden", "rounded-lg", "bg-base-200", 3, "click"], ["auth", "", 1, "h-full", "w-full", "object-contain", 3, "source"], [1, "absolute", "inset-0", "flex", "items-end", "justify-end", "p-1", "opacity-0", "transition-opacity", "duration-200", "hover:opacity-100"], [1, "w-1/2", "flex-1", "truncate", "text-base-content"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], [1, "flex", "min-h-10", "min-w-10", "items-center", "justify-center", "rounded-2xl", "border-4", "border-dashed", "border-base-400", "bg-base-300"], [1, "text-2xl", "text-base-100"], [1, "text-6xl"]], template: function SignagePlaylistMediaListComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
...
var _SignageMediaComponent = class _SignageMediaComponent extends AsyncHandler {
  ...
  async drop(playlist, event) {
    ...
    const media_list = await il(playlist.id).toPromise();
...
_SignageMediaComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaComponent, selectors: [["signage-media"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 22, consts: [[1, "relative", "flex", "h-full", "w-full", "space-x-2", "overflow-visible"], ["sidebar", "", 1, "flex", "h-full", "w-64", "flex-col", "space-y-2", "overflow-auto", "rounded-xl", "border", "border-base-300", "p-2"], [1, "rounded-lg", "bg-base-200", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["matRipple", "", 1, "flex", "min-h-12", "w-full", "items-center", "rounded-xl", "px-6", "hover:bg-base-200", 3, "routerLink", "queryParams"], [1, "-mx-2", "w-[calc(100%+1rem)]", "border-base-300", "bg-base-300"], [1, "relative", "h-full", "w-1/2", "flex-1", "overflow-hidden", "rounded-lg", "border", "border-base-300", "bg-base-200", "shadow-sm", 3, "dragover", "dragenter", "drop"], [1, "h-full", "w-full", "overflow-auto"], [3, "playlist_count"], [3, "playlist", "playlist_count"], [1, "absolute", "inset-0"], ["matRipple", "", "cdkDropList", "", 1, "flex", "h-12", "min-h-12", "w-full", "items-center", "rounded-3xl", "border", "border-base-100", "px-6", "even:border-base-200", "even:bg-base-200", "hover:border-info", 3, "bg-secondary!", "text-secondary-content", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], ["matRipple", "", "cdkDropList", "", 1, "flex", "h-12", "min-h-12", "w-full", "items-center", "rounded-3xl", "border", "border-base-100", "px-6", "even:border-base-200", "even:bg-base-200", "hover:border-info", 3, "cdkDropListDropped", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], [1, "flex-1"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], [1, "text-6xl"], [1, "text-center"], ["btn", "", "matRipple", "", 1, "inverse"], ["btn", "", "matRipple", "", 1, "inverse", 3, "click"], [1, "flex", "w-full", "items-center", "justify-center"], [1, "text-2xl"], [1, "ml-2", "mr-4"], [1, "absolute", "inset-0", 3, "dragleave", "drop"], [1, "absolute", "inset-0", "bg-base-content", "opacity-60"], [1, "absolute", "inset-4", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-2xl", "border-4", "border-dashed", "border-base-300", "text-base-100"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"]], template: function SignageMediaComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_SignageZonesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageZonesComponent, selectors: [["signage-zones"]], decls: 14, vars: 10, consts: [[1, "relative", "flex", "h-full", "w-full", "space-x-2", "overflow-visible"], ["sidebar", "", 1, "flex", "h-full", "w-64", "flex-col", "space-y-2", "overflow-auto", "rounded-xl", "border", "border-base-300", "p-2"], [1, "rounded-lg", "bg-base-200", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], [1, "h-1/2", "w-full", "flex-1", "space-y-2", "overflow-auto"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-30"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", "rounded-lg", "border", "border-base-300", "bg-base-200", "p-2", "shadow-sm"], [1, "flex", "flex-1", "flex-col", 3, "item", "name"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "opacity-30"], [3, "item_list"], ["matRipple", "", 1, "z-10", "flex", "h-12", "min-h-12", "w-full", "items-center", "truncate", "rounded-3xl", "border", "border-base-100", "px-6", "even:border-base-200", "even:bg-base-200", "hover:border-info", 3, "routerLink", "queryParams"], [1, "relative", "z-0", "flex", "items-center", "space-x-2"], [1, "w-6"], [1, "absolute", "left-6", "top-1/2", "h-16", "w-4", "-translate-y-full", "border-b-2", "border-l-2", "border-base-300"], ["matRipple", "", 1, "flex", "min-h-12", "w-full", "items-center", "truncate", "rounded-3xl", "px-6", "hover:bg-base-200", 3, "routerLink", "queryParams"], [1, "text-6xl"], [1, "text-center"], [1, "flex", "flex-1", "flex-col", 3, "add", "remove", "ondrop", "item", "name"], [3, "selected", "close", "item_list"]], template: function SignageZonesComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_SignageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageComponent, selectors: [["", "app-new-staff", ""]], attrs: _c09, decls: 17, vars: 6, consts: [["tabPanel", ""], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "h-20", "items-center", "justify-between", "p-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 1, "w-40"], [1, "px-8"], [1, "overflow-hidden", "rounded-sm", "bg-base-200"], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", 3, "routerLink", "active"], [1, "h-1/2", "flex-1", "overflow-auto", "px-8", "py-2"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], ["mat-tab-link", "", 3, "click", "routerLink", "active"]], template: function SignageComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=signage.module-YDMNH2MT.js.map
