...
} from "./chunk-B5T4RP7P.js";
import {
  MatTab,
  MatTabGroup,
  MatTabsModule
} from "./chunk-UVQAV4E5.js";
...
function AppSettingsModalComponent_Conditional_4_Conditional_19_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("formControlName", feature_r8);
  }
}
function AppSettingsModalComponent_Conditional_4_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, AppSettingsModalComponent_Conditional_4_Conditional_19_For_5_Template, 4, 2, "button", 13, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AppSettingsModalComponent_Conditional_4_Conditional_20_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("formControlName", feature_r10);
  }
}
function AppSettingsModalComponent_Conditional_4_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 9);
    \u0275\u0275repeaterCreate(4, AppSettingsModalComponent_Conditional_4_Conditional_20_For_5_Template, 4, 2, "button", 13, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function AppSettingsModalComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "footer", 5)(1, "button", 18);
    \u0275\u0275text(2, " Discard ");
    \u0275\u0275elementEnd();
...
var _AppSettingsModalComponent = class _AppSettingsModalComponent {
  ...
  async ngOnInit() {
    ...
    const zone_settings = (await Xu(this.zone.id, `${this.workplace_key}`).toPromise().catch(() => ({ details: {} }))).details;
    const parent_settings = (await Xu(this.zone.parent_id, `${this.workplace_key}`).toPromise().catch(() => ({ details: {} }))).details;
    const org_settings = (await Xu(this._org.organisation.id, `${this.workplace_key}`).toPromise().catch(() => ({ details: {} }))).details;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppSettingsModalComponent, { className: "AppSettingsModalComponent", filePath: "apps/concierge/src/app/ui/app-settings-modal.component.ts", lineNumber: 242 });
})();
...
var _AutoReleaseSettingsModalComponent = class _AutoReleaseSettingsModalComponent {
  ...
  async loadSettings(id) {
    ...
    this.settings = { custom: [] };
    const settings = await nextValueFrom(Wc({ parent_id: id }).pipe(map((_) => _.data)));
  ...
  async save() {
    ...
    const settings = await lastValueFrom(Wc({ parent_id: this.id }).pipe(map((_) => _.data)));
    ...
    unencrypted.id ? await lastValueFrom(Bc(unencrypted.id, unencrypted)).catch(on_error) : await lastValueFrom(Vc(unencrypted)).catch(on_error);
    const metadata_key = this._settings.get("app.workplace_metadata_key") || "workplace_app";
    const metadata = await lastValueFrom(Xu(this.id, metadata_key));
    const details = metadata.details || {};
    details.auto_release = new_settings;
    await nextValueFrom(ec(this.id, {
      name: metadata_key,
      details,
      description: ""
    })).catch(on_error);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AutoReleaseSettingsModalComponent, { className: "AutoReleaseSettingsModalComponent", filePath: "apps/concierge/src/app/building-manager/auto-release-settings-modal.component.ts", lineNumber: 273 });
})();
...
var _BuildingFormComponent = class _BuildingFormComponent extends AsyncHandler {
  ...
  async saveChanges() {
    ...
    const building = await (data.id ? Fa(data.id, body) : za(body)).toPromise().catch((e) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildingFormComponent, { className: "BuildingFormComponent", filePath: "apps/concierge/src/app/building-manager/building-form.component.ts", lineNumber: 133 });
})();
...
var _InductionSettingsModalComponent = class _InductionSettingsModalComponent {
  ...
  async loadSettings() {
    ...
    const [bld_metadata, org_metadata, org_settings] = await Promise.all([
      await lastValueFrom(Xu(this._zone_id, visitor_kiosk_app)),
      await lastValueFrom(Xu(this._org.organisation.id, visitor_kiosk_app)),
      await lastValueFrom(Xu(this._org.organisation.id, "settings"))
    ]);
  ...
  async save() {
    ...
    this._dialog_ref.disableClose = true;
    const metadata = await lastValueFrom(Xu(this._zone_id, visitor_kiosk_app));
    const con_metadata = await lastValueFrom(Xu(this._zone_id, concierge_app));
    ...
    const result_visitor = await lastValueFrom(ec(this._zone_id, {
    ...
    const result_concierge = await lastValueFrom(ec(this._zone_id, {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InductionSettingsModalComponent, { className: "InductionSettingsModalComponent", filePath: "apps/concierge/src/app/building-manager/induction-settings-modal.component.ts", lineNumber: 93 });
})();
...
var _ItemListModalComponent = class _ItemListModalComponent {
  ...
  async ngOnInit() {
    const metadata_key = this._settings.get("app.workplace_metadata_key") || "workplace_app";
    const metadata = await Xu(this._bld_id, metadata_key).toPromise();
  ...
  async save() {
    ...
    let resp = await ec(this._bld_id, {
      name: metadata_key,
    ...
    const concierge_metadata = await Xu(this._bld_id, metadata_key).toPromise();
    concierge_metadata.details.support_issue_types = items;
    resp = await ec(this._bld_id, {
      name: concierge_key,
...
var _BuildingManagementService = class _BuildingManagementService {
  ...
  editBuildingMetadata(zone = new Un()) {
  ...
  async removeBuilding(building) {
    ...
    await Ha(building.id).toPromise().catch((e) => {
...
var _BookingPanelSettingsModalComponent = class _BookingPanelSettingsModalComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    ...
    const settings = await lastValueFrom(Wc({ parent_id: this.zone.id }).pipe(catchError(() => of({ data: [] })), map((_) => _.data)));
  ...
  async save() {
    ...
    const update = unencrypted_settings.id ? Bc(unencrypted_settings.id, new_setting) : Vc(new_setting);
...
_BookingPanelSettingsModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingPanelSettingsModalComponent, selectors: [["booking-panel-settings-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 66, vars: 17, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-4", 3, "formGroup"], [1, "border-base-300", "relative", "mb-4", "flex", "flex-col", "rounded-sm", "border", "p-2"], [1, "bg-base-100", "absolute", "top-0", "left-8", "-translate-y-1/2", "p-2", "text-sm"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Disable booking", "formControlName", "disable_book_now"], ["name", "Hide booking host options", "formControlName", "disable_book_now_host"], [1, "flex", "space-x-4"], [1, "h-20", "flex-1"], ["for", "min-duration"], ["name", "min-duration", "formControlName", "min_duration", 3, "min", "step", "max"], ["for", "max-duration"], ["name", "max-duration", "formControlName", "max_duration", 3, "min", "step", "max"], [1, "flex-1"], ["for", "pending_before"], ["name", "pending_before", "formControlName", "pending_before", 3, "min", "step", "max"], ["for", "pending_period"], ["name", "pending_period", "formControlName", "pending_period", 3, "min", "step", "max"], ["name", "Disable auto-ending bookings", "formControlName", "disable_end_meeting", "info", "Disable ending the current booking early when sensors\ndon't detect presence in room after a period of time"], ["name", "Show button to end booking early", "formControlName", "enable_end_meeting_button"], ["name", "Hide Meeting Details", "formControlName", "hide_meeting_details", "info", "When enabled only shows the time of the current meeting"], ["name", "Hide Meeting Title", "formControlName", "hide_meeting_title", "info", "When enabled only shows the time and host of the current meeting"], ["name", "Show Booking QR Code", "formControlName", "show_qr_code"], [1, "mb-2"], ["for", "custom-qr-url"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "custom-qr-url", "placeholder", "/workplace/#/book/room/?room_id=sys-123456", "formControlName", "custom_qr_url"], ["for", "room-image"], [1, "flex", "space-x-2"], ["appearance", "outline", 1, "w-1/2", "flex-1"], ["matInput", "", "name", "room-image", "placeholder", "/assets/images/room_test1.png", "formControlName", "room_image"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "disabled"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["for", "offline-image"], ["matInput", "", "name", "offline-image", "placeholder", "/assets/images/offline1.png", "formControlName", "offline_image"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "relative", "h-12", "w-12", "rounded-sm", 3, "disabled"]], template: function BookingPanelSettingsModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-form-field", 25);
    \u0275\u0275element(36, "input", 26);
    \u0275\u0275elementStart(37, "mat-error");
    \u0275\u0275text(38, " Custom QR Code URL must be a valid URL ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-hint");
    \u0275\u0275text(40, " Custom QR Code URL will replace the default Booking QR Code ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "div", 7)(42, "div", 13)(43, "label", 27);
    \u0275\u0275text(44, "Room Image URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "div", 28)(46, "mat-form-field", 29);
    \u0275\u0275element(47, "input", 30);
    \u0275\u0275elementStart(48, "mat-error");
    \u0275\u0275text(49, " Room Image must be a valid URL ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(50, "button", 31)(51, "icon");
    \u0275\u0275text(52, "cloud_upload");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "input", 32);
    \u0275\u0275listener("change", function BookingPanelSettingsModalComponent_Template_input_change_53_listener($event) {
      return ctx.uploadImage($event, "room_image");
    });
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(54, "div", 13)(55, "label", 33);
    \u0275\u0275text(56, "Offline Image URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "div", 28)(58, "mat-form-field", 29);
    \u0275\u0275element(59, "input", 34);
    \u0275\u0275elementStart(60, "mat-error");
    \u0275\u0275text(61, " Offline Image must be a valid URL ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(62, "button", 35)(63, "icon");
    \u0275\u0275text(64, "cloud_upload");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "input", 32);
    \u0275\u0275listener("change", function BookingPanelSettingsModalComponent_Template_input_change_65_listener($event) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingPanelSettingsModalComponent, { className: "BookingPanelSettingsModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/booking-panel-settings-modal.component.ts", lineNumber: 262 });
})();
...
function ConciergeSettingsFormModalComponent_Conditional_94_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "label", 68);
    \u0275\u0275text(2, " Group Events Calendar ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 11);
    \u0275\u0275element(4, "input", 69);
    \u0275\u0275elementStart(5, "mat-hint");
    \u0275\u0275text(6, " Calendar to add all group events to ");
    \u0275\u0275elementEnd()()();
  }
}
function ConciergeSettingsFormModalComponent_Conditional_122_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_122_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-form-field", 11)(13, "mat-select", 74)(14, "mat-option", 49);
    \u0275\u0275text(15, "12AM (Midnight)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "mat-option", 49);
    \u0275\u0275text(17, "1AM");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(39, " Start time of dayview blocks ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "div", 37)(41, "label", 73);
    \u0275\u0275text(42, "Block End Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "mat-form-field", 11)(44, "mat-select", 74)(45, "mat-option", 49);
    \u0275\u0275text(46, "12PM (Midday)");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(70, "12AM (Midnight)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(71, "mat-hint");
    \u0275\u0275text(72, " End time of dayview blocks ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(73, "div", 36)(74, "div", 37)(75, "label", 75);
    \u0275\u0275text(76, " Block Height ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "mat-form-field", 11)(78, "mat-select", 76)(79, "mat-option", 49);
    \u0275\u0275text(80, "1rem (16px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "mat-option", 49);
    \u0275\u0275text(82, "1.5rem (24px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "mat-option", 49);
    \u0275\u0275text(84, "2rem (32px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "mat-option", 49);
    \u0275\u0275text(86, "2.5rem (40px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "mat-option", 49);
    \u0275\u0275text(88, "3rem (48px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "mat-option", 49);
    \u0275\u0275text(90, "3.5rem (56px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "mat-option", 49);
    \u0275\u0275text(92, "4rem (64px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "mat-option", 49);
    \u0275\u0275text(94, "4.5rem (72px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "mat-option", 49);
    \u0275\u0275text(96, "5rem (80px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "mat-option", 49);
    \u0275\u0275text(98, "5.5rem (88px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(99, "mat-option", 49);
    \u0275\u0275text(100, "6rem (96px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(101, "mat-option", 49);
    \u0275\u0275text(102, "6.5rem (104px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(103, "mat-option", 49);
    \u0275\u0275text(104, "7rem (112px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "mat-option", 49);
    \u0275\u0275text(106, "7.5rem (120px)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(107, "mat-option", 49);
    \u0275\u0275text(108, "8rem (128px)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(109, "mat-hint");
    \u0275\u0275text(110, " Height of 1 hour in dayview ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(111, "div", 37)(112, "label", 77);
    \u0275\u0275text(113, " Max Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(114, "mat-form-field", 11)(115, "mat-select", 78)(116, "mat-option", 49);
    \u0275\u0275text(117, "1 Hour");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(118, "mat-option", 49);
    \u0275\u0275text(119, "1 Hour 30 Minutes");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(159, " Max duration for single day bookings ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(160, "div", 50);
    \u0275\u0275element(161, "settings-toggle", 79)(162, "settings-toggle", 80)(163, "settings-toggle", 81)(164, "settings-toggle", 82)(165, "settings-toggle", 83)(166, "settings-toggle", 84)(167, "settings-toggle", 85)(168, "settings-toggle", 86)(169, "settings-toggle", 87)(170, "settings-toggle", 88)(171, "settings-toggle", 89)(172, "settings-toggle", 90)(173, "settings-toggle", 91);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ConciergeSettingsFormModalComponent_Conditional_123_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 70);
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_123_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "mat-form-field", 11)(11, "mat-select", 93)(12, "mat-option", 94);
    \u0275\u0275text(13);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-option", 95);
    \u0275\u0275text(16);
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "mat-option", 96);
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "mat-option", 97);
    \u0275\u0275text(22);
    \u0275\u0275pipe(23, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "mat-option", 98);
    \u0275\u0275text(25);
    \u0275\u0275pipe(26, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "mat-option", 99);
    \u0275\u0275text(28);
    \u0275\u0275pipe(29, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "mat-hint");
    \u0275\u0275text(31, " Hide selected columns on the visitor listing table ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div", 50);
    \u0275\u0275element(33, "settings-toggle", 100)(34, "settings-toggle", 101)(35, "settings-toggle", 102);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 9, "COMMON.CHECKED_IN_AT"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(17, 11, "COMMON.CHECKED_OUT_AT"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(20, 13, "COMMON.CHECKED_IN"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 15, "FORM.TIME"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(26, 17, "FORM.HOST"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 19, "COMMON.STATE"), " ");
  }
}
function ConciergeSettingsFormModalComponent_Conditional_124_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 70);
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_124_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 104)(13, "mat-option", 49);
    \u0275\u0275text(14, "1 Day");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-option", 49);
    \u0275\u0275text(16, "2 Days");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(56, " Number of days ahead the user is able to book ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(57, "div")(58, "label", 77);
    \u0275\u0275text(59, " Max Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "mat-form-field", 11)(61, "mat-select", 78)(62, "mat-option", 49);
    \u0275\u0275text(63, "1 Hour");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "mat-option", 49);
    \u0275\u0275text(65, "1 Hour 30 Minutes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "mat-option", 49);
    \u0275\u0275text(67, "2 Hours");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(105, " Max duration for single day bookings ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(106, "div", 50);
    \u0275\u0275element(107, "settings-toggle", 79)(108, "settings-toggle", 90)(109, "settings-toggle", 84);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ConciergeSettingsFormModalComponent_Conditional_125_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 70);
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_125_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(106, "div", 50);
    \u0275\u0275element(107, "settings-toggle", 79)(108, "settings-toggle", 105);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ConciergeSettingsFormModalComponent_Conditional_126_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 70);
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_126_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
var _ConciergeSettingsFormModalComponent = class _ConciergeSettingsFormModalComponent {
  ...
  async save() {
    ...
    await lastValueFrom(ec(zone.id, {
  ...
  _getMetadata(id) {
    return lastValueFrom(Xu(id, this.settings_key).pipe(map((m) => m.details)));
  }
};
...
_ConciergeSettingsFormModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConciergeSettingsFormModalComponent, selectors: [["concierge-settings-form-modal"]], decls: 127, vars: 27, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-8", "pb-4", 3, "formGroup"], ["general", "", 1, "bg-base-100", "space-y-2", "rounded-sm"], ["for", "logo_light"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "logo_light", "formControlName", "logo_light"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions"], ["for", "logo_dark"], ["matInput", "", "name", "logo_dark", "formControlName", "logo_dark"], ["for", "features"], ["appearance", "outline", 1, "w-full"], ["name", "features", "formControlName", "features", "multiple", ""], ["value", "zones"], ["value", "spaces"], ["value", "assets"], ["value", "desks"], ["value", "lockers"], ["value", "parking"], ["value", "parking-bookings"], ["value", "parking-manage"], ["value", "visitors"], ["value", "internal-users"], ["value", "surveys"], ["value", "catering"], ["value", "points-of-interest"], ["value", "url-management"], ["value", "events"], ["value", "points"], ["value", "emergency-contacts"], ["value", "signage"], ["value", "email-templates"], ["value", "deals-n-offers"], ["value", "reports"], [1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "px-2", "py-1", "font-medium"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], ["for", "banner-type"], ["name", "banner-type", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", ""], ["value", "info"], ["value", "warn"], ["value", "error"], ["matInput", "", "name", "banner-message", "placeholder", "Banner Message", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "default-route"], ["matInput", "", "name", "default-route", "formControlName", "default_route", "placeholder", "/book/rooms/new"], ["for", "week-start"], ["name", "week-start", "formControlName", "week_start", "placeholder", "Sunday"], [3, "value"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Use 24 hour time", "formControlName", "use_24_hour_time"], ["name", "Delegated", "formControlName", "delegated"], ["name", "Force upload state", "formControlName", "force_upload_state"], ["name", "All uploads are private", "formControlName", "private_uploads"], ["name", "Use region over building", "formControlName", "use_region"], ["spaces", "", "id", "feature-spaces", "formGroupName", "events", 1, "border-base-300", "relative", "rounded-sm", "border"], ["visitors", "", "id", "feature-visitors", "formGroupName", "visitors", 1, "border-base-300", "relative", "rounded-sm", "border"], ["bookings", "", "id", "feature-bookings", "formGroupName", "bookings", 1, "border-base-300", "relative", "rounded-sm", "border"], ["parking", "", "id", "feature-parking", "formGroupName", "parking", 1, "border-base-300", "relative", "rounded-sm", "border"], ["lockers", "", "id", "feature-lockers", "formGroupName", "lockers", 1, "border-base-300", "relative", "rounded-sm", "border"], ["value", "booking-report"], ["value", "desk-report"], ["value", "catering-report"], ["value", "parking-report"], ["value", "contact-tracing-report"], ["value", "assets-report"], ["value", "visitors-report"], ["for", "group-events-calendar"], ["matInput", "", "name", "group-events-calendar", "formControlName", "group_events_calendar", "placeholder", "shared.events@calendar.acme.tech"], ["icon", "", "matRipple", "", 1, "bg-base-100", "absolute", "top-0", "right-4", "-translate-y-1/2", 3, "click"], ["collapsible", ""], [1, "content", "px-4", "pt-4", "pb-2"], ["for", "block-start"], ["name", "block-start", "formControlName", "block_start", "placeholder", "12AM (Midnight)"], ["for", "block-height"], ["name", "block-height", "formControlName", "block_height"], ["for", "max-duration"], ["name", "max-duration", "formControlName", "max_duration"], ["name", "Allow all day bookings", "formControlName", "allow_all_day"], ["name", "Default to all day", "formControlName", "all_day_default"], ["name", "Allow editing setup/breakdown times", "formControlName", "allow_setup_breakdown"], ["name", "Allow booking for other users", "formControlName", "can_book_for_others"], ["name", "Allow booking for any other users", "formControlName", "can_book_for_anyone"], ["name", "Allow booking with assets", "formControlName", "has_assets"], ["name", "Hide notes field when booking", "formControlName", "hide_notes"], ["name", "Hide attendees field when booking", "formControlName", "hide_attendees"], ["name", "Allow booking for external users", "formControlName", "allow_externals"], ["name", "Enforce capacity for rooms", "formControlName", "strict_capacity_check"], ["name", "Allow booking for multiple days", "formControlName", "allow_multiday"], ["name", "Display times with building timezone", "formControlName", "use_building_timezone"], ["name", "Allow Visibility options", "formControlName", "allow_visibility"], ["for", "hide-fields"], ["name", "hide-fields", "formControlName", "hide_fields", "placeholder", "No fields selected", "multiple", ""], ["value", "checked_in_at"], ["value", "checked_out_at"], ["value", "state"], ["value", "date"], ["value", "user_name"], ["value", "status"], ["name", "Allow booking parking for visitors", "formControlName", "has_parking"], ["name", "Allow setting pass number for visitors", "formControlName", "allow_pass_number"], ["name", "Show calendar links after booking", "formControlName", "show_calendar_links"], ["for", "available-period"], ["name", "available-period", "formControlName", "available_period"], ["name", "Disable reservations", "formControlName", "disable_bookings"], ["name", "Default bookings to all day", "formControlName", "all_day_default"], ["name", "Show Calendar Links after booking", "formControlName", "show_calendar_links"], ["name", "Hide End time option", "formControlName", "hide_end_time"], ["name", "Disable Date selection", "formControlName", "disabled_date_select"], ["name", "Disable start time option", "formControlName", "disabled_start_time"]], template: function ConciergeSettingsFormModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(19, "Features");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-form-field", 11)(21, "mat-select", 12)(22, "mat-option", 13);
    \u0275\u0275text(23, " Zones ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(29, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "mat-option", 17);
    \u0275\u0275text(31, " Lockers ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(43, " Surveys ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "mat-option", 24);
    \u0275\u0275text(45, " Catering ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "mat-option", 25);
    \u0275\u0275text(47, " Points of Interest ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "mat-option", 26);
    \u0275\u0275text(49, " URL Management ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "mat-option", 27);
    \u0275\u0275text(51, " Group Events ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "mat-option", 28);
    \u0275\u0275text(53, " Points ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "mat-option", 29);
    \u0275\u0275text(55, " Emergency Contacts ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-option", 30);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(65, "div", 34)(66, "h3", 35);
    \u0275\u0275text(67, " Banner ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "div", 36)(69, "div", 37)(70, "label", 38);
    \u0275\u0275text(71, "Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(72, "mat-form-field", 11)(73, "mat-select", 39);
    ...
    \u0275\u0275elementStart(74, "mat-option", 40);
    \u0275\u0275text(75, "None");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "mat-option", 41);
    \u0275\u0275text(77, " Info ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "mat-option", 42);
    \u0275\u0275text(79, " Warning ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "mat-option", 43);
    \u0275\u0275text(81, " Error ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(82, "div", 37)(83, "label", 38);
    \u0275\u0275text(84, "Message");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "mat-form-field", 11)(86, "input", 44);
    \u0275\u0275listener("ngModelChange", function ConciergeSettingsFormModalComponent_Template_input_ngModelChange_86_listener($event) {
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(87, "div")(88, "label", 45);
    \u0275\u0275text(89, "Default Route");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(90, "mat-form-field", 11);
    \u0275\u0275element(91, "input", 46);
    \u0275\u0275elementStart(92, "mat-hint");
    \u0275\u0275text(93, " Main page of the application ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(94, ConciergeSettingsFormModalComponent_Conditional_94_Template, 7, 0, "div");
    \u0275\u0275elementStart(95, "div")(96, "label", 47);
    \u0275\u0275text(97, "Week Start");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(98, "mat-form-field", 11)(99, "mat-select", 48)(100, "mat-option", 49);
    \u0275\u0275text(101, "Sunday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(102, "mat-option", 49);
    \u0275\u0275text(103, "Monday");
    ...
    \u0275\u0275text(107, "Wednesday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(108, "mat-option", 49);
    \u0275\u0275text(109, "Thursday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(110, "mat-option", 49);
    \u0275\u0275text(111, "Friday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(112, "mat-option", 49);
    \u0275\u0275text(113, "Saturday");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(114, "mat-hint");
    \u0275\u0275text(115, " Day of the week to show initially on various calendars ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(116, "div", 50);
    \u0275\u0275element(117, "settings-toggle", 51)(118, "settings-toggle", 52)(119, "settings-toggle", 53)(120, "settings-toggle", 54)(121, "settings-toggle", 55);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(122, ConciergeSettingsFormModalComponent_Conditional_122_Template, 174, 64, "section", 56);
    \u0275\u0275conditionalCreate(123, ConciergeSettingsFormModalComponent_Conditional_123_Template, 36, 21, "section", 57);
    \u0275\u0275conditionalCreate(124, ConciergeSettingsFormModalComponent_Conditional_124_Template, 110, 45, "section", 58);
    \u0275\u0275conditionalCreate(125, ConciergeSettingsFormModalComponent_Conditional_125_Template, 109, 45, "section", 59);
    \u0275\u0275conditionalCreate(126, ConciergeSettingsFormModalComponent_Conditional_126_Template, 14, 3, "section", 60);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(48);
    \u0275\u0275conditional(ctx.form.value.features.includes("reports") ? 64 : -1);
    \u0275\u0275advance(9);
    ...
    \u0275\u0275advance(8);
    \u0275\u0275conditional(ctx.form.value.features.includes("events") ? 94 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275property("value", 0);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 1);
    ...
    \u0275\u0275property("value", 6);
    \u0275\u0275advance(10);
    \u0275\u0275conditional(ctx.form.value.features.includes("spaces") ? 122 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("visitors") ? 123 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("visitors") || ctx.form.value.features.includes("parking") || ctx.form.value.features.includes("lockers") ? 124 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("parking") || ctx.form.value.features.includes("parking-bookings") ? 125 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("lockers") ? 126 : -1);
  }
}, dependencies: [
  MatDialogModule,
  FullscreenModalShellComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConciergeSettingsFormModalComponent, { className: "ConciergeSettingsFormModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/concierge-settings-form-modal.component.ts", lineNumber: 1286 });
})();
...
function VisitorKioskSettingsFormModalComponent_Conditional_136_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 51)(1, "div", 53)(2, "mat-form-field", 5)(3, "input", 54);
    \u0275\u0275twoWayListener("ngModelChange", function VisitorKioskSettingsFormModalComponent_Conditional_136_For_4_Template_input_ngModelChange_3_listener($event) {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
      \u0275\u0275twoWayBindingSet(item_r3[0], $event) || (item_r3[0] = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(4, "div", 55)(5, "input", 56);
    \u0275\u0275twoWayListener("ngModelChange", function VisitorKioskSettingsFormModalComponent_Conditional_136_For_4_Template_input_ngModelChange_5_listener($event) {
      const item_r3 = \u0275\u0275restoreView(_r2).$implicit;
    ...
    \u0275\u0275listener("click", function VisitorKioskSettingsFormModalComponent_Conditional_136_For_4_Template_button_click_6_listener() {
      const \u0275$index_235_r4 = \u0275\u0275restoreView(_r2).$index;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.removeLegend(\u0275$index_235_r4));
    });
...
function VisitorKioskSettingsFormModalComponent_Conditional_136_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 43)(1, "h3", 23);
    \u0275\u0275text(2, " Legend ");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, VisitorKioskSettingsFormModalComponent_Conditional_136_For_4_Template, 9, 6, "div", 51, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(5, "button", 52);
    \u0275\u0275listener("click", function VisitorKioskSettingsFormModalComponent_Conditional_136_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r1);
...
_VisitorKioskSettingsFormModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorKioskSettingsFormModalComponent, selectors: [["visitor-kiosk-settings-form-modal"]], decls: 145, vars: 11, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-8", 3, "formGroup"], ["general", "", 1, "bg-base-100", "space-y-2", "rounded-sm"], ["for", "logo_light"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "logo_light", "formControlName", "logo_light"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions"], ["for", "logo_dark"], ["matInput", "", "name", "logo_dark", "formControlName", "logo_dark"], ["for", "welcome-background"], ["matInput", "", "name", "welcome-background", "formControlName", "welcome_background"], ["for", "default-route"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "welcome-message", "formControlName", "welcome_message", "placeholder", "Welcome to PlaceOS Self Service Kiosk"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Enable Induction", "formControlName", "induction_enabled"], ["name", "Induction after Confirm Details", "formControlName", "induction_after_details"], ["name", "Allow Self Registration", "formControlName", "allow_self_registration"], ["name", "Allow setting visitor pass number", "formControlName", "allow_pass_number"], ["name", "Allow Printing Label", "formControlName", "allow_printing_label"], ["name", "Hide Explore Map option", "formControlName", "hide_explore"], ["explore", "", "formGroupName", "explore", 1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "px-2", "py-1", "font-medium"], ["for", "disable"], ["name", "disable", "formControlName", "disable", "placeholder", "No disabled features", "multiple", ""], ["value", "devices"], ["value", "desks"], ["value", "lockers"], ["value", "parking"], ["value", "spaces"], ["value", "spaces-presence"], ["value", "zones"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], ["for", "disable-actions"], ["name", "disable-actions", "formControlName", "disable_actions", "placeholder", "No disabled actions", "multiple", ""], ["for", "available-period"], ["name", "disable-labels", "formControlName", "disable_labels", "placeholder", "No disabled labels", "multiple", ""], ["for", "disable-features"], ["name", "disable-features", "formControlName", "disable_features", "placeholder", "No disabled displays", "multiple", ""], ["for", "disable-styles"], ["name", "disable-styles", "formControlName", "disable_styles", "placeholder", "No disabled styles", "multiple", ""], [1, "border-base-300", "relative", "rounded-sm", "border", "p-4"], ["name", "Hide device fields", "formControlName", "hide_device_fields", "info", "Hides the MAC address, manufacturer, OS and SSID fields from device info tooltips"], ["name", "Show Legend", "formControlName", "show_legend"], ["name", "Hide Zones", "formControlName", "hide_zones"], ["name", "Show Booking QR Code", "formControlName", "show_booking_qr"], ["name", "Use defined polygons for zones", "formControlName", "use_zone_polygons"], ["name", "Show labels for zones", "formControlName", "show_zone_labels"], ["name", "Show zone sensor info", "formControlName", "show_zone_sensor_info"], [1, "mb-4", "flex", "items-center", "space-x-4"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "w-3/4", "flex-1"], ["matInput", "", "placeholder", "Legend Key", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matTooltip", "Legend Color", 1, "flex", "w-12", "items-center", "justify-center"], ["type", "color", 1, "border-base-content", "h-11", "rounded-lg", "border", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["icon", "", "matRipple", "", 1, "border-error", "text-error", "h-12", "w-12", "rounded-sm", "border", 3, "click"]], template: function VisitorKioskSettingsFormModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "mat-form-field", 13);
    \u0275\u0275element(28, "textarea", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 15);
    \u0275\u0275element(30, "settings-toggle", 16);
    \u0275\u0275conditionalCreate(31, VisitorKioskSettingsFormModalComponent_Conditional_31_Template, 1, 0, "settings-toggle", 17);
    \u0275\u0275element(32, "settings-toggle", 18)(33, "settings-toggle", 19)(34, "settings-toggle", 20)(35, "settings-toggle", 21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "section", 22)(37, "h3", 23);
    \u0275\u0275text(38, " PlaceOS Maps ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div")(40, "label", 24);
    \u0275\u0275text(41, " Disabled Features ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "mat-form-field", 13)(43, "mat-select", 25)(44, "mat-option", 26);
    \u0275\u0275text(45, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "mat-option", 27);
    \u0275\u0275text(47, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "mat-option", 28);
    \u0275\u0275text(49, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "mat-option", 29);
    \u0275\u0275text(51, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "mat-option", 30);
    \u0275\u0275text(53, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "mat-option", 31);
    \u0275\u0275text(55, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-option", 32);
    \u0275\u0275text(57, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(58, "div", 33)(59, "div", 34)(60, "label", 35);
    \u0275\u0275text(61, " Disabled Feature Actions ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "mat-form-field", 13)(63, "mat-select", 36)(64, "mat-option", 26);
    \u0275\u0275text(65, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "mat-option", 27);
    \u0275\u0275text(67, "Desks");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(75, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "mat-option", 32);
    \u0275\u0275text(77, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(78, "div", 34)(79, "label", 37);
    \u0275\u0275text(80, " Disabled Feature Labels ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "mat-form-field", 13)(82, "mat-select", 38)(83, "mat-option", 26);
    \u0275\u0275text(84, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "mat-option", 27);
    \u0275\u0275text(86, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "mat-option", 28);
    \u0275\u0275text(88, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "mat-option", 29);
    \u0275\u0275text(90, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "mat-option", 30);
    \u0275\u0275text(92, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "mat-option", 31);
    \u0275\u0275text(94, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "mat-option", 32);
    \u0275\u0275text(96, "Zones");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(97, "div", 33)(98, "div", 34)(99, "label", 39);
    \u0275\u0275text(100, " Disabled Feature Displays ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(101, "mat-form-field", 13)(102, "mat-select", 40)(103, "mat-option", 26);
    \u0275\u0275text(104, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "mat-option", 27);
    \u0275\u0275text(106, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(107, "mat-option", 28);
    \u0275\u0275text(108, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(109, "mat-option", 29);
    \u0275\u0275text(110, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(111, "mat-option", 30);
    \u0275\u0275text(112, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(113, "mat-option", 31);
    \u0275\u0275text(114, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(115, "mat-option", 32);
    \u0275\u0275text(116, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(117, "div", 34)(118, "label", 41);
    \u0275\u0275text(119, " Disabled Feature Styles ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(120, "mat-form-field", 13)(121, "mat-select", 42)(122, "mat-option", 26);
    \u0275\u0275text(123, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(124, "mat-option", 27);
    \u0275\u0275text(125, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(126, "mat-option", 28);
    \u0275\u0275text(127, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(128, "mat-option", 29);
    \u0275\u0275text(129, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(130, "mat-option", 30);
    \u0275\u0275text(131, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(132, "mat-option", 31);
    \u0275\u0275text(133, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(134, "mat-option", 32);
    \u0275\u0275text(135, "Zones");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275conditionalCreate(136, VisitorKioskSettingsFormModalComponent_Conditional_136_Template, 7, 1, "div", 43);
    \u0275\u0275elementStart(137, "div", 15);
    \u0275\u0275element(138, "settings-toggle", 44)(139, "settings-toggle", 45)(140, "settings-toggle", 46)(141, "settings-toggle", 47)(142, "settings-toggle", 48)(143, "settings-toggle", 49)(144, "settings-toggle", 50);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(8);
    \u0275\u0275conditional(ctx.form.value.induction_enabled ? 31 : -1);
    \u0275\u0275advance(105);
    \u0275\u0275conditional((ctx.form.value.explore == null ? null : ctx.form.value.explore.show_legend) ? 136 : -1);
  }
}, dependencies: [
  FullscreenModalShellComponent,
  MatDialogModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorKioskSettingsFormModalComponent, { className: "VisitorKioskSettingsFormModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/visitor-kiosk-settings-form-modal.component.ts", lineNumber: 448 });
})();
...
var _c7 = () => [];
function WorkplaceSettingsFormModalComponent_Conditional_159_Template(rf, ctx) {
  if (rf & 1) {
...
function WorkplaceSettingsFormModalComponent_Conditional_170_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10, " Available Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 81)(13, "mat-option", 53);
    \u0275\u0275text(14, "1 Day");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-option", 53);
    \u0275\u0275text(16, "2 Day");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(59, "div")(60, "label", 82);
    \u0275\u0275text(61, "Force Host");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "mat-form-field", 11);
    \u0275\u0275element(63, "input", 83);
    \u0275\u0275elementStart(64, "mat-hint");
    \u0275\u0275text(65, " Force host of room bookings to be this user ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "mat-error");
    \u0275\u0275text(67, "Invalid email address");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(68, "div")(69, "label", 84);
    \u0275\u0275text(70, " Max Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "mat-form-field", 11)(72, "mat-select", 85)(73, "mat-option", 53);
    \u0275\u0275text(74, "1 Hour");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "mat-option", 53);
    \u0275\u0275text(76, "1 Hour 30 Minutes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "mat-option", 53);
    \u0275\u0275text(78, "2 Hours");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "mat-option", 53);
    \u0275\u0275text(80, "3 Hours");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(116, " Max duration for single day bookings ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(117, "div", 34)(118, "div")(119, "label", 86);
    \u0275\u0275text(120, " Default Setup Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(121, "mat-form-field", 11)(122, "mat-select", 87)(123, "mat-option", 53);
    \u0275\u0275text(124, " 5 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(125, "mat-option", 53);
    \u0275\u0275text(126, " 10 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(127, "mat-option", 53);
    \u0275\u0275text(128, " 15 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(129, "mat-option", 53);
    \u0275\u0275text(130, " 30 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(131, "mat-option", 53);
    \u0275\u0275text(132, " 45 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(133, "mat-option", 53);
    \u0275\u0275text(134, " 1 Hour ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(135, "mat-option", 53);
    \u0275\u0275text(136, " 1 Hour 30 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(137, "mat-option", 53);
    \u0275\u0275text(138, " 2 Hours ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(139, "div")(140, "label", 88);
    \u0275\u0275text(141, " Default Breakdown Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(142, "mat-form-field", 11)(143, "mat-select", 89)(144, "mat-option", 53);
    \u0275\u0275text(145, " 5 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(146, "mat-option", 53);
    \u0275\u0275text(147, " 10 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(148, "mat-option", 53);
    \u0275\u0275text(149, " 15 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(150, "mat-option", 53);
    \u0275\u0275text(151, " 30 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(152, "mat-option", 53);
    \u0275\u0275text(153, " 45 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(154, "mat-option", 53);
    \u0275\u0275text(155, " 1 Hour ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(156, "mat-option", 53);
    \u0275\u0275text(157, " 1 Hour 30 Minutes ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(158, "mat-option", 53);
    \u0275\u0275text(159, " 2 Hours ");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(160, "div")(161, "label", 90);
    \u0275\u0275text(162, " Cache Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(163, "mat-form-field", 11)(164, "mat-select", 91)(165, "mat-option", 53);
    \u0275\u0275text(166, " No cache ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(167, "mat-option", 53);
    \u0275\u0275text(168, "1 Day");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(198, " 1 Month ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(199, "mat-hint");
    \u0275\u0275text(200, " Number of days ahead to grab bookings from the room driver ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(201, "div", 56);
    \u0275\u0275element(202, "settings-toggle", 92)(203, "settings-toggle", 93)(204, "settings-toggle", 94)(205, "settings-toggle", 95)(206, "settings-toggle", 96)(207, "settings-toggle", 97)(208, "settings-toggle", 98)(209, "settings-toggle", 99)(210, "settings-toggle", 100)(211, "settings-toggle", 101)(212, "settings-toggle", 102)(213, "settings-toggle", 103)(214, "settings-toggle", 104)(215, "settings-toggle", 105)(216, "settings-toggle", 106)(217, "settings-toggle", 107)(218, "settings-toggle", 108)(219, "settings-toggle", 109)(220, "settings-toggle", 110);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function WorkplaceSettingsFormModalComponent_Conditional_171_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 77);
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_171_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(10, " Available Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 111)(13, "mat-option", 53);
    \u0275\u0275text(14, "1 Day");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-option", 53);
    \u0275\u0275text(16, "2 Days");
    ...
    \u0275\u0275element(58, "settings-toggle", 92)(59, "settings-toggle", 93)(60, "settings-toggle", 112)(61, "settings-toggle", 113)(62, "settings-toggle", 114)(63, "settings-toggle", 115)(64, "settings-toggle", 116)(65, "settings-toggle", 117)(66, "settings-toggle", 118)(67, "settings-toggle", 119)(68, "settings-toggle", 120)(69, "settings-toggle", 121)(70, "settings-toggle", 122)(71, "settings-toggle", 123)(72, "settings-toggle", 110);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function WorkplaceSettingsFormModalComponent_Conditional_172_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 77);
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_172_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleGroup("bookings"));
    });
    ...
    \u0275\u0275listener("ngModelChange", function WorkplaceSettingsFormModalComponent_Conditional_172_Template_settings_toggle_ngModelChange_17_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
...
function WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 148)(1, "div", 150)(2, "mat-form-field", 5)(3, "input", 151);
    \u0275\u0275twoWayListener("ngModelChange", function WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_For_4_Template_input_ngModelChange_3_listener($event) {
      const item_r8 = \u0275\u0275restoreView(_r7).$implicit;
      \u0275\u0275twoWayBindingSet(item_r8[0], $event) || (item_r8[0] = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(4, "div", 152)(5, "input", 153);
    \u0275\u0275twoWayListener("ngModelChange", function WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_For_4_Template_input_ngModelChange_5_listener($event) {
      const item_r8 = \u0275\u0275restoreView(_r7).$implicit;
    ...
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_For_4_Template_button_click_6_listener() {
      const \u0275$index_973_r9 = \u0275\u0275restoreView(_r7).$index;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.removeLegend(\u0275$index_973_r9));
    });
    \u0275\u0275elementStart(7, "icon");
    \u0275\u0275text(8, "delete");
    \u0275\u0275elementEnd()()();
...
function WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 140)(1, "h3", 33);
    \u0275\u0275text(2, " Legend ");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_For_4_Template, 9, 6, "div", 148, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(5, "button", 149);
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function WorkplaceSettingsFormModalComponent_Conditional_173_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 77);
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_173_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 129)(13, "mat-option", 130);
    \u0275\u0275text(14, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-option", 14);
    \u0275\u0275text(16, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "mat-option", 18);
    \u0275\u0275text(18, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-option", 16);
    \u0275\u0275text(20, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "mat-option", 13);
    \u0275\u0275text(22, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "mat-option", 131);
    \u0275\u0275text(24, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-option", 132);
    \u0275\u0275text(26, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(27, "div", 34)(28, "div", 35)(29, "label", 133);
    \u0275\u0275text(30, " Disabled Feature Actions ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "mat-form-field", 11)(32, "mat-select", 134)(33, "mat-option", 130);
    \u0275\u0275text(34, "Devices");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(40, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "mat-option", 13);
    \u0275\u0275text(42, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "mat-option", 131);
    \u0275\u0275text(44, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "mat-option", 132);
    \u0275\u0275text(46, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(47, "div", 35)(48, "label", 80);
    \u0275\u0275text(49, " Disabled Feature Labels ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "mat-form-field", 11)(51, "mat-select", 135)(52, "mat-option", 130);
    \u0275\u0275text(53, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "mat-option", 14);
    \u0275\u0275text(55, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-option", 18);
    \u0275\u0275text(57, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "mat-option", 16);
    \u0275\u0275text(59, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "mat-option", 13);
    \u0275\u0275text(61, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "mat-option", 131);
    \u0275\u0275text(63, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "mat-option", 132);
    \u0275\u0275text(65, "Zones");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(66, "div", 34)(67, "div", 35)(68, "label", 136);
    \u0275\u0275text(69, " Disabled Feature Displays ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "mat-form-field", 11)(71, "mat-select", 137)(72, "mat-option", 130);
    \u0275\u0275text(73, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(74, "mat-option", 14);
    \u0275\u0275text(75, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "mat-option", 18);
    \u0275\u0275text(77, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "mat-option", 16);
    \u0275\u0275text(79, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "mat-option", 13);
    \u0275\u0275text(81, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(82, "mat-option", 131);
    \u0275\u0275text(83, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(84, "mat-option", 132);
    \u0275\u0275text(85, "Zones");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(86, "div", 35)(87, "label", 138);
    \u0275\u0275text(88, " Disabled Feature Styles ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "mat-form-field", 11)(90, "mat-select", 139)(91, "mat-option", 130);
    \u0275\u0275text(92, "Devices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "mat-option", 14);
    \u0275\u0275text(94, "Desks");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "mat-option", 18);
    \u0275\u0275text(96, " Lockers ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "mat-option", 16);
    \u0275\u0275text(98, " parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(99, "mat-option", 13);
    \u0275\u0275text(100, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(101, "mat-option", 131);
    \u0275\u0275text(102, " Room Presence ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(103, "mat-option", 132);
    \u0275\u0275text(104, "Zones");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275conditionalCreate(105, WorkplaceSettingsFormModalComponent_Conditional_173_Conditional_105_Template, 7, 1, "div", 140);
    \u0275\u0275elementStart(106, "div", 56);
    \u0275\u0275element(107, "settings-toggle", 141)(108, "settings-toggle", 142)(109, "settings-toggle", 143)(110, "settings-toggle", 144)(111, "settings-toggle", 145)(112, "settings-toggle", 146)(113, "settings-toggle", 147);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(99);
    \u0275\u0275conditional((ctx_r1.form.value.explore == null ? null : ctx_r1.form.value.explore.show_legend) ? 105 : -1);
  }
}
function WorkplaceSettingsFormModalComponent_Conditional_174_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 77);
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_174_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleGroup("parking"));
    });
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(57, "div", 56);
    \u0275\u0275element(58, "settings-toggle", 93)(59, "settings-toggle", 155)(60, "settings-toggle", 156)(61, "settings-toggle", 95)(62, "settings-toggle", 157)(63, "settings-toggle", 158);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function WorkplaceSettingsFormModalComponent_Conditional_175_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 77);
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_175_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleGroup("lockers"));
    });
...
_WorkplaceSettingsFormModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WorkplaceSettingsFormModalComponent, selectors: [["workplace-settings-form-modal"]], decls: 176, vars: 39, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-8", "pb-4", 3, "formGroup"], ["general", "", 1, "bg-base-100", "space-y-2", "rounded-sm"], ["for", "logo_light"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "logo_light", "formControlName", "logo_light"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions"], ["for", "logo_dark"], ["matInput", "", "name", "logo_dark", "formControlName", "logo_dark"], ["for", "features"], ["appearance", "outline", 1, "w-full"], ["name", "features", "formControlName", "features", "multiple", ""], ["value", "spaces"], ["value", "desks"], ["value", "explore"], ["value", "parking"], ["value", "visitor-invite"], ["value", "lockers"], ["value", "help"], ["value", "schedule"], ["value", "wfh"], ["value", "support-ticket"], ["value", "group-events"], ["value", "deals-n-offers"], ["name", "hide-global-search-items", "formControlName", "hide_global_search_items", "multiple", ""], ["value", "mapspeople"], ["value", "emergency_contacts"], ["value", "features"], ["value", "points_of_interest"], ["value", "contacts"], ["value", "users"], [1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "px-2", "py-1", "font-medium"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], ["for", "banner-type"], ["name", "banner-type", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", ""], ["value", "info"], ["value", "warn"], ["value", "error"], ["matInput", "", "name", "banner-message", "placeholder", "Banner Message", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "external-support-url"], ["matInput", "", "name", "external-support-url", "formControlName", "external_support_url", "placeholder", "https://support.com/ticket"], ["for", "support-email"], ["matInput", "", "name", "support-email", "formControlName", "support_email", "placeholder", "support@acme.tech"], ["for", "default-route"], ["matInput", "", "name", "default-route", "formControlName", "default_route", "placeholder", "/landing"], ["for", "catering-provider"], ["matInput", "", "name", "catering-provider", "formControlName", "catering_provider", "placeholder", "Catering Provider"], ["for", "week-start"], ["name", "week-start", "formControlName", "week_start", "placeholder", "Sunday"], [3, "value"], ["for", "locales"], ["name", "locales", "formControlName", "locales", "multiple", "", "placeholder", "Select locales"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Use 24 hour time", "formControlName", "use_24_hour_time"], ["name", "Use region over building", "formControlName", "use_region"], ["name", "Use imperial units for measurements", "formControlName", "use_imperial_units"], ["name", "Allow images in support tickets", "formControlName", "allow_support_ticket_images"], ["name", "Search only authenticated users", "formControlName", "basic_user_search"], ["name", "Only authenticated colleagues", "info", "Will limit the available users to add as colleagues to only\n those who have authenticated with the application", "formControlName", "colleagues_require_auth"], ["name", "Hide landing sidebar", "formControlName", "hide_landing_sidebar"], ["name", "Hide landing spaces", "formControlName", "hide_landing_spaces"], ["name", "Hide landing rooms", "formControlName", "hide_landing_rooms"], ["name", "Hide colleagues", "formControlName", "hide_colleagues"], ["name", "Show landing quick links", "formControlName", "show_quick_links"], ["name", "Show landing quick book", "formControlName", "show_quick_book"], ["name", "Allow dark mode", "formControlName", "allow_dark_mode"], ["name", "Show global search", "formControlName", "global_search"], ["events", "", "id", "feature-spaces", "formGroupName", "events", 1, "border-base-300", "relative", "rounded-sm", "border"], ["desks", "", "id", "feature-desks", "formGroupName", "desks", 1, "border-base-300", "relative", "rounded-sm", "border"], ["bookings", "", "id", "feature-bookings", "formGroupName", "bookings", 1, "border-base-300", "relative", "rounded-sm", "border"], ["explore", "", "id", "feature-explore", "formGroupName", "explore", 1, "border-base-300", "relative", "rounded-sm", "border"], ["parking", "", "id", "feature-parking", "formGroupName", "parking", 1, "border-base-300", "relative", "rounded-sm", "border"], ["lockers", "", "id", "feature-lockers", "formGroupName", "lockers", 1, "border-base-300", "relative", "rounded-sm", "border"], ["icon", "", "matRipple", "", 1, "bg-base-100", "absolute", "top-0", "right-4", "-translate-y-1/2", 3, "click"], ["collapsible", ""], [1, "content", "px-4", "pt-4", "pb-2"], ["for", "available-period"], ["name", "available-period", "formControlName", "allowed_future_days"], ["for", "force-host"], ["matInput", "", "name", "force-host", "formControlName", "force_host", "placeholder", "global.host@acme.tech"], ["for", "max-duration"], ["name", "max-duration", "formControlName", "max_duration"], ["for", "setup"], ["name", "setup", "formControlName", "setup", "placeholder", "No default setup"], ["for", "breakdown"], ["name", "breakdown", "formControlName", "breakdown", "placeholder", "No default breakdown"], ["for", "cache-duration"], ["name", "cache-duration", "formControlName", "cache_duration_in_days"], ["name", "Allow all day bookings", "formControlName", "allow_all_day"], ["name", "Default bookings to all day", "formControlName", "all_day_default"], ["name", "Disable booking requests", "formControlName", "booking_unavailable", "info", "Prevent making backend requests for bookings and give users links to create the booking in their own calendars"], ["name", "Allow booking for other users", "formControlName", "can_book_for_others"], ["name", "Allow booking with assets", "formControlName", "has_assets"], ["name", "Hide attendee actions", "formControlName", "hide_user_actions"], ["name", "Allow booking multiple spaces", "formControlName", "multiple_spaces"], ["name", "Force room as host", "formControlName", "room_as_host"], ["name", "Allow external attendees", "formControlName", "allow_externals"], ["name", "Allow Visibility options", "formControlName", "allow_visibility"], ["name", "Disable notes field", "formControlName", "hide_notes"], ["name", "Hide attendees field", "formControlName", "hide_attendees"], ["name", "Allow recurring meetings", "formControlName", "allow_recurrence"], ["name", "Allow multi-day bookings", "formControlName", "allow_multiday"], ["name", "Use PlaceOS bookings", "formControlName", "use_bookings"], ["name", "Display times with building timezone", "formControlName", "use_building_timezone"], ["name", "Allow daily all-day recurrence", "formControlName", "allow_daily_allday_recurrence"], ["name", "Disable standalone bookings", "formControlName", "no_standalone"], ["name", "Hide End Time option", "formControlName", "hide_end_time"], ["name", "available-period", "formControlName", "available_period"], ["name", "Allow group bookings", "formControlName", "allow_groups"], ["name", "Allow time changes", "formControlName", "allow_time_changes"], ["name", "Auto-allocation", "formControlName", "auto_allocation"], ["name", "Allow booking for others", "formControlName", "can_book_for_others"], ["name", "Allow also booking a locker", "formControlName", "can_book_lockers"], ["name", "Allow requesting assets with booking", "formControlName", "has_assets"], ["name", "Allow Recurring Desk bookings", "formControlName", "allow_recurrence"], ["name", "Auto-checkin map bookingss", "formControlName", "auto_checkin"], ["name", "Default to desk select modal to map view", "formControlName", "default_select_as_map"], ["name", "Show calendar links after booking", "formControlName", "show_calendar_links"], ["name", "Enabled desk height", "formControlName", "height_enabled"], ["name", "Hide Checkin Options", "formControlName", "hide_checkin"], ["name", "Allow booking multiple visitors", "formControlName", "multiple_visitors"], ["name", "Auto-approve bookings", "formControlName", "no_approval"], ["name", "Allow booking with assets", "formControlName", "allow_assets"], ["name", "Show calendar links after visitor invite", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "disable"], ["name", "disable", "formControlName", "disable", "placeholder", "No disabled features", "multiple", ""], ["value", "devices"], ["value", "spaces-presence"], ["value", "zones"], ["for", "disable-actions"], ["name", "disable-actions", "formControlName", "disable_actions", "placeholder", "No disabled actions", "multiple", ""], ["name", "disable-labels", "formControlName", "disable_labels", "placeholder", "No disabled labels", "multiple", ""], ["for", "disable-features"], ["name", "disable-features", "formControlName", "disable_features", "placeholder", "No disabled displays", "multiple", ""], ["for", "disable-styles"], ["name", "disable-styles", "formControlName", "disable_styles", "placeholder", "No disabled styles", "multiple", ""], [1, "border-base-300", "relative", "rounded-sm", "border", "p-4"], ["name", "Hide device fields", "formControlName", "hide_device_fields", "info", "Hides the MAC address, manufacturer, OS and SSID fields from device info tooltips"], ["name", "Show Legend", "formControlName", "show_legend"], ["name", "Hide Zones", "formControlName", "hide_zones"], ["name", "Show Booking QR Code", "formControlName", "show_booking_qr"], ["name", "Use defined polygons for zones", "formControlName", "use_zone_polygons"], ["name", "Show labels for zones", "formControlName", "show_zone_labels"], ["name", "Show zone sensor info", "formControlName", "show_zone_sensor_info"], [1, "mb-4", "flex", "items-center", "space-x-4"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "w-3/4", "flex-1"], ["matInput", "", "placeholder", "Legend Key", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matTooltip", "Legend Color", 1, "flex", "w-12", "items-center", "justify-center"], ["type", "color", 1, "border-base-content", "h-11", "rounded-lg", "border", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["icon", "", "matRipple", "", 1, "border-error", "text-error", "h-12", "w-12", "rounded-sm", "border", 3, "click"], ["name", "Allow user selecting booking time", "formControlName", "allow_time_changes"], ["name", "Auto-allocate parking spaces", "formControlName", "auto_allocation"], ["name", "Allow recurring parking bookings", "formControlName", "allow_recurrence"], ["name", "Hide End time option", "formControlName", "hide_end_time"], ["name", "Show Calendar Links after booking", "formControlName", "show_calendar_links"], ["name", "Disable Date selection", "formControlName", "disabled_date_select"], ["name", "Disable start time option", "formControlName", "disabled_start_time"]], template: function WorkplaceSettingsFormModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(46, "div")(47, "label", 10);
    \u0275\u0275text(48, "Hide Global Search Item Types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "mat-form-field", 11)(50, "mat-select", 25)(51, "mat-option", 26);
    \u0275\u0275text(52, " MapsPeople ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "mat-option", 13);
    \u0275\u0275text(54, " Rooms ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "mat-option", 27);
    \u0275\u0275text(56, " Emergency Contacts ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "mat-option", 28);
    ...
    \u0275\u0275text(64, " Users ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(65, "div", 32)(66, "h3", 33);
    \u0275\u0275text(67, " Banner ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "div", 34)(69, "div", 35)(70, "label", 36);
    \u0275\u0275text(71, "Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(72, "mat-form-field", 11)(73, "mat-select", 37);
    ...
    \u0275\u0275elementStart(74, "mat-option", 38);
    \u0275\u0275text(75, "None");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "mat-option", 39);
    \u0275\u0275text(77, " Info ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "mat-option", 40);
    \u0275\u0275text(79, " Warning ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "mat-option", 41);
    \u0275\u0275text(81, " Error ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(82, "div", 35)(83, "label", 36);
    \u0275\u0275text(84, "Message");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "mat-form-field", 11)(86, "input", 42);
    \u0275\u0275listener("ngModelChange", function WorkplaceSettingsFormModalComponent_Template_input_ngModelChange_86_listener($event) {
    ...
    \u0275\u0275text(89, " External Support URL ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(90, "mat-form-field", 11);
    \u0275\u0275element(91, "input", 44);
    \u0275\u0275elementStart(92, "mat-hint");
    \u0275\u0275text(93, " External URL to link users to for support tickets ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(94, "mat-error");
    \u0275\u0275text(95, "Invalid URL");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(96, "div")(97, "label", 45);
    \u0275\u0275text(98, "Support Email");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(99, "mat-form-field", 11);
    \u0275\u0275element(100, "input", 46);
    \u0275\u0275elementStart(101, "mat-hint");
    \u0275\u0275text(102, " Email to send tickets when created in the app ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(103, "div")(104, "label", 47);
    \u0275\u0275text(105, "Default Route");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(106, "mat-form-field", 11);
    \u0275\u0275element(107, "input", 48);
    \u0275\u0275elementStart(108, "mat-hint");
    \u0275\u0275text(109, " Main page of the application ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(110, "div")(111, "label", 49);
    \u0275\u0275text(112, "Catering Provider");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(113, "mat-form-field", 11);
    \u0275\u0275element(114, "input", 50);
    \u0275\u0275elementStart(115, "mat-hint");
    \u0275\u0275text(116, " Name of the catering provider to force orders to use ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(117, "div")(118, "label", 51);
    \u0275\u0275text(119, "Week Start");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(120, "mat-form-field", 11)(121, "mat-select", 52)(122, "mat-option", 53);
    \u0275\u0275text(123, "Sunday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(124, "mat-option", 53);
    \u0275\u0275text(125, "Monday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(126, "mat-option", 53);
    \u0275\u0275text(127, "Tuesday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(128, "mat-option", 53);
    \u0275\u0275text(129, "Wednesday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(130, "mat-option", 53);
    \u0275\u0275text(131, "Thursday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(132, "mat-option", 53);
    \u0275\u0275text(133, "Friday");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(134, "mat-option", 53);
    \u0275\u0275text(135, "Saturday");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(136, "mat-hint");
    \u0275\u0275text(137, " Day of the week to show initially on various calendars ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(138, "div")(139, "label", 54);
    \u0275\u0275text(140, "Locales");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(141, "mat-form-field", 11)(142, "mat-select", 55)(143, "mat-option", 53);
    \u0275\u0275text(144, " English (British) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(145, "mat-option", 53);
    \u0275\u0275text(146, " English (US) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(147, "mat-option", 53);
    \u0275\u0275text(148, " French ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(149, "mat-option", 53);
    \u0275\u0275text(150, " Spanish ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(151, "mat-option", 53);
    \u0275\u0275text(152, " Portuguese ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(153, "mat-option", 53);
    \u0275\u0275text(154, " Arabic ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(155, "div", 56);
    \u0275\u0275element(156, "settings-toggle", 57)(157, "settings-toggle", 58)(158, "settings-toggle", 59);
    \u0275\u0275conditionalCreate(159, WorkplaceSettingsFormModalComponent_Conditional_159_Template, 1, 0, "settings-toggle", 60);
    \u0275\u0275element(160, "settings-toggle", 61)(161, "settings-toggle", 62)(162, "settings-toggle", 63)(163, "settings-toggle", 64)(164, "settings-toggle", 65)(165, "settings-toggle", 66)(166, "settings-toggle", 67)(167, "settings-toggle", 68)(168, "settings-toggle", 69)(169, "settings-toggle", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(170, WorkplaceSettingsFormModalComponent_Conditional_170_Template, 221, 79, "section", 71);
    \u0275\u0275conditionalCreate(171, WorkplaceSettingsFormModalComponent_Conditional_171_Template, 73, 24, "section", 72);
    \u0275\u0275conditionalCreate(172, WorkplaceSettingsFormModalComponent_Conditional_172_Template, 18, 6, "section", 73);
    \u0275\u0275conditionalCreate(173, WorkplaceSettingsFormModalComponent_Conditional_173_Template, 114, 4, "section", 74);
    \u0275\u0275conditionalCreate(174, WorkplaceSettingsFormModalComponent_Conditional_174_Template, 64, 24, "section", 75);
    \u0275\u0275conditionalCreate(175, WorkplaceSettingsFormModalComponent_Conditional_175_Template, 14, 3, "section", 76);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275conditional(ctx.form.value.features.includes("support-ticket") ? 159 : -1);
    \u0275\u0275advance(11);
    \u0275\u0275conditional((ctx.form.value.features == null ? null : ctx.form.value.features.includes("spaces")) ? 170 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("desks") ? 171 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("desks") || ctx.form.value.features.includes("parking") || ctx.form.value.features.includes("lockers") || ctx.form.value.features.includes("visitor-invite") ? 172 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("explore") ? 173 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("parking") ? 174 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.value.features.includes("lockers") ? 175 : -1);
  }
}, dependencies: [
  MatDialogModule,
  FullscreenModalShellComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WorkplaceSettingsFormModalComponent, { className: "WorkplaceSettingsFormModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/workplace-settings-form-modal.component.ts", lineNumber: 1736 });
})();
...
_BuildingListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BuildingListComponent, selectors: [["building-list"]], decls: 18, vars: 34, consts: [["name_template", ""], ["timezone_template", ""], ["level_template", ""], ["image_template", ""], ["action_template", ""], ["menu", "matMenu"], ["app_settings_menu", "matMenu"], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "block", "w-full", "min-w-248", "text-sm", 3, "data", "empty_message", "columns", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "p-4", "font-mono", "text-xs"], ["auth", "", 1, "max-h-12", "max-w-32", 3, "source"], [1, "opacity-30"], [1, "flex", "w-full", "justify-center", "space-x-2", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], ["mat-menu-item", "", 3, "click"], ["className", "material-symbols-rounded", 1, "text-xl"], [1, "flex", "items-center", "space-x-2", "text-red-500"], [1, "text-error", "text-xl"]], template: function BuildingListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildingListComponent, { className: "BuildingListComponent", filePath: "apps/concierge/src/app/building-manager/building-list.component.ts", lineNumber: 255 });
})();

// apps/concierge/src/app/level-manager/level-modal.component.ts
function LevelModalComponent_Conditional_4_For_10_Template(rf, ctx) {
  if (rf & 1) {
...
function LevelModalComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275repeaterCreate(9, LevelModalComponent_Conditional_4_For_10_Template, 2, 2, "mat-option", 7, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(11, "async");
    \u0275\u0275elementEnd();
...
var _LevelModalComponent = class _LevelModalComponent {
  ...
  async save() {
    ...
    const resp = await (data.id ? Fa(data.id, __spreadProps(__spreadValues({}, data), {
      name: `LEVEL ${Ut().description} ${data.display_name}`
    })) : za(__spreadProps(__spreadValues({}, data), {
      name: `LEVEL ${Ut().description} ${data.display_name}`
    }))).toPromise().catch();
    if (resp.id)
...
_LevelModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LevelModalComponent, selectors: [["level-modal"]], decls: 8, vars: 11, consts: [[3, "confirm", "heading", "loading"], ["system", "", 3, "formGroup"], [1, "flex", "flex-col"], [1, "flex", "space-x-4", "pb-4"], ["for", "zone"], ["appearance", "outline"], ["formControlName", "parent_id", 3, "placeholder"], [3, "value"], ["for", "display-name"], ["matInput", "", "name", "display-name", "formControlName", "display_name", 3, "placeholder"], ["formControlName", "parking", 1, "flex-1", 3, "name"], [1, "flex-1"], ["for", "map-id"], ["matInput", "", "name", "map-id", "formControlName", "map_id", 3, "placeholder"]], template: function LevelModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(4, LevelModalComponent_Conditional_4_Template, 15, 13, "div", 2);
    \u0275\u0275conditionalCreate(5, LevelModalComponent_Conditional_5_Template, 7, 6, "div", 2);
    \u0275\u0275conditionalCreate(6, LevelModalComponent_Conditional_6_Template, 4, 3, "div", 3);
    \u0275\u0275conditionalCreate(7, LevelModalComponent_Conditional_7_Template, 7, 6, "div", 2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LevelModalComponent, { className: "LevelModalComponent", filePath: "apps/concierge/src/app/level-manager/level-modal.component.ts", lineNumber: 141 });
})();
...
var _LevelManagementService = class _LevelManagementService {
  ...
  async removeLevel(level) {
    ...
    await Ha(level.id).toPromise().catch((e) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LevelListComponent, { className: "LevelListComponent", filePath: "apps/concierge/src/app/level-manager/level-list.component.ts", lineNumber: 133 });
})();
...
function RegionModalComponent_For_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 8);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function RegionModalComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 9);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
...
_RegionModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegionModalComponent, selectors: [["region-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 16, consts: [["auto", "matAutocomplete"], [3, "confirm", "heading", "loading"], [3, "formGroup"], [1, "flex", "flex-col"], ["for", "display-name"], ["appearance", "outline"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "timezone", 3, "placeholder", "matAutocomplete"], [3, "value"], [3, "disabled"], ["matInput", "", "name", "display-name", "formControlName", "display_name", 3, "placeholder"]], template: function RegionModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(4, RegionModalComponent_Conditional_4_Template, 7, 6, "div", 3);
    \u0275\u0275elementStart(5, "div", 3)(6, "label", 4);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "mat-form-field", 5)(10, "icon", 6);
    \u0275\u0275text(11, "search");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(16, RegionModalComponent_For_17_Template, 2, 2, "mat-option", 8, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(18, RegionModalComponent_Conditional_18_Template, 3, 4, "mat-option", 9);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const auto_r3 = \u0275\u0275reference(15);
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 8, ctx.form.value.id ? "APP.CONCIERGE.REGIONS_EDIT" : "APP.CONCIERGE.REGIONS_NEW"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 10, "APP.CONCIERGE.REGION_SAVING") : "");
    \u0275\u0275advance(3);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.form.controls.display_name ? 4 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 12, "COMMON.TIMEZONE"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(13, 14, "COMMON.TIMEZONE"))("matAutocomplete", auto_r3);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx.filtered_timezones);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx.timezones.length ? 18 : -1);
  }
}, dependencies: [
  CommonModule,
  FullscreenModalShellComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RegionModalComponent, { className: "RegionModalComponent", filePath: "apps/concierge/src/app/region-manager/region-modal.component.ts", lineNumber: 98 });
})();
...
var _RegionManagementService = class _RegionManagementService {
  ...
  editRegionMetadata(region = new Un()) {
    const ref = this._dialog.open(AppSettingsModalComponent, {
      data: { zone: region }
    });
    ref.afterClosed().subscribe((data) => {
  ...
  async removeRegion(region) {
    ...
    await Ha(region.id).toPromise().catch((e) => {
...
_RegionListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegionListComponent, selectors: [["region-list"]], decls: 10, vars: 21, consts: [["name_template", ""], ["action_template", ""], ["menu", "matMenu"], ["app_settings_menu", "matMenu"], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "block", "min-w-lg", "text-sm", 3, "data", "empty_message", "columns", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "w-full", "justify-end", "space-x-2", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "flex", "items-center", "space-x-2"], [1, "text-xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2", "text-red-500"], [1, "text-error", "text-xl"]], template: function RegionListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275element(1, "simple-table", 5);
    \u0275\u0275pipe(2, "translate");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneManagerComponent, { className: "ZoneManagerComponent", filePath: "apps/concierge/src/app/zone-manager/zone-manager.component.ts", lineNumber: 162 });
})();
...
//# sourceMappingURL=zone-manager.module-XEGWRYUB.js.map
