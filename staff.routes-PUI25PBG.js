...
var EmergencyContactsService = class _EmergencyContactsService {
  ...
  async _queryLegacyMetadata(bld) {
    try {
      const { details } = await ic(bld.id, "emergency_contacts");
      return details || {
        contacts: [],
        roles: []
      };
  ...
  async ensureCategoryExists() {
    ...
    if (existing)
      return existing;
    try {
      const new_category = await saveAssetCategory(oi(new $r({
  ...
  async migrateFromMetadata() {
    ...
    try {
      ...
      if (legacy_data.roles?.length) {
        await saveAssetCategory(oi(new $r(__spreadProps(__spreadValues({}, category), {
          hidden: true,
  ...
  async updateRoles(roles) {
    try {
      ...
      await saveAssetCategory(new $r(__spreadProps(__spreadValues({}, category), {
        description: JSON.stringify({ roles })
      })));
      this._change.set(Date.now());
      return true;
...
function EmergencyContactModalComponent_Conditional_5_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275elementStart(2, "button", 25)(3, "icon");
    \u0275\u0275text(4, "add");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "APP.CONCIERGE.CONTACTS_ROLES_ADD"));
    \u0275\u0275advance(2);
...
function EmergencyContactModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(46, EmergencyContactModalComponent_Conditional_5_Conditional_46_Template, 5, 4, "div", 24);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275control();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 19, "FORM.EMAIL"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.email)("placeholder", \u0275\u0275pipeBind1(16, 21, "FORM.EMAIL"));
    \u0275\u0275control();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(20, 23, "FORM.PHONE"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.phone)("placeholder", \u0275\u0275pipeBind1(23, 25, "APP.CONCIERGE.CONTACTS_PHONE_PLACEHOLDER"));
    \u0275\u0275control();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(27, 27, "RESOURCE.LEVEL"));
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.form.zone)("placeholder", \u0275\u0275pipeBind1(30, 29, "COMMON.LEVEL_SELECT"));
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 31, "COMMON.LEVEL_ANY"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.levels());
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(39, 33, "APP.CONCIERGE.CONTACTS_ROLES"));
    \u0275\u0275advance(4);
    \u0275\u0275property("formField", ctx_r1.form.roles)("placeholder", \u0275\u0275pipeBind1(43, 35, "APP.CONCIERGE.CONTACTS_ROLES_SELECT"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.roles());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.can_manage_roles() ? 46 : -1);
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmergencyContactModalComponent, selectors: [["emergency-contact-modal"]], viewQuery: function EmergencyContactModalComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(5, EmergencyContactModalComponent_Conditional_5_Template, 47, 38, "main", 4)(6, EmergencyContactModalComponent_Conditional_6_Template, 5, 4, "main", 5);
...
function EmergencyContactsComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9)(1, "button", 23);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function EmergencyContactsComponent_Conditional_30_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.manageRoles());
    });
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(2, 1, "APP.CONCIERGE.CONTACTS_ROLES_MANAGE"));
  }
}
function EmergencyContactsComponent_ng_template_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function EmergencyContactsComponent_ng_template_38_Template_button_click_0_listener() {
      const row_r6 = \u0275\u0275restoreView(_r5).row;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.copyToClipboard(row_r6.email));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", row_r6.email, " ");
  }
}
function EmergencyContactsComponent_ng_template_40_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function EmergencyContactsComponent_ng_template_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27);
    \u0275\u0275repeaterCreate(1, EmergencyContactsComponent_ng_template_40_For_2_Template, 2, 1, "span", 28, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function EmergencyContactsComponent_ng_template_42_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", data_r9 ? \u0275\u0275pipeBind1(2, 1, data_r9)?.display_name : "All", " ");
  }
}
function EmergencyContactsComponent_ng_template_44_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 30)(1, "button", 23);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function EmergencyContactsComponent_ng_template_44_Template_button_click_1_listener() {
      const row_r11 = \u0275\u0275restoreView(_r10).row;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.editContact(row_r11));
    });
    \u0275\u0275elementStart(3, "icon");
    \u0275\u0275text(4, "edit");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function EmergencyContactsComponent_ng_template_44_Template_button_click_5_listener() {
      const row_r11 = \u0275\u0275restoreView(_r10).row;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.removeContact(row_r11));
    });
    \u0275\u0275elementStart(7, "icon");
    \u0275\u0275text(8, "delete");
    \u0275\u0275elementEnd()()();
...
var EmergencyContactsComponent = class _EmergencyContactsComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmergencyContactsComponent, selectors: [["", "app-emergency-contacts", ""]], decls: 46, vars: 47, consts: [["person_template", ""], ["roles_template", ""], ["zone_template", ""], ["actions_template", ""], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["topbar", "", 1, "flex", "flex-col", "px-8", "py-4"], [1, "flex", "items-center", "justify-between"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click"], [1, "text-2xl"], [1, "pr-2"], [1, "mt-2", "flex", "items-center", "justify-between", "py-2"], [3, "ngModelChange", "ngModel", "placeholder"], ["value", ""], [3, "value"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "block", "min-w-208", "text-sm", 3, "data", "filter", "empty_message", "columns", "sortable"], [1, "h-12", "w-full"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "flex-wrap", "p-2"], [1, "bg-info", "text-info-content", "m-1", "rounded-2xl", "px-2", "py-1", "font-mono", "text-xs"], [1, "p-4"], [1, "flex", "w-full", "items-center", "justify-end", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", "error", "", 3, "click", "matTooltip"]], template: function EmergencyContactsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(30, EmergencyContactsComponent_Conditional_30_Template, 5, 3, "div", 9);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "section", 20);
        \u0275\u0275element(32, "simple-table", 21);
        \u0275\u0275pipe(33, "translate");
        \u0275\u0275pipe(34, "translate");
        \u0275\u0275pipe(35, "translate");
        \u0275\u0275pipe(36, "translate");
        \u0275\u0275element(37, "div", 22);
        \u0275\u0275template(38, EmergencyContactsComponent_ng_template_38_Template, 5, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(40, EmergencyContactsComponent_ng_template_40_Template, 3, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(42, EmergencyContactsComponent_ng_template_42_Template, 3, 3, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(44, EmergencyContactsComponent_ng_template_44_Template, 9, 6, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        const person_template_r12 = \u0275\u0275reference(39);
        const roles_template_r13 = \u0275\u0275reference(41);
        const zone_template_r14 = \u0275\u0275reference(43);
        const actions_template_r15 = \u0275\u0275reference(45);
        \u0275\u0275advance(7);
        ...
        \u0275\u0275repeater(ctx.roles());
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.can_manage_roles() ? 30 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("data", ctx.filtered_contacts())("filter", ctx.search())("empty_message", \u0275\u0275pipeBind1(33, 23, ctx.search() ? "APP.CONCIERGE.CONTACTS_SEARCH_EMPTY" : "APP.CONCIERGE.CONTACTS_EMPTY"))("columns", \u0275\u0275pureFunction4(42, _c4, \u0275\u0275pureFunction2(31, _c03, \u0275\u0275pipeBind1(34, 25, "COMMON.PERSON"), person_template_r12), \u0275\u0275pureFunction2(34, _c1, \u0275\u0275pipeBind1(35, 27, "APP.CONCIERGE.CONTACTS_ROLES"), roles_template_r13), \u0275\u0275pureFunction2(37, _c2, \u0275\u0275pipeBind1(36, 29, "RESOURCE.LEVEL"), zone_template_r14), \u0275\u0275pureFunction1(40, _c3, actions_template_r15)))("sortable", true);
      }
    }, dependencies: [
      MatRippleModule,
      MatRipple,
...
//# debugId=ec0b03c3-ec70-55cb-b6af-d41c6c1fd180
//# sourceMappingURL=staff.routes-PUI25PBG.js.map
