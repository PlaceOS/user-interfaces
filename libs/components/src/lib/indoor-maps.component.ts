...
@Component({
    ...
    template: `
        ...
        <div
            class="absolute left-2 top-2 z-50 flex h-min w-min flex-col rounded-lg bg-base-100 p-2 text-base-content shadow-sm"
        >
            ...
            @if (search_result_items?.length) {
                ...
                >
                    @for (
                        ...
                        <li
                            class="w-full rounded-sm border border-base-200 even:bg-base-200 hover:bg-base-300"
                        >
                            <button
