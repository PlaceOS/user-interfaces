...
_PointsTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsTopbarComponent, selectors: [["points-topbar"]], features: [\u0275\u0275InheritDefinitionFeature], ngContentSelectors: _c0, decls: 8, vars: 3, consts: [[1, "flex", "h-20", "items-center", "space-x-2", "bg-base-100", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "pl-2"]], template: function PointsTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275projectionDef();
...
//# sourceMappingURL=points.module-OA24VAGA.js.map
