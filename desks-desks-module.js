...
class DeskFlowStateService extends _user_interfaces_common__WEBPACK_IMPORTED_MODULE_5__["BaseClass"] {
    ...
    startPolling(delay = 5000) {
        this.interval('poll', () => this._options.next(Object.assign({}, this._options.getValue())), delay);
    }
    stopPolling() {
        this.clearInterval('poll');
    }
