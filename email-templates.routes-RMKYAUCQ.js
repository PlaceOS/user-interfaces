...
var EmailTemplatesStateService = class _EmailTemplatesStateService extends AsyncHandler {
  constructor() {
    ...
    this._template_definitions = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_template_definitions" } : (
      ...
      loader: async ({ params }) => {
        if (!params.building)
          return [];
        const metadata = await rc(this._org.organisation.id, "email_template_fields").catch(() => null);
  ...
  async _queryTemplates(building, region) {
    ...
    const [org_templates, bld_templates, region_templates] = await Promise.all([
      rc(this._org.organisation.id, "email_templates").then((_) => this._processTemplates(_, this._org.organisation.id)).catch(() => []),
      rc(building, "email_templates").then((_) => this._processTemplates(_, building)).catch(() => []),
      region ? rc(region, "email_templates").then((_) => this._processTemplates(_, region)).catch(() => []) : Promise.resolve([])
    ]);
  ...
  async saveTemplate(template, old_zone = "") {
    ...
    if (template.id && old_zone) {
      const old_metadata = await rc(old_zone, "email_templates");
    ...
    const metadata = await rc(template.zone_id, "email_templates");
...
function EmailTemplateManageComponent_Conditional_82_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 34)(1, "button", 43);
    \u0275\u0275listener("click", function EmailTemplateManageComponent_Conditional_82_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r3 = \u0275\u0275nextContext();
...
function EmailTemplateManageComponent_ng_template_83_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplateManageComponent, selectors: [["email-template-manage"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 85, vars: 70, consts: [["trigger_menu", "matMenu"], ["tracking_menu", "matMenu"], ["load_state", ""], [1, "bg-base-200", "absolute", "inset-0", "overflow-auto"], [1, "bg-base-100", "border-base-300", "mx-auto", "min-h-full", "w-164", "max-w-full", "border-x"], [1, "bg-base-200", "sticky", "top-2", "z-20", "mx-auto", "mb-2", "flex", "w-full", "max-w-160", "items-center", "justify-between", "rounded-sm", "border-none", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "relative", "z-10", "mx-auto", "min-h-[calc(100vh-8.5rem)]", "w-full", "max-w-160", "overflow-visible", "p-2"], [1, "mb-2", "flex", "items-center", "gap-2"], [1, "w-1/4", "flex-1", "gap-2"], ["for", "zone"], ["appearance", "outline", 1, "no-subscript", "w-full"], [3, "placeholder", "formField"], [3, "value"], ["for", "trigger"], ["type", "button", "btn", "", "matRipple", "", 1, "inverse", "border-base-300", "flex", "h-12", "w-full", "items-center", "justify-between", "rounded-sm", "border", "px-2", 3, "click", "matMenuTriggerFor"], [1, "flex", "w-1/2", "flex-1", "flex-col", "px-2", "text-left", "leading-tight"], [1, "truncate"], [1, "truncate", "opacity-30"], [1, "text-2xl"], [1, "max-h-96"], ["mat-menu-item", "", 3, "click"], ["btn", "", "type", "button", "matRipple", "", "matTooltip", "Values that get replaced in the email template when sent", 1, "mt-5.5", "flex-1", 3, "disabled", "matMenuTriggerFor"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "disabled"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "flex-1"], ["matInput", "", 3, "placeholder", "formField"], [1, "mb-2", "-mt-2", "text-xs", "opacity-60"], ["appearance", "outline", 1, "w-full"], ["matPrefix", "", 1, "relative", "-left-1", "text-2xl"], ["matInput", "", "placeholder", "Template Subject", 3, "formField"], [1, "block", "min-h-[calc(100vh-32rem)]", 3, "formField", "placeholder", "images_allowed"], [1, "bg-base-200", "sticky", "bottom-2", "z-20", "mx-auto", "mt-2", "flex", "w-full", "max-w-160", "items-center", "justify-end", "rounded-sm", "border-none", "px-4", "py-2"], [1, "p-4"], [1, "flex", "items-center", "space-x-2", "pl-2"], [1, "my-2", "flex", "flex-1", "flex-col-reverse", "leading-tight"], [1, "text-xs", "opacity-30"], [1, "text-sm"], [1, "opacity-0"], [1, "flex", "flex-col", "leading-tight"], [1, "font-mono", "text-sm"], ["btn", "", "type", "button", "matRipple", "", 1, "w-40", 3, "click"], [1, "bg-base-100", "absolute", "inset-0"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [3, "diameter"]], template: function EmailTemplateManageComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(59, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(60, "div", 26)(61, "mat-form-field", 27);
        \u0275\u0275element(62, "input", 28);
        \u0275\u0275pipe(63, "translate");
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(64, "mat-form-field", 27);
        \u0275\u0275element(65, "input", 28);
        \u0275\u0275pipe(66, "translate");
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(67, "mat-form-field", 27);
        \u0275\u0275element(68, "input", 28);
        \u0275\u0275pipe(69, "translate");
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(70, "p", 29);
        \u0275\u0275text(71);
        \u0275\u0275pipe(72, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(73, "mat-form-field", 30)(74, "icon", 31);
        \u0275\u0275text(75, " description ");
        \u0275\u0275elementEnd();
        \u0275\u0275element(76, "input", 32);
        \u0275\u0275controlCreate();
        \u0275\u0275elementStart(77, "mat-error");
        \u0275\u0275text(78);
        \u0275\u0275pipe(79, "translate");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(80, "rich-text-input", 33);
        \u0275\u0275pipe(81, "translate");
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(82, EmailTemplateManageComponent_Conditional_82_Template, 4, 3, "footer", 34);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(83, EmailTemplateManageComponent_ng_template_83_Template, 5, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
      }
      if (rf & 2) {
        const trigger_menu_r9 = \u0275\u0275reference(33);
        const tracking_menu_r10 = \u0275\u0275reference(43);
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 34, ctx.template()?.id ? "APP.CONCIERGE.EMAIL_TEMPLATES_EDIT" : "APP.CONCIERGE.EMAIL_TEMPLATES_NEW"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275conditional(!ctx.loading() ? 6 : -1);
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 36, "RESOURCE.BUILDING"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(15, 38, "COMMON.BUILDING_SELECT"))("formField", ctx.form.zone_id);
        \u0275\u0275control();
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.buildings());
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(20, 40, "COMMON.BUILDING_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(24, 42, "COMMON.TRIGGER"), " ");
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(36, 44, "COMMON.NONE"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.definitions());
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", !ctx.model().trigger)("matMenuTriggerFor", tracking_menu_r10);
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(41, 46, "APP.CONCIERGE.EMAIL_TEMPLATES_PLACEHOLDERS"), " ");
        \u0275\u0275advance(4);
        \u0275\u0275repeater(ctx.active_trigger()?.fields || \u0275\u0275pureFunction0(68, _c0));
        \u0275\u0275advance(2);
        \u0275\u0275conditional(!(ctx.active_trigger()?.fields || \u0275\u0275pureFunction0(69, _c0)).length ? 46 : -1);
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(50, 48, "APP.CONCIERGE.EMAIL_TEMPLATES_REPLY_TO"))("formField", ctx.form.reply_to);
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(53, 50, "APP.CONCIERGE.EMAIL_TEMPLATES_REPLY_TO_REQUIRED"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(56, 52, "APP.CONCIERGE.EMAIL_TEMPLATES_FROM"))("formField", ctx.form.from);
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(59, 54, "APP.CONCIERGE.EMAIL_TEMPLATES_FROM_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(63, 56, "APP.CONCIERGE.EMAIL_TEMPLATES_TO"))("formField", ctx.form.to);
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(66, 58, "APP.CONCIERGE.EMAIL_TEMPLATES_CC"))("formField", ctx.form.cc);
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(69, 60, "APP.CONCIERGE.EMAIL_TEMPLATES_BCC"))("formField", ctx.form.bcc);
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(72, 62, "APP.CONCIERGE.EMAIL_TEMPLATES_RECIPIENTS_HINT"), " ");
        \u0275\u0275advance(5);
        \u0275\u0275property("formField", ctx.form.subject);
        \u0275\u0275control();
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(79, 64, "APP.CONCIERGE.EMAIL_TEMPLATES_SUBJECT_REQUIRED"));
        \u0275\u0275advance(2);
        \u0275\u0275property("formField", ctx.form.html)("placeholder", \u0275\u0275pipeBind1(81, 66, "APP.CONCIERGE.EMAIL_TEMPLATES_BODY"))("images_allowed", true);
        \u0275\u0275control();
        \u0275\u0275advance(2);
        \u0275\u0275conditional(!ctx.loading() ? 82 : -1);
      }
    }, dependencies: [
      RouterModule,
      RouterLink,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplateManageComponent, { className: "EmailTemplateManageComponent", filePath: "apps/concierge/src/app/email-templates/email-template-manage.component.ts", lineNumber: 342 });
})();
...
//# debugId=b78128a2-bda8-5753-af01-bfa4174d95a4
//# sourceMappingURL=email-templates.routes-RMKYAUCQ.js.map
