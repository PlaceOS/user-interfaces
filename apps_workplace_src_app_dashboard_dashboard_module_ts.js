...
/* harmony import */ var _dashboard_state_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard-state.service */ 8016);
...
DashboardAvailabilityComponent.ɵfac = function DashboardAvailabilityComponent_Factory(t) {
  return new (t || DashboardAvailabilityComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_dashboard_state_service__WEBPACK_IMPORTED_MODULE_1__.DashboardStateService));
};
DashboardAvailabilityComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  type: DashboardAvailabilityComponent,
  selectors: [["a-dashboard-availability"]],
  decls: 14,
  vars: 13,
  consts: [[1, "m-0", "font-medium", "text-xl"], [1, "flex", "flex-col", "items-center", "p-2", "bg-white", "dark:bg-neutral-600", "shadow", "my-4", "rounded-lg"], [1, "flex", "items-center", "w-full", "mb-2"], ["free-levels", "", 1, "items", "space-y-2", "w-full"], ["button", "", "btn", "", "matRipple", "", "class", "w-full", 3, "routerLink", "queryParams", 4, "ngFor", "ngForOf"], ["class", "text-black/30 dark:text-white/30 text-sm mb-2", 4, "ngIf"], ["free-spaces", "", "class", "flex items-center flex-col rounded-lg bg-white dark:bg-neutral-600 shadow my-4 p-2", 4, "ngIf"], ["button", "", "btn", "", "matRipple", "", 1, "w-full", 3, "routerLink", "queryParams"], [1, "max-w-full", "truncate"], [1, "text-black/30", "dark:text-white/30", "text-sm", "mb-2"], ["free-spaces", "", 1, "flex", "items-center", "flex-col", "rounded-lg", "bg-white", "dark:bg-neutral-600", "shadow", "my-4", "p-2"], [1, "items", "space-y-2", "w-full"], ["class", "text-dark-fade text-sm mb-2", 4, "ngIf"], [1, "text-dark-fade", "text-sm", "mb-2"]],
...
/* harmony import */ var _libs_components_src_lib_user_avatar_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../libs/components/src/lib/user-avatar.component */ 99685);
...
/* harmony import */ var _dashboard_deliveries_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dashboard-deliveries.component */ 10537);
...
DashboardContactsComponent.ɵfac = function DashboardContactsComponent_Factory(t) {
  return new (t || DashboardContactsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_dashboard_state_service__WEBPACK_IMPORTED_MODULE_1__.DashboardStateService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_0__.SettingsService));
};
DashboardContactsComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
...
/* harmony import */ var _dashboard_delivery_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard-delivery-modal.component */ 72220);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 86839);
...
function DashboardDeliveriesComponent_div_3_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵclassProp"]("bg-pending", !item_r4.received)("bg-success", item_r4.received);
  }
}
...
DashboardDeliveriesComponent.ɵfac = function DashboardDeliveriesComponent_Factory(t) {
  return new (t || DashboardDeliveriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__.MatDialog));
};
DashboardDeliveriesComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  type: DashboardDeliveriesComponent,
  selectors: [["dashboard-deliveries"]],
  decls: 6,
  vars: 2,
  consts: [[1, "m-0", "my-2", "font-medium", "text-xl"], [1, "bg-white", "shadow", "p-2", "rounded", "dark:bg-neutral-700"], ["class", "divide-y", 4, "ngIf", "ngIfElse"], ["empty_state", ""], [1, "divide-y"], ["class", "flex items-center py-2", 4, "ngFor", "ngForOf"], ["matRipple", "", 1, "w-full", "mt-2", 3, "click"], [1, "flex", "items-center", "py-2"], [1, "flex-1", "pl-2"], [1, ""], [1, "text-xs", "opacity-60"], [1, "m-4", "h-2", "w-2", "rounded-full"], [1, "p-8", "flex", "items-center", "justify-center", "opacity-40"]],
  template: function DashboardDeliveriesComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", ctx.deliveries == null ? null : ctx.deliveries.length)("ngIfElse", _r1);
    }
  },
...
/* harmony import */ var _angular_material_select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/material/select */ 56508);
...
DashboardDeliveryModalComponent.ɵfac = function DashboardDeliveryModalComponent_Factory(t) {
  return new (t || DashboardDeliveryModalComponent)();
};
DashboardDeliveryModalComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ 51233);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 86839);
...
class DashboardScheduledItemComponent {
  ...
  get has_ended() {
    return !this.item || this.item.id === 'date' || (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), this.item.date + this.item.duration * 60 * 1000);
  }
  get icon() {
...
DashboardScheduledItemComponent.ɵfac = function DashboardScheduledItemComponent_Factory(t) {
  return new (t || DashboardScheduledItemComponent)();
};
DashboardScheduledItemComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
  ...
  decls: 20,
  vars: 24,
  consts: [["btn", "", "matRipple", "", 1, "rounded-none", "my-1", "mx-4", "w-[calc(100%-2rem)]", "h-24", "bg-white", "dark:bg-neutral-700", "hover:shadow", "p-0", 3, "routerLink"], [1, "flex", "items-center", "border", "border-gray-200", "rounded-lg"], ["status", "", 1, "h-24", "w-20", "flex", "flex-col", "items-center", "justify-center", "text-white", "leading-tight"], [1, "text-2xl"], [1, "font-normal"], [1, "capitalize", "text-xs", "font-medium"], [1, "flex-1", "flex", "flex-col", "text-left", "p-2"], [1, "text-xl", "pl-1"], [1, "flex", "items-center", "font-normal", "leading-normal", "space-x-1"], [1, "text-lg"], [1, "text-sm"], ["class", "flex items-center font-normal leading-normal space-x-1", 4, "ngIf"]],
  template: function DashboardScheduledItemComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵclassProp"]("bg-success", ctx.status === "approved")("bg-pending", ctx.status === "tentative")("bg-error", ctx.status === "declined");
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs/operators */ 25670);
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! date-fns */ 90371);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! date-fns */ 33200);
...
/* harmony import */ var _placeos_users__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @placeos/users */ 42852);
/* harmony import */ var _placeos_organisation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @placeos/organisation */ 6221);
/* harmony import */ var _placeos_calendar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @placeos/calendar */ 51876);
/* harmony import */ var _placeos_bookings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @placeos/bookings */ 56917);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @angular/core */ 86839);
...
class DashboardStateService extends _placeos_common__WEBPACK_IMPORTED_MODULE_2__.AsyncHandler {
  ...
  updateFreeSpaces() {
    ...
    return (0,_Users_yuion_Documents_work_repos_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mins = Math.abs((0,date_fns__WEBPACK_IMPORTED_MODULE_16__["default"])(Date.now(), (0,date_fns__WEBPACK_IMPORTED_MODULE_17__["default"])(Date.now())));
  ...
  updateUpcomingEvents() {
    ...
    return (0,_Users_yuion_Documents_work_repos_user_interfaces_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const period_end = Math.floor((0,date_fns__WEBPACK_IMPORTED_MODULE_17__["default"])(new Date()).valueOf() / 1000);
...
/* harmony export */ });
/* harmony import */ var _placeos_organisation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @placeos/organisation */ 6221);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns */ 88053);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ 86942);
/* harmony import */ var _placeos_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @placeos/components */ 72470);
/* harmony import */ var _schedule_schedule_state_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../schedule/schedule-state.service */ 18676);
/* harmony import */ var _dashboard_state_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dashboard-state.service */ 8016);
...
function DashboardUpcomingComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](13, DashboardUpcomingComponent_div_2_div_13_Template, 3, 4, "div", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtemplate"](14, DashboardUpcomingComponent_div_2_div_14_Template, 2, 1, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
...
class DashboardUpcomingComponent {
  constructor(_org, _state, _schedule, _dialog) {
    ...
    this._dialog = _dialog;
    this.today = new Date();
    this.max_date = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(this.today, 4);
...
/* harmony import */ var _dashboard_availability_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dashboard-availability.component */ 81624);
/* harmony import */ var _dashboard_upcoming_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dashboard-upcoming.component */ 82175);
/* harmony import */ var _dashboard_contacts_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dashboard-contacts.component */ 7979);
...
DashboardComponent.ɵfac = function DashboardComponent_Factory(t) {
  return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdirectiveInject"](_placeos_common__WEBPACK_IMPORTED_MODULE_0__.SettingsService));
};
DashboardComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
  ...
  decls: 8,
  vars: 2,
  consts: [[1, "flex-1", "flex", "sm:flex-row", "flex-col-reverse", "h-1/2", "bg-gray-200", "dark:bg-neutral-600", "dark:text-white"], [1, "relative", "z-0", "flex", "flex-col", "flex-1", "h-1/2", "sm:h-auto", "overflow-hidden"], [1, "flex", "flex-1", "px-0", "sm:px-8", "flex-wrap", "overflow-auto", "h-px", "sm:h-auto"], ["class", "flex-1 min-w-64", 4, "ngIf"], [1, "flex-1", "min-w-64"]],
...
/* harmony export */ });
/* harmony import */ var _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/cdk/scrolling */ 53947);
...
/* harmony import */ var _dashboard_availability_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard-availability.component */ 81624);
/* harmony import */ var _dashboard_contacts_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dashboard-contacts.component */ 7979);
/* harmony import */ var _dashboard_deliveries_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dashboard-deliveries.component */ 10537);
/* harmony import */ var _dashboard_delivery_modal_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dashboard-delivery-modal.component */ 72220);
/* harmony import */ var _dashboard_schedule_item_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dashboard-schedule-item.component */ 19451);
/* harmony import */ var _dashboard_upcoming_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dashboard-upcoming.component */ 82175);
/* harmony import */ var _dashboard_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dashboard.component */ 20088);
