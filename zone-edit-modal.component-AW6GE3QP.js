...
var _c0 = (a0) => [a0];
var _c1 = () => [];
function ZoneEditModalComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
...
function ZoneEditModalComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneEditModalComponent, selectors: [["zone-edit-modal"]], decls: 37, vars: 43, consts: [["confirm_hotkey", "S", 3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "gap-4"], ["for", "signage-zone-name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", "id", "signage-zone-name", 3, "placeholder", "formField"], ["for", "signage-zone-description"], ["matInput", "", "id", "signage-zone-description", 1, "min-h-24", 3, "placeholder", "formField"], [1, "mb-1", "font-medium"], [1, "mb-3", "text-sm", "opacity-70"], [1, "bg-base-200", "mb-3", "rounded-lg", "px-3", "py-2", "text-sm"], [1, "border-base-300", "h-80", "overflow-auto", "rounded-lg", "border", "p-2"], [3, "selectedChange", "zoneSelected", "list", "roots", "load_children", "exclude_ids", "scoped_search", "selected"], [1, "text-error", "mt-1", "text-sm"]], template: function ZoneEditModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(24, "section")(25, "h3", 8);
        \u0275\u0275text(26);
        \u0275\u0275pipe(27, "translate");
        ...
        \u0275\u0275pipe(32, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(33, ZoneEditModalComponent_Conditional_33_Template, 3, 4, "div", 10);
        \u0275\u0275elementStart(34, "div", 11)(35, "zone-select-tree", 12);
        \u0275\u0275twoWayListener("selectedChange", function ZoneEditModalComponent_Template_zone_select_tree_selectedChange_35_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.selected_parent, $event) || (ctx.selected_parent = $event);
          return $event;
        });
        \u0275\u0275listener("zoneSelected", function ZoneEditModalComponent_Template_zone_select_tree_zoneSelected_35_listener($event) {
          return ctx.selectParent($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(36, ZoneEditModalComponent_Conditional_36_Template, 3, 3, "div", 13);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 20, ctx.zone.id ? "SIGNAGE_MANAGER.ZONE_EDIT" : "SIGNAGE_MANAGER.NEW_ZONE"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 22, "SIGNAGE_MANAGER.ZONE_SAVING") : "");
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 24, "FORM.NAME"));
        \u0275\u0275advance(5);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(12, 26, "FORM.NAME"))("formField", ctx.form.display_name);
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 28, "SIGNAGE_MANAGER.ZONE_NAME_ARIA"));
        \u0275\u0275control();
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 30, "FORM.NAME_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(20, 32, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(23, 34, "COMMON.DESCRIPTION"))("formField", ctx.form.description);
        \u0275\u0275control();
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(27, 36, "SIGNAGE_MANAGER.ZONE_PARENT"));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(32, 38, "SIGNAGE_MANAGER.ZONE_PARENT_HINT"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.selected_parent() ? 33 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("list", ctx.zone_list)("roots", ctx.roots())("load_children", ctx.loadChildren)("exclude_ids", ctx.zone.id ? \u0275\u0275pureFunction1(40, _c0, ctx.zone.id) : \u0275\u0275pureFunction0(42, _c1))("scoped_search", true);
        \u0275\u0275twoWayProperty("selected", ctx.selected_parent);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.parent_id().touched() && !ctx.model().parent_id ? 36 : -1);
      }
    }, dependencies: [
      FormField,
      MatFormFieldModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneEditModalComponent, { className: "ZoneEditModalComponent", filePath: "apps/signage-manager/src/app/zones/zone-edit-modal.component.ts", lineNumber: 147 });
})();
export {
  ZoneEditModalComponent
};
//# debugId=54019b5c-f38d-5504-bf79-5d9af61176af
//# sourceMappingURL=zone-edit-modal.component-AW6GE3QP.js.map
