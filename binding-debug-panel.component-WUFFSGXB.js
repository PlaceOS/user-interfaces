...
function BindingDebugPanelComponent_Conditional_0_For_32_Conditional_10_For_1_Conditional_7_Conditional_1_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classProp("text-error-content", (_a = command_r14.receive) == null ? void 0 : _a.error)("text-success-content", command_r14.receive && !command_r14.receive.error)("bg-error", (_b = command_r14.receive) == null ? void 0 : _b.error)("bg-success", command_r14.receive && !command_r14.receive.error);
    \u0275\u0275advance();
...
var _BindingDebugPanelComponent = class _BindingDebugPanelComponent extends AsyncHandler {
  ...
  copyLabel(key) {
    ...
    if ((result == null ? void 0 : result.key) !== key)
      return "Copy value";
...
//# sourceMappingURL=binding-debug-panel.component-WUFFSGXB.js.map
