...
import "./chunk-H23RGKQD.js";
import "./chunk-EXROLBBG.js";
import {
  DateCalendarComponent,
  startOfMonth
} from "./chunk-FTN2E3EY.js";
...
var GroupEventsStateService = class _GroupEventsStateService {
  ...
  constructor() {
    ...
    effect(async () => {
      ...
      const sys = await la({ in: this.calendar }).then((r) => r.data?.[0]).catch(() => null);
      if (!sys) {
        this._events.set([]);
        return;
      }
...
//# sourceMappingURL=group-events.routes-T4CXHAIM.js.map
