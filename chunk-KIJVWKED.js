...
var BookingDetailsModalComponent = class _BookingDetailsModalComponent {
  ...
  async toggleCheckedIn() {
    ...
    const promise = (bkn.instance ? checkinBookingInstance(bkn.id, bkn.instance, !bkn.checked_in) : checkinBooking(bkn.id, !bkn.checked_in)).catch((_) => {
...
//# sourceMappingURL=chunk-KIJVWKED.js.map
