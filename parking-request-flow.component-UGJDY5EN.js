...
} from "./chunk-3PYZ6EX4.js";
import {
  DateFieldComponent
} from "./chunk-MSMPQEHV.js";
import {
  UserSearchFieldComponent
} from "./chunk-6SGUXEFD.js";
import "./chunk-RNALWYLF.js";
import {
  ParkingService
} from "./chunk-SZAIIA2F.js";
import {
  BookingFormService
} from "./chunk-6NND2YX5.js";
import {
  SettingsToggleComponent
} from "./chunk-Y3B6LNLK.js";
import {
  MatTooltip,
  MatTooltipModule
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_32_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_32_Conditional_2_For_9_Template, 5, 12, "mat-option", 15, _forTrack0, true);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(9, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_33_For_10_Template, 10, 13, "div", 54, _forTrack0, true);
    \u0275\u0275elementEnd();
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275repeaterCreate(9, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_60_For_10_Template, 3, 4, "mat-option", 15, _forTrack0, true);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_61_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_61_Conditional_10_For_3_Template, 3, 4, "mat-option", 15, _forTrack0, true);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_61_Conditional_11_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275property("label", \u0275\u0275pipeBind1(1, 3, option_r32.name))("ngModel", ctx_r2.isExtraRestrictionSelected(option_r32.id))("ngModelOptions", \u0275\u0275pureFunction0(5, _c0));
    \u0275\u0275control();
  }
}
function ParkingRequestFormDetailsComponent_Conditional_0_Conditional_61_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ParkingRequestFormDetailsComponent_Conditional_0_Conditional_61_Conditional_11_For_2_Template, 2, 6, "settings-toggle", 70, _forTrack0, true);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ParkingRequestFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(18, ParkingRequestFormDetailsComponent_Conditional_0_For_19_Template, 12, 16, "div", 5, _forTrack0, true);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(49, ParkingRequestFormDetailsComponent_Conditional_0_For_50_Template, 3, 4, "mat-option", 15, _forTrack0, true);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r2.model().plate_number)("ngModelOptions", \u0275\u0275pureFunction0(37, _c0))("placeholder", \u0275\u0275pipeBind1(58, 35, "BOOKINGS.PARKING_REGISTRATION_PLACEHOLDER"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
...
var ParkingRequestFormDetailsComponent = class _ParkingRequestFormDetailsComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    ...
    if (!form || !model)
      return;
    this.supporting_doc_names.set(model().p2_document_names || (model().attachments || []).map((url) => this._fileNameFromUrl(url)));
  ...
  async onSupportingDocsSelected(event) {
    ...
    const existing_names = model?.().p2_document_names || [];
    const new_urls = [];
...
var ParkingRequestFormComponent = class _ParkingRequestFormComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingRequestFormComponent, selectors: [["parking-request-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 59, vars: 38, consts: [[1, "bg-base-200", "relative", "z-0", "flex", "h-full", "w-full", "flex-col", "overflow-auto"], [1, "mx-auto", "min-h-full", "w-[80rem]", "max-w-full", "flex-1", "space-y-2", "px-2", "pt-2", "sm:space-y-4", "sm:px-4", "sm:pt-4"], [1, "border-base-300", "bg-base-100", "flex", "w-full", "flex-col", "overflow-hidden", "rounded-xl", "border"], [1, "gradient", "border-base-content", "relative", "flex", "items-center", "space-x-2", "border-l-8", "px-4", "py-3", "text-xl", "font-medium"], [1, "px-6", "py-4"], [1, "opacity-60"], [3, "form", "model_input", "show_special_needs"], [1, "gradient", "border-base-content", "flex", "items-center", "space-x-2", "border-l-8", "px-4", "py-3", "font-medium"], [1, "space-y-4", "p-4"], [1, "bg-base-200", "border-base-300", "flex", "items-start", "gap-3", "rounded-lg", "border", "p-4"], [1, "text-warning", "mt-0.5", "shrink-0", "text-xl"], [1, "text-sm", 3, "innerHTML"], [1, "space-y-2"], [1, "flex", "items-center", "gap-2"], [1, "text-success", "text-lg"], [1, "text-warning", "text-lg"], [1, "text-warning", "flex", "items-center", "gap-2"], [1, "border-base-300", "bg-base-100", "sticky", "bottom-0", "z-20", "flex", "justify-between", "gap-2", "rounded-t-xl", "border-x", "border-t", "p-3", "text-sm", "sm:text-base"], ["btn", "", "matRipple", "", 1, "inverse", "flex", "items-center", "gap-2", 3, "click"], [1, "text-xl"], [1, "pr-2"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [1, "flex", "items-center", "space-x-2"], [1, "animate-spin", "text-2xl"], [1, "flex-1", "pr-4"], [1, "text-2xl"], [1, "border-base-300", "bg-base-100", "rounded-xl", "border", "p-4"], [1, "text-lg"], [1, "text-sm"], [1, "prose", "prose-sm", "max-w-none", 3, "innerHTML"]], template: function ParkingRequestFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(41, "translate");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(42, ParkingRequestFormComponent_Conditional_42_Template, 6, 3, "div", 16);
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275conditionalCreate(52, ParkingRequestFormComponent_Conditional_52_Template, 2, 0, "icon", 23)(53, ParkingRequestFormComponent_Conditional_53_Template, 2, 0, "icon", 19);
        \u0275\u0275elementStart(54, "div", 24);
        \u0275\u0275text(55);
        \u0275\u0275pipe(56, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(57, ParkingRequestFormComponent_Conditional_57_Template, 2, 0, "icon", 25);
        \u0275\u0275elementEnd()()();
        \u0275\u0275conditionalCreate(58, ParkingRequestFormComponent_Conditional_58_Template, 3, 3, "div", 26);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingRequestFormComponent, { className: "ParkingRequestFormComponent", filePath: "apps/workplace/src/app/book/parking-request-flow/parking-request-form.component.ts", lineNumber: 228 });
})();
...
//# sourceMappingURL=parking-request-flow.component-UGJDY5EN.js.map
