...
var MapsIndoorsComponent = class _MapsIndoorsComponent extends AsyncHandler {
  ...
  _setResource(id, resource2) {
    RESOURCE_MAP[id] = resource2;
  ...
  async _updateMapStyling() {
    ...
    for (const id in styles) {
      ...
      if (!resource2) {
        ...
        if (!list.length)
          continue;
        resource2 = list.find((_) => _.properties?.externalId === id_simple || _.properties?.roomId === id_simple || _.id === id_simple);
        if (resource2)
      ...
      this._styled_resources.set(id, resource2.id);
    }
  }
...
//# debugId=16cc812f-268a-5395-8b12-86a7789094e4
//# sourceMappingURL=chunk-IY377CW6.js.map
