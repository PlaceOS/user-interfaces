...
var MatTooltip = class _MatTooltip {
  ...
  _setupPointerEnterEventsIfNeeded() {
    ...
    if (!this._isTouchPlatform()) {
      ...
      this._addListener("touchstart", (event) => {
        ...
        }, ((_b = this._defaultOptions) == null ? void 0 : _b.touchLongPressShowDelay) ?? DEFAULT_LONGPRESS_DELAY);
      });
    }
  }
  _setupPointerExitEventsIfNeeded() {
    ...
    if (!this._isTouchPlatform()) {
      ...
      const touchendListener = () => {
        ...
        this.hide((_a = this._defaultOptions) == null ? void 0 : _a.touchendHideDelay);
      };
  ...
  _isTouchPlatform() {
    var _a;
    const detectHoverCapability = (_a = this._defaultOptions) == null ? void 0 : _a.detectHoverCapability;
...
//# sourceMappingURL=chunk-7FWFE6N4.js.map
