...
`],encapsulation:2})}return t})();var Ue=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵmod=Ve({type:t});static ɵinj=Le({imports:[ve,aa]})}return t})();var ue=(()=>{class t extends rn{constructor(){super(...arguments),this._element=m(we),this._observer=null,this._source_version=0,this.source=Od(void 0)}ngOnChanges(e){if(!e.source)return;this._source_version+=1,this.clearTimeout(`load`),this._observer?.disconnect(),this._observer=null;let n=this.source();if(n){if(!this._isLocalUrl(n)){this._element.nativeElement.src=n;return}this._loadWhenVisible(n,this._source_version)}}ngOnDestroy(){this._observer?.disconnect(),this._observer=null,super.ngOnDestroy()}_loadWhenVisible(e,n){if(typeof IntersectionObserver>`u`){this._loadImage(e,n);return}this._observer=new IntersectionObserver(c=>{c.some(({isIntersecting:i})=>i)&&(this._observer?.disconnect(),this._observer=null,this._loadImage(e,n))},{rootMargin:`300px`}),this._observer.observe(this._element.nativeElement)}async _loadImage(e,n){if(n!==this._source_version||e!==this.source())return;if(!Qf()){this.timeout(`load`,()=>{this._loadImage(e,n)},300);return}let c=Fd(e);if(c){this._element.nativeElement.src=c;return}let i=e.includes(`/api/engine/v2/uploads`)||e.includes(`/api/engine/v2/signage`);try{let l=i?await zu(e,this._cookiePath(e)):await Bu(e);n===this._source_version&&e===this.source()&&(this._element.nativeElement.src=l)}catch(l){n===this._source_version&&this._element.nativeElement.dispatchEvent(new ErrorEvent(`error`,{error:l}))}}_isLocalUrl(e){try{return new URL(e,location.href).origin===location.origin}catch{return!1}}_cookiePath(e){return e.includes(`/api/engine/v2/uploads`)?`/api/engine/v2/uploads`:`/api/engine/v2/signage`}static{this.ɵfac=(()=>{let e;return function(c){return(e||(e=Kn(t)))(c||t)}})()}static{this.ɵdir=X({type:t,selectors:[[`img`,`auth`,``],[`video`,`auth`,``],[`audio`,`auth`,``]],inputs:{source:[1,`source`]},features:[it,vt]})}}return t})();function fe(t,E){if(t&1&&(ri(0,`div`,1),i_(1),Ds()),t&2){let e=dc(2);ps(),mc(` `,e.initials,` `)}}function ge(t,E){if(t&1&&oo(0,`img`,2),t&2){let e=dc(2);Is(`alt`,e.initials)(`source`,e.user().photo)}}function ye(t,E){if(t&1&&(ri(0,`div`,0),cc(1,fe,2,1,`div`,1)(2,ge,1,2,`img`,2),Ds()),t&2){let e=dc();zn(`user-id`,e.user().id),ps(),uc(e.user().photo?2:1)}}var Qe=(()=>{class t{constructor(){this.user=Od(void 0),this.is_valid=Ne(()=>{let e=this.user();if(!e)return!1;let n=(e.name||``).trim(),c=(e.email||``).trim();return n.startsWith(`<empty>`)||c.startsWith(`<empty>`)?!1:!!(n||c||e.first_name||e.last_name)})}get initials(){let e=this.user();if(!e)return`NA`;if(e.first_name&&e.last_name)return`${e.first_name[0]}${e.last_name[0]}`;let n=(e.name||``).replace(/<[^>]*>/g,` `).trim();n||(n=(e.email||e.name||``).split(`@`)[0]);let c=n.replace(/[()[\]\-+=\\/@<>]+/gi,` `).split(/\s+/).filter(Boolean);return c.length===0?`NA`:c.length>1?`${c[0][0]}${c[c.length-1][0]}`:c[0].slice(0,2)}static{this.ɵfac=function(n){return new(n||t)}}static{this.ɵcmp=It({type:t,selectors:[[`a-user-avatar`]],inputs:{user:[1,`user`]},decls:1,vars:1,consts:[[1,`border-base-100`,`bg-base-200`,`flex`,`h-[2.5em]`,`w-[2.5em]`,`items-center`,`justify-center`,`overflow-hidden`,`rounded-full`,`border-2`],[`initials`,``,1,`text-base-content`,`uppercase`,`opacity-60`],[`auth`,``,1,`flex`,`h-full`,`w-full`,`items-center`,`justify-center`,`object-cover`,`object-center`,3,`alt`,`source`]],template:function(n,c){n&1&&cc(0,ye,3,2,`div`,0),n&2&&uc(c.is_valid()?0:-1)},dependencies:[ue],encapsulation:2})}}return t})();export{ve as i,Ue as n,ue as r,Qe as t};
//# debugId=648cf603-5347-5aae-a906-534b5fb260db
//# sourceMappingURL=chunk-DuiZ5onp.js.map