...
} from "./chunk-YMATF2QX.js";
import {
  HostSelectFieldComponent
} from "./chunk-2SDMHYYU.js";
import {
  MatBottomSheet,
  MatBottomSheetRef
...
} from "./chunk-SZCOD4Q4.js";
import {
  BuildingPipe
} from "./chunk-SZCHKURA.js";
import {
  MapPinComponent
} from "./chunk-XI6H3QZW.js";
import {
  DEFAULT_COLOURS
} from "./chunk-U46N6UFF.js";
import {
  InteractiveMapComponent
} from "./chunk-XGQ2OJWX.js";
import {
  DurationFieldComponent
} from "./chunk-5ZNCAA2T.js";
import {
  DateFieldComponent
} from "./chunk-HEN4KOMC.js";
import "./chunk-MAJDNXEP.js";
...
function ParkingFormDetailsComponent_Conditional_0_Conditional_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 16, "FORM.TIME_START"));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.model().date)("ngModelOptions", \u0275\u0275pureFunction0(20, _c05))("use_24hr", ctx_r1.use_24hr)("range", ctx_r1.bookable_hours)("min_duration", ctx_r1.effective_min_duration)("disabled", ctx_r1.form().date().disabled())("timezone", ctx_r1.timezone);
    \u0275\u0275control();
    \u0275\u0275advance(3);
...
function ParkingFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", ctx_r1.building())("ngModelOptions", \u0275\u0275pureFunction0(34, _c05));
    \u0275\u0275control();
    \u0275\u0275advance();
...
var ParkingFlowFormComponent = class _ParkingFlowFormComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingFlowFormComponent, selectors: [["parking-flow-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 39, vars: 23, consts: [[1, "bg-base-200", "h-full", "w-full", "overflow-auto"], [1, "border-base-200", "bg-base-100", "mx-auto", "w-3xl", "max-w-full", "border", "sm:my-4"], [1, "border-base-200", "w-full", "border-b", "p-4", "text-2xl", "font-medium", "sm:px-16", "sm:py-4"], [1, "divide-base-200", "space-y-2", "divide-y", "p-0", "sm:px-16", "sm:py-4"], [1, "p-2"], [1, "flex", "items-center", "space-x-2"], [1, "bg-base-200", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full"], [1, "text-xl"], [1, "w-px", "flex-1"], ["icon", "", "type", "button", "matRipple", "", 3, "click"], [1, "contract-expand"], [1, "mt-4", 3, "form"], [3, "formField"], [1, "flex", "flex-col", "items-center", "p-2", "sm:flex-row", "sm:space-x-2"], ["btn", "", "type", "button", "matRipple", "", "confirm", "", 1, "mb-2", "w-full", "sm:mb-0", "sm:w-auto", 3, "click"], ["btn", "", "type", "button", "matRipple", "", "clear-form", "", 1, "inverse", "w-full", "sm:w-auto", 3, "click"]], template: function ParkingFlowFormComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 13, ctx.model().id ? "APP.WORKPLACE.PARKING_EDIT_HEADER" : "APP.WORKPLACE.PARKING_NEW_HEADER"), " ");
        \u0275\u0275advance(8);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 15, "COMMON.DETAILS"), " ");
        \u0275\u0275advance(5);
        ...
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(25, 17, "RESOURCE.PARKING_SPACE"), " ");
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(ctx.hide_block.space ? "expand_more" : "expand_less");
        \u0275\u0275advance();
        \u0275\u0275classProp("contract-collapsed", ctx.hide_block.space);
        \u0275\u0275advance();
        \u0275\u0275property("formField", ctx.form.resources);
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(35, 19, "BOOKINGS.PARKING_CONFIRM"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(38, 21, ctx.model().id ? "FORM.RESET" : "FORM.CLEAR"), " ");
      }
    }, dependencies: [
      MatRippleModule,
      MatRipple,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingFlowFormComponent, { className: "ParkingFlowFormComponent", filePath: "apps/workplace/src/app/book/parking-flow/parking-flow-form.component.ts", lineNumber: 153 });
})();

// apps/workplace/src/app/book/parking-flow/parking-flow-success.component.ts
var _c06 = (a0, a1, a2, a3) => ({ name: a0, place: a1, date: a2, time: a3 });
var _c13 = () => ["/"];
...
function NewParkingFlowComponent_Conditional_0_Conditional_0_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 3, "APP.WORKPLACE.PARKING_ASSIGNED", \u0275\u0275pureFunction1(8, _c07, ctx_r0.assigned_space()?.name)), " ");
    \u0275\u0275advance(2);
...
//# debugId=8ccec61b-4f4f-5e98-86cf-ab50014d02d7
//# sourceMappingURL=parking-flow.component-DDQYZMHD.js.map
