...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavFooterComponent, { className: "NavFooterComponent", filePath: "apps/signage-manager/src/app/shared/nav-footer.component.ts", lineNumber: 130 });
})();
...
function GroupBreadcrumbsComponent_Conditional_0_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-current", \u0275$index_15_r7 === \u0275$count_15_r8 - 1 ? "true" : null)("aria-label", \u0275$index_15_r7 === \u0275$count_15_r8 - 1 ? \u0275\u0275pipeBind2(1, 8, "SIGNAGE_MANAGER.SIGNAGE_GROUP_LABEL", \u0275\u0275pureFunction1(11, _c02, group_r6.name)) : group_r6.name);
    \u0275\u0275advance(2);
...
function GroupBreadcrumbsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, GroupBreadcrumbsComponent_Conditional_0_For_7_Template, 4, 13, null, null, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
//# sourceMappingURL=chunk-ZUXEG6XW.js.map
