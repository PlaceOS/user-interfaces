...
var MatMenuItem = class _MatMenuItem {
  ...
  constructor() {
    ...
    (_b = (_a = this._parentMenu) == null ? void 0 : _a.addItem) == null ? void 0 : _b.call(_a, this);
  }
...
var MatMenuContent = class _MatMenuContent {
  ...
  detach() {
    var _a;
    if ((_a = this._portal) == null ? void 0 : _a.isAttached) {
      this._portal.detach();
    }
  }
  ngOnDestroy() {
    var _a;
    this.detach();
    (_a = this._outlet) == null ? void 0 : _a.dispose();
  }
...
var MatMenuTriggerBase = class _MatMenuTriggerBase {
  ...
  set _menu(menu) {
    ...
    (_a = this._menuItemInstance) == null ? void 0 : _a._setTriggersSubmenu(this._triggersSubmenu());
  }
  _menuInternal = null;
  ...
  ngOnDestroy() {
    ...
    (_a = this._pendingRemoval) == null ? void 0 : _a.unsubscribe();
    this._menuCloseSubscription.unsubscribe();
  ...
  _closeMenu() {
    var _a;
    (_a = this._menu) == null ? void 0 : _a.close.emit();
  }
  _openMenu(autoFocus) {
    var _a, _b;
    ...
    if (!overlayRef.hasAttached()) {
      ...
      (_b = menu.lazyContent) == null ? void 0 : _b.attach(this.menuData);
    }
    ...
    if (menu instanceof MatMenu && this._ownsMenu(menu)) {
      this._pendingRemoval = menu._animationDone.pipe(take(1)).subscribe(() => {
        ...
        if (!PANELS_TO_TRIGGERS.has(menu)) {
          (_a2 = menu.lazyContent) == null ? void 0 : _a2.detach();
        }
      });
      menu._setIsOpen(false);
    } else {
      overlayRef.detach();
      (_b = menu == null ? void 0 : menu.lazyContent) == null ? void 0 : _b.detach();
    }
...
var MatMenuTrigger = class _MatMenuTrigger extends MatMenuTriggerBase {
  ...
  _handleHover() {
    if (this.triggersSubmenu() && this._parentMaterialMenu) {
      this._hoverSubscription = this._parentMaterialMenu._hovered().subscribe((active) => {
        var _a;
        if (active === this._menuItemInstance && !active.disabled && ((_a = this._parentMaterialMenu) == null ? void 0 : _a._panelAnimationState) !== "void") {
  ...
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    ...
    hostBindings: function MatMenuTrigger_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275attribute("aria-haspopup", ctx.menu ? "menu" : null)("aria-expanded", ctx.menuOpen)("aria-controls", ctx.menuOpen ? (_a = ctx.menu) == null ? void 0 : _a.panelId : null);
      }
    },
    inputs: {
...
var MatContextMenuTrigger = class _MatContextMenuTrigger extends MatMenuTriggerBase {
  ...
  ngOnDestroy() {
    var _a;
    super.ngOnDestroy();
    (_a = this._scrollSubscription) == null ? void 0 : _a.unsubscribe();
  }
  ...
  _isWithinMenuOrTrigger(target) {
    ...
    const overlay = (_a = this._overlayRef) == null ? void 0 : _a.hostElement;
  ...
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    ...
    hostBindings: function MatContextMenuTrigger_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275attribute("aria-controls", ctx.menuOpen ? (_a = ctx.menu) == null ? void 0 : _a.panelId : null);
...
])], ngContentSelectors: _c03, decls: 11, vars: 13, consts: [["type", "button", "matRipple", "", 1, "hover:bg-base-200", "relative", "flex", "flex-1", "items-center", "space-x-2", "overflow-hidden", "rounded-sm", "border", "py-1", "pr-1", "pl-2", 3, "click"], [1, "z-10", "flex", "flex-1", "items-center", "space-x-2", "px-2", "text-left"], [1, "flex", "h-full", "w-full", "flex-col", "justify-center", "leading-none"], [1, "text-xs", "opacity-30"], [3, "matTooltip"], [1, "bg-info", "absolute", "inset-0", "z-0", "m-0!", "opacity-10"], [1, "px-2"], [1, "pointer-events-none", 3, "ngModel"], ["toggle", "", 1, "border-base-400", "relative", "h-8", "w-12", "rounded-full", "border-2"], [1, "absolute", "top-1/2", "flex", "h-6", "w-6", "-translate-x-0.5", "-translate-y-1/2", "items-center", "justify-center", "rounded-full", "text-black", "shadow-sm"], [1, "pointer-events-none", 3, "ngModelChange", "ngModel"]], template: function SettingsToggleComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275projectionDef();
...
var MatSliderVisualThumb = class _MatSliderVisualThumb {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    viewQuery: function MatSliderVisualThumb_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(MatRipple, 5)(_c04, 5)(_c13, 5);
      }
      if (rf & 2) {
        let _t;
...
var MatSlider = class _MatSlider {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    viewQuery: function MatSlider_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c22, 5)(MAT_SLIDER_VISUAL_THUMB, 5);
      }
      if (rf & 2) {
        let _t;
...
_SelectMeetingModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SelectMeetingModalComponent, selectors: [["select-meeting-modal"]], decls: 23, vars: 14, consts: [[1, "bg-base-100", "fixed", "inset-0"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "top-2", "right-2"], [1, "mx-auto", "w-160", "max-w-full", "p-2"], [1, "my-4", "w-full", "text-center", "text-2xl", "font-medium"], [1, "w-full"], ["for", "calendar"], ["appearance", "outline", 1, "w-full"], [3, "ngModelChange", "ngModel"], [3, "value"], [1, "my-4", "w-full", "font-medium"], [1, "flex", "h-32", "w-full", "items-center", "justify-center", "opacity-40"], [1, "space-y-2", "overflow-auto"], ["btn", "", "matRipple", "", 1, "border-base-200", "flex", "w-full", "items-center", "rounded-sm", "border", "p-4"], ["btn", "", "matRipple", "", 1, "border-base-200", "flex", "w-full", "items-center", "rounded-sm", "border", "p-4", 3, "click"], [1, "w-1/2", "flex-1", "truncate", "text-left"], [1, "text-sm", "opacity-60"], [3, "diameter"]], template: function SelectMeetingModalComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(20, 9, "APP.CONTROL.MEETING_COUNT", \u0275\u0275pureFunction1(12, _c05, ((_a = ctx.events()) == null ? void 0 : _a.length) || "0")), " ");
    \u0275\u0275advance(2);
...
function SourceSelectComponent_Conditional_5_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 1, "APP.CONTROL.SOURCE_INPUTS_EMPTY", \u0275\u0275pureFunction1(4, _c06, (source_r5 == null ? void 0 : source_r5.name) || "Unknown")), " ");
  }
}
...
_JoystickComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JoystickComponent, selectors: [["joystick"]], viewQuery: function JoystickComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._panning_el, _c07, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance();
  }
...
function LightingTooltipComponent_Conditional_5_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("sys", ctx_r1.id)("params", \u0275\u0275pureFunction2(5, _c08, ctx_r1.lights()[0], state_r3));
    \u0275\u0275advance();
...
function MicrophoneTooltipComponent_Conditional_4_For_3_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("sys", ctx_r4.id)("mod", mic_r10.module_id)("bind", mic_r10.level_feedback)("ignore", ctx_r4.changing())("params", \u0275\u0275pureFunction2(11, _c09, mic_r10.level_id, ctx_r4.volume[\u0275$index_43_r11]));
    \u0275\u0275twoWayProperty("model", ctx_r4.volume[\u0275$index_43_r11]);
    \u0275\u0275advance();
    \u0275\u0275property("sys", ctx_r4.id)("mod", mic_r10.module_id)("bind", mic_r10.mute_feedback)("params", \u0275\u0275pureFunction2(14, _c09, mic_r10.mute_id, ctx_r4.mute[\u0275$index_43_r11]));
...
var _c010 = (a0) => ["/panel", a0, "call"];
var _c14 = (a0) => ["/panel", a0];
var _c23 = () => ({ exact: true });
...
function VideoConferenceTooltipComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(12, _c010, ctx_r1.id));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 8, "APP.CONTROL.VC_VIEW_CALL"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(14, _c14, ctx_r1.id))("routerLinkActiveOptions", \u0275\u0275pureFunction0(16, _c23));
    \u0275\u0275advance();
...
//# sourceMappingURL=chunk-XNRMOYPT.js.map
