...
import {
  ...
  setMinutes,
  validate
} from "./chunk-MFQYYDCF.js";
import {
  MatTooltip,
  MatTooltipModule
} from "./chunk-GYIWQCRI.js";
import {
  SanitizePipe
} from "./chunk-QMLLGESS.js";
import {
  TranslatePipe
} from "./chunk-RBH6SCKM.js";
import {
  A11yModule,
...
var ExploreBookQrComponent = class _ExploreBookQrComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExploreBookQrComponent, selectors: [["explore-book-qr"]], decls: 10, vars: 7, consts: [[1, "truncate"], [1, "flex-1"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "p-4"], [1, "m-auto", "h-64", "w-64", 3, "src"]], template: function ExploreBookQrComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 2, "EXPLORE.BOOK_RESOURCE", \u0275\u0275pureFunction1(5, _c06, ctx.space()?.name)), " ");
        \u0275\u0275advance(7);
...
function ExploreSpaceInfoComponent_ng_template_2_Conditional_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(5, 1, "COMMON.PEOPLE_COUNT", \u0275\u0275pureFunction1(5, _c07, ctx_r0.space().capacity), ctx_r0.space().capacity), " ");
  }
}
...
function buildBookingExtensionData(value, group_members) {
  ...
  return __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadProps(__spreadValues(__spreadValues({}, formExtensionData(value.extension_data)), value.extension_data?.invoice ? {
    ...
    user_groups: [
      ...value.user && value.user.email !== currentUser()?.email ? value.user.groups || [] : currentUser()?.groups || []
    ]
...
var BookingFormService = class _BookingFormService extends AsyncHandler {
  ...
  async _computeAvailableResources(options, resources, restrictions, raw) {
    ...
    const zones = options.zone_id || (this._settings.get("app.use_region") ? this._org.region?.id : this._org.building?.id) || this._org.organisation.id;
    let booked_ids = [];
    if (!Rn()) {
  ...
  async postForm(ignore_check = false, reset_form = true) {
    ...
    if (ignore_check) {
      await this._checkAssignedResourceRestriction(host, this._options().type);
    } else {
  ...
  _visitorMemberPatch(member, base_form, opts) {
    ...
    return __spreadProps(__spreadValues({}, base_form), {
      ...
      phone: member.phone,
      zones: base_form.zones?.length ? [...base_form.zones] : opts.existing_zones?.length ? [...opts.existing_zones] : [...this._booking()?.zones || []],
      assets: [],
      attendees: [
        new User({
          name: member_name,
  ...
  _bookingRulesHost(user) {
    const current_user2 = currentUser();
    if (this._useCurrentUserForBookingRules() || !user || user.email === current_user2.email) {
      return current_user2;
    }
    return user;
  }
...
//# debugId=9eaf443a-a71d-564b-b883-efc806c4c00d
//# sourceMappingURL=chunk-STJ2VUEI.js.map
