...
} from "./chunk-AHBSTIYR.js";
import {
  FindAvailabilityModalComponent,
  RecurrenceFieldComponent
} from "./chunk-KBMER6VP.js";
import "./chunk-AIXJ3II5.js";
import {
    ...
    this.available_items = computed(
      () => {
        ...
        if (resources.length > 0 && (this.promote_selected() || this._promote_on_list_change())) {
          ...
          const selected_resources = resources.map((resource2) => available.find((item) => item.id === resource2.id) || resource2);
...
var DeskFlowSelectMapComponent = class _DeskFlowSelectMapComponent extends AsyncHandler {
  constructor() {
    ...
    this._show_users = this._settings.signal("desks.show_users", true);
      ...
      () => this.resource_list().map((space) => {
        ...
        return {
          ...
          data: {
            ...
            user: computed(() => this._booked_users()[space.id]?.join(", ") || ""),
    ...
    this._booking_query = computed(
      () => {
        const zone = this.level()?.id;
        const form = this.form_value();
        if (!this._show_users() || !zone || !(form?.date > 0))
          return;
      ...
      ...ngDevMode ? [{ debugName: "_booking_query" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this._booking_query_debounced = debounced(this._booking_query, 500, {
      equal: (a, b) => a?.zone === b?.zone && a?.start === b?.start && a?.end === b?.end
    });
    this._level_bookings = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_level_bookings" } : (
      /* istanbul ignore next */
      {}
    )), {
      params: () => this._booking_query_debounced.value(),
      loader: ({ params: { zone, start, end } }) => queryAllBookings({
        type: "desk",
        zones: zone,
    ...
    this._booked_users = computed(
      () => {
        const users = {};
        const bookings = this._level_bookings.value() ?? [];
        for (const booking of bookings) {
          ...
          for (const id of booking.asset_ids) {
            users[id] ??= [];
            if (!users[id].includes(name))
              users[id].push(name);
          }
        }
        return users;
      },
      ...ngDevMode ? [{ debugName: "_booked_users" }] : (
        /* istanbul ignore next */
        []
      )
    );
    ...
    this.levels = computed(
      () => {
        ...
        const level_ids = new Set(resources.filter((resource2) => resource2.bookable !== false).map((resource2) => resource2.zone?.id).filter((_) => _));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskFlowSelectMapComponent, { className: "DeskFlowSelectMapComponent", filePath: "apps/workplace/src/app/book/desk-flow-new/desk-flow-select-map.component.ts", lineNumber: 153 });
})();
...
var DeskFlowSelectComponent = class _DeskFlowSelectComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    this.subscription("clear_selected_desk_on_building_change", this._effect(() => {
      ...
      const selected_for_building = !!selected_resources.length && selected_resources.every((resource2) => resource2.zone?.parent_id === bld?.id);
  ...
  setMapView() {
    ...
    const level_ids = new Set(this.bookable_resources().filter((resource2) => resource2.bookable !== false).map((resource2) => resource2.zone?.id).filter((_) => _));
...
var _c05 = () => ["/"];
var _c14 = (a0) => ({ name: a0 });
var _c2 = (a0, a1, a2, a3, a4, a5) => ({ date: a0, time: a1, size: a2, booked: a3, failed: a4, location: a5 });
...
function NewDeskFlowSuccessComponent_Conditional_4_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(1, 1, "BOOKINGS.DESK_GROUP_RESULTS_ERROR"), " ");
  }
}
function NewDeskFlowSuccessComponent_Conditional_4_Conditional_6_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, "BOOKINGS.DESK_SUCCESS_GROUP_PARTIAL", details_r2), " ");
  }
}
...
function NewDeskFlowSuccessComponent_Conditional_4_Conditional_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function NewDeskFlowSuccessComponent_Conditional_4_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, NewDeskFlowSuccessComponent_Conditional_4_Conditional_6_Conditional_0_Template, 2, 4)(1, NewDeskFlowSuccessComponent_Conditional_4_Conditional_6_Conditional_1_Template, 2, 4)(2, NewDeskFlowSuccessComponent_Conditional_4_Conditional_6_Conditional_2_Template, 2, 4);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(ctx_r0.group_failures().length ? 0 : ctx_r0.last_event()?.all_day ? 1 : 2);
  }
}
function NewDeskFlowSuccessComponent_Conditional_4_Conditional_7_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function NewDeskFlowSuccessComponent_Conditional_4_Conditional_7_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function NewDeskFlowSuccessComponent_Conditional_4_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, NewDeskFlowSuccessComponent_Conditional_4_Conditional_7_Conditional_0_Template, 2, 4)(1, NewDeskFlowSuccessComponent_Conditional_4_Conditional_7_Conditional_1_Template, 2, 4);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function NewDeskFlowSuccessComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "date");
    \u0275\u0275pipe(4, "date");
    \u0275\u0275conditionalCreate(5, NewDeskFlowSuccessComponent_Conditional_4_Conditional_5_Template, 2, 3)(6, NewDeskFlowSuccessComponent_Conditional_4_Conditional_6_Template, 3, 1)(7, NewDeskFlowSuccessComponent_Conditional_4_Conditional_7_Template, 2, 1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275storeLet(\u0275\u0275pureFunction6(11, _c2, \u0275\u0275pipeBind2(2, 1, ctx_r0.last_event()?.date || 0, "mediumDate"), \u0275\u0275pipeBind2(3, 4, ctx_r0.last_event()?.date || 0, ctx_r0.time_format) + " - " + \u0275\u0275pipeBind2(4, 7, ctx_r0.last_event().date + ctx_r0.last_event().duration * 60 * 1e3, ctx_r0.time_format), ctx_r0.group_size(), ctx_r0.group_bookings().length, ctx_r0.group_failures().length, ctx_r0.location()));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r0.is_group() && ctx_r0.group_load_error() ? 5 : ctx_r0.is_group() ? 6 : 7);
  }
}
...
var NewDeskFlowSuccessComponent = class _NewDeskFlowSuccessComponent {
  constructor() {
    ...
    this.group_loading = signal(
      true,
      ...ngDevMode ? [{ debugName: "group_loading" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this.group_load_error = signal(
      false,
      ...ngDevMode ? [{ debugName: "group_load_error" }] : (
        /* istanbul ignore next */
        []
      )
    );
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeskFlowSuccessComponent, selectors: [["desk-flow-success"]], features: [\u0275\u0275ProvidersFeature([LevelPipe, BuildingPipe])], decls: 15, vars: 13, consts: [[1, "bg-base-100", "absolute", "inset-0", "z-50", "flex", "flex-col", "overflow-auto"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "text-center", "text-2xl", "font-medium"], ["src", "assets/icons/success.svg"], [1, "max-w-160", "text-center"], [1, "bg-base-200", "flex", "items-center", "space-x-2", "rounded-lg", "px-4", "py-2"], [1, "text-sm"], [1, "border-base-300", "bg-base-100", "mt-4", "w-full", "max-w-lg", "rounded-lg", "border", "p-4"], ["assets", ""], [1, "relative", "flex", "flex-col", "items-center", "space-y-4", "p-4"], [1, "border-base-200", "bg-base-100", "sticky", "bottom-0", "mt-4", "flex", "w-full", "items-center", "justify-center", "border-t", "p-2"], ["btn", "", "name", "desk-confirm-continue", "matRipple", "", 1, "mx-auto", "w-full", "max-w-lg", 3, "routerLink"], [1, "text-xl"], [1, "mb-3", "flex", "items-center", "space-x-2", "font-medium"], [1, "flex", "flex-col", "space-y-2"], [1, "bg-base-200/50", "border-base-200", "flex", "items-center", "space-x-3", "rounded", "border", "p-2", 3, "border-error"], [1, "bg-base-200/50", "border-base-200", "flex", "items-center", "space-x-3", "rounded", "border", "p-2"], [3, "user"], [1, "flex", "flex-1", "flex-col"], [1, "font-medium"], [1, "text-sm", "opacity-60"], [1, "text-error", "text-xs"], [1, "text-error", "text-2xl"], [1, "text-success", "text-2xl"], ["btn", "", "matRipple", "", "name", "desk-outlook-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded-sm", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/outlook.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-google-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded-sm", "p-2", "pr-4", 3, "href"], ["src", "assets/icons/gcal.svg", 1, "w-6"], ["btn", "", "matRipple", "", "name", "desk-ical-link", "target", "_blank", "rel", "noopener noreferer", 1, "inverse", "flex", "w-64", "items-center", "space-x-2", "rounded-sm", "p-2", "pr-4", 3, "href"]], template: function NewDeskFlowSuccessComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(3, "img", 3);
        \u0275\u0275conditionalCreate(4, NewDeskFlowSuccessComponent_Conditional_4_Template, 8, 18, "p", 4);
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.last_event() && (!ctx.is_group() || !ctx.group_loading()) ? 4 : -1);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NewDeskFlowSuccessComponent, { className: "NewDeskFlowSuccessComponent", filePath: "apps/workplace/src/app/book/desk-flow-new/desk-flow-success.component.ts", lineNumber: 292 });
})();
...
var DeskFlowNewComponent = class _DeskFlowNewComponent extends AsyncHandler {
  ...
  ngOnInit() {
    ...
    this.subscription("route.query", this._route.queryParamMap.subscribe(async (params) => {
      ...
      if (!asset_id)
        return;
      const resource2 = await this._findDeskResource(asset_id);
      if (!resource2)
        return;
      const building = resource2.zone?.parent_id ? this._org.find(resource2.zone.parent_id) : null;
      if (building && building.id !== this._org.building?.id) {
        this._org.building = building;
      }
      this._booking_form.setOptions(__spreadValues({
        type: "desk"
      }, resource2.zone?.id ? { zones: [resource2.zone.id] } : {}));
      this._booking_form.model.update((m) => __spreadProps(__spreadValues({}, m), {
        booking_type: "desk",
        resources: [resource2],
  ...
  async _findDeskResource(asset_id) {
    const resource2 = await this._findDeskResourceFromStream(asset_id, 50);
    if (resource2)
      return resource2;
  ...
  async _findDeskResourceFromStream(asset_id, wait_ms) {
    ...
    do {
      ...
      const resource2 = resources.find((item) => item.id === asset_id);
      if (resource2)
        return resource2;
  ...
  async _findDeskResourceFromBuildings(asset_id) {
    for (const building of this._org.buildings || []) {
      const data = await ac(building.id, {
        name: "desks"
      }).catch(() => []);
  ...
  async _initNearbyDeskBooking(space_id, event_date) {
    ...
    const resource2 = resources.find((_) => _.map_id === nearby || _.id === nearby);
    if (!resource2)
      return notifyError(i18n("APP.WORKPLACE.MEETING_DESK_ERROR"));
    this._booking_form.model.update((m) => __spreadProps(__spreadValues({}, m), {
      date: set(event_date, { hours: 8, minutes: 0 }).valueOf(),
...
//# debugId=81d4e71f-0843-5be9-b511-1c785d4b530d
//# sourceMappingURL=desk-flow.component-WJDEP3XM.js.map
