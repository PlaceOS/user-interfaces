import {
  queryCateringItems
} from "./chunk-H22CELVS.js";
import {
  HostSelectFieldComponent
} from "./chunk-P3UG37GC.js";
import {
  SpacesService
} from "./chunk-QMRBOH6E.js";
import {
...
} from "./chunk-UQFUT4CK.js";
import {
  BuildingPipe
} from "./chunk-LCO6ZZSS.js";
import {
  startOfMonth
} from "./chunk-IMRNGO2R.js";
import {
...
import {
  subMinutes
} from "./chunk-PDNNCWF3.js";
import {
  setHours
} from "./chunk-6AFPLT5W.js";
import {
...
function SpaceMapComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(5, _c12))("placeholder", \u0275\u0275pipeBind1(3, 3, "CALENDAR_EVENT.SPACE_LEVEL_ANY"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.levels());
  }
...
var SpaceSelectModalComponent = class _SpaceSelectModalComponent {
  ...
  toggleFavourite(item) {
    ...
    const updated = new_state ? [...fav_list, item.id] : fav_list.filter((_) => _ !== item.id);
...
var _c010 = (a0, a1, a2, a3) => ({ date: a0, duration: a1, all_day: a2, zone_id: a3 });
...
function EventBookModalComponent_Conditional_17_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 5, "CALENDAR_EVENT.ATTENDEES"), " ");
    \u0275\u0275advance(5);
...
function EventBookModalComponent_Conditional_32_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 18)(1, "mat-select", 20);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementStart(3, "input", 21, 0);
    \u0275\u0275pipe(5, "translate");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275element(6, "mat-option", 22);
    \u0275\u0275repeaterCreate(7, EventBookModalComponent_Conditional_32_Conditional_13_For_8_Template, 2, 2, "mat-option", 23, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementStart(9, "mat-error");
    \u0275\u0275text(10);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(12, _c15))("placeholder", \u0275\u0275pipeBind1(5, 8, "CALENDAR_EVENT.CATERING_CHARGE_CODE_SEARCH"));
    \u0275\u0275control();
    \u0275\u0275advance(4);
...
function EventBookModalComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 8);
    \u0275\u0275element(12, "catering-list-field", 17);
    \u0275\u0275controlCreate();
    \u0275\u0275conditionalCreate(13, EventBookModalComponent_Conditional_32_Conditional_13_Template, 12, 13, "mat-form-field", 18);
    \u0275\u0275conditionalCreate(14, EventBookModalComponent_Conditional_32_Conditional_14_Template, 6, 9, "mat-form-field", 19);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("formField", ctx_r1.form.catering)("options", \u0275\u0275pureFunction4(9, _c010, ctx_r1.model().date, ctx_r1.model().duration, ctx_r1.model().all_day, ctx_r1.model()?.resources?.length ? ctx_r1.model()?.resources[0]?.level?.parent_id : ""));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function EventBookModalComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 8);
    \u0275\u0275element(12, "asset-list-field", 27);
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("options", \u0275\u0275pureFunction4(8, _c010, ctx_r1.model().date, ctx_r1.model().duration, ctx_r1.model().all_day, ctx_r1.model()?.resources?.length ? ctx_r1.model()?.resources[0]?.level?.parent_id : ""))("formField", ctx_r1.form.assets);
    \u0275\u0275control();
  }
}
function EventBookModalComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 2)(1, "h3", 28)(2, "div", 4);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 5);
    \u0275\u0275text(5);
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "rich-text-input", 20);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd()();
  }
...
var EventBookModalComponent = class _EventBookModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventBookModalComponent, selectors: [["event-book-modal"]], outputs: { event: "event" }, decls: 35, vars: 24, consts: [["input", ""], [3, "confirm", "heading", "loading"], [1, "p-2"], [1, "flex", "items-center", "space-x-2"], [1, "bg-base-200", "flex", "h-6", "w-6", "items-center", "justify-center", "rounded-full"], [1, "text-xl"], [1, "w-px", "flex-1"], ["type", "button", "icon", "", "name", "toggle-details-meeting", "matRipple", "", 3, "click"], [1, "overflow-hidden"], [1, "mt-4", 3, "form"], ["type", "button", "icon", "", "name", "toggle-spaces-meeting", "matRipple", "", 3, "click"], [1, "flex", "flex-col", "items-center", "overflow-hidden"], [1, "bg-warning", "text-warning-content", "mx-auto", "my-2", "inline-flex", "rounded-sm", "p-2", "text-xs", "shadow-sm"], [1, "w-full", 3, "formField", "multiday"], ["type", "button", "icon", "", "name", "toggle-attendees-meeting", "matRipple", "", 3, "click"], [1, "mt-4", 3, "formField", "guests"], ["type", "button", "icon", "", "name", "toggle-catering-meeting", "matRipple", "", 3, "click"], [3, "formField", "options"], ["appearance", "outline", 1, "mt-2", "w-full"], ["appearance", "outline", 1, "w-full", 3, "mt-2"], [3, "formField", "placeholder"], [1, "border-base-200", "bg-base-100", "sticky", "top-0", "z-50", "w-full", "rounded-none", "border-x-0", "border-t-0", "border-b", "px-4", "py-3", "text-base", "focus:border-b", 3, "ngModelChange", "ngModel", "ngModelOptions", "placeholder"], [1, "hidden"], [3, "value"], ["appearance", "outline", 1, "w-full"], ["matInput", "", 3, "formField", "placeholder"], ["type", "button", "icon", "", "name", "toggle-assets-meeting", "matRipple", "", 3, "click"], [3, "options", "formField"], [1, "mb-4", "flex", "items-center", "space-x-2"], [1, "flex", "w-full", "flex-col"], ["for", "notes"]], template: function EventBookModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(17, EventBookModalComponent_Conditional_17_Template, 13, 7, "section", 2);
...
//# sourceMappingURL=chunk-VUOCBG6O.js.map
