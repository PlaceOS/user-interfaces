...
} from "./chunk-25TPSERJ.js";
import {
  searchStaff
} from "./chunk-BFQON5IW.js";
import {
  FormField,
  MatError,
  MatFormField,
...
var ChangelogService = class _ChangelogService {
  constructor() {
  ...
  static {
    this.\u0275fac = function ChangelogService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ChangelogService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ChangelogService, factory: _ChangelogService.\u0275fac, providedIn: "root" });
  }
};
(() => {
...
var WFHSettingsModalComponent = class _WFHSettingsModalComponent {
  ...
  async saveChanges(close = true) {
    ...
    if (!this._data?.local) {
      try {
        const user = await Za("current");
        await Va(user.id, __spreadProps(__spreadValues({}, user), {
...
function UserControlsComponent_Conditional_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("disabled", !ctx_r2.changelog_available());
    \u0275\u0275advance();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserControlsComponent, selectors: [["user-controls"]], inputs: { sidebar: [1, "sidebar"] }, decls: 35, vars: 32, consts: [["desk_height_tooltip", ""], ["work_menu", "matMenu"], [1, "divide-base-200", "border-base-300", "bg-base-100", "relative", "mt-1", "flex", "flex-col", "divide-y", "overflow-auto", "rounded-sm", "border", "shadow-sm"], ["avatar", "", 1, "flex", "w-full", "min-w-72", "flex-col", "items-center", "p-2"], [1, "text-2xl", 3, "user", "matTooltip"], [1, ""], [1, "truncate", "text-xs", "opacity-60"], [1, "border-base-200", "w-full", "rounded-sm", "border-y", "py-2"], ["customTooltip", "", 1, "relative", 3, "content"], ["customTooltip", "", 3, "content"], ["customTooltip", "", 3, "content", "border-b!"], ["customTooltip", "", 1, "border-b!", 3, "content"], ["btn", "", "matRipple", "", 1, "clear", "h-14", "w-full", "text-left"], [1, "flex", "flex-col", "items-center", "p-4"], [1, "mb-4", "flex", "items-center", "justify-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "inverse", 3, "click"], ["btn", "", "matRipple", ""], [1, "w-full", "text-xs", "opacity-60"], [1, "m-0", "border-none", "bg-none", "p-0", "text-xs", "underline", 3, "disabled"], [1, "w-full", "px-4", "pb-2", "text-sm", "font-medium"], [1, "w-full"], [1, "relative", "flex", "items-center", "px-4", "py-2"], [1, "bg-info", "text-info-content", "z-20", "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full"], [1, "text-2xl"], [1, "ml-2", "flex-1"], ["matRipple", "", 1, "hover:bg-base-200", "flex", "items-center", "space-x-2", "rounded-sm", "px-2", "py-1", "font-medium", 3, "matMenuTriggerFor"], ["mat-menu-item", ""], [1, "px-2", "text-xs", "opacity-60"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-8"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "bg-base-200", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full"], [1, "w-px", "flex-1", "truncate"], [1, "text-2xl", "opacity-60"], [1, "flex-1"], [1, "flex", "flex-1", "items-center", "justify-between", "space-x-4"], [1, "text-xs", "opacity-30"], [1, "bg-base-200", "max-w-24", "truncate", "rounded-sm", "px-2", "py-1", "text-sm", 3, "matTooltip"], ["btn", "", "matRipple", "", 1, "clear", "h-14", "w-full", "text-left", 3, "click"], ["btn", "", "matRipple", "", 3, "click"], [1, "m-0", "border-none", "bg-none", "p-0", "text-xs", "underline", 3, "click", "disabled"]], template: function UserControlsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(28, "translate");
        \u0275\u0275elementContainerEnd();
        \u0275\u0275conditionalCreate(29, UserControlsComponent_Conditional_29_Template, 2, 2, "button", 18)(30, UserControlsComponent_Conditional_30_Template, 2, 1, "span");
        \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserControlsComponent, { className: "UserControlsComponent", filePath: "libs/components/src/lib/user-controls.component.ts", lineNumber: 405 });
})();
...
//# debugId=187735ed-e524-52ea-bd82-4937bc2a7790
//# sourceMappingURL=chunk-W5XMAXTR.js.map
