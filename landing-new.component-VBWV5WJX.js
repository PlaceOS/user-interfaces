import {
  ...
  canEditBooking
} from "./chunk-5QWYYAAR.js";
import {
  GroupEventDetailsModalComponent,
  MapLocateModalComponent
} from "./chunk-FAMG2PMV.js";
import {
  AddColleaguesModalComponent,
  TeamScheduleService
} from "./chunk-G3HPXW42.js";
import "./chunk-YMATF2QX.js";
import {
  LandingStateService
} from "./chunk-JLVLMSRX.js";
import {
  VirtualConciergeButtonComponent
} from "./chunk-Z75I4SF3.js";
import "./chunk-PONEUNE7.js";
import {
  AutoAssignedDeskModalComponent
} from "./chunk-REPZRREX.js";
import {
  BuildingPipe
} from "./chunk-SZCHKURA.js";
import "./chunk-XI6H3QZW.js";
import {
  toObservable,
  toSignal
} from "./chunk-RTP3X7FE.js";
import {
  LevelPipe
} from "./chunk-POYPKYMP.js";
import {
  ExploreSpacesService
} from "./chunk-U46N6UFF.js";
import "./chunk-XGQ2OJWX.js";
import "./chunk-5ZNCAA2T.js";
import "./chunk-EY3MGQHV.js";
import {
  FooterMenuComponent,
  ScheduleStateService,
  TopbarComponent
} from "./chunk-CEMESOXQ.js";
import "./chunk-4IZ7PBC2.js";
import "./chunk-3X5MUU44.js";
import "./chunk-KJM2FUA6.js";
import "./chunk-TGMMXDFA.js";
import "./chunk-UYWA6U56.js";
import "./chunk-FZRCMD7B.js";
import {
  MatMenu,
  MatMenuItem,
  MatMenuModule,
  MatMenuTrigger
} from "./chunk-5FCNWHZJ.js";
import {
  AuthenticatedImageDirective,
  MatCheckbox,
  MatCheckboxModule,
  UserAvatarComponent
} from "./chunk-3B2MSINU.js";
import {
  MatTooltip,
  MatTooltipModule
} from "./chunk-QCCM4QOG.js";
import {
  EventFormService,
  SpacePipe
} from "./chunk-PNQQIMV3.js";
import "./chunk-FHHHDDQ7.js";
import "./chunk-Y46ITBXA.js";
import {
  BookingFormService
} from "./chunk-SYYGT2WV.js";
import {
  MatProgressSpinner,
...
function LandingUpcomingBookingComponent_Conditional_0_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingUpcomingBookingComponent_Conditional_0_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "icon", 11);
    \u0275\u0275text(2, "people");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div");
    \u0275\u0275text(4);
...
function LandingUpcomingBookingComponent_Conditional_0_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 24);
    \u0275\u0275listener("click", function LandingUpcomingBookingComponent_Conditional_0_Conditional_23_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 9, ctx_r2.isCheckedIn() ? "COMMON.CHECKED_IN" : "COMMON.CHECK_IN"), " ");
  }
}
function LandingUpcomingBookingComponent_Conditional_0_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
...
function LandingUpcomingBookingComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 10)(15, "icon", 11);
    \u0275\u0275text(16, "event");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div");
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(19, LandingUpcomingBookingComponent_Conditional_0_Conditional_19_Template, 5, 1, "div", 10);
    \u0275\u0275conditionalCreate(20, LandingUpcomingBookingComponent_Conditional_0_Conditional_20_Template, 5, 1, "div", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 13)(22, "div", 14);
    \u0275\u0275conditionalCreate(23, LandingUpcomingBookingComponent_Conditional_0_Conditional_23_Template, 6, 11, "button", 15);
    ...
    \u0275\u0275text(26, "edit");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(27, LandingUpcomingBookingComponent_Conditional_0_Conditional_27_Template, 3, 3, "div", 18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 14)(29, "button", 19);
    ...
    \u0275\u0275text(36, "delete");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "a", 21)(38, "icon", 17);
    \u0275\u0275text(39, "open_in_new");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 19, "CALENDAR_EVENT.GROUP_FEATURED"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.eventLocation() ? 19 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_8_0 = ctx_r2.attendeeCount()) ? 20 : -1, tmp_8_0);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r2.showCheckin() ? 23 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("w-12", ctx_r2.showCheckin())("flex-1", !ctx_r2.showCheckin())("space-x-2", !ctx_r2.showCheckin());
    \u0275\u0275property("disabled", !ctx_r2.canEdit());
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx_r2.showCheckin() ? 27 : -1);
    \u0275\u0275advance(7);
    \u0275\u0275property("disabled", ctx_r2.deleteDisabled());
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(23, _c05));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(42, 21, "APP.WORKPLACE.UPCOMING_VIEW_BOOKINGS"), " ");
  }
}
...
var LandingUpcomingBookingComponent = class _LandingUpcomingBookingComponent extends AsyncHandler {
  constructor() {
    ...
    this.showCheckin = computed(
      () => {
        const event = this.nextEvent();
        return !(event instanceof Booking && event.booking_type === "parking" && event.asset_id.startsWith("unallocated"));
      },
      ...ngDevMode ? [{ debugName: "showCheckin" }] : (
        /* istanbul ignore next */
        []
      )
    );
    this.canCheckin = computed(
      () => {
        ...
        return this.showCheckin() && can_checkin && (event instanceof Booking || event?.extension_data?.shared_event || this.room_status() && this.room_status() !== "free") && (event.state === "upcoming" || event.state === "started" || event.state === "in_progress") && event.status !== "declined";
      },
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LandingUpcomingBookingComponent, selectors: [["landing-upcoming-booking"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [[1, "bg-grad", "border-base-300", "text-brand-content", "col-span-2", "space-y-2", "rounded-lg", "border", "p-4"], [1, "bg-grad", "border-base-300", "text-brand-content", "col-span-2", "flex", "min-h-48", "flex-col", "items-start", "justify-center", "space-y-2", "rounded-lg", "border", "p-4"], [1, "flex", "w-full", "items-center", "justify-between"], [1, "relative", "overflow-hidden", "rounded", "px-2", "py-1", "text-sm", "capitalize"], [1, "bg-brand-content", "absolute", "inset-0", "opacity-20"], [1, "flex", "w-48", "items-center", "space-x-2", "px-2", "text-center"], [1, "flex", "min-w-48", "items-center", "space-x-2", "px-2", "text-center"], [1, "flex", "w-full", "flex-col", "items-center", "justify-between", "space-y-2", "sm:flex-row", "sm:space-y-0"], [1, "w-full", "sm:flex-1"], [1, "text-2xl", "font-medium"], [1, "mb-1", "flex", "items-center", "space-x-2"], [1, "text-xl"], [1, "flex", "items-center", "space-x-2"], [1, "flex", "w-full", "flex-col", "items-end", "space-y-2", "sm:flex-1"], [1, "flex", "w-full", "items-center", "space-x-2", "sm:w-56"], ["btn", "", "matRipple", "", 1, "flex-1", "space-x-2", 3, "disabled", "white", "bg-success", "text-success-content"], ["btn", "", "matRiple", "", "matTooltip", "Edit Booking", "matTooltipPosition", "left", 1, "white", "inverse", "h-12", "px-0", 3, "click", "disabled"], [1, "text-2xl"], [1, "pr-2"], ["btn", "", "matRipple", "", 1, "inverse", "white", "flex", "flex-1", "space-x-2", 3, "click"], ["btn", "", "matRiple", "", "matTooltip", "Delete Booking", "matTooltipPosition", "left", 1, "white", "inverse", "h-12", "w-12", "px-0", 3, "click", "disabled"], ["btn", "", "matRipple", "", 1, "inverse", "white", "w-full", "space-x-2", "sm:w-56", 3, "routerLink"], ["binding", "", "mod", "Bookings", "bind", "status", 1, "hidden", 3, "modelChange", "model", "sys"], ["binding", "", "mod", "Bookings", "bind", "last_booking_started", 1, "hidden", 3, "modelChange", "model", "sys"], ["btn", "", "matRipple", "", 1, "flex-1", "space-x-2", 3, "click", "disabled"], [1, "relative", "overflow-hidden", "rounded", "px-2", "py-1", "text-sm"], [1, "capitalize"], [1, "text-3xl", "font-medium"], [1, "text-base", "opacity-90"], [1, "flex", "w-full", "flex-wrap", "gap-3", "pt-2"], [1, "flex", "w-full", "flex-wrap", "gap-3", "sm:w-auto"], ["btn", "", "matRipple", "", 1, "white", "min-w-48", "flex-1", "space-x-2", "sm:w-48", "sm:flex-0", 3, "routerLink"], ["btn", "", "matRipple", "", 1, "inverse", "white", "min-w-48", "flex-1", "space-x-2", "sm:w-48", "sm:flex-0", 3, "routerLink"], [1, "hidden", "w-px", "flex-1", "sm:block"], ["btn", "", "matRipple", "", 1, "inverse", "white", "w-full", "space-x-2", "sm:w-52", 3, "routerLink"]], template: function LandingUpcomingBookingComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, LandingUpcomingBookingComponent_Conditional_0_Template, 43, 24, "div", 0)(1, LandingUpcomingBookingComponent_Conditional_1_Template, 24, 9, "div", 1);
      }
      if (rf & 2) {
        let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LandingUpcomingBookingComponent, { className: "LandingUpcomingBookingComponent", filePath: "apps/workplace/src/app/landing-new/landing-upcoming-booking.component.ts", lineNumber: 287 });
})();
...
//# debugId=4c6aeb68-7daf-5aba-bac8-ad5f66505e8d
//# sourceMappingURL=landing-new.component-VBWV5WJX.js.map
