...
function DisplayEditModalComponent_Conditional_50_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275listener("click", function DisplayEditModalComponent_Conditional_50_For_2_Template_button_click_3_listener() {
...
function DisplayEditModalComponent_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275repeaterCreate(1, DisplayEditModalComponent_Conditional_50_For_2_Template, 7, 7, "div", 19, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DisplayEditModalComponent, selectors: [["display-edit-modal"]], decls: 53, vars: 57, consts: [["confirm_hotkey", "S", 3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "gap-4"], ["for", "name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", 3, "placeholder", "formField"], ["for", "description"], ["matInput", "", 1, "min-h-24", 3, "placeholder", "formField"], ["for", "orientation"], [3, "formField"], ["value", "unspecified"], ["value", "landscape"], ["value", "portrait"], ["value", "square"], [1, "mb-1", "font-medium"], [1, "mb-3", "text-sm", "opacity-70"], [1, "mb-3", "flex", "flex-wrap", "gap-2"], [1, "border-base-300", "h-80", "overflow-auto", "rounded-lg", "border", "p-2"], [3, "selectedChange", "zoneSelected", "list", "roots", "load_children", "scoped_search", "selected"], [1, "bg-base-200", "flex", "items-center", "gap-1", "rounded-full", "py-1", "pr-1", "pl-3", "text-sm"], ["icon", "", "default", "", "type", "button", 1, "rounded-full", 3, "click"]], template: function DisplayEditModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(27, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(28, "mat-form-field", 4)(29, "mat-select", 9);
        \u0275\u0275pipe(30, "translate");
        \u0275\u0275elementStart(31, "mat-option", 10);
        \u0275\u0275text(32);
        \u0275\u0275pipe(33, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(34, "mat-option", 11);
        \u0275\u0275text(35);
        \u0275\u0275pipe(36, "translate");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(43, "section")(44, "h3", 14);
        \u0275\u0275text(45);
        \u0275\u0275pipe(46, "translate");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(49, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(50, DisplayEditModalComponent_Conditional_50_Template, 3, 0, "div", 16);
        \u0275\u0275elementStart(51, "div", 17)(52, "zone-select-tree", 18);
        \u0275\u0275twoWayListener("selectedChange", function DisplayEditModalComponent_Template_zone_select_tree_selectedChange_52_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.selected_zone, $event) || (ctx.selected_zone = $event);
          return $event;
        });
        \u0275\u0275listener("zoneSelected", function DisplayEditModalComponent_Template_zone_select_tree_zoneSelected_52_listener($event) {
          return ctx.addZone($event);
        });
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 25, ctx.display.id ? "SIGNAGE_MANAGER.DISPLAY_EDIT" : "SIGNAGE_MANAGER.NEW_DISPLAY"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 27, "SIGNAGE_MANAGER.DISPLAY_SAVING") : "");
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 29, "FORM.NAME"));
        \u0275\u0275advance(5);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(12, 31, "FORM.NAME"))("formField", ctx.form.name);
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(13, 33, "SIGNAGE_MANAGER.DISPLAY_NAME_ARIA"));
        \u0275\u0275control();
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 35, "FORM.NAME_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(20, 37, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(23, 39, "COMMON.DESCRIPTION"))("formField", ctx.form.description);
        \u0275\u0275control();
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(27, 41, "SIGNAGE_MANAGER.ORIENTATION"));
        \u0275\u0275advance(3);
        \u0275\u0275property("formField", ctx.form.orientation);
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(30, 43, "SIGNAGE_MANAGER.DISPLAY_ORIENTATION_ARIA"));
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 45, "SIGNAGE_MANAGER.ORIENTATION_UNSPECIFIED"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(36, 47, "SIGNAGE_MANAGER.ORIENTATION_LANDSCAPE"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(39, 49, "SIGNAGE_MANAGER.ORIENTATION_PORTRAIT"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 51, "SIGNAGE_MANAGER.ORIENTATION_SQUARE"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(46, 53, "SIGNAGE_MANAGER.DISPLAY_ZONES"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(49, 55, "SIGNAGE_MANAGER.DISPLAY_ZONES_HINT"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.selected_zones().length ? 50 : -1);
        \u0275\u0275advance(2);
...
//# debugId=4929e6d6-0c91-5042-bb8b-031f5c617c8f
//# sourceMappingURL=display-edit-modal.component-UWBUQ47B.js.map
