...
import {
  ...
  MatChipRow,
  MatChipsModule
} from "./chunk-O4NGBP6B.js";
import {
  USER_DOMAIN,
  generateUserForm
} from "./chunk-LDDCI2J5.js";
import {
  MatCheckbox,
  MatCheckboxModule,
  MatTooltip,
...
function UserListFieldComponent_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classProp("text-base-content!", !item_r2.is_external)("text-warning-content!", item_r2.is_external);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(5, 15, "COMMON.REMOVE_ITEM", \u0275\u0275pureFunction1(18, _c2, item_r2.name || item_r2.email)));
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListFieldComponent, selectors: [["a-user-list-field"]], viewQuery: function UserListFieldComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(6, UserListFieldComponent_For_7_Template, 8, 20, "mat-chip-row", 8, _forTrack0);
        \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-AR2XWTE6.js.map
