...
var SearchbarComponent = class _SearchbarComponent {
  constructor() {
    this._internal_model = signal("", ...ngDevMode ? [{ debugName: "_internal_model" }] : (
      /* istanbul ignore next */
      []
    ));
    this.model = input(void 0, ...ngDevMode ? [{ debugName: "model" }] : (
      /* istanbul ignore next */
      []
    ));
    this.value = computed(() => {
...
//# sourceMappingURL=chunk-FZPE2YSK.js.map
