import{Er as vi,Hr as l,Ht as _y,Jn as p$1,Jt as cI,Kt as bc,Ln as me,Lt as Zy,Nt as Z,Q as Pe,Rt as _,Ur as m,V as Lf,an as ee,ct as Re,ft as Sn,ht as Te,j as Ic,m as D,on as et,q as Ny,tt as Q,u as Ar}from"./chunk-DtKoY7OQ.js";import{Cn as Xr,Gi as yE,Gt as Rn,Hr as lr,L as Ff,Ot as Oi,Pt as Qe,Un as cr,Wr as n2,an as Ut,ea as zI,hi as r2,ln as Vf,oi as ps,sn as V2,tr as eo,u as $u,un as Vn,xr as ia}from"./chunk-j9S7_Z9_.js";import{n as Me}from"./chunk-ZpK9-Hg0.js";function at(n,l){}var $=`_mat-bottom-sheet-enter`;var tt=`_mat-bottom-sheet-exit`;var ot=(()=>{class n extends Ff{_breakpointSubscription;_animationsDisabled=Ut();_animationState=`void`;_animationStateChanged=new Pe;_destroyed=!1;constructor(){super();let t=p$1(ia);this._breakpointSubscription=t.observe([yE.Medium,yE.Large,yE.XLarge]).subscribe(()=>{let i=this._elementRef.nativeElement.classList;i.toggle(`mat-bottom-sheet-container-medium`,t.isMatched(yE.Medium)),i.toggle(`mat-bottom-sheet-container-large`,t.isMatched(yE.Large)),i.toggle(`mat-bottom-sheet-container-xlarge`,t.isMatched(yE.XLarge))})}enter(){this._destroyed||(this._animationState=`visible`,this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation($))}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute(`mat-exit`,``),this._animationState=`hidden`,this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(tt))}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=!0}_simulateAnimation(t){this._ngZone.run(()=>{this._handleAnimationEvent(!0,t,this._elementRef.nativeElement),setTimeout(()=>this._handleAnimationEvent(!1,t,this._elementRef.nativeElement))})}_trapFocus(){super._trapFocus({preventScroll:!0})}_handleAnimationEvent(t,i,e){if(e===this._elementRef.nativeElement){let a=i===$;(a||i===tt)&&this._animationStateChanged.emit({toState:a?`visible`:`hidden`,phase:t?`start`:`done`})}}static ɵfac=function(i){return new(i||n)};static ɵcmp=Lf({type:n,selectors:[[`mat-bottom-sheet-container`]],hostAttrs:[`tabindex`,`-1`,1,`mat-bottom-sheet-container`],hostVars:9,hostBindings:function(i,e){i&1&&bc(`animationstart`,function(o){return e._handleAnimationEvent(!0,o.animationName,o.target)})(`animationend`,function(o){return e._handleAnimationEvent(!1,o.animationName,o.target)})(`animationcancel`,function(o){return e._handleAnimationEvent(!1,o.animationName,o.target)}),i&2&&(Ic(`role`,e._config.role)(`aria-modal`,e._config.ariaModal)(`aria-label`,e._config.ariaLabel),Zy(`mat-bottom-sheet-container-animations-enabled`,!e._animationsDisabled)(`mat-bottom-sheet-container-enter`,e._animationState===`visible`)(`mat-bottom-sheet-container-exit`,e._animationState===`hidden`))},features:[_y],decls:1,vars:0,consts:[[`cdkPortalOutlet`,``]],template:function(i,e){i&1&&Ny(0,at,0,0,`ng-template`,0)},dependencies:[cr],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
