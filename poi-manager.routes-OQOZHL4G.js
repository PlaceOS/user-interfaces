...
function ImageFieldComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ImageFieldComponent_Conditional_3_Template_button_click_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.clearImage($event));
    });
...
var ImageFieldComponent = class _ImageFieldComponent extends AsyncHandler {
  ...
  static {
    ...
    ]), \u0275\u0275InheritDefinitionFeature], decls: 5, vars: 1, consts: [["file_input", ""], ["matRipple", "", 1, "bg-base-200", "relative", "h-48", "w-full", "rounded-xl"], ["type", "file", 1, "absolute", "inset-0", "z-10", "cursor-pointer", "opacity-0", 3, "change"], [1, "border-base-300", "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "rounded-xl", "border-2", "border-dashed"], ["auth", "", "alt", "Image", 1, "h-full", "w-full", "object-contain", 3, "source"], ["icon", "", "type", "button", "matRipple", "", "matTooltip", "Clear Image", "matTooltipPosition", "left", 1, "border-base-300", "bg-base-100", "absolute", "top-2", "right-2", "z-20", "rounded-full", "border", 3, "click"], [1, "border-base-300", "bg-base-100", "absolute", "top-1/2", "left-2", "z-20", "-translate-y-1/2", "rounded-full", "border"], ["icon", "", "matRipple", "", "matTooltip", "Copy Image URL", "matTooltipPosition", "right", 3, "click"], [1, "mb-2", "text-lg", "font-medium"], [1, "mb-4", "opacity-60"], ["btn", "", 1, "inverse", "bg-base-100"], [1, "mr-2", "text-2xl"], [1, "pr-2"]], template: function ImageFieldComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ImageFieldComponent, { className: "ImageFieldComponent", filePath: "libs/form-fields/src/lib/image-field.component.ts", lineNumber: 125 });
})();
...
var POIModalComponent = class _POIModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    const old_metadata = await rc(this._org.organisation.id, "points-of-interest");
    ...
    const resp = await oc(this._org.organisation.id, {
...
var POIManagementService = class _POIManagementService {
  ...
  async _loadFeatures() {
    const metadata = await rc(this._org.organisation.id, "points-of-interest").catch((_) => ({ details: {} }));
  ...
  async removePointOfInterest(poi) {
    ...
    await oc(this._org.organisation.id, {
      name: "points-of-interest",
      details: metadata,
      description: ""
    }).catch((e) => {
...
//# debugId=f315ff4f-b568-58f2-bf2c-837b015a3e37
//# sourceMappingURL=poi-manager.routes-OQOZHL4G.js.map
