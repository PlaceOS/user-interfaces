...
_VisitorInductionModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorInductionModalComponent, selectors: [["visitor-induction-modal"]], decls: 12, vars: 5, consts: [[1, "relative", "flex", "w-lg", "flex-col", "items-center", "overflow-hidden", "rounded-sm", "bg-base-100", "p-4", "shadow-sm"], [1, "my-4"], [1, "max-h-[50vh]", "w-full", "overflow-y-auto", "overflow-x-hidden", "whitespace-pre-wrap", "rounded-sm", "border", "border-base-300", "p-4", "text-sm", "opacity-60"], [1, "my-4", 3, "ngModelChange", "ngModel"], [1, "flex", "items-center", "justify-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "clear", "w-32", "underline", 3, "mat-dialog-close"], ["btn", "", "matRipple", "", 1, "w-32", 3, "disabled", "mat-dialog-close"]], template: function VisitorInductionModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_VisitorNotesModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorNotesModalComponent, selectors: [["visitor-notes-modal"]], decls: 10, vars: 7, consts: [[1, "ml-2", "rounded-sm", "bg-base-200", "px-2", "py-1", "text-sm", "font-medium"], ["icon", "", "mat-dialog-close", ""], [1, "max-h-[65vh]", "w-xl", "overflow-auto", "p-4"], ["loading", "", 1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "bg-base-100"], [1, "flex", "justify-end", "space-x-2", "border-t", "border-base-200", "p-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 1, "h-[60vh]", "max-h-256", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function VisitorNotesModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorNotesModalComponent, { className: "VisitorNotesModalComponent", filePath: "apps/concierge/src/app/visitors/visitor-notes-modal.component.ts", lineNumber: 79 });
})();
...
var _c13 = (a0) => ({ time: a0 });
function GuestListingComponent_ng_template_14_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_14_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_14_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, GuestListingComponent_ng_template_14_Conditional_0_Template, 5, 10, "div", 20);
    \u0275\u0275conditionalCreate(1, GuestListingComponent_ng_template_14_Conditional_1_Template, 4, 3, "div", 21);
    \u0275\u0275conditionalCreate(2, GuestListingComponent_ng_template_14_Conditional_2_Template, 5, 10, "div", 22);
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, GuestListingComponent_ng_template_16_Conditional_3_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_18_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function GuestListingComponent_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, GuestListingComponent_ng_template_18_Conditional_3_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_20_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_20_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 27);
    \u0275\u0275element(1, "img", 28);
    \u0275\u0275elementStart(2, "button", 29);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_20_ng_template_2_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r6);
      const row_r5 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_20_ng_template_2_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r6);
      const row_r5 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, GuestListingComponent_ng_template_20_Conditional_1_Template, 2, 1, "button", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275template(2, GuestListingComponent_ng_template_20_ng_template_2_Template, 8, 7, "ng-template", null, 12, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_22_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, GuestListingComponent_ng_template_22_Conditional_0_Template, 3, 0, "div", 31);
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_26_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 33)(1, "button", 34)(2, "div", 35)(3, "div", 36);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, GuestListingComponent_ng_template_26_Conditional_6_Template, 2, 0, "icon", 37);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "mat-menu", null, 13)(9, "button", 38);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_26_Template_button_click_9_listener() {
      const row_r11 = \u0275\u0275restoreView(_r10).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.approveVisitor(row_r11));
    });
    \u0275\u0275elementStart(10, "div", 39)(11, "icon", 37);
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_26_Template_button_click_16_listener() {
      const row_r11 = \u0275\u0275restoreView(_r10).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.declineVisitor(row_r11));
    });
    \u0275\u0275elementStart(17, "div", 39)(18, "icon", 41);
...
function GuestListingComponent_ng_template_28_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function GuestListingComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
    \u0275\u0275conditionalCreate(3, GuestListingComponent_ng_template_28_Conditional_3_Template, 3, 5, "span", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 33);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, GuestListingComponent_ng_template_30_Conditional_2_Template, 2, 0, "span", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function GuestListingComponent_ng_template_32_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 24);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function GuestListingComponent_ng_template_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "async");
    \u0275\u0275pipe(3, "date");
    \u0275\u0275conditionalCreate(4, GuestListingComponent_ng_template_32_Conditional_4_Template, 3, 5, "span", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_14_0;
...
function GuestListingComponent_ng_template_34_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 39)(2, "icon", 37);
...
function GuestListingComponent_ng_template_34_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_34_Conditional_27_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r22);
      const row_r18 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_34_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_34_Conditional_35_Template_button_click_0_listener() {
      ...
      const row_r18 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.pass_number.set(row_r18.extension_data.pass_number));
    });
    \u0275\u0275elementStart(1, "div", 39)(2, "icon", 37);
    \u0275\u0275text(3, "badge");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "mat-menu", null, 15)(9, "div", 49);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_34_Conditional_35_Template_div_click_9_listener($event) {
      \u0275\u0275restoreView(_r23);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(10, "mat-form-field", 50)(11, "input", 51);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function GuestListingComponent_ng_template_34_Conditional_35_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_34_Conditional_35_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r23);
      const row_r18 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
...
function GuestListingComponent_ng_template_34_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r26 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_34_Conditional_37_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r26);
      const row_r18 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function GuestListingComponent_ng_template_34_Conditional_37_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r26);
      const row_r18 = \u0275\u0275nextContext().row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.checkoutAllVisitors(row_r18));
    });
    \u0275\u0275elementStart(8, "div", 39)(9, "icon", 41);
...
function GuestListingComponent_ng_template_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "more_horiz");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "mat-menu", null, 14)(6, "button", 45)(7, "div", 39)(8, "icon", 37);
    \u0275\u0275text(9, "attachment");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(13, GuestListingComponent_ng_template_34_Conditional_13_Template, 7, 3, "button", 46);
    \u0275\u0275conditionalCreate(14, GuestListingComponent_ng_template_34_Conditional_14_Template, 7, 3, "button", 46);
    \u0275\u0275elementStart(15, "mat-menu", null, 13);
    \u0275\u0275repeaterCreate(17, GuestListingComponent_ng_template_34_For_18_Template, 2, 2, "a", 47, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(20, "div", 39)(21, "icon", 37);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(26, GuestListingComponent_ng_template_34_Conditional_26_Template, 7, 3, "button", 46);
    \u0275\u0275conditionalCreate(27, GuestListingComponent_ng_template_34_Conditional_27_Template, 7, 3, "button", 46);
    \u0275\u0275elementStart(28, "a", 47)(29, "div", 39)(30, "icon", 37);
    \u0275\u0275text(31, "email");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(34, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(35, GuestListingComponent_ng_template_34_Conditional_35_Template, 16, 12);
    \u0275\u0275conditionalCreate(36, GuestListingComponent_ng_template_34_Conditional_36_Template, 7, 4, "button", 46);
    \u0275\u0275conditionalCreate(37, GuestListingComponent_ng_template_34_Conditional_37_Template, 14, 6);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const row_r18 = ctx.row;
    const guest_menu_r27 = \u0275\u0275reference(5);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 15, "APP.CONCIERGE.VISITORS_ACTION_ATTACHMENTS"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.has_parking && !row_r18.extension_data.parking_booking_id ? 13 : -1);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(25, 17, row_r18.extension_data.remote ? "APP.CONCIERGE.VISITORS_ACTION_ONSITE" : "APP.CONCIERGE.VISITORS_ACTION_REMOTE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.can_print ? 26 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.allow_printing_label && row_r18.checked_in ? 27 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("href", "mailto:" + (row_r18 == null ? null : row_r18.asset_id), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(34, 19, (row_r18 == null ? null : row_r18.user_email) === (row_r18 == null ? null : row_r18.asset_id) ? "APP.CONCIERGE.VISITORS_ACTION_EMAIL_HOST" : "APP.CONCIERGE.VISITORS_ACTION_EMAIL_GUEST"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.pass_number_enabled ? 35 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!row_r18.checked_out_at ? 36 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(row_r18.linked_event ? 37 : -1);
  }
}
...
function GuestListingComponent_ng_template_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, GuestListingComponent_ng_template_36_Conditional_5_Template, 4, 3, "div", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
_GuestListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GuestListingComponent, selectors: [["guest-listings"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 41, vars: 91, consts: [["state_template", ""], ["person_template", ""], ["host_template", ""], ["id_template", ""], ["parking_template", ""], ["induction_template", ""], ["status_template", ""], ["time_template", ""], ["pass_template", ""], ["date_template", ""], ["action_template", ""], ["notes_template", ""], ["id_confirmation", ""], ["menu", "matMenu"], ["guest_menu", "matMenu"], ["pass_menu", ""], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "z-0", "block", "text-sm", 3, "data", "columns", "filter", "sortable"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 1, "absolute", "bottom-4", "right-4", "z-20", "h-12", "w-12", "bg-secondary", "text-white", "shadow-sm", "hover:shadow-lg", 3, "matTooltip"], [1, "h-8", "w-full"], ["matTooltipPosition", "right", 1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "bg-base-400", "text-2xl", "text-neutral-content", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "bg-warning", "text-2xl", "text-warning-content", 3, "matTooltip"], ["matTooltipPosition", "right", 1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "bg-success", "text-2xl", "text-success-content", 3, "matTooltip"], [1, "px-4", "py-2"], [1, "text-xs", "opacity-30"], ["customTooltip", "", 3, "content"], ["matRipple", "", 1, "rounded-3xl", "bg-success", "px-4", "py-2", "text-white"], [1, "my-2", "flex", "w-[20rem]", "flex-col", "space-y-2", "rounded-sm", "bg-base-100", "p-2"], [1, "max-h-80", "max-w-[20rem]", "object-contain", 3, "src"], ["matRipple", "", 3, "click"], ["matRipple", "", 1, "inverse", "mt-2", 3, "click"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "bg-success", "text-2xl", "text-success-content"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl"], [1, "px-4"], ["matRipple", "", 1, "h-10", "w-30", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pl-4", "pr-2"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], [1, "text-2xl", "text-error"], [1, "opacity-30"], [1, "flex", "items-center", "justify-end", "px-2"], ["icon", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "disabled", "matMenuTriggerFor"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "href"], ["mat-menu-item", "", 3, "click", "matMenuTriggerFor"], [1, "w-full", "space-y-2", "px-2", 3, "click"], ["appearance", "outline", 1, "no-subscript"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click", "disabled"], [1, "relative", "mx-auto", "p-4"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "absolute", "right-1", "top-1", "flex", "h-4", "w-4", "items-center", "justify-center", "rounded-full", "bg-info", "text-info-content", 3, "matTooltip"], ["className", "material-symbols-rounded", 1, "text-sm"], ["matTooltipPosition", "left", "icon", "", "matRipple", "", 1, "absolute", "bottom-4", "right-4", "z-20", "h-12", "w-12", "bg-secondary", "text-white", "shadow-sm", "hover:shadow-lg", 3, "click", "matTooltip"]], template: function GuestListingComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275element(1, "simple-table", 17);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275pipe(5, "translate");
    ...
    \u0275\u0275pipe(13, "async");
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, GuestListingComponent_ng_template_14_Template, 3, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(16, GuestListingComponent_ng_template_16_Template, 4, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(18, GuestListingComponent_ng_template_18_Template, 4, 2, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(20, GuestListingComponent_ng_template_20_Template, 4, 2, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(22, GuestListingComponent_ng_template_22_Template, 1, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(24, GuestListingComponent_ng_template_24_Template, 3, 13, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(26, GuestListingComponent_ng_template_26_Template, 23, 30, "ng-template", null, 6, \u0275\u0275templateRefExtractor)(28, GuestListingComponent_ng_template_28_Template, 4, 6, "ng-template", null, 7, \u0275\u0275templateRefExtractor)(30, GuestListingComponent_ng_template_30_Template, 3, 2, "ng-template", null, 8, \u0275\u0275templateRefExtractor)(32, GuestListingComponent_ng_template_32_Template, 5, 8, "ng-template", null, 9, \u0275\u0275templateRefExtractor)(34, GuestListingComponent_ng_template_34_Template, 38, 21, "ng-template", null, 10, \u0275\u0275templateRefExtractor)(36, GuestListingComponent_ng_template_36_Template, 6, 4, "ng-template", null, 11, \u0275\u0275templateRefExtractor);
    \u0275\u0275conditionalCreate(38, GuestListingComponent_Conditional_38_Template, 4, 3, "button", 18);
    \u0275\u0275pipe(39, "async");
    \u0275\u0275element(40, "div", 19);
  }
  if (rf & 2) {
    let tmp_17_0;
    const state_template_r31 = \u0275\u0275reference(15);
    const person_template_r32 = \u0275\u0275reference(17);
    const host_template_r33 = \u0275\u0275reference(19);
    const parking_template_r34 = \u0275\u0275reference(23);
    const induction_template_r35 = \u0275\u0275reference(25);
    const status_template_r36 = \u0275\u0275reference(27);
    const time_template_r37 = \u0275\u0275reference(29);
    const pass_template_r38 = \u0275\u0275reference(31);
    const date_template_r39 = \u0275\u0275reference(33);
    const action_template_r40 = \u0275\u0275reference(35);
    const notes_template_r41 = \u0275\u0275reference(37);
    \u0275\u0275advance();
    \u0275\u0275styleProp("min-width", 68 + ctx.extra_width + "rem");
    \u0275\u0275property("data", ctx.guests)("columns", \u0275\u0275pureFunctionV(78, _c12, [\u0275\u0275pureFunction3(33, _c0, \u0275\u0275pipeBind1(2, 7, "COMMON.STATUS"), state_template_r31, !ctx.hide_field("state")), \u0275\u0275pureFunction3(37, _c1, \u0275\u0275pipeBind1(3, 9, "FORM.TIME"), date_template_r39, !ctx.hide_field("date")), \u0275\u0275pureFunction2(41, _c2, \u0275\u0275pipeBind1(4, 11, "RESOURCE.VISITOR"), person_template_r32), \u0275\u0275pureFunction3(44, _c3, \u0275\u0275pipeBind1(5, 13, "FORM.HOST"), host_template_r33, !ctx.hide_field("user_name")), \u0275\u0275pureFunction3(48, _c4, \u0275\u0275pipeBind1(6, 15, "COMMON.CHECKED_IN"), time_template_r37, !ctx.hide_field("checked_in_at")), \u0275\u0275pureFunction3(52, _c5, \u0275\u0275pipeBind1(7, 17, "COMMON.CHECKED_OUT"), time_template_r37, !ctx.hide_field("checked_out_at")), \u0275\u0275pureFunction3(56, _c6, \u0275\u0275pipeBind1(8, 19, "BOOKINGS.INDUCTED"), induction_template_r35, !!ctx.inductions_enabled()), \u0275\u0275pureFunction3(60, _c7, \u0275\u0275pipeBind1(9, 21, "BOOKINGS.PASS_NUMBER"), pass_template_r38, ctx.pass_number_enabled), \u0275\u0275pureFunction3(64, _c8, \u0275\u0275pipeBind1(10, 23, "RESOURCE.PARKING"), parking_template_r34, !!ctx.has_parking), \u0275\u0275pureFunction3(68, _c9, \u0275\u0275pipeBind1(11, 25, "COMMON.STATE"), status_template_r36, !ctx.hide_field("status")), \u0275\u0275pureFunction3(72, _c10, \u0275\u0275pipeBind1(12, 27, "FORM.NOTES"), notes_template_r41, !ctx.hide_field("notes")), \u0275\u0275pureFunction1(76, _c11, action_template_r40)]))("filter", \u0275\u0275pipeBind1(13, 29, ctx.search))("sortable", true);
    \u0275\u0275advance(37);
    \u0275\u0275conditional(((tmp_17_0 = \u0275\u0275pipeBind1(39, 31, ctx.guests)) == null ? null : tmp_17_0.length) ? 38 : -1);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GuestListingComponent, { className: "GuestListingComponent", filePath: "apps/concierge/src/app/visitors/guest-listing.component.ts", lineNumber: 677 });
})();
...
//# sourceMappingURL=chunk-XNG7FUJP.js.map
