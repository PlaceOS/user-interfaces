import {
  PrintableComponent
} from "./chunk-MOQVDFOM.js";
import {
  DesksStateService
} from "./chunk-BD7FQXCX.js";
import "./chunk-NCPBZPEH.js";
import {
  ExploreZoomControlComponent
} from "./chunk-EVILZBFE.js";
import {
  AssetListFieldComponent,
  RecurrenceFieldComponent
} from "./chunk-MOJ66DSU.js";
import {
  UserListFieldComponent
} from "./chunk-S4FZBD4C.js";
import {
...
import "./chunk-PPQOYYDI.js";
import {
  BookingFormService
} from "./chunk-NQBFAUDP.js";
import "./chunk-GK6XMJPR.js";
import {
  DEFAULT_COLOURS
} from "./chunk-5BEH3HPK.js";
import "./chunk-JGZ6QN27.js";
...
function DeskBookingsComponent_ng_template_24_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 32)(2, "icon", 30);
    \u0275\u0275text(3, "event_busy");
    \u0275\u0275elementEnd();
...
function DeskBookingsComponent_ng_template_24_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 32)(2, "icon", 38);
    \u0275\u0275text(3, "delete");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div");
    \u0275\u0275text(5);
...
function DeskBookingsComponent_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35)(1, "button", 36)(2, "icon", 30);
    \u0275\u0275text(3, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "mat-menu", null, 9);
    \u0275\u0275conditionalCreate(6, DeskBookingsComponent_ng_template_24_Conditional_6_Template, 7, 3, "button", 37);
    \u0275\u0275conditionalCreate(7, DeskBookingsComponent_ng_template_24_Conditional_7_Template, 7, 3, "button", 37);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskBookingsComponent, selectors: [["desk-bookings"]], decls: 36, vars: 79, consts: [["date_template", ""], ["group_template", ""], ["period_template", ""], ["user_template", ""], ["status_template", ""], ["option_template", ""], ["action_template", ""], ["menu", "matMenu"], ["checkinMenu", "matMenu"], ["actionMenu", "matMenu"], [1, "h-full", "w-full", "overflow-auto", "pb-16"], [1, "block", "min-w-368", "text-sm", 3, "data", "filter", "filter_on", "columns", "empty_message", "sortable"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "fixed", "bottom-2", "left-1/2", "flex", "items-center", "gap-2", "rounded-full", "border", "px-3", "py-2", "text-sm", "shadow-xl"], [1, "bg-base-100", "border-base-300", "fixed", "right-8", "bottom-4", "flex", "items-center", "justify-end", "gap-2", "rounded-xl", "border", "px-2", "py-1", "shadow-lg"], [1, "mr-8", "text-xs", "opacity-60"], ["icon", "", "default", "", "matRipple", "", 1, "absolute", "top-1/2", "-right-2", "-translate-y-1/2", 3, "click", "disabled", "matTooltip"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-4", "font-mono", "text-[0.625rem]"], [1, "opacity-30"], [1, "flex", "flex-col", "p-2"], [1, "text-error", "text-xs"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], [1, "max-w-48", "truncate", "text-xs", "opacity-30", "select-all"], [1, "px-2"], ["matRipple", "", 1, "bg-warning", "text-warning-content", "h-10", "w-30", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pr-2", "pl-4"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "bg-warning", "text-warning-content", "h-10", "w-18", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled", "matTooltip"], [1, "mx-auto", "flex", "items-center", "justify-end", "space-x-2"], ["icon", "", "default", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", ""], [1, "text-error", "text-2xl"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "fixed", "bottom-2", "left-1/2", "flex", "items-center", "gap-2", "rounded-full", "border", "px-3", "py-2", "text-sm", "shadow-xl", 3, "click"], [1, "pr-1"]], template: function DeskBookingsComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.bookings())("filter", ctx.filters().search)("filter_on", \u0275\u0275pureFunction0(38, _c07))("columns", \u0275\u0275pureFunctionV(66, _c11, [\u0275\u0275pureFunction2(39, _c15, \u0275\u0275pipeBind1(2, 10, "FORM.DATE"), date_template_r19), \u0275\u0275pureFunction2(42, _c2, \u0275\u0275pipeBind1(3, 12, "FORM.PERIOD"), period_template_r20), \u0275\u0275pureFunction1(45, _c3, \u0275\u0275pipeBind1(4, 14, "RESOURCE.DESK")), \u0275\u0275pureFunction2(47, _c4, \u0275\u0275pipeBind1(5, 16, "COMMON.PERSON"), user_template_r21), \u0275\u0275pureFunction2(50, _c5, \u0275\u0275pipeBind1(6, 18, "COMMON.BOOKED_BY"), user_template_r21), \u0275\u0275pureFunction1(53, _c6, \u0275\u0275pipeBind1(7, 20, "FORM.TITLE")), \u0275\u0275pureFunction1(55, _c7, \u0275\u0275pipeBind1(8, 22, "APP.CONCIERGE.APPROVER")), \u0275\u0275pureFunction2(57, _c8, \u0275\u0275pipeBind1(9, 24, "COMMON.STATUS"), status_template_r22), \u0275\u0275pureFunction2(60, _c9, \u0275\u0275pipeBind1(10, 26, "COMMON.CHECKED_IN"), option_template_r23), \u0275\u0275pureFunction2(63, _c10, action_template_r24, ctx.can_delete())]))("empty_message", \u0275\u0275pipeBind1(11, 28, ctx.filters().search ? "APP.CONCIERGE.DESKS_BOOKINGS_SEARCH_EMPTY" : "APP.CONCIERGE.DESKS_BOOKINGS_EMPTY"))("sortable", true);
        \u0275\u0275advance(25);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskBookingsComponent, { className: "DeskBookingsComponent", filePath: "apps/concierge/src/app/desks/desk-bookings.component.ts", lineNumber: 388 });
})();
...
function NewDeskFormDetailsComponent_Conditional_0_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("text-secondary", ctx_r1.options()?.group);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 16, "BOOKINGS.DESK_GROUP"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("bg-base-200", !ctx_r1.options()?.group)("bg-secondary", ctx_r1.options()?.group);
  }
}
...
function NewDeskFormDetailsComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 22, "BOOKINGS.DETAILS"), " ");
    \u0275\u0275advance(2);
...
//# sourceMappingURL=desks.routes-PZX2DKC2.js.map
