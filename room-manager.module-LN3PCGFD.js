...
import {
  ...
  TIER_CATEGORIES,
  UNIT_LABELS
} from "./chunk-DPLZHTJT.js";
import {
  CateringStateService
} from "./chunk-WOPYGR4Z.js";
import "./chunk-2A4T7TVG.js";
import {
  SearchbarComponent
} from "./chunk-D3SE7XF5.js";
import "./chunk-AA265FLC.js";
...
function RoomModalComponent_Conditional_9_For_41_For_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 104)(1, "label", 105)(2, "input", 106);
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 108)(6, "span", 98);
    \u0275\u0275text(7, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "input", 109);
...
function RoomModalComponent_Conditional_9_For_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "details", 61)(1, "summary", 97)(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 98);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 99)(7, "div", 100)(8, "span", 101);
    \u0275\u0275text(9, "Select All");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(12, RoomModalComponent_Conditional_9_For_41_For_13_Template, 11, 7, "div", 103, _forTrack1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function RoomModalComponent_Conditional_9_For_75_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 99)(9, "div", 100)(10, "span", 101);
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(14, RoomModalComponent_Conditional_9_For_75_For_15_Template, 11, 7, "div", 103, _forTrack1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function RoomModalComponent_Conditional_9_For_88_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 77)(1, "div", 100)(2, "span", 101);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(6, RoomModalComponent_Conditional_9_For_88_For_7_Template, 11, 7, "div", 103, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function RoomModalComponent_Conditional_9_Conditional_131_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6)(1, "label", 114);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 14);
    \u0275\u0275element(5, "textarea", 115);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function RoomModalComponent_Conditional_9_Conditional_132_For_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-chip-row", 118);
    \u0275\u0275listener("removed", function RoomModalComponent_Conditional_9_Conditional_132_For_9_Template_mat_chip_row_removed_0_listener() {
      const feature_r23 = \u0275\u0275restoreView(_r22).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.removeFeature(feature_r23));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementStart(2, "icon", 119);
    \u0275\u0275text(3, "close");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", feature_r23, " ");
  }
}
function RoomModalComponent_Conditional_9_Conditional_132_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275repeaterCreate(8, RoomModalComponent_Conditional_9_Conditional_132_For_9_Template, 4, 2, "mat-chip-row", 116, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(10, "input", 117);
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275listener("matChipInputTokenEnd", function RoomModalComponent_Conditional_9_Conditional_132_Template_input_matChipInputTokenEnd_10_listener($event) {
      \u0275\u0275restoreView(_r21);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const chipList_r24 = \u0275\u0275reference(6);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(11, 12, "COMMON.FEATURES"))("matChipInputFor", chipList_r24)("matChipInputSeparatorKeyCodes", ctx_r1.separators)("matChipInputAddOnBlur", true);
  }
}
function RoomModalComponent_Conditional_9_Conditional_133_Template(rf, ctx) {
  if (rf & 1) {
    const _r25 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "label", 120);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275listener("click", function RoomModalComponent_Conditional_9_Conditional_133_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function RoomModalComponent_Conditional_9_For_146_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 16);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const tz_r26 = ctx.$implicit;
    \u0275\u0275property("value", tz_r26);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", tz_r26, " ");
  }
}
function RoomModalComponent_Conditional_9_Conditional_147_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 96);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
  }
...
function RoomModalComponent_Conditional_9_Conditional_148_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6)(1, "label", 123);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "image-list-field", 124);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
...
function RoomModalComponent_Conditional_9_Conditional_149_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomModalComponent_Conditional_9_Conditional_150_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6)(1, "label", 127);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-form-field", 14);
...
function RoomModalComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(95, "Planning, staffing & logistics");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(96, "div", 20)(97, "div", 52)(98, "label");
    \u0275\u0275text(99, "Available Event Services");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(104, "details", 17)(105, "summary", 18);
    \u0275\u0275text(106, " Parking & WiFi ");
    \u0275\u0275elementStart(107, "span", 19);
    \u0275\u0275text(108, "Connectivity & transportation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(109, "div", 20)(110, "div", 81);
    \u0275\u0275element(111, "settings-toggle", 82)(112, "settings-toggle", 83)(113, "settings-toggle", 84)(114, "settings-toggle", 85);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(115, "details", 17)(116, "summary", 18);
    \u0275\u0275text(117, " Accessibility ");
    \u0275\u0275elementStart(118, "span", 19);
    \u0275\u0275text(119, "ADA compliance & accommodations");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(120, "div", 86)(121, "div", 81);
    \u0275\u0275element(122, "settings-toggle", 87)(123, "settings-toggle", 88)(124, "settings-toggle", 89)(125, "settings-toggle", 90);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(126, "div", 91)(127, "label");
    \u0275\u0275text(128, "Wheelchair Capacity");
    \u0275\u0275elementEnd();
    \u0275\u0275element(129, "a-counter", 92);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(130, "form", 11);
    \u0275\u0275conditionalCreate(131, RoomModalComponent_Conditional_9_Conditional_131_Template, 7, 6, "div", 6);
    \u0275\u0275conditionalCreate(132, RoomModalComponent_Conditional_9_Conditional_132_Template, 12, 14, "div", 6);
    \u0275\u0275conditionalCreate(133, RoomModalComponent_Conditional_9_Conditional_133_Template, 12, 9, "div", 6);
    \u0275\u0275elementStart(134, "div", 6)(135, "label", 93);
    \u0275\u0275text(136);
    \u0275\u0275pipe(137, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(138, "mat-form-field", 14)(139, "icon", 94);
    \u0275\u0275text(140, "search");
    \u0275\u0275elementEnd();
    \u0275\u0275element(141, "input", 95);
    \u0275\u0275pipe(142, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(143, "mat-autocomplete", null, 0);
    \u0275\u0275repeaterCreate(145, RoomModalComponent_Conditional_9_For_146_Template, 2, 2, "mat-option", 16, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(147, RoomModalComponent_Conditional_9_Conditional_147_Template, 3, 4, "mat-option", 96);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(148, RoomModalComponent_Conditional_9_Conditional_148_Template, 5, 3, "div", 6);
    \u0275\u0275conditionalCreate(149, RoomModalComponent_Conditional_9_Conditional_149_Template, 10, 11, "div", 6);
    \u0275\u0275conditionalCreate(150, RoomModalComponent_Conditional_9_Conditional_150_Template, 10, 11, "div", 6);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const auto_r27 = \u0275\u0275reference(144);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroup", ctx_r1.settings_form);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 31, "APP.CONCIERGE.ROOMS_DEFAULT_SETUP"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(6, 33, "APP.CONCIERGE.ROOMS_SETUP_INFO"));
    \u0275\u0275advance(3);
    \u0275\u0275property("min", 0);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 35, "APP.CONCIERGE.ROOMS_DEFAULT_BREAKDOWN"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(14, 37, "APP.CONCIERGE.ROOMS_BREAKDOWN_INFO"));
    \u0275\u0275advance(3);
    \u0275\u0275property("min", 0);
    \u0275\u0275advance(6);
    \u0275\u0275property("formGroup", ctx_r1.venue_form);
    ...
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.controls.description ? 131 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.controls.features ? 132 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.controls.map_id ? 133 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(137, 39, "COMMON.TIMEZONE"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(142, 41, "COMMON.TIMEZONE"))("matAutocomplete", auto_r27);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r1.filtered_timezones());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r1.timezones().length ? 147 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.controls.images ? 148 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.controls.timetable_url ? 149 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.form.controls.room_booking_url ? 150 : -1);
  }
}
...
_RoomModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomModalComponent, selectors: [["room-form-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 10, vars: 24, consts: [["auto", "matAutocomplete"], ["chipList", ""], [3, "confirm", "heading", "loading"], [1, "flex", "border-b", "border-base-300", "mb-4"], ["type", "button", 1, "px-4", "py-2", "text-sm", "font-medium", "transition-colors", 3, "click"], ["system", "", 3, "formGroup"], [1, "flex", "flex-col"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col"], [1, "mb-4", "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col", "pt-4"], [3, "formGroup"], [1, "mb-4", "flex", "flex-col"], [1, "mb-3", 3, "formGroup"], ["appearance", "outline"], ["formControlName", "venue_type", "placeholder", "Select venue type"], [3, "value"], [1, "border", "border-base-300", "rounded-lg", "mb-3", "w-full", "overflow-hidden"], [1, "cursor-pointer", "px-4", "py-3", "font-medium", "text-sm", "hover:bg-base-200", "select-none"], [1, "text-xs", "opacity-50", "ml-2"], [1, "px-4", "pb-4", "pt-2", 3, "formGroup"], [1, "grid", "grid-cols-2", "gap-4", "mb-4"], [1, "flex", "flex-col", "min-w-0"], ["matInput", "", "type", "number", "formControlName", "sqft", "placeholder", "0", 3, "min"], [1, "flex", "items-center", "justify-center", "pt-4"], ["name", "Furniture Movable", "formControlName", "furniture_movable"], ["formControlName", "supported_layouts", "multiple", "", "placeholder", "Select layouts"], [1, "grid", "grid-cols-3", "gap-2"], ["matInput", "", "type", "number", "formControlName", "hourly_rate", "placeholder", "0", 3, "min"], ["matInput", "", "type", "number", "formControlName", "half_day_rate", "placeholder", "0", 3, "min"], ["matInput", "", "type", "number", "formControlName", "full_day_rate", "placeholder", "0", 3, "min"], ["for", "zone"], ["formControlName", "zone", 3, "placeholder"], ["for", "system-name"], ["matInput", "", "name", "system-name", "formControlName", "name", "required", "", 3, "placeholder"], ["for", "system-email"], ["matInput", "", "name", "system-email", "formControlName", "email", 3, "placeholder"], ["for", "display-name"], ["matInput", "", "name", "display-name", "formControlName", "display_name", 3, "placeholder"], ["for", "code-name"], ["matInput", "", "name", "code-name", "formControlName", "code", 3, "placeholder"], ["formControlName", "approval", 3, "name"], ["formControlName", "bookable", 3, "name"], ["for", "capacity"], ["name", "capacity", "formControlName", "capacity", 1, "w-full", 3, "min", "max"], [1, "flex", "space-x-2", 3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "setup", 1, "flex", "items-center"], [1, "ml-2", "text-base", 3, "matTooltip"], ["name", "setup", "formControlName", "setup", 3, "min"], ["for", "breakdown", 1, "flex", "items-center"], ["name", "breakdown", "formControlName", "breakdown", 3, "min"], [1, "flex", "flex-col", "min-w-0", "mb-4"], ["formControlName", "av_services", "multiple", "", "placeholder", "Select available services"], ["name", "On-Site Technical Staff", "formControlName", "onsite_tech_staff"], ["name", "After Hours AV Available", "formControlName", "after_hours_av"], [1, "text-xs", "font-medium", "opacity-70", "mb-1"], ["appearance", "outline", 1, "w-full"], ["matPrefix", "", 1, "text-xl"], ["matInput", "", "placeholder", "Search AV items...", 3, "input", "value"], [1, "max-h-[300px]", "overflow-y-auto", "border", "border-base-200", "rounded-lg"], [1, "border-b", "border-base-200", "last:border-b-0"], [1, "px-4", "pb-4", "pt-2", "flex", "flex-col", "space-y-3"], [1, "flex", "flex-col", 3, "formGroup"], [1, "text-xs", "opacity-70", "mb-1"], ["formControlName", "catering_tier", 3, "selectionChange"], [1, "grid", "grid-cols-2", "gap-4", "mb-2", 3, "formGroup"], ["name", "Kitchen Access", "formControlName", "kitchen_access"], ["name", "Piano Available", "formControlName", "piano_available"], [1, "grid", "grid-cols-2", "gap-2", "mb-2", 3, "formGroup"], [1, "text-xs", "opacity-70"], ["matInput", "", "formControlName", "catering_provider", "placeholder", "e.g. UCLA Conferences & Catering"], ["matInput", "", "formControlName", "catering_notes", "placeholder", "Additional notes"], ["matInput", "", "placeholder", "Search menu items...", 3, "input", "value"], [1, "max-h-[400px]", "overflow-y-auto", "border", "border-base-200", "rounded-lg"], [1, "px-4", "pb-4", "pt-2"], ["matInput", "", "placeholder", "Search setup items...", 3, "input", "value"], [1, "px-3", "pb-2", "pt-1"], [1, "mt-3", "pt-2", "border-t", "border-base-200", 3, "formGroup"], ["name", "After-Hours Service Charge (+$50)", "formControlName", "after_hours_service_charge"], ["formControlName", "event_services", "multiple", "", "placeholder", "Select available services"], [1, "grid", "grid-cols-2", "gap-4"], ["name", "Complimentary WiFi", "formControlName", "wifi_available"], ["name", "High-Speed WiFi", "formControlName", "high_speed_wifi"], ["name", "On-Site Parking", "formControlName", "onsite_parking"], ["name", "Visitor Transportation", "formControlName", "visitor_transportation"], [1, "px-4", "pb-4", "pt-2", "flex", "flex-col", "space-y-4", 3, "formGroup"], ["name", "ADA Accessible", "formControlName", "ada_accessible"], ["name", "Hearing Loop", "formControlName", "hearing_loop"], ["name", "Accessible Restroom Nearby", "formControlName", "accessible_restroom"], ["name", "Adjustable Lighting", "formControlName", "adjustable_lighting"], [1, "flex", "flex-col", "w-1/2"], ["formControlName", "wheelchair_capacity", 1, "w-full", 3, "min", "max"], ["for", "timezone"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "timezone", 3, "placeholder", "matAutocomplete"], [3, "disabled"], [1, "cursor-pointer", "px-3", "py-2", "font-medium", "text-xs", "hover:bg-base-100", "select-none", "flex", "items-center", "justify-between", "sticky", "top-0", "bg-white", "z-10"], [1, "text-xs", "opacity-50"], [1, "px-3", "pb-2"], [1, "flex", "items-center", "justify-between", "py-1", "mb-1", "border-b", "border-base-100"], [1, "text-xs", "font-medium", "opacity-60"], ["type", "button", 1, "text-xs", "text-primary", "hover:underline", 3, "click"], [1, "flex", "items-center", "justify-between", "py-1", "gap-2", "hover:bg-base-50", "rounded", "px-1", 3, "opacity-50"], [1, "flex", "items-center", "justify-between", "py-1", "gap-2", "hover:bg-base-50", "rounded", "px-1"], [1, "flex", "items-center", "gap-2", "flex-1", "min-w-0", "cursor-pointer", "text-xs"], ["type", "checkbox", 1, "accent-primary", "w-3.5", "h-3.5", 3, "change", "checked"], [1, "truncate"], [1, "flex", "items-center", "gap-1", "shrink-0"], ["type", "number", "step", "1", 1, "w-16", "text-xs", "text-right", "border", "border-base-200", "rounded", "px-1", "py-0.5", 3, "change", "value", "min"], [1, "text-xs", "opacity-40", "w-12"], [1, "text-xs", "opacity-50", "ml-1"], [1, "text-xs", "opacity-40", "ml-1"], ["type", "number", "step", "0.50", 1, "w-16", "text-xs", "text-right", "border", "border-base-200", "rounded", "px-1", "py-0.5", 3, "change", "value", "min"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 3, "placeholder"], [3, "removable"], [3, "matChipInputTokenEnd", "placeholder", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [3, "removed", "removable"], ["matChipRemove", ""], ["for", "map_id"], ["matInput", "", "name", "map_id", "formControlName", "map_id", 3, "placeholder"], ["icon", "", "matRipple", "", 1, "border-secondary", "text-secondary", "h-12", "w-12", "rounded-sm", "border", 3, "click", "matTooltip"], ["for", "images"], ["name", "images", "formControlName", "images"], ["for", "timetable-url"], ["matInput", "", "name", "timetable-url", "formControlName", "timetable_url", 3, "placeholder"], ["for", "room-booking-url"], ["matInput", "", "name", "room-booking-url", "formControlName", "room_booking_url", 3, "placeholder"]], template: function RoomModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(9, RoomModalComponent_Conditional_9_Template, 151, 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomModalComponent, { className: "RoomModalComponent", filePath: "apps/concierge/src/app/room-manager/room-modal.component.ts", lineNumber: 937 });
})();
...
//# sourceMappingURL=room-manager.module-LN3PCGFD.js.map
