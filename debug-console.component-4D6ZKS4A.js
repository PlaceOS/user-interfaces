import {
  ...
  CustomTooltipData
} from "./chunk-KEZU4HP4.js";
import {
  RemoteLoggingService
} from "./chunk-5KKDC5P2.js";
import {
  SanitizePipe
} from "./chunk-4VTAQPMK.js";
import {
  TranslatePipe
...
var _JsonDisplayComponent = class _JsonDisplayComponent {
  constructor() {
    this.json = input(
      void 0,
    ...
    if (_data == null ? void 0 : _data.data) {
...
var JsonDisplayComponent = _JsonDisplayComponent;
(() => {
...
function DebugConsoleComponent_Conditional_0_Conditional_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ((_a = ctx_r1.filtered_logs()) == null ? void 0 : _a.length) || "0", " of ");
  }
}
function DebugConsoleComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional(((_a = ctx_r1.filtered_logs()) == null ? void 0 : _a.length) ? 8 : 9);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", ctx_r1.filter());
    \u0275\u0275control();
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((_b = ctx_r1.filter()) == null ? void 0 : _b.length) ? 16 : -1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (_c = ctx_r1.logs()) == null ? void 0 : _c.length, " ");
  }
}
...
var _DebugConsoleComponent = class _DebugConsoleComponent extends AsyncHandler {
  get can_activate() {
  ...
  trackByFn(_, item) {
    return item == null ? void 0 : item.timestamp;
  }
};
...
var DebugConsoleComponent = _DebugConsoleComponent;
(() => {
...
//# sourceMappingURL=debug-console.component-4D6ZKS4A.js.map
