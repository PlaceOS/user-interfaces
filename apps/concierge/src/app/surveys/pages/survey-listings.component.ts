                ...
                >
                    <div class="flex items-center">
                        <span
                            ...
                            ></span
                        >
                        <ng-container *ngIf="building$ | async as building; else unknownBuilding;">
                            <span class="text-2xl">{{ building.display_name || building.name }} - Survey Listing</span>
                        </ng-container>
                ...
                <div class="flex flex-col w-full">
                    <table mat-table [dataSource]="surveys$ | async">
                        ...
                        <ng-container matColumnDef="title">
                            <th mat-header-cell *matHeaderCellDef class="text-lg"> Title </th>
                            <td mat-cell *matCellDef="let element" class="text-base"> {{element.title}} </td>
                        </ng-container>

                        <ng-container matColumnDef="level">
                            <th mat-header-cell *matHeaderCellDef class="text-lg"> Level </th>
                            <td mat-cell *matCellDef="let element" class="text-base"> {{levelMap[element.zone_id] || element.zone_id}} </td>
                        </ng-container>

                        <ng-container matColumnDef="trigger">
                            <th mat-header-cell *matHeaderCellDef class="text-lg"> Trigger </th>
                            <td mat-cell *matCellDef="let element" class="text-base"> {{triggerMap[element.trigger]}} </td>
                        </ng-container>

                        <ng-container matColumnDef="link">
                            <th mat-header-cell *matHeaderCellDef class="text-lg"> Link </th>
                            <td mat-cell *matCellDef="let element" class="text-base"> {{element.id}} </td>
                        </ng-container>
                            ...
                            <td class="mat-cell" [attr.colspan]="displayedColumns.length">
                                <div class="flex w-full h-20 items-center justify-center">
                                    <span class="text-base">
                                        No surveys found. Click on <i>Add survey</i> to create new surveys for this building.
                                    </span>
                                </div>
                            </td>
                        </tr>
...
export class SurveyListingsComponent extends BaseClass implements OnInit {
    ...
    public get building_name() {
        return this._service.building?.display_name || this._service.building?.name || '';
    }
    ...
    async ngOnInit() {
        ...
        this.subscription('level_map',
            this._service.levelNameMap$.subscribe(map => this.levelMap = map)
        );
    }
