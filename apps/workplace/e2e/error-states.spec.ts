 ...
 * Based on user stories in apps/workplace/USER_STORIES.md (US-090..US-093).
 */
...
test.describe('Error & access states', () => {
    ...
    test('US-092/093: unknown deep links recover to the configured default route', async ({
        page,
    }) => {
        await page.goto('/#/not-a-real-workplace-route?mock=true');
