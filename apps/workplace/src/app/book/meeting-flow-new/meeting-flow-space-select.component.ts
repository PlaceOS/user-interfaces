...
@Component({
    ...
    template: `
        <div
            class="relative z-0 mb-4 w-full overflow-hidden rounded border border-base-100 bg-base-100"
        >
            <div
        ...
        <div>
            <div class="flex w-full space-x-4 pb-4" [formGroup]="form()">
                <div
                    class="sticky top-0 w-[20rem] max-w-[20rem] rounded-xl border border-base-300 bg-base-100"
                >
                    <div
            ...
            <div
                class="sticky bottom-0 z-20 flex justify-end rounded-t-xl border-x border-t border-base-300 bg-base-100 p-3"
            >
                <button btn matRipple class="w-40">Continue</button>
            </div>
        </div>
    `,
    styles: [
