import {
  PrintableComponent
} from "./chunk-IKM55SF4.js";
import {
  DesksStateService
} from "./chunk-JG62FTDH.js";
import "./chunk-MP7JSMAQ.js";
import {
  ExploreZoomControlComponent
} from "./chunk-LRLRYRTT.js";
import {
  AssetListFieldComponent,
  RecurrenceFieldComponent
} from "./chunk-575EZTJX.js";
import "./chunk-GGHRUZXD.js";
import {
  UserListFieldComponent
} from "./chunk-X7RYZAYJ.js";
import {
  ImageCarouselComponent
} from "./chunk-V3XNSSWY.js";
import {
...
import {
  MapPinComponent
} from "./chunk-H76G3GTJ.js";
import {
  loadPersistedZones,
  persistZones
} from "./chunk-2IX3MLLC.js";
import "./chunk-5XWIUPTG.js";
...
var DesksManageComponent = class _DesksManageComponent extends AsyncHandler {
  ...
  async removeDesk(desk) {
    ...
    const updated_desks = desks.filter((_) => (_.zone?.id || zone_id) === zone_id && _.id !== desk.id);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DesksManageComponent, { className: "DesksManageComponent", filePath: "apps/concierge/src/app/desks/desks-manage.component.ts", lineNumber: 277 });
})();
...
function DesksComponent_Conditional_13_For_4_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, level_r5.parent_id)?.display_name, " ");
  }
}
...
function DesksComponent_Conditional_14_For_4_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, level_r7.parent_id)?.display_name, " ");
  }
}
...
function DesksComponent_Conditional_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.filters().zones?.length ? ctx_r1.filters().zones[0] : "")("placeholder", \u0275\u0275pipeBind1(2, 2, "COMMON.LEVEL_SELECT"));
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.levels());
  }
}
function DesksComponent_Conditional_16_Conditional_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 25);
  }
}
function DesksComponent_Conditional_16_Conditional_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function DesksComponent_Conditional_16_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 23);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function DesksComponent_Conditional_16_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.downloadCsv());
    });
    \u0275\u0275conditionalCreate(2, DesksComponent_Conditional_16_Conditional_5_Conditional_2_Template, 1, 0, "mat-spinner", 25)(3, DesksComponent_Conditional_16_Conditional_5_Conditional_3_Template, 2, 0, "icon");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DesksComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "event_busy");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, DesksComponent_Conditional_16_Conditional_5_Template, 4, 5, "button", 24);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
...
var DesksComponent = class _DesksComponent extends AsyncHandler {
  ...
  _syncZones(levels, restore = false) {
    ...
    let next_zones = restore ? [] : this.manage() ? valid_zones.slice(0, 1) : valid_zones;
    const persistence_view = this.manage() ? "desks-manage" : this.path() === "map" ? "desks" : "";
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DesksComponent, selectors: [["", "app-desks", ""]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], decls: 22, vars: 12, consts: [[1, "print:hidden"], [1, "flex", "h-px", "flex-1", "print:hidden"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "w-full", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], ["btn", "", "matRipple", "", 1, "w-44", "space-x-2"], [1, "mb-4", "flex", "w-full", "items-center", "gap-2", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-60"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], ["mode", "indeterminate", 1, "w-full"], [1, "desk-qr-print-preview", "print-only", "fixed", "top-0", "left-0"], ["btn", "", "matRipple", "", 1, "w-44", "space-x-2", 3, "click"], [1, "pl-2"], [1, "text-2xl"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "ngModelChange", "ngModel", "placeholder"], [3, "dateChange"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip", "disabled"], ["icon", "", "default", "", "matRipple", "", 3, "matTooltip", "disabled"], ["diameter", "24"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "matTooltip"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["target", "_blank", "ref", "noopener noreferrer", 1, "border-base-200", "bg-base-100", "m-2", "block", "rounded-lg", "border", "p-2", 3, "href"], [1, "w-48", 3, "src"], [1, "bg-base-200", "mx-2", "mt-2", "w-48", "rounded-sm", "p-2", "text-center", "font-mono", "text-sm"]], template: function DesksComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(15, "div", 5);
        \u0275\u0275conditionalCreate(16, DesksComponent_Conditional_16_Template, 6, 5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DesksComponent, { className: "DesksComponent", filePath: "apps/concierge/src/app/desks/desks.component.ts", lineNumber: 344 });
})();
...
//# sourceMappingURL=desks.routes-A3Z6M5VZ.js.map
