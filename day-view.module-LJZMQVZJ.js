...
import "./chunk-QDZAEM4C.js";
import {
  EventsStateService
} from "./chunk-UCWW4UTB.js";
import {
  MOCK_APPROVAL_EVENTS
} from "./chunk-XMV4ESIK.js";
import "./chunk-TTB7C5DE.js";
import "./chunk-IDDV5MNJ.js";
import "./chunk-F2JSZEED.js";
import {
  DateOptionsComponent
} from "./chunk-6KI2BWKC.js";
import "./chunk-4CINJZ6L.js";
import "./chunk-MDAI4PWI.js";
...
function RoomBookingsComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_For_34_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_For_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, RoomBookingsComponent_For_34_Conditional_2_Template, 5, 3, "div", 28);
...
function RoomBookingsComponent_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "settings-toggle", 5);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_Conditional_36_Template_settings_toggle_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RoomBookingsComponent_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-week-bookings-timeline", 25);
  }
}
function RoomBookingsComponent_Conditional_56_Template(rf, ctx) {
  if (rf & 1) {
...
_RoomBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsComponent, selectors: [["room-bookings"]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], decls: 58, vars: 49, consts: [[1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden", "pl-8"], [1, "flex", "w-full", "items-center", "space-x-2", "py-4", "pr-8"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "day"], ["value", "week"], ["matRipple", "", 1, "flex", "h-12", "items-center", "space-x-1", "rounded", "border", "px-3", "text-sm", "font-medium", 3, "click", "ngClass"], [1, "text-xl"], ["icon", "", "matRipple", "", 1, "border-secondary", "h-12", "w-12", "rounded", "border", 3, "click", "matTooltip", "disabled"], ["diameter", "24"], [1, "text-2xl"], [1, "flex", "w-full", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "ngModel"], [1, "flex", "flex-1", "items-center", "justify-end", "space-x-4", "pr-2"], [1, "flex", "items-center", "space-x-1"], [1, "h-3", "w-3", "rounded-full", "bg-success"], [1, "text-xs", "opacity-60"], [1, "h-3", "w-3", "rounded-full", "bg-warning"], [1, "h-3", "w-3", "rounded-full", "bg-error"], [1, "border-base-200", "mt-4", "flex", "h-px", "w-full", "flex-1", "border-t"], [1, "relative", "z-0", "w-1/2", "flex-1"], [1, "relative", "z-10"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"]], template: function RoomBookingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275listener("click", function RoomBookingsComponent_Template_button_click_24_listener() {
      return ctx.downloadCsv();
    });
    \u0275\u0275conditionalCreate(26, RoomBookingsComponent_Conditional_26_Template, 1, 0, "mat-spinner", 11)(27, RoomBookingsComponent_Conditional_27_Template, 2, 0, "icon", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 13)(29, "mat-form-field", 14)(30, "mat-select", 15);
    \u0275\u0275pipe(31, "async");
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_Template_mat_select_ngModelChange_30_listener($event) {
      return ctx.updateZones($event);
    });
    \u0275\u0275repeaterCreate(33, RoomBookingsComponent_For_34_Template, 5, 3, "mat-option", 16, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(35, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(36, RoomBookingsComponent_Conditional_36_Template, 4, 6, "settings-toggle", 17);
    \u0275\u0275elementStart(37, "div", 18)(38, "div", 19);
    \u0275\u0275element(39, "div", 20);
    ...
    \u0275\u0275conditionalCreate(51, RoomBookingsComponent_Conditional_51_Template, 1, 0, "room-bookings-timeline", 25);
    \u0275\u0275pipe(52, "async");
    \u0275\u0275pipe(53, "async");
    \u0275\u0275pipe(54, "async");
    \u0275\u0275conditionalBranchCreate(55, RoomBookingsComponent_Conditional_55_Template, 1, 0, "room-week-bookings-timeline", 25)(56, RoomBookingsComponent_Conditional_56_Template, 1, 0, "room-list-timeline", 25);
    \u0275\u0275conditionalCreate(57, RoomBookingsComponent_Conditional_57_Template, 1, 0, "room-bookings-approvals", 26);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 19, "APP.CONCIERGE.ROOM_BOOKINGS"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(8, 21, ctx.dropdown_period));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 23, "COMMON.DAY"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(14, 25, "COMMON.WEEK"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("border-primary", \u0275\u0275pipeBind1(16, 27, ctx.period) === "list")("text-primary", \u0275\u0275pipeBind1(17, 29, ctx.period) === "list")("border-base-300", \u0275\u0275pipeBind1(18, 31, ctx.period) !== "list");
    \u0275\u0275property("ngClass", \u0275\u0275pipeBind1(19, 33, ctx.period) === "list" ? "bg-primary/10" : "");
    \u0275\u0275advance(9);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(25, 35, "APP.CONCIERGE.DOWNLOAD_USER_LIST"))("disabled", ctx.downloading());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.downloading() ? 26 : 27);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(31, 37, ctx.zones))("placeholder", \u0275\u0275pipeBind1(32, 39, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(35, 41, ctx.levels));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.allow_setup_breakdown ? 36 : -1);
    \u0275\u0275advance(15);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(52, 43, ctx.period) === "day" ? 51 : \u0275\u0275pipeBind1(53, 45, ctx.period) === "week" ? 55 : \u0275\u0275pipeBind1(54, 47, ctx.period) === "list" ? 56 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275conditional(ctx.has_approvals ? 57 : -1);
  }
}, dependencies: [
  CommonModule,
  NgClass,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsComponent, { className: "RoomBookingsComponent", filePath: "apps/concierge/src/app/day-view/room-bookings.component.ts", lineNumber: 176 });
})();
...
//# sourceMappingURL=day-view.module-LJZMQVZJ.js.map
