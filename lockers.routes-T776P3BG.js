...
var SelectUserModalComponent = class _SelectUserModalComponent {
  constructor() {
    ...
    this._users = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_users" } : (
      ...
      loader: ({ params: { q } }) => La({ q }).then((o) => o.data.map((u) => new StaffUser(u))).catch(() => [])
    }));
    this.users = computed(
      () => this._users.value() ?? [],
...
//# debugId=18250f91-7cee-5220-a942-b7edcc51a32e
//# sourceMappingURL=lockers.routes-T776P3BG.js.map
