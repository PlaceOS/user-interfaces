...
} from "./chunk-GDG65ULE.js";
import "./chunk-D54ZDHOD.js";
import "./chunk-J7FIEMQT.js";
import {
  EventsStateService
} from "./chunk-UTNUT7NQ.js";
import {
  MOCK_APPROVAL_EVENTS
} from "./chunk-PI4YJS2W.js";
import "./chunk-2YFNPVRW.js";
import "./chunk-HLNPF7EU.js";
import "./chunk-4TXKBRN4.js";
import {
...
function RoomBookingsTimelineComponent_For_33_For_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, RoomBookingsTimelineComponent_For_33_For_1_Conditional_0_Conditional_2_Template, 1, 0, "div", 31)(3, RoomBookingsTimelineComponent_For_33_For_1_Conditional_0_Conditional_3_Template, 1, 0, "div", 32);
...
function RoomListTimelineComponent_For_28_For_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, RoomListTimelineComponent_For_28_For_1_Conditional_0_Conditional_2_Template, 1, 0, "div", 26)(3, RoomListTimelineComponent_For_28_For_1_Conditional_0_Conditional_3_Template, 1, 0, "div", 27);
...
function RoomWeekBookingsTimelineComponent_For_27_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", event_r4.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind3(8, 10, event_r4.date, ctx_r1.time_format, ctx_r1.tz), " \u2013 ", \u0275\u0275pipeBind3(9, 14, event_r4.date_end, ctx_r1.time_format, ctx_r1.tz), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r1.tz ? 10 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", event_r4.system == null ? null : event_r4.system.display_name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ((tmp_27_0 = \u0275\u0275pipeBind1(16, 20, \u0275\u0275pipeBind1(15, 18, event_r4.host))) == null ? null : tmp_27_0.name) || event_r4.host, " ");
  }
}
function RoomWeekBookingsTimelineComponent_For_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275repeaterCreate(1, RoomWeekBookingsTimelineComponent_For_27_For_2_Template, 17, 22, "button", 19, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
_RoomWeekBookingsTimelineComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomWeekBookingsTimelineComponent, selectors: [["room-week-bookings-timeline"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 29, vars: 35, consts: [[1, "bg-info", "text-info-content", "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "p-2", "text-center", "text-xs"], [1, "border-base-200", "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "p-2"], [3, "dateChange", "date", "step", "is_new", "hide_today"], [1, "text-info", "absolute", "top-1/2", "left-4", "-translate-y-1/2", "text-sm"], [1, "absolute", "top-1/2", "right-8", "-translate-y-1/2"], [3, "selected"], ["timeline", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["timezone", "", 1, "bg-base-100", "sticky", "top-0", "left-0", "z-30", "flex", "items-center", "justify-center"], [1, "text-xs", "opacity-30"], [1, "bg-base-300", "absolute", "right-0", "bottom-0", "h-2", "w-px"], [1, "bg-base-300", "absolute", "right-0", "bottom-0", "h-px", "w-2"], ["day-headers", "", 1, "border-base-300", "bg-base-100", "sticky", "top-0", "z-20", "flex", "min-w-[calc(100%-3rem)]", "items-center", "border-b"], [1, "relative", "flex", "h-full", "min-w-48", "flex-1", "flex-col", "items-center", "justify-center", "leading-tight"], ["empty-block", "", 1, "border-base-300", "bg-base-100", "sticky", "left-0", "z-10", "min-h-full", "border-r"], ["date-blocks", "", 1, "relative", "flex", "min-w-[calc(100%-3rem)]", "overflow-hidden"], [1, "border-base-200", "min-w-48", "flex-1", "overflow-hidden", "border-r", "p-2"], [1, "truncate"], [1, "text-info", "absolute", "bottom-1", "left-1/2", "-translate-x-1/2", "text-xs"], [1, "bg-base-300", "absolute", "bottom-0", "-left-px", "h-2", "w-px"], ["matRipple", "", 1, "mb-1", "w-full", "text-left", "hover:opacity-90"], ["matRipple", "", 1, "mb-1", "w-full", "text-left", "hover:opacity-90", 3, "click"], [1, "bg-base-100", "relative", "w-full", "overflow-hidden", "rounded-lg", "border", "border-base-200", "px-3", "py-1", "text-xs", "shadow-sm"], [1, "bg-success", "absolute", "inset-0", "opacity-25"], [1, "relative"], [1, "truncate", "font-medium", "text-base-content"], [1, "text-base-content", "opacity-70"], [1, "truncate", "text-base-content", "opacity-50"]], template: function RoomWeekBookingsTimelineComponent_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_For_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 16)(1, "div", 25);
    \u0275\u0275conditionalCreate(2, RoomBookingsComponent_For_34_Conditional_2_Template, 5, 3, "div", 26);
...
function RoomBookingsComponent_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "room-list-timeline", 23);
  }
}
...
_RoomBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsComponent, selectors: [["room-bookings"]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], decls: 50, vars: 49, consts: [[1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden", "pl-8"], [1, "flex", "w-full", "items-center", "space-x-2", "py-4", "pr-8"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "day"], ["value", "week"], ["matRipple", "", 1, "flex", "h-12", "items-center", "space-x-1", "rounded", "border", "px-3", "text-sm", "font-medium", 3, "click", "ngClass"], [1, "text-xl"], ["icon", "", "matRipple", "", 1, "border-secondary", "h-12", "w-12", "rounded", "border", 3, "click", "matTooltip", "disabled"], ["diameter", "24"], [1, "text-2xl"], [1, "flex", "w-full", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "ngModel"], [1, "flex", "flex-1", "items-center", "justify-end", "space-x-4", "pr-2"], [1, "flex", "items-center", "space-x-1"], [1, "h-3", "w-3", "rounded-full", "bg-success"], [1, "text-xs", "opacity-60"], [1, "border-base-200", "mt-4", "flex", "h-px", "w-full", "flex-1", "border-t"], [1, "relative", "z-0", "w-1/2", "flex-1"], [1, "relative", "z-10"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"]], template: function RoomBookingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(43, RoomBookingsComponent_Conditional_43_Template, 1, 0, "room-bookings-timeline", 23);
    \u0275\u0275pipe(44, "async");
    \u0275\u0275pipe(45, "async");
    \u0275\u0275pipe(46, "async");
    \u0275\u0275conditionalBranchCreate(47, RoomBookingsComponent_Conditional_47_Template, 1, 0, "room-week-bookings-timeline", 23)(48, RoomBookingsComponent_Conditional_48_Template, 1, 0, "room-list-timeline", 23);
    \u0275\u0275conditionalCreate(49, RoomBookingsComponent_Conditional_49_Template, 1, 0, "room-bookings-approvals", 24);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(7);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(44, 43, ctx.period) === "day" ? 43 : \u0275\u0275pipeBind1(45, 45, ctx.period) === "week" ? 47 : \u0275\u0275pipeBind1(46, 47, ctx.period) === "list" ? 48 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275conditional(ctx.has_approvals ? 49 : -1);
  }
}, dependencies: [
  CommonModule,
  NgClass,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsComponent, { className: "RoomBookingsComponent", filePath: "apps/concierge/src/app/day-view/room-bookings.component.ts", lineNumber: 168 });
})();
...
//# sourceMappingURL=day-view.module-C63Z3XPG.js.map
