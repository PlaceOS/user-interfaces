...
} from "./chunk-FOGX7PUA.js";
import {
  MatSelect,
  MatSelectModule
} from "./chunk-TXVAG53L.js";
import "./chunk-LMC45HBY.js";
import "./chunk-L5MI32FX.js";
...
var PlaylistRequestApprovalModalComponent = class _PlaylistRequestApprovalModalComponent {
  ...
  async _loadPlaylistVersions() {
    ...
    try {
      const versions = await Yh(playlist_id, { limit: 2 });
  ...
  async undoChanges() {
    ...
    try {
      await nl(this.data.playlist.id, previous_version.items);
...
//# sourceMappingURL=playlist-request-approval-modal.component-BNYLVY5V.js.map
