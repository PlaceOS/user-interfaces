...
var _DealsService = class _DealsService extends AsyncHandler {
  ...
  async saveDeal(deal) {
    const metadata = await lastValueFrom(Iu(this._org.building.id, "deals-n-offers")).catch(() => null);
    ...
    deals.push(deal);
    await lastValueFrom(Pu(this._org.building.id, {
      name: "deals-n-offers",
...
//# sourceMappingURL=deals.module-5MZG3JWQ.js.map
