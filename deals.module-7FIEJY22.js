...
_DealsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealsComponent, selectors: [["", "app-deals", ""]], attrs: _c0, decls: 5, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"]], template: function DealsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsComponent, { className: "DealsComponent", filePath: "apps/concierge/src/app/deals/deals.component.ts", lineNumber: 34 });
})();

// apps/concierge/src/app/deals/deal-modal.component.ts
var _c02 = (a0) => ["/deals-n-offers", "manage", a0];
...
var _DealModalComponent = class _DealModalComponent {
  constructor() {
...
_DealModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealModalComponent, selectors: [["app-deal-modal"]], outputs: { remove: "remove" }, decls: 39, vars: 24, consts: [[1, "bg-base-100", "relative", "w-lg", "max-w-[80vw]"], [1, "bg-base-300", "relative", "h-48", "w-lg", "max-w-full", "overflow-hidden", "rounded-b-lg"], ["auth", "", "alt", "Deal Image", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "bg-info", "text-info-content", "absolute", "bottom-2", "left-2", "max-w-full", "truncate", "rounded-sm", "px-2", "py-1", "text-xs", "shadow-sm"], [1, "flex", "space-x-2", "p-2"], [1, "w-auto", "px-2", "text-xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click", "routerLink"], [1, "text-2xl"], [1, "pr-2"], ["btn", "", "matRipple", "", 1, "inverse", "error", "space-x-2", 3, "click"], [1, "text-error", "text-2xl"], [1, "max-h-[60vh]", "space-y-2", "overflow-auto", "p-4"], [1, "font-medium"], [1, "max-w-[]", "pb-4", "text-sm"], [1, "pb-4", "text-sm"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "bg-base-100", "absolute", "top-2", "right-2"]], template: function DealModalComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(22, _c02, ctx.deal.id));
    \u0275\u0275advance(4);
...
var DealModalComponent = _DealModalComponent;
(() => {
...
var _DealsService = class _DealsService extends AsyncHandler {
  constructor() {
    super(...arguments);
    ...
    this.deals$ = combineLatest([
      ...
      return nc(bld.id, "deals-n-offers").pipe(catchError(() => of({ details: [] })));
    }), map(({ details }) => details instanceof Array ? details : []), tap(() => this.loading.set(false)), startWith([]), shareReplay(1));
  }
  async saveDeal(deal) {
    const metadata = await lastValueFrom(nc(this._org.building.id, "deals-n-offers")).catch(() => null);
    ...
    deals.push(deal);
    await lastValueFrom(rc(this._org.building.id, {
      name: "deals-n-offers",
...
_DealsService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _DealsService, factory: _DealsService.\u0275fac, providedIn: "root" });
var DealsService = _DealsService;
(() => {
...
var _c03 = () => ["/deals-n-offers", "manage"];
var _c1 = (a0) => ({ date: a0 });
...
var _c7 = (a0) => ({ key: "actions", name: " ", size: "3.5rem", content: a0, sortable: false });
var _c8 = (a0, a1, a2, a3, a4, a5) => [a0, a1, a2, a3, a4, a5];
var _c9 = (a0) => ["/deals-n-offers", "manage", a0];
var _forTrack0 = ($index, $item) => $item.id;
function DealsListComponent_For_46_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_49_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 26);
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_49_For_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_49_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "button", 24);
    \u0275\u0275listener("click", function DealsListComponent_Conditional_49_For_2_Template_button_click_1_listener() {
      const deal_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.view(deal_r3));
    });
    \u0275\u0275elementStart(2, "div", 25);
    \u0275\u0275conditionalCreate(3, DealsListComponent_Conditional_49_For_2_Conditional_3_Template, 1, 1, "img", 26);
    \u0275\u0275conditionalCreate(4, DealsListComponent_Conditional_49_For_2_Conditional_4_Template, 2, 1, "div", 27);
    \u0275\u0275elementEnd();
...
function DealsListComponent_Conditional_49_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22);
    \u0275\u0275repeaterCreate(1, DealsListComponent_Conditional_49_For_2_Template, 12, 12, "div", null, _forTrack0);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275conditionalCreate(4, DealsListComponent_Conditional_49_Conditional_4_Template, 11, 8, "div", 23);
    \u0275\u0275pipe(5, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pipeBind1(3, 1, ctx_r3.deals));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_2_0 = \u0275\u0275pipeBind1(5, 3, ctx_r3.deals)) == null ? null : tmp_2_0.length) <= 0 ? 4 : -1);
  }
}
function DealsListComponent_Conditional_50_ng_template_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 38);
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_50_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 37);
    \u0275\u0275conditionalCreate(2, DealsListComponent_Conditional_50_ng_template_8_Conditional_2_Template, 1, 3, "img", 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_50_ng_template_10_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_50_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "div", 40);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, DealsListComponent_Conditional_50_ng_template_10_Conditional_3_Template, 2, 0, "span", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_50_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_50_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DealsListComponent_Conditional_50_ng_template_14_Template_button_click_6_listener() {
    ...
    \u0275\u0275listener("click", function DealsListComponent_Conditional_50_ng_template_14_Template_button_click_20_listener() {
      const deal_r9 = \u0275\u0275restoreView(_r8).row;
      const ctx_r3 = \u0275\u0275nextContext(2);
...
function DealsListComponent_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, DealsListComponent_Conditional_50_ng_template_8_Template, 3, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(10, DealsListComponent_Conditional_50_ng_template_10_Template, 4, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(12, DealsListComponent_Conditional_50_ng_template_12_Template, 3, 4, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(14, DealsListComponent_Conditional_50_ng_template_14_Template, 27, 13, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const image_template_r11 = \u0275\u0275reference(9);
    const description_template_r12 = \u0275\u0275reference(11);
    const valid_until_template_r13 = \u0275\u0275reference(13);
    const actions_template_r14 = \u0275\u0275reference(15);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("data", \u0275\u0275pipeBind1(2, 3, ctx_r3.filtered_deals))("sortable", true)("columns", \u0275\u0275pureFunction6(31, _c8, \u0275\u0275pureFunction2(15, _c2, \u0275\u0275pipeBind1(3, 5, "COMMON.IMAGE"), image_template_r11), \u0275\u0275pureFunction1(18, _c3, \u0275\u0275pipeBind1(4, 7, "FORM.NAME")), \u0275\u0275pureFunction2(20, _c4, \u0275\u0275pipeBind1(5, 9, "COMMON.DESCRIPTION"), description_template_r12), \u0275\u0275pureFunction2(23, _c5, \u0275\u0275pipeBind1(6, 11, "COMMON.VALID_UNTIL"), valid_until_template_r13), \u0275\u0275pureFunction2(26, _c6, \u0275\u0275pipeBind1(7, 13, "COMMON.TERMS"), description_template_r12), \u0275\u0275pureFunction1(29, _c7, actions_template_r14)));
  }
}
var _DealsListComponent = class _DealsListComponent {
  constructor() {
    this._deals = inject(DealsService);
    this.display = signal("list");
    this.expires = new BehaviorSubject(0);
    this.type = new BehaviorSubject("");
    this.deals = this._deals.deals$;
    this.types = this.deals.pipe(map((_) => unique(_.map((d) => d.type)).filter((type) => !!type)));
    this.filtered_deals = combineLatest([
      this.deals,
      this.expires,
      this.type
    ]).pipe(map(([deals, expires, type]) => {
      let deal_list = deals;
      if (expires > 0) {
...
_DealsListComponent.\u0275fac = function DealsListComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DealsListComponent)();
};
_DealsListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealsListComponent, selectors: [["deals-list"]], decls: 51, vars: 30, consts: [["image_template", ""], ["description_template", ""], ["valid_until_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "px-8", "py-4", "pt-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], ["filters", "", 1, "flex", "space-x-2", "px-8", "pb-4"], [1, "flex", "items-center"], ["btn", "", "matRipple", "", "name", "deals-list", 1, "rounded-l", "rounded-r-none", "px-2", 3, "click", "matTooltip"], ["btn", "", "matRipple", "", "name", "deals-grid", 1, "rounded-l-none", "rounded-r", "px-2", 3, "click", "matTooltip"], ["appearance", "outline", 1, "no-subscript"], ["placeholder", "All Deals", 3, "ngModelChange", "ngModel"], [3, "value"], ["placeholder", "All Types", 3, "ngModelChange", "ngModel"], ["value", ""], [1, "capitalize", 3, "value"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "grid", "grid-cols-2", "gap-4", "md:grid-cols-3", "lg:grid-cols-4", "xl:grid-cols-5"], [1, "bg-base-200", "col-span-6", "flex", "w-full", "flex-col", "items-center", "justify-center", "rounded-lg", "p-16"], [1, "border-base-300", "bg-base-100", "mx-auto", "flex", "flex-col", "items-center", "overflow-hidden", "rounded-lg", "border", "shadow-sm", 3, "click"], [1, "bg-base-200", "relative", "h-36", "w-48", "max-w-full", "overflow-hidden", "rounded-b-lg"], ["auth", "", "alt", "Deal Image", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "bg-info", "text-info-content", "absolute", "bottom-2", "left-2", "max-w-full", "truncate", "rounded-sm", "px-2", "py-1", "text-xs", "shadow-sm"], [1, "w-full", "px-4", "py-2", "text-left"], [1, "truncate", "font-bold"], [1, "text-sm", "opacity-60"], ["src", "assets/icons/no-deals.svg", "alt", "No Deals or Offers Available", 1, "mb-8", "w-48"], [1, "flex", "flex-col", "items-center", "space-y-4", "text-center"], [1, "text-lg", "font-bold"], [1, "mb-4", "min-w-5xl"], [1, "text-sm", 3, "data", "sortable", "columns"], [1, "flex", "h-full", "w-full", "items-center", "justify-center", "p-2"], [1, "bg-base-200", "h-16", "w-16", "rounded-sm", "object-cover"], ["auth", "", 1, "bg-base-200", "h-16", "w-16", "rounded-sm", "object-cover", 3, "source", "alt"], [1, "flex", "max-h-24", "overflow-hidden", "px-4", "py-2", "text-sm"], [1, "line-clamp-4"], [1, "opacity-60"], [1, "flex", "p-4"], [1, "flex", "h-full", "w-full", "items-center", "justify-end", "p-1"], ["icon", "", "matRipple", "", "aria-label", "More options", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 1, "min-w-48", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", 3, "routerLink"], ["mat-menu-item", "", 3, "click"], [1, "text-error", "text-2xl"]], template: function DealsListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(20, "browse");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(21, "mat-form-field", 15)(22, "mat-label");
    \u0275\u0275text(23, "All Deals");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "mat-select", 16);
    \u0275\u0275listener("ngModelChange", function DealsListComponent_Template_mat_select_ngModelChange_24_listener($event) {
      return ctx.expires.next($event);
    });
    \u0275\u0275elementStart(25, "mat-option", 17);
    \u0275\u0275text(26, "All Deals");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "mat-option", 17);
    \u0275\u0275text(28, "Expired Deals");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-option", 17);
    \u0275\u0275text(30, "Expires next month");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "mat-option", 17);
    \u0275\u0275text(32, "Expires in 2 months");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "mat-option", 17);
    \u0275\u0275text(34, "Expires in 3 months");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-option", 17);
    \u0275\u0275text(36, "Expires in 6 months");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "mat-option", 17);
    \u0275\u0275text(38, "Expires in 12 months");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(39, "mat-form-field", 15)(40, "mat-label");
    \u0275\u0275text(41, "All Types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "mat-select", 18);
    \u0275\u0275listener("ngModelChange", function DealsListComponent_Template_mat_select_ngModelChange_42_listener($event) {
      return ctx.type.next($event);
    });
    \u0275\u0275elementStart(43, "mat-option", 19);
    \u0275\u0275text(44, "All Types");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(45, DealsListComponent_For_46_Template, 2, 2, "mat-option", 20, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(47, "async");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(48, "div", 21);
    \u0275\u0275conditionalCreate(49, DealsListComponent_Conditional_49_Template, 6, 5, "div", 22)(50, DealsListComponent_Conditional_50_Template, 16, 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(29, _c03));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(7);
    \u0275\u0275property("ngModel", ctx.expires.getValue());
    \u0275\u0275advance();
    \u0275\u0275property("value", 0);
    \u0275\u0275advance(2);
    \u0275\u0275property("value", -1);
    ...
    \u0275\u0275property("value", 12);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", ctx.type.getValue());
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(47, 27, ctx.types));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx.display() === "grid" ? 49 : 50);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
var DealsListComponent = _DealsListComponent;
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsListComponent, { className: "DealsListComponent", filePath: "apps/concierge/src/app/deals/deals-list.component.ts", lineNumber: 345 });
})();
...
function DealsManageComponent_Conditional_0_Conditional_74_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 27)(1, "button", 28);
    \u0275\u0275listener("click", function DealsManageComponent_Conditional_0_Conditional_74_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r3);
...
function DealsManageComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "mat-form-field", 8)(13, "mat-label");
    \u0275\u0275text(14, "Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "input", 9);
    \u0275\u0275elementStart(16, "mat-error");
    \u0275\u0275text(17, "Name is required");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "label", 10);
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "translate");
    ...
    \u0275\u0275pipe(39, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "mat-form-field", 8)(41, "mat-label");
    \u0275\u0275text(42);
    \u0275\u0275pipe(43, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(44, "textarea", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "label", 16);
    \u0275\u0275text(46);
    \u0275\u0275pipe(47, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "mat-form-field", 8)(49, "mat-label");
    \u0275\u0275text(50);
    \u0275\u0275pipe(51, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(52, "textarea", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "label", 18);
    \u0275\u0275text(54);
    \u0275\u0275pipe(55, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-form-field", 8)(57, "mat-label");
    \u0275\u0275text(58);
    \u0275\u0275pipe(59, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(60, "input", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "label", 20);
    \u0275\u0275text(62);
    \u0275\u0275pipe(63, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "div", 21)(65, "mat-form-field", 22)(66, "mat-label");
    \u0275\u0275text(67, "Image URL");
    \u0275\u0275elementEnd();
    \u0275\u0275element(68, "input", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "upload-button", 24);
    \u0275\u0275listener("ngModelChange", function DealsManageComponent_Conditional_0_Template_upload_button_ngModelChange_69_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.form.patchValue({ image: $event }));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(70, "label", 25);
    \u0275\u0275text(71);
    \u0275\u0275pipe(72, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(73, "a-date-field", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(74, DealsManageComponent_Conditional_0_Conditional_74_Template, 4, 3, "footer", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 18, ctx_r1.form.value.id ? "APP.CONCIERGE.DEALS_EDIT" : "APP.CONCIERGE.DEALS_NEW"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r1.loading() ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(9, 20, "FORM.NAME"), " ");
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(20, 22, "COMMON.TYPE"), " ");
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(31, 24, "COMMON.DETAILS"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(35, 26, "COMMON.DETAILS"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(39, 28, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 30, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 32, "COMMON.TERMS"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 34, "COMMON.TERMS"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(55, 36, "COMMON.CODE"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(59, 38, "COMMON.CODE"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(63, 40, "COMMON.IMAGE"));
    \u0275\u0275advance(7);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(44, _c04))("matTooltip", "Upload Image");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(72, 42, "FORM.EXPIRES_AT"));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx_r1.loading() ? 74 : -1);
  }
}
...
var _DealsManageComponent = class _DealsManageComponent extends AsyncHandler {
  constructor() {
    super(...arguments);
...
_DealsManageComponent.\u0275fac = /* @__PURE__ */ (() => {
  let \u0275DealsManageComponent_BaseFactory;
  return function DealsManageComponent_Factory(__ngFactoryType__) {
    return (\u0275DealsManageComponent_BaseFactory || (\u0275DealsManageComponent_BaseFactory = \u0275\u0275getInheritedFactory(_DealsManageComponent)))(__ngFactoryType__ || _DealsManageComponent);
  };
})();
_DealsManageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealsManageComponent, selectors: [["deals-manage"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [[1, "bg-base-100", "absolute", "inset-0", "overflow-auto"], [1, "bg-base-100", "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-4"], [1, "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "items-center", "justify-between", "rounded-sm", "border-none", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "mx-auto", "my-2", "flex", "w-160", "max-w-full", "flex-col", "px-4", "pb-16", 3, "formGroup"], ["for", "name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "Name of the deal or offer", "required", ""], ["for", "type"], ["matInput", "", "name", "type", "formControlName", "type", "placeholder", "Type of the deal or offer", "required", ""], ["for", "details"], ["matInput", "", "name", "details", "formControlName", "details", "placeholder", "Summary of the deal or offer", "required", ""], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", "placeholder", "Description of the deal or offer"], ["for", "terms"], ["matInput", "", "name", "terms", "formControlName", "terms", "placeholder", "Terms and conditions of the deal or offer"], ["for", "code"], ["matInput", "", "name", "code", "formControlName", "code", "placeholder", "Deal/Offer Code"], ["for", "image"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "image", "formControlName", "image", "placeholder", "Image URL"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions", "matTooltip"], ["for", "expires_at"], ["name", "expires_at", "formControlName", "expires_at"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "-translate-x-1/2", "items-center", "justify-end", "rounded-sm", "border-none", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["diameter", "48"]], template: function DealsManageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DealsManageComponent_Conditional_0_Template, 75, 45, "div", 0)(1, DealsManageComponent_Conditional_1_Template, 5, 3, "div", 1);
  }
  if (rf & 2) {
...
var DealsManageComponent = _DealsManageComponent;
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsManageComponent, { className: "DealsManageComponent", filePath: "apps/concierge/src/app/deals/deals-manage.component.ts", lineNumber: 201 });
})();

// apps/concierge/src/app/deals/deals.module.ts
var ROUTES = [
  {
    path: "",
...
var _DealsModule = class _DealsModule {
};
_DealsModule.\u0275fac = function DealsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DealsModule)();
};
_DealsModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _DealsModule });
_DealsModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [
  DealsListComponent,
  DealsManageComponent,
  DealsComponent,
  RouterModule.forChild(ROUTES)
] });
var DealsModule = _DealsModule;
(() => {
...
//# sourceMappingURL=deals.module-7FIEJY22.js.map
