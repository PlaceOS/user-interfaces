...
_FacilitiesTopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FacilitiesTopbarComponent, selectors: [["facilities-topbar"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 15, vars: 7, consts: [[1, "border-base-200", "bg-base-100", "flex", "h-20", "items-center", "space-x-2", "border-b", "px-4"], ["appearance", "outline"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["multiple", "", "placeholder", "No Events", 3, "ngModelChange", "ngModel"], [1, "flex-full"], [1, "mr-2"]], template: function FacilitiesTopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=facilities.module-BYGEETE6.js.map
