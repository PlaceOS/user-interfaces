...
var GroupEventsStateService = class _GroupEventsStateService {
  ...
  constructor() {
    ...
    effect(async () => {
      ...
      const sys = await ba({ in: this.calendar }).then((r) => r.data?.[0]).catch(() => null);
      if (!sys) {
        this._events.set([]);
        return;
      }
...
var GroupEventsComponent = class _GroupEventsComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GroupEventsComponent, selectors: [["", "group-events", ""]], features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 2, consts: [[1, "bg-base-200", "flex", "h-1/2", "flex-1", "flex-col", "sm:flex-row"], [1, "h-full", "w-full", "flex-1", "overflow-auto", "p-2", "sm:w-1/2", "sm:p-4"], [1, "mx-auto", "my-2", "w-5xl", "max-w-full", 3, "event", "featured"], [1, "mx-auto", "mt-2", "flex", "w-5xl", "max-w-full", "flex-wrap"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "m-2", 3, "event"], ["src", "assets/icons/no-results.svg", 1, "w-32"], [1, "font-medium"], [1, "opacity-30"]], template: function GroupEventsComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "topbar");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GroupEventsComponent, { className: "GroupEventsComponent", filePath: "apps/workplace/src/app/events/group-events.component.ts", lineNumber: 85 });
})();
...
//# debugId=77926be2-64cb-5476-b749-0f0a75f1ca76
//# sourceMappingURL=group-events.routes-NVUI4MTQ.js.map
