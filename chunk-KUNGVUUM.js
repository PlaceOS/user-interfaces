...
import {
  ...
  MatChipRow,
  MatChipsModule
} from "./chunk-EKG66BDR.js";
import {
  ExploreStateService
} from "./chunk-FRLJPUB4.js";
import {
...
var ScheduleStateService = class _ScheduleStateService extends AsyncHandler {
  ...
  async remove(item, remove_series = false) {
    ...
    await (item instanceof CalendarEvent && !item.from_bookings ? removeEvent : removeBooking)(remove_series ? item.recurring_event_id || item.id : item.id, {
      ...
      notifyError(i18n(remove_series ? "APP.WORKPLACE.SCHEDULE_REMOVE_SERIES_ERROR" : "APP.WORKPLACE.SCHEDULE_REMOVE_ERROR", { error: await responseErrorMessage(e) }));
      resp.close();
      throw e;
    });
  ...
  async end(item) {
    ...
    const promise = setBookingCheckedIn(item, false).catch(async (e) => {
      notifyError(i18n("APP.WORKPLACE.SCHEDULE_END_ERROR", {
...
//# debugId=858bfc42-d4d3-52a5-bd29-4881b2686d8a
//# sourceMappingURL=chunk-KUNGVUUM.js.map
