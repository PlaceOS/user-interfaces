...
} from "./chunk-KJIETZ2D.js";
import {
  ParkingStateService
} from "./chunk-VFJ5N666.js";
import {
  MatTab,
  MatTabGroup,
  MatTabsModule
...
import {
  LockerListComponent
} from "./chunk-YUPYMD4Y.js";
import {
  LockerStateService
} from "./chunk-SYPKT42Q.js";
import {
  BookingRulesModalComponent
} from "./chunk-QPOGMIJL.js";
import {
  SearchbarComponent
...
var _RoomAlertModalComponent = class _RoomAlertModalComponent {
  ...
  async save() {
    this.loading = true;
    const metadata = await Iu(this._org.organisation.id, "room_alerts").toPromise().catch((e) => {
    ...
    await Pu(this._org.organisation.id, {
      name: "room_alerts",
...
var _RoomModalComponent = class _RoomModalComponent extends AsyncHandler {
  constructor() {
    ...
    this.query_fn = (_) => ea({ q: _ }).pipe(map((resp) => resp.data));
  ...
  async ngOnInit() {
    const { details } = await Iu(this._org.organisation.id, "settings").toPromise();
  ...
  async save() {
    ...
    await lastValueFrom(Pu(this._org.organisation.id, {
      name: "settings",
    ...
    await lastValueFrom(data.id ? wc(data.id, data) : Oc(data));
...
_RoomModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomModalComponent, selectors: [["room-form-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 50, vars: 42, consts: [["auto", "matAutocomplete"], ["chipList", ""], [3, "confirm", "heading", "loading"], ["system", "", 3, "formGroup"], [1, "flex", "flex-col"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col"], [1, "flex", "space-x-2", 3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "setup", 1, "flex", "items-center"], [1, "ml-2", "text-base", 3, "matTooltip"], ["name", "setup", "formControlName", "setup", 3, "min"], ["for", "breakdown", 1, "flex", "items-center"], ["name", "breakdown", "formControlName", "breakdown", 3, "min"], [1, "mb-4", "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col", "pt-4"], [1, "mb-4", "flex", "flex-col"], ["for", "timezone"], ["appearance", "outline"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "timezone", 3, "placeholder", "matAutocomplete"], [3, "value"], [3, "disabled"], ["for", "zone"], ["formControlName", "zone", 3, "placeholder"], ["for", "system-name"], ["matInput", "", "name", "system-name", "formControlName", "name", "required", "", 3, "placeholder"], ["for", "system-email"], ["matInput", "", "name", "system-email", "formControlName", "email", 3, "placeholder"], ["for", "display-name"], ["matInput", "", "name", "display-name", "formControlName", "display_name", 3, "placeholder"], ["for", "code-name"], ["matInput", "", "name", "code-name", "formControlName", "code", 3, "placeholder"], ["formControlName", "approval", 3, "name"], ["formControlName", "bookable", 3, "name"], ["for", "capacity"], ["name", "capacity", "formControlName", "capacity", 1, "w-full", 3, "min", "max"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 3, "placeholder"], [3, "aria-label"], [3, "selectable", "removable"], [3, "matChipInputTokenEnd", "placeholder", "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur"], [3, "removed", "selectable", "removable"], ["matChipRemove", ""], ["for", "map_id"], ["matInput", "", "name", "map_id", "formControlName", "map_id", 3, "placeholder"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", "border", "border-secondary", "text-secondary", 3, "click", "matTooltip"], ["for", "images"], ["name", "images", "formControlName", "images"]], template: function RoomModalComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 26, ctx.form.value.id ? "APP.CONCIERGE.ROOMS_EDIT" : "APP.CONCIERGE.ROOMS_NEW"))("loading", ctx.loading ? \u0275\u0275pipeBind1(2, 28, "APP.CONCIERGE.ROOMS_SAVING") : "");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 30, "APP.CONCIERGE.ROOMS_DEFAULT_SETUP"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(17, 32, "APP.CONCIERGE.ROOMS_SETUP_INFO"));
    \u0275\u0275advance(3);
    \u0275\u0275property("min", 0);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(23, 34, "APP.CONCIERGE.ROOMS_DEFAULT_BREAKDOWN"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(25, 36, "APP.CONCIERGE.ROOMS_BREAKDOWN_INFO"));
    \u0275\u0275advance(3);
    \u0275\u0275property("min", 0);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(38, 38, "COMMON.TIMEZONE"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(43, 40, "COMMON.TIMEZONE"))("matAutocomplete", auto_r10);
    \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomModalComponent, { className: "RoomModalComponent", filePath: "apps/concierge/src/app/room-manager/room-modal.component.ts", lineNumber: 430 });
})();
...
var _RoomManagementService = class _RoomManagementService {
  constructor() {
    ...
    ]).pipe(switchMap(() => Iu(this._org.organisation.id, "room_alerts")), map((_) => _.details || {}), shareReplay(1));
...
//# sourceMappingURL=resource-manager.module-6RSAKBPC.js.map
