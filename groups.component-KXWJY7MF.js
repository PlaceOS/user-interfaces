...
function SignageGroupFeaturesModalComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(3, SignageGroupFeaturesModalComponent_Conditional_8_For_4_Template, 6, 7, "li", 9, _forTrack06, false, SignageGroupFeaturesModalComponent_Conditional_8_ForEmpty_5_Template, 3, 3, "li", 10);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275repeaterCreate(8, SignageGroupFeaturesModalComponent_Conditional_8_For_9_Template, 2, 2, "mat-checkbox", 11, _forTrack06, false, SignageGroupFeaturesModalComponent_Conditional_8_ForEmpty_10_Template, 3, 3, "p", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var SignageGroupFeaturesModalComponent = class _SignageGroupFeaturesModalComponent {
  constructor() {
    ...
    this._service = inject(SignageService);
    this.group = this._data.group;
    this.plugins = this._service.all_plugins;
  ...
  async _load() {
    try {
      ...
      const inherited = await this._service.loadGroupFeatures(group.parent_id);
      this.group = group;
  ...
  async save() {
    ...
    this._dialog_ref.disableClose = true;
    try {
      const result = await this._service.saveGroupFeatures(this.group, this._withKnownPlugins(this.own()));
      this._dialog_ref.disableClose = false;
      if (result)
        this._dialog_ref.close(result);
      else
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupFeaturesModalComponent, selectors: [["signage-group-features-modal"]], decls: 11, vars: 14, consts: [["list_header", ""], [3, "confirm", "heading", "loading", "confirm_disabled"], [1, "flex", "w-[36rem]", "max-w-full", "flex-col", "gap-4"], [1, "text-base-content/70", "text-sm"], [1, "flex", "justify-center", "p-8"], ["diameter", "32"], [1, "border-base-300", "flex", "flex-col", "rounded-lg", "border"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "divide-base-300", "divide-y"], [1, "flex", "items-center", "gap-3", "px-4", "py-3"], [1, "text-base-content/60", "p-4", "text-sm"], [1, "px-2", 3, "ngModel"], [1, "min-w-0", "flex-1", "text-sm"], [3, "ngModelChange", "ngModel", "aria-label"], [1, "px-2", 3, "ngModelChange", "ngModel"], [1, "border-base-300", "flex", "items-center", "gap-3", "border-b", "px-4", "py-3"], [1, "min-w-0", "flex-1"], [1, "text-sm", "font-medium"], [1, "text-base-content/60", "text-xs"], ["btn", "", "matRipple", "", "type", "button", 1, "clear", "text-xs"], ["btn", "", "matRipple", "", "type", "button", 1, "clear", "text-xs", 3, "click"]], template: function SignageGroupFeaturesModalComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind2(1, 5, "SIGNAGE_MANAGER.GROUP_FEATURES_HEADING", \u0275\u0275pureFunction1(12, _c03, ctx.group.name)))("loading", ctx.saving() ? \u0275\u0275pipeBind1(2, 8, "SIGNAGE_MANAGER.GROUP_SAVING") : "")("confirm_disabled", !ctx.inherited_loaded());
        \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupFeaturesModalComponent, { className: "SignageGroupFeaturesModalComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-features-modal.component.ts", lineNumber: 181 });
})();
...
function SignageGroupDetailHeaderComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(15, "translate");
    \u0275\u0275listener("click", function SignageGroupDetailHeaderComponent_Conditional_0_Template_button_click_14_listener() {
      const group_r4 = \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 5, "SIGNAGE_MANAGER.BACK_TO_GROUPS"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx.name || \u0275\u0275pipeBind1(8, 7, "SIGNAGE_MANAGER.UNNAMED_GROUP"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.can_edit_features() ? 9 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(11, 9, "SIGNAGE_MANAGER.EDIT_GROUP_TOOLTIP"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(15, 11, "SIGNAGE_MANAGER.REMOVE_GROUP_TOOLTIP"));
  }
}
var SignageGroupDetailHeaderComponent = class _SignageGroupDetailHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupDetailHeaderComponent, selectors: [["signage-group-detail-header"]], decls: 1, vars: 1, consts: [[1, "bg-base-100", "border-base-300", "mx-2", "flex", "items-center", "gap-2", "rounded-b-lg", "border", "px-4", "py-3"], ["icon", "", "matRipple", "", "type", "button", 1, "desktop-hidden", 3, "click"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-lg", "font-medium"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"]], template: function SignageGroupDetailHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, SignageGroupDetailHeaderComponent_Conditional_0_Template, 18, 13, "div", 0);
      }
      if (rf & 2) {
        let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupDetailHeaderComponent, { className: "SignageGroupDetailHeaderComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-detail-header.component.ts", lineNumber: 85 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageGroupHeaderComponent, selectors: [["signage-group-header"]], decls: 12, vars: 11, consts: [[1, "bg-base-100", "border-base-300", "sticky", "top-0", "z-10", "flex", "flex-nowrap", "items-center", "gap-4", "border-b", "px-4", "py-3", "shadow"], [1, "flex-1", "shrink-0"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "gap-4"], [1, "text-sm", "opacity-60"], [1, "min-w-0", "flex-1", "overflow-hidden"], ["icon", "", "default", "", "type", "button", "matRipple", "", "matTooltipPosition", "left", 1, "text-xl", 3, "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", "matTooltipPosition", "left", 1, "text-xl", 3, "click", "matTooltip"]], template: function SignageGroupHeaderComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(8, 5, "SIGNAGE_MANAGER.GROUP_COUNT", \u0275\u0275pureFunction1(9, _c04, ctx.group_count()), ctx.group_count()), " ");
        \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageGroupHeaderComponent, { className: "SignageGroupHeaderComponent", filePath: "apps/signage-manager/src/app/groups/signage-group-header.component.ts", lineNumber: 60 });
})();
...
function SignageGroupListComponent_Conditional_7_Conditional_0_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(1, 10, "SIGNAGE_MANAGER.OPEN_GROUP", \u0275\u0275pureFunction1(15, _c05, group_r2.name || group_r2.id)));
    \u0275\u0275advance(5);
...
function SignageGroupListComponent_Conditional_8_cdk_tree_node_1_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const row_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(1, 2, ctx_r2.isExpanded(row_r6.group) ? "SIGNAGE_MANAGER.COLLAPSE_GROUP" : "SIGNAGE_MANAGER.EXPAND_GROUP", \u0275\u0275pureFunction1(5, _c05, row_r6.group.name || row_r6.group.id)));
    \u0275\u0275advance(3);
...
//# debugId=52353991-943c-5786-b6f8-ce534d25c079
//# sourceMappingURL=groups.component-KXWJY7MF.js.map
