...
var _BookingRulesFormComponent = class _BookingRulesFormComponent {
  constructor() {
    ...
    this.building_zones = this._org.active_building.pipe(filter((_) => !!_), switchMap((bld) => ta({ parent_id: bld.id }).pipe(catchError(() => of({ data: [] })))), map((res) => res.data), shareReplay(1));
...
var _c7 = (a0) => ({ key: "actions", name: " ", size: "11.5rem", content: a0 });
...
function BookingRulesModalComponent_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function BookingRulesModalComponent_ng_template_19_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275listener("click", function BookingRulesModalComponent_ng_template_19_Template_button_click_5_listener() {
      const row_r14 = \u0275\u0275restoreView(_r13).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateRulesetPriority(row_r14, -1));
    });
    \u0275\u0275elementStart(7, "icon");
    \u0275\u0275text(8, "arrow_upward");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "button", 23);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("click", function BookingRulesModalComponent_ng_template_19_Template_button_click_9_listener() {
      const row_r14 = \u0275\u0275restoreView(_r13).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateRulesetPriority(row_r14, 1));
    });
    \u0275\u0275elementStart(11, "icon");
    \u0275\u0275text(12, "arrow_downward");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "button", 23);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275listener("click", function BookingRulesModalComponent_ng_template_19_Template_button_click_13_listener() {
      const row_r14 = \u0275\u0275restoreView(_r13).row;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeRuleset(row_r14));
    });
    \u0275\u0275elementStart(15, "icon", 24);
    \u0275\u0275text(16, "delete");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(2, 4, "APP.CONCIERGE.BOOKING_RULESET_EDIT"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(6, 6, "APP.CONCIERGE.BOOKING_RULESET_PRIORITY_UP"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(10, 8, "APP.CONCIERGE.BOOKING_RULESET_PRIORITY_DOWN"));
    \u0275\u0275advance(4);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(14, 10, "APP.CONCIERGE.BOOKING_RULESET_REMOVE"));
  }
}
...
function BookingRulesModalComponent_footer_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BookingRulesModalComponent_footer_21_button_1_Template, 3, 3, "button", 26)(2, BookingRulesModalComponent_footer_21_button_2_Template, 3, 3, "button", 27)(3, BookingRulesModalComponent_footer_21_button_3_Template, 3, 3, "button", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var _BookingRulesModalComponent = class _BookingRulesModalComponent {
  constructor() {
    ...
    this.booking_rules = combineLatest([this._org.active_building, this.change]).pipe(filter(([_]) => !!_), switchMap(([bld]) => {
      return Pu(bld.id, `${this._data.type}_booking_rules`).pipe(catchError(() => of({ details: [] })));
...
_BookingRulesModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingRulesModalComponent, selectors: [["app-booking-rules-modal"]], decls: 22, vars: 17, consts: [["index_template", ""], ["conditions_template", ""], ["zone_template", ""], ["bool_template", ""], ["actions_template", ""], [3, "heading", "loading", "hide_confirm"], [1, "-mx-2", "mb-2", "w-[calc(100%+1rem)]", "rounded", "bg-info", "p-4", "text-center", "text-xs", "text-info-content"], [3, "ngSwitch"], [3, "ruleset", "save", "rulesetChange", 4, "ngSwitchCase"], [1, "-mx-2", "w-[calc(100%+1rem)]", "overflow-auto"], ["class", "block w-full min-w-[48rem] text-sm", 3, "data", "columns", 4, "ngSwitchCase"], ["class", "fixed bottom-0 left-1/2 z-10 mx-auto my-2 flex w-full max-w-[39rem] -translate-x-1/2 items-center justify-end space-x-4 rounded border-none bg-base-200 px-4 py-2", 4, "ngIf"], [3, "rulesetChange", "ruleset", "save"], [1, "block", "w-full", "min-w-[48rem]", "text-sm", 3, "data", "columns"], [1, "m-auto", "p-4", "font-medium"], [1, "p-4"], ["class", "px-4 py-2", 4, "ngIf"], ["class", "px-4 py-2 font-mono italic", 4, "ngIf"], [1, "px-4", "py-2"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "px-4", "py-2", "font-mono", "italic"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "text-2xl", "text-white"], [1, "mx-auto", "flex", "w-full", "items-center", "space-x-2", "px-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "text-error"], [1, "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[39rem]", "-translate-x-1/2", "items-center", "justify-end", "space-x-4", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], ["btn", "", "matRipple", "", "class", "inverse w-36", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", "class", "w-36", 3, "click", 4, "ngIf"], ["btn", "", "matRipple", "", 1, "inverse", "w-36", 3, "click"], ["btn", "", "matRipple", "", 1, "w-36", 3, "click"]], template: function BookingRulesModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingRulesModalComponent, { className: "BookingRulesModalComponent", filePath: "apps/concierge/src/app/ui/booking-rules-modal.component.ts", lineNumber: 262 });
})();

export {
  BookingRulesModalComponent
};
//# sourceMappingURL=chunk-YUTBF2L5.js.map
