...
var RoomAlertModalComponent = class _RoomAlertModalComponent {
  ...
  async save() {
    ...
    const metadata = await ju(this._org.organisation.id, "room_alerts").catch((e) => {
    ...
    await Gu(this._org.organisation.id, {
      name: "room_alerts",
...
function RoomModalComponent_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(6, 5, "APP.CONCIERGE.ROOMS_CODE"))("formField", ctx_r1.form.code);
    \u0275\u0275control();
  }
}
...
var RoomModalComponent = class _RoomModalComponent extends AsyncHandler {
  ...
  async ngOnInit() {
    const { details } = await ju(this._org.organisation.id, "settings");
  ...
  async save() {
    ...
    await (data.id ? ia(data.id, data) : ra(data));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomModalComponent, { className: "RoomModalComponent", filePath: "apps/concierge/src/app/room-manager/room-modal.component.ts", lineNumber: 475 });
})();
...
var RoomManagementService = class _RoomManagementService {
  constructor() {
    ...
    this._room_alerts = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_room_alerts" } : (
      ...
      loader: async () => {
        const metadata = await ju(this._org.organisation.id, "room_alerts").catch(() => ({ details: {} }));
...
//# sourceMappingURL=room-manager.routes-IEHEI3CK.js.map
