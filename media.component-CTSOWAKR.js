import {
  ...
  MatTabNavPanel,
  MatTabsModule
} from "./chunk-ISGRHO7M.js";
import {
  CdkDrag,
  CdkDragPlaceholder,
  CdkDropList,
  DragDropModule
} from "./chunk-AZP2KAW5.js";
import {
  PlaylistThumbnailComponent
} from "./chunk-YKQW6VDW.js";
import {
  GroupBreadcrumbsComponent
} from "./chunk-BSUFRVVA.js";
import {
  NavFooterComponent,
  NavSidebarComponent
} from "./chunk-SPCJEKB5.js";
import {
  IntersectDirective
} from "./chunk-RH2ZNZ4A.js";
import "./chunk-3AKDHGBZ.js";
import {
  MediaDurationPipe
} from "./chunk-DN325Y4F.js";
import {
  MatCheckbox,
  MatCheckboxModule
} from "./chunk-SMPBGOJX.js";
import {
  FullscreenModalShellComponent
} from "./chunk-JLKVSLS3.js";
import {
  MatSelect,
  MatSelectModule
...
} from "./chunk-R3USX2XC.js";
import "./chunk-IURE73WI.js";
import {
  MatTooltip,
  MatTooltipModule
} from "./chunk-FC52RDLE.js";
import "./chunk-VK7CM6JR.js";
import {
  RouterLink
} from "./chunk-JUNGKQZF.js";
import {
  Component,
...
function MediaListHeaderComponent_Conditional_19_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 17);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_Conditional_0_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.generateWithAI());
    });
    \u0275\u0275elementStart(3, "icon");
  ...
  if (rf & 2) {
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(1, 2, "SIGNAGE_MANAGER.AI_CREATE_IMAGE"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 4, "SIGNAGE_MANAGER.AI_CREATE_IMAGE"));
  }
}
function MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_1_For_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const plugin_r7 = ctx.$implicit;
    \u0275\u0275property("value", plugin_r7);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", plugin_r7.name, " ");
  }
}
function MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 26)(1, "mat-select", 27);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_1_Template_mat_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r0.selected_plugin, $event) || (ctx_r0.selected_plugin = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275repeaterCreate(4, MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_1_For_5_Template, 2, 2, "mat-option", 28, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 29);
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_1_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.addFromPlugin());
    });
    \u0275\u0275elementStart(7, "icon", 30);
    \u0275\u0275text(8, "add");
    \u0275\u0275elementEnd();
...
function MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function MediaListHeaderComponent_Conditional_19_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275conditionalCreate(1, MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_1_Template, 12, 11)(2, MediaListHeaderComponent_Conditional_19_ng_template_6_Conditional_2_Template, 3, 3, "p", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MediaListHeaderComponent_Conditional_19_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24)(1, "mat-form-field", 26)(2, "input", 13);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function MediaListHeaderComponent_Conditional_19_ng_template_13_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_ng_template_13_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.addFromLink());
    });
    \u0275\u0275elementStart(6, "icon", 30);
    \u0275\u0275text(7, "add");
    \u0275\u0275elementEnd();
...
function MediaListHeaderComponent_Conditional_19_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 20);
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_Conditional_27_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.generateWithAI());
    });
  ...
  if (rf & 2) {
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 1, "SIGNAGE_MANAGER.AI_CREATE_IMAGE"), " ");
  }
}
function MediaListHeaderComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275conditionalCreate(0, MediaListHeaderComponent_Conditional_19_Conditional_0_Template, 5, 6, "button", 15);
    ...
    \u0275\u0275text(5, "extension");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, MediaListHeaderComponent_Conditional_19_ng_template_6_Template, 3, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    ...
    \u0275\u0275text(12, "link");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, MediaListHeaderComponent_Conditional_19_ng_template_13_Template, 11, 10, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(15, "button", 17);
    \u0275\u0275pipe(16, "translate");
    \u0275\u0275pipe(17, "translate");
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r4);
      const upload_input_r9 = \u0275\u0275reference(50);
      return \u0275\u0275resetView(upload_input_r9.click());
    });
    ...
    \u0275\u0275conditionalCreate(27, MediaListHeaderComponent_Conditional_19_Conditional_27_Template, 7, 3, "button", 19);
    \u0275\u0275elementStart(28, "button", 20);
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.openAdd("plugin"));
    });
    \u0275\u0275elementStart(29, "div", 21)(30, "icon", 22);
    \u0275\u0275text(31, "extension");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_Template_button_click_35_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.openAdd("link"));
    });
    \u0275\u0275elementStart(36, "div", 21)(37, "icon", 22);
    \u0275\u0275text(38, "link");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MediaListHeaderComponent_Conditional_19_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r4);
      const upload_input_r9 = \u0275\u0275reference(50);
      return \u0275\u0275resetView(upload_input_r9.click());
    });
    \u0275\u0275elementStart(43, "div", 21)(44, "icon", 22);
    \u0275\u0275text(45, "upload");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(48, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(49, "input", 23, 3);
    \u0275\u0275pipe(51, "translate");
    \u0275\u0275listener("change", function MediaListHeaderComponent_Conditional_19_Template_input_change_49_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const add_plugin_template_r11 = \u0275\u0275reference(7);
    const add_link_template_r12 = \u0275\u0275reference(14);
    const actions_menu_r13 = \u0275\u0275reference(26);
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r0.ai_enabled() ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("content", add_plugin_template_r11)("matTooltip", \u0275\u0275pipeBind1(2, 18, "SIGNAGE_MANAGER.ADD_PLUGIN"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(3, 20, "SIGNAGE_MANAGER.ADD_PLUGIN_ARIA"));
    \u0275\u0275advance(7);
    \u0275\u0275property("content", add_link_template_r12)("matTooltip", \u0275\u0275pipeBind1(9, 22, "SIGNAGE_MANAGER.ADD_FROM_LINK"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(10, 24, "SIGNAGE_MANAGER.ADD_FROM_LINK_ARIA"));
    \u0275\u0275advance(7);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(16, 26, "SIGNAGE_MANAGER.UPLOAD_MEDIA"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(17, 28, "SIGNAGE_MANAGER.UPLOAD_MEDIA_ARIA"));
    \u0275\u0275advance(5);
    \u0275\u0275property("matMenuTriggerFor", actions_menu_r13)("matTooltip", \u0275\u0275pipeBind1(21, 30, "SIGNAGE_MANAGER.MEDIA_ACTIONS"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(22, 32, "SIGNAGE_MANAGER.MEDIA_ACTIONS"));
    \u0275\u0275advance(7);
    \u0275\u0275conditional(ctx_r0.ai_enabled() ? 27 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(34, 34, "SIGNAGE_MANAGER.ADD_PLUGIN"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(41, 36, "SIGNAGE_MANAGER.ADD_FROM_LINK"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(48, 38, "SIGNAGE_MANAGER.UPLOAD_MEDIA"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275attribute("accept", ctx_r0.file_accept)("aria-label", \u0275\u0275pipeBind1(51, 40, "SIGNAGE_MANAGER.UPLOAD_MEDIA_ARIA"));
  }
}
...
var MediaListHeaderComponent = class _MediaListHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MediaListHeaderComponent, selectors: [["media-list-header"]], decls: 20, vars: 15, consts: [["add_plugin_template", ""], ["add_link_template", ""], ["actions_menu", "matMenu"], ["upload_input", ""], [1, "bg-base-100", "border-base-300", "sticky", "top-0", "flex", "flex-wrap", "items-center", "gap-1", "border-b", "px-4", "py-2", "shadow", "sm:flex-nowrap", "sm:gap-2"], [1, "py-2"], [1, "text-2xl", "font-medium"], [1, "flex", "flex-wrap", "items-center", "gap-2"], [1, "text-sm", "opacity-60"], [1, "w-px", "flex-1"], ["role", "group", 1, "border-base-300", "bg-base-200", "flex", "items-center", "rounded-lg", "border", "p-1"], ["icon", "", "type", "button", "matRipple", "", 1, "h-10", "w-10", "rounded-md", 3, "bg-base-100", "shadow", "text-base-content/60", "matTooltip"], ["appearance", "outline", 1, "no-subscript", "toolbar-field", "white", "order-last", "w-full", "sm:order-0", "sm:w-80"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["icon", "", "type", "button", "matRipple", "", 1, "h-10", "w-10", "rounded-md", 3, "click", "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", "matTooltipPosition", "left", 1, "text-xl", "max-sm:hidden", 3, "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", "customTooltip", "", "matTooltipPosition", "left", 1, "text-xl", "max-sm:hidden", 3, "content", "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", "matTooltipPosition", "left", 1, "text-xl", "max-sm:hidden", 3, "click", "matTooltip"], ["icon", "", "default", "", "type", "button", "matRipple", "", "matTooltipPosition", "left", 1, "desktop-hidden", "text-xl", 3, "matMenuTriggerFor", "matTooltip"], ["mat-menu-item", "", "type", "button"], ["mat-menu-item", "", "type", "button", 3, "click"], [1, "flex", "items-center", "gap-2"], [1, "text-2xl"], ["type", "file", "multiple", "", 1, "sr-only", 3, "change"], [1, "border-base-300", "bg-base-100", "my-2", "flex", "w-[20rem]", "flex-col", "space-y-4", "rounded-lg", "border", "p-4", "shadow-sm"], [1, "text-base-content/60", "m-0", "text-sm"], ["appearance", "outline", 1, "no-subscript"], [3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], ["btn", "", "type", "button", "matRipple", "", 1, "w-full", 3, "click", "disabled"], [1, "mr-2", "text-2xl"], ["btn", "", "type", "button", "matRipple", "", 1, "w-full", 3, "click"]], template: function MediaListHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(19, MediaListHeaderComponent_Conditional_19_Template, 52, 42);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MediaListHeaderComponent, { className: "MediaListHeaderComponent", filePath: "apps/signage-manager/src/app/media/media-list-header.component.ts", lineNumber: 345 });
})();

// apps/signage-manager/src/app/media/media-list.component.ts
var _c02 = (a0) => ({ count: a0 });
var _c1 = (a0) => ({ folder: a0 });
var _c2 = (a0) => ({ tag: a0 });
var _c3 = (a0) => ({ name: a0 });
var _c4 = (a0) => ({ item: a0 });
...
function MediaListComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.can_manage_all_groups() ? 2 : -1);
    \u0275\u0275advance();
...
function MediaListComponent_Conditional_1_Conditional_0_For_2_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function MediaListComponent_Conditional_1_Conditional_0_For_2_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const folder_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275nextContext(3);
    const folder_menu_r8 = \u0275\u0275reference(4);
    \u0275\u0275property("matMenuTriggerFor", folder_menu_r8)("matMenuTriggerData", \u0275\u0275pureFunction1(6, _c1, folder_r7));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(1, 3, "SIGNAGE_MANAGER.MEDIA_TAG_ACTIONS", \u0275\u0275pureFunction1(8, _c2, folder_r7.id)));
  }
}
function MediaListComponent_Conditional_1_Conditional_0_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MediaListComponent_Conditional_1_Conditional_0_For_2_Template_button_click_1_listener() {
    ...
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275conditionalCreate(6, MediaListComponent_Conditional_1_Conditional_0_For_2_Conditional_6_Template, 2, 3)(7, MediaListComponent_Conditional_1_Conditional_0_For_2_Conditional_7_Template, 1, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 15);
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(11, MediaListComponent_Conditional_1_Conditional_0_For_2_Conditional_11_Template, 4, 10, "button", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", folder_r7.untagged ? \u0275\u0275pipeBind1(5, 5, "SIGNAGE_MANAGER.UNTAGGED") : folder_r7.id);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(folder_r7.untagged ? 6 : 7);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(10, 7, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(10, _c02, folder_r7.count)), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!folder_r7.untagged && ctx_r1.can_update_media_tags() ? 11 : -1);
  }
}
function MediaListComponent_Conditional_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 8);
    \u0275\u0275repeaterCreate(1, MediaListComponent_Conditional_1_Conditional_0_For_2_Template, 12, 12, "div", 11, _forTrack12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "icon", 45);
    \u0275\u0275text(2, "add");
    \u0275\u0275elementEnd()();
  }
}
...
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const media_item_r12 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, media_item_r12.play_time / 1e3), " ");
  }
}
...
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_16_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const media_item_r12 = \u0275\u0275nextContext(3).$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("matTooltip", ctx_r1.remainingTags(media_item_r12).join(", "));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" +", ctx_r1.remainingTagCount(media_item_r12), " ");
  }
}
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 42);
    \u0275\u0275repeaterCreate(1, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_16_For_2_Template, 2, 1, "span", 46, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(3, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_16_Conditional_3_Template, 2, 2, "span", 47);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const media_item_r12 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.visibleTags(media_item_r12));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.remainingTagCount(media_item_r12) > 0 ? 3 : -1);
  }
}
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_div_1_Template, 3, 0, "div", 32);
    \u0275\u0275elementStart(2, "mat-checkbox", 33);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275listener("click", function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Template_mat_checkbox_click_2_listener($event) {
      ...
      \u0275\u0275restoreView(_r11);
      const media_item_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.toggleSelection(media_item_r12.id));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Template_button_click_4_listener() {
      ...
      const media_item_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.previewItem(media_item_r12));
    });
    \u0275\u0275element(6, "media-thumbnail", 35);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_14_Template, 3, 3, "span", 40);
    \u0275\u0275conditionalCreate(15, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_15_Template, 3, 3, "span", 41);
    \u0275\u0275conditionalCreate(16, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Conditional_16_Template, 4, 1, "div", 42);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("opacity-60", ctx_r1.isExpired(media_item_r12))("ring-2", ctx_r1.isSelected(media_item_r12.id))("ring-primary", ctx_r1.isSelected(media_item_r12.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", ctx_r1.isSelected(media_item_r12.id));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(3, 21, "SIGNAGE_MANAGER.SELECT_MEDIA", \u0275\u0275pureFunction1(31, _c3, media_item_r12.name)));
    \u0275\u0275advance(2);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(5, 24, "SIGNAGE_MANAGER.PREVIEW_MEDIA", \u0275\u0275pureFunction1(33, _c3, media_item_r12.name)));
    \u0275\u0275advance(2);
    \u0275\u0275property("item", media_item_r12);
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", media_item_r12.name);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", media_item_r12.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r1.typeBadgeClass(media_item_r12));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 27, ctx_r1.typeLabelKey(media_item_r12)), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.isExpired(media_item_r12) ? 14 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(media_item_r12.play_time ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(media_item_r12.tags?.length ? 16 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", menu_r14)("matMenuTriggerData", \u0275\u0275pureFunction1(35, _c4, media_item_r12));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(18, 29, "SIGNAGE_MANAGER.MEDIA_ACTIONS"));
  }
}
...
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52)(1, "icon", 59);
...
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_20_For_2_Template, 2, 1, "span", 60, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(3, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_20_Conditional_3_Template, 2, 2, "span", 61);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const media_item_r12 = \u0275\u0275nextContext(2).$implicit;
...
function MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_div_1_Template, 3, 0, "div", 32);
    \u0275\u0275elementStart(2, "mat-checkbox", 49);
    \u0275\u0275pipe(3, "translate");
    ...
    \u0275\u0275conditionalCreate(6, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_6_Template, 3, 3, "div", 51);
    \u0275\u0275element(7, "media-thumbnail", 35);
    \u0275\u0275conditionalCreate(8, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_8_Template, 3, 0, "div", 52);
    \u0275\u0275elementStart(9, "div", 53);
    \u0275\u0275text(10);
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_12_Template, 3, 3, "div", 54);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(19, "more_vert");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(20, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Conditional_20_Template, 4, 1, "div", 58);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const media_item_r12 = \u0275\u0275nextContext().$implicit;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", ctx_r1.isSelected(media_item_r12.id));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(3, 22, "SIGNAGE_MANAGER.SELECT_MEDIA", \u0275\u0275pureFunction1(32, _c3, media_item_r12.name)));
    \u0275\u0275advance(2);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind2(5, 25, "SIGNAGE_MANAGER.PREVIEW_MEDIA", \u0275\u0275pureFunction1(34, _c3, media_item_r12.name)));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.isExpired(media_item_r12) ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("item", media_item_r12);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.thumbnailUrl(media_item_r12) ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275classMap(ctx_r1.typeBadgeClass(media_item_r12));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 28, ctx_r1.typeLabelKey(media_item_r12)), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(media_item_r12.play_time ? 12 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", media_item_r12.name);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", media_item_r12.name, " ");
    \u0275\u0275advance();
    \u0275\u0275property("matMenuTriggerFor", menu_r14)("matMenuTriggerData", \u0275\u0275pureFunction1(36, _c4, media_item_r12));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(17, 30, "SIGNAGE_MANAGER.MEDIA_ACTIONS"));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(media_item_r12.tags?.length ? 20 : -1);
  }
}
function MediaListComponent_Conditional_2_Conditional_1_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_0_Template, 21, 37, "div", 29)(1, MediaListComponent_Conditional_2_Conditional_1_For_2_Conditional_1_Template, 21, 38, "div", 30);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function MediaListComponent_Conditional_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(3, MediaListComponent_Conditional_2_Conditional_1_Conditional_3_Template, 1, 0, "div", 27)(4, MediaListComponent_Conditional_2_Conditional_1_Conditional_4_Template, 3, 3, "div", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, MediaListComponent_Conditional_2_Conditional_0_Template, 10, 8, "div", 19);
    \u0275\u0275conditionalCreate(1, MediaListComponent_Conditional_2_Conditional_1_Template, 5, 5, "div", 20)(2, MediaListComponent_Conditional_2_Conditional_2_Template, 2, 0, "div", 9)(3, MediaListComponent_Conditional_2_Conditional_3_Template, 6, 3, "div", 10);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function MediaListComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MediaListComponent_ng_template_5_Template_button_click_0_listener() {
      const folder_r19 = \u0275\u0275restoreView(_r18).folder;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.renameTag(folder_r19.id, folder_r19.count));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "icon", 59);
    \u0275\u0275text(3, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MediaListComponent_ng_template_5_Template_button_click_7_listener() {
      const folder_r19 = \u0275\u0275restoreView(_r18).folder;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeTag(folder_r19.id, folder_r19.count));
    });
    \u0275\u0275elementStart(8, "div", 64)(9, "icon", 66);
    \u0275\u0275text(10, "delete");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 2, "SIGNAGE_MANAGER.RENAME_MEDIA_TAG"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(13, 4, "SIGNAGE_MANAGER.REMOVE_MEDIA_TAG"), " ");
  }
}
function MediaListComponent_ng_template_8_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 63);
    \u0275\u0275listener("click", function MediaListComponent_ng_template_8_Conditional_0_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r21);
      const media_item_r22 = \u0275\u0275nextContext().item;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.editItem(media_item_r22));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "icon", 59);
    \u0275\u0275text(3, "edit");
    \u0275\u0275elementEnd();
...
function MediaListComponent_ng_template_8_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 63);
    \u0275\u0275listener("click", function MediaListComponent_ng_template_8_Conditional_1_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r23);
      const media_item_r22 = \u0275\u0275nextContext().item;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.editItemWithAI(media_item_r22));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "icon", 59);
    \u0275\u0275text(3, "auto_awesome");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 1, "SIGNAGE_MANAGER.AI_EDIT_IMAGE"), " ");
  }
}
function MediaListComponent_ng_template_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 63);
    \u0275\u0275listener("click", function MediaListComponent_ng_template_8_Conditional_2_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r24);
      const media_item_r22 = \u0275\u0275nextContext().item;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addToPlaylist(media_item_r22.id));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "icon", 59);
    \u0275\u0275text(3, "add");
    \u0275\u0275elementEnd();
...
function MediaListComponent_ng_template_8_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r25 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 63);
    \u0275\u0275listener("click", function MediaListComponent_ng_template_8_Conditional_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r25);
      const media_item_r22 = \u0275\u0275nextContext().item;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.shareItem(media_item_r22));
    });
    \u0275\u0275elementStart(1, "div", 64)(2, "icon", 59);
    \u0275\u0275text(3, "ios_share");
    \u0275\u0275elementEnd();
...
function MediaListComponent_ng_template_8_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r26 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 63);
    \u0275\u0275listener("click", function MediaListComponent_ng_template_8_Conditional_11_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r26);
      const media_item_r22 = \u0275\u0275nextContext().item;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeItem(media_item_r22));
    });
...
function MediaListComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275conditionalCreate(0, MediaListComponent_ng_template_8_Conditional_0_Template, 7, 3, "button", 67);
    \u0275\u0275conditionalCreate(1, MediaListComponent_ng_template_8_Conditional_1_Template, 7, 3, "button", 67);
    \u0275\u0275conditionalCreate(2, MediaListComponent_ng_template_8_Conditional_2_Template, 7, 3, "button", 67);
    \u0275\u0275conditionalCreate(3, MediaListComponent_ng_template_8_Conditional_3_Template, 7, 3, "button", 67);
    \u0275\u0275elementStart(4, "button", 63);
    \u0275\u0275listener("click", function MediaListComponent_ng_template_8_Template_button_click_4_listener() {
      const media_item_r22 = \u0275\u0275restoreView(_r20).item;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.previewItem(media_item_r22));
    });
    \u0275\u0275elementStart(5, "div", 64)(6, "icon", 59);
    \u0275\u0275text(7, "visibility");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(11, MediaListComponent_ng_template_8_Conditional_11_Template, 7, 3, "button", 67);
  }
  if (rf & 2) {
    const media_item_r22 = ctx.item;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r1.can_update() ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.can_edit_with_ai() && ctx_r1.isImage(media_item_r22) ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.sidebar_hidden() && ctx_r1.can_update() ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.can_share() ? 3 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(10, 6, "COMMON.PREVIEW"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.can_delete() ? 11 : -1);
  }
}
function MediaListComponent_Conditional_9_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r28 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 74);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function MediaListComponent_Conditional_9_Conditional_11_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r28);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaListComponent_Conditional_9_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r29 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 75);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function MediaListComponent_Conditional_9_Conditional_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r29);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaListComponent_Conditional_9_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r30 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 74);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function MediaListComponent_Conditional_9_Conditional_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r30);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaListComponent_Conditional_9_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r31 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 74);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function MediaListComponent_Conditional_9_Conditional_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r31);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function MediaListComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r27 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "footer", 4)(1, "div", 68)(2, "button", 69);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275listener("click", function MediaListComponent_Conditional_9_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r27);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(11, MediaListComponent_Conditional_9_Conditional_11_Template, 5, 6, "button", 72);
    \u0275\u0275conditionalCreate(12, MediaListComponent_Conditional_9_Conditional_12_Template, 4, 3, "button", 73);
    \u0275\u0275conditionalCreate(13, MediaListComponent_Conditional_9_Conditional_13_Template, 4, 3, "button", 72);
    \u0275\u0275conditionalCreate(14, MediaListComponent_Conditional_9_Conditional_14_Template, 4, 3, "button", 72);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var MediaListComponent = class _MediaListComponent {
  constructor() {
    ...
    this.can_manage_all_groups = this._service.can_manage_all_groups;
    this.can_switch_groups = computed(
      () => this._service.show_media_group_tabs() && (this.can_manage_all_groups() ? this.groups().length > 0 : this.groups().length > 1),
    ...
    this.renameTag = (tag, count) => this._service.renameMediaTag(tag, count);
    this.removeTag = (tag, count) => this._service.removeMediaTag(tag, count);
    ...
    this.can_update_media_tags = this._service.can_update_media_tags;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MediaListComponent, selectors: [["media-list"]], inputs: { playlist_count: [1, "playlist_count"] }, decls: 10, vars: 3, consts: [["folder_menu", "matMenu"], ["menu", "matMenu"], ["group_tabs_panel", ""], ["matMenuContent", ""], ["aria-live", "polite", 1, "bg-base-100", "border-base-300", "sticky", "bottom-2", "z-20", "mx-2", "mt-2", "flex", "items-center", "justify-between", "gap-2", "rounded-xl", "border", "p-2", "shadow-lg"], ["mat-tab-nav-bar", "", 1, "bg-base-100/95", "border-base-300", "sticky", "top-2", "z-30", "mx-2", "rounded-xl", "border", 3, "tabPanel"], ["mat-tab-link", "", "type", "button", 3, "active"], ["mat-tab-link", "", "type", "button", 3, "click", "active"], ["role", "list", 1, "grid", "w-full", "grid-cols-2", "gap-4", "p-4", "sm:grid-cols-3", "lg:grid-cols-4", "xl:grid-cols-6"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "p-8"], [1, "text-base-content/70", "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], ["role", "listitem", 1, "border-base-300", "bg-base-100", "hover:border-info", "relative", "flex", "rounded-lg", "border", "hover:shadow-xl"], ["type", "button", "matRipple", "", 1, "flex", "min-w-0", "flex-1", "flex-col", "items-center", "justify-center", "rounded-lg", "p-4", 3, "click"], [1, "text-warning", "-my-2", "text-8xl"], [1, "text-base-content", "w-full", "truncate", "text-center", "font-medium", 3, "matTooltip"], [1, "text-base-content/60", "text-xs"], ["icon", "", "default", "", "type", "button", "matRipple", "", 1, "absolute", "top-2", "right-2", "z-10", "text-sm", 3, "matMenuTriggerFor", "matMenuTriggerData"], ["diameter", "32"], [1, "text-6xl"], [1, "text-base-content/80", "sticky", "z-30", "mx-2", "mt-4", "items-center", "gap-1", "px-2", "text-sm", 3, "top-2", "top-16"], ["cdkDropList", "", "id", "media-list", "role", "list", 3, "class", "cdkDropListData", "cdkDropListConnectedTo"], [1, "text-base-content/80", "sticky", "z-30", "mx-2", "mt-4", "items-center", "gap-1", "px-2", "text-sm"], [1, "bg-base-100", "border-base-300", "inline-flex", "items-center", "rounded-xl", "border", "p-1"], ["type", "button", "matRipple", "", 1, "hover:text-base-content", "flex", "items-center", "gap-1", "rounded-lg", "px-4", "py-2", "underline", 3, "click"], [1, "text-base-content/60", "text-xl"], [1, "text-base-content", "px-4", "font-medium"], ["cdkDropList", "", "id", "media-list", "role", "list", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], ["intersect", "", 1, "col-span-full", "h-px", "w-full"], [1, "text-base-content/50", "bg-base-content/10", "col-span-full", "rounded-lg", "p-2", "text-center", "text-xs"], ["cdkDrag", "", "role", "listitem", 1, "border-base-300", "bg-base-100", "hover:border-info", "relative", "flex", "items-center", "gap-3", "rounded-lg", "border", "p-2", "hover:shadow-md", 3, "opacity-60", "ring-2", "ring-primary"], ["cdkDrag", "", "role", "listitem", 1, "border-base-300", "bg-base-100", "hover:border-info", "relative", "flex", "flex-col", "items-center", "justify-center", "rounded-lg", "border", "p-3", "hover:opacity-80", "hover:shadow-xl", 3, "opacity-60", "ring-2", "ring-primary"], ["cdkDrag", "", "role", "listitem", 1, "border-base-300", "bg-base-100", "hover:border-info", "relative", "flex", "items-center", "gap-3", "rounded-lg", "border", "p-2", "hover:shadow-md"], ["class", "border-base-400 bg-base-300 flex min-h-10 min-w-10 items-center justify-center rounded-2xl border-4 border-dashed opacity-30", 4, "cdkDragPlaceholder"], [3, "click", "change", "checked"], ["preview", "", "type", "button", "matRipple", "", 1, "bg-base-200", "relative", "h-14", "w-20", "flex-none", "overflow-hidden", "rounded", 3, "click"], [1, "h-full", "w-full", 3, "item"], [1, "flex", "w-px", "flex-1", "flex-col"], [1, "text-base-content", "w-full", "truncate", "text-left", 3, "click", "matTooltip"], [1, "flex", "items-center", "gap-2"], [1, "rounded-lg", "px-2", "py-1", "font-mono", "text-xs", "capitalize"], [1, "bg-error", "text-error-content", "rounded", "px-2", "py-1", "text-xs", "font-bold"], [1, "text-base-content/70", "hidden", "font-mono", "text-xs", "sm:block"], [1, "hidden", "items-center", "gap-1", "lg:flex"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "matMenuTriggerFor", "matMenuTriggerData"], [1, "border-base-400", "bg-base-300", "flex", "min-h-10", "min-w-10", "items-center", "justify-center", "rounded-2xl", "border-4", "border-dashed", "opacity-30"], [1, "text-base-100", "text-2xl"], [1, "bg-info-light", "text-info", "max-w-32", "truncate", "rounded-full", "px-2", "py-1", "text-[0.625rem]", "font-medium"], [1, "bg-info-light", "text-info", "rounded-full", "px-2", "py-1", "text-[0.625rem]", "font-medium", 3, "matTooltip"], ["cdkDrag", "", "role", "listitem", 1, "border-base-300", "bg-base-100", "hover:border-info", "relative", "flex", "flex-col", "items-center", "justify-center", "rounded-lg", "border", "p-3", "hover:opacity-80", "hover:shadow-xl"], [1, "absolute", "top-4", "right-4", "z-20", "rounded", 3, "click", "change", "checked"], ["preview", "", "type", "button", "matRipple", "", 1, "bg-base-200", "relative", "h-36", "w-full", "overflow-hidden", "rounded-lg", 3, "click"], [1, "bg-error", "text-error-content", "absolute", "inset-x-0", "top-1/2", "z-10", "-translate-y-1/2", "py-1", "text-center", "text-xs", "font-bold", "tracking-wide"], [1, "absolute", "inset-0", "flex", "items-end", "justify-end", "p-1", "opacity-0", "transition-opacity", "duration-200", "hover:opacity-100"], [1, "absolute", "top-1", "left-1", "rounded-lg", "px-2", "py-1", "font-mono", "text-xs", "capitalize"], [1, "bg-info", "text-info-content", "absolute", "right-1", "bottom-1", "rounded-lg", "px-2", "py-1", "font-mono", "text-xs", "capitalize"], [1, "relative", "top-1", "flex", "w-full", "items-center", "justify-between"], [1, "text-base-content", "w-1/2", "flex-1", "truncate", "text-left", 3, "click", "matTooltip"], ["icon", "", "type", "button", "matRipple", "", 3, "matMenuTriggerFor", "matMenuTriggerData"], [1, "flex", "min-h-6", "w-full", "items-center", "gap-1", "overflow-hidden"], [1, "text-2xl"], [1, "bg-info-light", "text-info", "max-w-[45%]", "truncate", "rounded-full", "px-2", "py-1", "text-xs", "font-medium"], [1, "bg-info-light", "text-info", "rounded-full", "px-2", "py-1", "text-xs", "font-medium", 3, "matTooltip"], ["intersect", "", 1, "col-span-full", "h-px", "w-full", 3, "intersect"], ["type", "button", "mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], [1, "text-error", "text-2xl"], ["type", "button", "mat-menu-item", ""], [1, "flex", "items-center", "gap-3"], ["icon", "", "matRipple", "", 1, "hover:bg-base-200", "rounded-xl", 3, "click", "matTooltip"], [1, "font-medium"], [1, "flex", "flex-wrap", "items-center", "gap-2"], ["icon", "", "default", "", "matRipple", "", 3, "matTooltip"], ["icon", "", "default", "", "matRipple", "", "error", "", 3, "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "matRipple", "", "error", "", 3, "click", "matTooltip"]], template: function MediaListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(5, MediaListComponent_ng_template_5_Template, 14, 6, "ng-template", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "mat-menu", null, 1);
        \u0275\u0275template(8, MediaListComponent_ng_template_8_Template, 12, 8, "ng-template", 3);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(9, MediaListComponent_Conditional_9_Template, 15, 16, "footer", 4);
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(8);
        \u0275\u0275conditional(ctx.selected_count() > 0 ? 9 : -1);
      }
    }, dependencies: [
      DragDropModule,
      CdkDropList,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MediaListComponent, { className: "MediaListComponent", filePath: "apps/signage-manager/src/app/media/media-list.component.ts", lineNumber: 742 });
})();
...
function PlaylistSidebarComponent_Conditional_16_For_1_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function PlaylistSidebarComponent_Conditional_16_For_1_Case_9_Template(rf, ctx) {
  if (rf & 1) {
...
function PlaylistSidebarComponent_Conditional_16_For_1_Case_10_Template(rf, ctx) {
  if (rf & 1) {
...
function PlaylistSidebarComponent_Conditional_16_For_1_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PlaylistSidebarComponent_Conditional_16_For_1_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function PlaylistSidebarComponent_Conditional_16_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(8, PlaylistSidebarComponent_Conditional_16_For_1_Conditional_8_Template, 3, 3, "span", 21);
    \u0275\u0275conditionalCreate(9, PlaylistSidebarComponent_Conditional_16_For_1_Case_9_Template, 3, 3, "span", 22)(10, PlaylistSidebarComponent_Conditional_16_For_1_Case_10_Template, 3, 3, "span", 23)(11, PlaylistSidebarComponent_Conditional_16_For_1_Case_11_Template, 3, 3, "span", 24)(12, PlaylistSidebarComponent_Conditional_16_For_1_Case_12_Template, 3, 3, "span", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, PlaylistSidebarComponent_Conditional_16_For_1_Conditional_13_Template, 2, 1, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, PlaylistSidebarComponent_Conditional_16_For_1_Conditional_14_Template, 2, 0, "icon", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_19_0;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "playlist-" + $index_r5)("cdkDropListConnectedTo", \u0275\u0275pureFunction0(18, _c22))("cdkDropListData", playlist_r4);
    \u0275\u0275advance();
    \u0275\u0275property("playlist", playlist_r4);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", playlist_r4.name, " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!playlist_r4.enabled ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_19_0 = ctx_r1.getStatus(playlist_r4)) === "expired" ? 9 : tmp_19_0 === "pending" ? 10 : tmp_19_0 === "awaiting_review" ? 11 : tmp_19_0 === "awaiting_approval" ? 12 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(playlist_r4.description ? 13 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(playlist_r4.distribution ? 14 : -1);
  }
}
...
function PlaylistSidebarComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, PlaylistSidebarComponent_Conditional_16_For_1_Template, 15, 19, "a", 13, _forTrack04);
...
var PlaylistSidebarComponent = class _PlaylistSidebarComponent {
  constructor() {
    ...
    this.filtered_playlists = this._service.filtered_playlists;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlaylistSidebarComponent, selectors: [["playlist-sidebar"]], decls: 19, vars: 15, consts: [[1, "border-base-300", "bg-base-100", "my-4", "mr-4", "hidden", "h-[calc(100%-2rem)]", "w-72", "shrink-0", "flex-col", "rounded-lg", "border", "md:flex"], [1, "border-base-300", "border-b", "p-2"], [1, "flex", "justify-between"], [1, "px-2"], [1, "text-lg", "font-medium"], [1, "mb-2", "text-xs", "opacity-60"], ["icon", "", "default", "", "type", "button", "matRipple", "", "matTooltipPosition", "right", 3, "matTooltip"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], [1, "flex-1", "overflow-auto", "p-2"], [1, "flex", "items-center", "justify-center", "p-8"], [1, "text-base-content/70", "flex", "flex-col", "items-center", "justify-center", "p-8"], ["icon", "", "default", "", "type", "button", "matRipple", "", "matTooltipPosition", "right", 3, "click", "matTooltip"], [3, "routerLink"], ["intersect", "", 1, "h-px", "w-full"], [1, "text-base-content/50", "bg-base-content/10", "col-span-full", "rounded-lg", "p-2", "text-center", "text-xs"], ["cdkDropList", "", "matRipple", "", 1, "border-base-300", "mb-2", "flex", "items-center", "gap-3", "rounded-lg", "border", "p-0.5", "transition-colors", 3, "cdkDropListDropped", "id", "cdkDropListConnectedTo", "cdkDropListData"], [1, "relative", "h-12", "w-12", "shrink-0", "overflow-hidden", "rounded-md", 3, "playlist"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-sm", "font-medium"], [1, "flex", "flex-wrap", "gap-1", "text-[0.625rem]"], [1, "bg-base-200", "shrink-0", "rounded", "px-1.5", "py-0.5", "font-bold", "uppercase"], [1, "bg-error", "text-error-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "font-bold", "uppercase"], [1, "bg-info", "text-info-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "font-bold", "uppercase"], [1, "bg-base-300", "shrink-0", "rounded", "px-1.5", "py-0.5", "font-bold", "uppercase"], [1, "bg-warning", "text-warning-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "font-bold", "uppercase"], [1, "text-base-content/70", "mt-0.5", "truncate", "text-xs"], [1, "mx-2"], ["intersect", "", 1, "h-px", "w-full", 3, "intersect"], ["diameter", "32"], [1, "text-4xl"], [1, "mt-2", "text-sm"]], template: function PlaylistSidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaylistSidebarComponent, { className: "PlaylistSidebarComponent", filePath: "apps/signage-manager/src/app/media/playlist-sidebar.component.ts", lineNumber: 237 });
})();
...
//# debugId=0f8a69be-60c8-52fe-b81d-78f450154876
//# sourceMappingURL=media.component-CTSOWAKR.js.map
