import "./chunk-DLQBDNSL.js";
import "./chunk-5OLNNBWB.js";
import {
  queryParkingSpaces
} from "./chunk-7IPENQKL.js";
import {
  DateRangeFieldComponent
} from "./chunk-3KBRL57I.js";
import {
...
_ReportsOptionsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsOptionsComponent, selectors: [["reports-options"]], inputs: { loading: [1, "loading"], has_data: [1, "has_data"] }, outputs: { printing: "printing", generate: "generate", download: "download" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 24, vars: 21, consts: [["startDate", ""], ["endDate", ""], [1, "border-base-200", "bg-base-100", "z-20", "flex", "h-20", "w-full", "items-center", "space-x-2", "border-b", "p-4", "print:hidden"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "week_start", "from"], [3, "ngModelChange", "ngModel"], ["btn", "", "matRipple", "", 3, "click", "disabled"], [3, "diameter"], [1, "flex-1"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "click", "disabled", "matTooltip"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"]], template: function ReportsOptionsComponent_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(3, 13, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(6, 15, ctx.levels));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx.has_data())("matTooltip", \u0275\u0275pipeBind1(17, 17, "APP.CONCIERGE.REPORTS_DOWNLOAD"));
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", !ctx.has_data())("matTooltip", \u0275\u0275pipeBind1(21, 19, "APP.CONCIERGE.REPORTS_PRINT"));
  }
}, dependencies: [
  MatFormFieldModule,
  MatFormField,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsOptionsComponent, { className: "ReportsOptionsComponent", filePath: "apps/concierge/src/app/reports/reports-options.component.ts", lineNumber: 142 });
})();
...
var _ReportsStateService = class _ReportsStateService {
  ...
  constructor() {
    ...
    this._bookings_list = this._generate.pipe(debounceTime(500), switchMap((_) => {
      ...
      switch (options.type) {
        case "desks":
          request$ = queryAllBookings(__spreadProps(__spreadValues({}, query), {
            zones,
            type: "desk",
            limit: 1e3
          }));
    ...
    this.counts = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      if (!zones.length)
        return of([]);
      return forkJoin(zones.map((z) => nc(z, "desks").pipe(catchError(() => of({ details: [] })), map((m) => [z, m.details.length]))));
    }), map((list) => {
      const map3 = {};
...
_AssetReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportDailyUsageComponent, selectors: [["asset-report-daily-usage"]], inputs: { print: [1, "print"] }, decls: 15, vars: 38, consts: [["date_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function AssetReportDailyUsageComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_AssetReportExpiredItemsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportExpiredItemsComponent, selectors: [["asset-report-expired-items"]], inputs: { print: [1, "print"] }, decls: 15, vars: 40, consts: [["date_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"], [1, "opacity-30"]], template: function AssetReportExpiredItemsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_AssetReportOverallComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportOverallComponent, selectors: [["asset-report-overall"]], decls: 22, vars: 18, consts: [[1, "border-base-200", "bg-base-100", "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function AssetReportOverallComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_AssetReportProductUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportProductUsageComponent, selectors: [["asset-report-product-usage"]], inputs: { print: [1, "print"] }, decls: 12, vars: 32, consts: [[1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AssetReportProductUsageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_AssetReportUsersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetReportUsersComponent, selectors: [["asset-report-users"]], inputs: { print: [1, "print"] }, decls: 12, vars: 32, consts: [[1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function AssetReportUsersComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_CateringReportItemsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportItemsComponent, selectors: [["catering-report-items"]], inputs: { print: [1, "print"] }, decls: 17, vars: 44, consts: [["option_template", ""], ["cost_template", ""], [1, "border-base-200", "bg-base-100", "mx-auto", "my-2", "w-5xl", "max-w-[calc(100%-2rem)]", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "justify-between", "border-b", "px-4"], [1, "py-2", "text-xl", "font-medium"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "page_size", "empty_message", "sortable"], [1, "p-4"], [1, "bg-base-200", "rounded-sm", "px-2", "py-1", "text-xs", 3, "matTooltip"]], template: function CateringReportItemsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CateringReportItemsComponent, { className: "CateringReportItemsComponent", filePath: "apps/concierge/src/app/reports/catering/catering-report-items.component.ts", lineNumber: 89 });
})();
...
_CateringReportOrdersComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CateringReportOrdersComponent, selectors: [["catering-report-orders"]], inputs: { print: [1, "print"] }, decls: 18, vars: 31, consts: [["date_template", ""], ["cost_template", ""], [1, "border-base-200", "bg-base-100", "mx-auto", "my-2", "w-5xl", "max-w-[calc(100%-2rem)]", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "justify-between", "border-b", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", 1, "print:hidden", 3, "click", "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], [1, "p-4"]], template: function CateringReportOrdersComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h2", 4);
    \u0275\u0275text(3);
...
var _ContactTracingStateService = class _ContactTracingStateService {
  constructor() {
    ...
    this.events = this._generate.pipe(filter((gen) => !!gen), switchMap(() => {
      ...
      const mod = wh(this.system_id, "ContactTracing");
...
function ContactTracingReportComponent_Conditional_11_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("data", ctx_r3.tracing_events)("columns", \u0275\u0275pureFunction4(12, _c46, \u0275\u0275pureFunction1(4, _c08, date_template_r7), \u0275\u0275pureFunction1(6, _c17, user_template_r6), \u0275\u0275pureFunction1(8, _c27, user_template_r6), \u0275\u0275pureFunction1(10, _c37, duration_template_r8)))("sortable", true)("page_size", ctx_r3.printing ? 0 : 30);
  }
}
...
_ContactTracingReportComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactTracingReportComponent, selectors: [["app-contact-tracing-report"]], decls: 14, vars: 11, consts: [["user_template", ""], ["date_template", ""], ["duration_template", ""], [1, "print:hidden", 3, "printing", "download"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "bg-base-200", "m-4", "flex", "items-center", "overflow-hidden", "rounded-sm", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "border-base-200", "mx-auto", "my-2", "w-5xl", "max-w-[calc(100%-2rem)]", "rounded-lg", "border"], [1, "screen-only", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "border-base-200", "flex", "items-center", "justify-between", "border-b", "px-4"], [1, "py-2", "text-xl", "font-medium"], ["empty_message", "No contact tracing events for selected period", 1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size"], [1, "p-4"], [1, "opacity-30"], [3, "diameter"]], template: function ContactTracingReportComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(12, "async");
    \u0275\u0275conditionalBranchCreate(13, ContactTracingReportComponent_Conditional_13_Template, 5, 4, "div", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_0_0;
...
var _ReportDesksChartsComponent = class _ReportDesksChartsComponent extends AsyncHandler {
  constructor() {
    ...
    this._daily_chart_el = viewChild("dailyChart");
    this._level_chart_el = viewChild("levelChart");
...
_ReportDesksChartsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksChartsComponent, selectors: [["report-desks-charts"]], viewQuery: function ReportDesksChartsComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._daily_chart_el, _c09, 5);
    \u0275\u0275viewQuerySignal(ctx._level_chart_el, _c18, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance(2);
  }
}, inputs: { print: [1, "print"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 15, vars: 8, consts: [["dailyChart", ""], ["levelChart", ""], [1, "flex", "w-full", "items-center", "space-x-4", "px-4", 3, "resize"], [1, "border-base-200", "bg-base-100", "h-72", "flex-1", "rounded-sm", "border"], [1, "border-base-200", "border-b", "p-4", "text-xl", "font-bold"], [1, "mx-auto", "h-56", "w-full", "max-w-full", "p-2"], [1, "mx-auto", "h-56", "w-[24rem]", "max-w-full", "p-2"]], template: function ReportDesksChartsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 2);
    \u0275\u0275listener("resize", function ReportDesksChartsComponent_Template_div_resize_0_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.updateCharts());
    }, \u0275\u0275resolveWindow);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportDesksChartsComponent, { className: "ReportDesksChartsComponent", filePath: "apps/concierge/src/app/reports/desks/report-desks-charts.component.ts", lineNumber: 91 });
})();

// apps/concierge/src/app/reports/desks/report-desks-level-list.component.ts
var _c010 = (a0) => ({ key: "name", name: a0 });
var _c19 = (a0) => ({ key: "avg_usage", name: a0 });
...
_ReportDesksLevelListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksLevelListComponent, selectors: [["report-desks-levels-list"]], inputs: { print: [1, "print"] }, decls: 16, vars: 38, consts: [["percent_view", ""], [1, "w-full", "px-4", "pb-2"], [1, "border-base-200", "bg-base-100", "w-full", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "p-4"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "page_size", "sortable", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportDesksLevelListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _c110 = (a0) => ({ key: "approved", name: a0 });
...
_ReportDesksOverallListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksOverallListComponent, selectors: [["report-desks-overall-list"]], inputs: { print: [1, "print"] }, decls: 17, vars: 34, consts: [["date_template", ""], ["percent_template", ""], [1, "w-full", "pb-2"], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "p-4"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "page_size", "sortable", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportDesksOverallListComponent_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(!ctx.print() ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.day_list)("columns", \u0275\u0275pureFunction4(29, _c48, \u0275\u0275pureFunction2(19, _c011, \u0275\u0275pipeBind1(8, 9, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction1(22, _c110, \u0275\u0275pipeBind1(9, 11, "APP.CONCIERGE.REPORTS_APPROVED")), \u0275\u0275pureFunction1(24, _c29, \u0275\u0275pipeBind1(10, 13, "APP.CONCIERGE.REPORTS_TOTAL_REQUESTS")), \u0275\u0275pureFunction2(26, _c39, \u0275\u0275pipeBind1(11, 15, "APP.CONCIERGE.REPORTS_UTILISATION"), percent_template_r6)))("page_size", ctx.print() ? 0 : 10)("sortable", true)("empty_message", \u0275\u0275pipeBind1(12, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
  }
}, dependencies: [
  SimpleTableComponent,
  CommonModule,
...
_ReportDesksComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportDesksComponent, selectors: [["", "report-desks", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c012, decls: 16, vars: 17, consts: [[3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "bg-base-200", "m-4", "flex", "items-center", "rounded-sm", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "border-base-200", "bg-base-100", "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [3, "print"], [1, "opacity-30"], [1, "mb-4", 3, "diameter"]], template: function ReportDesksComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "reports-options", 0);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275pipe(2, "async");
...
var _LockersReportService = class _LockersReportService {
  constructor() {
    ...
    this.counts$ = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      if (!zones.length)
        return of([]);
      return forkJoin(zones.map((z) => nc(z, "lockers-spaces").pipe(catchError(() => of({ details: [] })), map((m) => [z, m.details.length]))));
    }), map((list) => {
      const mapping = {};
...
_LockersReportChartsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportChartsComponent, selectors: [["lockers-report-charts"]], viewQuery: function LockersReportChartsComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._daily_chart_el, _c013, 5);
    \u0275\u0275viewQuerySignal(ctx._level_chart_el, _c111, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance(2);
  }
}, inputs: { print: [1, "print"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 15, vars: 8, consts: [["dailyChart", ""], ["levelChart", ""], [1, "flex", "w-full", "items-center", "space-x-4", "px-4", 3, "resize"], [1, "border-base-200", "bg-base-100", "h-72", "w-1/2", "flex-1", "rounded-sm", "border"], [1, "border-base-200", "border-b", "p-4", "text-xl", "font-bold"], [1, "mx-auto", "h-56", "w-full", "max-w-full", "p-2"], [1, "mx-auto", "h-56", "w-[24rem]", "max-w-full", "p-2"]], template: function LockersReportChartsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportChartsComponent, { className: "LockersReportChartsComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-charts.component.ts", lineNumber: 94 });
})();
...
_LockersReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportDailyUsageComponent, selectors: [["lockers-report-daily-usage"]], inputs: { print: [1, "print"] }, decls: 14, vars: 33, consts: [["date_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function LockersReportDailyUsageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_LockersReportListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportListComponent, selectors: [["lockers-report-list"]], inputs: { print: [1, "print"] }, decls: 18, vars: 44, consts: [["date_template", ""], ["duration_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function LockersReportListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersReportListComponent, { className: "LockersReportListComponent", filePath: "apps/concierge/src/app/reports/lockers/lockers-report-list.component.ts", lineNumber: 105 });
})();
...
_LockersReportOverallComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportOverallComponent, selectors: [["lockers-report-overall"]], decls: 22, vars: 18, consts: [[1, "border-base-200", "bg-base-100", "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function LockersReportOverallComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_LockersReportComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LockersReportComponent, selectors: [["", "lockers-report", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c016, decls: 16, vars: 17, consts: [[3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "bg-base-200", "m-4", "flex", "items-center", "rounded-sm", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [3, "print"], [1, "opacity-30"], [1, "mb-4", 3, "diameter"]], template: function LockersReportComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "reports-options", 0);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275pipe(2, "async");
...
var _ParkingReportService = class _ParkingReportService {
  constructor() {
    ...
    this.counts$ = this._options.pipe(debounceTime(500), switchMap((filters) => {
      ...
      if (!zones.length)
        return of([]);
      return forkJoin(zones.map((z) => queryParkingSpaces(z).pipe(catchError(() => of([])), map((spaces) => [z, spaces.length]))));
    }), map((list) => {
      const mapping = {};
      list.forEach(([id, count]) => mapping[id] = Math.max(count || 0, 1));
      return mapping;
...
var _c017 = ["dailyChart"];
var _c114 = ["levelChart"];
Chart.register(LineController, LineElement, PointElement, LinearScale, CategoryScale, PieController, ArcElement, plugin_tooltip, plugin_legend);
...
_ParkingReportChartsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportChartsComponent, selectors: [["parking-report-charts"]], viewQuery: function ParkingReportChartsComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._daily_chart_el, _c017, 5);
    \u0275\u0275viewQuerySignal(ctx._level_chart_el, _c114, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance(2);
  }
}, inputs: { print: [1, "print"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 15, vars: 8, consts: [["dailyChart", ""], ["levelChart", ""], [1, "flex", "w-full", "items-center", "space-x-4", "px-4", 3, "resize"], [1, "border-base-200", "bg-base-100", "h-72", "w-1/2", "flex-1", "rounded-sm", "border"], [1, "border-base-200", "border-b", "p-4", "text-xl", "font-bold"], [1, "mx-auto", "h-56", "w-full", "max-w-full", "p-2"], [1, "mx-auto", "h-56", "w-[24rem]", "max-w-full", "p-2"]], template: function ParkingReportChartsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportChartsComponent, { className: "ParkingReportChartsComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-charts.component.ts", lineNumber: 93 });
})();

// apps/concierge/src/app/reports/parking/parking-report-daily-usage.component.ts
var _c018 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c115 = (a0) => ({ key: "booking_count", name: a0 });
...
_ParkingReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportDailyUsageComponent, selectors: [["parking-report-daily-usage"]], inputs: { print: [1, "print"] }, decls: 14, vars: 33, consts: [["date_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ParkingReportDailyUsageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
var _c019 = (a0) => ({ key: "parking_name", name: a0 });
var _c116 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
...
_ParkingReportListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportListComponent, selectors: [["parking-report-list"]], inputs: { print: [1, "print"] }, decls: 17, vars: 39, consts: [["date_template", ""], ["duration_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ParkingReportListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "h3", 4);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParkingReportListComponent, { className: "ParkingReportListComponent", filePath: "apps/concierge/src/app/reports/parking/parking-report-list.component.ts", lineNumber: 101 });
})();
...
_ParkingReportOverallComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportOverallComponent, selectors: [["parking-report-overall"]], decls: 22, vars: 18, consts: [[1, "border-base-200", "bg-base-100", "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function ParkingReportOverallComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_ParkingReportComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingReportComponent, selectors: [["", "parking-report", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c020, decls: 16, vars: 17, consts: [[3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "bg-base-200", "m-4", "flex", "items-center", "rounded-sm", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [3, "print"], [1, "opacity-30"], [1, "mb-4", 3, "diameter"]], template: function ParkingReportComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "reports-options", 0);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275pipe(2, "async");
...
var _c021 = () => ["/reports", "desks"];
var _c117 = () => ["/reports", "bookings"];
var _c214 = () => ["/reports", "catering"];
var _c314 = () => ["/reports", "contact-tracing"];
var _c413 = (a0) => ["/reports", a0];
function ReportsMenuComponent_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c021));
  }
}
function ReportsMenuComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c117));
  }
}
function ReportsMenuComponent_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c214));
  }
}
function ReportsMenuComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(1, _c314));
  }
}
function ReportsMenuComponent_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 2)(1, "icon", 3);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c413, report_r1.id));
    \u0275\u0275advance(2);
...
_ReportsMenuComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsMenuComponent, selectors: [["reports-menu"], ["", "reports-menu", ""]], decls: 8, vars: 4, consts: [[1, "bg-base-200", "absolute", "inset-0", "flex", "items-center", "justify-center", "overflow-auto"], [1, "grid", "w-full", "justify-items-center"], ["matRipple", "", 1, "border-base-200", "bg-base-100", "flex", "h-64", "w-64", "flex-col", "items-center", "justify-center", "rounded-sm", "border", "p-4", "shadow-sm", "hover:opacity-80", 3, "routerLink"], [1, "text-8xl"], [1, "mb-4", "text-xl", "font-bold"], [1, "flex", "items-center"], [1, "ml-2"]], template: function ReportsMenuComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1);
    ...
    \u0275\u0275conditionalCreate(4, ReportsMenuComponent_Conditional_4_Template, 10, 2, "a", 2);
    \u0275\u0275conditionalCreate(5, ReportsMenuComponent_Conditional_5_Template, 10, 2, "a", 2);
    \u0275\u0275repeaterCreate(6, ReportsMenuComponent_For_7_Template, 10, 5, "a", 2, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.features.includes("catering") ? 4 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.features.includes("contact-tracing") ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx.custom_reports);
  }
}, dependencies: [RouterModule, RouterLink, IconComponent, MatRippleModule, MatRipple], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: row !important;\n  align-items: center;\n  justify-content: center;\n  background: inherit;\n}\n.grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(16rem, 1fr));\n  gap: 1rem;\n}\n/*# sourceMappingURL=reports-menu.component.css.map */"] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ReportsMenuComponent, [{
    ...
    `, imports: [RouterModule, IconComponent, MatRippleModule], styles: ["/* angular:styles/component:css;3c3888f97d5b926a129adcc993c79eb028bb1478338967948b4453c5e0720738;/home/runner/work/user-interfaces/user-interfaces/apps/concierge/src/app/reports/reports-menu.component.ts */\n:host {\n  display: flex;\n  flex-direction: row !important;\n  align-items: center;\n  justify-content: center;\n  background: inherit;\n}\n.grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(16rem, 1fr));\n  gap: 1rem;\n}\n/*# sourceMappingURL=reports-menu.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsMenuComponent, { className: "ReportsMenuComponent", filePath: "apps/concierge/src/app/reports/reports-menu.component.ts", lineNumber: 112 });
})();

// apps/concierge/src/app/reports/reports.component.ts
var _c022 = ["app-new-reports", ""];
...
_ReportsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsComponent, selectors: [["", "app-new-reports", ""]], attrs: _c022, decls: 6, vars: 1, consts: [[1, "screen-only"], [1, "flex", "h-px", "flex-1"], [1, "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["reports-menu", "", 1, "screen-only", "absolute", "inset-0"]], template: function ReportsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _c023 = ["dailyChart"];
var _c118 = ["levelChart"];
Chart.register(LineController, LineElement, PointElement, LinearScale, CategoryScale, PieController, ArcElement, plugin_tooltip, plugin_legend);
...
_ReportSpacesChartsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesChartsComponent, selectors: [["report-spaces-charts"]], viewQuery: function ReportSpacesChartsComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuerySignal(ctx._daily_chart_el, _c023, 5);
    \u0275\u0275viewQuerySignal(ctx._level_chart_el, _c118, 5);
  }
  if (rf & 2) {
    \u0275\u0275queryAdvance(2);
  }
}, inputs: { print: [1, "print"] }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 15, vars: 8, consts: [["dailyChart", ""], ["levelChart", ""], [1, "flex", "w-full", "items-center", "space-x-4", "px-4", 3, "resize"], [1, "border-base-200", "bg-base-100", "h-72", "flex-1", "rounded-sm", "border"], [1, "border-base-200", "border-b", "p-4", "text-xl", "font-bold"], [1, "mx-auto", "h-56", "w-full", "max-w-full", "p-2"], [1, "mx-auto", "h-56", "w-[24rem]", "max-w-full", "p-2"]], template: function ReportSpacesChartsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesChartsComponent, { className: "ReportSpacesChartsComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-charts.component.ts", lineNumber: 91 });
})();

// apps/concierge/src/app/reports/spaces/report-spaces-overall-list.component.ts
var _c024 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c119 = (a0) => ({ key: "approved", name: a0 });
var _c215 = (a0) => ({ key: "count", name: a0 });
var _c315 = (a0, a1) => ({ key: "utilisation", name: a0, content: a1 });
...
_ReportSpacesOverallListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallListComponent, selectors: [["report-spaces-overall-list"]], inputs: { print: [1, "print"] }, decls: 17, vars: 34, consts: [["date_template", ""], ["percent_template", ""], [1, "w-full"], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "p-4"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function ReportSpacesOverallListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "div", 4)(3, "h3", 5);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(!ctx.print() ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.day_list)("columns", \u0275\u0275pureFunction4(29, _c414, \u0275\u0275pureFunction2(19, _c024, \u0275\u0275pipeBind1(8, 9, "FORM.DATE"), date_template_r5), \u0275\u0275pureFunction1(22, _c119, \u0275\u0275pipeBind1(9, 11, "APP.CONCIERGE.REPORTS_APPROVED")), \u0275\u0275pureFunction1(24, _c215, \u0275\u0275pipeBind1(10, 13, "APP.CONCIERGE.REPORTS_TOTAL_REQUESTS")), \u0275\u0275pureFunction2(26, _c315, \u0275\u0275pipeBind1(11, 15, "APP.CONCIERGE.REPORTS_UTILISATION"), percent_template_r6)))("sortable", true)("page_size", ctx.print() ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
  }
}, dependencies: [
  CommonModule,
  DatePipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportSpacesOverallListComponent, { className: "ReportSpacesOverallListComponent", filePath: "apps/concierge/src/app/reports/spaces/report-spaces-overall-list.component.ts", lineNumber: 90 });
})();
...
_ReportSpacesOverallComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesOverallComponent, selectors: [["report-spaces-overall"]], decls: 24, vars: 21, consts: [[1, "border-base-200", "bg-base-100", "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "bg-base-100", "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded-sm", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center", "justify-center"]], template: function ReportSpacesOverallComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _c025 = (a0) => ({ key: "name", name: a0 });
var _c120 = (a0, a1) => ({ key: "capacity", name: a0, content: a1 });
var _c216 = (a0) => ({ key: "booking_count", name: a0 });
var _c316 = (a0) => ({ key: "utilisation", name: a0 });
var _c415 = (a0) => ({ key: "avg_attendees", name: a0 });
...
_ReportSpacesSpaceListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesSpaceListingComponent, selectors: [["report-spaces-space-listing"]], inputs: { print: [1, "print"] }, decls: 22, vars: 67, consts: [["capacity_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"], [1, "opacity-30"]], template: function ReportSpacesSpaceListingComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(!ctx.print() ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.space_list)("columns", \u0275\u0275pureFunctionV(57, _c9, [\u0275\u0275pureFunction1(35, _c025, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction2(37, _c120, \u0275\u0275pipeBind1(8, 11, "COMMON.CAPACITY"), capacity_template_r4), \u0275\u0275pureFunction1(40, _c216, \u0275\u0275pipeBind1(9, 13, "RESOURCE.BOOKINGS")), \u0275\u0275pureFunction1(42, _c316, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_UTILISATION")), \u0275\u0275pureFunction1(44, _c415, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_AVG_BOOKING_INVITES")), \u0275\u0275pureFunction2(46, _c57, \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_NO_SHOWS"), \u0275\u0275pipeBind1(13, 21, ctx.has_attendance)), \u0275\u0275pureFunction2(49, _c63, \u0275\u0275pipeBind1(14, 23, "APP.CONCIERGE.REPORTS_MIN_ATTENDANCE"), \u0275\u0275pipeBind1(15, 25, ctx.has_attendance)), \u0275\u0275pureFunction2(52, _c72, \u0275\u0275pipeBind1(16, 27, "APP.CONCIERGE.REPORTS_MAX_ATTENDANCE"), \u0275\u0275pipeBind1(17, 29, ctx.has_attendance)), \u0275\u0275pureFunction1(55, _c8, \u0275\u0275pipeBind1(18, 31, "APP.CONCIERGE.REPORTS_OCCUPANCY"))]))("sortable", true)("page_size", ctx.print() ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(19, 33, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
var _c121 = (a0) => ({ key: "booking_count", name: a0 });
var _c217 = (a0) => ({ key: "avg_attendees", name: a0 });
var _c317 = (a0) => ({ key: "total_time", name: a0 });
var _c416 = (a0) => ({ key: "no_shows", name: a0 });
...
_ReportSpacesUserListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesUserListingComponent, selectors: [["report-spaces-user-listing"]], inputs: { print: [1, "print"] }, decls: 13, vars: 37, consts: [[1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"]], template: function ReportSpacesUserListingComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(!ctx.print() ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.user_list)("columns", \u0275\u0275pureFunction5(31, _c58, \u0275\u0275pureFunction1(21, _c026, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction1(23, _c121, \u0275\u0275pipeBind1(8, 11, "RESOURCE.BOOKINGS")), \u0275\u0275pureFunction1(25, _c217, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_AVG_BOOKING_INVITES")), \u0275\u0275pureFunction1(27, _c317, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_TOTAL_TIME")), \u0275\u0275pureFunction1(29, _c416, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_NO_SHOWS"))))("sortable", true)("page_size", ctx.print() ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
  }
}, dependencies: [
  SimpleTableComponent,
  TranslatePipe,
...
_ReportSpacesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportSpacesComponent, selectors: [["", "report-spaces", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c027, decls: 16, vars: 17, consts: [[3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "bg-base-200", "m-4", "flex", "items-center", "rounded-sm", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [3, "print"], [1, "opacity-30"], [1, "mb-4", 3, "diameter"]], template: function ReportSpacesComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "reports-options", 0);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275pipe(2, "async");
...
var _c028 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c122 = (a0) => ({ key: "booking_count", name: a0 });
var _c218 = (a0) => ({ key: "host_count", name: a0 });
var _c318 = (a0) => ({ key: "booked_count", name: a0 });
var _c417 = (a0, a1, a2, a3) => [a0, a1, a2, a3];
...
_VisitorReportDailyUsageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportDailyUsageComponent, selectors: [["visitor-report-daily-usage"]], inputs: { print: [1, "print"] }, decls: 14, vars: 33, consts: [["date_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function VisitorReportDailyUsageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(!ctx.print() ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.daily_stats)("columns", \u0275\u0275pureFunction4(28, _c417, \u0275\u0275pureFunction2(19, _c028, \u0275\u0275pipeBind1(7, 9, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(22, _c122, \u0275\u0275pipeBind1(8, 11, "APP.CONCIERGE.REPORTS_VISITORS_UNIQUE")), \u0275\u0275pureFunction1(24, _c218, \u0275\u0275pipeBind1(9, 13, "APP.CONCIERGE.REPORTS_VISITORS_HOSTS")), \u0275\u0275pureFunction1(26, _c318, \u0275\u0275pipeBind1(10, 15, "APP.CONCIERGE.REPORTS_BOOKING_COUNT_HEADER"))))("sortable", true)("page_size", ctx.print() ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
  }
}, dependencies: [
  CommonModule,
  DatePipe,
...
var _c029 = (a0) => ({ key: "visitor_name", name: a0 });
var _c123 = (a0, a1) => ({ key: "date", name: a0, content: a1 });
var _c219 = (a0) => ({ key: "host", name: a0 });
var _c319 = (a0) => ({ key: "checked_in", name: a0 });
var _c418 = (a0) => ({ key: "self_registered", name: a0 });
...
_VisitorReportListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportListComponent, selectors: [["visitor-report-list"]], inputs: { print: [1, "print"] }, decls: 15, vars: 38, consts: [["date_template", ""], [1, "border-base-200", "bg-base-100", "m-4", "overflow-hidden", "rounded-sm", "border"], [1, "border-base-200", "flex", "items-center", "border-b", "px-4", "py-2"], [1, "flex-1", "text-xl", "font-bold"], ["icon", "", "matRipple", "", 3, "matTooltip"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "sortable", "page_size", "empty_message"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], [1, "p-4"]], template: function VisitorReportListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h3", 3);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275conditional(!ctx.print() ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.visitor_bookings)("columns", \u0275\u0275pureFunction5(32, _c59, \u0275\u0275pureFunction1(21, _c029, \u0275\u0275pipeBind1(7, 9, "FORM.NAME")), \u0275\u0275pureFunction2(23, _c123, \u0275\u0275pipeBind1(8, 11, "FORM.DATE"), date_template_r4), \u0275\u0275pureFunction1(26, _c219, \u0275\u0275pipeBind1(9, 13, "FORM.HOST")), \u0275\u0275pureFunction1(28, _c319, \u0275\u0275pipeBind1(10, 15, "COMMON.CHECKED_IN")), \u0275\u0275pureFunction1(30, _c418, \u0275\u0275pipeBind1(11, 17, "APP.CONCIERGE.REPORTS_VISITORS_SELF_REGISTERED"))))("sortable", true)("page_size", ctx.print() ? 0 : 10)("empty_message", \u0275\u0275pipeBind1(12, 19, "APP.CONCIERGE.REPORTS_DAILY_EMPTY"));
  }
}, dependencies: [
  SimpleTableComponent,
  CommonModule,
...
_VisitorReportOverallComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorReportOverallComponent, selectors: [["visitor-report-overall"]], decls: 22, vars: 18, consts: [[1, "border-base-200", "bg-base-100", "m-4", "flex", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "p-4"], [1, "flex", "flex-1", "flex-col", "items-center"], [1, "text-sm"], [1, "text-2xl"]], template: function VisitorReportOverallComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h3", 2);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
_VisitorsReportComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorsReportComponent, selectors: [["", "visitors-report", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c030, decls: 16, vars: 17, consts: [[3, "printing", "download", "generate", "loading", "has_data"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "print:h-auto", "print:overflow-visible"], [1, "w-full"], [1, "bg-base-200", "m-4", "flex", "items-center", "rounded-sm", "p-4"], ["auth", "", 1, "h-12", 3, "source"], [1, "flex-1"], [1, "px-2", "text-2xl", "font-medium"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [1, "screen-only", "flex", "h-full", "w-full", "flex-col", "items-center", "p-8"], [3, "print"], [1, "opacity-30"], [1, "mb-4", 3, "diameter"]], template: function VisitorsReportComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "reports-options", 0);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275pipe(2, "async");
...
chart.js/dist/chart.js:
   ...
   *)
*/
//# sourceMappingURL=reports.module-4GZ56IUV.js.map
