...
function PointsAssetModalComponent_Conditional_5_For_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, PointsAssetModalComponent_Conditional_5_For_48_Conditional_14_Template, 1, 4, "a-time-field", 36);
    \u0275\u0275elementEnd();
...
function PointsAssetModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(47, PointsAssetModalComponent_Conditional_5_For_48_Template, 18, 23, "div", 24, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(50, "div", 26)(51, "icon", 27);
    \u0275\u0275text(52, "add");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(30, 34, "APP.CONCIERGE.POINTS_ACCEPT"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(35, 36, "APP.CONCIERGE.POINTS_STANDARD_RATE"));
    \u0275\u0275advance(2);
    \u0275\u0275property("min", 500)("max", 8e4)("step", 500)("render_fn", ctx_r5.renderPrice);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(40, 38, "APP.CONCIERGE.POINTS_DISCOUNT_CAP"));
    \u0275\u0275advance(2);
    \u0275\u0275property("min", 0)("max", 100)("step", 5)("render_fn", ctx_r5.renderPercent);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(45, 40, "APP.CONCIERGE.POINTS_RATE_RULES"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(((tmp_25_0 = ctx_r5.form.get("custom_rates")) == null ? null : tmp_25_0.value) || \u0275\u0275pureFunction0(44, _c0));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(55, 42, "APP.CONCIERGE.POINTS_RATE_RULES_NEW"));
  }
}
var PointsAssetModalComponent = class _PointsAssetModalComponent extends AsyncHandler {
  constructor() {
    ...
    this.asset_options = toSignal(combineLatest([
    ...
    }), tap(() => this.loading.set(false)), shareReplay(1)), { initialValue: [] });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsAssetModalComponent, selectors: [["points-asset-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 10, vars: 9, consts: [["auto", "matAutocomplete"], [1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "min-w-md", "overflow-hidden", "px-4", "py-2", 3, "formGroup"], [1, "border-base-200", "flex", "items-center", "justify-end", "space-x-2", "border-t", "p-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click", "disabled"], [1, "flex", "flex-col"], ["appearance", "outline", 1, "h-13", "flex-1"], ["formControlName", "type", "placeholder", "Select asset type"], ["value", "space"], ["value", "desk"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "name", 3, "placeholder", "matAutocomplete"], ["matSuffix", "", 3, "diameter"], [3, "value"], [3, "disabled"], [1, "mb-4", "flex", "items-center"], ["formControlName", "accept_points", 1, "w-full", 3, "name"], [1, "mb-4", "flex", "space-x-4"], [1, "flex", "flex-1", "flex-col"], ["formControlName", "unit_price", 1, "w-full", 3, "min", "max", "step", "render_fn"], ["formControlName", "discount_cap", 1, "w-full", 3, "min", "max", "step", "render_fn"], [1, ""], ["rule", "", 1, "flex", "items-center"], ["btn", "", "matRipple", "", 1, "clear", "w-full", 3, "click"], [1, "flex", "w-full", "items-center", "justify-center"], [1, "text-lg"], [1, "underline"], [1, "flex", "w-1/2", "flex-1", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-13", "w-32", "flex-2"], [3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", "before"], ["value", "between"], ["value", "after"], [1, "mt-2", "w-40", "flex-1", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "mt-2", "w-40", "flex-1", 3, "ngModel", "from", "ngModelOptions"], [1, "mx-2"], [1, "border-base-200", "rounded-sm", "border", 3, "ngModelChange", "ngModel", "ngModelOptions", "min", "max", "step", "render_fn"], [1, "mt-2", "w-40", "flex-1", 3, "ngModelChange", "ngModel", "from", "ngModelOptions"]], template: function PointsAssetModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(5, PointsAssetModalComponent_Conditional_5_Template, 56, 45, "main", 4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsAssetModalComponent, { className: "PointsAssetModalComponent", filePath: "apps/concierge/src/app/points/asset-modal.component.ts", lineNumber: 271 });
})();
...
var PointsAssetsComponent = class _PointsAssetsComponent {
  constructor() {
    ...
    this.asset_list = toSignal(this._state.assets || of([]), {
      initialValue: []
    });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsAssetsComponent, { className: "PointsAssetsComponent", filePath: "apps/concierge/src/app/points/points-assets.component.ts", lineNumber: 124 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsTopbarComponent, { className: "PointsTopbarComponent", filePath: "apps/concierge/src/app/points/points-topbar.component.ts", lineNumber: 34 });
})();
...
var PointsComponent = class _PointsComponent extends AsyncHandler {
  constructor() {
    ...
    this._state = inject(PointsStateService);
    this._router = inject(Router);
    this.page = toSignal(this._router.events.pipe(filter((event) => event instanceof NavigationEnd), startWith(null), map(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsComponent, { className: "PointsComponent", filePath: "apps/concierge/src/app/points/points.component.ts", lineNumber: 87 });
})();
...
//# sourceMappingURL=points.module-N4MQEAQX.js.map
