...
function ZoneContentComponent_Conditional_0_Conditional_11_For_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, ZoneContentComponent_Conditional_0_Conditional_11_For_1_Conditional_4_For_1_Template, 1, 7, "img", 24, \u0275\u0275repeaterTrackByIdentity);
  }
  if (rf & 2) {
...
function ZoneContentComponent_Conditional_0_Conditional_11_For_1_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15)(1, "icon", 26);
...
function ZoneContentComponent_Conditional_0_Conditional_11_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(15, ZoneContentComponent_Conditional_0_Conditional_11_For_1_Conditional_15_Template, 5, 9, "button", 7);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_14_0;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_14_0 = ctx_r1.playlist_thumbnail_media()[playlist_r6.id]) == null ? null : tmp_14_0.length) ? 4 : 5);
    \u0275\u0275advance(4);
...
function ZoneContentComponent_Conditional_0_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "icon", 28);
...
function ZoneContentComponent_Conditional_0_Conditional_22_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ZoneContentComponent_Conditional_0_Conditional_22_For_1_Conditional_7_Template, 2, 1, "div", 32);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ZoneContentComponent_Conditional_0_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, ZoneContentComponent_Conditional_0_Conditional_22_For_1_Template, 8, 11, "a", 30, _forTrack0);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
var ZoneContentComponent = class _ZoneContentComponent {
  constructor() {
    ...
    this.activeTab = input("playlists", ...ngDevMode ? [{ debugName: "activeTab" }] : (
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneContentComponent, selectors: [["zone-content"]], inputs: { activeTab: [1, "activeTab"] }, decls: 2, vars: 1, consts: [[1, "flex", "h-full", "flex-col", "overflow-hidden"], [1, "text-base-content/70", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "flex", "min-h-0", "flex-1", "flex-col", "gap-3", "p-3", "lg:flex-row"], ["id", "zone-playlists-panel", "role", "tabpanel", "aria-labelledby", "zone-playlists-tab", 1, "bg-base-100", "border-base-300", "min-h-0", "flex-1", "overflow-auto", "rounded-lg", "border", "lg:min-w-0"], [1, "border-base-300", "flex", "items-center", "gap-2", "border-b", "px-4", "py-3"], [1, "text-base-content/80", "flex", "flex-1", "items-center", "gap-2", "font-medium", "tracking-wider", "uppercase"], [1, "text-lg"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "matTooltip"], [1, "gap-2", "p-2"], [1, "text-base-content/70", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-6"], ["id", "zone-displays-panel", "role", "tabpanel", "aria-labelledby", "zone-displays-tab", 1, "bg-base-100", "border-base-300", "min-h-0", "flex-1", "overflow-auto", "rounded-lg", "border", "lg:min-w-0"], ["icon", "", "default", "", "type", "button", "matRipple", "", 3, "click", "matTooltip"], [1, "border-base-300", "bg-base-100", "mb-2", "flex", "items-center", "gap-3", "rounded-lg", "border", "p-0.5", "pl-1"], ["matRipple", "", 1, "hover:bg-base-200", "flex", "min-w-0", "flex-1", "items-center", "gap-3", "rounded-lg", "p-1", "no-underline", "transition-colors", 3, "routerLink"], [1, "border-base-200", "relative", "h-12", "w-12", "shrink-0", "overflow-hidden", "rounded-md", "border"], [1, "text-base-content/35", "flex", "h-full", "w-full", "items-center", "justify-center"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-sm", "font-medium"], [1, "mt-1", "flex", "flex-wrap", "gap-1"], [1, "bg-warning", "text-warning-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "bg-error", "text-error-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "bg-info", "text-info-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "bg-secondary", "text-secondary-content", "shrink-0", "rounded", "px-1.5", "py-0.5", "text-[10px]", "font-bold", "uppercase"], [1, "text-base-content/70", "mt-0.5", "truncate", "text-xs"], ["auth", "", "alt", "", 1, "border-base-300", "bg-base-200", "absolute", "h-9", "w-9", "rounded-sm", "border", "object-cover", "shadow", 3, "source", "top", "left", "z-index"], ["auth", "", "alt", "", 1, "border-base-300", "bg-base-200", "absolute", "h-9", "w-9", "rounded-sm", "border", "object-cover", "shadow", 3, "source"], [1, "text-2xl"], [1, "text-error"], [1, "text-4xl"], [1, "text-sm"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "hover:bg-base-200", "mb-2", "flex", "items-center", "gap-3", "rounded-lg", "border", "px-4", "py-3", "no-underline", "transition-colors", 3, "routerLink"], [1, "shrink-0", "text-xl", "opacity-60"], [1, "text-base-content/70", "truncate", "text-xs"], [1, "text-6xl"]], template: function ZoneContentComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneContentComponent, { className: "ZoneContentComponent", filePath: "apps/signage-manager/src/app/zones/zone-content.component.ts", lineNumber: 389 });
})();
...
var ZoneHeaderComponent = class _ZoneHeaderComponent {
  constructor() {
    this._service = inject(SignageService);
    this.total_count = computed(() => this._service.filtered_zones().length, ...ngDevMode ? [{ debugName: "total_count" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
function ZoneListComponent_Conditional_6_Conditional_0_For_1_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const zone_r2 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("opacity-70", ((tmp_13_0 = ctx_r2.selected()) == null ? null : tmp_13_0.id) !== zone_r2.id)("opacity-90", ((tmp_14_0 = ctx_r2.selected()) == null ? null : tmp_14_0.id) === zone_r2.id);
    \u0275\u0275advance();
...
function ZoneListComponent_Conditional_6_Conditional_0_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("bg-primary", ((tmp_12_0 = ctx_r2.selected()) == null ? null : tmp_12_0.id) === zone_r2.id)("text-primary-content", ((tmp_13_0 = ctx_r2.selected()) == null ? null : tmp_13_0.id) === zone_r2.id)("hover:bg-base-200", ((tmp_14_0 = ctx_r2.selected()) == null ? null : tmp_14_0.id) !== zone_r2.id);
...
function ZoneListComponent_Conditional_7_cdk_tree_node_1_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const node_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("opacity-70", ((tmp_4_0 = ctx_r2.selected()) == null ? null : tmp_4_0.id) !== node_r6.zone.id)("opacity-90", ((tmp_5_0 = ctx_r2.selected()) == null ? null : tmp_5_0.id) === node_r6.zone.id);
    \u0275\u0275advance();
...
function ZoneListComponent_Conditional_7_cdk_tree_node_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bg-primary", ((tmp_3_0 = ctx_r2.selected()) == null ? null : tmp_3_0.id) === node_r6.zone.id)("text-primary-content", ((tmp_4_0 = ctx_r2.selected()) == null ? null : tmp_4_0.id) === node_r6.zone.id)("hover:bg-base-200", ((tmp_5_0 = ctx_r2.selected()) == null ? null : tmp_5_0.id) !== node_r6.zone.id);
...
var ZoneListComponent = class _ZoneListComponent {
  constructor() {
    ...
    this._all_zones = toSignal(this._service.all_zones, {
      initialValue: []
    });
    this._root_zones = toSignal(this._service.root_zones, {
      initialValue: []
    });
  ...
  async loadChildren(zone_id) {
    ...
    const children = await lastValueFrom(this._service.zoneChildren(zone_id)).catch(() => this.children_lookup()[zone_id] || []);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZoneListComponent, { className: "ZoneListComponent", filePath: "apps/signage-manager/src/app/zones/zone-list.component.ts", lineNumber: 265 });
})();
...
var ZonesSectionComponent = class _ZonesSectionComponent {
  constructor() {
    ...
    this.view_tab = signal("playlists", ...ngDevMode ? [{ debugName: "view_tab" }] : (
      /* istanbul ignore next */
      []
    ));
    this.selected_zone = this._service.selected_zone;
    this._zones = toSignal(this._service.all_zones, {
      initialValue: []
    });
    this._playlists = toSignal(this._service.playlists, {
      initialValue: []
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZonesSectionComponent, selectors: [["zones-section"]], decls: 10, vars: 6, consts: [[1, "bg-base-200", "absolute", "inset-0", "flex", "flex-col", "sm:flex-row"], [1, "sm:h-full"], [1, "flex", "min-h-0", "flex-1", "flex-col"], [1, "relative", "z-10"], [1, "flex", "min-h-0", "flex-1", "flex-row"], [1, "mobile-full"], [1, "flex", "min-h-0", "w-px", "flex-1", "flex-col"], [1, "h-1/2", "flex-1", 3, "activeTab"], [1, "bg-base-100", "border-base-300", "mx-2", "flex", "items-center", "gap-2", "rounded-b-lg", "border", "px-4", "py-3"], ["icon", "", "type", "button", "matRipple", "", 1, "sm:hidden", 3, "click"], [1, "shrink-0", "text-2xl", "opacity-60"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-lg", "font-medium"], [1, "text-base-content/80", "truncate", "text-sm"], ["role", "tablist", 1, "bg-base-100", "border-base-300", "mx-2", "mt-2", "flex", "overflow-hidden", "rounded-lg", "border", "lg:hidden"], ["type", "button", "role", "tab", "aria-controls", "zone-playlists-panel", "id", "zone-playlists-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"], ["type", "button", "role", "tab", "aria-controls", "zone-displays-panel", "id", "zone-displays-tab", 1, "flex-1", "px-4", "py-2.5", "text-sm", "font-medium", "transition-colors", 3, "click"]], template: function ZonesSectionComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ZonesSectionComponent, { className: "ZonesSectionComponent", filePath: "apps/signage-manager/src/app/zones/zones.component.ts", lineNumber: 176 });
})();
export {
  ZonesSectionComponent
};
//# sourceMappingURL=zones.component-2NVB5FRG.js.map
