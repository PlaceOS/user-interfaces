...
function BookingDetailsModalComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, BookingDetailsModalComponent_Conditional_39_For_6_Template, 5, 2, "div", null, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function BookingDetailsModalComponent_Conditional_40_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 20, "BOOKINGS.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(23, _c03, \u0275\u0275pipeBind2(5, 17, request_r7.deliver_at, "MMM d, " + ctx_r0.time_format()))), " ");
    \u0275\u0275advance(3);
...
var BookingDetailsModalComponent = class _BookingDetailsModalComponent {
  ...
  async toggleCheckedIn() {
    ...
    const promise = (bkn.instance ? checkinBookingInstance(bkn.id, bkn.instance, !this.booking().checked_in) : checkinBooking(this.booking().id, !this.booking().checked_in)).catch((_) => {
...
//# sourceMappingURL=chunk-FBCIM6FT.js.map
