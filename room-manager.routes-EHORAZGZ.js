...
import "./chunk-GQS5EQHQ.js";
import {
  UserPipe
} from "./chunk-E4UWZQHY.js";
...
import "./chunk-RPE4PVZX.js";
import "./chunk-CD4QWGK6.js";
import "./chunk-ZXZHU4IX.js";
import "./chunk-HLO6GV4H.js";
import {
  MatAutocomplete,
...
var RoomAlertModalComponent = class _RoomAlertModalComponent {
  ...
  async save() {
    ...
    const metadata = await ic(this._org.organisation.id, "room_alerts").catch((e) => {
...
var RoomModalComponent = class _RoomModalComponent extends AsyncHandler {
  ...
  constructor() {
    ...
    this.encryption_levels = [
      { id: Fe.None, name: "None" },
      { id: Fe.Support, name: "Support" },
      { id: Fe.Admin, name: "Admin" },
      { id: Fe.NeverDisplay, name: "Never Display" }
    ];
  ...
  async ngOnInit() {
    const { details } = await ic(this._org.organisation.id, "settings");
  ...
  async save() {
    ...
    await (data.id ? $a(data.id, data) : va(data));
...
var RoomManagementService = class _RoomManagementService {
  constructor() {
    ...
    this._room_alerts = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_room_alerts" } : (
      ...
      loader: async () => {
        const metadata = await ic(this._org.organisation.id, "room_alerts").catch(() => ({ details: {} }));
    ...
    this._room_list = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_room_list" } : (
      ...
      loader: async ({ params }) => {
        ...
        const list = await queryAllPages(ga({ zone_id, limit: 200 })).catch(() => []);
...
//# sourceMappingURL=room-manager.routes-EHORAZGZ.js.map
