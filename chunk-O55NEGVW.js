...
import {
  ...
  MatChipRow,
  MatChipsModule
} from "./chunk-6EYQUPXN.js";
import {
  USER_DOMAIN,
  generateUserForm
} from "./chunk-I3XIGZBA.js";
import {
  MatCheckbox,
  MatCheckboxModule,
  MatTooltip,
...
var UserListFieldComponent = class _UserListFieldComponent extends AsyncHandler {
  async searchStaff(q) {
    return this._use_basic_user_search() ? Fa({ q, authority_id: It()?.id }).then((_) => _.data.map((u) => new User(u))) : searchStaff(q);
  }
  constructor() {
    super();
...
//# sourceMappingURL=chunk-O55NEGVW.js.map
