...
} from "./chunk-SSPKPDJO.js";
import {
  queryAllPages
} from "./chunk-WOQ27LF7.js";
import {
  MatTab,
  MatTabGroup,
  MatTabLink,
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe(async (params) => {
      if (params.get("id")) {
        ...
        const asset = await vl(params.get("id")).catch(() => null);
        if (!asset) {
      ...
      if (params.get("group_id")) {
        ...
        const product = await Rl(params.get("group_id")).catch(() => null);
        if (!product) {
...
var AssetGroupFormComponent = class _AssetGroupFormComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe(async (params) => {
      if (params.get("id")) {
        this.loading.set("Loading Product Details...");
        const product = await Rl(params.get("id")).catch(() => null);
        if (!product) {
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe(async (params) => {
      if (params.get("id")) {
        ...
        const asset = await Hl(params.get("id")).catch(() => null);
        if (!asset) {
...
//# debugId=bb3344d6-6d74-52e4-b19a-10f45f102942
//# sourceMappingURL=asset-manager.routes-XBCZQAAB.js.map
