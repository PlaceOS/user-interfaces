...
var EmailTemplatesStateService = class _EmailTemplatesStateService extends AsyncHandler {
  constructor() {
    ...
    this._template_definitions = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_template_definitions" } : (
      ...
      loader: async ({ params }) => {
        if (!params.building)
          return [];
        const metadata = await Wu(this._org.organisation.id, "email_template_fields").catch(() => null);
  ...
  async _queryTemplates(building, region) {
    ...
    const [org_templates, bld_templates, region_templates] = await Promise.all([
      Wu(this._org.organisation.id, "email_templates").then((_) => this._processTemplates(_, this._org.organisation.id)).catch(() => []),
      Wu(building, "email_templates").then((_) => this._processTemplates(_, building)).catch(() => []),
      region ? Wu(region, "email_templates").then((_) => this._processTemplates(_, region)).catch(() => []) : Promise.resolve([])
    ]);
  ...
  async saveTemplate(template, old_zone = "") {
    ...
    if (template.id && old_zone) {
      const old_metadata = await Wu(old_zone, "email_templates");
    ...
    const metadata = await Wu(template.zone_id, "email_templates");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmailTemplateManageComponent, { className: "EmailTemplateManageComponent", filePath: "apps/concierge/src/app/email-templates/email-template-manage.component.ts", lineNumber: 307 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BroadcastEmailModalComponent, { className: "BroadcastEmailModalComponent", filePath: "apps/concierge/src/app/email-templates/broadcast-email-modal.component.ts", lineNumber: 174 });
})();
...
var EmailTemplatesListComponent = class _EmailTemplatesListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmailTemplatesListComponent, selectors: [["email-templates-list"]], decls: 29, vars: 45, consts: [["date_template", ""], ["bld_template", ""], ["trigger_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "space-x-2", "p-8"], [1, "text-2xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", ""], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-y-auto", "px-8"], [1, "min-h-full", "w-full", "overflow-x-auto"], ["empty_message", "No group events for selected period", 1, "block", "w-full", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable"], ["btn", "", "matRipple", "", 3, "click"], [1, "p-4", "opacity-60"], [1, "p-4"], [1, "opacity-30"], [1, "p-4", "font-mono", "text-xs"], ["icon", "", "default", "", "matRipple", "", 1, "mx-auto", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", 3, "routerLink"], [1, "text-error", "text-2xl"]], template: function EmailTemplatesListComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=email-templates.routes-OVGKJEBI.js.map
