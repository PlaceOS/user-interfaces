...
_VisitorInductionModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorInductionModalComponent, selectors: [["visitor-induction-modal"]], decls: 12, vars: 5, consts: [[1, "relative", "flex", "w-[32rem]", "flex-col", "items-center", "overflow-hidden", "rounded", "bg-base-100", "p-4", "shadow"], [1, "my-4"], [1, "max-h-[50vh]", "w-full", "overflow-y-auto", "overflow-x-hidden", "whitespace-pre-wrap", "rounded", "border", "border-base-300", "p-4", "text-sm", "opacity-60"], [1, "my-4", 3, "ngModelChange", "ngModel"], [1, "flex", "items-center", "justify-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "clear", "w-32", "underline", 3, "mat-dialog-close"], ["btn", "", "matRipple", "", 1, "w-32", 3, "disabled", "mat-dialog-close"]], template: function VisitorInductionModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _GuestListingComponent = class _GuestListingComponent extends AsyncHandler {
  ...
  ngOnInit() {
    this.subscription("building", this._org.active_building.subscribe(async (bld) => {
      ...
      const metadata = await lastValueFrom(Iu(bld.id, visitor_kiosk_app));
      const org_metadata = await lastValueFrom(Iu(this._org.organisation.id, visitor_kiosk_app));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GuestListingComponent, { className: "GuestListingComponent", filePath: "apps/concierge/src/app/visitors/guest-listing.component.ts", lineNumber: 679 });
})();
...
//# sourceMappingURL=chunk-RHIYGJWV.js.map
