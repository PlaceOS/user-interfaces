...
} from "./chunk-FZIJ75NB.js";
import {
  PointsAssetsComponent,
  PointsOverviewComponent,
  PointsStateService
} from "./chunk-CMXYMCNR.js";
import {
  MatTab,
  MatTabGroup,
  MatTabsModule
...
var _POIModalComponent = class _POIModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    this.loading = true;
    const old_metadata = await Iu(this._org.organisation.id, "points-of-interest", {}).toPromise();
    ...
    const resp = await Pu(this._org.organisation.id, {
...
var _POIManagementService = class _POIManagementService {
  constructor() {
    ...
    this._features = combineLatest([
      ...
      this._change
    ]).pipe(switchMap(() => Iu(this._org.organisation.id, "points-of-interest").pipe(catchError((_) => of({ details: {} })))), map((_) => {
...
function SettingsManagerComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function SettingsManagerComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function SettingsManagerComponent_Conditional_20_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.url_search_term, $event) || (ctx_r1.url_search_term = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ngModelChange", function SettingsManagerComponent_Conditional_20_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
_SettingsManagerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsManagerComponent, selectors: [["", "app-settings-manager", ""]], features: [\u0275\u0275InheritDefinitionFeature], attrs: _c06, decls: 24, vars: 12, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "mb-2", "flex", "items-center", "justify-between", "px-8", "pb-2", "pt-4"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "gap-2"], ["btn", "", "matRipple", "", 1, "w-48"], [1, "mx-8", "mb-4", "overflow-hidden", "rounded-md", "bg-base-200", 3, "selectedIndexChange", "selectedIndex"], [3, "label"], [1, "relative", "flex-1"], [1, "relative", "block", "h-full", "w-full"], [1, "relative", "block", "h-full", "w-full", 3, "hide_header"], ["btn", "", "matRipple", "", 1, "w-48", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], [1, "mb-4", "flex", "justify-end"], ["appearance", "outline", 1, "no-subscript"], ["matInput", "", "placeholder", "Search", 3, "ngModelChange", "ngModel"]], template: function SettingsManagerComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(18, SettingsManagerComponent_Conditional_18_Template, 1, 0, "emergency-contacts-list", 9)(19, SettingsManagerComponent_Conditional_19_Template, 1, 1, "email-templates-list", 10)(20, SettingsManagerComponent_Conditional_20_Template, 4, 1)(21, SettingsManagerComponent_Conditional_21_Template, 1, 0, "poi-list", 9)(22, SettingsManagerComponent_Conditional_22_Template, 1, 0, "points-overview", 9)(23, SettingsManagerComponent_Conditional_23_Template, 1, 0, "points-assets", 9);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 10, "APP.CONCIERGE.SETTINGS_HEADER"), " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.show_points_overview() ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.show_points_assets() ? 16 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.current_tab_name() === "emergency-contacts" ? 18 : ctx.current_tab_name() === "email-templates" ? 19 : ctx.current_tab_name() === "url-management" ? 20 : ctx.current_tab_name() === "poi" ? 21 : ctx.current_tab_name() === "points-overview" ? 22 : ctx.current_tab_name() === "points-assets" ? 23 : -1);
  }
}, dependencies: [
  ApplicationTopbarComponent,
  ApplicationSidebarComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsManagerComponent, { className: "SettingsManagerComponent", filePath: "apps/concierge/src/app/settings-manager/settings-manager.component.ts", lineNumber: 181 });
})();
...
//# sourceMappingURL=settings-manager.module-P4CNIS5G.js.map
