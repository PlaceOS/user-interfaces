...
_DealModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealModalComponent, selectors: [["app-deal-modal"]], outputs: { remove: "remove" }, decls: 39, vars: 24, consts: [[1, "relative", "w-lg", "max-w-[80vw]", "bg-base-100"], [1, "relative", "h-48", "w-lg", "max-w-full", "overflow-hidden", "rounded-b-lg", "bg-base-300"], ["auth", "", "alt", "Deal Image", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "absolute", "bottom-2", "left-2", "max-w-full", "truncate", "rounded-sm", "bg-info", "px-2", "py-1", "text-xs", "text-info-content", "shadow-sm"], [1, "flex", "space-x-2", "p-2"], [1, "w-auto", "px-2", "text-xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click", "routerLink"], [1, "text-2xl"], [1, "pr-2"], ["btn", "", "matRipple", "", 1, "inverse", "error", "space-x-2", 3, "click"], [1, "text-2xl", "text-error"], [1, "max-h-[60vh]", "space-y-2", "overflow-auto", "p-4"], [1, "font-medium"], [1, "max-w-[]", "pb-4", "text-sm"], [1, "pb-4", "text-sm"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "right-2", "top-2", "bg-base-100"]], template: function DealModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _DealsService = class _DealsService extends AsyncHandler {
  constructor() {
    ...
    this.deals$ = combineLatest([
      ...
      return Xu(bld.id, "deals-n-offers").pipe(catchError(() => of({ details: [] })));
    }), map(({ details }) => details instanceof Array ? details : []), tap(() => this.loading.set(false)), startWith([]), shareReplay(1));
  }
  async saveDeal(deal) {
    const metadata = await lastValueFrom(Xu(this._org.building.id, "deals-n-offers")).catch(() => null);
    ...
    deals.push(deal);
    await lastValueFrom(ec(this._org.building.id, {
      name: "deals-n-offers",
...
function DealsListComponent_Conditional_45_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 26);
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_45_For_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_45_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "button", 24);
    \u0275\u0275listener("click", function DealsListComponent_Conditional_45_For_2_Template_button_click_1_listener() {
      const deal_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.view(deal_r3));
    });
    \u0275\u0275elementStart(2, "div", 25);
    \u0275\u0275conditionalCreate(3, DealsListComponent_Conditional_45_For_2_Conditional_3_Template, 1, 1, "img", 26);
    \u0275\u0275conditionalCreate(4, DealsListComponent_Conditional_45_For_2_Conditional_4_Template, 2, 1, "div", 27);
    \u0275\u0275elementEnd();
...
function DealsListComponent_Conditional_45_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, DealsListComponent_Conditional_45_For_2_Template, 12, 12, "div", null, _forTrack0);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275conditionalCreate(4, DealsListComponent_Conditional_45_Conditional_4_Template, 11, 8, "div", 23);
    \u0275\u0275pipe(5, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_46_ng_template_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 38);
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_46_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 37);
    \u0275\u0275conditionalCreate(2, DealsListComponent_Conditional_46_ng_template_8_Conditional_2_Template, 1, 3, "img", 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_46_ng_template_10_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_46_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39)(1, "div", 40);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, DealsListComponent_Conditional_46_ng_template_10_Conditional_3_Template, 2, 0, "span", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DealsListComponent_Conditional_46_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
...
function DealsListComponent_Conditional_46_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DealsListComponent_Conditional_46_ng_template_14_Template_button_click_6_listener() {
    ...
    \u0275\u0275listener("click", function DealsListComponent_Conditional_46_ng_template_14_Template_button_click_20_listener() {
      const deal_r9 = \u0275\u0275restoreView(_r8).row;
      const ctx_r3 = \u0275\u0275nextContext(2);
...
function DealsListComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, DealsListComponent_Conditional_46_ng_template_8_Template, 3, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(10, DealsListComponent_Conditional_46_ng_template_10_Template, 4, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(12, DealsListComponent_Conditional_46_ng_template_12_Template, 3, 4, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(14, DealsListComponent_Conditional_46_ng_template_14_Template, 27, 13, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
_DealsListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealsListComponent, selectors: [["deals-list"]], decls: 47, vars: 30, consts: [["image_template", ""], ["description_template", ""], ["valid_until_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "px-8", "py-4", "pt-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], ["filters", "", 1, "flex", "space-x-2", "px-8", "pb-4"], [1, "flex", "items-center"], ["btn", "", "matRipple", "", "name", "deals-list", 1, "rounded-l", "rounded-r-none", "px-2", 3, "click", "matTooltip"], ["btn", "", "matRipple", "", "name", "deals-grid", 1, "rounded-l-none", "rounded-r", "px-2", 3, "click", "matTooltip"], ["appearance", "outline", 1, "no-subscript"], ["placeholder", "All Deals", 3, "ngModelChange", "ngModel"], [3, "value"], ["placeholder", "All Types", 3, "ngModelChange", "ngModel"], ["value", ""], [1, "capitalize", 3, "value"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "grid", "grid-cols-2", "gap-4", "md:grid-cols-3", "lg:grid-cols-4", "xl:grid-cols-5"], [1, "col-span-6", "flex", "w-full", "flex-col", "items-center", "justify-center", "rounded-lg", "bg-base-200", "p-16"], [1, "mx-auto", "flex", "flex-col", "items-center", "overflow-hidden", "rounded-lg", "border", "border-base-300", "bg-base-100", "shadow-sm", 3, "click"], [1, "relative", "h-36", "w-48", "max-w-full", "overflow-hidden", "rounded-b-lg", "bg-base-200"], ["auth", "", "alt", "Deal Image", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "absolute", "bottom-2", "left-2", "max-w-full", "truncate", "rounded-sm", "bg-info", "px-2", "py-1", "text-xs", "text-info-content", "shadow-sm"], [1, "w-full", "px-4", "py-2", "text-left"], [1, "truncate", "font-bold"], [1, "text-sm", "opacity-50"], ["src", "assets/icons/no-deals.svg", "alt", "No Deals or Offers Available", 1, "mb-8", "w-48"], [1, "flex", "flex-col", "items-center", "space-y-4", "text-center"], [1, "text-lg", "font-bold"], [1, "mb-4", "min-w-5xl"], [1, "text-sm", 3, "data", "sortable", "columns"], [1, "flex", "h-full", "w-full", "items-center", "justify-center", "p-2"], [1, "h-16", "w-16", "rounded-sm", "bg-base-200", "object-cover"], ["auth", "", 1, "h-16", "w-16", "rounded-sm", "bg-base-200", "object-cover", 3, "source", "alt"], [1, "flex", "max-h-24", "overflow-hidden", "px-4", "py-2", "text-sm"], [1, "line-clamp-4"], [1, "opacity-30"], [1, "flex", "p-4"], [1, "flex", "h-full", "w-full", "items-center", "justify-end", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 1, "min-w-48", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", 3, "routerLink"], ["mat-menu-item", "", 3, "click"], [1, "text-2xl", "text-error"]], template: function DealsListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function DealsListComponent_Template_mat_select_ngModelChange_22_listener($event) {
    ...
    \u0275\u0275listener("ngModelChange", function DealsListComponent_Template_mat_select_ngModelChange_38_listener($event) {
    ...
    \u0275\u0275conditionalCreate(45, DealsListComponent_Conditional_45_Template, 6, 5, "div", 22)(46, DealsListComponent_Conditional_46_Template, 16, 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(43, 27, ctx.types));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx.display() === "grid" ? 45 : 46);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
                ...
                @if (display() === 'grid') {
                    ...
                    >
                        @for (deal of deals | async; track deal.id) {
                            <div>
                                <button
                                    class="mx-auto flex flex-col items-center overflow-hidden rounded-lg border border-base-300 bg-base-100 shadow-sm"
                                    (click)="view(deal)"
                                >
                                    <div
                    ...
                    <ng-template #image_template let-deal="row">
                        ...
                        >
                            <div
                                class="h-16 w-16 rounded-sm bg-base-200 object-cover"
                            >
                                @if (deal.image) {
                                    <img
                                        auth
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsListComponent, { className: "DealsListComponent", filePath: "apps/concierge/src/app/deals/deals-list.component.ts", lineNumber: 342 });
})();
...
function DealsManageComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 14, ctx_r1.form.value.id ? "APP.CONCIERGE.DEALS_EDIT" : "APP.CONCIERGE.DEALS_NEW"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r1.loading() ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(9, 16, "FORM.NAME"), " ");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(18, 18, "COMMON.TYPE"), " ");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(27, 20, "COMMON.DETAILS"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 22, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 24, "COMMON.TERMS"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 26, "COMMON.CODE"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 28, "COMMON.IMAGE"));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(32, _c04))("matTooltip", "Upload Image");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(54, 30, "FORM.EXPIRES_AT"));
    \u0275\u0275advance(3);
...
_DealsManageComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealsManageComponent, selectors: [["deals-manage"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 2, vars: 1, consts: [[1, "absolute", "inset-0", "overflow-auto", "bg-base-100"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "bg-base-100"], [1, "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "items-center", "justify-between", "rounded-sm", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 3, "routerLink"], [1, "mx-auto", "my-2", "flex", "w-160", "max-w-full", "flex-col", "px-4", "pb-16", 3, "formGroup"], ["for", "name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "Name of the deal or offer", "required", ""], ["for", "type"], ["matInput", "", "name", "type", "formControlName", "type", "placeholder", "Type of the deal or offer", "required", ""], ["for", "details"], ["matInput", "", "name", "details", "formControlName", "details", "placeholder", "Summary of the deal or offer", "required", ""], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", "placeholder", "Description of the deal or offer"], ["for", "terms"], ["matInput", "", "name", "terms", "formControlName", "terms", "placeholder", "Terms and conditions of the deal or offer"], ["for", "code"], ["matInput", "", "name", "code", "formControlName", "code", "placeholder", "Deal/Offer Code"], ["for", "image"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "image", "formControlName", "image", "placeholder", "Image URL"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions", "matTooltip"], ["for", "expires_at"], ["name", "expires_at", "formControlName", "expires_at"], [1, "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "-translate-x-1/2", "items-center", "justify-end", "rounded-sm", "border-none", "bg-base-200", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], ["diameter", "48"]], template: function DealsManageComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, DealsManageComponent_Conditional_0_Template, 57, 33, "div", 0)(1, DealsManageComponent_Conditional_1_Template, 5, 3, "div", 1);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsManageComponent, { className: "DealsManageComponent", filePath: "apps/concierge/src/app/deals/deals-manage.component.ts", lineNumber: 194 });
})();
...
//# sourceMappingURL=deals.module-DRGMBV3U.js.map
