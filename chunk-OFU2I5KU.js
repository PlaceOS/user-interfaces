...
} from "./chunk-L74QVXPC.js";
import {
  takeUntilDestroyed
} from "./chunk-RFNRR45U.js";
import {
  ParkingService
} from "./chunk-QYD75NKZ.js";
import {
...
var BindingDirective = class _BindingDirective extends AsyncHandler {
  ...
  bindVariable() {
    if (It() && this.bind() && this.sys() && this.mod() && !this._binding) {
      this.timeout("bind", () => {
        const module = gd(this.sys(), this.mod(), this.index());
...
function EventDetailsModalComponent_Conditional_88_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(11, 10, "CALENDAR_EVENT.CATERING_ORDER_AT", \u0275\u0275pureFunction1(19, _c02, \u0275\u0275pipeBind2(10, 7, order_r8.deliver_at, "MMM d, " + ctx_r1.time_format()))), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 16, "CALENDAR_EVENT.CATERING_ORDER_DETAILS", \u0275\u0275pureFunction2(21, _c1, order_r8.item_count, \u0275\u0275pipeBind2(15, 13, order_r8.total_cost / 100, ctx_r1.currency_code))), " ");
    \u0275\u0275advance(3);
...
function EventDetailsModalComponent_Conditional_88_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, EventDetailsModalComponent_Conditional_88_For_6_Template, 24, 24, "div", 52, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function EventDetailsModalComponent_Conditional_92_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 51);
    \u0275\u0275repeaterCreate(5, EventDetailsModalComponent_Conditional_92_For_6_Template, 16, 25, "div", 70, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var EventDetailsModalComponent = class _EventDetailsModalComponent {
  ...
  async checkin() {
    const mod = gd(this.space()?.id, "Bookings");
    if (!mod)
      return;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventDetailsModalComponent, { className: "EventDetailsModalComponent", filePath: "libs/events/src/lib/event-details-modal.component.ts", lineNumber: 767 });
})();
...
function EventCardComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(20, _c03))("queryParams", \u0275\u0275pureFunction1(21, _c12, ctx_r0.event()?.id));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.event()?.ext("catering")?.length ? 23 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(29, 17, "CALENDAR_EVENT.ATTENDEE_COUNT", \u0275\u0275pureFunction1(23, _c22, ctx_r0.event()?.attendees?.length || 0)), " ");
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r0.event()?.attendees?.length ? 32 : -1);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventCardComponent, { className: "EventCardComponent", filePath: "libs/events/src/lib/event-card.component.ts", lineNumber: 187 });
})();
...
function BookingDetailsModalComponent_Conditional_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(2, 2, "BOOKED_FOR_LABEL"));
    \u0275\u0275advance(4);
...
function BookingDetailsModalComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(9, BookingDetailsModalComponent_Conditional_38_Conditional_9_Template, 5, 1, "div", 37);
    \u0275\u0275conditionalCreate(10, BookingDetailsModalComponent_Conditional_38_Conditional_10_Template, 5, 1, "div", 37);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const group_r4 = ctx;
...
function BookingDetailsModalComponent_Conditional_39_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(14, BookingDetailsModalComponent_Conditional_39_For_6_For_15_Template, 6, 2, "div", 51, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 20, "BOOKINGS.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(23, _c04, \u0275\u0275pipeBind2(5, 17, request_r6.deliver_at, "MMM d, " + ctx_r0.time_format()))), " ");
    \u0275\u0275advance(3);
...
function BookingDetailsModalComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, BookingDetailsModalComponent_Conditional_39_For_6_Template, 16, 25, "div", 43, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function BookingDetailsModalComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, BookingDetailsModalComponent_Conditional_40_Conditional_1_Template, 1, 4, "interactive-map", 55);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
  ...
  constructor() {
    ...
    this.can_edit = computed(
      () => {
        ...
        const parking_allocated_edit_blocked = is_parking && !!this.booking().asset_id && !features.includes("parking");
        return !this.booking().is_done && !this.booking().checked_in && (!is_visitor || visitor_edit_allowed) && !parking_allocated_edit_blocked;
      },
      ...ngDevMode ? [{ debugName: "can_edit" }] : (
        /* istanbul ignore next */
        []
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingDetailsModalComponent, selectors: [["booking-details-modal"]], decls: 52, vars: 32, consts: [["menu", "matMenu"], [1, "bg-base-100", "sm:bg-base-200", "h-screen", "w-screen", "space-y-2", "overflow-auto", "pb-2", "sm:relative", "sm:inset-auto", "sm:h-auto", "sm:max-h-[80vh]", "sm:w-204", "sm:rounded-sm"], [1, "border-base-200", "bg-base-100", "max-h-screen", "flex-col", "items-center", "pb-4", "sm:flex", "sm:max-h-[80vh]", "sm:border-b", "sm:px-16"], [1, "block", "h-8", "w-full", "sm:hidden"], [1, "bg-neutral", "h-64", "w-full", "overflow-hidden", "sm:rounded-b"], ["title", "", 1, "mt-2", "w-full", "px-3", "text-xl", "font-medium"], [1, "w-full", "px-3", "text-sm", "opacity-70"], [1, "w-full", "items-center", "justify-between", "sm:flex"], [1, "m-2", "flex", "items-center", "space-x-2"], [3, "status"], [1, "text-2xl", 3, "matTooltip"], ["actions", "", 1, "flex", "items-center", "space-x-2", "px-2"], [1, "flex-wrap", "sm:flex", "sm:px-12"], [1, "border-base-200", "sm:bg-base-100", "min-w-1/3", "grow-4", "rounded-sm", "sm:m-2", "sm:w-[16rem]", "sm:border", "sm:p-4"], [1, "mt-2", "mb-2", "px-3", "text-lg", "font-medium"], [1, "flex", "items-center", "space-x-2", "px-2"], ["matTooltip", "Date"], ["matTooltip", "Time"], ["matTooltip", "Level and Resource"], [1, "border-base-200", "sm:bg-base-100", "mt-4", "min-w-1/3", "grow-3", "rounded-sm", "sm:m-2", "sm:w-[16rem]", "sm:border", "sm:p-4"], ["map", "", 1, "border-base-200", "sm:bg-base-100", "relative", "m-2", "mt-4", "h-64", "w-[calc(100%-1rem)]", "min-w-1/3", "grow-3", "overflow-hidden", "rounded-sm", "border", "p-2", "sm:my-2", "sm:h-48", "sm:w-[16rem]"], ["icon", "", "default", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "top-2", "left-2"], ["xPosition", "before"], ["mat-menu-item", "", "mat-dialog-close", ""], ["mat-menu-item", ""], [1, "h-64", "w-full", 3, "images"], ["icon", "", "matRipple", "", 1, "bg-secondary", "h-12", "w-12", "rounded-sm", "text-white", 3, "matMenuTriggerFor"], ["btn", "", "matRipple", "", 1, "h-10", "min-w-40", "flex-1", "border-none", 3, "bg-success", "text-success-content", "disabled"], ["btn", "", "matRipple", "", 1, "h-10", "min-w-40", "flex-1", "border-none", 3, "click", "disabled"], [1, "flex", "items-center", "justify-center", "gap-1"], [1, "mx-auto", 3, "diameter"], [1, "text-xl"], [1, "text-xs", "opacity-60"], ["matTooltip", "Location"], [3, "matTooltip"], [1, "mx-3", "py-2", "text-lg", "font-medium"], [1, "flex", "flex-col", "space-y-2", "px-3", "text-sm"], [1, "flex", "items-center", "space-x-2"], ["matTooltip", "Group Size"], ["matTooltip", "Resource Type"], ["matTooltip", "Group Reference"], [1, "break-all"], [1, "flex", "flex-col", "space-y-2"], ["request", "", 1, "border-base-300", "bg-base-100", "overflow-hidden", "rounded-xl", "border"], ["matRipple", "", 1, "flex", "w-full", "items-center", "space-x-2", "p-3", 3, "click"], [1, "flex-1", "text-left"], [1, "text-sm"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", 3, "matTooltip"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full"], [1, "text-2xl"], [1, "divide-base-100", "bg-base-200", "flex", "flex-col", "divide-y"], [1, "flex", "items-center", "space-x-2", "px-3", "py-1", "hover:opacity-90"], [1, "flex", "flex-1", "items-center"], [1, "bg-success", "text-success-content", "rounded-sm", "px-2", "py-1", "text-xs"], ["map", "", 1, "border-base-200", "sm:bg-base-100", "relative", "m-2", "mt-4", "h-64", "w-[calc(100%-1rem)]", "min-w-1/3", "grow-3", "overflow-hidden", "rounded-sm", "border", "p-2", "sm:my-2", "sm:h-48", "sm:w-[16rem]", 3, "click"], [1, "pointer-events-none", 3, "src", "features", "options"], ["mat-menu-item", "", "mat-dialog-close", "", 3, "click"], [1, "flex", "items-center", "space-x-2", "text-base"], ["mat-menu-item", "", 3, "click"], ["className", "material-symbols-rounded"], [1, "text-error"]], template: function BookingDetailsModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(36, BookingDetailsModalComponent_Conditional_36_Template, 8, 8, "div", 15);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingDetailsModalComponent, { className: "BookingDetailsModalComponent", filePath: "libs/bookings/src/lib/booking-details-modal.component.ts", lineNumber: 501 });
})();

// libs/bookings/src/lib/booking-card.component.ts
var _c05 = () => ["./"];
var _c14 = (a0) => ({ booking: a0 });
var _c23 = (a0) => ({ name: a0 });
...
function BookingCardComponent_Conditional_1_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "icon", 19);
    \u0275\u0275text(2, "person");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(5, 1, "BOOKINGS.BOOKED_FOR", \u0275\u0275pureFunction1(4, _c23, ctx_r0.booked_for_label())), " ");
  }
}
function BookingCardComponent_Conditional_1_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "icon", 10);
    \u0275\u0275text(1, "event_repeat");
    \u0275\u0275elementEnd();
...
function BookingCardComponent_Conditional_1_Case_15_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingCardComponent_Conditional_1_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingCardComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, BookingCardComponent_Conditional_1_Conditional_7_Template, 6, 6, "div", 9);
    \u0275\u0275conditionalCreate(8, BookingCardComponent_Conditional_1_Conditional_8_Template, 2, 1, "icon", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 11)(10, "div", 12);
    \u0275\u0275conditionalCreate(11, BookingCardComponent_Conditional_1_Case_11_Template, 3, 3, "icon", 13)(12, BookingCardComponent_Conditional_1_Case_12_Template, 3, 3, "icon", 13)(13, BookingCardComponent_Conditional_1_Case_13_Template, 3, 3, "icon", 13)(14, BookingCardComponent_Conditional_1_Case_14_Template, 3, 3, "icon", 13)(15, BookingCardComponent_Conditional_1_Case_15_Template, 2, 0, "icon");
    \u0275\u0275elementStart(16, "div", 14);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(18, BookingCardComponent_Conditional_1_Conditional_18_Template, 5, 1, "div", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "icon", 16);
    \u0275\u0275text(20, " chevron_right ");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(21, BookingCardComponent_Conditional_1_Conditional_21_Template, 6, 3, "div", 17);
    \u0275\u0275conditionalCreate(22, BookingCardComponent_Conditional_1_Conditional_22_Template, 3, 3, "div", 18);
    \u0275\u0275conditionalCreate(23, BookingCardComponent_Conditional_1_Conditional_23_Template, 3, 3, "div", 18);
    \u0275\u0275conditionalCreate(24, BookingCardComponent_Conditional_1_Conditional_24_Template, 3, 3, "div", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_8_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(14, _c05))("queryParams", \u0275\u0275pureFunction1(15, _c14, ctx_r0.booking()?.id));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275textInterpolate(ctx_r0.period());
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.for_current_user() && ctx_r0.booked_for_label() ? 7 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.booking().instance ? 8 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional((tmp_8_0 = ctx_r0.type()) === "desk" ? 11 : tmp_8_0 === "locker" ? 12 : tmp_8_0 === "parking" ? 13 : tmp_8_0 === "visitor" ? 14 : 15);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx_r0.resource_label(), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.location() ? 18 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.booking()?.checked_in && !ctx_r0.booking()?.is_done ? 21 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.booking()?.checked_in && !ctx_r0.for_current_user() && ctx_r0.booking()?.booking_type !== "group-event" ? 22 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.booking()?.checked_in && ctx_r0.booking()?.booking_type === "group-event" ? 23 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.booking()?.checked_in && ctx_r0.is_reserved_parking_space() ? 24 : -1);
  }
}
var BookingCardComponent = class _BookingCardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingCardComponent, selectors: [["booking-card"]], inputs: { booking: [1, "booking"], show_day: [1, "show_day"], edit_fn: [1, "edit_fn"], remove_fn: [1, "remove_fn"], end_fn: [1, "end_fn"], refresh_fn: [1, "refresh_fn"] }, decls: 2, vars: 2, consts: [[1, "mb-2", "flex", "items-center"], ["name", "view-booking-details", 1, "relative", "w-full", "cursor-pointer", "overflow-hidden", 3, "routerLink", "queryParams"], ["day", ""], [1, "px-2", "text-xs"], ["name", "view-booking-details", 1, "relative", "w-full", "cursor-pointer", "overflow-hidden", 3, "click", "routerLink", "queryParams"], [1, "border-base-300", "bg-base-100", "relative", "w-full", "rounded-xl", "border", "py-4", "shadow-sm"], [1, "px-4", "text-lg"], [1, "mx-4", "my-2", "flex", "items-center", "space-x-2"], [3, "status"], ["booked-for", "", 1, "text-base-content/70", "flex", "min-w-0", "items-center", "space-x-1", "text-sm"], [1, "text-2xl", 3, "matTooltip"], [1, "divide-base-200-500", "flex", "flex-col", "flex-wrap", "space-y-2", "py-2", "sm:flex-row", "sm:space-y-0", "sm:divide-x"], [1, "flex", "max-w-[33%]", "items-center", "px-4"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "mx-2", "w-1/2", "flex-1", "truncate"], [1, "flex", "items-center", "px-4"], [1, "absolute", "top-1/2", "right-1", "-translate-y-1/2", "text-4xl"], ["checked-in-badge", "", 1, "bg-success", "text-success-content", "absolute", "top-2", "right-2", "flex", "items-center", "space-x-1", "rounded-xl", "px-2", "py-1", "text-xs"], [1, "bg-warning/50", "absolute", "top-2", "right-2", "rounded-xl", "px-2", "py-1", "text-xs"], [1, "text-lg"], [1, "truncate"], [1, "mx-2", "truncate"], [1, "text-sm"]], template: function BookingCardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, BookingCardComponent_Conditional_0_Template, 7, 9, "h4", 0);
        \u0275\u0275conditionalCreate(1, BookingCardComponent_Conditional_1_Template, 25, 17, "a", 1);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingCardComponent, { className: "BookingCardComponent", filePath: "libs/bookings/src/lib/booking-card.component.ts", lineNumber: 211 });
})();
...
//# debugId=f82a16e3-9d28-5c54-acd1-151194391e11
//# sourceMappingURL=chunk-OFU2I5KU.js.map
