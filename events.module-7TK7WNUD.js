...
function EventRequestWizardComponent_Conditional_13_Conditional_8_For_12_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r2.isCnsiServiceSelected(svc_r16.id));
    \u0275\u0275advance();
...
function EventRequestWizardComponent_Conditional_13_Conditional_8_For_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(3, EventRequestWizardComponent_Conditional_13_Conditional_8_For_12_For_4_Template, 12, 10, "label", 59, _forTrack2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function EventRequestWizardComponent_Conditional_13_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, EventRequestWizardComponent_Conditional_13_Conditional_22_For_5_Template, 7, 1, "div", 70, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function EventRequestWizardComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(22, EventRequestWizardComponent_Conditional_13_Conditional_22_Template, 6, 0, "div", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function EventRequestWizardComponent_Conditional_14_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 84)(6, "div", 85);
    \u0275\u0275text(7, "Refund Deadlines");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, EventRequestWizardComponent_Conditional_14_Conditional_43_For_9_Template, 5, 2, "div", 86, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function EventRequestWizardComponent_Conditional_14_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 81)(6, "span", 82);
    \u0275\u0275text(7, "Est. Total");
    \u0275\u0275elementEnd();
...
function EventRequestWizardComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Documents");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 73)(4, "icon", 74);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 78)(15, "div", 79);
    ...
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 81)(39, "span", 82);
    \u0275\u0275text(40, "Organizer");
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventRequestWizardComponent, { className: "EventRequestWizardComponent", filePath: "apps/concierge/src/app/events/event-request-wizard.component.ts", lineNumber: 1027 });
})();
...
function EventApprovalsComponent_Conditional_10_For_3_Template(rf, ctx) {
  if (rf & 1) {
...
function EventApprovalsComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 6)(1, "mat-select", 8);
    \u0275\u0275listener("ngModelChange", function EventApprovalsComponent_Conditional_10_Template_mat_select_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0._approval_state.setRole($event));
    });
    \u0275\u0275repeaterCreate(2, EventApprovalsComponent_Conditional_10_For_3_Template, 2, 2, "mat-option", 9, _forTrack03);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
_EventApprovalsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventApprovalsComponent, selectors: [["event-approvals"]], inputs: { show_declined: [1, "show_declined"] }, decls: 12, vars: 8, consts: [["delegateMenu", "matMenu"], [1, "mb-4", "rounded", "border", "border-base-300", "bg-base-100", "p-4"], [1, "mb-3", "flex", "items-center", "justify-between"], [1, "flex", "items-center", "space-x-1", "text-base", "font-medium", 3, "click"], [1, "text-lg", "transition-transform"], [1, "ml-2", "flex", "items-center", "space-x-1", "text-xs", "text-gray-600"], ["appearance", "outline", 1, "no-subscript", "w-56"], [1, "text-success", "text-xs"], ["placeholder", "Select Role", 3, "ngModelChange", "ngModel"], [3, "value"], [1, "flex", "flex-col", "items-center", "justify-center", "py-8", "text-gray-600"], [1, "mb-2", "text-4xl"], [1, "text-sm"], [1, "mb-4"], [1, "mb-2", "flex", "items-center", "space-x-2", "text-sm", "font-medium", "text-gray-600"], [1, "text-base"], [1, "flex", "flex-wrap", "gap-3"], [1, "w-80", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-3"], [1, "mb-1", "flex", "items-center", "justify-between"], [1, "flex", "items-center", "space-x-1", "text-sm", "font-semibold"], [1, "rounded", "bg-blue-100", "px-1", "text-[10px]", "font-normal", "text-blue-600"], ["icon", "", "matRipple", "", 1, "h-7", "w-7", 3, "click"], [1, "text-base", "text-gray-600"], [1, "mb-1", "text-xs", "text-gray-600"], [1, "mb-1", "flex", "items-center", "space-x-1", "text-xs", "text-gray-600"], [1, "text-xs"], [1, "mb-2", "flex", "items-center", "space-x-1", "text-xs", "text-gray-600"], [1, "flex", "items-center", "space-x-2", "pt-1"], ["btn", "", "disabled", "", 1, "border-success", "bg-success-light", "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "text-black"], ["btn", "", "disabled", "", 1, "border-error", "bg-error-light", "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "text-black"], ["btn", "", "matRipple", "", 1, "border-error", "bg-error-light", "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "text-black"], [1, "text-xs", "italic", "text-gray-600"], [1, "mt-2", "flex", "items-center", "space-x-1", "text-xs"], [1, "ml-2"], [1, "text-success", "text-2xl"], [1, "text-error", "text-2xl"], ["btn", "", "matRipple", "", 1, "border-success", "bg-success-light", "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "text-black", 3, "click"], ["btn", "", "matRipple", "", 1, "border-error", "bg-error-light", "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "text-black", 3, "click"], ["btn", "", "matRipple", "", 1, "border-base-300", "bg-base-200", "flex", "items-center", "space-x-1", 3, "matMenuTriggerFor"], [1, "text-xl"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "text-info", "text-sm"], [1, "text-info", "font-medium"]], template: function EventApprovalsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "async");
    \u0275\u0275conditionalCreate(10, EventApprovalsComponent_Conditional_10_Template, 4, 1, "mat-form-field", 6);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventApprovalsComponent, { className: "EventApprovalsComponent", filePath: "apps/concierge/src/app/events/event-approvals.component.ts", lineNumber: 402 });
})();
...
function EventListingComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", ctx_r1.show_cancelled() ? "border-error/40 bg-error/10 text-error" : "border-base-300 bg-base-100 text-base-content/70");
    \u0275\u0275advance(4);
...
function EventListingComponent_ng_template_6_Conditional_14_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", change_r5.type === "cancelled" ? "bg-error/10 text-error" : "bg-info/10 text-info");
    \u0275\u0275advance(2);
...
_EventListingComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventListingComponent, selectors: [["event-listing"]], decls: 28, vars: 42, consts: [["event_template", ""], ["location_template", ""], ["venue_req_template", ""], ["dining_req_template", ""], ["av_req_template", ""], ["safety_req_template", ""], ["events_req_template", ""], ["parking_req_template", ""], ["setup_req_template", ""], ["services_req_template", ""], ["actions_template", ""], ["menu", "matMenu"], ["mode", "indeterminate", 1, "w-full"], [1, "mb-2", "flex", "items-center", "justify-end", "space-x-2"], ["matRipple", "", 1, "flex", "items-center", "space-x-1.5", "rounded", "border", "px-3", "py-1.5", "text-xs", "font-medium", "transition-colors", 3, "ngClass"], ["empty_message", "No events for selected period", 1, "block", "w-full", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable"], [1, "h-20", "w-full"], ["matRipple", "", 1, "flex", "items-center", "space-x-1.5", "rounded", "border", "px-3", "py-1.5", "text-xs", "font-medium", "transition-colors", 3, "click", "ngClass"], [1, "text-sm"], [1, "flex", "cursor-pointer", "items-center", "space-x-2", "px-3", "py-2", "hover:bg-base-200/50", 3, "click"], ["date", "", 1, "flex", "w-8", "flex-col", "items-center", "leading-tight"], ["month", "", 1, "relative", "top-0.5", "text-sm", "font-medium", "text-gray-600"], ["day", "", 1, "relative", "-top-0.5", "text-2xl", "font-light"], ["details", "", 1, "flex", "flex-col"], [1, "flex", "items-center", "space-x-1", "text-sm", "font-medium", "hover:underline"], [1, "rounded", "bg-error/20", "px-1.5", "py-0.5", "text-[10px]", "font-semibold", "text-error"], [1, "rounded", "bg-warning/20", "px-1.5", "py-0.5", "text-[10px]", "font-semibold", "text-warning"], [1, "mt-0.5", "flex", "flex-wrap", "gap-1"], [1, "text-xs", "text-gray-600"], [1, "flex", "items-center", "space-x-0.5", "rounded", "px-1", "py-0.5", "text-[10px]", "font-medium", 3, "ngClass"], [1, "text-[10px]"], [1, "p-4", "text-sm"], [1, "flex", "items-center", "justify-center", "p-2"], [1, "flex", "h-7", "w-7", "items-center", "justify-center", "rounded", "bg-success"], [1, "flex", "h-7", "w-7", "items-center", "justify-center", "rounded", "bg-error"], [1, "flex", "h-7", "w-7", "items-center", "justify-center", "rounded", "bg-warning"], [1, "text-gray-600"], [1, "text-base", "text-white"], ["icon", "", "matRipple", "", "aria-label", "Event actions", 1, "mx-2", "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["aria-hidden", "true"], [1, "sr-only"], ["mat-menu-item", "", 3, "routerLink"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "mr-2"], ["mat-menu-item", "", 3, "click"], [1, "text-error", "text-2xl"]], template: function EventListingComponent_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventListingComponent, { className: "EventListingComponent", filePath: "apps/concierge/src/app/events/event-listing.component.ts", lineNumber: 462 });
})();
...
function EventQuotesComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, EventQuotesComponent_Conditional_15_For_3_Template, 2, 2, "mat-option", 14, _forTrack06);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
...
function EventQuotesComponent_ng_template_25_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function EventQuotesComponent_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, EventQuotesComponent_ng_template_25_Conditional_3_Template, 5, 0, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function EventQuotesComponent_ng_template_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(11, EventQuotesComponent_ng_template_41_Conditional_11_Template, 6, 0, "button", 37);
    \u0275\u0275conditionalCreate(12, EventQuotesComponent_ng_template_41_Conditional_12_Template, 6, 0, "button", 37);
    \u0275\u0275conditionalCreate(13, EventQuotesComponent_ng_template_41_Conditional_13_Template, 6, 0, "button", 37);
    \u0275\u0275conditionalCreate(14, EventQuotesComponent_ng_template_41_Conditional_14_Template, 6, 0, "button", 37);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
_EventQuotesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventQuotesComponent, selectors: [["event-quotes"]], decls: 44, vars: 63, consts: [["event_template", ""], ["type_template", ""], ["docnum_template", ""], ["vendor_template", ""], ["total_template", ""], ["status_template", ""], ["due_template", ""], ["updated_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "mb-4", "flex", "flex-wrap", "items-center", "gap-2"], ["appearance", "outline", 1, "no-subscript", "w-44"], [3, "ngModelChange", "ngModel"], ["value", "all"], [3, "value"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["matInput", "", "placeholder", "Search docs...", 3, "ngModelChange", "ngModel"], [1, "mb-2", "text-base", "font-semibold"], [1, "w-full", "overflow-x-auto"], ["empty_message", "No quotes found", 1, "block", "w-full", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable"], [1, "mb-2", "mt-8", "text-base", "font-semibold"], ["empty_message", "No invoices found", 1, "block", "w-full", "min-w-4xl", "text-sm", 3, "data", "columns", "sortable"], [1, "h-20", "w-full"], [1, "cursor-pointer", "px-3", "py-2", "text-sm", "font-medium", "hover:underline", 3, "click"], [1, "mt-0.5", "flex", "items-center", "space-x-1"], [1, "text-error", "text-xs"], [1, "text-[10px]", "font-semibold", "text-error"], [1, "px-3", "py-2"], [1, "rounded-full", "px-2", "py-0.5", "text-xs", "font-medium"], [1, "px-3", "py-2", "text-sm", "font-mono"], [1, "px-3", "py-2", "text-sm"], [1, "px-3", "py-2", "text-sm", "font-medium"], ["icon", "", "matRipple", "", 1, "mx-2", "h-12", "w-12", "rounded-sm", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "mr-2"], ["mat-menu-item", ""]], template: function EventQuotesComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(5, EventQuotesComponent_For_6_Template, 2, 2, "mat-option", 14, _forTrack06);
    \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventQuotesComponent, { className: "EventQuotesComponent", filePath: "apps/concierge/src/app/events/event-quotes.component.ts", lineNumber: 311 });
})();
...
function EventsListComponent_For_26_Template(rf, ctx) {
  if (rf & 1) {
...
function EventsListComponent_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "event-quotes");
  }
}
function EventsListComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
...
_EventsListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventsListComponent, selectors: [["app-event-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 39, vars: 46, consts: [[1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "p-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], ["filters", "", 1, "flex", "items-center", "space-x-2", "px-8", "pb-4"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "week"], ["value", "month"], ["appearance", "outline", 1, "no-subscript", "w-64"], [3, "value"], [1, "flex", "items-center", "space-x-1", "px-8", "pb-4"], ["matRipple", "", 1, "rounded-full", "px-4", "py-1.5", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-y-auto", "px-8"], [1, "min-h-full", "w-full", "overflow-x-auto"], [1, "absolute", "inset-0", "z-50", "flex", "items-center", "justify-center"], [1, "block"], [1, "bg-base-100", "absolute", "inset-0", "opacity-80"], [1, "max-w-lg", "text-lg", "text-gray-600"]], template: function EventsListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "mat-form-field", 11)(23, "mat-select", 8);
    \u0275\u0275pipe(24, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function EventsListComponent_Template_mat_select_ngModelChange_23_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.selected_range, $event) || (ctx.selected_range = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function EventsListComponent_Template_mat_select_ngModelChange_23_listener($event) {
      return ctx.setPeriod($event);
    });
    \u0275\u0275repeaterCreate(25, EventsListComponent_For_26_Template, 2, 2, "mat-option", 12, _forTrack07);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(33, " Quotes & Invoices ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div", 15);
    \u0275\u0275conditionalCreate(35, EventsListComponent_Conditional_35_Template, 1, 0, "event-approvals");
    \u0275\u0275conditionalCreate(36, EventsListComponent_Conditional_36_Template, 2, 0, "div", 16);
    \u0275\u0275conditionalCreate(37, EventsListComponent_Conditional_37_Template, 1, 0, "event-quotes");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(38, EventsListComponent_Conditional_38_Template, 5, 3, "div", 17);
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(14, 35, ctx.period));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(15, 37, "COMMON.VIEW_PERIOD"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 39, "COMMON.WEEK"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 41, "COMMON.MONTH"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx.selected_range);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(24, 43, "COMMON.DATE_RANGE"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.view === "approvals" ? 35 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.view === "list" ? 36 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.view === "quotes" ? 37 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx.has_calendar ? 38 : -1);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
//# sourceMappingURL=events.module-7TK7WNUD.js.map
