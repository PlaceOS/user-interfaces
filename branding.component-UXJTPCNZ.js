...
function BrandingComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 4)(1, "icon", 25);
    \u0275\u0275text(2, "lock");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
...
function BrandingComponent_For_19_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 31);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function BrandingComponent_For_19_Conditional_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const $index_r4 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeColour($index_r4));
    });
...
function BrandingComponent_For_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "input", 26);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("input", function BrandingComponent_For_19_Template_input_input_1_listener($event) {
      const $index_r4 = \u0275\u0275restoreView(_r3).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setColourFromInput($index_r4, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-form-field", 27)(4, "input", 28);
    \u0275\u0275listener("ngModelChange", function BrandingComponent_For_19_Template_input_ngModelChange_4_listener($event) {
      const $index_r4 = \u0275\u0275restoreView(_r3).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setColour($index_r4, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, BrandingComponent_For_19_Conditional_7_Template, 4, 4, "button", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("disabled", !ctx_r1.can_edit())("value", colour_r6);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(2, 12, "SIGNAGE_MANAGER.BRAND_COLOURS"));
    \u0275\u0275advance(3);
    \u0275\u0275classProp("text-error", ctx_r1.colour_errors()[$index_r4]);
    \u0275\u0275property("ngModel", colour_r6)("disabled", !ctx_r1.can_edit());
    \u0275\u0275attribute("aria-invalid", ctx_r1.colour_errors()[$index_r4] ? "true" : null);
    \u0275\u0275control();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.colourName($index_r4));
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.can_edit() ? 7 : -1);
  }
}
function BrandingComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function BrandingComponent_Conditional_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
function BrandingComponent_For_27_Template(rf, ctx) {
  if (rf & 1) {
...
function BrandingComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
...
function BrandingComponent_For_37_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function BrandingComponent_For_37_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 37);
    \u0275\u0275pipe(1, "translate");
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("source", ctx_r1.logoUrl(slot_r9.id))("alt", \u0275\u0275pipeBind1(1, 2, slot_r9.label));
  }
}
function BrandingComponent_For_37_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function BrandingComponent_For_37_Conditional_9_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 41);
    \u0275\u0275listener("click", function BrandingComponent_For_37_Conditional_9_Conditional_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const slot_r9 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.derive(slot_r9.id));
    });
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
...
function BrandingComponent_For_37_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 39)(1, "button", 41);
    \u0275\u0275listener("click", function BrandingComponent_For_37_Conditional_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r10);
      const slot_r9 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.pick(slot_r9.id));
    });
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, BrandingComponent_For_37_Conditional_9_Conditional_4_Template, 3, 4, "button", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const slot_r9 = \u0275\u0275nextContext().$implicit;
    ...
    \u0275\u0275property("disabled", !!ctx_r1.busy());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 3, ctx_r1.busy() === slot_r9.id ? "SIGNAGE_MANAGER.AI_LOGO_UPLOADING" : ctx_r1.logoId(slot_r9.id) ? "SIGNAGE_MANAGER.AI_REPLACE_LOGO" : "SIGNAGE_MANAGER.AI_ADD_LOGO"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r1.logoId(slot_r9.id) && ctx_r1.logoId(ctx_r1.other(slot_r9.id)) ? 4 : -1);
  }
}
function BrandingComponent_For_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20)(1, "div", 33)(2, "span", 34);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, BrandingComponent_For_37_Conditional_5_Template, 3, 3, "span", 35);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 36);
    \u0275\u0275conditionalCreate(7, BrandingComponent_For_37_Conditional_7_Template, 2, 4, "img", 37)(8, BrandingComponent_For_37_Conditional_8_Template, 3, 5, "span", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, BrandingComponent_For_37_Conditional_9_Template, 5, 5, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.derived() === slot_r9.id ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275styleProp("background", slot_r9.ground);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.logoId(slot_r9.id) ? 7 : 8);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.can_edit() ? 9 : -1);
  }
}
function BrandingComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 43);
    \u0275\u0275listener("click", function BrandingComponent_Conditional_42_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
...
function BrandingComponent_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BrandingComponent, selectors: [["app-branding"]], viewQuery: function BrandingComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275pipe(6, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(7, BrandingComponent_Conditional_7_Template, 5, 3, "p", 4);
        ...
        \u0275\u0275pipe(13, "translate");
        \u0275\u0275twoWayListener("ngModelChange", function BrandingComponent_Template_input_ngModelChange_12_listener($event) {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275repeaterCreate(18, BrandingComponent_For_19_Template, 8, 14, "div", 10, \u0275\u0275repeaterTrackByIndex);
        \u0275\u0275conditionalCreate(20, BrandingComponent_Conditional_20_Template, 3, 3, "button", 11);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275twoWayListener("ngModelChange", function BrandingComponent_Template_mat_select_ngModelChange_25_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.font, $event) || (ctx.font = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("ngModelChange", function BrandingComponent_Template_mat_select_ngModelChange_25_listener() {
          return ctx.previewFont();
        });
        \u0275\u0275repeaterCreate(26, BrandingComponent_For_27_Template, 3, 4, "mat-option", 15, _forTrack0);
        \u0275\u0275elementEnd();
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275pipe(33, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(34, BrandingComponent_Conditional_34_Template, 3, 3, "p", 18);
        \u0275\u0275elementStart(35, "div", 19);
        \u0275\u0275repeaterCreate(36, BrandingComponent_For_37_Template, 10, 8, "div", 20, _forTrack1);
        \u0275\u0275elementStart(38, "input", 21, 0);
        \u0275\u0275pipe(40, "translate");
        \u0275\u0275listener("change", function BrandingComponent_Template_input_change_38_listener($event) {
          return ctx.pickLogo($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(41, "div", 22);
        \u0275\u0275conditionalCreate(42, BrandingComponent_Conditional_42_Template, 3, 4, "button", 23);
        \u0275\u0275conditionalCreate(43, BrandingComponent_Conditional_43_Template, 3, 3, "span", 24);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 20, "SIGNAGE_MANAGER.BRAND_HEADER"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 22, "SIGNAGE_MANAGER.BRAND_HINT"), " ");
        \u0275\u0275advance(2);
        \u0275\u0275conditional(!ctx.can_edit() ? 7 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 24, "SIGNAGE_MANAGER.BRAND_ORGANISATION"));
        \u0275\u0275advance(3);
        \u0275\u0275twoWayProperty("ngModel", ctx.organisation);
        \u0275\u0275property("disabled", !ctx.can_edit())("placeholder", \u0275\u0275pipeBind1(13, 26, "SIGNAGE_MANAGER.BRAND_ORGANISATION"));
        \u0275\u0275control();
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 28, "SIGNAGE_MANAGER.BRAND_COLOURS"));
        \u0275\u0275advance(3);
        \u0275\u0275repeater(ctx.colours());
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.can_edit() && ctx.colours().length < 3 ? 20 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 30, "SIGNAGE_MANAGER.BRAND_FONT"));
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(30, 32, "SIGNAGE_MANAGER.BRAND_FONT_SAMPLE"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 34, "SIGNAGE_MANAGER.BRAND_LOGO"));
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.can_edit() ? 34 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.slots);
        \u0275\u0275advance(2);
        \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(40, 36, "SIGNAGE_MANAGER.AI_ADD_LOGO"));
        \u0275\u0275advance(4);
        \u0275\u0275conditional(ctx.can_edit() ? 42 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(!ctx.enabled() ? 43 : -1);
      }
    }, dependencies: [
      AuthenticatedImageDirective,
      FormsModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BrandingComponent, { className: "BrandingComponent", filePath: "apps/signage-manager/src/app/branding/branding.component.ts", lineNumber: 299 });
})();
export {
  BrandingComponent
};
//# debugId=5d2944c2-0687-5e0e-ac07-4198da5ce71c
//# sourceMappingURL=branding.component-UXJTPCNZ.js.map
