...
function AssetCategoryFormComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(19, 15, "APP.CONCIERGE.ASSETS_CATEGORY_PARENT_EMPTY"))("disabled", !ctx_r1.categories().length);
    \u0275\u0275advance(2);
...
var AssetCategoryFormComponent = class _AssetCategoryFormComponent {
  constructor() {
    ...
    this.categories_list = toSignal(this._state.categories, {
      initialValue: []
    });
    this.categories = computed(() => this.categories_list().filter((_) => _.parent_category_id !== this.form.value.id), ...ngDevMode ? [{ debugName: "categories" }] : (
      /* istanbul ignore next */
      []
    ));
...
var AssetCategoryManagementModalComponent = class _AssetCategoryManagementModalComponent {
  constructor() {
    ...
    this.list = toSignal(this._data.list, { initialValue: [] });
    this.edit = this._data.edit;
    this.remove = async (category) => {
      await il(category.id);
      this.changed.emit();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetCategoryManagementModalComponent, { className: "AssetCategoryManagementModalComponent", filePath: "apps/concierge/src/app/asset-manager/asset-category-management-modal.component.ts", lineNumber: 85 });
})();
...
var AssetManagerStateService = class _AssetManagerStateService extends AsyncHandler {
  constructor() {
    ...
    this.filtered_products = combineLatest([
      this.products,
      this._options
    ]).pipe(map(([list, options]) => options.search ? list.filter((i) => i.name.toLowerCase().includes(options.search.toLowerCase())) : list), startWith([]));
    ...
    this.settings = combineLatest([
      this._org.active_building,
      this._change
    ]).pipe(filter(([_]) => !!_), switchMap(([_]) => Fu(_.id, "assets-settings").catch(() => ({}))), map((_) => _.details || {}), shareReplay(1));
  ...
  async postForm() {
    ...
    data.other_data = Js(other_data, [void 0, null, ""]);
  ...
  async getConfig(zone_id = this._org.building.id) {
    const rules = (await Fu(zone_id, "assets_config")).details;
...
var AssetBulkFormComponent = class _AssetBulkFormComponent extends AsyncHandler {
  constructor() {
    ...
    this.purchase_orders = toSignal(this._state.purchase_orders, {
      initialValue: []
    });
    this.product = signal(null, ...ngDevMode ? [{ debugName: "product" }] : (
      /* istanbul ignore next */
      []
    ));
    this.count = signal(2, ...ngDevMode ? [{ debugName: "count" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe(async (params) => {
      if (params.get("id")) {
        ...
        const asset = await Lh(params.get("id")).catch(() => null);
        if (!asset) {
      ...
      if (params.get("group_id")) {
        ...
        const product = await Jh(params.get("group_id")).catch(() => null);
        if (!product) {
  ...
  async save() {
    ...
    const data = this.form.value;
    const list = await Wh(new Array(this.count()).fill(__spreadProps(__spreadValues({}, data), {
      zone_id: this._org.building.id
    }))).catch((e) => {
      this.loading.set("");
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetBulkFormComponent, selectors: [["asset-bulk-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 40, vars: 46, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", 3, "ngModel", "ngModelOptions", "disabled"], [1, "flex", "items-center", "space-x-2"], ["for", "count"], ["matInput", "", "name", "count", "type", "number", 3, "ngModelChange", "ngModel", "placeholder", "ngModelOptions"], ["for", "identifier"], ["matInput", "", "name", "identifier", "formControlName", "identifier", 3, "placeholder"], ["for", "purchase-order-id"], ["formControlName", "purchase_order_id", 3, "placeholder"], [3, "value"], [1, "opacity-60", 3, "disabled"]], template: function AssetBulkFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(36, AssetBulkFormComponent_Conditional_36_Template, 3, 4, "mat-option", 14);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        let tmp_1_0;
        let tmp_5_0;
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 19, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_BULK_EDIT" : "APP.CONCIERGE.ASSETS_BULK_ADD"))("close", ctx.product() ? \u0275\u0275pureFunction2(39, _c0, ctx.base_route, (tmp_1_0 = ctx.product()) == null ? null : tmp_1_0.id) : \u0275\u0275pureFunction1(42, _c1, ctx.base_route))("loading", ctx.loading());
        \u0275\u0275advance(2);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 21, "APP.CONCIERGE.ASSETS_PRODUCT"));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", ((tmp_5_0 = ctx.product()) == null ? null : tmp_5_0.name) || "No Product")("ngModelOptions", \u0275\u0275pureFunction0(44, _c2))("disabled", true);
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 23, "APP.CONCIERGE.ASSETS_BULK_COUNT"));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", ctx.count())("placeholder", \u0275\u0275pipeBind1(16, 25, "APP.CONCIERGE.ASSETS_BULK_COUNT"))("ngModelOptions", \u0275\u0275pureFunction0(45, _c2));
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(39, 37, "APP.CONCIERGE.ASSETS_ORDER_ID_REQUIRED"));
      }
    }, dependencies: [
      FullscreenModalShellComponent,
      MatFormFieldModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetBulkFormComponent, { className: "AssetBulkFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-bulk-form.component.ts", lineNumber: 148 });
})();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetFormComponent, selectors: [["asset-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 53, vars: 55, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", 3, "ngModel", "ngModelOptions", "disabled"], [1, "flex", "items-center", "space-x-2"], ["for", "serial-number"], ["matInput", "", "name", "serial-number", "formControlName", "serial_number", 3, "placeholder"], ["for", "identifier"], ["matInput", "", "name", "identifier", "formControlName", "identifier", 3, "placeholder"], ["for", "purchase-order-id"], ["formControlName", "purchase_order_id", 3, "placeholder"], [3, "value"], [1, "opacity-60", 3, "disabled"], ["matInput", "", "name", "barcode", "formControlName", "barcode", 3, "placeholder"]], template: function AssetFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(39, AssetFormComponent_Conditional_39_Template, 3, 4, "mat-option", 14);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(40, "mat-error");
        \u0275\u0275text(41);
        \u0275\u0275pipe(42, "translate");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(43, "div", 2)(44, "label", 7);
        \u0275\u0275text(45);
        \u0275\u0275pipe(46, "translate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "mat-form-field", 4);
      ...
      if (rf & 2) {
        let tmp_1_0;
        let tmp_5_0;
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 21, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_EDIT" : "APP.CONCIERGE.ASSETS_NEW"))("close", ctx.product() ? \u0275\u0275pureFunction2(49, _c02, ctx.base_route, (tmp_1_0 = ctx.product()) == null ? null : tmp_1_0.id) : \u0275\u0275pureFunction1(52, _c12, ctx.base_route))("loading", ctx.loading());
        \u0275\u0275advance(2);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 23, "APP.CONCIERGE.ASSETS_PRODUCT"));
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", ((tmp_5_0 = ctx.product()) == null ? null : tmp_5_0.name) || "No Product")("ngModelOptions", \u0275\u0275pureFunction0(54, _c22))("disabled", true);
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 41, "APP.CONCIERGE.ASSETS_ORDER_ID_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(46, 43, "APP.CONCIERGE.ASSETS_BARCODE"));
        \u0275\u0275advance(3);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(49, 45, "APP.CONCIERGE.ASSETS_BARCODE"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(52, 47, "APP.CONCIERGE.ASSETS_BARCODE_REQUIRED"));
      }
    }, dependencies: [
      FullscreenModalShellComponent,
      MatFormFieldModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetFormComponent, { className: "AssetFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-form.component.ts", lineNumber: 166 });
})();
...
var AssetGroupFormComponent = class _AssetGroupFormComponent extends AsyncHandler {
  constructor() {
    ...
    this.new_category = signal(null, ...ngDevMode ? [{ debugName: "new_category" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.current_category = signal("", ...ngDevMode ? [{ debugName: "current_category" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe(async (params) => {
      if (params.get("id")) {
        this.loading.set("Loading Product Details...");
        const product = await Jh(params.get("id")).catch(() => null);
        if (!product) {
  ...
  async save() {
    ...
    this.loading.set("Saving Product...");
    const data = this.form.value;
    const item = await lastValueFrom(saveAssetType(data)).catch((e) => {
      this.loading.set("");
    ...
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetGroupFormComponent, selectors: [["asset-group-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 62, vars: 50, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "name"], ["appearance", "outline"], ["matInput", "", "name", "name", "formControlName", "name", 3, "placeholder"], ["formControlName", "category_id", 3, "click", "placeholder"], [3, "value"], [1, "relative", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["for", "brand"], ["matInput", "", "name", "brand", "formControlName", "brand", 3, "placeholder"], ["for", "description"], ["matInput", "", "name", "description", "placeholder", "Description of the product", "formControlName", "description"], ["for", "images"], ["name", "images", "formControlName", "images"]], template: function AssetGroupFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function AssetGroupFormComponent_Template_mat_select_click_22_listener() {
          return ctx.current_category.set(ctx.form.value.category_id);
        });
      ...
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 17, ctx.form.value.id ? "APP.CONCIERGE.ASSETS_ITEM_EDIT" : "APP.CONCIERGE.ASSETS_ITEM_NEW"))("close", ctx.form.value.id ? \u0275\u0275pureFunction2(45, _c03, ctx.base_route, ctx.form.value.id) : \u0275\u0275pureFunction1(48, _c13, ctx.base_route))("loading", ctx.loading());
        \u0275\u0275advance(2);
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(32, 29, "COMMON.CATEGORY_NEW"), " ");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(35, 31, "COMMON.CATEGORY_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(39, 33, "APP.CONCIERGE.ASSETS_ITEM_BRAND"));
        \u0275\u0275advance(5);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(44, 35, "APP.CONCIERGE.ASSETS_ITEM_BRAND"));
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 37, "APP.CONCIERGE.ASSETS_ITEM_BRAND_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 39, "COMMON.DESCRIPTION"));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(56, 41, "COMMON.DESCRIPTION_REQUIRED"));
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(60, 43, "COMMON.IMAGES"));
      }
    }, dependencies: [
      FullscreenModalShellComponent,
      ImageListFieldComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetGroupFormComponent, { className: "AssetGroupFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-group-form.component.ts", lineNumber: 156 });
})();
...
function AssetItemListComponent_div_0_ng_container_1_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" (", \u0275\u0275pipeBind2(6, 4, "COMMON.ITEM_COUNT", \u0275\u0275pureFunction1(7, _c04, (tmp_6_0 = ctx_r2.products()[group_r4.id]) == null ? null : tmp_6_0.length)), ") ");
    \u0275\u0275advance(2);
...
function AssetItemListComponent_div_0_ng_container_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_4_0 = ctx_r2.products()[group_r4.id]) == null ? null : tmp_4_0.length);
  }
}
...
var AssetItemListComponent = class _AssetItemListComponent {
  constructor() {
    ...
    this.categories = toSignal(this._state.categories, {
      initialValue: []
    });
    this.products = toSignal(this._state.product_mapping, {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetItemListComponent, { className: "AssetItemListComponent", filePath: "apps/concierge/src/app/asset-manager/asset-item-list.component.ts", lineNumber: 198 });
})();
...
function AssetManagerTopbarComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", (tmp_1_0 = ctx_r0.building()) == null ? null : tmp_1_0.id)("placeholder", \u0275\u0275pipeBind1(3, 2, "COMMON.BUILDINGS_ALL"));
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetManagerTopbarComponent, { className: "AssetManagerTopbarComponent", filePath: "apps/concierge/src/app/asset-manager/asset-manager-topbar.component.ts", lineNumber: 184 });
})();
...
var AssetListingComponent = class _AssetListingComponent extends AsyncHandler {
  constructor() {
    ...
    this._state = inject(AssetManagerStateService);
    this.is_new = true;
    this.current_url = toSignal(this._router.events.pipe(filter((event) => event instanceof NavigationEnd), startWith(null), map(() => this._router.url)), { initialValue: this._router.url });
    this.active = computed(() => this.current_url().includes("requests") ? "requests" : this.current_url().includes("items") ? "items" : "purchase-orders", ...ngDevMode ? [{ debugName: "active" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetListingComponent, { className: "AssetListingComponent", filePath: "apps/concierge/src/app/asset-manager/asset-listing.component.ts", lineNumber: 69 });
})();
...
var AssetManagerComponent = class _AssetManagerComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetManagerComponent, selectors: [["", "asset-manager", ""]], attrs: _c07, decls: 5, vars: 0, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"]], template: function AssetManagerComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetManagerComponent, { className: "AssetManagerComponent", filePath: "apps/concierge/src/app/asset-manager/asset-manager.component.ts", lineNumber: 36 });
})();
...
var AssetPurchaseOrderFormComponent = class _AssetPurchaseOrderFormComponent extends AsyncHandler {
  constructor() {
    ...
    this.product_id = signal("", ...ngDevMode ? [{ debugName: "product_id" }] : (
      /* istanbul ignore next */
      []
    ));
    this._id = signal("", ...ngDevMode ? [{ debugName: "_id" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.asset_list = toSignal(combineLatest([toObservable(this._id), this._org.active_building]).pipe(filter(([id, bld]) => !!id && !!bld), switchMap(([id]) => queryAssets({ order_id: id })), switchMap(async (asset_list) => {
  ...
  ngOnInit() {
    this.subscription("route.query", this._route.queryParamMap.subscribe(async (params) => {
      if (params.get("id")) {
        ...
        const asset = await ol(params.get("id")).catch(() => null);
        if (!asset) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetPurchaseOrderFormComponent, selectors: [["asset-purchase-order-form"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 52, vars: 45, consts: [[3, "confirm", "heading", "close", "loading"], [3, "formGroup"], [1, "flex", "flex-col", "space-y-2"], ["for", "order-number"], ["appearance", "outline"], ["matInput", "", "name", "order-number", "formControlName", "purchase_order_number", 3, "placeholder"], ["for", "invoice-number"], ["matInput", "", "name", "invoice-number", "formControlName", "invoice_number", 3, "placeholder"], [1, "flex", "space-x-2"], [1, "flex", "flex-1", "flex-col", "space-y-2"], ["for", "purchase-date"], ["name", "purchase-date", "formControlName", "purchase_date", 3, "from"], ["for", "unit-price"], ["appearance", "outline", 1, "w-full"], ["matPrefix", ""], ["matInput", "", "name", "unit-price", "formControlName", "unit_price"], ["for", "depreciation-start-date"], ["name", "depreciation-start-date", "formControlName", "expected_service_start_date", 3, "from"], ["for", "depreciation-end-date"], ["name", "depreciation-end-date", "formControlName", "expected_service_end_date"], [1, "mb-2", "font-medium"], [1, "block", "w-full", "text-sm", 3, "data", "columns", "empty_message"]], template: function AssetPurchaseOrderFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(50, AssetPurchaseOrderFormComponent_Conditional_50_Template, 3, 6, "h3", 20);
        \u0275\u0275conditionalCreate(51, AssetPurchaseOrderFormComponent_Conditional_51_Template, 5, 21, "simple-table", 21);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        let tmp_16_0;
        ...
        \u0275\u0275advance(3);
        \u0275\u0275conditional(((tmp_16_0 = ctx.item()) == null ? null : tmp_16_0.id) ? 50 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(((tmp_17_0 = ctx.item()) == null ? null : tmp_17_0.id) ? 51 : -1);
      }
    }, dependencies: [
      FullscreenModalShellComponent,
      SimpleTableComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetPurchaseOrderFormComponent, { className: "AssetPurchaseOrderFormComponent", filePath: "apps/concierge/src/app/asset-manager/asset-purchase-order-form.component.ts", lineNumber: 194 });
})();
...
var AssetPurchaseOrderListComponent = class _AssetPurchaseOrderListComponent {
  constructor() {
    ...
    this._router = inject(Router);
    this.now = Date.now();
    this.purchase_orders = toSignal(combineLatest([this._state.options, this._state.purchase_orders]).pipe(map(([{ search }, list]) => (list || []).filter((_) => !search || _.purchase_order_number.toLowerCase().includes(search.toLowerCase()) || _.invoice_number?.toLowerCase().includes(search.toLowerCase())))), { initialValue: [] });
    this.filters = toSignal(this._state.options, {
      initialValue: { view: "grid" }
    });
  }
  editOrder(order) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetPurchaseOrderListComponent, selectors: [["app-asset-purchase-order-list"]], decls: 11, vars: 36, consts: [["date_template", ""], [1, "relative", "-left-4", "mt-4", "flex", "h-[calc(100%-1rem)]", "w-[calc(100%+2rem)]", "flex-col"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "p-4"], ["purchase-orders", "", 1, "block", "min-w-208", "text-sm", 3, "row_clicked", "data", "columns", "empty_message", "filter", "sortable"], [1, "p-4"], [1, "opacity-30"]], template: function AssetPurchaseOrderListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("data", ctx.purchase_orders())("columns", \u0275\u0275pureFunction5(30, _c52, \u0275\u0275pureFunction1(17, _c09, \u0275\u0275pipeBind1(3, 5, "APP.CONCIERGE.ASSETS_PURCHASE_NUMBER")), \u0275\u0275pureFunction1(19, _c18, \u0275\u0275pipeBind1(4, 7, "APP.CONCIERGE.ASSETS_PURCHASE_INVOICE")), \u0275\u0275pureFunction2(21, _c26, \u0275\u0275pipeBind1(5, 9, "APP.CONCIERGE.ASSETS_PURCHASE_DATE"), date_template_r2), \u0275\u0275pureFunction2(24, _c32, \u0275\u0275pipeBind1(6, 11, "APP.CONCIERGE.ASSETS_PURCHASE_START"), date_template_r2), \u0275\u0275pureFunction2(27, _c42, \u0275\u0275pipeBind1(7, 13, "APP.CONCIERGE.ASSETS_PURCHASE_END"), date_template_r2)))("empty_message", \u0275\u0275pipeBind1(8, 15, ctx.filters().search ? "APP.CONCIERGE.ASSETS_PURCHASE_SEARCH_EMPTY" : "APP.CONCIERGE.ASSETS_PURCHASE_EMPTY"))("filter", ctx.filters().search)("sortable", true);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetPurchaseOrderListComponent, { className: "AssetPurchaseOrderListComponent", filePath: "apps/concierge/src/app/asset-manager/asset-purchase-order-list.component.ts", lineNumber: 92 });
})();
...
var AssetRequestDetailsComponent = class _AssetRequestDetailsComponent {
  constructor() {
    ...
    this._org = inject(OrganisationService);
    this._settings = inject(SettingsService);
    this.request = model(void 0, ...ngDevMode ? [{ debugName: "request" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.items = computed(() => this.request()?.extension_data?.request?.items || [], ...ngDevMode ? [{ debugName: "items" }] : (
      /* istanbul ignore next */
      []
    ));
    this.time_format = computed(() => this._settings.time_format, ...ngDevMode ? [{ debugName: "time_format" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
(() => {
  ...
  }], null, { request: [{ type: Input, args: [{ isSignal: true, alias: "request", required: false }] }, { type: Output, args: ["requestChange"] }], requestChange: [{ type: Output, args: ["requestChange"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetRequestDetailsComponent, { className: "AssetRequestDetailsComponent", filePath: "apps/concierge/src/app/asset-manager/asset-request-details.component.ts", lineNumber: 289 });
})();
...
function AssetRequestListComponent_ng_template_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater((row_r4.extension_data == null ? null : row_r4.extension_data.request == null ? null : row_r4.extension_data.request.items) || \u0275\u0275pureFunction0(0, _c9));
  }
}
function AssetRequestListComponent_ng_template_21_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, row_r5.date + (row_r5.extension_data == null ? null : row_r5.extension_data.request == null ? null : row_r5.extension_data.request.deliver_offset) * 60 * 1e3 + (row_r5.extension_data == null ? null : row_r5.extension_data.request == null ? null : row_r5.extension_data.request.deliver_day_offset) * 24 * 60 * 60 * 1e3, "MMM d, " + ctx_r1.time_format()), " ");
  }
}
...
function AssetRequestListComponent_ng_template_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (tmp_8_0 = ctx_r1.level(row_r6)) == null ? null : tmp_8_0.display_name, " ");
    \u0275\u0275advance();
...
function AssetRequestListComponent_ng_template_27_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 6, row_r11.extension_data == null ? null : row_r11.extension_data.tracking) || "In Storage", " ");
    \u0275\u0275advance(11);
...
var AssetRequestListComponent = class _AssetRequestListComponent extends AsyncHandler {
  constructor() {
    ...
    this._org = inject(OrganisationService);
    this._settings = inject(SettingsService);
    this.requests = toSignal(this._state.filtered_requests.pipe(map((list) => {
    ...
    this.request = signal(null, ...ngDevMode ? [{ debugName: "request" }] : (
      /* istanbul ignore next */
      []
    ));
    this.loading = signal({}, ...ngDevMode ? [{ debugName: "loading" }] : (
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetRequestListComponent, selectors: [["app-asset-request-list"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 30, vars: 57, consts: [["user_template", ""], ["assets_template", ""], ["date_template", ""], ["level_template", ""], ["approval_template", ""], ["tracking_template", ""], ["menu", "matMenu"], ["tracking_menu", "matMenu"], [1, "relative", "flex", "h-[calc(100%-1rem)]", "w-full", "flex-col"], [1, "flex", "items-center", "justify-between"], [1, "p-4", "text-sm", "opacity-60"], [3, "dateChange", "date"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "pt-2"], ["asset-requests", "", 1, "block", "min-w-328", "text-sm", 3, "row_clicked", "data", "filter", "columns", "empty_message", "sortable"], [1, "h-20", "w-full"], [3, "requestChange", "request"], [1, "flex", "flex-col", "px-4", "py-2", "text-left"], [1, "text-xs", "opacity-30"], [1, "flex", "flex-col", "p-4"], [1, "font-mono", "text-sm"], [1, "p-4"], [1, "opacity-30"], [1, "px-4", "py-2"], ["matRipple", "", 1, "!bg-opacity-20", "flex", "w-full", "items-center", "space-x-2", "rounded-3xl", "px-2", "py-1", "text-left", 3, "click", "matMenuTriggerFor", "disabled"], [1, "text-xl"], [1, "flex-1", "capitalize"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "flex", "w-full", "items-center", "rounded-sm", "bg-none", "px-2", "py-1", "text-left", 3, "click", "matMenuTriggerFor", "disabled"], [1, "min-w-32", "flex-1", "capitalize"]], template: function AssetRequestListComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(4, 8, "APP.CONCIERGE.ASSETS_REQUESTS_COUNT", \u0275\u0275pureFunction1(27, _c011, ctx.requests().length)), " ");
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetRequestListComponent, { className: "AssetRequestListComponent", filePath: "apps/concierge/src/app/asset-manager/asset-request-list.component.ts", lineNumber: 294 });
})();
...
function AssetLocationModalComponent_Conditional_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ((tmp_3_0 = ctx_r1.level((tmp_3_0 = ctx_r1.selected().zones) == null ? null : tmp_3_0[0])) == null ? null : tmp_3_0.display_name) || "N/A", " ");
  }
}
function AssetLocationModalComponent_Conditional_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_3_0;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("src", ((tmp_3_0 = ctx_r1.level((tmp_3_0 = ctx_r1.selected().zones) == null ? null : tmp_3_0[0])) == null ? null : tmp_3_0.map_id) || "")("styles", \u0275\u0275pureFunction2(5, _c63, \u0275\u0275pureFunction0(3, _c54), \u0275\u0275pureFunction0(4, _c54)))("features", ctx_r1.selected_feature());
  }
}
...
var AssetLocationModalComponent = class _AssetLocationModalComponent {
  constructor() {
    this._state = inject(AssetManagerStateService);
    this._org = inject(OrganisationService);
    this.asset = toSignal(this._state.active_product, {
      initialValue: null
    });
    this.requests = toSignal(this._state.active_product_requests, {
      initialValue: []
    });
    ...
    this.selected_feature = signal([], ...ngDevMode ? [{ debugName: "selected_feature" }] : (
      /* istanbul ignore next */
      []
    ));
    this.loading = signal({}, ...ngDevMode ? [{ debugName: "loading" }] : (
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AssetLocationModalComponent, selectors: [["asset-location-modal"]], decls: 21, vars: 18, consts: [["level_template", ""], ["tracking_template", ""], ["tracking_menu", "matMenu"], [1, "relative", "p-6"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "top-4", "right-4"], [1, "mb-2", "font-medium"], ["appearance", "outline", 1, "mb-2", "h-14"], ["matPrefix", ""], ["matInput", "", "placeholder", "Search..."], [1, "flex", "w-[90vw]", "items-center", "space-x-4", "text-sm"], [1, "border-base-200", "bg-base-200", "h-[60vh]", "w-1/2", "flex-1", "overflow-auto", "border"], ["empty_message", "No requested assets for this product", 1, "block", "w-full", 3, "row_clicked", "data", "columns", "sortable"], [1, "border-base-200", "bg-base-200", "relative", "flex", "h-[60vh]", "w-1/2", "flex-1", "items-center", "justify-center", "border"], [1, "border-base-200", "bg-base-100", "absolute", "top-4", "left-4", "rounded-3xl", "border", "px-4", "py-2"], [3, "src", "styles", "features"], [1, "opacity-30"], [1, "p-4"], [1, "px-4", "py-2"], ["matRipple", "", 1, "flex", "w-full", "items-center", "rounded-sm", "bg-none", "px-2", "py-1", "text-left", 3, "click", "matMenuTriggerFor", "disabled"], [1, "min-w-32", "flex-1", "capitalize"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"]], template: function AssetLocationModalComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate2(" ", (tmp_2_0 = ctx.asset()) == null ? null : tmp_2_0.name, " in use location: ", ctx.requests().length, " ");
        \u0275\u0275advance(7);
        \u0275\u0275property("data", ctx.requests())("columns", \u0275\u0275pureFunction4(13, _c44, \u0275\u0275pureFunction1(7, _c012, level_template_r7), \u0275\u0275pureFunction0(9, _c110), \u0275\u0275pureFunction1(10, _c28, tracking_template_r8), \u0275\u0275pureFunction0(12, _c34)))("sortable", true);
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetLocationModalComponent, { className: "AssetLocationModalComponent", filePath: "apps/concierge/src/app/asset-manager/asset-location-modal.component.ts", lineNumber: 154 });
})();
...
function AssetViewComponent_Conditional_0_Conditional_31_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", ((tmp_6_0 = ctx_r1.item()) == null ? null : tmp_6_0.description) || "~No Description~", " ");
  }
}
...
function AssetViewComponent_Conditional_0_ng_template_61_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(8, _c55, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction2(10, _c192, row_r4.id, (tmp_8_0 = ctx_r1.item()) == null ? null : tmp_8_0.id))("matTooltip", \u0275\u0275pipeBind1(2, 4, "APP.CONCIERGE.ASSETS_ITEM_ASSET_EDIT"));
    \u0275\u0275advance(4);
...
function AssetViewComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(85, _c013));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 37, "APP.CONCIERGE.ASSETS_MANAGE_HEADER"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((tmp_7_0 = ctx_r1.item()) == null ? null : tmp_7_0.name);
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(86, _c111, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(88, _c29, (tmp_9_0 = ctx_r1.item()) == null ? null : tmp_9_0.id));
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("images", ((tmp_13_0 = ctx_r1.item()) == null ? null : tmp_13_0.images) || \u0275\u0275pureFunction0(90, _c35));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_14_0 = ctx_r1.item()) == null ? null : tmp_14_0.description) ? 31 : 32);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(95, _c55, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(97, _c64, (tmp_21_0 = ctx_r1.item()) == null ? null : tmp_21_0.id));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(52, 53, "APP.CONCIERGE.ASSETS_ITEM_ASSET_ADD"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(99, _c72, ctx_r1.base_route))("queryParams", \u0275\u0275pureFunction1(101, _c64, (tmp_24_0 = ctx_r1.item()) == null ? null : tmp_24_0.id));
    \u0275\u0275advance();
...
var AssetViewComponent = class _AssetViewComponent extends AsyncHandler {
  constructor() {
    ...
    this.deleting = signal(false, ...ngDevMode ? [{ debugName: "deleting" }] : (
      /* istanbul ignore next */
      []
    ));
    this.item = toSignal(this._state.active_product, {
      initialValue: null
    });
    this.extra_assets = toSignal(this._state.extra_assets, {
      initialValue: []
    });
    ...
    this.requests_source = toSignal(this._state.active_product_requests, { initialValue: [] });
    this.requests = computed(() => this.requests_source().filter((_) => _.date <= Date.now() && addMinutes(_.date, _.duration).valueOf() >= Date.now()), ...ngDevMode ? [{ debugName: "requests" }] : (
      /* istanbul ignore next */
      []
    ));
    this.available_count = computed(() => this.asset_list().length - this.requests().length, ...ngDevMode ? [{ debugName: "available_count" }] : (
      /* istanbul ignore next */
      []
    ));
    this._tooltip_el = viewChild(CustomTooltipComponent, ...ngDevMode ? [{ debugName: "_tooltip_el" }] : (
      /* istanbul ignore next */
      []
    ));
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AssetViewComponent, { className: "AssetViewComponent", filePath: "apps/concierge/src/app/asset-manager/asset-view.component.ts", lineNumber: 500 });
})();
...
//# sourceMappingURL=asset-manager.module-LIOEWVHR.js.map
