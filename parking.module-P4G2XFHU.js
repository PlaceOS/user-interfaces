...
_ParkingUsersListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParkingUsersListComponent, selectors: [["parking-users-list"]], decls: 18, vars: 42, consts: [["name_template", ""], ["denied_template", ""], ["plate_template", ""], ["action_template", ""], [1, "w-full"], [1, "block", "min-w-[68rem]", "text-sm", 3, "data", "columns", "filter", "sortable"], [1, "h-20", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "bg-error", "text-2xl", "text-error-content"], [1, "p-4", "font-mono", "text-sm", "uppercase"], [1, "opacity-30"], [1, "mx-auto", "flex", "items-center", "space-x-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", 1, "text-error", 3, "click", "matTooltip"]], template: function ParkingUsersListComponent_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("data", ctx.user_list)("columns", \u0275\u0275pureFunction6(35, _c6, \u0275\u0275pureFunction2(20, _c02, \u0275\u0275pipeBind1(3, 8, "APP.CONCIERGE.PARKING_USER"), name_template_r9), \u0275\u0275pureFunction1(23, _c1, \u0275\u0275pipeBind1(4, 10, "APP.CONCIERGE.PARKING_CAR_COLOUR")), \u0275\u0275pureFunction2(25, _c2, \u0275\u0275pipeBind1(5, 12, "EXPLORE.PARKING_PLATE_NUMBER"), plate_template_r11), \u0275\u0275pureFunction1(28, _c3, \u0275\u0275pipeBind1(6, 14, "FORM.NOTES")), \u0275\u0275pureFunction2(30, _c4, \u0275\u0275pipeBind1(7, 16, "APP.CONCIERGE.PARKING_USER_DENY"), denied_template_r10), \u0275\u0275pureFunction1(33, _c5, action_template_r12)))("filter", (tmp_7_0 = \u0275\u0275pipeBind1(8, 18, ctx.options)) == null ? null : tmp_7_0.search)("sortable", true);
  }
}, dependencies: [
  CommonModule,
  AsyncPipe,
...
function ParkingTopbarComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(12, _c03))("matTooltip", \u0275\u0275pipeBind1(2, 8, "COMMON.LIST"));
    \u0275\u0275advance(4);
    \u0275\u0275classProp("inverse", ctx_r1.view() !== "map");
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(13, _c12))("matTooltip", \u0275\u0275pipeBind1(6, 10, "COMMON.MAP"));
  }
}
...
var _c04 = () => ["/book", "parking", "manage", "spaces"];
var _c13 = () => ["/book", "parking", "manage", "users"];
var _c22 = () => ["/book", "parking", "manage", "map"];
function ParkingComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(16, _c04))("active", ctx_r1.view() === "spaces");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(4, 10, "APP.CONCIERGE.PARKING_TAB_SPACES"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(17, _c13))("active", ctx_r1.view() === "users");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 12, "APP.CONCIERGE.PARKING_TAB_USERS"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(18, _c22))("active", ctx_r1.view() === "map");
    \u0275\u0275advance();
...
//# sourceMappingURL=parking.module-P4G2XFHU.js.map
