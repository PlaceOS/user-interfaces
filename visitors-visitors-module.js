...
function VisitorDetailsComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](1, VisitorDetailsComponent_ng_container_1_i_1_Template, 2, 0, "i", 11);
...
VisitorDetailsComponent.ɵfac = function VisitorDetailsComponent_Factory(t) { return new (t || VisitorDetailsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_visitors_state_service__WEBPACK_IMPORTED_MODULE_4__["VisitorsStateService"])); };
VisitorDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: VisitorDetailsComponent, selectors: [["visitor-details"]], inputs: { event: "event", visitor: "visitor" }, outputs: { eventChange: "eventChange" }, decls: 15, vars: 12, consts: [[1, "w-12", "text-lg", "flex", "justify-center"], [4, "ngIf", "ngIfElse"], ["checkin_state", ""], ["host_state", ""], ["flex", "", 1, "p-2", "flex-1"], [1, "w-32", "p-2", "flex", "items-center", "justify-end"], ["matTooltip", "Checkin Guest", "className", "material-icons", "content", "event_available", 3, "loading", "state", "click"], ["matTooltip", "Checkout Guest", "className", "material-icons", "content", "event_busy", 3, "loading", "click"], ["mat-icon-button", "", 3, "href", "matTooltip"], ["className", "material-icons"], [1, "w-16", "p-2"], ["class", "p-2 rounded-full material-icons border-2 border-dotted border-gray-600", 4, "ngIf", "ngIfElse"], [1, "p-2", "rounded-full", "material-icons", "border-2", "border-dotted", "border-gray-600"], [1, "p-2", "rounded-full", "material-icons", "bg-green-600", "border-2", "border-green-600", "text-white"], [1, "p-2", "rounded-full", "material-icons", "bg-blue-600", "border-2", "border-blue-600", "text-white"]], template: function VisitorDetailsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function VisitorDetailsComponent_Template_action_icon_click_9_listener() { return ctx.checkin(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](10, "action-icon", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function VisitorDetailsComponent_Template_action_icon_click_10_listener() { return ctx.checkout(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](11, "a", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](12, "app-icon", 9);
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _libs_components_src_lib_action_icon_action_icon_component__WEBPACK_IMPORTED_MODULE_6__["ActionIconComponent"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_7__["MatTooltip"], _angular_material_button__WEBPACK_IMPORTED_MODULE_8__["MatAnchor"], _libs_components_src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_9__["IconComponent"]], styles: ["[_nghost-%COMP%] {\n                display: flex;\n                align-items: center;\n                width: 100%;\n                padding: 0 0.5rem;\n            }\n\n            [_nghost-%COMP%]    > div[_ngcontent-%COMP%] {\n                display: flex;\n                align-items: center;\n                height: 100%;\n                border-bottom: 1px solid #ccc;\n                height: 3.5rem;\n            }\n\n            [_nghost-%COMP%]    > div[_ngcontent-%COMP%]:first-child {\n                border: none;\n            }\n\n            .invisible[_ngcontent-%COMP%] {\n                opacity: 0;\n                pointer-events: none;\n            }"] });
