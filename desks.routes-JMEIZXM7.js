import {
  PrintableComponent
} from "./chunk-ECG47W37.js";
import {
  ExploreDeskInfoComponent
} from "./chunk-J56FH3JY.js";
import {
...
} from "./chunk-IKZJEYLO.js";
import "./chunk-RUHPHW6W.js";
import {
  loadPersistedZones,
  persistZones
...
} from "./chunk-QPE7ZJFM.js";
import {
  AssetListFieldComponent,
  RecurrenceFieldComponent
} from "./chunk-QEPHOJW3.js";
  ...
  constructor() {
    ...
    this.levels = computed(
      () => {
        ...
        const level_ids = new Set(resources.map((resource2) => resource2.zone?.id).filter((_) => _));
...
var DeskSelectModalComponent = class _DeskSelectModalComponent {
  constructor() {
    ...
    this.favorites = signal(
      this._settings.get(SETTING_KEYS.FAVORITE_DESKS) || [],
      ...ngDevMode ? [{ debugName: "favorites" }] : (
        /* istanbul ignore next */
        []
      )
  ...
  toggleFavourite(item) {
    if (!item?.id)
      return;
    const fav_list = this._settings.get(SETTING_KEYS.FAVORITE_DESKS) || this.favorites();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskSelectModalComponent, { className: "DeskSelectModalComponent", filePath: "libs/bookings/src/lib/desk-select-modal/desk-select-modal.component.ts", lineNumber: 243 });
})();
...
var _c07 = () => ["user_name", "asset_name", "user_email", "asset_id", "status", "group", "title"];
var _c15 = (a0, a1) => ({ key: "date", name: a0, content: a1, size: "4rem", sortable: false });
...
var _c10 = (a0, a1) => ({ key: "actions", name: " ", content: a0, size: a1, sortable: false });
var _c11 = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => [a0, a1, a2, a3, a4, a5, a6, a7, a8, a9];
var _c122 = (a0) => ({ time: a0 });
...
function DeskBookingsComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, DeskBookingsComponent_ng_template_14_Conditional_2_Template, 3, 3, "span", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r2 = ctx.row;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r2.group || row_r2.extension_data?.group, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(!(row_r2.group || row_r2.extension_data?.group) ? 2 : -1);
  }
}
...
function DeskBookingsComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, DeskBookingsComponent_ng_template_16_Conditional_4_Template, 3, 3, "div", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DeskBookingsComponent_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, DeskBookingsComponent_ng_template_18_Conditional_6_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", user_r6?.name || user_r6?.email || email_r5, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(user_r6?.name ? 6 : -1);
  }
}
...
function DeskBookingsComponent_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, DeskBookingsComponent_ng_template_20_Conditional_6_Template, 2, 0, "icon", 30);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "mat-menu", null, 7)(9, "button", 31);
    ...
    \u0275\u0275elementStart(10, "div", 32)(11, "icon", 30);
    ...
    \u0275\u0275elementStart(17, "div", 32)(18, "icon", 30);
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("text-success-content!", row_r8?.status === "approved" && !row_r8.deleted)("bg-success!", row_r8?.status === "approved" && !row_r8.deleted)("text-neutral-content!", row_r8.deleted)("bg-neutral!", row_r8.deleted)("text-error-content!", row_r8?.status === "declined" && !row_r8.deleted)("bg-error!", row_r8?.status === "declined" && !row_r8.deleted)("text-neutral-content!", row_r8?.status === "ended" || row_r8?.has_ended)("bg-neutral!", row_r8?.status === "ended" || row_r8?.has_ended)("opacity-30", row_r8?.status === "ended" || row_r8?.has_ended);
    \u0275\u0275property("matMenuTriggerFor", menu_r9)("disabled", !ctx_r3.canChangeBooking(row_r8) || !!ctx_r3.loading());
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 26, row_r8.deleted ? "APP.CONCIERGE.BOOKING_STATUS_DELETED" : row_r8?.status === "ended" || row_r8?.has_ended ? "APP.CONCIERGE.BOOKING_STATUS_ENDED" : row_r8?.status === "approved" ? "APP.CONCIERGE.BOOKING_STATUS_APPROVED" : row_r8?.status === "declined" ? "APP.CONCIERGE.BOOKING_STATUS_DECLINED" : "APP.CONCIERGE.BOOKING_STATUS_PENDING"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r3.canChangeBooking(row_r8) ? 6 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx_r3.canChangeBooking(row_r8) || !!ctx_r3.loading());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 28, "APP.CONCIERGE.DESKS_ACTION_APPROVE"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r3.canChangeBooking(row_r8) || !!ctx_r3.loading());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 30, "APP.CONCIERGE.DESKS_ACTION_DECLINE"), " ");
  }
}
function DeskBookingsComponent_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(11, "div", 32)(12, "icon", 30);
    \u0275\u0275text(13, "check");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(18, "div", 32)(19, "icon", 30);
    \u0275\u0275text(20, "cancel");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("bg-neutral!", !data_r12)("text-neutral-content!", !data_r12)("bg-success!", data_r12)("text-success-content!", data_r12)("opacity-30", !ctx_r3.canChangeBooking(row_r11));
    \u0275\u0275property("matMenuTriggerFor", checkinMenu_r13)("disabled", !ctx_r3.canChangeBooking(row_r11) || !!ctx_r3.loading())("matTooltip", row_r11.status === "ended" ? "Desk booking has ended" : "Check-in or check-out desk");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(5, 18, data_r12 ? "COMMON.YES" : "COMMON.NO"), " ");
    \u0275\u0275advance(6);
    \u0275\u0275property("disabled", !ctx_r3.canChangeBooking(row_r11) || row_r11.checked_in || !!ctx_r3.loading());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 20, "COMMON.CHECK_IN"));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r3.canChangeBooking(row_r11) || !row_r11.checked_in || !!ctx_r3.loading());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 22, "COMMON.CHECK_OUT"));
  }
}
function DeskBookingsComponent_ng_template_24_Conditional_6_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_24_Conditional_6_Conditional_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r17);
      const row_r15 = \u0275\u0275nextContext(2).row;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.cancelSeries(row_r15));
    });
    \u0275\u0275elementStart(1, "div", 32)(2, "icon", 40);
    \u0275\u0275text(3, "delete");
    \u0275\u0275elementEnd();
...
function DeskBookingsComponent_ng_template_24_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "button", 37)(1, "icon", 30);
    \u0275\u0275text(2, "more_vert");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "mat-menu", null, 9)(5, "button", 38);
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_24_Conditional_6_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r16);
      const row_r15 = \u0275\u0275nextContext().row;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.cancel(row_r15));
    });
    \u0275\u0275elementStart(6, "div", 32)(7, "icon", 30);
    \u0275\u0275text(8, "event_busy");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(12, DeskBookingsComponent_ng_template_24_Conditional_6_Conditional_12_Template, 7, 3, "button", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const actionMenu_r18 = \u0275\u0275reference(4);
    const row_r15 = \u0275\u0275nextContext().row;
    \u0275\u0275property("matMenuTriggerFor", actionMenu_r18);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(11, 3, "COMMON.CANCEL_BOOKING"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(row_r15.instance ? 12 : -1);
  }
}
function DeskBookingsComponent_ng_template_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275listener("click", function DeskBookingsComponent_ng_template_24_Template_button_click_1_listener() {
      const row_r15 = \u0275\u0275restoreView(_r14).row;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.viewBookingHistory(row_r15));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5, "history");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(6, DeskBookingsComponent_ng_template_24_Conditional_6_Template, 13, 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(2, 3, "APP.CONCIERGE.BOOKING_VIEW_HISTORY"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(3, 5, "APP.CONCIERGE.BOOKING_VIEW_HISTORY"));
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r3.can_delete() && !ctx_r3.isRejected(row_r15) ? 6 : -1);
  }
}
...
var DeskBookingsComponent = class _DeskBookingsComponent {
  constructor() {
    ...
    this.viewBookingHistory = (b) => this._state.viewBookingHistory(b);
    this.loadMore = () => this._state.nextPage();
    this.last_updated = this._state.last_updated;
    this.state_loading = this._state.loading;
    this.refresh = () => this._state.refresh();
    this.isRejected = isDeskBookingRejected;
    this.canChangeBooking = canChangeDeskBooking;
    this.checkin = (d, s = true) => this.runMethod("checkin", async () => this._state.checkinDesk(d, s));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskBookingsComponent, selectors: [["desk-bookings"]], decls: 36, vars: 79, consts: [["date_template", ""], ["group_template", ""], ["period_template", ""], ["user_template", ""], ["status_template", ""], ["option_template", ""], ["action_template", ""], ["menu", "matMenu"], ["checkinMenu", "matMenu"], ["actionMenu", "matMenu"], [1, "h-full", "w-full", "overflow-auto", "pb-16"], [1, "block", "min-w-368", "text-sm", 3, "data", "filter", "filter_on", "columns", "empty_message", "sortable"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "fixed", "bottom-2", "left-1/2", "flex", "items-center", "gap-2", "rounded-full", "border", "px-3", "py-2", "text-sm", "shadow-xl"], [1, "bg-base-100", "border-base-300", "fixed", "right-8", "bottom-4", "flex", "items-center", "justify-end", "gap-2", "rounded-xl", "border", "px-2", "py-1", "shadow-lg"], [1, "mr-8", "text-xs", "opacity-60"], ["icon", "", "default", "", "matRipple", "", 1, "absolute", "top-1/2", "-right-2", "-translate-y-1/2", 3, "click", "disabled", "matTooltip"], [1, "flex", "w-full", "flex-col", "items-center", "justify-center", "py-2"], [1, "opacity-60"], [1, "text-xl"], [1, "p-4", "font-mono", "text-[0.625rem]"], [1, "opacity-30"], [1, "flex", "flex-col", "p-2"], [1, "text-error", "text-xs"], [1, "flex", "flex-col", "justify-center", "px-4", "py-2"], [1, "select-all"], [1, "max-w-48", "truncate", "text-xs", "opacity-30", "select-all"], [1, "px-2"], ["matRipple", "", 1, "bg-warning", "text-warning-content", "h-10", "w-30", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled"], [1, "flex", "items-center", "space-x-2", "pr-2", "pl-4"], [1, "flex-1", "text-left"], [1, "text-2xl"], ["mat-menu-item", "", 3, "click", "disabled"], [1, "flex", "items-center", "space-x-2"], [1, "pr-2"], ["matRipple", "", 1, "bg-warning", "text-warning-content", "h-10", "w-18", "rounded-3xl", "border-none", 3, "matMenuTriggerFor", "disabled", "matTooltip"], [1, "mx-auto", "flex", "items-center", "justify-end", "space-x-2"], ["icon", "", "default", "", "matRipple", "", "data-testid", "desk-booking-history", 3, "click", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], ["mat-menu-item", ""], [1, "text-error", "text-2xl"], ["matRipple", "", 1, "border-base-300", "bg-base-100", "fixed", "bottom-2", "left-1/2", "flex", "items-center", "gap-2", "rounded-full", "border", "px-3", "py-2", "text-sm", "shadow-xl", 3, "click"], [1, "pr-1"]], template: function DeskBookingsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(10, "translate");
        \u0275\u0275pipe(11, "translate");
        \u0275\u0275template(12, DeskBookingsComponent_ng_template_12_Template, 7, 8, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(14, DeskBookingsComponent_ng_template_14_Template, 3, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(16, DeskBookingsComponent_ng_template_16_Template, 5, 3, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(18, DeskBookingsComponent_ng_template_18_Template, 7, 6, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(20, DeskBookingsComponent_ng_template_20_Template, 23, 32, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(22, DeskBookingsComponent_ng_template_22_Template, 24, 24, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(24, DeskBookingsComponent_ng_template_24_Template, 7, 7, "ng-template", null, 6, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(26, DeskBookingsComponent_Conditional_26_Template, 6, 3, "button", 12);
        ...
        \u0275\u0275pipe(33, "translate");
        \u0275\u0275listener("click", function DeskBookingsComponent_Template_button_click_32_listener() {
          return ctx.refresh();
        });
      ...
      if (rf & 2) {
        ...
        const period_template_r21 = \u0275\u0275reference(17);
        const user_template_r22 = \u0275\u0275reference(19);
        const status_template_r23 = \u0275\u0275reference(21);
        const option_template_r24 = \u0275\u0275reference(23);
        const action_template_r25 = \u0275\u0275reference(25);
        \u0275\u0275advance();
        \u0275\u0275property("data", ctx.bookings())("filter", ctx.filters().search)("filter_on", \u0275\u0275pureFunction0(38, _c07))("columns", \u0275\u0275pureFunctionV(66, _c11, [\u0275\u0275pureFunction2(39, _c15, \u0275\u0275pipeBind1(2, 10, "FORM.DATE"), date_template_r20), \u0275\u0275pureFunction2(42, _c2, \u0275\u0275pipeBind1(3, 12, "FORM.PERIOD"), period_template_r21), \u0275\u0275pureFunction1(45, _c3, \u0275\u0275pipeBind1(4, 14, "RESOURCE.DESK")), \u0275\u0275pureFunction2(47, _c4, \u0275\u0275pipeBind1(5, 16, "COMMON.PERSON"), user_template_r22), \u0275\u0275pureFunction2(50, _c5, \u0275\u0275pipeBind1(6, 18, "COMMON.BOOKED_BY"), user_template_r22), \u0275\u0275pureFunction1(53, _c6, \u0275\u0275pipeBind1(7, 20, "FORM.TITLE")), \u0275\u0275pureFunction1(55, _c7, \u0275\u0275pipeBind1(8, 22, "APP.CONCIERGE.APPROVER")), \u0275\u0275pureFunction2(57, _c8, \u0275\u0275pipeBind1(9, 24, "COMMON.STATUS"), status_template_r23), \u0275\u0275pureFunction2(60, _c9, \u0275\u0275pipeBind1(10, 26, "COMMON.CHECKED_IN"), option_template_r24), \u0275\u0275pureFunction2(63, _c10, action_template_r25, ctx.can_delete() ? "7rem" : "3.5rem")]))("empty_message", \u0275\u0275pipeBind1(11, 28, ctx.filters().search ? "APP.CONCIERGE.DESKS_BOOKINGS_SEARCH_EMPTY" : "APP.CONCIERGE.DESKS_BOOKINGS_EMPTY"))("sortable", true);
        \u0275\u0275advance(25);
        \u0275\u0275conditional(!ctx.loading() && ctx.has_more_pages() ? 26 : -1);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(31, 33, "COMMON.LAST_UPDATED", \u0275\u0275pureFunction1(77, _c122, \u0275\u0275pipeBind2(30, 30, ctx.last_updated(), ctx.time_format))), " ");
        \u0275\u0275advance(3);
        \u0275\u0275property("disabled", ctx.state_loading())("matTooltip", \u0275\u0275pipeBind1(33, 36, "COMMON.REFRESH"));
      }
    }, dependencies: [
      CommonModule,
      MatRippleModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskBookingsComponent, { className: "DeskBookingsComponent", filePath: "apps/concierge/src/app/desks/desk-bookings.component.ts", lineNumber: 423 });
})();
...
function SetDatetimeModalComponent_Conditional_7_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r0.form.value.date)("ngModelOptions", \u0275\u0275pureFunction0(16, _c08))("range", ctx_r0.bookable_hours())("use_24hr", ctx_r0.use_24hr_time());
    \u0275\u0275control();
    \u0275\u0275advance(3);
...
var _c09 = (a0, a1) => ({ key: "id", name: a0, content: a1, size: "10rem" });
...
var _c42 = (a0, a1) => ({ key: "tags", name: a0, content: a1 });
var _c52 = (a0) => ({ key: "security", name: a0 });
var _c62 = (a0) => ({ key: "homebase", name: a0 });
var _c72 = (a0, a1) => ({ key: "bookable", name: a0, content: a1, size: "5.5rem" });
var _c82 = (a0) => ({ key: "actions", name: " ", content: a0, size: "8.5rem", sortable: false });
...
function DesksManageComponent_Conditional_20_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DesksManageComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, DesksManageComponent_Conditional_20_Conditional_2_Template, 2, 1, "p");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var DesksManageComponent = class _DesksManageComponent extends AsyncHandler {
  ...
  async removeDesk(desk) {
    ...
    const zone_id = desk.zone?.id || this._org.levelWithID(filters.zones)?.id;
    if (!zone_id) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DesksManageComponent, selectors: [["desks-manage"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 22, vars: 55, consts: [["name_template", ""], ["item_list_template", ""], ["bool_template", ""], ["assigned_template", ""], ["action_template", ""], ["qr_menu", ""], ["print_content", ""], [1, "h-full", "w-full", "overflow-auto", "pb-4", 3, "dragenter", "dragend"], [1, "block", "w-full", "min-w-6xl", "text-sm", 3, "filter", "data", "columns", "sortable", "empty_message"], [1, "bg-base-100", "bg-opacity-60", "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "bg-neutral", "absolute", "inset-0", "flex", "items-center", "justify-center"], [1, "flex", "flex-col", "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "flex-wrap", "p-2"], [1, "bg-info", "text-info-content", "m-1", "rounded-2xl", "px-2", "py-1", "font-mono", "text-xs"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-sm", "text-2xl", "text-white"], [1, "p-4", "opacity-30"], [1, "px-4", "py-2", "text-left", "leading-tight"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "flex", "items-center", "justify-end", "space-x-2", "p-2"], ["icon", "", "default", "", "matRipple", "", "customTooltip", "", 3, "click", "content", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "error", "", "matRipple", "", 3, "click", "matTooltip"], [1, "bg-base-100", "rounded-sm", "py-2", "shadow-sm"], ["printable", "", 1, "", 3, "content"], ["btn", "", "matRipple", "", 1, "mx-4", "my-2", "w-[calc(100%-2rem)]", 3, "click"], ["target", "_blank", "ref", "noopener noreferrer", 1, "border-base-200", "bg-base-100", "mx-4", "my-2", "block", "rounded-lg", "border", "p-2", 3, "href"], [1, "w-48", 3, "src"], [1, "bg-base-200", "mx-4", "mt-2", "w-[calc(100%-2rem)]", "rounded-sm", "p-2", "text-center", "font-mono", "text-sm"], ["diameter", "32"], [1, "bg-base-100", "rounded-sm", "p-4", "shadow-sm"], [1, "border-base-200", "flex", "h-64", "w-64", "flex-col", "items-center", "justify-center", "rounded-sm", "border-4", "border-dashed"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"]], template: function DesksManageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 7);
        ...
        \u0275\u0275conditionalCreate(20, DesksManageComponent_Conditional_20_Template, 3, 1, "div", 9);
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("filter", ctx.filters().search)("data", ctx.desks())("columns", \u0275\u0275pureFunctionV(45, _c92, [\u0275\u0275pureFunction2(23, _c09, \u0275\u0275pipeBind1(2, 7, "APP.CONCIERGE.DESKS_ID"), name_template_r17), \u0275\u0275pureFunction1(26, _c16, \u0275\u0275pipeBind1(3, 9, "APP.CONCIERGE.DESKS_NAME")), \u0275\u0275pureFunction1(28, _c22, assigned_template_r20), \u0275\u0275pureFunction2(30, _c32, \u0275\u0275pipeBind1(4, 11, "COMMON.FEATURES"), item_list_template_r18), \u0275\u0275pureFunction2(33, _c42, \u0275\u0275pipeBind1(5, 13, "COMMON.TAGS"), item_list_template_r18), \u0275\u0275pureFunction1(36, _c52, \u0275\u0275pipeBind1(6, 15, "APP.CONCIERGE.DESKS_SECURITY")), \u0275\u0275pureFunction1(38, _c62, \u0275\u0275pipeBind1(7, 17, "APP.CONCIERGE.DESKS_HOMEBASE")), \u0275\u0275pureFunction2(40, _c72, \u0275\u0275pipeBind1(8, 19, "COMMON.BOOKABLE"), bool_template_r19), \u0275\u0275pureFunction1(43, _c82, action_template_r21)]))("sortable", true)("empty_message", \u0275\u0275pipeBind1(9, 21, ctx.filters().search ? "APP.CONCIERGE.DESKS_MANAGE_SEARCH_EMPTY" : "APP.CONCIERGE.DESKS_MANAGE_EMPTY"));
        \u0275\u0275advance(19);
        \u0275\u0275conditional(ctx.loading() || ctx.stateLoading() ? 20 : -1);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DesksManageComponent, { className: "DesksManageComponent", filePath: "apps/concierge/src/app/desks/desks-manage.component.ts", lineNumber: 276 });
})();
...
function NewDeskFormDetailsComponent_Conditional_0_Conditional_33_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.model().date)("ngModelOptions", \u0275\u0275pureFunction0(21, _c010))("range", ctx_r1.bookable_hours)("min_duration", ctx_r1.effective_min_duration)("use_24hr", ctx_r1.use_24hr)("timezone", ctx_r1.timezone);
    \u0275\u0275control();
    \u0275\u0275advance(3);
...
function NewDeskFormDetailsComponent_Conditional_0_Conditional_34_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("date", ctx_r1.model().date)("ngModel", ctx_r1.model())("ngModelOptions", \u0275\u0275pureFunction0(8, _c010))("available_days", ctx_r1.available_days());
    \u0275\u0275control();
    \u0275\u0275advance();
...
function NewDeskFormDetailsComponent_Conditional_0_Conditional_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", !!ctx_r1.model().secondary_resource)("ngModelOptions", \u0275\u0275pureFunction0(5, _c010));
    \u0275\u0275control();
    \u0275\u0275advance();
...
function NewDeskFormDetailsComponent_Conditional_0_Conditional_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.options()?.members || \u0275\u0275pureFunction0(5, _c17))("ngModelOptions", \u0275\u0275pureFunction0(6, _c010));
    \u0275\u0275control();
  }
}
...
function NewDeskFormDetailsComponent_Conditional_0_Conditional_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("options", \u0275\u0275pureFunction3(6, _c23, ctx_r1.model().date, ctx_r1.model().duration, ctx_r1.model().all_day))("formField", ctx_r1.form().assets);
    \u0275\u0275control();
  }
}
...
var DeskBookModalComponent = class _DeskBookModalComponent {
  ...
  async save() {
    ...
    this.model.update((m) => __spreadProps(__spreadValues({}, m), { booking_type: "desk" }));
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskBookModalComponent, selectors: [["desk-book-modal"]], outputs: { event: "event" }, decls: 4, vars: 8, consts: [[3, "confirm", "heading", "loading"], [3, "form", "model_input"]], template: function DeskBookModalComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 4, ctx.model().id ? "APP.CONCIERGE.DESKS_BOOK_EDIT" : "APP.CONCIERGE.DESKS_BOOK_NEW"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 6, "APP.CONCIERGE.DESKS_BOOKING_LOADING") : "");
        \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskBookModalComponent, { className: "DeskBookModalComponent", filePath: "apps/concierge/src/app/desks/desk-book-modal.component.ts", lineNumber: 45 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeskQrCodeModalComponent, { className: "DeskQrCodeModalComponent", filePath: "apps/concierge/src/app/desks/desk-qr-code-modal.component.ts", lineNumber: 108 });
})();
...
function DesksComponent_For_17_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "building");
...
function DesksComponent_For_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 11)(1, "div", 18);
    \u0275\u0275conditionalCreate(2, DesksComponent_For_17_Conditional_2_Template, 5, 3, "div", 19);
    \u0275\u0275elementStart(3, "div");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
  }
...
function DesksComponent_Conditional_19_Conditional_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 24);
  }
}
function DesksComponent_Conditional_19_Conditional_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function DesksComponent_Conditional_19_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function DesksComponent_Conditional_19_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.downloadCsv());
    });
    \u0275\u0275conditionalCreate(2, DesksComponent_Conditional_19_Conditional_5_Conditional_2_Template, 1, 0, "mat-spinner", 24)(3, DesksComponent_Conditional_19_Conditional_5_Conditional_3_Template, 2, 0, "icon");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DesksComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "date-options", 21);
    \u0275\u0275listener("dateChange", function DesksComponent_Conditional_19_Template_date_options_dateChange_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("click", function DesksComponent_Conditional_19_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(4, "event_busy");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(5, DesksComponent_Conditional_19_Conditional_5_Template, 4, 5, "button", 23);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(2, 3, "APP.CONCIERGE.REJECT_ALL"))("disabled", ctx_r1.loading());
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.hide_user_list_download() ? 5 : -1);
  }
}
function DesksComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function DesksComponent_Conditional_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("change", function DesksComponent_Conditional_20_Template_input_change_8_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(10, "translate");
    \u0275\u0275listener("click", function DesksComponent_Conditional_20_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275listener("click", function DesksComponent_Conditional_20_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
function DesksComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 13);
  }
}
function DesksComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "a", 28);
    \u0275\u0275pipe(2, "safe");
    \u0275\u0275element(3, "img", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 30);
  ...
  if (rf & 2) {
    const desk_r8 = ctx;
    \u0275\u0275advance();
    \u0275\u0275property("href", \u0275\u0275pipeBind2(2, 3, desk_r8.qr_link, "url"), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275property("src", desk_r8.qr_code, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", desk_r8.name || desk_r8.id, " ");
  }
}
var DesksComponent = class _DesksComponent extends AsyncHandler {
  constructor() {
    ...
    this.manage = computed(
      () => this.path() === "manage",
      ...ngDevMode ? [{ debugName: "manage" }] : (
        /* istanbul ignore next */
        []
      )
    );
    ...
    this._all_levels = computed(() => (this._settings.get("app.use_region") ? this._org.levelsForRegion(this._org.active_region()) : this._org.levelsForBuilding(this._org.active_building())).sort((a, b) => +!!a.tags?.includes("parking") - +!!b.tags?.includes("parking")), __spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_all_levels" } : (
      /* istanbul ignore next */
      {}
    )), { equal: (a, b) => a.length === b.length && a.every((level, index) => level.id === b[index]?.id) }));
    this._desk_levels = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_desk_levels" } : (
      /* istanbul ignore next */
      {}
    )), {
      ...
      loader: async ({ params: levels }) => {
        ...
        const results = await Promise.all(levels.map(async (level) => {
          const metadata = await ic(level.id, "desks").catch(() => null);
          return metadata?.details instanceof Array && metadata.details.length ? level : null;
        }));
        return results.filter((level) => !!level);
      }
    }));
    this.levels = computed(
      () => {
        const resolved = this._desk_levels.status() === "resolved";
        return this.manage() || !resolved ? this._all_levels() : this._desk_levels.value();
      },
      ...ngDevMode ? [{ debugName: "levels" }] : (
        /* istanbul ignore next */
        []
    ...
    this.updateZones = (zones) => {
      ...
      const persistence_view = this.manage() ? "desks-manage" : this.path() === "map" ? "desks" : "";
      if (persistence_view) {
    ...
    effect(() => {
      if (this._desk_levels.status() !== "resolved")
        return;
  ...
  _syncZones(levels, restore = false) {
    ...
    if (!next_zones.length && persistence_view) {
      const persisted = loadPersistedZones(persistence_view, this._persistScopeId()).filter((zone) => levels.find((lvl) => lvl.id === zone));
      if (persisted.length) {
  ...
  static {
    this.\u0275fac = function DesksComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _DesksComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DesksComponent, selectors: [["", "app-desks", ""]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], decls: 25, vars: 14, consts: [[1, "print:hidden"], [1, "flex", "h-px", "flex-1", "print:hidden"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "flex", "w-full", "items-center", "space-x-2", "px-8", "py-4"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], [1, "mr-2", 3, "modelChange", "model"], ["btn", "", "matRipple", "", 1, "w-44", "space-x-2"], [1, "mb-4", "flex", "w-full", "items-center", "gap-2", "px-8"], ["appearance", "outline", 1, "no-subscript", "w-60"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], ["mode", "indeterminate", 1, "w-full"], [1, "desk-qr-print-preview", "print-only", "fixed", "top-0", "left-0"], ["btn", "", "matRipple", "", 1, "w-44", "space-x-2", 3, "click"], [1, "pl-2"], [1, "text-2xl"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [3, "dateChange"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip", "disabled"], ["icon", "", "default", "", "matRipple", "", 3, "matTooltip", "disabled"], ["diameter", "24"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "default", "", "matRipple", "", 3, "matTooltip"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["target", "_blank", "ref", "noopener noreferrer", 1, "border-base-200", "bg-base-100", "m-2", "block", "rounded-lg", "border", "p-2", 3, "href"], [1, "w-48", 3, "src"], [1, "bg-base-200", "mx-2", "mt-2", "w-48", "rounded-sm", "p-2", "text-center", "font-mono", "text-sm"]], template: function DesksComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275pipe(15, "translate");
        \u0275\u0275listener("ngModelChange", function DesksComponent_Template_mat_select_ngModelChange_14_listener($event) {
          return ctx.updateZones($event);
        });
        \u0275\u0275repeaterCreate(16, DesksComponent_For_17_Template, 5, 3, "mat-option", 11, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd();
        \u0275\u0275controlCreate();
        \u0275\u0275elementEnd();
        \u0275\u0275element(18, "div", 5);
        \u0275\u0275conditionalCreate(19, DesksComponent_Conditional_19_Template, 6, 5);
        \u0275\u0275conditionalCreate(20, DesksComponent_Conditional_20_Template, 17, 12);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(21, "div", 12);
        \u0275\u0275element(22, "router-outlet");
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(23, DesksComponent_Conditional_23_Template, 1, 0, "mat-progress-bar", 13);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(24, DesksComponent_Conditional_24_Template, 6, 6, "div", 14);
      }
      if (rf & 2) {
        let tmp_11_0;
        \u0275\u0275advance(6);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("ngModel", ctx.filters().zones)("placeholder", \u0275\u0275pipeBind1(15, 12, "COMMON.LEVEL_ALL"));
        \u0275\u0275control();
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.levels());
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.path() === "events" ? 19 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.path() === "manage" ? 20 : -1);
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.loading() && ctx.path() === "events" ? 23 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional((tmp_11_0 = ctx.print_desk()) ? 24 : -1, tmp_11_0);
      }
    }, dependencies: [
      MatProgressBarModule,
      MatProgressBar,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DesksComponent, { className: "DesksComponent", filePath: "apps/concierge/src/app/desks/desks.component.ts", lineNumber: 295 });
})();

// apps/concierge/src/app/desks/desks.routes.ts
var ROUTES = [
  {
    path: "",
...
//# debugId=96e50623-9a90-5b69-8aed-2b56c8c8ccc0
//# sourceMappingURL=desks.routes-JMEIZXM7.js.map
