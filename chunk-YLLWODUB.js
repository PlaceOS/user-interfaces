...
var _DesksStateService = class _DesksStateService extends AsyncHandler {
  ...
  constructor() {
    ...
    this.desks = combineLatest([
      ...
      return zones && !zones.includes("All") ? Pu(zones[0], "desks").pipe(map((m) => m.details instanceof Array ? m.details : []), catchError((_) => of([]))) : Du(this._org.building?.id, {
        name: "desks"
...
//# sourceMappingURL=chunk-YLLWODUB.js.map
