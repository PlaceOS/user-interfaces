...
} from "./chunk-NG2TMR75.js";
import {
  ImageCarouselComponent
} from "./chunk-PGSR5XW3.js";
import {
  MapPinComponent
} from "./chunk-5XCNLPDN.js";
import {
  ParkingService
} from "./chunk-X3YXIG2F.js";
import {
  takeUntilDestroyed
} from "./chunk-5V4URE3M.js";
import {
  InteractiveMapComponent
} from "./chunk-NHK6C4BQ.js";
import {
  UserPipe
} from "./chunk-VHYW7CD5.js";
import {
...
function BookingDetailsModalComponent_Conditional_40_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(6, 21, "BOOKINGS.ASSETS_REQUESTED_FOR", \u0275\u0275pureFunction1(24, _c04, \u0275\u0275pipeBind2(5, 18, request_r6.deliver_at, "MMM d, " + ctx_r0.time_format()))), " ");
    \u0275\u0275advance(3);
  ...
  constructor() {
    ...
    this.can_edit = computed(
      () => {
        ...
        return !this.is_cancelled() && !this.booking().is_done && !this.booking().checked_in && (!is_visitor || visitor_edit_allowed) && !parking_allocated_edit_blocked;
      },
      ...ngDevMode ? [{ debugName: "can_edit" }] : (
        /* istanbul ignore next */
        []
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingDetailsModalComponent, { className: "BookingDetailsModalComponent", filePath: "libs/bookings/src/lib/booking-details-modal.component.ts", lineNumber: 508 });
})();
...
function BookingCardComponent_Conditional_1_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function BookingCardComponent_Conditional_1_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "icon", 10);
    \u0275\u0275text(1, "event_repeat");
    \u0275\u0275elementEnd();
...
function BookingCardComponent_Conditional_1_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingCardComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(6, BookingCardComponent_Conditional_1_Conditional_6_Template, 2, 3);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, BookingCardComponent_Conditional_1_Conditional_8_Template, 6, 6, "div", 9);
    \u0275\u0275conditionalCreate(9, BookingCardComponent_Conditional_1_Conditional_9_Template, 2, 1, "icon", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 11)(11, "div", 12);
    \u0275\u0275conditionalCreate(12, BookingCardComponent_Conditional_1_Case_12_Template, 3, 3, "icon", 13)(13, BookingCardComponent_Conditional_1_Case_13_Template, 3, 3, "icon", 13)(14, BookingCardComponent_Conditional_1_Case_14_Template, 3, 3, "icon", 13)(15, BookingCardComponent_Conditional_1_Case_15_Template, 3, 3, "icon", 13)(16, BookingCardComponent_Conditional_1_Case_16_Template, 2, 0, "icon");
    \u0275\u0275elementStart(17, "div", 14);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(19, BookingCardComponent_Conditional_1_Conditional_19_Template, 5, 1, "div", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "icon", 16);
    \u0275\u0275text(21, " chevron_right ");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(22, BookingCardComponent_Conditional_1_Conditional_22_Template, 6, 3, "div", 17);
    ...
    \u0275\u0275conditionalCreate(25, BookingCardComponent_Conditional_1_Conditional_25_Template, 3, 3, "div", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_10_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(17, _c05))("queryParams", \u0275\u0275pureFunction1(18, _c14, ctx_r0.booking()?.id));
    \u0275\u0275advance();
    ...
    \u0275\u0275property("status", ctx_r0.status());
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.is_cancelled() ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.period(), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.for_current_user() && ctx_r0.booked_for_label() ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.booking().instance ? 9 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional((tmp_10_0 = ctx_r0.type()) === "desk" ? 12 : tmp_10_0 === "locker" ? 13 : tmp_10_0 === "parking" ? 14 : tmp_10_0 === "visitor" ? 15 : 16);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx_r0.resource_label(), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.location() ? 19 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.booking()?.checked_in && !ctx_r0.booking()?.is_done ? 22 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.booking()?.checked_in && !ctx_r0.for_current_user() && ctx_r0.booking()?.booking_type !== "group-event" ? 23 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.booking()?.checked_in && ctx_r0.booking()?.booking_type === "group-event" ? 24 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.booking()?.checked_in && ctx_r0.is_reserved_parking_space() ? 25 : -1);
  }
}
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingCardComponent, selectors: [["booking-card"]], inputs: { booking: [1, "booking"], show_day: [1, "show_day"], edit_fn: [1, "edit_fn"], remove_fn: [1, "remove_fn"], end_fn: [1, "end_fn"], refresh_fn: [1, "refresh_fn"] }, decls: 2, vars: 2, consts: [[1, "mb-2", "flex", "items-center"], ["name", "view-booking-details", 1, "relative", "w-full", "cursor-pointer", "overflow-hidden", 3, "routerLink", "queryParams"], ["day", ""], [1, "px-2", "text-xs"], ["name", "view-booking-details", 1, "relative", "w-full", "cursor-pointer", "overflow-hidden", 3, "click", "routerLink", "queryParams"], [1, "border-base-300", "bg-base-100", "relative", "w-full", "rounded-xl", "border", "py-4", "shadow-sm"], [1, "px-4", "text-lg"], [1, "mx-4", "my-2", "flex", "items-center", "space-x-2"], [3, "status"], ["booked-for", "", 1, "text-base-content/70", "flex", "min-w-0", "items-center", "space-x-1", "text-sm"], [1, "text-2xl", 3, "matTooltip"], [1, "divide-base-200-500", "flex", "flex-col", "flex-wrap", "space-y-2", "py-2", "sm:flex-row", "sm:space-y-0", "sm:divide-x"], [1, "flex", "max-w-[33%]", "items-center", "px-4"], ["matTooltipPosition", "right", 3, "matTooltip"], [1, "mx-2", "w-1/2", "flex-1", "truncate"], [1, "flex", "items-center", "px-4"], [1, "absolute", "top-1/2", "right-1", "-translate-y-1/2", "text-4xl"], ["checked-in-badge", "", 1, "bg-success", "text-success-content", "absolute", "top-2", "right-2", "flex", "items-center", "space-x-1", "rounded-xl", "px-2", "py-1", "text-xs"], [1, "bg-warning/50", "absolute", "top-2", "right-2", "rounded-xl", "px-2", "py-1", "text-xs"], [1, "text-lg"], [1, "truncate"], [1, "mx-2", "truncate"], [1, "text-sm"]], template: function BookingCardComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(1, BookingCardComponent_Conditional_1_Template, 26, 20, "a", 1);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingCardComponent, { className: "BookingCardComponent", filePath: "libs/bookings/src/lib/booking-card.component.ts", lineNumber: 215 });
})();
...
//# debugId=ac426525-ce85-5553-8405-e13f4130b2c9
//# sourceMappingURL=chunk-WSGCPWZW.js.map
