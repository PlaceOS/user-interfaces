...
} from "./chunk-YJ3ZZLGG.js";
import {
  ControlStateService,
  ControlStatusBarComponent,
  TopbarHeaderComponent
} from "./chunk-EIJMJZDE.js";
import {
  MatProgressSpinner,
...
import "./chunk-G2IP2PFC.js";
import "./chunk-7FWFE6N4.js";
import {
  ActivatedRoute,
  Component,
  effect,
...
function ControlVideoCallViewComponent_Conditional_0_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ControlVideoCallViewComponent_Conditional_0_Conditional_1_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.powerOn());
    })("touchend", function ControlVideoCallViewComponent_Conditional_0_Conditional_1_Template_div_touchend_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.powerOn());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 2, "APP.CONTROL.TOUCH_TO_START"), " ");
    \u0275\u0275advance(3);
...
function ControlVideoCallViewComponent_Conditional_0_Template(rf, ctx) {
  var _a;
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ControlVideoCallViewComponent_Conditional_0_Conditional_0_Template, 5, 0, "div", 1)(1, ControlVideoCallViewComponent_Conditional_0_Conditional_1_Template, 6, 4, "div", 2);
  }
  if (rf & 2) {
...
_ControlVideoCallViewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ControlVideoCallViewComponent, selectors: [["app-control-main-view"]], decls: 2, vars: 1, consts: [["name", "loader", 1, "bg-base-100", "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "text-black"], [1, "absolute", "inset-0", "flex", "flex-col"], ["name", "splash", 1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "text-white"], [1, "h-1/2", "flex-1"], ["video-call-page", "", 1, "bg-base-100", "absolute", "inset-4", "flex", "flex-col", "rounded-sm", "shadow-sm"], ["name", "splash", 1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "text-white", 3, "click", "touchend"], [1, "mb-4", "text-4xl", "font-light"], [1, "text-lg"], [1, "mb-4", 3, "diameter"], [1, "my-4", "text-2xl"], [1, "text-base"]], template: function ControlVideoCallViewComponent_Template(rf, ctx) {
  var _a;
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ControlVideoCallViewComponent_Conditional_0_Template, 2, 1)(1, ControlVideoCallViewComponent_Conditional_1_Template, 6, 7, "div", 0);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ControlVideoCallViewComponent, [{
    ...
    `, imports: [
      ...
      MatProgressSpinnerModule,
      TranslatePipe
    ], styles: [`/* angular:styles/component:css;edd402819cac0d627f6cdb0767693eac9bec87c8e0588fd7809e8df2fae5859b;/home/runner/work/user-interfaces/user-interfaces/apps/control/src/app/video-call/video-call-view.component.ts */
:host {
  display: block;
  position: relative;
  width: 100%;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ControlVideoCallViewComponent, { className: "ControlVideoCallViewComponent", filePath: "apps/control/src/app/video-call/video-call-view.component.ts", lineNumber: 85 });
})();
export {
  ControlVideoCallViewComponent
};
//# debugId=65d17ac4-daa8-5940-a3bb-9a5aaf73919e
//# sourceMappingURL=video-call-view.component-66OK5ET2.js.map
