...
_SelectMapItemModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SelectMapItemModalComponent, selectors: [["select-map-item-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 37, vars: 35, consts: [[1, "sticky", "top-0", "z-10", "mx-auto", "mt-2", "flex", "h-14", "w-[calc(100%-1rem)]", "items-center", "justify-between", "rounded", "border-none", "bg-base-200", "px-4", "py-2"], [1, "text-xl", "font-medium", "capitalize"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "h-[75vh]", "max-h-[75vh]", "min-w-[80vw]", "max-w-[calc(100vw-2rem)]", "space-x-2", "overflow-hidden", "p-2", "sm:max-w-[64rem]"], ["map", "", 1, "relative", "h-full", "w-1/2", "flex-1", "rounded-lg", "bg-base-200"], [3, "mapInfo", "src", "actions", "features", "options", "focus"], ["poi-list", "", 1, "relative", "flex", "h-full", "w-[20rem]", "flex-col", "rounded-lg", "border", "border-base-300"], ["search", "", 1, "flex", "flex-col", "border-b", "border-base-200", "p-2"], ["appearance", "outline", 1, "no-subscript", "mb-2", "w-full"], ["name", "level", 3, "ngModelChange", "ngModel"], [3, "value"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "search", "placeholder", "Search", 3, "ngModelChange", "ngModel"], ["matPrefix", "", 1, "text-2xl"], ["list", "", 1, "flex", "h-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", "px-2"], [1, "sticky", "top-0", "z-10", "w-full", "bg-base-100", "px-1", "py-3", "text-sm"], [1, "rounded-full", "border", "border-info", "bg-info-light", "px-2", "py-1", "text-xs"], [1, "flex", "h-full", "flex-1", "flex-col", "items-center", "justify-center", "space-y-4"], ["pagination", "", 1, "sticky", "bottom-0", "z-10", "-mx-2", "flex", "w-[calc(100%+1rem)]", "items-center", "justify-center", "space-x-1", "border-t", "border-base-300", "bg-base-100", "p-2"], ["actions", "", 1, "border-t", "border-base-200", "p-2"], ["btn", "", "matRipple", "", 1, "w-full", 3, "disabled", "mat-dialog-close"], ["btn", "", "matRipple", "", 1, "clear", "flex", "w-full", "items-center", "rounded", "text-left", "hover:bg-base-200", 3, "!bg-primary", "!text-primary-content"], ["btn", "", "matRipple", "", 1, "clear", "flex", "w-full", "items-center", "rounded", "text-left", "hover:bg-base-200", 3, "click", "mouseover"], [1, "flex", "w-full", "flex-col", "font-mono", "text-sm"], [1, ""], [1, "text-xs", "opacity-30"], ["src", "assets/icons/no-results.svg", 1, "w-36"], [1, "text-center", "opacity-30"], ["icon", "", "matRipple", "", 1, "rounded", "border", "border-base-200", 3, "click", "disabled"], ["icon", "", "matRipple", "", 3, "click"], ["icon", ""], ["icon", "", "matRipple", "", 1, "!bg-secondary", "text-secondary-content"], ["icon", "", "matRipple", "", 1, "rounded", "border", "border-base-200", 3, "click"]], template: function SelectMapItemModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_DeskModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeskModalComponent, selectors: [["desk-modal"]], outputs: { event: "event" }, decls: 12, vars: 8, consts: [[1, "w-[32rem]"], [1, "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded", "border-none", "bg-base-200", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "flex", "max-h-[65vh]", "flex-col", "overflow-auto", "p-4", 3, "formGroup"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8"], [1, "flex", "items-center", "justify-end", "space-x-2", "border-t", "border-base-300", "px-4", "py-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"], [1, "w-full"], ["for", "id"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "id", "formControlName", "id", "placeholder", "desk-10.123"], [1, "flex", "space-x-2"], [1, "w-1/3", "flex-1"], ["for", "name"], ["matInput", "", "name", "name", "formControlName", "name", "placeholder", "e.g. Office Desk"], ["for", "map-id"], ["matInput", "", "name", "map-id", "formControlName", "map_id", 3, "placeholder"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "min-w-12", "rounded", "border", "border-secondary", "text-secondary", 3, "click", "matTooltip"], ["for", "user"], [1, "mb-4", "flex", "space-x-2"], ["name", "user", "formControlName", "assigned_user", 1, "flex-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "min-w-12", "rounded", "bg-secondary", "text-secondary-content", 3, "click", "matTooltip"], ["className", "material-symbols-outlined"], [1, "flex", "space-x-4", "pb-4"], ["formControlName", "bookable", 1, "flex-1", 3, "name"], [1, "flex-1"], ["for", "notes"], ["formControlName", "groups", 1, "w-full", 3, "placeholder"], ["formControlName", "features", 1, "w-full", 3, "placeholder"], ["appearance", "outline"], ["matInput", "", "name", "notes", "formControlName", "notes", 3, "placeholder"], ["for", "security"], ["matInput", "", "name", "security", "formControlName", "security", 3, "placeholder"], ["diameter", "32"]], template: function DeskModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _DesksStateService = class _DesksStateService extends AsyncHandler {
  ...
  constructor() {
    ...
    this.desks = combineLatest([
      ...
      return zones && !zones.includes("All") ? Iu(zones[0], "desks").pipe(map((m) => m.details instanceof Array ? m.details : []), catchError((_) => of([]))) : Ru(this._org.building?.id, {
        name: "desks"
...
//# sourceMappingURL=chunk-2K3EVIC6.js.map
