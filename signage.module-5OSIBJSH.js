...
_SignageApprovePlaylistModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageApprovePlaylistModalComponent, selectors: [["signage-approve-playlist-modal"]], decls: 7, vars: 2, consts: [[1, "p-2"], [1, "bg-base-200", "rounded-sm", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", "aria-label", "Close dialog"], [1, "max-h-[60vh]", "gap-2", "overflow-auto", "py-2"], [1, "flex", "gap-2"], [1, "border-base-300", "bg-success-light", "w-[24rem]", "rounded-sm", "border"], [1, "border-base-300", "bg-base-200", "flex", "items-center", "space-x-8", "rounded-sm", "border-b", "px-4", "py-2"], [1, "font-mono", "text-xs", "opacity-60"], [1, "space-y-2", "p-2"], [1, "px-2", "text-sm"], [1, "border-base-300", "bg-base-100", "flex", "items-center", "space-x-2", "rounded-sm", "border", "p-2"], [1, "flex", "flex-col", "items-center", "justify-center", "p-8", "opacity-60"], [1, "border-base-300", "bg-error-light", "w-[24rem]", "rounded-sm", "border"], [1, "space-y-2", "px-2", "text-sm"], [1, "bg-base-200", "flex", "items-center", "justify-end", "space-x-2", "rounded-sm", "p-2"], ["btn", "", "matRipple", "", 1, "inverse", "bg-base-100", "w-40", 3, "click"], ["btn", "", "matRipple", "", 1, "w-40", 3, "click"], ["matRipple", "", 1, "bg-base-200", "h-10", "w-10", "shrink-0", "overflow-hidden", "rounded-sm", 3, "click"], [1, "truncate"], ["auth", "", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "absolute", "inset-0", "flex", "items-end", "justify-end", "p-1", "opacity-0", "transition-opacity", "duration-200", "hover:opacity-100"], [1, "text-lg"], [1, "text-4xl"], [1, "text-sm"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-4"], ["diameter", "32"]], template: function SignageApprovePlaylistModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_SignageDisplayModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageDisplayModalComponent, selectors: [["signage-display-modal"]], decls: 51, vars: 49, consts: [[3, "confirm", "heading", "loading"], [3, "formGroup"], [1, "flex", "flex-col"], ["for", "name"], ["required", ""], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "name", "formControlName", "name", "required", "", 3, "placeholder"], ["for", "description"], ["matInput", "", "name", "description", "formControlName", "description", 1, "min-h-32", 3, "placeholder"], ["for", "orientation"], ["name", "orientation", "formControlName", "orientation", 3, "placeholder"], ["value", "unspecified"], ["value", "landscape"], ["value", "portrait"], ["value", "square"]], template: function SignageDisplayModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(18, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(19, "div", 2)(20, "label", 7);
    \u0275\u0275text(21);
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(28, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 2)(30, "label", 9);
    \u0275\u0275text(31);
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(36, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "mat-select", 10);
    \u0275\u0275pipe(38, "translate");
    \u0275\u0275elementStart(39, "mat-option", 11);
    \u0275\u0275text(40);
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "mat-option", 12);
    \u0275\u0275text(43);
    \u0275\u0275pipe(44, "translate");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 17, ctx.display.id ? "APP.CONCIERGE.SIGNAGE_DISPLAYS_EDIT" : "APP.CONCIERGE.SIGNAGE_DISPLAYS_NEW"))("loading", ctx.loading ? \u0275\u0275pipeBind1(2, 19, "APP.CONCIERGE.SIGNAGE_DISPLAYS_SAVING") : "");
    \u0275\u0275advance(3);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 21, "FORM.NAME"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 23, "FORM.NAME"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(15, 25, "FORM.NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 27, "FORM.NAME_REQUIRED"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 29, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 31, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(28, 33, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 35, "APP.CONCIERGE.SIGNAGE_ORIENTATION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(36, 37, "APP.CONCIERGE.SIGNAGE_ORIENTATION"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(38, 39, "APP.CONCIERGE.SIGNAGE_ORIENTATION_NONE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(41, 41, "APP.CONCIERGE.SIGNAGE_ORIENTATION_NONE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(44, 43, "APP.CONCIERGE.SIGNAGE_ORIENTATION_LANDSCAPE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 45, "APP.CONCIERGE.SIGNAGE_ORIENTATION_PORTRAIT"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(50, 47, "APP.CONCIERGE.SIGNAGE_ORIENTATION_SQUARE"));
  }
}, dependencies: [
  FullscreenModalShellComponent,
  MatFormFieldModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageDisplayModalComponent, { className: "SignageDisplayModalComponent", filePath: "apps/concierge/src/app/signage/signage-display-modal.component.ts", lineNumber: 120 });
})();
...
function SignageMediaModalComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaModalComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
...
function SignageMediaModalComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
...
_SignageMediaModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaModalComponent, selectors: [["signage-media-modal"]], features: [\u0275\u0275ProvidersFeature([
  ...
  if (rf & 1) {
    ...
    \u0275\u0275pipe(21, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(22, SignageMediaModalComponent_Conditional_22_Template, 9, 8);
    \u0275\u0275elementStart(23, "div", 10)(24, "label", 11);
    \u0275\u0275text(25);
    \u0275\u0275pipe(26, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 12);
    \u0275\u0275conditionalCreate(28, SignageMediaModalComponent_Conditional_28_Template, 2, 4)(29, SignageMediaModalComponent_Conditional_29_Template, 4, 6, "span", 13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "mat-slider", 14);
    ...
    \u0275\u0275pipe(34, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-form-field", 8)(36, "mat-label");
    \u0275\u0275text(37);
    \u0275\u0275pipe(38, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-select", 17)(40, "mat-option", 18);
    \u0275\u0275text(41);
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(54, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "mat-option", 18);
    \u0275\u0275text(56);
    \u0275\u0275pipe(57, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "mat-option", 18);
    \u0275\u0275text(59);
    \u0275\u0275pipe(60, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(61, "label", 19);
    \u0275\u0275text(62);
    \u0275\u0275pipe(63, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "mat-form-field", 20)(65, "mat-label");
    \u0275\u0275text(66);
    \u0275\u0275pipe(67, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(68, "textarea", 21);
    \u0275\u0275pipe(69, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "div", 22)(71, "div", 23)(72, "label", 24);
    \u0275\u0275text(73);
    \u0275\u0275pipe(74, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(75, "a-date-field", 25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "div", 23)(77, "label", 26);
    \u0275\u0275text(78);
    \u0275\u0275pipe(79, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(80, "a-date-field", 27);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 36, ctx.item.id ? "APP.CONCIERGE.SIGNAGE_MEDIA_EDIT" : "APP.CONCIERGE.SIGNAGE_MEDIA_NEW"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 38, "APP.CONCIERGE.SIGNAGE_MEDIA_SAVING") : "");
    \u0275\u0275advance(3);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 40, "FORM.NAME"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 42, "FORM.NAME"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(18, 44, "FORM.NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(21, 46, "FORM.NAME_REQUIRED"));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.media_type === "video" ? 22 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(26, 48, "APP.CONCIERGE.SIGNAGE_MEDIA_PLAY_TIME"));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.form.value.play_time ? 28 : 29);
    \u0275\u0275advance(2);
    \u0275\u0275property("min", ctx.form.value.start_time)("max", ctx.item.video_length || 3e5);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(34, 50, "APP.CONCIERGE.SIGNAGE_ANIMATION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(38, 52, "APP.CONCIERGE.SIGNAGE_ANIMATION"));
    \u0275\u0275advance(3);
    \u0275\u0275property("value", 0);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 54, "APP.CONCIERGE.SIGNAGE_ANIMATION_DEFAULT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(45, 56, "APP.CONCIERGE.SIGNAGE_ANIMATION_CUT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(48, 58, "APP.CONCIERGE.SIGNAGE_ANIMATION_CROSS_FADE"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(51, 60, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_TOP"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(54, 62, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_LEFT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 64, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_RIGHT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 6);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(60, 66, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_BOTTOM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(63, 68, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(67, 70, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(69, 72, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(74, 74, "APP.CONCIERGE.VALID_FROM"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(79, 76, "APP.CONCIERGE.VALID_UNTIL"));
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaModalComponent, { className: "SignageMediaModalComponent", filePath: "apps/concierge/src/app/signage/signage-media-modal.component.ts", lineNumber: 252 });
})();
...
_SignageMediaPreviewModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaPreviewModalComponent, selectors: [["signage-media-preview-modal"]], outputs: { save: "save" }, decls: 10, vars: 8, consts: [[1, "border-base-300", "flex", "items-center", "justify-between", "border-b", "p-2"], [1, "px-2"], ["icon", "", "matRipple", "", "mat-dialog-close", "", "aria-label", "Close dialog"], [1, "bg-base-200"], [1, "flex", "h-80", "max-h-[65vh]", "w-md", "max-w-[80vw]", "flex-col", "items-center", "justify-center", "p-8"], [1, "border-base-300", "flex", "items-center", "justify-end", "space-x-2", "border-t", "p-2"], [1, "flex", "h-[65vh]", "max-h-[65vh]", "w-[80vw]", "max-w-[80vw]", "items-center", "justify-center"], ["auth", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [1, "h-full", "w-full", "object-contain", "object-center", 3, "src"], ["auth", "", "autoplay", "", "controls", "", 1, "h-full", "w-full", "object-contain", "object-center", 3, "source"], [3, "diameter"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click"]], template: function SignageMediaPreviewModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePlaylistModalComponent_Conditional_125_Template(rf, ctx) {
  if (rf & 1) {
...
function SignagePlaylistModalComponent_Conditional_126_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("ngModelChange", function SignagePlaylistModalComponent_Conditional_126_Template_a_time_field_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
function SignagePlaylistModalComponent_Conditional_127_Template(rf, ctx) {
  if (rf & 1) {
...
_SignagePlaylistModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignagePlaylistModalComponent, selectors: [["signage-playlist-modal"]], viewQuery: function SignagePlaylistModalComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275element(19, "settings-toggle", 7);
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275element(21, "settings-toggle", 8);
    \u0275\u0275pipe(22, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 9)(24, "div", 10)(25, "label", 11)(26, "div");
    \u0275\u0275text(27, "Default Play Time");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 12)(29, "mat-slider", 13);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(34, "div", 16)(35, "div", 17)(36, "label", 18);
    \u0275\u0275text(37);
    \u0275\u0275pipe(38, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "mat-select", 19);
    \u0275\u0275pipe(44, "translate");
    ...
    \u0275\u0275pipe(50, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "mat-option", 22);
    \u0275\u0275text(52);
    \u0275\u0275pipe(53, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(56, "translate");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(57, "div", 17)(58, "label", 24);
    \u0275\u0275text(59);
    \u0275\u0275pipe(60, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(64, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "mat-select", 25);
    \u0275\u0275pipe(66, "translate");
    ...
    \u0275\u0275pipe(78, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "mat-option", 26);
    \u0275\u0275text(80);
    \u0275\u0275pipe(81, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(87, "translate");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(88, "label", 27);
    \u0275\u0275text(89);
    \u0275\u0275pipe(90, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "mat-form-field", 4)(92, "mat-label");
    \u0275\u0275text(93);
    \u0275\u0275pipe(94, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(95, "textarea", 28);
    \u0275\u0275pipe(96, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "div", 29)(98, "div", 17)(99, "label", 30);
    \u0275\u0275text(100);
    \u0275\u0275pipe(101, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(102, "a-date-field", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(103, "div", 17)(104, "label", 32);
    \u0275\u0275text(105);
    \u0275\u0275pipe(106, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(107, "a-date-field", 33);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(108, "div", 34)(109, "label", 35)(110, "div");
    \u0275\u0275text(111, "Schedule");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(112, "mat-form-field", 36)(113, "mat-label");
    \u0275\u0275text(114, "Zones");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(115, "mat-select", 37);
    \u0275\u0275listener("ngModelChange", function SignagePlaylistModalComponent_Template_mat_select_ngModelChange_115_listener($event) {
      return ctx.schedule.set($event);
    });
    \u0275\u0275elementStart(116, "mat-option", 38);
    \u0275\u0275text(117, "No schedule");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(118, "mat-option", 39);
    \u0275\u0275text(119, "Play Between");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(120, "mat-option", 40);
    \u0275\u0275listener("click", function SignagePlaylistModalComponent_Template_mat_option_click_120_listener() {
      return ctx.form.patchValue({ play_duration: 30 });
    });
    \u0275\u0275text(121, "Set Date & Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(122, "mat-option", 41);
    \u0275\u0275listener("click", function SignagePlaylistModalComponent_Template_mat_option_click_122_listener() {
      return ctx.form.patchValue({ play_duration: 30 });
    });
    \u0275\u0275text(123, "Recurring Schedule");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(124, "div", 42);
    \u0275\u0275conditionalCreate(125, SignagePlaylistModalComponent_Conditional_125_Template, 11, 9, "div", 29)(126, SignagePlaylistModalComponent_Conditional_126_Template, 17, 12)(127, SignagePlaylistModalComponent_Conditional_127_Template, 14, 9);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    \u0275\u0275property("heading", \u0275\u0275pipeBind1(1, 43, ctx.playlist.id ? "APP.CONCIERGE.SIGNAGE_PLAYLISTS_EDIT" : "APP.CONCIERGE.SIGNAGE_PLAYLISTS_NEW"))("loading", ctx.loading() ? \u0275\u0275pipeBind1(2, 45, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_SAVING") : "");
    \u0275\u0275advance(3);
    \u0275\u0275property("formGroup", ctx.form);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 47, "FORM.NAME"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 49, "FORM.NAME"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(14, 51, "FORM.NAME"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(17, 53, "FORM.NAME_REQUIRED"));
    \u0275\u0275advance(3);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(20, 55, "COMMON.ENABLED"));
    \u0275\u0275advance(2);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(22, 57, "APP.CONCIERGE.SIGNAGE_PLAYLISTS_SHUFFLE"));
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(33, 59, ctx.form.value.default_duration / 1e3), " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(38, 61, "APP.CONCIERGE.SIGNAGE_ORIENTATION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 63, "APP.CONCIERGE.SIGNAGE_ORIENTATION"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(44, 65, "APP.CONCIERGE.SIGNAGE_ORIENTATION_NONE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(47, 67, "APP.CONCIERGE.SIGNAGE_ORIENTATION_NONE"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(50, 69, "APP.CONCIERGE.SIGNAGE_ORIENTATION_LANDSCAPE"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(53, 71, "APP.CONCIERGE.SIGNAGE_ORIENTATION_PORTRAIT"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(56, 73, "APP.CONCIERGE.SIGNAGE_ORIENTATION_SQUARE"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(60, 75, "APP.CONCIERGE.SIGNAGE_ANIMATION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(64, 77, "APP.CONCIERGE.SIGNAGE_ANIMATION"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(66, 79, "APP.CONCIERGE.SIGNAGE_ANIMATION_DEFAULT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 0);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(69, 81, "APP.CONCIERGE.SIGNAGE_ANIMATION_DEFAULT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(72, 83, "APP.CONCIERGE.SIGNAGE_ANIMATION_CUT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(75, 85, "APP.CONCIERGE.SIGNAGE_ANIMATION_CROSS_FADE"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(78, 87, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_TOP"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(81, 89, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_LEFT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 5);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(84, 91, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_RIGHT"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 6);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(87, 93, "APP.CONCIERGE.SIGNAGE_ANIMATION_SLIDE_BOTTOM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(90, 95, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(94, 97, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(96, 99, "COMMON.DESCRIPTION"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(101, 101, "APP.CONCIERGE.VALID_FROM"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(106, 103, "APP.CONCIERGE.VALID_UNTIL"));
    \u0275\u0275advance(2);
    \u0275\u0275property("from", ctx.form.value.valid_from);
    \u0275\u0275advance(8);
    \u0275\u0275property("ngModel", ctx.schedule())("ngModelOptions", \u0275\u0275pureFunction0(105, _c12));
    \u0275\u0275advance(10);
    \u0275\u0275conditional(ctx.schedule() === "between" ? 125 : ctx.schedule() === "exact" ? 126 : ctx.schedule() === "recurring" ? 127 : -1);
  }
}, dependencies: [
  TranslatePipe,
  FullscreenModalShellComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistModalComponent, { className: "SignagePlaylistModalComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-modal.component.ts", lineNumber: 397 });
})();
...
function ZoneSelectModalComponent_Conditional_14_button_0_For_7_Template(rf, ctx) {
  if (rf & 1) {
...
function ZoneSelectModalComponent_Conditional_14_button_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(6, ZoneSelectModalComponent_Conditional_14_button_0_For_7_Template, 2, 1, "div", 12, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275pipe(8, "slice");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ZoneSelectModalComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ZoneSelectModalComponent_Conditional_14_button_0_Template, 9, 7, "button", 8);
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const zone_list_r4 = \u0275\u0275readContextLet(12);
...
_ZoneSelectModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ZoneSelectModalComponent, selectors: [["app-zone-select-modal"]], decls: 16, vars: 8, consts: [[1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", "", "aria-label", "Close dialog"], [1, "h-[65vh]", "max-w-lg", "min-w-lg", "space-y-2", "overflow-auto", "px-4", "pt-2", "pb-4", "text-center"], ["appearance", "outline", 1, "no-subscript", "bg-base-100", "sticky", "top-0", "z-10", "w-full"], ["matInput", "", "placeholder", "Search zones", 3, "ngModelChange", "ngModel"], ["matRipple", "", 1, "border-base-300", "hover:bg-base-200", "z-0", "flex", "h-16", "w-full", "items-center", "justify-center", "space-x-2", "rounded-sm", "border", "p-2", "text-left", 3, "mat-dialog-close"], [1, "bg-base-200", "flex", "h-[calc(100%-3.5rem)]", "w-full", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-lg", "p-16"], ["matRipple", "", "class", "border-base-300 hover:bg-base-200 z-0 flex h-16 w-full items-center justify-center space-x-2 rounded-sm border p-2 text-left", 3, "mat-dialog-close", 4, "ngFor", "ngForOf"], [1, "flex-1"], [1, ""], [1, "text-xs", "opacity-60"], [1, "bg-info", "text-info-content", "rounded-lg", "px-2", "py-1", "font-mono", "text-[0.625rem]"], [1, "text-8xl", "opacity-60"], [1, "opacity-60"]], template: function ZoneSelectModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275text(6, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "main", 3)(8, "mat-form-field", 4)(9, "mat-label");
    \u0275\u0275text(10, "Search");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "input", 5);
    \u0275\u0275listener("ngModelChange", function ZoneSelectModalComponent_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275declareLet(12);
    \u0275\u0275pipe(13, "async");
    \u0275\u0275conditionalCreate(14, ZoneSelectModalComponent_Conditional_14_Template, 1, 1, "button", 6)(15, ZoneSelectModalComponent_Conditional_15_Template, 5, 0, "div", 7);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    const zone_list_r5 = \u0275\u0275storeLet(\u0275\u0275pipeBind1(13, 5, ctx.zones));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(zone_list_r5.length > 0 ? 14 : 15);
  }
}, dependencies: [
  CommonModule,
  NgForOf,
...
function SignageDisplaysComponent_Conditional_10_For_2_Conditional_2_For_1_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageDisplaysComponent_Conditional_10_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SignageDisplaysComponent_Conditional_10_For_2_Conditional_2_For_1_Template, 6, 11, "div", 14, _forTrack03);
  }
  if (rf & 2) {
...
function SignageDisplaysComponent_Conditional_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 13);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, SignageDisplaysComponent_Conditional_10_For_2_Conditional_2_Template, 2, 0);
  }
  if (rf & 2) {
    let tmp_16_0;
...
function SignageDisplaysComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275repeaterCreate(1, SignageDisplaysComponent_Conditional_10_For_2_Template, 3, 11, null, null, _forTrack03);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function SignageDisplaysComponent_Conditional_13_Conditional_2_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageDisplaysComponent_Conditional_13_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 22);
    \u0275\u0275repeaterCreate(1, SignageDisplaysComponent_Conditional_13_Conditional_2_For_2_Template, 6, 14, "a", 31, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(3, "button", 32);
    \u0275\u0275listener("click", function SignageDisplaysComponent_Conditional_13_Conditional_2_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function SignageDisplaysComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("add", function SignageDisplaysComponent_Conditional_13_Template_signage_item_playlists_add_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.adding.set(true));
    })("remove", function SignageDisplaysComponent_Conditional_13_Template_signage_item_playlists_remove_1_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removePlaylist($event));
    })("ondrop", function SignageDisplaysComponent_Conditional_13_Template_signage_item_playlists_ondrop_1_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.drop($event));
    });
    \u0275\u0275conditionalCreate(2, SignageDisplaysComponent_Conditional_13_Conditional_2_Template, 6, 3, "div", 22);
    ...
    \u0275\u0275listener("click", function SignageDisplaysComponent_Conditional_13_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function SignageDisplaysComponent_Conditional_13_Template_button_click_31_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function SignageDisplaysComponent_Conditional_13_Template_button_click_38_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function SignageDisplaysComponent_Conditional_13_Template_button_click_45_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function SignageDisplaysComponent_Conditional_13_Template_button_click_52_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
...
_SignageDisplaysComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageDisplaysComponent, selectors: [["signage-displays"]], decls: 16, vars: 10, consts: [["menu", "matMenu"], ["orientationMenu", "matMenu"], [1, "relative", "flex", "h-full", "w-full", "space-x-2", "overflow-visible"], ["sidebar", "", 1, "border-base-300", "flex", "h-full", "w-64", "flex-col", "space-y-2", "overflow-auto", "rounded-xl", "border", "p-2"], [1, "bg-base-200", "rounded-lg", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], [1, "h-1/2", "w-full", "flex-1", "space-y-2", "overflow-auto"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-60"], [1, "border-base-300", "bg-base-200", "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", "rounded-lg", "border", "p-2", "shadow-sm"], [1, "flex", "flex-1", "flex-col", 3, "item", "name", "extra", "link"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "opacity-60"], [3, "item_list"], ["matRipple", "", 1, "border-base-100", "even:border-base-200", "even:bg-base-200", "hover:border-info", "relative", "z-10", "flex", "h-12", "min-h-12", "w-full", "items-center", "truncate", "rounded-3xl", "border", "px-6", 3, "routerLink", "queryParams"], [1, "relative", "z-0", "flex", "items-center", "space-x-2"], [1, "w-6"], [1, "border-base-300", "absolute", "top-1/2", "left-6", "z-0", "h-16", "w-4", "-translate-y-full", "border-b-2", "border-l-2"], ["matRipple", "", 1, "hover:bg-base-200", "relative", "z-10", "flex", "min-h-12", "w-1/2", "flex-1", "items-center", "truncate", "rounded-3xl", "px-6", 3, "routerLink", "queryParams"], [1, "max-w-full", "truncate"], [1, "text-6xl"], [1, "text-center"], [1, "flex", "flex-1", "flex-col", 3, "add", "remove", "ondrop", "item", "name", "extra", "link"], [1, "bg-base-100", "mt-2", "flex", "flex-wrap", "items-center", "overflow-auto", "rounded-xl", "p-1"], ["icon", "", "matRipple", "", "aria-label", "More options", 1, "absolute", "top-2", "right-2", "m-0!", 3, "matMenuTriggerFor"], ["mat-menu-item", "", "target", "_blank", "ref", "noopener noreferrer", 3, "href"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "text-error", "text-2xl"], ["matRipple", "", 1, "bg-base-200", "m-1", "rounded-sm", "px-2", "py-1", "font-mono", "text-xs", "whitespace-nowrap", 3, "routerLink", "queryParams"], ["matRipple", "", 1, "m-1", "rounded-sm", "px-2", "py-1", "font-mono", "text-xs", "underline", 3, "click"], [3, "selected", "close", "item_list"]], template: function SignageDisplaysComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275listener("ngModelChange", function SignageDisplaysComponent_Template_input_ngModelChange_8_listener($event) {
      return ctx.search.set($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(10, SignageDisplaysComponent_Conditional_10_Template, 3, 0, "div", 7)(11, SignageDisplaysComponent_Conditional_11_Template, 6, 3, "div", 8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 9);
    \u0275\u0275conditionalCreate(13, SignageDisplaysComponent_Conditional_13_Template, 59, 30, "signage-item-playlists", 10)(14, SignageDisplaysComponent_Conditional_14_Template, 6, 3, "div", 11);
    \u0275\u0275conditionalCreate(15, SignageDisplaysComponent_Conditional_15_Template, 1, 1, "search-overlay", 12);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(9, 8, "COMMON.SEARCH"))("ngModel", ctx.search());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.displays().length > 0 ? 10 : 11);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.active_display() ? 13 : 14);
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageDisplaysComponent, { className: "SignageDisplaysComponent", filePath: "apps/concierge/src/app/signage/signage-displays.component.ts", lineNumber: 348 });
})();

// apps/concierge/src/app/signage/signage-media-list.component.ts
var _forTrack04 = ($index, $item) => $item.id;
function SignageMediaListComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 12)(1, "mat-form-field", 13)(2, "mat-label");
    \u0275\u0275text(3, "Search");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 6);
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275twoWayListener("ngModelChange", function SignageMediaListComponent_ng_template_13_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_ng_template_13_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.addFromLink(ctx_r2.link()));
    });
    \u0275\u0275elementStart(7, "icon", 15);
    \u0275\u0275text(8, "add");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(5, 3, "COMMON.URL"));
    \u0275\u0275twoWayProperty("ngModel", ctx_r2.link);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 5, "COMMON.ADD"));
  }
}
function SignageMediaListComponent_Conditional_20_For_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 18);
  }
}
function SignageMediaListComponent_Conditional_20_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 19);
  }
}
function SignageMediaListComponent_Conditional_20_For_2_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_20_For_2_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_20_For_2_Conditional_6_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 41);
...
function SignageMediaListComponent_Conditional_20_For_2_Conditional_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22)(1, "icon", 40);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function SignageMediaListComponent_Conditional_20_For_2_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SignageMediaListComponent_Conditional_20_For_2_Conditional_6_Conditional_0_Template, 4, 1)(1, SignageMediaListComponent_Conditional_20_For_2_Conditional_6_Conditional_1_Template, 3, 1, "div", 22);
  }
  if (rf & 2) {
...
function SignageMediaListComponent_Conditional_20_For_2_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_20_For_2_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageMediaListComponent_Conditional_20_For_2_For_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_20_For_2_For_27_Template_button_click_0_listener() {
...
function SignageMediaListComponent_Conditional_20_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275conditionalCreate(1, SignageMediaListComponent_Conditional_20_For_2_Conditional_1_Template, 1, 0, "div", 18)(2, SignageMediaListComponent_Conditional_20_For_2_Conditional_2_Template, 1, 0, "div", 19);
    \u0275\u0275template(3, SignageMediaListComponent_Conditional_20_For_2_div_3_Template, 3, 0, "div", 20);
    \u0275\u0275elementStart(4, "button", 21);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_20_For_2_Template_button_click_4_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.previewItem(media_r6));
    });
    \u0275\u0275conditionalCreate(5, SignageMediaListComponent_Conditional_20_For_2_Conditional_5_Template, 3, 0, "div", 22)(6, SignageMediaListComponent_Conditional_20_For_2_Conditional_6_Template, 2, 1);
    \u0275\u0275elementStart(7, "div", 23);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(10, SignageMediaListComponent_Conditional_20_For_2_Conditional_10_Template, 3, 3, "div", 24);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_20_For_2_Template_mat_form_field_click_20_listener($event) {
      \u0275\u0275restoreView(_r5);
    ...
    \u0275\u0275pipe(24, "translate");
    \u0275\u0275listener("ngModelChange", function SignageMediaListComponent_Conditional_20_For_2_Template_input_ngModelChange_23_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.playlist_search.set($event));
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(25, SignageMediaListComponent_Conditional_20_For_2_Conditional_25_Template, 3, 4, "button", 30);
    \u0275\u0275repeaterCreate(26, SignageMediaListComponent_Conditional_20_For_2_For_27_Template, 4, 1, "button", 31, _forTrack04);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "mat-menu", null, 2)(30, "button", 32);
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_20_For_2_Template_button_click_30_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.editItem(media_r6));
    });
    \u0275\u0275elementStart(31, "div", 33)(32, "icon", 34);
    \u0275\u0275text(33, "edit");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(36, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "button", 36)(38, "div", 33)(39, "icon", 34);
    \u0275\u0275text(40, "add");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_20_For_2_Template_button_click_44_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.previewItem(media_r6));
    });
    \u0275\u0275elementStart(45, "div", 33)(46, "icon", 34);
    \u0275\u0275text(47, "visibility");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function SignageMediaListComponent_Conditional_20_For_2_Template_button_click_51_listener() {
      const media_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeItem(media_r6));
    });
    \u0275\u0275elementStart(52, "div", 33)(53, "icon", 37);
    \u0275\u0275text(54, " delete ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(9);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(24, 29, "COMMON.SEARCH"))("ngModel", ctx_r2.playlist_search());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!(((tmp_29_0 = ctx_r2.playlists()) == null ? null : tmp_29_0.length) > 0) ? 25 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.playlists());
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(36, 31, "APP.CONCIERGE.SIGNAGE_MEDIA_EDIT"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("matMenuTriggerFor", playlist_menu_r9);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(43, 33, "APP.CONCIERGE.SIGNAGE_MEDIA_ADD_PLAYLIST"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(50, 35, "APP.CONCIERGE.SIGNAGE_MEDIA_PREVIEW"), " ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(57, 37, "APP.CONCIERGE.SIGNAGE_MEDIA_REMOVE"), " ");
  }
}
function SignageMediaListComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 16);
    \u0275\u0275listener("cdkDropListDropped", function SignageMediaListComponent_Conditional_20_Template_div_cdkDropListDropped_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.drop($event));
    });
    \u0275\u0275repeaterCreate(1, SignageMediaListComponent_Conditional_20_For_2_Template, 58, 39, "div", 17, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function SignageMediaListComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
_SignageMediaListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaListComponent, selectors: [["signage-media-list"]], inputs: { playlist_count: [1, "playlist_count"] }, features: [\u0275\u0275NgOnChangesFeature], decls: 22, vars: 15, consts: [["add_link_template", ""], ["playlist_menu", "matMenu"], ["menu", "matMenu"], [1, "relative", "p-2"], [1, "bg-base-100", "mb-2", "rounded-xl", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "white", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["icon", "", "matRipple", "", "customTooltip", "", "matTooltipPosition", "left", 1, "border-base-300", "absolute", "top-3", "right-14", "h-9!", "max-h-9", "w-9!", "max-w-9", "min-w-0", "border", 3, "content", "matTooltip"], ["icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "border-base-300", "absolute", "top-3", "right-3", "h-9!", "max-h-9", "w-9!", "max-w-9", "min-w-0", "border", 3, "matTooltip"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["cdkDropList", "", "id", "media-list", 1, "grid", "w-full", "gap-4", "p-4", "md:grid-cols-2", "lg:grid-cols-3", 3, "cdkDropListData", "cdkDropListConnectedTo"], [1, "mx-auto", "flex", "flex-1", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-60"], [1, "border-base-300", "bg-base-100", "my-2", "flex", "w-[20rem]", "flex-col", "space-y-4", "rounded-lg", "border", "p-4", "shadow-sm"], ["appearance", "outline", 1, "no-subscript"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "mr-2", "text-2xl"], ["cdkDropList", "", "id", "media-list", 1, "grid", "w-full", "gap-4", "p-4", "md:grid-cols-2", "lg:grid-cols-3", 3, "cdkDropListDropped", "cdkDropListData", "cdkDropListConnectedTo"], ["cdkDrag", "", 1, "border-base-300", "bg-base-100", "relative", "flex", "flex-col", "items-center", "justify-center", "rounded-lg", "border", "p-3", "hover:opacity-80"], [1, "bg-warning", "absolute", "inset-0", "z-0", "rounded-lg", "opacity-10"], [1, "bg-error", "absolute", "inset-0", "z-0", "rounded-lg", "opacity-10"], ["class", "border-base-400 bg-base-300 flex min-h-10 min-w-10 items-center justify-center rounded-2xl border-4 border-dashed opacity-60", 4, "cdkDragPlaceholder"], ["preview", "", "matRipple", "", 1, "bg-base-200", "relative", "h-36", "w-full", "overflow-hidden", "rounded-lg", 3, "click"], [1, "flex", "h-full", "w-full", "items-center", "justify-center"], [1, "absolute", "top-1", "left-1", "rounded-lg", "px-2", "py-1", "font-mono", "text-xs", "capitalize"], [1, "bg-info", "text-info-content", "absolute", "right-1", "bottom-1", "rounded-lg", "px-2", "py-1", "font-mono", "text-xs", "capitalize"], [1, "relative", "top-1", "flex", "w-full", "items-center", "justify-between"], [1, "text-base-content", "w-1/2", "flex-1", "truncate", 3, "matTooltip"], ["icon", "", "matRipple", "", "aria-label", "Media Actions", 3, "matMenuTriggerFor"], [1, "px-2"], ["appearance", "outline", 1, "no-subscript", "w-full", 3, "click"], ["mat-menu-item", "", 3, "disabled"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2"], [1, "text-2xl"], [1, "pr-2"], ["mat-menu-item", "", 3, "matMenuTriggerFor"], [1, "text-error", "text-2xl"], [1, "border-base-400", "bg-base-300", "flex", "min-h-10", "min-w-10", "items-center", "justify-center", "rounded-2xl", "border-4", "border-dashed", "opacity-60"], [1, "text-base-100", "text-2xl"], [1, "text-8xl", "opacity-60"], ["auth", "", 1, "absolute", "-inset-px", "rounded-lg", "object-contain", 3, "source"], [1, "absolute", "inset-0", "flex", "items-end", "justify-end", "p-1", "opacity-0", "transition-opacity", "duration-200", "hover:opacity-100"], [1, "text-6xl"]], template: function SignageMediaListComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275listener("ngModelChange", function SignageMediaListComponent_Template_input_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(12, "link");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(13, SignageMediaListComponent_ng_template_13_Template, 12, 7, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    ...
    \u0275\u0275listener("change", function SignageMediaListComponent_Template_input_change_19_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.previewFile($event));
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(20, SignageMediaListComponent_Conditional_20_Template, 3, 2, "div", 10)(21, SignageMediaListComponent_Conditional_21_Template, 6, 3, "div", 11);
  }
  if (rf & 2) {
    let tmp_7_0;
    const add_link_template_r11 = \u0275\u0275reference(14);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 7, "APP.CONCIERGE.SIGNAGE_MEDIA"), " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 9, "COMMON.SEARCH"))("ngModel", ctx.search());
    \u0275\u0275advance(2);
    \u0275\u0275property("content", add_link_template_r11)("matTooltip", \u0275\u0275pipeBind1(10, 11, "APP.CONCIERGE.SIGNAGE_MEDIA_LINK"));
    \u0275\u0275advance(6);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(16, 13, "APP.CONCIERGE.SIGNAGE_MEDIA_UPLOAD"));
    \u0275\u0275advance(5);
    \u0275\u0275conditional(((tmp_7_0 = ctx.media()) == null ? null : tmp_7_0.length) > 0 ? 20 : 21);
  }
}, dependencies: [
  CommonModule,
  TranslatePipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaListComponent, { className: "SignageMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-media-list.component.ts", lineNumber: 375 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignagePlaylistMediaListComponent, { className: "SignagePlaylistMediaListComponent", filePath: "apps/concierge/src/app/signage/signage-playlist-media-list.component.ts", lineNumber: 379 });
})();
...
function SignageMediaComponent_Conditional_14_For_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 13);
    \u0275\u0275listener("cdkDropListDropped", function SignageMediaComponent_Conditional_14_For_1_Template_a_cdkDropListDropped_0_listener($event) {
...
function SignageMediaComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SignageMediaComponent_Conditional_14_For_1_Template, 3, 13, "a", 12, _forTrack05);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275repeater(ctx_r2.playlists());
...
function SignageMediaComponent_Conditional_15_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 19);
    \u0275\u0275listener("click", function SignageMediaComponent_Conditional_15_Conditional_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function SignageMediaComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(6, SignageMediaComponent_Conditional_15_Conditional_6_Template, 7, 3, "button", 18);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
...
function SignageMediaComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275listener("dragleave", function SignageMediaComponent_Conditional_20_Template_div_dragleave_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.hideOverlay($event));
    })("drop", function SignageMediaComponent_Conditional_20_Template_div_drop_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("change", function SignageMediaComponent_Conditional_20_Template_input_change_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.previewFile($event));
    });
...
_SignageMediaComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageMediaComponent, selectors: [["signage-media"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 21, vars: 22, consts: [[1, "relative", "flex", "h-full", "w-full", "space-x-2", "overflow-visible"], ["sidebar", "", 1, "border-base-300", "flex", "h-full", "w-64", "flex-col", "space-y-2", "overflow-auto", "rounded-xl", "border", "p-2"], [1, "bg-base-200", "rounded-lg", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], ["matRipple", "", 1, "hover:bg-base-200", "flex", "min-h-12", "w-full", "items-center", "rounded-xl", "px-6", 3, "routerLink", "queryParams"], [1, "border-base-300", "bg-base-300", "-mx-2", "w-[calc(100%+1rem)]"], [1, "border-base-300", "bg-base-200", "relative", "h-full", "w-1/2", "flex-1", "overflow-hidden", "rounded-lg", "border", "shadow-sm", 3, "dragover", "dragenter", "drop"], [1, "h-full", "w-full", "overflow-auto"], [3, "playlist_count"], [3, "playlist", "playlist_count"], [1, "absolute", "inset-0"], ["matRipple", "", "cdkDropList", "", 1, "border-base-100", "even:border-base-200", "even:bg-base-200", "hover:border-info", "flex", "h-12", "min-h-12", "w-full", "items-center", "rounded-3xl", "border", "px-6", 3, "bg-secondary!", "text-secondary-content", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], ["matRipple", "", "cdkDropList", "", 1, "border-base-100", "even:border-base-200", "even:bg-base-200", "hover:border-info", "flex", "h-12", "min-h-12", "w-full", "items-center", "rounded-3xl", "border", "px-6", 3, "cdkDropListDropped", "routerLink", "queryParams", "id", "cdkDropListConnectedTo"], [1, "flex-1"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-60"], [1, "text-6xl"], [1, "text-center"], ["btn", "", "matRipple", "", 1, "inverse"], ["btn", "", "matRipple", "", 1, "inverse", 3, "click"], [1, "flex", "w-full", "items-center", "justify-center"], [1, "text-2xl"], [1, "mr-4", "ml-2"], [1, "absolute", "inset-0", 3, "dragleave", "drop"], [1, "bg-base-content", "absolute", "inset-0", "opacity-60"], [1, "border-base-300", "text-base-100", "absolute", "inset-4", "flex", "flex-col", "items-center", "justify-center", "space-y-4", "rounded-2xl", "border-4", "border-dashed"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"]], template: function SignageMediaComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275listener("ngModelChange", function SignageMediaComponent_Template_input_ngModelChange_8_listener($event) {
      return ctx.search.set($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(13, "hr", 6);
    \u0275\u0275conditionalCreate(14, SignageMediaComponent_Conditional_14_Template, 2, 0)(15, SignageMediaComponent_Conditional_15_Template, 7, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 7);
    \u0275\u0275listener("dragover", function SignageMediaComponent_Template_div_dragover_16_listener($event) {
      return ctx.onEnter($event);
    })("dragenter", function SignageMediaComponent_Template_div_dragenter_16_listener($event) {
      return ctx.onEnter($event);
    })("drop", function SignageMediaComponent_Template_div_drop_16_listener($event) {
      return ctx.hideOverlay($event);
    }, \u0275\u0275resolveWindow);
    \u0275\u0275elementStart(17, "div", 8);
    \u0275\u0275conditionalCreate(18, SignageMediaComponent_Conditional_18_Template, 1, 1, "signage-media-list", 9);
    \u0275\u0275conditionalCreate(19, SignageMediaComponent_Conditional_19_Template, 1, 2, "signage-playlist-media-list", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(20, SignageMediaComponent_Conditional_20_Template, 9, 3, "div", 11);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_8_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(9, 16, "COMMON.SEARCH"))("ngModel", ctx.search());
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 18, "APP.CONCIERGE.SIGNAGE_MEDIA_ALL"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(((tmp_8_0 = ctx.playlists()) == null ? null : tmp_8_0.length) > 0 ? 14 : 15);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(!ctx.selected_playlist() ? 18 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.selected_playlist() ? 19 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.show_dropzone() ? 20 : -1);
  }
}, dependencies: [
  CommonModule,
  MatFormFieldModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageMediaComponent, { className: "SignageMediaComponent", filePath: "apps/concierge/src/app/signage/signage-media.component.ts", lineNumber: 193 });
})();
...
function SignageZonesComponent_Conditional_10_For_2_Conditional_2_For_1_Template(rf, ctx) {
  if (rf & 1) {
...
function SignageZonesComponent_Conditional_10_For_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SignageZonesComponent_Conditional_10_For_2_Conditional_2_For_1_Template, 5, 11, "div", 12, _forTrack06);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275repeater(ctx_r2.triggers());
...
function SignageZonesComponent_Conditional_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 11);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, SignageZonesComponent_Conditional_10_For_2_Conditional_2_Template, 2, 0);
  }
  if (rf & 2) {
    let tmp_16_0;
...
function SignageZonesComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SignageZonesComponent_Conditional_10_For_2_Template, 3, 11, null, null, _forTrack06);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function SignageZonesComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("add", function SignageZonesComponent_Conditional_13_Template_signage_item_playlists_add_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.adding.set(true));
    })("remove", function SignageZonesComponent_Conditional_13_Template_signage_item_playlists_remove_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removePlaylist($event));
    })("ondrop", function SignageZonesComponent_Conditional_13_Template_signage_item_playlists_ondrop_0_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.drop($event));
    });
...
_SignageZonesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SignageZonesComponent, selectors: [["signage-zones"]], decls: 16, vars: 10, consts: [[1, "relative", "flex", "h-full", "w-full", "space-x-2", "overflow-visible"], ["sidebar", "", 1, "border-base-300", "flex", "h-full", "w-64", "flex-col", "space-y-2", "overflow-auto", "rounded-xl", "border", "p-2"], [1, "bg-base-200", "rounded-lg", "p-2", "text-center", "text-xl", "font-medium"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", 3, "ngModelChange", "placeholder", "ngModel"], [1, "h-1/2", "w-full", "flex-1", "space-y-2", "overflow-auto"], [1, "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-8", "opacity-60"], [1, "border-base-300", "bg-base-200", "relative", "flex", "h-full", "w-1/2", "flex-1", "flex-col", "space-y-2", "overflow-auto", "rounded-lg", "border", "p-2", "shadow-sm"], [1, "flex", "flex-1", "flex-col", 3, "item", "name"], [1, "absolute", "inset-0", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "opacity-60"], [3, "item_list"], ["matRipple", "", 1, "border-base-100", "even:border-base-200", "even:bg-base-200", "hover:border-info", "z-10", "flex", "h-12", "min-h-12", "w-full", "items-center", "truncate", "rounded-3xl", "border", "px-6", 3, "routerLink", "queryParams"], [1, "relative", "z-0", "flex", "items-center", "space-x-2"], [1, "w-6"], [1, "border-base-300", "absolute", "top-1/2", "left-6", "h-16", "w-4", "-translate-y-full", "border-b-2", "border-l-2"], ["matRipple", "", 1, "hover:bg-base-200", "flex", "min-h-12", "w-full", "items-center", "truncate", "rounded-3xl", "px-6", 3, "routerLink", "queryParams"], [1, "text-6xl"], [1, "text-center"], [1, "flex", "flex-1", "flex-col", 3, "add", "remove", "ondrop", "item", "name"], [3, "selected", "close", "item_list"]], template: function SignageZonesComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(8, "input", 4);
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275listener("ngModelChange", function SignageZonesComponent_Template_input_ngModelChange_8_listener($event) {
      return ctx.search.set($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(10, SignageZonesComponent_Conditional_10_Template, 3, 0, "div", 5)(11, SignageZonesComponent_Conditional_11_Template, 6, 3, "div", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 7);
    \u0275\u0275conditionalCreate(13, SignageZonesComponent_Conditional_13_Template, 1, 2, "signage-item-playlists", 8)(14, SignageZonesComponent_Conditional_14_Template, 6, 3, "div", 9);
    \u0275\u0275conditionalCreate(15, SignageZonesComponent_Conditional_15_Template, 1, 1, "search-overlay", 10);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(9, 8, "COMMON.SEARCH"))("ngModel", ctx.search());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.zones().length > 0 ? 10 : 11);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.active_zone() ? 13 : 14);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.adding() ? 15 : -1);
  }
}, dependencies: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SignageZonesComponent, { className: "SignageZonesComponent", filePath: "apps/concierge/src/app/signage/signage-zones.component.ts", lineNumber: 167 });
})();
...
//# sourceMappingURL=signage.module-5OSIBJSH.js.map
