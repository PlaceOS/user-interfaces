...
function TeamScheduleComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 10);
    \u0275\u0275listener("click", function TeamScheduleComponent_Conditional_10_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
var TeamScheduleComponent = class _TeamScheduleComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TeamScheduleComponent, selectors: [["team-schedule"]], decls: 13, vars: 3, consts: [[1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden"], [1, "z-10"], [1, "bg-base-200", "relative", "flex", "h-1/2", "flex-1", "overflow-auto"], [1, "mx-auto", "w-fit", "min-w-full", "gap-4", "p-4"], [1, "mb-4", "block"], [1, "bg-base-100", "overflow-hidden", "rounded-lg", "shadow"], [1, "hidden", "sm:block"], [1, "block", "sm:hidden"], [1, "h-4", "min-h-px", "w-full"], ["icon", "", "matRipple", "", 1, "bg-secondary", "absolute", "top-1/2", "left-2", "h-16", "w-16", "-translate-y-1/2"], ["icon", "", "matRipple", "", 1, "bg-secondary", "absolute", "top-1/2", "left-2", "h-16", "w-16", "-translate-y-1/2", 3, "click"], ["src", "assets/icons/ben_icon.svg", 1, "z-10", "h-12"]], template: function TeamScheduleComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275conditionalCreate(1, TeamScheduleComponent_Conditional_1_Template, 1, 0, "topbar", 1);
        \u0275\u0275elementStart(2, "div", 2)(3, "div", 3);
        \u0275\u0275element(4, "team-quick-actions", 4)(5, "team-schedule-filters", 4);
        \u0275\u0275elementStart(6, "div", 5);
        \u0275\u0275element(7, "team-schedule-table", 6)(8, "team-schedule-list", 7);
        \u0275\u0275elementEnd();
        \u0275\u0275element(9, "div", 8);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(10, TeamScheduleComponent_Conditional_10_Template, 2, 0, "button", 9);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(9);
        \u0275\u0275conditional(ctx.virtual_concierge_url() ? 10 : -1);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TeamScheduleComponent, { className: "TeamScheduleComponent", filePath: "apps/workplace/src/app/team-schedule/team-schedule.component.ts", lineNumber: 59 });
})();
export {
  TeamScheduleComponent
};
//# sourceMappingURL=team-schedule.component-DL4H5AFJ.js.map
