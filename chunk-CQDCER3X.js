...
function PointsAssetModalComponent_Conditional_5_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
...
function PointsAssetModalComponent_Conditional_5_For_50_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a-time-field", 39);
    \u0275\u0275twoWayListener("ngModelChange", function PointsAssetModalComponent_Conditional_5_For_50_Conditional_14_Template_a_time_field_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r5);
...
function PointsAssetModalComponent_Conditional_5_For_50_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24)(1, "div", 29)(2, "mat-form-field", 30)(3, "mat-select", 31);
    \u0275\u0275twoWayListener("ngModelChange", function PointsAssetModalComponent_Conditional_5_For_50_Template_mat_select_ngModelChange_3_listener($event) {
      const rule_r4 = \u0275\u0275restoreView(_r3).$implicit;
      \u0275\u0275twoWayBindingSet(rule_r4.type, $event) || (rule_r4.type = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(4, "mat-option", 32);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "mat-option", 34);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "a-time-field", 35);
    \u0275\u0275twoWayListener("ngModelChange", function PointsAssetModalComponent_Conditional_5_For_50_Template_a_time_field_ngModelChange_13_listener($event) {
      const rule_r4 = \u0275\u0275restoreView(_r3).$implicit;
      \u0275\u0275twoWayBindingSet(rule_r4.first, $event) || (rule_r4.first = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, PointsAssetModalComponent_Conditional_5_For_50_Conditional_14_Template, 1, 4, "a-time-field", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span", 37);
    \u0275\u0275text(16, "@");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "a-counter", 38);
    \u0275\u0275twoWayListener("ngModelChange", function PointsAssetModalComponent_Conditional_5_For_50_Template_a_counter_ngModelChange_17_listener($event) {
      const rule_r4 = \u0275\u0275restoreView(_r3).$implicit;
...
function PointsAssetModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(27, "async");
    \u0275\u0275conditionalCreate(28, PointsAssetModalComponent_Conditional_5_Conditional_28_Template, 3, 4, "mat-option", 16);
    \u0275\u0275pipe(29, "async");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 19)(34, "div", 20)(35, "label");
    \u0275\u0275text(36);
    \u0275\u0275pipe(37, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(38, "a-counter", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 20)(40, "label");
    \u0275\u0275text(41);
    \u0275\u0275pipe(42, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275element(43, "a-counter", 22);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275repeaterCreate(49, PointsAssetModalComponent_Conditional_5_For_50_Template, 18, 23, "div", 24, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "button", 25);
    \u0275\u0275listener("click", function PointsAssetModalComponent_Conditional_5_Template_button_click_51_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.newRule());
    });
    \u0275\u0275elementStart(52, "div", 26)(53, "icon", 27);
    \u0275\u0275text(54, "add");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 24, "APP.CONCIERGE.POINTS_TYPE"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 26, "RESOURCE.ROOM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 28, "RESOURCE.DESK"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 30, "RESOURCE.ASSET"));
    \u0275\u0275advance(3);
    \u0275\u0275classProp("opacity-30", !ctx_r5.form.get("type").value);
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(21, 32, "APP.CONCIERGE.POINTS_ASSETS_SEARCH"))("matAutocomplete", auto_r7);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r5.loading ? 22 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(27, 34, ctx_r5.asset_options));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!((tmp_12_0 = \u0275\u0275pipeBind1(29, 36, ctx_r5.asset_options)) == null ? null : tmp_12_0.length) ? 28 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(32, 38, "APP.CONCIERGE.POINTS_ACCEPT"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 40, "APP.CONCIERGE.POINTS_STANDARD_RATE"));
    \u0275\u0275advance(2);
    \u0275\u0275property("min", 500)("max", 8e4)("step", 500)("render_fn", ctx_r5.renderPrice);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(42, 42, "APP.CONCIERGE.POINTS_DISCOUNT_CAP"));
    \u0275\u0275advance(2);
    \u0275\u0275property("min", 0)("max", 100)("step", 5)("render_fn", ctx_r5.renderPercent);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 44, "APP.CONCIERGE.POINTS_RATE_RULES"));
    \u0275\u0275advance(3);
    \u0275\u0275repeater(((tmp_25_0 = ctx_r5.form.get("custom_rates")) == null ? null : tmp_25_0.value) || \u0275\u0275pureFunction0(48, _c0));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 46, "APP.CONCIERGE.POINTS_RATE_RULES_NEW"));
  }
}
...
_PointsAssetModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsAssetModalComponent, selectors: [["points-asset-modal"]], outputs: { event: "event" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 10, vars: 9, consts: [["auto", "matAutocomplete"], [1, "bg-base-200", "sticky", "top-0", "z-10", "m-2", "w-[calc(100%-1rem)]", "rounded-sm", "border-none", "p-2"], [1, "px-2", "text-xl", "font-medium"], ["icon", "", "matRipple", "", "mat-dialog-close", ""], [1, "min-w-md", "overflow-hidden", "px-4", "py-2", 3, "formGroup"], [1, "border-base-200", "flex", "items-center", "justify-end", "space-x-2", "border-t", "p-2"], ["btn", "", "matRipple", "", 1, "w-32", 3, "click", "disabled"], [1, "flex", "flex-col"], ["appearance", "outline", 1, "h-13", "flex-1"], ["formControlName", "type", "placeholder", "Select asset type"], ["value", "space"], ["value", "desk"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "name", 3, "placeholder", "matAutocomplete"], ["matSuffix", "", 3, "diameter"], [3, "value"], [3, "disabled"], [1, "mb-4", "flex", "items-center"], ["formControlName", "accept_points", 1, "w-full", 3, "name"], [1, "mb-4", "flex", "space-x-4"], [1, "flex", "flex-1", "flex-col"], ["formControlName", "unit_price", 1, "w-full", 3, "min", "max", "step", "render_fn"], ["formControlName", "discount_cap", 1, "w-full", 3, "min", "max", "step", "render_fn"], [1, ""], ["rule", "", 1, "flex", "items-center"], ["btn", "", "matRipple", "", 1, "clear", "w-full", 3, "click"], [1, "flex", "w-full", "items-center", "justify-center"], [1, "text-lg"], [1, "underline"], [1, "flex", "w-1/2", "flex-1", "items-center", "space-x-2"], ["appearance", "outline", 1, "h-13", "w-32", "flex-2"], [3, "ngModelChange", "ngModel", "ngModelOptions"], ["value", "before"], ["value", "between"], ["value", "after"], [1, "mt-2", "w-40", "flex-1", 3, "ngModelChange", "ngModel", "ngModelOptions"], [1, "mt-2", "w-40", "flex-1", 3, "ngModel", "from", "ngModelOptions"], [1, "mx-2"], [1, "border-base-200", "rounded-sm", "border", 3, "ngModelChange", "ngModel", "ngModelOptions", "min", "max", "step", "render_fn"], [1, "mt-2", "w-40", "flex-1", 3, "ngModelChange", "ngModel", "from", "ngModelOptions"]], template: function PointsAssetModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, PointsAssetModalComponent_Conditional_5_Template, 58, 49, "main", 4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsAssetModalComponent, { className: "PointsAssetModalComponent", filePath: "apps/concierge/src/app/points/asset-modal.component.ts", lineNumber: 273 });
})();
...
function PointsAssetsComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
...
function PointsAssetsComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
...
function PointsAssetsComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
...
function PointsAssetsComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
...
function PointsAssetsComponent_ng_template_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 12)(1, "button", 13);
    \u0275\u0275listener("click", function PointsAssetsComponent_ng_template_16_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function PointsAssetsComponent_ng_template_16_Template_button_click_4_listener() {
      const row_r7 = \u0275\u0275restoreView(_r6).row;
      const ctx_r2 = \u0275\u0275nextContext();
...
_PointsAssetsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsAssetsComponent, selectors: [["points-assets"]], decls: 18, vars: 39, consts: [["type_template", ""], ["price_template", ""], ["bool_template", ""], ["discount_template", ""], ["action_template", ""], [1, "absolute", "inset-0", "overflow-auto", "px-8"], [1, "block", "w-full", "min-w-[32rem]", 3, "data", "columns", "sortable", "empty_message"], [1, "p-2"], [1, "rounded", "bg-base-200", "px-2", "py-1", "text-sm", "capitalize"], [1, "p-4", "font-mono", "text-xs"], [1, "mx-auto", "flex", "h-8", "w-8", "items-center", "justify-center", "rounded", "text-2xl", "text-white"], [1, "p-4", "text-right"], [1, "mx-auto", "flex", "items-center", "justify-end", "p-2"], ["icon", "", "matRipple", "", 3, "click"], [1, "text-error"]], template: function PointsAssetsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(6, "translate");
    \u0275\u0275pipe(7, "translate");
    \u0275\u0275template(8, PointsAssetsComponent_ng_template_8_Template, 3, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(10, PointsAssetsComponent_ng_template_10_Template, 3, 4, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(12, PointsAssetsComponent_ng_template_12_Template, 3, 5, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(14, PointsAssetsComponent_ng_template_14_Template, 2, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(16, PointsAssetsComponent_ng_template_16_Template, 7, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const type_template_r8 = \u0275\u0275reference(9);
    const price_template_r9 = \u0275\u0275reference(11);
    const bool_template_r10 = \u0275\u0275reference(13);
    const discount_template_r11 = \u0275\u0275reference(15);
    const action_template_r12 = \u0275\u0275reference(17);
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.asset_list)("columns", \u0275\u0275pureFunction6(32, _c6, \u0275\u0275pureFunction1(16, _c02, \u0275\u0275pipeBind1(2, 4, "FORM.NAME")), \u0275\u0275pureFunction2(18, _c12, \u0275\u0275pipeBind1(3, 6, "COMMON.TYPE"), type_template_r8), \u0275\u0275pureFunction2(21, _c2, \u0275\u0275pipeBind1(4, 8, "APP.CONCIERGE.POINTS_PRICE"), price_template_r9), \u0275\u0275pureFunction2(24, _c3, \u0275\u0275pipeBind1(5, 10, "APP.CONCIERGE.POINTS_LABEL"), bool_template_r10), \u0275\u0275pureFunction2(27, _c4, \u0275\u0275pipeBind1(6, 12, "APP.CONCIERGE.POINTS_DISCOUNT"), discount_template_r11), \u0275\u0275pureFunction1(30, _c5, action_template_r12)))("sortable", true)("empty_message", \u0275\u0275pipeBind1(7, 14, "APP.CONCIERGE.POINTS_ASSETS_EMPTY"));
  }
}, dependencies: [
  CommonModule,
  CurrencyPipe,
    ...
    args: [{ selector: "points-assets", template: `
        <div class="absolute inset-0 overflow-auto px-8">
            <simple-table
                ...
                [sortable]="true"
                [empty_message]="
                    'APP.CONCIERGE.POINTS_ASSETS_EMPTY' | translate
                "
            />
            <ng-template #type_template let-data="data">
                <div class="p-2">
                    <span
                        class="rounded bg-base-200 px-2 py-1 text-sm capitalize"
                    >
                        {{ data }}
                    </span>
                </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsAssetsComponent, { className: "PointsAssetsComponent", filePath: "apps/concierge/src/app/points/points-assets.component.ts", lineNumber: 126 });
})();
...
_PointsOverviewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PointsOverviewComponent, selectors: [["points-overview"]], decls: 41, vars: 34, consts: [[1, "px-8"], [1, "mb-4", "w-full", "rounded", "border", "border-base-300", "px-4", "py-3", "text-lg", "font-medium"], [1, "w-full", "bg-base-100"], [1, "p-2", "text-lg", "font-medium", "underline"], [1, "mb-4", "flex", "items-center", "space-x-2", "p-4"], [1, "font-mono"], [1, "w-48", 3, "ngModelChange", "step", "ngModel", "render_fn"], [1, "text-2xl", 3, "matTooltip"], [1, "w-full", "flex-1", "bg-base-100"], [1, "p-4"], [1, "flex", "items-center", "space-x-4", "border-b", "border-base-200", "p-2"], [3, "ngModelChange", "ngModel"], [1, "flex", "items-center", "space-x-4", "p-2"]], template: function PointsOverviewComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(11, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "a-counter", 6);
    \u0275\u0275twoWayListener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_12_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.points.value, $event) || (ctx.points.value = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_12_listener() {
      return ctx.storePoints();
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "icon", 7);
    \u0275\u0275pipe(14, "translate");
    \u0275\u0275text(15, " info ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "section", 8)(17, "h2", 3);
    \u0275\u0275text(18);
    \u0275\u0275pipe(19, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 9)(21, "div", 10)(22, "a-counter", 11);
    \u0275\u0275twoWayListener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_22_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.points.desk_checkin, $event) || (ctx.points.desk_checkin = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_22_listener() {
      return ctx.storePoints();
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(25, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 10)(27, "a-counter", 11);
    \u0275\u0275twoWayListener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_27_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.points.room_checkin, $event) || (ctx.points.room_checkin = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_27_listener() {
      return ctx.storePoints();
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(30, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 10)(32, "a-counter", 11);
    \u0275\u0275twoWayListener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_32_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.points.booking_cancel, $event) || (ctx.points.booking_cancel = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_32_listener() {
      return ctx.storePoints();
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(35, "translate");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "div", 12)(37, "a-counter", 11);
    \u0275\u0275twoWayListener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_37_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.points.wellness_card, $event) || (ctx.points.wellness_card = $event);
      return $event;
    });
    \u0275\u0275listener("ngModelChange", function PointsOverviewComponent_Template_a_counter_ngModelChange_37_listener() {
      return ctx.storePoints();
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 16, "APP.CONCIERGE.POINTS_OVERVIEW_HEADER"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 18, "APP.CONCIERGE.POINTS_VALUE_HEADER"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(11, 20, "APP.CONCIERGE.POINTS_ONE_POINT"), " =");
    \u0275\u0275advance(2);
    \u0275\u0275property("step", 0.1);
    \u0275\u0275twoWayProperty("ngModel", ctx.points.value);
    \u0275\u0275property("render_fn", ctx.renderPrice);
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(14, 22, "APP.CONCIERGE.POINTS_VALUE_INFO"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(19, 24, "APP.CONCIERGE.POINTS_AUTO_REWARDS"), " ");
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx.points.desk_checkin);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 26, "APP.CONCIERGE.POINTS_REWARD_DESK"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx.points.room_checkin);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(30, 28, "APP.CONCIERGE.POINTS_REWARD_ROOM"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx.points.booking_cancel);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(35, 30, "APP.CONCIERGE.POINTS_REWARD_CANCEL"));
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx.points.wellness_card);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(40, 32, "APP.CONCIERGE.POINTS_REWARD_WELLNESS"));
  }
}, dependencies: [
  CounterComponent,
  FormsModule,
            ...
            <section class="w-full bg-base-100">
                ...
                <div class="mb-4 flex items-center space-x-2 p-4">
                    <span class="font-mono"
                        >{{
                            'APP.CONCIERGE.POINTS_ONE_POINT' | translate
                        }}
                        =</span
                    >
                    <a-counter
                    ...
                    <icon
                        class="text-2xl"
                        [matTooltip]="
                            'APP.CONCIERGE.POINTS_VALUE_INFO' | translate
                        "
                    >
                        info
                    </icon>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PointsOverviewComponent, { className: "PointsOverviewComponent", filePath: "apps/concierge/src/app/points/points-overview.component.ts", lineNumber: 111 });
})();
...
//# sourceMappingURL=chunk-CQDCER3X.js.map
