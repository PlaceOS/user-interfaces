import {
  FooterMenuComponent,
  TopbarComponent
} from "./chunk-ZVNJWG33.js";
import "./chunk-LJEOYAHH.js";
...
var DealsService = class _DealsService {
  constructor() {
    ...
    effect(async () => {
      ...
      const { details } = await ju(bld.id, "deals-n-offers").catch(() => ({ details: [] }));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DealsComponent, { className: "DealsComponent", filePath: "apps/workplace/src/app/deals/deals.component.ts", lineNumber: 202 });
})();
...
//# sourceMappingURL=deals.routes-7GV7VV7P.js.map
