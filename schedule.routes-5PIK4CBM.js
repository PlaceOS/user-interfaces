import {
  ...
  StatusPillComponent,
  isSameWeek
} from "./chunk-7QWTI26F.js";
import {
  GroupEventDetailsModalComponent
} from "./chunk-XY3NSOSJ.js";
import {
  VirtualConciergeButtonComponent
} from "./chunk-UMU5PVCC.js";
import {
  takeUntilDestroyed
} from "./chunk-VXRW2YAJ.js";
import {
  MatBottomSheet,
  MatBottomSheetRef
} from "./chunk-UJ4QV5E3.js";
import "./chunk-LMI3OTVY.js";
import "./chunk-FUCJEE4R.js";
import "./chunk-QFII5XAU.js";
import "./chunk-C3VPATXU.js";
import {
  DateCalendarComponent,
  isSameMonth,
  startOfMonth
} from "./chunk-C4LIQUFF.js";
import {
  MatProgressBar,
  MatProgressBarModule,
  subDays
} from "./chunk-FM7OROZ6.js";
import {
  FooterMenuComponent,
  ScheduleStateService,
  TopbarComponent,
  parse
} from "./chunk-I2XEUGEU.js";
import "./chunk-Y5DBTTYX.js";
import "./chunk-6TIK2A6V.js";
import "./chunk-3IBGPMK3.js";
import "./chunk-JNP3PD7G.js";
import {
  MatMenu,
  MatMenuModule,
  MatMenuTrigger
} from "./chunk-AKFH6YTM.js";
import {
  SpacePipe,
  UserPipe,
  setMinutes
} from "./chunk-HPX2XOS2.js";
import "./chunk-FRFVXSRB.js";
import {
  ParkingService
} from "./chunk-M6RF23B5.js";
import "./chunk-MKMOIFSK.js";
import {
...
function ScheduleDayViewComponent_For_20_Conditional_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Booked by ", item_r4.booking.booked_by_name || \u0275\u0275pipeBind1(3, 3, \u0275\u0275pipeBind1(2, 1, item_r4.booking.booked_by_email))?.name || item_r4.booking.booked_by_email, " ");
  }
}
function ScheduleDayViewComponent_For_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(15, ScheduleDayViewComponent_For_20_Conditional_15_Template, 4, 5, "div", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_22_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r4.height > 7 && !item_r4.booking.host && item_r4.booking.user_email !== item_r4.booking.booked_by_email ? 15 : -1);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleDayViewComponent, { className: "ScheduleDayViewComponent", filePath: "apps/workplace/src/app/schedule/schedule-day-view.component.ts", lineNumber: 306 });
})();
...
var ScheduleFilterCardComponent = class _ScheduleFilterCardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleFilterCardComponent, selectors: [["schedule-filter-card"]], inputs: { bookings: [1, "bookings"] }, outputs: { bookings: "bookingsChange" }, decls: 15, vars: 6, consts: [[1, "border-base-200", "mb-4", "flex", "items-center", "space-x-2", "border-b", "text-xl"], ["icon", "", "matRipple", "", 3, "click"], [1, "w-1/2", "flex-1", "text-center"], [1, "border-base-200", "mb-4", "space-y-2", "border-b", "px-4", "pb-4"], [1, "px-4", "pb-4"], ["btn", "", "matRipple", "", "name", "schedule-apply-filter", 1, "w-full", 3, "click"], [3, "ngModel"], [3, "click", "ngModel"], [1, "-my-2", "-ml-2", "flex", "items-center", "space-x-2"], [1, "bg-base-300", "rounded-full", "p-1", "text-2xl"], [1, "flex-1", "font-medium"], [1, "font-mono", "text-xs"]], template: function ScheduleFilterCardComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleFilterCardComponent, { className: "ScheduleFilterCardComponent", filePath: "apps/workplace/src/app/schedule/schedule-filter-card.component.ts", lineNumber: 89 });
})();
...
function ScheduleFiltersComponent_For_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.filters()?.shown_types?.includes(item_r5.type) && ctx_r2.hasFeature(item_r5.feat) ? 0 : -1);
  }
}
var ScheduleFiltersComponent = class _ScheduleFiltersComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleFiltersComponent, selectors: [["schedule-filters"]], inputs: { bookings: [1, "bookings"] }, decls: 11, vars: 0, consts: [[1, "border-base-300", "bg-base-100", "hidden", "border-b", "p-1", "sm:block"], [1, "flex", "flex-wrap"], [1, "border-base-300", "bg-base-100", "flex", "items-center", "space-x-2", "overflow-auto", "border-b", "p-2", "sm:hidden"], ["btn", "", "matRipple", "", "name", "schedule-open-filter-edit", 1, "h-10", "min-h-10", "min-w-10", "sm:min-h-12", "sm:w-24", 3, "click"], [1, "flex", "items-center", "justify-center", "space-x-2"], [1, "text-xl"], [1, "border-base-200", "bg-base-100", "m-0.5", "flex", "items-center", "rounded-3xl", "border", "pl-2", "text-sm"], [1, "px-2"], [1, "bg-base-200", "flex", "h-5", "w-5", "items-center", "justify-center", "rounded-full", "font-mono", "text-[0.625rem]", "opacity-50"], ["icon", "", "matRipple", "", 3, "click", "name"], [1, "border-base-200", "bg-base-100", "flex", "items-center", "rounded-3xl", "border", "pl-2", "text-sm"]], template: function ScheduleFiltersComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275repeaterCreate(9, ScheduleFiltersComponent_For_10_Template, 1, 1, null, null, _forTrack04);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
...
var ScheduleSidebarComponent = class _ScheduleSidebarComponent extends AsyncHandler {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ScheduleSidebarComponent, selectors: [["schedule-sidebar"]], inputs: { bookings: [1, "bookings"], view: [1, "view"] }, features: [\u0275\u0275InheritDefinitionFeature], decls: 10, vars: 6, consts: [[1, "border-base-300", "bg-base-100", "flex", "h-full", "w-[18rem]", "flex-col", "overflow-hidden", "border-r"], [1, "border-base-200", "border-b", 3, "ngModel", "offset_weekday"], [1, "w-full", "p-2"], [1, "mx-4", "mt-4", "pb-2", "font-medium", "uppercase"], [1, "h-1/2", "flex-1", "space-y-1", "overflow-auto", "px-4"], [1, "border-base-200", "border-b", 3, "ngModelChange", "ngModel", "offset_weekday"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["placeholder", "Select Week...", 3, "ngModelChange", "ngModel"], [1, "leading-tight", 3, "value"], [1, "text-info", "px-1", "text-xs", 3, "matTooltip"], [1, "border-base-200", "border-b", "p-2", 3, "startChange", "endChange", "from", "start", "end", "offset_weekday"], [1, "bg-info", "text-info-content", "m-2", "w-[calc(100%-1rem)]", "rounded", "p-1", "text-center", "text-xs"], [3, "ngModel"], [3, "click", "ngModel"], [1, "-my-2", "-ml-2", "flex", "items-center", "space-x-2"], [1, "bg-base-300", "rounded-full", "p-1", "text-2xl"], [1, "flex-1", "font-medium"], [1, "font-mono", "text-xs"]], template: function ScheduleSidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleSidebarComponent, { className: "ScheduleSidebarComponent", filePath: "apps/workplace/src/app/schedule/schedule-sidebar.component.ts", lineNumber: 161 });
})();
...
function ScheduleWeekViewComponent_For_7_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("matTooltip", bkn_r4.title + (ctx_r1.location(bkn_r4) ? "\n" + ctx_r1.location(bkn_r4) : "") + (ctx_r1.visitorName(bkn_r4) ? "\n" + ctx_r1.visitorName(bkn_r4) : "") + "\n" + (bkn_r4.user_name || \u0275\u0275pipeBind1(2, 12, \u0275\u0275pipeBind1(1, 10, bkn_r4.host))?.name || bkn_r4.host) + "\n" + \u0275\u0275pipeBind2(3, 14, bkn_r4.date, "shortTime") + " - " + \u0275\u0275pipeBind2(4, 17, bkn_r4.date_end, "shortTime"));
    \u0275\u0275advance(7);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(13, 20, bkn_r4.date, "shortTime"), " ");
  }
}
...
function ScheduleWeekViewComponent_For_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ScheduleWeekViewComponent_For_7_For_2_Template, 14, 23, "button", 10, _forTrack07);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ScheduleWeekViewComponent, { className: "ScheduleWeekViewComponent", filePath: "apps/workplace/src/app/schedule/schedule-week-view.component.ts", lineNumber: 189 });
})();
...
//# sourceMappingURL=schedule.routes-5PIK4CBM.js.map
