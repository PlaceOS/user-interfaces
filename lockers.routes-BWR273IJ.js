...
} from "./chunk-RGLL5HA2.js";
import {
  BookingRulesModalComponent
} from "./chunk-MAAQ7NLC.js";
import "./chunk-WV5CBWEF.js";
import {
  loadPersistedZones,
  persistZones
...
var SelectUserModalComponent = class _SelectUserModalComponent {
  constructor() {
    ...
    this._users = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_users" } : (
      ...
      loader: ({ params: { q } }) => Ja({ q }).then((o) => o.data.map((u) => new StaffUser(u))).catch(() => [])
    }));
    this.users = computed(
      () => this._users.value() ?? [],
...
//# sourceMappingURL=lockers.routes-BWR273IJ.js.map
