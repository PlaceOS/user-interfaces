...
_DateOptionsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DateOptionsComponent, selectors: [["date-options"]], inputs: { is_new: [1, "is_new"], disabled: [1, "disabled"], week_start: [1, "week_start"], date: [1, "date"], step: [1, "step"], hide_today: [1, "hide_today"] }, outputs: { date: "dateChange", dateChange: "dateChange" }, features: [\u0275\u0275InheritDefinitionFeature, \u0275\u0275NgOnChangesFeature], decls: 14, vars: 11, consts: [["calendar_picker", ""], ["icon", "", "matRipple", "", "customTooltip", "", "yPosition", "top", 1, "relative", "rounded-sm", 3, "content", "pointer-events-none", "opacity-30"], ["icon", "", "matRipple", "", 1, "rounded-sm", "hover:bg-base-200", 3, "click"], ["icon", "", "matRipple", "", 1, "rounded-sm", "hover:bg-base-200"], ["matRipple", "", 1, "display", "relative", "mx-4", "flex", "h-12", "w-28", "items-center", "justify-center", "rounded-sm", "leading-none", "hover:bg-base-200", 3, "dblclick"], [1, "absolute", "left-1/2", "top-1", "-translate-x-1/2", "text-xs", "text-info"], [1, "relative"], ["icon", "", "matRipple", "", "customTooltip", "", "yPosition", "top", 1, "relative", "rounded-sm", "border", "border-base-200", 3, "content", "pointer-events-none", "opacity-30"], ["icon", "", "matRipple", "", "customTooltip", "", "yPosition", "top", 1, "relative", "rounded-sm", 3, "content"], ["icon", "", "matRipple", "", "customTooltip", "", "yPosition", "top", 1, "relative", "rounded-sm", "border", "border-base-200", 3, "content"], [1, "relative", "w-76", "rounded-sm", "bg-base-100", "px-2", "py-4"], [3, "ngModelChange", "ngModel", "offset_weekday"]], template: function DateOptionsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-6PAIEHXO.js.map
