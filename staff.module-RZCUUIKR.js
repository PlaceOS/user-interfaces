...
var EmergencyContactsService = class _EmergencyContactsService {
  constructor() {
    ...
    this.category$ = combineLatest([
      ...
      this._change
    ]).pipe(filter(([bld]) => !!bld), switchMap(([bld]) => from(el({ zone_id: bld.id })).pipe(map((_) => _.data), catchError(() => of([])))), map((categories) => categories.find((c) => c.name === EMERGENCY_CONTACTS_CATEGORY_NAME) || null), shareReplay(1));
    this.assetType$ = combineLatest([
      ...
      if (!category)
        return of(null);
      return from(Zh({ zone_id: bld.id, q: category.name })).pipe(map((_) => _.data), catchError(() => of([])), map((groups) => groups.find((g) => g.name === EMERGENCY_CONTACTS_CATEGORY_NAME && g.category_id === category.id) || null));
    }), shareReplay(1));
    this.contacts$ = combineLatest([
      ...
      return queryAssets({
        ...
        limit: 200
      }).pipe(map((_) => _.data), catchError(() => of([])), map((assets) => assets.filter((a) => a.asset_type_id === assetType.id).map((a) => this.assetToContact(a))));
    }), shareReplay(1));
    ...
    this.legacyMetadata$ = this._org.active_building.pipe(filter((bld) => !!bld), switchMap((bld) => from(Fu(bld.id, "emergency_contacts")).pipe(catchError(() => of({ details: { contacts: [], roles: [] } })))), map(({ details }) => details || {
      contacts: [],
      roles: []
    }), shareReplay(1));
  ...
  async ensureCategoryExists() {
    ...
    if (!bld)
      return null;
    const categories = await firstValueFrom(from(el({ zone_id: bld.id })).pipe(map((_) => _.data), catchError(() => of([]))));
    const existing = categories.find((c) => c.name === EMERGENCY_CONTACTS_CATEGORY_NAME);
    if (existing)
      return existing;
    try {
      const new_category = await firstValueFrom(saveAssetCategory(Js(new ir({
  ...
  async ensureAssetTypeExists(category) {
    ...
    if (!bld || !category)
      return null;
    const groups = await firstValueFrom(from(Zh({ zone_id: bld.id, q: category.name })).pipe(map((_) => _.data), catchError(() => of([]))));
    const existing = groups.find((g) => g.name === EMERGENCY_CONTACTS_CATEGORY_NAME && g.category_id === category.id);
    if (existing)
      return existing;
    try {
      const new_group = await firstValueFrom(saveAssetType({
        name: EMERGENCY_CONTACTS_CATEGORY_NAME,
  ...
  async migrateFromMetadata() {
    ...
    try {
      ...
      if (legacy_data.roles?.length) {
        await firstValueFrom(saveAssetCategory(Js(new ir(__spreadProps(__spreadValues({}, category), {
          hidden: true,
  ...
  async updateRoles(roles) {
    try {
      ...
      await firstValueFrom(saveAssetCategory(new ir(__spreadProps(__spreadValues({}, category), {
        description: JSON.stringify({ roles })
      }))));
      this._change.next(Date.now());
      return true;
...
function EmergencyContactModalComponent_Conditional_5_For_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, EmergencyContactModalComponent_Conditional_5_For_45_Conditional_0_Template, 2, 2, "mat-option", 21);
  }
  if (rf & 2) {
...
function EmergencyContactModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(39, 30, "APP.CONCIERGE.CONTACTS_ROLES"));
    \u0275\u0275advance(4);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(43, 32, "APP.CONCIERGE.CONTACTS_ROLES_SELECT"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.roles());
    \u0275\u0275advance(2);
    \u0275\u0275property("content", role_form_r5);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(51, 34, "APP.CONCIERGE.CONTACTS_ROLES_ADD"), " ");
  }
}
...
var EmergencyContactModalComponent = class _EmergencyContactModalComponent {
  constructor() {
    ...
    this.role_name = signal("", ...ngDevMode ? [{ debugName: "role_name" }] : (
      /* istanbul ignore next */
      []
    ));
    this.contact = this._data;
    this.roles = toSignal(this._contacts_service.roles$, {
      initialValue: []
    });
    ...
    this._tooltip = viewChild(CustomTooltipComponent, ...ngDevMode ? [{ debugName: "_tooltip" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmergencyContactModalComponent, selectors: [["emergency-contact-modal"]], viewQuery: function EmergencyContactModalComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(5, EmergencyContactModalComponent_Conditional_5_Template, 52, 37, "main", 4)(6, EmergencyContactModalComponent_Conditional_6_Template, 5, 4, "main", 5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmergencyContactModalComponent, { className: "EmergencyContactModalComponent", filePath: "apps/concierge/src/app/staff/emergency-contact-modal.component.ts", lineNumber: 219 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoleManagementModalComponent, { className: "RoleManagementModalComponent", filePath: "apps/concierge/src/app/staff/role-management-modal.component.ts", lineNumber: 101 });
})();
...
var _c2 = (a0, a1) => ({ key: "roles", name: a0, content: a1, sortable: false });
var _c3 = (a0, a1) => ({ key: "zone", name: a0, content: a1, sortable: false });
...
var EmergencyContactsComponent = class _EmergencyContactsComponent {
  constructor() {
    ...
    this._contacts_service = inject(EmergencyContactsService);
    this.search = "";
    this.role_filter = signal("", ...ngDevMode ? [{ debugName: "role_filter" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.contacts = toSignal(this._contacts_service.contacts$, {
      initialValue: []
    });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmergencyContactsComponent, selectors: [["", "app-emergency-contacts", ""]], attrs: _c02, decls: 50, vars: 49, consts: [["person_template", ""], ["roles_template", ""], ["zone_template", ""], ["actions_template", ""], [1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], ["topbar", "", 1, "flex", "flex-col", "px-8", "py-4"], [1, "flex", "items-center", "justify-between"], [1, "text-2xl", "font-medium"], [1, "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", 3, "ngModelChange", "ngModel", "placeholder"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click"], [1, "text-2xl"], [1, "pr-2"], [1, "mt-2", "flex", "items-center", "justify-between", "py-2"], [3, "ngModelChange", "ngModel", "placeholder"], ["value", ""], [3, "value"], ["icon", "", "default", "", "matRipple", "", 3, "click", "matTooltip"], [1, "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "block", "min-w-208", "text-sm", 3, "data", "filter", "empty_message", "columns", "sortable"], [1, "h-12", "w-full"], [1, "px-4", "py-2", "text-left", "leading-tight", 3, "click"], [1, ""], [1, "font-mono", "text-[0.625rem]", "opacity-30"], [1, "flex", "flex-wrap", "p-2"], [1, "bg-info", "text-info-content", "m-1", "rounded-2xl", "px-2", "py-1", "font-mono", "text-xs"], [1, "p-4"], [1, "flex", "w-full", "items-center", "justify-end", "space-x-2", "p-2"], ["icon", "", "matRipple", "", 3, "click", "matTooltip"], ["icon", "", "matRipple", "", 1, "text-error", 3, "click", "matTooltip"]], template: function EmergencyContactsComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(5);
        \u0275\u0275property("data", ctx.filtered_contacts())("filter", ctx.search)("empty_message", \u0275\u0275pipeBind1(37, 25, ctx.search ? "APP.CONCIERGE.CONTACTS_SEARCH_EMPTY" : "APP.CONCIERGE.CONTACTS_EMPTY"))("columns", \u0275\u0275pureFunction4(44, _c5, \u0275\u0275pureFunction2(33, _c1, \u0275\u0275pipeBind1(38, 27, "COMMON.PERSON"), person_template_r11), \u0275\u0275pureFunction2(36, _c2, \u0275\u0275pipeBind1(39, 29, "APP.CONCIERGE.CONTACTS_ROLES"), roles_template_r12), \u0275\u0275pureFunction2(39, _c3, \u0275\u0275pipeBind1(40, 31, "RESOURCE.LEVEL"), zone_template_r13), \u0275\u0275pureFunction1(42, _c4, actions_template_r14)))("sortable", true);
      }
    }, dependencies: [
      MatRippleModule,
      MatRipple,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmergencyContactsComponent, { className: "EmergencyContactsComponent", filePath: "apps/concierge/src/app/staff/emergency-contacts.component.ts", lineNumber: 237 });
})();
...
var StaffDetailsComponent = class _StaffDetailsComponent {
  constructor() {
    ...
    this.user = input(void 0, ...ngDevMode ? [{ debugName: "user" }] : (
      /* istanbul ignore next */
      []
    ));
    this.onsite = input(void 0, ...ngDevMode ? [{ debugName: "onsite" }] : (
      /* istanbul ignore next */
      []
    ));
    this.loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : (
...
var StaffListingComponent = class _StaffListingComponent extends AsyncHandler {
  constructor() {
    super();
    this._state = inject(StaffStateService);
    this.active_group = signal("#", ...ngDevMode ? [{ debugName: "active_group" }] : (
      /* istanbul ignore next */
      []
    ));
    this.groups = CHARS;
    this.events = toSignal(this._state.user_events || of({}), {
      initialValue: {}
    });
    this.loading = toSignal(this._state.loading || of(false), {
      initialValue: false
    });
    this.filtered_users = toSignal(this._state.filtered_users || of([]), {
      initialValue: []
    });
    this.user_count = computed(() => this.filtered_users().length, ...ngDevMode ? [{ debugName: "user_count" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this._el = viewChild("container", ...ngDevMode ? [{ debugName: "_el" }] : (
      /* istanbul ignore next */
      []
    ));
    effect(() => {
  ...
  onScroll(_) {
    ...
    for (const group of CHARS) {
      const el2 = document.querySelector(`#letter-${group === "#" ? "0" : group}`);
      if (el2) {
        if (el2.offsetTop - scroll_top > 0) {
          break;
        }
  ...
  scrollTo(group) {
    const el2 = document.querySelector(`#letter-${group}-0`);
    if (el2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffListingComponent, { className: "StaffListingComponent", filePath: "apps/concierge/src/app/staff/staff-listing.component.ts", lineNumber: 116 });
})();
...
var StaffTopbarComponent = class _StaffTopbarComponent extends AsyncHandler {
  constructor() {
    ...
    this.levels = signal([], ...ngDevMode ? [{ debugName: "levels" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  async ngOnInit() {
    ...
    if (this._state.filters?.subscribe) {
      this.subscription("filters", this._state.filters.subscribe((filters) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffTopbarComponent, selectors: [["staff-topbar"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 12, vars: 8, consts: [[1, "border-base-200", "bg-base-100", "flex", "items-center", "space-x-4", "border-b", "p-4"], ["appearance", "outline", 1, "no-subscript", "w-48"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [1, "m-2", 3, "ngModelChange", "ngModel"], [1, "text-xs"], [1, "w-2", "flex-1"], [1, "mr-2", 3, "modelChange"]], template: function StaffTopbarComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("ngModel", (tmp_3_0 = ctx.filters()) == null ? null : tmp_3_0.only_onsite);
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffTopbarComponent, { className: "StaffTopbarComponent", filePath: "apps/concierge/src/app/staff/staff-topbar.component.ts", lineNumber: 66 });
})();

// apps/concierge/src/app/staff/staff.component.ts
var _c05 = ["app-new-staff", ""];
...
var StaffComponent = class _StaffComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaffComponent, selectors: [["", "app-new-staff", ""]], attrs: _c05, decls: 7, vars: 1, consts: [[1, "flex", "h-px", "flex-1"], [1, "flex", "h-full", "w-1/2", "flex-1", "flex-col"], [1, "w-full"], [1, "h-0", "w-full", "flex-1"], ["mode", "indeterminate", 1, "w-full"]], template: function StaffComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "app-topbar");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaffComponent, { className: "StaffComponent", filePath: "apps/concierge/src/app/staff/staff.component.ts", lineNumber: 48 });
})();
...
//# sourceMappingURL=staff.module-RZCUUIKR.js.map
