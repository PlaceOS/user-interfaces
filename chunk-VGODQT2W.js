...
function TemplateMappingsComponent_Conditional_13_For_2_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, TemplateMappingsComponent_Conditional_13_For_2_For_5_Conditional_1_Template, 2, 0, "icon", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TemplateMappingsComponent_Conditional_13_For_2_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const card_r3 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c1, ctx))("queryParams", \u0275\u0275pureFunction0(5, _c2));
    \u0275\u0275advance();
...
function TemplateMappingsComponent_Conditional_13_For_2_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 23)(1, "button", 10);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275pipe(3, "translate");
    ...
    \u0275\u0275text(5, "edit");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(6, TemplateMappingsComponent_Conditional_13_For_2_Conditional_14_Conditional_6_Template, 5, 6, "button", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const card_r3 = \u0275\u0275nextContext().$implicit;
...
function TemplateMappingsComponent_Conditional_13_For_2_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "span", 34);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "translate");
    \u0275\u0275elementEnd()();
  }
...
function TemplateMappingsComponent_Conditional_13_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, TemplateMappingsComponent_Conditional_13_For_2_Conditional_12_Template, 5, 6, "div", 21);
    \u0275\u0275conditionalCreate(13, TemplateMappingsComponent_Conditional_13_For_2_Conditional_13_Template, 2, 1, "p", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(14, TemplateMappingsComponent_Conditional_13_For_2_Conditional_14_Template, 7, 7, "div", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(15, TemplateMappingsComponent_Conditional_13_For_2_Conditional_15_Template, 6, 5, "div", 24)(16, TemplateMappingsComponent_Conditional_13_For_2_Conditional_16_Template, 4, 3, "div", 25);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_12_0;
...
function TemplateMappingsComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, TemplateMappingsComponent_Conditional_13_For_2_Template, 17, 13, "article", 12, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function TemplateMappingsComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "icon", 35);
    \u0275\u0275text(2, "dashboard");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4);
...
var TemplateMappingsComponent = class _TemplateMappingsComponent {
  constructor() {
    ...
    this.mapping_cards = computed(
      () => {
        const zone_names = new Map(this._service.all_zones().map((zone) => [
          zone.id,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TemplateMappingsComponent, { className: "TemplateMappingsComponent", filePath: "apps/signage-manager/src/app/shared/template-mappings.component.ts", lineNumber: 321 });
})();

export {
  TemplateMappingsComponent
};
//# debugId=42f33243-b9a0-51cd-b3d5-200b2bc812dc
//# sourceMappingURL=chunk-VGODQT2W.js.map
