...
])], decls: 4, vars: 4, consts: [["icon", "", "matRipple", "", 1, "h-12", "w-12", "overflow-hidden", "rounded", "bg-secondary", "text-secondary-content", 3, "disabled", "title"], ["type", "file", 1, "absolute", "inset-0", "cursor-pointer", "opacity-0", 3, "change"], ["diameter", "32", 3, "mode", "value"]], template: function UploadButtonComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-ZA35KNNU.js.map
