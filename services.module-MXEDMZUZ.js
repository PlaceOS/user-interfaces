...
_ServiceFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceFormComponent, selectors: [["service-form"]], decls: 72, vars: 7, consts: [[1, "bg-base-100", "absolute", "inset-0", "overflow-auto"], [1, "bg-base-200", "sticky", "top-0", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "items-center", "justify-between", "rounded", "px-4", "py-2"], [1, "text-xl", "font-medium"], ["icon", "", "matRipple", "", 1, "flex", "h-10", "w-10", "items-center", "justify-center", "rounded-full", 3, "routerLink"], [1, "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "flex-col", "gap-1", "px-4", "pb-20", 3, "formGroup"], [1, "text-sm", "font-medium"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "formControlName", "name", "placeholder", "Service name"], ["formControlName", "category", "placeholder", "Select category"], ["value", "package"], ["value", "alacarte"], ["value", "addon"], ["value", "space"], ["matInput", "", "formControlName", "space", "placeholder", "e.g. Auditorium and Lobby"], ["matInput", "", "formControlName", "duration", "placeholder", "e.g. Up to 4 hours"], ["matInput", "", "formControlName", "description", "placeholder", "Service description", "rows", "3"], [1, "grid", "grid-cols-2", "gap-4"], ["matInput", "", "formControlName", "internal_price", "placeholder", "e.g. $719"], ["matInput", "", "formControlName", "external_price", "placeholder", "e.g. $990.94"], ["matInput", "", "type", "number", "formControlName", "refund_lead_days", "placeholder", "e.g. 7"], ["matInput", "", "formControlName", "icon", "placeholder", "e.g. groups, school, meeting_room"], [1, "bg-base-200", "fixed", "bottom-0", "left-1/2", "z-10", "mx-auto", "my-2", "flex", "w-full", "max-w-[640px]", "-translate-x-1/2", "items-center", "justify-end", "gap-2", "rounded", "px-4", "py-2"], ["matRipple", "", 1, "bg-base-300", "hover:bg-base-content/20", "rounded", "px-6", "py-2", "text-sm", "font-medium", 3, "routerLink"], ["matRipple", "", 1, "bg-primary", "text-primary-content", "rounded", "px-6", "py-2", "text-sm", "font-medium", 3, "click"]], template: function ServiceFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(56, " Refund Lead Time (days) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "mat-form-field", 6);
    \u0275\u0275element(58, "input", 19);
    \u0275\u0275elementStart(59, "mat-hint");
    \u0275\u0275text(60, " Days before event date when refund cutoff applies ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "label", 5);
    \u0275\u0275text(62, "Icon");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "mat-form-field", 6);
    \u0275\u0275element(64, "input", 20);
    \u0275\u0275elementStart(65, "mat-hint");
    \u0275\u0275text(66, " Use underscores, e.g. meeting_room not meeting room ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(67, "footer", 21)(68, "a", 22);
    \u0275\u0275text(69, " Cancel ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "button", 23);
    \u0275\u0275listener("click", function ServiceFormComponent_Template_button_click_70_listener() {
      return ctx.save();
    });
    \u0275\u0275text(71);
    \u0275\u0275elementEnd()()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServiceFormComponent, { className: "ServiceFormComponent", filePath: "apps/concierge/src/app/services/service-form.component.ts", lineNumber: 185 });
})();
...
//# sourceMappingURL=services.module-MXEDMZUZ.js.map
