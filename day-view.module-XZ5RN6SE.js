import {
  EventsStateService
} from "./chunk-2DVKNKGY.js";
import "./chunk-FH5HNXXQ.js";
import "./chunk-JF23LPCO.js";
import "./chunk-6ZGQ6MJF.js";
...
_RoomBookingsApprovalsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsApprovalsComponent, selectors: [["room-bookings-approvals"]], decls: 25, vars: 29, consts: [["menu", "matMenu"], [1, "flex", "h-full", "w-[20rem]", "flex-col", "overflow-hidden", "border-l", "border-base-300"], [1, "relative", "flex", "items-center", "justify-center", "space-x-2", "border-b", "border-base-200", "p-2"], ["btn", "", "icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "left-2", "top-3", "bg-base-200", 3, "click", "matTooltip"], [1, "flex-1", "py-3", "text-center"], [1, "relative", "-mt-px", "border-b", "border-base-300"], ["type", "text", 1, "w-full", "py-4", "pl-10", "pr-4", 3, "ngModelChange", "placeholder", "ngModel"], [1, "pointer-events-none", "absolute", "left-2", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "flex-1", "space-y-1", "overflow-auto", "bg-base-200", "p-1"], [1, "flex", "h-full", "w-full", "flex-col", "items-center", "justify-center", "space-y-2"], [1, "relative", "w-full", "rounded-lg", "border", "border-base-300", "bg-base-100", "p-2"], [1, "absolute", "bottom-0", "left-0", "right-0", "top-14", "flex", "flex-col", "items-center", "justify-center", "space-y-2", "p-2"], ["btn", "", "icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "-left-8", "top-3", "bg-warning", "text-warning-content", "shadow-sm", 3, "matTooltip"], ["src", "assets/icons/no-pending.svg"], [1, "opacity-30"], ["matTooltip", "Recurring Series", "matTooltipPosition", "left", 1, "absolute", "right-2", "top-3", "text-2xl"], [1, "font-medium"], [1, "mb-2", "text-xs", "opacity-30"], [1, "mb-2", "h-32", "w-full", "overflow-hidden", "rounded-sm", "bg-base-200"], [1, "mb-2", "border-base-300", "bg-base-200"], [1, "mb-2", "flex", "items-center", "space-x-2"], [1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "bg-base-200"], [1, "text-xl"], [1, "flex-1"], [1, "text-sm"], [1, "text-xs", "opacity-50"], [1, "flex-1", "text-sm"], [1, "flex", "items-center", "space-x-2"], ["btn", "", "matRipple", "", 1, "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "border-success", "bg-success-light", "text-black", 3, "click", "disabled"], [1, "ml-2"], [1, "text-2xl", "text-success"], ["btn", "", "matRipple", "", 1, "flex", "min-w-0", "flex-1", "items-center", "space-x-1", "border-error", "bg-error-light", "text-black", 3, "click", "disabled"], [1, "text-2xl", "text-error"], ["auth", "", 1, "min-h-full", "min-w-full", "object-cover", "object-center", 3, "source"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded-md", "border", "border-base-300", "bg-base-200", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "click"], [1, "flex", "items-center", "space-x-2", "pr-4"], [1, "absolute", "inset-0", "z-0", "bg-base-100", "opacity-80"], ["diameter", "32"], [1, "relative", "z-10"], ["btn", "", "icon", "", "matRipple", "", "matTooltipPosition", "left", 1, "absolute", "-left-8", "top-3", "bg-warning", "text-warning-content", "shadow-sm", 3, "click", "matTooltip"]], template: function RoomBookingsApprovalsComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, outputs: { selected: "selected" }, features: [\u0275\u0275InheritDefinitionFeature], decls: 9, vars: 10, consts: [["input_el", ""], [1, "relative"], ["icon", "", "matRipple", "", 3, "click"], [1, "absolute", "right-0", "top-1/2", "w-[20rem]", "-translate-y-1/2", "rounded-full", "border", "border-base-300", "bg-base-100", "py-3", "pl-10", "pr-4", "shadow-sm", 3, "ngModelChange", "blur", "ngModel", "placeholder"], [1, "absolute", "right-70", "top-1/2", "-translate-y-1/2", "text-2xl"], [1, "absolute", "right-4", "top-full", "max-h-[65vh]", "w-[18rem]", "translate-y-2", "overflow-auto", "rounded-sm", "border", "border-base-300", "bg-base-100", "shadow-sm"], [1, "sticky", "top-0", "z-10", "rounded-sm", "bg-base-100", "p-4"], [1, "text-xs", "opacity-60"], [1, "flex", "items-center", "justify-center", "p-4", "text-center", "text-sm", "opacity-30"], [1, "-mt-2", "px-2", "pb-2"], ["matRipple", "", 1, "relative", "z-0", "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "p-2", "text-left", "hover:bg-base-200"], ["matRipple", "", 1, "relative", "z-0", "flex", "w-full", "items-center", "space-x-2", "rounded-sm", "p-2", "text-left", "hover:bg-base-200", 3, "click"], [1, "h-10", "w-1", "rounded-full"], ["date", "", 1, "leading-tight"], [1, "mx-auto", "text-2xl"], [1, "mx-auto", "-mt-1", "text-sm", "font-medium", "uppercase"], [1, "w-1/2", "flex-1"], [1, "flex", "w-full", "items-center", "space-x-2"], [1, "flex-1", "truncate", "text-sm"], [1, "truncate", "text-xs", "opacity-30"]], template: function RoomBookingSearchComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
...
_RoomBookingsTimelineComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsTimelineComponent, selectors: [["room-bookings-timeline"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 37, vars: 34, consts: [[1, "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "bg-info", "p-2", "text-center", "text-xs", "text-info-content"], [1, "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "border-base-200", "p-2"], [3, "dateChange", "date", "is_new", "hide_today"], [1, "absolute", "left-4", "top-1/2", "-translate-y-1/2", "text-sm", "text-info"], [1, "absolute", "right-8", "top-1/2", "-translate-y-1/2"], [3, "selected"], ["timeline", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["timezone", "", 1, "sticky", "left-0", "top-0", "z-30", "flex", "items-center", "justify-center", "bg-base-100"], [1, "text-xs", "opacity-30"], [1, "absolute", "bottom-0", "right-0", "h-2", "w-px", "bg-base-300"], [1, "absolute", "bottom-0", "right-0", "h-px", "w-2", "bg-base-300"], ["space-headers", "", 1, "sticky", "top-0", "z-20", "flex", "items-center", "border-b", "border-base-300", "bg-base-100"], [1, "relative", "flex", "h-full", "w-56", "items-center", "justify-center", "px-4"], ["hour-blocks", "", 1, "sticky", "left-0", "z-10", "overflow-visible", "border-r", "border-base-300", "bg-base-100"], [1, "relative", "w-full", 3, "height"], [1, "absolute", "right-0", "h-2", "w-2", "-translate-y-1/2", "translate-x-1/2", "rounded-full", "bg-secondary", 3, "top"], ["space-blocks", "", 1, "relative", "overflow-hidden"], [1, "relative", "w-full", "border-b", "border-base-200", 3, "height"], [1, "absolute", "top-0", "h-full", "w-px", "bg-base-200", 3, "left"], [1, "absolute", "inset-x-0", "h-[2px]", "bg-secondary", 3, "top"], [1, "truncate", "px-4"], [1, "absolute", "-left-px", "bottom-0", "h-2", "w-px", "bg-base-300"], [1, "relative", "w-full"], [1, "absolute", "-top-px", "right-0", "h-px", "w-2", "bg-base-300"], [1, "absolute", "-top-px", "right-3", "-translate-y-1/2", "text-xs", "opacity-60"], [1, "absolute", "right-0", "h-2", "w-2", "-translate-y-1/2", "translate-x-1/2", "rounded-full", "bg-secondary"], [1, "relative", "w-full", "border-b", "border-base-200"], [1, "absolute", "top-0", "h-full", "w-px", "bg-base-200"], ["event", "", "matRipple", "", 1, "absolute", "w-52", "text-left", "hover:opacity-90", 3, "left", "top", "height", "matTooltip"], ["event", "", "matRipple", "", 1, "absolute", "w-52", "text-left", "hover:opacity-90", 3, "click", "matTooltip"], [1, "relative", "h-full", "w-full", "overflow-hidden", "rounded-lg", "border", "border-base-200", "bg-base-100", "px-3", "py-1", "text-xs", "shadow-sm", "hover:bg-base-200"], [1, "absolute", "-inset-px", "bg-secondary", "opacity-30"], [1, "absolute", "inset-y-0", "left-0", "w-1"], [1, "truncate"], [1, "absolute", "inset-x-0", "h-[2px]", "bg-secondary"]], template: function RoomBookingsTimelineComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_RoomWeekBookingsTimelineComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomWeekBookingsTimelineComponent, selectors: [["room-week-bookings-timeline"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 29, vars: 35, consts: [[1, "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "bg-info", "p-2", "text-center", "text-xs", "text-info-content"], [1, "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "border-base-200", "p-2"], [3, "dateChange", "date", "step", "is_new", "hide_today"], [1, "absolute", "left-4", "top-1/2", "-translate-y-1/2", "text-sm", "text-info"], [1, "absolute", "right-8", "top-1/2", "-translate-y-1/2"], [3, "selected"], ["timeline", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["timezone", "", 1, "sticky", "left-0", "top-0", "z-30", "flex", "items-center", "justify-center", "bg-base-100"], [1, "text-xs", "opacity-30"], [1, "absolute", "bottom-0", "right-0", "h-2", "w-px", "bg-base-300"], [1, "absolute", "bottom-0", "right-0", "h-px", "w-2", "bg-base-300"], ["day-headers", "", 1, "sticky", "top-0", "z-20", "flex", "min-w-[calc(100%-3rem)]", "items-center", "border-b", "border-base-300", "bg-base-100"], [1, "relative", "flex", "h-full", "min-w-48", "flex-1", "flex-col", "items-center", "justify-center", "leading-tight"], ["empty-block", "", 1, "sticky", "left-0", "z-10", "min-h-full", "border-r", "border-base-300", "bg-base-100"], ["date-blocks", "", 1, "relative", "flex", "min-w-[calc(100%-3rem)]", "overflow-hidden"], [1, "min-w-48", "flex-1", "overflow-hidden", "border-r", "border-base-200", "p-2"], [1, "truncate"], [1, "absolute", "bottom-1", "left-1/2", "-translate-x-1/2", "text-xs", "text-info"], [1, "absolute", "-left-px", "bottom-0", "h-2", "w-px", "bg-base-300"], ["matRipple", "", 1, "flex", "w-full", "space-x-2", "rounded-sm", "p-2", "text-left", "hover:bg-base-200"], ["matRipple", "", 1, "flex", "w-full", "space-x-2", "rounded-sm", "p-2", "text-left", "hover:bg-base-200", 3, "click"], [1, "my-1.5", "h-2", "w-2", "rounded-full"], [1, "w-1/2", "flex-1"], [1, "truncate", "text-sm"], [1, "flex-1", "text-xs", "opacity-60"], [1, "truncate", "text-xs", "opacity-30"]], template: function RoomWeekBookingsTimelineComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_RoomBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsComponent, selectors: [["room-bookings"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 52, vars: 34, consts: [["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden", "pl-8"], [1, "flex", "w-full", "items-center", "space-x-4", "py-4", "pr-8"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "day"], ["value", "week"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click"], [1, "pl-2"], [1, "text-2xl"], [1, "flex", "w-full", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "ngModel"], [1, "flex", "flex-1", "justify-end", "pr-2"], [1, "flex", "max-w-lg", "flex-1", "items-center", "rounded-full", "border", "border-base-300"], [1, "flex", "w-px", "flex-1", "items-center", "space-x-1", "overflow-x-auto", "rounded-l-full", "px-1"], ["btn", "", "matRipple", "", 1, "inverse", "bg-base-100", 3, "matMenuTriggerFor"], [1, "mx-2"], [1, ""], [1, "flex", "w-48", "flex-col", "space-y-2", "overflow-hidden"], [1, "mt-4", "flex", "h-px", "w-full", "flex-1", "border-t", "border-base-200"], [1, "relative", "z-0", "w-1/2", "flex-1"], [1, "relative", "z-10"], [1, "flex", "flex-col-reverse"], [1, "text-xs", "opacity-30"], [1, "opacity-0"], [1, "flex", "items-center", "rounded-full", "border", "border-base-300"], [1, "m-2", "h-4", "w-4", "rounded-full"], [1, "truncate", "text-sm"], ["icon", "", "matRipple", "", 1, "text-base-300", "hover:text-base-content", 3, "click"], [1, "text-xl"]], template: function RoomBookingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsComponent, { className: "RoomBookingsComponent", filePath: "apps/concierge/src/app/day-view/room-bookings.component.ts", lineNumber: 192 });
})();
...
//# sourceMappingURL=day-view.module-XZ5RN6SE.js.map
