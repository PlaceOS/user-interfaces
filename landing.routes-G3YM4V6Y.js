import {
  FAV_LOCKER_KEY
} from "./chunk-6SJSURGD.js";
import "./chunk-CFFGOHVA.js";
import {
  BookingCardComponent,
  EventCardComponent
} from "./chunk-OFU2I5KU.js";
import "./chunk-L74QVXPC.js";
import {
  FAV_DESK_KEY
} from "./chunk-W6DJE52W.js";
import {
  LevelPipe
} from "./chunk-FXNHTIGR.js";
import "./chunk-ARANS6QM.js";
import "./chunk-RFNRR45U.js";
import {
  FAV_PARKING_KEY
} from "./chunk-YOYILDUA.js";
import "./chunk-NR5OGRIG.js";
import "./chunk-QYD75NKZ.js";
import {
  BookingFormService
...
import "./chunk-HOIF25TY.js";
import "./chunk-CDKBW3NC.js";
...
var LandingStateService = class _LandingStateService extends AsyncHandler {
  constructor() {
    ...
    this.search_fn = async (q) => this._settings.get("app.basic_user_search") || this._settings.get("app.colleagues_require_auth") !== false ? La({ q, authority_id: It()?.id }).then(({ data }) => data.map((_) => new StaffUser(_))) : searchStaff(q);
    ...
    effect((onCleanup) => {
      ...
      for (const [idx, space] of list.entries()) {
        const binding = gd(space.id, "Bookings").variable("status");
  ...
  async updateContacts() {
    ...
    const users = await Promise.all(list.map((_) => ja(_.email).catch(() => _)));
...
//# debugId=2a39dc69-da32-53ee-8b84-986a4caf4529
//# sourceMappingURL=landing.routes-G3YM4V6Y.js.map
