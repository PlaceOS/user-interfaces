import{$a as mt,$t as Le,Ds as xS,Ho as ta,Is as ye,L as Ch,Ma as jt,Mi as dae,Po as se,Xs as m$1,Y as ET,Ys as l,Yt as L,_r as Ve,_t as Hb,ba as it,co as oa,ft as Gt,go as pt,is as v,jt as It,qa as m,qs as zn,vo as q}from"./chunk-CMsd6no9.js";import{C as Ii,Ft as no,I as Nf,Z as Ti,_n as zv,l as Cf,x as Hn}from"./chunk-CbQ6hFiI.js";function Y(o,m){}var z=`_mat-bottom-sheet-enter`;var P=`_mat-bottom-sheet-exit`;var G=(()=>{class o extends Cf{_breakpointSubscription;_animationsDisabled=ta();_animationState=`void`;_animationStateChanged=new ye;_destroyed=!1;constructor(){super();let e=m(xS);this._breakpointSubscription=e.observe([dae.Medium,dae.Large,dae.XLarge]).subscribe(()=>{let n=this._elementRef.nativeElement.classList;n.toggle(`mat-bottom-sheet-container-medium`,e.isMatched(dae.Medium)),n.toggle(`mat-bottom-sheet-container-large`,e.isMatched(dae.Large)),n.toggle(`mat-bottom-sheet-container-xlarge`,e.isMatched(dae.XLarge))})}enter(){this._destroyed||(this._animationState=`visible`,this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation(z))}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute(`mat-exit`,``),this._animationState=`hidden`,this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(P))}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=!0}_simulateAnimation(e){this._ngZone.run(()=>{this._handleAnimationEvent(!0,e,this._elementRef.nativeElement),setTimeout(()=>this._handleAnimationEvent(!1,e,this._elementRef.nativeElement))})}_trapFocus(){super._trapFocus({preventScroll:!0})}_handleAnimationEvent(e,n,t){if(t===this._elementRef.nativeElement){let i=n===z;(i||n===P)&&this._animationStateChanged.emit({toState:i?`visible`:`hidden`,phase:e?`start`:`done`})}}static ɵfac=function(n){return new(n||o)};static ɵcmp=It({type:o,selectors:[[`mat-bottom-sheet-container`]],hostAttrs:[`tabindex`,`-1`,1,`mat-bottom-sheet-container`],hostVars:9,hostBindings:function(n,t){n&1&&Gt(`animationstart`,function(a){return t._handleAnimationEvent(!0,a.animationName,a.target)})(`animationend`,function(a){return t._handleAnimationEvent(!1,a.animationName,a.target)})(`animationcancel`,function(a){return t._handleAnimationEvent(!1,a.animationName,a.target)}),n&2&&(zn(`role`,t._config.role)(`aria-modal`,t._config.ariaModal)(`aria-label`,t._config.ariaLabel),jt(`mat-bottom-sheet-container-animations-enabled`,!t._animationsDisabled)(`mat-bottom-sheet-container-enter`,t._animationState===`visible`)(`mat-bottom-sheet-container-exit`,t._animationState===`hidden`))},features:[it],decls:1,vars:0,consts:[[`cdkPortalOutlet`,``]],template:function(n,t){n&1&&ET(0,Y,0,0,`ng-template`,0)},dependencies:[Ti],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
...
//# debugId=272acdd2-7655-50a4-b189-68e3b5d06dfb
//# sourceMappingURL=chunk-DlCnyiq4.js.map