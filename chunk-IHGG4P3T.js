...
import {
  ...
  updateSpaceList,
  validate
} from "./chunk-YHJKXICL.js";
import {
  SanitizePipe
} from "./chunk-L3OUOIRD.js";
import {
  TranslatePipe
} from "./chunk-UCFSK25H.js";
import {
  $a,
  A11yModule,
...
async function bootstrap_desk_type() {
  let category = findOldestByName(await nd({ hidden: true, limit: 500 }).then((response) => response.data), DESK_CATEGORY_NAME);
  if (!category) {
...
async function query_hidden_categories2() {
  if (!_hidden_categories_promise2) {
    _hidden_categories_promise2 = nd({
      hidden: true,
      limit: 500
    }).then((_) => _.data).catch(() => []);
  }
...
//# debugId=ccc94ca0-f113-5b2d-b0bd-e9054ff63a2b
//# sourceMappingURL=chunk-IHGG4P3T.js.map
