...
var AppSettingsModalComponent = class _AppSettingsModalComponent {
  ...
  async ngOnInit() {
    ...
    const zone_settings = (await Fu(this.zone.id, `${this.workplace_key}`).catch(() => ({ details: {} }))).details;
    const parent_settings = (await Fu(this.zone.parent_id, `${this.workplace_key}`).catch(() => ({ details: {} }))).details;
    const org_settings = (await Fu(this._org.organisation.id, `${this.workplace_key}`).catch(() => ({ details: {} }))).details;
...
function AutoReleaseSettingsModalComponent_Conditional_5_For_48_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("name", \u0275\u0275pipeBind1(2, 3, "APP.CONCIERGE.AUTO_RELEASE_" + name_r6.toUpperCase()))("ngModel", (tmp_13_0 = ctx_r1.setting("custom")) == null ? null : tmp_13_0.includes(name_r6));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(((tmp_14_0 = ctx_r1.setting("custom")) == null ? null : tmp_14_0.includes(name_r6)) ? 3 : -1);
  }
}
function AutoReleaseSettingsModalComponent_Conditional_5_For_48_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(((tmp_11_0 = ctx_r1.setting("resources")) == null ? null : tmp_11_0.includes(name_r6)) ? 0 : -1);
  }
}
function AutoReleaseSettingsModalComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("name", \u0275\u0275pipeBind1(19, 31, "APP.CONCIERGE.AUTO_RELEASE_OUTSIDE_HOURS"))("ngModel", ctx_r1.setting("release_outside_hours"));
    \u0275\u0275advance(3);
...
var AutoReleaseSettingsModalComponent = class _AutoReleaseSettingsModalComponent {
  constructor() {
    ...
    this.default_work_preferences = computed(() => (this.setting("default_work_preferences") || []).map((pref) => ({
  ...
  async loadSettings(id) {
    ...
    const settings = (await Qc({ parent_id: id })).data;
    const unencrypted = settings.find((_) => _.encryption_level === De.None);
    if (!unencrypted)
      return;
    try {
  ...
  async save() {
    ...
    const settings = (await Qc({ parent_id: this.id })).data;
    let unencrypted = settings.find((_) => _.encryption_level === De.None);
    if (!unencrypted) {
      unencrypted = new Ae({
        parent_id: this.id,
    ...
    unencrypted.id ? await Zc(unencrypted.id, unencrypted).catch(on_error) : await Jc(unencrypted).catch(on_error);
    const metadata_key = this._settings.get("app.workplace_metadata_key") || "workplace_app";
    const metadata = await Fu(this.id, metadata_key);
...
function BuildingFormComponent_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(10, BuildingFormComponent_Conditional_0_Conditional_1_For_11_Template, 2, 2, "mat-option", 8, _forTrack02);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function BuildingFormComponent_Conditional_0_For_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 8);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BuildingFormComponent_Conditional_0_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function BuildingFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, BuildingFormComponent_Conditional_0_Conditional_1_Template, 12, 10, "div", 2);
    ...
    \u0275\u0275repeaterCreate(20, BuildingFormComponent_Conditional_0_For_21_Template, 2, 2, "mat-option", 8, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275conditionalCreate(22, BuildingFormComponent_Conditional_0_Conditional_22_Template, 3, 4, "mat-option", 9);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("formGroup", ctx_r1.form);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.region_list().length ? 1 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(5, 10, "FORM.DISPLAY_NAME"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(8, 12, "FORM.DISPLAY_NAME"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 14, "COMMON.TIMEZONE"));
    \u0275\u0275advance(5);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(17, 16, "COMMON.TIMEZONE"))("matAutocomplete", auto_r4);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r1.filtered_timezones());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r1.timezones.length ? 22 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(26, 18, "COMMON.LOCATION"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(29, 20, "COMMON.LOCATION"));
  }
}
var BuildingFormComponent = class _BuildingFormComponent extends AsyncHandler {
  ...
  constructor() {
    super();
    this._org = inject(OrganisationService);
    this.building = input(null, ...ngDevMode ? [{ debugName: "building" }] : (
      /* istanbul ignore next */
      []
    ));
    this.save = input(0, ...ngDevMode ? [{ debugName: "save" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.region_list = toSignal(this._org.region_list, {
      initialValue: []
    });
    this.form = new FormGroup({
      id: new FormControl(""),
    ...
    this._timezone = toSignal(this.form.controls.timezone.valueChanges.pipe(startWith(this.form.controls.timezone.value || "")), { initialValue: this.form.controls.timezone.value || "" });
  ...
  async saveChanges() {
    ...
    const body = __spreadProps(__spreadValues({}, data), {
      tags: ["building"],
      name: `BLD ${Pt().description} ${data.display_name}`
    });
    const building = await (data.id ? Wa(data.id, body) : Qa(body)).catch((e) => {
...
(() => {
  ...
  }], () => [], { building: [{ type: Input, args: [{ isSignal: true, alias: "building", required: false }] }], save: [{ type: Input, args: [{ isSignal: true, alias: "save", required: false }] }], loading: [{ type: Input, args: [{ isSignal: true, alias: "loading", required: false }] }, { type: Output, args: ["loadingChange"] }], loadingChange: [{ type: Output, args: ["loadingChange"] }], done: [{ type: Output, args: ["done"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildingFormComponent, { className: "BuildingFormComponent", filePath: "apps/concierge/src/app/building-manager/building-form.component.ts", lineNumber: 132 });
})();
...
var BuildingModalComponent = class _BuildingModalComponent {
  constructor() {
    ...
    this.save_state = signal(0, ...ngDevMode ? [{ debugName: "save_state" }] : (
      /* istanbul ignore next */
      []
    ));
    this.building = signal(this._data, ...ngDevMode ? [{ debugName: "building" }] : (
      /* istanbul ignore next */
      []
    ));
...
var InductionSettingsModalComponent = class _InductionSettingsModalComponent {
  constructor() {
    ...
    this.induction_details = signal("", ...ngDevMode ? [{ debugName: "induction_details" }] : (
      /* istanbul ignore next */
      []
    ));
    this.is_enabled = signal(false, ...ngDevMode ? [{ debugName: "is_enabled" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  async loadSettings() {
    ...
    const [bld_metadata, org_metadata, org_settings] = await Promise.all([
      Fu(this._zone_id, visitor_kiosk_app),
      Fu(this._org.organisation.id, visitor_kiosk_app),
      Fu(this._org.organisation.id, "settings")
    ]);
  ...
  async save() {
    ...
    this._dialog_ref.disableClose = true;
    const metadata = await Fu(this._zone_id, visitor_kiosk_app);
    const con_metadata = await Fu(this._zone_id, concierge_app);
    ...
    const result_visitor = await Lu(this._zone_id, {
    ...
    const result_concierge = await Lu(this._zone_id, {
...
var ItemListModalComponent = class _ItemListModalComponent {
  constructor() {
    ...
    this._settings = inject(SettingsService);
    this._dialog_ref = inject(MatDialogRef);
    this.item_list = signal([], ...ngDevMode ? [{ debugName: "item_list" }] : (
      /* istanbul ignore next */
      []
    ));
    this.loading = signal(false, ...ngDevMode ? [{ debugName: "loading" }] : (
  ...
  async ngOnInit() {
    const metadata_key = this._settings.get("app.workplace_metadata_key") || "workplace_app";
    const metadata = await Fu(this._bld_id, metadata_key);
  ...
  async save() {
    ...
    let resp = await Lu(this._bld_id, {
      name: metadata_key,
    ...
    const concierge_metadata = await Fu(this._bld_id, metadata_key);
    concierge_metadata.details.support_issue_types = items;
    resp = await Lu(this._bld_id, {
      name: concierge_key,
...
var BuildingManagementService = class _BuildingManagementService {
  ...
  editBuildingMetadata(zone = new Qt()) {
...
var BookingPanelSettingsModalComponent = class _BookingPanelSettingsModalComponent extends AsyncHandler {
  constructor() {
    ...
    this.uploading = signal(0, ...ngDevMode ? [{ debugName: "uploading" }] : (
      /* istanbul ignore next */
      []
    ));
    this.zone = this._data.zone;
  ...
  async ngOnInit() {
    ...
    let settings = [];
    try {
      const response = await Qc({ parent_id: this.zone.id });
      settings = response?.data || [];
    } catch {
    }
    const unencrypted_settings = settings.find((block) => block.encryption_level === De.None);
  ...
  async save() {
    ...
    let unencrypted_settings = settings.find((block) => block.encryption_level === De.None);
    if (!unencrypted_settings)
    ...
    const update = unencrypted_settings.id ? Zc(unencrypted_settings.id, new_setting) : Jc(new_setting);
    try {
      await update;
    } catch (e) {
      this._dialog_ref.disableClose = false;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingPanelSettingsModalComponent, selectors: [["booking-panel-settings-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 87, vars: 17, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-4", 3, "formGroup"], [1, "border-base-300", "relative", "mb-4", "flex", "flex-col", "rounded-sm", "border", "p-2"], [1, "bg-base-100", "absolute", "top-0", "left-8", "-translate-y-1/2", "p-2", "text-sm"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Disable booking", "formControlName", "disable_book_now"], ["name", "Hide booking host options", "formControlName", "disable_book_now_host"], [1, "flex", "space-x-4"], [1, "h-20", "flex-1"], ["for", "min-duration"], ["name", "min-duration", "formControlName", "min_duration", 3, "min", "step", "max"], ["for", "max-duration"], ["name", "max-duration", "formControlName", "max_duration", 3, "min", "step", "max"], [1, "flex-1"], ["for", "pending_before"], ["name", "pending_before", "formControlName", "pending_before", 3, "min", "step", "max"], ["for", "pending_period"], ["name", "pending_period", "formControlName", "pending_period", 3, "min", "step", "max"], ["name", "Disable auto-ending bookings", "formControlName", "disable_end_meeting", "info", "Disable ending the current booking early when sensors\ndon't detect presence in room after a period of time"], ["name", "Show button to end booking early", "formControlName", "enable_end_meeting_button"], ["name", "Hide Meeting Details", "formControlName", "hide_meeting_details", "info", "When enabled only shows the time of the current meeting"], ["name", "Hide Meeting Title", "formControlName", "hide_meeting_title", "info", "When enabled only shows the time and host of the current meeting"], ["name", "Show Booking QR Code", "formControlName", "show_qr_code"], ["name", "Hide QR helper text", "formControlName", "hide_qr_text"], [1, "mb-2"], ["for", "custom-qr-url"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "custom-qr-url", "placeholder", "/workplace/#/book/room/?room_id=sys-123456", "formControlName", "custom_qr_url"], ["for", "custom-qr-color"], ["matInput", "", "name", "custom-qr-color", "placeholder", "#4A2C89", "formControlName", "custom_qr_color"], ["for", "control-ui"], ["matInput", "", "name", "control-ui", "formControlName", "control_ui", "placeholder", "https://control.example.com/..."], ["for", "catering-ui"], ["matInput", "", "name", "catering-ui", "formControlName", "catering_ui", "placeholder", "https://catering.example.com/..."], ["for", "room-image"], [1, "flex", "space-x-2"], ["appearance", "outline", 1, "w-1/2", "flex-1"], ["matInput", "", "name", "room-image", "placeholder", "/assets/images/room_test1.png", "formControlName", "room_image"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "h-12", "w-12", "rounded-sm", 3, "disabled"], ["type", "file", 1, "absolute", "inset-0", "opacity-0", 3, "change"], ["for", "offline-image"], ["matInput", "", "name", "offline-image", "placeholder", "/assets/images/offline1.png", "formControlName", "offline_image"], ["icon", "", "matRipple", "", 1, "bg-secondary", "text-secondary-content", "relative", "h-12", "w-12", "rounded-sm", 3, "disabled"]], template: function BookingPanelSettingsModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(27, "settings-toggle", 18)(28, "settings-toggle", 19)(29, "settings-toggle", 20)(30, "settings-toggle", 21)(31, "settings-toggle", 22)(32, "settings-toggle", 23);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(33, "div", 24)(34, "label", 25);
        \u0275\u0275text(35, "Custom QR Code URL");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(36, "mat-form-field", 26);
        ...
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(75, "div", 13)(76, "label", 40);
        \u0275\u0275text(77, "Offline Image URL");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(78, "div", 35)(79, "mat-form-field", 36);
        \u0275\u0275element(80, "input", 41);
        \u0275\u0275elementStart(81, "mat-error");
        \u0275\u0275text(82, " Offline Image must be a valid URL ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(83, "button", 42)(84, "icon");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BookingPanelSettingsModalComponent, { className: "BookingPanelSettingsModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/booking-panel-settings-modal.component.ts", lineNumber: 304 });
})();
...
function ConciergeSettingsFormModalComponent_Conditional_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 77);
    \u0275\u0275text(1, " Room Report ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "mat-option", 78);
    \u0275\u0275text(3, " Desk Report ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-option", 79);
    \u0275\u0275text(5, " Catering Report ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "mat-option", 80);
    \u0275\u0275text(7, " Parking Report ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-option", 81);
    \u0275\u0275text(9, " Contact Tracing Report ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "mat-option", 82);
    \u0275\u0275text(11, " Assets Report ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-option", 83);
...
function ConciergeSettingsFormModalComponent_Conditional_148_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 70)(1, "h3", 35);
    \u0275\u0275text(2, " Reports ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "settings-toggle", 86);
    \u0275\u0275elementEnd();
  }
}
...
function ConciergeSettingsFormModalComponent_Conditional_149_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 71)(1, "h3", 35);
    \u0275\u0275text(2, " Room Bookings ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_149_Template_button_click_3_listener() {
      ...
      return \u0275\u0275resetView(ctx_r4.toggleGroup("spaces"));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 88)(7, "div", 89)(8, "div", 37)(9, "label", 90);
    \u0275\u0275text(10, " Day Timeline Default View ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 91);
    \u0275\u0275repeaterCreate(13, ConciergeSettingsFormModalComponent_Conditional_149_For_14_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-hint");
    \u0275\u0275text(16, " Default day timeline layout for room bookings ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div", 36)(18, "div", 37)(19, "label", 92);
    \u0275\u0275text(20, "Block Start Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "mat-form-field", 11)(22, "mat-select", 93);
    \u0275\u0275repeaterCreate(23, ConciergeSettingsFormModalComponent_Conditional_149_For_24_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-hint");
    \u0275\u0275text(26, " Start time of dayview blocks ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "div", 37)(28, "label", 94);
    \u0275\u0275text(29, "Block End Time");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "mat-form-field", 11)(31, "mat-select", 95);
    \u0275\u0275repeaterCreate(32, ConciergeSettingsFormModalComponent_Conditional_149_For_33_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "mat-hint");
    \u0275\u0275text(35, " End time of dayview blocks ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(36, "div", 36)(37, "div", 37)(38, "label", 96);
    \u0275\u0275text(39, " Block Height ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "mat-form-field", 11)(41, "mat-select", 97);
    \u0275\u0275repeaterCreate(42, ConciergeSettingsFormModalComponent_Conditional_149_For_43_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "mat-hint");
    \u0275\u0275text(45, " Height of 1 hour in dayview ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(46, "div", 37)(47, "label", 98);
    \u0275\u0275text(48, " Max Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "mat-form-field", 11)(50, "mat-select", 99);
    \u0275\u0275repeaterCreate(51, ConciergeSettingsFormModalComponent_Conditional_149_For_52_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "mat-hint");
    \u0275\u0275text(54, " Max duration for single day bookings ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(55, "div")(56, "label", 100);
    \u0275\u0275text(57, " Available Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "mat-form-field", 11)(59, "mat-select", 101);
    \u0275\u0275repeaterCreate(60, ConciergeSettingsFormModalComponent_Conditional_149_For_61_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "mat-hint");
    \u0275\u0275text(63, " Number of days ahead users can create bookings from the room booking manager ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(64, "div", 102)(65, "div")(66, "label", 103);
    \u0275\u0275text(67, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "mat-form-field", 11)(69, "mat-select", 104);
    \u0275\u0275repeaterCreate(70, ConciergeSettingsFormModalComponent_Conditional_149_For_71_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(72, "div")(73, "label", 105);
    \u0275\u0275text(74, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "mat-form-field", 11)(76, "mat-select", 106);
    \u0275\u0275repeaterCreate(77, ConciergeSettingsFormModalComponent_Conditional_149_For_78_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(79, "div", 64);
    \u0275\u0275element(80, "settings-toggle", 107)(81, "settings-toggle", 108)(82, "settings-toggle", 109)(83, "settings-toggle", 110)(84, "settings-toggle", 111)(85, "settings-toggle", 112)(86, "settings-toggle", 113)(87, "settings-toggle", 114)(88, "settings-toggle", 115)(89, "settings-toggle", 116)(90, "settings-toggle", 117)(91, "settings-toggle", 118)(92, "settings-toggle", 119)(93, "settings-toggle", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(94, "div", 121)(95, "div")(96, "label", 122);
    \u0275\u0275text(97, " All Day Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(98, "mat-form-field", 11)(99, "mat-select", 123);
    \u0275\u0275repeaterCreate(100, ConciergeSettingsFormModalComponent_Conditional_149_For_101_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(102, "div")(103, "label", 124);
    \u0275\u0275text(104, " All Day End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "mat-form-field", 11)(106, "mat-select", 125);
    \u0275\u0275repeaterCreate(107, ConciergeSettingsFormModalComponent_Conditional_149_For_108_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.shown_group() === "spaces" ? "chevron_left" : "keyboard_arrow_down");
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "spaces");
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.DAY_TIMELINE_VIEW);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r4.BLOCK_START);
    \u0275\u0275advance(9);
    \u0275\u0275repeater(ctx_r4.BLOCK_END);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r4.BLOCK_HEIGHT);
    \u0275\u0275advance(9);
    \u0275\u0275repeater(ctx_r4.MAX_DURATION_FULL);
    \u0275\u0275advance(9);
    \u0275\u0275repeater(ctx_r4.AVAILABLE_PERIOD_SHORT);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_START);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_END);
    \u0275\u0275advance(23);
    \u0275\u0275repeater(ctx_r4.BLOCK_START);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.BLOCK_END);
...
function ConciergeSettingsFormModalComponent_Conditional_150_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 72)(1, "h3", 35);
    ...
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_150_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleGroup("desks"));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 88)(7, "div", 89)(8, "div")(9, "label", 126);
    \u0275\u0275text(10, " Max Assigned Desks Per User ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11);
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.shown_group() === "desks" ? "chevron_left" : "keyboard_arrow_down");
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "desks");
  }
}
...
function ConciergeSettingsFormModalComponent_Conditional_151_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 73)(1, "h3", 35);
    \u0275\u0275text(2, " Visitors ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 87);
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_151_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleGroup("visitors"));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 88)(7, "div", 89)(8, "div", 102)(9, "div")(10, "label", 128);
    \u0275\u0275text(11, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-form-field", 11)(13, "mat-select", 129);
    \u0275\u0275repeaterCreate(14, ConciergeSettingsFormModalComponent_Conditional_151_For_15_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "div")(17, "label", 130);
    \u0275\u0275text(18, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 11)(20, "mat-select", 131);
    \u0275\u0275repeaterCreate(21, ConciergeSettingsFormModalComponent_Conditional_151_For_22_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(23, "label", 132);
    \u0275\u0275text(24, "Hide Guest List fields");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-form-field", 11)(26, "mat-select", 133)(27, "mat-option", 134);
    \u0275\u0275text(28);
    \u0275\u0275pipe(29, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "mat-option", 135);
    \u0275\u0275text(31);
    \u0275\u0275pipe(32, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "mat-option", 136);
    \u0275\u0275text(34);
    \u0275\u0275pipe(35, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "mat-option", 137);
    \u0275\u0275text(37);
    \u0275\u0275pipe(38, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-option", 138);
    \u0275\u0275text(40);
    \u0275\u0275pipe(41, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "mat-option", 139);
    \u0275\u0275text(43);
    \u0275\u0275pipe(44, "translate");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "label", 140);
    \u0275\u0275text(48, " Check-in/out all visitors action window ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "mat-form-field", 11);
    \u0275\u0275element(50, "input", 141);
    ...
    \u0275\u0275element(54, "settings-toggle", 142)(55, "settings-toggle", 143)(56, "settings-toggle", 144)(57, "settings-toggle", 145)(58, "settings-toggle", 146);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.shown_group() === "visitors" ? "chevron_left" : "keyboard_arrow_down");
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "visitors");
    \u0275\u0275advance(8);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_START);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_END);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 9, "COMMON.CHECKED_IN_AT"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(32, 11, "COMMON.CHECKED_OUT_AT"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(35, 13, "COMMON.CHECKED_IN"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(38, 15, "FORM.TIME"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(41, 17, "FORM.HOST"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(44, 19, "COMMON.STATE"), " ");
  }
}
...
function ConciergeSettingsFormModalComponent_Conditional_152_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 74)(1, "h3", 35);
    ...
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_152_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r20);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleGroup("bookings"));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 88)(7, "div", 89)(8, "div")(9, "label", 100);
    \u0275\u0275text(10, " Available Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 101);
    \u0275\u0275repeaterCreate(13, ConciergeSettingsFormModalComponent_Conditional_152_For_14_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-hint");
    \u0275\u0275text(16, " Number of days ahead the user is able to book ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div")(18, "label", 98);
    \u0275\u0275text(19, " Max Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-form-field", 11)(21, "mat-select", 99);
    \u0275\u0275repeaterCreate(22, ConciergeSettingsFormModalComponent_Conditional_152_For_23_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "mat-hint");
    \u0275\u0275text(25, " Max duration for single day bookings ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 102)(27, "div")(28, "label", 147);
    \u0275\u0275text(29, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "mat-form-field", 11)(31, "mat-select", 148);
    \u0275\u0275repeaterCreate(32, ConciergeSettingsFormModalComponent_Conditional_152_For_33_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(34, "div")(35, "label", 149);
    \u0275\u0275text(36, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "mat-form-field", 11)(38, "mat-select", 150);
    \u0275\u0275repeaterCreate(39, ConciergeSettingsFormModalComponent_Conditional_152_For_40_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(41, "div", 64);
    \u0275\u0275element(42, "settings-toggle", 107)(43, "settings-toggle", 118)(44, "settings-toggle", 112);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "div", 121)(46, "div")(47, "label", 151);
    \u0275\u0275text(48, " All Day Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "mat-form-field", 11)(50, "mat-select", 152);
    \u0275\u0275repeaterCreate(51, ConciergeSettingsFormModalComponent_Conditional_152_For_52_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(53, "div")(54, "label", 153);
    \u0275\u0275text(55, " All Day End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "mat-form-field", 11)(57, "mat-select", 154);
    \u0275\u0275repeaterCreate(58, ConciergeSettingsFormModalComponent_Conditional_152_For_59_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.shown_group() === "bookings" ? "chevron_left" : "keyboard_arrow_down");
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "bookings");
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.AVAILABLE_PERIOD_EXTENDED);
    \u0275\u0275advance(9);
    \u0275\u0275repeater(ctx_r4.MAX_DURATION_FULL);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_START);
...
function ConciergeSettingsFormModalComponent_Conditional_153_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 75)(1, "h3", 35);
    \u0275\u0275text(2, " Parking ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 87);
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_153_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r27);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleGroup("parking"));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 101);
    \u0275\u0275repeaterCreate(13, ConciergeSettingsFormModalComponent_Conditional_153_For_14_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-hint");
    \u0275\u0275text(16, " Number of days ahead the user is able to book ");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-form-field", 11)(21, "mat-select", 99);
    \u0275\u0275repeaterCreate(22, ConciergeSettingsFormModalComponent_Conditional_153_For_23_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "mat-hint");
    \u0275\u0275text(25, " Max duration for single day bookings ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div")(27, "label", 155);
    \u0275\u0275text(28, " Max Assigned Parking Spaces Per User ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-form-field", 11);
    \u0275\u0275element(30, "input", 156);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(33, "div", 102)(34, "div")(35, "label", 157);
    \u0275\u0275text(36, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "mat-form-field", 11)(38, "mat-select", 158);
    \u0275\u0275repeaterCreate(39, ConciergeSettingsFormModalComponent_Conditional_153_For_40_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "div")(42, "label", 159);
    \u0275\u0275text(43, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "mat-form-field", 11)(45, "mat-select", 160);
    \u0275\u0275repeaterCreate(46, ConciergeSettingsFormModalComponent_Conditional_153_For_47_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(48, "div", 64);
    \u0275\u0275element(49, "settings-toggle", 107)(50, "settings-toggle", 161)(51, "settings-toggle", 162)(52, "settings-toggle", 163)(53, "settings-toggle", 164)(54, "settings-toggle", 165)(55, "settings-toggle", 166)(56, "settings-toggle", 167)(57, "settings-toggle", 168)(58, "settings-toggle", 169)(59, "settings-toggle", 170)(60, "settings-toggle", 171);
    \u0275\u0275pipe(61, "translate");
    \u0275\u0275element(62, "settings-toggle", 172);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.shown_group() === "parking" ? "chevron_left" : "keyboard_arrow_down");
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "parking");
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.AVAILABLE_PERIOD_EXTENDED);
    \u0275\u0275advance(9);
    \u0275\u0275repeater(ctx_r4.MAX_DURATION_FULL);
    ...
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_END);
    \u0275\u0275advance(14);
    \u0275\u0275property("name", \u0275\u0275pipeBind1(61, 4, "APP.CONCIERGE.PARKING_ALLOW_DELETING"));
  }
}
...
function ConciergeSettingsFormModalComponent_Conditional_154_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 76)(1, "h3", 35);
    ...
    \u0275\u0275listener("click", function ConciergeSettingsFormModalComponent_Conditional_154_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r32);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleGroup("lockers"));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 101);
    \u0275\u0275repeaterCreate(13, ConciergeSettingsFormModalComponent_Conditional_154_For_14_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-hint");
    \u0275\u0275text(16, " Number of days ahead the user is able to book ");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "mat-form-field", 11)(21, "mat-select", 99);
    \u0275\u0275repeaterCreate(22, ConciergeSettingsFormModalComponent_Conditional_154_For_23_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "div", 102)(25, "div")(26, "label", 173);
    \u0275\u0275text(27, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "mat-form-field", 11)(29, "mat-select", 174);
    \u0275\u0275repeaterCreate(30, ConciergeSettingsFormModalComponent_Conditional_154_For_31_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div")(33, "label", 175);
    \u0275\u0275text(34, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-form-field", 11)(36, "mat-select", 176);
    \u0275\u0275repeaterCreate(37, ConciergeSettingsFormModalComponent_Conditional_154_For_38_Template, 2, 2, "mat-option", 40, _forTrack03);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(39, "div", 64);
    \u0275\u0275element(40, "settings-toggle", 107)(41, "settings-toggle", 177)(42, "settings-toggle", 178)(43, "settings-toggle", 179)(44, "settings-toggle", 180)(45, "settings-toggle", 181);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.shown_group() === "lockers" ? "chevron_left" : "keyboard_arrow_down");
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "lockers");
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.AVAILABLE_PERIOD_SHORT);
    \u0275\u0275advance(9);
    \u0275\u0275repeater(ctx_r4.MAX_DURATION_FULL);
...
var ConciergeSettingsFormModalComponent = class _ConciergeSettingsFormModalComponent {
  constructor() {
    ...
    this.heading = signal("", ...ngDevMode ? [{ debugName: "heading" }] : (
      /* istanbul ignore next */
      []
    ));
    this.loading = signal("", ...ngDevMode ? [{ debugName: "loading" }] : (
    ...
    this.shown_group = signal("", ...ngDevMode ? [{ debugName: "shown_group" }] : (
      /* istanbul ignore next */
      []
    ));
    this.currency_filter = signal("", ...ngDevMode ? [{ debugName: "currency_filter" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  _getMetadata(id) {
    return firstValueFrom(from(Fu(id, this.settings_key)).pipe(map((m) => m.details)));
  }
  static {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConciergeSettingsFormModalComponent, selectors: [["concierge-settings-form-modal"]], decls: 155, vars: 26, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-8", "pb-4", 3, "formGroup"], ["general", "", 1, "bg-base-100", "space-y-2", "rounded-sm"], ["for", "logo_light"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "logo_light", "formControlName", "logo_light"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions"], ["for", "logo_dark"], ["matInput", "", "name", "logo_dark", "formControlName", "logo_dark"], ["for", "features"], ["appearance", "outline", 1, "w-full"], ["name", "features", "formControlName", "features", "multiple", ""], ["value", "zones"], ["value", "spaces"], ["value", "assets"], ["value", "desks"], ["value", "lockers"], ["value", "parking"], ["value", "parking-bookings"], ["value", "parking-manage"], ["value", "visitors"], ["value", "internal-users"], ["value", "surveys"], ["value", "catering"], ["value", "points-of-interest"], ["value", "url-management"], ["value", "events"], ["value", "points"], ["value", "emergency-contacts"], ["value", "signage"], ["value", "email-templates"], ["value", "deals-n-offers"], ["value", "reports"], [1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "px-2", "py-1", "font-medium"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], ["for", "banner-type"], ["name", "banner-type", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value"], ["matInput", "", "name", "banner-message", "placeholder", "Banner Message", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "default-route"], ["matInput", "", "name", "default-route", "formControlName", "default_route", "placeholder", "/book/rooms/new"], [1, "grid", "gap-4", "md:grid-cols-2"], ["for", "workplace-url-path"], ["matInput", "", "name", "workplace-url-path", "formControlName", "workplace_url_path", "placeholder", "/workplace"], ["for", "public-url-path"], ["matInput", "", "name", "public-url-path", "formControlName", "public_url_path", "placeholder", "/public"], ["for", "kiosk-url-path"], ["matInput", "", "name", "kiosk-url-path", "formControlName", "kiosk_url_path", "placeholder", "/map-kiosk"], ["for", "control-path"], ["matInput", "", "name", "control-path", "formControlName", "control_path", "placeholder", "/control"], ["for", "signage-path"], ["matInput", "", "name", "signage-path", "formControlName", "signage_path", "placeholder", "/signage"], ["for", "short-url-public-key"], ["matInput", "", "name", "short-url-public-key", "formControlName", "short_url_public_key", "placeholder", "your-short-url-public-key"], ["for", "week-start"], ["name", "week-start", "formControlName", "week_start", "placeholder", "Sunday"], ["for", "currency"], ["name", "currency", "formControlName", "currency", "placeholder", "Select currency code", 3, "openedChange"], ["disabled", "", 1, "!h-auto", "!py-2"], ["matInput", "", "placeholder", "Search currency code or name", 3, "ngModelChange", "click", "keydown", "ngModel", "ngModelOptions"], ["disabled", ""], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Use 24 hour time", "formControlName", "use_24_hour_time"], ["name", "Delegated", "formControlName", "delegated"], ["name", "Force upload state", "formControlName", "force_upload_state"], ["name", "All uploads are private", "formControlName", "private_uploads"], ["name", "Use region over building", "formControlName", "use_region"], ["reports", "", "id", "feature-reports", "formGroupName", "reports", 1, "border-base-300", "relative", "rounded-sm", "border", "px-2", "pt-4", "pb-2"], ["spaces", "", "id", "feature-spaces", "formGroupName", "events", 1, "border-base-300", "relative", "rounded-sm", "border"], ["desks", "", "id", "feature-desks", "formGroupName", "desks", 1, "border-base-300", "relative", "rounded-sm", "border"], ["visitors", "", "id", "feature-visitors", "formGroupName", "visitors", 1, "border-base-300", "relative", "rounded-sm", "border"], ["bookings", "", "id", "feature-bookings", "formGroupName", "bookings", 1, "border-base-300", "relative", "rounded-sm", "border"], ["parking", "", "id", "feature-parking", "formGroupName", "parking", 1, "border-base-300", "relative", "rounded-sm", "border"], ["lockers", "", "id", "feature-lockers", "formGroupName", "lockers", 1, "border-base-300", "relative", "rounded-sm", "border"], ["value", "booking-report"], ["value", "desk-report"], ["value", "catering-report"], ["value", "parking-report"], ["value", "contact-tracing-report"], ["value", "assets-report"], ["value", "visitors-report"], ["for", "group-events-calendar"], ["matInput", "", "name", "group-events-calendar", "formControlName", "group_events_calendar", "placeholder", "shared.events@calendar.acme.tech"], ["name", "Include weekends in site attendance averages", "formControlName", "attendance_include_weekends"], ["icon", "", "matRipple", "", 1, "bg-base-100", "absolute", "top-0", "right-4", "-translate-y-1/2", 3, "click"], ["collapsible", ""], [1, "content", "px-4", "pt-4", "pb-2"], ["for", "day-timeline-view"], ["name", "day-timeline-view", "formControlName", "day_timeline_view"], ["for", "block-start"], ["name", "block-start", "formControlName", "block_start", "placeholder", "12AM (Midnight)"], ["for", "block-end"], ["name", "block-end", "formControlName", "block_end", "placeholder", "12AM (Midnight)"], ["for", "block-height"], ["name", "block-height", "formControlName", "block_height"], ["for", "max-duration"], ["name", "max-duration", "formControlName", "max_duration"], ["for", "available-period"], ["name", "available-period", "formControlName", "available_period"], ["formGroupName", "bookable_hours", 1, "grid", "grid-cols-1", "gap-4", "md:grid-cols-2"], ["for", "events-bookable-start"], ["name", "events-bookable-start", "formControlName", "start"], ["for", "events-bookable-end"], ["name", "events-bookable-end", "formControlName", "end"], ["name", "Allow all day bookings", "formControlName", "allow_all_day"], ["name", "Default to all day", "formControlName", "all_day_default"], ["name", "Allow editing setup/breakdown times", "formControlName", "allow_setup_breakdown"], ["name", "Allow booking for other users", "formControlName", "can_book_for_others"], ["name", "Allow booking for any other users", "formControlName", "can_book_for_anyone"], ["name", "Allow booking with assets", "formControlName", "has_assets"], ["name", "Hide notes field when booking", "formControlName", "hide_notes"], ["name", "Hide attendees field when booking", "formControlName", "hide_attendees"], ["name", "Allow booking for external users", "formControlName", "allow_externals"], ["name", "Enforce capacity for rooms", "formControlName", "strict_capacity_check"], ["name", "Allow booking for multiple days", "formControlName", "allow_multiday"], ["name", "Display times with building timezone", "formControlName", "use_building_timezone"], ["name", "Allow Visibility options", "formControlName", "allow_visibility"], ["name", "Allow editing bookings", "formControlName", "allow_edit"], ["formGroupName", "all_day_period", 1, "grid", "grid-cols-1", "gap-4", "md:grid-cols-2"], ["for", "events-all-day-start"], ["name", "events-all-day-start", "formControlName", "start", "placeholder", "None"], ["for", "events-all-day-end"], ["name", "events-all-day-end", "formControlName", "end", "placeholder", "None"], ["for", "desks-max-assigned-count"], ["matInput", "", "type", "number", "min", "0", "name", "desks-max-assigned-count", "formControlName", "max_assigned_count"], ["for", "visitors-bookable-start"], ["name", "visitors-bookable-start", "formControlName", "start", "placeholder", "None"], ["for", "visitors-bookable-end"], ["name", "visitors-bookable-end", "formControlName", "end", "placeholder", "None"], ["for", "hide-fields"], ["name", "hide-fields", "formControlName", "hide_fields", "placeholder", "No fields selected", "multiple", ""], ["value", "checked_in_at"], ["value", "checked_out_at"], ["value", "state"], ["value", "date"], ["value", "user_name"], ["value", "status"], ["for", "all-visitors-action-window"], ["matInput", "", "type", "number", "min", "0", "name", "all-visitors-action-window", "formControlName", "all_visitors_action_window"], ["name", "Allow booking parking for visitors", "formControlName", "has_parking"], ["name", "Allow setting pass number for visitors", "formControlName", "allow_pass_number"], ["name", "Allow printing visitor labels", "formControlName", "allow_printing_label"], ["name", "Allow international flag for visitors", "formControlName", "allow_international"], ["name", "Show calendar links after booking", "formControlName", "show_calendar_links"], ["for", "bookings-bookable-start"], ["name", "bookings-bookable-start", "formControlName", "start"], ["for", "bookings-bookable-end"], ["name", "bookings-bookable-end", "formControlName", "end"], ["for", "bookings-all-day-start"], ["name", "bookings-all-day-start", "formControlName", "start"], ["for", "bookings-all-day-end"], ["name", "bookings-all-day-end", "formControlName", "end"], ["for", "parking-max-assigned-count"], ["matInput", "", "type", "number", "min", "0", "name", "parking-max-assigned-count", "formControlName", "max_assigned_count"], ["for", "parking-bookable-start"], ["name", "parking-bookable-start", "formControlName", "start"], ["for", "parking-bookable-end"], ["name", "parking-bookable-end", "formControlName", "end"], ["name", "Show assigned users on parking map", "formControlName", "show_users"], ["name", "Show parking status details on map", "formControlName", "show_status_details"], ["name", "Disable parking map styles", "formControlName", "disable_styles"], ["name", "Disable reservations", "formControlName", "disable_bookings"], ["name", "Show booking requests", "formControlName", "show_requests"], ["name", "Show waitlisted status and filter", "formControlName", "show_waitlist"], ["name", "Always hide bay number column", "formControlName", "hide_bay_number"], ["name", "Hide level selector on booking list", "formControlName", "hide_level_selector_on_booking_list"], ["name", "Hide users and vehicle tabs", "formControlName", "hide_users_and_vehicles"], ["name", "Hide assign space action", "formControlName", "hide_assign_space"], ["formControlName", "allow_deleting", 3, "name"], ["name", "Assign a space when approving requests", "formControlName", "assign_space_on_approve"], ["for", "lockers-bookable-start"], ["name", "lockers-bookable-start", "formControlName", "start"], ["for", "lockers-bookable-end"], ["name", "lockers-bookable-end", "formControlName", "end"], ["name", "Default bookings to all day", "formControlName", "all_day_default"], ["name", "Show Calendar Links after booking", "formControlName", "show_calendar_links"], ["name", "Hide End time option", "formControlName", "hide_end_time"], ["name", "Disable Date selection", "formControlName", "disabled_date_select"], ["name", "Disable start time option", "formControlName", "disabled_start_time"]], template: function ConciergeSettingsFormModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
        ...
        \u0275\u0275repeaterCreate(74, ConciergeSettingsFormModalComponent_For_75_Template, 2, 2, "mat-option", 40, _forTrack03);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(76, "div", 37)(77, "label", 38);
        \u0275\u0275text(78, "Message");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(79, "mat-form-field", 11)(80, "input", 41);
        ...
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(81, "div")(82, "label", 42);
        \u0275\u0275text(83, "Default Route");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(84, "mat-form-field", 11);
        \u0275\u0275element(85, "input", 43);
        \u0275\u0275elementStart(86, "mat-hint");
        \u0275\u0275text(87, " Main page of the application ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275conditionalCreate(88, ConciergeSettingsFormModalComponent_Conditional_88_Template, 7, 0, "div");
        \u0275\u0275elementStart(89, "div", 44)(90, "div")(91, "label", 45);
        \u0275\u0275text(92, "Workplace URL Path");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(93, "mat-form-field", 11);
        \u0275\u0275element(94, "input", 46);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(95, "div")(96, "label", 47);
        \u0275\u0275text(97, "Public URL Path");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(98, "mat-form-field", 11);
        \u0275\u0275element(99, "input", 48);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(100, "div")(101, "label", 49);
        \u0275\u0275text(102, "Map Kiosk URL Path");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(103, "mat-form-field", 11);
        \u0275\u0275element(104, "input", 50);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(105, "div", 44)(106, "div")(107, "label", 51);
        \u0275\u0275text(108, "Control URL Path");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(109, "mat-form-field", 11);
        \u0275\u0275element(110, "input", 52);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(111, "div")(112, "label", 53);
        \u0275\u0275text(113, "Signage URL Path");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(114, "mat-form-field", 11);
        \u0275\u0275element(115, "input", 54);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(116, "div")(117, "label", 55);
        \u0275\u0275text(118, "Short URL Public Key");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(119, "mat-form-field", 11);
        \u0275\u0275element(120, "input", 56);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(121, "div")(122, "label", 57);
        \u0275\u0275text(123, "Week Start");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(124, "mat-form-field", 11)(125, "mat-select", 58);
        \u0275\u0275repeaterCreate(126, ConciergeSettingsFormModalComponent_For_127_Template, 2, 2, "mat-option", 40, _forTrack03);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(128, "mat-hint");
        \u0275\u0275text(129, " Day of the week to show initially on various calendars ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(130, "div")(131, "label", 59);
        \u0275\u0275text(132, "Currency");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(133, "mat-form-field", 11)(134, "mat-select", 60);
        ...
        \u0275\u0275elementStart(135, "mat-option", 61)(136, "input", 62);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275repeaterCreate(137, ConciergeSettingsFormModalComponent_For_138_Template, 2, 2, "mat-option", 40, _forTrack12);
        \u0275\u0275conditionalCreate(139, ConciergeSettingsFormModalComponent_Conditional_139_Template, 2, 0, "mat-option", 63);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(140, "mat-hint");
        \u0275\u0275text(141, " ISO 4217 currency code for pricing ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(142, "div", 64);
        \u0275\u0275element(143, "settings-toggle", 65)(144, "settings-toggle", 66)(145, "settings-toggle", 67)(146, "settings-toggle", 68)(147, "settings-toggle", 69);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(148, ConciergeSettingsFormModalComponent_Conditional_148_Template, 4, 0, "section", 70);
        \u0275\u0275conditionalCreate(149, ConciergeSettingsFormModalComponent_Conditional_149_Template, 109, 3, "section", 71);
        \u0275\u0275conditionalCreate(150, ConciergeSettingsFormModalComponent_Conditional_150_Template, 15, 3, "section", 72);
        \u0275\u0275conditionalCreate(151, ConciergeSettingsFormModalComponent_Conditional_151_Template, 59, 21, "section", 73);
        \u0275\u0275conditionalCreate(152, ConciergeSettingsFormModalComponent_Conditional_152_Template, 60, 3, "section", 74);
        \u0275\u0275conditionalCreate(153, ConciergeSettingsFormModalComponent_Conditional_153_Template, 63, 6, "section", 75);
        \u0275\u0275conditionalCreate(154, ConciergeSettingsFormModalComponent_Conditional_154_Template, 46, 3, "section", 76);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(8);
        \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(21, _c02));
        \u0275\u0275advance(7);
        \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(22, _c02));
        \u0275\u0275advance(48);
        \u0275\u0275conditional(ctx.form.value.features.includes("reports") ? 64 : -1);
        \u0275\u0275advance(9);
        \u0275\u0275property("ngModel", (ctx.form.value.banner == null ? null : ctx.form.value.banner.type) || "")("ngModelOptions", \u0275\u0275pureFunction0(23, _c02));
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.BANNER_TYPE);
        \u0275\u0275advance(6);
        \u0275\u0275property("ngModel", (ctx.form.value.banner == null ? null : ctx.form.value.banner.content) || "")("ngModelOptions", \u0275\u0275pureFunction0(24, _c02));
        \u0275\u0275advance(8);
        \u0275\u0275conditional(ctx.form.value.features.includes("events") ? 88 : -1);
        \u0275\u0275advance(38);
        \u0275\u0275repeater(ctx.WEEK_START);
        \u0275\u0275advance(10);
        \u0275\u0275property("ngModel", ctx.currency_filter())("ngModelOptions", \u0275\u0275pureFunction0(25, _c02));
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.filtered_currency_options());
        \u0275\u0275advance(2);
        \u0275\u0275conditional(!ctx.filtered_currency_options().length ? 139 : -1);
        \u0275\u0275advance(9);
        \u0275\u0275conditional(ctx.form.value.features.includes("attendance-report") ? 148 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("spaces") ? 149 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("desks") ? 150 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("visitors") ? 151 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("visitors") || ctx.form.value.features.includes("parking") || ctx.form.value.features.includes("lockers") ? 152 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("parking") || ctx.form.value.features.includes("parking-bookings") ? 153 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("lockers") ? 154 : -1);
      }
    }, dependencies: [
      MatDialogModule,
      FullscreenModalShellComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConciergeSettingsFormModalComponent, { className: "ConciergeSettingsFormModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/concierge-settings-form-modal.component.ts", lineNumber: 1747 });
})();
...
function VisitorKioskSettingsFormModalComponent_Conditional_109_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 65)(1, "div", 67)(2, "mat-form-field", 5)(3, "input", 68);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(4, "div", 69)(5, "input", 70);
    ...
    \u0275\u0275listener("click", function VisitorKioskSettingsFormModalComponent_Conditional_109_For_4_Template_button_click_6_listener() {
      const \u0275$index_210_r9 = \u0275\u0275restoreView(_r7).$index;
      const ctx_r9 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r9.removeLegend(\u0275$index_210_r9));
    });
...
function VisitorKioskSettingsFormModalComponent_Conditional_109_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 53)(1, "h3", 31);
    \u0275\u0275text(2, " Legend ");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, VisitorKioskSettingsFormModalComponent_Conditional_109_For_4_Template, 9, 6, "div", 65, \u0275\u0275repeaterTrackByIdentity);
    ...
    \u0275\u0275listener("click", function VisitorKioskSettingsFormModalComponent_Conditional_109_Template_button_click_5_listener() {
      ...
      return \u0275\u0275resetView(ctx_r9.addLegend());
    });
  ...
  if (rf & 2) {
    const ctx_r9 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275repeater((ctx_r9.form.value.explore == null ? null : ctx_r9.form.value.explore.legend) || \u0275\u0275pureFunction0(0, _c1));
  }
}
...
var VisitorKioskSettingsFormModalComponent = class _VisitorKioskSettingsFormModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisitorKioskSettingsFormModalComponent, selectors: [["visitor-kiosk-settings-form-modal"]], decls: 130, vars: 11, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-8", 3, "formGroup"], ["general", "", 1, "bg-base-100", "space-y-2", "rounded-sm"], ["for", "logo_light"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "logo_light", "formControlName", "logo_light"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions"], ["for", "logo_dark"], ["matInput", "", "name", "logo_dark", "formControlName", "logo_dark"], ["for", "welcome-background"], ["matInput", "", "name", "welcome-background", "formControlName", "welcome_background"], ["for", "default-route"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "name", "welcome-message", "formControlName", "welcome_message", "placeholder", "Welcome to PlaceOS Self Service Kiosk"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Enable Induction", "formControlName", "induction_enabled"], ["name", "Induction after Confirm Details", "formControlName", "induction_after_details"], ["name", "Allow Self Registration", "formControlName", "allow_self_registration"], ["name", "Allow setting visitor pass number", "formControlName", "allow_pass_number"], ["name", "Allow Printing Label", "formControlName", "allow_printing_label"], ["name", "Allow Visitor Photo", "formControlName", "allow_user_photo"], ["name", "Allow Registration Time Options", "formControlName", "allow_registration_time_options"], ["name", "Allow Beverages", "formControlName", "allow_beverages"], ["name", "Hide Explore Map option", "formControlName", "hide_explore"], ["name", "Hide Building Image", "formControlName", "hide_building_image"], ["for", "standalone-visitor-location"], ["matInput", "", "name", "standalone-visitor-location", "formControlName", "standalone_visitor_location", "placeholder", "zone-system-id"], ["for", "checked-in-template"], ["matInput", "", "name", "checked-in-template", "formControlName", "checked_in_template", "placeholder", "Welcome >visitor_name<"], ["formGroupName", "visitor_label_size", 1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "px-2", "py-1", "font-medium"], [1, "grid", "gap-4", "md:grid-cols-3"], ["for", "label-width"], ["matInput", "", "type", "number", "name", "label-width", "formControlName", "width"], ["for", "label-height"], ["matInput", "", "type", "number", "name", "label-height", "formControlName", "height"], ["for", "label-scale"], ["matInput", "", "type", "number", "name", "label-scale", "formControlName", "scale"], ["explore", "", "formGroupName", "explore", 1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], ["for", "disable"], ["name", "disable", "formControlName", "disable", "placeholder", "No disabled features", "multiple", ""], [3, "value"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], ["for", "disable-actions"], ["name", "disable-actions", "formControlName", "disable_actions", "placeholder", "No disabled actions", "multiple", ""], ["for", "available-period"], ["name", "disable-labels", "formControlName", "disable_labels", "placeholder", "No disabled labels", "multiple", ""], ["for", "disable-features"], ["name", "disable-features", "formControlName", "disable_features", "placeholder", "No disabled displays", "multiple", ""], ["for", "disable-styles"], ["name", "disable-styles", "formControlName", "disable_styles", "placeholder", "No disabled styles", "multiple", ""], [1, "border-base-300", "relative", "rounded-sm", "border", "p-4"], ["name", "Hide device fields", "formControlName", "hide_device_fields", "info", "Hides the MAC address, manufacturer, OS and SSID fields from device info tooltips"], ["name", "Show Legend", "formControlName", "show_legend"], ["name", "Hide Zones", "formControlName", "hide_zones"], ["name", "Show Booking QR Code", "formControlName", "show_booking_qr"], ["name", "Use defined polygons for zones", "formControlName", "use_zone_polygons"], ["name", "Show labels for zones", "formControlName", "show_zone_labels"], ["name", "Show zone sensor info", "formControlName", "show_zone_sensor_info"], ["booking", "", "formGroupName", "visitors", 1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], ["for", "max-duration"], ["name", "max-duration", "formControlName", "max_duration"], ["name", "Allow all day bookings", "formControlName", "allow_all_day"], [1, "mb-4", "flex", "items-center", "space-x-4"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "w-3/4", "flex-1"], ["matInput", "", "placeholder", "Legend Key", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matTooltip", "Legend Color", 1, "flex", "w-12", "items-center", "justify-center"], ["type", "color", 1, "border-base-content", "h-11", "rounded-lg", "border", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["icon", "", "matRipple", "", 1, "border-error", "text-error", "h-12", "w-12", "rounded-sm", "border", 3, "click"]], template: function VisitorKioskSettingsFormModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
        ...
        \u0275\u0275element(32, "settings-toggle", 18)(33, "settings-toggle", 19)(34, "settings-toggle", 20)(35, "settings-toggle", 21)(36, "settings-toggle", 22)(37, "settings-toggle", 23)(38, "settings-toggle", 24)(39, "settings-toggle", 25);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(40, "div")(41, "label", 26);
        \u0275\u0275text(42, " Standalone Visitor Location ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(43, "mat-form-field", 13);
        \u0275\u0275element(44, "input", 27);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(45, "div")(46, "label", 28);
        \u0275\u0275text(47, " Checked In Template ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(48, "mat-form-field", 13);
        ...
        \u0275\u0275text(61, "Height (mm)");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(62, "mat-form-field", 13);
        \u0275\u0275element(63, "input", 36);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(64, "div")(65, "label", 37);
        \u0275\u0275text(66, "Scale");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(67, "mat-form-field", 13);
        \u0275\u0275element(68, "input", 38);
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(69, "section", 39)(70, "h3", 31);
        \u0275\u0275text(71, " PlaceOS Maps ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(72, "div")(73, "label", 40);
        \u0275\u0275text(74, " Disabled Features ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(75, "mat-form-field", 13)(76, "mat-select", 41);
        \u0275\u0275repeaterCreate(77, VisitorKioskSettingsFormModalComponent_For_78_Template, 2, 2, "mat-option", 42, _forTrack04);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(79, "div", 43)(80, "div", 44)(81, "label", 45);
        \u0275\u0275text(82, " Disabled Feature Actions ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(83, "mat-form-field", 13)(84, "mat-select", 46);
        \u0275\u0275repeaterCreate(85, VisitorKioskSettingsFormModalComponent_For_86_Template, 2, 2, "mat-option", 42, _forTrack04);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(87, "div", 44)(88, "label", 47);
        \u0275\u0275text(89, " Disabled Feature Labels ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(90, "mat-form-field", 13)(91, "mat-select", 48);
        \u0275\u0275repeaterCreate(92, VisitorKioskSettingsFormModalComponent_For_93_Template, 2, 2, "mat-option", 42, _forTrack04);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(94, "div", 43)(95, "div", 44)(96, "label", 49);
        \u0275\u0275text(97, " Disabled Feature Displays ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(98, "mat-form-field", 13)(99, "mat-select", 50);
        \u0275\u0275repeaterCreate(100, VisitorKioskSettingsFormModalComponent_For_101_Template, 2, 2, "mat-option", 42, _forTrack04);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(102, "div", 44)(103, "label", 51);
        \u0275\u0275text(104, " Disabled Feature Styles ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(105, "mat-form-field", 13)(106, "mat-select", 52);
        \u0275\u0275repeaterCreate(107, VisitorKioskSettingsFormModalComponent_For_108_Template, 2, 2, "mat-option", 42, _forTrack04);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275conditionalCreate(109, VisitorKioskSettingsFormModalComponent_Conditional_109_Template, 7, 1, "div", 53);
        \u0275\u0275elementStart(110, "div", 15);
        \u0275\u0275element(111, "settings-toggle", 54)(112, "settings-toggle", 55)(113, "settings-toggle", 56)(114, "settings-toggle", 57)(115, "settings-toggle", 58)(116, "settings-toggle", 59)(117, "settings-toggle", 60);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(118, "section", 61)(119, "h3", 31);
        \u0275\u0275text(120, " Visitor Booking Rules ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(121, "div")(122, "label", 62);
        \u0275\u0275text(123, "Max Duration");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(124, "mat-form-field", 13)(125, "mat-select", 63);
        \u0275\u0275repeaterCreate(126, VisitorKioskSettingsFormModalComponent_For_127_Template, 2, 2, "mat-option", 42, _forTrack04);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(128, "div", 15);
        \u0275\u0275element(129, "settings-toggle", 64);
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275repeater(ctx.EXPLORE_FEATURE);
        \u0275\u0275advance(2);
        \u0275\u0275conditional((ctx.form.value.explore == null ? null : ctx.form.value.explore.show_legend) ? 109 : -1);
        \u0275\u0275advance(17);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisitorKioskSettingsFormModalComponent, { className: "VisitorKioskSettingsFormModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/visitor-kiosk-settings-form-modal.component.ts", lineNumber: 540 });
})();
...
function WorkplaceSettingsFormModalComponent_Conditional_153_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "settings-toggle", 61);
  }
}
...
function WorkplaceSettingsFormModalComponent_Conditional_165_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 80)(7, "div", 81)(8, "div")(9, "label", 82);
    \u0275\u0275text(10, " Available Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 83);
    \u0275\u0275repeaterCreate(13, WorkplaceSettingsFormModalComponent_Conditional_165_For_14_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-hint");
    \u0275\u0275text(16, " Number of days ahead the user is able to book ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div")(18, "label", 84);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div")(27, "label", 86);
    \u0275\u0275text(28, " Max Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "mat-form-field", 11)(30, "mat-select", 87);
    \u0275\u0275repeaterCreate(31, WorkplaceSettingsFormModalComponent_Conditional_165_For_32_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "mat-hint");
    \u0275\u0275text(34, " Max duration for single day bookings ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(35, "div", 34)(36, "div")(37, "label", 88);
    \u0275\u0275text(38, " Default Setup Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-form-field", 11)(40, "mat-select", 89);
    \u0275\u0275repeaterCreate(41, WorkplaceSettingsFormModalComponent_Conditional_165_For_42_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(43, "div")(44, "label", 90);
    \u0275\u0275text(45, " Default Breakdown Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "mat-form-field", 11)(47, "mat-select", 91);
    \u0275\u0275repeaterCreate(48, WorkplaceSettingsFormModalComponent_Conditional_165_For_49_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(50, "div")(51, "label", 92);
    \u0275\u0275text(52, " Cache Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "mat-form-field", 11)(54, "mat-select", 93);
    \u0275\u0275repeaterCreate(55, WorkplaceSettingsFormModalComponent_Conditional_165_For_56_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "mat-hint");
    \u0275\u0275text(58, " Number of days ahead to grab bookings from the room driver ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(59, "div", 94)(60, "div")(61, "label", 95);
    \u0275\u0275text(62, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "mat-form-field", 11)(64, "mat-select", 96);
    \u0275\u0275repeaterCreate(65, WorkplaceSettingsFormModalComponent_Conditional_165_For_66_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(67, "div")(68, "label", 97);
    \u0275\u0275text(69, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "mat-form-field", 11)(71, "mat-select", 98);
    \u0275\u0275repeaterCreate(72, WorkplaceSettingsFormModalComponent_Conditional_165_For_73_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(74, "div", 57);
    \u0275\u0275element(75, "settings-toggle", 99)(76, "settings-toggle", 100)(77, "settings-toggle", 101)(78, "settings-toggle", 102)(79, "settings-toggle", 103)(80, "settings-toggle", 104)(81, "settings-toggle", 105)(82, "settings-toggle", 106)(83, "settings-toggle", 107)(84, "settings-toggle", 108)(85, "settings-toggle", 109)(86, "settings-toggle", 110)(87, "settings-toggle", 111)(88, "settings-toggle", 112)(89, "settings-toggle", 113)(90, "settings-toggle", 114)(91, "settings-toggle", 115)(92, "settings-toggle", 116)(93, "settings-toggle", 117)(94, "settings-toggle", 118)(95, "settings-toggle", 119)(96, "settings-toggle", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "div", 121)(98, "div")(99, "label", 122);
    \u0275\u0275text(100, " All Day Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(101, "mat-form-field", 11)(102, "mat-select", 123);
    \u0275\u0275repeaterCreate(103, WorkplaceSettingsFormModalComponent_Conditional_165_For_104_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(105, "div")(106, "label", 124);
    \u0275\u0275text(107, " All Day End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(108, "mat-form-field", 11)(109, "mat-select", 125);
    \u0275\u0275repeaterCreate(110, WorkplaceSettingsFormModalComponent_Conditional_165_For_111_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    ...
    \u0275\u0275repeater(ctx_r4.MAX_DURATION_FULL);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r4.SETUP_BREAKDOWN);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.SETUP_BREAKDOWN);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.CACHE_DURATION);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_START);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_END);
...
function WorkplaceSettingsFormModalComponent_Conditional_166_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 80)(7, "div", 81)(8, "div")(9, "label", 86);
    \u0275\u0275text(10, " Max Duration ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 87);
    \u0275\u0275repeaterCreate(13, WorkplaceSettingsFormModalComponent_Conditional_166_For_14_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div")(16, "label", 82);
    \u0275\u0275text(17, " Available Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "mat-form-field", 11)(19, "mat-select", 126);
    \u0275\u0275repeaterCreate(20, WorkplaceSettingsFormModalComponent_Conditional_166_For_21_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "mat-hint");
    \u0275\u0275text(23, " Number of days ahead the user is able to book ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "div", 94)(25, "div")(26, "label", 127);
    \u0275\u0275text(27, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "mat-form-field", 11)(29, "mat-select", 128);
    \u0275\u0275repeaterCreate(30, WorkplaceSettingsFormModalComponent_Conditional_166_For_31_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div")(33, "label", 129);
    \u0275\u0275text(34, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-form-field", 11)(36, "mat-select", 130);
    \u0275\u0275repeaterCreate(37, WorkplaceSettingsFormModalComponent_Conditional_166_For_38_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(39, "div", 57);
    \u0275\u0275element(40, "settings-toggle", 99)(41, "settings-toggle", 100)(42, "settings-toggle", 131)(43, "settings-toggle", 132)(44, "settings-toggle", 133)(45, "settings-toggle", 134)(46, "settings-toggle", 135)(47, "settings-toggle", 136)(48, "settings-toggle", 137)(49, "settings-toggle", 138)(50, "settings-toggle", 139)(51, "settings-toggle", 140)(52, "settings-toggle", 141)(53, "settings-toggle", 142)(54, "settings-toggle", 120)(55, "settings-toggle", 117);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    ...
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "desks");
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.MAX_DURATION_SHORT);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.AVAILABLE_PERIOD_EXTENDED);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_START);
...
function WorkplaceSettingsFormModalComponent_Conditional_167_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 80)(7, "div", 81)(8, "div", 94)(9, "div")(10, "label", 143);
    \u0275\u0275text(11, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-form-field", 11)(13, "mat-select", 144);
    \u0275\u0275repeaterCreate(14, WorkplaceSettingsFormModalComponent_Conditional_167_For_15_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "div")(17, "label", 145);
    \u0275\u0275text(18, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 11)(20, "mat-select", 146);
    \u0275\u0275repeaterCreate(21, WorkplaceSettingsFormModalComponent_Conditional_167_For_22_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(23, "div", 57);
    \u0275\u0275element(24, "settings-toggle", 99)(25, "settings-toggle", 100)(26, "settings-toggle", 117)(27, "settings-toggle", 102)(28, "settings-toggle", 147)(29, "settings-toggle", 148)(30, "settings-toggle", 149);
    \u0275\u0275elementContainerStart(31);
    \u0275\u0275elementStart(32, "settings-toggle", 150);
    \u0275\u0275listener("ngModelChange", function WorkplaceSettingsFormModalComponent_Conditional_167_Template_settings_toggle_ngModelChange_32_listener($event) {
      \u0275\u0275restoreView(_r20);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.form.controls.visitors.patchValue({ show_calendar_links: $event }));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(33);
    \u0275\u0275elementStart(34, "settings-toggle", 151);
    \u0275\u0275listener("ngModelChange", function WorkplaceSettingsFormModalComponent_Conditional_167_Template_settings_toggle_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r20);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.form.controls.visitors.patchValue({ allow_international: $event }));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 121)(36, "div")(37, "label", 152);
    \u0275\u0275text(38, " All Day Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "mat-form-field", 11)(40, "mat-select", 153);
    \u0275\u0275repeaterCreate(41, WorkplaceSettingsFormModalComponent_Conditional_167_For_42_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(43, "div")(44, "label", 154);
    \u0275\u0275text(45, " All Day End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "mat-form-field", 11)(47, "mat-select", 155);
    \u0275\u0275repeaterCreate(48, WorkplaceSettingsFormModalComponent_Conditional_167_For_49_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    ...
    \u0275\u0275repeater(ctx_r4.BOOKABLE_HOUR_END);
    \u0275\u0275advance(11);
    \u0275\u0275property("ngModel", ctx_r4.form.value.visitors.show_calendar_links)("ngModelOptions", \u0275\u0275pureFunction0(7, _c04));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", ctx_r4.form.value.visitors.allow_international)("ngModelOptions", \u0275\u0275pureFunction0(8, _c04));
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.BLOCK_START);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.BLOCK_END);
...
function WorkplaceSettingsFormModalComponent_Conditional_168_Conditional_45_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r32 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 173)(1, "div", 175)(2, "mat-form-field", 5)(3, "input", 176);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(4, "div", 177)(5, "input", 178);
    ...
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_168_Conditional_45_For_4_Template_button_click_6_listener() {
      ...
      return \u0275\u0275resetView(ctx_r4.removeLegend(\u0275$index_787_r34));
    });
    \u0275\u0275elementStart(7, "icon");
    \u0275\u0275text(8, "delete");
    \u0275\u0275elementEnd()()();
...
function WorkplaceSettingsFormModalComponent_Conditional_168_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 165)(1, "h3", 33);
    \u0275\u0275text(2, " Legend ");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, WorkplaceSettingsFormModalComponent_Conditional_168_Conditional_45_For_4_Template, 9, 6, "div", 173, \u0275\u0275repeaterTrackByIdentity);
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r4.form.value.explore.legend || \u0275\u0275pureFunction0(0, _c7));
  }
}
function WorkplaceSettingsFormModalComponent_Conditional_168_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function WorkplaceSettingsFormModalComponent_Conditional_168_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleGroup("explore"));
    });
    \u0275\u0275elementStart(4, "icon");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 80)(7, "div", 81)(8, "div")(9, "label", 156);
    \u0275\u0275text(10, " Disabled Features ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 157);
    \u0275\u0275repeaterCreate(13, WorkplaceSettingsFormModalComponent_Conditional_168_For_14_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 34)(16, "div", 35)(17, "label", 158);
    \u0275\u0275text(18, " Disabled Feature Actions ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 11)(20, "mat-select", 159);
    \u0275\u0275repeaterCreate(21, WorkplaceSettingsFormModalComponent_Conditional_168_For_22_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div", 35)(24, "label", 82);
    \u0275\u0275text(25, " Disabled Feature Labels ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "mat-form-field", 11)(27, "mat-select", 160);
    \u0275\u0275repeaterCreate(28, WorkplaceSettingsFormModalComponent_Conditional_168_For_29_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(30, "div", 34)(31, "div", 35)(32, "label", 161);
    \u0275\u0275text(33, " Disabled Feature Displays ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "mat-form-field", 11)(35, "mat-select", 162);
    \u0275\u0275repeaterCreate(36, WorkplaceSettingsFormModalComponent_Conditional_168_For_37_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(38, "div", 35)(39, "label", 163);
    \u0275\u0275text(40, " Disabled Feature Styles ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "mat-form-field", 11)(42, "mat-select", 164);
    \u0275\u0275repeaterCreate(43, WorkplaceSettingsFormModalComponent_Conditional_168_For_44_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(45, WorkplaceSettingsFormModalComponent_Conditional_168_Conditional_45_Template, 7, 1, "div", 165);
    \u0275\u0275elementStart(46, "div", 57);
    \u0275\u0275element(47, "settings-toggle", 166)(48, "settings-toggle", 167)(49, "settings-toggle", 168)(50, "settings-toggle", 169)(51, "settings-toggle", 170)(52, "settings-toggle", 171)(53, "settings-toggle", 172);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.shown_group() === "explore" ? "chevron_left" : "keyboard_arrow_down");
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r4.shown_group() === "explore");
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.EXPLORE_FEATURE);
    \u0275\u0275advance(8);
    \u0275\u0275repeater(ctx_r4.EXPLORE_FEATURE);
    \u0275\u0275advance(7);
    \u0275\u0275repeater(ctx_r4.EXPLORE_FEATURE);
    ...
    \u0275\u0275repeater(ctx_r4.EXPLORE_FEATURE);
    \u0275\u0275advance(2);
    \u0275\u0275conditional((ctx_r4.form.value.explore == null ? null : ctx_r4.form.value.explore.show_legend) ? 45 : -1);
  }
}
...
function WorkplaceSettingsFormModalComponent_Conditional_169_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 77)(1, "h3", 33);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 87);
    \u0275\u0275repeaterCreate(13, WorkplaceSettingsFormModalComponent_Conditional_169_For_14_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div")(16, "label", 82);
    \u0275\u0275text(17, " Available Period ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "mat-form-field", 11)(19, "mat-select", 126);
    \u0275\u0275repeaterCreate(20, WorkplaceSettingsFormModalComponent_Conditional_169_For_21_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "mat-hint");
    \u0275\u0275text(23, " Number of days ahead the user is able to book ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "div", 94)(25, "div")(26, "label", 180);
    \u0275\u0275text(27, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "mat-form-field", 11)(29, "mat-select", 181);
    \u0275\u0275repeaterCreate(30, WorkplaceSettingsFormModalComponent_Conditional_169_For_31_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div")(33, "label", 182);
    \u0275\u0275text(34, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "mat-form-field", 11)(36, "mat-select", 183);
    \u0275\u0275repeaterCreate(37, WorkplaceSettingsFormModalComponent_Conditional_169_For_38_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(39, "div", 57);
    \u0275\u0275element(40, "settings-toggle", 99)(41, "settings-toggle", 100)(42, "settings-toggle", 184)(43, "settings-toggle", 185)(44, "settings-toggle", 186)(45, "settings-toggle", 187)(46, "settings-toggle", 102)(47, "settings-toggle", 188)(48, "settings-toggle", 189)(49, "settings-toggle", 117);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
...
function WorkplaceSettingsFormModalComponent_Conditional_170_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "section", 78)(1, "h3", 33);
    \u0275\u0275text(2, " Locker Bookings ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 79);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-form-field", 11)(12, "mat-select", 87);
    \u0275\u0275repeaterCreate(13, WorkplaceSettingsFormModalComponent_Conditional_170_For_14_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 94)(16, "div")(17, "label", 190);
    \u0275\u0275text(18, " Bookable Start ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 11)(20, "mat-select", 191);
    \u0275\u0275repeaterCreate(21, WorkplaceSettingsFormModalComponent_Conditional_170_For_22_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div")(24, "label", 192);
    \u0275\u0275text(25, " Bookable End ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "mat-form-field", 11)(27, "mat-select", 193);
    \u0275\u0275repeaterCreate(28, WorkplaceSettingsFormModalComponent_Conditional_170_For_29_Template, 2, 2, "mat-option", 38, _forTrack05);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(30, "div", 57);
    \u0275\u0275element(31, "settings-toggle", 99)(32, "settings-toggle", 100)(33, "settings-toggle", 194)(34, "settings-toggle", 189)(35, "settings-toggle", 186)(36, "settings-toggle", 117)(37, "settings-toggle", 195)(38, "settings-toggle", 196);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
...
var WorkplaceSettingsFormModalComponent = class _WorkplaceSettingsFormModalComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WorkplaceSettingsFormModalComponent, selectors: [["workplace-settings-form-modal"]], decls: 171, vars: 36, consts: [[3, "confirm", "heading", "loading"], [1, "flex", "flex-col", "space-y-8", "pb-4", 3, "formGroup"], ["general", "", 1, "bg-base-100", "space-y-2", "rounded-sm"], ["for", "logo_light"], [1, "mb-4", "flex", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-full"], ["matInput", "", "name", "logo_light", "formControlName", "logo_light"], ["ngModel", "", 3, "ngModelChange", "ngModelOptions"], ["for", "logo_dark"], ["matInput", "", "name", "logo_dark", "formControlName", "logo_dark"], ["for", "features"], ["appearance", "outline", 1, "w-full"], ["name", "features", "formControlName", "features", "multiple", ""], ["value", "spaces"], ["value", "desks"], ["value", "explore"], ["value", "parking"], ["value", "visitor-invite"], ["value", "lockers"], ["value", "help"], ["value", "schedule"], ["value", "wfh"], ["value", "support-ticket"], ["value", "group-events"], ["value", "deals-n-offers"], ["name", "hide-global-search-items", "formControlName", "hide_global_search_items", "multiple", ""], ["value", "mapspeople"], ["value", "emergency_contacts"], ["value", "features"], ["value", "points_of_interest"], ["value", "contacts"], ["value", "users"], [1, "border-base-300", "relative", "rounded-sm", "border", "px-4", "pt-4", "pb-2"], [1, "bg-base-100", "absolute", "top-0", "left-4", "-translate-y-1/2", "rounded-sm", "px-2", "py-1", "font-medium"], [1, "flex", "items-center", "space-x-4"], [1, "flex-1"], ["for", "banner-type"], ["name", "banner-type", 3, "ngModelChange", "ngModel", "ngModelOptions"], [3, "value"], ["matInput", "", "name", "banner-message", "placeholder", "Banner Message", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "external-support-url"], ["matInput", "", "name", "external-support-url", "formControlName", "external_support_url", "placeholder", "https://support.com/ticket"], ["for", "support-email"], ["matInput", "", "name", "support-email", "formControlName", "support_email", "placeholder", "support@acme.tech"], ["for", "default-route"], ["matInput", "", "name", "default-route", "formControlName", "default_route", "placeholder", "/landing"], ["for", "catering-provider"], ["matInput", "", "name", "catering-provider", "formControlName", "catering_provider", "placeholder", "Catering Provider"], ["for", "week-start"], ["name", "week-start", "formControlName", "week_start", "placeholder", "Sunday"], ["for", "currency"], ["name", "currency", "formControlName", "currency", "placeholder", "Select currency code", 3, "openedChange"], ["disabled", "", 1, "!h-auto", "!py-2"], ["matInput", "", "placeholder", "Search currency code or name", 3, "ngModelChange", "click", "keydown", "ngModel", "ngModelOptions"], ["disabled", ""], ["for", "locales"], ["name", "locales", "formControlName", "locales", "multiple", "", "placeholder", "Select locales"], [1, "-mx-2", "flex", "flex-wrap", "items-center"], ["name", "Use 24 hour time", "formControlName", "use_24_hour_time"], ["name", "Use region over building", "formControlName", "use_region"], ["name", "Use imperial units for measurements", "formControlName", "use_imperial_units"], ["name", "Allow images in support tickets", "formControlName", "allow_support_ticket_images"], ["name", "Search only authenticated users", "formControlName", "basic_user_search"], ["name", "Only authenticated colleagues", "info", "Will limit the available users to add as colleagues to only\n those who have authenticated with the application", "formControlName", "colleagues_require_auth"], ["name", "Hide landing sidebar", "formControlName", "hide_landing_sidebar"], ["name", "Hide landing spaces", "formControlName", "hide_landing_spaces"], ["name", "Hide landing rooms", "formControlName", "hide_landing_rooms"], ["name", "Hide colleagues", "formControlName", "hide_colleagues"], ["name", "Show landing quick links", "formControlName", "show_quick_links"], ["name", "Show landing quick book", "formControlName", "show_quick_book"], ["name", "Allow dark mode", "formControlName", "allow_dark_mode"], ["name", "Show changelog link", "formControlName", "show_changelog"], ["name", "Show global search", "formControlName", "global_search"], ["events", "", "id", "feature-spaces", "formGroupName", "events", 1, "border-base-300", "relative", "rounded-sm", "border"], ["desks", "", "id", "feature-desks", "formGroupName", "desks", 1, "border-base-300", "relative", "rounded-sm", "border"], ["bookings", "", "id", "feature-bookings", "formGroupName", "bookings", 1, "border-base-300", "relative", "rounded-sm", "border"], ["explore", "", "id", "feature-explore", "formGroupName", "explore", 1, "border-base-300", "relative", "rounded-sm", "border"], ["parking", "", "id", "feature-parking", "formGroupName", "parking", 1, "border-base-300", "relative", "rounded-sm", "border"], ["lockers", "", "id", "feature-lockers", "formGroupName", "lockers", 1, "border-base-300", "relative", "rounded-sm", "border"], ["icon", "", "matRipple", "", 1, "bg-base-100", "absolute", "top-0", "right-4", "-translate-y-1/2", 3, "click"], ["collapsible", ""], [1, "content", "px-4", "pt-4", "pb-2"], ["for", "available-period"], ["name", "available-period", "formControlName", "allowed_future_days"], ["for", "force-host"], ["matInput", "", "name", "force-host", "formControlName", "force_host", "placeholder", "global.host@acme.tech"], ["for", "max-duration"], ["name", "max-duration", "formControlName", "max_duration"], ["for", "setup"], ["name", "setup", "formControlName", "setup", "placeholder", "No default setup"], ["for", "breakdown"], ["name", "breakdown", "formControlName", "breakdown", "placeholder", "No default breakdown"], ["for", "cache-duration"], ["name", "cache-duration", "formControlName", "cache_duration_in_days"], ["formGroupName", "bookable_hours", 1, "grid", "grid-cols-1", "gap-4", "md:grid-cols-2"], ["for", "events-bookable-start"], ["name", "events-bookable-start", "formControlName", "start", "placeholder", "None"], ["for", "events-bookable-end"], ["name", "events-bookable-end", "formControlName", "end", "placeholder", "None"], ["name", "Allow all day bookings", "formControlName", "allow_all_day"], ["name", "Default bookings to all day", "formControlName", "all_day_default"], ["name", "Disable booking requests", "formControlName", "booking_unavailable", "info", "Prevent making backend requests for bookings and give users links to create the booking in their own calendars"], ["name", "Allow booking for other users", "formControlName", "can_book_for_others"], ["name", "Allow booking for any users", "formControlName", "can_book_for_anyone"], ["name", "Allow booking with assets", "formControlName", "has_assets"], ["name", "Hide attendee actions", "formControlName", "hide_user_actions"], ["name", "Allow booking multiple spaces", "formControlName", "multiple_spaces"], ["name", "Force room as host", "formControlName", "room_as_host"], ["name", "Allow external attendees", "formControlName", "allow_externals"], ["name", "Enforce room capacity limits", "formControlName", "strict_capacity_check"], ["name", "Allow Visibility options", "formControlName", "allow_visibility"], ["name", "Disable notes field", "formControlName", "hide_notes"], ["name", "Hide attendees field", "formControlName", "hide_attendees"], ["name", "Hide nearby desk action", "info", "Hide the book nearby desks button on the meeting success view", "formControlName", "hide_nearby_desks"], ["name", "Allow recurring meetings", "formControlName", "allow_recurrence"], ["name", "Allow multi-day bookings", "formControlName", "allow_multiday"], ["name", "Use PlaceOS bookings", "formControlName", "use_bookings"], ["name", "Display times with building timezone", "formControlName", "use_building_timezone"], ["name", "Allow daily all-day recurrence", "formControlName", "allow_daily_allday_recurrence"], ["name", "Disable standalone bookings", "formControlName", "no_standalone"], ["name", "Hide End Time option", "formControlName", "hide_end_time"], ["formGroupName", "all_day_period", 1, "grid", "grid-cols-1", "gap-4", "md:grid-cols-2"], ["for", "events-all-day-start"], ["name", "events-all-day-start", "formControlName", "start"], ["for", "events-all-day-end"], ["name", "events-all-day-end", "formControlName", "end"], ["name", "available-period", "formControlName", "available_period"], ["for", "desks-bookable-start"], ["name", "desks-bookable-start", "formControlName", "start"], ["for", "desks-bookable-end"], ["name", "desks-bookable-end", "formControlName", "end"], ["name", "Allow group bookings", "formControlName", "allow_groups"], ["name", "Allow time changes", "formControlName", "allow_time_changes"], ["name", "Auto-allocation", "formControlName", "auto_allocation"], ["name", "Allow booking for others", "formControlName", "can_book_for_others"], ["name", "Allow also booking a locker", "formControlName", "can_book_lockers"], ["name", "Allow requesting assets with booking", "formControlName", "has_assets"], ["name", "Allow Recurring Desk bookings", "formControlName", "allow_recurrence"], ["name", "Auto-checkin map bookingss", "formControlName", "auto_checkin"], ["name", "Default to desk select modal to map view", "formControlName", "default_select_as_map"], ["name", "Show calendar links after booking", "formControlName", "show_calendar_links"], ["name", "Enabled desk height", "formControlName", "height_enabled"], ["name", "Hide Checkin Options", "formControlName", "hide_checkin"], ["for", "bookings-bookable-start"], ["name", "bookings-bookable-start", "formControlName", "start"], ["for", "bookings-bookable-end"], ["name", "bookings-bookable-end", "formControlName", "end"], ["name", "Allow booking multiple visitors", "formControlName", "multiple_visitors"], ["name", "Auto-approve bookings", "formControlName", "no_approval"], ["name", "Allow booking with assets", "formControlName", "allow_assets"], ["name", "Show calendar links after visitor invite", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["name", "Allow international flag for visitors", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["for", "bookings-all-day-start"], ["name", "bookings-all-day-start", "formControlName", "start", "placeholder", "None"], ["for", "bookings-all-day-end"], ["name", "bookings-all-day-end", "formControlName", "end", "placeholder", "None"], ["for", "disable"], ["name", "disable", "formControlName", "disable", "placeholder", "No disabled features", "multiple", ""], ["for", "disable-actions"], ["name", "disable-actions", "formControlName", "disable_actions", "placeholder", "No disabled actions", "multiple", ""], ["name", "disable-labels", "formControlName", "disable_labels", "placeholder", "No disabled labels", "multiple", ""], ["for", "disable-features"], ["name", "disable-features", "formControlName", "disable_features", "placeholder", "No disabled displays", "multiple", ""], ["for", "disable-styles"], ["name", "disable-styles", "formControlName", "disable_styles", "placeholder", "No disabled styles", "multiple", ""], [1, "border-base-300", "relative", "rounded-sm", "border", "p-4"], ["name", "Hide device fields", "formControlName", "hide_device_fields", "info", "Hides the MAC address, manufacturer, OS and SSID fields from device info tooltips"], ["name", "Show Legend", "formControlName", "show_legend"], ["name", "Hide Zones", "formControlName", "hide_zones"], ["name", "Show Booking QR Code", "formControlName", "show_booking_qr"], ["name", "Use defined polygons for zones", "formControlName", "use_zone_polygons"], ["name", "Show labels for zones", "formControlName", "show_zone_labels"], ["name", "Show zone sensor info", "formControlName", "show_zone_sensor_info"], [1, "mb-4", "flex", "items-center", "space-x-4"], ["btn", "", "matRipple", "", 1, "w-full", 3, "click"], [1, "w-3/4", "flex-1"], ["matInput", "", "placeholder", "Legend Key", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["matTooltip", "Legend Color", 1, "flex", "w-12", "items-center", "justify-center"], ["type", "color", 1, "border-base-content", "h-11", "rounded-lg", "border", 3, "ngModelChange", "ngModel", "ngModelOptions"], ["icon", "", "matRipple", "", 1, "border-error", "text-error", "h-12", "w-12", "rounded-sm", "border", 3, "click"], ["for", "parking-bookable-start"], ["name", "parking-bookable-start", "formControlName", "start"], ["for", "parking-bookable-end"], ["name", "parking-bookable-end", "formControlName", "end"], ["name", "Show assigned users on parking map", "formControlName", "show_users"], ["name", "Show parking status details on map", "formControlName", "show_status_details"], ["name", "Allow user selecting booking time", "formControlName", "allow_time_changes"], ["name", "Auto-allocate parking spaces", "formControlName", "auto_allocation"], ["name", "Allow recurring parking bookings", "formControlName", "allow_recurrence"], ["name", "Hide End time option", "formControlName", "hide_end_time"], ["for", "lockers-bookable-start"], ["name", "lockers-bookable-start", "formControlName", "start"], ["for", "lockers-bookable-end"], ["name", "lockers-bookable-end", "formControlName", "end"], ["name", "Show Calendar Links after booking", "formControlName", "show_calendar_links"], ["name", "Disable Date selection", "formControlName", "disabled_date_select"], ["name", "Disable start time option", "formControlName", "disabled_start_time"]], template: function WorkplaceSettingsFormModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "fullscreen-modal-shell", 0);
        ...
        \u0275\u0275repeaterCreate(74, WorkplaceSettingsFormModalComponent_For_75_Template, 2, 2, "mat-option", 38, _forTrack05);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(76, "div", 35)(77, "label", 36);
        \u0275\u0275text(78, "Message");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(79, "mat-form-field", 11)(80, "input", 39);
        \u0275\u0275listener("ngModelChange", function WorkplaceSettingsFormModalComponent_Template_input_ngModelChange_80_listener($event) {
          return ctx.form.patchValue({ banner: { id: ctx.date_string, type: (ctx.form.value.banner == null ? null : ctx.form.value.banner.type) || "", content: $event } });
        });
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(81, "div")(82, "label", 40);
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(97, "div")(98, "label", 44);
        \u0275\u0275text(99, "Default Route");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(100, "mat-form-field", 11);
        \u0275\u0275element(101, "input", 45);
        \u0275\u0275elementStart(102, "mat-hint");
        \u0275\u0275text(103, " Main page of the application ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(104, "div")(105, "label", 46);
        \u0275\u0275text(106, "Catering Provider");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(107, "mat-form-field", 11);
        \u0275\u0275element(108, "input", 47);
        \u0275\u0275elementStart(109, "mat-hint");
        \u0275\u0275text(110, " Name of the catering provider to force orders to use ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(111, "div")(112, "label", 48);
        \u0275\u0275text(113, "Week Start");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(114, "mat-form-field", 11)(115, "mat-select", 49);
        \u0275\u0275repeaterCreate(116, WorkplaceSettingsFormModalComponent_For_117_Template, 2, 2, "mat-option", 38, _forTrack05);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(118, "mat-hint");
        \u0275\u0275text(119, " Day of the week to show initially on various calendars ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(120, "div")(121, "label", 50);
        \u0275\u0275text(122, "Currency");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(123, "mat-form-field", 11)(124, "mat-select", 51);
        \u0275\u0275listener("openedChange", function WorkplaceSettingsFormModalComponent_Template_mat_select_openedChange_124_listener($event) {
          return ctx.onCurrencySelectStateChange($event);
        });
        \u0275\u0275elementStart(125, "mat-option", 52)(126, "input", 53);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275repeaterCreate(127, WorkplaceSettingsFormModalComponent_For_128_Template, 2, 2, "mat-option", 38, _forTrack13);
        \u0275\u0275conditionalCreate(129, WorkplaceSettingsFormModalComponent_Conditional_129_Template, 2, 0, "mat-option", 54);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(130, "mat-hint");
        \u0275\u0275text(131, " ISO 4217 currency code for pricing ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(132, "div")(133, "label", 55);
        \u0275\u0275text(134, "Locales");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(135, "mat-form-field", 11)(136, "mat-select", 56)(137, "mat-option", 38);
        \u0275\u0275text(138, " English (British) ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(139, "mat-option", 38);
        \u0275\u0275text(140, " English (US) ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(141, "mat-option", 38);
        \u0275\u0275text(142, " French ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(143, "mat-option", 38);
        \u0275\u0275text(144, " Spanish ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(145, "mat-option", 38);
        \u0275\u0275text(146, " Portuguese ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(147, "mat-option", 38);
        \u0275\u0275text(148, " Arabic ");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(149, "div", 57);
        \u0275\u0275element(150, "settings-toggle", 58)(151, "settings-toggle", 59)(152, "settings-toggle", 60);
        \u0275\u0275conditionalCreate(153, WorkplaceSettingsFormModalComponent_Conditional_153_Template, 1, 0, "settings-toggle", 61);
        \u0275\u0275element(154, "settings-toggle", 62)(155, "settings-toggle", 63)(156, "settings-toggle", 64)(157, "settings-toggle", 65)(158, "settings-toggle", 66)(159, "settings-toggle", 67)(160, "settings-toggle", 68)(161, "settings-toggle", 69)(162, "settings-toggle", 70)(163, "settings-toggle", 71)(164, "settings-toggle", 72);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(165, WorkplaceSettingsFormModalComponent_Conditional_165_Template, 112, 3, "section", 73);
        \u0275\u0275conditionalCreate(166, WorkplaceSettingsFormModalComponent_Conditional_166_Template, 56, 3, "section", 74);
        \u0275\u0275conditionalCreate(167, WorkplaceSettingsFormModalComponent_Conditional_167_Template, 50, 9, "section", 75);
        \u0275\u0275conditionalCreate(168, WorkplaceSettingsFormModalComponent_Conditional_168_Template, 54, 4, "section", 76);
        \u0275\u0275conditionalCreate(169, WorkplaceSettingsFormModalComponent_Conditional_169_Template, 50, 3, "section", 77);
        \u0275\u0275conditionalCreate(170, WorkplaceSettingsFormModalComponent_Conditional_170_Template, 39, 3, "section", 78);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275property("heading", ctx.heading())("loading", ctx.loading());
        ...
        \u0275\u0275property("formGroup", ctx.form);
        \u0275\u0275advance(8);
        \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(25, _c04));
        \u0275\u0275advance(7);
        \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(26, _c04));
        \u0275\u0275advance(57);
        \u0275\u0275property("ngModel", (ctx.form.value.banner == null ? null : ctx.form.value.banner.type) || "")("ngModelOptions", \u0275\u0275pureFunction0(27, _c04));
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.BANNER_TYPE);
        \u0275\u0275advance(6);
        \u0275\u0275property("ngModel", (ctx.form.value.banner == null ? null : ctx.form.value.banner.content) || "")("ngModelOptions", \u0275\u0275pureFunction0(28, _c04));
        \u0275\u0275advance(36);
        \u0275\u0275repeater(ctx.WEEK_START);
        \u0275\u0275advance(10);
        \u0275\u0275property("ngModel", ctx.currency_filter())("ngModelOptions", \u0275\u0275pureFunction0(29, _c04));
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.filtered_currency_options());
        \u0275\u0275advance(2);
        \u0275\u0275conditional(!ctx.filtered_currency_options().length ? 129 : -1);
        \u0275\u0275advance(8);
        \u0275\u0275property("value", \u0275\u0275pureFunction0(30, _c12));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", \u0275\u0275pureFunction0(31, _c2));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", \u0275\u0275pureFunction0(32, _c3));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", \u0275\u0275pureFunction0(33, _c4));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", \u0275\u0275pureFunction0(34, _c5));
        \u0275\u0275advance(2);
        \u0275\u0275property("value", \u0275\u0275pureFunction0(35, _c6));
        \u0275\u0275advance(6);
        \u0275\u0275conditional(ctx.form.value.features.includes("support-ticket") ? 153 : -1);
        \u0275\u0275advance(12);
        \u0275\u0275conditional((ctx.form.value.features == null ? null : ctx.form.value.features.includes("spaces")) ? 165 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("desks") ? 166 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("desks") || ctx.form.value.features.includes("parking") || ctx.form.value.features.includes("lockers") || ctx.form.value.features.includes("visitor-invite") ? 167 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("explore") ? 168 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("parking") ? 169 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.form.value.features.includes("lockers") ? 170 : -1);
      }
    }, dependencies: [
      MatDialogModule,
      FullscreenModalShellComponent,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WorkplaceSettingsFormModalComponent, { className: "WorkplaceSettingsFormModalComponent", filePath: "apps/concierge/src/app/ui/app-settings/workplace-settings-form-modal.component.ts", lineNumber: 1985 });
})();
...
var BuildingListComponent = class _BuildingListComponent {
  constructor() {
    ...
    this._dialog = inject(MatDialog);
    this.buildings = toSignal(this._manager.filtered_buildings, {
      initialValue: []
    });
    this.settings = {};
...
function LevelModalComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275repeaterCreate(9, LevelModalComponent_Conditional_4_For_10_Template, 2, 2, "mat-option", 7, _forTrack06);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 9, "APP.CONCIERGE.LEVELS_BUILDING_REQUIRED"));
  }
}
...
var LevelModalComponent = class _LevelModalComponent {
  ...
  async save() {
    ...
    const resp = await (data.id ? Wa(data.id, __spreadProps(__spreadValues({}, data), {
      name: `LEVEL ${Pt().description} ${data.display_name}`
    })) : Qa(__spreadProps(__spreadValues({}, data), {
      name: `LEVEL ${Pt().description} ${data.display_name}`
    }))).catch();
    if (resp.id)
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LevelModalComponent, selectors: [["level-modal"]], decls: 8, vars: 11, consts: [[3, "confirm", "heading", "loading"], ["system", "", 3, "formGroup"], [1, "flex", "flex-col"], [1, "flex", "space-x-4", "pb-4"], ["for", "zone"], ["appearance", "outline"], ["formControlName", "parent_id", 3, "placeholder"], [3, "value"], ["for", "display-name"], ["matInput", "", "name", "display-name", "formControlName", "display_name", 3, "placeholder"], ["formControlName", "parking", 1, "flex-1", 3, "name"], [1, "flex-1"], ["for", "map-id"], ["matInput", "", "name", "map-id", "formControlName", "map_id", 3, "placeholder"]], template: function LevelModalComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(4, LevelModalComponent_Conditional_4_Template, 14, 11, "div", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LevelModalComponent, { className: "LevelModalComponent", filePath: "apps/concierge/src/app/level-manager/level-modal.component.ts", lineNumber: 140 });
})();
...
var LevelListComponent = class _LevelListComponent {
  constructor() {
    ...
    this._clipboard = inject(Clipboard);
    this._dialog = inject(MatDialog);
    this.levels = toSignal(this._manager.filtered_levels, {
      initialValue: []
    });
...
var RegionModalComponent = class _RegionModalComponent extends AsyncHandler {
  ...
  async save() {
    ...
    this.loading.set(true);
    const resp = await (data.id ? Wa(data.id, __spreadProps(__spreadValues({}, data), {
      name: `REGION ${Pt().description} ${data.display_name}`
    })) : Qa(__spreadProps(__spreadValues({}, data), {
      name: `REGION ${Pt().description} ${data.display_name}`
    }))).catch();
    if (resp.id)
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegionModalComponent, selectors: [["region-modal"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 19, vars: 16, consts: [["auto", "matAutocomplete"], [3, "confirm", "heading", "loading"], [3, "formGroup"], [1, "flex", "flex-col"], ["for", "display-name"], ["appearance", "outline"], ["matPrefix", "", 1, "text-2xl"], ["matInput", "", "formControlName", "timezone", 3, "placeholder", "matAutocomplete"], [3, "value"], [3, "disabled"], ["matInput", "", "name", "display-name", "formControlName", "display_name", 3, "placeholder"]], template: function RegionModalComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(5);
        \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(13, 14, "COMMON.TIMEZONE"))("matAutocomplete", auto_r2);
        \u0275\u0275advance(4);
...
var RegionManagementService = class _RegionManagementService {
  ...
  editRegionMetadata(region = new Qt()) {
    const ref = this._dialog.open(AppSettingsModalComponent, {
      data: { zone: region }
    });
    ref.afterClosed().subscribe((data) => {
...
var RegionListComponent = class _RegionListComponent {
  constructor() {
    ...
    this._clipboard = inject(Clipboard);
    this._dialog = inject(MatDialog);
    this.regions = toSignal(this._manager.filtered_regions, {
      initialValue: []
    });
...
var ZoneManagerComponent = class _ZoneManagerComponent extends AsyncHandler {
  constructor() {
    ...
    this.selected_tab = signal(0, ...ngDevMode ? [{ debugName: "selected_tab" }] : (
      /* istanbul ignore next */
      []
    ));
...
var ZoneManagerModule = class _ZoneManagerModule {
  static {
    this.\u0275fac = function ZoneManagerModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ZoneManagerModule)();
    };
  }
  static {
    this.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _ZoneManagerModule });
  }
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [ZoneManagerComponent, RouterModule.forChild(ROUTES)] });
  }
};
(() => {
...
//# sourceMappingURL=zone-manager.module-VW2F5WVE.js.map
