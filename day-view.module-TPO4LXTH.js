...
} from "./chunk-VNQ35LO6.js";
import "./chunk-D54ZDHOD.js";
import "./chunk-WBAO5SRF.js";
import {
  EventsStateService
} from "./chunk-7Z3ZLJNZ.js";
import {
  MOCK_APPROVAL_EVENTS
} from "./chunk-HW3Z5KFO.js";
import "./chunk-5BORRCGD.js";
import "./chunk-QUETR2BI.js";
import "./chunk-XEZHXF4D.js";
import {
  DateOptionsComponent
} from "./chunk-DTRGGXQY.js";
import "./chunk-ITS4AH5Z.js";
import "./chunk-JXLXDFNC.js";
...
function RoomListTimelineComponent_For_28_For_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, RoomListTimelineComponent_For_28_For_1_Conditional_0_Conditional_2_Template, 1, 0, "div", 26)(3, RoomListTimelineComponent_For_28_For_1_Conditional_0_Conditional_3_Template, 1, 2, "div", 27);
    \u0275\u0275conditionalCreate(4, RoomListTimelineComponent_For_28_For_1_Conditional_0_Conditional_4_Template, 6, 7, "div", 28);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const event_r7 = \u0275\u0275nextContext().$implicit;
...
function RoomListTimelineComponent_For_28_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, RoomListTimelineComponent_For_28_For_1_Conditional_0_Template, 5, 13, "button", 23);
    \u0275\u0275pipe(1, "async");
  }
  if (rf & 2) {
    const event_r7 = ctx.$implicit;
...
_RoomListTimelineComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomListTimelineComponent, selectors: [["room-list-timeline"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 32, vars: 29, consts: [[1, "bg-info", "text-info-content", "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "p-2", "text-center", "text-xs"], [1, "border-base-200", "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "p-2"], [3, "dateChange", "date", "is_new", "hide_today"], [1, "text-info", "absolute", "top-1/2", "left-4", "-translate-y-1/2", "text-sm"], [1, "absolute", "top-1/2", "right-8", "-translate-y-1/2"], [3, "selected"], ["list-grid", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], [1, "bg-base-100", "sticky", "top-0", "left-0", "z-30", "flex", "items-center", "justify-center", "border-r", "border-b", "border-base-300"], [1, "text-xs", "opacity-30"], ["hour-headers", "", 1, "border-base-300", "bg-base-100", "sticky", "top-0", "z-20", "flex", "items-center", "border-b"], [1, "relative", "flex", "h-full", "items-end", "justify-center", "border-l", "border-base-200", "pb-1", 3, "width"], ["space-names", "", 1, "border-base-300", "bg-base-100", "sticky", "left-0", "z-10", "border-r"], [1, "flex", "items-center", "border-b", "border-base-200", "px-3", 3, "height", "matTooltip"], ["event-grid", "", 1, "relative"], [1, "border-b", "border-base-200", 3, "ngClass", "height"], [1, "absolute", "top-0", "h-full", "border-l", "border-base-200", 3, "left"], [1, "bg-secondary", "absolute", "top-0", "h-full", "w-[2px]", 3, "left"], [1, "relative", "flex", "h-full", "items-end", "justify-center", "border-l", "border-base-200", "pb-1"], [1, "text-xs", "opacity-60"], [1, "flex", "items-center", "border-b", "border-base-200", "px-3", 3, "matTooltip"], [1, "block", "w-full", "truncate", "text-xs", "font-medium"], [1, "border-b", "border-base-200", 3, "ngClass"], [1, "absolute", "top-0", "h-full", "border-l", "border-base-200"], ["matRipple", "", 1, "absolute", "overflow-hidden", "text-left", "hover:opacity-90", 3, "top", "height", "left", "width", "matTooltip"], ["matRipple", "", 1, "absolute", "overflow-hidden", "text-left", "hover:opacity-90", 3, "click", "matTooltip"], [1, "bg-base-100", "relative", "h-full", "w-full", "overflow-hidden", "rounded", "border", "border-base-200", "px-2", "py-0.5", "text-[11px]", "shadow-sm"], [1, "bg-secondary", "absolute", "inset-0", "opacity-20"], [3, "class"], [1, "relative"], [1, "truncate", "pl-1", "font-medium", "text-base-content"], [1, "truncate", "pl-1", "text-base-content", "opacity-70"], [1, "bg-secondary", "absolute", "top-0", "h-full", "w-[2px]"]], template: function RoomListTimelineComponent_Template(rf, ctx) {
  if (rf & 1) {
...
_RoomWeekBookingsTimelineComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomWeekBookingsTimelineComponent, selectors: [["room-week-bookings-timeline"]], features: [\u0275\u0275InheritDefinitionFeature], decls: 29, vars: 35, consts: [[1, "bg-info", "text-info-content", "mx-2", "mt-2", "w-[calc(100%-1rem)]", "rounded-lg", "p-2", "text-center", "text-xs"], [1, "border-base-200", "relative", "z-20", "flex", "items-center", "justify-center", "space-x-2", "border-b", "p-2"], [3, "dateChange", "date", "step", "is_new", "hide_today"], [1, "text-info", "absolute", "top-1/2", "left-4", "-translate-y-1/2", "text-sm"], [1, "absolute", "top-1/2", "right-8", "-translate-y-1/2"], [3, "selected"], ["timeline", "", 1, "z-0", "grid", "h-1/2", "w-full", "flex-1", "overflow-auto"], ["timezone", "", 1, "bg-base-100", "sticky", "top-0", "left-0", "z-30", "flex", "items-center", "justify-center"], [1, "text-xs", "opacity-30"], [1, "bg-base-300", "absolute", "right-0", "bottom-0", "h-2", "w-px"], [1, "bg-base-300", "absolute", "right-0", "bottom-0", "h-px", "w-2"], ["day-headers", "", 1, "border-base-300", "bg-base-100", "sticky", "top-0", "z-20", "flex", "min-w-[calc(100%-3rem)]", "items-center", "border-b"], [1, "relative", "flex", "h-full", "min-w-48", "flex-1", "flex-col", "items-center", "justify-center", "leading-tight"], ["empty-block", "", 1, "border-base-300", "bg-base-100", "sticky", "left-0", "z-10", "min-h-full", "border-r"], ["date-blocks", "", 1, "relative", "flex", "min-w-[calc(100%-3rem)]", "overflow-hidden"], [1, "border-base-200", "min-w-48", "flex-1", "overflow-hidden", "border-r", "p-2"], [1, "truncate"], [1, "text-info", "absolute", "bottom-1", "left-1/2", "-translate-x-1/2", "text-xs"], [1, "bg-base-300", "absolute", "bottom-0", "-left-px", "h-2", "w-px"], ["matRipple", "", 1, "mb-1", "w-full", "text-left", "hover:opacity-90"], ["matRipple", "", 1, "mb-1", "w-full", "text-left", "hover:opacity-90", 3, "click"], [1, "bg-base-100", "relative", "w-full", "overflow-hidden", "rounded-lg", "border", "border-base-200", "px-3", "py-1", "text-xs", "shadow-sm"], [1, "relative"], [1, "truncate", "font-medium", "text-base-content"], [1, "text-base-content", "opacity-70"], [1, "truncate", "text-base-content", "opacity-50"]], template: function RoomWeekBookingsTimelineComponent_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 11);
  }
}
function RoomBookingsComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_For_36_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function RoomBookingsComponent_For_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 16)(1, "div", 27);
    \u0275\u0275conditionalCreate(2, RoomBookingsComponent_For_36_Conditional_2_Template, 5, 3, "div", 21);
...
function RoomBookingsComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "settings-toggle", 5);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_Conditional_38_Template_settings_toggle_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RoomBookingsComponent_Conditional_53_Template(rf, ctx) {
  if (rf & 1) {
...
_RoomBookingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomBookingsComponent, selectors: [["room-bookings"]], features: [\u0275\u0275ProvidersFeature([UserPipe]), \u0275\u0275InheritDefinitionFeature], decls: 60, vars: 55, consts: [[1, "absolute", "inset-0", "flex", "flex-col", "overflow-hidden", "pl-8"], [1, "flex", "w-full", "items-center", "space-x-2", "py-4", "pr-8"], [1, "text-2xl", "font-medium"], [1, "w-px", "flex-1"], ["appearance", "outline", 1, "no-subscript", "w-32"], [3, "ngModelChange", "ngModel"], ["value", "day"], ["value", "week"], ["matRipple", "", 1, "flex", "h-12", "items-center", "space-x-1", "rounded", "border", "px-3", "text-sm", "font-medium", 3, "click", "ngClass"], [1, "text-xl"], ["icon", "", "matRipple", "", 1, "border-secondary", "h-12", "w-12", "rounded", "border", 3, "click", "matTooltip", "disabled"], ["diameter", "24"], [1, "text-2xl"], [1, "flex", "w-full", "items-center", "space-x-2"], ["appearance", "outline", 1, "no-subscript", "w-52"], ["multiple", "", 3, "ngModelChange", "ngModel", "placeholder"], [3, "value"], [3, "ngModel"], [1, "flex", "flex-1", "items-center", "justify-end", "space-x-4", "pr-2"], [1, "flex", "items-center", "space-x-1"], [1, "h-3", "w-3", "rounded-full", "bg-success"], [1, "text-xs", "text-gray-600"], [1, "h-3", "w-3", "rounded-full", "bg-warning"], [1, "h-3", "w-3", "rounded-full", "bg-error"], [1, "border-base-200", "mt-4", "flex", "h-px", "w-full", "flex-1", "border-t"], [1, "relative", "z-0", "w-1/2", "flex-1"], [1, "relative", "z-10"], [1, "flex", "flex-col-reverse"], [1, "opacity-0"]], template: function RoomBookingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(19, "async");
    \u0275\u0275pipe(20, "async");
    \u0275\u0275listener("click", function RoomBookingsComponent_Template_button_click_16_listener() {
    ...
    \u0275\u0275conditionalCreate(27, RoomBookingsComponent_Conditional_27_Template, 1, 0, "mat-spinner", 11)(28, RoomBookingsComponent_Conditional_28_Template, 2, 0, "icon", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 13)(30, "mat-form-field", 14)(31, "mat-select", 15);
    \u0275\u0275pipe(32, "async");
    \u0275\u0275pipe(33, "translate");
    \u0275\u0275pipe(34, "translate");
    \u0275\u0275listener("ngModelChange", function RoomBookingsComponent_Template_mat_select_ngModelChange_31_listener($event) {
      return ctx.updateZones($event);
    });
    \u0275\u0275repeaterCreate(35, RoomBookingsComponent_For_36_Template, 5, 3, "mat-option", 16, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275pipe(37, "async");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(38, RoomBookingsComponent_Conditional_38_Template, 4, 6, "settings-toggle", 17);
    \u0275\u0275elementStart(39, "div", 18)(40, "div", 19);
    \u0275\u0275element(41, "div", 20);
    ...
    \u0275\u0275conditionalCreate(53, RoomBookingsComponent_Conditional_53_Template, 1, 0, "room-bookings-timeline", 25);
    \u0275\u0275pipe(54, "async");
    \u0275\u0275pipe(55, "async");
    \u0275\u0275pipe(56, "async");
    \u0275\u0275conditionalBranchCreate(57, RoomBookingsComponent_Conditional_57_Template, 1, 0, "room-week-bookings-timeline", 25)(58, RoomBookingsComponent_Conditional_58_Template, 1, 0, "room-list-timeline", 25);
    \u0275\u0275conditionalCreate(59, RoomBookingsComponent_Conditional_59_Template, 1, 0, "room-bookings-approvals", 26);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(8, 23, ctx.dropdown_period));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(9, 25, "COMMON.VIEW_PERIOD"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 27, "COMMON.DAY"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(15, 29, "COMMON.WEEK"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("border-primary", \u0275\u0275pipeBind1(17, 31, ctx.period) === "list")("text-primary", \u0275\u0275pipeBind1(18, 33, ctx.period) === "list")("border-base-300", \u0275\u0275pipeBind1(19, 35, ctx.period) !== "list");
    \u0275\u0275property("ngClass", \u0275\u0275pipeBind1(20, 37, ctx.period) === "list" ? "bg-primary/10" : "");
    \u0275\u0275advance(9);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(26, 39, "APP.CONCIERGE.DOWNLOAD_USER_LIST"))("disabled", ctx.downloading());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.downloading() ? 27 : 28);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", \u0275\u0275pipeBind1(32, 41, ctx.zones))("placeholder", \u0275\u0275pipeBind1(33, 43, "COMMON.LEVEL_ALL"));
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(34, 45, "COMMON.LEVEL_ALL"));
    \u0275\u0275advance(4);
    \u0275\u0275repeater(\u0275\u0275pipeBind1(37, 47, ctx.levels));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.allow_setup_breakdown ? 38 : -1);
    \u0275\u0275advance(15);
    \u0275\u0275conditional(\u0275\u0275pipeBind1(54, 49, ctx.period) === "day" ? 53 : \u0275\u0275pipeBind1(55, 51, ctx.period) === "week" ? 57 : \u0275\u0275pipeBind1(56, 53, ctx.period) === "list" ? 58 : -1);
    \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomBookingsComponent, { className: "RoomBookingsComponent", filePath: "apps/concierge/src/app/day-view/room-bookings.component.ts", lineNumber: 178 });
})();
...
//# sourceMappingURL=day-view.module-TPO4LXTH.js.map
