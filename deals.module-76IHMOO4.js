...
_DealModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealModalComponent, selectors: [["app-deal-modal"]], outputs: { remove: "remove" }, decls: 39, vars: 24, consts: [[1, "relative", "w-[32rem]", "max-w-[80vw]", "bg-base-100"], [1, "relative", "h-48", "w-[32rem]", "max-w-full", "overflow-hidden", "rounded-b-lg", "bg-base-300"], ["auth", "", "alt", "Deal Image", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "absolute", "bottom-2", "left-2", "max-w-full", "truncate", "rounded", "bg-info", "px-2", "py-1", "text-xs", "text-info-content", "shadow"], [1, "flex", "space-x-2", "p-2"], [1, "w-auto", "px-2", "text-xl", "font-medium"], [1, "flex-1"], ["btn", "", "matRipple", "", 1, "space-x-2", 3, "click", "routerLink"], [1, "text-2xl"], [1, "pr-2"], ["btn", "", "matRipple", "", 1, "inverse", "error", "space-x-2", 3, "click"], [1, "text-2xl", "text-error"], [1, "max-h-[60vh]", "space-y-2", "overflow-auto", "p-4"], [1, "font-medium"], [1, "max-w-[]", "pb-4", "text-sm"], [1, "pb-4", "text-sm"], ["icon", "", "matRipple", "", "mat-dialog-close", "", 1, "absolute", "right-2", "top-2", "bg-base-100"]], template: function DealModalComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _DealsService = class _DealsService extends AsyncHandler {
  constructor() {
    ...
    this.deals$ = combineLatest([
      ...
      return Pu(bld.id, "deals-n-offers").pipe(catchError(() => of({ details: [] })));
    }), map(({ details }) => details instanceof Array ? details : []), tap(() => this.loading.set(false)), startWith([]), shareReplay(1));
  }
  async saveDeal(deal) {
    const metadata = await lastValueFrom(Pu(this._org.building.id, "deals-n-offers")).catch(() => null);
    ...
    deals.push(deal);
    await lastValueFrom(Tu(this._org.building.id, {
      name: "deals-n-offers",
...
_DealsListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DealsListComponent, selectors: [["deals-list"]], decls: 47, vars: 30, consts: [["image_template", ""], ["description_template", ""], ["valid_until_template", ""], ["actions_template", ""], ["menu", "matMenu"], [1, "absolute", "inset-0", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "px-8", "py-4", "pt-8"], [1, "text-2xl", "font-medium"], ["btn", "", "matRipple", "", 3, "routerLink"], [1, "ml-2"], [1, "text-2xl"], ["filters", "", 1, "flex", "space-x-2", "px-8", "pb-4"], [1, "flex", "items-center"], ["btn", "", "matRipple", "", "name", "deals-list", 1, "rounded-l", "rounded-r-none", "px-2", 3, "click", "matTooltip"], ["btn", "", "matRipple", "", "name", "deals-grid", 1, "rounded-l-none", "rounded-r", "px-2", 3, "click", "matTooltip"], ["appearance", "outline", 1, "no-subscript"], ["placeholder", "All Deals", 3, "ngModelChange", "ngModel"], [3, "value"], ["placeholder", "All Types", 3, "ngModelChange", "ngModel"], ["value", ""], [1, "capitalize", 3, "value"], [1, "relative", "h-1/2", "w-full", "flex-1", "overflow-auto", "px-8"], [1, "grid", "grid-cols-2", "gap-4", "md:grid-cols-3", "lg:grid-cols-4", "xl:grid-cols-5"], [1, "col-span-6", "flex", "w-full", "flex-col", "items-center", "justify-center", "rounded-lg", "bg-base-200", "p-16"], [1, "mx-auto", "flex", "flex-col", "items-center", "overflow-hidden", "rounded-lg", "border", "border-base-300", "bg-base-100", "shadow", 3, "click"], [1, "relative", "h-36", "w-48", "max-w-full", "overflow-hidden", "rounded-b-lg", "bg-base-200"], ["auth", "", "alt", "Deal Image", 1, "h-full", "w-full", "object-cover", 3, "source"], [1, "absolute", "bottom-2", "left-2", "max-w-full", "truncate", "rounded", "bg-info", "px-2", "py-1", "text-xs", "text-info-content", "shadow"], [1, "w-full", "px-4", "py-2", "text-left"], [1, "truncate", "font-bold"], [1, "text-sm", "opacity-50"], ["src", "assets/icons/no-deals.svg", "alt", "No Deals or Offers Available", 1, "mb-8", "w-48"], [1, "flex", "flex-col", "items-center", "space-y-4", "text-center"], [1, "text-lg", "font-bold"], [1, "mb-4", "min-w-[64rem]"], [1, "text-sm", 3, "data", "sortable", "columns"], [1, "flex", "h-full", "w-full", "items-center", "justify-center", "p-2"], [1, "h-16", "w-16", "rounded", "bg-base-200", "object-cover"], ["auth", "", 1, "h-16", "w-16", "rounded", "bg-base-200", "object-cover", 3, "source", "alt"], [1, "flex", "max-h-24", "overflow-hidden", "px-4", "py-2", "text-sm"], [1, "line-clamp-4"], [1, "opacity-30"], [1, "flex", "p-4"], [1, "flex", "h-full", "w-full", "items-center", "justify-end", "p-1"], ["icon", "", "matRipple", "", 1, "h-12", "w-12", "rounded", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 1, "min-w-48", 3, "click"], [1, "flex", "items-center", "space-x-2"], ["mat-menu-item", "", 3, "routerLink"], ["mat-menu-item", "", 3, "click"], [1, "text-2xl", "text-error"]], template: function DealsListComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=deals.module-76IHMOO4.js.map
