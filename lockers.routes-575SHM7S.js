...
} from "./chunk-HPSCTHJ7.js";
import {
  BookingRulesModalComponent
} from "./chunk-LAIDJ7CV.js";
import "./chunk-D4BBQWCU.js";
import {
  CounterComponent
...
import {
  toSignal
} from "./chunk-OTY4AWMZ.js";
import "./chunk-BRKP7SQL.js";
import {
  loadPersistedZones,
  persistZones
...
import "./chunk-DOIASZBB.js";
import "./chunk-DR7BIH7U.js";
import {
  showStaff
...
} from "./chunk-CN7U6CSW.js";
import "./chunk-YOCQEJ7L.js";
import "./chunk-2QRFMC2W.js";
import "./chunk-LM2BDEDP.js";
...
var SelectUserModalComponent = class _SelectUserModalComponent {
  constructor() {
    ...
    this._users = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "_users" } : (
      ...
      loader: ({ params: { q } }) => Ea({ q }).then((o) => o.data.map((u) => new StaffUser(u))).catch(() => [])
    }));
    this.users = computed(
      () => this._users.value() ?? [],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LockersTopbarComponent, { className: "LockersTopbarComponent", filePath: "apps/concierge/src/app/lockers/locker-topbar.component.ts", lineNumber: 183 });
})();
...
//# sourceMappingURL=lockers.routes-575SHM7S.js.map
